...
extends RealmsScreen {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.drawCenteredString(this.textRenderer, this.line1, this.width / 2, 80, 0xFFFFFF);
        this.drawCenteredString(this.textRenderer, this.line2, this.width / 2, 100, 0xFF0000);
