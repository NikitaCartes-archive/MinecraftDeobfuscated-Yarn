...
public class GlStateManager {
    ...
    private static final FloatBuffer MATRIX_BUFFER = GLX.make(MemoryUtil.memAllocFloat(16), floatBuffer -> UntrackMemoryUtil.untrack(MemoryUtil.memAddress(floatBuffer)));
    private static final FloatBuffer COLOR_BUFFER = GLX.make(MemoryUtil.memAllocFloat(4), floatBuffer -> UntrackMemoryUtil.untrack(MemoryUtil.memAddress(floatBuffer)));
    ...
    public static void texGenParam(TexCoord texCoord, int i, FloatBuffer floatBuffer) {
        GL11.glTexGenfv(GlStateManager.getTexGen((TexCoord)texCoord).coord, i, floatBuffer);
    }
