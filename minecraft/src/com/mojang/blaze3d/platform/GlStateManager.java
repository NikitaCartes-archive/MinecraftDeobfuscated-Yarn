...
public class GlStateManager {
	...
	private static final FloatBuffer COLOR_BUFFER = GLX.make(
		MemoryUtil.memAllocFloat(4), floatBuffer -> class_301.method_1407(MemoryUtil.memAddress(floatBuffer))
	);
	...
	private static final GlStateManager.CapabilityTracker[] LIGHT_ENABLE = (GlStateManager.CapabilityTracker[])IntStream.range(0, 8)
		...
		.toArray(i -> new GlStateManager.CapabilityTracker[i]);
	...
	private static final GlStateManager.Texture2DState[] TEXTURES = (GlStateManager.Texture2DState[])IntStream.range(0, 8)
		...
		.toArray(i -> new GlStateManager.Texture2DState[i]);
	...
	public static void blendFunc(GlStateManager.SrcBlendFactor srcBlendFactor, GlStateManager.DstBlendFactor dstBlendFactor) {
		blendFunc(srcBlendFactor.glValue, dstBlendFactor.glValue);
	}
	...
	public static void blendFuncSeparate(
		GlStateManager.SrcBlendFactor srcBlendFactor,
		GlStateManager.DstBlendFactor dstBlendFactor,
		GlStateManager.SrcBlendFactor srcBlendFactor2,
		GlStateManager.DstBlendFactor dstBlendFactor2
	) {
		blendFuncSeparate(srcBlendFactor.glValue, dstBlendFactor.glValue, srcBlendFactor2.glValue, dstBlendFactor2.glValue);
	}
	...
	static class AlphaTestState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(3008);
		public int func = 519;
	...
	static class BlendFuncState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(3042);
	...
	static class ClearState {
		...
		public GlStateManager.Color4 clearColor = new GlStateManager.Color4(0.0F, 0.0F, 0.0F, 0.0F);
	...
	static class ColorMaterialState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(2903);
	...
	static class CullFaceState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(2884);
	...
	static class DepthTestState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(2929);
	...
	@Environment(EnvType.CLIENT)
	public static enum DstBlendFactor {
	...
	static class FogState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(2912);
	...
	static class LogicOpState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(3058);
	...
	static class PolygonOffsetState {
		public GlStateManager.CapabilityTracker capFill = new GlStateManager.CapabilityTracker(32823);
		public GlStateManager.CapabilityTracker capLine = new GlStateManager.CapabilityTracker(10754);
		public float factor;
		public float units;
		...
		DEFAULT {
			...
			public void begin() {
				...
				GlStateManager.blendFuncSeparate(
					GlStateManager.SrcBlendFactor.ONE, GlStateManager.DstBlendFactor.ZERO, GlStateManager.SrcBlendFactor.ONE, GlStateManager.DstBlendFactor.ZERO
				);
	...
	@Environment(EnvType.CLIENT)
	public static enum SrcBlendFactor {
		CONSTANT_ALPHA(32771),
		CONSTANT_COLOR(32769),
		DST_ALPHA(772),
		DST_COLOR(774),
	...
	static class StencilState {
		public GlStateManager.StencilSubState subState = new GlStateManager.StencilSubState();
	...
	static class TexGenCoordState {
		public GlStateManager.CapabilityTracker capState;
		public int coord;
		public int mode = -1;
	...
	static class Texture2DState {
		public GlStateManager.CapabilityTracker capState = new GlStateManager.CapabilityTracker(3553);
