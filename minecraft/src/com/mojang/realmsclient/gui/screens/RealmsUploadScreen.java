	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		if (this.field_20503 != null) {
			for(int i = 0; i < this.field_20503.length; ++i) {
				this.drawCenteredText(matrices, this.textRenderer, this.field_20503[i], this.width / 2, 110 + 12 * i, 16711680);
			}
		}
											...
											if (SizeUnit.humanReadableSize(m, sizeUnit).equals(SizeUnit.humanReadableSize(5368709120L, sizeUnit2)) && sizeUnit != SizeUnit.B) {
												...
												this.method_27460(
													...
													new TranslatableText(
														"mco.upload.size.failure.line2", SizeUnit.humanReadableSize(m, sizeUnit3), SizeUnit.humanReadableSize(5368709120L, sizeUnit3)
													)
												);
											} else {
												this.method_27460(
