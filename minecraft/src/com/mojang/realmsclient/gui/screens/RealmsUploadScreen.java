...
public class RealmsUploadScreen extends RealmsScreen {
	...
	private void drawProgressBar() {
		...
		tezzelator.vertex(e - 0.5, 95.5, 0.0).color(217, 210, 210, 255).next();
		tezzelator.vertex(e + 200.0 * d / 100.0 + 0.5, 95.5, 0.0).color(217, 210, 210, 255).next();
		tezzelator.vertex(e + 200.0 * d / 100.0 + 0.5, 79.5, 0.0).color(217, 210, 210, 255).next();
		tezzelator.vertex(e - 0.5, 79.5, 0.0).color(217, 210, 210, 255).next();
		tezzelator.vertex(e, 95.0, 0.0).color(128, 128, 128, 255).next();
		tezzelator.vertex(e + 200.0 * d / 100.0, 95.0, 0.0).color(128, 128, 128, 255).next();
		tezzelator.vertex(e + 200.0 * d / 100.0, 80.0, 0.0).color(128, 128, 128, 255).next();
		tezzelator.vertex(e, 80.0, 0.0).color(128, 128, 128, 255).next();
		tezzelator.end();
