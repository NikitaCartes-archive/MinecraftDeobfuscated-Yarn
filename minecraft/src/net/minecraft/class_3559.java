...
public class class_3559 extends DataFix {
	public class_3559(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	public TypeRewriteRule makeRule() {
		...
		return this.fixTypeEverywhereTyped("BedItemColorFix", this.getInputSchema().getType(class_1208.field_5712), typed -> {
