...
public class class_2430 implements Consumer<BiConsumer<Identifier, LootSupplier.Builder>> {
	...
	private static <T> T method_10393(ItemContainer itemContainer, FunctionConsumerBuilder<T> functionConsumerBuilder) {
		return (T)(!field_11340.contains(itemContainer.getItem())
		...
		return LootSupplier.create()
			.withPool(
				LootPool.create()
					...
					.method_351(((LeafEntry.Builder)ItemEntry.method_411(block).withCondition(builder)).withChild(builder2))
			);
	}
	...
	private static LootSupplier.Builder method_10382(Block block, ItemContainer itemContainer) {
		return method_10397(block, method_10392(block, ItemEntry.method_411(itemContainer)));
	}
	...
	private static LootSupplier.Builder method_10384(ItemContainer itemContainer, LootTableRange lootTableRange) {
		return LootSupplier.create()
			.withPool(
				LootPool.create()
					.withRolls(ConstantLootTableRange.create(1))
					.method_351(method_10393(itemContainer, ItemEntry.method_411(itemContainer).withFunction(SetCountLootFunction.method_621(lootTableRange))))
			);
	}

	private static LootSupplier.Builder method_10386(Block block, ItemContainer itemContainer, LootTableRange lootTableRange) {
		return method_10397(block, method_10393(block, ItemEntry.method_411(itemContainer).withFunction(SetCountLootFunction.method_621(lootTableRange))));
	}
	...
	private static LootSupplier.Builder method_10377(Block block, Item item) {
		return method_10397(block, method_10393(block, ItemEntry.method_411(item).withFunction(ApplyBonusLootFunction.oreDrops(Enchantments.field_9130))));
	}
	...
	private static LootSupplier.Builder method_10371(Block block) {
		return method_10380(
			...
			method_10393(
				block,
				((LeafEntry.Builder)ItemEntry.method_411(Items.field_8317).withCondition(RandomChanceLootCondition.method_932(0.125F)))
	...
	private static LootSupplier.Builder method_10390(Block block, Block block2, float... fs) {
		return method_10388(block, method_10392(block, ItemEntry.method_411(block2)).withCondition(TableBonusLootCondition.method_800(Enchantments.field_9130, fs)))
			.withPool(
				LootPool.create()
					.withRolls(ConstantLootTableRange.create(1))
					.withCondition(field_11341)
					.method_351(
						method_10393(block, ItemEntry.method_411(Items.field_8600).withFunction(SetCountLootFunction.method_621(UniformLootTableRange.method_377(1.0F, 2.0F))))
		...
		return method_10390(block, block2, fs)
			.withPool(
				LootPool.create()
					...
					.withCondition(field_11341)
					.method_351(
						method_10392(block, ItemEntry.method_411(Items.field_8279))
	...
	private static LootSupplier.Builder method_10391(Block block, Item item, Item item2, LootCondition.Builder builder) {
		return method_10393(
			block,
			LootSupplier.create()
				.withPool(LootPool.create().method_351(((LeafEntry.Builder)ItemEntry.method_411(item).withCondition(builder)).withChild(ItemEntry.method_411(item2))))
				.withPool(
					LootPool.create()
	...
	public void method_10379(BiConsumer<Identifier, LootSupplier.Builder> biConsumer) {
		...
		this.method_16293(Blocks.field_10343, blockx -> method_10388(blockx, method_10392(blockx, ItemEntry.method_411(Items.field_8276))));
		this.method_16293(
			Blocks.field_10428,
			blockx -> method_10380(
					blockx,
					method_10393(blockx, ItemEntry.method_411(Items.field_8600).withFunction(SetCountLootFunction.method_621(UniformLootTableRange.method_377(0.0F, 2.0F))))
				)
		);
		...
		this.method_16293(
			...
			blockx -> method_10380(
					Blocks.field_10479,
					((LeafEntry.Builder)method_10392(blockx, ItemEntry.method_411(Items.field_8317))
		...
		this.method_16293(
			...
			blockx -> LootSupplier.create()
					.withPool(
						LootPool.create()
							.withRolls(ConstantLootTableRange.create(1))
							.method_351(method_10392(blockx, ItemEntry.method_411(blockx)).withCondition(EntityPropertiesLootCondition.method_15972(LootContext.EntityTarget.THIS)))
					)
		);
							...
							.method_351(
								AlternativeEntry.create(
									AlternativeEntry.create(
											...
											((LeafEntry.Builder)ItemEntry.method_411(Items.field_8543)
		...
		this.method_16293(
			...
			blockx -> method_10397(
					...
					method_10392(
						blockx,
						((LeafEntry.Builder)ItemEntry.method_411(Items.field_8145)
