...
public class class_3159 extends class_2944<class_3111> {
			...
			if (!method_16430(arg, lv)) {
				...
				for (int r = 0; r < i; r++) {
					...
					if (method_16420(arg, lv3)) {
						this.method_13874(set, arg, lv3, arg3);
						this.method_13874(set, arg, lv3.method_10078(), arg3);
						this.method_13874(set, arg, lv3.method_10072(), arg3);
						this.method_13874(set, arg, lv3.method_10078().method_10072(), arg3);
					}
				}
				...
				for (int r = -2; r <= 0; r++) {
					for (int s = -2; s <= 0; s++) {
						int t = -1;
						this.method_13873(arg, o + r, q + t, p + s, arg3, set);
						this.method_13873(arg, 1 + o - r, q + t, p + s, arg3, set);
						this.method_13873(arg, o + r, q + t, 1 + p - s, arg3, set);
						this.method_13873(arg, 1 + o - r, q + t, 1 + p - s, arg3, set);
						if ((r > -2 || s > -1) && (r != -1 || s != -2)) {
							int var29 = 1;
							this.method_13873(arg, o + r, q + var29, p + s, arg3, set);
							this.method_13873(arg, 1 + o - r, q + var29, p + s, arg3, set);
							this.method_13873(arg, o + r, q + var29, 1 + p - s, arg3, set);
							this.method_13873(arg, 1 + o - r, q + var29, 1 + p - s, arg3, set);
						}
					}
				}

				if (random.nextBoolean()) {
					this.method_13873(arg, o, q + 2, p, arg3, set);
					this.method_13873(arg, o + 1, q + 2, p, arg3, set);
					this.method_13873(arg, o + 1, q + 2, p + 1, arg3, set);
					this.method_13873(arg, o, q + 2, p + 1, arg3, set);
				}

				for (int r = -3; r <= 4; r++) {
					for (int sx = -3; sx <= 4; sx++) {
						if ((r != -3 || sx != -3) && (r != -3 || sx != 4) && (r != 4 || sx != -3) && (r != 4 || sx != 4) && (Math.abs(r) < 3 || Math.abs(sx) < 3)) {
							this.method_13873(arg, o + r, q, p + sx, arg3, set);
						}
					}
				}
				...
				for (int r = -1; r <= 2; r++) {
					for (int sxx = -1; sxx <= 2; sxx++) {
						if ((r < 0 || r > 1 || sxx < 0 || sxx > 1) && random.nextInt(3) <= 0) {
							...
							for (int u = 0; u < t; u++) {
								this.method_13874(set, arg, new class_2338(j + r, q - u - 1, l + sxx), arg3);
							}

							for (int u = -1; u <= 1; u++) {
								for (int v = -1; v <= 1; v++) {
									this.method_13873(arg, o + r + u, q, p + sxx + v, arg3, set);
								}
							}
							...
							for (int u = -2; u <= 2; u++) {
								for (int v = -2; v <= 2; v++) {
									if (Math.abs(u) != 2 || Math.abs(v) != 2) {
										this.method_13873(arg, o + r + u, q - 1, p + sxx + v, arg3, set);
									}
								}
							}
						}
	...
	private void method_13874(Set<class_2338> set, class_3747 arg, class_2338 arg2, class_3341 arg3) {
		if (method_16432(arg, arg2)) {
			this.method_12773(set, arg, arg2, field_13781, arg3);
		}
	}

	private void method_13873(class_3747 arg, int i, int j, int k, class_3341 arg2, Set<class_2338> set) {
		class_2338 lv = new class_2338(i, j, k);
		if (method_16424(arg, lv)) {
			this.method_12773(set, arg, lv, field_13782, arg2);
		}
	}
}
