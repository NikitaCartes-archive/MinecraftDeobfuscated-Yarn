...
public final class class_1301 {
	...
	public static final Predicate<class_1297> field_6156 = arg -> !(arg instanceof class_1657)
			|| !((class_1657)arg).method_7325() && !((class_1657)arg).method_7337();
	public static final Predicate<class_1297> field_6155 = arg -> !(arg instanceof class_1657) || !((class_1657)arg).method_7325();
	...
	public static Predicate<class_1297> method_5911(class_1297 arg) {
		...
		return (Predicate<class_1297>)(lv2 == class_270.class_271.field_1435 ? Predicates.alwaysFalse() : field_6155.and(arg4 -> {
			if (!arg4.method_5810()) {
				return false;
			} else if (!arg.field_6002.field_9236 || arg4 instanceof class_1657 && ((class_1657)arg4).method_7340()) {
				class_270 lvxx = arg4.method_5781();
				class_270.class_271 lv2xx = lvxx == null ? class_270.class_271.field_1437 : lvxx.method_1203();
				if (lv2xx == class_270.class_271.field_1435) {
					return false;
				} else {
					boolean bl = lv != null && lv.method_1206(lvxx);
					if ((lv2 == class_270.class_271.field_1440 || lv2xx == class_270.class_271.field_1440) && bl) {
						return false;
					} else {
						return lv2 != class_270.class_271.field_1434 && lv2xx != class_270.class_271.field_1434 || bl;
					}
				}
			} else {
				return false;
	...
	public static class class_1302 implements Predicate<class_1297> {
		...
		public boolean method_5916(@Nullable class_1297 arg) {
			if (!arg.method_5805()) {
				...
				class_1304 lv2 = class_1308.method_5953(this.field_6158);
				if (!lv.method_6118(lv2).method_7960()) {
					return false;
				} else if (lv instanceof class_1308) {
					return ((class_1308)lv).method_5936();
				} else if (lv instanceof class_1531) {
					return !((class_1531)lv).method_6915(lv2);
				} else {
					return lv instanceof class_1657;
				}
			}
		}
	}
