...
public class class_466 extends class_465<class_1704> {
	...
	public void tick() {
		...
		if (this.field_2805 && i >= 0) {
			...
			for(int m = 0; m < k - 1; ++m) {
				class_1291 lv = class_2580.field_11801[3][m];
				class_466.class_469 lv2 = new class_466.class_469(this.field_2776 + 167 + m * 24 - l / 2, this.field_2800 + 47, lv, false);
				this.addButton(lv2);
				if (3 >= i) {
					lv2.active = false;
	...
	class class_469 extends class_466.class_470 {
		...
		protected void method_18641() {
			...
			this.blit(this.x + 2, this.y + 2, this.field_18223, 18, 18);
		}
	}
