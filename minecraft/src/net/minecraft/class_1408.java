...
public abstract class class_1408 {
	...
	protected class_11 method_18416(class_2338 arg, double d, double e, double f, int i, boolean bl) {
		if (this.field_6684.field_6010 < 0.0) {
			...
			int j = (int)(g + (float)i);
			class_1941 lv2 = new class_1950(this.field_6677, lv.method_10069(-j, -j, -j), lv.method_10069(j, j, j));
