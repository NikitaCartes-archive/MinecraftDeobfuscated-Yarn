...
public abstract class class_1408 {
	...
	public class_1408(class_1308 arg, class_1937 arg2) {
		...
		this.field_6673 = this.method_6336(class_3532.method_15357(this.field_6671.method_6194() * 16.0));
	}
	...
	protected abstract class_13 method_6336(int i);
	...
	public class_11 method_6348(class_2338 arg) {
		float f = (float)arg.method_10263() + 0.5F;
		float g = (float)arg.method_10264() + 0.5F;
		float h = (float)arg.method_10260() + 0.5F;
		return this.method_18416(arg, (double)f, (double)g, (double)h, 8, false);
	}
	...
	public class_11 method_6349(class_1297 arg) {
		...
		double e = arg.method_5829().field_1322;
		double f = arg.field_6035;
		return this.method_18416(lv, d, e, f, 16, true);
	}

	@Nullable
	protected class_11 method_18416(class_2338 arg, double d, double e, double f, int i, boolean bl) {
		if (!this.method_6358()) {
			return null;
			...
			this.field_6676 = arg;
			float g = this.method_6338();
			this.field_6677.method_16107().method_15396("pathfind");
			class_2338 lv = bl ? new class_2338(this.field_6684).method_10084() : new class_2338(this.field_6684);
			int j = (int)(g + (float)i);
			class_1922 lv2 = new class_1950(this.field_6677, lv.method_10069(-j, -j, -j), lv.method_10069(j, j, j));
			class_11 lv3 = this.field_6673.method_52(lv2, this.field_6684, d, e, f, g);
	...
	protected void method_6339() {
		...
		if (Math.abs(this.field_6684.field_5987 - (lv2.field_1352 + 0.5)) < (double)this.field_6683
			&& Math.abs(this.field_6684.field_6035 - (lv2.field_1350 + 0.5)) < (double)this.field_6683
			&& Math.abs(this.field_6684.field_6010 - lv2.field_1351) < 1.0) {
			this.field_6681.method_42(this.field_6681.method_39() + 1);
		}

		int k = class_3532.method_15386(this.field_6684.method_17681());
		int l = class_3532.method_15386(this.field_6684.method_17682());
		int m = k;
	...
	public void method_18053(class_2338 arg) {
		if (this.field_6681 != null && !this.field_6681.method_46() && this.field_6681.method_38() != 0) {
			class_9 lv = this.field_6681.method_45();
			class_243 lv2 = new class_243(
				((double)lv.field_40 + this.field_6684.field_5987) / 2.0,
				((double)lv.field_39 + this.field_6684.field_6010) / 2.0,
				((double)lv.field_38 + this.field_6684.field_6035) / 2.0
			);
			if (arg.method_19769(lv2, (double)(this.field_6681.method_38() - this.field_6681.method_39()))) {
				this.method_6356();
			}
		}
	}
