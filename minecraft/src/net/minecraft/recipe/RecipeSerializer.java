...
public interface RecipeSerializer<T extends Recipe<?>> {
	...
	T method_8121(Identifier identifier, JsonObject jsonObject);

	T method_8122(Identifier identifier, PacketByteBuf packetByteBuf);

	void method_8124(PacketByteBuf packetByteBuf, T recipe);
