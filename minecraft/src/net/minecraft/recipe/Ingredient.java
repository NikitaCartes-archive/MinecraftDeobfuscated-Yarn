...
public final class Ingredient implements Predicate<ItemStack> {
	...
	public ItemStack[] getMatchingStacks() {
		if (this.matchingStacks == null) {
			this.matchingStacks = (ItemStack[])Arrays.stream(this.entries).flatMap(entry -> entry.getStacks().stream()).distinct().toArray(i -> new ItemStack[i]);
		}
	...
	static record StackEntry(ItemStack stack) implements Ingredient.Entry {
		...
		public boolean equals(Object o) {
			if (!(o instanceof Ingredient.StackEntry)) {
				return false;
			} else {
				Ingredient.StackEntry stackEntry = (Ingredient.StackEntry)o;
