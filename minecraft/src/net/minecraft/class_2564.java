...
public class class_2564 {
	...
	public static class_2561 method_10881(@Nullable class_2168 arg, class_2561 arg2, @Nullable class_1297 arg3, int i) throws CommandSyntaxException {
		if (i > 100) {
			return arg2;
		} else {
			i++;
			class_2561 lv = arg2 instanceof class_2566 ? ((class_2566)arg2).method_10890(arg, arg3, i) : arg2.method_10850();

			for (class_2561 lv2 : arg2.method_10855()) {
				lv.method_10852(method_10881(arg, lv2, arg3, i));
			}
