...
public class class_1198 extends DataFix {
	public class_1198(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	public TypeRewriteRule makeRule() {
		Type<?> type = this.getOutputSchema().getType(class_1208.field_5718);
		return this.fixTypeEverywhereTyped("MobSpawnerEntityIdentifiersFix", this.getInputSchema().getType(class_1208.field_5718), type, typed -> {
