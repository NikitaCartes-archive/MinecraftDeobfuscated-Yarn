...
public abstract class class_922<T extends class_1309, M extends class_583<T>> extends class_897<T> implements class_3883<T, M> {
	...
	protected float method_4043(float f, float g, float h) {
		float i = g - f;
	...
	public void method_4054(T arg, double d, double e, double f, float g, float h) {
		...
		try {
			float i = this.method_4043(arg.field_6220, arg.field_6283, h);
			float j = this.method_4043(arg.field_6259, arg.field_6241, h);
			float k = j - i;
			if (arg.method_5765() && arg.method_5854() instanceof class_1309) {
				class_1309 lv = (class_1309)arg.method_5854();
				i = this.method_4043(lv.field_6220, lv.field_6283, h);
				k = j - i;
			...
			float l = this.method_4045(arg, h);
			this.method_4058(arg, l, i, h);
			...
			this.field_4737.method_17080(arg, p, o, l, k, m, n);
			if (this.field_4674) {
				boolean bl = this.method_4057(arg);
				GlStateManager.enableColorMaterial();
				GlStateManager.setupSolidRenderingTextureCombine(this.method_3929(arg));
				if (!this.field_4739) {
					this.method_4052(arg, p, o, l, k, m, n);
				}

				if (!(arg instanceof class_1657) || !((class_1657)arg).method_7325()) {
					this.method_4051(arg, p, o, h, l, k, m, n);
				}
				...
				boolean bl = this.method_4059(arg, h);
				this.method_4052(arg, p, o, l, k, m, n);
				if (bl) {
					this.method_4040();
				}
	...
	protected void method_4058(T arg, float f, float g, float h) {
		...
		if (arg.field_6213 > 0) {
			...
			if (string != null
				...
				GlStateManager.translatef(0.0F, arg.field_6019 + 0.1F, 0.0F);
	...
	protected boolean method_4055(T arg) {
		...
		return class_310.method_1498() && arg != this.field_4676.field_4686 && bl && !arg.method_5782();
	}
}
