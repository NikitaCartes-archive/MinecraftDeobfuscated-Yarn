...
public abstract class class_1937 implements class_1920, class_1924, class_1936, AutoCloseable {
	...
	protected class_1937(
		class_30 arg,
		@Nullable class_37 arg2,
		class_31 arg3,
		class_2874 arg4,
		BiFunction<class_1937, class_2869, class_2802> biFunction,
		class_3695 arg5,
		boolean bl
	) {
		this.field_9243 = arg;
	...
	public void method_8429() {
		...
		for(int i = 0; i < this.field_9227.size(); ++i) {
			this.method_8539((class_1297)this.field_9227.get(i));
		}
		...
		for(int i = 0; i < this.field_9240.size(); ++i) {
			class_1297 lv = (class_1297)this.field_9240.get(i);
