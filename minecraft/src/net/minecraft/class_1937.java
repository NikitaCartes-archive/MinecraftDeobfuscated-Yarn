...
public abstract class class_1937 implements class_1920, class_1936, AutoCloseable {
	...
	public boolean method_8651(class_2338 arg, boolean bl) {
		...
		if (lv.method_11588()) {
			...
			this.method_20290(2001, arg, class_2248.method_9507(lv));
			if (bl) {
	...
	public boolean method_8438(class_2586 arg) {
		if (this.field_9249) {
			field_9224.error("Adding block entity while ticking: {} @ {}", () -> class_2378.field_11137.method_10221(arg.method_11017()), arg::method_11016);
		}
	...
	public void method_18471() {
		...
		while(iterator.hasNext()) {
			...
			if (!lv2.method_11015() && lv2.method_11002()) {
				...
				if (this.field_9248.method_20529(lv3) && this.method_8621().method_11952(lv3)) {
					try {
						lv.method_15400(() -> String.valueOf(class_2591.method_11033(lv2.method_11017())));
						if (lv2.method_11017().method_20526(this.method_8320(lv3).method_11614())) {
	...
	public boolean method_8422(class_238 arg, class_3614 arg2) {
		...
		return class_2338.method_17962(i, k, m, j - 1, l - 1, n - 1).anyMatch(arg2x -> lv.method_11745(this.method_8320(arg2x)));
	}
	...
	@Override
	public class_2806 method_20311() {
	...
	public boolean method_8479(class_2338 arg) {
		if (this.method_8499(arg.method_10074(), class_2350.field_11033) > 0) {
			...
			return true;
		} else if (this.method_8499(arg.method_10067(), class_2350.field_11039) > 0) {
			return true;
		} else {
			return this.method_8499(arg.method_10078(), class_2350.field_11034) > 0;
		}
	}
	...
	public boolean method_8546() {
		if (this.field_9247.method_12451() && !this.field_9247.method_12467()) {
			return (double)this.method_8478(1.0F) > 0.9;
		} else {
			return false;
		}
	}
	...
	public boolean method_8520(class_2338 arg) {
		if (!this.method_8419()) {
			...
			return false;
		} else if (this.method_8598(class_2902.class_2903.field_13197, arg).method_10264() > arg.method_10264()) {
			return false;
		} else {
			return this.method_8310(arg).method_8694() == class_1959.class_1963.field_9382;
		}
	}
	...
	public class_129 method_8538(class_128 arg) {
		...
		lv.method_577("Level dimension", () -> this.field_9247.method_12460().toString());
