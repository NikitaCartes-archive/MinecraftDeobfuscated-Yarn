...
public class class_2641 implements class_2596<class_2602> {
	...
	public void method_11053(class_2540 arg) throws IOException {
		...
		this.field_12123 = (RootCommandNode)lvs[arg.method_10816()].field_12128;
	}

	@Override
	public void method_11052(class_2540 arg) throws IOException {
		Map<CommandNode<class_2172>, Integer> map = Maps.newHashMap();
		Deque<CommandNode<class_2172>> deque = new ArrayDeque();
		deque.add(this.field_12123);

		while(!deque.isEmpty()) {
			CommandNode<class_2172> commandNode = (CommandNode)deque.pollFirst();
		...
		arg.method_10804(map.get(this.field_12123));
	}
	...
	private void method_11401(class_2540 arg, CommandNode<class_2172> commandNode, Map<CommandNode<class_2172>, Integer> map) {
		...
		for(CommandNode<class_2172> commandNode2 : commandNode.getChildren()) {
			arg.method_10804(map.get(commandNode2));
		}

		if (commandNode.getRedirect() != null) {
			arg.method_10804(map.get(commandNode.getRedirect()));
		}

		if (commandNode instanceof ArgumentCommandNode) {
			ArgumentCommandNode<class_2172, ?> argumentCommandNode = (ArgumentCommandNode)commandNode;
	...
	static class class_2642 {
		...
		public boolean method_11406(class_2641.class_2642[] args) {
			...
			for(int i : this.field_12125) {
				CommandNode<class_2172> commandNode = args[i].field_12128;
				if (!(commandNode instanceof RootCommandNode)) {
