...
public class class_845 implements Runnable {
	...
	void method_3615(class_842 arg) throws InterruptedException {
		arg.method_3605().lock();

		try {
			if (!method_20719(arg, class_842.class_843.field_4422)) {
				return;
			}
		...
		final class_750 lv = this.method_3613();
		arg.method_3605().lock();

		try {
			if (!method_20719(arg, class_842.class_843.field_4424)) {
				this.method_3610(lv);
				return;
			}
		} finally {
		...
		arg.method_3603(lv);
		class_243 lv2 = this.field_4430.method_19420();
		float f = (float)lv2.field_1352;
		float g = (float)lv2.field_1351;
		float h = (float)lv2.field_1350;
		class_842.class_844 lv3 = arg.method_3604();
		if (lv3 == class_842.class_844.field_4426) {
			arg.method_3608().method_3652(f, g, h, arg);
		} else if (lv3 == class_842.class_844.field_4427) {
		...
		final class_849 lv4 = arg.method_3609();
		ArrayList list = Lists.newArrayList();
		if (lv3 == class_842.class_844.field_4426) {
			for (class_1921 lv5 : class_1921.values()) {
				if (lv4.method_3649(lv5)) {
					list.add(this.field_4430.method_3635(lv5, arg.method_3600().method_3154(lv5), arg.method_3608(), lv4, arg.method_3602()));
				}
			}
		} else if (lv3 == class_842.class_844.field_4427) {
			list.add(this.field_4430.method_3635(class_1921.field_9179, arg.method_3600().method_3154(class_1921.field_9179), arg.method_3608(), lv4, arg.method_3602()));
		}
		...
		Futures.addCallback(listenableFuture, new FutureCallback<List<Void>>() {
			public void method_3617(@Nullable List<Void> list) {
				class_845.this.method_3610(lv);
				arg.method_3605().lock();

				label32: {
					try {
						if (class_845.method_20719(arg, class_842.class_843.field_4421)) {
				...
				arg.method_3608().method_3665(lv4);
			}
	...
	private static boolean method_20719(class_842 arg, class_842.class_843 arg2) {
		if (arg.method_3599() != arg2) {
			if (!arg.method_3595()) {
				field_4431.warn("Chunk render task was {} when I expected it to be {}; ignoring task", arg.method_3599(), arg2);
			}
	...
	private void method_3610(class_750 arg) {
		if (arg != this.field_4428) {
			this.field_4430.method_3625(arg);
		}
	}
