...
public class class_3589 extends DataFix {
	public class_3589(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		...
		return this.fixTypeEverywhereTyped(
			"ChunkStatusFix", type, this.getOutputSchema().getType(class_1208.field_5726), typed -> typed.updateTyped(opticFinder, typedx -> {
