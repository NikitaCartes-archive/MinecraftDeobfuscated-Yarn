...
public class class_4184 {
	...
	public void method_19321(class_1922 arg, class_1297 arg2, boolean bl, boolean bl2, float f) {
		...
		if (bl) {
			if (bl2) {
				...
				this.method_19320(0.0F, -this.field_18717 * 2.0F);
			}
	...
	public void method_19317() {
		if (this.field_18711 != null) {
			...
			this.field_18721 += (this.field_18711.method_5751() - this.field_18721) * 0.5F;
		}
	}
	...
	private double method_19318(double d) {
		for(int i = 0; i < 8; ++i) {
			...
			class_239 lv3 = this.field_18710
				.method_17742(new class_3959(lv, lv2, class_3959.class_3960.field_17558, class_3959.class_242.field_1348, this.field_18711));
	...
	protected void method_19319(double d, double e, double f) {
		double g = d - this.field_18712.field_1352;
		double h = e - this.field_18712.field_1351;
		double i = f - this.field_18712.field_1350;
		double j = (double)class_3532.method_15368(g * g + i * i);
		this.field_18717 = class_3532.method_15393((float)(-(class_3532.method_15349(h, j) * 180.0F / (float)Math.PI)));
		this.field_18718 = class_3532.method_15393((float)(class_3532.method_15349(i, g) * 180.0F / (float)Math.PI) - 90.0F);
		this.method_19323();
	}
