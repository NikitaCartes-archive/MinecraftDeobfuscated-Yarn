...
public class class_2955 implements class_2952<Integer> {
	...
	public void method_12826(class_3222 arg, @Nullable class_1860 arg2, boolean bl) {
		if (arg2 != null && arg.method_14253().method_14878(arg2)) {
			this.field_13350 = arg.field_7514;
			this.field_13348 = (class_1729)arg.field_7512;
	...
	protected void method_12821(class_1860 arg, boolean bl) {
		...
		int j = this.method_12819(bl, i, bl2);
	...
	public void method_12815(Iterator<Integer> iterator, int i, int j, int k, int l) {
		...
		class_1799 lv2 = class_1662.method_7405(iterator.next());
		if (!lv2.method_7960()) {
			for(int m = 0; m < j; ++m) {
