...
public class class_1357 extends Goal {
	...
	public void start() {
		Direction direction = this.field_6471.method_5755();
		this.field_6471.velocityX += (double)direction.getOffsetX() * 0.6;
		this.field_6471.velocityY += 0.7;
		this.field_6471.velocityZ += (double)direction.getOffsetZ() * 0.6;
	...
	public void tick() {
		...
		if (this.field_6473 && !bl) {
			this.field_6471.playSound(SoundEvents.field_14707, 1.0F, 1.0F);
		}
