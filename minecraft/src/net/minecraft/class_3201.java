...
public class class_3201 extends class_3225 {
	...
	public class_3201(class_1937 arg) {
		super(arg);
	}
	...
	public void method_14264() {
		...
		if (l % 24000L == 500L) {
			...
			if (l == 100L) {
				this.field_14008.field_13987.method_14364(new class_2668(5, 101.0F));
			} else if (l == 175L) {
				this.field_14008.field_13987.method_14364(new class_2668(5, 102.0F));
			} else if (l == 250L) {
				this.field_14008.field_13987.method_14364(new class_2668(5, 103.0F));
			}
	...
	public class_1269 method_14262(class_1657 arg, class_1937 arg2, class_1799 arg3, class_1268 arg4, class_2338 arg5, class_2350 arg6, float f, float g, float h) {
		if (this.field_13889) {
			...
			return super.method_14262(arg, arg2, arg3, arg4, arg5, arg6, f, g, h);
		}
	}
}
