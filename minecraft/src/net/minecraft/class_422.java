...
public class class_422 extends class_437 {
	...
	public class_422(BooleanConsumer booleanConsumer, class_642 arg) {
	...
	protected void init() {
		...
		this.field_2471 = new class_342(this.font, this.width / 2 - 100, 66, 200, 20, class_1074.method_4662("addServer.enterName"));
		...
		this.field_2474 = new class_342(this.font, this.width / 2 - 100, 106, 200, 20, class_1074.method_4662("addServer.enterIp"));
		...
		this.addButton(
			new class_4185(this.width / 2 - 100, this.height / 4 + 120 + 18, 200, 20, class_1074.method_4662("gui.cancel"), arg -> this.field_19236.accept(false))
		);
		this.onClose();
	}
