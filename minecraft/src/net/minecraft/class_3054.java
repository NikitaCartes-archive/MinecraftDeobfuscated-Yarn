					...
					class_2170.method_9247("add")
						.then(
							class_2170.method_9244("targets", class_2186.method_9308())
								.then(
									((RequiredArgumentBuilder)((RequiredArgumentBuilder)class_2170.method_9244("amount", IntegerArgumentType.integer())
												.executes(
				...
				.then(
					class_2170.method_9247("set")
						.then(
							class_2170.method_9244("targets", class_2186.method_9308())
								.then(
									((RequiredArgumentBuilder)((RequiredArgumentBuilder)class_2170.method_9244("amount", IntegerArgumentType.integer(0))
												.executes(
