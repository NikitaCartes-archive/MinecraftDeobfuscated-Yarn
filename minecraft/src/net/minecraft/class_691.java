...
public class class_691 extends class_4003 {
	private final class_4002 field_17815;

	private class_691(class_1937 arg, double d, double e, double f, double g, class_4002 arg2) {
		super(arg, d, e, f, 0.0, 0.0, 0.0);
		this.field_3847 = 6 + this.field_3840.nextInt(4);
		float h = this.field_3840.nextFloat() * 0.6F + 0.4F;
		this.field_3861 = h;
		this.field_3842 = h;
		this.field_3859 = h;
		this.field_17867 = 2.0F * (1.0F - (float)g * 0.5F);
		this.field_17815 = arg2;
	...
	public static class class_692 implements class_707<class_2400> {
		...
		public class_692(class_4002 arg) {
		...
		public class_703 method_3038(class_2400 arg, class_1937 arg2, double d, double e, double f, double g, double h, double i) {
			return new class_691(arg2, d, e, f, g, this.field_17816);
		}
	}
}
