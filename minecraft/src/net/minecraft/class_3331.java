...
public class class_3331<K, V extends class_3330<K>> {
	...
	public void method_14633(V arg) {
		...
		try {
			...
			field_14373.warn("Could not save the list after adding a user.", var3);
		}
	}
	...
	public void method_14635(K object) {
		...
		try {
			...
			field_14373.warn("Could not save the list after removing a user.", var3);
		}
	}
	...
	protected class_3330<K> method_14642(JsonObject jsonObject) {
		return new class_3330<>((K)null, jsonObject);
	}
