...
public class class_269 {
	...
	public boolean method_1183(String string, class_266 arg) {
		Map<class_266, class_267> map = (Map)this.field_1431.get(string);
		if (map == null) {
			return false;
		} else {
	...
	public class_267 method_1180(String string, class_266 arg) {
		if (string.length() > 40) {
			...
			Map<class_266, class_267> map = (Map)this.field_1431.computeIfAbsent(string, stringx -> Maps.newHashMap());
	...
	public void method_1155(String string, @Nullable class_266 arg) {
		if (arg == null) {
			Map<class_266, class_267> map = (Map)this.field_1431.remove(string);
			if (map != null) {
			...
			if (map != null) {
				...
				if (map.size() < 1) {
					Map<class_266, class_267> map2 = (Map)this.field_1431.remove(string);
					if (map2 != null) {
						this.method_1152(string);
					}
				} else if (lv != null) {
	...
	public void method_1194(class_266 arg) {
		...
		List<class_266> list = (List)this.field_1429.get(arg.method_1116());
		if (list != null) {
			list.remove(arg);
		}
	...
	protected class_2499 method_1169() {
		...
		this.field_1431.values().stream().map(Map::values).forEach(collection -> collection.stream().filter(arg -> arg.method_1127() != null).forEach(arg2 -> {
				class_2487 lvxx = new class_2487();
				lvxx.method_10582("Name", arg2.method_1129());
				lvxx.method_10582("Objective", arg2.method_1127().method_1113());
				lvxx.method_10569("Score", arg2.method_1126());
				lvxx.method_10556("Locked", arg2.method_1131());
				lv.method_10606(lvxx);
			}));
		return lv;
	}
