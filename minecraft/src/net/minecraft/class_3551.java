...
public class class_3551 {
	...
	private static void method_15451(DataFixerBuilder dataFixerBuilder) {
		...
		Schema schema81 = dataFixerBuilder.addSchema(1909, class_3743::new);
		dataFixerBuilder.addFixer(new class_3553(schema81, "Add jigsaw", class_1208.field_5727));
		Schema schema82 = dataFixerBuilder.addSchema(1911, field_15775);
		dataFixerBuilder.addFixer(new class_3788(schema82, false));
		Schema schema83 = dataFixerBuilder.addSchema(1917, field_15775);
		dataFixerBuilder.addFixer(new class_3903(schema83, false));
		Schema schema84 = dataFixerBuilder.addSchema(1918, field_15775);
		dataFixerBuilder.addFixer(new class_3845(schema84, "minecraft:villager"));
		dataFixerBuilder.addFixer(new class_3845(schema84, "minecraft:zombie_villager"));
		Schema schema85 = dataFixerBuilder.addSchema(1920, class_3905::new);
		dataFixerBuilder.addFixer(new class_3904(schema85, false));
		dataFixerBuilder.addFixer(new class_3553(schema85, "Add campfire", class_1208.field_5727));
		Schema schema86 = dataFixerBuilder.addSchema(1925, field_15775);
		dataFixerBuilder.addFixer(new class_3970(schema86, false));
		Schema schema87 = dataFixerBuilder.addSchema(1928, class_3984::new);
		dataFixerBuilder.addFixer(new class_3983(schema87, true));
		dataFixerBuilder.addFixer(class_1182.method_5019(schema87, "Rename ravager egg item", string -> (String)class_3983.field_17712.getOrDefault(string, string)));
		Schema schema88 = dataFixerBuilder.addSchema(1929, class_3985::new);
		dataFixerBuilder.addFixer(new class_3553(schema88, "Add Wandering Trader and Trader Llama", class_1208.field_5729));
		Schema schema89 = dataFixerBuilder.addSchema(1931, class_4016::new);
		dataFixerBuilder.addFixer(new class_3553(schema89, "Added Fox", class_1208.field_5729));
		Schema schema90 = dataFixerBuilder.addSchema(1936, field_15775);
		dataFixerBuilder.addFixer(new class_4092(schema90, false));
		Schema schema91 = dataFixerBuilder.addSchema(1946, field_15775);
		dataFixerBuilder.addFixer(new class_4285(schema91, false));
		Schema schema92 = dataFixerBuilder.addSchema(1948, field_15775);
		dataFixerBuilder.addFixer(new class_4294(schema92, false));
		Schema schema93 = dataFixerBuilder.addSchema(1953, field_15775);
		dataFixerBuilder.addFixer(new class_4299(schema93, false));
		Schema schema94 = dataFixerBuilder.addSchema(1955, field_15775);
		dataFixerBuilder.addFixer(new class_4300(schema94, false));
		dataFixerBuilder.addFixer(new class_4301(schema94, false));
		Schema schema95 = dataFixerBuilder.addSchema(1961, field_15775);
		dataFixerBuilder.addFixer(new class_3755(schema95, false));
	}
}
