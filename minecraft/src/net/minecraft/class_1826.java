...
public class class_1826 extends class_1792 {
	...
	public class_1269 method_7884(class_1838 arg) {
		...
		if (lv.field_9236) {
			...
			if (lv11 == null
				|| lv11.method_5894(lv, lv2, arg.method_8036(), lv10, class_3730.field_16465, true, !Objects.equals(lv3, lv10) && lv4 == class_2350.field_11036) != null) {
				lv2.method_7934(1);
			}
	...
	public class_1271<class_1799> method_7836(class_1937 arg, class_1657 arg2, class_1268 arg3) {
		...
		if (arg.field_9236) {
			...
			if (lv2 != null && lv2.field_1330 == class_239.class_240.field_1332) {
				class_2338 lv3 = lv2.method_1015();
				if (!(arg.method_8320(lv3).method_11614() instanceof class_2404)) {
					return new class_1271<>(class_1269.field_5811, lv);
				} else if (arg.method_8505(arg2, lv3) && arg2.method_7343(lv3, lv2.field_1327, lv)) {
					class_1299<?> lv4 = this.method_8015(lv.method_7969());
					if (lv4 != null && lv4.method_5894(arg, lv, arg2, lv3, class_3730.field_16465, false, false) != null) {
	...
	public class_1299<?> method_8015(@Nullable class_2487 arg) {
		if (arg != null && arg.method_10573("EntityTag", 10)) {
			...
			if (lv.method_10573("id", 8)) {
				return class_1299.method_5898(lv.method_10558("id"));
			}
		}
