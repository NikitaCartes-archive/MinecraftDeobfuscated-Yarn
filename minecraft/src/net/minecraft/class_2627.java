...
public class class_2627 extends class_2621 implements class_1278, class_3000 {
	...
	public class_238 method_11311(class_2350 arg) {
		float f = this.method_11312(1.0F);
		return class_259.method_1077()
			.method_1107()
			.method_1012((double)(0.5F * f * (float)arg.method_10148()), (double)(0.5F * f * (float)arg.method_10164()), (double)(0.5F * f * (float)arg.method_10165()));
	}
			...
			if (!list.isEmpty()) {
				for (int i = 0; i < list.size(); i++) {
					...
					if (lv4.method_5657() != class_3619.field_15975) {
						...
						lv4.method_5784(class_1313.field_6306, new class_243(d * (double)lv2.method_10148(), e * (double)lv2.method_10164(), f * (double)lv2.method_10165()));
					}
				}
			}
		}
	...
	private void method_20047() {
		this.method_11010().method_11635(this.method_10997(), this.method_11016(), 3);
	}
