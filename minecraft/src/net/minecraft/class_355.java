		...
		for (int v = 0; v < m; v++) {
			...
			if (v < list.size()) {
				...
				if (bl) {
					...
					int z = 8 + (bl2 ? 8 : 0);
					int aa = 8 * (bl2 ? -1 : 1);
					class_332.blit(x, y, 8.0F, (float)z, 8, aa, 8, 8, 64.0F, 64.0F);
					if (lv4 != null && lv4.method_7348(class_1664.field_7563)) {
						int ab = 8 + (bl2 ? 8 : 0);
						int ac = 8 * (bl2 ? -1 : 1);
						class_332.blit(x, y, 40.0F, (float)ab, 8, ac, 8, 8, 64.0F, 64.0F);
					}
	...
	private void method_1922(class_266 arg, int i, String string, int j, int k, class_640 arg2) {
		...
		if (arg.method_1118() == class_274.class_275.field_1471) {
			...
			if (n > 0) {
				...
				if (f > 3.0F) {
					for (int p = n; p < o; p++) {
						this.blit((float)j + (float)p * f, (float)i, bl ? 25 : 16, 0, 9, 9);
					}
					...
					for (int p = 0; p < n; p++) {
						...
						if (bl) {
							if (p * 2 + 1 < arg2.method_2960()) {
								this.blit((float)j + (float)p * f, (float)i, 70, 0, 9, 9);
							}

							if (p * 2 + 1 == arg2.method_2960()) {
								this.blit((float)j + (float)p * f, (float)i, 79, 0, 9, 9);
							}
						}

						if (p * 2 + 1 < l) {
							this.blit((float)j + (float)p * f, (float)i, p >= 10 ? 160 : 52, 0, 9, 9);
						}

						if (p * 2 + 1 == l) {
							this.blit((float)j + (float)p * f, (float)i, p >= 10 ? 169 : 61, 0, 9, 9);
						}
					}
				} else {
