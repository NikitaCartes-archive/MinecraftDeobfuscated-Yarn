...
public class class_2985 {
			...
			try {
				...
				try {
					...
					dynamic = this.field_13397
						.method_3855()
						.update(DataFixTypes.ADVANCEMENTS, dynamic, dynamic.get("DataVersion").asInt(0), class_155.method_16673().getWorldVersion());
					dynamic = dynamic.remove("DataVersion");
					Map<class_2960, class_167> map = (Map)field_13395.getAdapter(field_13392).fromJsonTree(dynamic.getValue());
					if (map == null) {
	...
	public void method_12890() {
		...
		try {
			...
			try {
				Writer writer;
				try {
					writer = new OutputStreamWriter(outputStream, Charsets.UTF_8.newEncoder());
					Throwable var6 = null;
	...
	public boolean method_12878(class_161 arg, String string) {
		...
		if (lv.method_743(string)) {
			...
			if (!bl2 && lv.method_740()) {
				...
				if (arg.method_686() != null && arg.method_686().method_808() && this.field_13391.field_6002.method_8450().method_8355("announceAdvancements")) {
					this.field_13397
						.method_3760()
	...
	public void method_12876(class_3222 arg) {
		if (this.field_13396 || !this.field_13386.isEmpty() || !this.field_13388.isEmpty()) {
			...
			for(class_161 lv : this.field_13386) {
				if (this.field_13390.contains(lv)) {
					set.add(lv);
				} else {
					set2.add(lv.method_688());
				}
			}
