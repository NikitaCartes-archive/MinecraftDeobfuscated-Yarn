...
public class class_2541 extends class_2248 {
	...
	private boolean method_10829(class_1922 arg, class_2338 arg2, class_2350 arg3) {
		if (arg3 == class_2350.field_11033) {
			...
			if (method_10821(arg, lv, arg3)) {
				...
				return lv3.method_11614() == this && lv3.method_11654(lv2);
			}
		}
	}
	...
	public static boolean method_10821(class_1922 arg, class_2338 arg2, class_2350 arg3) {
		...
		return class_2248.method_9501(lv.method_11628(arg, arg2), arg3.method_10153());
	}
		...
		for(class_2350 lv3 : class_2350.class_2353.field_11062) {
			...
			if (arg.method_11654(lv4)) {
				...
				if (!bl) {
					...
					bl = lv2.method_11614() == this && lv2.method_11654(lv4);
				}
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (!arg2.field_9236) {
			...
			if (lv != arg) {
				...
				if (lv2.method_10166().method_10179() && !arg.method_11654(method_10828(lv2))) {
					if (this.method_10824(arg2, arg3)) {
						...
						if (lv5.method_11588()) {
							...
							boolean bl = arg.method_11654(method_10828(lv6));
							boolean bl2 = arg.method_11654(method_10828(lv7));
	...
	private boolean method_10830(class_2680 arg) {
		return arg.method_11654(field_11706) || arg.method_11654(field_11702) || arg.method_11654(field_11699) || arg.method_11654(field_11696);
	}
	...
	public boolean method_9616(class_2680 arg, class_1750 arg2) {
		...
		if (lv.method_11614() == this) {
			return this.method_10822(lv) < field_11697.size();
		} else {
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		for(class_2350 lv3 : arg.method_7718()) {
			if (lv3 != class_2350.field_11033) {
				class_2746 lv4 = method_10828(lv3);
				boolean bl2 = bl && lv.method_11654(lv4);
