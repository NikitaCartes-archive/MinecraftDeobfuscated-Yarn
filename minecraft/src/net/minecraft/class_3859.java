...
public class class_3859 extends class_1874 {
	public class_3859(class_2960 arg, String string, class_1856 arg2, class_1799 arg3, float f, int i) {
		super(arg, string, arg2, arg3, f, i);
	}

	@Override
	public boolean method_8115(class_1263 arg, class_1937 arg2) {
		return arg instanceof class_3720 && this.field_9061.method_8093(arg.method_5438(0));
	}
	...
	public static class class_3860 implements class_1862<class_3859> {
		public class_3859 method_16947(class_2960 arg, JsonObject jsonObject) {
			...
			if (lv2 != null) {
				...
				return new class_3859(arg, string, lv, lv3, f, i);
			} else {
				throw new IllegalStateException(string2 + " did not exist");
			}
		}

		public class_3859 method_16948(class_2960 arg, class_2540 arg2) {
			...
			return new class_3859(arg, string, lv, lv2, f, i);
		}

		public void method_16946(class_2540 arg, class_3859 arg2) {
