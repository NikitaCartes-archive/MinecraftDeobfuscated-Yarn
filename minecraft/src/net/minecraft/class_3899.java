...
public class class_3899 {
	...
	protected void method_17272(int i, ChunkPos chunkPos, int j) {
		if (i < field_17241) {
			Long2ObjectMap<List<Runnable>> long2ObjectMap = (Long2ObjectMap)this.field_17243.get(i);
			List<Runnable> list = (List)long2ObjectMap.remove(chunkPos.toLong());
	...
	public Runnable method_17270() {
		if (this.field_17244 >= field_17241) {
			...
			Long2ObjectLinkedOpenHashMap<List<Runnable>> long2ObjectLinkedOpenHashMap = (Long2ObjectLinkedOpenHashMap)this.field_17243.get(i);
