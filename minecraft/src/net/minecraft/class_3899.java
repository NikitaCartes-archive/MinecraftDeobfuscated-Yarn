...
public class class_3899<T> {
	public static final int field_17241 = class_3215.field_13922 + 2;
	...
	protected void method_17272(int i, class_1923 arg, int j) {
		if (i < field_17241) {
			Long2ObjectLinkedOpenHashMap<List<Optional<T>>> long2ObjectLinkedOpenHashMap = (Long2ObjectLinkedOpenHashMap)this.field_17243.get(i);
			List<Optional<T>> list = (List)long2ObjectLinkedOpenHashMap.remove(arg.method_8324());
	...
	protected void method_17609(long l, boolean bl) {
		for(Long2ObjectLinkedOpenHashMap<List<Optional<T>>> long2ObjectLinkedOpenHashMap : this.field_17243) {
			List<Optional<T>> list = (List)long2ObjectLinkedOpenHashMap.get(l);
			if (list != null) {
				if (bl) {
					list.clear();
				} else {
