	...
	public void run() {
		...
		if (bl3) {
			...
			if (this.server.ownerUUID.equals(MinecraftClient.getInstance().getSession().getUuid())) {
				...
				setScreen(
					new RealmsGenericErrorScreen(I18n.translate("mco.brokenworld.nonowner.title"), I18n.translate("mco.brokenworld.nonowner.error"), this.lastScreen)
				);
			}
