...
public class class_564<T extends class_1642> extends class_623<T> {
	...
	public void method_17077(T arg, float f, float g, float h) {
		...
		if (lv.method_7909() == class_1802.field_8547 && arg.method_6999()) {
	...
	public void method_17134(T arg, float f, float g, float h, float i, float j, float k) {
		super.method_17134(arg, f, g, h, i, j, k);
		...
		if (this.field_3396 > 0.0F) {
			...
			this.field_3397.field_3654 -= this.field_3396 * 0.55F * class_3532.method_15374(0.1F * h);
			this.field_3392.field_3654 += this.field_3396 * 0.55F * class_3532.method_15374(0.1F * h);
