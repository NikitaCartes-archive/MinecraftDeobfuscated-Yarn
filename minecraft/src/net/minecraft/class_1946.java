...
public class class_1946 {
			...
			if (lv3 != null) {
				...
				for(int j = -128; j <= 128; ++j) {
					...
					for(int k = -128; k <= 128; ++k) {
						for(class_2338 lv4 = arg.method_10069(j, this.field_9286.method_8456() - 1 - arg.method_10264(), k); lv4.method_10264() >= 0; lv4 = lv5) {
							lv5 = lv4.method_10074();
	...
	private void method_20467(long l) {
		...
		while(iterator.hasNext()) {
			Entry<class_2265, class_1946.class_1947> entry = (Entry)iterator.next();
