...
public class class_2401 extends class_2341 {
	...
	public boolean method_9534(class_2680 arg, class_1937 arg2, class_2338 arg3, class_1657 arg4, class_1268 arg5, class_2350 arg6, float f, float g, float h) {
		...
		boolean bl = arg.method_11654(field_11265);
		if (arg2.field_9236) {
			if (bl) {
			...
			float i = bl ? 0.6F : 0.5F;
			arg2.method_8396(null, arg3, class_3417.field_14962, class_3419.field_15245, 0.3F, i);
	...
	public void method_9496(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (arg.method_11654(field_11265) && random.nextFloat() < 0.25F) {
	...
	public void method_9536(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2680 arg4, boolean bl) {
		if (!bl && arg.method_11614() != arg4.method_11614()) {
			if (arg.method_11654(field_11265)) {
				this.method_10309(arg, arg2, arg3);
			}
