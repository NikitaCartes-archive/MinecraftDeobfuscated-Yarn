...
public class class_1170 extends class_1211 {
	public static final Map<String, String> field_5671 = ImmutableMap.<String, String>builder()
		...
		.build();
	public static final Map<String, String> field_5672 = ImmutableMap.<String, String>builder()
		...
		.build();
	public static final Map<String, String> field_5673 = ImmutableMap.<String, String>builder()
		.putAll(field_5672)
	...
	public class_1170(Schema schema, boolean bl) {
	...
	protected String method_5163(String string) {
		...
		return (String)field_5671.getOrDefault(string, string);
	}
}
