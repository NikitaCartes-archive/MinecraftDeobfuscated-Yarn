...
public class class_1170 extends class_1211 {
	public static final Map<String, String> field_5671 = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> field_5672 = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> field_5673 = ImmutableMap.builder()
		.putAll(field_5672)
