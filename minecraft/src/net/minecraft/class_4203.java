...
public class class_4203 implements DebugRenderer.DebugRenderer {
	private final MinecraftClient field_18767;
	private final Map<String, class_4203.class_4204> field_18768 = Maps.newHashMap();
	private String field_18769 = null;

	public void method_19423(class_4203.class_4204 arg) {
		this.field_18768.put(arg.field_18770, arg);
	}

	public class_4203(MinecraftClient minecraftClient) {
	...
	public void render(long l) {
		...
		for(class_4203.class_4204 lv : this.field_18768.values()) {
	...
	private void method_19426(class_4203.class_4204 arg) {
		int i = 0;
	...
	private void method_19421() {
		Entity entity = this.method_19425();
		if (entity != null) {
			this.field_18769 = entity.getUuid().toString();
		}
	}

	private boolean method_19427(class_4203.class_4204 arg) {
		return Objects.equals(this.field_18769, arg.field_18770);
	}

	@Nullable
	private Entity method_19425() {
		...
		if (entity == null) {
			...
			try {
				int i = 160;
				float f = 1.0F;
				this.field_18767.hitResult = entity.method_5745(160.0, 1.0F, false);
				...
				float g = 1.0F;
				BoundingBox boundingBox = entity.method_5829().method_18804(vec3d2.multiply(160.0)).expand(1.0, 1.0, 1.0);
				int j = 25600;
	...
	private boolean method_19428(class_4203.class_4204 arg) {
		PlayerEntity playerEntity = this.field_18767.field_1724;
	...
	public static class class_4204 {
		...
		public final List<String> field_18773 = Lists.newArrayList();
		public final List<String> field_18774 = Lists.newArrayList();
