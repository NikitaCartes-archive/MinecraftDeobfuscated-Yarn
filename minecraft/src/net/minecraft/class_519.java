...
public class class_519 extends class_437 {
	...
	protected void init() {
		...
		this.addButton(new class_4185(this.width / 2 + 4, this.height - 48, 150, 20, class_1074.method_4662("gui.done"), arg -> {
			if (this.field_3155) {
				List<class_1075> listxx = Lists.<class_1075>newArrayList();

				for(class_521.class_4271 lvxx : this.field_3154.children()) {
					listxx.add(lvxx.method_20150());
				}

				Collections.reverse(listxx);
				this.minecraft.method_1520().method_14447(listxx);
				this.minecraft.field_1690.field_1887.clear();
				this.minecraft.field_1690.field_1846.clear();

				for(class_1075 lv2xx : listxx) {
					if (!lv2xx.method_14465()) {
						this.minecraft.field_1690.field_1887.add(lv2xx.method_14463());
						if (!lv2xx.method_14460().method_14437()) {
							this.minecraft.field_1690.field_1846.add(lv2xx.method_14463());
						}
					}
				}
		...
		this.field_3157.method_20065(this.width / 2 - 4 - 200);
		if (lv != null) {
		...
		this.field_3154.method_20065(this.width / 2 + 4);
		if (lv2 != null) {
