...
public abstract class class_3324 {
	...
	public void method_14570(class_2535 arg, class_3222 arg2) {
		...
		arg2.method_5866(this.field_14360.method_3847(arg2.field_6026));
		...
		lv5.method_14364(
			new class_2678(
				...
				this.method_14592(),
				lv4.method_153(),
				lv3.method_8450().method_8355("reducedDebugInfo")
			)
		);
		...
		if (lv2 != null && lv2.method_10573("RootVehicle", 10)) {
			...
			class_1297 lv9 = class_2852.method_12378(lv8.method_10562("Entity"), lv3, true);
			if (lv9 != null) {
	...
	public void method_14591(class_3218 arg) {
		this.field_14358 = arg.method_8411().method_129();
	...
	public void method_14612(class_3222 arg, @Nullable class_3218 arg2) {
		class_3218 lv = arg.method_14220();
		if (arg2 != null) {
			arg2.method_14178().method_14116(arg);
		}

		lv.method_14178().method_14156(arg);
		if (arg2 != null) {
			class_174.field_1183.method_8794(arg, arg2.field_9247.method_12460(), lv.field_9247.method_12460());
			if (arg2.field_9247.method_12460() == class_2874.field_13076
				&& arg.field_6002.field_9247.method_12460() == class_2874.field_13072
				&& arg.method_14225() != null) {
				class_174.field_1211.method_9080(arg, arg.method_14225());
			}
		}
	}
	...
	public void method_14610(class_3222 arg) {
		this.field_14351.add(arg);
		this.field_14354.put(arg.method_5667(), arg);
		this.method_14581(new class_2703(class_2703.class_2704.field_12372, arg));
		class_3218 lv = this.field_14360.method_3847(arg.field_6026);

		for (int i = 0; i < this.field_14351.size(); i++) {
			arg.field_13987.method_14364(new class_2703(class_2703.class_2704.field_12372, (class_3222)this.field_14351.get(i)));
		}

		lv.method_8649(arg);
		this.method_14612(arg, null);
		this.field_14360.method_3837().method_12975(arg);
	}

	public void method_14575(class_3222 arg) {
		arg.method_14220().method_14178().method_14143(arg);
	}
	...
	public void method_14611(class_3222 arg) {
		...
		lv.method_8463(arg);
		lv.method_14178().method_14116(arg);
	...
	public class_3222 method_14556(class_3222 arg, class_2874 arg2, boolean bl) {
		arg.method_14220().method_14180().method_14072(arg);
		arg.method_14220().method_14180().method_14068(arg);
		arg.method_14220().method_14178().method_14116(arg);
		this.field_14351.remove(arg);
		this.field_14360.method_3847(arg.field_6026).method_8507(arg);
		...
		if (lv != null) {
			class_2338 lv5 = class_1657.method_7288(this.field_14360.method_3847(arg.field_6026), lv, bl2);
			if (lv5 != null) {
				lv3.method_5808(
					(double)((float)lv5.method_10263() + 0.5F), (double)((float)lv5.method_10264() + 0.1F), (double)((float)lv5.method_10260() + 0.5F), 0.0F, 0.0F
				);
		...
		while (!lv4.method_8587(lv3, lv3.method_5829()) && lv3.field_6010 < 256.0) {
			lv3.method_5814(lv3.field_5987, lv3.field_6010 + 1.0, lv3.field_6035);
		}

		lv3.field_13987
			.method_14364(new class_2724(lv3.field_6026, lv3.field_6002.method_8407(), lv3.field_6002.method_8401().method_153(), lv3.field_13974.method_14257()));
		class_2338 lv5 = lv4.method_8395();
		lv3.field_13987.method_14363(lv3.field_5987, lv3.field_6010, lv3.field_6035, lv3.field_6031, lv3.field_5965);
		lv3.field_13987.method_14364(new class_2759(lv5));
		...
		lv4.method_14178().method_14156(lv3);
		lv4.method_8649(lv3);
	...
	public void method_14598(class_3222 arg, class_2874 arg2) {
		class_2874 lv = arg.field_6026;
		class_3218 lv2 = this.field_14360.method_3847(arg.field_6026);
		arg.field_6026 = arg2;
		class_3218 lv3 = this.field_14360.method_3847(arg.field_6026);
		arg.field_13987
			.method_14364(new class_2724(arg.field_6026, arg.field_6002.method_8407(), arg.field_6002.method_8401().method_153(), arg.field_13974.method_14257()));
		this.method_14576(arg);
		lv2.method_8507(arg);
		arg.field_5988 = false;
		this.method_14558(arg, lv, lv2, lv3);
		this.method_14612(arg, lv2);
		arg.field_13987.method_14363(arg.field_5987, arg.field_6010, arg.field_6035, arg.field_6031, arg.field_5965);
		arg.field_13974.method_14259(lv3);
		arg.field_13987.method_14364(new class_2696(arg.field_7503));
		this.method_14606(arg, lv3);
		this.method_14594(arg);

		for (class_1293 lv4 : arg.method_6026()) {
			arg.field_13987.method_14364(new class_2783(arg.method_5628(), lv4));
		}
	}

	public void method_14558(class_1297 arg, class_2874 arg2, class_3218 arg3, class_3218 arg4) {
		double d = arg.field_5987;
		double e = arg.field_6035;
		double f = 8.0;
		float g = arg.field_6031;
		arg3.method_16107().method_15396("moving");
		if (arg.field_6026 == class_2874.field_13076) {
			d = class_3532.method_15350(d / 8.0, arg4.method_8621().method_11976() + 16.0, arg4.method_8621().method_11963() - 16.0);
			e = class_3532.method_15350(e / 8.0, arg4.method_8621().method_11958() + 16.0, arg4.method_8621().method_11977() - 16.0);
			arg.method_5808(d, arg.field_6010, e, arg.field_6031, arg.field_5965);
			if (arg.method_5805()) {
				arg3.method_8553(arg, false);
			}
		} else if (arg.field_6026 == class_2874.field_13072) {
			d = class_3532.method_15350(d * 8.0, arg4.method_8621().method_11976() + 16.0, arg4.method_8621().method_11963() - 16.0);
			e = class_3532.method_15350(e * 8.0, arg4.method_8621().method_11958() + 16.0, arg4.method_8621().method_11977() - 16.0);
			arg.method_5808(d, arg.field_6010, e, arg.field_6031, arg.field_5965);
			if (arg.method_5805()) {
			...
			class_2338 lv;
			if (arg2 == class_2874.field_13078) {
				lv = arg4.method_8395();
			} else {
				lv = arg4.method_14169();
			}

			d = (double)lv.method_10263();
			arg.field_6010 = (double)lv.method_10264();
			e = (double)lv.method_10260();
			arg.method_5808(d, arg.field_6010, e, 90.0F, 0.0F);
			if (arg.method_5805()) {
				arg3.method_8553(arg, false);
			}
		}

		arg3.method_16107().method_15407();
		if (arg2 != class_2874.field_13078) {
			arg3.method_16107().method_15396("placing");
			d = (double)class_3532.method_15340((int)d, -29999872, 29999872);
			e = (double)class_3532.method_15340((int)e, -29999872, 29999872);
			if (arg.method_5805()) {
				arg.method_5808(d, arg.field_6010, e, arg.field_6031, arg.field_5965);
				arg4.method_14173().method_8655(arg, g);
				arg4.method_8649(arg);
				arg4.method_8553(arg, false);
			}

			arg3.method_16107().method_15407();
		}

		arg.method_5866(arg4);
	}
	...
	public boolean method_14569(GameProfile gameProfile) {
		return this.field_14353.method_14644(gameProfile)
			|| this.field_14360.method_3724()
				&& this.field_14360.method_3847(class_2874.field_13072).method_8401().method_194()
				&& this.field_14360.method_3811().equalsIgnoreCase(gameProfile.getName())
			|| this.field_14350;
	}
	...
	public void method_14606(class_3222 arg, class_3218 arg2) {
		...
		arg.field_13987.method_14364(new class_2761(arg2.method_8510(), arg2.method_8532(), arg2.method_8450().method_8355("doDaylightCycle")));
	...
	public String[] method_14562() {
		return this.field_14360.method_3847(class_2874.field_13072).method_8411().method_129().method_263();
	}
	...
	public class_3442 method_14583(class_1657 arg) {
		...
		if (lv == null) {
			File file = new File(this.field_14360.method_3847(class_2874.field_13072).method_8411().method_132(), "stats");
	...
	public class_2985 method_14578(class_3222 arg) {
		...
		if (lv == null) {
			File file = new File(this.field_14360.method_3847(class_2874.field_13072).method_8411().method_132(), "advancements");
			File file2 = new File(file, uUID + ".json");
	...
	public void method_14608(int i) {
		...
		for (class_3218 lv : this.field_14360.method_3738()) {
			if (lv != null) {
				...
				lv.method_14180().method_14069(i);
			}
		}
	}
