...
public class class_1540 extends class_1297 {
	...
	public class_1540(class_1299<? extends class_1540> arg, class_1937 arg2) {
		super(arg, arg2);
	}

	public class_1540(class_1937 arg, double d, double e, double f, class_2680 arg2) {
		this(class_1299.field_6089, arg);
		...
		if (this.field_7188.method_11588()) {
			...
			if (this.field_7192++ == 0) {
				...
				if (this.field_6002.method_8320(lv2).method_11614() == lv) {
					this.field_6002.method_8650(lv2, false);
			...
			if (!this.field_6002.field_9236) {
				...
				double d = this.method_18798().method_1027();
				if (bl && d > 1.0) {
					class_3965 lv3 = this.field_6002
						.method_17742(
							new class_3959(
								new class_243(this.field_6014, this.field_6036, this.field_5969),
					...
					if (lv3.method_17783() != class_239.class_240.field_1333 && this.field_6002.method_8316(lv3.method_17777()).method_15767(class_3486.field_15517)) {
						lv2 = lv3.method_17777();
						bl2 = true;
					}
				}
				...
				if (this.field_5952 || bl2) {
					...
					if (lv4.method_11614() != class_2246.field_10008) {
						...
						if (!this.field_7189) {
							if (bl2
								|| lv4.method_11587(new class_2968(this.field_6002, lv2, class_2350.field_11033, class_1799.field_8037, class_2350.field_11036))
									&& this.field_7188.method_11591(this.field_6002, lv2)) {
				...
				} else if (!this.field_6002.field_9236 && (this.field_7192 > 100 && (lv2.method_10264() < 1 || lv2.method_10264() > 256) || this.field_7192 > 600)) {
	...
	public class_2596<?> method_18002() {
		return new class_2604(this, class_2248.method_9507(this.method_6962()));
	}
}
