...
public class class_1634 extends class_1588 {
	...
	public class_1634(class_1937 arg) {
		super(class_1299.field_6059, arg);
		this.field_5977 = true;
		this.field_6207 = new class_1634.class_1637(this);
		this.method_5835(0.4F, 0.8F);
		this.field_6194 = 3;
	}
	...
	class class_1635 extends class_1352 {
		...
		public boolean method_6264() {
			if (class_1634.this.method_5968() != null && !class_1634.this.method_5962().method_6241() && class_1634.this.field_5974.nextInt(7) == 0) {
				return class_1634.this.method_5858(class_1634.this.method_5968()) > 4.0;
			} else {
				return false;
			}
		}
	...
	class class_1636 extends class_1405 {
		...
		public boolean method_6264() {
			return class_1634.this.field_7411 != null
				...
				&& this.method_6328(class_1634.this.field_7411.method_5968(), false);
		}
	...
	class class_1637 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6374 == class_1335.class_1336.field_6378) {
				double d = this.field_6370 - class_1634.this.field_5987;
				double e = this.field_6369 - class_1634.this.field_6010;
				double f = this.field_6367 - class_1634.this.field_6035;
				double g = d * d + e * e + f * f;
				g = (double)class_3532.method_15368(g);
				if (g < class_1634.this.method_5829().method_995()) {
					this.field_6374 = class_1335.class_1336.field_6377;
					class_1634.this.field_5967 *= 0.5;
					class_1634.this.field_5984 *= 0.5;
					class_1634.this.field_6006 *= 0.5;
				} else {
					class_1634.this.field_5967 += d / g * 0.05 * this.field_6372;
					class_1634.this.field_5984 += e / g * 0.05 * this.field_6372;
					class_1634.this.field_6006 += f / g * 0.05 * this.field_6372;
					if (class_1634.this.method_5968() == null) {
						class_1634.this.field_6031 = -((float)class_3532.method_15349(class_1634.this.field_5967, class_1634.this.field_6006)) * (180.0F / (float)Math.PI);
						class_1634.this.field_6283 = class_1634.this.field_6031;
					} else {
						double h = class_1634.this.method_5968().field_5987 - class_1634.this.field_5987;
						double i = class_1634.this.method_5968().field_6035 - class_1634.this.field_6035;
						class_1634.this.field_6031 = -((float)class_3532.method_15349(h, i)) * (180.0F / (float)Math.PI);
						class_1634.this.field_6283 = class_1634.this.field_6031;
					}
				}
			}
