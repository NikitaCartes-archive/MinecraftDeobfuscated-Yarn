...
public class class_1144 implements class_3000, class_3302 {
	...
	public void method_14491(class_3300 arg) {
		...
		for(class_2960 lv2 : this.field_5588.keySet()) {
			if (class_2378.field_11156.method_10223(lv2) == null) {
				field_5593.debug("Not having sound event for: {}", lv2);
			}
		}
					...
					lv4 = new class_1148<class_1111>() {
						...
						public class_1111 method_4883() {
							...
							if (lv == null) {
								...
								class_1111 lv2x = lv.method_4887();
								return new class_1111(
									lv2x.method_4767().toString(),
									lv2x.method_4771() * lv2.method_4771(),
									lv2x.method_4772() * lv2.method_4772(),
									lv2.method_4894(),
									class_1111.class_1112.field_5474,
									lv2x.method_4769() || lv2.method_4769(),
									lv2x.method_4764(),
									lv2x.method_4770()
								);
							}
