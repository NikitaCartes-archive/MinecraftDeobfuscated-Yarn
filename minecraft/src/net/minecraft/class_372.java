...
public class class_372 implements class_368 {
	...
	public class_368.class_369 method_1986(class_374 arg, long l) {
		...
		arg.method_1788(0, 0, 0, 96, 160, 32);
		...
		if (this.field_2222) {
			class_332.method_1785(3, 28, 157, 29, -1);
			...
			class_332.method_1785(3, 28, (int)(3.0F + 154.0F * f), 29, i);
			this.field_2229 = f;
			this.field_2223 = l;
		}
	...
	public static enum class_373 {
		...
		public void method_1994(class_332 arg, int i, int j) {
			...
			arg.method_1788(i, j, 176 + this.field_2232 * 20, this.field_2231 * 20, 20, 20);
			GlStateManager.enableBlend();
		}
	}
}
