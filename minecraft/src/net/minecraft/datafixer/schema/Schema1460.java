...
public class Schema1460 extends IdentifierNormalizingSchema {
	protected static final Map<String, String> field_28625 = ImmutableMap.builder()
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(
			map, "minecraft:arrow", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("inBlockState", TypeReferences.BLOCK_STATE.in(schema)))
		);
