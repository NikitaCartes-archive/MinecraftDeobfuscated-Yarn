					...
					dynamicOps -> pair -> {
							...
							while(true) {
								Either<List<NewEntityTree>, Unit> either = DataFixUtils.orElse(
									optional.map(
										pairx -> {
											Typed<NewEntityTree> typed = (Typed)outputEntityTreeType.pointTyped(dynamicOps)
								...
								pair2 = (Pair)new Typed<>(inputEntityTreeType, dynamicOps, (OldEntityTree)optional2.get())
