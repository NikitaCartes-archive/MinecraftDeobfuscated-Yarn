		...
		return !bl
			...
			: data.update(
				...
				dynamic -> {
					...
					boolean blxx = hasObsoleteValue(string) || hasObsoleteValue(string2);
					...
					String string7 = !hasObsoleteValue(string3) && !blxx ? "side" : string3;
					String string8 = !hasObsoleteValue(string4) && !blxx ? "side" : string4;
