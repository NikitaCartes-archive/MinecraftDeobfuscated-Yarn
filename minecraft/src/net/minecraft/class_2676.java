...
public class class_2676 implements class_2596<class_2602> {
	...
	public class_2676(class_1923 arg, class_3568 arg2) {
		...
		for(int i = 0; i < 18; ++i) {
			class_2804 lv = arg2.method_15562(class_1944.field_9284).method_15544(this.field_12265, -1 + i, this.field_12264);
			class_2804 lv2 = arg2.method_15562(class_1944.field_9282).method_15544(this.field_12265, -1 + i, this.field_12264);
			if (lv != null) {
				if (lv.method_12146()) {
	...
	public class_2676(class_1923 arg, class_3568 arg2, int i, int j) {
		...
		for(int k = 0; k < 18; ++k) {
			if ((this.field_12263 & 1 << k) != 0) {
				class_2804 lv = arg2.method_15562(class_1944.field_9284).method_15544(this.field_12265, -1 + k, this.field_12264);
			...
			if ((this.field_12262 & 1 << k) != 0) {
				class_2804 lv = arg2.method_15562(class_1944.field_9282).method_15544(this.field_12265, -1 + k, this.field_12264);
				if (lv != null && !lv.method_12146()) {
