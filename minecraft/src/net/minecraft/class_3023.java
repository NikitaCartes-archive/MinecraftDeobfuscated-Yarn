...
public class class_3023 {
	...
	private static int method_13090(
		class_2168 arg, class_2338 arg2, class_2338 arg3, class_2338 arg4, Predicate<class_2694> predicate, class_3023.class_3025 arg5
		...
		if (!arg5.method_13109() && lv3.method_14657(lv)) {
			...
			if (i > 32768) {
				...
				if (lv4.method_8617(arg2, arg3) && lv4.method_8617(arg4, lv2)) {
							...
							for(int l = lv.field_14381; l <= lv.field_14378; ++l) {
								...
								if (predicate.test(lv8)) {
									...
									if (lv10 != null) {
										...
										deque.addLast(lv6);
									} else if (!lv9.method_11598(lv4, lv6) && !lv9.method_11604(lv4, lv6)) {
					...
					for(class_3023.class_3024 lv16 : list2) {
						class_2586 lv17 = lv4.method_8321(lv16.field_13496);
						if (lv16.field_13494 != null && lv17 != null) {
							lv16.field_13494.method_10569("x", lv16.field_13496.method_10263());
							lv16.field_13494.method_10569("y", lv16.field_13496.method_10264());
							lv16.field_13494.method_10569("z", lv16.field_13496.method_10260());
							lv17.method_11014(lv16.field_13494);
							lv17.method_5431();
						}

						lv4.method_8652(lv16.field_13496, lv16.field_13495, 2);
					}

					for(class_3023.class_3024 lv16 : list5) {
						lv4.method_8408(lv16.field_13496, lv16.field_13495.method_11614());
					}
					...
					if (l == 0) {
						...
						arg.method_9226(new class_2588("commands.clone.success", l), true);
						return l;
					}
				} else {
