...
public class class_1701 extends class_1688 {
	...
	public class_1701(class_1299<? extends class_1701> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public void method_5773() {
		...
		if (this.field_7751 > 0) {
			...
			this.method_7576(method_17996(this.method_18798()));
		}
	...
	public boolean method_5643(class_1282 arg, float f) {
		...
		if (lv instanceof class_1665) {
			...
			if (lv2.method_5809()) {
				this.method_7576(lv2.method_18798().method_1027());
			}
		}
	...
	protected void method_7576(double d) {
		if (!this.field_6002.field_9236) {
			...
			this.field_6002
				.method_8437(
					this, this.field_5987, this.field_6010, this.field_6035, (float)(4.0 + this.field_5974.nextDouble() * 1.5 * e), class_1927.class_4179.field_18686
				);
			this.method_5650();
		}
	}
