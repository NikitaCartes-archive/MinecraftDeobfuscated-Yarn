	...
	public class_9 method_21() {
		...
		if (this.method_22() && this.field_33.method_5799()) {
			...
			class_2338.class_2339 lv = new class_2338.class_2339(
				class_3532.method_15357(this.field_33.field_5987), i, class_3532.method_15357(this.field_33.field_6035)
			);
		...
		if (e - d > 1.125) {
			...
			if (lv3 == class_7.field_12) {
				...
				if (lv == null && l > 0 && lv3 != class_7.field_10 && lv3 != class_7.field_19) {
					...
					if (lv != null && (lv.field_41 == class_7.field_7 || lv.field_41 == class_7.field_12) && this.field_33.method_17681() < 1.0F) {
						...
						class_238 lv4 = new class_238(
							h - g, (double)j + 0.001, m - g, h + g, (double)this.field_33.method_17682() + method_60(this.field_26, lv2.method_10084()) - 0.002, m + g
						);
						if (!this.field_33.field_6002.method_8587(this.field_33, lv4)) {
							lv = null;
						}
					}
				}
				...
				if (lv3 == class_7.field_7) {
					...
					if (!this.field_33.field_6002.method_8587(this.field_33, lv5)) {
						return null;
					}
