...
public class class_14 extends class_8 {
	...
	public int method_18(class_9[] args, class_9 arg) {
		...
		if (lv2 != null && !lv2.field_42 && lv2.field_43 >= 0.0F) {
			args[i++] = lv2;
		}

		class_9 lv3 = this.method_62(arg.field_40 - 1, arg.field_39, arg.field_38, j, d, class_2350.field_11039);
		if (lv3 != null && !lv3.field_42 && lv3.field_43 >= 0.0F) {
			args[i++] = lv3;
		}

		class_9 lv4 = this.method_62(arg.field_40 + 1, arg.field_39, arg.field_38, j, d, class_2350.field_11034);
		if (lv4 != null && !lv4.field_42 && lv4.field_43 >= 0.0F) {
			args[i++] = lv4;
		}

		class_9 lv5 = this.method_62(arg.field_40, arg.field_39, arg.field_38 - 1, j, d, class_2350.field_11043);
		if (lv5 != null && !lv5.field_42 && lv5.field_43 >= 0.0F) {
			args[i++] = lv5;
		}

		class_9 lv6 = this.method_62(arg.field_40 - 1, arg.field_39, arg.field_38 - 1, j, d, class_2350.field_11043);
		if (this.method_20536(arg, lv3, lv5, lv6)) {
			args[i++] = lv6;
		}

		class_9 lv7 = this.method_62(arg.field_40 + 1, arg.field_39, arg.field_38 - 1, j, d, class_2350.field_11043);
		if (this.method_20536(arg, lv4, lv5, lv7)) {
			args[i++] = lv7;
		}

		class_9 lv8 = this.method_62(arg.field_40 - 1, arg.field_39, arg.field_38 + 1, j, d, class_2350.field_11035);
		if (this.method_20536(arg, lv3, lv2, lv8)) {
			args[i++] = lv8;
		}

		class_9 lv9 = this.method_62(arg.field_40 + 1, arg.field_39, arg.field_38 + 1, j, d, class_2350.field_11035);
		if (this.method_20536(arg, lv4, lv2, lv9)) {
			args[i++] = lv9;
		}
	...
	private boolean method_20536(class_9 arg, @Nullable class_9 arg2, @Nullable class_9 arg3, @Nullable class_9 arg4) {
		return arg4 != null
			&& !arg4.field_42
			&& arg3 != null
			&& arg3.field_43 >= 0.0F
			&& arg3.field_39 <= arg.field_39
			&& arg2 != null
			&& arg2.field_43 >= 0.0F
			&& arg2.field_39 <= arg.field_39;
	}
	...
	private class_9 method_62(int i, int j, int k, int l, double d, class_2350 arg) {
		...
		if (e - d > 1.125) {
			...
			if (lv3 == class_7.field_12) {
				...
				if ((lv == null || lv.field_43 < 0.0F) && l > 0 && lv3 != class_7.field_10 && lv3 != class_7.field_19) {
					lv = this.method_62(i, j + 1, k, l - 1, d, arg);
					if (lv != null && (lv.field_41 == class_7.field_7 || lv.field_41 == class_7.field_12) && this.field_33.method_17681() < 1.0F) {
						double h = (double)(i - arg.method_10148()) + 0.5;
						double m = (double)(k - arg.method_10165()) + 0.5;
						class_238 lv4 = new class_238(
							h - g,
							method_60(this.field_26, new class_2338(h, (double)(j + 1), m)) + 0.001,
							m - g,
							h + g,
							(double)this.field_33.method_17682() + method_60(this.field_26, new class_2338(lv.field_40, lv.field_39, lv.field_38)) - 0.002,
							m + g
						);
						if (!this.field_26.method_8587(this.field_33, lv4)) {
							lv = null;
						}
					}
				}
				...
				if (lv3 == class_7.field_7) {
					class_238 lv5 = new class_238(
						(double)i - g + 0.5, (double)j + 0.001, (double)k - g + 0.5, (double)i + g + 0.5, (double)((float)j + this.field_33.method_17682()), (double)k + g + 0.5
					);
					if (!this.field_26.method_8587(this.field_33, lv5)) {
						return null;
					}
					...
					while(lv3 == class_7.field_7) {
						if (--j < 0) {
							class_9 lv7 = this.method_13(i, o, k);
							lv7.field_41 = class_7.field_22;
							lv7.field_43 = -1.0F;
							return lv7;
						}

						class_9 lv7 = this.method_13(i, j, k);
						...
						if (lv3 != class_7.field_7 && f >= 0.0F) {
							lv = lv7;
							lv7.field_41 = lv3;
							lv7.field_43 = Math.max(lv7.field_43, f);
							break;
						}
	...
	public class_7 method_17(class_1922 arg, int i, int j, int k, class_1308 arg2, int l, int m, int n, boolean bl, boolean bl2) {
		...
		double d = (double)arg2.method_17681() / 2.0;
	...
	protected class_7 method_58(class_1922 arg, int i, int j, int k) {
		...
		if (lv2.method_11588()) {
		...
		} else if (lv3 instanceof class_2323 && lv4 == class_3614.field_15932 && !lv2.method_11654(class_2323.field_10945)) {
			return class_7.field_23;
		} else if (lv3 instanceof class_2323 && lv4 == class_3614.field_15953 && !lv2.method_11654(class_2323.field_10945)) {
			return class_7.field_8;
		} else if (lv3 instanceof class_2323 && lv2.method_11654(class_2323.field_10945)) {
			...
			&& (!(lv3 instanceof class_2349) || lv2.method_11654(class_2349.field_11026))) {
