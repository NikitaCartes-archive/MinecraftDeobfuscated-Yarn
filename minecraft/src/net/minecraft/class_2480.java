...
public class class_2480 extends class_2237 {
	...
	public void method_9576(class_1937 arg, class_2338 arg2, class_2680 arg3, class_1657 arg4) {
		...
		if (lv instanceof class_2627) {
			...
			if (!arg.field_9236 && arg4.method_7337() && !lv2.method_5442()) {
				class_1799 lv3 = method_10529(this.method_10528());
				class_2487 lv4 = lv2.method_11317(new class_2487());
				if (!lv4.isEmpty()) {
					lv3.method_7959("BlockEntityTag", lv4);
				}

				if (lv2.method_16914()) {
					lv3.method_7977(lv2.method_5797());
				}

				class_1542 lv5 = new class_1542(arg, (double)arg2.method_10263(), (double)arg2.method_10264(), (double)arg2.method_10260(), lv3);
				lv5.method_6988();
				arg.method_8649(lv5);
			} else {
				lv2.method_11289(arg4);
			}
		}
	...
	public static class_2248 method_10525(@Nullable class_1767 arg) {
		if (arg == null) {
	...
	public static class_1799 method_10529(@Nullable class_1767 arg) {
