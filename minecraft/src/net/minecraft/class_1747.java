...
public class class_1747 extends class_1792 {
	...
	public class_1269 method_7884(class_1838 arg) {
		class_1269 lv = this.method_7712(new class_1750(arg));
		return lv != class_1269.field_5812 && this.method_19263() ? this.method_7836(arg.field_8945, arg.field_8942, arg.field_19176).method_5467() : lv;
	}
			...
			if (lv == null) {
				...
				if (lv2 == null) {
					...
					if (lv8 == lv2.method_11614()) {
						lv7 = this.method_18084(lv3, lv4, lv6, lv7);
					...
					lv4.method_8396(lv5, lv3, this.method_19260(lv7), class_3419.field_15245, (lv9.method_10597() + 1.0F) / 2.0F, lv9.method_10599() * 0.8F);
					lv6.method_7934(1);
	...
	protected class_3414 method_19260(class_2680 arg) {
		return arg.method_11638().method_10598();
	}
	...
	private class_2680 method_18084(class_2338 arg, class_1937 arg2, class_1799 arg3, class_2680 arg4) {
		class_2680 lv = arg4;
		class_2487 lv2 = arg3.method_7969();
		if (lv2 != null) {
			class_2487 lv3 = lv2.method_10562("BlockStateTag");
			class_2689<class_2248, class_2680> lv4 = arg4.method_11614().method_9595();

			for (String string : lv3.method_10541()) {
				class_2769<?> lv5 = lv4.method_11663(string);
				if (lv5 != null) {
					String string2 = lv3.method_10580(string).method_10714();
					lv = method_18083(lv, lv5, string2);
				}
			}
		}

		if (lv != arg4) {
			arg2.method_8652(arg, lv, 2);
		}

		return lv;
	}

	private static <T extends Comparable<T>> class_2680 method_18083(class_2680 arg, class_2769<T> arg2, String string) {
		return (class_2680)arg2.method_11900(string).map(comparable -> arg.method_11657(arg2, comparable)).orElse(arg);
	}

	protected boolean method_7709(class_1750 arg, class_2680 arg2) {
		class_1657 lv = arg.method_8036();
		class_3726 lv2 = lv == null ? class_3726.method_16194() : class_3726.method_16195(lv);
		return (!this.method_20360() || arg2.method_11591(arg.method_8045(), arg.method_8037())) && arg.method_8045().method_8628(arg2, arg.method_8037(), lv2);
	}
