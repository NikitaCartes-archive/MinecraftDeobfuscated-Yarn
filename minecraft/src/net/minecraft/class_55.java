...
public class class_55 {
	...
	public static class class_57 implements JsonDeserializer<class_55>, JsonSerializer<class_55> {
		public class_55 method_358(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
			...
			class_79[] lvs = (class_79[])class_3518.method_15272(jsonObject, "entries", jsonDeserializationContext, class_79[].class);
			class_209[] lvs2 = (class_209[])class_3518.method_15283(jsonObject, "conditions", new class_209[0], jsonDeserializationContext, class_209[].class);
			class_117[] lvs3 = (class_117[])class_3518.method_15283(jsonObject, "functions", new class_117[0], jsonDeserializationContext, class_117[].class);
