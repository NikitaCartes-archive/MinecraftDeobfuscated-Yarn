...
public class class_22 extends class_18 {
	...
	public final Map<String, class_20> field_117 = Maps.newLinkedHashMap();
	...
	public void method_77(class_2487 arg) {
		int i = arg.method_10550("dimension");
		class_2874 lv = class_2874.method_12490(i);
		if (lv == null) {
			...
			class_2499 lv2 = arg.method_10554("banners", 10);

			for(int j = 0; j < lv2.size(); ++j) {
				class_17 lv3 = class_17.method_67(lv2.method_10602(j));
				this.field_123.put(lv3.method_71(), lv3);
				this.method_107(
					lv3.method_72(), null, lv3.method_71(), (double)lv3.method_70().method_10263(), (double)lv3.method_70().method_10260(), 180.0, lv3.method_68()
				);
			}

			class_2499 lv4 = arg.method_10554("frames", 10);

			for(int k = 0; k < lv4.size(); ++k) {
				class_19 lv5 = class_19.method_87(lv4.method_10602(k));
				this.field_121.put(lv5.method_82(), lv5);
				this.method_107(
					class_20.class_21.field_95,
					null,
					"frame-" + lv5.method_85(),
					(double)lv5.method_86().method_10263(),
					(double)lv5.method_86().method_10260(),
					(double)lv5.method_83(),
					null
				);
			}
		}
	...
	public void method_18818(class_22 arg) {
		this.field_17403 = true;
		this.field_116 = arg.field_116;
		this.field_115 = arg.field_115;
		this.field_123.putAll(arg.field_123);
		this.field_117.putAll(arg.field_117);
		System.arraycopy(arg.field_122, 0, this.field_122, 0, arg.field_122.length);
		this.method_80();
	}
	...
	public void method_102(class_1657 arg, class_1799 arg2) {
		...
		if (arg2.method_7961() && this.field_114) {
			...
			class_19 lv6 = new class_19(lv4, lv3.method_5735().method_10161() * 90, lv3.method_5628());
			this.method_107(
				class_20.class_21.field_95,
				arg.field_6002,
				...
				(double)(lv3.method_5735().method_10161() * 90),
				null
			);
