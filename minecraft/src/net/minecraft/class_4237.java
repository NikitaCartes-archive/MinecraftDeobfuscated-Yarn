...
public class class_4237 {
		...
		return (CompletableFuture<class_4231>)this.field_18944.computeIfAbsent(arg, argx -> CompletableFuture.supplyAsync(() -> {
				try {
					...
					try {
						...
						try {
							inputStream = lv.method_14482();
							Throwable var6 = null;

							try {
								class_4234 lv2;
								try {
									lv2 = (class_4234)(bl ? new class_4280(new class_4228(inputStream)) : new class_4228(inputStream));
									Throwable var8 = null;
	...
	public CompletableFuture<?> method_19741(Collection<class_1111> collection) {
		return CompletableFuture.allOf(
			(CompletableFuture[])collection.stream().map(arg -> this.method_19743(arg.method_4766(), true)).toArray(i -> new CompletableFuture[i])
		);
	}
}
