...
public class class_3862 extends class_1874 {
	...
	public boolean method_8115(class_1263 arg, class_1937 arg2) {
		return arg instanceof class_3723 && this.field_9061.method_8093(arg.method_5438(0));
	}
	...
	public static class class_3863 implements class_1862<class_3862> {
		public class_3862 method_16950(class_2960 arg, JsonObject jsonObject) {
			...
			if (lv2 != null) {
				...
				return new class_3862(arg, string, lv, lv3, f, i);
			} else {
				throw new IllegalStateException(string2 + " did not exist");
			}
		}

		public class_3862 method_16951(class_2960 arg, class_2540 arg2) {
			...
			return new class_3862(arg, string, lv, lv2, f, i);
		}

		public void method_16949(class_2540 arg, class_3862 arg2) {
