...
public class class_2543 extends ByteToMessageDecoder {
	...
	protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
		if (byteBuf.readableBytes() != 0) {
			...
			class_2596<?> lv2 = ((class_2539)channelHandlerContext.channel().attr(class_2535.field_11648).get()).method_10783(this.field_11714, i);
			if (lv2 == null) {
				...
				if (lv.readableBytes() > 0) {
					throw new IOException(
						"Packet "
							+ ((class_2539)channelHandlerContext.channel().attr(class_2535.field_11648).get()).method_10785()
							+ "/"
							+ i
							+ " ("
