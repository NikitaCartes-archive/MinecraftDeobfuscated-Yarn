...
public class class_1949<T> implements class_1951<T> {
	...
	public void method_8670() {
		...
		if (i != this.field_9296.size()) {
			...
			for(int j = 0; j < i; ++j) {
				class_1954<T> lv = (class_1954)this.field_9295.first();
			...
			while(iterator.hasNext()) {
				class_1954<T> lv = (class_1954)iterator.next();
				iterator.remove();
				int k = 0;
				if (this.field_9301.method_8617(lv.field_9322.method_10069(0, 0, 0), lv.field_9322.method_10069(0, 0, 0))) {
					try {
						this.field_9300.accept(lv);
					} catch (Throwable var8) {
						class_128 lv2 = class_128.method_560(var8, "Exception while ticking");
	...
	public void method_8675(class_2338 arg, T object, int i, class_1953 arg2) {
		if (!this.field_9297.test(object)) {
			if (this.field_9301.method_8591(arg)) {
