	...
	public void method_8670() {
		...
		if (i != this.field_9296.size()) {
			...
			while(i > 0 && iterator.hasNext()) {
				class_1954<T> lv2 = (class_1954)iterator.next();
			...
			class_1954<T> lv2;
			while((lv2 = (class_1954)this.field_9299.poll()) != null) {
				if (lv.method_20529(lv2.field_9322)) {
					try {
						this.field_19338.add(lv2);
						this.field_9300.accept(lv2);
					} catch (Throwable var8) {
						class_128 lv3 = class_128.method_560(var8, "Exception while ticking");
						class_129 lv4 = lv3.method_562("Block being ticked");
						class_129.method_586(lv4, lv2.field_9322, null);
						throw new class_148(lv3);
					}
				} else {
					this.method_8676(lv2.field_9322, lv2.method_8683(), 0);
				}
			}
