...
public abstract class class_1367 extends class_1352 {
	protected final class_1314 field_6516;
	...
	public void method_6268() {
		if (!this.field_6512.method_10084().method_19769(this.field_6516.method_19538(), this.method_6291())) {
			...
			for (int l = 0; l < i; l++) {
				for (int m = 0; m <= l; m = m > 0 ? -m : 1 - m) {
					for (int n = m < l && m > -l ? l : 0; n <= l; n = n > 0 ? -n : 1 - n) {
						...
						if (this.field_6516.method_18407(lv2) && this.method_6296(this.field_6516.field_6002, lv2)) {
							this.field_6512 = lv2;
							return true;
						}
					}
