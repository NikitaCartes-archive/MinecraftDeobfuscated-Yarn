...
public class class_1328 implements class_1324 {
	...
	private final Map<String, Set<class_1322>> field_6345 = Maps.newHashMap();
	private final Map<UUID, class_1322> field_6343 = Maps.newHashMap();
	...
	public void method_6197(class_1322 arg) {
		if (this.method_6199(arg.method_6189()) != null) {
			...
			Set<class_1322> set = (Set)this.field_6345.computeIfAbsent(arg.method_6185(), string -> Sets.newHashSet());
	...
	public void method_6202(class_1322 arg) {
		...
		Set<class_1322> set = (Set)this.field_6345.get(arg.method_6185());
		if (set != null) {
			set.remove(arg);
			if (set.isEmpty()) {
