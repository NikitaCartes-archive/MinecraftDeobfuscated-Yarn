...
public class class_2203 implements ArgumentType<class_2203.class_2209> {
	...
	static class class_2204 implements class_2203.class_2210 {
		...
		public int method_9376(class_2520 arg, Supplier<class_2520> supplier) {
			if (!(arg instanceof class_2483)) {
				...
				int i = lv.size();
				if (i == 0) {
					lv.method_10533(0, (class_2520)supplier.get());
					return 1;
				} else {
					class_2520 lv2 = (class_2520)supplier.get();
					...
					if (j == 0) {
						...
						if (!lv.method_10533(0, lv2)) {
							...
							for (int k = 1; k < i; k++) {
								lv.method_10533(k, (class_2520)supplier.get());
							}
	...
	static class class_2205 implements class_2203.class_2210 {
		...
		public int method_9376(class_2520 arg, Supplier<class_2520> supplier) {
			if (arg instanceof class_2487) {
				class_2487 lv = (class_2487)arg;
				class_2520 lv2 = (class_2520)supplier.get();
				class_2520 lv3 = lv.method_10566(this.field_9902, lv2);
				if (!lv2.equals(lv3)) {
					return 1;
				}
			}
	...
	static class class_2206 implements class_2203.class_2210 {
		...
		public int method_9376(class_2520 arg, Supplier<class_2520> supplier) {
			if (arg instanceof class_2483) {
				...
				int j = this.field_9903 < 0 ? i + this.field_9903 : this.field_9903;
				if (0 <= j && j < i) {
					class_2520 lv2 = (class_2520)lv.get(j);
					class_2520 lv3 = (class_2520)supplier.get();
					if (!lv3.equals(lv2) && lv.method_10535(j, lv3)) {
						return 1;
					}
				}
			}
	...
	static class class_2207 implements class_2203.class_2210 {
		...
		private int method_9364(class_2520 arg, class_2203.class_3967 arg2) {
			int i = 0;
			if (arg instanceof class_2499) {
				class_2499 lv = (class_2499)arg;

				for (int j = lv.size() - 1; j >= 0; j--) {
					class_2520 lv2 = lv.method_10534(j);
					if (this.field_9905.test(lv2) && arg2.apply(lv, j, lv2)) {
						i++;
					}
				}
			}
		...
		@Override
		public int method_9376(class_2520 arg, Supplier<class_2520> supplier) {
			return this.method_9364(arg, (argx, i, arg2) -> {
				class_2520 lv = (class_2520)supplier.get();
				return !lv.equals(arg2) && argx.method_10535(i, lv);
			});
		}
		...
		public int method_9376(class_2520 arg, Supplier<class_2520> supplier) {
			if (arg instanceof class_2487) {
				...
				if (this.field_9908.test(lv2)) {
					class_2520 lv3 = (class_2520)supplier.get();
					if (!lv3.equals(lv2)) {
						lv.method_10566(this.field_9906, lv3);
						return 1;
					}
				}
			}
	...
	public static class class_2209 {
		...
		public int method_9368(class_2520 arg, Supplier<class_2520> supplier) throws CommandSyntaxException {
			List<class_2520> list = this.method_9369(arg);
			class_2203.class_2210 lv = this.field_9911[this.field_9911.length - 1];
			return method_9371(list, arg2 -> lv.method_9376(arg2, supplier));
		}
	...
	interface class_3967 {
		boolean apply(class_2499 arg, int i, class_2520 arg2);
	}
}
