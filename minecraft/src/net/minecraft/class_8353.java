...
public class class_8353 extends class_8285<SoundEvent> {
	...
	public SoundEvent method_50434(SoundEvent soundEvent) {
		return (SoundEvent)this.field_43935.computeIfAbsent(soundEvent, soundEvent2 -> {
			RegistryKey<SoundEvent> registryKey = (RegistryKey)Registries.SOUND_EVENT.getKey(soundEvent2).orElse(null);
			if (registryKey != null) {
				RegistryKey<SoundEvent> registryKey2 = (RegistryKey)this.field_43489.get(registryKey);
