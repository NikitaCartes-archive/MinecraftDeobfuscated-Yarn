...
public class class_6954 {
	...
	private static final RegistryKey<NoiseType> CAVES_SPAGHETTI_2D_THICKNESS_MODULATOR_OVERWORLD = method_41109(
	...
	private static NoiseType method_41117() {
		...
		NoiseType noiseType8 = class_6916.method_40486(
			class_6916.method_40486(noiseType7, class_6916.method_40480(0.37)), class_6916.method_40481(-10, 30, 0.3, 0.0)
		);
	...
	public static NoiseRouter method_40544(
		...
		NoiseType.class_6915 lv = noiseType -> {
			if (noiseType instanceof class_6916.class_6931 lvxx) {
				RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> registryEntry = lvxx.noiseData();
				return new class_6916.class_6931(registryEntry, method_41107(randomDeriver, registry, registryEntry), lvxx.xzScale(), lvxx.yScale());
			} else if (noiseType instanceof class_6916.class_6939 lv2xx) {
				RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> registryEntry2 = lv2xx.noiseData();
				...
				return lv2xx.method_41086(doublePerlinNoiseSampler);
			} else if (noiseType instanceof class_6916.class_6940 lv3xx) {
				if (bl) {
					RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> registryEntry = lv3xx.noiseData();
					if (Objects.equals(registryEntry.getKey(), Optional.of(NoiseParametersKeys.TEMPERATURE))) {
						...
						return new class_6916.class_6940(
							lv3xx.shiftX(), lv3xx.shiftY(), lv3xx.shiftZ(), lv3xx.xzScale(), lv3xx.yScale(), registryEntry, doublePerlinNoiseSampler2
						);
					}
				...
				RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> registryEntry = lv3xx.noiseData();
				return new class_6916.class_6940(
					lv3xx.shiftX(), lv3xx.shiftY(), lv3xx.shiftZ(), lv3xx.xzScale(), lv3xx.yScale(), registryEntry, method_41107(randomDeriver, registry, registryEntry)
				);
