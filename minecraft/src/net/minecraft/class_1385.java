...
public class class_1385 extends class_1352 {
	...
	public boolean method_6264() {
		if (this.field_6596.field_6002.method_8530()) {
			...
			if (lv2 == null) {
				...
				if (this.field_6595 == null) {
					return false;
				} else {
					return (double)this.field_6595.method_6417(lv) < 2.25;
				}
			}
		}
	}
	...
	public boolean method_6266() {
		if (this.field_6596.field_6002.method_8530()) {
			...
			return !this.field_6595.method_6413() && this.field_6595.method_6425(new class_2338(this.field_6596));
		}
	}
