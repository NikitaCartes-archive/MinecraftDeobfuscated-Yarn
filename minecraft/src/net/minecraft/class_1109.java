...
public class class_1109 extends class_1102 {
	...
	public static class_1109 method_4757(class_3414 arg, float f, float g) {
		return new class_1109(arg.method_14833(), class_3419.field_15250, g, f, false, 0, class_1113.class_1114.field_5478, 0.0F, 0.0F, 0.0F, true);
	}

	public static class_1109 method_4759(class_3414 arg) {
		return new class_1109(arg.method_14833(), class_3419.field_15253, 1.0F, 1.0F, false, 0, class_1113.class_1114.field_5478, 0.0F, 0.0F, 0.0F, true);
	}
	...
	private class_1109(class_3414 arg, class_3419 arg2, float f, float g, boolean bl, int i, class_1113.class_1114 arg3, float h, float j, float k) {
		this(arg.method_14833(), arg2, f, g, bl, i, arg3, h, j, k, false);
	}

	public class_1109(class_2960 arg, class_3419 arg2, float f, float g, boolean bl, int i, class_1113.class_1114 arg3, float h, float j, float k, boolean bl2) {
		super(arg, arg2);
		this.field_5442 = f;
		this.field_5441 = g;
		this.field_5439 = h;
