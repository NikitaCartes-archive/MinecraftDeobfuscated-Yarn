...
public class class_2346 extends class_2248 {
	...
	private void method_10131(class_1937 arg, class_2338 arg2) {
		if (method_10128(arg.method_8320(arg2.method_10074())) && arg2.method_10264() >= 0) {
			int i = 32;
			if (!arg.method_8617(arg2.method_10069(-32, -32, -32), arg2.method_10069(32, 32, 32))) {
				...
				while (method_10128(arg.method_8320(lv)) && lv.method_10264() > 0) {
					lv = lv.method_10074();
				}

				if (lv.method_10264() > 0) {
					arg.method_8501(lv.method_10084(), this.method_9564());
				}
			} else if (!arg.field_9236) {
