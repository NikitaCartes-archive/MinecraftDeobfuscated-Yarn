...
public abstract class class_1422 extends class_1480 implements class_1298 {
	private static final class_2940<Boolean> field_6730 = class_2945.method_12791(class_1422.class, class_2943.field_13323);

	public class_1422(class_1299<?> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		...
		return arg.method_8320(lv).method_11614() == class_2246.field_10382 && arg.method_8320(lv.method_10084()).method_11614() == class_2246.field_10382
	...
	protected void method_5959() {
		...
		this.field_6201.method_6277(2, new class_1338(this, class_1657.class, 8.0F, 1.6, 1.4, class_1301.field_6155));
	...
	public void method_6007() {
		if (!this.method_5799() && this.field_5952 && this.field_5992) {
			...
			this.field_5967 = this.field_5967 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.05F);
			this.field_6006 = this.field_6006 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.05F);
	...
	static class class_1423 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6731.method_5777(class_3486.field_15517)) {
				this.field_6731.field_5984 += 0.005;
			}
			...
			if (this.field_6374 == class_1335.class_1336.field_6378 && !this.field_6731.method_5942().method_6357()) {
				...
				this.field_6731.field_5984 = this.field_6731.field_5984 + (double)this.field_6731.method_6029() * e * 0.1;
			} else {
