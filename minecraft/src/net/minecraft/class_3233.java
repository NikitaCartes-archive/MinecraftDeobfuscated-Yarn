...
public class class_3233 implements class_1936 {
	...
	private final class_1937 field_14093;
	...
	public class_3233(class_1937 arg, List<class_2791> list) {
		...
		if (i * i != list.size()) {
			...
			this.field_14095 = arg.method_8398().method_12129().method_12109();
	...
	public class_2791 method_8402(int i, int j, class_2806 arg, boolean bl) {
		...
		if (!bl) {
			...
			field_14092.error(
				"Region bounds : {} {} | {} {}",
				lv3.method_12004().field_9181,
				lv3.method_12004().field_9180,
				lv4.method_12004().field_9181,
				lv4.method_12004().field_9180
			);
			if (lv2 != null) {
	...
	public class_37 method_8646() {
		return this.field_14093.method_8646();
	}
	...
	public class_30 method_8411() {
		return this.field_14093.method_8411();
	}
