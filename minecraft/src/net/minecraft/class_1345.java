...
public class class_1345 extends class_1352 {
	...
	public boolean method_6264() {
		if (this.field_6424.method_6051().nextInt(this.field_6424.method_6109() ? 50 : 1000) != 0) {
			...
			class_2338 lv = new class_2338(this.field_6424);
			if (field_6423.test(this.field_6421.method_8320(lv))) {
				return true;
			} else {
				return this.field_6421.method_8320(lv.method_10074()).method_11614() == class_2246.field_10219;
			}
		}
	}
		...
		if (this.field_6422 == 4) {
			...
			if (field_6423.test(this.field_6421.method_8320(lv))) {
				...
				if (this.field_6421.method_8320(lv2).method_11614() == class_2246.field_10219) {
					if (this.field_6421.method_8450().method_8355(class_1928.field_19388)) {
						this.field_6421.method_20290(2001, lv2, class_2248.method_9507(class_2246.field_10219.method_9564()));
