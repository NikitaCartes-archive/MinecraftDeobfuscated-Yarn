...
public abstract class class_2944<T extends class_3037> extends class_3031<T> {
	...
	protected final void method_12773(Set<class_2338> set, class_1945 arg, class_2338 arg2, class_2680 arg3, class_3341 arg4) {
		this.method_12774(arg, arg2, arg3);
		arg4.method_14668(new class_3341(arg2, arg2));
	...
	public final boolean method_13151(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, T arg4) {
		...
		boolean bl = this.method_12775(set, arg, random, arg3, lv);
		if (lv.field_14381 > lv.field_14378) {
			return false;
		} else {
			List<Set<class_2338>> list = Lists.newArrayList();
			int i = 6;
			...
			class_251 lv2 = new class_244(lv.method_14660(), lv.method_14663(), lv.method_14664());

			try (class_2338.class_2340 lv3 = class_2338.class_2340.method_10109()) {
				if (bl && !set.isEmpty()) {
					for(class_2338 lv4 : Lists.newArrayList(set)) {
						if (lv.method_14662(lv4)) {
							lv2.method_1049(lv4.method_10263() - lv.field_14381, lv4.method_10264() - lv.field_14380, lv4.method_10260() - lv.field_14379, true, true);
						}

						for(class_2350 lv5 : class_2350.values()) {
							lv3.method_10114(lv4).method_10118(lv5);
							if (!set.contains(lv3)) {
								class_2680 lv6 = arg.method_8320(lv3);
								if (lv6.method_11570(class_2741.field_12541)) {
									((Set)list.get(0)).add(lv3.method_10062());
									this.method_12774(arg, lv3, lv6.method_11657(class_2741.field_12541, Integer.valueOf(1)));
									if (lv.method_14662(lv3)) {
										lv2.method_1049(lv3.method_10263() - lv.field_14381, lv3.method_10264() - lv.field_14380, lv3.method_10260() - lv.field_14379, true, true);
									}
								}
							}
						}
				...
				for(int k = 1; k < 6; ++k) {
					Set<class_2338> set2 = (Set)list.get(k - 1);
					Set<class_2338> set3 = (Set)list.get(k);

					for(class_2338 lv7 : set2) {
						if (lv.method_14662(lv7)) {
							lv2.method_1049(lv7.method_10263() - lv.field_14381, lv7.method_10264() - lv.field_14380, lv7.method_10260() - lv.field_14379, true, true);
						}

						for(class_2350 lv8 : class_2350.values()) {
							lv3.method_10114(lv7).method_10118(lv8);
							if (!set2.contains(lv3) && !set3.contains(lv3)) {
								class_2680 lv9 = arg.method_8320(lv3);
								if (lv9.method_11570(class_2741.field_12541)) {
									int l = lv9.method_11654(class_2741.field_12541);
									if (l > k + 1) {
										class_2680 lv10 = lv9.method_11657(class_2741.field_12541, Integer.valueOf(k + 1));
										this.method_12774(arg, lv3, lv10);
										if (lv.method_14662(lv3)) {
											lv2.method_1049(lv3.method_10263() - lv.field_14381, lv3.method_10264() - lv.field_14380, lv3.method_10260() - lv.field_14379, true, true);
										}

										set3.add(lv3.method_10062());
									}
								}
							}
						}
			...
			class_3499.method_20532(arg, 3, lv2, lv.field_14381, lv.field_14380, lv.field_14379);
			return bl;
		}
	}

	protected abstract boolean method_12775(Set<class_2338> set, class_3747 arg, Random random, class_2338 arg2, class_3341 arg3);
}
