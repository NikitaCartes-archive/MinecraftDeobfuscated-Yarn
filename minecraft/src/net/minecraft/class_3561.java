...
public class class_3561 extends DataFix {
	public static final Map<String, String> field_15810 = ImmutableMap.<String, String>builder()
	...
	public class_3561(Schema schema, boolean bl) {
		super(schema, bl);
	}

	@Override
	protected TypeRewriteRule makeRule() {
		Type<Pair<String, String>> type = DSL.named(class_1208.field_5728.typeName(), DSL.namespacedString());
		if (!Objects.equals(type, this.getInputSchema().getType(class_1208.field_5728))) {
			throw new IllegalStateException("Biome type is not what was expected.");
		} else {
			return this.fixTypeEverywhere("Biomes fix", type, dynamicOps -> pair -> pair.mapSecond(string -> (String)field_15810.getOrDefault(string, string)));
		}
	}
}
