...
public abstract class class_2269 extends class_2341 {
	...
	public class_265 method_9529(class_2680 arg, class_1922 arg2, class_2338 arg3) {
		...
		boolean bl = arg.method_11654(field_10729);
	...
	public boolean method_9534(class_2680 arg, class_1937 arg2, class_2338 arg3, class_1657 arg4, class_1268 arg5, class_2350 arg6, float f, float g, float h) {
		if (arg.method_11654(field_10729)) {
			return true;
		} else {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (!arg2.field_9236 && arg.method_11654(field_10729)) {
			if (this.field_10725) {
	...
	public void method_9548(class_2680 arg, class_1937 arg2, class_2338 arg3, class_1297 arg4) {
		if (!arg2.field_9236 && this.field_10725 && !arg.method_11654(field_10729)) {
			this.method_9715(arg, arg2, arg3);
		}
	}

	private void method_9715(class_2680 arg, class_1937 arg2, class_2338 arg3) {
		List<? extends class_1297> list = arg2.method_8403(class_1665.class, arg.method_11606(arg2, arg3).method_1107().method_996(arg3));
		boolean bl = !list.isEmpty();
		boolean bl2 = arg.method_11654(field_10729);
		if (bl != bl2) {
