...
public class class_1863 extends class_4309 {
	...
	protected void method_20705(Map<class_2960, JsonObject> map, class_3300 arg, class_3695 arg2) {
		...
		this.field_9023 = (Map)map2.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, entryx -> ((Builder)entryx.getValue()).build()));
	...
	public void method_20702(Iterable<class_1860<?>> iterable) {
		this.field_9024 = false;
		Map<class_3956<?>, Map<class_2960, class_1860<?>>> map = Maps.newHashMap();
		iterable.forEach(arg -> {
			Map<class_2960, class_1860<?>> map2 = (Map)map.computeIfAbsent(arg.method_17716(), argx -> Maps.newHashMap());
