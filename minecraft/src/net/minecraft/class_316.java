...
public abstract class class_316 {
	...
	public static final class_4067 field_18190 = new class_4067("options.mipmapLevels", 0.0, 4.0, 1.0F, arg -> (double)arg.field_1856, (arg, double_) -> {
		int i = arg.field_1856;
		arg.field_1856 = (int)double_.doubleValue();
		if ((double)i != double_) {
			class_310 lv = class_310.method_1551();
			lv.method_1549().method_4605(arg.field_1856);
			lv.method_1531().method_4618(class_1059.field_5275);
			lv.method_1549().method_4527(false, arg.field_1856 > 0);
			lv.method_1513();
		}
	}, (arg, arg2) -> {
		double d = arg2.method_18613(arg);
	...
	public static final class_4067 field_18191 = new class_4067(
		"options.mouseWheelSensitivity", 1.0, 10.0, 0.5F, arg -> arg.field_1889, (arg, double_) -> arg.field_1889 = double_, (arg, arg2) -> {
			double d = arg2.method_18611(arg2.method_18613(arg));
			String string = arg2.method_18518();
			return d == 1.0 ? string + class_1074.method_4662("options.mouseWheelSensitivity.default") : string + "+" + (int)d + "." + (int)(d * 10.0) % 10;
		}
	);
	...
	public static final class_4062 field_18196 = new class_4062(
		"options.autoSuggestCommands", arg -> arg.field_1873, (arg, boolean_) -> arg.field_1873 = boolean_
	);
	...
	public static final class_4062 field_18185 = new class_4062("options.forceUnicodeFont", arg -> arg.field_1819, (arg, boolean_) -> {
		...
		class_310 lv = class_310.method_1551();
		class_310.method_1551().method_1568().method_2018(arg.field_1819, class_156.method_18349(), lv);
	});
	...
	public static final class_4062 field_18186 = new class_4062(
		"options.realmsNotifications", arg -> arg.field_1830, (arg, boolean_) -> arg.field_1830 = boolean_
	);
	...
	public static final class_4062 field_1932 = new class_4062("options.fullscreen", arg -> arg.field_1857, (arg, boolean_) -> {
		...
		class_310 lv = class_310.method_1551();
		if (lv.field_1704.method_4498() != arg.field_1857) {
