...
public class class_1132 extends MinecraftServer {
	...
	public class_1132(
		...
		this.field_5518 = arg;
		this.field_5523 = this.method_3799() ? class_3199.field_13884 : arg2;
	}
	...
	public void method_3735(String string, String string2, long l, class_1942 arg, JsonElement jsonElement) {
		...
		class_37 lv3 = new class_37(lv);
		class_3949 lv4 = this.field_17439.create(11);
		this.method_3786(lv, lv3, lv2, this.field_5523, lv4);
		if (this.method_3847(class_2874.field_13072).method_8401().method_207() == null) {
			this.method_3776(this.field_5518.field_1690.field_1851);
		}

		this.method_3774(lv3, lv4);
	}
	...
	public void method_3748(BooleanSupplier booleanSupplier) {
		...
		if (!this.field_5524) {
			...
			if (this.field_5518.field_1687 != null) {
				class_31 lv = this.method_3847(class_2874.field_13072).method_8401();
				class_31 lv2 = this.field_5518.field_1687.method_8401();
				if (!lv.method_197() && lv2.method_207() != lv.method_207()) {
					field_5520.info("Changing difficulty to {}, from {}", lv2.method_207(), lv.method_207());
					this.method_3776(lv2.method_207());
				} else if (lv2.method_197() && !lv.method_197()) {
					field_5520.info("Locking difficulty to {}", lv2.method_207());

					for (class_3218 lv3 : this.method_3738()) {
						if (lv3 != null) {
							lv3.method_8401().method_186(true);
						}
					}
				}
			}
	...
	public void method_3776(class_1267 arg) {
		super.method_3776(arg);
		if (this.field_5518.field_1687 != null) {
			this.field_5518.field_1687.method_8401().method_208(arg);
		}
	}
