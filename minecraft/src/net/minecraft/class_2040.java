...
public class class_2040 {
	...
	public boolean method_8892(class_1297 arg) {
		if (this.field_9580 != null && arg.method_5809() != this.field_9580) {
			...
			return false;
		} else if (this.field_9578 != null && arg.method_5681() != this.field_9578) {
			return false;
		} else {
			return this.field_9583 == null || !(arg instanceof class_1309) || ((class_1309)arg).method_6109() == this.field_9583;
		}
	}
