...
public class class_898 {
	private final Map<Class<? extends class_1297>, class_897<? extends class_1297>> field_4696 = Maps.newHashMap();
	private final Map<String, class_1007> field_4687 = Maps.newHashMap();
	...
	public class_898(class_1060 arg, class_918 arg2, class_3296 arg3) {
		...
		this.method_17145(class_3989.class, new class_3992(this));
		...
		this.method_17145(class_4019.class, new class_4042(this));
		...
		this.method_17145(class_3986.class, new class_921(this));
	...
	public <T extends class_1297, U extends class_897<T>> U method_3953(Class<? extends class_1297> class_) {
		class_897<? extends class_1297> lv = (class_897)this.field_4696.get(class_);
	...
	public void method_3941(class_1937 arg, class_327 arg2, class_4184 arg3, class_1297 arg4, class_315 arg5) {
		this.field_4684 = arg;
		this.field_4692 = arg5;
		this.field_4686 = arg3;
		this.field_4678 = arg4;
		this.field_4689 = arg2;
		if (arg3.method_19331() instanceof class_1309 && ((class_1309)arg3.method_19331()).method_6113()) {
			class_2350 lv = ((class_1309)arg3.method_19331()).method_18401();
			if (lv != null) {
				this.field_4679 = lv.method_10153().method_10144();
				this.field_4677 = 0.0F;
			}
		} else {
			this.field_4679 = arg3.method_19330();
			this.field_4677 = arg3.method_19329();
		}
	}
	...
	private void method_3956(class_1297 arg, double d, double e, double f, float g, float h) {
		...
		if (arg instanceof class_1510) {
			for(class_1508 lv2 : ((class_1510)arg).method_5690()) {
	...
	public double method_3959(double d, double e, double f) {
		return this.field_4686.method_19326().method_1028(d, e, f);
	}
