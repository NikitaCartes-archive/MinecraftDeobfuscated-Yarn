...
public class class_3533 implements class_3693 {
	...
	private final List<Long> field_15730 = Lists.newArrayList();
	private final Map<String, Long> field_15731 = Maps.newHashMap();
	...
	public void method_16066() {
		if (!this.field_15733) {
			...
			if (!this.field_15734.isEmpty()) {
				field_15735.error("Profiler tick ended before path was fully popped. Mismatched push/pop?");
			}
		}
	}
	...
	public void method_15396(String string) {
		if (!this.field_15733) {
			field_15735.error("Cannot push to profiler if profiler tick hasn't started - missing startTick()?");
		} else {
			if (!this.field_15734.isEmpty()) {
	...
	public void method_15407() {
		if (!this.field_15733) {
			...
			long m = this.field_15730.remove(this.field_15730.size() - 1);
			this.field_15736.remove(this.field_15736.size() - 1);
			long n = l - m;
			if (this.field_15731.containsKey(this.field_15734)) {
				this.field_15731.put(this.field_15734, this.field_15731.get(this.field_15734) + n);
			} else {
				this.field_15731.put(this.field_15734, n);
			}
	...
	public class_3696 method_16064() {
		return new class_3692(this.field_15731, this.field_15732, this.field_15729, class_156.method_648(), this.field_16266.getAsInt());
	}
}
