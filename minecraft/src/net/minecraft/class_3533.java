...
public class class_3533 implements class_3693 {
	...
	private final List<Long> field_15730 = Lists.<Long>newArrayList();
	...
	public void method_15407() {
		if (!this.field_15733) {
			...
			long m = (Long)this.field_15730.remove(this.field_15730.size() - 1);
			this.field_15736.remove(this.field_15736.size() - 1);
			long n = l - m;
			if (this.field_15731.containsKey(this.field_15734)) {
				this.field_15731.put(this.field_15734, (Long)this.field_15731.get(this.field_15734) + n);
			} else {
