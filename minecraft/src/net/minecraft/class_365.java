	...
	public void method_1978(float f) {
		if (this.field_2200 != null) {
			...
			if (g <= 0.0F) {
				...
				this.blitOffset = -90;
				int k = class_3532.method_15375((float)this.field_2201.field_1704.method_4502() - 22.0F * g);
				class_539 lv = this.field_2200.method_2772();
				this.method_1975(g, i, k, lv);
				this.blitOffset = j;
			}
		}
	}

	protected void method_1975(float f, int i, int j, class_539 arg) {
		...
		if (arg.method_2787() >= 0) {
			this.blit(i - 91 - 1 + arg.method_2787() * 20, j - 1, 0, 22, 24, 22);
		}

		class_308.method_1453();

		for(int k = 0; k < 9; ++k) {
			this.method_1982(k, this.field_2201.field_1704.method_4486() / 2 - 90 + k * 20 + 2, (float)(j + 3), f, arg.method_2786(k));
		}
	...
	private void method_1982(int i, int j, float f, float g, class_537 arg) {
		...
		if (arg != class_531.field_3260) {
			...
			if (k > 3 && arg.method_16893()) {
				this.field_2201
					.field_1772
					.method_1720(string, (float)(j + 19 - 2 - this.field_2201.field_1772.method_1727(string)), f + 6.0F + 3.0F, 16777215 + (k << 24));
			}
		}
	}
