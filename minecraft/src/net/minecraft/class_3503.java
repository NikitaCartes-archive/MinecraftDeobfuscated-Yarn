...
public class class_3503<T> {
	...
	public class_3494<T> method_15188(class_2960 arg) {
		class_3494<T> lv = (class_3494)this.field_15602.get(arg);
					...
					for(class_3298 lv3 : arg.method_14489(lv)) {
						try {
							...
							if (jsonObject == null) {
								...
								class_3494.class_3495<T> lv4 = (class_3494.class_3495)map.getOrDefault(lv2, class_3494.class_3495.method_15146());
								lv4.method_15147(this.field_15609, jsonObject);
								map.put(lv2, lv4);
							}
	...
	public void method_18242(Map<class_2960, class_3494.class_3495<T>> map) {
		while(!map.isEmpty()) {
			...
			while(iterator.hasNext()) {
				Entry<class_2960, class_3494.class_3495<T>> entry = (Entry)iterator.next();
