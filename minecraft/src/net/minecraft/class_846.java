...
public class class_846 {
	...
	private final List<Thread> field_4440 = Lists.newArrayList();
	...
	public class_846() {
		...
		int j = Math.max(1, class_3532.method_15340(Runtime.getRuntime().availableProcessors(), 1, i / 5));
		this.field_4442 = class_3532.method_15340(j * 10, 1, i);
		if (j > 1) {
			for(int k = 0; k < j; ++k) {
		...
		for(int k = 0; k < this.field_4442; ++k) {
			this.field_4438.add(new class_750());
		}
	...
	public String method_3622() {
		return this.field_4440.isEmpty()
			...
			: String.format("pC: %03d, pU: %1d, aB: %1d", this.field_4435.size(), this.field_4443.size(), this.field_4438.size());
	}
		...
		do {
			...
			synchronized(this.field_4443) {
				if (!this.field_4443.isEmpty()) {
					((class_846.class_847)this.field_4443.poll()).field_4446.run();
					bl2 = true;
					bl = true;
				}
			}
	...
	public ListenableFuture<Object> method_3635(class_1921 arg, class_287 arg2, class_851 arg3, class_849 arg4, double d) {
		if (class_310.method_1551().method_5387()) {
			if (GLX.useVbo()) {
				this.method_3621(arg2, arg3.method_3656(arg.ordinal()));
			} else {
				this.method_3623(arg2, ((class_848)arg3).method_3639(arg, arg4), arg3);
			}

			arg2.method_1331(0.0, 0.0, 0.0);
			return Futures.immediateFuture(null);
		} else {
			ListenableFutureTask<Object> listenableFutureTask = ListenableFutureTask.create(() -> this.method_3635(arg, arg2, arg3, arg4, d), null);
			synchronized(this.field_4443) {
	...
	private void method_3623(class_287 arg, int i, class_851 arg2) {
	...
	public void method_3619() {
		...
		for(Thread thread : this.field_4440) {
			try {
				...
				field_4445.warn("Interrupted whilst waiting for worker to die", var4);
			}
		}
