...
public abstract class class_1405 extends class_1352 {
	...
	public class_1405(class_1308 arg, boolean bl) {
		this(arg, bl, false);
	}

	public class_1405(class_1308 arg, boolean bl, boolean bl2) {
		this.field_6660 = arg;
		this.field_6658 = bl;
		this.field_6663 = bl2;
	}
	...
	protected boolean method_6328(@Nullable class_1309 arg, class_4051 arg2) {
		if (arg == null) {
			return false;
		} else if (!arg2.method_18419(this.field_6660, arg)) {
			return false;
		} else if (!this.field_6660.method_18407(new class_2338(arg))) {
			return false;
		} else {
			if (this.field_6663) {
