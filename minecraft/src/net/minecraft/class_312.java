...
public class class_312 {
	...
	private void method_1601(long l, int i, int j, int k) {
		if (l == this.field_1779.field_1704.method_4490()) {
			...
			if (this.field_1779.field_1755 == null) {
				...
				if (bl) {
					class_437.method_2217(
						() -> bls[0] = this.field_1779.field_1755.method_16807(d, e, m), "mouseClicked event handler", this.field_1779.field_1755.getClass().getCanonicalName()
					);
				} else {
					class_437.method_2217(
						() -> bls[0] = this.field_1779.field_1755.method_16804(d, e, m), "mouseReleased event handler", this.field_1779.field_1755.getClass().getCanonicalName()
					);
				}
			}

			if (!bls[0] && (this.field_1779.field_1755 == null || this.field_1779.field_1755.field_2558)) {
				if (m == 0) {
					this.field_1791 = bl;
				} else if (m == 2) {
					this.field_1790 = bl;
	...
	private void method_1598(long l, double d, double e) {
		if (l == class_310.method_1551().field_1704.method_4490()) {
			...
			if (this.field_1779.field_1755 != null) {
				this.field_1779.field_1755.method_16802(f);
				...
				if (this.field_1779.field_1724.method_7325()) {
					if (this.field_1779.field_1705.method_1739().method_1980()) {
						this.field_1779.field_1705.method_1739().method_1976(-g);
					} else {
						double h = class_3532.method_15350((double)this.field_1779.field_1724.field_7503.method_7252() + g * 0.005F, 0.0, 0.2F);
						this.field_1779.field_1724.field_7503.method_7248(h);
					}
				} else {
					this.field_1779.field_1724.field_7514.method_7373(g);
				}
			}
		}
	}
	...
	private void method_1600(long l, double d, double e) {
		if (l == class_310.method_1551().field_1704.method_4490()) {
			...
			if (lv != null) {
				...
				class_437.method_2217(() -> lv.method_16014(f, g), "mouseMoved event handler", lv.getClass().getCanonicalName());
				if (this.field_1780 != -1 && this.field_1792 > 0.0) {
					...
					class_437.method_2217(() -> lv.method_16801(f, g, this.field_1780, h, i), "mouseDragged event handler", lv.getClass().getCanonicalName());
				}
			}

			this.field_1779.method_16011().method_15396("mouse");
			if (this.method_1613() && this.field_1779.method_1569()) {
				this.field_1789 += d - this.field_1795;
				this.field_1787 += e - this.field_1794;
			}
