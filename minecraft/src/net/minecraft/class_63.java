...
public class class_63 {
	private static final Map<class_2960, Class<? extends class_59>> field_978 = Maps.newHashMap();
	...
	public static class_59 method_383(JsonElement jsonElement, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
		if (jsonElement.isJsonPrimitive()) {
			...
			Class<? extends class_59> class_ = (Class)field_978.get(new class_2960(string));
			if (class_ == null) {
