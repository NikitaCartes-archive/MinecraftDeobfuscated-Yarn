...
public class class_1183 extends DataFix {
	private static final String[] field_5678 = DataFixUtils.make(new String[128], strings -> {
	...
	public class_1183(Schema schema, boolean bl) {
		super(schema, bl);
	}
				...
				if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:potion")) {
					...
					if (optional2.isPresent()) {
						...
						if (!optional3.isPresent()) {
							String string = field_5678[s & 127];
							...
							if ((s & 16384) == 16384) {
								typed2 = typed2.set(opticFinder, Pair.of(class_1208.field_5713.typeName(), "minecraft:splash_potion"));
							}
						}
