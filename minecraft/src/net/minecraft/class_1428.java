...
public class class_1428 extends class_1429 {
	private static final class_1856 field_6742 = class_1856.method_8091(
	...
	public class_1428(class_1937 arg) {
		super(class_1299.field_6132, arg);
		this.method_5835(0.4F, 0.7F);
	...
	public void method_6007() {
		...
		if (!this.field_6002.field_9236 && !this.method_6109() && !this.method_6472() && --this.field_6739 <= 0) {
	...
	public class_1428 method_6471(class_1296 arg) {
		return new class_1428(this.field_6002);
	}
	...
	public void method_5865(class_1297 arg) {
		...
		float i = 0.0F;
		arg.method_5814(
			this.field_5987 + (double)(0.1F * f), this.field_6010 + (double)(this.field_6019 * 0.5F) + arg.method_5678() + 0.0, this.field_6035 - (double)(0.1F * g)
		);
