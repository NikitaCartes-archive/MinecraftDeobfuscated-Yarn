	...
	public boolean method_12775(Set<class_2338> set, class_3747 arg, Random random, class_2338 arg2, class_3341 arg3) {
		...
		if (arg2.method_10264() >= 1 && arg2.method_10264() + i + 1 <= 256) {
			...
			if (!bl) {
					...
					for(int r = arg2.method_10263() - m; r <= arg2.method_10263() + m; ++r) {
						...
						for(int t = arg2.method_10260() - m; t <= arg2.method_10260() + m; ++t) {
							...
							if (Math.abs(s) != m || Math.abs(u) != m || m <= 0) {
								class_2338 lv2 = new class_2338(r, p, t);
								if (method_16420(arg, lv2) || method_16425(arg, lv2)) {
									this.method_12773(set, arg, lv2, field_13856, arg3);
								}
							}
						}
					}
				...
				for(int p = 0; p < i - o; ++p) {
					if (method_16420(arg, arg2.method_10086(p))) {
						this.method_12773(set, arg, arg2.method_10086(p), field_13855, arg3);
					}
				}
