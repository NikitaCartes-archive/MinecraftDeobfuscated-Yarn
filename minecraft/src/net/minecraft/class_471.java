...
public class class_471 extends class_465<class_1706> implements class_1712 {
	...
	protected void init() {
		...
		this.field_2821 = new class_342(this.font, i + 62, j + 24, 103, 12);
		...
		this.field_2821.method_1876(true);
	...
	public boolean keyPressed(int i, int j, int k) {
		if (this.field_2821.keyPressed(i, j, k)) {
			return true;
		} else {
			return this.field_2821.method_1871() && this.field_2821.method_1885() && i != 256 ? true : super.keyPressed(i, j, k);
		}
	}
