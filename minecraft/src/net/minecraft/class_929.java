...
public class class_929 extends class_927<class_1451, class_3680<class_1451>> {
	...
	protected void method_16045(class_1451 arg, float f, float g, float h) {
		...
		if (i > 0.0F) {
			...
			GlStateManager.rotatef(this.method_4043(0.0F, 90.0F, i), 0.0F, 0.0F, 1.0F);
			class_2338 lv = new class_2338(arg);

			for (class_1657 lv2 : arg.field_6002.method_8403(class_1657.class, new class_238(lv).method_1009(2.0, 2.0, 2.0))) {
				if (lv2.method_6113()) {
