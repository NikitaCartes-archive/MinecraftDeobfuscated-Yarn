...
public class class_860 implements class_863.class_864 {
	...
	public void method_3715(long l) {
		...
		if (this.field_4512 != null) {
			...
			Map<class_1923, String> map = (Map)this.field_4512.field_4514.getNow(null);
	...
	final class class_861 {
		...
		private class_861(class_1132 arg2) {
			...
			this.field_4514 = arg2.method_5385(() -> {
				Builder<class_1923, String> builderxx = ImmutableMap.builder();
				class_3215 lvxx = lv3.method_14178();

				for(int kxx = i - 12; kxx <= i + 12; ++kxx) {
					for(int lxx = j - 12; lxx <= j + 12; ++lxx) {
						class_1923 lv2xx = new class_1923(kxx, lxx);
						builderxx.put(lv2xx, "Server: " + lvxx.method_17294(lv2xx));
					}
				}
