		...
		for(class_2960 lv : set) {
			if (!this.field_5282.method_4598().equals(lv)) {
				list.add(CompletableFuture.runAsync(() -> {
					class_2960 lvxx = this.method_4603(lv);

					class_1058 lv5;
					try {
						class_3298 lv2 = arg.method_14486(lvxx);
						Throwable var7 = null;
						...
						field_5278.error("Unable to parse metadata from {} : {}", lvxx, var21);
						return;
					} catch (IOException var22) {
						field_5278.error("Using missing texture, unable to load {} : {}", lvxx, var22);
						return;
					}
