...
public class class_1059 extends class_1044 implements class_1063 {
	...
	public void method_4610(class_3300 arg) {
		...
		for(class_1058 lv7 : lv.method_4549()) {
			if (lv7 == this.field_5282 || this.method_4604(arg, lv7)) {
				this.field_5280.put(lv7.method_4598(), lv7);
				...
				try {
					...
					lv10.method_578("Sprite", lv7);
					throw new class_148(lv9);
				}

				if (lv7.method_4599()) {
					this.field_5276.add(lv7);
				}
			}
		}
	}
