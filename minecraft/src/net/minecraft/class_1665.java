...
public abstract class class_1665 extends class_1297 implements class_1676 {
	...
	public void method_5773() {
		...
		class_2338 lv2 = new class_2338(this.field_5987, this.field_6010, this.field_6035);
		...
		if (this.field_7588 && !bl) {
			if (this.field_7586 != lv3 && this.field_6002.method_18026(this.method_5829().method_1014(0.06))) {
	...
	protected void method_7457(class_239 arg) {
		...
		if (lv == class_239.class_240.field_1331) {
			...
			class_2680 lv3 = this.field_6002.method_8320(lv2.method_17777());
			this.field_7586 = lv3;
			class_243 lv4 = lv2.method_17784().method_1023(this.field_5987, this.field_6010, this.field_6035);
			this.method_18799(lv4);
			class_243 lv5 = lv4.method_1029().method_1021(0.05F);
			this.field_5987 -= lv5.field_1352;
			this.field_6010 -= lv5.field_1351;
			this.field_6035 -= lv5.field_1350;
			...
			this.method_7453();
			lv3.method_19287(this.field_6002, lv3, lv2, this);
		}
	}
	...
	protected void method_7454(class_3966 arg) {
		...
		int i = class_3532.method_15384(Math.max((double)f * this.field_7571, 0.0));
		...
		if (lv.method_5643(lv3, (float)i)) {
			if (lv instanceof class_1309) {
				...
				if (!this.field_6002.field_9236 && lv2 instanceof class_1309) {
	...
	public boolean method_7441() {
		if (!this.field_6002.field_9236) {
			...
			return (this.field_6011.method_12789(field_7573) & 2) != 0;
		}
	}
