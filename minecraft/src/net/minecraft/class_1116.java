...
public class class_1116 implements class_1104 {
	...
	public void method_4756() {
		...
		if (this.field_5480 <= 0 && this.field_5481.isInWater()) {
			...
			if (f < 1.0E-4F) {
				this.field_5480 = 0;
				this.field_5479.play(new AmbientSoundLoops.MusicLoop(this.field_5481, SoundEvents.field_15178));
			} else if (f < 0.001F) {
				this.field_5480 = 0;
				this.field_5479.play(new AmbientSoundLoops.MusicLoop(this.field_5481, SoundEvents.field_15068));
			} else if (f < 0.01F) {
				this.field_5480 = 0;
				this.field_5479.play(new AmbientSoundLoops.MusicLoop(this.field_5481, SoundEvents.field_15028));
			}
		}
	}
}
