...
public class class_4515 {
	...
	private final Map<String, Collection<class_4517>> field_20552 = Maps.newHashMap();
	...
	private void method_22156(int i) {
		...
		if (i < this.field_20547.size()) {
			...
			Collection<class_4517> collection = (Collection)this.field_20552.get(string);
	...
	private void method_22157(GameTestBatch gameTestBatch) {
		Collection<class_4517> collection = (Collection)this.field_20552.get(gameTestBatch.method_22152());
