...
public class class_3778 {
	...
	static final class class_4182 {
		...
		public class_4182(
			...
			int l = arg3.method_18028(j, k, class_2902.class_2903.field_13194);
							...
							if (lv14.method_14663() > 16) {
								...
								o = list2.stream().mapToInt(arg2 -> {
									if (!lv14.method_14662(arg2.field_15597.method_10093(arg2.field_15596.method_11654(class_3748.field_10927)))) {
										...
										class_2960 lvxx = new class_2960(arg2.field_15595.method_10558("target_pool"));
										class_3785 lv2xx = class_3778.field_16666.method_16639(lvxx);
										class_3785 lv3xx = class_3778.field_16666.method_16639(lv2xx.method_16634());
										return Math.max(lv2xx.method_19309(this.field_18703), lv3xx.method_19309(this.field_18703));
									}
								}).max().orElse(0);
							}
							...
							for(class_3499.class_3501 lv15 : list2) {
								if (class_3748.method_16546(lv6, lv15)) {
									...
									if (bl && bl3) {
										...
										if (m == -1) {
											m = this.field_18702.method_18028(lv8.method_10263(), lv8.method_10260(), class_2902.class_2903.field_13194);
										}
