						...
						for(String string : compoundTag2.getKeys()) {
							if (compoundTag2.contains(string, 10)) {
								Util.ifPresentOrElse(
									...
									statType -> {
										CompoundTag compoundTag2xx = compoundTag2.getCompound(string);
	
										for(String string2 : compoundTag2xx.getKeys()) {
											if (compoundTag2xx.contains(string2, 99)) {
												Util.ifPresentOrElse(
												...
												LOGGER.warn("Invalid statistic value in {}: Don't know what {} is for key {}", this.file, compoundTag2xx.get(string2), string2);
											}
										}
									},
