...
public class class_687 extends class_703 {
	...
	protected class_687(class_1937 arg, double d, double e, double f, double g, double h, double i) {
		...
		this.field_3874 += (double)((this.field_3840.nextFloat() - this.field_3840.nextFloat()) * 0.05F);
		this.field_3854 += (double)((this.field_3840.nextFloat() - this.field_3840.nextFloat()) * 0.05F);
		this.field_3871 += (double)((this.field_3840.nextFloat() - this.field_3840.nextFloat()) * 0.05F);
