...
public class class_3767 extends class_18 {
	private final Map<Integer, class_3765> field_16639 = Maps.newHashMap();
	private final Map<class_1657, Integer> field_16640 = Maps.newHashMap();
	...
	public void method_16539() {
		...
		while(iterator.hasNext()) {
			Entry<Integer, class_3765> entry = (Entry)iterator.next();
	...
	public void method_16531(class_1415 arg) {
		...
		while(iterator.hasNext()) {
			Entry<class_1657, Integer> entry = (Entry)iterator.next();
	...
	public static boolean method_16838(class_3763 arg, class_3765 arg2) {
		if (arg != null && arg2 != null && arg2.method_16831() != null) {
			return arg.method_5805() && arg.method_6131() <= 2400 && arg.field_6002.method_8597().method_12460() == arg2.method_16831().method_8597().method_12460();
		} else {
			return false;
		}
	}
