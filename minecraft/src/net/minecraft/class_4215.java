...
public class class_4215 {
	...
	public static boolean method_19550(class_4095<?> arg, class_1309 arg2) {
		return arg.method_18904(class_4140.field_18442).filter(list -> list.contains(arg2)).isPresent();
	}

	public static boolean method_19551(class_4095<?> arg, class_4140<? extends class_1309> arg2, class_1299<?> arg3) {
		return arg.method_18904(arg2)
	...
	public static class_4076 method_20419(class_3218 arg, class_4076 arg2, int i) {
		int j = arg.method_19498(arg2);
		return (class_4076)class_4076.method_20439(arg2, i).filter(arg2x -> arg.method_19498(arg2x) < j).min(Comparator.comparingInt(arg::method_19498)).orElse(arg2);
	}
}
