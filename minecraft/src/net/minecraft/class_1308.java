...
public abstract class class_1308 extends class_1309 {
	...
	private class_2338 field_18074 = class_2338.field_10980;
	private float field_18075 = -1.0F;

	protected class_1308(class_1299<? extends class_1308> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public boolean method_5973(class_1299<?> arg) {
		return arg != class_1299.field_6107;
	}
	...
	protected int method_6110(class_1657 arg) {
		if (this.field_6194 > 0) {
			...
			for(int j = 0; j < this.field_6195.size(); ++j) {
				if (!this.field_6195.get(j).method_7960() && this.field_6187[j] <= 1.0F) {
					i += 1 + this.field_5974.nextInt(3);
				}
			}
			...
			for(int i = 0; i < 20; ++i) {
				...
				this.field_6002
					.method_8406(
						...
						this.field_5987 + (double)(this.field_5974.nextFloat() * this.method_17681() * 2.0F) - (double)this.method_17681() - d * 10.0,
						this.field_6010 + (double)(this.field_5974.nextFloat() * this.method_17682()) - e * 10.0,
						this.field_6035 + (double)(this.field_5974.nextFloat() * this.method_17681() * 2.0F) - (double)this.method_17681() - f * 10.0,
						d,
						e,
						f
					);
	...
	protected void method_20417() {
		...
		this.field_6201.method_6276(class_1352.class_4134.field_18405, bl);
		this.field_6201.method_6276(class_1352.class_4134.field_18407, bl && bl2);
	...
	public void method_6007() {
		...
		if (!this.field_6002.field_9236
			...
			&& this.method_5805()
			&& !this.field_6272
			&& this.field_6002.method_8450().method_8355(class_1928.field_19388)) {
			for(class_1542 lv : this.field_6002.method_18467(class_1542.class, this.method_5829().method_1009(1.0, 0.0, 1.0))) {
	...
	protected void method_5982() {
		if (!this.method_5947() && !this.method_17326()) {
			class_1297 lv = this.field_6002.method_18460(this, -1.0);
			if (lv != null) {
	...
	public static boolean method_20636(class_1299<? extends class_1308> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		class_2338 lv = arg4.method_10074();
		return arg3 == class_3730.field_16469 || arg2.method_8320(lv).method_11611(arg2, lv, arg);
	}
	...
	public boolean method_5957(class_1941 arg) {
		return !arg.method_8599(this.method_5829()) && arg.method_8606(this);
	}
	...
	public boolean method_18397(class_1799 arg) {
		class_1304 lv = method_5953(arg);
		return this.method_6118(lv).method_7960() && this.method_5936();
	}
	...
	public boolean method_18411() {
		return this.method_18407(new class_2338(this));
	}

	public boolean method_18407(class_2338 arg) {
		if (this.field_18075 == -1.0F) {
			return true;
		} else {
			return this.field_18074.method_10262(arg) < (double)(this.field_18075 * this.field_18075);
		}
	}

	public void method_18408(class_2338 arg, int i) {
		this.field_18074 = arg;
	...
	protected void method_5995() {
		...
		if (this.field_6202 != null) {
			if (!this.method_5805() || !this.field_6202.method_5805()) {
	...
	public void method_5932(boolean bl, boolean bl2) {
		if (this.field_6202 != null) {
			...
			if (!(this.field_6202 instanceof class_1657)) {
				this.field_6202.field_5983 = false;
			}
			...
			if (!this.field_6002.field_9236 && bl && this.field_6002 instanceof class_3218) {
				((class_3218)this.field_6002).method_14178().method_18754(this, new class_2740(this, null));
			}
		}
	}
	...
	public boolean method_5934() {
		return this.field_6202 != null;
	}

	@Nullable
	public class_1297 method_5933() {
		if (this.field_6202 == null && this.field_18279 != 0 && this.field_6002.field_9236) {
			this.field_6202 = this.field_6002.method_8469(this.field_18279);
		}
	...
	public void method_5954(class_1297 arg, boolean bl) {
		...
		if (!(this.field_6202 instanceof class_1657)) {
			this.field_6202.field_5983 = true;
		}

		if (!this.field_6002.field_9236 && bl && this.field_6002 instanceof class_3218) {
			((class_3218)this.field_6002).method_14178().method_18754(this, new class_2740(this, this.field_6202));
		}
	...
	private void method_5940() {
		if (this.field_6192 != null && this.field_6002 instanceof class_3218) {
			if (this.field_6192.method_10576("UUID")) {
				UUID uUID = this.field_6192.method_10584("UUID");
				class_1297 lv = ((class_3218)this.field_6002).method_14190(uUID);
				if (lv != null) {
				...
				this.method_5954(class_1532.method_6932(this.field_6002, lv2), true);
			} else {
	...
	public void method_19540(boolean bl) {
		byte b = this.field_6011.method_12789(field_6193);
		this.field_6011.method_12778(field_6193, bl ? (byte)(b | 4) : (byte)(b & -5));
	}
	...
	public boolean method_6510() {
		return (this.field_6011.method_12789(field_6193) & 4) != 0;
	}
	...
	public boolean method_18395(class_1309 arg) {
		return arg.method_5864() == class_1299.field_6097 && ((class_1657)arg).field_7503.field_7480 ? false : super.method_18395(arg);
	}
	...
	public boolean method_18809(class_1792 arg) {
		return this.method_6047().method_7909() == arg || this.method_6079().method_7909() == arg;
	}
}
