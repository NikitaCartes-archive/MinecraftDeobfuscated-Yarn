...
public class class_1550 extends class_1577 {
	public class_1550(class_1937 arg) {
		super(class_1299.field_6086, arg);
		this.method_5835(this.field_5998 * 2.35F, this.field_6019 * 2.35F);
		this.method_5971();
	...
	protected void method_5958() {
		...
		if ((this.field_6012 + this.method_5628()) % 1200 == 0) {
			...
			List<class_3222> list = this.field_6002.method_8498(class_3222.class, arg -> this.method_5858(arg) < 2500.0 && arg.field_13974.method_14267());
			int j = 2;
			int k = 6000;
			int l = 1200;
		...
		if (!this.method_6151()) {
			this.method_6145(new class_2338(this), 16);
		}
	}
}
