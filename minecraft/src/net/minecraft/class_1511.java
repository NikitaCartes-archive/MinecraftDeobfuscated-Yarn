...
public class class_1511 extends class_1297 {
	...
	public class_1511(class_1937 arg) {
		super(class_1299.field_6110, arg);
		this.field_6033 = true;
		this.method_5835(2.0F, 2.0F);
	...
	public boolean method_5643(class_1282 arg, float f) {
		if (this.method_5679(arg)) {
			...
			if (!this.field_5988 && !this.field_6002.field_9236) {
				...
				if (!this.field_6002.field_9236) {
					if (!arg.method_5535()) {
						this.field_6002.method_8437(null, this.field_5987, this.field_6010, this.field_6035, 6.0F, true);
					}
	...
	public class_2338 method_6838() {
		return (class_2338)((Optional)this.method_5841().method_12789(field_7033)).orElse(null);
	}
