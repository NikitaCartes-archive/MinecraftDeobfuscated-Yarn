...
public class class_1869 implements class_1860 {
	...
	public boolean method_8115(class_1263 arg, class_1937 arg2) {
		if (!(arg instanceof class_1715)) {
			...
			for(int i = 0; i <= lv.method_17398() - this.field_9055; ++i) {
				for(int j = 0; j <= lv.method_17397() - this.field_9054; ++j) {
					if (this.method_8161(lv, i, j, true)) {
						return true;
					}

					if (this.method_8161(lv, i, j, false)) {
						return true;
					}
				}
			}
	...
	private static Map<String, class_1856> method_8157(JsonObject jsonObject) {
		Map<String, class_1856> map = Maps.newHashMap();
	...
	public static class_1799 method_8155(JsonObject jsonObject) {
		...
		class_1792 lv = class_2378.field_11142.method_10223(new class_2960(string));
		if (lv == null) {
	...
	public static class class_1870 implements class_1862<class_1869> {
