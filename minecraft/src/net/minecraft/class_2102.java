	...
	public static class_2102 method_9064(@Nullable JsonElement jsonElement) {
		if (jsonElement != null && !jsonElement.isJsonNull()) {
			...
			for(Entry<String, JsonElement> entry : jsonObject.entrySet()) {
				...
				class_1291 lv2 = (class_1291)class_2378.field_11159.method_17966(lv).orElseThrow(() -> new JsonSyntaxException("Unknown effect '" + lv + "'"));
	...
	public static class class_2103 {
		...
		public boolean method_9069(@Nullable class_1293 arg) {
			if (arg == null) {
				...
				return false;
			} else if (this.field_9714 != null && this.field_9714 != arg.method_5591()) {
				return false;
			} else {
				return this.field_9712 == null || this.field_9712 == arg.method_5581();
			}
		}
