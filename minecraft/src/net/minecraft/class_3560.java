...
public abstract class class_3560<M extends class_3556<M>> extends class_4079 {
	...
	@Nullable
	public class_2804 method_20533(long l) {
		class_2804 lv = this.field_15807.get(l);
		return lv != null ? lv : this.method_15522(l, false);
	}
	...
	protected void method_15527(class_3558<M, ?> arg, boolean bl, boolean bl2) {
		if (this.method_15528() || !this.field_15807.isEmpty()) {
			...
			while(objectIterator.hasNext()) {
				...
				class_2804 lv = this.field_15807.remove(l);
				class_2804 lv2 = this.field_15796.method_15500(l);
				if (this.field_19342.contains(class_4076.method_18693(l))) {
					if (lv != null) {
						this.field_15807.put(l, lv);
					} else if (lv2 != null) {
						this.field_15807.put(l, lv2);
					}
				}
			}
			...
			for(Entry<class_2804> entry : this.field_15807.long2ObjectEntrySet()) {
				...
				if (this.method_15524(m)) {
					class_2804 lv2 = (class_2804)entry.getValue();
					if (this.field_15796.method_15501(m) != lv2) {
						this.method_15536(arg, m);
						this.field_15796.method_15499(m, lv2);
			...
			if (!bl2) {
				...
				while(objectIterator.hasNext()) {
					...
					if (this.method_15524(l)) {
						...
						for(class_2350 lv3 : field_15799) {
							long n = class_4076.method_18679(l, lv3);
	...
	protected void method_15532(long l, @Nullable class_2804 arg) {
		if (arg != null) {
