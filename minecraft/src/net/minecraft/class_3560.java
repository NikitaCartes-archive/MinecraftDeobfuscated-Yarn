...
public abstract class class_3560<M extends class_3556<M>> extends class_3554 {
	...
	protected class_2804 method_15522(long l, boolean bl) {
		return this.method_15533((M)(bl ? this.field_15796 : this.field_15806), l);
	}
	...
	protected int method_15537(long l) {
		...
		return lv.method_12139(class_2338.method_10061(l) & 15, class_2338.method_10071(l) & 15, class_2338.method_10083(l) & 15);
	}
	...
	protected void method_15525(long l, int i) {
		...
		class_2804 lv = this.method_15522(m, true);
		lv.method_12145(class_2338.method_10061(l) & 15, class_2338.method_10071(l) & 15, class_2338.method_10083(l) & 15, i);

		for(int j = -1; j <= 1; ++j) {
			for(int k = -1; k <= 1; ++k) {
				for(int n = -1; n <= 1; ++n) {
					this.field_16448.add(class_2338.method_10090(class_2338.method_10096(l, k, n, j)));
				}
			}
		}
	}
	...
	protected void method_15487(long l, int i, boolean bl) {
		for(int j = -1; j <= 1; ++j) {
			for(int k = -1; k <= 1; ++k) {
				for(int m = -1; m <= 1; ++m) {
					long n = class_2338.method_10096(l, j * 16, k * 16, m * 16);
					if (n != l) {
	...
	protected int method_15486(long l, long m, int i) {
		...
		for(int k = -1; k <= 1; ++k) {
			for(int n = -1; n <= 1; ++n) {
				for(int o = -1; o <= 1; ++o) {
					long p = class_2338.method_10096(l, k * 16, n * 16, o * 16);
					if (p == l) {
						p = -1L;
					}
		...
		if (j >= 2 && i != 2) {
			if (this.field_15798.contains(l)) {
				...
				for(int k = -1; k <= 1; ++k) {
					for(int m = -1; m <= 1; ++m) {
						for(int n = -1; n <= 1; ++n) {
							this.field_16448.add(class_2338.method_10090(class_2338.method_10096(l, m * 16, n * 16, k * 16)));
						}
					}
				}
			}
	...
	protected void method_15527(class_3558<M, ?> arg, boolean bl, boolean bl2) {
		if (this.method_15528() || !this.field_15807.isEmpty()) {
				...
				while(objectIterator.hasNext()) {
					...
					if (this.method_15524(l)) {
						...
						for(class_2350 lv2 : field_15799) {
							long n = class_2338.method_10096(l, lv2.method_10148() * 16, lv2.method_10164() * 16, lv2.method_10165() * 16);
			...
			while(objectIteratorx.hasNext()) {
				Entry<class_2804> entry = (Entry)objectIteratorx.next();
				long m = entry.getLongKey();
				if (this.method_15524(m)) {
