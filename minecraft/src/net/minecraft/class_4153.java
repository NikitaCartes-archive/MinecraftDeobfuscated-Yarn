...
public class class_4153 extends class_4180<class_4157> {
	...
	public Optional<class_2338> method_20005(
		...
		List<class_4156> list = (List)this.method_19125(predicate, arg2, i, arg).collect(Collectors.toList());
	...
	public boolean method_19116(class_2338 arg, Predicate<class_4158> predicate) {
		return this.method_19294(class_4076.method_18682(arg).method_18694()).map(arg2 -> arg2.method_19147(arg, predicate)).orElse(false);
	}
	...
	private boolean method_19133(long l) {
		...
		return optional == null
			? false
			: optional.map(arg -> arg.method_19150(class_4158.field_18501, class_4153.class_4155.field_18488).count() > 0L).orElse(false);
	}
	...
	public void method_19510(class_1923 arg, class_2826 arg2) {
		...
		class_156.method_17974(this.method_19294(lv.method_18694()), arg3 -> arg3.method_20353(biConsumer -> {
			...
			if (method_20345(arg2)) {
				class_4157 lvxx = this.method_19295(lv.method_18694());
				this.method_20348(arg2, lv, lvxx::method_19146);
			}
		});
	}
