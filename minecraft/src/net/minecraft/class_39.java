...
public class class_39 {
	private static final Set<class_2960> field_667 = Sets.<class_2960>newHashSet();
	...
	public static final class_2960 field_16216 = method_269("entities/cat_morning_gift");
	...
	private static class_2960 method_269(String string) {
		return method_271(new class_2960(string));
	}

	private static class_2960 method_271(class_2960 arg) {
		if (field_667.add(arg)) {
			return arg;
		} else {
