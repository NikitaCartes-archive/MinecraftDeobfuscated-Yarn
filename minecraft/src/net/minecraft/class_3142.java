...
public class class_3142 {
			...
			class_2170.method_9247("team")
				...
				.then(
					class_2170.method_9247("add")
						.then(
							((RequiredArgumentBuilder)class_2170.method_9244("team", StringArgumentType.word())
									.executes(commandContext -> method_13757((class_2168)commandContext.getSource(), StringArgumentType.getString(commandContext, "team"))))
								.then(
				...
				.then(
					class_2170.method_9247("join")
						.then(
							((RequiredArgumentBuilder)class_2170.method_9244("team", class_2243.method_9482())
									.executes(
										commandContext -> method_13720(
												(class_2168)commandContext.getSource(),
												class_2243.method_9480(commandContext, "team"),
												Collections.singleton(((class_2168)commandContext.getSource()).method_9229().method_5820())
											)
									))
								.then(
				...
				.then(
					class_2170.method_9247("modify")
						.then(
							((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)class_2170.method_9244(
																	"team", class_2243.method_9482()
																)
																.then(
	...
	private static int method_13723(class_2168 arg, class_268 arg2) throws CommandSyntaxException {
		class_269 lv = arg.method_9211().method_3845();
		Collection<String> collection = Lists.newArrayList(arg2.method_1204());
