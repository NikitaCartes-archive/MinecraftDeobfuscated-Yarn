...
public class class_636 {
	...
	public void method_2898(class_1657 arg) {
		arg.field_6031 = -180.0F;
	}
		...
		if (!this.field_3712.field_1724.method_6047().method_7909().method_7885(lv4, lv3, arg, this.field_3712.field_1724)) {
			...
			if ((lv5 instanceof class_2288 || lv5 instanceof class_2515 || lv5 instanceof class_3748) && !this.field_3712.field_1724.method_7338()) {
				...
				if (!this.field_3719.method_8386()) {
					class_1799 lv7 = this.field_3712.field_1724.method_6047();
					if (!lv7.method_7960()) {
						lv7.method_7952(lv3, lv4, arg, this.field_3712.field_1724);
						if (lv7.method_7960()) {
							this.field_3712.field_1724.method_6122(class_1268.field_5808, class_1799.field_8037);
						}
					}
				}
	...
	public boolean method_2902(class_2338 arg, class_2350 arg2) {
		...
		if (this.field_3716 > 0) {
			...
			if (lv.method_11588()) {
				...
				this.field_3715 += lv.method_11589(this.field_3712.field_1724, this.field_3712.field_1724.field_6002, arg);
	...
	public class_1269 method_2896(class_746 arg, class_638 arg2, class_2338 arg3, class_2350 arg4, class_243 arg5, class_1268 arg6) {
		this.method_2911();
		if (!this.field_3712.field_1687.method_8621().method_11952(arg3)) {
			return class_1269.field_5814;
		} else {
			class_1799 lv = arg.method_5998(arg6);
			float f = (float)(arg5.field_1352 - (double)arg3.method_10263());
			float g = (float)(arg5.field_1351 - (double)arg3.method_10264());
			float h = (float)(arg5.field_1350 - (double)arg3.method_10260());
			if (this.field_3719 == class_1934.field_9219) {
				this.field_3720.method_2883(new class_2885(arg3, arg4, arg6, f, g, h));
				return class_1269.field_5812;
			} else {
				boolean bl = !arg.method_6047().method_7960() || !arg.method_6079().method_7960();
				boolean bl2 = arg.method_5715() && bl;
				if (!bl2 && arg2.method_8320(arg3).method_11629(arg2, arg3, arg, arg6, arg4, f, g, h)) {
					this.field_3720.method_2883(new class_2885(arg3, arg4, arg6, f, g, h));
					return class_1269.field_5812;
				} else {
					this.field_3720.method_2883(new class_2885(arg3, arg4, arg6, f, g, h));
					if (!lv.method_7960() && !arg.method_7357().method_7904(lv.method_7909())) {
						class_1838 lv2 = new class_1838(arg, arg.method_5998(arg6), arg3, arg4, f, g, h);
						class_1269 lv3;
						if (this.field_3719.method_8386()) {
							int i = lv.method_7947();
							lv3 = lv.method_7981(lv2);
							lv.method_7939(i);
						} else {
							lv3 = lv.method_7981(lv2);
						}
	...
	public class_746 method_2901(class_1937 arg, class_3469 arg2, class_299 arg3) {
	...
	public class_1269 method_2917(class_1657 arg, class_1297 arg2, class_239 arg3, class_1268 arg4) {
		this.method_2911();
		class_243 lv = new class_243(
			arg3.field_1329.field_1352 - arg2.field_5987, arg3.field_1329.field_1351 - arg2.field_6010, arg3.field_1329.field_1350 - arg2.field_6035
		);
