...
public class class_1914 {
	...
	public class_1914(class_2487 arg) {
		...
		this.field_18676 = arg.method_10550("specialPrice");
		this.field_18677 = arg.method_10550("demand");
	}
	...
	public class_1799 method_19272() {
		...
		lv.method_7939(class_3532.method_15340(i + j + this.field_18676, 1, this.field_9146.method_7909().method_7882()));
		return lv;
	}
	...
	public class_2487 method_8251() {
		...
		lv.method_10569("specialPrice", this.field_18676);
		lv.method_10569("demand", this.field_18677);
		return lv;
	}
	...
	private boolean method_16954(class_1799 arg, class_1799 arg2) {
		if (arg2.method_7960() && arg.method_7960()) {
			...
			return class_1799.method_7984(lv, arg2)
				&& (!arg2.method_7985() || lv.method_7985() && class_2512.method_10687(arg2.method_7969(), lv.method_7969(), false));
		}
	}
