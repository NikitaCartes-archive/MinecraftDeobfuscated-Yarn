...
public class class_2447 {
	...
	private final Map<Character, Ingredient> field_11376 = Maps.newLinkedHashMap();
	...
	public class_2447 method_10434(Character character, ItemProvider itemProvider) {
		return this.method_10428(character, Ingredient.ofItems(itemProvider));
	}
	...
	private void method_10432(Identifier identifier) {
		if (this.field_11377.isEmpty()) {
			...
			Set<Character> set = Sets.newHashSet(this.field_11376.keySet());
			set.remove(' ');
