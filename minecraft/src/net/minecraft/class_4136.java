...
public class class_4136 {
	...
	public void method_20651() {
		Iterator<class_4136.class_4137> iterator = this.field_18419.values().iterator();

		while(iterator.hasNext()) {
			class_4136.class_4137 lv = (class_4136.class_4137)iterator.next();
			lv.method_20652();
			if (lv.method_20654()) {
				iterator.remove();
			}
	...
	private Collection<class_4136.class_4138> method_19070(Random random, int i) {
		List<class_4136.class_4138> list = (List)this.method_19074().collect(Collectors.toList());
		if (list.isEmpty()) {
	...
	public void method_19061(class_4136 arg, Random random, int i) {
		...
		collection.forEach(argx -> {
			int ixx = argx.field_18423 - argx.field_18422.field_18434;
			if (ixx >= 2) {
				this.method_19071(argx.field_18421).field_18420.mergeInt(argx.field_18422, ixx, class_4136::method_19059);
			}
		});
	}
	...
	public void method_19072(UUID uUID, class_4139 arg, int i) {
		class_4136.class_4137 lv = this.method_19071(uUID);
		lv.field_18420.mergeInt(arg, i, (integer, integer2) -> this.method_19063(arg, integer, integer2));
		lv.method_20653(arg);
		if (lv.method_20654()) {
	...
	public void method_19066(Dynamic<?> dynamic) {
		dynamic.asStream()
			...
			.flatMap(class_156::method_17815)
	...
	static class class_4137 {
		...
		public void method_20652() {
			ObjectIterator<Entry<class_4139>> objectIterator = this.field_18420.object2IntEntrySet().iterator();

			while(objectIterator.hasNext()) {
				Entry<class_4139> entry = (Entry)objectIterator.next();
				int i = entry.getIntValue() - ((class_4139)entry.getKey()).field_19354;
				if (i < 2) {
		...
		public void method_20653(class_4139 arg) {
			int i = this.field_18420.getInt(arg);
			if (i > arg.field_18432) {
				this.field_18420.put(arg, arg.field_18432);
			}

			if (i < 2) {
				this.method_20655(arg);
			}
		}

		public void method_20655(class_4139 arg) {
			this.field_18420.removeInt(arg);
		}
	}
	...
	static class class_4138 {
		...
		public static Optional<class_4136.class_4138> method_19084(Dynamic<?> dynamic) {
			return dynamic.get("Type")
				...
				.flatMap(
					arg -> class_156.method_19481("Target", dynamic)
