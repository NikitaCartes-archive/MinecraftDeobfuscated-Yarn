...
public class class_4136 {
	...
	public long method_19062(class_4139 arg, DoublePredicate doublePredicate) {
		return this.field_18419.values().stream().filter(arg2 -> doublePredicate.test((double)(arg2.field_18420.getOrDefault(arg, 0) * arg.field_18431))).count();
	}
