	...
	public void method_12110(class_2791 arg) {
		...
		for(int m = 0; m < 16; ++m) {
			for(int n = 0; n < 16; ++n) {
				...
				lvs[n * 16 + m]
					.method_8703(
						lv2, arg, o, p, q, e, this.method_12109().method_12569(), this.method_12109().method_12570(), this.method_16398(), this.field_12760.method_8412()
					);
			}
		}
						...
						for(int ag = 0; ag < this.field_16570; ++ag) {
							...
							for(int am = 0; am < this.field_16570; ++am) {
								...
								for(ar = ar / 2.0 - ar * ar * ar / 24.0; objectListIterator.hasNext(); ar += method_16572(as, at, au) * 0.8) {
									...
									as = Math.max(0, Math.max(lv16.field_14381 - ah, ah - lv16.field_14378));
									at = y - (lv16.field_14380 + lv15.method_16646());
									au = Math.max(0, Math.max(lv16.field_14379 - an, an - lv16.field_14376));
								}
								...
								while(objectListIterator2.hasNext()) {
									...
									as = y - lv17.method_16611();
									at = an - lv17.method_16609();
