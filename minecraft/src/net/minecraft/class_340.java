	...
	protected List<String> method_1835() {
		...
		if (this.field_2079.method_1555()) {
			...
			List<String> list = Lists.<String>newArrayList(
				...
				"P: " + this.field_2079.field_1713.method_3052() + ". T: " + this.field_2079.field_1687.method_18120(),
				this.field_2079.field_1687.method_8457(),
				class_2874.method_12485(this.field_2079.field_1687.field_9247.method_12460()).toString() + " FC: " + Integer.toString(longSet.size()),
				"",
				String.format(
					Locale.ROOT,
					"XYZ: %.3f / %.5f / %.3f",
				...
				if (this.field_2079.field_1687.method_8591(lv3)) {
					...
					if (lv8.method_12223()) {
						...
						if (lv3.method_10264() >= 0 && lv3.method_10264() < 256) {
							...
							class_1266 lv11 = new class_1266(lv7.method_8407(), lv7.method_8532(), l, h);
							list.add(
								String.format(
									Locale.ROOT, "Local Difficulty: %.2f // %.2f (Day %d)", lv11.method_5457(), lv11.method_5458(), this.field_2079.field_1687.method_8532() / 24000L
								)
							);
						}
					}
			...
			if (this.field_2082.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv12 = ((class_3965)this.field_2082).method_17777();
				list.add(String.format("Looking at block: %d %d %d", lv12.method_10263(), lv12.method_10264(), lv12.method_10260()));
			}

			if (this.field_2083.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv12 = ((class_3965)this.field_2083).method_17777();
				list.add(String.format("Looking at liquid: %d %d %d", lv12.method_10263(), lv12.method_10264(), lv12.method_10260()));
			}
