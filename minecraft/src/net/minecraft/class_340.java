...
public class class_340 extends class_332 {
	private static final Map<class_2902.class_2903, String> field_19274 = class_156.method_654(new EnumMap(class_2902.class_2903.class), enumMap -> {
		enumMap.put(class_2902.class_2903.field_13194, "SW");
		enumMap.put(class_2902.class_2903.field_13202, "S");
		enumMap.put(class_2902.class_2903.field_13195, "OW");
		enumMap.put(class_2902.class_2903.field_13200, "O");
		enumMap.put(class_2902.class_2903.field_13197, "M");
		enumMap.put(class_2902.class_2903.field_13203, "ML");
	});
	...
	public void method_1846() {
		...
		this.field_2082 = lv.method_5745(20.0, 0.0F, false);
		this.field_2083 = lv.method_5745(20.0, 0.0F, true);
		this.method_1847();
		this.method_1848();
	...
	protected void method_1847() {
		...
		list.add("");
		boolean bl = this.field_2079.method_1576() != null;
		list.add(
			"Debug: Pie [shift]: "
	...
	protected List<String> method_1835() {
		...
		if (this.field_2079.method_1555()) {
			return Lists.<String>newArrayList(
				...
				"P: " + this.field_2079.field_1713.method_3052() + ". T: " + this.field_2079.field_1687.method_18120(),
			...
			class_1923 lv6 = new class_1923(lv3);
			if (!Objects.equals(this.field_2085, lv6)) {
				this.field_2085 = lv6;
				this.method_1842();
			}

			class_1937 lv7 = this.method_1840();
			LongSet longSet = (LongSet)(lv7 instanceof class_3218 ? ((class_3218)lv7).method_17984() : LongSets.EMPTY_SET);
			...
			list.add(class_2874.method_12485(this.field_2079.field_1687.field_9247.method_12460()).toString() + " FC: " + Integer.toString(longSet.size()));
			list.add("");
			list.add(
				String.format(
					Locale.ROOT,
			...
			list.add(String.format("Block: %d %d %d", lv3.method_10263(), lv3.method_10264(), lv3.method_10260()));
			list.add(
				String.format(
			...
			if (this.field_2079.field_1687 != null) {
				if (this.field_2079.field_1687.method_8591(lv3)) {
					class_2818 lv8 = this.method_1836();
					if (lv8.method_12223()) {
						list.add("Waiting for chunk...");
					} else {
						list.add(
							"Client Light: "
								+ lv8.method_12233(lv3, 0)
								+ " ("
						...
						class_2818 lv9 = this.method_1834();
						if (lv9 != null) {
							class_3568 lv10 = lv7.method_8398().method_12130();
							list.add(
								"Server Light: ("
									+ lv10.method_15562(class_1944.field_9284).method_15543(lv3)
									+ " sky, "
									+ lv10.method_15562(class_1944.field_9282).method_15543(lv3)
									+ " block)"
							);
						}
						...
						for (class_2902.class_2903 lv11 : class_2902.class_2903.values()) {
							if (lv11.method_16137()) {
								stringBuilder.append(" ").append((String)field_19274.get(lv11)).append(": ").append(lv8.method_12005(lv11, lv3.method_10263(), lv3.method_10260()));
							}
						}
						...
						if (lv9 != null) {
							...
							for (class_2902.class_2903 lv11x : class_2902.class_2903.values()) {
								if (lv11x.method_20454()) {
									stringBuilder.append(" ").append((String)field_19274.get(lv11x)).append(": ").append(lv9.method_12005(lv11x, lv3.method_10263(), lv3.method_10260()));
								}
							}
						...
						if (lv3.method_10264() >= 0 && lv3.method_10264() < 256) {
							list.add("Biome: " + class_2378.field_11153.method_10221(lv8.method_16552(lv3)));
							long l = 0L;
							float h = 0.0F;
							if (lv9 != null) {
								h = lv7.method_8391();
							...
							class_1266 lv12 = new class_1266(lv7.method_8407(), lv7.method_8532(), l, h);
							list.add(
								String.format(
									Locale.ROOT, "Local Difficulty: %.2f // %.2f (Day %d)", lv12.method_5457(), lv12.method_5458(), this.field_2079.field_1687.method_8532() / 24000L
								)
							);
						}
					}
			...
			if (this.field_2082.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv13 = ((class_3965)this.field_2082).method_17777();
				list.add(String.format("Looking at block: %d %d %d", lv13.method_10263(), lv13.method_10264(), lv13.method_10260()));
			}

			if (this.field_2083.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv13 = ((class_3965)this.field_2083).method_17777();
				list.add(String.format("Looking at liquid: %d %d %d", lv13.method_10263(), lv13.method_10264(), lv13.method_10260()));
			}

			list.add(this.field_2079.method_1483().method_20305());
			return list;
		}
	}
	...
	private String method_20603() {
		class_1132 lv = this.field_2079.method_1576();
		if (lv != null) {
			class_3218 lv2 = lv.method_3847(this.field_2079.field_1687.method_8597().method_12460());
			if (lv2 != null) {
				return lv2.method_8457();
			}
		}
	...
	private class_2818 method_1834() {
		if (this.field_2080 == null) {
			...
			if (lv != null) {
				...
				if (lv2 != null) {
					this.field_2080 = lv2.method_14178()
						.method_17299(this.field_2085.field_9181, this.field_2085.field_9180, class_2806.field_12803, false)
						.thenApply(either -> either.map(arg -> (class_2818)arg, arg -> null));
				}
			}
	...
	protected List<String> method_1839() {
		...
		if (this.field_2079.method_1555()) {
			...
			if (this.field_2082.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv = ((class_3965)this.field_2082).method_17777();
			...
			if (this.field_2083.method_17783() == class_239.class_240.field_1332) {
				class_2338 lv = ((class_3965)this.field_2083).method_17777();
	...
	private void method_15870(class_3517 arg, int i, int j, boolean bl) {
		...
		if (bl && this.field_2079.field_1690.field_1909 > 0 && this.field_2079.field_1690.field_1909 <= 250) {
			this.hLine(i, i + p - 1, t - 1 - (int)(1800.0 / (double)this.field_2079.field_1690.field_1909), -16711681);
		}
