...
public class class_2669 extends class_2586 implements class_3000 {
	...
	private class_2680 method_11496() {
		return !this.method_11501() && this.method_11515() && this.field_12204.method_11614() instanceof class_2665
			...
			if (!list2.isEmpty()) {
				...
				for(int i = 0; i < list2.size(); ++i) {
					...
					if (lv4.method_5657() != class_3619.field_15975) {
						if (bl) {
							class_243 lv5 = lv4.method_18798();
							double e = lv5.field_1352;
							double g = lv5.field_1351;
							double h = lv5.field_1350;
							switch(lv.method_10166()) {
								case field_11048:
									e = (double)lv.method_10148();
									break;
								case field_11052:
									g = (double)lv.method_10164();
									break;
								case field_11051:
									h = (double)lv.method_10165();
							}

							lv4.method_18800(e, g, h);
						}

						double j = 0.0;

						for(int k = 0; k < list.size(); ++k) {
							class_238 lv6 = this.method_11502(this.method_11500((class_238)list.get(k)), lv, d);
							class_238 lv7 = lv4.method_5829();
							if (lv6.method_994(lv7)) {
								j = Math.max(j, this.method_11497(lv6, lv, lv7));
								if (j >= d) {
									break;
								}
							}
						...
						if (!(j <= 0.0)) {
							j = Math.min(j, d) + 0.01;
							field_12205.set(lv);
							lv4.method_5784(class_1313.field_6310, new class_243(j * (double)lv.method_10148(), j * (double)lv.method_10164(), j * (double)lv.method_10165()));
	...
	private void method_11514(class_1297 arg, class_2350 arg2, double d) {
		...
		if (lv.method_994(lv2)) {
			...
			if (Math.abs(e - f) < 0.01) {
				...
				arg.method_5784(class_1313.field_6310, new class_243(e * (double)lv3.method_10148(), e * (double)lv3.method_10164(), e * (double)lv3.method_10165()));
				field_12205.set(null);
			}
		}
	}
		...
		if (this.field_12206 >= 1.0F) {
			...
			if (this.field_12204 != null && this.field_11863.method_8320(this.field_11867).method_11614() == class_2246.field_10008) {
				...
				if (lv.method_11588()) {
					...
					if (lv.method_11570(class_2741.field_12508) && lv.method_11654(class_2741.field_12508)) {
