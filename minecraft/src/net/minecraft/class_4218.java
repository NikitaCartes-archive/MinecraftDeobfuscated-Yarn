...
public class class_4218 extends class_4097<class_1314> {
	...
	protected Set<Pair<class_4140<?>, class_4141>> method_18914() {
		return ImmutableSet.of(
			Pair.of(class_4140.field_19006, class_4141.field_18456),
			Pair.of(class_4140.field_18445, class_4141.field_18457),
			Pair.of(class_4140.field_18446, class_4141.field_18458),
			Pair.of(class_4140.field_18447, class_4141.field_18458)
		);
	}
	...
	private Map<class_1309, Integer> method_19592(class_1314 arg) {
		Map<class_1309, Integer> map = Maps.newHashMap();
		this.method_19594(arg).stream().filter(this::method_19593).forEach(argx -> this.method_19576(argx));
		return map;
	}

	private List<class_1309> method_19594(class_1314 arg) {
		return (List<class_1309>)arg.method_18868().method_19543(class_4140.field_19006).get();
	}

	private class_1309 method_19576(class_1309 arg) {
		return (class_1309)arg.method_18868().method_19543(class_4140.field_18447).get();
	}

	@Nullable
	private class_1309 method_19586(class_1309 arg) {
		return (class_1309)((List)arg.method_18868().method_19543(class_4140.field_19006).get())
			.stream()
	...
	private boolean method_19593(class_1309 arg) {
		return arg.method_18868().method_19543(class_4140.field_18447).isPresent();
	}

	private boolean method_19577(class_1309 arg, class_1309 arg2) {
		return arg2.method_18868().method_19543(class_4140.field_18447).filter(arg2x -> arg2x == arg).isPresent();
	}
