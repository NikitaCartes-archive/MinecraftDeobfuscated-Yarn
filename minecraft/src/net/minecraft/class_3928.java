...
public class class_3928 extends class_437 {
	...
	public void render(int i, int j, float f) {
		...
		if (l - this.field_19101 > 2000L) {
			this.field_19101 = l;
			class_333.field_2054.method_19788(new class_2588("narrator.loading").getString());
		}
		...
		this.drawCenteredString(this.font, class_3532.method_15340(this.field_17406.method_17679(), 0, 100) + "%", k, m - 9 / 2 - 30, 16777215);
	}
