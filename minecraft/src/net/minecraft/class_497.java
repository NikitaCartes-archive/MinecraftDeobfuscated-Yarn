...
public class class_497 extends class_437 {
	...
	protected void init() {
		...
		this.field_3009 = this.addButton(
			new class_4185(this.width / 2 + 4 + 100, 120, 50, 20, class_1074.method_4662("structure_block.button.detect_size"), arg -> {
				if (this.field_2980.method_11374() == class_2776.field_12695) {
		...
		this.field_3005 = new class_342(this.font, this.width / 2 - 152, 40, 300, 20, class_1074.method_4662("structure_block.structure_name")) {
			@Override
		...
		this.field_2982 = new class_342(this.font, this.width / 2 - 152, 80, 80, 20, class_1074.method_4662("structure_block.position.x"));
		...
		this.field_2999 = new class_342(this.font, this.width / 2 - 72, 80, 80, 20, class_1074.method_4662("structure_block.position.y"));
		...
		this.field_3010 = new class_342(this.font, this.width / 2 + 8, 80, 80, 20, class_1074.method_4662("structure_block.position.z"));
		...
		this.field_2988 = new class_342(this.font, this.width / 2 - 152, 120, 80, 20, class_1074.method_4662("structure_block.size.x"));
		...
		this.field_2998 = new class_342(this.font, this.width / 2 - 72, 120, 80, 20, class_1074.method_4662("structure_block.size.y"));
		...
		this.field_2978 = new class_342(this.font, this.width / 2 + 8, 120, 80, 20, class_1074.method_4662("structure_block.size.z"));
		...
		this.field_3000 = new class_342(this.font, this.width / 2 - 152, 120, 80, 20, class_1074.method_4662("structure_block.integrity.integrity"));
		...
		this.field_2992 = new class_342(this.font, this.width / 2 - 72, 120, 80, 20, class_1074.method_4662("structure_block.integrity.seed"));
		...
		this.field_2986 = new class_342(this.font, this.width / 2 - 152, 120, 240, 20, class_1074.method_4662("structure_block.custom_data"));
