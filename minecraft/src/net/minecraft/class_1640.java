...
public class class_1640 extends class_3763 implements class_1603 {
	...
	public class_1640(class_1299<? extends class_1640> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	protected void method_5959() {
		super.method_5959();
		this.field_17283 = new class_3909<>(this, class_3763.class, true, arg -> arg != null && this.method_16482() && arg.method_5864() != class_1299.field_6145);
	...
	public void method_7105(class_1309 arg, float f) {
		if (!this.method_7193()) {
			...
			double d = arg.field_5987 + lv.field_1352 - this.field_5987;
			double e = arg.field_6010 + (double)arg.method_5751() - 1.1F - this.field_6010;
			double g = arg.field_6035 + lv.field_1350 - this.field_6035;
			float h = class_3532.method_15368(d * d + g * g);
			class_1842 lv2 = class_1847.field_9004;
			if (arg instanceof class_3763) {
				if (arg.method_6032() <= 4.0F) {
					lv2 = class_1847.field_8963;
				} else {
					lv2 = class_1847.field_8986;
				}

				this.method_5980(null);
			} else if (h >= 8.0F && !arg.method_6059(class_1294.field_5909)) {
				lv2 = class_1847.field_8996;
			} else if (arg.method_6032() >= 8.0F && !arg.method_6059(class_1294.field_5899)) {
				lv2 = class_1847.field_8982;
			} else if (h <= 3.0F && !arg.method_6059(class_1294.field_5911) && this.field_5974.nextFloat() < 0.25F) {
				lv2 = class_1847.field_8975;
			}

			class_1686 lv3 = new class_1686(this.field_6002, this);
			lv3.method_7494(class_1844.method_8061(new class_1799(class_1802.field_8436), lv2));
			lv3.field_5965 -= -20.0F;
			lv3.method_7485(d, e + (double)(h * 0.2F), g, 0.75F, 8.0F);
			this.field_6002
				.method_8465(
	...
	public class_1315 method_5943(class_1936 arg, class_1266 arg2, class_3730 arg3, @Nullable class_1315 arg4, @Nullable class_2487 arg5) {
		if (arg3 == class_3730.field_16459) {
