...
public abstract class class_3609 extends class_3611 {
		...
		try (class_2338.class_2340 lv = class_2338.class_2340.method_10109()) {
			for(class_2350 lv2 : class_2350.class_2353.field_11062) {
				...
				if (this.method_15748(lv3)) {
					float f = lv3.method_15763();
					float g = 0.0F;
					if (f == 0.0F) {
						if (!arg.method_8320(lv).method_11620().method_15801()) {
							class_3610 lv4 = arg.method_8316(lv.method_10074());
							if (this.method_15748(lv4)) {
								f = lv4.method_15763();
								if (f > 0.0F) {
									g = arg3.method_15763() - (f - 0.8888889F);
								}
							}
						}
					} else if (f > 0.0F) {
						g = arg3.method_15763() - f;
					}
			...
			class_243 lv5 = new class_243(d, 0.0, e);
			if (arg3.method_11654(field_15902)) {
				for(class_2350 lv6 : class_2350.class_2353.field_11062) {
					lv.method_10114(arg2).method_10118(lv6);
					if (this.method_15749(arg, lv, lv6) || this.method_15749(arg, lv.method_10084(), lv6)) {
						lv5 = lv5.method_1029().method_1031(0.0, -6.0, 0.0);
						break;
					}
				}
			}

			var27 = lv5.method_1029();
		}
	...
	protected boolean method_15749(class_1922 arg, class_2338 arg2, class_2350 arg3) {
		...
		class_3610 lv3 = arg.method_8316(arg2);
		if (lv3.method_15772().method_15780(this)) {
			return false;
		} else if (arg3 == class_2350.field_11036) {
			return true;
		} else if (lv.method_11620() == class_3614.field_15958) {
			return false;
		} else {
			boolean bl = class_2248.method_9581(lv2) || lv2 instanceof class_2510;
			return !bl && class_2248.method_9501(lv.method_11628(arg, arg2), arg3);
		}
	}
		...
		for(class_2350 lv : class_2350.class_2353.field_11062) {
			if (lv != arg3) {
				...
				Pair<class_2680, class_3610> pair = short2ObjectMap.computeIfAbsent(s, ix -> {
					class_2680 lvxx = arg.method_8320(lv2);
				...
				if (this.method_15746(arg, this.method_15750(), arg2, arg4, lv, lv2, lv3, lv4)) {
					boolean bl = short2BooleanMap.computeIfAbsent(s, ix -> {
						class_2338 lvxx = lv2.method_10074();
						class_2680 lv2xx = arg.method_8320(lvxx);
						return this.method_15736(arg, this.method_15750(), lv2, lv3, lvxx, lv2xx);
					});
					if (bl) {
						return i;
					}
	...
	protected Map<class_2350, class_3610> method_15726(class_1941 arg, class_2338 arg2, class_2680 arg3) {
		...
		for(class_2350 lv : class_2350.class_2353.field_11062) {
			...
			if (this.method_15746(arg, lv5.method_15772(), arg2, arg3, lv, lv2, lv3, lv4)) {
				...
				boolean bl = short2BooleanMap.computeIfAbsent(s, ix -> {
					class_2680 lvxx = arg.method_8320(lv6);
					return this.method_15736(arg, this.method_15750(), lv2, lv3, lv6, lvxx);
				});
				int j;
				if (bl) {
					j = 0;
	...
	private boolean method_15754(class_1922 arg, class_2338 arg2, class_2680 arg3, class_3611 arg4) {
		...
		if (lv instanceof class_2402) {
			...
			if (lv2 != class_3614.field_15919 && lv2 != class_3614.field_15927 && lv2 != class_3614.field_15947 && lv2 != class_3614.field_15926) {
				return !lv2.method_15801();
			} else {
				return false;
			}
		} else {
	...
	protected boolean method_15738(
		...
		return arg7.method_15764(arg8, arg4) && this.method_15732(arg4, arg, arg2, arg3, arg5, arg6) && this.method_15754(arg, arg5, arg6, arg8);
	}

	protected abstract int method_15739(class_1941 arg);

	protected int method_15753(class_1937 arg, class_3610 arg2, class_3610 arg3) {
	...
	public void method_15778(class_1937 arg, class_2338 arg2, class_3610 arg3) {
		if (!arg3.method_15771()) {
			...
			int i = this.method_15753(arg, arg3, lv);
			if (lv.method_15769()) {
				arg3 = lv;
	...
	@Override
	public float method_15788(class_3610 arg) {
