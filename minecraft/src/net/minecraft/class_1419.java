...
public class class_1419 {
			...
			if (!lv.method_7325()) {
				...
				if (this.field_6727.method_19500(lv2)) {
					for (int i = 0; i < 10; i++) {
						...
						this.field_6721 = lv2.method_10263() + class_3532.method_15375(class_3532.method_15362(f) * 32.0F);
						this.field_6720 = lv2.method_10264();
						this.field_6719 = lv2.method_10260() + class_3532.method_15375(class_3532.method_15374(f) * 32.0F);
						if (this.method_6448(new class_2338(this.field_6721, this.field_6720, this.field_6719)) != null) {
							this.field_6722 = 0;
							this.field_6723 = 20;
							break;
						}
	...
	private class_243 method_6448(class_2338 arg) {
		for (int i = 0; i < 10; i++) {
			int j = arg.method_10263() + this.field_6727.field_9229.nextInt(16) - 8;
			int k = arg.method_10260() + this.field_6727.field_9229.nextInt(16) - 8;
			int l = this.field_6727.method_8589(class_2902.class_2903.field_13202, j, k);
			class_2338 lv = new class_2338(j, l, k);
			if (this.field_6727.method_19500(lv) && class_1948.method_8660(class_1317.class_1319.field_6317, this.field_6727, lv, class_1299.field_6051)) {
