...
public class class_1058 {
	...
	protected class_1058(class_2960 arg, class_1050 arg2, @Nullable class_1079 arg3) {
		this.field_5257 = arg;
		if (arg3 != null) {
			int i = Math.min(arg2.field_5227, arg2.field_5226);
			this.field_5260 = this.field_5261 = i;
		} else {
			if (arg2.field_5226 != arg2.field_5227) {
	...
	private void method_4591(int i) {
		...
		if (i > 0) {
			...
			for(int j = i + 1; j < this.field_5262.length; ++j) {
				if (this.field_5262[j] != null) {
					this.field_5262[j].close();
				}
			}
		}
	...
	public void method_4587(int i, int j, int k, int l, boolean bl) {
		this.field_5258 = k;
		this.field_5256 = l;
		this.field_5266 = bl;
	...
	public void method_4576(class_3298 arg, int i) throws IOException {
		...
		if (this.field_5271 != null && this.field_5271.method_4682() > 0) {
			int l = this.field_5271.method_4688().stream().max(Integer::compareTo).get() + 1;
	...
	public void method_4590(int i) {
		try {
			...
			lv2.method_577("Frame sizes", () -> {
				...
				for(class_1011 lvxx : this.field_5262) {
					if (stringBuilder.length() > 0) {
						stringBuilder.append(", ");
					}

					stringBuilder.append(lvxx == null ? "null" : lvxx.method_4307() + "x" + lvxx.method_4323());
				}
