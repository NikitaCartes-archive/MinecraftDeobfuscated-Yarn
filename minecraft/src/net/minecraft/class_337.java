...
public class class_337 extends class_332 {
	...
	private final Map<UUID, class_345> field_2060 = Maps.newLinkedHashMap();
	...
	public void method_1796() {
		if (!this.field_2060.isEmpty()) {
			...
			for(class_345 lv : this.field_2060.values()) {
				...
				this.field_2058.field_1772.method_1720(string, (float)(i / 2 - this.field_2058.field_1772.method_1727(string) / 2), (float)(j - 9), 16777215);
				j += 10 + 9;
	...
	private void method_1799(int i, int j, class_1259 arg) {
		this.method_1788(i, j, 0, arg.method_5420().ordinal() * 5 * 2, 182, 5);
		if (arg.method_5415() != class_1259.class_1261.field_5795) {
			this.method_1788(i, j, 0, 80 + (arg.method_5415().ordinal() - 1) * 5 * 2, 182, 5);
		}

		int k = (int)(arg.method_5412() * 183.0F);
		if (k > 0) {
			this.method_1788(i, j, 0, arg.method_5420().ordinal() * 5 * 2 + 5, k, 5);
			if (arg.method_5415() != class_1259.class_1261.field_5795) {
				this.method_1788(i, j, 0, 80 + (arg.method_5415().ordinal() - 1) * 5 * 2 + 5, k, 5);
			}
		}
	}
