...
public class class_1493 extends class_1321 {
	...
	public class_1493(class_1937 arg) {
		super(class_1299.field_6055, arg);
		this.method_5835(0.6F, 0.85F);
	...
	protected void method_5959() {
		...
		this.field_6185.method_6277(4, new class_1404(this, class_1429.class, false, arg -> arg instanceof class_1472 || arg instanceof class_1463));
	...
	public void method_5773() {
		...
		if (this.method_5637()) {
			...
			if (this.field_6947 > 0.4F) {
				...
				for(int j = 0; j < i; ++j) {
					float g = (this.field_5974.nextFloat() * 2.0F - 1.0F) * this.field_5998 * 0.5F;
					float h = (this.field_5974.nextFloat() * 2.0F - 1.0F) * this.field_5998 * 0.5F;
					this.field_6002
						.method_8406(
							class_2398.field_11202, this.field_5987 + (double)g, (double)(f + 0.8F), this.field_6035 + (double)h, this.field_5967, this.field_5984, this.field_6006
						);
				}
			}
		}
	...
	public boolean method_5992(class_1657 arg, class_1268 arg2) {
		...
		if (this.method_6181()) {
			if (!lv.method_7960()) {
				if (lv2 instanceof class_1789) {
					class_1789 lv3 = (class_1789)lv2;
					if (lv3.method_7833() && this.field_6011.method_12789(field_6948) < 20.0F) {
						if (!arg.field_7503.field_7477) {
							lv.method_7934(1);
						}

						this.method_6025((float)lv3.method_7832(lv));
						return true;
					}
				} else if (lv2 instanceof class_1769) {
					class_1767 lv4 = ((class_1769)lv2).method_7802();
					if (lv4 != this.method_6713()) {
						this.method_6708(lv4);
						if (!arg.field_7503.field_7477) {
							lv.method_7934(1);
						}
	...
	public boolean method_6481(class_1799 arg) {
		...
		return lv instanceof class_1789 && ((class_1789)lv).method_7833();
	}
	...
	public class_1493 method_6717(class_1296 arg) {
		class_1493 lv = new class_1493(this.field_6002);
	...
	public boolean method_6474(class_1429 arg) {
		if (arg == this) {
			...
			if (!lv.method_6181()) {
				return false;
			} else if (lv.method_6172()) {
				return false;
			} else {
				return this.method_6479() && lv.method_6479();
			}
		}
	}
	...
	public boolean method_6178(class_1309 arg, class_1309 arg2) {
		if (!(arg instanceof class_1548) && !(arg instanceof class_1571)) {
			...
			if (arg instanceof class_1657 && arg2 instanceof class_1657 && !((class_1657)arg2).method_7256((class_1657)arg)) {
				...
				return !(arg instanceof class_1496) || !((class_1496)arg).method_6727();
			}
		} else {
			return false;
		}
	...
	class class_1494<T extends class_1297> extends class_1338<T> {
		...
		public boolean method_6264() {
			if (super.method_6264() && this.field_6390 instanceof class_1501) {
				return !this.field_6954.method_6181() && this.method_6720((class_1501)this.field_6390);
			} else {
				return false;
			}
		}
