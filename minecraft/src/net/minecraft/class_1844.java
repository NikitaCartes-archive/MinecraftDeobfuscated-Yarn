	...
	public static class_1799 method_8056(class_1799 arg, Collection<class_1293> collection) {
		if (collection.isEmpty()) {
			...
			for(class_1293 lv3 : collection) {
				lv2.method_10606(lv3.method_5582(new class_2487()));
			}
	...
	public static void method_8065(class_1799 arg, List<class_2561> list, float f) {
		...
		if (list2.isEmpty()) {
			...
			for(class_1293 lv : list2) {
				...
				list.add(lv2.method_10854(lv3.method_5570() ? class_124.field_1061 : class_124.field_1078));
			}
		}
		...
		if (!list3.isEmpty()) {
			...
			for(class_3545<String, class_1322> lv6 : list3) {
				...
				if (d > 0.0) {
					list.add(
						new class_2588(
								"attribute.modifier.plus." + lv7.method_6182().method_6191(),
								class_1799.field_8029.format(e),
								new class_2588("attribute.name." + (String)lv6.method_15442())
							)
					...
					list.add(
						new class_2588(
								"attribute.modifier.take." + lv7.method_6182().method_6191(),
								class_1799.field_8029.format(e),
								new class_2588("attribute.name." + (String)lv6.method_15442())
							)
