...
public abstract class class_2500 extends class_2493 {
	...
	private static boolean method_10614(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		if (lv2.method_11614() == class_2246.field_10477 && (Integer)lv2.method_11654(class_2488.field_11518) == 1) {
			return true;
		} else {
				...
				if (arg2.method_8602(arg3.method_10084()) >= 9) {
					...
					for (int i = 0; i < 4; i++) {
						...
						if (arg2.method_8320(lv2).method_11614() == class_2246.field_10566 && method_10613(lv, arg2, lv2)) {
							arg2.method_8501(lv2, lv.method_11657(field_11522, Boolean.valueOf(arg2.method_8320(lv2.method_10084()).method_11614() == class_2246.field_10477)));
						}
					}
				}
			}
