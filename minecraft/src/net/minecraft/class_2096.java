...
public abstract class class_2096<T extends Number> {
	...
	public static class class_2099 extends class_2096<Float> {
		...
		public boolean method_9047(float f) {
			if (this.field_9702 != null && this.field_9702 > f) {
				return false;
			} else {
				return this.field_9699 == null || !(this.field_9699 < f);
			}
		}

		public boolean method_9045(double d) {
			if (this.field_9703 != null && this.field_9703 > d) {
				return false;
			} else {
				return this.field_9704 == null || !(this.field_9704 < d);
			}
		}
	...
	public static class class_2100 extends class_2096<Integer> {
		...
		public boolean method_9054(int i) {
			if (this.field_9702 != null && this.field_9702 > i) {
				return false;
			} else {
				return this.field_9699 == null || this.field_9699 >= i;
			}
		}
