...
public class class_457 extends class_437 implements class_632.class_633 {
	...
	public boolean method_16807(double d, double e, int i) {
		if (i == 0) {
			int j = (this.field_2561 - 252) / 2;
			int k = (this.field_2559 - 140) / 2;
	...
	public boolean method_16805(int i, int j, int k) {
		if (this.field_2563.field_1690.field_1844.method_1417(i, j)) {
			this.field_2563.method_1507(null);
			this.field_2563.field_1729.method_1612();
			return true;
		} else {
	...
	public void method_2214(int i, int j, float f) {
		int k = (this.field_2561 - 252) / 2;
		int l = (this.field_2559 - 140) / 2;
		this.method_2240();
	...
	private void method_2337(int i, int j, int k, int l) {
		...
		if (lv == null) {
			method_1785(k + 9, l + 18, k + 9 + 234, l + 18 + 113, -16777216);
			String string = class_1074.method_4662("advancements.empty");
			int m = this.field_2554.method_1727(string);
			this.field_2554.method_1729(string, (float)(k + 9 + 117 - m / 2), (float)(l + 18 + 56 - 9 / 2), -1);
			this.field_2554.method_1729(":(", (float)(k + 9 + 117 - this.field_2554.method_1727(":(") / 2), (float)(l + 18 + 113 - 9), -1);
		} else {
	...
	public void method_2334(int i, int j) {
		...
		this.field_2563.method_1531().method_4618(field_2717);
		this.method_1788(i, j, 0, 0, 252, 140);
		if (this.field_2719.size() > 1) {
			this.field_2563.method_1531().method_4618(field_2716);
			...
			for (class_454 lv : this.field_2719.values()) {
				lv.method_2315(i, j, this.field_2560);
			}

			GlStateManager.disableBlend();
		}

		this.field_2554.method_1729(class_1074.method_4662("gui.advancements"), (float)(i + 8), (float)(j + 6), 4210752);
	}
		...
		if (this.field_2719.size() > 1) {
			for (class_454 lv : this.field_2719.values()) {
				if (lv.method_2316(k, l, (double)i, (double)j)) {
					this.method_2215(lv.method_2309(), i, j);
				}
			}
		}
	}
	...
	public void method_723(class_161 arg) {
		class_454 lv = class_454.method_2317(this.field_2563, this, this.field_2719.size(), arg);
		if (lv != null) {
