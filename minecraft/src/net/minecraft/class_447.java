...
public class class_447 extends class_437 implements class_452 {
	...
	@Nullable
	public class_4280<?> method_19399() {
		return this.field_2643;
	}

	public void method_19390(@Nullable class_4280<?> arg) {
	...
	@Environment(EnvType.CLIENT)
	class class_4198 extends class_4280<class_447.class_4198.class_4197> {
		public class_4198(class_310 arg2) {
			...
			for(class_3445<class_2960> lv : class_3468.field_15419) {
				this.addEntry(new class_447.class_4198.class_4197(lv));
			}
		}
		...
		@Environment(EnvType.CLIENT)
		class class_4197 extends class_4280.class_4281<class_447.class_4198.class_4197> {
	...
	@Environment(EnvType.CLIENT)
	class class_4200 extends class_4280<class_447.class_4200.class_4199> {
		...
		public class_4200(class_310 arg2) {
			...
			for(class_2248 lv3 : class_2378.field_11146) {
				...
				for(class_3448<class_2248> lv2 : this.field_18754) {
					if (lv2.method_14958(lv3) && class_447.this.field_2647.method_15025(lv2.method_14956(lv3)) > 0) {
						bl = true;
					}
				}
			...
			for(int i = 0; i < this.field_18757.size(); ++i) {
				this.addEntry(new class_447.class_4200.class_4199());
			}
		}
		...
		protected void renderDecorations(int i, int j) {
			if (j >= this.field_19085 && j <= this.field_19086) {
				class_447.class_4200.class_4199 lv = this.getEntryAtPosition((double)i, (double)j);
		...
		@Environment(EnvType.CLIENT)
		class class_4199 extends class_4280.class_4281<class_447.class_4200.class_4199> {
			private class_4199() {
			}
		...
		class class_450 implements Comparator<class_1792> {
			...
			public int method_2297(class_1792 arg, class_1792 arg2) {
				...
				if (class_4200.this.field_18759 == null) {
					...
					class_3448<class_2248> lv = class_4200.this.field_18759;
					...
					class_3448<class_1792> lv = class_4200.this.field_18759;
	...
	@Environment(EnvType.CLIENT)
	class class_4202 extends class_4280<class_447.class_4202.class_4201> {
		public class_4202(class_310 arg2) {
			...
			for(class_1299<?> lv : class_2378.field_11145) {
				if (class_447.this.field_2647.method_15025(class_3468.field_15403.method_14956(lv)) > 0
					...
					this.addEntry(new class_447.class_4202.class_4201(lv));
				}
			}
		}
		...
		@Environment(EnvType.CLIENT)
		class class_4201 extends class_4280.class_4281<class_447.class_4202.class_4201> {
