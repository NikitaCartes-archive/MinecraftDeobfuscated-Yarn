...
public class class_3910 extends class_1703 {
	...
	public final class_1263 field_17293 = new class_1277(2) {
		@Override
	...
	private final class_1731 field_19272 = new class_1731() {
		@Override
		public void method_5431() {
			class_3910.this.method_7609(this);
			super.method_5431();
	...
	public class_3910(int i, class_1661 arg, class_3914 arg2) {
		...
		this.method_7621(new class_1735(this.field_19272, 2, 145, 39) {
			@Override
			public boolean method_7680(class_1799 arg) {
				return false;
			}
			...
			public class_1799 method_7671(int i) {
				class_1799 lv = super.method_7671(i);
				class_1799 lv2 = (class_1799)arg2.method_17395((arg2xx, arg3) -> {
					if (!class_3910.this.field_17295 && class_3910.this.field_17293.method_5438(1).method_7909() == class_1802.field_8141) {
						class_1799 lvxx = class_1806.method_17442(arg2xx, class_3910.this.field_17293.method_5438(0));
						if (lvxx != null) {
							lvxx.method_7939(1);
							return lvxx;
						}
				...
				class_3910.this.field_17293.method_5434(0, 1);
				class_3910.this.field_17293.method_5434(1, 1);
				return lv2;
			}
			...
			protected void method_7678(class_1799 arg, int i) {
				this.method_7671(i);
				super.method_7678(arg, i);
			}

			@Override
			public class_1799 method_7667(class_1657 arg, class_1799 arg2) {
				arg2.method_7909().method_7843(arg2, arg.field_6002, arg);
				arg2.method_17393((argx, arg2xxx) -> argx.method_8396(null, arg2xxx, class_3417.field_17484, class_3419.field_15245, 1.0F, 1.0F));
	...
	public boolean method_7597(class_1657 arg) {
		return method_17695(this.field_17294, arg, class_2246.field_16336);
	}
	...
	public void method_7609(class_1263 arg) {
		...
		class_1799 lv3 = this.field_19272.method_5438(2);
	...
	private void method_17381(class_1799 arg, class_1799 arg2, class_1799 arg3) {
		this.field_17294.method_17393((arg4, arg5) -> {
			...
			class_22 lv2 = class_1806.method_7997(arg, arg4);
			if (lv2 != null) {
				class_1799 lv3;
				...
				if (!class_1799.method_7973(lv3, arg3)) {
					this.field_19272.method_5447(2, lv3);
					this.method_7623();
				}
			}
		});
			...
			if (i == 2) {
				if (this.field_17293.method_5438(1).method_7909() == class_1802.field_8141) {
					lv4 = (class_1799)this.field_17294.method_17395((arg2, arg3) -> {
						class_1799 lvxx = class_1806.method_17442(arg2, this.field_17293.method_5438(0));
						if (lvxx != null) {
							lvxx.method_7939(1);
							return lvxx;
						} else {
