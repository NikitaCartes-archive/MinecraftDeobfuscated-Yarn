...
public class class_1213 extends DataFix {
	public class_1213(Schema schema, boolean bl) {
		super(schema, bl);
	}

	@Override
	protected TypeRewriteRule makeRule() {
		Type<?> type = this.getOutputSchema().getType(class_1208.field_5730);
		Type<?> type2 = this.getInputSchema().getType(class_1208.field_5730);
