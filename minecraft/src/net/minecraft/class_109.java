...
public class class_109 extends class_120 {
	...
	public static class_109.class_4279 method_20238() {
		return new class_109.class_4279();
	}
		...
		public class_109 method_490(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, class_209[] args) {
			...
			if (jsonObject.has("enchantments")) {
				for (JsonElement jsonElement : class_3518.method_15261(jsonObject, "enchantments")) {
					...
					class_1887 lv = (class_1887)class_2378.field_11160
	...
	public static class class_4279 extends class_120.class_121<class_109.class_4279> {
		private final Set<class_1887> field_19180 = Sets.<class_1887>newHashSet();

		protected class_109.class_4279 method_20239() {
			return this;
		}

		public class_109.class_4279 method_20240(class_1887 arg) {
			this.field_19180.add(arg);
			return this;
		}

		@Override
		public class_117 method_515() {
			return new class_109(this.method_526(), this.field_19180);
		}
	}
}
