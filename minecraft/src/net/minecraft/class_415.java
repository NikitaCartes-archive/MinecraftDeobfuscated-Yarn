...
public class class_415 extends class_437 {
	...
	private void method_2161() {
		...
		if (this.field_19098.method_10573("biome_source", 10) && this.field_19098.method_10562("biome_source").method_10573("biomes", 9)) {
			...
			for(int i = 0; i < lv2.size(); ++i) {
				class_2960 lv3 = new class_2960(lv2.method_10608(i));
				this.field_2441
					.method_20089(
	...
	private class_2487 method_2153() {
		...
		lv4.add(new class_2519(this.field_2441.method_20064().field_19099.toString()));
	...
	public void method_2151() {
		this.field_2438.active = this.field_2441.method_20064() != null;
	}
	...
	@Environment(EnvType.CLIENT)
	class class_4190 extends class_350<class_415.class_4190.class_4191> {
		private class_4190() {
			...
			class_2378.field_11153
				...
				.forEach(argx -> this.method_1901(new class_415.class_4190.class_4191(argx)));
		}
		...
		@Environment(EnvType.CLIENT)
		class class_4191 extends class_350.class_351<class_415.class_4190.class_4191> {
