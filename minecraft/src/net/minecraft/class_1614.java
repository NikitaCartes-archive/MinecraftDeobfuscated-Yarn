...
public class class_1614 extends class_1588 {
	...
	public class_1614(class_1937 arg) {
		super(class_1299.field_6125, arg);
		this.method_5835(0.4F, 0.3F);
	}
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		if (super.method_5979(arg, arg2)) {
			class_1657 lv = arg.method_8613(this, 5.0);
			return lv == null;
		} else {
			return false;
		}
	...
	static class class_1615 extends class_1379 {
		...
		public boolean method_6264() {
			if (this.field_6566.method_5968() != null) {
				...
				if (this.field_6566.field_6002.method_8450().method_8355("mobGriefing") && random.nextInt(10) == 0) {
					...
					for (int j = 0; j <= 10 && j >= -10; j = (j <= 0 ? 1 : 0) - j) {
						for (int k = 0; k <= 10 && k >= -10; k = (k <= 0 ? 1 : 0) - k) {
							...
							if (lv5 instanceof class_2384) {
								if (lv.method_8450().method_8355("mobGriefing")) {
