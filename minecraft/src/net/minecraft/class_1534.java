...
public class class_1534 extends class_1530 {
	...
	public class_1534(class_1299<? extends class_1534> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public class_1534(class_1937 arg, class_2338 arg2, class_2350 arg3) {
		...
		for(class_1535 lv : class_2378.field_11150) {
			...
			if (this.method_6888()) {
				list.add(lv);
				int j = lv.method_6945() * lv.method_6943();
				if (j > i) {
					i = j;
				}
			}
		...
		if (!list.isEmpty()) {
			...
			while(iterator.hasNext()) {
				class_1535 lv = (class_1535)iterator.next();
				if (lv.method_6945() * lv.method_6943() < i) {
					iterator.remove();
				}
			}
	...
	public int method_6897() {
		return this.field_7134 == null ? 1 : this.field_7134.method_6945();
	}

	@Override
	public int method_6891() {
		return this.field_7134 == null ? 1 : this.field_7134.method_6943();
	}
