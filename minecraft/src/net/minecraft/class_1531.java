...
public class class_1531 extends class_1309 {
	...
	public class_1531(class_1299<? extends class_1531> arg, class_1937 arg2) {
		super(arg, arg2);
		this.field_6013 = 0.0F;
	}

	public class_1531(class_1937 arg, double d, double e, double f) {
		this(class_1299.field_6131, arg);
	...
	public boolean method_18397(class_1799 arg) {
		...
		return this.method_6118(lv).method_7960() && !this.method_6915(lv);
	}
	...
	public void method_5749(class_2487 arg) {
		...
		this.field_5960 = !this.method_18059();
	...
	public boolean method_5643(class_1282 arg, float f) {
		if (this.field_6002.field_9236 || this.field_5988) {
			...
			boolean bl2 = bl && ((class_1665)arg.method_5526()).method_7447() > 0;
			boolean bl3 = "player".equals(arg.method_5525());
			if (!bl3 && !bl) {
				return false;
		...
		if (this.field_6002 instanceof class_3218) {
			((class_3218)this.field_6002)
				.method_14199(
					...
					this.field_5987,
					this.field_6010 + (double)this.method_17682() / 1.5,
					this.field_6035,
					10,
					(double)(this.method_17681() / 4.0F),
					(double)(this.method_17682() / 4.0F),
					(double)(this.method_17681() / 4.0F),
					0.05
				);
		}
	...
	private void method_6908(class_1282 arg) {
		...
		for(int i = 0; i < this.field_7108.size(); ++i) {
			class_1799 lv = this.field_7108.get(i);
			if (!lv.method_7960()) {
				class_2248.method_9577(this.field_6002, new class_2338(this).method_10084(), lv);
				this.field_7108.set(i, class_1799.field_8037);
			}
		}
	}
	...
	protected float method_18394(class_4050 arg, class_4048 arg2) {
		return arg2.field_18068 * (this.method_6109() ? 0.5F : 0.9F);
	}
	...
	public void method_5674(class_2940<?> arg) {
		if (field_7107.equals(arg)) {
			this.method_18382();
			this.field_6033 = !this.method_6912();
		}
	...
	public class_4048 method_18377(class_4050 arg) {
		float f = this.method_6912() ? 0.0F : (this.method_6109() ? 0.5F : 1.0F);
		return this.method_5864().method_18386().method_18383(f);
	}
}
