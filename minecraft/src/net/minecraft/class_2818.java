...
public class class_2818 implements class_2791 {
	...
	private final Map<String, class_3449> field_12838 = Maps.newHashMap();
	private final Map<String, LongSet> field_12845 = Maps.newHashMap();
	...
	public class_2818(class_1937 arg, int i, int j, class_1959[] args) {
		this(arg, i, j, args, class_2843.field_12950, class_1925.method_8339(), class_1925.method_8339(), 0L, null);
	}
	...
	public class_2818(
		...
		class_1959[] args,
		class_2843 arg2,
		class_1951<class_2248> arg3,
		class_1951<class_3611> arg4,
		long l,
		@Nullable Consumer<class_2818> consumer
	) {
		this(arg, i, j, args, arg2, arg3, arg4, l, null, consumer);
	}
	...
	public class_2818(
		...
		this.field_12848 = new class_1923(i, j);
		this.field_12849 = arg2;
		...
		for(int k = 0; k < this.field_12833.length; ++k) {
			this.field_12833[k] = new class_3509<>(class_1297.class);
		}

		this.field_12842 = args;
		this.field_12841 = arg3;
		this.field_12857 = arg4;
		this.field_12843 = l;
	...
	public class_2818(class_1937 arg, class_2839 arg2, int i, int j) {
		this(arg, i, j, arg2.method_12036(), arg2.method_12003(), arg2.method_12303(), arg2.method_12313(), arg2.method_12033(), null);

		for(int k = 0; k < this.field_12840.length; ++k) {
			this.field_12840[k] = arg2.method_12006()[k];
		}

		for(class_2487 lv : arg2.method_12295()) {
			class_2852.method_12383(lv, arg, this);
		}
		...
		for(int k = 0; k < arg2.method_12012().length; ++k) {
			this.field_12836[k] = arg2.method_12012()[k];
		}
		...
		for(Entry<class_2902.class_2903, class_2902> entry : arg2.method_12011()) {
			if (((class_2902.class_2903)entry.getKey()).method_16136()) {
	...
	public class_2680 method_12010(class_2338 arg, class_2680 arg2, boolean bl) {
		...
		if (lv2 == arg2) {
			...
			if (lv.method_12254(i, j & 15, k).method_11614() != lv3) {
				...
				if (!this.field_12858.field_9236) {
					arg2.method_11580(this.field_12858, arg, lv2);
				}
	...
	public void method_12206() {
		...
		this.field_12858.method_8447(this.field_12854.values());

		for(class_3509<class_1297> lv : this.field_12833) {
			this.field_12858.method_8555(lv.stream().filter(arg -> !(arg instanceof class_1657)));
		}
	}
	...
	public void method_12213() {
		...
		for(class_2586 lv : this.field_12854.values()) {
			this.field_12858.method_8556(lv);
		}

		for(class_3509<class_1297> lv2 : this.field_12833) {
			this.field_12858.method_8512(lv2);
		}
	}
	...
	public boolean method_12228(int i, int j) {
		...
		for(int k = i; k <= j; k += 16) {
			class_2826 lv = this.field_12840[k >> 4];
			if (lv != field_12852 && !lv.method_12261()) {
				return false;
			}
		}
	...
	public void method_12224(class_2540 arg, class_2487 arg2, int i, boolean bl) {
		if (bl) {
			...
			Iterator<class_2338> iterator = this.field_12854.keySet().iterator();

			while(iterator.hasNext()) {
				class_2338 lv = (class_2338)iterator.next();
				int j = lv.method_10264() >> 4;
				if ((i & 1 << j) != 0) {
					iterator.remove();
				}
			}
		...
		for(int k = 0; k < this.field_12840.length; ++k) {
			class_2826 lv2 = this.field_12840[k];
			if ((i & 1 << k) == 0) {
				if (bl && lv2 != field_12852) {
					this.field_12840[k] = field_12852;
				}
			} else {
				if (lv2 == field_12852) {
					lv2 = new class_2826(k << 4);
					this.field_12840[k] = lv2;
				}

				lv2.method_12258(arg);
			}
		}

		if (bl) {
			for(int k = 0; k < this.field_12842.length; ++k) {
				this.field_12842[k] = class_2378.field_11153.method_10200(arg.readInt());
			}
		}

		for(class_2902.class_2903 lv3 : class_2902.class_2903.values()) {
			String string = lv3.method_12605();
			if (arg2.method_10573(string, 12)) {
				this.method_12037(lv3, arg2.method_10565(string));
			}
		}

		for(class_2586 lv4 : this.field_12854.values()) {
			lv4.method_11000();
		}
	}
	...
	public boolean method_12229() {
		return this.field_12855;
	}
	...
	public Stream<class_2338> method_12018() {
		return StreamSupport.stream(
				class_2338.class_2339.method_10094(
