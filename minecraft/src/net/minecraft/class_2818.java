...
public class class_2818 implements class_2791 {
	...
	private class_1951<class_2248> field_12841;
	private class_1951<class_3611> field_12857;
	...
	public void method_12216(class_2586 arg) {
		...
		if (this.field_12855 || this.field_12858.method_8608()) {
			this.field_12858.method_8526(arg.method_11016(), arg);
		}
	}
	...
	public void method_12007(class_2338 arg, class_2586 arg2) {
		if (this.method_8320(arg).method_11614() instanceof class_2343) {
			...
			arg2.method_10996();
			class_2586 lv = (class_2586)this.field_12854.put(arg.method_10062(), arg2);
			if (lv != null && lv != arg2) {
				lv.method_11012();
			}
		}
	...
	public class_2487 method_20598(class_2338 arg) {
		...
		if (lv != null && !lv.method_11015()) {
			class_2487 lv2 = lv.method_11007(new class_2487());
			lv2.method_10556("keepPacked", false);
			return lv2;
		} else {
			class_2487 lv2 = (class_2487)this.field_12846.get(arg);
			if (lv2 != null) {
				lv2 = lv2.method_10553();
				lv2.method_10556("keepPacked", true);
			}
	...
	public void method_12224(class_2540 arg, class_2487 arg2, int i, boolean bl) {
		...
		if (bl) {
			for(int j = 0; j < this.field_12842.length; ++j) {
				this.field_12842[j] = class_2378.field_11153.method_10200(arg.readInt());
			}
		}
	...
	public void method_20530() {
		if (this.field_12841 instanceof class_2850) {
			...
			this.field_12841 = class_1925.method_8339();
		} else if (this.field_12841 instanceof class_4296) {
			this.field_12858.method_8397().method_20470(((class_4296)this.field_12841).method_20462());
			this.field_12841 = class_1925.method_8339();
		}
		...
		if (this.field_12857 instanceof class_2850) {
			...
			this.field_12857 = class_1925.method_8339();
		} else if (this.field_12857 instanceof class_4296) {
			this.field_12858.method_8405().method_20470(((class_4296)this.field_12857).method_20462());
			this.field_12857 = class_1925.method_8339();
		}
	}

	public void method_20471(class_3218 arg) {
		if (this.field_12841 == class_1925.method_8339()) {
			this.field_12841 = new class_4296<>(class_2378.field_11146::method_10221, arg.method_14196().method_8671(this.field_12848, true, false));
			this.method_12008(true);
		}

		if (this.field_12857 == class_1925.method_8339()) {
			this.field_12857 = new class_4296<>(class_2378.field_11154::method_10221, arg.method_14179().method_8671(this.field_12848, true, false));
			this.method_12008(true);
		}
	}
