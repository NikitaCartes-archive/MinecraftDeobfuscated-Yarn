	...
	private void method_3364(class_1920 arg, class_2680 arg2, class_2338 arg3, int[] is, class_2350 arg4, @Nullable float[] fs, BitSet bitSet) {
		...
		switch(arg4) {
			case field_11033:
				...
				bitSet.set(0, (g < 1.0E-4F || arg2.method_11604(arg, arg3)) && g == j);
				break;
			case field_11036:
				bitSet.set(1, f >= 1.0E-4F || h >= 1.0E-4F || i <= 0.9999F || k <= 0.9999F);
				bitSet.set(0, (j > 0.9999F || arg2.method_11604(arg, arg3)) && g == j);
				break;
			case field_11043:
				bitSet.set(1, f >= 1.0E-4F || g >= 1.0E-4F || i <= 0.9999F || j <= 0.9999F);
				bitSet.set(0, (h < 1.0E-4F || arg2.method_11604(arg, arg3)) && h == k);
				break;
			case field_11035:
				bitSet.set(1, f >= 1.0E-4F || g >= 1.0E-4F || i <= 0.9999F || j <= 0.9999F);
				bitSet.set(0, (k > 0.9999F || arg2.method_11604(arg, arg3)) && h == k);
				break;
			case field_11039:
				bitSet.set(1, g >= 1.0E-4F || h >= 1.0E-4F || j <= 0.9999F || k <= 0.9999F);
				bitSet.set(0, (f < 1.0E-4F || arg2.method_11604(arg, arg3)) && f == i);
				break;
			case field_11034:
				bitSet.set(1, g >= 1.0E-4F || h >= 1.0E-4F || j <= 0.9999F || k <= 0.9999F);
				bitSet.set(0, (i > 0.9999F || arg2.method_11604(arg, arg3)) && f == i);
		}
	}
