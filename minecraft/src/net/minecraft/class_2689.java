...
public class class_2689<O, S extends class_2688<S>> {
	...
	protected <A extends class_2679<O, S>> class_2689(O object, class_2689.class_2691<O, S, A> arg, Map<String, class_2769<?>> map) {
		...
		Map<Map<class_2769<?>, Comparable<?>>, A> map2 = Maps.newLinkedHashMap();
		...
		stream.forEach(list2 -> {
			Map<class_2769<?>, Comparable<?>> map2xx = class_2367.method_10209(this.field_12316.values(), list2);
			A lv = arg.create(object, ImmutableMap.copyOf(map2xx));
			map2.put(map2xx, lv);
			list.add(lv);
		});
