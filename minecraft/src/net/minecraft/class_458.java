...
public class class_458 extends class_437 {
	...
	protected void init() {
		...
		this.field_2725 = this.addButton(new class_4185(this.width / 2 - 155, this.height - 29, 150, 20, class_1074.method_4662("controls.resetAll"), arg -> {
			for(class_304 lvxx : this.minecraft.field_1690.field_1839) {
				lvxx.method_1422(lvxx.method_1429());
			}
		...
		this.addButton(
			new class_4185(
				this.width / 2 - 155 + 160, this.height - 29, 150, 20, class_1074.method_4662("gui.done"), arg -> this.minecraft.method_1507(this.field_2729)
			)
		);
	}
