...
public class class_1669 extends class_1297 {
	...
	public class_1669(class_1299<? extends class_1669> arg, class_1937 arg2) {
		super(arg, arg2);
	}

	public class_1669(class_1937 arg, double d, double e, double f, float g, int i, class_1309 arg2) {
		this(class_1299.field_6060, arg);
		this.field_7609 = i;
	...
	public class_1309 method_7470() {
		if (this.field_7605 == null && this.field_7606 != null && this.field_6002 instanceof class_3218) {
			class_1297 lv = ((class_3218)this.field_6002).method_14190(this.field_7606);
		...
		if (this.field_6002.field_9236) {
			if (this.field_7608) {
				...
				if (this.field_7607 == 14) {
					for (int i = 0; i < 12; i++) {
						double d = this.field_5987 + (this.field_5974.nextDouble() * 2.0 - 1.0) * (double)this.method_17681() * 0.5;
						double e = this.field_6010 + 0.05 + this.field_5974.nextDouble();
						double f = this.field_6035 + (this.field_5974.nextDouble() * 2.0 - 1.0) * (double)this.method_17681() * 0.5;
			...
			if (this.field_7609 == -8) {
				for (class_1309 lv : this.field_6002.method_18467(class_1309.class, this.method_5829().method_1009(0.2, 0.0, 0.2))) {
					this.method_7471(lv);
				}
			}
