...
public class LootFunctionTypes {
	...
	public static final LootFunctionType SET_INSTRUMENT = register("set_instrument", new SetGoatHornSoundLootFunction.Serializer());
		...
		switch(lootFunctions.length) {
			...
			default:
				return (stack, context) -> {
					for(BiFunction<ItemStack, LootContext, ItemStack> biFunctionxx : lootFunctions) {
						stack = (ItemStack)biFunctionxx.apply(stack, context);
					}
