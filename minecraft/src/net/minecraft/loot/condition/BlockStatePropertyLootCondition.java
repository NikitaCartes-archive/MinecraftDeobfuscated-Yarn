...
public class BlockStatePropertyLootCondition implements LootCondition {
	...
	private static Predicate<BlockState> getBlockState(Block block, Map<Property<?>, Object> properties) {
		...
		if (i == 0) {
			...
			Entry<Property<?>, Object> entry = (Entry<Property<?>, Object>)properties.entrySet().iterator().next();
			...
			for (Entry<Property<?>, Object> entry2 : properties.entrySet()) {
	...
	public static class Builder implements LootCondition.Builder {
		...
		public <T extends Comparable<T>> BlockStatePropertyLootCondition.Builder withBlockStateProperty(Property<T> property, T value) {
			...
			} else if (!property.getValues().contains(value)) {
	...
	public static class Factory extends LootCondition.Factory<BlockStatePropertyLootCondition> {
		...
		public void toJson(JsonObject jsonObject, BlockStatePropertyLootCondition blockStatePropertyLootCondition, JsonSerializationContext jsonSerializationContext) {
			...
			blockStatePropertyLootCondition.properties
				.forEach((property, value) -> jsonObject2.addProperty(property.getName(), getPropertyValueString(property, value)));
					...
					.forEach(
						entry -> {
							...
							if (property == null) {
								...
								Object object = property.parse(string2)
									.orElseThrow(
