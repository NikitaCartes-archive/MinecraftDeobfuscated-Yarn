...
public class class_3471 {
	...
	static class class_3474 {
		...
		private void method_15048() {
			...
			if (list.isEmpty()) {
				...
				class_3545<Integer, Integer> lv2 = (class_3545)list.get(this.field_15438.nextInt(list.size()));
				int j = lv.method_15066(lv2.method_15442(), lv2.method_15441());
				lv.method_15065(lv2.method_15442(), lv2.method_15441(), j | 4194304);
				class_2350 lv3 = this.method_15040(this.field_15440, lv2.method_15442(), lv2.method_15441(), 1, j & 65535);
				...
				if (list2.isEmpty()) {
					this.field_15439.method_15062(0, 0, this.field_15439.field_15454, this.field_15439.field_15453, 5);
					lv.method_15065(lv2.method_15442(), lv2.method_15441(), j);
				} else {
	...
	static class class_3475 {
		...
		public void method_15050(class_2338 arg, class_2470 arg2, List<class_3471.class_3480> list, class_3471.class_3474 arg3) {
			...
			for(int l = 0; l < 3; ++l) {
				class_2338 lv6 = arg.method_10086(8 * l + (l == 2 ? 3 : 0));
				class_3471.class_3478 lv7 = arg3.field_15443[l];
				class_3471.class_3478 lv8 = l == 2 ? lv4 : lv3;
				...
				for(int o = 0; o < lv8.field_15453; ++o) {
					for(int p = 0; p < lv8.field_15454; ++p) {
						boolean bl2 = l == 2 && lv8.method_15066(p, o) == 3;
						if (lv8.method_15066(p, o) == 2 || bl2) {
							...
							if (class_3471.class_3474.method_15047(lv8, p - 1, o) && !arg3.method_15039(lv8, p - 1, o, l, s)) {
							...
							if (class_3471.class_3474.method_15047(lv8, p, o + 1) && !arg3.method_15039(lv8, p, o + 1, l, s)) {
							...
							if (r == 65536) {
								this.method_15057(list, lv12, arg2, lv11, lvs[l]);
							} else if (r == 131072 && lv11 != null) {
								class_2350 lv14 = arg3.method_15040(lv8, p, o, l, s);
								boolean bl3 = (q & 4194304) == 4194304;
								this.method_15059(list, lv12, arg2, lv14, lv11, lvs[l], bl3);
							} else if (r == 262144 && lv11 != null && lv11 != class_2350.field_11036) {
								class_2350 lv14 = lv11.method_10170();
								if (!arg3.method_15039(lv8, p + lv14.method_10148(), o + lv14.method_10165(), l, s)) {
									lv14 = lv14.method_10153();
								}

								this.method_15056(list, lv12, arg2, lv14, lv11, lvs[l]);
							} else if (r == 262144 && lv11 == class_2350.field_11036) {
								this.method_15053(list, lv12, arg2, lvs[l]);
							}
						}
					}
				}
		...
		private void method_15055(
			List<class_3471.class_3480> list, class_2338 arg, class_2470 arg2, class_3471.class_3478 arg3, @Nullable class_3471.class_3478 arg4
		) {
			...
			if (arg4 != null) {
				for(int i = 0; i < arg3.field_15453; ++i) {
					for(int j = 0; j < arg3.field_15454; ++j) {
						...
						var17 = var17.method_10079(arg2.method_10503(class_2350.field_11034), (j - this.field_15446) * 8);
						boolean bl = class_3471.class_3474.method_15047(arg4, j, i);
						if (class_3471.class_3474.method_15047(arg3, j, i) && bl) {
							if (!class_3471.class_3474.method_15047(arg3, j + 1, i)) {
			...
			for(int i = 0; i < arg3.field_15453; ++i) {
				for(int j = 0; j < arg3.field_15454; ++j) {
					...
					var19 = var19.method_10079(arg2.method_10503(class_2350.field_11034), (j - this.field_15446) * 8);
					boolean bl = arg4 != null && class_3471.class_3474.method_15047(arg4, j, i);
					if (class_3471.class_3474.method_15047(arg3, j, i) && !bl) {
						if (!class_3471.class_3474.method_15047(arg3, j + 1, i)) {
							...
							} else if (class_3471.class_3474.method_15047(arg3, j + 1, i + 1)) {
						...
						if (!class_3471.class_3474.method_15047(arg3, j - 1, i)) {
							class_2338 lv2 = var19.method_10079(arg2.method_10503(class_2350.field_11034), 0);
							lv2 = lv2.method_10079(arg2.method_10503(class_2350.field_11035), 0);
							if (!class_3471.class_3474.method_15047(arg3, j, i + 1)) {
								class_2338 lv3 = lv2.method_10079(arg2.method_10503(class_2350.field_11035), 6);
								list.add(new class_3471.class_3480(this.field_15444, "roof_corner", lv3, arg2.method_10501(class_2470.field_11463)));
							} else if (class_3471.class_3474.method_15047(arg3, j - 1, i + 1)) {
								class_2338 lv3 = lv2.method_10079(arg2.method_10503(class_2350.field_11035), 8);
							...
							if (!class_3471.class_3474.method_15047(arg3, j, i - 1)) {
								list.add(new class_3471.class_3480(this.field_15444, "roof_corner", lv2, arg2.method_10501(class_2470.field_11464)));
							} else if (class_3471.class_3474.method_15047(arg3, j - 1, i - 1)) {
								class_2338 lv3 = lv2.method_10079(arg2.method_10503(class_2350.field_11035), 1);
		...
		private void method_15059(
			...
			if (arg4 == class_2350.field_11034 && arg3 == class_2350.field_11035) {
				...
				list.add(
					new class_3471.class_3480(
						this.field_15444, arg5.method_15033(this.field_15447, bl), lv, arg2.method_10501(class_2470.field_11463), class_2415.field_11300
					)
				);
				...
				list.add(
					new class_3471.class_3480(
						this.field_15444, arg5.method_15033(this.field_15447, bl), lv, arg2.method_10501(class_2470.field_11463), class_2415.field_11301
					)
				);
	...
	public static class class_3480 extends class_3470 {
		...
		protected void method_15026(String string, class_2338 arg, class_1936 arg2, Random random, class_3341 arg3) {
			if (string.startsWith("Chest")) {
				...
				switch(string) {
					case "Mage":
						lv3 = class_1299.field_6090.method_5883(arg2.method_8410());
						break;
					case "Warrior":
						lv3 = class_1299.field_6117.method_5883(arg2.method_8410());
						break;
					default:
						return;
				}
				...
				lv3.method_5943(arg2, arg2.method_8404(new class_2338(lv3)), class_3730.field_16474, null, null);
