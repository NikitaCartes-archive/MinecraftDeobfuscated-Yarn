...
public class class_11 {
	...
	public class_243 method_47(class_1297 arg, int i) {
		double d = (double)this.field_52[i].field_40 + (double)((int)(arg.method_17681() + 1.0F)) * 0.5;
		double e = (double)this.field_52[i].field_39;
		double f = (double)this.field_52[i].field_38 + (double)((int)(arg.method_17681() + 1.0F)) * 0.5;
	...
	public boolean method_19315() {
		...
		return lv != null && this.method_19313(lv.method_19312());
	}

	public boolean method_19313(class_243 arg) {
		class_9 lv = this.method_45();
		return lv == null ? false : lv.field_40 == (int)arg.field_1352 && lv.field_39 == (int)arg.field_1351 && lv.field_38 == (int)arg.field_1350;
	}
	...
	public String toString() {
		return "Path(length=" + this.field_53 + ")";
	}
}
