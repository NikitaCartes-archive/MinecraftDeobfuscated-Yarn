...
public class class_1533 extends class_1530 {
	...
	public class_1533(class_1937 arg) {
		super(class_1299.field_6043, arg);
	}
	...
	protected void method_6895() {
		if (this.field_7099 != null) {
			...
			g /= 32.0;
			this.method_5857(
				new class_238(this.field_5987 - e, this.field_6010 - f, this.field_6035 - g, this.field_5987 + e, this.field_6010 + f, this.field_6035 + g)
			);
		}
	}
	...
	public void method_6936(@Nullable class_1297 arg, boolean bl) {
		if (this.field_6002.method_8450().method_8355("doEntityDrops")) {
			...
			if (!lv.method_7960() && this.field_5974.nextFloat() < this.field_7129) {
				lv = lv.method_7972();
				this.method_6937(lv);
				this.method_5775(lv);
			}
