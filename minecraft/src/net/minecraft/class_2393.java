...
public class class_2393 extends class_2248 implements class_2402 {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (!arg.method_11591(arg2, arg3)) {
			...
			if (lv2.method_11614() == class_2246.field_10382 && arg.method_11654(field_11194) < 25 && random.nextDouble() < 0.14) {
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		if (lv3 == class_2246.field_10092) {
			return false;
		} else {
			return lv3 == this || lv3 == class_2246.field_10463 || class_2248.method_9501(lv2.method_11628(arg2, lv), class_2350.field_11036);
		}
	}
