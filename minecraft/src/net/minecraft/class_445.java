...
public class class_445 extends class_437 {
			...
			try {
				...
				if (this.field_2627) {
					...
					while((string2 = bufferedReader.readLine()) != null) {
						String string3;
						String string4;
						for(string2 = string2.replaceAll("PLAYERNAME", this.minecraft.method_1548().method_1676());
	...
	public void render(int i, int j, float f) {
		...
		GlStateManager.blendFunc(GlStateManager.class_5119.ZERO, GlStateManager.class_5118.ONE_MINUS_SRC_COLOR);
		int o = this.width;
		int p = this.height;
		class_289 lv = class_289.method_1348();
		class_287 lv2 = lv.method_1349();
