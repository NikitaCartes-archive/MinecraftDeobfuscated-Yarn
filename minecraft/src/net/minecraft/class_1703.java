...
public abstract class class_1703 {
	...
	public void method_7623() {
		...
		for(int i = 0; i < this.field_17285.size(); ++i) {
			class_3915 lv4 = (class_3915)this.field_17285.get(i);
			if (lv4.method_17408()) {
				for(class_1712 lv5 : this.field_7765) {
					lv5.method_7633(this, i, lv4.method_17407());
				}
			}
		}
	}
	...
	public class_1799 method_7593(int i, int j, class_1713 arg, class_1657 arg2) {
		...
		if (arg == class_1713.field_7789) {
				...
				if (lv9 != null) {
					...
					if (lv5.method_7960()) {
						...
						if (lv4.method_7960()) {
							...
							int o = lv5.method_7947();
							if (o + lv4.method_7947() <= lv4.method_7914()) {
								lv4.method_7933(o);
								lv5 = lv9.method_7671(o);
								if (lv5.method_7960()) {
									lv9.method_7673(class_1799.field_8037);
								}
			...
			class_1735 lv9 = (class_1735)this.field_7761.get(i);
			class_1799 lv5 = lv2.method_5438(j);
			class_1799 lv4 = lv9.method_7677();
			if (!lv5.method_7960() || !lv4.method_7960()) {
				if (lv5.method_7960()) {
					if (lv9.method_7674(arg2)) {
						lv2.method_5447(j, lv4);
						lv9.method_7672(lv4.method_7947());
						lv9.method_7673(class_1799.field_8037);
						lv9.method_7667(arg2, lv4);
					}
				} else if (lv4.method_7960()) {
					if (lv9.method_7680(lv5)) {
						int o = lv9.method_7676(lv5);
						if (lv5.method_7947() > o) {
							lv9.method_7673(lv5.method_7971(o));
						} else {
							lv9.method_7673(lv5);
							lv2.method_5447(j, class_1799.field_8037);
						}
					}
				} else if (lv9.method_7674(arg2) && lv9.method_7680(lv5)) {
					int o = lv9.method_7676(lv5);
					if (lv5.method_7947() > o) {
						lv9.method_7673(lv5.method_7971(o));
						lv9.method_7667(arg2, lv4);
						if (!lv2.method_7394(lv4)) {
							arg2.method_7328(lv4, true);
						}
					} else {
						lv9.method_7673(lv5);
						lv2.method_5447(j, lv4);
			...
			if (lv9 != null && lv9.method_7681()) {
				class_1799 lv5 = lv9.method_7677().method_7972();
			...
			if (lv9 != null && lv9.method_7681() && lv9.method_7674(arg2)) {
				class_1799 lv5 = lv9.method_7671(j == 0 ? 1 : lv9.method_7677().method_7947());
				lv9.method_7667(arg2, lv5);
				arg2.method_7328(lv5, true);
			}
		} else if (arg == class_1713.field_7793 && i >= 0) {
			class_1735 lv9 = (class_1735)this.field_7761.get(i);
			class_1799 lv5 = lv2.method_7399();
			if (!lv5.method_7960() && (lv9 == null || !lv9.method_7681() || !lv9.method_7674(arg2))) {
				int l = j == 0 ? 0 : this.field_7761.size() - 1;
				int o = j == 0 ? 1 : -1;

				for(int p = 0; p < 2; ++p) {
					for(int q = l; q >= 0 && q < this.field_7761.size() && lv5.method_7947() < lv5.method_7914(); q += o) {
						class_1735 lv10 = (class_1735)this.field_7761.get(q);
						if (lv10.method_7681() && method_7592(lv10, lv5, true) && lv10.method_7674(arg2) && this.method_7613(lv5, lv10)) {
							class_1799 lv11 = lv10.method_7677();
							if (p != 0 || lv11.method_7947() != lv11.method_7914()) {
								int n = Math.min(lv5.method_7914() - lv5.method_7947(), lv11.method_7947());
	...
	protected boolean method_7616(class_1799 arg, int i, int j, boolean bl) {
		...
		if (!arg.method_7960()) {
			...
			while(bl ? k >= i : k < j) {
				class_1735 lv = (class_1735)this.field_7761.get(k);
				class_1799 lv2 = lv.method_7677();
				if (lv2.method_7960() && lv.method_7680(arg)) {
					if (arg.method_7947() > lv.method_7675()) {
						lv.method_7673(arg.method_7971(lv.method_7675()));
					} else {
						lv.method_7673(arg.method_7971(arg.method_7947()));
					}
	...
	public static boolean method_7600(int i, class_1657 arg) {
		if (i == 0) {
			...
			return i == 2 && arg.field_7503.field_7477;
		}
	}
	...
	public static boolean method_7592(@Nullable class_1735 arg, class_1799 arg2, boolean bl) {
		...
		if (!bl2 && arg2.method_7962(arg.method_7677()) && class_1799.method_7975(arg.method_7677(), arg2)) {
			return arg.method_7677().method_7947() + (bl ? 0 : arg2.method_7947()) <= arg2.method_7914();
		} else {
			return bl2;
		}
	}
	...
	protected void method_7599(class_1937 arg, class_1657 arg2, class_1263 arg3, class_1731 arg4) {
		if (!arg.field_9236) {
			class_3222 lv = (class_3222)arg2;
			class_1799 lv2 = class_1799.field_8037;
			class_1860 lv3 = arg.method_8503().method_3772().method_8132(arg3, arg);
			if (arg4.method_7665(arg, lv, lv3) && lv3 != null) {
				lv2 = lv3.method_8116(arg3);
			}

			arg4.method_5447(0, lv2);
			lv.field_13987.method_14364(new class_2653(this.field_7763, 0, lv2));
		}
	}
}
