...
public class Enchantments {
	...
	public static final Enchantment field_9110 = register(
		"looting", new LuckEnchantment(Enchantment.Weight.field_9088, EnchantmentTarget.WEAPON, EquipmentSlot.field_6173)
	);
	...
	public static final Enchantment field_9130 = register(
		"fortune", new LuckEnchantment(Enchantment.Weight.field_9088, EnchantmentTarget.DIGGER, EquipmentSlot.field_6173)
	);
	...
	public static final Enchantment field_9114 = register(
		"luck_of_the_sea", new LuckEnchantment(Enchantment.Weight.field_9088, EnchantmentTarget.FISHING_ROD, EquipmentSlot.field_6173)
	);
	public static final Enchantment field_9100 = register(
		"lure", new LureEnchantment(Enchantment.Weight.field_9088, EnchantmentTarget.FISHING_ROD, EquipmentSlot.field_6173)
	);
