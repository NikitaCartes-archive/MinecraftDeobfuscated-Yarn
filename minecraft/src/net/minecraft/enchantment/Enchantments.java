...
import net.minecraft.class_5511;
...
public class Enchantments {
	...
	public static final Enchantment CLEAVING = register("cleaving", new class_5511(Enchantment.Rarity.RARE, EquipmentSlot.MAINHAND));
