...
public class ProtectionEnchantment extends Enchantment {
	...
	public ProtectionEnchantment(Enchantment.Weight weight, ProtectionEnchantment.Type type, EquipmentSlot... equipmentSlots) {
		...
		if (type == ProtectionEnchantment.Type.field_9140) {
			this.field_9083 = EnchantmentTarget.ARMOR_FEET;
		}
	}
	...
	public boolean differs(Enchantment enchantment) {
		if (enchantment instanceof ProtectionEnchantment) {
			...
			if (this.type == protectionEnchantment.type) {
				...
				return this.type == ProtectionEnchantment.Type.field_9140 || protectionEnchantment.type == ProtectionEnchantment.Type.field_9140;
			}
		} else {
