...
public class class_1621 extends class_1308 implements class_1569 {
	...
	public class_1621(class_1299<? extends class_1621> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	protected void method_7155(class_1309 arg) {
		if (this.method_5805()) {
			int i = this.method_7152();
			if (this.method_5858(arg) < 0.6 * (double)i * 0.6 * (double)i
				&& this.method_6057(arg)
	...
	public static boolean method_20685(class_1299<class_1621> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		if (arg2.method_8401().method_153() == class_1942.field_9277 && random.nextInt(4) != 1) {
			return false;
		} else {
			if (arg2.method_8407() != class_1267.field_5801) {
				class_1959 lv = arg2.method_8310(arg4);
				if (lv == class_1972.field_9471
					&& arg4.method_10264() > 50
					&& arg4.method_10264() < 70
					&& random.nextFloat() < 0.5F
					&& random.nextFloat() < arg2.method_8391()
					&& arg2.method_8602(arg4) <= random.nextInt(8)) {
					return method_20636(arg, arg2, arg3, arg4, random);
				}

				class_1923 lv2 = new class_1923(arg4);
				boolean bl = class_2919.method_12662(lv2.field_9181, lv2.field_9180, arg2.method_8412(), 987234911L).nextInt(10) == 0;
				if (random.nextInt(10) == 0 && bl && arg4.method_10264() < 40) {
					return method_20636(arg, arg2, arg3, arg4, random);
				}
			}
	...
	protected void method_6043() {
		...
		this.method_18800(lv.field_1352, 0.42F, lv.field_1350);
	...
	public class_4048 method_18377(class_4050 arg) {
		return super.method_18377(arg).method_18383(0.255F * (float)this.method_7152());
	}
	...
	static class class_1623 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			return (this.field_7394.method_5799() || this.field_7394.method_5771()) && this.field_7394.method_5962() instanceof class_1621.class_1625;
		}
	...
	static class class_1626 extends class_1352 {
		...
		public boolean method_6264() {
			return this.field_7402.method_5968() == null
				...
				&& this.field_7402.method_5962() instanceof class_1621.class_1625;
		}
