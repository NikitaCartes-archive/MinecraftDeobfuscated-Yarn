...
public class class_3074 extends class_3031<class_3067> {
	...
	public boolean method_13423(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, class_3067 arg4) {
		...
		for(int p = -o; p < o; ++p) {
			for(int q = -o; q < o; ++q) {
				for(int r = -1; r > -m; --r) {
					int s = bl2 ? class_3532.method_15386((float)o * (1.0F - (float)Math.pow((double)r, 2.0) / ((float)m * 8.0F))) : o;
					int t = this.method_13427(random, -r, m, n);
					if (p < t) {
						this.method_13426(arg, random, arg3, m, p, r, q, t, s, bl2, j, d, bl, lv);
					}
				}
			}
		}
	...
	private void method_13428(Random random, class_1936 arg, int i, int j, class_2338 arg2, boolean bl, int k, double d, int l) {
		...
		class_2338 lv = new class_2338(m * o, 0, n * p);
	...
	private void method_13426(
		...
		double e = bl
			? this.method_13424(j, l, class_2338.field_10980, n, this.method_13416(k, i, o), d)
			: this.method_13421(j, l, class_2338.field_10980, m, random);
		if (e < 0.0) {
			class_2338 lv = arg2.method_10069(j, k, l);
