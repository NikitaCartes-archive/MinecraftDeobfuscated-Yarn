...
public class CrashReportElement {
	private final CrashReport report;
	private final String title;
	private final List<CrashReportElement.Element> elements = Lists.<CrashReportElement.Element>newArrayList();
	private StackTraceElement[] stackTrace = new StackTraceElement[0];

	public CrashReportElement(CrashReport crashReport, String string) {
	...
	public void add(String string, Object object) {
		this.elements.add(new CrashReportElement.Element(string, object));
	}
	...
	public void addStackTrace(StringBuilder stringBuilder) {
		...
		for (CrashReportElement.Element element : this.elements) {
			stringBuilder.append("\n\t");
	...
	public static void addBlockInfo(CrashReportElement crashReportElement, BlockPos blockPos, @Nullable BlockState blockState) {
		if (blockState != null) {
			crashReportElement.add("Block", blockState::toString);
		}

		crashReportElement.add("Block location", (ICrashCallable<String>)(() -> createPositionString(blockPos)));
	}
