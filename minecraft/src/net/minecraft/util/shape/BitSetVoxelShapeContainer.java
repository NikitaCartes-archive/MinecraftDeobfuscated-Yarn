	...
	static BitSetVoxelShapeContainer method_1040(
		...
		arg.method_1065((i, j, k) -> {
			...
			boolean bl = arg2.method_1065((l, m, n) -> {
				...
				boolean blxx = arg3.method_1065((o, p, q) -> {
					boolean blxxx = booleanBiFunction.apply(abstractVoxelShapeContainer.method_1044(i, l, o), abstractVoxelShapeContainer2.method_1044(j, m, p));
					if (blxxx) {
