...
public class BuiltinRegistries {
	...
	public static final Registry<ConfiguredCarver<?>> CONFIGURED_CARVER = addRegistry(Registry.CONFIGURED_CARVER_KEY, registryx -> ConfiguredCarvers.CAVE);
	...
	public static final Registry<Structure> STRUCTURE = addRegistry(Registry.STRUCTURE_KEY, Structures::getDefault);
	...
	public static final Registry<StructureProcessorList> STRUCTURE_PROCESSOR_LIST = addRegistry(
		Registry.STRUCTURE_PROCESSOR_LIST_KEY, registryx -> StructureProcessorLists.ZOMBIE_PLAINS
	);
	...
	private static <T> Registry<T> addRegistry(RegistryKey<? extends Registry<T>> registryRef, Lifecycle lifecycle, BuiltinRegistries.Initializer<T> initializer) {
		return addRegistry(registryRef, new SimpleRegistry<>(registryRef, lifecycle), initializer, lifecycle);
	}
	...
	public static <V extends T, T> RegistryEntry<V> addCasted(Registry<T> registry, String id, V value) {
		return add(registry, new Identifier(id), (T)value);
	}
