...
public abstract class Registry<T> implements IndexedIterable<T> {
	...
	public static final Registry<TrunkPlacerType<?>> TRUNK_PLACER_TYPE = create("trunk_placer_type", () -> TrunkPlacerType.STRAIGHT_TRUNK_PLACER);
	...
	public static final Registry<FeatureSizeType<?>> FEATURE_SIZE_TYPE = create("feature_size_type", () -> FeatureSizeType.TWO_LAYERS_FEATURE_SIZE);
	...
	public static final Registry<EntityAttribute> ATTRIBUTES = create("attributes", () -> EntityAttributes.GENERIC_LUCK);
