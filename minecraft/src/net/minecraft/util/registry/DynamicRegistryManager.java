...
public abstract class DynamicRegistryManager {
	...
	private static final Map<RegistryKey<? extends Registry<?>>, DynamicRegistryManager.Info<?>> INFOS = Util.make(() -> {
		...
		register(builder, Registry.field_25912, ConfiguredSurfaceBuilder.field_25878);
		register(builder, Registry.field_25913, ConfiguredCarver.field_25832);
		register(builder, Registry.field_25914, ConfiguredFeature.field_25833);
		register(builder, Registry.field_25915, ConfiguredStructureFeature.CODEC);
		register(builder, Registry.field_25916, StructureProcessorType.field_25876);
		register(builder, Registry.field_25917, StructurePool.CODEC);
		register(builder, Registry.field_26374, ChunkGeneratorSettings.CODEC);
	...
	private static <E> void method_31141(DynamicRegistryManager.Impl impl, RegistryOps.class_5506.class_5507 arg, DynamicRegistryManager.Info<E> info) {
		...
		boolean bl = !registryKey.equals(Registry.field_26374) && !registryKey.equals(Registry.DIMENSION_TYPE_KEY);
	...
	private static <E> void load(RegistryOps<?> ops, DynamicRegistryManager.Impl manager, DynamicRegistryManager.Info<E> info) {
		RegistryKey<? extends Registry<E>> registryKey = info.getRegistry();
		SimpleRegistry<E> simpleRegistry = (SimpleRegistry)Optional.ofNullable(manager.registries.get(registryKey))
