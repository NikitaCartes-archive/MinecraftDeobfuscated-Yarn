...
public class ChunkRandom extends AtomicSimpleRandom {
	...
	public int next(int bits) {
		++this.sampleCount;
		AbstractRandom var3 = this.baseRandom;
		return var3 instanceof AtomicSimpleRandom atomicSimpleRandom ? atomicSimpleRandom.next(bits) : (int)(this.baseRandom.nextLong() >>> 64 - bits);
	}
