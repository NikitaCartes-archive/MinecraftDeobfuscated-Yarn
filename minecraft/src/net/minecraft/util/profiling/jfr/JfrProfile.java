...
public final class JfrProfile extends Record {
	...
	public PacketSample.Statistics packetReadStatistics() {
		return this.packetReadStatistics;
	}

	public PacketSample.Statistics packetSentStatistics() {
