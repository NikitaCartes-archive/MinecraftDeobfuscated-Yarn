...
public class HitResult {
	...
	public String toString() {
		return "HitResult{type=" + this.type + ", blockpos=" + this.blockPos + ", f=" + this.field_1327 + ", pos=" + this.pos + ", entity=" + this.entity + '}';
	}
