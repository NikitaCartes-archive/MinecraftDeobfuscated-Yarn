...
public class class_2881 {
	...
	private void method_12515() {
		...
		List<class_1510> list = this.field_13108.method_18776();
		if (list.isEmpty()) {
			this.field_13115 = true;
		} else {
	...
	private void method_12520() {
		...
		for(class_3222 lv : this.field_13108.method_18766(field_13113)) {
	...
	private void method_12535() {
		...
		for(class_3310.class_3181 lv : class_3310.method_14506(this.field_13108)) {
			this.field_13106 += this.field_13108.method_18467(class_1511.class, lv.method_13968()).size();
		}
	...
	public void method_12528(class_1510 arg) {
		if (arg.method_5667().equals(this.field_13116)) {
			...
			if (!this.field_13114) {
				this.field_13108
					.method_8501(this.field_13108.method_8598(class_2902.class_2903.field_13197, class_3033.field_13600), class_2246.field_10081.method_9564());
			}
	...
	private void method_12519() {
		if (!this.field_13121.isEmpty()) {
			int i = this.field_13121.remove(this.field_13121.size() - 1);
			int j = class_3532.method_15357(96.0 * Math.cos(2.0 * (-Math.PI + (Math.PI / 20) * (double)i)));
			int k = class_3532.method_15357(96.0 * Math.sin(2.0 * (-Math.PI + (Math.PI / 20) * (double)i)));
			this.method_12516(new class_2338(j, 75, k));
		}
	}

	private void method_12516(class_2338 arg) {
		this.field_13108.method_20290(3000, arg, 0);
		class_3031.field_13564.method_13151(this.field_13108, this.field_13108.method_14178().method_12129(), new Random(), arg, class_3018.method_18030());
	}
	...
	private void method_12518(boolean bl) {
		...
		lv.method_13163(this.field_13108, this.field_13108.method_14178().method_12129(), new Random(), this.field_13117, class_3037.field_13603);
	}

	private class_1510 method_12523() {
		this.field_13108.method_8500(new class_2338(0, 128, 0));
		class_1510 lv = class_1299.field_6116.method_5883(this.field_13108);
	...
	public void method_12522() {
		if (this.field_13115 && this.field_13120 == null) {
			...
			for(class_2350 lv4 : class_2350.class_2353.field_11062) {
				List<class_1511> list2 = this.field_13108.method_18467(class_1511.class, new class_238(lv3.method_10079(lv4, 2)));
				if (list2.isEmpty()) {
					return;
				}
	...
	public void method_12524() {
		for(class_3310.class_3181 lv : class_3310.method_14506(this.field_13108)) {
			for(class_1511 lv2 : this.field_13108.method_18467(class_1511.class, lv.method_13968())) {
