...
public class class_1571 extends class_1307 implements class_1569 {
	...
	public class_1571(class_1299<? extends class_1571> arg, class_1937 arg2) {
		super(arg, arg2);
		this.field_6194 = 5;
	...
	protected void method_5959() {
		...
		this.field_6185.method_6277(1, new class_1400(this, class_1657.class, 10, true, false, arg -> Math.abs(arg.field_6010 - this.field_6010) <= 4.0));
	}
	...
	public static boolean method_20675(class_1299<class_1571> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		return arg2.method_8407() != class_1267.field_5801 && random.nextInt(20) == 0 && method_20636(arg, arg2, arg3, arg4, random);
	}
	...
	static class class_1572 extends class_1352 {
		...
		public void method_6268() {
			if (this.field_7274.method_5968() == null) {
				class_243 lv = this.field_7274.method_18798();
				this.field_7274.field_6031 = -((float)class_3532.method_15349(lv.field_1352, lv.field_1350)) * (180.0F / (float)Math.PI);
				this.field_7274.field_6283 = this.field_7274.field_6031;
			} else {
				class_1309 lv2 = this.field_7274.method_5968();
				double d = 64.0;
				if (lv2.method_5858(this.field_7274) < 4096.0) {
					double e = lv2.field_5987 - this.field_7274.field_5987;
					double f = lv2.field_6035 - this.field_7274.field_6035;
	...
	static class class_1573 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6374 == class_1335.class_1336.field_6378) {
				if (this.field_7276-- <= 0) {
					this.field_7276 += this.field_7275.method_6051().nextInt(5) + 2;
					class_243 lv = new class_243(
						this.field_6370 - this.field_7275.field_5987, this.field_6369 - this.field_7275.field_6010, this.field_6367 - this.field_7275.field_6035
					);
					double d = lv.method_1033();
					lv = lv.method_1029();
					if (this.method_7051(lv, class_3532.method_15384(d))) {
						this.field_7275.method_18799(this.field_7275.method_18798().method_1019(lv.method_1021(0.1)));
					} else {
		...
		private boolean method_7051(class_243 arg, int i) {
			class_238 lv = this.field_7275.method_5829();

			for(int j = 1; j < i; ++j) {
				lv = lv.method_997(arg);
		...
		public void method_6268() {
			...
			if (lv.method_5858(this.field_7277) < 4096.0 && this.field_7277.method_6057(lv)) {
				...
				if (this.field_7278 == 20) {
					...
					double g = lv.method_5829().field_1322
						+ (double)(lv.method_17682() / 2.0F)
						- (0.5 + this.field_7277.field_6010 + (double)(this.field_7277.method_17682() / 2.0F));
					...
					lv4.field_6010 = this.field_7277.field_6010 + (double)(this.field_7277.method_17682() / 2.0F) + 0.5;
