...
public class DefaultResourcePack implements ResourcePack, ResourceFactory {
	...
	private static final Map<ResourceType, FileSystem> TYPE_TO_FILE_SYSTEM = Util.make(Maps.newHashMap(), hashMap -> {
		synchronized(DefaultResourcePack.class) {
			for(ResourceType resourceType : ResourceType.values()) {
				...
				try {
					...
					LOGGER.error("Couldn't get a list of all vanilla resources", var13);
				}
			}
		}
	});
