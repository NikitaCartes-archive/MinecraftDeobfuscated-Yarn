...
public class DefaultResourcePack implements ResourcePack {
	...
	private static final Map<ResourceType, FileSystem> typeToFileSystem = Util.create(Maps.newHashMap(), hashMap -> {
	...
	public <T> T parseMetadata(ResourceMetadataReader<T> metaReader) throws IOException {
		try {
			...
			Object var4;
			try {
				var4 = AbstractFileResourcePack.<T>parseMetadata(metaReader, inputStream);
