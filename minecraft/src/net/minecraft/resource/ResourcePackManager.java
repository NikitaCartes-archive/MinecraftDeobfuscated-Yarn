...
public class ResourcePackManager {
	...
	public void scanPacks() {
		List<String> list = (List)this.enabled.stream().map(ResourcePackProfile::getId).collect(ImmutableList.toImmutableList());
	...
	private List<ResourcePackProfile> buildEnabledProfiles(Collection<String> enabledNames) {
		List<ResourcePackProfile> list = (List)this.streamProfilesById(enabledNames).collect(Collectors.toList());
