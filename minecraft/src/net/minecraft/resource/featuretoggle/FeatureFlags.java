...
public class FeatureFlags {
	...
	public static final Codec<FeatureSet> CODEC = FEATURE_MANAGER.getCodec();
	public static final FeatureSet VANILLA_FEATURES = FeatureSet.of(VANILLA);
	public static final FeatureSet DEFAULT_ENABLED_FEATURES = VANILLA_FEATURES;
	...
	static {
		...
		UPDATE_1_20 = builder.addVanillaFlag("update_1_20");
