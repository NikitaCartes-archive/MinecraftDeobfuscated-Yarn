...
public class class_1916 extends ArrayList<class_1914> {
	...
	public void method_8270(class_2540 arg) {
		...
		for (int i = 0; i < this.size(); i++) {
			class_1914 lv = (class_1914)this.get(i);
			arg.method_10793(lv.method_19272());
			...
			arg.writeInt(lv.method_19279());
			arg.writeInt(lv.method_19277());
			arg.writeFloat(lv.method_19278());
		}
	}
	...
	public static class_1916 method_8265(class_2540 arg) {
		...
		for (int j = 0; j < i; j++) {
			...
			class_1914 lv5 = new class_1914(lv2, lv4, lv3, k, l, m, f);
			if (bl) {
				lv5.method_8254();
			}
