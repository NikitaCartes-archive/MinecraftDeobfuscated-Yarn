...
public class class_238 {
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			if (Double.compare(lv.field_1323, this.field_1323) != 0) {
				...
				return false;
			} else if (Double.compare(lv.field_1325, this.field_1325) != 0) {
				return false;
			} else {
				return Double.compare(lv.field_1324, this.field_1324) == 0;
			}
		}
	}
	...
	public double method_995() {
		double d = this.field_1320 - this.field_1323;
		double e = this.field_1325 - this.field_1322;
		double f = this.field_1324 - this.field_1321;
		return (d + e + f) / 3.0;
	}

	public class_238 method_1000(double d, double e, double f) {
		return this.method_1009(-d, -e, -f);
	}
	...
	@Nullable
	public class_239 method_1004(class_243 arg, class_243 arg2) {
		return this.method_992(arg, arg2, null);
	}

	@Nullable
	public class_239 method_992(class_243 arg, class_243 arg2, @Nullable class_2338 arg3) {
		...
		lv = method_1007(arg3 == null ? this : this.method_996(arg3), arg, ds, lv, d, e, f);
		if (lv == null) {
			return null;
		} else {
			double g = ds[0];
			return new class_239(arg.method_1031(g * d, g * e, g * f), lv, arg3 == null ? class_2338.field_10980 : arg3);
		}
	}

	@Nullable
	public static class_239 method_1010(Iterable<class_238> iterable, class_243 arg, class_243 arg2, class_2338 arg3) {
		double[] ds = new double[]{1.0};
		class_2350 lv = null;
		double d = arg2.field_1352 - arg.field_1352;
		double e = arg2.field_1351 - arg.field_1351;
		...
		if (lv == null) {
			...
			double g = ds[0];
			return new class_239(arg.method_1031(g * d, g * e, g * f), lv, arg3);
		}
	}
