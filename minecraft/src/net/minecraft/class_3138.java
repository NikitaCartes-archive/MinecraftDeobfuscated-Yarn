...
public class class_3138 {
	...
	private static int method_13694(class_2168 arg, class_2960 arg2, class_243 arg3, class_2487 arg4, boolean bl) throws CommandSyntaxException {
		...
		if (class_1299.method_5890(class_1299.field_6112).equals(arg2)) {
			class_1297 lv2 = new class_1538(arg.method_9225(), arg3.field_1352, arg3.field_1351, arg3.field_1350, false);
			arg.method_9225().method_8416(lv2);
			arg.method_9226(new class_2588("commands.summon.success", lv2.method_5476()), true);
			return 1;
		} else {
			class_1297 lv2 = class_2852.method_12399(lv, arg.method_9225(), arg3.field_1352, arg3.field_1351, arg3.field_1350, true);
			if (lv2 == null) {
				throw field_13741.create();
			} else {
				lv2.method_5808(arg3.field_1352, arg3.field_1351, arg3.field_1350, lv2.field_6031, lv2.field_5965);
				if (bl && lv2 instanceof class_1308) {
					((class_1308)lv2).method_5943(arg.method_9225(), arg.method_9225().method_8404(new class_2338(lv2)), class_3730.field_16462, null, null);
				}
