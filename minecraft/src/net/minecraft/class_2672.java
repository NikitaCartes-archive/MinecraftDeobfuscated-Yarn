...
public class class_2672 implements class_2596<class_2602> {
	...
	public class_2672(class_2818 arg, int i) {
		...
		for(Entry<class_2338, class_2586> entry : arg.method_12214().entrySet()) {
			class_2338 lv2 = (class_2338)entry.getKey();
			class_2586 lv3 = (class_2586)entry.getValue();
	...
	public int method_11529(class_2540 arg, class_2818 arg2, int i) {
		...
		if (this.method_11530()) {
			...
			for(int l = 0; l < lvs2.length; ++l) {
				arg.writeInt(class_2378.field_11153.method_10249(lvs2[l]));
			}
		}
