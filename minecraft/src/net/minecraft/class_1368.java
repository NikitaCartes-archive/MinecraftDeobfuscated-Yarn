...
public class class_1368 extends class_1352 {
			...
			if (!lv.method_19497(lv2, 6)) {
				...
				class_243 lv3 = class_1414.method_19108(this.field_6525, 15, 7, arg3 -> {
					if (!lv.method_19500(arg3)) {
						...
						Optional<class_2338> optionalxx = lv.method_19494()
							.method_19127(class_4158.field_18501, this::method_19052, arg3, 10, class_4153.class_4155.field_18488);
						return !optionalxx.isPresent() ? Double.NEGATIVE_INFINITY : -((class_2338)optionalxx.get()).method_10262(lv2);
					}
				});
				if (lv3 == null) {
					return false;
	...
	public boolean method_6266() {
		if (this.field_6525.method_5942().method_6357()) {
			...
			return !this.field_18412.method_19769(this.field_6525.method_19538(), (double)(this.field_6525.method_17681() + (float)this.field_18414));
		}
	}
