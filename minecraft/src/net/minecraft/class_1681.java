...
public class class_1681 extends class_3857 {
	public class_1681(class_1299<? extends class_1681> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	protected void method_7492(class_239 arg) {
		if (arg.method_17783() == class_239.class_240.field_1331) {
			((class_3966)arg).method_17782().method_5643(class_1282.method_5524(this, this.method_7491()), 0.0F);
		}
		...
		if (!this.field_6002.field_9236) {
			if (this.field_5974.nextInt(8) == 0) {
				...
				for (int j = 0; j < i; j++) {
					class_1428 lv = class_1299.field_6132.method_5883(this.field_6002);
