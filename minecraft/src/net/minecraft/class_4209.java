...
public class class_4209 {
	...
	public static void method_19470(World world, MobEntity mobEntity, Path path, float f) {
	}

	public static void method_19472(World world, BlockPos blockPos) {
	}

	public static void method_19474(IWorld iWorld, StructureStart structureStart) {
	}
