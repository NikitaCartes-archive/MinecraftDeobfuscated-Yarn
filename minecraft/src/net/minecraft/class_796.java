...
public class class_796 {
	...
	private void method_3462(int[] is, class_2350 arg) {
		...
		for(int j = 0; j < 4; ++j) {
			int k = 7 * j;
			class_753.class_755 lv2 = lv.method_3162(j);
			float h = fs[lv2.field_3975];
			...
			for(int n = 0; n < 4; ++n) {
				...
				if (class_3532.method_15347(h, p) && class_3532.method_15347(l, q) && class_3532.method_15347(m, r)) {
					is[k + 4] = js[o + 4];
					is[k + 4 + 1] = js[o + 4 + 1];
				}
			}
