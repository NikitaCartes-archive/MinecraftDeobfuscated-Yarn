...
public class class_1439 extends class_1427 {
	...
	protected void method_5959() {
		...
		this.field_6201.method_6277(2, new class_4291(this, 0.6));
	...
	public boolean method_5957(class_1941 arg) {
		...
		if (!lv3.method_11631(arg, lv2, this)) {
			...
			for (int i = 1; i < 3; i++) {
				class_2338 lv4 = lv.method_10086(i);
				class_2680 lv5 = arg.method_8320(lv4);
				if (!class_1948.method_8662(arg, lv4, lv5, lv5.method_11618())) {
					return false;
				}
			}

			return class_1948.method_8662(arg, lv, arg.method_8320(lv), class_3612.field_15906.method_15785()) && arg.method_8606(this);
		}
	}
}
