...
public class class_1685 extends class_1665 {
	...
	public void method_5773() {
		...
		if ((this.field_7648 || this.method_7441()) && lv != null) {
			...
			if (i > 0 && !this.method_7493()) {
				...
				this.field_6010 += lv2.field_1351 * 0.015 * (double)i;
				...
				this.field_5967 += lv2.field_1352 * d - this.field_5967 * 0.05;
				this.field_5984 += lv2.field_1351 * d - this.field_5984 * 0.05;
				this.field_6006 += lv2.field_1350 * d - this.field_6006 * 0.05;
	...
	private boolean method_7493() {
		...
		if (lv == null || !lv.method_5805()) {
			...
			return !(lv instanceof class_3222) || !((class_3222)lv).method_7325();
		}
	}
