...
public class class_1685 extends class_1665 {
	...
	public class_1685(class_1937 arg) {
		super(class_1299.field_6127, arg);
	}
	...
	public void method_5773() {
		...
		if ((this.field_7648 || this.method_7441()) && lv != null) {
			...
			if (i > 0 && !this.method_7493()) {
				...
				this.field_5967 = this.field_5967 + (lv2.field_1352 * d - this.field_5967 * 0.05);
				this.field_5984 = this.field_5984 + (lv2.field_1351 * d - this.field_5984 * 0.05);
				this.field_6006 = this.field_6006 + (lv2.field_1350 * d - this.field_6006 * 0.05);
	...
	private boolean method_7493() {
		class_1297 lv = this.method_7452();
		return lv == null || !lv.method_5805() ? false : !(lv instanceof class_3222) || !((class_3222)lv).method_7325();
	}
	...
	protected void method_7454(class_239 arg) {
		...
		this.field_5967 *= -0.01F;
		this.field_5984 *= -0.1F;
		this.field_6006 *= -0.01F;
		float g = 1.0F;
		if (this.field_6002.method_8546() && class_1890.method_8228(this.field_7650)) {
			...
			if (this.field_6002.method_8311(lv7)) {
				...
				this.field_6002.method_8416(lv8);
