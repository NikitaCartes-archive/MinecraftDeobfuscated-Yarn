...
public class class_2423 extends class_2248 {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (arg2.field_9247.method_12462() && arg2.method_8450().method_8355("doMobSpawning") && random.nextInt(2000) < arg2.method_8407().method_5461()) {
			int i = arg3.method_10264();
			class_2338 lv = arg3;

			while (!arg2.method_8320(lv).method_11631(arg2, lv) && lv.method_10264() > 0) {
				lv = lv.method_10074();
			}

			class_2338 lv2 = lv.method_10084();
			if (i > 0 && !arg2.method_8320(lv2).method_11621(arg2, lv2)) {
				class_1297 lv3 = class_1299.field_6050.method_5899(arg2, null, null, null, lv2, class_3730.field_16474, false, false);
				if (lv3 != null) {
					lv3.field_6018 = lv3.method_5806();
				}
			}
		}
	}
