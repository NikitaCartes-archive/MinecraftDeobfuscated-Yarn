...
public class class_1181 extends DataFix {
	private static final Int2ObjectMap<String> field_5675 = DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
	...
	public class_1181(Schema schema, boolean bl) {
		super(schema, bl);
	}

	public static String method_5018(int i) {
		return (String)field_5675.get(i);
	}

	@Override
	public TypeRewriteRule makeRule() {
		Type<Either<Integer, Pair<String, String>>> type = DSL.or(DSL.intType(), DSL.named(class_1208.field_5713.typeName(), DSL.namespacedString()));
		Type<Pair<String, String>> type2 = DSL.named(class_1208.field_5713.typeName(), DSL.namespacedString());
		OpticFinder<Either<Integer, Pair<String, String>>> opticFinder = DSL.fieldFinder("id", type);
		return this.fixTypeEverywhereTyped(
			"ItemIdFix",
			this.getInputSchema().getType(class_1208.field_5712),
			this.getOutputSchema().getType(class_1208.field_5712),
			typed -> typed.update(opticFinder, type2, either -> either.map(integer -> Pair.of(class_1208.field_5713.typeName(), method_5018(integer)), pair -> pair))
		);
	}
}
