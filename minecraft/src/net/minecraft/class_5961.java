...
public class class_5961 implements class_5962 {
	...
	private void method_34761() {
		...
		class_5950.field_29555.method_34701().forEach((arg, list) -> {
			List<class_5965> list2 = (List)list.stream().map(argx -> class_5965.method_34776(argx.method_34697(), argx.method_34698())).collect(Collectors.toList());
