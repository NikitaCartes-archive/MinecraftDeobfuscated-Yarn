...
public class class_2948 extends class_2944<class_3111> {
	...
	private void method_12811(class_3747 arg, class_2338 arg2, float f, class_3341 arg3, Set<class_2338> set) {
			...
			for (int k = -i; k <= i; k++) {
				if (Math.pow((double)Math.abs(j) + 0.5, 2.0) + Math.pow((double)Math.abs(k) + 0.5, 2.0) <= (double)(f * f)) {
					...
					if (method_16420(arg, lv)) {
						this.method_12773(set, arg, lv, field_13343, arg3);
					}
				}
			}
		}
	...
	private void method_12810(class_3747 arg, class_2338 arg2, class_3341 arg3, Set<class_2338> set) {
		for (int i = 0; i < 5; i++) {
			this.method_12811(arg, arg2.method_10086(i), this.method_12804(i), arg3, set);
		}
	}

	private int method_12808(Set<class_2338> set, class_3747 arg, class_2338 arg2, class_2338 arg3, boolean bl, class_3341 arg4) {
		if (!bl && Objects.equals(arg2, arg3)) {
			...
			for (int j = 0; j <= i; j++) {
				...
				if (bl) {
					this.method_12773(set, arg, lv2, field_13342.method_11657(class_2410.field_11459, this.method_12809(arg2, lv2)), arg4);
	...
	private void method_12802(class_3747 arg, int i, class_2338 arg2, List<class_2948.class_2949> list, class_3341 arg3, Set<class_2338> set) {
		for (class_2948.class_2949 lv : list) {
			if (this.method_12801(i, lv.method_12812() - arg2.method_10264())) {
				this.method_12810(arg, lv, arg3, set);
			}
		}
	}
	...
	private void method_12806(Set<class_2338> set, class_3747 arg, class_2338 arg2, int i, class_3341 arg3) {
		this.method_12808(set, arg, arg2, arg2.method_10086(i), true, arg3);
	}

	private void method_12800(Set<class_2338> set, class_3747 arg, int i, class_2338 arg2, List<class_2948.class_2949> list, class_3341 arg3) {
		for (class_2948.class_2949 lv : list) {
			...
			if (!lv2.equals(lv) && this.method_12801(i, j - arg2.method_10264())) {
				this.method_12808(set, arg, lv2, lv, true, arg3);
			}
		}
	}
	...
	public boolean method_12775(Set<class_2338> set, class_3747 arg, Random random, class_2338 arg2, class_3341 arg3) {
		...
		int i = this.method_12803(set, arg, arg2, 5 + random2.nextInt(12), arg3);
		if (i == -1) {
			return false;
		} else {
			...
			for (; m >= 0; m--) {
				...
				if (!(f < 0.0F)) {
					for (int n = 0; n < k; n++) {
						...
						if (this.method_12808(set, arg, lv, lv2, false, arg3) == -1) {
							...
							if (this.method_12808(set, arg, lv3, lv, false, arg3) == -1) {
			...
			this.method_12802(arg, i, arg2, list, arg3, set);
			this.method_12806(set, arg, arg2, j, arg3);
			this.method_12800(set, arg, i, arg2, list, arg3);
			return true;
		}
	}

	private int method_12803(Set<class_2338> set, class_3747 arg, class_2338 arg2, int i, class_3341 arg3) {
		if (!method_16433(arg, arg2.method_10074())) {
			return -1;
		} else {
			int j = this.method_12808(set, arg, arg2, arg2.method_10086(i - 1), false, arg3);
			if (j == -1) {
				return i;
			} else {
				return j < 6 ? -1 : j;
