	...
	default Stream<class_265> method_8600(@Nullable class_1297 arg, class_238 arg2, Set<class_1297> set) {
		...
		Stream<class_265> stream2 = class_2338.method_17962(i, k, m, j - 1, l - 1, n - 1).map(arg3 -> {
			...
			if (class_1937.method_8476(p)) {
				...
				class_1923 lvxx = (class_1923)atomicReference.get();
				int r = o >> 4;
				int s = q >> 4;
				class_2791 lv2xx;
				if (lvxx.field_9181 == r && lvxx.field_9180 == s) {
					lv2xx = (class_2791)atomicReference2.get();
				} else {
					lv2xx = this.method_8402(r, s, class_2806.field_12798, false);
					atomicReference.set(new class_1923(r, s));
					atomicReference2.set(lv2xx);
				}

				if ((!bl || !bl2) && (!bl2 || !bl3) && (!bl3 || !bl) && lv2xx != null) {
					class_265 lv3 = lv2xx.method_8320(arg3).method_16337(this, arg3, lv2);
					class_265 lv4xx = class_259.method_1073().method_1096((double)(-o), (double)(-p), (double)(-q));
					if (class_259.method_1074(lv4xx, lv3, class_247.field_16896)) {
						return class_259.method_1073();
					} else if (lv3 == class_259.method_1077()) {
						lv4.method_1049(o - i, p - k, q - m, true, true);
						return class_259.method_1073();
					} else {
						return lv3.method_1096((double)o, (double)p, (double)q);
					}
				} else {
					return class_259.method_1073();
				}
