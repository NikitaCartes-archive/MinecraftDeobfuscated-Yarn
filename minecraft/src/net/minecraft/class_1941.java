		...
		return StreamSupport.stream(new AbstractSpliterator<class_265>(Long.MAX_VALUE, 1280) {
			...
			public boolean tryAdvance(Consumer<? super class_265> consumer) {
				if (!this.field_19296) {
					...
					class_265 lvx = class_1941.this.method_8621().method_17903();
					boolean bl = class_259.method_1074(lvx, class_259.method_1078(arg.method_5829().method_1011(1.0E-7)), class_247.field_16896);
					boolean bl2 = class_259.method_1074(lvx, class_259.method_1078(arg.method_5829().method_1014(1.0E-7)), class_247.field_16896);
					if (!bl && bl2) {
						consumer.accept(lvx);
						return true;
					}
				...
				while(lv2.method_17963()) {
					...
					if (l != 3) {
						int m = i >> 4;
						int n = k >> 4;
						class_2791 lv2x = class_1941.this.method_8402(m, n, class_1941.this.method_20311(), false);
						if (lv2x != null) {
							lv3.method_10103(i, j, k);
							class_2680 lv3x = lv2x.method_8320(lv3);
							if ((l != 1 || lv3x.method_17900()) && (l != 2 || lv3x.method_11614() == class_2246.field_10008)) {
								class_265 lv4x = lv3x.method_16337(class_1941.this, lv3, lv);
								class_265 lv5 = lv4x.method_1096((double)i, (double)j, (double)k);
