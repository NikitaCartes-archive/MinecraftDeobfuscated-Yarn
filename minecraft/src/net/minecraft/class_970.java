...
public abstract class class_970<T extends class_1309, M extends class_583<T>, A extends class_583<T>> extends class_3887<T, M> {
	...
	private void method_4169(T arg, float f, float g, float h, float i, float j, float k, float l, class_1304 arg2) {
		...
		if (lv.method_7909() instanceof class_1738) {
			...
			if (lv2.method_7685() == arg2) {
				...
				this.method_17165().method_17081(lv3);
				lv3.method_2816(arg, f, g, h);
				this.method_4170(lv3, arg2);
				boolean bl = this.method_4173(arg2);
				this.method_17164(this.method_4168(lv2, bl));
				if (lv2 instanceof class_1768) {
					int m = ((class_1768)lv2).method_7800(lv);
					...
					lv3.method_2819(arg, f, g, i, j, k, l);
	...
	public A method_4172(class_1304 arg) {
		return (A)(this.method_4173(arg) ? this.field_4830 : this.field_4831);
	}
