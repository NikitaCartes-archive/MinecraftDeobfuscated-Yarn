...
public class class_2878 extends class_2869 {
	...
	public class_2794<? extends class_2888> method_12443() {
		...
		if (lv == class_1942.field_9277) {
			...
			class_2906 lv25 = lv6.method_12117();
			class_2084 lv26 = lv8.method_8774().method_9002(this.field_13058.method_8401()).method_9004(lv25);
			return lv6.create(this.field_13058, lv8.method_8772(lv26), lv25);
		} else {
			...
			if (jsonObject.has("biome_source") && jsonObject.getAsJsonObject("biome_source").has("type") && jsonObject.getAsJsonObject("biome_source").has("options")) {
				...
				if (jsonObject2.has("biomes")) {
					...
					for (int i = 0; i < jsonArray.size(); i++) {
						class_1959 lv15 = class_2378.field_11153.method_10223(new class_2960(jsonArray.get(i).getAsString()));
						lvs[i] = lv15 != null ? lv15 : class_1972.field_9423;
					}
				}

				if (class_1969.field_9401 == lv14) {
					class_1991 lv16 = lv7.method_8774().method_8782(lvs[0]);
					lv13 = lv7.method_8772(lv16);
				}

				if (class_1969.field_9398 == lv14) {
					int j = jsonObject2.has("size") ? jsonObject2.getAsJsonPrimitive("size").getAsInt() : 2;
					class_1976 lv17 = lv9.method_8774().method_8777(lvs).method_8780(j);
					lv13 = lv9.method_8772(lv17);
				}

				if (class_1969.field_9402 == lv14) {
					class_2084 lv18 = lv8.method_8774().method_9004(new class_2906()).method_9002(this.field_13058.method_8401());
					lv13 = lv8.method_8772(lv18);
				}
			}
			...
			class_2680 lv19 = class_2246.field_10340.method_9564();
			class_2680 lv20 = class_2246.field_10382.method_9564();
			if (jsonObject.has("chunk_generator") && jsonObject.getAsJsonObject("chunk_generator").has("options")) {
				...
				if (jsonObject.getAsJsonObject("chunk_generator").getAsJsonObject("options").has("default_fluid")) {
					...
					lv20 = class_2378.field_11146.method_10223(new class_2960(string)).method_9564();
				}
			}

			if (jsonObject.has("chunk_generator") && jsonObject.getAsJsonObject("chunk_generator").has("type")) {
				class_2798<?, ?> lv21 = class_2378.field_11149
					.method_10223(new class_2960(jsonObject.getAsJsonObject("chunk_generator").getAsJsonPrimitive("type").getAsString()));
				if (class_2798.field_12765 == lv21) {
					class_2900 lv22 = lv4.method_12117();
					lv22.method_12571(lv19);
					lv22.method_12572(lv20);
					return lv4.create(this.field_13058, lv13, lv22);
				}

				if (class_2798.field_12770 == lv21) {
					class_2916 lv23 = lv5.method_12117();
					lv23.method_12651(new class_2338(0, 64, 0));
					lv23.method_12571(lv19);
					lv23.method_12572(lv20);
					return lv5.create(this.field_13058, lv13, lv23);
				}
			}

			class_2906 lv24 = lv6.method_12117();
			lv24.method_12571(lv19);
			lv24.method_12572(lv20);
			return lv6.create(this.field_13058, lv13, lv24);
		}
	}
