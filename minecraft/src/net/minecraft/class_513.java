...
public class class_513 {
	...
	private void method_2626() {
		this.field_3128.field_2076 = this.field_3124 > 1 && this.field_3135 < this.field_3124 - 1;
		this.field_3130.field_2076 = this.field_3124 > 1 && this.field_3135 > 0;
	}
	...
	public void method_2634(int i, int j, int k, int l, float f) {
		...
		for (class_514 lv : this.field_3131) {
			lv.method_1824(k, l, f);
			if (lv.field_2076 && lv.method_1828()) {
				this.field_3129 = lv;
			}
		}

		this.field_3130.method_1824(k, l, f);
		this.field_3128.method_1824(k, l, f);
	...
	public void method_2628(int i, int j) {
		if (this.field_3126.field_1755 != null && this.field_3129 != null && !this.field_3132.method_2616()) {
			this.field_3126.field_1755.method_2211(this.field_3129.method_2644(this.field_3126.field_1755), i, j);
		}
	}
	...
	public boolean method_2632(double d, double e, int i, int j, int k, int l, int m) {
		...
		if (this.field_3132.method_2616()) {
			if (this.field_3132.method_16807(d, e, i)) {
			...
			return true;
		} else if (this.field_3128.method_16807(d, e, i)) {
			this.field_3135++;
			this.method_2625();
			return true;
		} else if (this.field_3130.method_16807(d, e, i)) {
			this.field_3135--;
			this.method_2625();
			return true;
		} else {
			for (class_514 lv : this.field_3131) {
				if (lv.method_16807(d, e, i)) {
					if (i == 0) {
						this.field_3125 = lv.method_2643();
						this.field_3133 = lv.method_2645();
					} else if (i == 1 && !this.field_3132.method_2616() && !lv.method_2642()) {
						this.field_3132.method_2617(this.field_3126, lv.method_2645(), lv.field_2069, lv.field_2068, j + l / 2, k + 13 + m / 2, (float)lv.method_1825());
					}
