...
public class class_4835 {
	...
	public static Brain<?> method_24668(HoglinEntity hoglinEntity, Dynamic<?> dynamic) {
		Brain<HoglinEntity> brain = new Brain<>(HoglinEntity.field_22366, HoglinEntity.field_22365, dynamic);
	...
	private static void method_24673(HoglinEntity hoglinEntity, Brain<HoglinEntity> brain) {
		...
		brain.setTaskList(
			...
			ImmutableList.of(
				...
				new class_4820<MobEntityWithAi>(HoglinEntity::method_24658, GoToNearbyEntityTask.method_24603(MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLIN, f, 8, false)),
