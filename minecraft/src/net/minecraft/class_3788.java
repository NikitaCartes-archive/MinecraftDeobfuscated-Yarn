...
public class class_3788 extends DataFix {
	private static final Map<String, String> field_16691 = ImmutableMap.<String, String>builder()
	...
	public class_3788(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		...
		return this.fixTypeEverywhereTyped(
			"ChunkStatusFix2", type, this.getOutputSchema().getType(class_1208.field_5726), typed -> typed.updateTyped(opticFinder, typedx -> {
					Dynamic<?> dynamic = typedx.get(DSL.remainderFinder());
					String string = dynamic.get("Status").asString("empty");
					String string2 = (String)field_16691.getOrDefault(string, "empty");
