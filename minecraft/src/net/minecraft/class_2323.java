...
public class class_2323 extends class_2248 {
	...
	public class_265 method_9530(class_2680 arg, class_1922 arg2, class_2338 arg3, class_3726 arg4) {
		...
		boolean bl = !arg.method_11654(field_10945);
	...
	public boolean method_9516(class_2680 arg, class_1922 arg2, class_2338 arg3, class_10 arg4) {
		switch(arg4) {
			case field_50:
				return arg.method_11654(field_10945);
			case field_48:
				return false;
			case field_51:
				return arg.method_11654(field_10945);
	...
	private class_2750 method_10035(class_1750 arg) {
		...
		int i = (method_9614(lv7.method_11628(lv, lv6)) ? -1 : 0)
			+ (method_9614(lv9.method_11628(lv, lv8)) ? -1 : 0)
			+ (method_9614(lv12.method_11628(lv, lv11)) ? 1 : 0)
			+ (method_9614(lv14.method_11628(lv, lv13)) ? 1 : 0);
		...
		if ((!bl || bl2) && i <= 0) {
			if ((!bl2 || bl) && i >= 0) {
				...
				class_243 lv15 = arg.method_17698();
				double d = lv15.field_1352 - (double)lv2.method_10263();
				double e = lv15.field_1350 - (double)lv2.method_10260();
	...
	public void method_10033(class_1937 arg, class_2338 arg2, boolean bl) {
		...
		if (lv.method_11614() == this && lv.method_11654(field_10945) != bl) {
	...
	public void method_9612(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2248 arg4, class_2338 arg5, boolean bl) {
		...
		if (arg4 != this && bl2 != arg.method_11654(field_10940)) {
			if (bl2 != arg.method_11654(field_10945)) {
				this.method_10036(arg2, arg3, bl2);
			}

			arg2.method_8652(arg3, arg.method_11657(field_10940, Boolean.valueOf(bl2)).method_11657(field_10945, Boolean.valueOf(bl2)), 2);
		}
	}
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		if (arg.method_11654(field_10946) == class_2756.field_12607) {
			return class_2248.method_20045(lv2, arg2, lv, class_2350.field_11036);
		} else {
