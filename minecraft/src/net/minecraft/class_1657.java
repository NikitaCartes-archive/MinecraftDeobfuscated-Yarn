...
public abstract class class_1657 extends class_1309 {
	...
	private static final Map<class_4050, class_4048> field_18134 = ImmutableMap.builder()
		...
		.put(class_4050.field_18081, class_4048.method_18384(0.6F, 1.5F))
	...
	protected void method_6001() {
		...
		this.method_6127().method_6208(class_1612.field_23644);
	}
	...
	protected void method_7318() {
		if (this.method_20233(class_4050.field_18079)) {
			...
			} else if (this.method_6123()) {
				lv = class_4050.field_18080;
			} else if (this.method_5715() && !this.field_7503.field_7479) {
			...
			class_4050 lv2;
			if (this.method_7325() || this.method_5765() || this.method_20233(lv)) {
				lv2 = lv;
			} else if (this.method_20233(class_4050.field_18081)) {
				lv2 = class_4050.field_18081;
			} else {
				lv2 = class_4050.field_18079;
			}

			this.method_18380(lv2);
		}
	}
	...
	public void method_6007() {
		...
		if (this.field_5952 && !(this.method_6032() <= 0.0F) && !this.method_5681()) {
			f = Math.min(0.1F, class_3532.method_15368(method_17996(this.method_18798())));
		} else {
			f = 0.0F;
		}
	...
	private void method_7267(@Nullable class_2487 arg) {
		if (arg != null && !arg.method_10545("Silent") || !arg.method_10577("Silent")) {
			...
			class_1299.method_5898(string).filter(argx -> argx == class_1299.field_6104).ifPresent(argx -> class_1453.method_6589(this.field_6002, this));
		}
	}
	...
	public void method_6078(class_1282 arg) {
		...
		if (arg != null) {
			this.method_18800(
				(double)(-class_3532.method_15362((this.field_6271 + this.field_6031) * (float) (Math.PI / 180.0)) * 0.1F),
				0.1F,
				(double)(-class_3532.method_15374((this.field_6271 + this.field_6031) * (float) (Math.PI / 180.0)) * 0.1F)
			);
		} else {
	...
	protected class_3414 method_6011(class_1282 arg) {
		...
		} else if (arg == class_1282.field_5859) {
			return class_3417.field_15205;
		} else {
			return arg == class_1282.field_16992 ? class_3417.field_17614 : class_3417.field_15115;
		}
	}
	...
	public class_1542 method_7329(class_1799 arg, boolean bl, boolean bl2) {
		if (arg.method_7960()) {
			...
			if (bl) {
				...
				this.method_18800((double)(-class_3532.method_15374(g) * f), 0.2F, (double)(class_3532.method_15362(g) * f));
			} else {
				float f = 0.3F;
				float g = class_3532.method_15374(this.field_5965 * (float) (Math.PI / 180.0));
				float h = class_3532.method_15362(this.field_5965 * (float) (Math.PI / 180.0));
				float i = class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0));
				float j = class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0));
				float k = this.field_5974.nextFloat() * (float) (Math.PI * 2);
				float l = 0.02F * this.field_5974.nextFloat();
				lv.method_18800(
					(double)(-i * h * 0.3F) + Math.cos((double)k) * (double)l,
					(double)(-g * 0.3F + 0.1F + (this.field_5974.nextFloat() - this.field_5974.nextFloat()) * 0.1F),
	...
	protected void method_6056(float f) {
		class_1799 lv = this.field_6277;
		class_1268 lv2 = this.method_6058();
		if (lv.method_7909() != class_1802.field_8255) {
			lv = this.method_6079();
			lv2 = class_1268.field_5810;
		}

		if (f >= 3.0F && lv.method_7909() == class_1802.field_8255) {
			int i = 1 + class_3532.method_15375(f);
			class_1268 lv3 = lv2;
			lv.method_7956(i, this, arg2 -> arg2.method_20236(lv3));
			if (lv.method_7960()) {
				if (lv2 == class_1268.field_5808) {
	...
	public void method_7324(class_1297 arg) {
		if (arg.method_5732()) {
			if (!arg.method_5698(this)) {
				float f = this.method_7261(1.0F);
				if (!(f < 1.0F)) {
					float g = (float)this.method_5996(class_1612.field_7363).method_6194();
					float h;
					if (arg instanceof class_1309) {
						h = class_1890.method_8218(this.method_6047(), ((class_1309)arg).method_6046());
					} else {
						h = class_1890.method_8218(this.method_6047(), class_1310.field_6290);
					}

					float i = this.method_26738(1.0F);
					this.method_7350();
					if (g > 0.0F || h > 0.0F) {
						boolean bl = f > 1.95F;
						boolean bl2 = false;
						int j = 0;
						j += class_1890.method_8205(this);
						...
						g += h;
						boolean bl4 = false;
						if (bl && !bl3 && !bl2 && this.method_26736()) {
							bl4 = true;
						}

						float k = 0.0F;
						boolean bl5 = false;
						int l = class_1890.method_8199(this);
						if (arg instanceof class_1309) {
							k = ((class_1309)arg).method_6032();
							if (l > 0 && !arg.method_5809()) {
								bl5 = true;
								arg.method_5639(1);
							}
						}
						...
						boolean bl6 = arg.method_5643(class_1282.method_5532(this).method_26729(bl3), g);
						if (bl6) {
							if (j > 0) {
								if (arg instanceof class_1309) {
									((class_1309)arg)
									...
									arg.method_5762(
										(double)(-class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0)) * (float)j * 0.5F),
										0.1,
										(double)(class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0)) * (float)j * 0.5F)
									);
								}
							...
							if (bl4) {
								class_238 lv2 = arg.method_5829().method_1009(1.0, 0.25, 1.0);
								this.method_26734(lv2, i, g, arg);
							}
							...
							if (arg instanceof class_1508) {
								lv4 = ((class_1508)arg).field_7007;
							}

							if (!this.field_6002.field_9236 && !lv3.method_7960() && lv4 instanceof class_1309) {
							...
							if (arg instanceof class_1309) {
								float m = k - ((class_1309)arg).method_6032();
								this.method_7339(class_3468.field_15399, Math.round(m * 10.0F));
								if (l > 0) {
									arg.method_5639(l * 4);
								}

								if (this.field_6002 instanceof class_3218 && m > 2.0F) {
									int n = (int)((double)m * 0.5);
									((class_3218)this.field_6002)
										.method_14199(class_2398.field_11209, arg.field_5987, arg.field_6010 + (double)(arg.method_17682() * 0.5F), arg.field_6035, n, 0.1, 0.0, 0.1, 0.2);
								}
							}
	...
	public void method_26735() {
		...
		if (!(f < 1.0F)) {
			...
			float g = (float)this.method_5996(class_1612.field_7363).method_6194();
			boolean bl = f > 1.95F;
			if (bl && g > 0.0F && this.method_26736()) {
				float h = this.method_26738(1.0F);
				double d = 2.0;
				double e = (double)(-class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0))) * 2.0;
				double i = (double)class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0)) * 2.0;
				class_238 lv = this.method_5829().method_1009(1.0, 0.25, 1.0).method_989(e, 0.0, i);
				this.method_26734(lv, h, g, null);
			}
		}
	}
	...
	protected boolean method_26736() {
		double d = (double)(this.field_5973 - this.field_6039);
		return this.field_5952 && d < (double)this.method_6029() && class_1890.method_8217(this) > 0.0F;
	}

	public void method_26734(class_238 arg, float f, float g, class_1297 arg2) {
		float h = 1.0F + class_1890.method_8217(this) * g;

		for(class_1309 lv : this.field_6002.method_18467(class_1309.class, arg)) {
			if (lv != this && lv != arg2 && !this.method_5722(lv) && (!(lv instanceof class_1531) || !((class_1531)lv).method_6912())) {
				float i = f + lv.method_17681() * 0.5F;
				if (this.method_5858(lv) < (double)(i * i)) {
					lv.method_6005(
						this,
						0.4F,
						(double)class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0)),
					...
					lv.method_5643(class_1282.method_5532(this), h);
				}
			}
		}

		this.field_6002.method_8465(null, this.field_5987, this.field_6010, this.field_6035, class_3417.field_23670, this.method_5634(), 1.0F, 1.0F);
		if (this.field_6002 instanceof class_3218) {
			...
			((class_3218)this.field_6002)
				.method_14199(class_2398.field_11227, this.field_5987 + d, this.field_6010 + (double)this.method_17682() * 0.5, this.field_6035 + e, 0, d, 0.0, e, 0.0);
		}
	}
	...
	private boolean method_19205(class_2338 arg, class_2350 arg2) {
		class_2338 lv = arg.method_10084();
		return !this.method_7326(lv) || !this.method_7326(lv.method_10093(arg2.method_10153()));
	}

	public void method_7358(boolean bl, boolean bl2, boolean bl3) {
		Optional<class_2338> optional = this.method_18398();
		super.method_18400();
		if (this.field_6002 instanceof class_3218 && bl2) {
			((class_3218)this.field_6002).method_8448();
		}

		this.field_7487 = bl ? 0 : 100;
		if (bl3) {
			optional.ifPresent(arg -> this.method_7289(arg, false));
		}
	}
	...
	public static Optional<class_243> method_7288(class_1941 arg, class_2338 arg2, boolean bl) {
		...
		if (!(lv instanceof class_2244)) {
			if (!bl) {
				...
				return bl2 && bl3
					? Optional.of(new class_243((double)arg2.method_10263() + 0.5, (double)arg2.method_10264() + 0.1, (double)arg2.method_10260() + 0.5))
					: Optional.empty();
			}
		} else {
			return class_2244.method_9484(class_1299.field_6097, arg, arg2, 0);
		}
	}

	public boolean method_7276() {
		return this.method_6113() && this.field_7487 >= 100;
	}
	...
	public void method_6091(class_243 arg) {
		...
		if (this.method_5681() && !this.method_5765()) {
			double g = this.method_5720().field_1351;
			...
			if (g <= 0.0
				...
				this.method_18799(lv.method_1031(0.0, (g - lv.field_1351) * h, 0.0));
			}
		}

		if (this.field_7503.field_7479 && !this.method_5765()) {
			double g = this.method_18798().field_1351;
			...
			this.method_18800(lv2.field_1352, g * 0.6, lv2.field_1350);
			this.field_6281 = i;
			this.field_6017 = 0.0F;
		...
		this.method_7282(this.field_5987 - d, this.field_6010 - e, this.field_6035 - f);
	}
	...
	protected boolean method_7326(class_2338 arg) {
		return !this.field_6002.method_8320(arg).method_11582(this.field_6002, arg);
	}
	...
	public void method_7255(int i) {
		this.method_7285(i);
		this.field_7510 += (float)i / (float)this.method_7349();
		...
		while(this.field_7510 >= 1.0F) {
			...
			this.method_7316(1);
			this.field_7510 /= (float)this.method_7349();
		}
	}
	...
	protected int method_6110(class_1657 arg) {
		if (!this.field_6002.method_8450().method_8355(class_1928.field_19389) && !this.method_7325()) {
	...
	private void method_7296(@Nullable class_2487 arg) {
		if (!this.field_6002.field_9236 && !arg.isEmpty()) {
			class_1299.method_5892(arg, this.field_6002).ifPresent(argx -> {
				if (argx instanceof class_1321) {
					((class_1321)argx).method_6174(this.field_6021);
				}

				argx.method_5814(this.field_5987, this.field_6010 + 0.7F, this.field_6035);
				((class_3218)this.field_6002).method_18768(argx);
			});
		}
	}
	...
	public float method_26737() {
		float f = (float)this.method_5996(class_1612.field_7356).method_6194() - 1.5F;
		f = class_3532.method_15363(f, 0.1F, 1024.0F);
		return 1.0F / f * 20.0F;
	}

	public float method_7261(float f) {
		return class_3532.method_15363(((float)this.field_6273 + f) / this.method_26737(), 0.0F, 2.0F);
	}
	...
	public float method_26738(float f) {
		float g = 0.0F;
		float h = this.method_7261(f);
		if (h > 1.95F) {
			g = 0.5F;
		}

		return (float)this.method_5996(class_1612.field_23644).method_6194() + g;
	}
	...
	public boolean method_26732(class_1799 arg) {
		return this.field_7484.method_7904(arg.method_7909());
	}
	...
	public boolean method_18397(class_1799 arg) {
		...
		return this.method_6118(lv).method_7960();
	}
	...
	public class_1799 method_18808(class_1799 arg) {
		if (!(arg.method_7909() instanceof class_1811)) {
			...
			if (!lv.method_7960()) {
				...
				predicate = ((class_1811)arg.method_7909()).method_19268();

				for(int i = 0; i < this.field_7514.method_5439(); ++i) {
					class_1799 lv2 = this.field_7514.method_5438(i);
	...
	public class_1799 method_18866(class_1937 arg, class_1799 arg2) {
		this.method_7344().method_7579(arg2.method_7909(), arg2);
		this.method_7259(class_3468.field_15372.method_14956(arg2.method_7909()));
		arg.method_8465(
			null, this.field_5987, this.field_6010, this.field_6035, class_3417.field_19149, class_3419.field_15248, 0.5F, arg.field_9229.nextFloat() * 0.1F + 0.9F
		);
		if (this instanceof class_3222) {
			class_174.field_1198.method_8821((class_3222)this, arg2);
		}

		return super.method_18866(arg, arg2);
	}

	public static enum class_1658 {
		field_7528,
		field_7529(new class_2588("block.minecraft.bed.no_sleep")),
		field_7530(new class_2588("block.minecraft.bed.too_far_away")),
		field_18592(new class_2588("block.minecraft.bed.obstructed")),
		field_7531,
		field_7532(new class_2588("block.minecraft.bed.not_safe"));
		...
		private class_1658(class_2561 arg) {
			this.field_18593 = arg;
		}
