...
public abstract class class_1657 extends class_1309 {
	...
	private void method_7300() {
		...
		if (lv != null) {
			if (!this.field_7517 && !this.field_5953 && lv.method_11614() == class_2246.field_10422 && !this.method_7325()) {
				boolean bl = lv.method_11654(class_2258.field_10680);
				if (bl) {
	...
	public void method_6007() {
		...
		if (!this.field_5952 && !(this.method_6032() <= 0.0F)) {
			g = (float)(Math.atan(-this.method_18798().field_1351 * 0.2F) * 15.0);
		} else {
			g = 0.0F;
		}
	...
	public void method_17354(int i, class_1916 arg, int j, int k, boolean bl) {
	}
			...
			if (!arg.method_5698(this)) {
				...
				if (f > 0.0F || g > 0.0F) {
					...
					if (bl6) {
						...
						if (bl4) {
							float l = 1.0F + class_1890.method_8217(this) * f;

							for(class_1309 lv3 : this.field_6002.method_18467(class_1309.class, arg.method_5829().method_1009(1.0, 0.25, 1.0))) {
								if (lv3 != this
									&& lv3 != arg
									&& !this.method_5722(lv3)
									&& (!(lv3 instanceof class_1531) || !((class_1531)lv3).method_6912())
									&& this.method_5858(lv3) < 9.0) {
									lv3.method_6005(
										this,
										0.4F,
										(double)class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0)),
									...
									lv3.method_5643(class_1282.method_5532(this), l);
								}
							}
						...
						class_1799 lv4 = this.method_6047();
						class_1297 lv5 = arg;
						if (arg instanceof class_1508) {
							lv5 = ((class_1508)arg).field_7007;
						}

						if (!lv4.method_7960() && lv5 instanceof class_1309) {
							lv4.method_7979((class_1309)lv5, this);
							if (lv4.method_7960()) {
						...
						if (arg instanceof class_1309) {
							float m = j - ((class_1309)arg).method_6032();
	...
	public class_1799 method_18808(class_1799 arg) {
		if (!(arg.method_7909() instanceof class_1811)) {
			...
			Predicate<class_1799> predicate = ((class_1811)arg.method_7909()).method_19268();
