...
public class class_4124 extends class_4097<class_1309> {
	...
	protected boolean method_18919(class_3218 arg, class_1309 arg2) {
		...
		Optional<class_4208> optional = lv.method_19543(class_4140.field_18440);
		return arg.method_8409().nextInt(100) == 0
			...
			&& ((List)lv.method_19543(class_4140.field_18442).get()).stream().anyMatch(argx -> class_1299.field_6077.equals(argx.method_5864()));
	}
