...
public class class_1522 extends class_1514 {
	...
	public class_1522(class_1510 arg) {
		super(arg);
		this.field_18124 = new class_4051().method_18418(20.0).method_18420(arg2 -> Math.abs(arg2.field_6010 - arg.field_6010) <= 10.0);
	}

	@Override
	public void method_6855() {
		++this.field_7050;
		class_1309 lv = this.field_7036
			.field_6002
			.method_18463(this.field_18124, this.field_7036, this.field_7036.field_5987, this.field_7036.field_6010, this.field_7036.field_6035);
		if (lv != null) {
			if (this.field_7050 > 25) {
				...
				if (g < 0.0F || g > 10.0F) {
					...
					this.field_7036.field_6031 += this.field_7036.field_6267;
				}
			}
		} else if (this.field_7050 >= 100) {
			lv = this.field_7036
				.field_6002
				.method_18463(field_18123, this.field_7036, this.field_7036.field_5987, this.field_7036.field_6010, this.field_7036.field_6035);
