...
public class class_433 extends class_437 {
	...
	public class_433(boolean bl) {
		super(bl ? new class_2588("menu.game") : new class_2588("menu.paused"));
		this.field_19319 = bl;
	}
	...
	private void method_20543() {
		...
		String string = class_155.method_16673().isStable() ? "https://aka.ms/javafeedback?ref=game" : "https://aka.ms/snapshotfeedback?ref=game";
		this.addButton(
			new class_4185(
				this.width / 2 - 102,
				this.height / 4 + 72 + -16,
				98,
				20,
				class_1074.method_4662("menu.sendFeedback"),
				arg -> this.minecraft.method_1507(new class_407(bl -> {
						if (bl) {
		...
		this.addButton(
			new class_4185(
				this.width / 2 + 4, this.height / 4 + 72 + -16, 98, 20, class_1074.method_4662("menu.reportBugs"), arg -> this.minecraft.method_1507(new class_407(bl -> {
						if (bl) {
