...
public class class_4008 extends class_4080<List<String>> {
	...
	private final List<String> field_17906 = Lists.newArrayList();
	...
	protected List<String> method_18176(class_3300 arg, class_3695 arg2) {
		try {
			...
			try {
				...
				try {
					bufferedReader = new BufferedReader(new InputStreamReader(lv.method_14482(), StandardCharsets.UTF_8));
					Throwable var6 = null;
	...
	public String method_18174() {
		...
		if (calendar.get(2) + 1 == 12 && calendar.get(5) == 24) {
			...
			return "Maaan, wouldn't it be cool if you could keep monsters in you pocket and use them for fighting?";
		} else {
			return this.field_18934 != null && field_17905.nextInt(this.field_17906.size()) == 42
				? "Run, " + this.field_18934.method_1676().toUpperCase(Locale.ROOT) + ", Run!"
