...
public class class_2843 {
	...
	private static void method_12352(class_2818 arg, class_2355 arg2) {
		...
		if (arg.method_12003().field_12951.remove(arg2)) {
			...
			for(class_2338.class_2339 lv4 : class_2338.method_10068(k, 0, m, l, lv.method_8322() - 1, n)) {
	...
	private static class_2680 method_12351(class_2680 arg, class_2350 arg2, class_1936 arg3, class_2338.class_2339 arg4, class_2338.class_2339 arg5) {
		...
		try (
			...
			for(int i = 0; i < this.field_12955.length; ++i) {
				if (this.field_12955[i] != null) {
					field_12956.warn("Discarding update data for section {} for chunk ({} {})", i, lv3.field_9181, lv3.field_9180);
				}
	...
	static enum class_2845 implements class_2843.class_2844 {
		...
		field_12963(
			...
			public class_2680 method_12358(class_2680 arg, class_2350 arg2, class_2680 arg3, class_1936 arg4, class_2338 arg5, class_2338 arg6) {
				...
				if (arg != lv) {
					int i = lv.method_11654(class_2741.field_12541);
					List<ObjectSet<class_2338>> list = (List)this.field_12964.get();
					if (list.isEmpty()) {
						for(int j = 0; j < 7; ++j) {
			...
			public void method_12357(class_1936 arg) {
				...
				for(int i = 2; i < list.size(); ++i) {
					int j = i - 1;
					ObjectSet<class_2338> objectSet = (ObjectSet)list.get(j);
					ObjectSet<class_2338> objectSet2 = (ObjectSet)list.get(i);

					for(class_2338 lv2 : objectSet) {
						class_2680 lv3 = arg.method_8320(lv2);
						if (lv3.method_11654(class_2741.field_12541) >= j) {
							...
							if (i != 7) {
								for(class_2350 lv4 : field_12959) {
									...
									if (lv5.method_11570(class_2741.field_12541) && lv3.method_11654(class_2741.field_12541) > i) {
		...
		field_12958(class_2246.field_10168, class_2246.field_9984) {
			@Override
			public class_2680 method_12358(class_2680 arg, class_2350 arg2, class_2680 arg3, class_1936 arg4, class_2338 arg5, class_2338 arg6) {
				if (arg.method_11654(class_2513.field_11584) == 7) {
