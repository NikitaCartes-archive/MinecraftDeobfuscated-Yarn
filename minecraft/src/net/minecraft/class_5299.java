...
public class class_5299 extends DataFix {
	private static final ImmutableMap<String, class_5299.class_5300> field_24647 = ImmutableMap.builder()
		...
		if (optional.equals(Optional.of("customized"))) {
			...
			switch(bl6) {
				...
				case "buffet":
					...
					Dynamic<T> dynamic4 = (Dynamic)optionalDynamic.get("biome_source")
						.result()
	...
	private static <T> Map<Dynamic<T>, Dynamic<T>> method_28275(DynamicOps<T> dynamicOps, OptionalDynamic<T> optionalDynamic) {
		...
		Map<String, class_5299.class_5300> map = Maps.newHashMap();
