					...
					for (int m = 0; m < this.field_2290.size(); m++) {
						...
						for (int n = 0; n < string.length(); n++) {
							...
							if (c != 0 && c != ' ') {
								...
								class_386.class_388 lv3 = char2ObjectMap.put(
									c, new class_386.class_388(f, lv2, n * k, m * l, k, l, (int)(0.5 + (double)((float)o * f)) + 1, this.field_2287)
								);
								if (lv3 != null) {
									class_386.field_2286.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString(c), this.field_2289);
								}
							}
						}
					}

					var28 = new class_386(lv2, char2ObjectMap);
