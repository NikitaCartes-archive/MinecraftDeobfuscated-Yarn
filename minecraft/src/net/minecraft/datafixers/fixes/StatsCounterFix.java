...
public class StatsCounterFix extends DataFix {
	private static final Set<String> skip = ImmutableSet.builder()
		...
		.build();
	private static final Map<String, String> customMap = ImmutableMap.builder()
		...
		.build();
	private static final Map<String, String> field_5738 = ImmutableMap.builder()
		...
		.build();
	private static final Map<String, String> field_5736 = ImmutableMap.builder()
		.put("stat.entityKilledBy", "minecraft:killed_by")
		.put("stat.killEntity", "minecraft:killed")
		.build();
	private static final Map<String, String> entityMap = ImmutableMap.builder()
