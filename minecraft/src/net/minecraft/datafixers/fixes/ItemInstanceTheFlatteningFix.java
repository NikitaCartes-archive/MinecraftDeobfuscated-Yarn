...
public class ItemInstanceTheFlatteningFix extends DataFix {
	private static final Map<String, String> damageMap = DataFixUtils.make(Maps.newHashMap(), hashMap -> {
	...
	private static final Set<String> damagedItems = Sets.newHashSet(
		"minecraft:bow",
