...
public final class class_6916 {
	...
	public static NoiseType method_40496(
		RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> registryEntry, @Deprecated double d, double e, double f, double g
	) {
	...
	public static NoiseType method_40489(
