...
public class class_2495 extends class_2483<class_2497> {
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			return object instanceof class_2495 && Arrays.equals(this.field_11524, ((class_2495)object).field_11524);
		}
	}
	...
	public class_2497 method_17806(int i, class_2497 arg) {
		int j = this.field_11524[i];
		this.field_11524[i] = arg.method_10701();
		return new class_2497(j);
	}

	public void method_17808(int i, class_2497 arg) {
		this.field_11524 = ArrayUtils.add(this.field_11524, i, arg.method_10701());
	}
	...
	public class_2497 method_17807(int i) {
		int j = this.field_11524[i];
