...
public class class_2991 implements class_3000, class_3302 {
	...
	private final class_3503<class_2158> field_13416 = new class_3503<>(
		arg -> this.method_12905(arg) != null, this::method_12905, "tags/functions", true, "function"
	);
	...
	@Nullable
	public class_2158 method_12905(class_2960 arg) {
		return (class_2158)this.field_13420.get(arg);
	}
	...
	public void method_14491(class_3300 arg) {
		...
		for(class_2960 lv : collection) {
			...
			list.add(
				CompletableFuture.supplyAsync(() -> method_12906(arg, lv), class_3306.field_14301)
					.thenApplyAsync(listx -> class_2158.method_9195(lv2, this, listx))
		...
		this.field_13416.method_15192(arg);
