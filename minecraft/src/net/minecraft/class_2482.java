...
public class class_2482 extends class_2248 implements class_3737 {
	...
	public boolean method_9561(class_2680 arg, class_1922 arg2, class_2338 arg3) {
		return arg.method_11654(field_11501) == class_2771.field_12682 || arg.method_11654(field_11501) == class_2771.field_12679;
	}
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		if (lv.method_11614() == this) {
			return lv.method_11657(field_11501, class_2771.field_12682).method_11657(field_11502, Boolean.valueOf(false));
		} else {
			...
			class_2680 lv3 = this.method_9564()
				...
				.method_11657(field_11502, Boolean.valueOf(lv2.method_15772() == class_3612.field_15910));
			class_2350 lv4 = arg.method_8038();
			return lv4 != class_2350.field_11033 && (lv4 == class_2350.field_11036 || !((double)arg.method_8039() > 0.5))
				? lv3
				: lv3.method_11657(field_11501, class_2771.field_12679);
		}
	}
	...
	public boolean method_9616(class_2680 arg, class_1750 arg2) {
		...
		if (lv2 == class_2771.field_12682 || lv.method_7909() != this.method_8389()) {
			...
			boolean bl = (double)arg2.method_8039() > 0.5;
			class_2350 lv3 = arg2.method_8038();
			if (lv2 == class_2771.field_12681) {
				return lv3 == class_2350.field_11036 || bl && lv3.method_10166().method_10179();
			} else {
				return lv3 == class_2350.field_11033 || !bl && lv3.method_10166().method_10179();
			}
		} else {
			return true;
		}
	...
	public class_2680 method_9559(class_2680 arg, class_2350 arg2, class_2680 arg3, class_1936 arg4, class_2338 arg5, class_2338 arg6) {
		if (arg.method_11654(field_11502)) {
