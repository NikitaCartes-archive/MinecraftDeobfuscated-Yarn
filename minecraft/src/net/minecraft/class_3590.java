...
public class class_3590 extends DataFix {
	private static final ImmutableMap<String, Pair<String, ImmutableMap<String, String>>> field_15889 = ImmutableMap.<String, Pair<String, ImmutableMap<String, String>>>builder()
		.put(
			"EndCity",
			Pair.of(
				"ECP",
	...
	public class_3590(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	private Dynamic<?> method_15671(Dynamic<?> dynamic, Dynamic<?> dynamic2) {
		...
		if (field_15889.containsKey(string)) {
			Pair<String, ImmutableMap<String, String>> pair = field_15889.get(string);
