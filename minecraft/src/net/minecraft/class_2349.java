...
public class class_2349 extends class_2383 {
	...
	public class_265 method_9530(class_2680 arg, class_1922 arg2, class_2338 arg3, class_3726 arg4) {
		if (arg.method_11654(field_11024)) {
	...
	public class_265 method_9549(class_2680 arg, class_1922 arg2, class_2338 arg3, class_3726 arg4) {
		if (arg.method_11654(field_11026)) {
	...
	public boolean method_9516(class_2680 arg, class_1922 arg2, class_2338 arg3, class_10 arg4) {
		switch(arg4) {
			case field_50:
				return arg.method_11654(field_11026);
			case field_48:
				return false;
			case field_51:
				return arg.method_11654(field_11026);
	...
	public void method_9612(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2248 arg4, class_2338 arg5, boolean bl) {
		if (!arg2.field_9236) {
			...
			if (arg.method_11654(field_11021) != bl2) {
				arg2.method_8652(arg3, arg.method_11657(field_11021, Boolean.valueOf(bl2)).method_11657(field_11026, Boolean.valueOf(bl2)), 2);
				if (arg.method_11654(field_11026) != bl2) {
					arg2.method_8444(null, bl2 ? 1008 : 1014, arg3, 0);
				}
			}
		}
	}
