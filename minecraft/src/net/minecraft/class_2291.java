...
public class class_2291 {
	...
	private final Map<class_2769<?>, Comparable<?>> field_10801 = Maps.newHashMap();
	...
	public void method_9795() throws CommandSyntaxException {
		...
		this.field_10803 = (class_1792)class_2378.field_11142.method_17966(lv).orElseThrow(() -> {
			this.field_10802.setCursor(i);
			return field_10799.createWithContext(this.field_10802, lv.toString());
		});
	}
