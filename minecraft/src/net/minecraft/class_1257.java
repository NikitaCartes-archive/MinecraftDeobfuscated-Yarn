		...
		if (this.field_5768 == 0) {
			...
			while(this.field_5760) {
				...
				for(class_2874 lv3 : class_2874.method_12482()) {
					ListIterator<class_1923> listIterator = (ListIterator)immutableMap.get(lv3);
					...
					if (listIterator.hasNext()) {
						...
						try {
							...
							field_5756.error("Error upgrading chunk {}", lv5, var21);
						}
			...
			for(class_3977 lv8 : immutableMap2.values()) {
				try {
					lv8.close();
				} catch (IOException var20) {
					field_5756.error("Error upgrading chunk", var20);
				}
			}
