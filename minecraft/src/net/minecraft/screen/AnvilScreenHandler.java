...
public class AnvilScreenHandler extends ForgingScreenHandler {
	...
	public void updateResult() {
		...
		if (!itemStack.isEmpty() && EnchantmentHelper.canHaveEnchantments(itemStack)) {
			...
			l += (long)((Integer)itemStack.getOrDefault(DataComponentTypes.REPAIR_COST, Integer.valueOf(0))).intValue()
				+ (long)((Integer)itemStack3.getOrDefault(DataComponentTypes.REPAIR_COST, Integer.valueOf(0))).intValue();
			...
			if (!itemStack2.isEmpty()) {
				int k = itemStack2.getOrDefault(DataComponentTypes.REPAIR_COST, Integer.valueOf(0));
				if (k < itemStack3.getOrDefault(DataComponentTypes.REPAIR_COST, Integer.valueOf(0))) {
					k = itemStack3.getOrDefault(DataComponentTypes.REPAIR_COST, Integer.valueOf(0));
				}
