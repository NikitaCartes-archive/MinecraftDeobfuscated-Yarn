...
public class class_1517 extends class_1512 {
	...
	private void method_6841() {
		if (this.field_7043 != null && this.field_7043.method_46()) {
			...
			if (lv2 != null
				&& !lv2.field_7503.field_7480
				&& (this.field_7036.method_6051().nextInt(class_3532.method_15382((int)d) + 2) == 0 || this.field_7036.method_6051().nextInt(i + 2) == 0)) {
		...
		if (this.field_7043 == null || this.field_7043.method_46()) {
			...
			this.field_7043 = this.field_7036.method_6833(j, i, null);
