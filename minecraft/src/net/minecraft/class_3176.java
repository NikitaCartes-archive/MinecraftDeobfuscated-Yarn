...
public class class_3176 extends MinecraftServer implements class_2994 {
	...
	public class_3176(
		...
		super(file, Proxy.NO_PROXY, dataFixer, new class_2170(true), yggdrasilAuthenticationService, minecraftSessionService, gameProfileRepository, arg2, arg3);
	...
	public boolean method_3823() throws IOException {
		Thread thread = new Thread("Server console handler") {
			public void run() {
				...
				try {
					...
					class_3176.field_13814.error("Exception handling console input", var4);
				}
			}
		};
		...
		if (this.method_3865() == null) {
			this.method_3807(lv.field_16820);
		}
