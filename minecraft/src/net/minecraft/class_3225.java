...
public class class_3225 {
	...
	public class_3225(class_3218 arg) {
	...
	public void method_14264() {
		...
		if (this.field_14001) {
			...
			if (lv2.method_11588()) {
				...
				float f = lv2.method_11589(this.field_14008, this.field_14008.field_6002, this.field_14004) * (float)(k + 1);
				int j = (int)(f * 10.0F);
				if (j != this.field_14009) {
					this.field_14007.method_8517(this.field_14008.method_5628(), this.field_14006, j);
					this.field_14009 = j;
				}
			}
		}
	...
	private boolean method_14265(class_2338 arg) {
		...
		boolean bl = this.field_14007.method_8650(arg, false);
		if (bl) {
	...
	public class_1269 method_14262(class_1657 arg, class_1937 arg2, class_1799 arg3, class_1268 arg4, class_3965 arg5) {
		class_2338 lv = arg5.method_17777();
		class_2680 lv2 = arg2.method_8320(lv);
		if (this.field_14005 == class_1934.field_9219) {
			class_3908 lv3 = lv2.method_17526(arg2, lv);
			if (lv3 != null) {
				arg.method_17355(lv3);
			...
			if (!bl2 && lv2.method_11629(arg2, arg, arg4, arg5)) {
				return class_1269.field_5812;
			} else if (!arg3.method_7960() && !arg.method_7357().method_7904(arg3.method_7909())) {
				class_1838 lv4 = new class_1838(arg, arg.method_5998(arg4), arg5);
				if (this.method_14268()) {
					int i = arg3.method_7947();
					class_1269 lv5 = arg3.method_7981(lv4);
					arg3.method_7939(i);
					return lv5;
				} else {
					return arg3.method_7981(lv4);
				}
			} else {
				return class_1269.field_5811;
			}
