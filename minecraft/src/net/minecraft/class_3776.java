...
public class class_3776 extends class_3784 {
	...
	public boolean method_16626(
		...
		return this.field_16661.generate(iWorld, chunkGenerator, random, blockPos);
	}

	@Override
	public <T> Dynamic<T> method_16625(DynamicOps<T> dynamicOps) {
		return new Dynamic<>(
			dynamicOps, dynamicOps.createMap(ImmutableMap.of(dynamicOps.createString("feature"), this.field_16661.serialize(dynamicOps).getValue()))
		);
	}
