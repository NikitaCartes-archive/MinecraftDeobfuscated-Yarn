...
public class class_52 {
	...
	public void method_329(class_1263 arg, class_47 arg2) {
		...
		for(class_1799 lv : list) {
			...
			if (lv.method_7960()) {
				arg.method_5447(list2.remove(list2.size() - 1), class_1799.field_8037);
			} else {
				arg.method_5447(list2.remove(list2.size() - 1), lv);
			}
		}
	}
	...
	public static class class_54 implements JsonDeserializer<class_52>, JsonSerializer<class_52> {
		public class_52 method_340(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
			...
			class_55[] lvs = (class_55[])class_3518.method_15283(jsonObject, "pools", new class_55[0], jsonDeserializationContext, class_55[].class);
			class_176 lv = null;
			...
			class_117[] lvs2 = (class_117[])class_3518.method_15283(jsonObject, "functions", new class_117[0], jsonDeserializationContext, class_117[].class);
