...
public class class_2570 extends class_2484 {
	...
	public static void method_10898(class_1937 arg, class_2338 arg2, class_2631 arg3) {
		if (!arg.field_9236) {
			...
			if (bl && arg2.method_10264() >= 2 && arg.method_8407() != class_1267.field_5801) {
				...
				if (lv3 != null) {
					for(int i = 0; i < lv2.method_11710(); ++i) {
						for(int j = 0; j < lv2.method_11713(); ++j) {
							class_2694 lv4 = lv3.method_11717(i, j, 0);
							arg.method_8652(lv4.method_11683(), class_2246.field_10124.method_9564(), 2);
							arg.method_20290(2001, lv4.method_11683(), class_2248.method_9507(lv4.method_11681()));
						}
					}

					class_1528 lv5 = class_1299.field_6119.method_5883(arg);
					...
					for(class_3222 lv7 : arg.method_18467(class_3222.class, lv5.method_5829().method_1014(50.0))) {
	...
	public static boolean method_10899(class_1937 arg, class_2338 arg2, class_1799 arg3) {
		if (arg3.method_7909() == class_1802.field_8791 && arg2.method_10264() >= 2 && arg.method_8407() != class_1267.field_5801 && !arg.field_9236) {
			return method_10897().method_11708(arg, arg2) != null;
		} else {
			return false;
		}
	}

	private static class_2700 method_10900() {
		if (field_11765 == null) {
	...
	private static class_2700 method_10897() {
		if (field_11764 == null) {
