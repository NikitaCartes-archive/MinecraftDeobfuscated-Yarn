...
public class class_1646 extends class_3988 implements class_4094, class_3851 {
	...
	public static final Map<class_4140<class_4208>, BiPredicate<class_1646, class_4158>> field_18851 = ImmutableMap.of(
		class_4140.field_18438,
		(BiPredicate)(arg, arg2) -> arg2 == class_4158.field_18517,
		class_4140.field_18439,
		(BiPredicate)(arg, arg2) -> arg.method_7231().method_16924().method_19198() == arg2,
		class_4140.field_18440,
		(BiPredicate)(arg, arg2) -> arg2 == class_4158.field_18518
	);
	...
	protected void method_18008(class_1914 arg) {
		...
		this.field_18536 += arg.method_19279();
	...
	public void method_19176(class_4140<class_4208> arg) {
		if (this.field_6002 instanceof class_3218) {
			...
			this.field_18321.method_18904(arg).ifPresent(arg2 -> {
				...
				BiPredicate<class_1646, class_4158> biPredicate = (BiPredicate)field_18851.get(arg);
	...
	private int method_19189() {
		...
		return field_18526.entrySet().stream().mapToInt(entry -> lv.method_18861((class_1792)entry.getKey()) * entry.getValue()).sum();
	}
	...
	protected void method_7237() {
		class_3850 lv = this.method_7231();
		Int2ObjectMap<class_3853.class_1652[]> int2ObjectMap = (Int2ObjectMap)class_3853.field_17067.get(lv.method_16924());
		if (int2ObjectMap != null && !int2ObjectMap.isEmpty()) {
			class_3853.class_1652[] lvs = (class_3853.class_1652[])int2ObjectMap.get(lv.method_16925());
			if (lvs != null) {
	...
	public void method_20688(long l, int i) {
		if (this.method_20687(l)) {
			...
			List<class_1646> list2 = (List)list.stream().filter(arg -> arg.method_20687(l)).limit(5L).collect(Collectors.toList());
			if (list2.size() >= i) {
	...
	public boolean method_20687(long l) {
		...
		if (lv.method_16924() == class_3852.field_17051 || lv.method_16924() == class_3852.field_17062) {
			return false;
		} else if (!this.method_20741(this.field_6002.method_8510())) {
			return false;
		} else {
