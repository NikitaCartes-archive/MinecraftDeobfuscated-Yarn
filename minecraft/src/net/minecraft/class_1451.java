...
public class class_1451 extends class_1321 {
	...
	public static final Map<Integer, class_2960> field_16283 = class_156.method_654(Maps.newHashMap(), hashMap -> {
	...
	public class_1451(class_1299<? extends class_1451> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public class_1451 method_6573(class_1296 arg) {
		class_1451 lv = class_1299.field_16281.method_5883(this.field_6002);
		if (arg instanceof class_1451) {
		...
		if (this.method_6181()) {
			if (this.method_6171(arg)) {
				if (lv2 instanceof class_1769) {
					...
					if (this.method_6032() < this.method_6063() && lv2.method_19263()) {
	...
	static class class_3698<T extends class_1309> extends class_1338<T> {
	...
	static class class_3699 extends class_1352 {
		...
		private boolean method_16098() {
			for(class_1451 lv : this.field_16297.field_6002.method_18467(class_1451.class, new class_238(this.field_16294).method_1014(2.0))) {
	...
	static class class_3700 extends class_1391 {
		...
		private final class_1451 field_17948;

		public class_3700(class_1451 arg, double d, class_1856 arg2, boolean bl) {
			super(arg, d, arg2, bl);
			this.field_17948 = arg;
		}
		...
		@Override
		public boolean method_6264() {
			return super.method_6264() && !this.field_17948.method_6181();
		}
	}
}
