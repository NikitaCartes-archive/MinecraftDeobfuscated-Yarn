...
public class class_2597 extends class_2586 implements class_3000 {
			...
			for(int j = -2; j <= 2; ++j) {
				for(int k = -2; k <= 2; ++k) {
					...
					if ((l > 1 || m > 1 || n > 1) && (i == 0 && (m == 2 || n == 2) || j == 0 && (l == 2 || n == 2) || k == 0 && (l == 2 || m == 2))) {
						class_2338 lv2 = this.field_11867.method_10069(i, j, k);
	...
	private void method_11055() {
		...
		List<class_1657> list = this.field_11863.method_8403(class_1657.class, lv);
		if (!list.isEmpty()) {
			for(class_1657 lv2 : list) {
				if (this.field_11867.method_10267(new class_2338(lv2)) <= (double)j && lv2.method_5721()) {
	...
	private void method_11068() {
		...
		} else if (!this.field_11939.method_5805() || this.field_11867.method_10267(new class_2338(this.field_11939)) > 8.0) {
			this.field_11939 = null;
		}
	...
	private void method_11063() {
		...
		if (this.field_11939 != null) {
			class_243 lv5 = new class_243(
				this.field_11939.field_5987, this.field_11939.field_6010 + (double)this.field_11939.method_5751(), this.field_11939.field_6035
			);
			float j = (-0.5F + random.nextFloat()) * (3.0F + this.field_11939.field_5998);
			float g = -1.0F + random.nextFloat() * this.field_11939.field_6019;
			float h = (-0.5F + random.nextFloat()) * (3.0F + this.field_11939.field_5998);
