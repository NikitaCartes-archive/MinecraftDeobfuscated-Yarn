...
public class class_2542 extends class_2248 {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (this.method_10832(arg2) && this.method_10831(arg2, arg3)) {
			int i = arg.method_11654(field_11711);
			if (i < 2) {
				...
				if (!arg2.field_9236) {
					for(int j = 0; j < arg.method_11654(field_11710); ++j) {
						arg2.method_8535(2001, arg3, class_2248.method_9507(arg));
						class_1481 lv = new class_1481(arg2);
	...
	private boolean method_10832(class_1937 arg) {
		...
		if ((double)f < 0.69 && (double)f > 0.65) {
			...
			return arg.field_9229.nextInt(500) == 0;
		}
	}
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		return lv.method_11614() == this ? lv.method_11657(field_11710, Integer.valueOf(Math.min(4, lv.method_11654(field_11710) + 1))) : super.method_9605(arg);
	}
	...
	private boolean method_10835(class_1937 arg, class_1297 arg2) {
		if (arg2 instanceof class_1481) {
			...
			return arg2 instanceof class_1309 && !(arg2 instanceof class_1657) ? arg.method_8450().method_8355("mobGriefing") : true;
		}
	}
}
