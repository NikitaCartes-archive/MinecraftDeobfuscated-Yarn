	...
	public boolean method_12977(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, class_3111 arg4) {
		...
		if (!field_13450.method_11760(arg.method_8320(arg3))) {
			...
			for(int i = -1; i <= 0; ++i) {
				for(int j = -2; j <= 2; ++j) {
					for(int k = -2; k <= 2; ++k) {
						arg.method_8652(arg3.method_10069(j, i, k), this.field_13451, 2);
					}
				}
			}
			...
			for(int i = -2; i <= 2; ++i) {
				for(int j = -2; j <= 2; ++j) {
					if (i == -2 || i == 2 || j == -2 || j == 2) {
						arg.method_8652(arg3.method_10069(i, 1, j), this.field_13451, 2);
					}
				}
			}
			...
			for(int i = -1; i <= 1; ++i) {
				for(int j = -1; j <= 1; ++j) {
					if (i == 0 && j == 0) {
						arg.method_8652(arg3.method_10069(i, 4, j), this.field_13451, 2);
					} else {
						arg.method_8652(arg3.method_10069(i, 4, j), this.field_13452, 2);
					}
				}
			}
