...
public class class_3603 extends DataFix {
	private static final Map<String, String> field_15895 = DataFixUtils.make(Maps.newHashMap(), hashMap -> {
	...
	public class_3603(Schema schema, boolean bl) {
		super(schema, bl);
	}
