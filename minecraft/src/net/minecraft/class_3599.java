...
public class class_3599 extends DataFix {
	public class_3599(Schema schema, boolean bl) {
		super(schema, bl);
	}

	@Override
	public TypeRewriteRule makeRule() {
		return this.method_15703(this.getInputSchema().getTypeRaw(class_1208.field_5712));
	}
	...
	private <IS> TypeRewriteRule method_15703(Type<IS> type) {
		...
		return this.fixTypeEverywhereTyped(
			...
			this.getOutputSchema().getType(class_1208.field_5729),
			typed -> {
