...
public enum class_2766 implements class_3542 {
	...
	field_18284("iron_xylophone", class_3417.field_18308),
	field_18285("cow_bell", class_3417.field_18309),
	field_18286("didgeridoo", class_3417.field_18310),
	field_18287("bit", class_3417.field_18311),
	field_18288("banjo", class_3417.field_18312),
	field_18289("pling", class_3417.field_14622);
	...
	public static class_2766 method_11887(class_2680 arg) {
		...
		if (lv == class_2246.field_10460) {
			...
			return field_12655;
		} else if (lv == class_2246.field_10085) {
			return field_18284;
		} else if (lv == class_2246.field_10114) {
			return field_18285;
		} else if (lv == class_2246.field_10261) {
			return field_18286;
		} else if (lv == class_2246.field_10234) {
			return field_18287;
		} else if (lv == class_2246.field_10359) {
			return field_18288;
		} else if (lv == class_2246.field_10171) {
			return field_18289;
		} else {
