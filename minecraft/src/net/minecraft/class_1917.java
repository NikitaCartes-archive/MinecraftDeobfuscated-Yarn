...
public abstract class class_1917 {
	...
	private boolean method_8284() {
		...
		return this.method_8271()
			.method_18458((double)lv.method_10263() + 0.5, (double)lv.method_10264() + 0.5, (double)lv.method_10260() + 0.5, (double)this.field_9158);
	}
	...
	public void method_8285() {
		if (!this.method_8284()) {
			...
			class_1937 lv = this.method_8271();
			class_2338 lv2 = this.method_8276();
			if (lv.field_9236) {
				double d = (double)((float)lv2.method_10263() + lv.field_9229.nextFloat());
				double e = (double)((float)lv2.method_10264() + lv.field_9229.nextFloat());
				double f = (double)((float)lv2.method_10260() + lv.field_9229.nextFloat());
				lv.method_8406(class_2398.field_11251, d, e, f, 0.0, 0.0, 0.0);
				lv.method_8406(class_2398.field_11240, d, e, f, 0.0, 0.0, 0.0);
				...
				for (int i = 0; i < this.field_9149; i++) {
					class_2487 lv3 = this.field_9155.method_8678();
					Optional<class_1299<?>> optional = class_1299.method_17684(lv3);
					if (!optional.isPresent()) {
						this.method_8282();
						return;
					}

					class_2499 lv4 = lv3.method_10554("Pos", 6);
					int j = lv4.size();
					double g = j >= 1
						? lv4.method_10611(0)
						: (double)lv2.method_10263() + (lv.field_9229.nextDouble() - lv.field_9229.nextDouble()) * (double)this.field_9157 + 0.5;
					double h = j >= 2 ? lv4.method_10611(1) : (double)(lv2.method_10264() + lv.field_9229.nextInt(3) - 1);
					double k = j >= 3
						? lv4.method_10611(2)
						: (double)lv2.method_10260() + (lv.field_9229.nextDouble() - lv.field_9229.nextDouble()) * (double)this.field_9157 + 0.5;
					if (lv.method_18026(((class_1299)optional.get()).method_17683(g, h, k))
						&& class_1317.method_20638((class_1299)optional.get(), lv.method_8410(), class_3730.field_16469, new class_2338(g, h, k), lv.method_8409())) {
						class_1297 lv5 = class_1299.method_17842(lv3, lv, arg -> {
							arg.method_5808(g, h, k, arg.field_6031, arg.field_5965);
							return arg;
						});
						if (lv5 == null) {
							this.method_8282();
						...
						int l = lv.method_18467(
								lv5.getClass(),
								new class_238(
										(double)lv2.method_10263(),
										(double)lv2.method_10264(),
										(double)lv2.method_10260(),
										(double)(lv2.method_10263() + 1),
										(double)(lv2.method_10264() + 1),
										(double)(lv2.method_10260() + 1)
									)
						...
						lv5.method_5808(lv5.field_5987, lv5.field_6010, lv5.field_6035, lv.field_9229.nextFloat() * 360.0F, 0.0F);
						if (lv5 instanceof class_1308) {
							class_1308 lv6 = (class_1308)lv5;
							if (!lv6.method_5979(lv, class_3730.field_16469) || !lv6.method_5957(lv)) {
								continue;
							}

							if (this.field_9155.method_8678().method_10546() == 1 && this.field_9155.method_8678().method_10573("id", 8)) {
								((class_1308)lv5).method_5943(lv, lv.method_8404(new class_2338(lv5)), class_3730.field_16469, null, null);
							}
						}

						this.method_18086(lv5);
						lv.method_20290(2004, lv2, 0);
						if (lv5 instanceof class_1308) {
							((class_1308)lv5).method_5990();
						}
	...
	private void method_18086(class_1297 arg) {
		if (this.method_8271().method_8649(arg)) {
			for (class_1297 lv : arg.method_5685()) {
				this.method_18086(lv);
			}
		}
	}
	...
	public class_2487 method_8272(class_2487 arg) {
		...
		if (lv == null) {
			...
			if (this.field_9152.isEmpty()) {
				lv2.add(this.field_9155.method_8679());
			} else {
				for (class_1952 lv3 : this.field_9152) {
					lv2.add(lv3.method_8679());
				}
			}
	...
	public class_1297 method_8283() {
		if (this.field_9153 == null) {
			this.field_9153 = class_1299.method_17842(this.field_9155.method_8678(), this.method_8271(), Function.identity());
