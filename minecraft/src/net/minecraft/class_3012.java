	...
	public static void method_13008(CommandDispatcher<class_2168> commandDispatcher) {
		commandDispatcher.register(
			class_2170.method_9247("ban-ip")
				...
				.then(
					((RequiredArgumentBuilder)class_2170.method_9244("target", StringArgumentType.word())
							.executes(commandContext -> method_13009((class_2168)commandContext.getSource(), StringArgumentType.getString(commandContext, "target"), null)))
						.then(
