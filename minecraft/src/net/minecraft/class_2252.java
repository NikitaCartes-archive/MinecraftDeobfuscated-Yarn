...
public class class_2252 implements ArgumentType<class_2252.class_2254> {
	...
	private static final DynamicCommandExceptionType field_10671 = new DynamicCommandExceptionType(
		object -> new class_2588("arguments.block.tag.unknown", object)
	);
	...
	public class_2252.class_2254 method_9642(StringReader stringReader) throws CommandSyntaxException {
		...
		if (lv.method_9669() != null) {
			...
			return arg3 -> {
				class_3494<class_2248> lvxx = arg3.method_15202().method_15193(lv3);
				if (lvxx == null) {
					throw field_10671.create(lv3.toString());
				} else {
					return new class_2252.class_2255(lvxx, lv.method_9688(), lv.method_9694());
				}
			};
		}
	}
