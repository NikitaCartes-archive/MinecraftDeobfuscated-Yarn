...
public final class class_2512 {
	...
	public static class_2487 method_10688(DataFixer dataFixer, class_4284 arg, class_2487 arg2, int i) {
		return method_10693(dataFixer, arg, arg2, i, class_155.method_16673().getWorldVersion());
	}

	public static class_2487 method_10693(DataFixer dataFixer, class_4284 arg, class_2487 arg2, int i, int j) {
		return (class_2487)dataFixer.update(arg.method_20329(), new Dynamic<>(class_2509.field_11560, arg2), i, j).getValue();
	}
}
