...
public class class_1481 extends class_1429 {
	...
	public static boolean method_20671(class_1299<class_1481> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		return arg4.method_10264() < arg2.method_8615() + 4
			&& arg2.method_8320(arg4.method_10074()).method_11614() == class_2246.field_10102
	...
	public float method_6144(class_2338 arg, class_1941 arg2) {
		if (!this.method_6684() && arg2.method_8316(arg).method_15767(class_3486.field_15517)) {
			return 10.0F;
		} else {
			return arg2.method_8320(arg.method_10074()).method_11614() == class_2246.field_10102 ? 10.0F : arg2.method_8610(arg) - 0.5F;
		}
	}
	...
	public void method_6007() {
		...
		if (this.method_5805() && this.method_6695() && this.field_6918 >= 1 && this.field_6918 % 5 == 0) {
			...
			if (this.field_6002.method_8320(lv.method_10074()).method_11614() == class_2246.field_10102) {
				this.field_6002.method_20290(2001, lv, class_2248.method_9507(class_2246.field_10102.method_9564()));
			}
		}
	}
	...
	protected void method_5619() {
		super.method_5619();
		if (!this.method_6109() && this.field_6002.method_8450().method_8355(class_1928.field_19391)) {
	...
	static class class_1483 extends class_1352 {
		...
		public boolean method_6264() {
			if (this.field_6930.method_6109()) {
				...
				return !this.field_6930.method_6693().method_19769(this.field_6930.method_19538(), 64.0);
			}
		}
