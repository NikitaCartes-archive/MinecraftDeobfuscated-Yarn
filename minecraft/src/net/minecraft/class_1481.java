...
public class class_1481 extends class_1429 {
	...
	public static final Predicate<class_1297> field_6921 = arg -> {
		if (!(arg instanceof class_1309)) {
			return false;
		} else {
			return ((class_1309)arg).method_6109() && !arg.method_5799();
		}
	};

	public class_1481(class_1937 arg) {
		super(class_1299.field_6113, arg);
		this.method_5835(1.2F, 0.4F);
	...
	public class_1315 method_5943(class_1936 arg, class_1266 arg2, class_3730 arg3, @Nullable class_1315 arg4, @Nullable class_2487 arg5) {
		this.method_6683(new class_2338(this.field_5987, this.field_6010, this.field_6035));
	...
	public class_1296 method_5613(class_1296 arg) {
		return new class_1481(this.field_6002);
	}
	...
	protected void method_5619() {
		super.method_5619();
		if (this.field_6002.method_8450().method_8355("doMobLoot")) {
	...
	public void method_6091(float f, float g, float h) {
		if (this.method_6034() && this.method_5799()) {
			...
			if (this.method_5968() == null && (!this.method_6684() || !(this.method_5831(this.method_6693()) < 400.0))) {
	...
	static class class_1483 extends class_1352 {
		...
		public boolean method_6264() {
			if (this.field_6930.method_6109()) {
				...
				return true;
			} else if (this.field_6930.method_6051().nextInt(700) != 0) {
				return false;
			} else {
				return this.field_6930.method_5831(this.field_6930.method_6693()) >= 4096.0;
			}
		}
		...
		public void method_6268() {
			...
			boolean bl = this.field_6930.method_5831(lv) <= 256.0;
			if (bl) {
				++this.field_6928;
			}
	...
	static class class_1485 extends class_1367 {
		...
		@Override
		public boolean method_6264() {
			return this.field_6932.method_6679() && this.field_6932.method_5831(this.field_6932.method_6693()) < 81.0 ? super.method_6264() : false;
		}

		@Override
		public boolean method_6266() {
			return super.method_6266() && this.field_6932.method_6679() && this.field_6932.method_5831(this.field_6932.method_6693()) < 81.0;
		}
	...
	static class class_1486 extends class_1335 {
		...
		private void method_6700() {
			if (this.field_6933.method_5799()) {
				this.field_6933.field_5984 += 0.005;
				if (this.field_6933.method_5831(this.field_6933.method_6693()) > 256.0) {
		...
		public void method_6240() {
			...
			if (this.field_6374 == class_1335.class_1336.field_6378 && !this.field_6933.method_5942().method_6357()) {
				...
				this.field_6933.field_5984 += (double)this.field_6933.method_6029() * e * 0.1;
			} else {
	...
	static class class_1488 extends class_1412 {
		...
		protected class_13 method_6336() {
			return new class_13(new class_15());
		}
	...
	static class class_1490 extends class_1352 {
		...
		public boolean method_6264() {
			if (this.field_6936 > 0) {
				...
				this.field_6939 = this.field_6938.field_6002.method_8614(this.field_6938, 10.0);
				if (this.field_6939 == null) {
					return false;
				} else {
					return this.method_6701(this.field_6939.method_6047()) || this.method_6701(this.field_6939.method_6079());
				}
			}
		}
