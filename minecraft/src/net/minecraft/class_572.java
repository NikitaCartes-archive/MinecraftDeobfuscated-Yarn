...
public class class_572<T extends class_1309> extends class_583<T> implements class_3881, class_3882 {
	...
	public void method_17087(T arg, float f, float g, float h, float i, float j, float k) {
		...
		float m;
		if (bl) {
			float l = (float)arg.method_18798().method_1027();
			m = Math.min(l * l * l * 125.0F, 1.0F);
		} else {
			m = 1.0F;
		}

		this.field_3401.field_3654 = class_3532.method_15362(f * 0.6662F + (float) Math.PI) * 2.0F * g * 0.5F / m;
		this.field_3390.field_3654 = class_3532.method_15362(f * 0.6662F) * 2.0F * g * 0.5F / m;
		this.field_3401.field_3674 = 0.0F;
		this.field_3390.field_3674 = 0.0F;
		this.field_3392.field_3654 = class_3532.method_15362(f * 0.6662F) * 1.4F * g / m;
		this.field_3397.field_3654 = class_3532.method_15362(f * 0.6662F + (float) Math.PI) * 1.4F * g / m;
		...
		if (this.field_3447 > 0.0F) {
			...
			float n = this.field_3447;
			this.field_3391.field_3675 = class_3532.method_15374(class_3532.method_15355(n) * (float) (Math.PI * 2)) * 0.2F;
			...
			n = 1.0F - this.field_3447;
			n *= n;
			n *= n;
			n = 1.0F - n;
			float o = class_3532.method_15374(n * (float) Math.PI);
			float p = class_3532.method_15374(this.field_3447 * (float) Math.PI) * -(this.field_3398.field_3654 - 0.7F) * 0.75F;
			lv2.field_3654 = (float)((double)lv2.field_3654 - ((double)o * 1.2 + (double)p));
			lv2.field_3675 += this.field_3391.field_3675 * 2.0F;
			lv2.field_3674 += class_3532.method_15374(this.field_3447 * (float) Math.PI) * -0.4F;
		}
		...
		this.field_3401.field_3674 += class_3532.method_15362(h * 0.09F) * 0.05F + 0.05F;
		this.field_3390.field_3674 -= class_3532.method_15362(h * 0.09F) * 0.05F + 0.05F;
		this.field_3401.field_3654 += class_3532.method_15374(h * 0.067F) * 0.05F;
		this.field_3390.field_3654 -= class_3532.method_15374(h * 0.067F) * 0.05F;
		...
		float l = (float)class_1764.method_7775(arg.method_6030());
		if (this.field_3395 == class_572.class_573.field_3405) {
			...
			float q = class_3532.method_15363(this.field_3393, 0.0F, l);
			this.field_3390.field_3675 = class_3532.method_16439(q / l, 0.4F, 0.85F);
			this.field_3390.field_3654 = class_3532.method_16439(q / l, this.field_3390.field_3654, (float) (-Math.PI / 2));
		} else if (this.field_3399 == class_572.class_573.field_3405) {
			this.field_3390.field_3675 = 0.8F;
			this.field_3401.field_3654 = -0.97079635F;
			this.field_3390.field_3654 = -0.97079635F;
			float q = class_3532.method_15363(this.field_3393, 0.0F, l);
			this.field_3401.field_3675 = class_3532.method_16439(q / l, -0.4F, -0.85F);
			this.field_3401.field_3654 = class_3532.method_16439(q / l, this.field_3401.field_3654, (float) (-Math.PI / 2));
		}
		...
		if (this.field_3396 > 0.0F) {
			float q = f % 26.0F;
			float n = this.field_3447 > 0.0F ? 0.0F : this.field_3396;
			if (q < 14.0F) {
				this.field_3390.field_3654 = this.method_2804(this.field_3390.field_3654, 0.0F, this.field_3396);
				this.field_3401.field_3654 = class_3532.method_16439(n, this.field_3401.field_3654, 0.0F);
				this.field_3390.field_3675 = this.method_2804(this.field_3390.field_3675, (float) Math.PI, this.field_3396);
				this.field_3401.field_3675 = class_3532.method_16439(n, this.field_3401.field_3675, (float) Math.PI);
				...
				this.field_3401.field_3674 = class_3532.method_16439(
					n, this.field_3401.field_3674, (float) Math.PI - 1.8707964F * this.method_2807(q) / this.method_2807(14.0F)
				);
			} else if (q >= 14.0F && q < 22.0F) {
				float o = (q - 14.0F) / 8.0F;
				this.field_3390.field_3654 = this.method_2804(this.field_3390.field_3654, (float) (Math.PI / 2) * o, this.field_3396);
				this.field_3401.field_3654 = class_3532.method_16439(n, this.field_3401.field_3654, (float) (Math.PI / 2) * o);
				this.field_3390.field_3675 = this.method_2804(this.field_3390.field_3675, (float) Math.PI, this.field_3396);
				this.field_3401.field_3675 = class_3532.method_16439(n, this.field_3401.field_3675, (float) Math.PI);
				this.field_3390.field_3674 = this.method_2804(this.field_3390.field_3674, 5.012389F - 1.8707964F * o, this.field_3396);
				this.field_3401.field_3674 = class_3532.method_16439(n, this.field_3401.field_3674, 1.2707963F + 1.8707964F * o);
			} else if (q >= 22.0F && q < 26.0F) {
				float o = (q - 22.0F) / 4.0F;
				this.field_3390.field_3654 = this.method_2804(this.field_3390.field_3654, (float) (Math.PI / 2) - (float) (Math.PI / 2) * o, this.field_3396);
				this.field_3401.field_3654 = class_3532.method_16439(n, this.field_3401.field_3654, (float) (Math.PI / 2) - (float) (Math.PI / 2) * o);
				this.field_3390.field_3675 = this.method_2804(this.field_3390.field_3675, (float) Math.PI, this.field_3396);
				this.field_3401.field_3675 = class_3532.method_16439(n, this.field_3401.field_3675, (float) Math.PI);
				this.field_3390.field_3674 = this.method_2804(this.field_3390.field_3674, (float) Math.PI, this.field_3396);
				this.field_3401.field_3674 = class_3532.method_16439(n, this.field_3401.field_3674, (float) Math.PI);
			}
