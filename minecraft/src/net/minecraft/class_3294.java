...
public class class_3294 implements class_3300 {
	...
	public boolean method_18234(class_2960 arg) {
		if (!this.method_18221(arg)) {
			return false;
		} else {
			for (int i = this.field_14283.size() - 1; i >= 0; i--) {
				class_3262 lv = (class_3262)this.field_14283.get(i);
				if (lv.method_14411(this.field_14284, arg)) {
					return true;
				}
			}
	...
	private boolean method_18221(class_2960 arg) {
		return !arg.method_12832().contains("..");
	}
