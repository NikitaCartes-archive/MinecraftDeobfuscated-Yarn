...
public abstract class class_1297 implements class_1275, class_2165 {
	...
	private static final class_2940<class_4050> field_18064 = class_2945.method_12791(class_1297.class, class_2943.field_18238);
	...
	public boolean equals(Object object) {
		if (object instanceof class_1297) {
			return ((class_1297)object).field_5986 == this.field_5986;
		} else {
			return false;
		}
	}
	...
	public void method_5784(class_1313 arg, class_243 arg2) {
		if (this.field_5960) {
			...
			this.field_5976 = arg2.field_1352 != lv.field_1352 || arg2.field_1350 != lv.field_1350;
			...
			if (this.method_5658() && (!this.field_5952 || !this.method_5715() || !(this instanceof class_1657)) && !this.method_5765()) {
				...
				if (this.field_5994 > this.field_6003 && !lv3.method_11588()) {
					...
					if (this.method_5799()) {
						...
						float h = class_3532.method_15368(
								lv10.field_1352 * lv10.field_1352 * 0.2F + lv10.field_1351 * lv10.field_1351 + lv10.field_1350 * lv10.field_1350 * 0.2F
							)
							* g;
						if (h > 1.0F) {
							h = 1.0F;
	...
	private class_243 method_17835(class_243 arg) {
		...
		Stream<class_265> stream = class_259.method_1074(lv3, class_259.method_1078(lv.method_1011(1.0E-7)), class_247.field_16896)
			? Stream.empty()
			: Stream.of(lv3);
		class_238 lv4 = lv.method_18804(arg).method_1014(1.0E-7);
		Stream<class_265> stream2 = this.field_6002
			.method_8335(this, lv4)
			.stream()
			.filter(argx -> !this.method_5794(argx))
			.flatMap(argx -> Stream.of(argx.method_5827(), this.method_5708(argx)))
			.filter(Objects::nonNull)
			.filter(lv4::method_994)
			.map(class_259::method_1078);
		class_3538<class_265> lv5 = new class_3538<>(Stream.concat(stream2, stream));
		class_243 lv6 = arg.method_1027() == 0.0 ? arg : method_17833(arg, lv, this.field_6002, lv2, lv5);
		boolean bl = arg.field_1352 != lv6.field_1352;
		boolean bl2 = arg.field_1351 != lv6.field_1351;
		boolean bl3 = arg.field_1350 != lv6.field_1350;
		boolean bl4 = this.field_5952 || bl2 && arg.field_1351 < 0.0;
		if (this.field_6013 > 0.0F && bl4 && (bl || bl3)) {
			class_243 lv7 = method_17833(new class_243(arg.field_1352, (double)this.field_6013, arg.field_1350), lv, this.field_6002, lv2, lv5);
			class_243 lv8 = method_17833(
				new class_243(0.0, (double)this.field_6013, 0.0), lv.method_1012(arg.field_1352, 0.0, arg.field_1350), this.field_6002, lv2, lv5
			);
			if (lv8.field_1351 < (double)this.field_6013) {
				class_243 lv9 = method_17833(new class_243(arg.field_1352, 0.0, arg.field_1350), lv.method_997(lv8), this.field_6002, lv2, lv5).method_1019(lv8);
				if (method_17996(lv9) > method_17996(lv7)) {
					lv7 = lv9;
				}
			}

			if (method_17996(lv7) > method_17996(lv6)) {
				return lv7.method_1019(method_17833(new class_243(0.0, -lv7.field_1351 + arg.field_1351, 0.0), lv.method_997(lv7), this.field_6002, lv2, lv5));
			}
		}
	...
	public class_1297 method_5731(class_2874 arg) {
		if (!this.field_6002.field_9236 && !this.field_5988) {
			...
			if (lv == class_2874.field_13078 && arg == class_2874.field_13072) {
				...
				long l = class_1923.method_8331(class_3532.method_15357(d), class_3532.method_15357(e));
				lv5 = new class_2338(d, this.field_6010, e);
				Pair<class_243, Pair<class_243, Integer>> pair = lv3.method_14173().method_18475(lv5, lv4, l, this.method_5843(), lv6.field_1352, lv6.field_1351);
				if (pair != null) {
					lv5 = new class_2338(pair.getFirst());
					lv4 = pair.getSecond().getFirst();
					f = (float)((Integer)pair.getSecond().getSecond()).intValue();
				}
			}

			this.field_6002.method_16107().method_15405("reloading");
			class_1297 lv7 = this.method_5864().method_5883(lv3);
			if (lv7 != null) {
				lv7.method_5878(this);
				lv7.method_5725(lv5, lv7.field_6031 + f, lv7.field_5965);
				lv7.method_18799(lv4);
				lv3.method_18769(lv7);
			}
	...
	public boolean method_5787() {
		...
		if (lv instanceof class_1657) {
			return ((class_1657)lv).method_7340();
		} else {
