...
public class class_3390 {
	...
	private static class_3390.class_3403 method_14795(
		class_3390.class_3404 arg, List<class_3443> list, Random random, int i, int j, int k, class_2350 arg2, int l
	) {
	...
	public static class class_3396 extends class_3390.class_3403 {
		...
		public boolean method_14931(class_1936 arg, Random random, class_3341 arg2, class_1923 arg3) {
			...
			for(int i = 4; i <= 8; ++i) {
				for(int j = 0; j <= 2; ++j) {
					this.method_14936(arg, class_2246.field_10266.method_9564(), i, -1, j, arg2);
					this.method_14936(arg, class_2246.field_10266.method_9564(), i, -1, 12 - j, arg2);
				}
			}
			...
			for(int i = 0; i <= 2; ++i) {
				for(int j = 4; j <= 8; ++j) {
					this.method_14936(arg, class_2246.field_10266.method_9564(), i, -1, j, arg2);
					this.method_14936(arg, class_2246.field_10266.method_9564(), 12 - i, -1, j, arg2);
				}
			}
	...
	public static class class_3401 extends class_3390.class_3403 {
		...
		public boolean method_14931(class_1936 arg, Random random, class_3341 arg2, class_1923 arg3) {
			...
			for(int i = 3; i <= 9; i += 2) {
				this.method_14940(arg, arg2, 1, 7, i, 1, 8, i, lv3, lv3, false);
				this.method_14940(arg, arg2, 11, 7, i, 11, 8, i, lv4, lv4, false);
			}
