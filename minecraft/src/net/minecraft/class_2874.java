...
public class class_2874 implements class_4213 {
	...
	public static class_2874 method_19298(Dynamic<?> dynamic) {
		return class_2378.field_11155.method_10223(new class_2960(dynamic.asString("")));
	}
	...
	public <T> T method_19508(DynamicOps<T> dynamicOps) {
		return dynamicOps.createString(class_2378.field_11155.method_10221(this).toString());
	}
}
