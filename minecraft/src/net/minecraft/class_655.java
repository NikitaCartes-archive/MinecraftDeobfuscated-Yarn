...
public class class_655 extends Particle {
	protected class_655(World world, double d, double e, double f, double g, double h, double i) {
	...
	@Environment(EnvType.CLIENT)
	public static class class_656 implements FactoryParticle<TexturedParticle> {
		public Particle createParticle(TexturedParticle texturedParticle, World world, double d, double e, double f, double g, double h, double i) {
			return new class_655(world, d, e, f, g, h, i);
		}
	}
}
