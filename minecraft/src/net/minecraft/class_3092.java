...
public class class_3092 extends class_3096<class_3111> {
	...
	public boolean method_12775(Set<class_2338> set, class_3747 arg, Random random, class_2338 arg2, class_3341 arg3) {
		...
		if (!this.method_13523(arg, arg2, i)) {
			...
			this.method_13506(arg, arg2.method_10086(i), 2, arg3, set);
			...
			for (int j = arg2.method_10264() + i - 2 - random.nextInt(4); j > arg2.method_10264() + i / 2; j -= 2 + random.nextInt(4)) {
				...
				for (int m = 0; m < 5; m++) {
					...
					this.method_12773(set, arg, new class_2338(k, j - 3 + m / 2, l), this.field_13685, arg3);
				}
				...
				for (int o = j - m; o <= n; o++) {
					int p = o - n;
					this.method_13526(arg, new class_2338(k, o, l), 1 - p, arg3, set);
				}
			}
			...
			for (int q = 0; q < i; q++) {
				...
				if (method_16432(arg, lv)) {
					this.method_12773(set, arg, lv, this.field_13685, arg3);
					if (q > 0) {
				...
				if (q < i - 1) {
					...
					if (method_16432(arg, lv2)) {
						this.method_12773(set, arg, lv2, this.field_13685, arg3);
						if (q > 0) {
					...
					if (method_16432(arg, lv3)) {
						this.method_12773(set, arg, lv3, this.field_13685, arg3);
						if (q > 0) {
					...
					if (method_16432(arg, lv4)) {
						this.method_12773(set, arg, lv4, this.field_13685, arg3);
						if (q > 0) {
	...
	private void method_13506(class_3747 arg, class_2338 arg2, int i, class_3341 arg3, Set<class_2338> set) {
		int j = 2;

		for (int k = -2; k <= 0; k++) {
			this.method_13528(arg, arg2.method_10086(k), i + 1 - k, arg3, set);
		}
	}
}
