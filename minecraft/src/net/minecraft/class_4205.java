...
public class class_4205 implements class_863.class_864 {
	...
	private final Map<Integer, List<class_4205.class_4206>> field_18781 = Maps.newHashMap();
	...
	public void method_3715(long l) {
		...
		this.field_18781.forEach((integer, list) -> {
			for(int i = 0; i < list.size(); ++i) {
				class_4205.class_4206 lvxx = (class_4205.class_4206)list.get(i);
				if (lv2.method_19771(lvxx.field_18782, 160.0)) {
					double d = (double)lvxx.field_18782.method_10263() + 0.5;
					double e = (double)lvxx.field_18782.method_10264() + 2.0 + (double)i * 0.25;
					double f = (double)lvxx.field_18782.method_10260() + 0.5;
					int j = lvxx.field_18785 ? -16711936 : -3355444;
					class_863.method_3714(lvxx.field_18784, d, e, f, j);
				}
			}
		});
