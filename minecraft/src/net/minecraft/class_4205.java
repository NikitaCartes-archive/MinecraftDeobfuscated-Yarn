...
public class class_4205 implements DebugRenderer.DebugRenderer {
	...
	private final Map<String, List<class_4205.class_4206>> field_18781 = Maps.newHashMap();
	...
	public void render(long l) {
		...
		this.field_18781.forEach((string, list) -> {
			for(int i = 0; i < list.size(); ++i) {
				...
				if (blockPos.distanceTo(lvxx.field_18782) < 160.0) {
					double d = (double)lvxx.field_18782.getX() + 0.5;
					double e = (double)lvxx.field_18782.getY() + 2.0 + (double)i * 0.25;
					double f = (double)lvxx.field_18782.getZ() + 0.5;
					int j = lvxx.field_18785 ? -16711936 : -3355444;
					DebugRenderer.method_3714(lvxx.field_18784, d, e, f, j);
				}
			}
		});
