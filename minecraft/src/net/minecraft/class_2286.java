...
public class class_2286 extends class_2312 implements class_2343 {
	...
	protected boolean method_9990(class_1937 arg, class_2338 arg2, class_2680 arg3) {
		...
		if (i >= 15) {
			...
			return i >= this.method_10000(arg, arg2, arg3);
		}
	}

	@Override
	protected void method_9994(class_1937 arg, class_2338 arg2) {
		arg.method_8544(arg2);
	}
	...
	public boolean method_9534(class_2680 arg, class_1937 arg2, class_2338 arg3, class_1657 arg4, class_1268 arg5, class_2350 arg6, float f, float g, float h) {
		if (!arg4.field_7503.field_7476) {
			...
			float i = arg.method_11654(field_10789) == class_2747.field_12578 ? 0.55F : 0.5F;
			arg2.method_8396(arg4, arg3, class_3417.field_14762, class_3419.field_15245, 0.3F, i);
	...
	protected void method_9998(class_1937 arg, class_2338 arg2, class_2680 arg3) {
		if (!arg.method_8397().method_8677(arg2, this)) {
			...
			if (i != j || arg3.method_11654(field_10911) != this.method_9990(arg, arg2, arg3)) {
	...
	private void method_9775(class_1937 arg, class_2338 arg2, class_2680 arg3) {
		...
		if (j != i || arg3.method_11654(field_10789) == class_2747.field_12576) {
			...
			boolean bl2 = arg3.method_11654(field_10911);
			if (bl2 && !bl) {
