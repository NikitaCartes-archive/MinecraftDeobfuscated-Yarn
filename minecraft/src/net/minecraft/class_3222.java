...
public class class_3222 extends class_1657 implements class_1712 {
	...
	private final List<Integer> field_13988 = Lists.newLinkedList();
	...
	private class_1657.class_1659 field_13993;
	...
	private class_1923 field_13990 = new class_1923(0, 0);
	...
	private void method_14245(class_3218 arg) {
		...
		if (arg.field_9247.method_12451() && arg.method_8401().method_210() != class_1934.field_9216) {
			...
			for(int n = 0; n < k; ++n) {
				...
				int p = o % (i * 2 + 1);
				int q = o / (i * 2 + 1);
				class_2338 lv2 = arg.method_8597().method_12444(lv.method_10263() + p - i, lv.method_10260() + q - i, false);
				if (lv2 != null) {
					this.method_5725(lv2, 0.0F, 0.0F);
					if (arg.method_8587(this, this.method_5829())) {
						break;
					}
				}
			}
			...
			while(!arg.method_8587(this, this.method_5829()) && this.field_6010 < 255.0) {
	...
	public void method_5773() {
		...
		if (lv != this) {
			if (lv.method_5805()) {
				...
				this.field_13995.method_3760().method_14575(this);
				if (this.method_5715()) {
	...
	public void method_14226() {
		try {
			...
			if (this.method_6032() != this.field_13997
				|| this.field_13979 != this.field_7493.method_7586()
				|| this.field_7493.method_7589() == 0.0F != this.field_13972) {
	...
	public void method_6078(class_1282 arg) {
		boolean bl = this.field_6002.method_8450().method_8355("showDeathMessages");
		if (bl) {
				...
				.method_14369(
					...
					future -> {
						if (!future.isSuccess()) {
							...
							class_2561 lv = new class_2588("death.attack.message_too_long", new class_2585(string).method_10854(class_124.field_1054));
	...
	public class_1297 method_5731(class_2874 arg) {
		...
		if (this.field_6026 == class_2874.field_13072 && arg == class_2874.field_13076) {
			this.field_13994 = new class_243(this.field_5987, this.field_6010, this.field_6035);
		} else if (this.field_6026 != class_2874.field_13076 && arg != class_2874.field_13072) {
			this.field_13994 = null;
		}

		if (this.field_6026 == class_2874.field_13078 && arg == class_2874.field_13078) {
			...
			if (this.field_6026 == class_2874.field_13072 && arg == class_2874.field_13078) {
				arg = class_2874.field_13078;
			}

			this.field_13995.method_3760().method_14598(this, arg);
	...
	public class_1657.class_1658 method_7269(class_2338 arg) {
		class_1657.class_1658 lv = super.method_7269(arg);
		if (lv == class_1657.class_1658.field_7527) {
			this.method_7281(class_3468.field_15381);
			class_2596<?> lv2 = new class_2711(this, arg);
			this.method_14220().method_14180().method_14079(this, lv2);
	...
	public void method_7358(boolean bl, boolean bl2, boolean bl3) {
		if (this.method_6113()) {
			this.method_14220().method_14180().method_14073(this, new class_2616(this, 2));
		}
	...
	public void method_17354(int i, class_1916 arg) {
		this.field_13987.method_14364(new class_3943(i, arg));
	}
	...
	public void method_7335(class_2960[] args) {
		...
		for(class_2960 lv : args) {
			class_1860 lv2 = this.field_13995.method_3772().method_8130(lv);
			if (lv2 != null) {
				list.add(lv2);
			}
		}
	...
	public void method_14203(class_3222 arg, boolean bl) {
		...
		} else if (this.field_6002.method_8450().method_8355("keepInventory") || arg.method_7325()) {
			this.field_7514.method_7377(arg.field_7514);
			this.field_7520 = arg.field_7520;
			this.field_7495 = arg.field_7495;
			this.field_7510 = arg.field_7510;
	...
	public void method_7277(class_1297 arg) {
		this.method_14220().method_14180().method_14073(this, new class_2616(arg, 4));
	}

	@Override
	public void method_7304(class_1297 arg) {
		this.method_14220().method_14180().method_14073(this, new class_2616(arg, 5));
	}
	...
	public class_1657.class_1659 method_14238() {
	...
	protected void method_6027() {
		...
		this.method_14220().method_14180().method_14071(this);
	}
	...
	@Nullable
	public class_243 method_14225() {
		return this.field_13994;
	}
	...
	public void method_14251(class_3218 arg, double d, double e, double f, float g, float h) {
		...
		if (arg == this.field_6002) {
			...
			this.field_13987.method_14364(new class_2724(this.field_6026, lv.method_8407(), lv.method_8401().method_153(), this.field_13974.method_14257()));
			this.field_13995.method_3760().method_14576(this);
			lv.method_8507(this);
			this.field_5988 = false;
			this.method_5808(d, e, f, g, h);
			if (this.method_5805()) {
				lv.method_8553(this, false);
				arg.method_8649(this);
				arg.method_8553(this, false);
			}

			this.method_5866(arg);
			this.field_13995.method_3760().method_14612(this, lv);
			this.field_13987.method_14363(d, e, f, g, h);
	...
	public void method_14205(class_1923 arg, class_2596<?> arg2, class_2596<?> arg3) {
		...
		this.method_14220().method_14180().method_14067(this, arg.field_9181, arg.field_9180);
	}
	...
	public class_1923 method_14232() {
		return this.field_13990;
	}

	public void method_17668(class_1923 arg) {
