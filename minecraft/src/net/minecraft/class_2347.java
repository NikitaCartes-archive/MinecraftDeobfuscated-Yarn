...
public class class_2347 implements class_2357 {
	...
	public static void method_10134(class_1937 arg, class_1799 arg2, int i, class_2350 arg3, class_2374 arg4) {
		...
		lv.field_5967 = (double)arg3.method_10148() * g;
		lv.field_5984 = 0.2F;
		lv.field_6006 = (double)arg3.method_10165() * g;
		lv.field_5967 = lv.field_5967 + arg.field_9229.nextGaussian() * 0.0075F * (double)i;
		lv.field_5984 = lv.field_5984 + arg.field_9229.nextGaussian() * 0.0075F * (double)i;
		lv.field_6006 = lv.field_6006 + arg.field_9229.nextGaussian() * 0.0075F * (double)i;
		arg.method_8649(lv);
	}
	...
	protected void method_10133(class_2342 arg, class_2350 arg2) {
		arg.method_10207().method_8535(2000, arg.method_10122(), arg2.method_10146());
	}
}
