...
public class class_1409 extends class_1408 {
	...
	private int method_6362() {
		if (this.field_6684.method_5799() && this.method_6350()) {
			int i = class_3532.method_15357(this.field_6684.method_5829().field_1322);
			class_2248 lv = this.field_6677.method_8320(new class_2338(this.field_6684.field_5987, (double)i, this.field_6684.field_6035)).method_11614();
			int j = 0;

			while (lv == class_2246.field_10382) {
				lv = this.field_6677.method_8320(new class_2338(this.field_6684.field_5987, (double)(++i), this.field_6684.field_6035)).method_11614();
				if (++j > 16) {
					return class_3532.method_15357(this.field_6684.method_5829().field_1322);
				}
			}

			return i;
		} else {
			return class_3532.method_15357(this.field_6684.method_5829().field_1322 + 0.5);
		}
	}
	...
	protected void method_6359() {
		super.method_6359();
		if (this.field_6686) {
			if (this.field_6677.method_8311(new class_2338(this.field_6684.field_5987, this.field_6684.method_5829().field_1322 + 0.5, this.field_6684.field_6035))) {
				return;
			}
	...
	protected boolean method_6341(class_243 arg, class_243 arg2, int i, int j, int k) {
		...
		if (f < 1.0E-8) {
			...
			i += 2;
			k += 2;
			if (!this.method_6364(l, class_3532.method_15357(arg.field_1351), m, i, j, k, arg, d, e)) {
				return false;
			} else {
				i -= 2;
				k -= 2;
