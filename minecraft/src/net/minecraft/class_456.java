...
public class class_456 extends class_332 {
	...
	public void method_2325(int i, int j) {
		if (!this.field_2712.method_824() || this.field_2714 != null && this.field_2714.method_740()) {
			...
			this.blit(i + this.field_2711 + 3, j + this.field_2710, this.field_2712.method_815().method_832(), 128 + lv.method_2320() * 26, 26, 26);
	...
	public void method_2331(int i, int j, float f, int k, int l) {
		boolean bl = k + i + this.field_2711 + this.field_2715 + 26 >= this.field_2703.method_2312().width;
		...
		this.blit(q, p, 0, lv.method_2320() * 26, n, 26);
		this.blit(q + n, p, 200 - o, lv2.method_2320() * 26, o, 26);
		this.blit(i + this.field_2711 + 3, j + this.field_2710, this.field_2712.method_815().method_832(), 128 + lv3.method_2320() * 26, 26, 26);
		if (bl) {
