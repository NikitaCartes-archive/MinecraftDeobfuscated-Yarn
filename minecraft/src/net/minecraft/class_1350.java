...
public class class_1350 extends class_1352 {
	protected final class_1321 field_6448;
				...
				if (!this.field_6446.method_6335(this.field_6444, this.field_6442)) {
					if (!this.field_6448.method_5934() && !this.field_6448.method_5765()) {
						if (!(this.field_6448.method_5858(this.field_6444) < 144.0)) {
							...
							for (int l = 0; l <= 4; l++) {
								for (int m = 0; m <= 4; m++) {
									if ((l < 1 || m < 1 || l > 3 || m > 3) && this.method_6263(new class_2338(i + l, k - 1, j + m))) {
										this.field_6448
	...
	protected boolean method_6263(class_2338 arg) {
		class_2680 lv = this.field_6445.method_8320(arg);
		return lv.method_11611(this.field_6445, arg, this.field_6448.method_5864())
			&& this.field_6445.method_8623(arg.method_10084())
			&& this.field_6445.method_8623(arg.method_10086(2));
	}
}
