...
public class class_793 implements class_1100 {
	...
	public Collection<class_2960> method_4754(Function<class_2960, class_1100> function, Set<String> set) {
		...
		for(class_785 lv3 : this.method_3433()) {
			for(class_783 lv4 : lv3.field_4230.values()) {
				...
				if (Objects.equals(string, class_1047.method_4539().toString())) {
		...
		this.field_4255.forEach(arg -> {
			class_1100 lvxx = (class_1100)function.apply(arg.method_3472());
			if (!Objects.equals(lvxx, this)) {
				set3.addAll(lvxx.method_4754(function, set));
			}
		});
	...
	public boolean method_3432(String string) {
		return !class_1047.method_4539().toString().equals(this.method_3436(string));
	}
	...
	private String method_3442(String string, class_793.class_794 arg) {
		if (this.method_3439(string)) {
			if (this == arg.field_4256) {
				...
				return class_1047.method_4539().toString();
			} else {
				...
				return string2 != null && !this.method_3439(string2) ? string2 : class_1047.method_4539().toString();
			}
		} else {
			return string;
		}
