...
public class class_1250 extends Schema {
	...
	protected static final HookFunction field_5745 = new HookFunction() {
		...
		public <T> T apply(DynamicOps<T> dynamicOps, T object) {
			return class_1254.method_5359(new Dynamic<>(dynamicOps, object), class_1250.field_5744, "ArmorStand");
		}
	};

	public class_1250(int i, Schema schema) {
		super(i, schema);
	}
	...
	public Type<?> getChoiceType(TypeReference typeReference, String string) {
		return Objects.equals(typeReference.typeName(), class_1208.field_5727.typeName())
			? super.getChoiceType(typeReference, class_1220.method_5193(string))
	...
	public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map2) {
		...
		schema.registerType(false, class_1208.field_5727, () -> DSL.taggedChoiceLazy("id", DSL.namespacedString(), map2));
		schema.registerType(
			true,
