...
public class class_2595 extends class_2621 implements class_2618, class_3000 {
	...
	public void method_16896() {
		...
		this.field_11930++;
		if (!this.field_11863.field_9236 && this.field_11928 != 0 && (this.field_11930 + i + j + k) % 200 == 0) {
			this.field_11928 = 0;
			float f = 5.0F;

			for (class_1657 lv : this.field_11863
				.method_8403(
					class_1657.class,
					new class_238(
						(double)((float)i - 5.0F),
				...
				if (lv.field_7512 instanceof class_1707) {
					...
					if (lv2 == this || lv2 instanceof class_1258 && ((class_1258)lv2).method_5405(this)) {
						this.field_11928++;
					}
				}
			}
