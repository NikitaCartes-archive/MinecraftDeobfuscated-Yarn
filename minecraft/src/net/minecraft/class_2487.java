...
public class class_2487 implements class_2520 {
	...
	private final Map<String, class_2520> field_11515 = Maps.newHashMap();
	...
	@Nullable
	public class_2520 method_10566(String string, class_2520 arg) {
		return (class_2520)this.field_11515.put(string, arg);
	}
	...
	public String toString() {
		...
		if (field_11514.isDebugEnabled()) {
			List<String> list = Lists.newArrayList(this.field_11515.keySet());
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			return object instanceof class_2487 && Objects.equals(this.field_11515, ((class_2487)object).field_11515);
		}
	}
	...
	protected static String method_10578(String string) {
		return field_11516.matcher(string).matches() ? string : class_2519.method_10706(string);
	}
	...
	protected static class_2561 method_10557(String string) {
		if (field_11516.matcher(string).matches()) {
			...
			String string2 = class_2519.method_10706(string);
			String string3 = string2.substring(0, 1);
			class_2561 lv = new class_2585(string2.substring(1, string2.length() - 1)).method_10854(field_11591);
	...
	public class_2561 method_10710(String string, int i) {
		if (this.field_11515.isEmpty()) {
			...
			class_2561 lv2;
			for(Iterator<String> iterator = collection.iterator(); iterator.hasNext(); lv.method_10852(lv2)) {
				String string2 = (String)iterator.next();
				lv2 = new class_2585(Strings.repeat(string, i + 1))
