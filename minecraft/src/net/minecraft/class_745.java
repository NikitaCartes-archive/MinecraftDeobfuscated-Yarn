...
public class class_745 extends class_742 {
	public class_745(class_638 arg, GameProfile gameProfile) {
	...
	public void method_6007() {
		...
		if (this.field_5952 && !(this.method_6032() <= 0.0F)) {
			g = Math.min(0.1F, class_3532.method_15368(method_17996(this.method_18798())));
		} else {
			g = 0.0F;
		}

		if (!this.field_5952 && !(this.method_6032() <= 0.0F)) {
			float h = (float)Math.atan(-this.method_18798().field_1351 * 0.2F) * 15.0F;
		} else {
			float h = 0.0F;
		}
