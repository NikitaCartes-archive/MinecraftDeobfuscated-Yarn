...
public class class_273 extends class_18 {
	...
	protected void method_1220(class_2499 arg) {
		for(int i = 0; i < arg.size(); ++i) {
			class_2487 lv = arg.method_10602(i);
			class_274.method_1224(lv.method_10558("CriteriaName")).ifPresent(arg2 -> {
				String string = lv.method_10558("Name");
				if (string.length() > 16) {
					string = string.substring(0, 16);
				}

				class_2561 lvxx = class_2561.class_2562.method_10877(lv.method_10558("DisplayName"));
				class_274.class_275 lv2 = class_274.class_275.method_1229(lv.method_10558("RenderType"));
				this.field_1449.method_1168(string, arg2, lvxx, lv2);
			});
		}
	}
