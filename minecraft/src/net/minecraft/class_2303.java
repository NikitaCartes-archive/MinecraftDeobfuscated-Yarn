...
public class class_2303 {
	...
	private Class<? extends class_1297> field_10863;
	...
	public class_2300 method_9871() {
		...
		if (this.field_10862 == null && this.field_10852 == null && this.field_10881 == null) {
			if (this.field_10838.method_9042() != null) {
				float f = this.field_10838.method_9042();
		...
		return new class_2300(
			...
			this.field_10876,
			this.field_10878,
			this.field_10863 == null ? class_1297.class : this.field_10863,
			this.field_10840
		);
	}
	...
	protected void method_9917() throws CommandSyntaxException {
		...
		if (!this.field_10860.canRead()) {
			...
			if (c == 'p') {
				...
				this.method_9842(class_3222.class);
			} else if (c == 'a') {
	...
	public void method_9842(Class<? extends class_1297> class_) {
		this.field_10863 = class_;
	}
