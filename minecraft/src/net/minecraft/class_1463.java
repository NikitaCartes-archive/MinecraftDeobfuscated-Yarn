...
public class class_1463 extends class_1429 {
	...
	public class_1463(class_1937 arg) {
		super(class_1299.field_6140, arg);
		this.method_5835(0.4F, 0.5F);
	...
	protected void method_6043() {
		...
		if (d > 0.0) {
			double e = this.field_5967 * this.field_5967 + this.field_6006 * this.field_6006;
	...
	public class_1463 method_6620(class_1296 arg) {
		class_1463 lv = new class_1463(this.field_6002);
	...
	static class class_1465<T extends class_1297> extends class_1338<T> {
