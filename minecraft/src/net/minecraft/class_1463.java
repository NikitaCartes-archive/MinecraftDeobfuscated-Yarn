...
public class class_1463 extends class_1429 {
	...
	public void method_5958() {
		...
		if (this.field_6847 > 0) {
			this.field_6847 -= this.field_5974.nextInt(3);
			if (this.field_6847 < 0) {
				this.field_6847 = 0;
			}
		}
	...
	public static boolean method_20669(class_1299<class_1463> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		class_2248 lv = arg2.method_8320(arg4.method_10074()).method_11614();
		if (lv != class_2246.field_10219 && lv != class_2246.field_10477 && lv != class_2246.field_10102) {
			return arg2.method_8624(arg4, 0) > 8;
		} else {
			return true;
		}
	}
	...
	static class class_1470 extends class_1367 {
		...
		public boolean method_6264() {
			if (this.field_6518 <= 0) {
				if (!this.field_6863.field_6002.method_8450().method_8355(class_1928.field_19388)) {
					return false;
				}
			...
			if (this.method_6295()) {
				...
				if (this.field_6861 && lv4 instanceof class_2271) {
					...
					if (integer == 0) {
						...
						lv.method_20290(2001, lv2, class_2248.method_9507(lv3));
					}
