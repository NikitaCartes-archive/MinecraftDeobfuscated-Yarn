		...
		(new Thread("Realms-reset-world-fetcher") {
			public void run() {
				...
				try {
					...
					class_4410.field_19999.error("Couldn't fetch templates in reset world", var6);
				}
			}
		}).start();
		...
		this.buttonsAdd(
			new class_4410.class_4411(
				...
				public void onPress() {
					Realms.setScreen(
						new class_4416(
							class_4410.this.field_20001.id,
							class_4410.this.field_19998 != -1 ? class_4410.this.field_19998 : class_4410.this.field_20001.activeSlot,
							class_4410.this
						)
					);
				}
