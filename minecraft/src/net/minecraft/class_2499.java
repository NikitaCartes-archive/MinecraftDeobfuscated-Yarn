...
public class class_2499 extends class_2483<class_2520> {
	private static final Logger field_11549 = LogManager.getLogger();
	...
	public void method_10713(DataOutput dataOutput) throws IOException {
		...
		for(int i = 0; i < this.field_11550.size(); ++i) {
			((class_2520)this.field_11550.get(i)).method_10713(dataOutput);
		}
	}
	...
	public boolean method_10606(class_2520 arg) {
		if (this.method_10605(arg)) {
			this.field_11550.add(arg);
			return true;
		} else {
			return false;
		}
	...
	@Override
	public class_2520 method_10531(int i, class_2520 arg) {
		if (arg.method_10711() == 0) {
			field_11549.warn("Invalid TagEnd added to ListTag");
			return (class_2520)this.field_11550.get(i);
		} else if (i >= 0 && i < this.field_11550.size()) {
			if (this.field_11551 == 0) {
				this.field_11551 = arg.method_10711();
			} else if (this.field_11551 != arg.method_10711()) {
				field_11549.warn("Adding mismatching tag types to tag list");
				return (class_2520)this.field_11550.get(i);
			}

			return (class_2520)this.field_11550.set(i, arg);
		} else {
			field_11549.warn("index out of bounds to set tag in tag list");
			return null;
		}
	}

	public class_2520 method_10607(int i) {
		return (class_2520)this.field_11550.remove(i);
	}
	...
	public class_2520 method_10534(int i) {
		return (class_2520)(i >= 0 && i < this.field_11550.size() ? (class_2520)this.field_11550.get(i) : new class_2491());
	}
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			return object instanceof class_2499 && Objects.equals(this.field_11550, ((class_2499)object).field_11550);
		}
	}
