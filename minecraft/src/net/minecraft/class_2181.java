...
public class class_2181 implements ArgumentType<class_2874> {
	...
	public class_2874 method_9287(StringReader stringReader) throws CommandSyntaxException {
		class_2960 lv = class_2960.method_12835(stringReader);
		return (class_2874)class_2378.field_11155.method_17966(lv).orElseThrow(() -> field_9845.create(lv));
	}
