...
public class class_494 extends class_465<class_1726> {
	...
	private static final int field_2963 = (class_2582.field_11846 - 5 - 1 + 4 - 1) / 4;
	...
	public void tick() {
		...
		if (this.field_2969 < class_2582.field_11846) {
			...
			this.field_2972[this.field_2969] = class_770.field_4154.method_3331(string + string2, Lists.newArrayList(class_2582.field_11834, lv), field_2959);
			++this.field_2969;
		}
	}
	...
	protected void method_2389(float f, int i, int j) {
		...
		this.minecraft.method_1531().method_4618(field_2966);
		...
		if (!lv.method_7681()) {
			this.blit(k + lv.field_7873, l + lv.field_7872, this.field_2792, 0, 16, 16);
		}

		if (!lv2.method_7681()) {
			this.blit(k + lv2.field_7873, l + lv2.field_7872, this.field_2792 + 16, 0, 16, 16);
		}

		if (!lv3.method_7681()) {
			this.blit(k + lv3.field_7873, l + lv3.field_7872, this.field_2792 + 32, 0, 16, 16);
		}

		int m = (int)(41.0F * this.field_2968);
		this.blit(k + 119, l + 13 + m, 232 + (this.field_2965 ? 0 : 12), 0, 12, 15);
		if (this.field_2957 != null && !this.field_2961) {
			this.minecraft.method_1531().method_4618(this.field_2957);
			blit(k + 141, l + 8, 1.0F, 1.0F, 20, 40, 20, 40, 64.0F, 64.0F);
		} else if (this.field_2961) {
			this.blit(k + lv4.field_7873 - 2, l + lv4.field_7872 - 2, this.field_2792, 17, 17, 16);
		}
		...
		if (this.field_2965) {
			...
			for(int q = this.field_2970; q < p && q < this.field_2972.length - 5; ++q) {
				...
				if (this.field_2972[q] != null) {
					this.minecraft.method_1531().method_4618(this.field_2972[q]);
					blit(s + 4, t + 2, 1.0F, 1.0F, 20, 40, 5, 10, 64.0F, 64.0F);
				}
			}
			...
			int o = l + 13;
			this.minecraft.method_1531().method_4618(field_2966);
			this.blit(n, o, 0, this.field_2779, 14, 14);
			int p = this.field_2797.method_7647();
			if (this.field_2972[p] != null) {
				this.minecraft.method_1531().method_4618(this.field_2972[p]);
				blit(n + 4, o + 2, 1.0F, 1.0F, 20, 40, 5, 10, 64.0F, 64.0F);
			}
		}
	}
	...
	public boolean mouseClicked(double d, double e, int i) {
		...
		if (this.field_2965) {
			...
			for(int m = this.field_2970; m < l; ++m) {
				...
				if (f >= 0.0 && g >= 0.0 && f < 14.0 && g < 14.0 && this.field_2797.method_7604(this.minecraft.field_1724, m)) {
	...
	public boolean mouseScrolled(double d, double e, double f) {
		if (this.field_2965) {
			int i = field_2963 - 4;
			this.field_2968 = (float)((double)this.field_2968 - f / (double)i);
			this.field_2968 = class_3532.method_15363(this.field_2968, 0.0F, 1.0F);
	...
	private void method_17576() {
		...
		if (!class_1799.method_7973(lv3, this.field_2955) || !class_1799.method_7973(lv4, this.field_2954) || !class_1799.method_7973(lv5, this.field_2967)) {
			...
			this.field_2962 = !this.field_2961 && !lv5.method_7960() && !lv3.method_7960() && !lv4.method_7960();
		}
