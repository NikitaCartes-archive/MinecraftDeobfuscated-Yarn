...
public class ParticleTypes {
	...
	public static final ParticleType<SculkChargeParticleEffect> SCULK_CHARGE = method_40960(
	...
	public static final ParticleType<ShriekParticleEffect> SHRIEK = register("shriek", ShriekParticleEffect.FACTORY, particleType -> ShriekParticleEffect.CODEC);
	...
	private static <T extends ParticleEffect> ParticleType<T> register(
		...
		return method_40960(name, factory, function, false);
	}

	private static <T extends ParticleEffect> ParticleType<T> method_40960(
