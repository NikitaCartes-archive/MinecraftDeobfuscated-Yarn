...
public class DustParticleParameters implements ParticleParameters {
	...
	public static final ParticleParameters.Factory<DustParticleParameters> PARAMETERS_FACTORY = new ParticleParameters.Factory<DustParticleParameters>() {
		public DustParticleParameters method_10287(ParticleType<DustParticleParameters> particleType, StringReader stringReader) throws CommandSyntaxException {
			stringReader.expect(' ');
		...
		public DustParticleParameters method_10288(ParticleType<DustParticleParameters> particleType, PacketByteBuf packetByteBuf) {
