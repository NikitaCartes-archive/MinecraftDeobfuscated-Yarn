...
public class class_1641 extends class_1642 implements class_3851 {
	...
	public class_1641(class_1299<? extends class_1641> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public void method_5652(class_2487 arg) {
		...
		arg.method_10569("Xp", this.field_18877);
	}
	...
	public void method_5749(class_2487 arg) {
		...
		if (arg.method_10573("Xp", 3)) {
			this.field_18877 = arg.method_10550("Xp");
		} else {
			this.field_18877 = class_3850.method_19194(this.method_7231().method_16925());
		}
	}

	@Override
	public void method_5773() {
		if (!this.field_6002.field_9236 && this.method_5805() && this.method_7198()) {
			int i = this.method_7194();
			this.field_7422 -= i;
			if (this.field_7422 <= 0) {
				this.method_7197((class_3218)this.field_6002);
			}
		}
	...
	protected void method_7197(class_3218 arg) {
		class_1646 lv = class_1299.field_6077.method_5883(arg);
		lv.method_5719(this);
		...
		lv.method_19625(this.field_18877);
		lv.method_5943(arg, arg.method_8404(new class_2338(lv)), class_3730.field_16468, null, null);
		if (this.method_6109()) {
		...
		arg.method_8649(lv);
		if (this.field_7421 != null) {
			class_1657 lv2 = arg.method_18470(this.field_7421);
			if (lv2 instanceof class_3222) {
				class_174.field_1210.method_8831((class_3222)lv2, this, lv);
				arg.method_19496(class_4151.field_18474, lv2, lv);
			}
		}

		lv.method_6092(new class_1293(class_1294.field_5916, 200, 0));
		arg.method_8444(null, 1027, new class_2338((int)this.field_5987, (int)this.field_6010, (int)this.field_6035), 0);
	}
	...
	public class_1315 method_5943(class_1936 arg, class_1266 arg2, class_3730 arg3, @Nullable class_1315 arg4, @Nullable class_2487 arg5) {
		if (arg3 == class_3730.field_16462 || arg3 == class_3730.field_16465 || arg3 == class_3730.field_16469) {
			this.method_7195(this.method_7231().method_16922(class_3854.method_16930(arg.method_8310(new class_2338(this)))));
		}
