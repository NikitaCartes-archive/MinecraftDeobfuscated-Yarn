...
public class class_302 {
	...
	private void method_1411() {
		try {
			...
			lv = class_2512.method_10688(this.field_1648, DataFixTypes.HOTBAR, lv, lv.method_10550("DataVersion"));

			for(int i = 0; i < 9; ++i) {
				this.field_1644[i].method_3152(lv.method_10554(String.valueOf(i), 10));
			}
		} catch (Exception var3) {
			field_1647.error("Failed to load creative mode options", var3);
		}
	}
	...
	public void method_1409() {
		try {
			...
			field_1647.error("Failed to save creative mode options", var3);
		}
	}
