...
public class class_1577 extends class_1588 {
	...
	protected class_1577(class_1299<?> arg, class_1937 arg2) {
		super(arg, arg2);
		this.field_6194 = 10;
		this.method_5835(0.85F, 0.85F);
		this.field_6207 = new class_1577.class_1580(this);
		this.field_7286 = this.field_5974.nextFloat();
		this.field_7284 = this.field_7286;
	}

	public class_1577(class_1937 arg) {
		this(class_1299.field_6118, arg);
	}
	...
	public void method_6007() {
		if (this.field_6002.field_9236) {
			...
			if (!this.method_5799()) {
				...
				if (this.field_5984 > 0.0 && this.field_7283 && !this.method_5701()) {
				...
				this.field_7283 = this.field_5984 < 0.0 && this.field_6002.method_8515(new class_2338(this).method_10074());
			} else if (this.method_7058()) {
				if (this.field_7281 < 0.5F) {
					this.field_7281 = 4.0F;
				} else {
					this.field_7281 += (0.5F - this.field_7281) * 0.1F;
				}
			} else {
				this.field_7281 += (0.125F - this.field_7281) * 0.2F;
			}

			this.field_7286 += this.field_7281;
			this.field_7287 = this.field_7285;
			if (!this.method_5816()) {
				this.field_7285 = this.field_5974.nextFloat();
			} else if (this.method_7058()) {
				this.field_7285 += (0.0F - this.field_7285) * 0.25F;
			} else {
				this.field_7285 += (1.0F - this.field_7285) * 0.06F;
			}
				...
				for(int i = 0; i < 2; ++i) {
					this.field_6002
						.method_8406(
							...
							this.field_5987 + (this.field_5974.nextDouble() - 0.5) * (double)this.field_5998 - lv.field_1352 * 1.5,
							this.field_6010 + this.field_5974.nextDouble() * (double)this.field_6019 - lv.field_1351 * 1.5,
							this.field_6035 + (this.field_5974.nextDouble() - 0.5) * (double)this.field_5998 - lv.field_1350 * 1.5,
							0.0,
							0.0,
							0.0
						);
			...
			if (this.method_7063()) {
				...
				if (lv2 != null) {
					...
					double f = lv2.field_6010 + (double)(lv2.field_6019 * 0.5F) - (this.field_6010 + (double)this.method_5751());
		...
		if (this.method_5816()) {
			...
			this.field_5984 += 0.5;
			this.field_5967 += (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.4F);
			this.field_6006 += (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.4F);
	...
	public boolean method_5957(class_1941 arg) {
		return arg.method_8606(this, this.method_5829()) && arg.method_8587(this, this.method_5829());
	}
	...
	public void method_6091(float f, float g, float h) {
		if (this.method_6034() && this.method_5799()) {
			...
			this.field_5967 *= 0.9F;
			this.field_5984 *= 0.9F;
			this.field_6006 *= 0.9F;
			if (!this.method_7058() && this.method_5968() == null) {
				this.field_5984 -= 0.005;
			}
		} else {
	...
	static class class_1580 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6374 == class_1335.class_1336.field_6378 && !this.field_7295.method_5942().method_6357()) {
				double d = this.field_6370 - this.field_7295.field_5987;
				double e = this.field_6369 - this.field_7295.field_6010;
				double f = this.field_6367 - this.field_7295.field_6035;
				...
				this.field_7295.method_6125(class_3532.method_16439(0.125F, this.field_7295.method_6029(), i));
				double j = Math.sin((double)(this.field_7295.field_6012 + this.field_7295.method_5628()) * 0.5) * 0.05;
				double k = Math.cos((double)(this.field_7295.field_6031 * (float) (Math.PI / 180.0)));
				double l = Math.sin((double)(this.field_7295.field_6031 * (float) (Math.PI / 180.0)));
				this.field_7295.field_5967 += j * k;
				this.field_7295.field_6006 += j * l;
				j = Math.sin((double)(this.field_7295.field_6012 + this.field_7295.method_5628()) * 0.75) * 0.05;
				this.field_7295.field_5984 += j * (l + k) * 0.25;
				this.field_7295.field_5984 += (double)this.field_7295.method_6029() * e * 0.1;
				class_1333 lv = this.field_7295.method_5988();
				double m = this.field_7295.field_5987 + d / g * 2.0;
				double n = (double)this.field_7295.method_5751() + this.field_7295.field_6010 + e / g;
				double o = this.field_7295.field_6035 + f / g * 2.0;
				double p = lv.method_6225();
				double q = lv.method_6227();
				double r = lv.method_6228();
				if (!lv.method_6232()) {
					p = m;
					q = n;
					r = o;
				...
				this.field_7295
					.method_5988()
					.method_6230(class_3532.method_16436(0.125, p, m), class_3532.method_16436(0.125, q, n), class_3532.method_16436(0.125, r, o), 10.0F, 40.0F);
