...
public class class_1577 extends class_1588 {
	...
	public void method_6007() {
		...
		if (this.method_5816()) {
			...
			this.field_5984 += 0.5;
			this.field_5967 = this.field_5967 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.4F);
			this.field_6006 = this.field_6006 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.4F);
	...
	static class class_1580 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6374 == class_1335.class_1336.field_6378 && !this.field_7295.method_5942().method_6357()) {
				...
				this.field_7295.field_5984 = this.field_7295.field_5984 + (double)this.field_7295.method_6029() * e * 0.1;
