...
public class class_3059 extends class_3031<class_4302> {
	public class_3059(Function<Dynamic<?>, ? extends class_4302> function) {
		super(function);
	}

	public boolean method_13362(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, class_4302 arg4) {
			...
			if (!class_2248.method_9519(lv) && lv != class_2246.field_10219 && lv != class_2246.field_10402) {
				...
				for(int m = -3; m <= 3; ++m) {
					for(int n = -3; n <= 3; ++n) {
						...
						boolean bl6 = bl3 || bl4;
						if (!bl5 || !bl6) {
							lv2.method_10101(arg3).method_10100(m, i, n);
				...
				for(int n = 0; n < i; ++n) {
					lv2.method_10101(arg3).method_10104(class_2350.field_11036, n);
					if (!arg.method_8320(lv2).method_11598(arg, lv2)) {
						if (arg4.field_19317) {
