...
public class class_2684 implements class_2596<class_2602> {
	...
	protected short field_12309;
	protected short field_12308;
	protected short field_12307;
	...
	public static class_243 method_18695(long l, long m, long n) {
		return new class_243((double)l, (double)m, (double)n).method_1021(2.4414062E-4F);
	}
	...
	@Environment(EnvType.CLIENT)
	public short method_11648() {
		return this.field_12309;
	}

	@Environment(EnvType.CLIENT)
	public short method_11646() {
		return this.field_12308;
	}

	@Environment(EnvType.CLIENT)
	public short method_11647() {
	...
	public static class class_2685 extends class_2684 {
		...
		public class_2685(int i, short s, short t, short u, boolean bl) {
			super(i);
			this.field_12309 = s;
			this.field_12308 = t;
			this.field_12307 = u;
	...
	public static class class_2686 extends class_2684 {
		...
		public class_2686(int i, short s, short t, short u, byte b, byte c, boolean bl) {
			super(i);
			this.field_12309 = s;
			this.field_12308 = t;
			this.field_12307 = u;
