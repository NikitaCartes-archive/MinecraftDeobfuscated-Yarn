...
public class class_2403 {
	...
	public void method_10315() throws IOException {
		...
		for (class_2405 lv2 : this.field_11273) {
			...
			lv2.method_10319(lv);
			stopwatch2.stop();
			field_11275.info("{} finished after {} ms", lv2.method_10321(), stopwatch2.elapsed(TimeUnit.MILLISECONDS));
			stopwatch2.reset();
		}

		field_11275.info("All providers took: {} ms", stopwatch.elapsed(TimeUnit.MILLISECONDS));
		lv.method_10326();
	}
