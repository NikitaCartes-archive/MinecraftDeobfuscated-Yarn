...
public class class_766 {
	...
	public void method_3317(float f) {
		this.field_4140 += f;
		this.field_4141.method_3156(this.field_4139, MathHelper.sin(this.field_4140 * 0.001F) * 5.0F + 25.0F, -this.field_4140 * 0.1F);
		this.field_4139.window.method_4493(MinecraftClient.isSystemMac);
	}
}
