...
public class class_5579<T extends class_5568> implements AutoCloseable {
	...
	private void method_31810(long l) {
		class_5579.class_5581 lv = (class_5579.class_5581)this.field_27268.get(l);
	...
	private boolean method_31812(long l, Consumer<T> consumer) {
		...
		if (lv == class_5579.class_5581.field_27276) {
			...
			List<T> list = (List)this.field_27265.method_31782(l).flatMap(arg -> arg.method_31766().filter(class_5568::method_31746)).collect(Collectors.toList());
			if (list.isEmpty()) {
