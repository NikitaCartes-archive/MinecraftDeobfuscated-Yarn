...
public class class_2090 {
	...
	public boolean method_9020(class_3218 arg, float f, float g, float h) {
		if (!this.field_9682.method_9047(f)) {
			...
			if (this.field_9683 != null && this.field_9683 != arg.method_8310(lv)) {
				return false;
			} else {
				return this.field_9687 == null || this.field_9687.method_14024(arg, lv);
			}
		}
	}
	...
	public static class_2090 method_9021(@Nullable JsonElement jsonElement) {
		if (jsonElement != null && !jsonElement.isJsonNull()) {
			...
			if (jsonObject.has("biome")) {
				...
				lv6 = class_2378.field_11153.method_10223(lv7);
				if (lv6 == null) {
					throw new JsonSyntaxException("Unknown biome '" + lv7 + "'");
				}
			}
