...
public class class_3591 extends DataFix {
	public class_3591(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	public TypeRewriteRule makeRule() {
		...
		return TypeRewriteRule.seq(
			...
			this.writeAndRead("Structure biome inject", this.getInputSchema().getType(class_1208.field_5724), this.getOutputSchema().getType(class_1208.field_5724))
		);
	}
