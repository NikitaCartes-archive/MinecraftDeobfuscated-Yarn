...
public class class_2850<T> implements class_1951<T> {
	...
	protected final Function<T, class_2960> field_12989;
	protected final Function<class_2960, T> field_12992;
	private final class_1923 field_12993;
	private final ShortList[] field_12990 = new ShortList[16];

	public class_2850(Predicate<T> predicate, Function<T, class_2960> function, Function<class_2960, T> function2, class_1923 arg) {
		this(predicate, function, function2, arg, new class_2499());
	}

	public class_2850(Predicate<T> predicate, Function<T, class_2960> function, Function<class_2960, T> function2, class_1923 arg, class_2499 arg2) {
		this.field_12991 = predicate;
		this.field_12989 = function;
		this.field_12992 = function2;
