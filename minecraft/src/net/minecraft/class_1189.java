...
public class class_1189 extends DataFix {
	private static final Map<String, String> field_5685 = DataFixUtils.make(Maps.<String, String>newHashMap(), hashMap -> {
	...
	public class_1189(Schema schema, boolean bl) {
		super(schema, bl);
	}
		...
		return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, typed -> {
			...
			if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg")) {
				...
				if (optional2.isPresent()) {
					return typed.set(opticFinder, Pair.of(class_1208.field_5713.typeName(), (String)field_5685.getOrDefault(optional2.get(), "minecraft:pig_spawn_egg")));
				}
			}
