...
public class class_1498 extends class_1496 {
	...
	private static final class_2940<Integer> field_6993 = class_2945.method_12791(class_1498.class, class_2943.field_13327);
	...
	private final String[] field_6988 = new String[3];

	public class_1498(class_1937 arg) {
		super(class_1299.field_6139, arg);
	}
	...
	protected void method_5693() {
		...
		this.field_6011.method_12784(field_6993, class_1497.field_6979.method_6778());
	}
	...
	public void method_5749(class_2487 arg) {
		...
		if (arg.method_10573("ArmorItem", 10)) {
			...
			if (!lv.method_7960() && class_1497.method_6782(lv.method_7909())) {
	...
	private void method_6789() {
		...
		int j = (i & 0xFF) % 7;
		int k = ((i & 0xFF00) >> 8) % 5;
		class_1497 lv = this.method_6786();
		this.field_6988[0] = field_6992[j];
		this.field_6988[1] = field_6986[k];
		this.field_6988[2] = lv.method_6775();
		this.field_6987 = "horse/" + field_6991[j] + field_6989[k] + lv.method_6780();
	}
	...
	public void method_6790(class_1799 arg) {
		class_1497 lv = class_1497.method_6779(arg);
		this.field_6011.method_12778(field_6993, lv.method_6778());
		this.method_6785();
		if (!this.field_6002.field_9236) {
			this.method_5996(class_1612.field_7358).method_6200(field_6985);
			int i = lv.method_6776();
			if (i != 0) {
	...
	public class_1497 method_6786() {
		return class_1497.method_6781(this.field_6011.method_12789(field_6993));
	}
	...
	public void method_5453(class_1263 arg) {
		...
		class_1497 lv2 = this.method_6786();
		if (this.field_6012 > 20 && lv != lv2 && lv2 != class_1497.field_6979) {
	...
	public boolean method_5992(class_1657 arg, class_1268 arg2) {
		...
		if (bl && lv.method_7909() instanceof class_1826) {
			...
			if (bl) {
				...
				boolean bl2 = class_1497.method_6779(lv) != class_1497.field_6979;
				boolean bl3 = !this.method_6109() && !this.method_6725() && lv.method_7909() == class_1802.field_8175;
				if (bl2 || bl3) {
					this.method_6722(arg);
					return true;
				}
	...
	public boolean method_6474(class_1429 arg) {
		if (arg == this) {
			return false;
		} else if (!(arg instanceof class_1495) && !(arg instanceof class_1498)) {
			return false;
		} else {
			return this.method_6734() && ((class_1496)arg).method_6734();
		}
	}
	...
	public class_1296 method_5613(class_1296 arg) {
		...
		if (arg instanceof class_1495) {
			lv = new class_1500(this.field_6002);
		} else {
			class_1498 lv2 = (class_1498)arg;
			lv = new class_1498(this.field_6002);
	...
	public boolean method_6773(class_1799 arg) {
		return class_1497.method_6782(arg.method_7909());
	}
