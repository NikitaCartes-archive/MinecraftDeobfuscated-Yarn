		...
		if (this.field_18894) {
			...
			if (this.field_18896 != null) {
				try {
					...
					field_18892.error("Failed to close audio stream", var2);
				}
	...
	private void method_19640(int i) {
		if (this.field_18896 != null) {
			try {
				...
				field_18892.error("Failed to read from audio stream", var4);
			}
		}
	}
