...
public abstract class class_465<T extends class_1703> extends class_437 implements class_3936<T> {
	...
	protected void init() {
		...
		this.field_2800 = (this.height - this.field_2779) / 2;
	}
	...
	public void render(int i, int j, float f) {
		...
		class_308.method_1453();
		class_1661 lv2 = this.minecraft.field_1724.field_7514;
	...
	protected void method_2380(int i, int j) {
		if (this.minecraft.field_1724.field_7514.method_7399().method_7960() && this.field_2787 != null && this.field_2787.method_7681()) {
			this.renderTooltip(this.field_2787.method_7677(), i, j);
		}
	}

	private void method_2382(class_1799 arg, int i, int j, String string) {
		GlStateManager.translatef(0.0F, 0.0F, 32.0F);
		this.blitOffset = 200.0F;
		this.itemRenderer.field_4730 = 200.0F;
		this.itemRenderer.method_4023(arg, i, j);
		this.itemRenderer.method_4022(this.font, arg, i, j - (this.field_2782.method_7960() ? 0 : 8), string);
	...
	private void method_2385(class_1735 arg) {
		...
		class_1799 lv2 = this.minecraft.field_1724.field_7514.method_7399();
		String string = null;
		...
		if (lv.method_7960() && arg.method_7682()) {
			...
			if (string2 != null) {
				class_1058 lv3 = this.minecraft.method_1549().method_4607(string2);
				GlStateManager.disableLighting();
				this.minecraft.method_1531().method_4618(class_1059.field_5275);
				this.blit(i, j, lv3, 16, 16);
				GlStateManager.enableLighting();
				bl2 = true;
			}
		}
		...
		if (!bl2) {
			...
			GlStateManager.enableDepthTest();
			this.itemRenderer.method_4026(this.minecraft.field_1724, lv, i, j);
			this.itemRenderer.method_4022(this.font, lv, i, j, string);
		}
	...
	private void method_2379() {
		class_1799 lv = this.minecraft.field_1724.field_7514.method_7399();
		if (!lv.method_7960() && this.field_2794) {
			if (this.field_2790 == 2) {
				...
				for(class_1735 lv2 : this.field_2793) {
					...
					this.field_2803 -= lv3.method_7947() - i;
				}
			}
		}
	}
	...
	public boolean mouseClicked(double d, double e, int i) {
		if (super.mouseClicked(d, e, i)) {
			...
			boolean bl = this.minecraft.field_1690.field_1871.method_1433(i);
			...
			if (i == 0 || i == 1 || bl) {
				...
				if (this.minecraft.field_1690.field_1854 && bl2 && this.minecraft.field_1724.field_7514.method_7399().method_7960()) {
					this.minecraft.method_1507(null);
					return true;
				}

				if (m != -1) {
					if (this.minecraft.field_1690.field_1854) {
						...
						if (this.minecraft.field_1724.field_7514.method_7399().method_7960()) {
							if (this.minecraft.field_1690.field_1871.method_1433(i)) {
							...
							if (i == 0) {
								...
								this.field_2790 = 1;
							} else if (this.minecraft.field_1690.field_1871.method_1433(i)) {
								this.field_2790 = 2;
							}
						}
					}
	...
	public boolean mouseDragged(double d, double e, int i, double f, double g) {
		class_1735 lv = this.method_2386(d, e);
		class_1799 lv2 = this.minecraft.field_1724.field_7514.method_7399();
		if (this.field_2777 != null && this.minecraft.field_1690.field_1854) {
			if (i == 0 || i == 1) {
	...
	public boolean mouseReleased(double d, double e, int i) {
		...
		if (this.field_2783 && lv != null && i == 0 && this.field_2797.method_7613(class_1799.field_8037, lv)) {
			if (hasShiftDown()) {
				if (!this.field_2791.method_7960()) {
					for(class_1735 lv2 : this.field_2797.field_7761) {
						if (lv2 != null
							&& lv2.method_7674(this.minecraft.field_1724)
							&& lv2.method_7681()
			...
			if (this.field_2777 != null && this.minecraft.field_1690.field_1854) {
				...
				for(class_1735 lv2 : this.field_2793) {
					this.method_2383(lv2, lv2.field_7874, class_1703.method_7591(1, this.field_2790), class_1713.field_7789);
				}

				this.method_2383(null, -999, class_1703.method_7591(2, this.field_2790), class_1713.field_7789);
			} else if (!this.minecraft.field_1724.field_7514.method_7399().method_7960()) {
				if (this.minecraft.field_1690.field_1871.method_1433(i)) {
	...
	protected void method_2383(class_1735 arg, int i, int j, class_1713 arg2) {
		...
		this.minecraft.field_1761.method_2906(this.field_2797.field_7763, i, j, arg2, this.minecraft.field_1724);
	}
	...
	public boolean keyPressed(int i, int j, int k) {
		if (super.keyPressed(i, j, k)) {
			...
			if (i == 256 || this.minecraft.field_1690.field_1822.method_1417(i, j)) {
				this.minecraft.field_1724.method_7346();
			}

			this.method_2384(i, j);
			if (this.field_2787 != null && this.field_2787.method_7681()) {
				if (this.minecraft.field_1690.field_1871.method_1417(i, j)) {
					this.method_2383(this.field_2787, this.field_2787.field_7874, 0, class_1713.field_7796);
				} else if (this.minecraft.field_1690.field_1869.method_1417(i, j)) {
					this.method_2383(this.field_2787, this.field_2787.field_7874, hasControlDown() ? 1 : 0, class_1713.field_7795);
				}
			}
	...
	protected boolean method_2384(int i, int j) {
		if (this.minecraft.field_1724.field_7514.method_7399().method_7960() && this.field_2787 != null) {
			for(int k = 0; k < 9; ++k) {
				if (this.minecraft.field_1690.field_1852[k].method_1417(i, j)) {
	...
	public void removed() {
		if (this.minecraft.field_1724 != null) {
			this.field_2797.method_7595(this.minecraft.field_1724);
		}
	}
	...
	public void tick() {
		super.tick();
		if (!this.minecraft.field_1724.method_5805() || this.minecraft.field_1724.field_5988) {
			this.minecraft.field_1724.method_7346();
		}
	}
