...
public class Potions {
	public static final RegistryEntry<Potion> WATER = register("water", new Potion("water"));
	public static final RegistryEntry<Potion> MUNDANE = register("mundane", new Potion("mundane"));
	public static final RegistryEntry<Potion> THICK = register("thick", new Potion("thick"));
	public static final RegistryEntry<Potion> AWKWARD = register("awkward", new Potion("awkward"));
	public static final RegistryEntry<Potion> NIGHT_VISION = register(
		"night_vision", new Potion("night_vision", new StatusEffectInstance(StatusEffects.NIGHT_VISION, 3600))
	);
	...
	public static final RegistryEntry<Potion> INVISIBILITY = register(
		"invisibility", new Potion("invisibility", new StatusEffectInstance(StatusEffects.INVISIBILITY, 3600))
	);
	...
	public static final RegistryEntry<Potion> LEAPING = register("leaping", new Potion("leaping", new StatusEffectInstance(StatusEffects.JUMP_BOOST, 3600)));
	...
	public static final RegistryEntry<Potion> FIRE_RESISTANCE = register(
		"fire_resistance", new Potion("fire_resistance", new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 3600))
	);
	...
	public static final RegistryEntry<Potion> SWIFTNESS = register("swiftness", new Potion("swiftness", new StatusEffectInstance(StatusEffects.SPEED, 3600)));
	...
	public static final RegistryEntry<Potion> SLOWNESS = register("slowness", new Potion("slowness", new StatusEffectInstance(StatusEffects.SLOWNESS, 1800)));
	...
	public static final RegistryEntry<Potion> WATER_BREATHING = register(
		"water_breathing", new Potion("water_breathing", new StatusEffectInstance(StatusEffects.WATER_BREATHING, 3600))
	);
	...
	public static final RegistryEntry<Potion> HEALING = register("healing", new Potion("healing", new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 1)));
	...
	public static final RegistryEntry<Potion> HARMING = register("harming", new Potion("harming", new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 1)));
	...
	public static final RegistryEntry<Potion> POISON = register("poison", new Potion("poison", new StatusEffectInstance(StatusEffects.POISON, 900)));
	...
	public static final RegistryEntry<Potion> REGENERATION = register(
		"regeneration", new Potion("regeneration", new StatusEffectInstance(StatusEffects.REGENERATION, 900))
	);
	...
	public static final RegistryEntry<Potion> STRENGTH = register("strength", new Potion("strength", new StatusEffectInstance(StatusEffects.STRENGTH, 3600)));
	...
	public static final RegistryEntry<Potion> WEAKNESS = register("weakness", new Potion("weakness", new StatusEffectInstance(StatusEffects.WEAKNESS, 1800)));
	...
	public static final RegistryEntry<Potion> SLOW_FALLING = register(
		"slow_falling", new Potion("slow_falling", new StatusEffectInstance(StatusEffects.SLOW_FALLING, 1800))
	);
