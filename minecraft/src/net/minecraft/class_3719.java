...
public class class_3719 extends class_2621 {
	...
	public void method_5435(class_1657 arg) {
		if (!arg.method_7325()) {
			...
			boolean bl = lv.method_11654(class_3708.field_18006);
			if (!bl) {
				this.method_17764(lv, class_3417.field_17604);
	...
	private void method_20363() {
		this.field_11863.method_8397().method_8676(this.method_11016(), this.method_11010().method_11614(), 5);
	}
	...
	public void method_20362() {
		...
		this.field_17583 = class_2595.method_17765(this.field_11863, this, i, j, k);
		if (this.field_17583 > 0) {
			this.method_20363();
		} else {
			class_2680 lv = this.method_11010();
			if (lv.method_11614() != class_2246.field_16328) {
				this.method_11012();
				return;
			}
			...
			boolean bl = lv.method_11654(class_3708.field_18006);
			if (bl) {
				this.method_17764(lv, class_3417.field_17603);
				this.method_18318(lv, false);
			}
		}
	}
