...
public class class_1412 extends class_1408 {
	...
	protected class_243 method_6347() {
		return new class_243(this.field_6684.field_5987, this.field_6684.field_6010 + (double)this.field_6684.field_6019 * 0.5, this.field_6684.field_6035);
	}
	...
	protected void method_6339() {
		if (this.field_6681 != null) {
			...
			float f = this.field_6684.field_5998 > 0.75F ? this.field_6684.field_5998 / 2.0F : 0.75F - this.field_6684.field_5998 / 2.0F;
			if ((double)class_3532.method_15379((float)this.field_6684.field_5967) > 0.2 || (double)class_3532.method_15379((float)this.field_6684.field_6006) > 0.2) {
				f *= class_3532.method_15368(
						this.field_6684.field_5967 * this.field_6684.field_5967
							+ this.field_6684.field_5984 * this.field_6684.field_5984
							+ this.field_6684.field_6006 * this.field_6684.field_6006
					)
					* 6.0F;
			}
			...
			if (class_3532.method_15379((float)(this.field_6684.field_5987 - (lv2.field_1352 + 0.5))) < f
				&& class_3532.method_15379((float)(this.field_6684.field_6035 - (lv2.field_1350 + 0.5))) < f
				&& Math.abs(this.field_6684.field_6010 - lv2.field_1351) < (double)(f * 2.0F)) {
			...
			for(int j = Math.min(this.field_6681.method_39() + 6, this.field_6681.method_38() - 1); j > this.field_6681.method_39(); --j) {
				lv2 = this.field_6681.method_47(this.field_6684, j);
				if (!(lv2.method_1025(lv) > 36.0) && this.method_6341(lv, lv2, 0, 0, 0)) {
	...
	protected void method_6346(class_243 arg) {
		...
		if (this.field_6681 != null && !this.field_6681.method_46()) {
			...
			if (lv.equals(this.field_6680)) {
				this.field_6670 += class_156.method_658() - this.field_6669;
			} else {
				this.field_6680 = lv;
	...
	protected boolean method_6341(class_243 arg, class_243 arg2, int i, int j, int k) {
		class_239 lv = this.field_6677
			.method_8531(
				arg, new class_243(arg2.field_1352, arg2.field_1351 + (double)this.field_6684.field_6019 * 0.5, arg2.field_1350), class_242.field_1348, true, false
			);
		return lv == null || lv.field_1330 == class_239.class_240.field_1333;
	}
