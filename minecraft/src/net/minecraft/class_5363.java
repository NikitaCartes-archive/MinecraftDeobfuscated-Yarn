...
public final class class_5363 {
	...
	public static SimpleRegistry<class_5363> method_29569(SimpleRegistry<class_5363> simpleRegistry) {
		...
		for(Entry<RegistryKey<class_5363>, class_5363> entry : simpleRegistry.method_29722()) {
			RegistryKey<class_5363> registryKey2 = (RegistryKey)entry.getKey();
	...
	public static boolean method_29567(long l, SimpleRegistry<class_5363> simpleRegistry) {
		List<Entry<RegistryKey<class_5363>, class_5363>> list = Lists.newArrayList(simpleRegistry.method_29722());
		if (list.size() != field_25415.size()) {
			return false;
		} else {
			Entry<RegistryKey<class_5363>, class_5363> entry = (Entry)list.get(0);
			Entry<RegistryKey<class_5363>, class_5363> entry2 = (Entry)list.get(1);
			Entry<RegistryKey<class_5363>, class_5363> entry3 = (Entry)list.get(2);
