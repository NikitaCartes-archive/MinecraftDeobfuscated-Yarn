...
public class class_1890 {
	...
	public static Map<class_1887, Integer> method_8222(class_1799 arg) {
		Map<class_1887, Integer> map = Maps.newLinkedHashMap();
		...
		for(int i = 0; i < lv.size(); ++i) {
			...
			if (lv3 != null) {
				map.put(lv3, lv2.method_10550("lvl"));
			}
		}
	...
	private static void method_8220(class_1890.class_1891 arg, class_1799 arg2) {
		if (!arg2.method_7960()) {
			...
			for(int i = 0; i < lv.size(); ++i) {
				...
				class_1887 lv2 = class_2378.field_11160.method_10223(class_2960.method_12829(string));
				if (lv2 != null) {
					arg.accept(lv2, j);
				}
			}
	...
	public static int method_8203(class_1887 arg, class_1309 arg2) {
		Iterable<class_1799> iterable = arg.method_8185(arg2);
		if (iterable == null) {
			return 0;
		} else {
			int i = 0;
	...
	public static class_1799 method_8204(class_1887 arg, class_1309 arg2) {
		List<class_1799> list = arg.method_8185(arg2);
		if (list.isEmpty()) {
			...
			return list2.isEmpty() ? class_1799.field_8037 : (class_1799)list2.get(arg2.method_6051().nextInt(list2.size()));
		}
	}
		...
		if (j <= 0) {
			...
			if (!list2.isEmpty()) {
				...
				while(random.nextInt(50) <= i) {
					i = i * 4 / 5 + 1;
					list2 = method_8229(i, arg, bl);

					for(class_1889 lv2 : list) {
						method_8231(list2, lv2);
					}
