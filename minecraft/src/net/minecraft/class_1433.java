...
public class class_1433 extends class_1480 {
	...
	public class_1433(class_1937 arg) {
		super(class_1299.field_6087, arg);
		this.method_5835(0.9F, 0.6F);
	...
	public void method_5773() {
		...
		if (!this.method_5987()) {
			if (this.method_5637()) {
				...
				if (this.field_5952) {
					this.field_5984 += 0.5;
					this.field_5967 = this.field_5967 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.2F);
					this.field_6006 = this.field_6006 + (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.2F);
			...
			if (this.field_6002.field_9236
				&& this.method_5799()
				&& this.field_5967 * this.field_5967 + this.field_5984 * this.field_5984 + this.field_6006 * this.field_6006 > 0.03) {
		...
		for (int i = 0; i < 7; i++) {
			...
			this.field_6002
				.method_8406(
					...
					this.field_6010 + 0.2F + (double)(this.field_5974.nextFloat() * this.field_6019),
	...
	@Nullable
	public class_1542 method_6490(class_1799 arg) {
		if (arg.method_7960()) {
			return null;
		} else {
			...
			lv.field_5984 = (double)(class_3532.method_15374(this.field_5965 * (float) (Math.PI / 180.0)) * f * 1.5F);
			...
			lv.field_5967 = lv.field_5967 + (double)(class_3532.method_15362(g) * f);
			lv.field_6006 = lv.field_6006 + (double)(class_3532.method_15374(g) * f);
	...
	protected boolean method_6484() {
		...
		return lv != null ? this.method_5831(lv) < 144.0 : false;
	}
	...
	static class class_1434 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6751.method_5799()) {
				this.field_6751.field_5984 += 0.005;
			}
	...
	static class class_1435 extends class_1352 {
		...
		public boolean method_6266() {
			...
			return this.field_6752.method_5831(new class_2338((double)lv.method_10263(), this.field_6752.field_6010, (double)lv.method_10260())) > 16.0
				&& !this.field_6753
		...
		public void method_6270() {
			class_2338 lv = this.field_6752.method_6494();
			if (this.field_6752.method_5831(new class_2338((double)lv.method_10263(), this.field_6752.field_6010, (double)lv.method_10260())) <= 16.0 || this.field_6753
				)
			 {
	...
	static class class_1436 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			this.field_6756 = this.field_6755.field_6002.method_8614(this.field_6755, 10.0);
	...
	class class_1437 extends class_1352 {
		...
		public void method_6270() {
			...
			if (!lv.method_7960()) {
				class_1433.this.method_6490(lv);
