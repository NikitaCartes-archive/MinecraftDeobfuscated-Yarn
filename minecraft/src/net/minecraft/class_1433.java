...
public class class_1433 extends class_1480 {
	...
	public void method_5773() {
		...
		if (!this.method_5987()) {
			if (this.method_5637()) {
				...
				if (this.field_5952) {
					this.field_5984 += 0.5;
					this.field_5967 += (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.2F);
					this.field_6006 += (double)((this.field_5974.nextFloat() * 2.0F - 1.0F) * 0.2F);
	...
	public class_1542 method_6490(class_1799 arg) {
		if (arg.method_7960()) {
			...
			lv.field_5967 += (double)(class_3532.method_15362(g) * f);
			lv.field_6006 += (double)(class_3532.method_15374(g) * f);
	...
	protected boolean method_6484() {
		...
		if (lv != null) {
			return this.method_5831(lv) < 144.0;
		} else {
			return false;
		}
	}
	...
	static class class_1435 extends class_1352 {
		...
		public void method_6270() {
			class_2338 lv = this.field_6752.method_6494();
			if (this.field_6752.method_5831(new class_2338((double)lv.method_10263(), this.field_6752.field_6010, (double)lv.method_10260())) <= 16.0
				|| this.field_6753) {
