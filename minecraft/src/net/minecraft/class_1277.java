...
public class class_1277 implements class_1263, class_1737 {
	...
	public class_1277(class_1799... args) {
		this.field_5831 = args.length;
		this.field_5828 = class_2371.method_10212(class_1799.field_8037, args);
	}
	...
	public class_1799 method_20631(class_1792 arg, int i) {
		class_1799 lv = new class_1799(arg, 0);

		for (int j = this.field_5831 - 1; j >= 0; j--) {
			class_1799 lv2 = this.method_5438(j);
			if (lv2.method_7909().equals(arg)) {
				int k = i - lv.method_7947();
				class_1799 lv3 = lv2.method_7971(k);
				lv.method_7933(lv3.method_7947());
				if (lv.method_7947() == i) {
					break;
				}
			}
	...
	public class_1799 method_5491(class_1799 arg) {
		...
		this.method_20634(lv);
		if (lv.method_7960()) {
			return class_1799.field_8037;
		} else {
			this.method_20633(lv);
			return lv.method_7960() ? class_1799.field_8037 : lv;
		}
	}
	...
	public String toString() {
		return ((List)this.field_5828.stream().filter(arg -> !arg.method_7960()).collect(Collectors.toList())).toString();
	}

	private void method_20633(class_1799 arg) {
		for (int i = 0; i < this.field_5831; i++) {
			class_1799 lv = this.method_5438(i);
			if (lv.method_7960()) {
				this.method_5447(i, arg.method_7972());
				arg.method_7939(0);
				return;
			}
		}
	...
	private void method_20634(class_1799 arg) {
		for (int i = 0; i < this.field_5831; i++) {
			class_1799 lv = this.method_5438(i);
			if (class_1799.method_7984(lv, arg)) {
				this.method_20632(arg, lv);
				if (arg.method_7960()) {
					return;
				}
			}
	...
	private void method_20632(class_1799 arg, class_1799 arg2) {
		int i = Math.min(this.method_5444(), arg2.method_7914());
		int j = Math.min(arg.method_7947(), i - arg2.method_7947());
		if (j > 0) {
			arg2.method_7933(j);
			arg.method_7934(j);
			this.method_5431();
