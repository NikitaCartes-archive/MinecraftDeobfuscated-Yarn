...
public class class_6832 {
	...
	private class_6833 method_39832(ChunkPos chunkPos, StructureFeature<?> structureFeature, boolean bl, long l) {
		class_6841 lv = new class_6841(
			new class_6841.class_6843(NbtInt.TYPE, "DataVersion"),
			new class_6841.class_6843("Level", "Structures", NbtCompound.TYPE, "Starts"),
			new class_6841.class_6843("structures", NbtCompound.TYPE, "starts")
		);
		...
		if (!(lv.method_39887() instanceof NbtCompound nbtCompound)) {
			return null;
		} else {
