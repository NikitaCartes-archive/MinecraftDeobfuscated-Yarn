...
public class class_634 implements class_2602 {
	...
	public void method_11120(class_2678 arg) {
		...
		this.field_3690.field_1690.field_1851 = arg.method_11566();
		...
		this.field_3690.field_1724.method_5838(arg.method_11564());
		...
		this.field_3689
			.method_10743(new class_2817(class_2817.field_12831, new class_2540(Unpooled.buffer()).method_10814(ClientBrandRetriever.getClientModName())));
	...
	public void method_11112(class_2604 arg) {
		...
		class_1297 lv = null;
		if (arg.method_11169() == 10) {
			lv = class_1688.method_7523(this.field_3699, d, e, f, class_1688.class_1689.method_7529(arg.method_11166()));
		} else if (arg.method_11169() == 90) {
			class_1297 lv2 = this.field_3699.method_8469(arg.method_11166());
			if (lv2 instanceof class_1657) {
				lv = new class_1536(this.field_3699, (class_1657)lv2, d, e, f);
			}

			arg.method_11163(0);
		} else if (arg.method_11169() == 60) {
			lv = new class_1667(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 91) {
			lv = new class_1679(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 94) {
			lv = new class_1685(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 61) {
			lv = new class_1680(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 68) {
			lv = new class_1673(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
		} else if (arg.method_11169() == 71) {
			lv = new class_1533(this.field_3699, new class_2338(d, e, f), class_2350.method_10143(arg.method_11166()));
			arg.method_11163(0);
		} else if (arg.method_11169() == 77) {
			lv = new class_1532(this.field_3699, new class_2338(class_3532.method_15357(d), class_3532.method_15357(e), class_3532.method_15357(f)));
			arg.method_11163(0);
		} else if (arg.method_11169() == 65) {
			lv = new class_1684(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 72) {
			lv = new class_1672(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 76) {
			lv = new class_1671(this.field_3699, d, e, f, class_1799.field_8037);
		} else if (arg.method_11169() == 63) {
			lv = new class_1674(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			arg.method_11163(0);
		} else if (arg.method_11169() == 93) {
			lv = new class_1670(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			arg.method_11163(0);
		} else if (arg.method_11169() == 64) {
			lv = new class_1677(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			arg.method_11163(0);
		} else if (arg.method_11169() == 66) {
			lv = new class_1687(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			arg.method_11163(0);
		} else if (arg.method_11169() == 67) {
			lv = new class_1678(this.field_3699, d, e, f, (double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			arg.method_11163(0);
		} else if (arg.method_11169() == 62) {
			lv = new class_1681(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 79) {
			lv = new class_1669(this.field_3699, d, e, f, 0.0F, 0, null);
		} else if (arg.method_11169() == 73) {
			lv = new class_1686(this.field_3699, d, e, f);
			arg.method_11163(0);
		} else if (arg.method_11169() == 75) {
			lv = new class_1683(this.field_3699, d, e, f);
			arg.method_11163(0);
		} else if (arg.method_11169() == 1) {
			lv = new class_1690(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 50) {
			lv = new class_1541(this.field_3699, d, e, f, null);
		} else if (arg.method_11169() == 78) {
			lv = new class_1531(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 51) {
			lv = new class_1511(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 2) {
			lv = new class_1542(this.field_3699, d, e, f);
		} else if (arg.method_11169() == 70) {
			lv = new class_1540(this.field_3699, d, e, f, class_2248.method_9531(arg.method_11166()));
			arg.method_11163(0);
		} else if (arg.method_11169() == 3) {
			lv = new class_1295(this.field_3699, d, e, f);
		}

		if (lv != null) {
			class_3208.method_14070(lv, d, e, f);
			lv.field_5965 = (float)(arg.method_11171() * 360) / 256.0F;
			lv.field_6031 = (float)(arg.method_11168() * 360) / 256.0F;
			class_1297[] lvs = lv.method_5690();
			if (lvs != null) {
				int i = arg.method_11167() - lv.method_5628();

				for(class_1297 lv3 : lvs) {
					lv3.method_5838(lv3.method_5628() + i);
				}
			}

			lv.method_5838(arg.method_11167());
			lv.method_5826(arg.method_11164());
			this.field_3699.method_2942(arg.method_11167(), lv);
			if (arg.method_11166() > 0) {
				if (arg.method_11169() == 60 || arg.method_11169() == 91 || arg.method_11169() == 94) {
					class_1297 lv4 = this.field_3699.method_8469(arg.method_11166() - 1);
					if (lv4 instanceof class_1309 && lv instanceof class_1665) {
						class_1665 lv5 = (class_1665)lv;
						lv5.method_7432(lv4);
						if (lv4 instanceof class_1657) {
							lv5.field_7572 = class_1665.class_1666.field_7593;
							if (((class_1657)lv4).field_7503.field_7477) {
								lv5.field_7572 = class_1665.class_1666.field_7594;
							}
						}
					}
				}

				lv.method_5750((double)arg.method_11170() / 8000.0, (double)arg.method_11172() / 8000.0, (double)arg.method_11173() / 8000.0);
			}
		}
	}
	...
	public void method_11156(class_2607 arg) {
		...
		if (arg.method_11190() == 1) {
			lv = new class_1538(this.field_3699, d, e, f, false);
		}
		...
		if (lv != null) {
			...
			this.field_3699.method_8416(lv);
		}
	}
	...
	public void method_11097(class_2613 arg) {
		...
		this.field_3699.method_2942(arg.method_11227(), lv);
	...
	public void method_11155(class_2684 arg) {
		...
		if (lv != null) {
			lv.field_6001 += (long)arg.method_11648();
			lv.field_6023 += (long)arg.method_11646();
			lv.field_5954 += (long)arg.method_11647();
			double d = (double)lv.field_6001 / 4096.0;
			double e = (double)lv.field_6023 / 4096.0;
			double f = (double)lv.field_5954 / 4096.0;
			if (!lv.method_5787()) {
				float g = arg.method_11652() ? (float)(arg.method_11649() * 360) / 256.0F : lv.field_6031;
				float h = arg.method_11652() ? (float)(arg.method_11650() * 360) / 256.0F : lv.field_5965;
				lv.method_5759(d, e, f, g, h, 3, false);
	...
	public void method_11095(class_2716 arg) {
		...
		for(int i = 0; i < arg.method_11763().length; ++i) {
			this.field_3699.method_2945(arg.method_11763()[i]);
		}
	}
	...
	public void method_11128(class_2672 arg) {
		...
		this.field_3699.method_2935().method_16020(this.field_3699, i, j, arg.method_11521(), arg.method_16123(), arg.method_11526(), arg.method_11530());

		for(int k = 0; k < 16; ++k) {
			this.field_3699.method_16108(i, k, j);
		}

		for(class_2487 lv : arg.method_11525()) {
			class_2338 lv2 = new class_2338(lv.method_10550("x"), lv.method_10550("y"), lv.method_10550("z"));
			class_2586 lv3 = this.field_3699.method_8321(lv2);
			if (lv3 != null) {
				lv3.method_11014(lv);
			}
		}
	...
	public void method_10839(class_2561 arg) {
		this.field_3690.method_1481(null);
		if (this.field_3701 != null) {
			if (this.field_3701 instanceof class_399) {
				this.field_3690.method_1507(new DisconnectedRealmsScreen(((class_399)this.field_3701).method_2069(), "disconnect.lost", arg).getProxy());
			} else {
	...
	@Override
	public void method_11137(class_2711 arg) {
		class_2600.method_11074(arg, this, this.field_3690);
		arg.method_11747(this.field_3699).method_7269(arg.method_11749());
	}
	...
	public void method_11138(class_2610 arg) {
		...
		if (lv != null) {
			...
			class_1297[] lvs = lv.method_5690();
			if (lvs != null) {
				int i = arg.method_11207() - lv.method_5628();

				for(class_1297 lv2 : lvs) {
					lv2.method_5838(lv2.method_5628() + i);
				}
			}
			...
			lv.method_5641(d, e, f, g, h);
			lv.field_5967 = (double)((float)arg.method_11212() / 8000.0F);
			lv.field_5984 = (double)((float)arg.method_11211() / 8000.0F);
			lv.field_6006 = (double)((float)arg.method_11209() / 8000.0F);
	...
	public void method_11110(class_2740 arg) {
		...
		class_1297 lv2 = this.field_3699.method_8469(arg.method_11810());
		if (lv instanceof class_1308) {
			if (lv2 != null) {
				((class_1308)lv).method_5954(lv2, false);
			} else {
				((class_1308)lv).method_5932(false, false);
			}
		}
	}
		...
		if (lv != null) {
			if (arg.method_11470() == 21) {
				...
				if (lv == this.field_3690.field_1724) {
					this.field_3690.field_1773.method_3189(new class_1799(class_1802.field_8288));
				}
			} else {
	...
	public void method_11117(class_2724 arg) {
		...
		if (lv != this.field_3690.field_1724.field_6026) {
			this.field_3698 = false;
			class_269 lv2 = this.field_3699.method_8428();
			this.field_3699 = new class_638(
				this,
			...
			this.field_3699.method_2944(lv2);
			this.field_3690.method_1481(this.field_3699);
			this.field_3690.field_1724.field_6026 = lv;
			this.field_3690.method_1507(new class_434());
		}

		this.field_3690.method_1585(arg.method_11779());
	...
	public void method_11124(class_2664 arg) {
		...
		lv.method_8350(true);
		this.field_3690.field_1724.field_5967 += (double)arg.method_11472();
		this.field_3690.field_1724.field_5984 += (double)arg.method_11473();
		this.field_3690.field_1724.field_6006 += (double)arg.method_11474();
	}
	...
	public void method_11088(class_2683 arg) {
		...
		class_22 lv2 = class_1806.method_7997(this.field_3690.field_1687, string);
		if (lv2 == null) {
			...
			this.field_3690.field_1687.method_8647(class_2874.field_13072, string, lv2);
		}
		...
		switch(lv2) {
			case field_12417:
				for(class_2960 lv3 : arg.method_11750()) {
					class_1860 lv4 = this.field_3688.method_8130(lv3);
					if (lv4 != null) {
						lv.method_14893(lv4);
					}
				}
			...
			case field_12415:
				for(class_2960 lv3 : arg.method_11750()) {
					...
					if (lv4 != null) {
						lv.method_14876(lv4);
						lv.method_14885(lv4);
						class_366.method_1985(this.field_3690.method_1566(), lv4);
					}
				}
		}
	...
	public void method_11133(class_2698 arg) {
		...
		if (arg.field_12347 == class_2698.class_2699.field_12350) {
			...
			if (lv == this.field_3690.field_1724) {
				this.field_3690.method_1507(new class_418(arg.field_12346));
			}
		}
	}
	...
	public void method_11154(class_2696 arg) {
		...
		lv.field_7503.method_7248((double)arg.method_11690());
			...
			if (string.startsWith("level://")) {
				...
				if (lv != null && lv.method_2990() == class_642.class_643.field_3768) {
					...
					this.field_3690.execute(() -> this.field_3690.method_1507(new class_410((bl, i) -> {
							...
							class_642 lvxx = this.field_3690.method_1558();
							if (bl) {
								if (lvxx != null) {
									lvxx.method_2995(class_642.class_643.field_3768);
								}
								...
								if (lvxx != null) {
									lvxx.method_2995(class_642.class_643.field_3764);
								}

								this.method_2873(class_2856.class_2857.field_13018);
							}

							class_641.method_2986(lvxx);
							this.field_3690.method_1507(null);
						}, class_1074.method_4662("multiplayer.texturePrompt.line1"), class_1074.method_4662("multiplayer.texturePrompt.line2"), 0)));
				}
			}
		}
	}
	...
	public void method_11090(class_2695 arg) {
		...
		if (lv.field_7763 == arg.method_11685() && lv.method_7622(this.field_3690.field_1724)) {
			class_1860 lv2 = this.field_3688.method_8130(arg.method_11684());
			if (lv2 != null && this.field_3690.field_1755 instanceof class_518) {
				class_507 lv3 = ((class_518)this.field_3690.field_1755).method_2659();
				lv3.method_2596(lv2, lv.field_7761);
			}
		}
	}
	...
	private void method_2870(int i, int j, class_3568 arg, class_1944 arg2, int k, int l, Iterator<byte[]> iterator) {
		for(int m = 0; m < 18; ++m) {
			...
			boolean bl2 = (l & 1 << m) != 0;
			if (bl || bl2) {
				arg.method_15558(arg2, i, n, j, bl ? new class_2804((byte[])((byte[])iterator.next()).clone()) : new class_2804());
				this.field_3699.method_16108(i, n, j);
			}
		}
	}
