...
public class class_634 implements class_2602 {
	...
	public void method_11098(class_2673 arg) {
		...
		if (arg.method_11533()) {
			...
			this.field_3690.field_1687.method_20290(arg.method_11532(), arg.method_11531(), arg.method_11534());
		}
	}
	...
	public void method_11106(class_2788 arg) {
		class_2600.method_11074(arg, this, this.field_3690);
		this.field_3688.method_20702(arg.method_11998());
		class_1123<class_516> lv = this.field_3690.method_1484(class_1124.field_5496);
		lv.method_4797();
		class_299 lv2 = this.field_3690.field_1724.method_3130();
		lv2.method_1401();
		lv2.method_1393().forEach(lv::method_4798);
		lv.method_4799();
	}
		...
		if (this.method_2888(string)) {
			if (string.startsWith("level://")) {
				...
				if (lv != null && lv.method_2990() == class_642.class_643.field_3768) {
					...
					this.field_3690.execute(() -> this.field_3690.method_1507(new class_410(bl -> {
	...
	public void method_11152(class_2658 arg) {
		...
		try {
			...
			if (class_2658.field_12158.equals(lv)) {
				...
				class_2874 lv6 = class_2874.method_12490(lv2.readInt());
				class_3341 lv7 = new class_3341(lv2.readInt(), lv2.readInt(), lv2.readInt(), lv2.readInt(), lv2.readInt(), lv2.readInt());
				int m = lv2.readInt();
				...
				this.field_3690.field_1709.field_4539.method_3871(lv7, list2, list3, lv6);
				...
				int m = lv2.readInt();
				class_4207.class_4233 lv8 = new class_4207.class_4233(lv5, string, m);
				this.field_3690.field_1709.field_18777.method_19701(lv8);
				...
				int j = lv2.readInt();
				int m = lv2.readInt();
				List<class_4205.class_4206> list2 = Lists.<class_4205.class_4206>newArrayList();

				for(int k = 0; k < m; ++k) {
					int n = lv2.readInt();
					boolean bl = lv2.readBoolean();
					String string2 = lv2.method_10800(255);
					list2.add(new class_4205.class_4206(lv5, n, string2, bl));
				}

				this.field_3690.field_1709.field_18778.method_19430(j, list2);
			} else if (class_2658.field_19331.equals(lv)) {
				int i = lv2.readInt();
				Collection<class_2338> collection = Lists.<class_2338>newArrayList();

				for(int m = 0; m < i; ++m) {
					collection.add(lv2.method_10811());
				}

				this.field_3690.field_1709.field_19325.method_20561(collection);
				...
				class_11 lv10;
				if (bl2) {
					lv10 = class_11.method_34(lv2);
				} else {
					lv10 = null;
				}

				boolean bl3 = lv2.readBoolean();
				class_4207.class_4232 lv11 = new class_4207.class_4232(uUID, o, string3, string4, p, lv9, string5, lv10, bl3);
				int q = lv2.readInt();

				for(int r = 0; r < q; ++r) {
					String string6 = lv2.method_19772();
					lv11.field_18927.add(string6);
				}

				int r = lv2.readInt();

				for(int s = 0; s < r; ++s) {
					String string7 = lv2.method_19772();
					lv11.field_18928.add(string7);
				}

				int s = lv2.readInt();

				for(int t = 0; t < s; ++t) {
					String string8 = lv2.method_19772();
					lv11.field_19374.add(string8);
				}

				int t = lv2.readInt();

				for(int u = 0; u < t; ++u) {
					class_2338 lv12 = lv2.method_10811();
					lv11.field_18930.add(lv12);
				}

				int u = lv2.readInt();

				for(int v = 0; v < u; ++v) {
					String string9 = lv2.method_19772();
					lv11.field_19375.add(string9);
				}

				this.field_3690.field_1709.field_18777.method_19432(lv11);
			} else {
	...
	public void method_11090(class_2695 arg) {
		...
		if (lv.field_7763 == arg.method_11685() && lv.method_7622(this.field_3690.field_1724)) {
			this.field_3688.method_8130(arg.method_11684()).ifPresent(arg2 -> {
				if (this.field_3690.field_1755 instanceof class_518) {
					class_507 lvxx = ((class_518)this.field_3690.field_1755).method_2659();
					lvxx.method_2596(arg2, lv.field_7761);
				}
			});
		}
	}
	...
	public void method_17586(class_3943 arg) {
		...
		if (arg.method_17589() == lv.field_7763 && lv instanceof class_1728) {
			((class_1728)lv).method_17437(new class_1916(arg.method_17590().method_8268()));
			...
			((class_1728)lv).method_20700(arg.method_20722());
		}
	}
	...
	@Override
	public void method_20320(class_4282 arg) {
		class_2600.method_11074(arg, this, this.field_3690);
		this.field_3699.method_2935().method_20317(arg.method_20322(), arg.method_20323());
	}
