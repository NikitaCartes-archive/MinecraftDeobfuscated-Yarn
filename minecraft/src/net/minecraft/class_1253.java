...
public class class_1253 extends class_1220 {
	protected static final HookFunction field_5746 = new HookFunction() {
		@Override
		public <T> T apply(DynamicOps<T> dynamicOps, T object) {
			return class_1254.method_5359(new Dynamic<>(dynamicOps, object), class_1250.field_5744, "minecraft:armor_stand");
		}
	};

	public class_1253(int i, Schema schema) {
		super(i, schema);
	}
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(map, "minecraft:arrow", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("inTile", class_1208.field_5731.in(schema))));
		...
		schema.register(
			map, "minecraft:commandblock_minecart", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("DisplayTile", class_1208.field_5731.in(schema)))
		);
		...
		schema.register(
			map,
			"minecraft:enderman",
			(Function<String, TypeTemplate>)(string -> DSL.optionalFields("carried", class_1208.field_5731.in(schema), class_1222.method_5196(schema)))
		);
		...
		schema.register(
			map, "minecraft:furnace_minecart", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("DisplayTile", class_1208.field_5731.in(schema)))
		);
		...
		schema.register(map, "minecraft:minecart", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("DisplayTile", class_1208.field_5731.in(schema))));
		...
		schema.register(
			map,
			"minecraft:potion",
			(Function<String, TypeTemplate>)(string -> DSL.optionalFields("Potion", class_1208.field_5712.in(schema), "inTile", class_1208.field_5731.in(schema)))
		);
		...
		schema.register(
			...
			(Function<String, TypeTemplate>)(string -> DSL.optionalFields("DisplayTile", class_1208.field_5731.in(schema), class_1208.field_5718.in(schema)))
		);
		schema.register(map, "minecraft:spectral_arrow", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("inTile", class_1208.field_5731.in(schema))));
		...
		schema.register(
			map, "minecraft:tnt_minecart", (Function<String, TypeTemplate>)(string -> DSL.optionalFields("DisplayTile", class_1208.field_5731.in(schema)))
		);
		schema.register(
			map,
			"minecraft:villager",
