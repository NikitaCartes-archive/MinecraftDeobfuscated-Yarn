...
public class IntProperty extends Property<Integer> {
	...
	private final int field_38611;
	private final int field_38612;
	...
	protected IntProperty(String name, int min, int max) {
		...
		if (min < 0) {
			...
			this.field_38611 = min;
			this.field_38612 = max;
	...
	public Optional<Integer> parse(String name) {
		try {
			...
			return integer >= this.field_38611 && integer <= this.field_38612 ? Optional.of(integer) : Optional.empty();
