	...
	private static class_243 method_6371(
		...
		for(int k = 0; k < 10; ++k) {
			...
			if (lv3 != null) {
				...
				class_2338 lv4 = new class_2338((double)l + arg.field_5987, (double)m + arg.field_6010, (double)n + arg.field_6035);
				if ((!bl2 || arg.method_18407(lv4)) && lv.method_6333(lv4)) {
					if (!bl) {
						lv4 = method_6372(lv4, arg);
						if (method_6380(lv4, arg)) {
							continue;
						}
					}

					double f = toDoubleFunction.applyAsDouble(lv4);
					if (f > e) {
						e = f;
						lv2 = lv4;
						bl3 = true;
