		...
		for(int n = 0; n < 10; ++n) {
			...
			if (lv2 != null) {
				...
				if (arg.method_18410() && i > 1) {
					class_2338 lv3 = arg.method_18412();
				...
				class_2338 lv3 = new class_2338((double)o + arg.field_5987, (double)p + arg.field_6010, (double)q + arg.field_6035);
				if ((!bl2 || arg.method_18407(lv3)) && lv.method_6333(lv3)) {
					if (!bl) {
						lv3 = method_6372(lv3, arg);
						if (method_6380(lv3, arg)) {
							continue;
						}
					}

					double f = toDoubleFunction.applyAsDouble(lv3);
					if (f > e) {
						e = f;
						k = o;
						l = p;
