	...
	private static void method_13766(
		...
		if (arg2 instanceof class_3222) {
			...
			if (arg3 == arg2.field_6002) {
				...
				class_3218 lv = (class_3218)arg2.field_6002;
				lv.method_8463(arg2);
				arg2.field_6026 = arg3.field_9247.method_12460();
				arg2.field_5988 = false;
				class_1297 lv2 = arg2;
				...
				arg2.method_5808(d, e, f, i, j);
				arg2.method_5847(i);
				boolean bl = arg2.field_5983;
				arg2.field_5983 = true;
				arg3.method_8649(arg2);
				arg2.field_5983 = bl;
				arg3.method_8553(arg2, false);
				lv2.field_5988 = true;
			}
		}
