...
public class class_5610 {
	...
	public ModelPart method_32112(int i, int j) {
		Object2ObjectArrayMap<String, ModelPart> object2ObjectArrayMap = (Object2ObjectArrayMap)this.field_27730
			.entrySet()
			.stream()
			.collect(
				Collectors.toMap(
		...
		List<ModelPart.Cuboid> list = (List)this.field_27728.stream().map(arg -> arg.method_32093(i, j)).collect(ImmutableList.toImmutableList());
