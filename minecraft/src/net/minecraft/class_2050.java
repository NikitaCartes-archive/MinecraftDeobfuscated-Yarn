	...
	public static class_2050 method_8928(@Nullable JsonElement jsonElement) {
		if (jsonElement != null && !jsonElement.isJsonNull()) {
			...
			if (string.startsWith("#")) {
				...
				class_1299<?> lv3 = class_2378.field_11145.method_10223(lv);
				if (lv3 == null) {
					throw new JsonSyntaxException("Unknown entity type '" + lv + "', valid types are: " + field_9608.join(class_2378.field_11145.method_10235()));
				} else {
