...
public class class_4230 {
	private static final Logger field_18915 = LogManager.getLogger();

	private static String method_19683(int i) {
		switch (i) {
			case 40961:
	...
	static boolean method_19684(String string) {
		int i = AL10.alGetError();
		if (i != 0) {
			field_18915.error("{}: {}", string, method_19683(i));
			return true;
		} else {
			return false;
		}
	...
	static boolean method_20051(long l, String string) {
		...
		if (i != 0) {
			field_18915.error("{}{}: {}", string, l, method_20052(i));
			return true;
		} else {
			return false;
		}
	...
	static int method_19685(AudioFormat audioFormat) {
