...
public class class_635 implements class_2896 {
	...
	public void method_12587(class_2905 arg) {
		...
		class_3521.field_15664.submit((Runnable)(() -> {
			class_2561 lvxx = this.method_2892(string);
			if (lvxx != null) {
				if (this.field_3708.method_1558() == null || !this.field_3708.method_1558().method_2994()) {
					this.field_3707.method_10747(lvxx);
					return;
				}

				field_3710.warn(lvxx.getString());
			}
	...
	public void method_10839(class_2561 arg) {
		if (this.field_3706 != null && this.field_3706 instanceof RealmsScreenProxy) {
			this.field_3708.method_1507(new DisconnectedRealmsScreen(((RealmsScreenProxy)this.field_3706).getScreen(), "connect.failed", arg).getProxy());
		} else {
