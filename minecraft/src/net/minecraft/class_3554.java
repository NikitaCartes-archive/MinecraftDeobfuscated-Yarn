...
public abstract class class_3554 {
	...
	private void method_15479(long l, int i, int j) {
		if (i <= this.field_15783 - 1) {
			i = Math.min(this.field_15783 - 1, i);
