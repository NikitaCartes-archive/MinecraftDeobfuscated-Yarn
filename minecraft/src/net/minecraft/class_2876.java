			...
			if (bl || bl2) {
				...
				if (k < list2.size()) {
					...
					if (bl) {
						...
						for(class_2338.class_2339 lv3 : class_2338.method_10082(
						...
						arg.method_8437(null, (double)((float)lv.method_13966() + 0.5F), (double)lv.method_13964(), (double)((float)lv.method_13967() + 0.5F), 5.0F, true);
						class_3666 lv4 = new class_3666(true, ImmutableList.of(lv), new class_2338(0, 128, 0));
						class_3031.field_13522.method_13151(arg, arg.method_14178().method_12129(), new Random(), new class_2338(lv.method_13966(), 45, lv.method_13967()), lv4);
					}
				} else if (bl) {
		...
		public void method_12507(class_3218 arg, class_2881 arg2, List<class_1511> list, int i, class_2338 arg3) {
			if (i >= 100) {
				...
				for(class_1511 lv : list) {
					lv.method_6837(null);
					arg.method_8437(lv, lv.field_5987, lv.field_6010, lv.field_6035, 6.0F, false);
					lv.method_5650();
				}
			} else if (i >= 80) {
				arg.method_8535(3001, new class_2338(0, 128, 0), 0);
