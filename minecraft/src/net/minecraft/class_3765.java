...
public class class_3765 {
	...
	private final Map<Integer, class_3763> field_16615 = Maps.newHashMap();
	private final Map<Integer, Set<class_3763>> field_16618 = Maps.newHashMap();
	private final Set<UUID> field_19021 = Sets.newHashSet();
	private long field_16605;
	private final class_2338 field_16613;
	...
	private Predicate<class_3222> method_16501() {
		return arg -> arg.method_5805() && arg.method_14220().method_19497(new class_2338(arg), 2);
	}

	private void method_16499() {
		Set<class_3222> set = Sets.<class_3222>newHashSet();

		for(class_3222 lv : this.field_16619.method_18766(this.method_16501())) {
	...
	public void method_16518(class_1657 arg) {
		if (arg.method_6059(class_1294.field_16595)) {
			this.field_16623 += arg.method_6112(class_1294.field_16595).method_5578() + 1;
		...
		if (!this.method_20022()) {
			if (this.field_19023 == class_3765.class_4259.field_19026) {
				...
				while(this.method_16519()) {
					class_2338 lv = this.method_16525(j);
					if (lv != null) {
					...
					if (bl) {
						for(UUID uUID : this.field_19021) {
							...
							if (lv2 instanceof class_1309 && !lv2.method_7325()) {
								...
								lv3.method_6092(new class_1293(class_1294.field_18980, 48000, this.field_16623 - 1));
							}
						}
					}
	...
	private boolean method_16833() {
		if (this.method_20013()) {
			return !this.method_20014();
		} else {
			return !this.method_20012();
		}
	}
	...
	private void method_16834() {
		...
		while(iterator.hasNext()) {
			...
			for(class_3763 lv : set2) {
				...
				if (!class_3767.method_16537(lv, this.field_16613, 32) && lv.method_6131() > 2400) {
	...
	private void method_16521(class_2338 arg) {
		...
		for(class_1657 lv : this.field_16619.method_18456()) {
			...
			if (g <= 64.0F || class_3767.method_16537(lv, this.field_16613, 32)) {
	...
	public void method_16510(@Nonnull class_3763 arg, boolean bl) {
		Set<class_3763> set = (Set)this.field_16618.get(arg.method_16486());
		if (set != null) {
			boolean bl2 = set.remove(arg);
			if (bl2) {
				if (bl) {
					this.field_16620 -= arg.method_6032();
				}
	...
	@Nullable
	private class_2338 method_16525(int i) {
		int j = i == 0 ? 2 : 2 - i;
		class_2338.class_2339 lv = new class_2338.class_2339();

		for(int k = 0; k < 20; ++k) {
			float f = this.field_16619.field_9229.nextFloat() * (float) (Math.PI * 2);
			int l = this.field_16613.method_10263() + (int)(class_3532.method_15362(f) * 32.0F * (float)j) + this.field_16619.field_9229.nextInt(5);
			int m = this.field_16613.method_10260() + (int)(class_3532.method_15374(f) * 32.0F * (float)j) + this.field_16619.field_9229.nextInt(5);
			int n = this.field_16619.method_8589(class_2902.class_2903.field_13202, l, m);
			...
			if ((!this.field_16619.method_19500(lv) || i >= 2)
				...
				&& (
					class_1948.method_8660(class_1317.class_1319.field_6317, this.field_16619, lv, class_1299.field_6105)
	...
	public boolean method_16487(int i, class_3763 arg, boolean bl) {
		...
		Set<class_3763> set = (Set)this.field_16618.get(i);
		class_3763 lv = null;
