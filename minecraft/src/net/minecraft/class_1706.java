...
public class class_1706 extends class_1703 {
			...
			new class_1735(this.field_7769, 2, 134, 47) {
				...
				public class_1799 method_7667(class_1657 arg, class_1799 arg2) {
					...
					arg2.method_17393((arg2xxx, arg3) -> {
						class_2680 lvxx = arg2xxx.method_8320(arg3);
						if (!arg.field_7503.field_7477 && lvxx.method_11602(class_3481.field_15486) && arg.method_6051().nextFloat() < 0.12F) {
							class_2680 lv2 = class_2199.method_9346(lvxx);
							if (lv2 == null) {
								arg2xxx.method_8650(arg3);
								arg2xxx.method_8535(1029, arg3, 0);
							} else {
								arg2xxx.method_8652(arg3, lv2, 2);
								arg2xxx.method_8535(1030, arg3, 0);
							}
						} else {
							arg2xxx.method_8535(1030, arg3, 0);
						}
	...
	@Override
	public class_3917<class_1706> method_17358() {
			...
			if (!lv3.method_7960()) {
				...
				if (lv2.method_7963() && lv2.method_7909().method_7878(lv, lv3)) {
					...
					if (lv2.method_7963() && !bl) {
						int l = lv.method_7936() - lv.method_7919();
					...
					for(class_1887 lv4 : map2.keySet()) {
						if (lv4 != null) {
							int q = map.containsKey(lv4) ? map.get(lv4) : 0;
							int r = map2.get(lv4);
