...
public class TestRunner {
	...
	private void runBatch(int i) {
		...
		if (i < this.batches.size()) {
			...
			Collection<GameTest> collection = (Collection)this.testsByBatch.get(string);
	...
	private void runBatch(GameTestBatch gameTestBatch) {
		Collection<GameTest> collection = (Collection)this.testsByBatch.get(gameTestBatch.getId());
