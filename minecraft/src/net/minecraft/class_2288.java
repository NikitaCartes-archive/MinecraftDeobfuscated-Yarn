...
public class class_2288 extends class_2237 {
	...
	public void method_9612(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2248 arg4, class_2338 arg5, boolean bl) {
		if (!arg2.field_9236) {
			...
			if (lv instanceof class_2593) {
				...
				boolean bl3 = lv2.method_11043();
				lv2.method_11038(bl2);
				if (!bl3 && !lv2.method_11042() && lv2.method_11039() != class_2593.class_2594.field_11922) {
					if (bl2) {
						lv2.method_11045();
		...
		if (lv instanceof class_2593) {
			...
			if (!arg.field_9236) {
				if (arg5.method_7941("BlockEntityTag") == null) {
					lv3.method_8287(arg.method_8450().method_8355(class_1928.field_19400));
	...
	private static void method_9779(class_1937 arg, class_2338 arg2, class_2350 arg3) {
		...
		int i;
		class_2680 lv3;
		for(i = lv2.method_8356(class_1928.field_19408); i-- > 0; arg3 = lv3.method_11654(field_10791)) {
		...
		if (i <= 0) {
			int j = Math.max(lv2.method_8356(class_1928.field_19408), 0);
