...
public class class_531 {
	...
	static class class_532 implements class_537 {
		...
		public void method_2784(float f, int i) {
			...
			class_332.method_1781(0, 0, 128.0F, 0.0F, 16, 16, 256.0F, 256.0F);
		}
	...
	static class class_533 implements class_537 {
		...
		public void method_2784(float f, int i) {
			...
			if (this.field_3264 < 0) {
				class_332.method_1781(0, 0, 144.0F, 0.0F, 16, 16, 256.0F, 256.0F);
			} else {
				class_332.method_1781(0, 0, 160.0F, 0.0F, 16, 16, 256.0F, 256.0F);
			}
		}
