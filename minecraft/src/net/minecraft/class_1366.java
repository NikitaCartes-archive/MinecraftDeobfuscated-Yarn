...
public class class_1366 extends class_1352 {
	...
	public boolean method_6264() {
		long l = this.field_6503.field_6002.method_8510();
		if (l - this.field_19200 < 20L) {
			...
			if (lv == null) {
				...
				if (this.field_6509 != null) {
					...
					return this.method_6289(lv) >= this.field_6503.method_5649(lv.field_5987, lv.method_5829().field_1322, lv.field_6035);
				}
			}
		}
	}
	...
	public boolean method_6266() {
		...
		} else if (!this.field_6503.method_18407(new class_2338(lv))) {
			return false;
		} else {
			return !(lv instanceof class_1657) || !lv.method_7325() && !((class_1657)lv).method_7337();
		}
	}
	...
	public void method_6270() {
		class_1309 lv = this.field_6503.method_5968();
		if (!class_1301.field_6156.test(lv)) {
	...
	protected double method_6289(class_1309 arg) {
		return (double)(this.field_6503.method_17681() * 2.0F * this.field_6503.method_17681() * 2.0F + arg.method_17681());
	}
}
