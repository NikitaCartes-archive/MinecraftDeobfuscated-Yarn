...
public class class_3103 extends class_3031<class_3111> {
	...
	public boolean method_13548(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, class_3111 arg4) {
		...
		if (r >= 1 && r <= 5) {
				...
				for(int t = 3; t >= -1; --t) {
					for(int u = p; u <= q; ++u) {
						...
						if (s != k && t != -1 && u != p && s != l && t != 4 && u != q) {
							if (arg.method_8320(lv).method_11614() != class_2246.field_10034) {
								arg.method_8652(lv, field_13698, 2);
							}
						} else if (lv.method_10264() >= 0 && !arg.method_8320(lv.method_10074()).method_11620().method_15799()) {
							arg.method_8652(lv, field_13698, 2);
						} else if (arg.method_8320(lv).method_11620().method_15799() && arg.method_8320(lv).method_11614() != class_2246.field_10034) {
							if (t == -1 && random.nextInt(4) != 0) {
								arg.method_8652(lv, class_2246.field_9989.method_9564(), 2);
							} else {
								arg.method_8652(lv, class_2246.field_10445.method_9564(), 2);
							}
						}
					}
				}
			...
			for(int s = 0; s < 2; ++s) {
				for(int t = 0; t < 3; ++t) {
					int u = arg3.method_10263() + random.nextInt(j * 2 + 1) - j;
					int v = arg3.method_10264();
					int w = arg3.method_10260() + random.nextInt(o * 2 + 1) - o;
					class_2338 lv3 = new class_2338(u, v, w);
