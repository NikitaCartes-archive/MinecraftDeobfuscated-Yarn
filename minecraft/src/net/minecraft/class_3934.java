...
public class class_3934 extends class_465<class_3910> {
	...
	protected void method_2389(float f, int i, int j) {
		...
		this.minecraft.method_1531().method_4618(field_17421);
		...
		if (lv2.method_7909() == class_1802.field_8204) {
			lv3 = class_1806.method_7997(lv2, this.minecraft.field_1687);
			if (lv3 != null) {
				if (lv3.field_17403) {
					bl4 = true;
					if (bl2 || bl3) {
						this.blit(k + 35, l + 31, this.field_2792 + 50, 132, 28, 21);
					}
				}
	...
	private void method_17567(@Nullable class_22 arg, boolean bl, boolean bl2, boolean bl3, boolean bl4) {
		...
		if (bl2 && !bl4) {
			this.blit(i + 67, j + 13, this.field_2792, 66, 66, 66);
			this.method_17566(arg, i + 85, j + 31, 0.226F);
		} else if (bl) {
			this.blit(i + 67 + 16, j + 13, this.field_2792, 132, 50, 66);
			this.method_17566(arg, i + 86, j + 16, 0.34F);
			this.minecraft.method_1531().method_4618(field_17421);
			GlStateManager.pushMatrix();
			GlStateManager.translatef(0.0F, 0.0F, 1.0F);
			this.blit(i + 67, j + 13 + 16, this.field_2792, 132, 50, 66);
			this.method_17566(arg, i + 70, j + 32, 0.34F);
			GlStateManager.popMatrix();
		} else if (bl3) {
			this.blit(i + 67, j + 13, this.field_2792, 0, 66, 66);
			this.method_17566(arg, i + 71, j + 17, 0.45F);
			this.minecraft.method_1531().method_4618(field_17421);
			GlStateManager.pushMatrix();
			GlStateManager.translatef(0.0F, 0.0F, 1.0F);
			this.blit(i + 66, j + 12, 0, this.field_2779, 66, 66);
			GlStateManager.popMatrix();
		} else {
			this.blit(i + 67, j + 13, this.field_2792, 0, 66, 66);
			this.method_17566(arg, i + 71, j + 17, 0.45F);
	...
	private void method_17566(@Nullable class_22 arg, int i, int j, float f) {
		if (arg != null) {
			...
			this.minecraft.field_1773.method_3194().method_1773(arg, true);
			GlStateManager.popMatrix();
		}
	}
}
