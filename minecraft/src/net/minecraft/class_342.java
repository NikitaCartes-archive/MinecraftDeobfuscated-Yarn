...
public class class_342 extends class_332 implements class_4068, class_364 {
	...
	public class_342(class_327 arg, int i, int j, int k, int l) {
		this(arg, i, j, k, l, null);
	}

	public class_342(class_327 arg, int i, int j, int k, int l, @Nullable class_342 arg2) {
		this.field_2105 = arg;
		this.field_2093 = i;
		this.field_2090 = j;
		this.field_2087 = k;
	...
	public void method_1874(String string) {
	...
	public void render(int i, int j, float f) {
		if (this.method_1885()) {
			if (this.method_1851()) {
				fill(this.field_2093 - 1, this.field_2090 - 1, this.field_2093 + this.field_2087 + 1, this.field_2090 + this.field_2109 + 1, -6250336);
				fill(this.field_2093, this.field_2090, this.field_2093 + this.field_2087, this.field_2090 + this.field_2109, -16777216);
			}
	...
	public void onFocusChanged(boolean bl, boolean bl2) {
		this.method_1876(bl2);
	}

	@Override
	public boolean isPartOfFocusCycle() {
		return this.field_2091 && this.field_2094;
	}

	@Override
	public boolean isMouseOver(double d, double e) {
		return this.field_2091
			&& d >= (double)this.field_2093
			&& d < (double)(this.field_2093 + this.field_2087)
			&& e >= (double)this.field_2090
			&& e < (double)(this.field_2090 + this.field_2109);
	}
	...
	public void method_1884(int i) {
		...
		if (this.field_2105 != null) {
			...
			if (this.field_2101 == this.field_2103) {
				this.field_2103 -= this.field_2105.method_1711(this.field_2092, k, true).length();
			}

			if (this.field_2101 > l) {
				this.field_2103 += this.field_2101 - l;
