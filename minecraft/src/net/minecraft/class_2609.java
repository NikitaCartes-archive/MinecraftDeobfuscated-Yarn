...
public abstract class class_2609 extends class_2624 implements class_1278, class_1732, class_1737, class_3000 {
	...
	private final Map<class_2960, Integer> field_11986 = Maps.newHashMap();

	protected class_2609(class_2591<?> arg) {
		super(arg);
	}

	public static Map<class_1792, Integer> method_11196() {
		Map<class_1792, Integer> map = Maps.newLinkedHashMap();
	...
	public class_2487 method_11007(class_2487 arg) {
		...
		for(Entry<class_2960, Integer> entry : this.field_11986.entrySet()) {
			...
			arg.method_10569("RecipeAmount" + i, entry.getValue());
			++i;
		}
	...
	public void method_16896() {
		...
		if (!this.field_11863.field_9236) {
			...
			if (this.method_11201() || !lv.method_7960() && !this.field_11984.get(0).method_7960()) {
				class_1860 lv2 = this.field_11863.method_8433().method_8132(this, this.field_11863);
		...
		if (!this.field_11984.get(0).method_7960() && arg != null) {
			...
			if (lv.method_7960()) {
				...
				if (lv2.method_7960()) {
					...
					return false;
				} else if (lv2.method_7947() < this.method_5444() && lv2.method_7947() < lv2.method_7914()) {
					return true;
				} else {
					return lv2.method_7947() < lv.method_7914();
				}
			}
		} else {
			return false;
	...
	private void method_11203(@Nullable class_1860 arg) {
		if (arg != null && this.method_11192(arg)) {
			...
			if (!this.field_11863.field_9236) {
				this.method_7665(this.field_11863, null, arg);
			}
	...
	protected int method_11200(class_1799 arg) {
		if (arg.method_7960()) {
			...
			return method_11196().getOrDefault(lv, 0);
		}
	}
	...
	public void method_7662(@Nullable class_1860 arg) {
		if (this.field_11986.containsKey(arg.method_8114())) {
			this.field_11986.put(arg.method_8114(), this.field_11986.get(arg.method_8114()) + 1);
		} else {
			this.field_11986.put(arg.method_8114(), 1);
		}
	}

	@Override
	public boolean method_7665(class_1937 arg, class_3222 arg2, @Nullable class_1860 arg3) {
		if (arg3 != null) {
	...
	public Map<class_2960, Integer> method_11198() {
	...
	public void method_7664(class_1657 arg) {
		if (!this.field_11863.method_8450().method_8355("doLimitedCrafting")) {
			...
			for(class_2960 lv : this.field_11986.keySet()) {
				class_1860 lv2 = arg.field_6002.method_8433().method_8130(lv);
				if (lv2 != null) {
					list.add(lv2);
				}
			}
