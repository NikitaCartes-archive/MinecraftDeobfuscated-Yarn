...
public class class_3723 extends class_2609 {
	public class_3723() {
		super(class_2591.field_16414);
	}

	@Override
	protected class_2561 method_5477() {
		return new class_2588("container.smoker");
	}

	@Override
	protected int method_17029() {
		class_3862 lv = (class_3862)this.field_11863.method_8433().method_8132(this, this.field_11863);
	...
	protected class_1703 method_5465(int i, class_1661 arg) {
		return new class_3706(i, arg, this, this.field_17374);
	}
}
