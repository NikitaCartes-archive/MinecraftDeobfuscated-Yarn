...
public class class_1792 implements class_1935 {
	...
	public static class_1792 method_7867(class_2248 arg) {
		class_1792 lv = (class_1792)field_8003.get(arg);
		return lv == null ? class_1802.field_8162 : lv;
	}
	...
	@Nullable
	protected class_239 method_7872(class_1937 arg, class_1657 arg2, boolean bl) {
		float f = arg2.field_5965;
		float g = arg2.field_6031;
		double d = arg2.field_5987;
		double e = arg2.field_6010 + (double)arg2.method_5751();
		double h = arg2.field_6035;
		class_243 lv = new class_243(d, e, h);
		float i = class_3532.method_15362(-g * (float) (Math.PI / 180.0) - (float) Math.PI);
		float j = class_3532.method_15374(-g * (float) (Math.PI / 180.0) - (float) Math.PI);
		float k = -class_3532.method_15362(-f * (float) (Math.PI / 180.0));
		float l = class_3532.method_15374(-f * (float) (Math.PI / 180.0));
		float m = j * k;
		float o = i * k;
		double p = 5.0;
		class_243 lv2 = lv.method_1031((double)m * 5.0, (double)l * 5.0, (double)o * 5.0);
		return arg.method_8531(lv, lv2, bl ? class_242.field_1345 : class_242.field_1348, false, false);
	}
