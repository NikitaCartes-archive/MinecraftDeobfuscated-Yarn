...
public class class_3843 implements DataProvider {
	private final DataGenerator field_17038;

	public class_3843(DataGenerator dataGenerator) {
		this.field_17038 = dataGenerator;
	}

	@Override
	public void run(DataCache dataCache) throws IOException {
		for (Path path : this.field_17038.getInputs()) {
