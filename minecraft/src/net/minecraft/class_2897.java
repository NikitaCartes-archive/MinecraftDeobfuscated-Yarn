...
public class class_2897 extends class_2794<class_3232> {
	...
	private final class_4274 field_19180 = new class_4274();
	...
	private class_1959 method_12589() {
			...
			if (lvs != null) {
				for(class_2975<?> lv3 : lvs) {
					...
					if (lv4.field_13376 instanceof class_3195) {
						class_3195<class_3037> lv5 = (class_3195)lv4.field_13376;
		...
		if (bl) {
			List<class_2893.class_2895> list = Lists.newArrayList();
		...
		class_2680[] lvs2 = this.field_16567.method_14312();

		for(int i = 0; i < lvs2.length; ++i) {
			class_2680 lv8 = lvs2[i];
			if (lv8 != null && !class_2902.class_2903.field_13197.method_16402().test(lv8)) {
				this.field_16567.method_20314(i);
				lv2.method_8719(
					class_2893.class_2895.field_13179, class_1959.method_8699(class_3031.field_19201, new class_4279(i, lv8), class_3284.field_14250, class_2998.field_13436)
				);
			}
		}
	...
	public void method_12088(class_1936 arg, class_2791 arg2) {
		...
		class_2902 lv2 = arg2.method_12032(class_2902.class_2903.field_13195);
		class_2902 lv3 = arg2.method_12032(class_2902.class_2903.field_13194);
	...
	public void method_12099(class_3218 arg, boolean bl, boolean bl2) {
		...
		this.field_19180.method_20261(arg, bl, bl2);
	}
