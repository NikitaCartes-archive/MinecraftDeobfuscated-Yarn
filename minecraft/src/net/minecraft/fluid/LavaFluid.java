...
public abstract class LavaFluid extends BaseFluid {
	...
	public boolean method_15777(FluidState fluidState, Fluid fluid, Direction direction) {
		return fluidState.method_15763() >= 0.44444445F && fluid.matches(FluidTags.field_15517);
	}
	...
	@Override
	public int method_15753(World world, FluidState fluidState, FluidState fluidState2) {
		int i = this.method_15789(world);
		if (!fluidState.isEmpty()
			&& !fluidState2.isEmpty()
			&& !fluidState.get(STILL)
			&& !fluidState2.get(STILL)
			&& fluidState2.method_15763() > fluidState.method_15763()
