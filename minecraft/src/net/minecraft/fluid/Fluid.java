...
public abstract class Fluid {
	public static final IdList<FluidState> field_15904 = new IdList<>();
	...
	protected Fluid() {
		...
		this.stateFactory = builder.method_11668(FluidStateImpl::new);
	...
	public boolean method_15791(Tag<Fluid> tag) {
