...
public class class_2479 extends class_2483<class_2481> {
	...
	public boolean equals(Object object) {
		if (this == object) {
			...
			return object instanceof class_2479 && Arrays.equals(this.field_11493, ((class_2479)object).field_11493);
		}
	}
	...
	public class_2481 method_17803(int i, class_2481 arg) {
		byte b = this.field_11493[i];
		this.field_11493[i] = arg.method_10698();
		return new class_2481(b);
	}

	public void method_17805(int i, class_2481 arg) {
		this.field_11493 = ArrayUtils.add(this.field_11493, i, arg.method_10698());
	}
