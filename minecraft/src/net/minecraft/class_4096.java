...
public class class_4096 extends class_4097<class_1309> {
	...
	protected boolean method_18919(class_3218 arg, class_1309 arg2) {
		if (this.field_18854 && arg2.method_6109()) {
			...
			return arg.method_8510() - this.field_18332 >= 20L;
		}
	}
	...
	protected void method_18920(class_3218 arg, class_1309 arg2, long l) {
		...
		Predicate<class_2338> predicate = arg3 -> {
			long lxx = arg3.method_10063();
			if (this.field_19289.containsKey(lxx)) {
				return false;
				...
				if (this.field_19287 == class_4158.field_18518) {
					...
					this.method_20496(arg, lvxx);
					lvxx.method_10098(class_2350.field_11036);
					lv2xx = lvxx;
				} else {
					lv2xx = arg3;
				}

				if (lv.method_5829().method_1014(2.0).method_1006(new class_243(lv2xx))) {
					return true;
				} else {
					class_11 lv3xx = lv.method_5942().method_6348(lv2xx);
					boolean bl = lv3xx != null && lv3xx.method_19313(lv2xx);
					if (!bl) {
						this.field_19289.put(lxx, this.field_18332 + 40L);
					}
