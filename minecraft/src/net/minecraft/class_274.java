...
public class class_274 {
	public static final Map<String, class_274> field_1455 = Maps.newHashMap();
	...
	@Nullable
	public static class_274 method_1224(String string) {
		if (field_1455.containsKey(string)) {
			return (class_274)field_1455.get(string);
		} else {
			int i = string.indexOf(58);
			if (i < 0) {
				return null;
			} else {
				class_3448<?> lv = class_2378.field_11152.method_10223(class_2960.method_12838(string.substring(0, i), '.'));
				return lv == null ? null : method_1223(lv, class_2960.method_12838(string.substring(i + 1), '.'));
			}
		}
	}

	@Nullable
	private static <T> class_274 method_1223(class_3448<T> arg, class_2960 arg2) {
		class_2378<T> lv = arg.method_14959();
		return lv.method_10250(arg2) ? arg.method_14956(lv.method_10223(arg2)) : null;
	}
