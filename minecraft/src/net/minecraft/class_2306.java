...
public class class_2306 {
	private static final Map<String, class_2306.class_2308> field_10891 = Maps.newHashMap();
	...
	public static void method_9960() {
		if (field_10891.isEmpty()) {
			...
			method_9961("distance", arg -> {
				...
				if ((lv.method_9038() == null || !(lv.method_9038() < 0.0F)) && (lv.method_9042() == null || !(lv.method_9042() < 0.0F))) {
					arg.method_9870(lv);
					arg.method_9852();
				} else {
					arg.method_9835().setCursor(i);
			...
			method_9961("level", arg -> {
				...
				if ((lv.method_9038() == null || lv.method_9038() >= 0) && (lv.method_9042() == null || lv.method_9042() >= 0)) {
					arg.method_9846(lv);
			...
			method_9961("gamemode", arg -> {
				arg.method_9875((suggestionsBuilder, consumer) -> {
					...
					for(class_1934 lvxx : class_1934.values()) {
						if (lvxx != class_1934.field_9218 && lvxx.method_8381().toLowerCase(Locale.ROOT).startsWith(stringxx)) {
							if (bl2) {
								suggestionsBuilder.suggest('!' + lvxx.method_8381());
							}
					...
					if (lv == class_1934.field_9218) {
						...
						arg.method_9916(arg2 -> {
							if (!(arg2 instanceof class_3222)) {
								...
								class_1934 lvxx = ((class_3222)arg2).field_13974.method_14257();
								return bl ? lvxx != lv : lvxx == lv;
							}
						});
						if (bl) {
			...
			method_9961("type", arg -> {
				...
				if (arg.method_9910() && !bl) {
					...
					if (arg.method_9915()) {
						...
						class_2960 lv = class_2960.method_12835(arg.method_9835());
						class_1299<?> lv3 = (class_1299)class_2378.field_11145.method_17966(lv).orElseThrow(() -> {
							arg.method_9835().setCursor(i);
							return field_10892.createWithContext(arg.method_9835(), lv.toString());
						});
			...
			method_9961("tag", arg -> {
				...
				arg.method_9916(argx -> {
					if ("".equals(string)) {
						return argx.method_5752().isEmpty() != bl;
					} else {
						return argx.method_5752().contains(string) != bl;
					}
				});
			...
			method_9961("nbt", arg -> {
				...
				arg.method_9916(arg2 -> {
					class_2487 lvxx = arg2.method_5647(new class_2487());
					if (arg2 instanceof class_3222) {
						class_1799 lv2 = ((class_3222)arg2).field_7514.method_7391();
						if (!lv2.method_7960()) {
							lvxx.method_10566("SelectedItem", lv2.method_7953(new class_2487()));
						}
					}

					return class_2512.method_10687(lv, lvxx, true) != bl;
				});
			...
			method_9961("scores", arg -> {
				...
				Map<String, class_2096.class_2100> map = Maps.newHashMap();
				stringReader.expect('{');
				...
				if (!map.isEmpty()) {
					arg.method_9916(argx -> {
						class_269 lvxx = argx.method_5682().method_3845();
						String stringxx = argx.method_5820();

						for(Entry<String, class_2096.class_2100> entry : map.entrySet()) {
							class_266 lv2 = lvxx.method_1170((String)entry.getKey());
							if (lv2 == null) {
								return false;
							}

							if (!lvxx.method_1183(stringxx, lv2)) {
								return false;
							}

							class_267 lv3 = lvxx.method_1180(stringxx, lv2);
			...
			method_9961("advancements", arg -> {
				StringReader stringReader = arg.method_9835();
				Map<class_2960, Predicate<class_167>> map = Maps.newHashMap();
				stringReader.expect('{');
				stringReader.skipWhitespace();
				...
				while(stringReader.canRead() && stringReader.peek() != '}') {
					...
					stringReader.skipWhitespace();
					if (stringReader.canRead() && stringReader.peek() == '{') {
						Map<String, Predicate<class_178>> map2 = Maps.newHashMap();
						stringReader.skipWhitespace();
						stringReader.expect('{');
						stringReader.skipWhitespace();
						...
						map.put(lv, (Predicate)argx -> {
							for(Entry<String, Predicate<class_178>> entry : map2.entrySet()) {
								class_178 lvxx = argx.method_737((String)entry.getKey());
								if (lvxx == null || !((Predicate)entry.getValue()).test(lvxx)) {
									return false;
								}
							}
				...
				if (!map.isEmpty()) {
					arg.method_9916(argx -> {
						if (!(argx instanceof class_3222)) {
							...
							class_3222 lvxx = (class_3222)argx;
							class_2985 lv2 = lvxx.method_14236();
							class_2989 lv3 = lvxx.method_5682().method_3851();
