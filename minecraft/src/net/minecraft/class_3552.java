...
public final class class_3552 extends class_3558<class_3547.class_3548, class_3547> {
	...
	protected int method_15488(long l, long m, int i) {
		if (m == Long.MAX_VALUE) {
			...
			int j = Integer.signum(class_2338.method_10061(m) - class_2338.method_10061(l));
			int k = Integer.signum(class_2338.method_10071(m) - class_2338.method_10071(l));
			int n = Integer.signum(class_2338.method_10083(m) - class_2338.method_10083(l));
			class_2350 lv = class_2350.method_16365(j, k, n);
			if (lv == null) {
				return 15;
			} else {
				AtomicInteger atomicInteger = new AtomicInteger();
				class_2680 lv2 = this.method_20479(m, atomicInteger);
				if (atomicInteger.get() >= 15) {
					return 15;
				} else {
					class_2680 lv3 = this.method_20479(l, null);
					class_265 lv4 = this.method_20710(lv3, l, lv);
					class_265 lv5 = this.method_20710(lv2, m, lv.method_10153());
					return class_259.method_20713(lv4, lv5) ? 15 : i + Math.max(1, atomicInteger.get());
				}
			}
		}
	}
