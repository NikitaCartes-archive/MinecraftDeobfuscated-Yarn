...
public class class_1670 extends class_1668 {
	public class_1670(class_1937 arg) {
		super(class_1299.field_6129, arg, 1.0F, 1.0F);
	}

	@Environment(EnvType.CLIENT)
	public class_1670(class_1937 arg, double d, double e, double f, double g, double h, double i) {
		super(class_1299.field_6129, d, e, f, g, h, i, arg, 1.0F, 1.0F);
	}

	public class_1670(class_1937 arg, class_1309 arg2, double d, double e, double f) {
		super(class_1299.field_6129, arg2, d, e, f, arg, 1.0F, 1.0F);
	}

	@Override
	protected void method_7469(class_239 arg) {
		if (arg.field_1326 == null || !arg.field_1326.method_5779(this.field_7604)) {
			if (!this.field_6002.field_9236) {
				List<class_1309> list = this.field_6002.method_8403(class_1309.class, this.method_5829().method_1009(4.0, 2.0, 4.0));
