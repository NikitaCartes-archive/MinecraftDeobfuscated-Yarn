...
public class class_3670 extends class_120 {
	...
	public static UnaryOperator<class_2561> method_16190(class_47 arg, @Nullable class_47.class_50 arg2) {
		if (arg2 != null) {
			...
			if (lv != null) {
				...
				return arg3 -> {
					try {
						return class_2564.method_10881(lv2, arg3, lv);
					} catch (CommandSyntaxException var4) {
						field_16230.warn("Failed to resolve text component", var4);
						return arg3;
					}
				};
			}
	...
	public static class_120.class_121<?> method_20241(class_2561 arg) {
		return method_520(args -> new class_3670(args, arg, null));
	}
