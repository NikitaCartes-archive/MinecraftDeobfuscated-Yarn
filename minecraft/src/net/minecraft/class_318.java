			...
			.execute(
				() -> {
					try {
						...
						class_2561 lvxx = new class_2585(file3.getName())
						...
						consumer.accept(new class_2588("screenshot.success", lvxx));
					} catch (Exception var7xx) {
						field_1974.warn("Couldn't save screenshot", var7xx);
						consumer.accept(new class_2588("screenshot.failure", var7xx.getMessage()));
					} finally {
						lv.close();
					}
				}
