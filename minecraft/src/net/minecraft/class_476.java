...
public class class_476<T extends class_1707<T>> extends class_465<T> implements class_3936<T> {
	...
	public class_476(T arg, class_1661 arg2, class_2561 arg3) {
		super(arg, arg2, arg3);
	...
	protected void method_2389(float f, int i, int j) {
		...
		this.field_2563.method_1531().method_4618(field_2861);
		int k = (this.field_2561 - this.field_2792) / 2;
		int l = (this.field_2559 - this.field_2779) / 2;
		this.method_1788(k, l, 0, 0, this.field_2792, this.field_2864 * 18 + 17);
		this.method_1788(k, l + this.field_2864 * 18 + 17, 0, 126, this.field_2792, 96);
	}
}
