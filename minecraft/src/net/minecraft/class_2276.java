...
public class class_2276 extends class_2383 {
	...
	private void method_9731(class_1937 arg, class_2338 arg2) {
		...
		if (lv != null) {
			for (int i = 0; i < this.method_9729().method_11713(); i++) {
				...
				arg.method_20290(2001, lv2.method_11683(), class_2248.method_9507(lv2.method_11681()));
			}

			class_1473 lv3 = class_1299.field_6047.method_5883(arg);
			...
			for (class_3222 lv5 : arg.method_18467(class_3222.class, lv3.method_5829().method_1014(5.0))) {
				class_174.field_1182.method_9124(lv5, lv3);
			}

			for (int j = 0; j < this.method_9729().method_11713(); j++) {
				class_2694 lv6 = lv.method_11717(0, j, 0);
			...
			if (lv != null) {
				for (int i = 0; i < this.method_9730().method_11710(); i++) {
					for (int k = 0; k < this.method_9730().method_11713(); k++) {
						class_2694 lv7 = lv.method_11717(i, k, 0);
						arg.method_8652(lv7.method_11683(), class_2246.field_10124.method_9564(), 2);
						arg.method_20290(2001, lv7.method_11683(), class_2248.method_9507(lv7.method_11681()));
					}
				}

				class_2338 lv8 = lv.method_11717(1, 2, 0).method_11683();
				class_1439 lv9 = class_1299.field_6147.method_5883(arg);
				lv9.method_6499(true);
				lv9.method_5808((double)lv8.method_10263() + 0.5, (double)lv8.method_10264() + 0.05, (double)lv8.method_10260() + 0.5, 0.0F, 0.0F);
				arg.method_8649(lv9);

				for (class_3222 lv5 : arg.method_18467(class_3222.class, lv9.method_5829().method_1014(5.0))) {
					class_174.field_1182.method_9124(lv5, lv9);
				}

				for (int j = 0; j < this.method_9730().method_11710(); j++) {
					for (int l = 0; l < this.method_9730().method_11713(); l++) {
						class_2694 lv10 = lv.method_11717(j, l, 0);
						arg.method_8408(lv10.method_11683(), class_2246.field_10124);
					}
				}
			}
		}
	...
	private class_2700 method_9732() {
	...
	private class_2700 method_9729() {
	...
	private class_2700 method_9727() {
	...
	private class_2700 method_9730() {
