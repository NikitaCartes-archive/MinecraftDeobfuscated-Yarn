...
public class class_3353 {
		...
		public void method_14918(class_3443 arg, List<class_3443> list, Random random) {
			...
			if (i < 8) {
				if (lv != class_2350.field_11043 && lv != class_2350.field_11035) {
					...
					for(int k = this.field_15315.field_14379 + 3; k + 3 <= this.field_15315.field_14376; k += 5) {
						int l = random.nextInt(5);
						if (l == 0) {
							class_3353.method_14711(arg, list, random, this.field_15315.field_14381 - 1, this.field_15315.field_14380, k, class_2350.field_11039, i + 1);
						} else if (l == 1) {
							class_3353.method_14711(arg, list, random, this.field_15315.field_14378 + 1, this.field_15315.field_14380, k, class_2350.field_11034, i + 1);
						}
					}
				}
			}
		...
		public boolean method_14931(class_1936 arg, Random random, class_3341 arg2, class_1923 arg3) {
			if (this.method_14937(arg, arg2)) {
				...
				for(int n = 0; n <= 2; ++n) {
					for(int o = 0; o <= m; ++o) {
						int p = -1;
						class_2680 lv4 = this.method_14929(arg, n, -1, o, arg2);
						if (lv4.method_11588() && this.method_14939(arg, n, -1, o, arg2)) {
							int r = -1;
							this.method_14917(arg, lv, n, -1, o, arg2);
						}
					}
				}
				...
				if (this.field_14416) {
					...
					for(int o = 0; o <= m; ++o) {
						class_2680 lv6 = this.method_14929(arg, 1, -1, o, arg2);
						if (!lv6.method_11588() && lv6.method_11598(arg, new class_2338(this.method_14928(1, o), this.method_14924(-1), this.method_14941(1, o)))) {
							float f = this.method_14939(arg, 1, 0, o, arg2) ? 0.7F : 0.9F;
							this.method_14945(arg, arg2, random, f, 1, 0, o, lv5);
						}
					}
				}
	...
	public static class class_3355 extends class_3353.class_3356 {
		...
		public boolean method_14931(class_1936 arg, Random random, class_3341 arg2, class_1923 arg3) {
			if (this.method_14937(arg, arg2)) {
				...
				this.method_14716(
					arg, arg2, this.field_15315.field_14381 + 1, this.field_15315.field_14380, this.field_15315.field_14379 + 1, this.field_15315.field_14377
				);
				this.method_14716(
					arg, arg2, this.field_15315.field_14381 + 1, this.field_15315.field_14380, this.field_15315.field_14376 - 1, this.field_15315.field_14377
				);
				this.method_14716(
					arg, arg2, this.field_15315.field_14378 - 1, this.field_15315.field_14380, this.field_15315.field_14379 + 1, this.field_15315.field_14377
				);
				this.method_14716(
					arg, arg2, this.field_15315.field_14378 - 1, this.field_15315.field_14380, this.field_15315.field_14376 - 1, this.field_15315.field_14377
				);
	...
	public static class class_3357 extends class_3353.class_3356 {
		...
		public void method_14918(class_3443 arg, List<class_3443> list, Random random) {
			...
			int k;
			for(k = 0; k < this.field_15315.method_14660(); k += 4) {
			...
			for(k = 0; k < this.field_15315.method_14664(); k += 4) {
		...
		protected void method_14943(class_2487 arg) {
			...
			for(class_3341 lv2 : this.field_14422) {
				lv.method_10606(lv2.method_14658());
			}
