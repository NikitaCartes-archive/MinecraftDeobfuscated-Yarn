...
public class class_2457 extends class_2248 {
	...
	private class_2773 method_10477(class_1922 arg, class_2338 arg2, class_2350 arg3) {
		...
		if (!lv4.method_11621(arg, lv3)) {
			boolean bl = class_2248.method_20045(lv2, arg, lv, class_2350.field_11036) || lv2.method_11614() == class_2246.field_10312;
			if (bl && method_10484(arg.method_8320(lv.method_10084()))) {
				if (method_9614(lv2.method_11628(arg, lv))) {
		...
		return !method_10482(lv2, arg3) && (lv2.method_11621(arg, lv) || !method_10484(arg.method_8320(lv.method_10074())))
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		return class_2248.method_20045(lv2, arg2, lv, class_2350.field_11036) || lv2.method_11614() == class_2246.field_10312;
	}
	...
	private class_2680 method_10481(class_1937 arg, class_2338 arg2, class_2680 arg3) {
		class_2680 lv = arg3;
		int i = arg3.method_11654(field_11432);
	...
	private int method_10486(int i, class_2680 arg) {
		if (arg.method_11614() != this) {
			...
			int j = arg.method_11654(field_11432);
			return j > i ? j : i;
		}
	}
	...
	public int method_9524(class_2680 arg, class_1922 arg2, class_2338 arg3, class_2350 arg4) {
		if (!this.field_11438) {
			...
			int i = arg.method_11654(field_11432);
			if (i == 0) {
				return 0;
	...
	private boolean method_10478(class_1922 arg, class_2338 arg2, class_2350 arg3) {
		...
		if (!bl2 && bl && method_10483(arg, lv.method_10084())) {
			...
			return true;
		} else if (lv2.method_11614() == class_2246.field_10450 && lv2.method_11654(class_2312.field_10911) && lv2.method_11654(class_2312.field_11177) == arg3) {
			return true;
		} else {
			return !bl && method_10483(arg, lv.method_10074());
		}
	}
	...
	protected static boolean method_10482(class_2680 arg, @Nullable class_2350 arg2) {
		...
		} else if (class_2246.field_10282 == arg.method_11614()) {
			return arg2 == arg.method_11654(class_2426.field_10927);
		} else {
