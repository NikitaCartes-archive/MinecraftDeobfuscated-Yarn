...
public class class_3218 extends class_1937 {
	...
	private final Int2ObjectMap<class_1297> field_17915 = new Int2ObjectLinkedOpenHashMap<>();
	private final Map<UUID, class_1297> field_13960 = Maps.newHashMap();
	...
	public void method_18765(BooleanSupplier booleanSupplier) {
		...
		if (this.field_9247.method_12451()) {
			if (this.method_8450().method_8355(class_1928.field_19406)) {
		...
		if (this.field_13955 && this.field_18261.stream().noneMatch(arg -> !arg.method_7325() && !arg.method_7276())) {
			...
			if (this.method_8450().method_8355(class_1928.field_19396)) {
		...
		this.field_13956.method_20464(this.method_8510());
		...
		if (bl4 || this.field_13948++ < 300) {
			...
			while(objectIterator.hasNext()) {
				Entry<class_1297> entry = (Entry)objectIterator.next();
	...
	public void method_18203(class_2818 arg, int i) {
		...
		if (bl && this.method_8546() && this.field_9229.nextInt(100000) == 0) {
			...
			if (this.method_8520(lv3)) {
				...
				boolean bl2 = this.method_8450().method_8355(class_1928.field_19390) && this.field_9229.nextDouble() < (double)lv4.method_5457() * 0.01;
				if (bl2) {
	...
	protected void method_14187() {
		...
		for(int i = 0; i < 10; ++i) {
			...
			if (lv.method_12817(this, this.field_9248.method_12129(), this.field_9229, lv2, class_3037.field_13603)) {
				break;
			}
		}
	}
	...
	public Object2IntMap<class_1311> method_18219() {
		...
		for(class_1297 lv : this.field_17915.values()) {
			if (!(lv instanceof class_1308) || !((class_1308)lv).method_5947()) {
				...
				if (lv2 != class_1311.field_17715 && this.method_14178().method_20727(lv)) {
					object2IntMap.mergeInt(lv2, 1, Integer::sum);
				}
			}
		}
	...
	public boolean method_18214(class_1297 arg) {
	...
	public class_22 method_17891(String string) {
		return this.method_8503().method_3847(class_2874.field_13072).method_17983().method_20786(() -> new class_22(string), string);
	}
	...
	public LongSet method_17984() {
		class_1932 lv = this.method_17983().method_20786(class_1932::new, "chunks");
	...
	public boolean method_20588(class_4076 arg) {
		return this.method_19500(arg.method_19768());
	}
	...
	public boolean method_19497(class_2338 arg, int i) {
		if (i > 6) {
			...
			return this.method_19498(class_4076.method_18682(arg)) <= i;
		}
	}
	...
	public class_3765 method_19502(class_2338 arg) {
		return this.field_18811.method_19209(arg, 9216);
	}
