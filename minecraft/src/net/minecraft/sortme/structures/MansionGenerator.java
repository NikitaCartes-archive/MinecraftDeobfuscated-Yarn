...
public class MansionGenerator {
	public static void method_15029(
		StructureManager structureManager, BlockPos blockPos, Rotation rotation, List<MansionGenerator.class_3480> list, Random random
	) {
	...
	static class class_3474 {
		...
		private void method_15048() {
			...
			if (list.isEmpty()) {
				...
				Direction direction = this.method_15040(this.field_15440, lv2.method_15442(), lv2.method_15441(), 1, j & 65535);
	...
	static class class_3475 {
		...
		public void method_15050(BlockPos blockPos, Rotation rotation, List<MansionGenerator.class_3480> list, MansionGenerator.class_3474 arg) {
			...
			for(int l = 0; l < 3; ++l) {
				...
				MansionGenerator.class_3478 lv6 = arg.field_15443[l];
				MansionGenerator.class_3478 lv7 = l == 2 ? lv4 : lv3;
				...
				for(int o = 0; o < lv7.field_15453; ++o) {
					for(int p = 0; p < lv7.field_15454; ++p) {
						...
						if (lv7.method_15066(p, o) == 2 || bl2) {
							...
							if (MansionGenerator.class_3474.method_15047(lv7, p - 1, o) && !arg.method_15039(lv7, p - 1, o, l, s)) {
							...
							if (MansionGenerator.class_3474.method_15047(lv7, p, o + 1) && !arg.method_15039(lv7, p, o + 1, l, s)) {
		...
		private void method_15055(
			...
			if (arg2 != null) {
				for(int i = 0; i < arg.field_15453; ++i) {
					for(int j = 0; j < arg.field_15454; ++j) {
						...
						var17 = var17.offset(rotation.method_10503(Direction.EAST), (j - this.field_15446) * 8);
						boolean bl = MansionGenerator.class_3474.method_15047(arg2, j, i);
						if (MansionGenerator.class_3474.method_15047(arg, j, i) && bl) {
							if (!MansionGenerator.class_3474.method_15047(arg, j + 1, i)) {
			...
			for(int i = 0; i < arg.field_15453; ++i) {
				for(int j = 0; j < arg.field_15454; ++j) {
					...
					var19 = var19.offset(rotation.method_10503(Direction.EAST), (j - this.field_15446) * 8);
					boolean bl = arg2 != null && MansionGenerator.class_3474.method_15047(arg2, j, i);
					if (MansionGenerator.class_3474.method_15047(arg, j, i) && !bl) {
						if (!MansionGenerator.class_3474.method_15047(arg, j + 1, i)) {
							...
							} else if (MansionGenerator.class_3474.method_15047(arg, j + 1, i + 1)) {
						...
						if (!MansionGenerator.class_3474.method_15047(arg, j - 1, i)) {
							BlockPos blockPos3 = var19.offset(rotation.method_10503(Direction.EAST), 0);
							blockPos3 = blockPos3.offset(rotation.method_10503(Direction.SOUTH), 0);
							if (!MansionGenerator.class_3474.method_15047(arg, j, i + 1)) {
								BlockPos blockPos4 = blockPos3.offset(rotation.method_10503(Direction.SOUTH), 6);
								list.add(new MansionGenerator.class_3480(this.field_15444, "roof_corner", blockPos4, rotation.method_10501(Rotation.ROT_90)));
							} else if (MansionGenerator.class_3474.method_15047(arg, j - 1, i + 1)) {
								BlockPos blockPos4 = blockPos3.offset(rotation.method_10503(Direction.SOUTH), 8);
							...
							if (!MansionGenerator.class_3474.method_15047(arg, j, i - 1)) {
								list.add(new MansionGenerator.class_3480(this.field_15444, "roof_corner", blockPos3, rotation.method_10501(Rotation.ROT_180)));
							} else if (MansionGenerator.class_3474.method_15047(arg, j - 1, i - 1)) {
								BlockPos blockPos4 = blockPos3.offset(rotation.method_10503(Direction.SOUTH), 1);
		...
		private void method_15052(List<MansionGenerator.class_3480> list, MansionGenerator.class_3476 arg) {
			list.add(
				new MansionGenerator.class_3480(
					this.field_15444, arg.field_15448, arg.field_15449.offset(arg.field_15450.method_10503(Direction.EAST), 7), arg.field_15450
				)
			);
