...
public class NetherFortressGenerator {
				...
				switch(direction) {
					...
					case WEST:
						return this.method_14813(
							...
							list,
							random,
							this.structureBounds.minX + j,
							this.structureBounds.minY + i,
	...
	static class class_3404 {
		public Class<? extends NetherFortressGenerator.class_3403> field_14501;
		public final int field_14503;
		public int field_14502;
		public int field_14499;
		public boolean field_14500;
	...
	public static class class_3407 extends NetherFortressGenerator.class_3391 {
		...
		public List<class_3443> field_14505 = Lists.<class_3443>newArrayList();
