				...
				for (class_3545<Rotation, BlockPos> lv3 : EndCityGenerator.field_14385) {
					if (random.nextBoolean()) {
						EndCityGenerator.class_3343 lv4 = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv2, lv3.method_15441(), "bridge_end", rotation.method_10501(lv3.method_15442()), true)
						);
				...
				for (class_3545<Rotation, BlockPos> lv2 : EndCityGenerator.field_14388) {
					if (random.nextBoolean()) {
						EndCityGenerator.class_3343 lv3 = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv, lv2.method_15441(), "bridge_end", rotation.method_10501(lv2.method_15442()), true)
						);
