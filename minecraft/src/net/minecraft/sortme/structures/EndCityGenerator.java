...
public class EndCityGenerator {
	...
	private static final EndCityGenerator.class_3344 field_14390 = new EndCityGenerator.class_3344() {
		...
		public boolean method_14687(
			...
			if (i > 8) {
				...
				if (j == 0) {
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 4, -1), "base_roof", rotation, true));
				} else if (j == 1) {
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 8, -1), "second_roof", rotation, false));
					EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14386, i + 1, lv, null, list, random);
				} else if (j == 2) {
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 4, -1), "third_floor_2", rotation, false));
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 8, -1), "third_roof", rotation, true));
					EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14386, i + 1, lv, null, list, random);
				}
	...
	private static final EndCityGenerator.class_3344 field_14386 = new EndCityGenerator.class_3344() {
		...
		public boolean method_14687(
			...
			lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, 7, 0), "tower_piece", rotation, true));
			EndCityGenerator.class_3343 lv2 = random.nextInt(3) == 0 ? lv : null;
			int j = 1 + random.nextInt(3);

			for(int k = 0; k < j; ++k) {
				lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, 4, 0), "tower_piece", rotation, true));
				...
				for(class_3545<Rotation, BlockPos> lv3 : EndCityGenerator.field_14385) {
					if (random.nextBoolean()) {
						EndCityGenerator.class_3343 lv4 = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv2, lv3.method_15441(), "bridge_end", rotation.method_10501((Rotation)lv3.method_15442()), true)
						);
						EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14387, i + 1, lv4, null, list, random);
					}
				}

				lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-1, 4, -1), "tower_top", rotation, true));
			} else {
				if (i != 7) {
					return EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14384, i + 1, lv, null, list, random);
				}
	...
	private static final EndCityGenerator.class_3344 field_14387 = new EndCityGenerator.class_3344() {
		...
		public boolean method_14687(
			...
			for(int l = 0; l < j; ++l) {
				if (random.nextBoolean()) {
					lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, k, -4), "bridge_piece", rotation, true));
					k = 0;
				} else {
					if (random.nextBoolean()) {
						lv = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, k, -4), "bridge_steep_stairs", rotation, true)
						);
					} else {
						lv = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, k, -8), "bridge_gentle_stairs", rotation, true)
						);
					}
			...
			if (!this.field_14394 && random.nextInt(10 - i) == 0) {
				EndCityGenerator.method_14681(
					list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-8 + random.nextInt(8), k, -70 + random.nextInt(10)), "ship", rotation, true)
				);
				this.field_14394 = true;
			} else if (!EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14390, i + 1, lv, new BlockPos(-3, k + 1, -11), list, random)) {
				return false;
			}

			lv = EndCityGenerator.method_14681(
				list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(4, k, 0), "bridge_end", rotation.method_10501(Rotation.ROT_180), true)
			);
			lv.field_15316 = -1;
			return true;
		}
	...
	private static final EndCityGenerator.class_3344 field_14384 = new EndCityGenerator.class_3344() {
		...
		public boolean method_14687(
			...
			lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, 4, 0), "fat_tower_middle", rotation, true));

			for(int j = 0; j < 2 && random.nextInt(3) != 0; ++j) {
				lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(0, 8, 0), "fat_tower_middle", rotation, true));
				...
				for(class_3545<Rotation, BlockPos> lv2 : EndCityGenerator.field_14388) {
					if (random.nextBoolean()) {
						EndCityGenerator.class_3343 lv3 = EndCityGenerator.method_14681(
							list, EndCityGenerator.method_14684(structureManager, lv, lv2.method_15441(), "bridge_end", rotation.method_10501((Rotation)lv2.method_15442()), true)
						);
						EndCityGenerator.method_14673(structureManager, EndCityGenerator.field_14387, i + 1, lv3, null, list, random);
					}
				}
			}

			lv = EndCityGenerator.method_14681(list, EndCityGenerator.method_14684(structureManager, lv, new BlockPos(-2, 8, -2), "fat_tower_top", rotation, true));
			return true;
		}
	};

	private static EndCityGenerator.class_3343 method_14684(
		StructureManager structureManager, EndCityGenerator.class_3343 arg, BlockPos blockPos, String string, Rotation rotation, boolean bl
	) {
		EndCityGenerator.class_3343 lv = new EndCityGenerator.class_3343(structureManager, string, arg.field_15432, rotation, bl);
		BlockPos blockPos2 = arg.field_15433.method_15180(arg.field_15434, blockPos, lv.field_15434, BlockPos.ORIGIN);
		lv.translate(blockPos2.getX(), blockPos2.getY(), blockPos2.getZ());
		return lv;
	}

	public static void method_14679(StructureManager structureManager, BlockPos blockPos, Rotation rotation, List<class_3443> list, Random random) {
		field_14384.method_14688();
		field_14390.method_14688();
		field_14387.method_14688();
		field_14386.method_14688();
		EndCityGenerator.class_3343 lv = method_14681(list, new EndCityGenerator.class_3343(structureManager, "base_floor", blockPos, rotation, true));
		lv = method_14681(list, method_14684(structureManager, lv, new BlockPos(-1, 0, -1), "second_floor_1", rotation, false));
		lv = method_14681(list, method_14684(structureManager, lv, new BlockPos(-1, 4, -1), "third_floor_1", rotation, false));
		lv = method_14681(list, method_14684(structureManager, lv, new BlockPos(-1, 8, -1), "third_roof", rotation, true));
		method_14673(structureManager, field_14386, 1, lv, null, list, random);
	}
	...
	private static boolean method_14673(
		...
		int i,
		EndCityGenerator.class_3343 arg2,
		BlockPos blockPos,
		...
		if (i > 8) {
			...
			if (arg.method_14687(structureManager, i, arg2, blockPos, list2, random)) {
				boolean bl = false;
				...
				for(class_3443 lv : list2) {
					...
					if (lv2 != null && lv2.field_15316 != arg2.field_15316) {
						bl = true;
						break;
					}
				}
	...
	public static class class_3343 extends class_3470 {
		...
		public class_3343(StructureManager structureManager, String string, BlockPos blockPos, Rotation rotation, boolean bl) {
		...
		public class_3343(StructureManager structureManager, CompoundTag compoundTag) {
	...
	interface class_3344 {
		...
		boolean method_14687(StructureManager structureManager, int i, EndCityGenerator.class_3343 arg, BlockPos blockPos, List<class_3443> list, Random random);
	}
}
