...
public class class_2188 implements ArgumentType<class_2960> {
	...
	private static final class_2960 method_9326(class_2960 arg) throws CommandSyntaxException {
		class_1299<?> lv = class_2378.field_11145.method_10223(arg);
		if (lv != null && lv.method_5896()) {
			return arg;
		} else {
			throw field_9866.create(arg);
		}
	}
