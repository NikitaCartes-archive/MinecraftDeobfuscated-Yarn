...
public class class_3499 {
	private final List<List<class_3499.class_3501>> field_15586 = Lists.newArrayList();
	...
	public void method_15174(class_1937 arg, class_2338 arg2, class_2338 arg3, boolean bl, @Nullable class_2248 arg4) {
		if (arg3.method_10263() >= 1 && arg3.method_10264() >= 1 && arg3.method_10260() >= 1) {
			...
			for(class_2338.class_2339 lv4 : class_2338.method_10082(lv2, lv3)) {
				...
				if (arg4 == null || arg4 != lv6.method_11614()) {
					...
					} else if (!lv6.method_11598(arg, lv4) && !lv6.method_11604(arg, lv4)) {
	...
	public boolean method_15172(class_1936 arg, class_2338 arg2, class_3492 arg3, int i) {
		if (this.field_15586.isEmpty()) {
			...
			if ((!list.isEmpty() || !arg3.method_15135() && !this.field_15589.isEmpty())
				...
				for(class_3499.class_3501 lv2 : method_16446(arg, arg2, arg3, list)) {
					...
					if (lv == null || lv.method_14662(lv3)) {
						...
						if (lv2.field_15595 != null) {
							...
							arg.method_8652(lv3, class_2246.field_10499.method_9564(), 4);
						}
				...
				boolean bl = true;
				class_2350[] lvs = new class_2350[]{
					class_2350.field_11036, class_2350.field_11043, class_2350.field_11034, class_2350.field_11035, class_2350.field_11039
				};
				...
				while(bl && !list2.isEmpty()) {
					...
					while(iterator.hasNext()) {
						...
						class_3610 lv8 = arg.method_8316(lv7);

						for(int p = 0; p < lvs.length && !lv8.method_15771(); ++p) {
							class_3610 lv9 = arg.method_8316(lv7.method_10093(lvs[p]));
							if (lv9.method_15763() > lv8.method_15763() || lv9.method_15771() && !lv8.method_15771()) {
								lv8 = lv9;
							}
						}

						if (lv8.method_15771()) {
							class_2680 lv10 = arg.method_8320(lv7);
							if (lv10.method_11614() instanceof class_2402) {
								((class_2402)lv10.method_11614()).method_10311(arg, lv7, lv10, lv8);
								bl = true;
								iterator.remove();
							}
						}
				...
				if (j <= m) {
					if (!arg3.method_16444()) {
						class_251 lv11 = new class_244(m - j + 1, n - k + 1, o - l + 1);
						int q = j;
						int r = k;
						int p = l;

						for(Pair<class_2338, class_2487> pair : list3) {
							class_2338 lv12 = pair.getFirst();
							lv11.method_1049(lv12.method_10263() - q, lv12.method_10264() - r, lv12.method_10260() - p, true, true);
						}

						lv11.method_1046((arg2x, mx, nx, ox) -> {
							class_2338 lvxx = new class_2338(q + mx, r + nx, p + ox);
							class_2338 lv2 = lvxx.method_10093(arg2x);
							class_2680 lv3 = arg.method_8320(lvxx);
							class_2680 lv4 = arg.method_8320(lv2);
							class_2680 lv5 = lv3.method_11578(arg2x, lv4, arg, lvxx, lv2);
							if (lv3 != lv5) {
								arg.method_8652(lvxx, lv5, i & -2 | 16);
							}

							class_2680 lv6xx = lv4.method_11578(arg2x.method_10153(), lv5, arg, lv2, lvxx);
							if (lv4 != lv6xx) {
								arg.method_8652(lv2, lv6xx, i & -2 | 16);
							}
						});
					}

					for(Pair<class_2338, class_2487> pair2 : list3) {
						class_2338 lv13 = pair2.getFirst();
						if (!arg3.method_16444()) {
							class_2680 lv10 = arg.method_8320(lv13);
							class_2680 lv14 = class_2248.method_9510(lv10, arg, lv13);
							if (lv10 != lv14) {
								arg.method_8652(lv13, lv14, i & -2 | 16);
							}

							arg.method_8408(lv13, lv14.method_11614());
						}

						if (pair2.getSecond() != null) {
							class_2586 lv6 = arg.method_8321(lv13);
							if (lv6 != null) {
								lv6.method_5431();
							}
						}
	...
	private void method_15179(class_1936 arg, class_2338 arg2, class_2415 arg3, class_2470 arg4, class_2338 arg5, @Nullable class_3341 arg6) {
		for(class_3499.class_3502 lv : this.field_15589) {
			...
			if (arg6 == null || arg6.method_14662(lv2)) {
				...
				lv6.method_10606(new class_2489(lv5.field_1352));
				lv6.method_10606(new class_2489(lv5.field_1351));
				lv6.method_10606(new class_2489(lv5.field_1350));
				lv3.method_10566("Pos", lv6);
				lv3.method_10560("UUID", UUID.randomUUID());

				class_1297 lv7;
				try {
					lv7 = class_1299.method_5892(lv3, arg.method_8410());
				} catch (Exception var16) {
					lv7 = null;
				}

				if (lv7 != null) {
					float f = lv7.method_5763(arg3);
					f += lv7.field_6031 - lv7.method_5832(arg4);
					lv7.method_5808(lv5.field_1352, lv5.field_1351, lv5.field_1350, f, lv7.field_5965);
					arg.method_8649(lv7);
				}
			}
		}
	...
	public class_2487 method_15175(class_2487 arg) {
		if (this.field_15586.isEmpty()) {
			...
			List<class_3499.class_3501> list2 = (List)this.field_15586.get(0);
			...
			if (list.size() == 1) {
				...
				for(class_2680 lv7 : lv) {
					lv6.method_10606(class_2512.method_10686(lv7));
				}
				...
				for(class_3499.class_3500 lv8 : list) {
					...
					for(class_2680 lv10 : lv8) {
						lv9.method_10606(class_2512.method_10686(lv10));
					}

					lv6.method_10606(lv9);
				}
	...
	private class_2499 method_15169(int... is) {
		...
		for(int i : is) {
			lv.method_10606(new class_2497(i));
		}
