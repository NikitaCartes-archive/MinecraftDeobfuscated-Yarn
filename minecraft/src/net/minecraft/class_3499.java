				...
				if (j <= m) {
					if (!arg3.method_16444()) {
						...
						for (Pair<class_2338, class_2487> pair : list3) {
							...
							lv11.method_1049(lv12.method_10263() - q, lv12.method_10264() - r, lv12.method_10260() - px, true, true);
						}

						lv11.method_1046((arg2x, mx, nx, ox) -> {
							class_2338 lvx = new class_2338(q + mx, r + nx, p + ox);
							class_2338 lv2x = lvx.method_10093(arg2x);
							class_2680 lv3 = arg.method_8320(lvx);
							class_2680 lv4x = arg.method_8320(lv2x);
							class_2680 lv5x = lv3.method_11578(arg2x, lv4x, arg, lvx, lv2x);
							if (lv3 != lv5x) {
								arg.method_8652(lvx, lv5x, i & -2 | 16);
							}

							class_2680 lv6x = lv4x.method_11578(arg2x.method_10153(), lv5x, arg, lv2x, lvx);
							if (lv4x != lv6x) {
								arg.method_8652(lv2x, lv6x, i & -2 | 16);
							}
						});
					}
