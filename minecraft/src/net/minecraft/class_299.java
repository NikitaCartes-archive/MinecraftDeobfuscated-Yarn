...
public class class_299 extends class_3439 {
	...
	private final Map<class_314, List<class_516>> field_1638 = Maps.newHashMap();
	...
	private class_516 method_1394(class_314 arg) {
		...
		if (arg == class_314.field_1811 || arg == class_314.field_1808 || arg == class_314.field_1812) {
			this.method_18092(class_314.field_1804, lv);
		} else if (arg == class_314.field_17111 || arg == class_314.field_17112) {
			this.method_18092(class_314.field_17110, lv);
		} else if (arg == class_314.field_17114) {
			this.method_18092(class_314.field_17113, lv);
		} else if (arg == class_314.field_17764) {
			this.method_18092(class_314.field_17764, lv);
		} else if (arg == class_314.field_17765) {
			this.method_18092(class_314.field_17765, lv);
		} else {
			this.method_18092(class_314.field_1809, lv);
		}

		return lv;
	}

	private void method_18092(class_314 arg, class_516 arg2) {
		((List)this.field_1638.computeIfAbsent(arg, argx -> Lists.newArrayList())).add(arg2);
	}

	private static class_314 method_1400(class_1860<?> arg) {
		class_3956<?> lv = arg.method_17716();
		if (lv == class_3956.field_17546) {
			if (arg.method_8110().method_7909().method_19263()) {
		...
		} else if (lv == class_3956.field_17547) {
			return arg.method_8110().method_7909() instanceof class_1747 ? class_314.field_17111 : class_314.field_17112;
		} else if (lv == class_3956.field_17548) {
			return class_314.field_17114;
		} else if (lv == class_3956.field_17641) {
			return class_314.field_17764;
		} else if (lv == class_3956.field_17549) {
			return class_314.field_17765;
		} else {
			class_1799 lv2 = arg.method_8110();
			class_1761 lv3 = lv2.method_7909().method_7859();
			if (lv3 == class_1761.field_7931) {
				return class_314.field_1806;
			} else if (lv3 == class_1761.field_7930 || lv3 == class_1761.field_7916) {
				return class_314.field_1813;
			} else {
				return lv3 == class_1761.field_7914 ? class_314.field_1803 : class_314.field_1810;
			}
		}
	}
	...
	public static List<class_314> method_1395(class_1729<?> arg) {
		if (arg instanceof class_1714 || arg instanceof class_1723) {
			return Lists.newArrayList(class_314.field_1809, class_314.field_1813, class_314.field_1806, class_314.field_1810, class_314.field_1803);
		} else if (arg instanceof class_3858) {
			return Lists.newArrayList(class_314.field_1804, class_314.field_1808, class_314.field_1811, class_314.field_1812);
		} else if (arg instanceof class_3705) {
			return Lists.newArrayList(class_314.field_17110, class_314.field_17111, class_314.field_17112);
		} else {
			return arg instanceof class_3706 ? Lists.newArrayList(class_314.field_17113, class_314.field_17114) : Lists.newArrayList();
		}
	}
