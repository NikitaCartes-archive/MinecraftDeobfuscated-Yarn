...
public class class_1584 extends class_3763 {
	...
	public class_1584(class_1299<? extends class_1584> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	protected void method_5959() {
		...
		this.field_6185.method_6277(2, new class_1399(this, class_3763.class).method_6318());
	...
	protected void method_20417() {
		boolean bl = !(this.method_5642() instanceof class_1308) || this.method_5642().method_5864().method_20210(class_3483.field_19168);
		...
		this.field_6201.method_6276(class_1352.class_4134.field_18408, bl);
	}
	...
	public boolean method_5956() {
		return !this.method_5987() && this.method_5642() instanceof class_1309;
	}
	...
	public void method_6007() {
		...
		if (this.method_5805()) {
			...
			if (this.field_5976 && this.field_6002.method_8450().method_8355(class_1928.field_19388)) {
				boolean bl = false;
				class_238 lv = this.method_5829().method_1014(0.2);

				for (class_2338 lv2 : class_2338.method_10094(
	...
	private void method_7073() {
		if (this.field_5974.nextInt(6) == 0) {
			double d = this.field_5987
				- (double)this.method_17681() * Math.sin((double)(this.field_6283 * (float) (Math.PI / 180.0)))
				+ (this.field_5974.nextDouble() * 0.6 - 0.3);
			double e = this.field_6010 + (double)this.method_17682() - 0.3;
			double f = this.field_6035
				+ (double)this.method_17681() * Math.cos((double)(this.field_6283 * (float) (Math.PI / 180.0)))
				+ (this.field_5974.nextDouble() * 0.6 - 0.3);
	...
	public boolean method_5957(class_1941 arg) {
		return !arg.method_8599(this.method_5829());
	}
	...
	class class_1585 extends class_1366 {
		...
		protected double method_6289(class_1309 arg) {
			float f = class_1584.this.method_17681() - 0.1F;
