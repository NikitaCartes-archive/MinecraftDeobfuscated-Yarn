...
public class class_3090 extends class_3096<class_3111> {
	...
	public boolean method_12775(Set<class_2338> set, class_3747 arg, Random random, class_2338 arg2, class_3341 arg3) {
		...
		if (!this.method_13523(arg, arg2, i)) {
			...
			this.method_13495(arg, arg2.method_10263(), arg2.method_10260(), arg2.method_10264() + i, 0, random, arg3, set);

			for (int j = 0; j < i; j++) {
				if (method_16420(arg, arg2.method_10086(j))) {
					this.method_12773(set, arg, arg2.method_10086(j), this.field_13685, arg3);
				}

				if (j < i - 1) {
					if (method_16420(arg, arg2.method_10069(1, j, 0))) {
						this.method_12773(set, arg, arg2.method_10069(1, j, 0), this.field_13685, arg3);
					}

					if (method_16420(arg, arg2.method_10069(1, j, 1))) {
						this.method_12773(set, arg, arg2.method_10069(1, j, 1), this.field_13685, arg3);
					}

					if (method_16420(arg, arg2.method_10069(0, j, 1))) {
						this.method_12773(set, arg, arg2.method_10069(0, j, 1), this.field_13685, arg3);
					}
				}
			}
	...
	private void method_13495(class_3747 arg, int i, int j, int k, int l, Random random, class_3341 arg2, Set<class_2338> set) {
		...
		for (int o = k - m; o <= k; o++) {
			...
			this.method_13528(arg, new class_2338(i, o, j), q + (p > 0 && q == n && (o & 1) == 0 ? 1 : 0), arg2, set);
			n = q;
		}
	}
