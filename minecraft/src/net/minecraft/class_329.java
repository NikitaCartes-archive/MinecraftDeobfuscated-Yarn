...
public class class_329 extends class_332 {
		...
		if (!this.field_2035.field_1690.field_1842) {
			...
			if (this.field_2023 > 0) {
				...
				if (this.field_2023 > this.field_2036 + this.field_2017) {
					float m = (float)(this.field_2037 + this.field_2017 + this.field_2036) - g;
					k = (int)(m * 255.0F / (float)this.field_2037);
				}
				...
				k = class_3532.method_15340(k, 0, 255);
				if (k > 8) {
					GlStateManager.pushMatrix();
		...
		if (lv.field_1850 == 0) {
			if (this.field_2035.field_1761.method_2920() != class_1934.field_9219 || this.method_17534(this.field_2035.field_1765)) {
				if (lv.field_1866 && !lv.field_1842 && !this.field_2035.field_1724.method_7302() && !lv.field_1910) {
					GlStateManager.pushMatrix();
					GlStateManager.translatef((float)(this.field_2011 / 2), (float)(this.field_2029 / 2), (float)this.blitOffset);
					...
					GlStateManager.blendFuncSeparate(
						GlStateManager.class_5119.ONE_MINUS_DST_COLOR,
						GlStateManager.class_5118.ONE_MINUS_SRC_COLOR,
						GlStateManager.class_5119.ONE,
						GlStateManager.class_5118.ZERO
					);
					int i = 15;
					this.blit((this.field_2011 - 15) / 2, (this.field_2029 - 15) / 2, 0, 0, 15, 15);
					if (this.field_2035.field_1690.field_1895 == class_4061.field_18152) {
						float f = this.field_2035.field_1724.method_7261(0.0F);
						boolean bl = false;
						if (this.field_2035.field_1692 != null && this.field_2035.field_1692 instanceof class_1309 && f >= 2.0F) {
							bl = ((class_3966)this.field_2035.field_1765).method_26747() <= this.field_2035.field_1724.method_26738(0.0F);
			...
			for(class_1293 lv2 : Ordering.natural().reverse().sortedCopy(collection)) {
				...
				if (lv2.method_5592()) {
					...
					list.add((Runnable)() -> {
						...
						blit(n + 3, o + 3, this.blitOffset, 18, 18, lv4);
					});
				}
			}
	...
	protected void method_1759(float f) {
		...
		if (lv != null) {
			...
			int l = 91;
			this.blitOffset = -90;
			this.blit(i - 91, this.field_2029 - 22, 0, 0, 182, 22);
			this.blit(i - 91 - 1 + lv.field_7514.field_7545 * 20, this.field_2029 - 22 - 1, 0, 22, 24, 22);
			if (!lv2.method_7960()) {
				if (lv3 == class_1306.field_6182) {
					this.blit(i - 91 - 29, this.field_2029 - 23, 24, 22, 29, 24);
				} else {
					this.blit(i + 91, this.field_2029 - 23, 53, 22, 29, 24);
				}
			}
			...
			for(int m = 0; m < 9; ++m) {
				int n = i - 90 + m * 20 + 2;
				int o = this.field_2029 - 16 - 3;
				this.method_1762(n, o, f, lv, lv.field_7514.field_7547.get(m));
			}

			if (!lv2.method_7960()) {
				int m = this.field_2029 - 16 - 3;
				if (lv3 == class_1306.field_6182) {
					this.method_1762(i - 91 - 26, m, f, lv, lv2);
				} else {
					this.method_1762(i + 91 + 10, m, f, lv, lv2);
				}
			}
	...
	private void method_1757(class_266 arg) {
		...
		List<class_267> list = (List)collection.stream()
	...
	private void method_1760() {
		...
		if (lv != null) {
			...
			for(int x = class_3532.method_15386((f + (float)p) / 2.0F) - 1; x >= 0; --x) {
				int y = 16;
				...
				int aa = class_3532.method_15386((float)(x + 1) / 10.0F) - 1;
				int ab = m + x % 10 * 8;
				int ac = o - aa * r;
				if (i <= 4) {
			...
			if (y == 0) {
				...
				for(int z = 0; z < 10; ++z) {
					...
					if (lv.method_7344().method_7589() <= 0.0F && this.field_2042 % (k * 3 + 1) == 0) {
						aa = o + (this.field_2034.nextInt(3) - 1);
					}
			...
			int z = lv.method_5669();
			int aa = lv.method_5748();
			if (lv.method_5777(class_3486.field_15517) || z < aa) {
				int ab = this.method_1733(y) - 1;
				t -= ab * 10;
				int ac = class_3532.method_15384((double)(z - 2) * 10.0 / (double)aa);
				int ad = class_3532.method_15384((double)z * 10.0 / (double)aa) - ac;
	...
	private void method_1735(class_1297 arg) {
		...
		GlStateManager.depthMask(false);
		GlStateManager.blendFuncSeparate(
			GlStateManager.class_5119.ZERO, GlStateManager.class_5118.ONE_MINUS_SRC_COLOR, GlStateManager.class_5119.ONE, GlStateManager.class_5118.ZERO
		);
		if (f > 0.0F) {
