...
public abstract class class_1496 extends class_1429 implements class_1265, class_1316 {
	private static final Predicate<class_1297> field_6956 = arg -> arg instanceof class_1496 && ((class_1496)arg).method_6744();
	...
	protected class_1496(class_1299<?> arg, class_1937 arg2) {
		super(arg, arg2);
		this.method_5835(1.3964844F, 1.6F);
	...
	@Nullable
	protected class_1496 method_6756(class_1297 arg, double d) {
		double e = Double.MAX_VALUE;
		class_1297 lv = null;

		for (class_1297 lv2 : this.field_6002.method_8333(arg, arg.method_5829().method_1012(d, d, d), field_6956)) {
			double f = lv2.method_5649(arg.field_5987, arg.field_6010, arg.field_6035);
			if (f < e) {
				lv = lv2;
				e = f;
			}
		...
		if (!this.field_6002.field_9236) {
			...
			if (this.method_6762()) {
				if (!this.method_6724()
					...
					&& this.field_6002
							.method_8320(
								new class_2338(class_3532.method_15357(this.field_5987), class_3532.method_15357(this.field_6010) - 1, class_3532.method_15357(this.field_6035))
							)
							.method_11614()
	...
	protected void method_6746() {
		if (this.method_6744() && this.method_6109() && !this.method_6724()) {
			class_1496 lv = this.method_6756(this, 16.0);
	...
	public void method_6091(float f, float g, float h) {
		if (this.method_5782() && this.method_5956() && this.method_6725()) {
			...
			if (this.field_6976 > 0.0F && !this.method_6763() && this.field_5952) {
				this.field_5984 = this.method_6771() * (double)this.field_6976;
				...
				if (h > 0.0F) {
					...
					this.field_5967 = this.field_5967 + (double)(-0.4F * i * this.field_6976);
					this.field_6006 = this.field_6006 + (double)(0.4F * j * this.field_6976);
					this.method_6723();
				}
