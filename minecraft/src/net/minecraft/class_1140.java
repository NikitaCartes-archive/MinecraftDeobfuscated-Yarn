...
public class class_1140 {
	...
	private final List<String> field_5564 = Lists.newArrayList();
	...
	public class_1140(class_1144 arg, class_315 arg2) {
		...
		try {
			...
			field_5559.error(field_5553, "Error linking with the LibraryJavaSound plug-in", var4);
		}
	}
	...
	public void method_4857() {
		...
		while(iterator.hasNext()) {
			Entry<String, class_1113> entry = (Entry)iterator.next();
		...
		while(iterator2.hasNext()) {
			...
			if (this.field_5550 >= entry2.getValue()) {
				class_1113 lv2 = (class_1113)entry2.getKey();
				if (lv2 instanceof class_1117) {
					((class_1117)lv2).method_16896();
				}

				this.method_4854(lv2);
				iterator2.remove();
			}
		}
	}
	...
	public boolean method_4835(class_1113 arg) {
		if (!this.field_5563) {
			...
			if (string == null) {
				...
				return this.field_5560.playing(string) || this.field_5554.containsKey(string) && this.field_5554.get(string) <= this.field_5550;
			}
		}
	}
