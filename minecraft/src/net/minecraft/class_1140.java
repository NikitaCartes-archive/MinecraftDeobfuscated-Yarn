...
public class class_1140 {
	...
	private synchronized void method_4846() {
		if (!this.field_5563) {
			try {
				...
				field_5559.error(field_5553, "Error starting SoundSystem. Turning off sounds & music", var2);
			}
		}
	}
		...
		if (this.field_5563) {
			if (arg == class_3419.field_15250) {
				...
				this.field_18950.forEach((argx, arg2) -> {
					float fxx = this.method_4853(argx);
	...
	public void method_19753(class_1113 arg) {
		if (this.field_5563) {
			class_4235.class_4236 lv = (class_4235.class_4236)this.field_18950.remove(arg);
			if (lv != null) {
				this.field_18952.remove(arg);
	...
	private void method_4857() {
		...
		while(iterator.hasNext()) {
			Entry<class_1113, class_4235.class_4236> entry = (Entry)iterator.next();
			...
			if (h <= 0.0F) {
				...
				int i = this.field_18952.get(lv5);
				if (i <= this.field_5550) {
					...
					try {
						this.field_18951.remove(lv5.method_4774(), lv4);
		...
		while(iterator2.hasNext()) {
			Entry<class_1113, Integer> entry2 = (Entry)iterator2.next();
			if (this.field_5550 >= entry2.getValue()) {
					...
					if (lv4 == class_1144.field_5592) {
						...
						if (h == 0.0F && !arg.method_4785()) {
							...
							lv8.method_19735(arg3 -> {
								...
								arg3.method_19645(bl3);
								arg3.method_19641(lv7);
								arg3.method_19649(bl);
							});
							if (!lv4.method_4769()) {
								this.field_18947.method_19743(lv4.method_4766(), bl2).thenAccept(arg2 -> lv8.method_19735(arg2x -> {
	...
	public void method_4838(@Nullable class_2960 arg, @Nullable class_3419 arg2) {
		if (arg2 != null) {
			...
			for(class_1113 lv : this.field_18950.keySet()) {
				if (lv.method_4775().equals(arg)) {
					this.method_19753(lv);
				}
			}
		}
