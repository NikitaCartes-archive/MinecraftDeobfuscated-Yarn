...
public class class_1384 extends Goal {
	...
	public boolean canStart() {
		return this.field_6594.world.isDaylight()
			&& this.field_6594.getEquippedStack(EquipmentSlot.HEAD).isEmpty()
			&& this.field_6594.getNavigation() instanceof EntityMobNavigation;
	}
