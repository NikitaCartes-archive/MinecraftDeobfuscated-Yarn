...
public class class_236<T> {
	...
	private final Map<String, class_236.class_237<T>> field_1312 = Maps.newHashMap();
	...
	public void method_988(T object, long l) {
		while(true) {
			class_236.class_237<T> lv = (class_236.class_237)this.field_1313.peek();
	...
	public void method_984(String string, long l, class_234<T> arg) {
		class_236.class_237<T> lv = (class_236.class_237)this.field_1312.remove(string);
		if (lv != null) {
	...
	public class_2499 method_982() {
		...
		this.field_1313.stream().sorted(method_987()).map(this::method_980).forEach(lv::add);
		return lv;
	}
