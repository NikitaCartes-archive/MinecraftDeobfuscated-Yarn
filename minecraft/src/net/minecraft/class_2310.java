...
public class class_2310 extends class_2248 implements class_3737 {
	...
	private final Object2IntMap<class_2680> field_19313 = new Object2IntOpenHashMap<>();
	...
	public boolean method_9579(class_2680 arg, class_1922 arg2, class_2338 arg3) {
		return !arg.method_11654(field_10900);
	}
	...
	protected int method_9987(class_2680 arg) {
		return this.field_19313.computeIntIfAbsent(arg, argx -> {
			int i = 0;
			if (argx.method_11654(field_10905)) {
				i |= method_9985(class_2350.field_11043);
			}

			if (argx.method_11654(field_10907)) {
				i |= method_9985(class_2350.field_11034);
			}

			if (argx.method_11654(field_10904)) {
				i |= method_9985(class_2350.field_11035);
			}

			if (argx.method_11654(field_10903)) {
