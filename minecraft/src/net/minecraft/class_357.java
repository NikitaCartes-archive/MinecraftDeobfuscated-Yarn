...
public abstract class class_357 extends class_339 {
	...
	protected void renderBg(class_310 arg, int i, int j) {
		...
		this.blit(this.field_23658 + (int)(this.value * (double)(this.width - 8)), this.field_23659, 0, 46 + k, 4, 20);
		this.blit(this.field_23658 + (int)(this.value * (double)(this.width - 8)) + 4, this.field_23659, 196, 46 + k, 4, 20);
	}
	...
	private void setValueFromMouse(double d) {
		this.setValue((d - (double)(this.field_23658 + 4)) / (double)(this.width - 8));
	}

	private void setValue(double d) {
		double e = this.value;
		this.value = class_3532.method_15350(d, 0.0, 1.0);
		if (e != this.value) {
			this.applyValue();
		}
