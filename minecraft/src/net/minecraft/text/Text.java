...
public interface Text extends Message, StringVisitable {
	...
	default String getLiteralString() {
		...
		if (var2 instanceof PlainTextContent plainTextContent && this.getSiblings().isEmpty() && this.getStyle().isEmpty()) {
	...
	public static class Serialization {
		...
		static MutableText fromJson(JsonElement json) {
			return Util.getResult(TextCodecs.CODEC.parse(JsonOps.INSTANCE, json), JsonParseException::new);
		}
		...
		public static MutableText fromJson(com.mojang.brigadier.StringReader reader) {
			...
			try {
				...
				var3 = jsonElement != null ? fromJson(jsonElement) : null;
