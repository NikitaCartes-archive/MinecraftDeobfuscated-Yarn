...
public class class_1684 extends class_3857 {
	...
	public class_1684(class_1299<? extends class_1684> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	protected void method_7492(class_239 arg) {
		...
		if (arg.method_17783() == class_239.class_240.field_1331) {
			class_1297 lv2 = ((class_3966)arg).method_17782();
			if (lv2 == this.field_7646) {
				return;
			}

			lv2.method_5643(class_1282.method_5524(this, lv), 0.0F);
		}

		if (arg.method_17783() == class_239.class_240.field_1332) {
			class_2338 lv3 = ((class_3965)arg).method_17777();
			class_2586 lv4 = this.field_6002.method_8321(lv3);
			if (lv4 instanceof class_2643) {
				class_2643 lv5 = (class_2643)lv4;
				if (lv != null) {
					if (lv instanceof class_3222) {
						class_174.field_1180.method_8885((class_3222)lv, this.field_6002.method_8320(lv3));
					}
		...
		if (!this.field_6002.field_9236) {
			if (lv instanceof class_3222) {
				class_3222 lv6 = (class_3222)lv;
				if (lv6.field_13987.method_14366().method_10758() && lv6.field_6002 == this.field_6002 && !lv6.method_6113()) {
					if (this.field_5974.nextFloat() < 0.05F && this.field_6002.method_8450().method_8355(class_1928.field_19390)) {
						class_1559 lv7 = class_1299.field_6128.method_5883(this.field_6002);
						lv7.method_7022(true);
						lv7.method_5808(lv.field_5987, lv.field_6010, lv.field_6035, lv.field_6031, lv.field_5965);
						this.field_6002.method_8649(lv7);
					}
