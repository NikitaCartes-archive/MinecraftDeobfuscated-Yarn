		...
		if (arg2.method_10264() >= 1 && arg2.method_10264() + i + 1 <= 256) {
			...
			if (!bl) {
				...
				for(int n = arg2.method_10264() - 3 + i; n <= arg2.method_10264() + i; ++n) {
					...
					for(int o = arg2.method_10263() - m; o <= arg2.method_10263() + m; ++o) {
						int p = o - arg2.method_10263();

						for(int q = arg2.method_10260() - m; q <= arg2.method_10260() + m; ++q) {
							...
							if (Math.abs(p) != m || Math.abs(r) != m || random.nextInt(2) != 0 && l != 0) {
								...
								if (method_16420(arg, lv2) || method_16425(arg, lv2)) {
									this.method_13153(arg, lv2, this.field_13901);
								}
							}
						}
					}
				...
				for(int n = 0; n < i; ++n) {
					if (method_16420(arg, arg2.method_10086(n)) || method_16425(arg, arg2.method_10086(n))) {
						this.method_12773(set, arg, arg2.method_10086(n), this.field_13898);
				...
				if (this.field_13903) {
					for(int n = arg2.method_10264() - 3 + i; n <= arg2.method_10264() + i; ++n) {
						...
						for(int p = arg2.method_10263() - m; p <= arg2.method_10263() + m; ++p) {
							for(int q = arg2.method_10260() - m; q <= arg2.method_10260() + m; ++q) {
								lv3.method_10103(p, n, q);
						...
						for(int n = 0; n < 2; ++n) {
							for(class_2350 lv7 : class_2350.class_2353.field_11062) {
								if (random.nextInt(4 - n) == 0) {
									...
									this.method_14063(arg, random.nextInt(3), arg2.method_10069(lv8.method_10148(), i - 5 + n, lv8.method_10165()), lv7);
								}
							}
						}
					}
