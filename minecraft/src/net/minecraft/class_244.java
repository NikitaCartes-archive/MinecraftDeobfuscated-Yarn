...
public final class class_244 extends class_251 {
	...
	protected boolean method_1059(int i, int j, int k, int l) {
		if (k < 0 || l < 0 || i < 0) {
			return false;
		} else if (k < this.field_1374 && l < this.field_1373 && j <= this.field_1372) {
			return this.field_1359.nextClearBit(this.method_1039(k, l, i)) >= this.method_1039(k, l, j);
		} else {
			return false;
		}
	}
	...
	static class_244 method_1040(class_251 arg, class_251 arg2, class_255 arg3, class_255 arg4, class_255 arg5, class_247 arg6) {
		...
		arg3.method_1065((i, j, k) -> {
			...
			boolean bl = arg4.method_1065((l, m, n) -> {
				...
				boolean blxx = arg5.method_1065((o, p, q) -> {
					boolean blxxx = arg6.apply(arg.method_1044(i, l, o), arg2.method_1044(j, m, p));
					if (blxxx) {
