...
public class class_2300 {
	...
	private final Class<? extends class_1297> field_10832;
	...
	public class_2300(
		...
		@Nullable UUID uUID,
		Class<? extends class_1297> class_,
		boolean bl4
	) {
		this.field_10822 = i;
		this.field_10830 = bl;
	...
	private void method_9823(List<class_1297> list, class_3218 arg, class_243 arg2, Predicate<class_1297> predicate) {
		if (this.field_10824 != null) {
			list.addAll(arg.method_8390(this.field_10832, this.field_10824.method_997(arg2), predicate::test));
		} else {
			list.addAll(arg.method_8490(this.field_10832, predicate::test));
		}
	}
	...
	public List<class_3222> method_9813(class_2168 arg) throws CommandSyntaxException {
		...
		if (this.field_10831 != null) {
			...
			if (this.field_10828) {
				...
				if (this.method_9821()) {
					list = arg.method_9225().method_8498(class_3222.class, predicate::test);
				} else {
