...
public abstract class class_350<E extends class_350.class_351<E>> extends class_362 implements class_4068 {
	...
	protected final E method_20055(double d, double e) {
		...
		return (E)(d < (double)this.method_20078() && d >= (double)k && d <= (double)l && n >= 0 && m >= 0 && n < this.method_20073()
			? this.children().get(n)
			: null);
	}
	...
	public boolean mouseClicked(double d, double e, int i) {
		...
		if (!this.isMouseOver(d, e)) {
			...
			if (lv != null) {
				...
				this.method_20058(
					(int)(d - (double)(this.field_19088 + this.field_19083 / 2 - this.method_20053() / 2)),
					(int)(e - (double)this.field_19085) + (int)this.method_20077() - 4
				);
				return true;
			}
