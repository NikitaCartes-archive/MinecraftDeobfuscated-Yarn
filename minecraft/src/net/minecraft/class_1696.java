...
public class class_1696 extends class_1688 {
	...
	public class_1696(class_1937 arg) {
		super(class_1299.field_6080, arg);
	}
	...
	protected void method_7513(class_2338 arg, class_2680 arg2) {
		...
		if (d > 1.0E-4 && this.field_5967 * this.field_5967 + this.field_6006 * this.field_6006 > 0.001) {
			d = (double)class_3532.method_15368(d);
			this.field_7737 /= d;
			this.field_7736 /= d;
			if (this.field_7737 * this.field_5967 + this.field_7736 * this.field_6006 < 0.0) {
				this.field_7737 = 0.0;
				this.field_7736 = 0.0;
			} else {
	...
	protected void method_7525() {
		...
		if (d > 1.0E-4) {
			...
			this.field_5967 = this.field_5967 + this.field_7737 * 1.0;
			this.field_6006 = this.field_6006 + this.field_7736 * 1.0;
		} else {
