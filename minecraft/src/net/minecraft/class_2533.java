...
public class class_2533 extends class_2383 implements class_3737 {
	...
	public class_265 method_9530(class_2680 arg, class_1922 arg2, class_2338 arg3, class_3726 arg4) {
		if (!arg.method_11654(field_11631)) {
	...
	public boolean method_9516(class_2680 arg, class_1922 arg2, class_2338 arg3, class_10 arg4) {
		switch(arg4) {
			case field_50:
				return arg.method_11654(field_11631);
			case field_48:
				return arg.method_11654(field_11626);
			case field_51:
				return arg.method_11654(field_11631);
			default:
				return false;
	...
	public void method_9612(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2248 arg4, class_2338 arg5, boolean bl) {
		if (!arg2.field_9236) {
			...
			if (bl2 != arg.method_11654(field_11629)) {
				if (arg.method_11654(field_11631) != bl2) {
					arg = arg.method_11657(field_11631, Boolean.valueOf(bl2));
					this.method_10740(null, arg2, arg3, bl2);
				}

				arg2.method_8652(arg3, arg.method_11657(field_11629, Boolean.valueOf(bl2)), 2);
				if (arg.method_11654(field_11626)) {
					arg2.method_8405().method_8676(arg3, class_3612.field_15910, class_3612.field_15910.method_15789(arg2));
				}
			}
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		if (!arg.method_7717() && lv3.method_10166().method_10179()) {
			lv = lv.method_11657(field_11177, lv3)
				.method_11657(
					field_11625, arg.method_17698().field_1351 - (double)arg.method_8037().method_10264() > 0.5 ? class_2760.field_12619 : class_2760.field_12617
				);
		} else {
