...
public class class_446 extends class_437 {
	...
	@Override
	protected void init() {
		this.field_19186 = this.field_2638.field_1856;
		this.field_2639 = new class_353(this.minecraft, this.width, this.height, 32, this.height - 32, 25);
		this.field_2639.method_20406(class_316.field_1931);
		this.field_2639.method_20408(field_2640);
	...
	@Override
	public void removed() {
		if (this.field_2638.field_1856 != this.field_19186) {
			this.minecraft.method_1549().method_4605(this.field_2638.field_1856);
			this.minecraft.method_1531().method_4618(class_1059.field_5275);
			this.minecraft.method_1549().method_4527(false, this.field_2638.field_1856 > 0);
			this.minecraft.method_1513();
		}
