...
public class class_4158 {
	...
	public static CompletableFuture<Void> method_19515(
		...
		return arg.method_18352(class_3902.field_17274).thenRunAsync(() -> {
			field_18849.clear();
			class_2378.field_18792.forEach(argx -> argx.field_18850.clear());
			class_2378.field_11146.method_10220().filter(argx -> argx.method_9525(class_3481.field_18847)).forEach(argx -> {
				List<class_4158> list = (List)class_2378.field_18792.method_10220().filter(arg2x -> arg2x.field_18520.method_15141(argx)).collect(Collectors.toList());
				if (list.size() > 1) {
