...
public abstract class class_521 extends class_350<class_521.class_4271> {
	...
	public class_521(class_310 arg, int i, int j, class_2561 arg2) {
		...
		this.method_20063(true, (int)(9.0F * 1.5F));
	...
	protected void method_20061(int i, int j, class_289 arg) {
		...
		this.field_3166
			...
			.method_1729(
				lv.method_10863(),
				(float)(i + this.field_19083 / 2 - this.field_3166.field_1772.method_1727(lv.method_10863()) / 2),
	...
	public void method_2690(class_521.class_4271 arg) {
		this.method_1901(arg);
		arg.field_19130 = this;
	}

	@Environment(EnvType.CLIENT)
	public static class class_4271 extends class_350.class_351<class_521.class_4271> {
		...
		public void method_1903(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
			...
			this.method_20144();
			GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
			class_332.blit(k, j, 0.0F, 0.0F, 32, 32, 32.0F, 32.0F);
			...
			if (this.method_20151() && (this.field_19128.field_1690.field_1854 || bl)) {
				...
				if (this.method_20152()) {
					...
					if (this.method_20153()) {
						if (p < 16) {
							class_332.blit(k, j, 32.0F, 32.0F, 32, 32, 256.0F, 256.0F);
						} else {
							class_332.blit(k, j, 32.0F, 0.0F, 32, 32, 256.0F, 256.0F);
						}
					}
			...
			int p = this.field_19128.field_1772.method_1727(string);
			if (p > 157) {
		...
		public boolean mouseClicked(double d, double e, int i) {
			double f = d - (double)this.field_19130.method_20079();
			double g = e - (double)this.field_19130.method_20071(this.field_19130.children().indexOf(this));
			if (this.method_20151() && f <= 32.0) {
				if (this.method_20152()) {
					...
					if (lv.method_14437()) {
						...
						this.field_19128.method_1507(new class_410((bl, ix) -> {
							this.field_19128.method_1507(this.method_20156());
							if (bl) {
								this.method_20156().method_2674(this);
							}
						}, class_521.field_19127, lv2, 0));
					}
