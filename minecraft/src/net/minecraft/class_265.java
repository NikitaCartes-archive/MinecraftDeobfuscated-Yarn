...
public abstract class class_265 {
	...
	public class_265 method_20538(class_2350 arg) {
		if (!this.method_1110() && this != class_259.method_1077()) {
			if (this.field_19318 != null) {
				class_265 lv = this.field_19318[arg.ordinal()];
				if (lv != null) {
					return lv;
				}
			} else {
			...
			class_265 lv = this.method_1098(arg);
			this.field_19318[arg.ordinal()] = lv;
			return lv;
		} else {
			return this;
		}
	...
	private class_265 method_1098(class_2350 arg) {
