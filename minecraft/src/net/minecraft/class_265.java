...
public abstract class class_265 {
	...
	protected int method_1100(class_2350.class_2351 arg, double d) {
		return class_3532.method_15360(0, this.field_1401.method_1051(arg) + 1, i -> {
			if (i < 0) {
				return false;
			} else if (i > this.field_1401.method_1051(arg)) {
				return true;
			} else {
				return d < this.method_1099(arg, i);
			}
		}) - 1;
	}
	...
	@Nullable
	public class_239 method_1092(class_243 arg, class_243 arg2, class_2338 arg3) {
		if (this.method_1110()) {
			return null;
		} else {
			...
			if (lv.method_1027() < 1.0E-7) {
				...
				class_243 lv3 = arg.method_1019(lv.method_1021(0.001)).method_1023((double)arg3.method_10263(), (double)arg3.method_10264(), (double)arg3.method_10260());
				return this.method_1095(lv3.field_1352, lv3.field_1351, lv3.field_1350)
					? new class_239(lv2, class_2350.method_10142(lv.field_1352, lv.field_1351, lv.field_1350), arg3)
