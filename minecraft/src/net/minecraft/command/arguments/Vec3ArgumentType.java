...
public class Vec3ArgumentType implements ArgumentType<PosArgument> {
	...
	public static final SimpleCommandExceptionType MIXED_COORDINATE_EXCEPTION = new SimpleCommandExceptionType(
		new TranslatableTextComponent("argument.pos.mixed")
	);
	...
	public static PosArgument method_9734(CommandContext<ServerCommandSource> commandContext, String string) {
