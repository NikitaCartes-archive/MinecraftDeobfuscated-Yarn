...
public class CommandExecutionContext<T> implements AutoCloseable {
	...
	private final List<CommandQueueEntry<T>> pendingCommands = Lists.newArrayList();
	...
	public void run() {
		...
		while(!this.commandQueue.isEmpty()) {
			...
			CommandQueueEntry<T> commandQueueEntry = (CommandQueueEntry)this.commandQueue.removeFirst();
