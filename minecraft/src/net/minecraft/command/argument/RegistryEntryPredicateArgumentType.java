	...
	public RegistryEntryPredicateArgumentType.EntryPredicate<T> parse(StringReader stringReader) throws CommandSyntaxException {
		if (stringReader.canRead() && stringReader.peek() == '#') {
			...
			try {
				...
				RegistryEntryList.Named<T> named = (RegistryEntryList.Named)this.registryWrapper
					.getOptional(tagKey)
			...
			RegistryEntry.Reference<T> reference = (RegistryEntry.Reference)this.registryWrapper
