...
public class ItemStringReader {
	private static final SimpleCommandExceptionType TAG_DISALLOWED_EXCEPTION = new SimpleCommandExceptionType(
	...
	public static ItemStringReader.ItemResult item(CommandRegistryWrapper<Item> registryWrapper, StringReader reader) throws CommandSyntaxException {
		...
		try {
			...
			RegistryEntry<Item> registryEntry = (RegistryEntry)itemStringReader.result
				.left()
