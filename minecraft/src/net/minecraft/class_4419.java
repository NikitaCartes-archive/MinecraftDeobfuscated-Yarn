	...
	private void method_21415(WorldTemplatePaginatedList worldTemplatePaginatedList) {
		(new Thread("realms-template-fetcher") {
				public void run() {
					...
					for(class_4341 lv = class_4341.method_20989();
						worldTemplatePaginatedListx != null;
						worldTemplatePaginatedListx = (WorldTemplatePaginatedList)Realms.execute(
								(Supplier)(() -> {
									if (either.right().isPresent()) {
										...
										if (worldTemplatePaginatedListxxxx.templates.isEmpty()) {
											if (class_4419.this.field_20071.method_21446()) {
												...
												class_4450.class_4452 lvxx = class_4450.class_4452.method_21582(
													RealmsScreen.getLocalizedString("mco.template.select.none.linkTitle"), "https://minecraft.net/realms/content-creator/"
												);
												class_4419.this.field_20085 = class_4450.method_21578(string, lvxx);
											}
						...
						either = class_4419.this.method_21416(worldTemplatePaginatedListx, lv);
					}
				}
			})
			.start();
