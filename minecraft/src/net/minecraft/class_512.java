...
public class class_512 extends class_361 {
	...
	public void renderButton(int i, int j, float f) {
		if (this.field_3122 > 0.0F) {
			...
			GlStateManager.translatef((float)(this.field_23658 + 8), (float)(this.field_23659 + 12), 0.0F);
		...
		int m = this.field_23658;
		if (this.field_2194) {
			m -= 2;
		}

		GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
		this.blit(m, this.field_23659, k, l, this.width, this.height);
	...
	private void method_2621(class_918 arg) {
		...
		if (list.size() == 1) {
			arg.method_4023((class_1799)list.get(0), this.field_23658 + 9 + i, this.field_23659 + 5);
		} else if (list.size() == 2) {
			arg.method_4023((class_1799)list.get(0), this.field_23658 + 3 + i, this.field_23659 + 5);
			arg.method_4023((class_1799)list.get(1), this.field_23658 + 14 + i, this.field_23659 + 5);
		}
	}
