...
public class class_761 implements class_1938, AutoCloseable, class_3302 {
	...
	private boolean method_3284(class_1297 arg, class_1297 arg2, class_856 arg3) {
		...
		if (arg == arg2 && this.field_4088.field_1690.field_1850 == 0 && !bl) {
			...
			return true;
		} else if (this.field_4088.field_1724.method_7325() && this.field_4088.field_1690.field_1906.method_1434() && arg instanceof class_1657) {
			return arg.field_5985 || arg3.method_3699(arg.method_5829()) || arg.method_5821(this.field_4088.field_1724);
		} else {
			return false;
		}
	}
	...
	public void method_3294(class_1657 arg, class_239 arg2, int i, float f) {
		if (i == 0 && arg2.field_1330 == class_239.class_240.field_1332) {
			...
			if (!lv2.method_11588() && this.field_4085.method_8621().method_11952(lv)) {
				...
				method_3291(
					lv2.method_11606(this.field_4085, lv),
					(double)lv.method_10263() - d,
					(double)lv.method_10264() - e,
					(double)lv.method_10260() - g,
					0.0F,
					0.0F,
					0.0F,
					0.4F
