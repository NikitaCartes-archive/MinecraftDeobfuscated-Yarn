...
public class class_761 implements AutoCloseable, class_4013 {
	...
	private final Map<Integer, class_3191> field_4058 = Maps.newHashMap();
	...
	public void method_3279() {
		if (this.field_4085 != null) {
			if (this.field_4106 == null) {
				this.field_4106 = new class_846(this.field_4088.method_1540());
			}
	...
	public void method_3271(class_4184 arg, class_856 arg2, float f) {
		if (this.field_4076 > 0) {
			...
			class_824.field_4346.method_3549(this.field_4085, this.field_4088.method_1531(), this.field_4088.field_1772, arg, this.field_4088.field_1765);
			this.field_4109.method_3941(this.field_4085, this.field_4088.field_1772, arg, this.field_4088.field_1692, this.field_4088.field_1690);
			this.field_4089 = 0;
			this.field_4110 = 0;
			double h = arg.method_19326().field_1352;
			double i = arg.method_19326().field_1351;
			double j = arg.method_19326().field_1350;
			...
			for(class_1297 lv : this.field_4085.method_18112()) {
				if ((this.field_4109.method_3950(lv, arg2, d, e, g) || lv.method_5821(this.field_4088.field_1724))
					&& (lv != arg.method_19331() || arg.method_19333() || arg.method_19331() instanceof class_1309 && ((class_1309)arg.method_19331()).method_6113())) {
					++this.field_4089;
					this.field_4109.method_3946(lv, f, false);
					if (lv.method_5851() || lv instanceof class_1657 && this.field_4088.field_1724.method_7325() && this.field_4088.field_1690.field_1906.method_1434()) {
						list.add(lv);
					}

					if (this.field_4109.method_3942(lv)) {
						list2.add(lv);
					}
				}
			}
			...
			if (!list2.isEmpty()) {
				for(class_1297 lv : list2) {
					this.field_4109.method_3947(lv, f);
				}
			}
			...
			if (this.method_3270() && (!list.isEmpty() || this.field_4090)) {
				...
				if (!list.isEmpty()) {
					...
					for(int k = 0; k < list.size(); ++k) {
						this.field_4109.method_3946((class_1297)list.get(k), f, false);
					}
			...
			for(class_761.class_762 lv2 : this.field_4086) {
				List<class_2586> list3 = lv2.field_4124.method_3677().method_3642();
				if (!list3.isEmpty()) {
					for(class_2586 lv3 : list3) {
						class_824.field_4346.method_3555(lv3, f, -1);
					}
				}
			}

			synchronized(this.field_4055) {
				for(class_2586 lv4 : this.field_4055) {
					class_824.field_4346.method_3555(lv4, f, -1);
				}
			}

			this.method_3263();

			for(class_3191 lv5 : this.field_4058.values()) {
				class_2338 lv6 = lv5.method_13991();
				class_2680 lv7 = this.field_4085.method_8320(lv6);
				if (lv7.method_11614().method_9570()) {
					class_2586 lv3 = this.field_4085.method_8321(lv6);
					if (lv3 instanceof class_2595 && lv7.method_11654(class_2281.field_10770) == class_2745.field_12574) {
						lv6 = lv6.method_10093(((class_2350)lv7.method_11654(class_2281.field_10768)).method_10170());
						lv3 = this.field_4085.method_8321(lv6);
					}

					if (lv3 != null && lv7.method_11608()) {
						class_824.field_4346.method_3555(lv3, f, lv5.method_13988());
					}
				}
			}
	...
	public String method_3272() {
		return "E: " + this.field_4089 + "/" + this.field_4085.method_18120() + ", B: " + this.field_4110;
	}

	public void method_3273(class_4184 arg, class_856 arg2, int i, boolean bl) {
		if (this.field_4088.field_1690.field_1870 != this.field_4062) {
			this.method_3279();
		}

		this.field_4085.method_16107().method_15396("camera");
		double d = this.field_4088.field_1724.field_5987 - this.field_4104;
		double e = this.field_4088.field_1724.field_6010 - this.field_4120;
		double f = this.field_4088.field_1724.field_6035 - this.field_4070;
		if (this.field_4084 != this.field_4088.field_1724.field_6024
			|| this.field_4105 != this.field_4088.field_1724.field_5959
			|| this.field_4121 != this.field_4088.field_1724.field_5980
			|| d * d + e * e + f * f > 16.0) {
			this.field_4104 = this.field_4088.field_1724.field_5987;
			this.field_4120 = this.field_4088.field_1724.field_6010;
			this.field_4070 = this.field_4088.field_1724.field_6035;
			this.field_4084 = this.field_4088.field_1724.field_6024;
			this.field_4105 = this.field_4088.field_1724.field_5959;
			this.field_4121 = this.field_4088.field_1724.field_5980;
			this.field_4112.method_3330(this.field_4088.field_1724.field_5987, this.field_4088.field_1724.field_6035);
		}

		this.field_4085.method_16107().method_15405("renderlistcamera");
		this.field_4092.method_3158(arg.method_19326().field_1352, arg.method_19326().field_1351, arg.method_19326().field_1350);
		...
		class_2338 lv2 = arg.method_19328();
		class_851 lv3 = this.field_4112.method_3323(lv2);
		class_2338 lv4 = new class_2338(
			class_3532.method_15357(arg.method_19326().field_1352 / 16.0) * 16,
			class_3532.method_15357(arg.method_19326().field_1351 / 16.0) * 16,
			class_3532.method_15357(arg.method_19326().field_1350 / 16.0) * 16
		);
		float g = arg.method_19329();
		float h = arg.method_19330();
		this.field_4077 = this.field_4077
			|| !this.field_4075.isEmpty()
			|| arg.method_19326().field_1352 != this.field_4069
			|| arg.method_19326().field_1351 != this.field_4081
			|| arg.method_19326().field_1350 != this.field_4096
			|| (double)g != this.field_4115
			|| (double)h != this.field_4064;
		this.field_4069 = arg.method_19326().field_1352;
		this.field_4081 = arg.method_19326().field_1351;
		this.field_4096 = arg.method_19326().field_1350;
		this.field_4115 = (double)g;
		this.field_4064 = (double)h;
		...
		if (!bl2 && this.field_4077) {
			...
			if (lv3 != null) {
				...
				if (set.size() == 1) {
					class_243 lv7 = arg.method_19335();
					class_2350 lv8 = class_2350.method_10142(lv7.field_1352, lv7.field_1351, lv7.field_1350).method_10153();
					set.remove(lv8);
				}
				...
				int j = lv2.method_10264() > 0 ? 248 : 8;

				for(int k = -this.field_4062; k <= this.field_4062; ++k) {
					for(int l = -this.field_4062; l <= this.field_4062; ++l) {
						class_851 lv5 = this.field_4112.method_3323(new class_2338((k << 4) + 8, j, (l << 4) + 8));
		...
		if (this.field_4066) {
			this.method_3275(arg.method_19326().field_1352, arg.method_19326().field_1351, arg.method_19326().field_1350);
	...
	private Set<class_2350> method_3285(class_2338 arg) {
		...
		for(class_2338 lv4 : class_2338.method_10097(lv2, lv2.method_10069(15, 15, 15))) {
	...
	public int method_3251(class_1921 arg, class_4184 arg2) {
		class_308.method_1450();
		if (arg == class_1921.field_9179) {
			this.field_4088.method_16011().method_15396("translucent_sort");
			double d = arg2.method_19326().field_1352 - this.field_4083;
			double e = arg2.method_19326().field_1351 - this.field_4103;
			double f = arg2.method_19326().field_1350 - this.field_4118;
			if (d * d + e * e + f * f > 1.0) {
				this.field_4083 = arg2.method_19326().field_1352;
				this.field_4103 = arg2.method_19326().field_1351;
				this.field_4118 = arg2.method_19326().field_1350;
				int i = 0;
	...
	public void method_3257(float f) {
		if (this.field_4088.field_1687.field_9247.method_12460() == class_2874.field_13078) {
			...
			class_243 lv = this.field_4085.method_8548(this.field_4088.field_1773.method_19418().method_19328(), f);
	...
	public void method_3269(long l) {
		this.field_4077 |= this.field_4106.method_3631(l);
	...
	public void method_3243(class_4184 arg, float f) {
		class_289 lv = class_289.method_1348();
		class_287 lv2 = lv.method_1349();
		class_2784 lv3 = this.field_4085.method_8621();
		double d = (double)(this.field_4088.field_1690.field_1870 * 16);
		if (!(arg.method_19326().field_1352 < lv3.method_11963() - d)
			|| !(arg.method_19326().field_1352 > lv3.method_11976() + d)
			|| !(arg.method_19326().field_1350 < lv3.method_11977() - d)
			|| !(arg.method_19326().field_1350 > lv3.method_11958() + d)) {
			double e = 1.0 - lv3.method_11961(arg.method_19326().field_1352, arg.method_19326().field_1350) / d;
			e = Math.pow(e, 4.0);
			double g = arg.method_19326().field_1352;
			double h = arg.method_19326().field_1351;
			double i = arg.method_19326().field_1350;
			GlStateManager.enableBlend();
			GlStateManager.blendFuncSeparate(
				GlStateManager.class_5119.SRC_ALPHA, GlStateManager.class_5118.ONE, GlStateManager.class_5119.ONE, GlStateManager.class_5118.ZERO
			);
	...
	private void method_3263() {
		GlStateManager.blendFuncSeparate(
			GlStateManager.class_5119.DST_COLOR, GlStateManager.class_5118.SRC_COLOR, GlStateManager.class_5119.ONE, GlStateManager.class_5118.ZERO
		);
		GlStateManager.enableBlend();
	...
	public void method_3256(class_289 arg, class_287 arg2, class_4184 arg3) {
		double d = arg3.method_19326().field_1352;
		double e = arg3.method_19326().field_1351;
		double f = arg3.method_19326().field_1350;
		if (!this.field_4058.isEmpty()) {
			this.field_4057.method_4618(class_1059.field_5275);
			this.method_3263();
			arg2.method_1328(7, class_290.field_1582);
			arg2.method_1331(-d, -e, -f);
			arg2.method_1327();
			...
			while(iterator.hasNext()) {
				...
				if (!(lv3 instanceof class_2281) && !(lv3 instanceof class_2336) && !(lv3 instanceof class_2478) && !(lv3 instanceof class_2190)) {
					double g = (double)lv2.method_10263() - d;
					double h = (double)lv2.method_10264() - e;
					double i = (double)lv2.method_10260() - f;
					if (g * g + h * h + i * i > 1024.0) {
						iterator.remove();
					} else {
						class_2680 lv4 = this.field_4085.method_8320(lv2);
						if (!lv4.method_11588()) {
							int j = lv.method_13988();
							class_1058 lv5 = this.field_4068[j];
	...
	public void method_3294(class_4184 arg, class_239 arg2, int i) {
		if (i == 0 && arg2.method_17783() == class_239.class_240.field_1332) {
			class_2338 lv = ((class_3965)arg2).method_17777();
			...
			if (!lv2.method_11588() && this.field_4085.method_8621().method_11952(lv)) {
				...
				method_3291(
					lv2.method_11606(this.field_4085, lv, class_3726.method_16195(arg.method_19331())),
					(double)lv.method_10263() - d,
					(double)lv.method_10264() - e,
					(double)lv.method_10260() - f,
					0.0F,
					0.0F,
					0.0F,
					0.4F
	...
	public void method_18146(int i, int j, int k, int l, int m, int n) {
	...
	private void method_3247(class_1937 arg, class_2338 arg2, boolean bl) {
		for(class_1309 lv : arg.method_18467(class_1309.class, new class_238(arg2).method_1014(3.0))) {
	...
	public void method_8563(class_2394 arg, boolean bl, boolean bl2, double d, double e, double f, double g, double h, double i) {
		try {
			...
			lv2.method_578("ID", class_2378.field_11141.method_10221(arg.method_10295()));
	...
	private class_703 method_3288(class_2394 arg, boolean bl, boolean bl2, double d, double e, double f, double g, double h, double i) {
		class_4184 lv = this.field_4088.field_1773.method_19418();
		if (this.field_4088 != null && lv.method_19332() && this.field_4088.field_1713 != null) {
			class_4066 lv2 = this.method_3268(bl2);
			if (bl) {
				return this.field_4088.field_1713.method_3056(arg, d, e, f, g, h, i);
			} else if (lv.method_19326().method_1028(d, e, f) > 1024.0) {
				return null;
			} else {
				return lv2 == class_4066.field_18199 ? null : this.field_4088.field_1713.method_3056(arg, d, e, f, g, h, i);
			}
		} else {
			return null;
		}
	...
	private class_4066 method_3268(boolean bl) {
		class_4066 lv = this.field_4088.field_1690.field_1882;
		if (bl && lv == class_4066.field_18199 && this.field_4085.field_9229.nextInt(10) == 0) {
			lv = class_4066.field_18198;
		}

		if (lv == class_4066.field_18198 && this.field_4085.field_9229.nextInt(3) == 0) {
	...
	public void method_8564(int i, class_2338 arg, int j) {
		switch(i) {
			...
			case 1038:
				class_4184 lv = this.field_4088.field_1773.method_19418();
				if (lv.method_19332()) {
					double d = (double)arg.method_10263() - lv.method_19326().field_1352;
					double e = (double)arg.method_10264() - lv.method_19326().field_1351;
					double f = (double)arg.method_10260() - lv.method_19326().field_1350;
					double g = Math.sqrt(d * d + e * e + f * f);
					double h = lv.method_19326().field_1352;
					double k = lv.method_19326().field_1351;
					double l = lv.method_19326().field_1350;
					if (g > 0.0) {
						h += d / g * 2.0;
						k += e / g * 2.0;
						l += f / g * 2.0;
		...
		switch(i) {
			...
			case 1010:
				if (class_1792.method_7875(j) instanceof class_1813) {
					this.method_8562(((class_1813)class_1792.method_7875(j)).method_8009(), arg2);
				} else {
					this.method_8562(null, arg2);
				}
				break;
			case 1011:
			...
			case 1043:
				...
				break;
			case 1500:
				class_3962.method_18027(this.field_4085, arg2, j > 0);
				break;
			case 1501:
				this.field_4085
					.method_2947(
						...
						0.5F,
						2.6F + (this.field_4085.method_8409().nextFloat() - this.field_4085.method_8409().nextFloat()) * 0.8F,
						false
					);
				...
				for(int k = 0; k < 8; ++k) {
					this.field_4085
						.method_8406(
							...
							(double)arg2.method_10263() + Math.random(),
							(double)arg2.method_10264() + 1.2,
							(double)arg2.method_10260() + Math.random(),
							0.0,
							0.0,
							0.0
						);
			...
			case 1502:
				this.field_4085
					.method_2947(
						arg2,
						class_3417.field_19199,
						class_3419.field_15245,
						0.5F,
						2.6F + (this.field_4085.field_9229.nextFloat() - this.field_4085.field_9229.nextFloat()) * 0.8F,
						false
					);

				for(int k = 0; k < 5; ++k) {
					double u = (double)arg2.method_10263() + random.nextDouble() * 0.6 + 0.2;
					double d = (double)arg2.method_10264() + random.nextDouble() * 0.6 + 0.2;
					double e = (double)arg2.method_10260() + random.nextDouble() * 0.6 + 0.2;
					this.field_4085.method_8406(class_2398.field_11251, u, d, e, 0.0, 0.0, 0.0);
				}
				break;
			case 1503:
				this.field_4085.method_2947(arg2, class_3417.field_19197, class_3419.field_15245, 1.0F, 1.0F, false);

				for(int k = 0; k < 16; ++k) {
					double u = (double)((float)arg2.method_10263() + (5.0F + random.nextFloat() * 6.0F) / 16.0F);
					double d = (double)((float)arg2.method_10264() + 0.8125F);
					double e = (double)((float)arg2.method_10260() + (5.0F + random.nextFloat() * 6.0F) / 16.0F);
					double f = 0.0;
					double aa = 0.0;
					double ab = 0.0;
					this.field_4085.method_8406(class_2398.field_11251, u, d, e, 0.0, 0.0, 0.0);
			...
			case 2004:
				for(int k = 0; k < 20; ++k) {
					double u = (double)arg2.method_10263() + 0.5 + ((double)this.field_4085.field_9229.nextFloat() - 0.5) * 2.0;
					double d = (double)arg2.method_10264() + 0.5 + ((double)this.field_4085.field_9229.nextFloat() - 0.5) * 2.0;
					double e = (double)arg2.method_10260() + 0.5 + ((double)this.field_4085.field_9229.nextFloat() - 0.5) * 2.0;
					this.field_4085.method_8406(class_2398.field_11251, u, d, e, 0.0, 0.0, 0.0);
					this.field_4085.method_8406(class_2398.field_11240, u, d, e, 0.0, 0.0, 0.0);
				}
				break;
			case 2005:
			...
			case 2006:
				for(int k = 0; k < 200; ++k) {
					...
					double d = (double)(class_3532.method_15362(ad) * ac);
					double e = 0.01 + random.nextDouble() * 0.5;
					double f = (double)(class_3532.method_15374(ad) * ac);
					class_703 lv6 = this.method_3282(
						class_2398.field_11216, false, (double)arg2.method_10263() + d * 0.1, (double)arg2.method_10264() + 0.3, (double)arg2.method_10260() + f * 0.1, d, e, f
					);
					if (lv6 != null) {
						lv6.method_3075(ac);
					}
			...
			case 2008:
				this.field_4085
					.method_8406(
						class_2398.field_11236, (double)arg2.method_10263() + 0.5, (double)arg2.method_10264() + 0.5, (double)arg2.method_10260() + 0.5, 0.0, 0.0, 0.0
					);
				break;
			case 3000:
				this.field_4085
