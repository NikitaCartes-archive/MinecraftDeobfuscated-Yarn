	...
	public class_2293.class_2295 method_9800(StringReader stringReader) throws CommandSyntaxException {
		...
		if (lv.method_9786() != null) {
			...
			return commandContext -> {
				class_3494<class_1792> lvxx = commandContext.getSource().method_9211().method_3801().method_15201().method_15193(lv3);
				if (lvxx == null) {
					throw field_10811.create(lv3.toString());
				} else {
					return new class_2293.class_2296(lvxx, lv.method_9797());
				}
			};
		}
	}
