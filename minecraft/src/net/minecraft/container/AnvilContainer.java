...
public class AnvilContainer extends Container {
	...
	private final Inventory inventory = new BasicInventory(new StringTextComponent("Repair"), 2) {
		@Override
	...
	public AnvilContainer(PlayerInventory playerInventory, World world, PlayerEntity playerEntity) {
		this(playerInventory, world, BlockPos.ORIGIN, playerEntity);
	}

	public AnvilContainer(PlayerInventory playerInventory, World world, BlockPos blockPos, PlayerEntity playerEntity) {
		this.pos = blockPos;
		this.world = world;
		...
		this.addSlot(
			new Slot(this.result, 2, 134, 47) {
				...
				public boolean canTakeItems(PlayerEntity playerEntity) {
					return (playerEntity.abilities.creativeMode || playerEntity.experience >= AnvilContainer.this.field_7772)
				...
				public ItemStack onTakeItem(PlayerEntity playerEntity, ItemStack itemStack) {
					if (!playerEntity.abilities.creativeMode) {
						playerEntity.method_7316(-AnvilContainer.this.field_7772);
					}
	...
	public void method_7628() {
		...
		if (itemStack.isEmpty()) {
			...
			if (k == i && k > 0 && this.field_7772 >= 40) {
				this.field_7772 = 39;
			}

			if (this.field_7772 >= 40 && !this.player.abilities.creativeMode) {
				itemStack2 = ItemStack.EMPTY;
			}
	...
	public void addListener(ContainerListener containerListener) {
		...
		containerListener.onContainerPropertyUpdate(this, 0, this.field_7772);
	}
	...
	public boolean canUse(PlayerEntity playerEntity) {
		return !this.world.getBlockState(this.pos).matches(BlockTags.field_15486)
			? false
