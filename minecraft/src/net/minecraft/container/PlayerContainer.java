...
public class PlayerContainer extends CraftingContainer {
	...
	public CraftingInventory invCrafting = new CraftingInventory(this, 2, 2);
	public CraftingResultInventory invCraftingResult = new CraftingResultInventory();
	...
	public int getCraftingWidth() {
		return this.invCrafting.getInvWidth();
	}
