...
public class class_4076 extends class_2382 {
	...
	public static Stream<class_4076> method_20439(class_4076 arg, int i) {
		int j = arg.method_18674();
		int k = arg.method_18683();
		int l = arg.method_18687();
		return method_20438(j - i, k - i, l - i, j + i, k + i, l + i);
	}

	public static Stream<class_4076> method_20438(int i, int j, int k, int l, int m, int n) {
		return StreamSupport.stream(new AbstractSpliterator<class_4076>((long)((l - i + 1) * (m - j + 1) * (n - k + 1)), 64) {
			final class_3980 field_19263 = new class_3980(i, j, k, l, m, n);

			public boolean tryAdvance(Consumer<? super class_4076> consumer) {
				if (this.field_19263.method_17963()) {
					consumer.accept(new class_4076(this.field_19263.method_18671(), this.field_19263.method_18672(), this.field_19263.method_18673()));
					return true;
				} else {
					return false;
				}
