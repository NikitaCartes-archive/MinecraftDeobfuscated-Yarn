...
public class class_2538 extends class_2248 {
	...
	public void method_9548(class_2680 arg, class_1937 arg2, class_2338 arg3, class_1297 arg4) {
		if (!arg2.field_9236) {
			if (!arg.method_11654(field_11680)) {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		if (!arg2.field_9236) {
			if (arg2.method_8320(arg3).method_11654(field_11680)) {
				this.method_10780(arg2, arg3);
			}
		}
	}
	...
	private void method_10780(class_1937 arg, class_2338 arg2) {
		...
		boolean bl = lv.method_11654(field_11680);
		boolean bl2 = false;
		List<? extends class_1297> list = arg.method_8335(null, lv.method_11606(arg, arg2).method_1107().method_996(arg2));
		if (!list.isEmpty()) {
	...
	public boolean method_10778(class_2680 arg, class_2350 arg2) {
		...
		if (lv == this.field_11677) {
			return arg.method_11654(class_2537.field_11666) == arg2.method_10153();
		} else {
			return lv == this;
		}
	}
