...
public class class_3039 {
	...
	private static final DynamicCommandExceptionType field_13604 = new DynamicCommandExceptionType(
		object -> new class_2588("commands.drop.no_held_items", object)
	);
	private static final DynamicCommandExceptionType field_13606 = new DynamicCommandExceptionType(
		object -> new class_2588("commands.drop.no_loot_table", object)
	);
	...
	private static int method_13183(class_2168 arg, class_243 arg2, List<class_1799> list, class_3039.class_3040 arg3) throws CommandSyntaxException {
		...
		list.forEach(arg3x -> {
			class_1542 lvxx = new class_1542(lv, arg2.field_1352, arg2.field_1351, arg2.field_1350, arg3x.method_7972());
			lvxx.method_6988();
			lv.method_8649(lvxx);
		});
		arg3.accept(list);
