...
public class class_3898 implements AutoCloseable {
					...
					completableFuture.thenAcceptAsync(arg -> {
						if (arg != null) {
							...
							for(int ixx = 0; ixx < 16; ++ixx) {
								this.field_17215.method_15551(arg.method_12004().field_9181, ixx, arg.method_12004().field_9180, true);
							}
	...
	public CompletableFuture<Either<class_2791, class_3193.class_3724>> method_17236(class_3193 arg, class_2806 arg2) {
		...
		if (arg2 == class_2806.field_12798) {
			return CompletableFuture.supplyAsync(() -> {
				class_2791 lvxx = this.field_17227.method_12411(this.field_17214, lv.field_9181, lv.field_9180);
				if (lvxx != null) {
					lvxx.method_12043(this.field_17214.method_8510());
		...
		if (lv2 == null) {
			...
			return CompletableFuture.supplyAsync(() -> {
				...
				if (arg instanceof class_2821) {
					...
					lvxx = new class_2818(this.field_17214, (class_2839)arg, lv.field_9181, lv.field_9180);
				}

				lvxx.method_12207(() -> class_3193.method_14008(lv2.method_14005()));
				lvxx.method_12206();
				return lvxx;
	...
	public CompletableFuture<Either<class_2818, class_3193.class_3724>> method_17235(class_3193 arg) {
		...
		return completableFuture.thenApplyAsync(either -> either.flatMap(list -> {
				final class_2818 lvxx = (class_2818)list.get(list.size() / 2);
				if (!Objects.equals(lv, lvxx.method_12004())) {
					throw new IllegalStateException();
				} else if (!lvxx.method_12229()) {
					return Either.right(new class_3193.class_3724() {
						public String toString() {
	...
	private void method_17228(class_2791 arg, boolean bl) {
		try {
			...
			field_17212.error("Couldn't save chunk", var4);
		} catch (class_1939 var5) {
			field_17212.error("Couldn't save chunk; already in use by another instance of Minecraft?", var5);
		}
	}
