...
public class class_3898 extends class_3977 implements class_3193.class_3897 {
	...
	protected void method_17242(boolean bl) {
		if (bl) {
			List<class_3193> list = (List)this.field_17220
				.values()
				.stream()
		...
		if (arg2 == class_2806.field_12798) {
			...
			return completableFuture.thenComposeAsync(either -> {
				...
				if (!optional.isPresent()) {
					...
					class_2791 lvxx = (class_2791)optional.get();
					if (lvxx.method_12009().method_12165(arg2)) {
						CompletableFuture<Either<class_2791, class_3193.class_3724>> completableFuturexx;
						if (arg2 == class_2806.field_12805) {
							completableFuturexx = this.method_20617(arg, arg2);
						} else {
							completableFuturexx = arg2.method_20612(this.field_17214, this.field_17706, this.field_17215, arg2xx -> this.method_17226(arg), lvxx);
						}
	...
	private CompletableFuture<Either<class_2791, class_3193.class_3724>> method_17226(class_3193 arg) {
		...
		return completableFuture.thenApplyAsync(either -> {
			...
			return !lv.method_12165(class_2806.field_12803) ? class_3193.field_16426 : either.mapLeft(arg2 -> {
				class_1923 lvxx = arg.method_13994();
				class_2818 lv2;
				...
				lv2.method_12206();
				if (this.field_18307.add(lvxx.method_8324())) {
		...
		if (j != this.field_18243) {
			...
			for(class_3193 lv : this.field_17213.values()) {
				...
				this.method_17210(lv2, false).forEach(arg2 -> {
					int jxx = method_18719(lv2, arg2, true);
					boolean bl = jxx <= k;
