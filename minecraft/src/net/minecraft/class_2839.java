...
public class class_2839 implements class_2791 {
	...
	private volatile boolean field_12924;
	...
	public class_2839(class_1923 arg, class_2843 arg2) {
		this(
			...
			arg2,
			null,
			new class_2850<>(argx -> argx == null || argx.method_9564().method_11588(), arg),
			new class_2850<>(argx -> argx == null || argx == class_3612.field_15906, arg)
		);
	}
	...
	public class_2680 method_12010(class_2338 arg, class_2680 arg2, boolean bl) {
		...
		if (j >= 0 && j < 256) {
			if (this.field_12909[j >> 4] == class_2818.field_12852 && arg2.method_11614() == class_2246.field_10124) {
				...
				if (this.field_12918.method_12165(class_2806.field_12795)
					&& arg2 != lv2
					&& (arg2.method_11581(this, arg) != lv2.method_11581(this, arg) || arg2.method_11630() != lv2.method_11630() || arg2.method_16386() || lv2.method_16386())
					)
				 {
					class_3568 lv3 = this.method_12023();
					lv3.method_15559(arg);
				}

				EnumSet<class_2902.class_2903> enumSet = this.method_12009().method_12160();
				EnumSet<class_2902.class_2903> enumSet2 = null;

				for(class_2902.class_2903 lv4 : enumSet) {
					class_2902 lv5 = (class_2902)this.field_12912.get(lv4);
					if (lv5 == null) {
						if (enumSet2 == null) {
				...
				for(class_2902.class_2903 lv4 : enumSet) {
					((class_2902)this.field_12912.get(lv4)).method_12597(i & 15, j, k & 15, arg2);
				}
	...
	public class_2487 method_20598(class_2338 arg) {
		...
		return lv != null ? lv.method_11007(new class_2487()) : (class_2487)this.field_12927.get(arg);
	}
