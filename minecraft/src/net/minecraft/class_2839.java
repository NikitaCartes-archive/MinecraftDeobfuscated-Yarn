...
public class class_2839 implements class_2791 {
	...
	private final Map<String, class_3449> field_12915 = Maps.newHashMap();
	private final Map<String, LongSet> field_12930 = Maps.newHashMap();
	...
	private final Map<class_2893.class_2894, BitSet> field_12926 = Maps.newHashMap();
	private volatile boolean field_12914;

	public class_2839(int i, int j, class_2843 arg, class_2826[] args, class_2850<class_2248> arg2, class_2850<class_3611> arg3) {
		this(new class_1923(i, j), arg, arg2, arg3);
	...
	public class_2839(class_1923 arg, class_2843 arg2, class_2850<class_2248> arg3, class_2850<class_3611> arg4) {
	...
	public class_2680 method_8320(class_2338 arg) {
		if (class_1937.method_8518(arg)) {
			...
			return this.method_12006()[arg.method_10264() >> 4] == class_2818.field_12852
				? class_2246.field_10124.method_9564()
				: this.method_12006()[arg.method_10264() >> 4].method_12254(arg.method_10263() & 15, arg.method_10264() & 15, arg.method_10260() & 15);
		}
	}
	...
	public class_3610 method_8316(class_2338 arg) {
		...
		return j >= 0 && j < 256 && this.field_12909[j >> 4] != class_2818.field_12852
			? this.field_12909[j >> 4].method_12255(i & 15, j & 15, k & 15)
	...
	public class_2680 method_12010(class_2338 arg, class_2680 arg2, boolean bl) {
		...
		if (j >= 0 && j < 256) {
			if (this.field_12909[j >> 4] == class_2818.field_12852 && arg2.method_11614() == class_2246.field_10124) {
				...
				if (!this.method_12009().method_12160()) {
					class_2902 lv3 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13195);
					class_2902 lv4 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13194);
					if (lv3 == null || lv4 == null) {
						EnumSet<class_2902.class_2903> enumSet = EnumSet.noneOf(class_2902.class_2903.class);
						if (lv3 == null) {
							enumSet.add(class_2902.class_2903.field_13195);
						}

						if (lv4 == null) {
							enumSet.add(class_2902.class_2903.field_13194);
						}

						class_2902.method_16684(this, enumSet);
						lv3 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13195);
						lv4 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13194);
					}

					lv3.method_12597(i & 15, j, k & 15, arg2);
					lv4.method_12597(i & 15, j, k & 15, arg2);
				} else {
					class_2902 lv3 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13197);
					class_2902 lv4 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13203);
					class_2902 lv5 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13200);
					class_2902 lv6 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13202);
					if (lv3 == null || lv4 == null || lv5 == null || lv6 == null) {
						EnumSet<class_2902.class_2903> enumSet2 = EnumSet.noneOf(class_2902.class_2903.class);
						if (lv3 == null) {
							enumSet2.add(class_2902.class_2903.field_13197);
						}

						if (lv4 == null) {
							enumSet2.add(class_2902.class_2903.field_13203);
						}

						if (lv5 == null) {
							enumSet2.add(class_2902.class_2903.field_13200);
						}

						if (lv6 == null) {
							enumSet2.add(class_2902.class_2903.field_13202);
						}

						class_2902.method_16684(this, enumSet2);
						lv3 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13197);
						lv4 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13203);
						lv5 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13200);
						lv6 = (class_2902)this.field_12912.get(class_2902.class_2903.field_13202);
					}

					lv3.method_12597(i & 15, j, k & 15, arg2);
					lv4.method_12597(i & 15, j, k & 15, arg2);
					lv5.method_12597(i & 15, j, k & 15, arg2);
					lv6.method_12597(i & 15, j, k & 15, arg2);
				}
