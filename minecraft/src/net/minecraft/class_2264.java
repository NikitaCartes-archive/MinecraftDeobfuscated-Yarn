...
public class class_2264 implements ArgumentType<class_2267> {
	...
	public static class_2264.class_2265 method_9702(CommandContext<class_2168> commandContext, String string) {
		class_2338 lv = commandContext.<class_2267>getArgument(string, class_2267.class).method_9704(commandContext.getSource());
		return new class_2264.class_2265(lv.method_10263(), lv.method_10260());
	}
	...
	public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandContext, SuggestionsBuilder suggestionsBuilder) {
		if (!(commandContext.getSource() instanceof class_2172)) {
			...
			if (!string.isEmpty() && string.charAt(0) == '^') {
				...
				collection = ((class_2172)commandContext.getSource()).method_9274(false);
			}
