...
public class class_1671 extends class_1297 implements class_3856 {
	...
	public void method_7474(class_1297 arg, float f, float g) {
		...
		this.field_6004 = this.field_5965;
		this.field_7613 = 0;
		this.field_5967 += arg.field_5967;
		this.field_5984 += arg.field_5984;
		this.field_6006 += arg.field_6006;
	}
	...
	public void method_5773() {
		...
		if (this.method_7476()) {
			if (this.field_7616 == null) {
				UUID uUID = (UUID)((Optional)this.field_6011.method_12789(field_7611)).orElse(null);
			...
			if (this.field_7616 != null) {
				if (this.field_7616.method_6128()) {
					...
					double d = 1.5;
					double e = 0.1;
					this.field_7616.field_5967 += lv2.field_1352 * 0.1 + (lv2.field_1352 * 1.5 - this.field_7616.field_5967) * 0.5;
					this.field_7616.field_5984 += lv2.field_1351 * 0.1 + (lv2.field_1351 * 1.5 - this.field_7616.field_5984) * 0.5;
					this.field_7616.field_6006 += lv2.field_1350 * 0.1 + (lv2.field_1350 * 1.5 - this.field_7616.field_6006) * 0.5;
				}
	...
	private boolean method_7476() {
		return ((Optional)this.field_6011.method_12789(field_7611)).orElse(null) != null;
	}
