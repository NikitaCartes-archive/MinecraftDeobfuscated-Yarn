...
public class class_1671 extends class_1297 implements class_3856, class_1676 {
	...
	public void method_5773() {
		...
		if (this.method_7476()) {
			if (this.field_7616 == null) {
				((OptionalInt)this.field_6011.method_12789(field_7611)).ifPresent(i -> {
					class_1297 lvxx = this.field_6002.method_8469(i);
					if (lvxx instanceof class_1309) {
						this.field_7616 = (class_1309)lvxx;
					}
				});
			}
	...
	private boolean method_7476() {
		return ((OptionalInt)this.field_6011.method_12789(field_7611)).isPresent();
	}
	...
	public void method_5711(byte b) {
		if (b == 17 && this.field_6002.field_9236) {
			if (!this.method_20308()) {
				for(int i = 0; i < this.field_5974.nextInt(3) + 2; ++i) {
					this.field_6002
						.method_8406(
