	...
	public void method_6636() {
		if (!this.field_6002.field_9236) {
			...
			for(int j = 0; j < i; ++j) {
				...
				if (lv != null) {
					lv.field_5984 += (double)(this.field_5974.nextFloat() * 0.05F);
					lv.field_5967 += (double)((this.field_5974.nextFloat() - this.field_5974.nextFloat()) * 0.1F);
					lv.field_6006 += (double)((this.field_5974.nextFloat() - this.field_5974.nextFloat()) * 0.1F);
				}
			}
		}
