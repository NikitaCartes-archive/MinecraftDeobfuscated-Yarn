...
public class class_1472 extends class_1429 {
	...
	private final class_1715 field_6866 = new class_1715(new class_1703(-1) {
		@Override
	...
	public class_1472(class_1937 arg) {
		super(class_1299.field_6115, arg);
		this.method_5835(0.9F, 1.3F);
	}
	...
	public void method_6636() {
		if (!this.field_6002.field_9236) {
			...
			for (int j = 0; j < i; j++) {
				...
				if (lv != null) {
					lv.field_5984 = lv.field_5984 + (double)(this.field_5974.nextFloat() * 0.05F);
					lv.field_5967 = lv.field_5967 + (double)((this.field_5974.nextFloat() - this.field_5974.nextFloat()) * 0.1F);
					lv.field_6006 = lv.field_6006 + (double)((this.field_5974.nextFloat() - this.field_5974.nextFloat()) * 0.1F);
				}
			}
		}
	...
	public class_1472 method_6640(class_1296 arg) {
		...
		class_1472 lv2 = new class_1472(this.field_6002);
	...
	private class_1767 method_6639(class_1429 arg, class_1429 arg2) {
		...
		this.field_6866.method_5447(0, new class_1799(class_1769.method_7803(lv)));
		this.field_6866.method_5447(1, new class_1799(class_1769.method_7803(lv2)));
		class_1799 lv3 = arg.field_6002.method_8433().method_8129(this.field_6866, ((class_1472)arg).field_6002);
		class_1792 lv4 = lv3.method_7909();
		class_1767 lv5;
		if (lv4 instanceof class_1769) {
			lv5 = ((class_1769)lv4).method_7802();
		} else {
			lv5 = this.field_6002.field_9229.nextBoolean() ? lv : lv2;
		}
