...
public abstract class class_437 extends class_362 implements class_4068 {
				...
				if (lv.method_10845() == class_2558.class_2559.field_11749) {
					...
					try {
						...
						if (this.minecraft.field_1690.field_1817) {
							...
							this.minecraft.method_1507(new class_407(this::confirmLink, lv.method_10844(), false));
						} else {
							this.openLink(uRI);
						}
					...
					URI uRI = new File(lv.method_10844()).toURI();
					this.openLink(uRI);
	...
	public static boolean hasControlDown() {
		if (class_310.field_1703) {
			return class_3675.method_15987(class_310.method_1551().field_1704.method_4490(), 343)
				|| class_3675.method_15987(class_310.method_1551().field_1704.method_4490(), 347);
		} else {
			return class_3675.method_15987(class_310.method_1551().field_1704.method_4490(), 341)
