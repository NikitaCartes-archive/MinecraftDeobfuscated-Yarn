...
public class class_1548 extends class_1588 {
	...
	private static final class_2940<Boolean> field_19170 = class_2945.method_12791(class_1548.class, class_2943.field_13323);
	...
	public class_1548(class_1299<? extends class_1548> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	protected void method_5693() {
		...
		this.field_6011.method_12784(field_19170, false);
	}
	...
	public void method_5652(class_2487 arg) {
		...
		if (this.field_6011.method_12789(field_19170)) {
			arg.method_10556("d20", true);
		}
	}
	...
	public void method_5749(class_2487 arg) {
		...
		this.field_6011.method_12778(field_19170, arg.method_10577("d20"));
	...
	protected void method_6099(class_1282 arg, int i, boolean bl) {
		...
		if (this.method_20232()) {
			this.method_5706(class_1802.field_19174);
		}
	...
	public boolean method_20232() {
		return this.field_6011.method_12789(field_19170);
	}
	...
	private void method_7006() {
		if (!this.field_6002.field_9236) {
			...
			this.field_6002.method_8437(this, this.field_5987, this.field_6010, this.field_6035, (float)this.field_7225 * f, lv);
			this.method_5650();
			this.method_7001();
		}
	}
	...
	@Environment(EnvType.CLIENT)
	public void method_20233() {
		this.field_6011.method_12778(field_19170, true);
	}
}
