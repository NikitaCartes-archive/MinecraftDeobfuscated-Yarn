...
public class BlockStateModelGenerator {
			...
			.accept(
				MultipartBlockStateSupplier.create(Blocks.field_10333)
					...
					.with(
						...
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_bottle0"))
					)
					.with(
						When.create().set(Properties.HAS_BOTTLE_1, true),
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_bottle1"))
					)
					.with(
						When.create().set(Properties.HAS_BOTTLE_2, true),
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_bottle2"))
					)
					.with(
						When.create().set(Properties.HAS_BOTTLE_0, false),
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_empty0"))
					)
					.with(
						When.create().set(Properties.HAS_BOTTLE_1, false),
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_empty1"))
					)
					.with(
						When.create().set(Properties.HAS_BOTTLE_2, false),
						BlockStateVariant.create().put(VariantSettings.MODEL, Texture.getSubId(Blocks.field_10333, "_empty2"))
					)
			);
	}
	...
	private void registerFarmland() {
		Texture texture = new Texture()
			...
			.put(TextureKey.field_23015, Texture.getId(Blocks.field_10362));
		Texture texture2 = new Texture()
			.put(TextureKey.field_23000, Texture.getId(Blocks.field_10566))
				...
				VariantsBlockStateSupplier.create(Blocks.field_10589)
					.coordinate(
						BlockStateVariantMap.create(Properties.ATTACHED, Properties.EAST, Properties.NORTH, Properties.SOUTH, Properties.WEST)
							...
							.register(
								false, false, true, false, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10589, "_n"))
							)
							.register(
								false,
								false,
							...
							.register(
								false, true, true, false, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10589, "_ne"))
							)
							.register(
								false,
								true,
							...
							.register(
								false, false, true, true, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10589, "_ns"))
							)
							.register(
								false,
								true,
							...
							.register(
								false, true, true, true, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10589, "_nse"))
							)
							.register(
								false,
								true,
							...
							.register(
								false, true, true, true, true, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10589, "_nsew"))
							)
							.register(
								true,
								false,
				...
				VariantsBlockStateSupplier.create(Blocks.field_10597)
					.coordinate(
						BlockStateVariantMap.create(Properties.EAST, Properties.NORTH, Properties.SOUTH, Properties.UP, Properties.WEST)
							...
							.register(
								false, false, true, false, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10597, "_1"))
							)
							.register(
								false,
								false,
							...
							.register(
								false, false, false, true, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10597, "_u"))
							)
							.register(
								false, false, true, true, false, BlockStateVariant.create().put(VariantSettings.MODEL, ModelIds.getBlockSubModelId(Blocks.field_10597, "_1u"))
							)
							.register(
								false,
								false,
	...
	public void register() {
		...
		this.registerTexturePool(Blocks.field_10344, TexturedModel.WALL_CUBE_BOTTOM_TOP)
			.wall(Blocks.field_10413)
			.stairs(Blocks.field_10420)
			.slab(Blocks.field_10624);
	...
	class BlockTexturePool {
		...
		public BlockStateModelGenerator.BlockTexturePool stairs(Block stairsBlock) {
			...
			BlockStateModelGenerator.this.blockStateCollector
				.accept(BlockStateModelGenerator.createStairsBlockState(stairsBlock, identifier, identifier2, identifier3));
			return this;
		}
	}
