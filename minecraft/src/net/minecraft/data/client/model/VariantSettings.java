...
public class VariantSettings {
	public static final VariantSetting<VariantSettings.Rotation> X = new VariantSetting<>("x", rotation -> new JsonPrimitive(rotation.degree));
	public static final VariantSetting<VariantSettings.Rotation> Y = new VariantSetting<>("y", rotation -> new JsonPrimitive(rotation.degree));
