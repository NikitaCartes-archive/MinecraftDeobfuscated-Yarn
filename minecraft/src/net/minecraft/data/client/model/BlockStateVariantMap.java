											...
											comparable3 -> this.fourth
													...
													.forEach(
														comparable4 -> this.register(
																(T1)comparable, (T2)comparable2, (T3)comparable3, (T4)comparable4, arg.method_35906(comparable, comparable2, comparable3, comparable4)
															)
													)
										)
							)
											...
											comparable3 -> this.fourth
													...
													.forEach(
														comparable4 -> this.register(
																...
																(T3)comparable3,
																(T4)comparable4,
																(List<BlockStateVariant>)arg.method_35906(comparable, comparable2, comparable3, comparable4)
															)
													)
										)
							)
														...
														comparable4 -> this.fifth
																...
																.forEach(
																	comparable5 -> this.register(
																			...
																			(T4)comparable4,
																			(T5)comparable5,
																			arg.method_35905(comparable, comparable2, comparable3, comparable4, comparable5)
																		)
																)
													)
										)
														...
														comparable4 -> this.fifth
																...
																.forEach(
																	comparable5 -> this.register(
																			...
																			(T4)comparable4,
																			(T5)comparable5,
																			(List<BlockStateVariant>)arg.method_35905(comparable, comparable2, comparable3, comparable4, comparable5)
																		)
																)
													)
										)
								...
								comparable2 -> this.third
										...
										.forEach(
											comparable3 -> this.register(
													(T1)comparable, (T2)comparable2, (T3)comparable3, (List<BlockStateVariant>)triFunction.apply(comparable, comparable2, comparable3)
												)
										)
							)
				);
