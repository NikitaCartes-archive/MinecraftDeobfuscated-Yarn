											...
											thirdValue -> this.fourth
													...
													.forEach(
														fourthValue -> this.register(
																(T1)firstValue, (T2)secondValue, (T3)thirdValue, (T4)fourthValue, variantFactory.apply(firstValue, secondValue, thirdValue, fourthValue)
															)
													)
										)
							)
											...
											thirdValue -> this.fourth
													...
													.forEach(
														fourthValue -> this.register(
																...
																(T3)thirdValue,
																(T4)fourthValue,
																(List<BlockStateVariant>)variantFactory.apply(firstValue, secondValue, thirdValue, fourthValue)
															)
													)
										)
							)
														...
														fourthValue -> this.fifth
																...
																.forEach(
																	fifthValue -> this.register(
																			...
																			(T4)fourthValue,
																			(T5)fifthValue,
																			(List<BlockStateVariant>)variantFactory.apply(firstValue, secondValue, thirdValue, fourthValue, fifthValue)
																		)
																)
													)
										)
				...
				.forEach(
					firstValue -> this.second
							...
							.forEach(
								secondValue -> this.third
										.getValues()
										.forEach(thirdValue -> this.register((T1)firstValue, (T2)secondValue, (T3)thirdValue, variantFactory.apply(firstValue, secondValue, thirdValue)))
							)
				);
			return this;
		}
								...
								secondValue -> this.third
										...
										.forEach(
											thirdValue -> this.register(
													(T1)firstValue, (T2)secondValue, (T3)thirdValue, (List<BlockStateVariant>)variantFactory.apply(firstValue, secondValue, thirdValue)
												)
										)
							)
				);
