...
public class Main {
	...
	public static DataGenerator create(
		...
		TagProvider<Block> tagProvider3 = pack4.addProvider(outputx -> new OneTwentyBlockTagProvider(outputx, completableFuture2, tagProvider.getTagLookupFuture()));
		pack4.addProvider(outputx -> new OneTwentyItemTagProvider(outputx, completableFuture2, tagProvider2.getTagLookupFuture(), tagProvider3.getTagLookupFuture()));
		pack4.addProvider(toFactory(OneTwentyBiomeTagProvider::new, completableFuture2));
		pack4.addProvider(OneTwentyLootTableProviders::createOneTwentyProvider);
		pack4.addProvider(toFactory(OneTwentyAdvancementProviders::createOneTwentyProvider, completableFuture2));
		pack4.addProvider(toFactory(DynamicRegistriesProvider::new, completableFuture2));
		pack4.addProvider(outputx -> MetadataProvider.create(outputx, Text.translatable("dataPack.update_1_20.description"), FeatureSet.of(FeatureFlags.UPDATE_1_20)));
