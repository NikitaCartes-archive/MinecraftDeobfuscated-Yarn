			...
			LootTable.builder()
				...
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.SPECTRAL_ARROW).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(5.0F, 18.0F))))
						.withEntry(ItemEntry.builder(Blocks.GILDED_BLACKSTONE).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(5.0F, 10.0F))))
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						.withRolls(ConstantLootTableRange.create(1))
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_SHOVEL)
								.setWeight(10)
						...
						.withEntry(ItemEntry.builder(Items.ANCIENT_DEBRIS).setWeight(10).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Items.SADDLE).setWeight(15).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Blocks.GOLD_BLOCK).setWeight(10).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 4.0F))))
						.withEntry(
						...
						.withEntry(EmptyEntry.Serializer().setWeight(10))
				)
				.withPool(
					LootPool.builder()
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.ANCIENT_DEBRIS).setWeight(5).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Items.NETHERITE_SCRAP).setWeight(5).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Items.SPECTRAL_ARROW).setWeight(10).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(5.0F, 20.0F))))
						.withEntry(ItemEntry.builder(Items.PIGLIN_BANNER_PATTERN).setWeight(10).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Items.MUSIC_DISC_PIGSTEP).setWeight(10).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(EmptyEntry.Serializer().setWeight(10))
				)
				.withPool(
					LootPool.builder()
						.withRolls(ConstantLootTableRange.create(2))
						.withEntry(ItemEntry.builder(Items.BOOK).withFunction(new EnchantRandomlyLootFunction.Builder().add(Enchantments.SOUL_SPEED)))
						.withEntry(
							ItemEntry.builder(Items.GOLDEN_BOOTS)
								.withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1)))
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Blocks.ANCIENT_DEBRIS).setWeight(10).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Items.NETHERITE_SCRAP).setWeight(10).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.withEntry(ItemEntry.builder(Blocks.ANCIENT_DEBRIS).setWeight(5).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2))))
						.withEntry(
						...
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_CHESTPLATE)
								.setWeight(6)
								.withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
								.withFunction(EnchantRandomlyLootFunction.builder())
						)
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_HELMET)
								.setWeight(6)
								.withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
								.withFunction(EnchantRandomlyLootFunction.builder())
						)
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_LEGGINGS)
								.setWeight(6)
								.withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
								.withFunction(EnchantRandomlyLootFunction.builder())
						)
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_BOOTS)
								.setWeight(6)
								.withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
								.withFunction(EnchantRandomlyLootFunction.builder())
						)
						.withEntry(ItemEntry.builder(Items.NETHERITE_SWORD).setWeight(6).withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_CHESTPLATE).setWeight(5).withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
						)
						.withEntry(ItemEntry.builder(Items.NETHERITE_HELMET).setWeight(5).withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.withEntry(ItemEntry.builder(Items.NETHERITE_BOOTS).setWeight(5).withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.withEntry(
							ItemEntry.builder(Items.NETHERITE_LEGGINGS).setWeight(5).withFunction(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
						)
