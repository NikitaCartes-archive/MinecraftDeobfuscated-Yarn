...
public class ChestLootTableGenerator implements Consumer<BiConsumer<Identifier, LootSupplier.Builder>> {
	public void method_10399(BiConsumer<Identifier, LootSupplier.Builder> biConsumer) {
		...
		biConsumer.accept(
			...
			LootSupplier.builder()
				.withPool(LootPool.builder().method_352(ConstantLootTableRange.create(1)).method_351(ItemEntry.method_411(Items.field_8207)))
				.withPool(
					LootPool.builder()
		...
		biConsumer.accept(
			...
			LootSupplier.builder()
				...
				.withPool(LootPool.builder().method_352(ConstantLootTableRange.create(1)).method_351(ItemEntry.method_411(Items.field_8463)))
		);
		biConsumer.accept(
			...
			LootSupplier.builder()
				.withPool(
					LootPool.builder()
						...
						.method_351(ItemEntry.method_411(Items.field_8807))
						.method_351(
							ItemEntry.method_411(Items.field_8529).method_438(EnchantWithLevelsLootFunction.builder(ConstantLootTableRange.create(30)).allowTreasureEnchantments())
						)
				)
		);
		biConsumer.accept(
		...
		biConsumer.accept(
			...
			LootSupplier.builder()
				.withPool(LootPool.builder().method_352(UniformLootTableRange.between(0.0F, 1.0F)).method_351(ItemEntry.method_411(Items.field_8399)))
				.withPool(
					LootPool.builder()
			...
			LootSupplier.builder()
				.withPool(
					LootPool.builder()
						...
						.method_351(ItemEntry.method_411(Items.field_8600).setWeight(5).method_438(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 2.0F))))
				)
		);
		biConsumer.accept(
