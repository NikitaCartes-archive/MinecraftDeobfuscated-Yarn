			...
			LootTable.builder()
				...
				.pool(
					LootPool.builder()
						...
						.with(ItemEntry.builder(Items.SPECTRAL_ARROW).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 12.0F))))
						.with(ItemEntry.builder(Blocks.GILDED_BLACKSTONE).apply(SetCountLootFunction.builder(UniformLootTableRange.between(5.0F, 8.0F))))
						...
						.with(ItemEntry.builder(Items.GOLD_INGOT).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 8.0F))))
						.with(ItemEntry.builder(Items.IRON_INGOT).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 8.0F))))
					...
					LootPool.builder()
						...
						.with(
							ItemEntry.builder(Items.DIAMOND_SHOVEL)
								.weight(5)
								.apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.15F, 0.45F)))
								.apply(EnchantRandomlyLootFunction.builder())
						)
						.with(ItemEntry.builder(Items.NETHERITE_SCRAP).weight(2).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.ANCIENT_DEBRIS).weight(3).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.SADDLE).weight(10).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Blocks.GOLD_BLOCK).weight(25).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 4.0F))))
						.with(
						...
						.with(EmptyEntry.Serializer().weight(45))
				)
				.pool(
					LootPool.builder()
						.rolls(UniformLootTableRange.between(3.0F, 4.0F))
						.with(ItemEntry.builder(Blocks.GLOWSTONE).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 5.0F))))
						.with(ItemEntry.builder(Blocks.GILDED_BLACKSTONE).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 5.0F))))
			...
			LootTable.builder()
				.pool(
					LootPool.builder()
						...
						.with(ItemEntry.builder(Items.ANCIENT_DEBRIS).weight(2).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.NETHERITE_SCRAP).weight(2).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.SPECTRAL_ARROW).weight(16).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 15.0F))))
						.with(ItemEntry.builder(Items.PIGLIN_BANNER_PATTERN).weight(5).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.MUSIC_DISC_PIGSTEP).weight(3).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.BOOK).weight(10).apply(new EnchantRandomlyLootFunction.Builder().add(Enchantments.SOUL_SPEED)))
						.with(EmptyEntry.Serializer().weight(50))
				)
				.pool(
					LootPool.builder()
						...
						.with(ItemEntry.builder(Items.GOLD_INGOT).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 6.0F))))
						.with(ItemEntry.builder(Items.IRON_INGOT).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 6.0F))))
						.with(ItemEntry.builder(Items.GOLDEN_SWORD).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
				...
				.pool(
					LootPool.builder()
						.rolls(UniformLootTableRange.between(3.0F, 5.0F))
						...
						.with(ItemEntry.builder(Items.MAGMA_CREAM).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 6.0F))))
		...
		biConsumer.accept(
			...
			LootTable.builder()
				.pool(
					LootPool.builder()
						.rolls(UniformLootTableRange.between(1.0F, 2.0F))
						.with(ItemEntry.builder(Items.NETHERITE_INGOT).weight(10).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Blocks.ANCIENT_DEBRIS).weight(14).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Items.NETHERITE_SCRAP).weight(10).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
						.with(ItemEntry.builder(Blocks.ANCIENT_DEBRIS).weight(1).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2))))
						.with(
							ItemEntry.builder(Items.DIAMOND_SWORD)
								.weight(10)
								.apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F)))
								.apply(EnchantRandomlyLootFunction.builder())
						)
						.with(
						...
						.with(ItemEntry.builder(Items.DIAMOND_SWORD).weight(6).apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.with(ItemEntry.builder(Items.DIAMOND_CHESTPLATE).weight(5).apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.with(ItemEntry.builder(Items.DIAMOND_HELMET).weight(5).apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.with(ItemEntry.builder(Items.DIAMOND_BOOTS).weight(5).apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.with(ItemEntry.builder(Items.DIAMOND_LEGGINGS).weight(5).apply(SetDamageLootFunction.builder(UniformLootTableRange.between(0.2F, 0.65F))))
						.with(ItemEntry.builder(Items.DIAMOND).weight(5).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 3.0F))))
				)
				.pool(
					LootPool.builder()
						.rolls(UniformLootTableRange.between(2.0F, 4.0F))
						.with(ItemEntry.builder(Items.SPECTRAL_ARROW).apply(SetCountLootFunction.builder(UniformLootTableRange.between(5.0F, 21.0F))))
						...
						.with(ItemEntry.builder(Blocks.GILDED_BLACKSTONE).apply(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 5.0F))))
						.with(ItemEntry.builder(Items.MAGMA_CREAM).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 8.0F))))
						.with(ItemEntry.builder(Items.IRON_NUGGET).apply(SetCountLootFunction.builder(UniformLootTableRange.between(8.0F, 16.0F))))
				)
		);
		biConsumer.accept(
