...
public class BlockTagsProvider extends AbstractTagProvider<Block> {
	...
	protected void configure() {
		...
		this.getOrCreateTagBuilder(BlockTags.BEE_GROWABLES).addTag(BlockTags.CROPS).add(Blocks.SWEET_BERRY_BUSH);
		...
		this.getOrCreateTagBuilder(BlockTags.BASE_STONE_OVERWORLD).add(Blocks.STONE).add(Blocks.GRANITE).add(Blocks.DIORITE).add(Blocks.ANDESITE);
