...
public class FishingLootTableGenerator implements Consumer<BiConsumer<Identifier, LootSupplier.Builder>> {
	public static final LootCondition.Builder field_11346 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9417));
	public static final LootCondition.Builder field_11347 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9432));
	public static final LootCondition.Builder field_11350 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9474));
	public static final LootCondition.Builder field_11349 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9440));
	public static final LootCondition.Builder field_11348 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9426));
	public static final LootCondition.Builder field_11351 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9405));
	public static final LootCondition.Builder field_11352 = LocationCheckLootCondition.method_884(new LocationPredicate.Builder().method_9024(Biomes.field_9468));
	...
	public void method_10405(BiConsumer<Identifier, LootSupplier.Builder> biConsumer) {
			...
			LootSupplier.builder()
				.withPool(
					LootPool.builder()
						...
						.method_351(LootTableEntry.builder(LootTables.field_266).setWeight(10).setQuality(-2))
						.method_351(LootTableEntry.builder(LootTables.field_854).setWeight(5).setQuality(2))
						.method_351(LootTableEntry.builder(LootTables.field_795).setWeight(85).setQuality(-1))
				)
		);
		biConsumer.accept(
		...
		biConsumer.accept(
			...
			LootSupplier.builder()
				.withPool(
					LootPool.builder()
						.method_351(ItemEntry.method_411(Items.field_8370).setWeight(10).method_438(SetDamageLootFunction.builder(UniformLootTableRange.between(0.0F, 0.9F))))
						...
						.method_351(ItemEntry.method_411(Items.field_8378).setWeight(2).method_438(SetDamageLootFunction.builder(UniformLootTableRange.between(0.0F, 0.9F))))
						...
						.method_351(ItemEntry.method_411(Items.field_8794).setWeight(1).method_438(SetCountLootFunction.builder(ConstantLootTableRange.create(10))))
