	...
	public void method_10405(BiConsumer<Identifier, LootSupplier.Builder> biConsumer) {
		...
		biConsumer.accept(
			...
			LootSupplier.create()
				.withPool(
					LootPool.create()
						.method_351(ItemEntry.method_411(Items.field_8370).setWeight(10).method_438(SetDamageLootFunction.method_633(UniformLootTableRange.between(0.0F, 0.9F))))
						...
						.method_351(ItemEntry.method_411(Items.field_8378).setWeight(2).method_438(SetDamageLootFunction.method_633(UniformLootTableRange.between(0.0F, 0.9F))))
