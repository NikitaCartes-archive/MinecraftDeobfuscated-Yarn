...
public class FishingLootTableGenerator implements Consumer<BiConsumer<Identifier, LootSupplier.Builder>> {
	...
	public static final class_4570.Builder field_11348 = LocationCheckLootCondition.builder(
		LocationPredicate.Builder.method_22484().biome(Biomes.MODIFIED_JUNGLE)
	);
			...
			LootSupplier.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(
							((LeafEntry.Builder)ItemEntry.builder(Blocks.BAMBOO)
									.method_421(
