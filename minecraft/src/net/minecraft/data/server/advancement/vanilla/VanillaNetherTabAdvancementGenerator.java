	...
	public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<AdvancementEntry> exporter) {
		...
		AdvancementEntry advancementEntry3 = Advancement.Builder.create()
			...
			.criterion(
				...
				TickCriterion.Conditions.createLocation(
					LocationPredicate.Builder.createStructure(lookup.<Structure>getWrapperOrThrow(RegistryKeys.STRUCTURE).getOrThrow(StructureKeys.FORTRESS))
				)
			)
		...
		AdvancementEntry advancementEntry13 = Advancement.Builder.create()
			...
			.criterion(
				"bastion",
				TickCriterion.Conditions.createLocation(
					LocationPredicate.Builder.createStructure(lookup.<Structure>getWrapperOrThrow(RegistryKeys.STRUCTURE).getOrThrow(StructureKeys.BASTION_REMNANT))
				)
			)
