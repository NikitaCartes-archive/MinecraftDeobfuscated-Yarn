...
public class RecipesProvider implements DataProvider {
	...
	private void generate(Consumer<RecipeJsonProvider> consumer) {
		...
		ShapedRecipeJsonFactory.create(Items.field_8572)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8112)
			.input('#', Blocks.field_10146)
			...
			.criterion("has_black_wool", this.method_10426(Blocks.field_10146))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8112)
			.input(Items.field_8258)
			.input(Items.field_8226)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapedRecipeJsonFactory.create(Items.field_8128)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8893)
			.input('#', Blocks.field_10514)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_blue_wool", this.method_10426(Blocks.field_10514))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8893)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10384)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_packed_ice", this.method_10424(NumberRange.Integer.atLeast(9), Blocks.field_10225))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10166)
			...
			.pattern("XXX")
			.pattern("XXX")
			.criterion("has_at_least_9_bonemeal", this.method_10424(NumberRange.Integer.atLeast(9), item))
			.offerTo(consumer);
		...
		ShapelessRecipeJsonFactory.create(Items.field_8324, 9)
			...
			.group("bonemeal")
			.criterion("has_at_least_9_bonemeal", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8324))
		...
		ShapedRecipeJsonFactory.create(Items.field_8124)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8464)
			.input('#', Blocks.field_10113)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_brown_wool", this.method_10426(Blocks.field_10113))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8464)
			.input(Items.field_8258)
		...
		ShapelessRecipeJsonFactory.create(Items.field_8713, 9)
			...
			.criterion("has_at_least_9_coal", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8713))
		...
		ShapedRecipeJsonFactory.create(Items.field_8629)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8390)
			.input('#', Blocks.field_10619)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_cyan_wool", this.method_10426(Blocks.field_10619))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8390)
			.input(Items.field_8258)
		...
		ShapelessRecipeJsonFactory.create(Items.field_8477, 9)
			...
			.criterion("has_at_least_9_diamond", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8477))
		...
		ShapelessRecipeJsonFactory.create(Items.field_8687, 9)
			...
			.criterion("has_at_least_9_emerald", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8687))
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10205)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_gold_ingot", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8695))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8695)
			...
			.pattern("###")
			.group("gold_ingot")
			.criterion("has_at_least_9_gold_nugget", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8397))
		...
		ShapedRecipeJsonFactory.create(Items.field_8617)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8754)
			.input('#', Blocks.field_10423)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_gray_wool", this.method_10426(Blocks.field_10423))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8754)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Items.field_8295)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8368)
			.input('#', Blocks.field_10170)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_green_wool", this.method_10426(Blocks.field_10170))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8368)
			.input(Items.field_8258)
			.input(Items.field_8408)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10359)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_wheat", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8861))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10085)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_iron_ingot", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8620))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8620)
			...
			.pattern("###")
			.group("iron_ingot")
			.criterion("has_at_least_9_iron_nugget", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8675))
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10441)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_lapis", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8759))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8379)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8286)
			.input('#', Blocks.field_10294)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_light_blue_wool", this.method_10426(Blocks.field_10294))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8286)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Items.field_8855)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8146)
			.input('#', Blocks.field_10222)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_light_gray_wool", this.method_10426(Blocks.field_10222))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8146)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Items.field_8778)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8679)
			.input('#', Blocks.field_10028)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_lime_wool", this.method_10426(Blocks.field_10028))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8679)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Items.field_8671)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8349)
			.input('#', Blocks.field_10215)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_magenta_wool", this.method_10426(Blocks.field_10215))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8349)
			.input(Items.field_8258)
		...
		ShapedRecipeJsonFactory.create(Items.field_8824)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8059)
			.input('#', Blocks.field_10095)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_orange_wool", this.method_10426(Blocks.field_10095))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8059)
			.input(Items.field_8258)
		...
		ShapelessRecipeJsonFactory.create(Blocks.field_10225)
			...
			.criterion("has_at_least_9_ice", this.method_10424(NumberRange.Integer.atLeast(9), Blocks.field_10295))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8329)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8417)
			.input('#', Blocks.field_10459)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_pink_wool", this.method_10426(Blocks.field_10459))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8417)
			.input(Items.field_8258)
			.input(Items.field_8330)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapedRecipeJsonFactory.create(Items.field_8405)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8262)
			.input('#', Blocks.field_10259)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_purple_wool", this.method_10426(Blocks.field_10259))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8262)
			.input(Items.field_8258)
			.input(Items.field_8296)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapelessRecipeJsonFactory.create(Items.field_8725, 9)
			...
			.criterion("has_at_least_9_redstone", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8725))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8586)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8789)
			.input('#', Blocks.field_10314)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_red_wool", this.method_10426(Blocks.field_10314))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8789)
			.input(Items.field_8258)
			.input(Items.field_8264)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapedRecipeJsonFactory.create(Items.field_8788, 3)
			.input('#', Items.field_8118)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_oak_planks", this.method_10426(Items.field_8118))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8111, 3)
			.input('#', Items.field_8113)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_spruce_planks", this.method_10426(Items.field_8113))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8422, 3)
			.input('#', Items.field_8191)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_birch_planks", this.method_10426(Items.field_8191))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8203, 3)
			.input('#', Items.field_8651)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_acacia_planks", this.method_10426(Items.field_8651))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8867, 3)
			.input('#', Items.field_8842)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_jungle_planks", this.method_10426(Items.field_8842))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8496, 3)
			.input('#', Items.field_8404)
			.input('X', Items.field_8600)
			.pattern("###")
			.pattern("###")
			.pattern(" X ")
			.criterion("has_dark_oak_planks", this.method_10426(Items.field_8404))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Blocks.field_10030)
			...
			.pattern("###")
			.pattern("###")
			.criterion("has_at_least_9_slime_ball", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8777))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10131, 6)
			.input('#', Ingredient.fromTag(ItemTags.field_15531))
			.pattern("###")
			.criterion("has_stone_bricks", this.method_10420(ItemTags.field_15531))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8539)
			...
			.criterion("has_white_wool", this.method_10426(Blocks.field_10446))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8258)
			.input('#', Blocks.field_10446)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
		...
		ShapedRecipeJsonFactory.create(Items.field_8049)
			...
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8863)
			.input('#', Blocks.field_10490)
			.input('X', ItemTags.field_15537)
			.pattern("###")
			.pattern("XXX")
			...
			.criterion("has_yellow_wool", this.method_10426(Blocks.field_10490))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8863)
			.input(Items.field_8258)
			.input(Items.field_8192)
			.group("dyed_bed")
			.criterion("has_bed", this.method_10426(Items.field_8258))
		...
		ShapelessRecipeJsonFactory.create(Items.field_8551, 9)
			...
			.criterion("has_at_least_9_dried_kelp", this.method_10424(NumberRange.Integer.atLeast(9), Items.field_8551))
		...
		ShapelessRecipeJsonFactory.create(Items.field_8573)
			.input(Items.field_8407)
			.input(Items.field_8681)
			.criterion("has_creeper_head", this.method_10426(Items.field_8681))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8891)
			.input(Items.field_8407)
			.input(Items.field_8791)
			.criterion("has_wither_skeleton_skull", this.method_10426(Items.field_8791))
			.offerTo(consumer);
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Items.field_8233), Items.field_8882, 0.1F, 200)
			...
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10418.getItem()), Items.field_8713, 0.1F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Items.field_8504), Items.field_8752, 0.35F, 200)
			...
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10442.getItem()), Items.field_8477, 1.0F, 200)
			.criterion("has_diamond_ore", this.method_10426(Blocks.field_10442))
			.offerTo(consumer, "diamond_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10090.getItem()), Items.field_8759, 0.2F, 200)
			.criterion("has_lapis_ore", this.method_10426(Blocks.field_10090))
			.offerTo(consumer, "lapis_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10013.getItem()), Items.field_8687, 1.0F, 200)
			.criterion("has_emerald_ore", this.method_10426(Blocks.field_10013))
			.offerTo(consumer, "emerald_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.fromTag(ItemTags.field_15532), Blocks.field_10033.getItem(), 0.1F, 200)
			.criterion("has_sand", this.method_10420(ItemTags.field_15532))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10571.getItem()), Items.field_8695, 1.0F, 200)
			.criterion("has_gold_ore", this.method_10426(Blocks.field_10571))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10476.getItem()), Items.field_8131, 0.1F, 200)
			.criterion("has_sea_pickle", this.method_10426(Blocks.field_10476))
			.offerTo(consumer, "lime_dye_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10029.getItem()), Items.field_8408, 1.0F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10212.getItem()), Items.field_8620, 0.7F, 200)
			.criterion("has_iron_ore", this.method_10426(Blocks.field_10212.getItem()))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10460), Blocks.field_10415.getItem(), 0.35F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10562), Blocks.field_10258.getItem(), 0.15F, 200)
			.criterion("has_wet_sponge", this.method_10426(Blocks.field_10562))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10445), Blocks.field_10340.getItem(), 0.1F, 200)
			.criterion("has_cobblestone", this.method_10426(Blocks.field_10445))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10340), Blocks.field_10360.getItem(), 0.1F, 200)
			.criterion("has_stone", this.method_10426(Blocks.field_10340))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_9979), Blocks.field_10467.getItem(), 0.1F, 200)
			.criterion("has_sandstone", this.method_10426(Blocks.field_9979))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10344), Blocks.field_10483.getItem(), 0.1F, 200)
			.criterion("has_red_sandstone", this.method_10426(Blocks.field_10344))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10153), Blocks.field_9978.getItem(), 0.1F, 200)
			.criterion("has_quartz_block", this.method_10426(Blocks.field_10153))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10056), Blocks.field_10416.getItem(), 0.1F, 200)
			.criterion("has_stone_bricks", this.method_10426(Blocks.field_10056))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10626), Blocks.field_10501.getItem(), 0.1F, 200)
			.criterion("has_black_terracotta", this.method_10426(Blocks.field_10626))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10409), Blocks.field_10550.getItem(), 0.1F, 200)
			.criterion("has_blue_terracotta", this.method_10426(Blocks.field_10409))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10123), Blocks.field_10004.getItem(), 0.1F, 200)
			.criterion("has_brown_terracotta", this.method_10426(Blocks.field_10123))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10235), Blocks.field_10078.getItem(), 0.1F, 200)
			.criterion("has_cyan_terracotta", this.method_10426(Blocks.field_10235))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10349), Blocks.field_10220.getItem(), 0.1F, 200)
			.criterion("has_gray_terracotta", this.method_10426(Blocks.field_10349))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10526), Blocks.field_10475.getItem(), 0.1F, 200)
			.criterion("has_green_terracotta", this.method_10426(Blocks.field_10526))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10325), Blocks.field_10345.getItem(), 0.1F, 200)
			.criterion("has_light_blue_terracotta", this.method_10426(Blocks.field_10325))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10590), Blocks.field_10052.getItem(), 0.1F, 200)
			.criterion("has_light_gray_terracotta", this.method_10426(Blocks.field_10590))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10014), Blocks.field_10046.getItem(), 0.1F, 200)
			.criterion("has_lime_terracotta", this.method_10426(Blocks.field_10014))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10015), Blocks.field_10538.getItem(), 0.1F, 200)
			.criterion("has_magenta_terracotta", this.method_10426(Blocks.field_10015))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10184), Blocks.field_10280.getItem(), 0.1F, 200)
			.criterion("has_orange_terracotta", this.method_10426(Blocks.field_10184))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10444), Blocks.field_10567.getItem(), 0.1F, 200)
			.criterion("has_pink_terracotta", this.method_10426(Blocks.field_10444))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10570), Blocks.field_10426.getItem(), 0.1F, 200)
			.criterion("has_purple_terracotta", this.method_10426(Blocks.field_10570))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10328), Blocks.field_10383.getItem(), 0.1F, 200)
			.criterion("has_red_terracotta", this.method_10426(Blocks.field_10328))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10611), Blocks.field_10595.getItem(), 0.1F, 200)
			.criterion("has_white_terracotta", this.method_10426(Blocks.field_10611))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.field_10143), Blocks.field_10096.getItem(), 0.1F, 200)
			.criterion("has_yellow_terracotta", this.method_10426(Blocks.field_10143))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10212.getItem()), Items.field_8620, 0.7F, 100)
			.criterion("has_iron_ore", this.method_10426(Blocks.field_10212.getItem()))
			.offerTo(consumer, "iron_ingot_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10571.getItem()), Items.field_8695, 1.0F, 100)
			.criterion("has_gold_ore", this.method_10426(Blocks.field_10571))
			.offerTo(consumer, "gold_ingot_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10442.getItem()), Items.field_8477, 1.0F, 100)
			.criterion("has_diamond_ore", this.method_10426(Blocks.field_10442))
			.offerTo(consumer, "diamond_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10090.getItem()), Items.field_8759, 0.2F, 100)
			.criterion("has_lapis_ore", this.method_10426(Blocks.field_10090))
		...
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10418.getItem()), Items.field_8713, 0.1F, 100)
			.criterion("has_coal_ore", this.method_10426(Blocks.field_10418))
			.offerTo(consumer, "coal_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.field_10013.getItem()), Items.field_8687, 1.0F, 100)
			.criterion("has_emerald_ore", this.method_10426(Blocks.field_10013))
