...
public class RecipesProvider implements DataProvider {
		...
		this.method_10419(
			arg -> {
				if (!set.add(arg.method_10417())) {
					...
					this.method_10425(
						dataCache, arg.method_10416(), path.resolve("data/" + arg.method_10417().getNamespace() + "/recipes/" + arg.method_10417().getPath() + ".json")
					);
	...
	private void method_10419(Consumer<class_2444> consumer) {
		...
		class_2456.method_10476(RecipeSerializers.FIREWORK_ROCKET).method_10475(consumer, "firework_rocket");
		class_2456.method_10476(RecipeSerializers.FIREWORK_STAR).method_10475(consumer, "firework_star");
		class_2456.method_10476(RecipeSerializers.FIREWORK_STAR_FADE).method_10475(consumer, "firework_star_fade");
		class_2456.method_10476(RecipeSerializers.MAP_CLONING).method_10475(consumer, "map_cloning");
		class_2456.method_10476(RecipeSerializers.MAP_EXTEND).method_10475(consumer, "map_extending");
		class_2456.method_10476(RecipeSerializers.SHIELD_DECORATION).method_10475(consumer, "shield_decoration");
