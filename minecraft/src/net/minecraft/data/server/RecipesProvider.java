...
public class RecipesProvider implements DataProvider {
	...
	public void method_10319(DataCache dataCache) throws IOException {
			...
			recipeJsonProvider -> {
				if (!set.add(recipeJsonProvider.method_10417())) {
					...
					this.method_10425(
						...
						path.resolve("data/" + recipeJsonProvider.method_10417().getNamespace() + "/recipes/" + recipeJsonProvider.method_10417().getPath() + ".json")
					);
					...
					if (jsonObject != null) {
						this.method_10427(
							dataCache,
							jsonObject,
							path.resolve("data/" + recipeJsonProvider.method_10417().getNamespace() + "/advancements/" + recipeJsonProvider.method_10418().getPath() + ".json")
						);
					}
				}
			}
		...
		this.method_10427(
			dataCache,
			SimpleAdvancement.Builder.create().method_709("impossible", new ImpossibleCriterion.Conditions()).toJson(),
	...
	private void generate(Consumer<RecipeJsonProvider> consumer) {
		...
		ShapelessRecipeJsonFactory.create(Items.BLACK_BED)
			...
			.group("dyed_bed")
			.method_10442("has_bed", this.method_10426(Items.WHITE_BED))
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10429)
			...
			.input('G', Blocks.field_10033)
			.input('W', Ingredient.method_8106(ItemTags.field_15534))
			.pattern("GGG")
			.pattern("QQQ")
			.pattern("WWW")
			.method_10429("has_quartz", this.method_10426(Items.field_8155))
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10545)
			...
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8188).input(Items.field_8497).method_10442("has_melon", this.method_10426(Items.field_8497)).offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Items.field_8892)
			.input('#', Items.field_8600)
			.input('X', Ingredient.method_8106(ItemTags.field_15544))
			.pattern("###")
			.pattern("#X#")
			.pattern("###")
		...
		ShapedRecipeJsonFactory.create(Items.field_8788, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_oak_planks", this.method_10426(Items.OAK_PLANKS))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8111, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_spruce_planks", this.method_10426(Items.SPRUCE_PLANKS))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8422, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_birch_planks", this.method_10426(Items.BIRCH_PLANKS))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8203, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_acacia_planks", this.method_10426(Items.ACACIA_PLANKS))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8867, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_jungle_planks", this.method_10426(Items.JUNGLE_PLANKS))
			.offerTo(consumer);
		ShapedRecipeJsonFactory.create(Items.field_8496, 3)
			...
			.pattern("###")
			.pattern(" X ")
			.method_10429("has_dark_oak_planks", this.method_10426(Items.DARK_OAK_PLANKS))
			.offerTo(consumer);
		...
		ShapedRecipeJsonFactory.create(Blocks.field_10131, 6)
			.input('#', Ingredient.method_8106(ItemTags.field_15531))
			.pattern("###")
			.method_10429("has_stone_bricks", this.method_10420(ItemTags.field_15531))
			.offerTo(consumer);
		...
		ShapelessRecipeJsonFactory.create(Items.field_8573)
			...
			.method_10442("has_creeper_head", this.method_10426(Items.CREEPER_HEAD))
			.offerTo(consumer);
		ShapelessRecipeJsonFactory.create(Items.field_8891)
			.input(Items.field_8407)
			.input(Items.WITHER_SKELETON_SKULL)
			.method_10442("has_wither_skeleton_skull", this.method_10426(Items.WITHER_SKELETON_SKULL))
			.offerTo(consumer);
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Items.field_8696), Items.field_8621, 0.3F, 200)
			...
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8106(ItemTags.field_15539), Items.field_8665, 0.15F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Items.field_8233), Items.field_8882, 0.1F, 200)
			...
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10418.getItem()), Items.field_8713, 0.1F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Items.field_8504), Items.field_8752, 0.35F, 200)
			...
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10442.getItem()), Items.field_8477, 1.0F, 200)
			.method_10469("has_diamond_ore", this.method_10426(Blocks.field_10442))
			.offerTo(consumer, "diamond_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10090.getItem()), Items.field_8759, 0.2F, 200)
			.method_10469("has_lapis_ore", this.method_10426(Blocks.field_10090))
			.offerTo(consumer, "lapis_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10013.getItem()), Items.field_8687, 1.0F, 200)
			.method_10469("has_emerald_ore", this.method_10426(Blocks.field_10013))
			.offerTo(consumer, "emerald_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8106(ItemTags.field_15532), Blocks.field_10033.getItem(), 0.1F, 200)
			.method_10469("has_sand", this.method_10420(ItemTags.field_15532))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10571.getItem()), Items.field_8695, 1.0F, 200)
			.method_10469("has_gold_ore", this.method_10426(Blocks.field_10571))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10476.getItem()), Items.field_8131, 0.1F, 200)
			.method_10469("has_sea_pickle", this.method_10426(Blocks.field_10476))
			.offerTo(consumer, "lime_dye_from_smelting");
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10029.getItem()), Items.field_8408, 1.0F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10212.getItem()), Items.field_8620, 0.7F, 200)
			.method_10469("has_iron_ore", this.method_10426(Blocks.field_10212.getItem()))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10460), Blocks.field_10415.getItem(), 0.35F, 200)
		...
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10562), Blocks.field_10258.getItem(), 0.15F, 200)
			.method_10469("has_wet_sponge", this.method_10426(Blocks.field_10562))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10445), Blocks.field_10340.getItem(), 0.1F, 200)
			.method_10469("has_cobblestone", this.method_10426(Blocks.field_10445))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10340), Blocks.field_10360.getItem(), 0.1F, 200)
			.method_10469("has_stone", this.method_10426(Blocks.field_10340))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_9979), Blocks.field_10467.getItem(), 0.1F, 200)
			.method_10469("has_sandstone", this.method_10426(Blocks.field_9979))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10344), Blocks.field_10483.getItem(), 0.1F, 200)
			.method_10469("has_red_sandstone", this.method_10426(Blocks.field_10344))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10153), Blocks.field_9978.getItem(), 0.1F, 200)
			.method_10469("has_quartz_block", this.method_10426(Blocks.field_10153))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10056), Blocks.field_10416.getItem(), 0.1F, 200)
			.method_10469("has_stone_bricks", this.method_10426(Blocks.field_10056))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10626), Blocks.field_10501.getItem(), 0.1F, 200)
			.method_10469("has_black_terracotta", this.method_10426(Blocks.field_10626))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10409), Blocks.field_10550.getItem(), 0.1F, 200)
			.method_10469("has_blue_terracotta", this.method_10426(Blocks.field_10409))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10123), Blocks.field_10004.getItem(), 0.1F, 200)
			.method_10469("has_brown_terracotta", this.method_10426(Blocks.field_10123))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10235), Blocks.field_10078.getItem(), 0.1F, 200)
			.method_10469("has_cyan_terracotta", this.method_10426(Blocks.field_10235))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10349), Blocks.field_10220.getItem(), 0.1F, 200)
			.method_10469("has_gray_terracotta", this.method_10426(Blocks.field_10349))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10526), Blocks.field_10475.getItem(), 0.1F, 200)
			.method_10469("has_green_terracotta", this.method_10426(Blocks.field_10526))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10325), Blocks.field_10345.getItem(), 0.1F, 200)
			.method_10469("has_light_blue_terracotta", this.method_10426(Blocks.field_10325))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10590), Blocks.field_10052.getItem(), 0.1F, 200)
			.method_10469("has_light_gray_terracotta", this.method_10426(Blocks.field_10590))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10014), Blocks.field_10046.getItem(), 0.1F, 200)
			.method_10469("has_lime_terracotta", this.method_10426(Blocks.field_10014))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10015), Blocks.field_10538.getItem(), 0.1F, 200)
			.method_10469("has_magenta_terracotta", this.method_10426(Blocks.field_10015))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10184), Blocks.field_10280.getItem(), 0.1F, 200)
			.method_10469("has_orange_terracotta", this.method_10426(Blocks.field_10184))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10444), Blocks.field_10567.getItem(), 0.1F, 200)
			.method_10469("has_pink_terracotta", this.method_10426(Blocks.field_10444))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10570), Blocks.field_10426.getItem(), 0.1F, 200)
			.method_10469("has_purple_terracotta", this.method_10426(Blocks.field_10570))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10328), Blocks.field_10383.getItem(), 0.1F, 200)
			.method_10469("has_red_terracotta", this.method_10426(Blocks.field_10328))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10611), Blocks.field_10595.getItem(), 0.1F, 200)
			.method_10469("has_white_terracotta", this.method_10426(Blocks.field_10611))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createSmelting(Ingredient.method_8091(Blocks.field_10143), Blocks.field_10096.getItem(), 0.1F, 200)
			.method_10469("has_yellow_terracotta", this.method_10426(Blocks.field_10143))
			.offerTo(consumer);
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10212.getItem()), Items.field_8620, 0.7F, 100)
			.method_10469("has_iron_ore", this.method_10426(Blocks.field_10212.getItem()))
			.offerTo(consumer, "iron_ingot_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10571.getItem()), Items.field_8695, 1.0F, 100)
			.method_10469("has_gold_ore", this.method_10426(Blocks.field_10571))
			.offerTo(consumer, "gold_ingot_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10442.getItem()), Items.field_8477, 1.0F, 100)
			.method_10469("has_diamond_ore", this.method_10426(Blocks.field_10442))
			.offerTo(consumer, "diamond_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10090.getItem()), Items.field_8759, 0.2F, 100)
			.method_10469("has_lapis_ore", this.method_10426(Blocks.field_10090))
		...
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10418.getItem()), Items.field_8713, 0.1F, 100)
			.method_10469("has_coal_ore", this.method_10426(Blocks.field_10418))
			.offerTo(consumer, "coal_from_blasting");
		CookingRecipeJsonFactory.createBlasting(Ingredient.method_8091(Blocks.field_10013.getItem()), Items.field_8687, 1.0F, 100)
			.method_10469("has_emerald_ore", this.method_10426(Blocks.field_10013))
	...
	private InventoryChangedCriterion.Conditions method_10420(Tag<Item> tag) {
		return this.method_10423(ItemPredicate.Builder.create().method_8975(tag).build());
	}
