...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
			...
			.pool(
				LootPool.builder()
					.with(
						applyExplosionDecay(
							glowLichen,
							((LeafEntry.Builder)ItemEntry.builder(glowLichen).conditionally(WITH_SHEARS))
								.apply(
									SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true)
										.conditionally(
											BlockStatePropertyLootCondition.builder(glowLichen).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.EAST, true))
										)
								)
								.apply(
									SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true)
										.conditionally(
											BlockStatePropertyLootCondition.builder(glowLichen).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.WEST, true))
										)
								)
								.apply(
									SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true)
								...
								.apply(
									SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F), true)
										.conditionally(
											BlockStatePropertyLootCondition.builder(glowLichen).properties(StatePredicate.Builder.create().exactMatch(ConnectingBlock.DOWN, true))
										)
								)
	...
	public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
		this.addDrop(Blocks.GENERIC_ITEM_BLOCK);
		...
		this.addDrop(
			...
			blockx -> dropsWithSilkTouch(
					...
					((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD)
						...
						.alternatively(
							applyExplosionDecay(blockx, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))))
						)
				)
		);
		...
		this.addDrop(Blocks.END_PORTAL_FRAME);
		this.addDrop(Blocks.BEDROCK);
