...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
	...
	public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
		...
		this.addDrop(
			...
			blockx -> dropsWithShears(
					Blocks.FERN,
					((LeafEntry.Builder)addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.WHEAT_SEEDS))
							.conditionally(
		...
		this.addDrop(
			...
			dropsWithShears(
				Blocks.GRASS,
				((LeafEntry.Builder)addSurvivesExplosionCondition(Blocks.TALL_GRASS, ItemEntry.builder(Items.WHEAT_SEEDS))
						.conditionally(
