...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
		...
		return LootTable.builder()
			.pool(
				LootPool.builder()
					...
					.with(((LeafEntry.Builder)ItemEntry.builder(drop).method_421(conditionBuilder)).alternatively(child))
			);
	}
	...
	private static LootTable.Builder drops(ItemConvertible drop, LootTableRange count) {
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.rolls(ConstantLootTableRange.create(1))
					.with(applyExplosionDecay(drop, ItemEntry.builder(drop).method_438(SetCountLootFunction.builder(count))))
			);
	}

	private static LootTable.Builder drops(Block dropWithSilkTouch, ItemConvertible drop, LootTableRange count) {
		return dropsWithSilkTouch(dropWithSilkTouch, applyExplosionDecay(dropWithSilkTouch, ItemEntry.builder(drop).method_438(SetCountLootFunction.builder(count))));
	}
		...
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.rolls(ConstantLootTableRange.create(1))
					.with(
						((LeafEntry.Builder)ItemEntry.builder(drop).method_421(WITH_SILK_TOUCH))
							.method_438(CopyNbtLootFunction.builder(CopyNbtLootFunction.Source.field_17027).withOperation("Bees", "BlockEntityTag.Bees"))
							.method_438(CopyStateFunction.getBuilder(drop).method_21898(BeehiveBlock.HONEY_LEVEL))
	...
	private static LootTable.Builder oreDrops(Block dropWithSilkTouch, Item drop) {
		return dropsWithSilkTouch(
			dropWithSilkTouch, applyExplosionDecay(dropWithSilkTouch, ItemEntry.builder(drop).method_438(ApplyBonusLootFunction.oreDrops(Enchantments.field_9130)))
		);
	}
	...
	private static LootTable.Builder grassDrops(Block dropWithShears) {
		return dropsWithShears(
			...
			applyExplosionDecay(
				dropWithShears,
				((LeafEntry.Builder)ItemEntry.builder(Items.field_8317).method_421(RandomChanceLootCondition.builder(0.125F)))
	...
	private static LootTable.Builder leavesDrop(Block leaves, Block drop, float... chance) {
		return dropsWithSilkTouchOrShears(
				leaves, addSurvivesExplosionCondition(leaves, ItemEntry.builder(drop)).method_421(TableBonusLootCondition.builder(Enchantments.field_9130, chance))
			)
			.pool(
				LootPool.builder()
					.rolls(ConstantLootTableRange.create(1))
					...
					.with(
						applyExplosionDecay(leaves, ItemEntry.builder(Items.field_8600).method_438(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 2.0F))))
		...
		return leavesDrop(leaves, drop, chance)
			.pool(
				LootPool.builder()
					...
					.method_356(WITHOUT_SILK_TOUCH_NOR_SHEARS)
					.with(
						addSurvivesExplosionCondition(leaves, ItemEntry.builder(Items.field_8279))
	...
	private static LootTable.Builder cropDrops(Block crop, Item product, Item seeds, LootCondition.Builder condition) {
		return applyExplosionDecay(
			crop,
			LootTable.builder()
				.pool(LootPool.builder().with(((LeafEntry.Builder)ItemEntry.builder(product).method_421(condition)).alternatively(ItemEntry.builder(seeds))))
				.pool(
					LootPool.builder()
	...
	private static LootTable.Builder method_30158(Block block, Block block2) {
		LootPoolEntry.Builder<?> builder = ((LeafEntry.Builder)ItemEntry.builder(block2)
				.method_438(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))
				.method_421(WITH_SHEARS))
			.alternatively(addSurvivesExplosionCondition(block, ItemEntry.builder(Items.field_8317)).method_421(RandomChanceLootCondition.builder(0.125F)));
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.with(builder)
	...
	public void method_10379(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
		...
		this.addDrop(Blocks.field_10343, blockx -> dropsWithSilkTouchOrShears(blockx, addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.field_8276))));
		this.addDrop(
			Blocks.field_10428,
			blockx -> dropsWithShears(
					blockx,
					applyExplosionDecay(blockx, ItemEntry.builder(Items.field_8600).method_438(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 2.0F))))
				)
		);
			...
			blockx -> LootTable.builder()
					.pool(
						LootPool.builder()
							.rolls(ConstantLootTableRange.create(1))
							.with(
								addSurvivesExplosionCondition(blockx, ItemEntry.builder(blockx)).method_421(EntityPropertiesLootCondition.create(LootContext.EntityTarget.field_935))
							)
					)
		);
		...
		this.addDrop(
			...
			blockx -> dropsWithSilkTouch(
					blockx,
					addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.field_8665).method_438(SetCountLootFunction.builder(ConstantLootTableRange.create(2))))
				)
		);
		this.addDrop(
			Blocks.field_23880,
			blockx -> dropsWithSilkTouch(
					...
					addSurvivesExplosionCondition(
						blockx,
						((LeafEntry.Builder)ItemEntry.builder(Items.field_8397)
		...
		this.addDrop(
			...
			blockx -> dropsWithSilkTouch(
					blockx,
					addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.SOUL_SOIL).method_438(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
				)
		);
