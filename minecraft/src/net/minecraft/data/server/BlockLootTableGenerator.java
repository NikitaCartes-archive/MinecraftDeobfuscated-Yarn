...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
	...
	private static <T> T addExplosionDecayLootFunction(ItemConvertible itemConvertible, LootFunctionConsumingBuilder<T> lootFunctionConsumingBuilder) {
		return (T)(!ALWAYS_DROPPED_FROM_EXPLOSION.contains(itemConvertible.asItem())
		...
		return LootTable.builder()
			.withPool(
				LootPool.builder()
					...
					.withEntry(((LeafEntry.Builder)ItemEntry.builder(block).withCondition(conditionBuilder)).withChild(child))
			);
	}
	...
	private static LootTable.Builder create(ItemConvertible itemConvertible, LootTableRange count) {
		return LootTable.builder()
			.withPool(
				LootPool.builder()
					.withRolls(ConstantLootTableRange.create(1))
					.withEntry(addExplosionDecayLootFunction(itemConvertible, ItemEntry.builder(itemConvertible).withFunction(SetCountLootFunction.builder(count))))
			);
	}
	...
	private static LootTable.Builder createForBlockWithItemDrops(Block block, ItemConvertible lootWithoutSilkTouch, LootTableRange count) {
		return createForNeedingSilkTouch(
			block, addExplosionDecayLootFunction(block, ItemEntry.builder(lootWithoutSilkTouch).withFunction(SetCountLootFunction.builder(count)))
		);
	}
		...
		return LootTable.builder()
			.withPool(
				LootPool.builder()
					.withRolls(ConstantLootTableRange.create(1))
					.withEntry(
						((LeafEntry.Builder)ItemEntry.builder(block).withCondition(NEEDS_SILK_TOUCH))
							.withFunction(CopyNbtLootFunction.builder(CopyNbtLootFunction.Source.BLOCK_ENTITY).withOperation("Bees", "BlockEntityTag.Bees"))
							.withFunction(CopyStateFunction.getBuilder(block).method_21898(BeehiveBlock.HONEY_LEVEL))
	...
	private static LootTable.Builder createForOreWithSingleItemDrop(Block block, Item item) {
		return createForNeedingSilkTouch(
			block, addExplosionDecayLootFunction(block, ItemEntry.builder(item).withFunction(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)))
		);
	}
	...
	private static LootTable.Builder createForLeaves(Block leafBlock, Block sapling, float... saplingDropChances) {
		return createForNeedingSilkTouchShears(
				leafBlock,
				addSurvivesExplosionLootCondition(leafBlock, ItemEntry.builder(sapling))
		...
		return createForLeaves(block, block2, fs)
			.withPool(
				LootPool.builder()
					...
					.withCondition(DOESNT_NEED_SILK_TOUCH_SHEARS)
					.withEntry(
						addSurvivesExplosionLootCondition(block, ItemEntry.builder(Items.APPLE))
	...
	private static LootTable.Builder createForCrops(Block block, Item food, Item seeds, LootCondition.Builder condition) {
		return addExplosionDecayLootFunction(
			block,
			LootTable.builder()
				.withPool(LootPool.builder().withEntry(((LeafEntry.Builder)ItemEntry.builder(food).withCondition(condition)).withChild(ItemEntry.builder(seeds))))
				.withPool(
					LootPool.builder()
	...
	public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
		...
		this.registerWithFunction(
			Blocks.COMPOSTER,
			blockx -> LootTable.builder()
					.withPool(LootPool.builder().withEntry(addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.COMPOSTER))))
					.withPool(
						LootPool.builder()
		...
		this.registerWithFunction(
			Blocks.COBWEB, blockx -> createForNeedingSilkTouchShears(blockx, addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.STRING)))
		);
		this.registerWithFunction(
			Blocks.DEAD_BUSH,
		...
		this.registerWithFunction(
			...
			blockx -> createForNeedingSilkTouchShears(blockx, addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Blocks.NETHER_SPROUTS)))
		);
		...
		this.registerWithFunction(
			...
			blockx -> createForNeedingShears(
					Blocks.FERN,
					((LeafEntry.Builder)addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.WHEAT_SEEDS))
							.withCondition(
		...
		this.register(
			...
			createForNeedingShears(
				Blocks.GRASS,
				((LeafEntry.Builder)addSurvivesExplosionLootCondition(Blocks.TALL_GRASS, ItemEntry.builder(Items.WHEAT_SEEDS))
						.withCondition(
			...
			blockx -> LootTable.builder()
					.withPool(
						LootPool.builder()
							.withRolls(ConstantLootTableRange.create(1))
							.withEntry(
								addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(blockx))
		...
		this.registerWithFunction(
			...
			blockx -> createForNeedingSilkTouch(
					blockx,
					addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.CHARCOAL).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2))))
				)
		);
		this.registerWithFunction(
		...
		this.registerWithFunction(
			...
			blockx -> createForNeedingSilkTouch(
					blockx,
					addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.SOUL_SOIL).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))
				)
		);
		...
		LootTable.Builder builder = LootTable.builder()
			.withPool(
				LootPool.builder()
					.withRolls(ConstantLootTableRange.create(1))
					.withEntry(
						((LeafEntry.Builder)ItemEntry.builder(block).withCondition(RandomChanceLootCondition.builder(0.33333334F)))
							.withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE, 2))
					)
			);
