...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootSupplier.Builder>> {
	...
	private static LootSupplier.Builder method_10381(Block block, LootCondition.Builder builder, LootEntry.Builder<?> builder2) {
		return LootSupplier.builder()
			.withPool(LootPool.builder().method_352(ConstantLootTableRange.create(1)).method_351(ItemEntry.method_411(block).method_421(builder).withChild(builder2)));
	}
	...
	private static LootSupplier.Builder method_10382(Block block, ItemConvertible itemConvertible) {
		return method_10397(block, (LootEntry.Builder<?>)method_10392(block, ItemEntry.method_411(itemConvertible)));
	}
		...
		return LootSupplier.builder()
			.withPool(
				LootPool.builder()
					...
					.method_351(
						(LootEntry.Builder<?>)method_10393(itemConvertible, ItemEntry.method_411(itemConvertible).method_438(SetCountLootFunction.builder(lootTableRange)))
					)
			);
	}
	...
	private static LootSupplier.Builder method_10386(Block block, ItemConvertible itemConvertible, LootTableRange lootTableRange) {
		return method_10397(
			block, (LootEntry.Builder<?>)method_10393(block, ItemEntry.method_411(itemConvertible).method_438(SetCountLootFunction.builder(lootTableRange)))
		);
	}
	...
	private static LootSupplier.Builder method_10391(Block block, Item item, Item item2, LootCondition.Builder builder) {
		return method_10393(
			...
			LootSupplier.builder()
				.withPool(LootPool.builder().method_351(ItemEntry.method_411(item).method_421(builder).withChild(ItemEntry.method_411(item2))))
				.withPool(
					LootPool.builder()
						.method_356(builder)
	...
	public void method_10379(BiConsumer<Identifier, LootSupplier.Builder> biConsumer) {
		...
		this.method_16293(
			Blocks.field_17563,
			blockx -> LootSupplier.builder()
					.withPool(LootPool.builder().method_351((LootEntry.Builder<?>)method_10393(blockx, ItemEntry.method_411(Items.COMPOSTER))))
					.withPool(
						LootPool.builder()
		...
		this.method_16293(
			...
			blockx -> method_10393(
					...
					LootSupplier.builder()
						...
						.withPool(LootPool.builder().method_356(builder4).method_351(ItemEntry.method_411(Items.field_8635).method_421(RandomChanceLootCondition.builder(0.02F))))
				)
		);
		this.method_16293(
			Blocks.field_16999,
