...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
	...
	private static LootTable.Builder drops(ItemConvertible drop, LootNumberProvider count) {
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.rolls(ConstantLootNumberProvider.create(1.0F))
					.with(applyExplosionDecay(drop, ItemEntry.builder(drop).apply(SetCountLootFunction.builder(count))))
			);
	}
	...
	private static LootTable.Builder oreDrops(Block dropWithSilkTouch, Item drop) {
		return dropsWithSilkTouch(
			dropWithSilkTouch, applyExplosionDecay(dropWithSilkTouch, ItemEntry.builder(drop).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)))
		);
	}
	...
	private static LootTable.Builder leavesDrop(Block leaves, Block drop, float... chance) {
		return dropsWithSilkTouchOrShears(
				leaves, addSurvivesExplosionCondition(leaves, ItemEntry.builder(drop)).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, chance))
			)
			.pool(
				LootPool.builder()
					.rolls(ConstantLootNumberProvider.create(1.0F))
					...
					.with(
						applyExplosionDecay(leaves, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
	...
	private static LootTable.Builder tallGrassDrops(Block tallGrass, Block grass) {
		LootPoolEntry.Builder<?> builder = ((LeafEntry.Builder)ItemEntry.builder(grass)
				...
				.conditionally(WITH_SHEARS))
			.alternatively(addSurvivesExplosionCondition(tallGrass, ItemEntry.builder(Items.WHEAT_SEEDS)).conditionally(RandomChanceLootCondition.builder(0.125F)));
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.with(builder)
	...
	public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
		...
		this.addDrop(Blocks.GRIMSTONE);
		this.addDrop(Blocks.GRIMSTONE_STAIRS);
		this.addDrop(Blocks.GRIMSTONE_WALL);
		this.addDrop(Blocks.POLISHED_GRIMSTONE);
		this.addDrop(Blocks.POLISHED_GRIMSTONE_STAIRS);
		this.addDrop(Blocks.POLISHED_GRIMSTONE_WALL);
		this.addDrop(Blocks.GRIMSTONE_TILES);
		this.addDrop(Blocks.GRIMSTONE_TILE_STAIRS);
		this.addDrop(Blocks.GRIMSTONE_TILE_WALL);
		this.addDrop(Blocks.GRIMSTONE_BRICKS);
		this.addDrop(Blocks.GRIMSTONE_BRICK_STAIRS);
		this.addDrop(Blocks.GRIMSTONE_BRICK_WALL);
		this.addDrop(Blocks.CHISELED_GRIMSTONE);
		...
		this.addDrop(Blocks.GRIMSTONE_SLAB, BlockLootTableGenerator::slabDrops);
		this.addDrop(Blocks.POLISHED_GRIMSTONE_SLAB, BlockLootTableGenerator::slabDrops);
		this.addDrop(Blocks.GRIMSTONE_TILE_SLAB, BlockLootTableGenerator::slabDrops);
		this.addDrop(Blocks.GRIMSTONE_BRICK_SLAB, BlockLootTableGenerator::slabDrops);
		...
		this.addDrop(
			Blocks.COMPOSTER,
			blockx -> LootTable.builder()
					.pool(LootPool.builder().with(applyExplosionDecay(blockx, ItemEntry.builder(Items.COMPOSTER))))
					.pool(
						LootPool.builder()
		...
		this.addDrop(Blocks.COBWEB, blockx -> dropsWithSilkTouchOrShears(blockx, addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.STRING))));
		this.addDrop(
			Blocks.DEAD_BUSH,
			blockx -> dropsWithShears(
					blockx, applyExplosionDecay(blockx, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0F, 2.0F))))
				)
		);
			...
			blockx -> LootTable.builder()
					.pool(
						LootPool.builder()
							.rolls(ConstantLootNumberProvider.create(1.0F))
							.with(
								addSurvivesExplosionCondition(blockx, ItemEntry.builder(blockx)).conditionally(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS))
							)
					)
		);
		...
		this.addDrop(
			...
			blockx -> dropsWithSilkTouch(
					blockx,
					addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0F))))
				)
		);
		this.addDrop(
		...
		this.addDrop(
			...
			blockx -> dropsWithSilkTouch(
					blockx,
					addSurvivesExplosionCondition(blockx, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
				)
		);
		this.addDrop(
