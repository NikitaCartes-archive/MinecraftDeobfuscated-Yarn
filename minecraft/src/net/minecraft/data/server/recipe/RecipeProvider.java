...
public abstract class RecipeProvider implements DataProvider {
	...
	private static final Map<BlockFamily.Variant, BiFunction<ItemConvertible, ItemConvertible, CraftingRecipeJsonBuilder>> VARIANT_FACTORIES = ImmutableMap.builder(
		...
		.put(BlockFamily.Variant.CUT, (BiFunction)(output, input) -> createCutCopperRecipe(RecipeCategory.BUILDING_BLOCKS, output, Ingredient.ofItems(input)))
		...
		.put(BlockFamily.Variant.CUSTOM_FENCE_GATE, (BiFunction)(output, input) -> createFenceGateRecipe(output, Ingredient.ofItems(input)))
