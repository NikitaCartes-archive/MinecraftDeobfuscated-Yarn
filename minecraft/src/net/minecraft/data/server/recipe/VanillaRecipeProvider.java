...
public class VanillaRecipeProvider extends RecipeProvider {
	...
	protected void generate(RecipeExporter exporter) {
		...
		offerSmithingTemplateCopyingRecipe(exporter, Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, Ingredient.ofItems(Items.COPPER_BLOCK, Items.WAXED_COPPER_BLOCK));
		...
		ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, Items.MACE, 1)
			...
			.offerTo(exporter);
		createDoorRecipe(Blocks.COPPER_DOOR, Ingredient.ofItems(Items.COPPER_INGOT))
			.criterion(hasItem(Items.COPPER_INGOT), conditionsFromItem(Items.COPPER_INGOT))
			.offerTo(exporter);
		createTrapdoorRecipe(Blocks.COPPER_TRAPDOOR, Ingredient.ofItems(Items.COPPER_INGOT))
			.criterion(hasItem(Items.COPPER_INGOT), conditionsFromItem(Items.COPPER_INGOT))
			.offerTo(exporter);
	}
	...
	public static Stream<VanillaRecipeProvider.SmithingTemplate> streamSmithingTemplates() {
		return Stream.of(
			...
			.map(template -> new VanillaRecipeProvider.SmithingTemplate(template, Identifier.ofVanilla(getItemPath(template) + "_smithing_trim")));
	}
