...
public class StoryTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
	public void method_10347(Consumer<Advancement> consumer) {
		...
		Advancement advancement2 = Advancement.Task.create()
			...
			.criterion("get_stone", InventoryChangedCriterion.Conditions.items(ItemPredicate.Builder.create().tag(ItemTags.field_23802).build()))
		...
		Advancement advancement11 = Advancement.Task.create()
			...
			.criterion("in_stronghold", LocationArrivalCriterion.Conditions.create(LocationPredicate.feature(StructureFeature.field_24852)))
