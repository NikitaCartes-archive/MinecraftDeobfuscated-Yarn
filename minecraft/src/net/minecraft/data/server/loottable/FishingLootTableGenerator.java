...
public class FishingLootTableGenerator implements LootTableGenerator {
			...
			LootTable.builder()
				.pool(
					LootPool.builder()
						...
						.with(
							((LeafEntry.Builder)ItemEntry.builder(Blocks.BAMBOO).conditionally(NEEDS_JUNGLE_BIOME.or(NEEDS_SPARSE_JUNGLE_BIOME).or(NEEDS_BAMBOO_JUNGLE_BIOME)))
								.weight(10)
						)
				)
		);
