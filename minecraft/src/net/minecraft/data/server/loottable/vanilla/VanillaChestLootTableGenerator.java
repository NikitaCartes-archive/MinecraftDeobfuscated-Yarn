...
public class VanillaChestLootTableGenerator implements LootTableGenerator {
	...
	public void accept(BiConsumer<Identifier, LootTable.Builder> exporter) {
		...
		exporter.accept(
			LootTables.MOON_RESUPLY_CHEST,
			LootTable.builder()
				.pool(
					LootPool.builder()
						.rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
						.with(ItemEntry.builder(Items.BUCKET).weight(5))
						.with(ItemEntry.builder(Items.WATER_BUCKET).weight(2))
						.with(ItemEntry.builder(Items.LAVA_BUCKET).weight(2))
						.with(ItemEntry.builder(Items.DIRT).weight(20).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 10.0F))))
						.with(ItemEntry.builder(Items.SAND).weight(20).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 64.0F))))
						.with(ItemEntry.builder(Items.END_STONE).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
						.with(ItemEntry.builder(Items.GRAVEL).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 64.0F))))
						.with(ItemEntry.builder(Items.GRASS_BLOCK).weight(15).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
						.with(ItemEntry.builder(Items.SNOW_BLOCK).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
				)
				.pool(
					LootPool.builder()
						.rolls(UniformLootNumberProvider.create(1.0F, 2.0F))
						.with(ItemEntry.builder(Items.IRON_INGOT).weight(30).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.GOLD_INGOT).weight(30).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.OAK_LOG).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.WHEAT_SEEDS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.PUMPKIN_SEEDS).weight(5))
						.with(ItemEntry.builder(Items.BEETROOT_SEEDS).weight(5))
						.with(ItemEntry.builder(Items.CARROT).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.POTATO).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.OAK_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SPRUCE_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BIRCH_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.ACACIA_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.JUNGLE_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
				)
				.pool(
					LootPool.builder()
						.rolls(UniformLootNumberProvider.create(0.0F, 1.0F))
						.with(ItemEntry.builder(Items.GUNPOWDER).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
						...
						.with(ItemEntry.builder(Items.QUARTZ).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
						.with(ItemEntry.builder(Items.STRING).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
				)
		);
		exporter.accept(
			LootTables.MOON_LAB_CHEST,
			LootTable.builder()
				.pool(
					LootPool.builder()
						.rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
						.with(ItemEntry.builder(Items.ELYTRA).weight(2))
						.with(ItemEntry.builder(Items.GOLDEN_APPLE).weight(2))
						.with(ItemEntry.builder(Items.BUCKET).weight(10))
						.with(ItemEntry.builder(Items.WATER_BUCKET).weight(5))
						.with(ItemEntry.builder(Items.LAVA_BUCKET).weight(5))
						.with(ItemEntry.builder(Items.SPYGLASS).weight(2))
						.with(ItemEntry.builder(Items.DIAMOND_PICKAXE).weight(2).apply(EnchantRandomlyLootFunction.builder()))
						.with(ItemEntry.builder(Items.END_STONE).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BUDDING_AMETHYST).weight(10))
						.with(ItemEntry.builder(Items.BRAIN_CORAL_BLOCK).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BUBBLE_CORAL_BLOCK).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.FIRE_CORAL_BLOCK).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.HORN_CORAL_BLOCK).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.TUBE_CORAL_BLOCK).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.VILLAGER_SPAWN_EGG).weight(5))
						.with(ItemEntry.builder(Items.COW_SPAWN_EGG).weight(5))
						.with(ItemEntry.builder(Items.SHEEP_SPAWN_EGG).weight(2))
						.with(ItemEntry.builder(Items.TURTLE_EGG).weight(2))
						.with(ItemEntry.builder(Items.SNIFFER_EGG).weight(1))
						.with(ItemEntry.builder(Items.SOUL_SAND).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.ECHO_SHARD).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SNOW_BLOCK).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SCULK_CATALYST).weight(2))
						.with(ItemEntry.builder(Items.HEART_OF_THE_SEA).weight(1))
						.with(ItemEntry.builder(Items.COBWEB).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.POWDER_SNOW_BUCKET).weight(2))
						.with(ItemEntry.builder(Items.PUFFERFISH_BUCKET).weight(2))
				...
				.pool(
					LootPool.builder()
						...
						.with(ItemEntry.builder(Items.WHEAT_SEEDS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.PUMPKIN_SEEDS).weight(5))
						.with(ItemEntry.builder(Items.MELON_SEEDS).weight(5))
						.with(ItemEntry.builder(Items.BEETROOT_SEEDS).weight(5))
						.with(ItemEntry.builder(Items.CARROT).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.POTATO).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BROWN_MUSHROOM).weight(5))
						.with(ItemEntry.builder(Items.MOSS_BLOCK).weight(5))
						.with(ItemEntry.builder(Items.WARPED_NYLIUM).weight(1))
						.with(ItemEntry.builder(Items.CRIMSON_NYLIUM).weight(1))
						.with(ItemEntry.builder(Items.MYCELIUM).weight(5))
						.with(ItemEntry.builder(Items.POINTED_DRIPSTONE).weight(1))
						.with(ItemEntry.builder(Items.RED_MUSHROOM).weight(5))
						.with(ItemEntry.builder(Items.CHORUS_FLOWER).weight(5))
						.with(ItemEntry.builder(Items.ROSE_BUSH).weight(1))
						.with(ItemEntry.builder(Items.SUNFLOWER).weight(1))
						.with(ItemEntry.builder(Items.LILAC).weight(1))
						.with(ItemEntry.builder(Items.PEONY).weight(1))
						.with(ItemEntry.builder(Items.DANDELION).weight(1))
						.with(ItemEntry.builder(Items.POPPY).weight(1))
						.with(ItemEntry.builder(Items.BLUE_ORCHID).weight(1))
						.with(ItemEntry.builder(Items.ALLIUM).weight(1))
						.with(ItemEntry.builder(Items.AZURE_BLUET).weight(1))
						.with(ItemEntry.builder(Items.ORANGE_TULIP).weight(1))
						.with(ItemEntry.builder(Items.PINK_TULIP).weight(1))
						.with(ItemEntry.builder(Items.RED_TULIP).weight(1))
						.with(ItemEntry.builder(Items.WHITE_TULIP).weight(1))
						.with(ItemEntry.builder(Items.OXEYE_DAISY).weight(1))
						.with(ItemEntry.builder(Items.CORNFLOWER).weight(1))
						.with(ItemEntry.builder(Items.LILY_OF_THE_VALLEY).weight(1))
						.with(ItemEntry.builder(Items.PINK_PETALS).weight(1))
						.with(ItemEntry.builder(Items.SPORE_BLOSSOM).weight(2))
						.with(ItemEntry.builder(Items.KELP).weight(5))
						.with(ItemEntry.builder(Items.BIG_DRIPLEAF).weight(1))
						.with(ItemEntry.builder(Items.FERN).weight(5))
						.with(ItemEntry.builder(Items.LARGE_FERN).weight(1))
						.with(ItemEntry.builder(Items.GLOW_BERRIES).weight(5))
						.with(ItemEntry.builder(Items.SWEET_BERRIES).weight(5))
						.with(ItemEntry.builder(Items.OAK_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.SPRUCE_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.DARK_OAK_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BIRCH_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.MANGROVE_PROPAGULE).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.ACACIA_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.JUNGLE_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.CHERRY_SAPLING).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F))))
						.with(ItemEntry.builder(Items.CACTUS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SUGAR_CANE).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.NETHER_WART).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.COCOA_BEANS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SEA_PICKLE).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.BAMBOO).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.WITHER_SKELETON_SKULL).weight(1).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(3.0F))))
						.with(ItemEntry.builder(Items.ENDER_PEARL).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
				)
				.pool(
					LootPool.builder()
						.rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
						.with(ItemEntry.builder(Items.AIR_BLOCK).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.PACKED_AIR).weight(2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
						.with(ItemEntry.builder(Items.GUNPOWDER).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 32.0F))))
						.with(ItemEntry.builder(Items.BONE_BLOCK).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
						.with(ItemEntry.builder(Items.SLIME_BALL).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(8.0F, 32.0F))))
						.with(ItemEntry.builder(Items.REDSTONE).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(8.0F, 32.0F))))
						.with(ItemEntry.builder(Items.GLOWSTONE_DUST).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
						.with(ItemEntry.builder(Items.LAPIS_LAZULI).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 32.0F))))
						.with(ItemEntry.builder(Items.GOLD_INGOT).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 16.0F))))
						.with(ItemEntry.builder(Items.DIAMOND).weight(5))
						.with(ItemEntry.builder(Items.ANCIENT_DEBRIS).weight(5))
						.with(ItemEntry.builder(Items.QUARTZ).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 32.0F))))
						.with(ItemEntry.builder(Items.IRON_INGOT).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 16.0F))))
						.with(ItemEntry.builder(Items.BLAZE_ROD).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F))))
						.with(ItemEntry.builder(Items.PRISMARINE_SHARD).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 16.0F))))
						.with(ItemEntry.builder(Items.PRISMARINE_CRYSTALS).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F))))
						.with(ItemEntry.builder(Items.NAUTILUS_SHELL).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
						.with(ItemEntry.builder(Items.SPIDER_EYE).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
						.with(ItemEntry.builder(Items.GHAST_TEAR).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
						.with(ItemEntry.builder(Items.RABBIT_FOOT).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
				)
		);
		exporter.accept(
