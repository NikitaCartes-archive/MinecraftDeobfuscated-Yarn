...
public class VanillaBlockLootTableGenerator extends BlockLootTableGenerator {
	...
	protected void generate() {
		...
		this.addDrop(Blocks.COPPER_SPLEAVES, dropsNothing());
		...
		this.addDrop(Blocks.COPPER_SINK);
		...
		this.addDrop(Blocks.PICKAXE_BLOCK);
		this.addDrop(Blocks.PLACE_BLOCK);
		...
		this.addDrop(Blocks.FILLED_COPPER_SINK, Blocks.COPPER_SINK);
		...
		this.addDrop(
			...
			block -> LootTable.builder()
					.pool(
						LootPool.builder()
							.conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(CheeseBlock.SLICES, 255)))
							.with(ItemEntry.builder(Blocks.CHEESE))
					)
		);
		...
		this.addDrop(Blocks.OTHER_PORTAL, dropsNothing());
		...
		return LootTable.builder()
			.pool(
				LootPool.builder()
					.rolls(ConstantLootNumberProvider.create(1.0F))
					.with(
						((LeafEntry.Builder)((LeafEntry.Builder)DynamicEntry.builder(DecoratedPotBlock.SHARDS_NBT_KEY)
						...
						.with(
							AlternativeEntry.builder(
								...
								age -> {
									...
									return age == 4
										? ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_PLANT).conditionally(builder2)).conditionally(builder))
											.apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))
										: ((LeafEntry.Builder)((LeafEntry.Builder)ItemEntry.builder(Items.PITCHER_POD).conditionally(builder2)).conditionally(builder))
											.apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)));
								}
							)
						)
