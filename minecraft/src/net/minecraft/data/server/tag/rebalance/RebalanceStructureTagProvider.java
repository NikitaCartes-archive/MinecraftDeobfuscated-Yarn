...
public class RebalanceStructureTagProvider extends TagProvider<Structure> {
	public RebalanceStructureTagProvider(DataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookupFuture) {
