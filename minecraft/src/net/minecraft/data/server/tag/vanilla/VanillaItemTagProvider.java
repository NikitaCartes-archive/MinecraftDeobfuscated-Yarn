...
public class VanillaItemTagProvider extends ItemTagProvider {
	...
	protected void configure(RegistryWrapper.WrapperLookup lookup) {
		...
		this.getOrCreateTagBuilder(ItemTags.HEAVY).add(Items.ANVIL, Items.CHIPPED_ANVIL, Items.DAMAGED_ANVIL, Items.OBSIDIAN, Items.CRYING_OBSIDIAN);
		this.getOrCreateTagBuilder(ItemTags.COPPER)
