...
public class OneTwentyOneBlockTagProvider extends ValueLookupTagProvider<Block> {
	...
	protected void configure(RegistryWrapper.WrapperLookup lookup) {
		...
		this.getOrCreateTagBuilder(BlockTags.WALLS).add(Blocks.TUFF_WALL, Blocks.POLISHED_TUFF_WALL, Blocks.TUFF_BRICK_WALL);
		...
		this.getOrCreateTagBuilder(BlockTags.FEATURES_CANNOT_REPLACE).add(Blocks.TRIAL_SPAWNER).add(Blocks.VAULT);
