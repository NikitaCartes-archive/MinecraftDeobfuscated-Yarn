...
public class class_575<T extends class_1543> extends class_583<T> implements class_3881, class_3882 {
	...
	public void method_17094(T arg, float f, float g, float h, float i, float j, float k) {
		...
		if (lv == class_1543.class_1544.field_7211) {
			...
			this.field_3426.field_3674 += class_3532.method_15362(h * 0.09F) * 0.05F + 0.05F;
			this.field_3417.field_3674 -= class_3532.method_15362(h * 0.09F) * 0.05F + 0.05F;
			this.field_3426.field_3654 += class_3532.method_15374(h * 0.067F) * 0.05F;
			this.field_3417.field_3654 -= class_3532.method_15374(h * 0.067F) * 0.05F;
		...
		} else if (lv == class_1543.class_1544.field_19012) {
			this.field_3426.field_3655 = 0.0F;
			this.field_3426.field_3657 = -5.0F;
			this.field_3426.field_3654 = class_3532.method_15362(h * 0.6662F) * 0.05F;
			this.field_3426.field_3674 = 2.670354F;
			this.field_3426.field_3675 = 0.0F;
			this.field_3417.field_3655 = 0.0F;
			this.field_3417.field_3657 = 5.0F;
			this.field_3417.field_3654 = class_3532.method_15362(h * 0.6662F) * 0.05F;
			this.field_3417.field_3674 = (float) (-Math.PI * 3.0 / 4.0);
			this.field_3417.field_3675 = 0.0F;
		}
	}
