...
public class class_1927 {
	...
	public void method_8348() {
		...
		int l = class_3532.method_15357(this.field_9195 + (double)r + 1.0);
		...
		List<class_1297> list = this.field_9187.method_8335(this.field_9185, new class_238((double)k, (double)s, (double)u, (double)l, (double)t, (double)v));
