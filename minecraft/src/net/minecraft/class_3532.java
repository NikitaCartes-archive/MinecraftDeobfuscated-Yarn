...
public class class_3532 {
	...
	public static float method_15381(float f, float g) {
		return method_15393(g - f);
	}

	public static float method_15356(float f, float g) {
		return method_15379(method_15381(f, g));
	}

	public static float method_20306(float f, float g, float h) {
		float i = method_15381(f, g);
		float j = method_15363(i, -h, h);
		return g - j;
	}
	...
	public static double method_15385(double d) {
		return d - (double)method_15372(d);
	}
