...
public class class_492 extends class_465<class_1728> {
	...
	public void render(int i, int j, float f) {
		...
		if (!lv.isEmpty()) {
			...
			class_1914 lv2 = (class_1914)lv.get(q);
			GlStateManager.disableLighting();
			if (this.field_2797.method_19259()) {
				this.method_19413(k, l, lv2);
			}

			if (lv2.method_8255() && this.method_2378(186, 35, 22, 21, (double)i, (double)j) && this.field_2797.method_20701()) {
