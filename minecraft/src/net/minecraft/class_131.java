...
public class class_131 {
	...
	private static final Map<Class<? extends class_117>, class_117.class_119<?>> field_1101 = Maps.newHashMap();
	...
	public static <T extends class_117> class_117.class_119<T> method_590(T arg) {
		class_117.class_119<T> lv = (class_117.class_119)field_1101.get(arg.getClass());
		if (lv == null) {
			throw new IllegalArgumentException("Unknown loot item function " + arg);
		} else {
			return lv;
	...
	public static BiFunction<class_1799, class_47, class_1799> method_594(BiFunction<class_1799, class_47, class_1799>[] biFunctions) {
		switch(biFunctions.length) {
			...
			default:
				return (arg, arg2) -> {
					for(BiFunction<class_1799, class_47, class_1799> biFunctionxx : biFunctions) {
						arg = (class_1799)biFunctionxx.apply(arg, arg2);
					}
	...
	static {
		...
		method_589(new class_4277.class_4278());
	}
