...
public class class_309 {
		...
		if (this.field_1682 > 0L && this.field_1682 < class_156.method_658() - 100L) {
			...
			switch (i) {
				...
				default:
					return false;
				case 70:
					this.field_1678.field_1690.method_1629(class_315.class_316.field_1933, class_437.method_2223() ? -1 : 1);
				...
				case 73:
					if (!this.field_1678.field_1724.method_7302()) {
						this.method_1465(this.field_1678.field_1724.method_5687(2), !class_437.method_2223());
					}
	...
	private void method_1465(boolean bl, boolean bl2) {
		if (this.field_1678.field_1765 != null) {
			switch (this.field_1678.field_1765.field_1330) {
				case field_1332:
					class_2338 lv = this.field_1678.field_1765.method_1015();
					class_2680 lv2 = this.field_1678.field_1724.field_6002.method_8320(lv);
					if (bl) {
						if (bl2) {
							this.field_1678.field_1724.field_3944.method_2876().method_1403(lv, arg3 -> {
								this.method_1475(lv2, lv, arg3);
								this.method_1459("debug.inspect.server.block");
							});
						} else {
							class_2586 lv3 = this.field_1678.field_1724.field_6002.method_8321(lv);
							class_2487 lv4 = lv3 != null ? lv3.method_11007(new class_2487()) : null;
							this.method_1475(lv2, lv, lv4);
							this.method_1459("debug.inspect.client.block");
						}
					} else {
						this.method_1475(lv2, lv, null);
						this.method_1459("debug.inspect.client.block");
					}
					break;
				case field_1331:
					class_1297 lv5 = this.field_1678.field_1765.field_1326;
					if (lv5 == null) {
						return;
					}

					class_2960 lv6 = class_2378.field_11145.method_10221(lv5.method_5864());
					class_243 lv7 = new class_243(lv5.field_5987, lv5.field_6010, lv5.field_6035);
					if (bl) {
						if (bl2) {
							this.field_1678.field_1724.field_3944.method_2876().method_1405(lv5.method_5628(), arg3 -> {
								this.method_1469(lv6, lv7, arg3);
								this.method_1459("debug.inspect.server.entity");
							});
						} else {
							class_2487 lv4 = lv5.method_5647(new class_2487());
							this.method_1469(lv6, lv7, lv4);
							this.method_1459("debug.inspect.client.entity");
						}
					} else {
						this.method_1469(lv6, lv7, null);
						this.method_1459("debug.inspect.client.entity");
					}
			}
		}
				...
				if (k == 0) {
					...
					if (i == 292) {
						if (this.field_1679) {
							...
							this.field_1678.field_1690.field_1880 = this.field_1678.field_1690.field_1866 && class_437.method_2223();
							this.field_1678.field_1690.field_1893 = this.field_1678.field_1690.field_1866 && class_437.method_2232();
						}
					}
				} else {
					if (i == 66 && class_437.method_2238()) {
						this.field_1678.field_1690.method_1629(class_315.class_316.field_1956, 1);
		...
		if (l == this.field_1678.field_1704.method_4490()) {
			...
			if (lv != null) {
				if (Character.charCount(i) == 1) {
					class_437.method_2217(() -> lv.method_16806((char)i, j), "charTyped event handler", lv.getClass().getCanonicalName());
				} else {
					for (char c : Character.toChars(i)) {
						class_437.method_2217(() -> lv.method_16806(c, j), "charTyped event handler", lv.getClass().getCanonicalName());
					}
				}
			}
		}
