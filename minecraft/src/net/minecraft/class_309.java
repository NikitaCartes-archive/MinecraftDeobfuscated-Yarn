				...
				if (lv != null) {
					if (this.field_19182.endsWith("IDKFA")) {
						...
						minecraftServer.method_20231(() -> {
							...
							class_1890.method_8214(ImmutableMap.of(class_1893.field_9108, 12), lv);
							lv.field_7514.method_7394(lv);
						...
						minecraftServer.method_20231(
							() -> {
								class_243 lv = lv.method_19538();
								class_243 lv2xx = new class_243(
									lv.field_1352 + (double)(this.field_19183.nextFloat() * 3.0F), lv.field_1351, lv.field_1350 + (double)(this.field_19183.nextFloat() * 3.0F)
								);
								class_1498 lv3 = class_1299.field_6139.method_5883(lv.field_6002);
								lv3.method_5814(lv2xx.field_1352, lv2xx.field_1351, lv2xx.field_1350);
						...
						minecraftServer.method_20231(() -> {
							class_2338 lv = new class_2338(lv);

							for(int ixx = 0; ixx < 5; ++ixx) {
								class_2338 lv2xx = method_20248(lv.field_6002, lv, ixx);
								if (lv2xx != null) {
									class_1548 lv3 = class_1299.field_6046.method_5883(lv.field_6002);
									lv3.method_5814((double)lv2xx.method_10263() + 0.5, (double)lv2xx.method_10264() + 0.5, (double)lv2xx.method_10260() + 0.5);
									lv3.method_20233();
									lv.field_6002.method_8649(lv3);
