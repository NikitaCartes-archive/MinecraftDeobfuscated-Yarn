...
public class class_606<T extends class_1309 & class_1603> extends class_572<T> {
	public class_606() {
		this(0.0F, false);
	}
	...
	public void method_17086(T arg, float f, float g, float h) {
		...
		if (lv.method_7909() == class_1802.field_8102 && arg.method_6999()) {
	...
	public void method_17087(T arg, float f, float g, float h, float i, float j, float k) {
		...
		if (arg.method_6999() && (lv.method_7960() || lv.method_7909() != class_1802.field_8102)) {
