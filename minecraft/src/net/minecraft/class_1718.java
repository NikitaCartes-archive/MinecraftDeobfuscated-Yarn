...
public class class_1718 extends class_1703 {
	...
	@Override
	public class_3917<class_1718> method_17358() {
		...
		if (arg == this.field_7809) {
			...
			if (!lv.method_7960() && lv.method_7923()) {
				this.field_7813.method_17393((arg2, arg3) -> {
					...
					for(int j = 0; j < 3; ++j) {
						this.field_7808[j] = class_1890.method_8227(this.field_7811, j, ixx, lv);
						this.field_7812[j] = -1;
						this.field_7810[j] = -1;
					...
					for(int j = 0; j < 3; ++j) {
						if (this.field_7808[j] > 0) {
							List<class_1889> list = this.method_7637(lv, j, this.field_7808[j]);
							if (list != null && !list.isEmpty()) {
								class_1889 lvxx = (class_1889)list.get(this.field_7811.nextInt(list.size()));
								this.field_7812[j] = class_2378.field_11160.method_10249(lvxx.field_9093);
								this.field_7810[j] = lvxx.field_9094;
							}
						}
					}
		...
		if ((lv2.method_7960() || lv2.method_7947() < j) && !arg.field_7503.field_7477) {
			...
			this.field_7813.method_17393((arg4, arg5) -> {
				...
				if (!list.isEmpty()) {
					...
					if (bl) {
						lvxx = new class_1799(class_1802.field_8598);
						this.field_7809.method_5447(0, lvxx);
					}

					for(int k = 0; k < list.size(); ++k) {
						class_1889 lv2xx = (class_1889)list.get(k);
						if (bl) {
							class_1772.method_7807(lvxx, lv2xx);
						} else {
							lvxx.method_7978(lv2xx.field_9093, lv2xx.field_9094);
						}
					}
					...
					if (arg instanceof class_3222) {
						class_174.field_1181.method_8870((class_3222)arg, lvxx, j);
					}
	...
	public boolean method_7597(class_1657 arg) {
		return this.field_7813
			.method_17396(
				(arg2, arg3) -> arg2.method_8320(arg3).method_11614() != class_2246.field_10485
						? false
