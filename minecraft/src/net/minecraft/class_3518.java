...
public class class_3518 {
	...
	public static class_1792 method_15256(JsonElement jsonElement, String string) {
		if (jsonElement.isJsonPrimitive()) {
			...
			class_1792 lv = class_2378.field_11142.method_10223(new class_2960(string2));
			if (lv == null) {
	...
	public static <T> T method_15283(
		...
		return (T)(jsonObject.has(string) ? method_15291(jsonObject.get(string), string, jsonDeserializationContext, class_) : object);
	}
