...
public class class_3215 extends class_2802 implements class_3193.class_3897 {
	...
	private final Queue<Runnable> field_13918 = Queues.newConcurrentLinkedQueue();
	...
	public boolean method_12125(class_1297 arg) {
		...
		if (lv == null) {
			...
			Either<class_2818, class_3193.class_3724> either = (Either)lv.method_14003().getNow(class_3193.field_16427);
	...
	private void method_14161() {
		...
		if (!bl) {
			...
			while(objectBidirectionalIterator.hasNext()) {
				Entry<class_3193> entry = (Entry)objectBidirectionalIterator.next();
	...
	public boolean method_14154(class_3222 arg, int i, int j) {
		...
		if (lv2 == null) {
			return false;
		} else if (lv2.method_16144() != null) {
			return method_17295(lv, arg, false) <= this.field_13942;
		} else {
			return false;
		}
	}
	...
	public Stream<class_3222> method_17211(class_1923 arg, boolean bl, boolean bl2) {
		return this.field_13930.method_14083(arg.method_8324()).filter(arg2 -> {
			...
			if (i > this.field_13942) {
				return false;
			} else {
				return !bl || i == this.field_13942;
			}
		});
	}
