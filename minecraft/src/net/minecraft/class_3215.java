...
public class class_3215 extends class_2802 {
	...
	private boolean method_20585(long l, Function<class_3193, CompletableFuture<Either<class_2818, class_3193.class_3724>>> function) {
		...
		if (lv == null) {
			...
			Either<class_2818, class_3193.class_3724> either = (Either)((CompletableFuture)function.apply(lv)).getNow(class_3193.field_16427);
			...
			this.field_17254
				...
				.forEach(
					arg2 -> {
						...
						if (optional.isPresent()) {
							class_2818 lvxx = (class_2818)optional.get();
							this.field_13945.method_16107().method_15396("broadcast");
							arg2.method_14006(lvxx);
							this.field_13945.method_16107().method_15407();
							class_1923 lv2xx = arg2.method_13994();
							if (!this.field_17254.method_18724(lv2xx)) {
								lvxx.method_12028(lvxx.method_12033() + m);
								if (bl2 && (this.field_13929 || this.field_13941) && this.field_13945.method_8621().method_11951(lvxx.method_12004())) {
									...
									for(class_1311 lv3 : lvs) {
										if (lv3 != class_1311.field_17715
											...
											if (object2IntMap.getInt(lv3) <= k) {
												class_1948.method_8663(lv3, this.field_13945, lvxx, lv2);
											}
										}
									}
								...
								this.field_13945.method_18203(lvxx, i);
							}
						}
					}
				);
