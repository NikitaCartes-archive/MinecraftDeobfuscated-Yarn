...
public class class_3089 {
									...
									class_2170.method_9244("delta", class_2277.method_9735(false))
										.then(
											class_2170.method_9244("speed", FloatArgumentType.floatArg(0.0F))
												.then(
													((RequiredArgumentBuilder)((RequiredArgumentBuilder)class_2170.method_9244("count", IntegerArgumentType.integer(0))
																.executes(
																	commandContext -> method_13491(
																			...
																			false,
																			((class_2168)commandContext.getSource()).method_9211().method_3760().method_14571()
																		)
																))
															.then(
	...
	private static int method_13491(
		class_2168 arg, class_2394 arg2, class_243 arg3, class_243 arg4, float f, int i, boolean bl, Collection<class_3222> collection
		...
		if (j == 0) {
			...
			arg.method_9226(new class_2588("commands.particle.success", class_2378.field_11141.method_10221(arg2.method_10295()).toString()), true);
			return j;
		}
	}
}
