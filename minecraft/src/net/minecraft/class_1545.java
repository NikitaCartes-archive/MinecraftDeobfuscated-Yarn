...
public class class_1545 extends class_1588 {
	...
	public class_1545(class_1937 arg) {
		super(class_1299.field_6099, arg);
	...
	public void method_6007() {
		if (!this.field_5952 && this.field_5984 < 0.0) {
			this.field_5984 *= 0.6;
		}
	...
	protected void method_5958() {
		...
		if (lv != null && lv.field_6010 + (double)lv.method_5751() > this.field_6010 + (double)this.method_5751() + (double)this.field_7214) {
			this.field_5984 = this.field_5984 + (0.3F - this.field_5984) * 0.3F;
	...
	public boolean method_6994() {
		return (this.field_6011.method_12789(field_7216) & 1) != 0;
	}

	public void method_6993(boolean bl) {
	...
	static class class_1546 extends class_1352 {
		...
		public void method_6268() {
			...
			if (d < 4.0) {
				...
				double f = lv.method_5829().field_1322 + (double)(lv.field_6019 / 2.0F) - (this.field_7219.field_6010 + (double)(this.field_7219.field_6019 / 2.0F));
				...
				if (this.field_7217 <= 0) {
					...
					if (this.field_7218 > 1) {
						...
						this.field_7219
							.field_6002
							.method_8444(null, 1018, new class_2338((int)this.field_7219.field_5987, (int)this.field_7219.field_6010, (int)this.field_7219.field_6035), 0);
						...
						for (int i = 0; i < 1; i++) {
							...
							lv2.field_6010 = this.field_7219.field_6010 + (double)(this.field_7219.field_6019 / 2.0F) + 0.5;
				...
				this.field_7219.method_5942().method_6340();
				this.field_7219.method_5962().method_6239(lv.field_5987, lv.field_6010, lv.field_6035, 1.0);
			}
		...
		private double method_6995() {
			class_1324 lv = this.field_7219.method_5996(class_1612.field_7365);
