...
public class class_1752 extends class_1792 {
	...
	public class_1269 method_7884(class_1838 arg) {
		...
		if (method_7720(arg.method_8041(), lv, lv2)) {
			...
			boolean bl = class_2248.method_9501(lv4.method_11628(lv, lv2), arg.method_8038());
			if (bl && method_7719(arg.method_8041(), lv, lv3, arg.method_8038())) {
				if (!lv.field_9236) {
					lv.method_8535(2005, lv3, 0);
				}
			...
			if (!arg2.field_9236) {
				...
				for(int i = 0; i < 128; ++i) {
					...
					for(int j = 0; j < i / 16; ++j) {
						...
						if (arg2.method_8320(lv).method_11603(arg2, lv)) {
							continue label79;
						}
					}
					...
					if (lv3.method_11614().method_9525(class_3481.field_15476)) {
						for(int j = 0; !lv3.method_11591(arg2, lv) && j < 4; ++j) {
		...
		if (!lv.method_11588()) {
			for(int j = 0; j < i; ++j) {
				...
				arg.method_8406(
					...
					(double)arg2.method_10264() + (double)field_8005.nextFloat() * lv.method_11606(arg, arg2).method_1105(class_2350.class_2351.field_11052),
