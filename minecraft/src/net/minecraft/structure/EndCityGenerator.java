...
public class EndCityGenerator {
	...
	private static final EndCityGenerator.Part SMALL_TOWER = new EndCityGenerator.Part() {
		...
		public boolean method_14687(
			...
			for(int k = 0; k < j; ++k) {
				piece2 = EndCityGenerator.addPiece(
					list, EndCityGenerator.method_14684(structureManager, piece2, new BlockPos(0, 4, 0), "tower_piece", blockRotation, true)
				);
			...
			if (piece3 != null) {
				for(Pair<BlockRotation, BlockPos> pair : EndCityGenerator.SMALL_TOWER_BRIDGE_ATTACHMENTS) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece4 = EndCityGenerator.addPiece(
							list, EndCityGenerator.method_14684(structureManager, piece3, pair.getRight(), "bridge_end", blockRotation.rotate((BlockRotation)pair.getLeft()), true)
						);
				...
				piece2 = EndCityGenerator.addPiece(
					list, EndCityGenerator.method_14684(structureManager, piece2, new BlockPos(-1, 4, -1), "tower_top", blockRotation, true)
				);
			} else {
				if (i != 7) {
				...
				for(Pair<BlockRotation, BlockPos> pair : EndCityGenerator.FAT_TOWER_BRIDGE_ATTACHMENTS) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece3 = EndCityGenerator.addPiece(
							list, EndCityGenerator.method_14684(structureManager, piece2, pair.getRight(), "bridge_end", blockRotation.rotate((BlockRotation)pair.getLeft()), true)
						);
