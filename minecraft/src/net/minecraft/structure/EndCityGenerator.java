				...
				for(Pair<Rotation, BlockPos> pair : EndCityGenerator.field_14385) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece4 = EndCityGenerator.addPiece(
							list, EndCityGenerator.createPiece(structureManager, piece3, pair.getRight(), "bridge_end", rotation.rotate((Rotation)pair.getLeft()), true)
						);
				...
				for(Pair<Rotation, BlockPos> pair : EndCityGenerator.field_14388) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece3 = EndCityGenerator.addPiece(
							list, EndCityGenerator.createPiece(structureManager, piece2, pair.getRight(), "bridge_end", rotation.rotate((Rotation)pair.getLeft()), true)
						);
