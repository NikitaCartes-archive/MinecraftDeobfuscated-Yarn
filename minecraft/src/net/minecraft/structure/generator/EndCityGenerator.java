		...
		public boolean method_14687(
			...
			if (i > 8) {
				...
				if (j == 0) {
					...
					piece2 = EndCityGenerator.addPiece(
						list, EndCityGenerator.createPiece(structureManager, piece2, new BlockPos(-1, 4, -1), "third_floor_2", rotation, false)
					);
				...
				for(Pair<Rotation, BlockPos> pair : EndCityGenerator.field_14385) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece4 = EndCityGenerator.addPiece(
							list, EndCityGenerator.createPiece(structureManager, piece3, pair.getRight(), "bridge_end", rotation.method_10501((Rotation)pair.getLeft()), true)
						);
				...
				for(Pair<Rotation, BlockPos> pair : EndCityGenerator.field_14388) {
					if (random.nextBoolean()) {
						EndCityGenerator.Piece piece3 = EndCityGenerator.addPiece(
							list, EndCityGenerator.createPiece(structureManager, piece2, pair.getRight(), "bridge_end", rotation.method_10501((Rotation)pair.getLeft()), true)
						);
