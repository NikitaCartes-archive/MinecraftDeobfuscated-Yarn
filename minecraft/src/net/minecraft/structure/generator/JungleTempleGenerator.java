...
public class JungleTempleGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
		if (!this.method_14839(iWorld, mutableIntBoundingBox, 0)) {
			...
			BlockState blockState = Blocks.field_10596.method_9564().method_11657(StairsBlock.field_11571, Direction.EAST);
			BlockState blockState2 = Blocks.field_10596.method_9564().method_11657(StairsBlock.field_11571, Direction.WEST);
			BlockState blockState3 = Blocks.field_10596.method_9564().method_11657(StairsBlock.field_11571, Direction.SOUTH);
			BlockState blockState4 = Blocks.field_10596.method_9564().method_11657(StairsBlock.field_11571, Direction.NORTH);
			...
			this.addBlock(
				...
				Blocks.field_10348
					.method_9564()
					.method_11657(TripwireHookBlock.field_11666, Direction.EAST)
			...
			this.addBlock(
				...
				Blocks.field_10348
					.method_9564()
					.method_11657(TripwireHookBlock.field_11666, Direction.WEST)
					.method_11657(TripwireHookBlock.field_11669, Boolean.valueOf(true)),
				4,
				-3,
				8,
			...
			if (!this.placedTrap1) {
				this.placedTrap1 = this.method_14930(iWorld, mutableIntBoundingBox, random, 3, -2, 1, Direction.NORTH, LootTables.field_751);
			}
			...
			this.addBlock(
				...
				Blocks.field_10348
					.method_9564()
					.method_11657(TripwireHookBlock.field_11666, Direction.NORTH)
					.method_11657(TripwireHookBlock.field_11669, Boolean.valueOf(true)),
				7,
				-3,
				1,
			...
			this.addBlock(
				...
				Blocks.field_10348
					.method_9564()
					.method_11657(TripwireHookBlock.field_11666, Direction.SOUTH)
					.method_11657(TripwireHookBlock.field_11669, Boolean.valueOf(true)),
				7,
				-3,
				5,
			...
			if (!this.placedTrap2) {
				this.placedTrap2 = this.method_14930(iWorld, mutableIntBoundingBox, random, 9, -2, 3, Direction.WEST, LootTables.field_751);
			}
			...
			if (!this.placedMainChest) {
				this.placedMainChest = this.method_14915(iWorld, mutableIntBoundingBox, random, 8, -3, 3, LootTables.field_803);
			}
			...
			BlockState blockState6 = Blocks.field_10363
				.method_9564()
				.method_11657(LeverBlock.field_11177, Direction.NORTH)
			...
			this.addBlock(iWorld, Blocks.field_10615.method_9564().method_11657(PistonBlock.field_10927, Direction.UP), 9, -2, 8, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10615.method_9564().method_11657(PistonBlock.field_10927, Direction.WEST), 10, -2, 8, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10615.method_9564().method_11657(PistonBlock.field_10927, Direction.WEST), 10, -1, 8, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10450.method_9564().method_11657(RepeaterBlock.field_11177, Direction.NORTH), 10, -2, 10, mutableIntBoundingBox);
			if (!this.placedHiddenChest) {
				this.placedHiddenChest = this.method_14915(iWorld, mutableIntBoundingBox, random, 9, -3, 10, LootTables.field_803);
			}
