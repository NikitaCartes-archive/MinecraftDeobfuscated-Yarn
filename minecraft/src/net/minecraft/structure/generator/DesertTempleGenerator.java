...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
		...
		this.fillWithOutline(
			iWorld, mutableIntBoundingBox, 8, -14, 8, 12, -11, 12, Blocks.field_10361.getDefaultState(), Blocks.field_10361.getDefaultState(), false
		);
		this.fillWithOutline(
			iWorld, mutableIntBoundingBox, 8, -10, 8, 12, -10, 12, Blocks.field_10292.getDefaultState(), Blocks.field_10292.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			iWorld, mutableIntBoundingBox, 9, -13, 9, 11, -13, 11, Blocks.field_10375.getDefaultState(), Blocks.field_10124.getDefaultState(), false
		);
