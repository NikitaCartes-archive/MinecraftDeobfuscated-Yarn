		...
		StructurePoolBasedGenerator.REGISTRY
			.add(
				new StructurePool(
					...
					ImmutableList.of(
						new Pair<>(new SinglePoolElement("village/snowy/town_centers/snowy_meeting_point_1"), 2),
						new Pair<>(new SinglePoolElement("village/snowy/town_centers/snowy_meeting_point_2"), 1),
						new Pair<>(new SinglePoolElement("village/snowy/town_centers/snowy_meeting_point_3"), 3)
					),
		...
		StructurePoolBasedGenerator.REGISTRY
			.add(
				new StructurePool(
					...
					ImmutableList.of(
						new Pair<>(new SinglePoolElement("village/snowy/streets/corner_01", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/corner_02", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/corner_03", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/square_01", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_01", immutableList), 4),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_02", immutableList), 4),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_03", immutableList), 4),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_04", immutableList), 7),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_06", immutableList), 4),
						new Pair<>(new SinglePoolElement("village/snowy/streets/straight_08", immutableList), 4),
						new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_02", immutableList), 1),
						new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_03", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_04", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_05", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_06", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/snowy/streets/turn_01", immutableList), 3)
					),
			...
			.add(
				new StructurePool(
					...
					ImmutableList.of(
						...
						new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_1", immutableList2), 3),
						new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_2", immutableList2), 3),
