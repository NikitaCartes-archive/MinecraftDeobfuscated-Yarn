			...
			.add(
				new StructurePool(
					...
					ImmutableList.of(
						...
						new Pair<>(new SinglePoolElement("village/plains/town_centers/plains_meeting_point_2"), 1),
						new Pair<>(
							new SinglePoolElement(
		...
		StructurePoolBasedGenerator.REGISTRY
			.add(
				new StructurePool(
					...
					ImmutableList.of(
						new Pair<>(new SinglePoolElement("village/plains/streets/corner_01", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/corner_02", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/corner_03", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_01", immutableList2), 4),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_02", immutableList2), 4),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_03", immutableList2), 7),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_04", immutableList2), 7),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_05", immutableList2), 3),
						new Pair<>(new SinglePoolElement("village/plains/streets/straight_06", immutableList2), 4),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_01", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_02", immutableList2), 1),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_03", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_04", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_05", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/crossroad_06", immutableList2), 2),
						new Pair<>(new SinglePoolElement("village/plains/streets/turn_01", immutableList2), 3)
					),
		...
		StructurePoolBasedGenerator.REGISTRY
			.add(
				new StructurePool(
					...
					new Identifier("village/plains/terminators"),
					ImmutableList.of(
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_2", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_3", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_4", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_5", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_6", immutableList), 1),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_7", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_house_8", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_medium_house_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_medium_house_2", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_big_house_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_butcher_shop_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_butcher_shop_2", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_tool_smith_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_fletcher_house_1", immutableList), 2),
						...
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_stable_1", immutableList), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_stable_2"), 2),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_large_farm_1", immutableList3), 4),
						new Pair<>(new SinglePoolElement("village/plains/houses/plains_small_farm_1", immutableList3), 4),
