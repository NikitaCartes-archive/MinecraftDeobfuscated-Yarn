	...
	public static class CorridorExit extends NetherFortressGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int ix = 4; ix <= 8; ix++) {
				for (int j = 0; j <= 2; j++) {
					this.method_14936(iWorld, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, j, mutableIntBoundingBox);
					this.method_14936(iWorld, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, 12 - j, mutableIntBoundingBox);
				}
			}
			...
			for (int ix = 0; ix <= 2; ix++) {
				for (int j = 4; j <= 8; j++) {
					this.method_14936(iWorld, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, j, mutableIntBoundingBox);
					this.method_14936(iWorld, Blocks.NETHER_BRICKS.getDefaultState(), 12 - ix, -1, j, mutableIntBoundingBox);
				}
			}
	...
	public static class CorridorStairs extends NetherFortressGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int i = 0; i <= 9; i++) {
				...
				int l = i;
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 0, 0, i, 4, j, i, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
				...
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 0, k, i, 4, k, i, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
				this.fillWithOutline(
