		...
		public boolean generate(IWorld world, ChunkGenerator<?> generator, Random random, BlockBox box, ChunkPos pos) {
			...
			for(int i = 3; i <= 9; i += 2) {
				this.fillWithOutline(
					world, box, 1, 7, i, 1, 8, i, blockState2.with(FenceBlock.WEST, Boolean.valueOf(true)), blockState2.with(FenceBlock.WEST, Boolean.valueOf(true)), false
				);
				this.fillWithOutline(
					world, box, 11, 7, i, 11, 8, i, blockState2.with(FenceBlock.EAST, Boolean.valueOf(true)), blockState2.with(FenceBlock.EAST, Boolean.valueOf(true)), false
				);
			}
