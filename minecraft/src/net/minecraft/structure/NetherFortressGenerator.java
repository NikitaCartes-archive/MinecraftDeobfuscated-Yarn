...
public class NetherFortressGenerator {
	...
	public static class CorridorExit extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			for (int ix = 4; ix <= 8; ix++) {
				for (int j = 0; j <= 2; j++) {
					this.method_14936(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, j, boundingBox);
					this.method_14936(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, 12 - j, boundingBox);
				}
			}
			...
			for (int ix = 0; ix <= 2; ix++) {
				for (int j = 4; j <= 8; j++) {
					this.method_14936(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), ix, -1, j, boundingBox);
					this.method_14936(serverWorldAccess, Blocks.NETHER_BRICKS.getDefaultState(), 12 - ix, -1, j, boundingBox);
				}
			}
	...
	public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			for (int ix = 3; ix <= 9; ix += 2) {
				this.fillWithOutline(serverWorldAccess, boundingBox, 1, 7, ix, 1, 8, ix, blockState3, blockState3, false);
				this.fillWithOutline(serverWorldAccess, boundingBox, 11, 7, ix, 11, 8, ix, blockState4, blockState4, false);
			}
