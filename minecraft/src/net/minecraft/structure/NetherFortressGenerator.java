...
public class NetherFortressGenerator {
	...
	public static class Bridge extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 3, 0, 4, 4, 18, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 1, 5, 0, 3, 7, 18, Blocks.field_10124.getDefaultState(), Blocks.field_10124.getDefaultState(), false
			);
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 5, 0, 0, 5, 18, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 4, 5, 0, 4, 5, 18, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
	...
	public static class BridgeCrossing extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 7, 2, 0, 11, 2, 5, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 7, 0, 0, 11, 1, 3, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 2, 7, 5, 2, 11, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 0, 7, 3, 1, 11, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
	...
	public static class BridgeStairs extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 6, 1, 6, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false);
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 2, 0, 6, 10, 6, Blocks.field_10124.getDefaultState(), Blocks.field_10124.getDefaultState(), false
			);
	...
	public static class CorridorExit extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 2, 5, 0, 4, 12, 1, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 5, 9, 0, 7, 12, 1, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 4, 2, 0, 8, 2, 12, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 0, 2, 4, 12, 2, 8, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 4, 0, 9, 8, 1, 12, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 9, 0, 4, 12, 1, 8, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);

			for(int i = 4; i <= 8; ++i) {
				for(int j = 0; j <= 2; ++j) {
					this.method_14936(structureWorldAccess, Blocks.field_10266.getDefaultState(), i, -1, j, boundingBox);
					this.method_14936(structureWorldAccess, Blocks.field_10266.getDefaultState(), i, -1, 12 - j, boundingBox);
				}
			}
			...
			for(int i = 0; i <= 2; ++i) {
				for(int j = 4; j <= 8; ++j) {
					this.method_14936(structureWorldAccess, Blocks.field_10266.getDefaultState(), i, -1, j, boundingBox);
					this.method_14936(structureWorldAccess, Blocks.field_10266.getDefaultState(), 12 - i, -1, j, boundingBox);
				}
			}
	...
	public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 2, 5, 9, 3, 5, 10, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			...
			this.fillWithOutline(
				structureWorldAccess, boundingBox, 9, 5, 2, 10, 5, 3, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
			);
			this.fillWithOutline(
	...
	public static class CorridorStairs extends NetherFortressGenerator.Piece {
		...
		public boolean generate(
			...
			for(int i = 0; i <= 9; ++i) {
				...
				int l = i;
				this.fillWithOutline(
					structureWorldAccess, boundingBox, 0, 0, i, 4, j, i, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
				);
				this.fillWithOutline(
				...
				this.fillWithOutline(
					structureWorldAccess, boundingBox, 0, k, i, 4, k, i, Blocks.field_10266.getDefaultState(), Blocks.field_10266.getDefaultState(), false
				);
				this.fillWithOutline(
