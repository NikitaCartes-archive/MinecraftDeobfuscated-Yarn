	...
	public static class class_3396 extends NetherFortressGenerator.class_3403 {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for(int i = 4; i <= 8; ++i) {
				for(int j = 0; j <= 2; ++j) {
					this.method_14936(iWorld, Blocks.field_10266.getDefaultState(), i, -1, j, mutableIntBoundingBox);
					this.method_14936(iWorld, Blocks.field_10266.getDefaultState(), i, -1, 12 - j, mutableIntBoundingBox);
				}
			}
			...
			for(int i = 0; i <= 2; ++i) {
				for(int j = 4; j <= 8; ++j) {
					this.method_14936(iWorld, Blocks.field_10266.getDefaultState(), i, -1, j, mutableIntBoundingBox);
					this.method_14936(iWorld, Blocks.field_10266.getDefaultState(), 12 - i, -1, j, mutableIntBoundingBox);
				}
			}
