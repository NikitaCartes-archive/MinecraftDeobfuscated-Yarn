	...
	public static final RegistryEntry<StructurePool> STRUCTURE_POOLS = StructurePools.register(
		new StructurePool(
			...
			ImmutableList.of(
				...
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/desert/zombie/town_centers/desert_meeting_point_1", StructureProcessorLists.ZOMBIE_DESERT), 2
				),
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/desert/zombie/town_centers/desert_meeting_point_2", StructureProcessorLists.ZOMBIE_DESERT), 2
				),
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/desert/zombie/town_centers/desert_meeting_point_3", StructureProcessorLists.ZOMBIE_DESERT), 1
				)
			),
		...
		StructurePools.register(
			new StructurePool(
				...
				ImmutableList.of(
					...
					Pair.of(StructurePoolElement.ofFeature(VillagePlacedFeatures.PATCH_CACTUS), 4),
