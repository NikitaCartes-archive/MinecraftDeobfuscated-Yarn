...
public class StrongholdGenerator {
	...
	public static class ChestCorridor extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.generateEntrance(iWorld, random, blockBox, StrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 6);
	...
	public static class FiveWayCrossing extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 6, 5, 6, blockBox);
			return true;
		}
	}
	...
	public static class Library extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.fillWithOutlineUnderSealevel(
				iWorld, blockBox, random, 0.07F, 2, 1, 1, 11, 4, 13, Blocks.COBWEB.getDefaultState(), Blocks.COBWEB.getDefaultState(), false, false
			);
			int j = 1;
			int k = 12;
			...
			for (int l = 1; l <= 13; l++) {
				if ((l - 1) % 4 == 0) {
					...
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 2, 3, l, blockBox);
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 11, 3, l, blockBox);
					if (this.tall) {
			...
			for (int lx = 3; lx < 12; lx += 2) {
				this.fillWithOutline(iWorld, blockBox, 3, 1, lx, 4, 3, lx, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
				this.fillWithOutline(iWorld, blockBox, 6, 1, lx, 7, 3, lx, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
				this.fillWithOutline(iWorld, blockBox, 9, 1, lx, 10, 3, lx, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
			}
			...
			if (this.tall) {
				...
				this.addBlock(
					iWorld, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true)), 3, 6, 2, blockBox
				);
				this.addBlock(
					iWorld, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true)), 3, 6, 12, blockBox
				);
				this.addBlock(
					iWorld, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.WEST, Boolean.valueOf(true)), 10, 6, 2, blockBox
				);
		...
		protected void generateEntrance(IWorld iWorld, Random random, BlockBox blockBox, StrongholdGenerator.Piece.EntranceType entranceType, int i, int j, int k) {
			switch (entranceType) {
				...
				case WOOD_DOOR:
					...
					this.addBlock(iWorld, Blocks.OAK_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), i + 1, j + 1, k, blockBox);
					break;
				case GRATES:
					...
					this.addBlock(iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)), i, j, k, blockBox);
					this.addBlock(iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)), i, j + 1, k, blockBox);
					this.addBlock(
						iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, Boolean.valueOf(true)).with(PaneBlock.WEST, Boolean.valueOf(true)), i, j + 2, k, blockBox
					);
					this.addBlock(
						iWorld,
					...
					this.addBlock(iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, Boolean.valueOf(true)), i + 2, j + 1, k, blockBox);
					this.addBlock(iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, Boolean.valueOf(true)), i + 2, j, k, blockBox);
					break;
				case IRON_DOOR:
					this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j, k, blockBox);
					this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j + 1, k, blockBox);
					...
					this.addBlock(iWorld, Blocks.IRON_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), i + 1, j + 1, k, blockBox);
					this.addBlock(iWorld, Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.NORTH), i + 2, j + 1, k + 1, blockBox);
					this.addBlock(iWorld, Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.SOUTH), i + 2, j + 1, k - 1, blockBox);
			}
		}
	...
	public static class PortalRoom extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.generateEntrance(iWorld, random, blockBox, StrongholdGenerator.Piece.EntranceType.GRATES, 4, 1, 0);
			int i = 6;
	...
	public static class PrisonHall extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			for (int i = 1; i <= 3; i++) {
				this.addBlock(
					iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, i, 4, blockBox
				);
				this.addBlock(
					iWorld,
					Blocks.IRON_BARS
				...
				this.addBlock(
					iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, i, 6, blockBox
				);
				this.addBlock(
					iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 5, i, 5, blockBox
				);
				this.addBlock(
					iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 6, i, 5, blockBox
				);
				this.addBlock(
					iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 7, i, 5, blockBox
				);
			}

			this.addBlock(
				iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, 3, 2, blockBox
			);
			this.addBlock(
				iWorld, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, 3, 8, blockBox
			);
	...
	public static class SpiralStaircase extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.generateEntrance(iWorld, random, blockBox, StrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 4);
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			switch (this.roomType) {
				case 0:
					...
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 4, 3, 5, blockBox);
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 6, 3, 5, blockBox);
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 5, 3, 4, blockBox);
					this.addBlock(iWorld, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.NORTH), 5, 3, 6, blockBox);
	...
	public static class Stairs extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
			...
			this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 1, 7, 0);
			this.generateEntrance(iWorld, random, blockBox, StrongholdGenerator.Piece.EntranceType.OPENING, 1, 1, 7);
