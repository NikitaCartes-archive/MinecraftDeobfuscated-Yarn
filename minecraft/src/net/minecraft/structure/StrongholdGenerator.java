		...
		protected void generateEntrance(
			...
			switch(type) {
				...
				case IRON_DOOR:
					...
					this.addBlock(
						serverWorldAccess, Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.NORTH), x + 2, y + 1, z + 1, boundingBox
					);
					this.addBlock(
						serverWorldAccess, Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.SOUTH), x + 2, y + 1, z - 1, boundingBox
					);
			}
		}
