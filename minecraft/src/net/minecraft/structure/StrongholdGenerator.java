		...
		public boolean generate(
			...
			for(int l = 1; l <= 13; ++l) {
				if ((l - 1) % 4 == 0) {
					...
					if (this.tall) {
						this.fillWithOutline(
							structureWorldAccess, boundingBox, 1, 6, l, 1, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false
						);
						this.fillWithOutline(
					...
					if (this.tall) {
						...
						this.fillWithOutline(
							structureWorldAccess, boundingBox, 12, 6, l, 12, 9, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false
						);
					}
				}
			}
			...
			if (this.tall) {
				...
				this.fillWithOutline(
					structureWorldAccess, boundingBox, 4, 5, 12, 9, 5, 13, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false
				);
