	...
	public static class Library extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for(int l = 3; l < 12; l += 2) {
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 3, 1, l, 4, 3, l, Blocks.field_10504.method_9564(), Blocks.field_10504.method_9564(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 6, 1, l, 7, 3, l, Blocks.field_10504.method_9564(), Blocks.field_10504.method_9564(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 9, 1, l, 10, 3, l, Blocks.field_10504.method_9564(), Blocks.field_10504.method_9564(), false);
			}
		...
		protected void generateEntrance(
			...
			switch(entranceType) {
				...
				case field_15291:
					...
					this.addBlock(
						iWorld,
						Blocks.field_10494.method_9564().method_11657(AbstractButtonBlock.field_11177, Direction.field_11043),
						i + 2,
						j + 1,
						k + 1,
						mutableIntBoundingBox
					...
					this.addBlock(
						iWorld,
						Blocks.field_10494.method_9564().method_11657(AbstractButtonBlock.field_11177, Direction.field_11035),
						i + 2,
						j + 1,
						k - 1,
						mutableIntBoundingBox
