	...
	public static class Library extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for(int l = 1; l <= 13; ++l) {
				if ((l - 1) % 4 == 0) {
					...
					if (this.tall) {
						...
						this.fillWithOutline(
							iWorld, mutableIntBoundingBox, 12, 6, l, 12, 9, l, Blocks.field_10161.getDefaultState(), Blocks.field_10161.getDefaultState(), false
						);
					}
				} else {
					...
					if (this.tall) {
						...
						this.fillWithOutline(
							iWorld, mutableIntBoundingBox, 12, 6, l, 12, 9, l, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false
						);
					}
				}
			}
			...
			for(int l = 3; l < 12; l += 2) {
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 3, 1, l, 4, 3, l, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 6, 1, l, 7, 3, l, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 9, 1, l, 10, 3, l, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
			}
