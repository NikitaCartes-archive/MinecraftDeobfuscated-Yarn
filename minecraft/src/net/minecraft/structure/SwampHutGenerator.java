...
public class SwampHutGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
		if (!this.method_14839(iWorld, mutableIntBoundingBox, 0)) {
			...
			BlockState blockState = Blocks.field_10569.method_9564().method_11657(StairsBlock.field_11571, Direction.field_11043);
			BlockState blockState2 = Blocks.field_10569.method_9564().method_11657(StairsBlock.field_11571, Direction.field_11034);
			BlockState blockState3 = Blocks.field_10569.method_9564().method_11657(StairsBlock.field_11571, Direction.field_11039);
			BlockState blockState4 = Blocks.field_10569.method_9564().method_11657(StairsBlock.field_11571, Direction.field_11035);
			...
			if (!this.hasWitch) {
				...
				if (mutableIntBoundingBox.contains(new BlockPos(i, j, k))) {
					this.hasWitch = true;
					WitchEntity witchEntity = EntityType.field_6145.method_5883(iWorld.getWorld());
					witchEntity.setPersistent();
					witchEntity.setPositionAndAngles((double)i + 0.5, (double)j, (double)k + 0.5, 0.0F, 0.0F);
					witchEntity.method_5943(iWorld, iWorld.getLocalDifficulty(new BlockPos(i, j, k)), SpawnType.field_16474, null, null);
	...
	private void method_16181(IWorld iWorld, MutableIntBoundingBox mutableIntBoundingBox) {
		if (!this.hasCat) {
			...
			if (mutableIntBoundingBox.contains(new BlockPos(i, j, k))) {
				this.hasCat = true;
				CatEntity catEntity = EntityType.field_16281.method_5883(iWorld.getWorld());
				catEntity.setPersistent();
				catEntity.setPositionAndAngles((double)i + 0.5, (double)j, (double)k + 0.5, 0.0F, 0.0F);
				catEntity.method_5943(iWorld, iWorld.getLocalDifficulty(new BlockPos(i, j, k)), SpawnType.field_16474, null, null);
