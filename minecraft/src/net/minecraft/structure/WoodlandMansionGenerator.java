	...
	static class LayoutGenerator {
		...
		public void generate(
			...
			for(int l = 0; l < 3; ++l) {
				...
				WoodlandMansionGenerator.class_3478 lv3 = mansionParameters.field_15443[l];
				...
				for(int o = 0; o < lv4.field_15453; ++o) {
					for(int p = 0; p < lv4.field_15454; ++p) {
						...
						if (lv4.method_15066(p, o) == 2 || bl2) {
							...
							if (WoodlandMansionGenerator.MansionParameters.method_15047(lv4, p - 1, o) && !mansionParameters.method_15039(lv4, p - 1, o, l, s)) {
							...
							if (WoodlandMansionGenerator.MansionParameters.method_15047(lv4, p, o + 1) && !mansionParameters.method_15039(lv4, p, o + 1, l, s)) {
							...
							if (r == 65536) {
								...
								Direction direction3 = mansionParameters.method_15040(lv4, p, o, l, s);
			...
			if (arg2 != null) {
				for(int i = 0; i < arg.field_15453; ++i) {
					for(int j = 0; j < arg.field_15454; ++j) {
						...
						boolean bl = WoodlandMansionGenerator.MansionParameters.method_15047(arg2, j, i);
						if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, j, i) && bl) {
							if (!WoodlandMansionGenerator.MansionParameters.method_15047(arg, j + 1, i)) {
				...
				for(int j = 0; j < arg.field_15454; ++j) {
					...
					if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, j, i) && !bl) {
						if (!WoodlandMansionGenerator.MansionParameters.method_15047(arg, j + 1, i)) {
							...
							} else if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, j + 1, i + 1)) {
