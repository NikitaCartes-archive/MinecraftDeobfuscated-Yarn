	...
	static class LayoutGenerator {
			...
			for(int k = 0; k < lv2.field_15453 && !bl; ++k) {
				for(int l = lv2.field_15454 - 1; l >= 0 && !bl; --l) {
					if (WoodlandMansionGenerator.class_3474.method_15047(lv2, l, k)) {
						generationPiece3.position = generationPiece3.position.method_10079(blockRotation.rotate(Direction.SOUTH), 8 + (k - this.field_15445) * 8);
						generationPiece3.position = generationPiece3.position.method_10079(blockRotation.rotate(Direction.EAST), (l - this.field_15446) * 8);
				...
				for(int m = 0; m < lv4.field_15453; ++m) {
					for(int n = 0; n < lv4.field_15454; ++n) {
						if (lv4.method_15066(n, m) == 1) {
							BlockPos blockPos3 = blockPos2.method_10079(blockRotation.rotate(Direction.SOUTH), 8 + (m - this.field_15445) * 8);
							blockPos3 = blockPos3.method_10079(blockRotation.rotate(Direction.EAST), (n - this.field_15446) * 8);
							...
							if (lv4.method_15066(n, m - 1) == 1 || (lv3.method_15066(n, m - 1) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionGenerator.Piece(this.manager, "carpet_north", blockPos3.method_10079(blockRotation.rotate(Direction.EAST), 1).up(), blockRotation)
								);
							}
							...
							if (lv4.method_15066(n + 1, m) == 1 || (lv3.method_15066(n + 1, m) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionGenerator.Piece(
										this.manager,
										"carpet_east",
										blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 1).method_10079(blockRotation.rotate(Direction.EAST), 5).up(),
										blockRotation
									)
								);
							}
							...
							if (lv4.method_15066(n, m + 1) == 1 || (lv3.method_15066(n, m + 1) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionGenerator.Piece(
										this.manager,
										string,
										blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 5).method_10079(blockRotation.rotate(Direction.WEST), 1),
										blockRotation
									)
								);
							}
							...
							if (lv4.method_15066(n - 1, m) == 1 || (lv3.method_15066(n - 1, m) & 8388608) == 8388608) {
								list.add(
									new WoodlandMansionGenerator.Piece(
										this.manager,
										string2,
										blockPos3.method_10079(blockRotation.rotate(Direction.WEST), 1).method_10079(blockRotation.rotate(Direction.NORTH), 1),
										blockRotation
									)
								);
							}
				...
				for(int o = 0; o < lv4.field_15453; ++o) {
					for(int p = 0; p < lv4.field_15454; ++p) {
						...
						if (lv4.method_15066(p, o) == 2 || bl2) {
							...
							BlockPos blockPos4 = blockPos2.method_10079(blockRotation.rotate(Direction.SOUTH), 8 + (o - this.field_15445) * 8);
							blockPos4 = blockPos4.method_10079(blockRotation.rotate(Direction.EAST), -1 + (p - this.field_15446) * 8);
							...
							if (lv4.method_15066(p + 1, o) == 1 && !bl2) {
								BlockPos blockPos5 = blockPos4.method_10079(blockRotation.rotate(Direction.EAST), 8);
							...
							if (WoodlandMansionGenerator.class_3474.method_15047(lv4, p, o + 1) && !arg.method_15039(lv4, p, o + 1, l, s)) {
								BlockPos blockPos5 = blockPos4.method_10079(blockRotation.rotate(Direction.SOUTH), 7);
								blockPos5 = blockPos5.method_10079(blockRotation.rotate(Direction.EAST), 7);
								list.add(
									new WoodlandMansionGenerator.Piece(
										this.manager, direction2 == Direction.SOUTH ? string4 : string3, blockPos5, blockRotation.rotate(BlockRotation.CLOCKWISE_90)
									)
								);
							}

							if (lv4.method_15066(p, o - 1) == 1 && !bl2) {
								BlockPos blockPos5 = blockPos4.method_10079(blockRotation.rotate(Direction.NORTH), 1);
								blockPos5 = blockPos5.method_10079(blockRotation.rotate(Direction.EAST), 7);
								list.add(
									new WoodlandMansionGenerator.Piece(
										this.manager, direction2 == Direction.NORTH ? string4 : string3, blockPos5, blockRotation.rotate(BlockRotation.CLOCKWISE_90)
									)
								);
							}
		...
		private void method_15055(
			...
			if (arg2 != null) {
				for(int i = 0; i < arg.field_15453; ++i) {
					for(int j = 0; j < arg.field_15454; ++j) {
						...
						var17 = var17.method_10079(blockRotation.rotate(Direction.EAST), (j - this.field_15446) * 8);
			...
			for(int i = 0; i < arg.field_15453; ++i) {
				for(int j = 0; j < arg.field_15454; ++j) {
					...
					var19 = var19.method_10079(blockRotation.rotate(Direction.EAST), (j - this.field_15446) * 8);
					boolean bl = arg2 != null && WoodlandMansionGenerator.class_3474.method_15047(arg2, j, i);
					if (WoodlandMansionGenerator.class_3474.method_15047(arg, j, i) && !bl) {
						if (!WoodlandMansionGenerator.class_3474.method_15047(arg, j + 1, i)) {
						...
						if (!WoodlandMansionGenerator.class_3474.method_15047(arg, j - 1, i)) {
							BlockPos blockPos3 = var19.method_10079(blockRotation.rotate(Direction.EAST), 0);
							blockPos3 = blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 0);
							if (!WoodlandMansionGenerator.class_3474.method_15047(arg, j, i + 1)) {
								BlockPos blockPos4 = blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 6);
								...
								BlockPos blockPos4 = blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 8);
							...
							if (!WoodlandMansionGenerator.class_3474.method_15047(arg, j, i - 1)) {
								list.add(new WoodlandMansionGenerator.Piece(this.manager, "roof_corner", blockPos3, blockRotation.rotate(BlockRotation.CLOCKWISE_180)));
							} else if (WoodlandMansionGenerator.class_3474.method_15047(arg, j - 1, i - 1)) {
								BlockPos blockPos4 = blockPos3.method_10079(blockRotation.rotate(Direction.SOUTH), 1);
		...
		private void addMediumRoom(
			...
			if (direction2 == Direction.EAST && direction == Direction.SOUTH) {
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumFunctionalRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_180)
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumFunctionalRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_90), BlockMirror.LEFT_RIGHT
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumFunctionalRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumFunctionalRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_90), BlockMirror.FRONT_BACK
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumFunctionalRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumGenericRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_180)
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumGenericRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.CLOCKWISE_90)
					)
				);
				...
				list.add(
					new WoodlandMansionGenerator.Piece(
						this.manager, roomPool.getMediumGenericRoom(this.random, bl), blockPos2, blockRotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
					)
				);
