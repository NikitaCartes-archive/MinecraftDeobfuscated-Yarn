...
public class FeaturePoolElement extends StructurePoolElement {
	...
	public List<Structure.StructureBlockInfo> method_16627(StructureManager structureManager, BlockPos blockPos, Rotation rotation, Random random) {
		...
		list.add(
			new Structure.StructureBlockInfo(blockPos, Blocks.field_16540.method_9564().method_11657(JigsawBlock.field_10927, Direction.DOWN), this.field_16662)
		);
		return list;
	}
	...
	public boolean method_16626(
		...
		return this.feature.method_12862(iWorld, chunkGenerator, random, blockPos);
	}
