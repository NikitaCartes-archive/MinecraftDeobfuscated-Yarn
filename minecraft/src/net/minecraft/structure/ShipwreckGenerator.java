...
public class ShipwreckGenerator {
	...
	private static final Identifier[] BEACHED_TEMPLATES = new Identifier[]{
		Identifier.method_60656("shipwreck/with_mast"),
		Identifier.method_60656("shipwreck/sideways_full"),
		Identifier.method_60656("shipwreck/sideways_fronthalf"),
		Identifier.method_60656("shipwreck/sideways_backhalf"),
		Identifier.method_60656("shipwreck/rightsideup_full"),
		Identifier.method_60656("shipwreck/rightsideup_fronthalf"),
		Identifier.method_60656("shipwreck/rightsideup_backhalf"),
		Identifier.method_60656("shipwreck/with_mast_degraded"),
		Identifier.method_60656("shipwreck/rightsideup_full_degraded"),
		Identifier.method_60656("shipwreck/rightsideup_fronthalf_degraded"),
	...
	private static final Identifier[] REGULAR_TEMPLATES = new Identifier[]{
		Identifier.method_60656("shipwreck/with_mast"),
		Identifier.method_60656("shipwreck/upsidedown_full"),
		Identifier.method_60656("shipwreck/upsidedown_fronthalf"),
		...
		Identifier.method_60656("shipwreck/rightsideup_backhalf"),
		Identifier.method_60656("shipwreck/with_mast_degraded"),
		Identifier.method_60656("shipwreck/upsidedown_full_degraded"),
		Identifier.method_60656("shipwreck/upsidedown_fronthalf_degraded"),
		Identifier.method_60656("shipwreck/upsidedown_backhalf_degraded"),
		Identifier.method_60656("shipwreck/sideways_full_degraded"),
		Identifier.method_60656("shipwreck/sideways_fronthalf_degraded"),
		Identifier.method_60656("shipwreck/sideways_backhalf_degraded"),
		Identifier.method_60656("shipwreck/rightsideup_full_degraded"),
		Identifier.method_60656("shipwreck/rightsideup_fronthalf_degraded"),
		Identifier.method_60656("shipwreck/rightsideup_backhalf_degraded")
	};
