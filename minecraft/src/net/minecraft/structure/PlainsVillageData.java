	...
	public static final StructurePool STRUCTURE_POOLS = StructurePools.register(
		new StructurePool(
			...
			ImmutableList.of(
				...
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/plains/zombie/town_centers/plains_meeting_point_1", StructureProcessorLists.ZOMBIE_PLAINS), 1
				),
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/plains/zombie/town_centers/plains_meeting_point_2", StructureProcessorLists.ZOMBIE_PLAINS), 1
				),
				Pair.of(
					StructurePoolElement.ofProcessedLegacySingle("village/plains/zombie/town_centers/plains_meeting_point_3", StructureProcessorLists.ZOMBIE_PLAINS), 1
				)
			),
	...
	static {
		...
		StructurePools.register(
			new StructurePool(
				...
				new Identifier("empty"),
				ImmutableList.of(Pair.of(StructurePoolElement.ofFeature(TreePlacedFeatures.OAK_CHECKED), 1)),
				StructurePool.Projection.RIGID
			)
		);
		StructurePools.register(
			new StructurePool(
				...
				ImmutableList.of(
					...
					Pair.of(StructurePoolElement.ofFeature(TreePlacedFeatures.OAK_CHECKED), 1),
					Pair.of(StructurePoolElement.ofFeature(VegetationConfiguredFeatures.FLOWER_PLAIN.withPlacement()), 1),
					Pair.of(StructurePoolElement.ofFeature(PileConfiguredFeatures.PILE_HAY.withPlacement()), 1),
