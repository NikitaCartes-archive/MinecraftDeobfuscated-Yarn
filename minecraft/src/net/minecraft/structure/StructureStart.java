...
public final class StructureStart {
	...
	public BlockBox getBoundingBox() {
		...
		if (blockBox == null) {
			blockBox = this.feature.method_41129(this.children.getBoundingBox());
	...
	public void place(
		...
		if (!list.isEmpty()) {
			...
			this.feature.feature.getPostProcessor().afterPlace(world, structureAccessor, chunkGenerator, random, chunkBox, chunkPos, this.children);
		}
	}
