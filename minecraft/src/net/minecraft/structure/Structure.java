				...
				if (j <= m) {
					if (!structurePlacementData.method_16444()) {
						...
						abstractVoxelShapeContainer.method_1046((direction, mx, nx, ox) -> {
							...
							BlockState blockState = iWorld.method_8320(blockPosxx);
							BlockState blockState2xx = iWorld.method_8320(blockPos2);
							BlockState blockState3 = blockState.method_11578(direction, blockState2xx, iWorld, blockPosxx, blockPos2);
							if (blockState != blockState3) {
								iWorld.method_8652(blockPosxx, blockState3, i & -2 | 16);
							}

							BlockState blockState4 = blockState2xx.method_11578(direction.getOpposite(), blockState3, iWorld, blockPos2, blockPosxx);
		...
		for(Structure.StructureBlockInfo structureBlockInfo : list) {
			...
			while(structureBlockInfo2 != null && iterator.hasNext()) {
				structureBlockInfo2 = ((StructureProcessor)iterator.next())
					.method_15110(iWorld, blockPos, structureBlockInfo, structureBlockInfo2, structurePlacementData);
			}
