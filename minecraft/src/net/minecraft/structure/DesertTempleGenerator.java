...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 12, 1, 2, 16, 2, 2, Blocks.field_10124.getDefaultState(), Blocks.field_10124.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess,
			boundingBox,
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 9, 4, 9, 11, 4, 11, Blocks.field_10124.getDefaultState(), Blocks.field_10124.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 12, 1, 8, 12, 3, 8, Blocks.field_10361.getDefaultState(), Blocks.field_10361.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, 1, 12, 8, 3, 12, Blocks.field_10361.getDefaultState(), Blocks.field_10361.getDefaultState(), false
		);
		this.fillWithOutline(
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, -8, 8, 12, -1, 12, Blocks.field_9979.getDefaultState(), Blocks.field_9979.getDefaultState(), false
		);
		this.fillWithOutline(
