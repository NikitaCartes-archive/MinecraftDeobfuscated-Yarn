...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
		...
		this.fillWithOutline(iWorld, mutableIntBoundingBox, 0, 0, 0, 4, 9, 4, Blocks.field_9979.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		...
		this.fillWithOutline(
			iWorld, mutableIntBoundingBox, this.width - 5, 0, 0, this.width - 1, 9, 4, Blocks.field_9979.getDefaultState(), Blocks.AIR.getDefaultState(), false
		);
		this.fillWithOutline(
		...
		this.fillWithOutline(iWorld, mutableIntBoundingBox, 8, 0, 0, 12, 4, 4, Blocks.field_9979.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		...
		this.fillWithOutline(iWorld, mutableIntBoundingBox, 4, 1, 1, 8, 3, 3, Blocks.field_9979.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		...
		this.fillWithOutline(iWorld, mutableIntBoundingBox, 12, 1, 1, 16, 3, 3, Blocks.field_9979.getDefaultState(), Blocks.AIR.getDefaultState(), false);
		...
		this.fillWithOutline(iWorld, mutableIntBoundingBox, 9, -13, 9, 11, -13, 11, Blocks.field_10375.getDefaultState(), Blocks.AIR.getDefaultState(), false);
