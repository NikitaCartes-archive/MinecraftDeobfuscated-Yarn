		...
		StructurePools.register(
			new StructurePool(
				...
				ImmutableList.of(
					...
					Pair.of(
						StructurePoolElement.ofProcessedSingle("ancient_city/structures/small_portal_statue", StructureProcessorLists.ANCIENT_CITY_GENERIC_DEGRADATION), 4
					),
		...
		StructurePools.register(
			new StructurePool(
				...
				ImmutableList.of(
					...
					Pair.of(
						StructurePoolElement.ofProcessedSingle("ancient_city/walls/intact_intersection_wall_1", StructureProcessorLists.ANCIENT_CITY_WALLS_DEGRADATION), 1
					),
		...
		StructurePools.register(
			new StructurePool(
				...
				ImmutableList.of(
					...
					Pair.of(
						StructurePoolElement.ofProcessedSingle("ancient_city/city_center/walls/bottom_right_corner", StructureProcessorLists.ANCIENT_CITY_GENERIC_DEGRADATION),
						1
					),
