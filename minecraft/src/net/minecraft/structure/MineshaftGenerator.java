			...
			if (i < 8) {
				if (direction != Direction.field_11043 && direction != Direction.field_11035) {
					...
					for(int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5) {
						int l = random.nextInt(5);
						if (l == 0) {
							MineshaftGenerator.tryGenerateJigsaw(structurePiece, list, random, this.boundingBox.minX - 1, this.boundingBox.minY, k, Direction.field_11039, i + 1);
						} else if (l == 1) {
							MineshaftGenerator.tryGenerateJigsaw(structurePiece, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY, k, Direction.field_11034, i + 1);
						}
					}
				}
			}
