...
public class StructureProcessorLists {
	...
	public static final StructureProcessorList ANCIENT_CITY_START_DEGRADATION = register(
		...
		ImmutableList.of(
			new ReplaceInTagStructureProcessor(BlockTags.ANCIENT_CITY_REPLACEABLES, 0.98F),
			new RuleStructureProcessor(
				ImmutableList.of(
					new StructureProcessorRule(
	...
	public static final StructureProcessorList ANCIENT_CITY_GENERIC_DEGRADATION = register(
		...
		ImmutableList.of(
			new ReplaceInTagStructureProcessor(BlockTags.ANCIENT_CITY_REPLACEABLES, 0.95F),
			new RuleStructureProcessor(
				ImmutableList.of(
					new StructureProcessorRule(
						new RandomBlockMatchRuleTest(Blocks.DEEPSLATE_BRICKS, 0.3F), AlwaysTrueRuleTest.INSTANCE, Blocks.CRACKED_DEEPSLATE_BRICKS.getDefaultState()
