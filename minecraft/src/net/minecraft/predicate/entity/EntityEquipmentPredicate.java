	...
	public boolean test(@Nullable Entity entity) {
		if (this == ANY) {
			...
			if (!this.field_16483.test(livingEntity.method_6118(EquipmentSlot.HEAD))) {
				...
				return false;
			} else if (!this.field_16486.test(livingEntity.method_6118(EquipmentSlot.HAND_MAIN))) {
				return false;
			} else {
				return this.field_16484.test(livingEntity.method_6118(EquipmentSlot.HAND_OFF));
			}
		}
	}
