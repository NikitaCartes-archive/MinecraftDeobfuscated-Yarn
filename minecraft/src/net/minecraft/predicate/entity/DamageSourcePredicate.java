...
public class DamageSourcePredicate {
	...
	public boolean method_8845(ServerWorld serverWorld, Vec3d vec3d, DamageSource damageSource) {
		if (this == EMPTY) {
			...
			return false;
		} else if (!this.directEntity.method_8909(serverWorld, vec3d, damageSource.getSource())) {
			return false;
		} else {
			return this.sourceEntity.method_8909(serverWorld, vec3d, damageSource.getAttacker());
		}
	}
