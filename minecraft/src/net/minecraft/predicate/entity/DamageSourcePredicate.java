...
public class DamageSourcePredicate {
	...
	public boolean method_8845(ServerWorld serverWorld, Vec3d vec3d, DamageSource damageSource) {
		if (this == EMPTY) {
			...
			return false;
		} else if (!this.field_9534.method_8909(serverWorld, vec3d, damageSource.method_5526())) {
			return false;
		} else {
			return this.field_9539.method_8909(serverWorld, vec3d, damageSource.method_5529());
		}
	}
