...
public class PlayerPredicate {
		...
		if (this == ANY) {
			...
			if (!this.stats.isEmpty()) {
				...
				this.stats.forEach((stat, intRange) -> {
					...
					jsonObjectxx.addProperty("type", Registry.STAT_TYPE.getId(stat.getType()).toString());
					jsonObjectxx.addProperty("stat", getStatId(stat).toString());
					jsonObjectxx.add("value", intRange.toJson());
	...
	public static class Builder {
		...
		public PlayerPredicate.Builder method_26486(Stat<?> stat, NumberRange.IntRange intRange) {
			this.stats.put(stat, intRange);
			return this;
		}
