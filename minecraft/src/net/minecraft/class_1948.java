...
public final class class_1948 {
			...
			if (!lv3.method_11621(arg3, lv2)) {
				...
				for(int m = 0; m < 3; ++m) {
					...
					for(int s = 0; s < q; ++s) {
						...
						class_1657 lv7 = arg2.method_8491((double)f, (double)g, -1.0);
						if (lv7 != null) {
							double d = lv7.method_5649((double)f, (double)k, (double)g);
							if (!(d <= 576.0) && !(arg4.method_10261((double)f, (double)k, (double)g) < 576.0)) {
								...
								if (Objects.equals(lv8, arg3.method_12004())) {
									...
									if (lv9.method_5896() && method_8659(lv, arg, lv5, lv4)) {
										...
										if (lv10 != null && method_8660(lv10, arg2, lv4, lv9)) {
											class_1297 lv11;
											try {
												lv11 = lv9.method_5883(arg2);
												if (lv11 == null) {
													throw new NullPointerException(class_2378.field_11145.method_10221(lv9) + " is unable to create an instance");
												}
											} catch (Exception var31) {
												field_9292.warn("Failed to create mob", var31);
												return;
											}

											lv11.method_5808((double)f, (double)k, (double)g, arg2.field_9229.nextFloat() * 360.0F, 0.0F);
											if (lv11 instanceof class_1308) {
												class_1308 lv12 = (class_1308)lv11;
												if ((d <= 16384.0 || !lv12.method_5974(d)) && lv12.method_5979(arg2, class_3730.field_16459) && lv12.method_5957(arg2)) {
													lv6 = lv12.method_5943(arg2, arg2.method_8404(new class_2338(lv12)), class_3730.field_16459, lv6, null);
													if (lv12.method_5957(arg2)) {
														++i;
														++r;
	...
	public static boolean method_8662(class_1922 arg, class_2338 arg2, class_2680 arg3, class_3610 arg4) {
		if (arg3.method_11603(arg, arg2)) {
			return false;
		} else if (arg3.method_11634()) {
			return false;
		} else if (!arg4.method_15769()) {
			return false;
		} else {
			return !arg3.method_11602(class_3481.field_15463);
		}
	}
		...
		if (arg4 != null && arg2.method_8621().method_11952(arg3)) {
			...
			switch(arg) {
				...
				default:
					...
					if (!lv5.method_11631(arg2, lv4) && !class_1317.method_6158(arg4, lv5)) {
						return false;
					} else {
						class_2248 lv6 = lv5.method_11614();
						boolean bl = lv6 != class_2246.field_9987 && lv6 != class_2246.field_10499;
						return bl && method_8662(arg2, arg3, lv, lv2) && method_8662(arg2, lv3, arg2.method_8320(lv3), arg2.method_8316(lv3));
					}
			}
		} else {
			return false;
					...
					for(int s = 0; !bl && s < 4; ++s) {
						...
						if (lv.field_9389.method_5896() && method_8660(class_1317.class_1319.field_6317, arg, lv3, lv.field_9389)) {
							...
							try {
								...
								field_9292.warn("Failed to create mob", var25);
								continue;
							}

							double d = class_3532.method_15350((double)n, (double)k + (double)lv4.field_5998, (double)k + 16.0 - (double)lv4.field_5998);
							double e = class_3532.method_15350((double)o, (double)l + (double)lv4.field_5998, (double)l + 16.0 - (double)lv4.field_5998);
