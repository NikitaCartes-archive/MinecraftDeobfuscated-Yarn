...
public final class class_1948 {
					...
					while(true) {
						label109: {
							...
							if (s < q) {
								...
								if (lv7 == null
									|| lv7.method_5649((double)f, (double)k, (double)g) <= 576.0
									|| arg4.method_19769(new class_243((double)f, (double)k, (double)g), 24.0)) {
									break label109;
								}

								class_1923 lv8 = new class_1923(lv4);
								if (!Objects.equals(lv8, arg3.method_12004()) && !arg2.method_8398().method_20591(lv8)) {
									break label109;
								}
								...
								if (!method_8660(lv10, arg2, lv4, lv9)
									|| !class_1317.method_20638(lv9, arg2, class_3730.field_16459, lv4, arg2.field_9229)
									|| !arg2.method_18026(lv9.method_17683((double)f, (double)k, (double)g))) {
									break label109;
								}
								...
								try {
									...
									field_9292.warn("Failed to create mob", var29);
									return;
								}
	...
	public static boolean method_8660(class_1317.class_1319 arg, class_1941 arg2, class_2338 arg3, @Nullable class_1299<?> arg4) {
		if (arg == class_1317.class_1319.field_19350) {
			return true;
		} else if (arg4 != null && arg2.method_8621().method_11952(arg3)) {
			...
			switch(arg) {
				...
				default:
					...
					if (!lv5.method_11611(arg2, lv4, arg4)) {
						...
						return method_8662(arg2, arg3, lv, lv2) && method_8662(arg2, lv3, arg2.method_8320(lv3), arg2.method_8316(lv3));
					}
			}
		} else {
			return false;
					...
					for(int s = 0; !bl && s < 4; ++s) {
						...
						if (lv.field_9389.method_5896() && method_8660(class_1317.class_1319.field_6317, arg, lv3, lv.field_9389)) {
							...
							if (!arg.method_18026(lv.field_9389.method_17683(d, (double)lv3.method_10264(), e))
								|| !class_1317.method_20638(lv.field_9389, arg, class_3730.field_16472, new class_2338(d, (double)lv3.method_10264(), e), arg.method_8409())) {
								continue;
							}
							...
							try {
								...
								field_9292.warn("Failed to create mob", var26);
								continue;
							}
