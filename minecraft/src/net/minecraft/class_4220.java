...
public class class_4220 extends class_4097<class_1646> {
	...
	protected boolean method_19609(class_3218 arg, class_1646 arg2) {
		Optional<List<class_4208>> optional = arg2.method_18868().method_19543(this.field_18866);
		Optional<class_4208> optional2 = arg2.method_18868().method_19543(this.field_18867);
		if (optional.isPresent() && optional2.isPresent()) {
			List<class_4208> list = (List)optional.get();
			if (!list.isEmpty()) {
	...
	protected Set<Pair<class_4140<?>, class_4141>> method_18914() {
		return ImmutableSet.of(
			...
			Pair.of(this.field_18866, class_4141.field_18456),
			Pair.of(this.field_18867, class_4141.field_18456)
		);
	}
