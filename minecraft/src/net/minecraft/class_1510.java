...
public class class_1510 extends class_1308 implements class_1569 {
	...
	public void method_6007() {
		...
		if (this.method_6032() <= 0.0F) {
			...
			float gx = 0.2F / (class_3532.method_15368(method_17996(lv)) * 10.0F + 1.0F);
			gx *= (float)Math.pow(2.0, lv.field_1351);
			...
			if (this.method_5987()) {
				...
				this.field_7017
					.method_5808(
						this.field_5987 + (double)(aa * 6.5F * v), this.field_6010 + (double)mx + (double)(w * 6.5F), this.field_6035 - (double)(ab * 6.5F * v), 0.0F, 0.0F
					);
				this.field_7011
					.method_5808(
						this.field_5987 + (double)(aa * 5.5F * v), this.field_6010 + (double)mx + (double)(w * 5.5F), this.field_6035 - (double)(ab * 5.5F * v), 0.0F, 0.0F
					);
