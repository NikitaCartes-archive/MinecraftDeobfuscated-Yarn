...
public class class_1510 extends class_1308 implements class_1569 {
	...
	public class_1510(class_1299<? extends class_1510> arg, class_1937 arg2) {
		super(class_1299.field_6116, arg2);
		this.field_7017 = new class_1508(this, "head", 1.0F, 1.0F);
		this.field_7011 = new class_1508(this, "neck", 3.0F, 3.0F);
		this.field_7023 = new class_1508(this, "body", 5.0F, 3.0F);
		this.field_7020 = new class_1508(this, "tail", 2.0F, 2.0F);
		this.field_7009 = new class_1508(this, "tail", 2.0F, 2.0F);
		this.field_7022 = new class_1508(this, "tail", 2.0F, 2.0F);
		this.field_7015 = new class_1508(this, "wing", 4.0F, 2.0F);
		this.field_7014 = new class_1508(this, "wing", 4.0F, 2.0F);
		...
		if (!arg2.field_9236 && arg2.field_9247 instanceof class_2880) {
			this.field_7016 = ((class_2880)arg2.field_9247).method_12513();
		} else {
	...
	public void method_6007() {
		...
		if (this.method_6032() <= 0.0F) {
			...
			this.field_6002
				.method_8406(class_2398.field_11236, this.field_5987 + (double)f, this.field_6010 + 2.0 + (double)g, this.field_6035 + (double)h, 0.0, 0.0, 0.0);
		} else {
			this.method_6830();
			class_243 lv = this.method_18798();
			float g = 0.2F / (class_3532.method_15368(method_17996(lv)) * 10.0F + 1.0F);
			g *= (float)Math.pow(2.0, lv.field_1351);
			if (this.field_7028.method_6864().method_6848()) {
				this.field_7030 += 0.1F;
			} else if (this.field_7027) {
				this.field_7030 += g * 0.5F;
			} else {
				this.field_7030 += g;
			}
			...
			if (this.method_5987()) {
				...
				if (this.field_6002.field_9236) {
					...
					class_1521 lv2 = this.field_7028.method_6864();
					lv2.method_6855();
					if (this.field_7028.method_6864() != lv2) {
						lv2 = this.field_7028.method_6864();
						lv2.method_6855();
					}

					class_243 lv3 = lv2.method_6851();
					if (lv3 != null) {
						double e = lv3.field_1352 - this.field_5987;
						double j = lv3.field_1351 - this.field_6010;
						double k = lv3.field_1350 - this.field_6035;
						double l = e * e + j * j + k * k;
						float m = lv2.method_6846();
						double n = (double)class_3532.method_15368(e * e + k * k);
						if (n > 0.0) {
							j = class_3532.method_15350(j / n, (double)(-m), (double)m);
						}

						this.method_18799(this.method_18798().method_1031(0.0, j * 0.01, 0.0));
						this.field_6031 = class_3532.method_15393(this.field_6031);
						double o = class_3532.method_15350(
							class_3532.method_15338(180.0 - class_3532.method_15349(e, k) * 180.0F / (float)Math.PI - (double)this.field_6031), -50.0, 50.0
						);
						class_243 lv4 = lv3.method_1023(this.field_5987, this.field_6010, this.field_6035).method_1029();
						class_243 lv5 = new class_243(
							...
							.method_1029();
						float p = Math.max(((float)lv5.method_1026(lv4) + 0.5F) / 1.5F, 0.0F);
						this.field_6267 *= 0.8F;
						this.field_6267 = (float)((double)this.field_6267 + o * (double)lv2.method_6847());
						this.field_6031 += this.field_6267 * 0.1F;
						float q = (float)(2.0 / (l + 1.0));
						float r = 0.06F;
						this.method_5724(0.06F * (p * q + (1.0F - q)), new class_243(0.0, 0.0, -1.0));
						if (this.field_7027) {
							this.method_5784(class_1313.field_6308, this.method_18798().method_1021(0.8F));
						} else {
							this.method_5784(class_1313.field_6308, this.method_18798());
						}

						class_243 lv6 = this.method_18798().method_1029();
						double s = 0.8 + 0.15 * (lv6.method_1026(lv5) + 1.0) / 2.0;
						this.method_18799(this.method_18798().method_18805(s, 0.91F, s));
					}
				}
				...
				for(int t = 0; t < this.field_7032.length; ++t) {
					lvs[t] = new class_243(this.field_7032[t].field_5987, this.field_7032[t].field_6010, this.field_7032[t].field_6035);
				}

				float u = (float)(this.method_6817(5, 1.0F)[1] - this.method_6817(10, 1.0F)[1]) * 10.0F * (float) (Math.PI / 180.0);
				float v = class_3532.method_15362(u);
				float w = class_3532.method_15374(u);
				float x = this.field_6031 * (float) (Math.PI / 180.0);
				float y = class_3532.method_15374(x);
				float z = class_3532.method_15362(x);
				this.field_7023.method_5773();
				this.field_7023.method_5808(this.field_5987 + (double)(y * 0.5F), this.field_6010, this.field_6035 - (double)(z * 0.5F), 0.0F, 0.0F);
				this.field_7015.method_5773();
				this.field_7015.method_5808(this.field_5987 + (double)(z * 4.5F), this.field_6010 + 2.0, this.field_6035 + (double)(y * 4.5F), 0.0F, 0.0F);
				this.field_7014.method_5773();
				this.field_7014.method_5808(this.field_5987 - (double)(z * 4.5F), this.field_6010 + 2.0, this.field_6035 - (double)(y * 4.5F), 0.0F, 0.0F);
				if (!this.field_6002.field_9236 && this.field_6235 == 0) {
					this.method_6825(
						this.field_6002.method_8333(this, this.field_7015.method_5829().method_1009(4.0, 2.0, 4.0).method_989(0.0, -2.0, 0.0), class_1301.field_6156)
					);
					this.method_6825(
						this.field_6002.method_8333(this, this.field_7014.method_5829().method_1009(4.0, 2.0, 4.0).method_989(0.0, -2.0, 0.0), class_1301.field_6156)
					);
					this.method_6827(this.field_6002.method_8333(this, this.field_7017.method_5829().method_1014(1.0), class_1301.field_6156));
					this.method_6827(this.field_6002.method_8333(this, this.field_7011.method_5829().method_1014(1.0), class_1301.field_6156));
				}

				double[] ds = this.method_6817(5, 1.0F);
				float aa = class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0) - this.field_6267 * 0.01F);
				float ab = class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0) - this.field_6267 * 0.01F);
				this.field_7017.method_5773();
				this.field_7011.method_5773();
				float m = this.method_6820(1.0F);
				this.field_7017
					.method_5808(
						this.field_5987 + (double)(aa * 6.5F * v), this.field_6010 + (double)m + (double)(w * 6.5F), this.field_6035 - (double)(ab * 6.5F * v), 0.0F, 0.0F
					);
				this.field_7011
					.method_5808(
						this.field_5987 + (double)(aa * 5.5F * v), this.field_6010 + (double)m + (double)(w * 5.5F), this.field_6035 - (double)(ab * 5.5F * v), 0.0F, 0.0F
					);
				...
				for(int ac = 0; ac < 3; ++ac) {
					...
					float ad = this.field_6031 * (float) (Math.PI / 180.0) + this.method_6832(es[0] - ds[0]) * (float) (Math.PI / 180.0);
					float ae = class_3532.method_15374(ad);
					float af = class_3532.method_15362(ad);
					float ag = 1.5F;
					float ah = (float)(ac + 1) * 2.0F;
					lv7.method_5773();
					lv7.method_5808(
						this.field_5987 - (double)((y * 1.5F + ae * ah) * v),
						this.field_6010 + (es[1] - ds[1]) - (double)((ah + 1.5F) * w) + 1.5,
						this.field_6035 + (double)((z * 1.5F + af * ah) * v),
						0.0F,
						0.0F
					);
				}
				...
				for(int ac = 0; ac < this.field_7032.length; ++ac) {
					this.field_7032[ac].field_6014 = lvs[ac].field_1352;
					this.field_7032[ac].field_6036 = lvs[ac].field_1351;
					this.field_7032[ac].field_5969 = lvs[ac].field_1350;
				}
			}
		}
	}
	...
	private void method_6830() {
		...
		if (this.field_5974.nextInt(10) == 0) {
			List<class_1511> list = this.field_6002.method_18467(class_1511.class, this.method_5829().method_1014(32.0));
			class_1511 lv = null;
	...
	private boolean method_6821(class_238 arg) {
			...
			for(int p = j; p <= m; ++p) {
				for(int q = k; q <= n; ++q) {
					...
					if (!lv2.method_11588() && lv2.method_11620() != class_3614.field_15943) {
						if (this.field_6002.method_8450().method_8355(class_1928.field_19388) && !class_3481.field_17753.method_15141(lv3)) {
							bl2 = this.field_6002.method_8650(lv, false) || bl2;
						} else {
							bl = true;
						}
					}
		...
		if (bl2) {
			class_2338 lv4 = new class_2338(i + this.field_5974.nextInt(l - i + 1), j + this.field_5974.nextInt(m - j + 1), k + this.field_5974.nextInt(n - k + 1));
			this.field_6002.method_20290(2008, lv4, 0);
		}
	...
	public boolean method_6816(class_1508 arg, class_1282 arg2, float f) {
		f = this.field_7028.method_6864().method_6852(arg2, f);
	...
	protected void method_6108() {
		...
		boolean bl = this.field_6002.method_8450().method_8355(class_1928.field_19391);
		int i = 500;
		...
		this.method_5784(class_1313.field_6308, new class_243(0.0, 0.1F, 0.0));
	...
	public int method_6818() {
		if (this.field_7012[0] == null) {
			for(int i = 0; i < 24; ++i) {
				...
				int m;
				if (i < 12) {
					l = class_3532.method_15375(60.0F * class_3532.method_15362(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)i)));
					m = class_3532.method_15375(60.0F * class_3532.method_15374(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)i)));
				} else if (i < 20) {
					int k = i - 12;
					l = class_3532.method_15375(40.0F * class_3532.method_15362(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)k)));
					m = class_3532.method_15375(40.0F * class_3532.method_15374(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)k)));
					j += 10;
				} else {
					int var7 = i - 20;
					l = class_3532.method_15375(20.0F * class_3532.method_15362(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
					m = class_3532.method_15375(20.0F * class_3532.method_15374(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
				}
	...
	public class_11 method_6833(int i, int j, @Nullable class_9 arg) {
		...
		while(!this.field_7008.method_8()) {
			...
			for(int n = l; n < 24; ++n) {
				if ((this.field_7025[m] & 1 << n) > 0) {
					class_9 lv5 = this.field_7012[n];
					if (!lv5.field_42) {
	...
	public float method_6823(int i, double[] ds, double[] es) {
		...
		if (lv2 == class_1527.field_7067 || lv2 == class_1527.field_7077) {
			...
			float f = Math.max(class_3532.method_15368(lv3.method_19770(this.method_19538(), true)) / 4.0F, 1.0F);
			d = (double)((float)i / f);
	...
	public class_243 method_6834(float f) {
		...
		if (lv2 == class_1527.field_7067 || lv2 == class_1527.field_7077) {
			class_2338 lv3 = this.field_6002.method_8598(class_2902.class_2903.field_13203, class_3033.field_13600);
			float g = Math.max(class_3532.method_15368(lv3.method_19770(this.method_19538(), true)) / 4.0F, 1.0F);
			float h = 6.0F / g;
	...
	public void method_6828(class_1511 arg, class_2338 arg2, class_1282 arg3) {
		...
		if (arg3.method_5529() instanceof class_1657) {
			...
			lv = this.field_6002.method_18461(field_18120, (double)arg2.method_10263(), (double)arg2.method_10264(), (double)arg2.method_10260());
		}
