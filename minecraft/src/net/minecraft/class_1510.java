...
public class class_1510 extends class_1308 implements class_1509, class_1569 {
	...
	public void method_6007() {
		...
		if (this.method_6032() <= 0.0F) {
			...
			this.method_6830();
			float f = 0.2F / (class_3532.method_15368(this.field_5967 * this.field_5967 + this.field_6006 * this.field_6006) * 10.0F + 1.0F);
			f *= (float)Math.pow(2.0, this.field_5984);
			if (this.field_7028.method_6864().method_6848()) {
				this.field_7030 += 0.1F;
			} else if (this.field_7027) {
				this.field_7030 += f * 0.5F;
			} else {
				this.field_7030 += f;
			}
