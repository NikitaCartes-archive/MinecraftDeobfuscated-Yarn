	...
	public void method_6007() {
		...
		if (this.method_6032() <= 0.0F) {
			...
			if (this.method_5987()) {
				...
				if (this.field_6002.field_9236) {
					...
					if (lv3 != null) {
						...
						class_243 lv5 = new class_243(
							...
							.method_1029();
						float o = Math.max(((float)lv5.method_1026(lv4) + 0.5F) / 1.5F, 0.0F);
						this.field_6267 *= 0.8F;
						this.field_6267 = (float)((double)this.field_6267 + n * (double)lv2.method_6847());
						this.field_6031 += this.field_6267 * 0.1F;
						float p = (float)(2.0 / (l + 1.0));
						float q = 0.06F;
						this.method_5724(0.06F * (o * p + (1.0F - p)), new class_243(0.0, 0.0, -1.0));
						if (this.field_7027) {
						...
						double r = 0.8 + 0.15 * (lv6.method_1026(lv5) + 1.0) / 2.0;
						this.method_18799(this.method_18798().method_18805(r, 0.91F, r));
					}
				}
				...
				float t = (float)(this.method_6817(5, 1.0F)[1] - this.method_6817(10, 1.0F)[1]) * 10.0F * (float) (Math.PI / 180.0);
				float u = class_3532.method_15362(t);
				float v = class_3532.method_15374(t);
				float w = this.field_6031 * (float) (Math.PI / 180.0);
				float x = class_3532.method_15374(w);
				float y = class_3532.method_15362(w);
				this.field_7023.method_5773();
				this.field_7023.method_5808(this.field_5987 + (double)(x * 0.5F), this.field_6010, this.field_6035 - (double)(y * 0.5F), 0.0F, 0.0F);
				this.field_7015.method_5773();
				this.field_7015.method_5808(this.field_5987 + (double)(y * 4.5F), this.field_6010 + 2.0, this.field_6035 + (double)(x * 4.5F), 0.0F, 0.0F);
				this.field_7014.method_5773();
				this.field_7014.method_5808(this.field_5987 - (double)(y * 4.5F), this.field_6010 + 2.0, this.field_6035 - (double)(x * 4.5F), 0.0F, 0.0F);
				...
				float z = class_3532.method_15374(this.field_6031 * (float) (Math.PI / 180.0) - this.field_6267 * 0.01F);
				float aa = class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0) - this.field_6267 * 0.01F);
				this.field_7017.method_5773();
				this.field_7011.method_5773();
				float m = this.method_6820(1.0F);
				this.field_7017
					.method_5808(
						this.field_5987 + (double)(z * 6.5F * u), this.field_6010 + (double)m + (double)(v * 6.5F), this.field_6035 - (double)(aa * 6.5F * u), 0.0F, 0.0F
					);
				this.field_7011
					.method_5808(
						this.field_5987 + (double)(z * 5.5F * u), this.field_6010 + (double)m + (double)(v * 5.5F), this.field_6035 - (double)(aa * 5.5F * u), 0.0F, 0.0F
					);
				...
				for(int ab = 0; ab < 3; ++ab) {
					...
					double[] es = this.method_6817(12 + ab * 2, 1.0F);
					float ac = this.field_6031 * (float) (Math.PI / 180.0) + this.method_6832(es[0] - ds[0]) * (float) (Math.PI / 180.0);
					float ad = class_3532.method_15374(ac);
					float ae = class_3532.method_15362(ac);
					float af = 1.5F;
					float o = (float)(ab + 1) * 2.0F;
					lv7.method_5773();
					lv7.method_5808(
						this.field_5987 - (double)((x * 1.5F + ad * o) * u),
						this.field_6010 + (es[1] - ds[1]) - (double)((o + 1.5F) * v) + 1.5,
						this.field_6035 + (double)((y * 1.5F + ae * o) * u),
						0.0F,
						0.0F
					);
				}
				...
				for(int ab = 0; ab < this.field_7032.length; ++ab) {
					this.field_7032[ab].field_6014 = lvs[ab].field_1352;
					this.field_7032[ab].field_6036 = lvs[ab].field_1351;
					this.field_7032[ab].field_5969 = lvs[ab].field_1350;
				}
			}
		}
	}
			...
			for(int p = j; p <= m; ++p) {
				for(int q = k; q <= n; ++q) {
					...
					if (!lv2.method_11588() && lv2.method_11620() != class_3614.field_15943) {
						if (this.field_6002.method_8450().method_8355("mobGriefing") && !class_3481.field_17753.method_15141(lv3)) {
