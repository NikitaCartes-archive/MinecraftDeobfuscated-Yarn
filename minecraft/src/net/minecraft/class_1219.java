...
public class class_1219 extends class_1197 {
	public class_1219(Schema schema, boolean bl) {
		super(schema, bl, "Villager trade fix", class_1208.field_5729, "minecraft:villager");
	}
	...
	protected Typed<?> method_5105(Typed<?> typed) {
		...
		if (!(type instanceof ListType)) {
			...
			OpticFinder<Pair<String, String>> opticFinder7 = DSL.fieldFinder("id", DSL.named(class_1208.field_5713.typeName(), DSL.namespacedString()));
