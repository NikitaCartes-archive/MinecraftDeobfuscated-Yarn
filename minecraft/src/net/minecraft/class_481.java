...
public class class_481 extends class_485<class_481.class_483> {
	...
	public void method_2225() {
		if (!this.field_2563.field_1761.method_2914()) {
			this.field_2563.method_1507(new class_490(this.field_2563.field_1724));
	...
	protected void method_2383(@Nullable class_1735 arg, int i, int j, class_1713 arg2) {
		...
		if (arg == null && field_2896 != class_1761.field_7918.method_7741() && arg2 != class_1713.field_7789) {
			class_1661 lv3 = this.field_2563.field_1724.field_7514;
			if (!lv3.method_7399().method_7960() && this.field_2887) {
				if (j == 0) {
					this.field_2563.field_1724.method_7328(lv3.method_7399(), true);
					this.field_2563.field_1761.method_2915(lv3.method_7399());
					lv3.method_7396(class_1799.field_8037);
				}

				if (j == 1) {
					class_1799 lv2 = lv3.method_7399().method_7971(1);
					this.field_2563.field_1724.method_7328(lv2, true);
					this.field_2563.field_1761.method_2915(lv2);
				}
			}
		} else {
			if (arg != null && !arg.method_7674(this.field_2563.field_1724)) {
				return;
			}

			if (arg == this.field_2889 && bl) {
				for(int k = 0; k < this.field_2563.field_1724.field_7498.method_7602().size(); ++k) {
					this.field_2563.field_1761.method_2909(class_1799.field_8037, k);
				}
			} else if (field_2896 == class_1761.field_7918.method_7741()) {
				if (arg == this.field_2889) {
					this.field_2563.field_1724.field_7514.method_7396(class_1799.field_8037);
					...
					this.field_2563.field_1724.method_7328(lv, true);
					this.field_2563.field_1761.method_2915(lv);
					this.field_2563.field_1761.method_2909(lv2, ((class_481.class_484)arg).field_2898.field_7874);
				} else if (arg2 == class_1713.field_7795 && !this.field_2563.field_1724.field_7514.method_7399().method_7960()) {
					this.field_2563.field_1724.method_7328(this.field_2563.field_1724.field_7514.method_7399(), true);
					this.field_2563.field_1761.method_2915(this.field_2563.field_1724.field_7514.method_7399());
					this.field_2563.field_1724.field_7514.method_7396(class_1799.field_8037);
				} else {
					this.field_2563
						.field_1724
						.field_7498
						.method_7593(arg == null ? i : ((class_481.class_484)arg).field_2898.field_7874, j, arg2, this.field_2563.field_1724);
					this.field_2563.field_1724.field_7498.method_7623();
				}
				...
				if (arg2 == class_1713.field_7791) {
					if (!lv4.method_7960() && j >= 0 && j < 9) {
						...
						this.field_2563.field_1724.field_7514.method_5447(j, lv5);
						this.field_2563.field_1724.field_7498.method_7623();
					}
				...
				if (arg2 == class_1713.field_7795) {
					if (!lv4.method_7960()) {
						...
						this.field_2563.field_1724.method_7328(lv5, true);
						this.field_2563.field_1761.method_2915(lv5);
					}
				...
				this.field_2797.method_7593(arg == null ? i : arg.field_7874, j, arg2, this.field_2563.field_1724);
				if (class_1703.method_7594(j) == 2) {
					for(int l = 0; l < 9; ++l) {
						this.field_2563.field_1761.method_2909(this.field_2797.method_7611(45 + l).method_7677(), 36 + l);
					}
				} else if (arg != null) {
					class_1799 lv2 = this.field_2797.method_7611(arg.field_7874).method_7677();
					this.field_2563.field_1761.method_2909(lv2, arg.field_7874 - this.field_2797.field_7761.size() + 9 + 36);
					int m = 45 + j;
					if (arg2 == class_1713.field_7791) {
						this.field_2563.field_1761.method_2909(lv, m - this.field_2797.field_7761.size() + 9 + 36);
	...
	protected void method_2224() {
		if (this.field_2563.field_1761.method_2914()) {
			...
			this.field_2894 = new class_342(0, this.field_2554, this.field_2776 + 82, this.field_2800 + 6, 80, 9);
			...
			this.field_2557.add(this.field_2894);
			int i = field_2896;
			field_2896 = -1;
			this.method_2466(class_1761.field_7921[i]);
			this.field_2891 = new class_478(this.field_2563);
			this.field_2563.field_1724.field_7498.method_7596(this.field_2891);
		} else {
			this.field_2563.method_1507(new class_490(this.field_2563.field_1724));
		}
	}
	...
	public void method_2234() {
		super.method_2234();
		if (this.field_2563.field_1724 != null && this.field_2563.field_1724.field_7514 != null) {
			this.field_2563.field_1724.field_7498.method_7603(this.field_2891);
		}
	...
	public boolean method_16806(char c, int i) {
		if (this.field_2888) {
			...
			String string = this.field_2894.method_1882();
			if (this.field_2894.method_16806(c, i)) {
	...
	public boolean method_16805(int i, int j, int k) {
		...
		if (field_2896 != class_1761.field_7915.method_7741()) {
			if (this.field_2563.field_1690.field_1890.method_1417(i, j)) {
			...
			if (bl && this.method_2384(i, j)) {
				...
				String string = this.field_2894.method_1882();
				if (this.field_2894.method_16805(i, j, k)) {
					if (!Objects.equals(string, this.field_2894.method_1882())) {
						this.method_2464();
					}
	...
	private void method_2464() {
		...
		if (string.isEmpty()) {
			...
			if (string.startsWith("#")) {
				...
				lv2 = this.field_2563.method_1484(class_1124.field_5494);
				this.method_15871(string);
			} else {
				lv2 = this.field_2563.method_1484(class_1124.field_5495);
			}
	...
	protected void method_2388(int i, int j) {
		...
		if (lv.method_7754()) {
			...
			this.field_2554.method_1729(class_1074.method_4662(lv.method_7737()), 8.0F, 6.0F, 4210752);
		}
	}
	...
	private void method_2466(class_1761 arg) {
		...
		if (arg == class_1761.field_7925) {
			class_302 lv = this.field_2563.method_1571();
				...
				if (lv2.isEmpty()) {
					for(int k = 0; k < 9; ++k) {
						if (k == j) {
							...
							String string = this.field_2563.field_1690.field_1852[j].method_16007();
							String string2 = this.field_2563.field_1690.field_1879.method_16007();
		...
		if (arg == class_1761.field_7918) {
			class_1703 lv4 = this.field_2563.field_1724.field_7498;
			...
			for(int j = 0; j < lv4.field_7761.size(); ++j) {
				class_1735 lv5 = new class_481.class_484((class_1735)lv4.field_7761.get(j), j);
	...
	public boolean method_16802(double d) {
		if (!this.method_2465()) {
			...
			this.field_2890 = (float)((double)this.field_2890 - d / (double)i);
	...
	public void method_2214(int i, int j, float f) {
		...
		if (this.field_2889 != null
			...
			this.method_2215(class_1074.method_4662("inventory.binSlot"), i, j);
		}
	...
	protected void method_2389(float f, int i, int j) {
		...
		for(class_1761 lv2 : class_1761.field_7921) {
			this.field_2563.method_1531().method_4618(field_2893);
			if (lv2.method_7741() != field_2896) {
				this.method_2468(lv2);
			}
		}

		this.field_2563.method_1531().method_4618(new class_2960("textures/gui/container/creative_inventory/tab_" + lv.method_7742()));
		this.method_1788(this.field_2776, this.field_2800, 0, 0, this.field_2792, this.field_2779);
		this.field_2894.method_1857(i, j, f);
		GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
		...
		this.field_2563.method_1531().method_4618(field_2893);
		if (lv.method_7756()) {
			this.method_1788(k, l + (int)((float)(m - l - 17) * this.field_2890), 232 + (this.method_2465() ? 0 : 12), 0, 12, 15);
		}

		this.method_2468(lv);
		if (lv == class_1761.field_7918) {
			class_490.method_2486(
				this.field_2776 + 88, this.field_2800 + 45, 20, (float)(this.field_2776 + 88 - i), (float)(this.field_2800 + 45 - 30 - j), this.field_2563.field_1724
			);
		}
	}
	...
	protected boolean method_2471(class_1761 arg, int i, int j) {
		...
		if (this.method_2378(l + 3, m + 3, 23, 27, (double)i, (double)j)) {
			this.method_2215(class_1074.method_4662(arg.method_7737()), i, j);
			return true;
		} else {
			return false;
		}
	...
	protected void method_2468(class_1761 arg) {
		...
		GlStateManager.disableLighting();
		this.method_1788(l, m, j, k, 28, 32);
		...
		this.field_2560.method_4023(lv, l, m);
		this.field_2560.method_4025(this.field_2554, lv, l, m);
		GlStateManager.disableLighting();
	...
	static class class_482 extends class_1735 {
		...
		public boolean method_7674(class_1657 arg) {
			if (super.method_7674(arg) && this.method_7681()) {
	...
	public static class class_483 extends class_1703 {
		...
		public boolean method_7613(class_1799 arg, class_1735 arg2) {
			return arg2.field_7872 > 90;
		}

		@Override
		public boolean method_7615(class_1735 arg) {
			return arg.field_7871 instanceof class_1661 || arg.field_7872 > 90 && arg.field_7873 <= 162;
		}

		@Override
		public class_3917<class_481.class_483> method_17358() {
