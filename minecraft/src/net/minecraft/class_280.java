...
public class class_280 implements class_3679, AutoCloseable {
	...
	private final Map<String, Object> field_1516 = Maps.newHashMap();
	private final List<String> field_1503 = Lists.newArrayList();
	private final List<Integer> field_1506 = Lists.newArrayList();
	private final List<class_284> field_1515 = Lists.<class_284>newArrayList();
	private final List<Integer> field_1507 = Lists.newArrayList();
	private final Map<String, class_284> field_1510 = Maps.newHashMap();
	...
	public class_280(class_3300 arg, String string) throws IOException {
		...
		try {
			...
			if (jsonArray2 != null) {
				int j = 0;
				this.field_1518 = Lists.newArrayListWithCapacity(jsonArray2.size());
				this.field_1504 = Lists.newArrayListWithCapacity(jsonArray2.size());
