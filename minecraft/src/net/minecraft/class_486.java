...
public class class_486 extends class_465<class_1718> {
	...
	protected void method_2388(int i, int j) {
		this.field_2554.method_1729(this.field_17411.method_10863(), 12.0F, 5.0F, 4210752);
	...
	public boolean method_16807(double d, double e, int i) {
		int j = (this.field_2561 - this.field_2792) / 2;
		int k = (this.field_2559 - this.field_2779) / 2;

		for(int l = 0; l < 3; ++l) {
			double f = d - (double)(j + 60);
			double g = e - (double)(k + 14 + 19 * l);
			if (f >= 0.0 && g >= 0.0 && f < 108.0 && g < 19.0 && this.field_2797.method_7604(this.field_2563.field_1724, l)) {
				this.field_2563.field_1761.method_2900(this.field_2797.field_7763, l);
				return true;
			}
		}
	...
	protected void method_2389(float f, int i, int j) {
		...
		this.field_2563.method_1531().method_4618(field_2910);
		...
		int m = (int)this.field_2563.field_1704.method_4495();
		GlStateManager.viewport((this.field_2561 - 320) / 2 * m, (this.field_2559 - 240) / 2 * m, 320 * m, 240 * m);
		...
		this.field_2563.method_1531().method_4618(field_2901);
		...
		GlStateManager.matrixMode(5889);
		GlStateManager.viewport(0, 0, this.field_2563.field_1704.method_4489(), this.field_2563.field_1704.method_4506());
		...
		for(int r = 0; r < 3; ++r) {
			...
			GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
			if (u == 0) {
				this.method_1788(s, l + 14 + 19 * r, 0, 185, 108, 19);
			} else {
				String string = "" + u;
				int v = 86 - this.field_2554.method_1727(string);
				String string2 = class_487.method_2481().method_2479(this.field_2554, v);
				class_327 lv = this.field_2563.method_1568().method_2019(class_310.field_1749);
				int w = 6839882;
				if ((q < r + 1 || this.field_2563.field_1724.field_7520 < u) && !this.field_2563.field_1724.field_7503.field_7477) {
					this.method_1788(s, l + 14 + 19 * r, 0, 185, 108, 19);
					this.method_1788(s + 1, l + 15 + 19 * r, 16 * r, 239, 16, 16);
					...
					if (x >= 0 && y >= 0 && x < 108 && y < 19) {
						this.method_1788(s, l + 14 + 19 * r, 0, 204, 108, 19);
						w = 16777088;
					} else {
						this.method_1788(s, l + 14 + 19 * r, 0, 166, 108, 19);
					}

					this.method_1788(s + 1, l + 15 + 19 * r, 16 * r, 223, 16, 16);
					lv.method_1712(string2, t, l + 16 + 19 * r, v, w);
					w = 8453920;
				}

				lv = this.field_2563.field_1772;
	...
	public void method_2214(int i, int j, float f) {
		f = this.field_2563.method_1488();
		this.method_2240();
		super.method_2214(i, j, f);
		this.method_2380(i, j);
		boolean bl = this.field_2563.field_1724.field_7503.field_7477;
		...
		for(int l = 0; l < 3; ++l) {
			...
			if (this.method_2378(60, 14 + 19 * l, 108, 17, (double)i, (double)j) && m > 0 && n >= 0 && lv != null) {
				...
				if (!bl) {
					list.add("");
					if (this.field_2563.field_1724.field_7520 < m) {
	...
	public void method_2478() {
		...
		if (!class_1799.method_7973(lv, this.field_2913)) {
			...
			do {
				this.field_2909 += (float)(this.field_2911.nextInt(4) - this.field_2911.nextInt(4));
		...
		this.field_2912 += this.field_2906;
	}
}
