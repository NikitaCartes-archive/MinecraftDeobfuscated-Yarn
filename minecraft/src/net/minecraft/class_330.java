...
public class class_330 implements AutoCloseable {
	...
	private final Map<String, class_330.class_331> field_2045 = Maps.newHashMap();
	...
	class class_331 implements AutoCloseable {
		...
		private void method_1777(boolean bl) {
			...
			GlStateManager.blendFuncSeparate(
				GlStateManager.class_5119.ONE, GlStateManager.class_5118.ONE_MINUS_SRC_ALPHA, GlStateManager.class_5119.ZERO, GlStateManager.class_5118.ONE
			);
			...
			for(class_20 lv3 : this.field_2046.field_117.values()) {
				if (!bl || lv3.method_94()) {
					...
					if (lv3.method_88() != null) {
						...
						class_332.fill(-1, -1, (int)o, 9 - 1, Integer.MIN_VALUE);
