...
public class class_708 extends class_4003 {
	...
	protected class_708(class_1937 arg, double d, double e, double f, class_4002 arg2, float g) {
		super(arg, d, e, f);
		this.field_17866 = arg2;
		this.field_3881 = g;
	}
	...
	public void method_3070() {
		...
		if (this.field_3866++ >= this.field_3847) {
			...
			if (this.field_3866 > this.field_3847 / 2) {
				...
				if (this.field_3880) {
					this.field_3861 += (this.field_3878 - this.field_3861) * 0.2F;
					this.field_3842 += (this.field_3877 - this.field_3842) * 0.2F;
					this.field_3859 += (this.field_3876 - this.field_3859) * 0.2F;
				}
			}

			this.field_3869 += (double)this.field_3881;
			this.method_3069(this.field_3852, this.field_3869, this.field_3850);
			this.field_3852 *= (double)this.field_3879;
			this.field_3869 *= (double)this.field_3879;
			this.field_3850 *= (double)this.field_3879;
			if (this.field_3845) {
