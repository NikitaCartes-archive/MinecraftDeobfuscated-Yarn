...
public class class_26 {
	...
	public <T extends class_18> T method_17924(Supplier<T> supplier, String string) {
		T lv = this.method_20786(supplier, string);
		if (lv != null) {
			return lv;
		} else {
	...
	@Nullable
	public <T extends class_18> T method_20786(Supplier<T> supplier, String string) {
		class_18 lv = (class_18)this.field_134.get(string);
		if (lv == null && !this.field_134.containsKey(string)) {
			lv = this.method_120(supplier, string);
	...
	@Nullable
	private <T extends class_18> T method_120(Supplier<T> supplier, String string) {
		try {
	...
	public class_2487 method_17923(String string, int i) throws IOException {
		...
		try {
			...
			var36 = class_2512.method_10693(this.field_17663, class_4284.field_19219, lv, j, i);
