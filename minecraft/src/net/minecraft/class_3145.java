...
public abstract class class_3145<C extends FeatureConfig> extends StructureFeature<C> {
	...
	protected ChunkPos method_14018(ChunkGenerator<?> chunkGenerator, Random random, int i, int j, int k, int l) {
		...
		int s = q / m;
		int t = r / m;
		((class_2919)random).method_12665(chunkGenerator.getSeed(), s, t, this.method_13774());
		s *= m;
		t *= m;
	...
	protected int method_13773(ChunkGenerator<?> chunkGenerator) {
		return chunkGenerator.getSettings().method_12567();
	}
