...
public class class_1806 extends class_1762 {
	...
	@Nullable
	public static class_22 method_17441(class_1799 arg, class_1936 arg2) {
		return method_7997(arg2, method_17440(method_8003(arg)));
	}

	@Nullable
	public static class_22 method_8001(class_1799 arg, class_1937 arg2) {
		class_22 lv = method_17441(arg, arg2);
	...
	private static class_22 method_8000(class_1799 arg, class_1937 arg2, int i, int j, int k, boolean bl, boolean bl2, class_2874 arg3) {
		int l = arg2.method_8645(class_2874.field_13072, "map");
		class_22 lv = new class_22(method_17440(l));
		lv.method_105(i, j, k, bl, bl2, arg3);
		arg2.method_8647(class_2874.field_13072, lv.method_76(), lv);
	...
	@Nullable
	public static class_22 method_7997(class_1936 arg, String string) {
		return arg.method_8648(class_2874.field_13072, class_22::new, string);
	}
	...
	private class_2680 method_7995(class_1937 arg, class_2680 arg2, class_2338 arg3) {
		...
		return !lv.method_15769() && !class_2248.method_9501(arg2.method_11628(arg, arg3), class_2350.field_11036) ? lv.method_15759() : arg2;
	}
	...
	public static class_1799 method_17442(class_1937 arg, class_1799 arg2) {
		...
		if (lv != null) {
			...
			lv3.field_116 = lv.field_116;
			lv3.field_115 = lv.field_115;
			lv3.field_17403 = true;
			lv3.method_80();
			System.arraycopy(lv.field_122, 0, lv3.field_122, 0, lv.field_122.length);
			return lv2;
		} else {
			return null;
		}
