...
public class class_310 extends class_1255<Runnable> implements class_1279, class_3678, class_363 {
	...
	private void method_1503() {
		...
		try {
			...
			field_1762.error("Couldn't set icon", (Throwable)var5);
		}
	...
	public void method_1521() {
		...
		try {
			...
			field_1762.info("Caught error stitching, removing all assigned resourcepacks", (Throwable)var4);
			this.field_1715.method_14447(Collections.emptyList());
			List<class_3262> list2 = (List<class_3262>)this.field_1715.method_14444().stream().map(class_3288::method_14458).collect(Collectors.toList());
