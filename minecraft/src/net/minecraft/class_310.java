...
public class class_310 extends class_1255<Runnable> implements class_1279, class_3678, class_363 {
	...
	private final Queue<Runnable> field_17404 = Queues.newConcurrentLinkedQueue();
	...
	public void method_1514() {
		...
		try {
			try {
				...
				this.method_1519();
				field_1762.fatal("Reported exception thrown!", var11);
	...
	private void method_1503() {
		...
		try {
			...
			field_1762.error("Couldn't set icon", var5);
		}
		...
		this.field_1745 = new class_3304(class_3264.field_14188);
		...
		this.method_15993();
		this.method_1507(new class_425());
		this.method_1567();
		this.field_1707 = new class_1071(this.field_1764, new File(this.field_1753, "skins"), this.field_1723);
		this.field_1748 = new class_24(this.field_1697.toPath().resolve("saves"), this.field_1697.toPath().resolve("backups"), this.field_1768);
		...
		this.field_1745.method_14477(this.field_1708);
		...
		if (this.field_1706 != null) {
			...
			this.method_1507(new class_442());
		}
	...
	public void method_1521() {
		...
		List<class_3262> list = (List)this.field_1715.method_14444().stream().map(class_3288::method_14458).collect(Collectors.toList());
		if (this.field_1766 != null) {
			this.field_1766.method_3848();
		}

		try {
			this.field_1745.method_14478(list);
		} catch (RuntimeException var4) {
			field_1762.info("Caught error stitching, removing all assigned resourcepacks", var4);
			this.field_1715.method_14447(Collections.emptyList());
			List<class_3262> list2 = (List)this.field_1715.method_14444().stream().map(class_3288::method_14458).collect(Collectors.toList());
			this.field_1745.method_14478(list2);
	...
	private void method_1567() {
		...
		this.field_1755.method_2214(0, 0, 0.0F);
	...
	public void method_1501(int i, int j, int k, int l, int m, int n, int o, int p, int q, int r) {
		...
		lv.method_1328(7, class_290.field_1575);
		float f = 0.00390625F;
		float g = 0.00390625F;
		lv.method_1315((double)i, (double)(j + n), 0.0)
			.method_1312((double)((float)k * 0.00390625F), (double)((float)(l + n) * 0.00390625F))
			.method_1323(o, p, q, r)
			.method_1344();
		lv.method_1315((double)(i + m), (double)(j + n), 0.0)
			.method_1312((double)((float)(k + m) * 0.00390625F), (double)((float)(l + n) * 0.00390625F))
			.method_1323(o, p, q, r)
			.method_1344();
		lv.method_1315((double)(i + m), (double)j, 0.0)
			.method_1312((double)((float)(k + m) * 0.00390625F), (double)((float)l * 0.00390625F))
			.method_1323(o, p, q, r)
			.method_1344();
		lv.method_1315((double)i, (double)j, 0.0)
			.method_1312((double)((float)k * 0.00390625F), (double)((float)l * 0.00390625F))
			.method_1323(o, p, q, r)
			.method_1344();
	...
	public void method_1507(@Nullable class_437 arg) {
		...
		if (arg != null) {
			...
			arg.method_2233(this, this.field_1704.method_4486(), this.field_1704.method_4502());
	...
	private void method_1523(boolean bl) {
		...
		this.field_1727.method_4876(this.field_1724, this.field_1728.field_1970);
		this.field_16240.method_15407();
		...
		if (!this.field_1743) {
			...
			this.field_1773.method_3192(this.field_1734 ? this.field_1741 : this.field_1728.field_1970, l, bl);
		...
		GlStateManager.popMatrix();
		GlStateManager.pushMatrix();
		this.field_1773.method_3200(this.field_1728.field_1970);
		GlStateManager.popMatrix();
		this.field_16240.method_16065();
		...
		++this.field_1735;
		boolean bl2 = this.method_1496() && this.field_1755 != null && this.field_1755.method_2222() && !this.field_1766.method_3860();
		...
		while(class_156.method_658() >= this.field_1712 + 1000L) {
			...
			this.field_1770 = String.format(
				...
				(double)this.field_1690.field_1909 == class_315.class_316.field_1935.method_1652() ? "inf" : this.field_1690.field_1909,
				this.field_1690.field_1884 ? " vsync" : "",
				this.field_1690.field_1833 ? "" : " fast",
				this.field_1690.field_1814 == 0 ? "" : (this.field_1690.field_1814 == 1 ? " fast-clouds" : " fancy-clouds"),
				GLX.useVbo() ? " vbo" : ""
			);
	...
	public void method_15993() {
		...
		if (this.field_1755 != null) {
			this.field_1755.method_2228(this, this.field_1704.method_4486(), this.field_1704.method_4502());
		}
	...
	private int method_16009() {
		return this.field_1687 == null && this.field_1755 != null ? 60 : this.field_1704.method_16000();
	}

	private boolean method_16008() {
		return (double)this.method_16009() < class_315.class_316.field_1935.method_1652();
	}
	...
	public void method_1519() {
		...
		try {
			...
			this.method_1550(null, new class_424(class_1074.method_4662("menu.savingLevel")));
	...
	private void method_1590(boolean bl) {
		...
		if (this.field_1771 <= 0 && !this.field_1724.method_6115()) {
			if (bl && this.field_1765 != null && this.field_1765.field_1330 == class_239.class_240.field_1332) {
				class_2338 lv = this.field_1765.method_1015();
				if (!this.field_1687.method_8320(lv).method_11588() && this.field_1761.method_2902(lv, this.field_1765.field_1327)) {
					this.field_1713.method_3054(lv, this.field_1765.field_1327);
	...
	private void method_1536() {
		if (this.field_1771 <= 0) {
			if (this.field_1765 == null) {
				...
				switch(this.field_1765.field_1330) {
					case field_1331:
						this.field_1761.method_2918(this.field_1724, this.field_1765.field_1326);
						break;
					case field_1332:
						class_2338 lv = this.field_1765.method_1015();
						if (!this.field_1687.method_8320(lv).method_11588()) {
							this.field_1761.method_2910(lv, this.field_1765.field_1327);
							break;
						}
					case field_1333:
						if (this.field_1761.method_2924()) {
			...
			if (!this.field_1724.method_3144()) {
				...
				for(class_1268 lv : class_1268.values()) {
					...
					if (this.field_1765 != null) {
						switch(this.field_1765.field_1330) {
							case field_1331:
								if (this.field_1761.method_2917(this.field_1724, this.field_1765.field_1326, this.field_1765, lv) == class_1269.field_5812) {
									return;
								}

								if (this.field_1761.method_2905(this.field_1724, this.field_1765.field_1326, lv) == class_1269.field_5812) {
									return;
								}
								break;
							case field_1332:
								class_2338 lv3 = this.field_1765.method_1015();
								if (!this.field_1687.method_8320(lv3).method_11588()) {
									int i = lv2.method_7947();
									class_1269 lv4 = this.field_1761.method_2896(this.field_1724, this.field_1687, lv3, this.field_1765.field_1327, this.field_1765.field_1329, lv);
									if (lv4 == class_1269.field_5812) {
	...
	public void method_1574() {
		...
		if (this.field_1755 != null) {
			class_437.method_2217(() -> this.field_1755.method_2225(), "Ticking screen", this.field_1755.getClass().getCanonicalName());
		}
		...
		if (this.field_1755 == null || this.field_1755.field_2558) {
		...
		if (this.field_1687 != null) {
			if (this.field_1724 != null) {
				...
				if (this.field_1736 == 30) {
					this.field_1736 = 0;
					this.field_1687.method_8443(this.field_1724);
				}
			}
		...
		if (!this.field_1734) {
			this.field_1714.method_16896();
			this.field_1727.method_16896();
		}
	...
	private void method_1508() {
		for(; this.field_1690.field_1824.method_1436(); this.field_1769.method_3292()) {
		...
		while(this.field_1690.field_1869.method_1436()) {
			if (!this.field_1724.method_7325()) {
				this.field_1724.method_7290(class_437.method_2238());
			}
		}

		boolean bl3 = this.field_1690.field_1877 != class_1657.class_1659.field_7536;
		if (bl3) {
			while(this.field_1690.field_1890.method_1436()) {
				this.method_1507(new class_408());
			}

			if (this.field_1755 == null && this.field_1690.field_1845.method_1436()) {
				this.method_1507(new class_408("/"));
			}
		}
	...
	public void method_1559(String string, String string2, @Nullable class_1940 arg) {
		this.method_1481(null);
		System.gc();
		class_30 lv = this.field_1748.method_242(string, null);
		...
		try {
			...
			this.field_1766 = new class_1132(this, string, string2, arg, yggdrasilAuthenticationService, minecraftSessionService, gameProfileRepository, lv3, i -> {
				class_3953 lvxx = new class_3953(i + 0);
				lvxx.method_17675();
				this.field_17405.set(lvxx);
				return new class_3952(lvxx, this.field_17404::add);
			});
	...
	public void method_1481(@Nullable class_638 arg) {
		class_435 lv = new class_435();
		if (arg != null) {
			lv.method_15412(new class_2588("connect.joining"));
		}

		this.method_1550(arg, lv);
	}

	public void method_1550(@Nullable class_638 arg, class_437 arg2) {
		class_1132 lv = this.field_1766;
		if (arg == null) {
			class_634 lv2 = this.method_1562();
			if (lv2 != null) {
		...
		this.method_1507(arg2);
		this.method_1523(false);
		if (arg == null && this.field_1687 != null) {
			if (lv != null) {
				while(!lv.method_16043()) {
					this.method_1523(false);
				}
			}
		...
		if (arg != null) {
			...
			if (this.field_1724 == null) {
				this.field_1724 = this.field_1761.method_2901(arg, new class_3469(), new class_299(arg.method_8433()));
				this.field_1761.method_2898(this.field_1724);
				if (this.field_1766 != null) {
					this.field_1766.method_4817(this.field_1724.method_5667());
				}
			}

			this.field_1724.method_5823();
			arg.method_8649(this.field_1724);
			this.field_1724.field_3913 = new class_743(this.field_1690);
			this.field_1761.method_2903(this.field_1724);
			this.field_1719 = this.field_1724;
		} else {
	...
	public void method_1585(class_2874 arg) {
		this.field_1687.method_8513();
		this.field_1687.method_2936();
		int i = 0;
		String string = null;
		if (this.field_1724 != null) {
			i = this.field_1724.method_5628();
			this.field_1687.method_8463(this.field_1724);
			string = this.field_1724.method_3135();
		}

		this.field_1719 = null;
		class_746 lv = this.field_1724;
		this.field_1724 = this.field_1761
			.method_2901(
				this.field_1687,
				this.field_1724 == null ? new class_3469() : this.field_1724.method_3143(),
				this.field_1724 == null ? new class_299(new class_1863()) : this.field_1724.method_3130()
			);
		this.field_1724.method_5841().method_12779(lv.method_5841().method_12793());
		this.field_1724.field_6026 = arg;
		this.field_1719 = this.field_1724;
		this.field_1724.method_5823();
		this.field_1724.method_3146(string);
		this.field_1687.method_8649(this.field_1724);
		this.field_1761.method_2898(this.field_1724);
		this.field_1724.field_3913 = new class_743(this.field_1690);
		this.field_1724.method_5838(i);
		this.field_1761.method_2903(this.field_1724);
		this.field_1724.method_7268(lv.method_7302());
		if (this.field_1755 instanceof class_418) {
			this.method_1507(null);
		}
	}
	...
	public static boolean method_1588() {
		return field_1700 != null && field_1700.field_1690.field_1841 != 0;
	}

	private void method_1511() {
		if (this.field_1765 != null && this.field_1765.field_1330 != class_239.class_240.field_1333) {
			boolean bl = this.field_1724.field_7503.field_7477;
			class_2586 lv = null;
			class_1799 lv5;
			if (this.field_1765.field_1330 == class_239.class_240.field_1332) {
				class_2338 lv2 = this.field_1765.method_1015();
				class_2680 lv3 = this.field_1687.method_8320(lv2);
				class_2248 lv4 = lv3.method_11614();
				if (lv3.method_11588()) {
					return;
				}

				lv5 = lv4.method_9574(this.field_1687, lv2, lv3);
				if (lv5.method_7960()) {
					return;
				}

				if (bl && class_437.method_2238() && lv4.method_9570()) {
					lv = this.field_1687.method_8321(lv2);
				}
			} else {
				if (this.field_1765.field_1330 != class_239.class_240.field_1331 || this.field_1765.field_1326 == null || !bl) {
					return;
				}

				if (this.field_1765.field_1326 instanceof class_1534) {
					lv5 = new class_1799(class_1802.field_8892);
				} else if (this.field_1765.field_1326 instanceof class_1532) {
					lv5 = new class_1799(class_1802.field_8719);
				} else if (this.field_1765.field_1326 instanceof class_1533) {
					class_1533 lv6 = (class_1533)this.field_1765.field_1326;
					class_1799 lv7 = lv6.method_6940();
					if (lv7.method_7960()) {
						lv5 = new class_1799(class_1802.field_8143);
					} else {
						lv5 = lv7.method_7972();
					}
				} else if (this.field_1765.field_1326 instanceof class_1688) {
					class_1688 lv8 = (class_1688)this.field_1765.field_1326;
					class_1792 lv9;
					switch(lv8.method_7518()) {
						case field_7679:
							lv9 = class_1802.field_8063;
							break;
						case field_7678:
							lv9 = class_1802.field_8388;
							break;
						case field_7675:
							lv9 = class_1802.field_8069;
							break;
						case field_7677:
							lv9 = class_1802.field_8836;
							break;
						case field_7681:
							lv9 = class_1802.field_8220;
							break;
						default:
							lv9 = class_1802.field_8045;
					}

					lv5 = new class_1799(lv9);
				} else if (this.field_1765.field_1326 instanceof class_1690) {
					lv5 = new class_1799(((class_1690)this.field_1765.field_1326).method_7557());
				} else if (this.field_1765.field_1326 instanceof class_1531) {
					lv5 = new class_1799(class_1802.field_8694);
				} else if (this.field_1765.field_1326 instanceof class_1511) {
					lv5 = new class_1799(class_1802.field_8301);
				} else {
					class_1826 lv10 = class_1826.method_8019(this.field_1765.field_1326.method_5864());
					if (lv10 == null) {
						return;
					}

					lv5 = new class_1799(lv10);
				}
			}
			...
			if (lv5.method_7960()) {
				String string = "";
				if (this.field_1765.field_1330 == class_239.class_240.field_1332) {
					string = class_2378.field_11146.method_10221(this.field_1687.method_8320(this.field_1765.method_1015()).method_11614()).toString();
				} else if (this.field_1765.field_1330 == class_239.class_240.field_1331) {
					string = class_2378.field_11145.method_10221(this.field_1765.field_1326.method_5864()).toString();
				}

				field_1762.warn("Picking on: [{}] {} gave null item", this.field_1765.field_1330, string);
			} else {
				class_1661 lv11 = this.field_1724.field_7514;
				if (lv != null) {
					this.method_1499(lv5, lv);
				}

				int i = lv11.method_7395(lv5);
				if (bl) {
					lv11.method_7374(lv5);
					this.field_1761.method_2909(this.field_1724.method_5998(class_1268.field_5808), 36 + lv11.field_7545);
				} else if (i != -1) {
	...
	private class_1799 method_1499(class_1799 arg, class_2586 arg2) {
		...
		if (arg.method_7909() instanceof class_1809 && lv.method_10545("Owner")) {
			...
			lv3.method_10606(new class_2519("\"(+NBT)\""));
	...
	public CompletableFuture<Object> method_1513() {
		return this.method_5382(this::method_1521);
	}
	...
	public class_1142.class_1143 method_1544() {
		if (this.field_1755 instanceof class_445) {
			...
			if (!this.field_1714.method_4860(class_1142.class_1143.field_5576)
				...
				return this.field_1724.field_7503.field_7477 && this.field_1724.field_7503.field_7478
					? class_1142.class_1143.field_5581
					: class_1142.class_1143.field_5586;
			} else {
	...
	public boolean method_5387() {
		return Thread.currentThread() == this.field_1696;
	}
