...
public class class_310 extends class_4093<Runnable> implements class_1279, class_3678, AutoCloseable {
	...
	public void method_1514() {
		...
		try {
			...
			class_128 lv = class_128.method_560(var9, "Initializing game");
			...
			try {
				...
				while(this.field_1698) {
					...
					try {
						...
						System.gc();
						field_1762.fatal("Out of memory", var10);
						bl = true;
					}
				}
	...
	private void method_1503() {
		...
		try {
			...
			field_1762.error("Couldn't set icon", var6);
		}
		...
		if (this.field_1706 != null) {
			...
			this.method_1507(new class_442(true));
		}

		class_425.method_18819(this);
		this.method_18502(
			new class_425(this, this.field_1745.method_18230(class_156.method_18349(), this, CompletableFuture.completedFuture(class_3902.field_17274)), () -> {
	...
	private void method_17044() {
		...
		for(class_1792 lv11 : class_2378.field_11142) {
			...
			for(class_1799 lv12 : lv10) {
				String string = lv12.method_7922();
				String string2 = new class_2588(string).getString();
				if (string2.toLowerCase(Locale.ROOT).equals(lv11.method_7876())) {
					field_1762.debug("Missing translation for: {} {} {}", lv12, string, lv12.method_7909());
				}
			}
		}
	...
	public void method_1490() {
		try {
			...
			class_333.field_2054.method_20371();
	...
	public void method_20539(boolean bl) {
		if (this.field_1755 == null) {
			boolean bl2 = this.method_1496() && !this.field_1766.method_3860();
			if (bl2) {
				this.method_1507(new class_433(!bl));
				this.field_1727.method_4879();
			} else {
				this.method_1507(new class_433(true));
			}
		}
	}
	...
	private void method_1590(boolean bl) {
		...
		if (this.field_1771 <= 0 && !this.field_1724.method_6115()) {
			...
			} else if (bl && this.field_1724.method_7261(0.0F) >= 1.0F) {
				this.method_1536();
			} else {
	...
	private void method_1536() {
		if (this.field_1771 <= 0) {
			float f = this.field_1724.method_7261(0.0F);
			if (!(f < 0.8F)) {
				if (f < 1.0F) {
					this.field_23657 = true;
				} else {
					this.field_23657 = false;
					if (this.field_1765 == null) {
						...
						switch(this.field_1765.method_17783()) {
							case field_1331:
								if (((class_3966)this.field_1765).method_26747() <= this.field_1724.method_26738(0.0F)) {
							...
							case field_1333:
								this.field_1761.method_26748(this.field_1724);
						}
					...
					if (this.field_1765 != null) {
						switch(this.field_1765.method_17783()) {
							case field_1331:
								...
								if (!(lv3.method_26747() > this.field_1761.method_26750())) {
	...
	private void method_1508() {
		...
		this.method_1590(this.field_1755 == null && (this.field_1690.field_1886.method_1434() || this.field_23657) && this.field_1729.method_1613());
	}
	...
	public class_1142.class_1143 method_1544() {
		if (this.field_1755 instanceof class_445) {
			...
			class_1959.class_1961 lv = this.field_1724.field_6002.method_8310(new class_2338(this.field_1724)).method_8688();
