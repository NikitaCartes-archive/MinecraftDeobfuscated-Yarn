...
public class class_3060 {
	...
	private static int method_13374(class_2168 arg, class_2265 arg2) throws CommandSyntaxException {
		...
		boolean bl = arg.method_9211().method_3847(lv2).method_17984().contains(lv.method_8324());
		if (bl) {
	...
	private static int method_13373(class_2168 arg) {
		...
		LongSet longSet = arg.method_9211().method_3847(lv).method_17984();
		int i = longSet.size();
		if (i > 0) {
	...
	private static int method_13366(class_2168 arg) {
		...
		LongSet longSet = lv2.method_17984();
		longSet.forEach(l -> lv2.method_17988(class_1923.method_8325(l), class_1923.method_8332(l), false));
		arg.method_9226(new class_2588("commands.forceload.removed.all", lv), true);
		return 0;
	}

	private static int method_13372(class_2168 arg, class_2265 arg2, class_2265 arg3, boolean bl) throws CommandSyntaxException {
		...
		if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000) {
			...
			if (q > 256L) {
				...
				for (int s = m; s <= o; s++) {
					for (int t = n; t <= p; t++) {
						boolean bl2 = lv2.method_17988(s, t, bl);
						if (bl2) {
							r++;
							if (lv3 == null) {
