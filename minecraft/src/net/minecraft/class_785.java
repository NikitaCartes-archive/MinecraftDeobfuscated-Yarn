...
public class class_785 {
	...
	private float[] method_3401(class_2350 arg) {
		switch(arg) {
			...
			default:
				return new float[]{
					16.0F - this.field_4231.method_4943(),
					16.0F - this.field_4231.method_4945(),
					16.0F - this.field_4228.method_4943(),
					16.0F - this.field_4228.method_4945()
				};
			case field_11035:
				return new float[]{
			...
			case field_11034:
				return new float[]{
					16.0F - this.field_4231.method_4947(),
					16.0F - this.field_4231.method_4945(),
					16.0F - this.field_4228.method_4947(),
					16.0F - this.field_4228.method_4945()
				};
		}
	}
