...
public class class_6748 {
	...
	public static class_6748 method_39342(@Nullable ChunkRegion chunkRegion) {
		if (chunkRegion == null) {
			...
			List<class_6748.class_6782> list = Lists.newArrayList();
			List<class_6748.class_6782> list2 = Lists.newArrayList();
			...
			for(class_6748.class_6782 lv : this.field_35509) {
				lv.blendingData.method_39351(BiomeCoords.fromChunk(lv.chunkX), BiomeCoords.fromChunk(lv.chunkZ), (kx, lx, dx) -> {
					...
					if (!(e > (double)field_35502)) {
						...
						double fxx = 1.0 / (e * e * e * e);
						mutableDouble2.add(dx * fxx);
						mutableDouble.add(fxx);
					}
				});
			}
		...
		if (e != Double.MAX_VALUE) {
			...
			for(class_6748.class_6782 lv : this.field_35510) {
				lv.blendingData.method_39346(BiomeCoords.fromChunk(lv.chunkX), BiomeCoords.fromChunk(lv.chunkZ), m - 2, m + 2, (lx, mx, nx, dx) -> {
					double exx = MathHelper.magnitude((double)(l - lx), (double)(m - mx), (double)(n - nx));
					if (!(exx > 2.0)) {
						if (exx < mutableDouble3.doubleValue()) {
							mutableDouble3.setValue(exx);
						}

						double f = 1.0 / (exx * exx * exx * exx);
	...
	private static class_6748.class_6831 method_39812(@Nullable EightWayDirection eightWayDirection) {
		...
		double f = d;
		double g = e;
		return (f, gx, h) -> method_39808(f - 8.0 - f, gx - field_36223, h - 8.0 - g, 8.0, field_36222, 8.0);
	}
	...
	static final class class_6782 extends Record {
		final int chunkX;
		final int chunkZ;
		...
		public final String toString() {
			return ObjectMethods.bootstrap<"toString",class_6748.class_6782,"chunkX;chunkZ;blendingData",class_6748.class_6782::chunkX,class_6748.class_6782::chunkZ,class_6748.class_6782::blendingData>(
				this
			);
		}

		public final int hashCode() {
			return ObjectMethods.bootstrap<"hashCode",class_6748.class_6782,"chunkX;chunkZ;blendingData",class_6748.class_6782::chunkX,class_6748.class_6782::chunkZ,class_6748.class_6782::blendingData>(
				this
			);
		}

		public final boolean equals(Object object) {
			return ObjectMethods.bootstrap<"equals",class_6748.class_6782,"chunkX;chunkZ;blendingData",class_6748.class_6782::chunkX,class_6748.class_6782::chunkZ,class_6748.class_6782::blendingData>(
				this, object
			);
		}
