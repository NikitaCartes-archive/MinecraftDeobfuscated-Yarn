...
public class SharedConstants {
	...
	@Deprecated
	public static final String VERSION_NAME = "24w34a";
	@Deprecated
	public static final int RELEASE_TARGET_PROTOCOL_VERSION = 768;
	@Deprecated
	public static final int field_29736 = 206;
	...
	@Deprecated
	public static final int RESOURCE_PACK_VERSION = 36;
	@Deprecated
	public static final int DATA_PACK_VERSION = 50;
	@Deprecated
