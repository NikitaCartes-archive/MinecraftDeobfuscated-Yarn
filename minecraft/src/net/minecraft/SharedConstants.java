...
public class SharedConstants {
	...
	@Deprecated
	public static final String VERSION_NAME = "24w11a";
	@Deprecated
	public static final int RELEASE_TARGET_PROTOCOL_VERSION = 766;
	@Deprecated
	public static final int field_29736 = 180;
	...
	@Deprecated
	public static final int RESOURCE_PACK_VERSION = 29;
	@Deprecated
	public static final int DATA_PACK_VERSION = 35;
	@Deprecated
