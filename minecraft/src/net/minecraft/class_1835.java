...
public class class_1835 extends class_1792 {
		...
		if (arg3 instanceof class_1657) {
			...
			if (j >= 10) {
				...
				if (k <= 0 || lv.method_5721()) {
					if (!arg2.field_9236) {
						arg.method_7956(1, lv, arg2x -> arg2x.method_20236(arg3.method_6058()));
						if (k == 0) {
							class_1685 lv2 = new class_1685(arg2, lv, arg);
							lv2.method_7474(lv, lv.field_5965, lv.field_6031, 0.0F, 2.5F + (float)k * 0.5F, 1.0F);
					...
					if (k > 0) {
						...
						if (lv.field_5952) {
							float p = 1.1999999F;
							lv.method_5784(class_1313.field_6308, new class_243(0.0, 1.1999999F, 0.0));
						}
	...
	public Multimap<String, class_1322> method_7844(class_1304 arg) {
		...
		if (arg == class_1304.field_6173) {
			class_5117.field_23650.method_26741(class_1834.field_8923, multimap);
		}
