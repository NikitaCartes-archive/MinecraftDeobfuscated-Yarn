...
public class class_1362 extends class_1352 {
	...
	public boolean method_6264() {
		if (!this.field_6488.method_5934() && !this.field_6488.method_6805()) {
			List<class_1297> list = this.field_6488.field_6002.method_8333(this.field_6488, this.field_6488.method_5829().method_1009(9.0, 4.0, 9.0), arg -> {
				class_1299<?> lvx = arg.method_5864();
				return lvx == class_1299.field_6074 || lvx == class_1299.field_17714;
			});
			class_1501 lv = null;
			double d = Double.MAX_VALUE;

			for (class_1297 lv2 : list) {
				class_1501 lv3 = (class_1501)lv2;
				if (lv3.method_6805() && !lv3.method_6793()) {
					double e = this.field_6488.method_5858(lv3);
					if (!(e > d)) {
						d = e;
						lv = lv3;
					}
			...
			if (lv == null) {
				for (class_1297 lv2x : list) {
					class_1501 lv3 = (class_1501)lv2x;
					if (lv3.method_5934() && !lv3.method_6793()) {
						double e = this.field_6488.method_5858(lv3);
						if (!(e > d)) {
							d = e;
							lv = lv3;
