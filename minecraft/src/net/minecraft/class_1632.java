...
public class class_1632 extends class_1543 {
	...
	protected void method_5959() {
		...
		this.field_6201.method_6277(4, new class_1632.class_4293(this));
	...
	public boolean method_5722(class_1297 arg) {
		if (super.method_5722(arg)) {
			return true;
		} else if (arg instanceof class_1309 && ((class_1309)arg).method_6046() == class_1310.field_6291) {
			return this.method_5781() == null && arg.method_5781() == null;
		} else {
			return false;
		}
	}
	...
	public void method_16484(int i, boolean bl) {
		class_1799 lv = new class_1799(class_1802.field_8475);
		class_3765 lv2 = this.method_16478();
		int j = 1;
		if (i > lv2.method_20016(class_1267.field_5802)) {
			j = 2;
		}

		boolean bl2 = this.field_5974.nextFloat() <= lv2.method_20025();
		if (bl2) {
			Map<class_1887, Integer> map = Maps.newHashMap();
	...
	static class class_3761 extends class_1339 {
		...
		public boolean method_6266() {
			...
			return lv.method_16482() && super.method_6266();
		}

		@Override
		public boolean method_6264() {
			class_1632 lv = (class_1632)this.field_6413;
			return lv.method_16482() && lv.field_5974.nextInt(10) == 0 && super.method_6264();
		}
	...
	class class_4293 extends class_1366 {
		public class_4293(class_1632 arg2) {
		...
		protected double method_6289(class_1309 arg) {
			if (this.field_6503.method_5854() instanceof class_1584) {
				float f = this.field_6503.method_5854().method_17681() - 0.1F;
				return (double)(f * 2.0F * f * 2.0F + arg.method_17681());
			} else {
				return super.method_6289(arg);
			}
		}
	}
}
