...
public class class_2419 implements Consumer<Consumer<SimpleAdvancement>> {
	public void method_10348(Consumer<SimpleAdvancement> consumer) {
		...
		SimpleAdvancement simpleAdvancement2 = SimpleAdvancement.Builder.create()
			...
			.criterion("killed_dragon", OnKilledCriterion.class_2083.method_8997(EntityPredicate.Builder.create().type(EntityType.ENDER_DRAGON)))
