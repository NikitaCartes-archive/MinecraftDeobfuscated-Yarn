...
public class class_315 {
	...
	public List<String> field_1887 = Lists.newArrayList();
	public List<String> field_1846 = Lists.newArrayList();
	...
	private final Set<class_1664> field_1892 = Sets.newHashSet(class_1664.values());
	...
	public void method_1636() {
		try {
			...
			for(String string : lv.method_10541()) {
				...
				try {
					...
					if ("discrete_mouse_scroll".equals(string)) {
						class_316.field_19243.method_18492(this, string2);
					}
					...
					if ("maxFps".equals(string)) {
						...
						if (this.field_1863.field_1704 != null) {
					...
					if ("resourcePacks".equals(string)) {
						...
						if (this.field_1887 == null) {
							this.field_1887 = Lists.newArrayList();
						}
					}
					...
					if ("incompatibleResourcePacks".equals(string)) {
						...
						if (this.field_1846 == null) {
							this.field_1846 = Lists.newArrayList();
						}
					}
			...
			field_1834.error("Failed to load options", var12);
		}
	}
	...
	private class_2487 method_1626(class_2487 arg) {
		...
		return class_2512.method_10688(this.field_1863.method_1543(), class_4284.field_19216, arg, i);
	}
	...
	public void method_1640() {
		try {
			...
			try {
				...
				printWriter.println("discrete_mouse_scroll:" + class_316.field_19243.method_18494(this));
			...
			field_1834.error("Failed to save options", var17);
		}
	...
	public float method_1630(class_3419 arg) {
		return this.field_1916.containsKey(arg) ? this.field_1916.get(arg) : 1.0F;
	}
