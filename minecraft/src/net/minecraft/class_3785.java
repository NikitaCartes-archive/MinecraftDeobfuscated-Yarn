...
public class class_3785 {
	...
	public int method_19309(class_3485 arg) {
		if (this.field_18707 == Integer.MIN_VALUE) {
			this.field_18707 = this.field_16680
				.stream()
				.mapToInt(arg2 -> arg2.method_16628(arg, class_2338.field_10980, class_2470.field_11467).method_14663())
				.max()
				.orElse(0);
		}
	...
	public List<class_3784> method_16633(Random random) {
		return ImmutableList.copyOf(ObjectArrays.shuffle(this.field_16680.toArray(new class_3784[0]), random));
	}
