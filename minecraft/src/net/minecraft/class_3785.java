...
public class class_3785 {
	...
	public class_3785(Identifier identifier, Identifier identifier2, ImmutableList<Pair<class_3784, Integer>> immutableList, class_3785.Projection projection) {
		this.field_16678 = identifier;
		this.field_16864 = immutableList;
		this.field_16680 = Lists.<class_3784>newArrayList();

		for (Pair<class_3784, Integer> pair : immutableList) {
