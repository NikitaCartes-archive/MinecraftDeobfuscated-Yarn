...
public class class_4019 extends class_1429 {
	...
	protected void method_5959() {
		...
		this.field_6201
			.method_6277(3, new class_1338(this, class_1657.class, 16.0F, 1.6, 1.4, arg -> field_17956.test(arg) && !this.method_18428(arg.method_5667())));
		this.field_6201.method_6277(3, new class_1338(this, class_1493.class, 8.0F, 1.6, 1.4, class_1301.field_6155::test));
		...
		this.field_6201.method_6277(6, new class_4019.class_4029(1.0, true));
		...
		this.field_6201.method_6277(11, new class_1361(this, class_1657.class, 24.0F));
		...
		if (!this.field_6002.field_9236 && this.method_5805() && this.method_6034()) {
			...
			if (this.method_18430(lv)) {
				if (this.field_17964 > 600) {
					lv.method_7910(this.field_6002, this);
					this.field_17964 = 0;
			...
			class_1309 lv2 = this.method_5968();
	...
	protected float method_18394(class_4050 arg, class_4048 arg2) {
		return this.method_6109() ? arg2.field_18068 : 0.4F;
	}
	...
	private List<UUID> method_18281() {
		...
		list.add(((Optional)this.field_6011.method_12789(field_17951)).orElse(null));
		list.add(((Optional)this.field_6011.method_12789(field_17952)).orElse(null));
		return list;
	}
	...
	public void method_5773() {
		...
		if (this.method_6034()) {
			...
			if (this.method_18273() && this.field_6002.field_9229.nextFloat() < 0.2F) {
				...
				this.field_6002.method_8535(2001, lv, class_2248.method_9507(lv2));
			}
		}
	...
	class class_4021 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			return class_4019.this.method_18273() && class_4019.this.field_5965 > 0.0F;
		}
	...
	public class class_4022 implements Predicate<class_1309> {
		public boolean method_18303(class_1309 arg) {
			if (arg instanceof class_4019) {
				...
				if (!(arg instanceof class_1657) || !arg.method_7325() && !((class_1657)arg).method_7337()) {
					if (class_4019.this.method_18428(arg.method_5667())) {
						return false;
					} else {
						return !arg.method_6113() && !arg.method_5715();
					}
				} else {
					return false;
				}
	...
	public class class_4025 extends class_1367 {
		...
		protected boolean method_6296(class_1941 arg, class_2338 arg2) {
			...
			return lv.method_11614() == class_2246.field_16999 && lv.method_11654(class_3830.field_17000) >= 2;
		}
		...
		protected void method_18307() {
			if (class_4019.this.field_6002.method_8450().method_8355("mobGriefing")) {
				class_2680 lv = class_4019.this.field_6002.method_8320(this.field_6512);
				if (lv.method_11614() == class_2246.field_16999) {
					int i = lv.method_11654(class_3830.field_17000);
	...
	public class class_4033 extends class_4017 {
		...
		public boolean method_6266() {
			...
			return (!(d * d < 0.03F) || class_4019.this.field_5965 == 0.0F || !(Math.abs(class_4019.this.field_5965) < 10.0F) || !class_4019.this.field_5952)
				&& !class_4019.this.method_18273();
		}
		...
		public void method_6269() {
			...
			class_4019.this.method_18299(false);
			class_1309 lv = class_4019.this.method_5968();
			class_4019.this.method_5988().method_6226(lv, 30.0F, 30.0F);
		...
		public void method_6268() {
			...
			if (lv != null && class_4019.this.method_5739(lv) <= 2.0F) {
				...
				&& class_4019.this.method_18798().field_1351 != 0.0
				&& class_4019.this.field_6002.method_8320(new class_2338(class_4019.this)).method_11614() == class_2246.field_10477) {
				if (class_4019.this.field_5965 < 0.0F) {
					class_4019.this.field_5965 = 0.0F;
				} else {
	...
	class class_4037 extends class_4019.class_4023 {
		...
		@Override
		public boolean method_6264() {
			return this.method_18432() || class_4019.this.method_6113();
		}
	...
	public static enum class_4039 {
		...
		private static final class_4019.class_4039[] field_17998 = (class_4019.class_4039[])Arrays.stream(values())
			...
			.toArray(i -> new class_4019.class_4039[i]);
