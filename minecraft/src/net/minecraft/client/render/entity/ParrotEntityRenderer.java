...
public class ParrotEntityRenderer extends EntityMobRenderer<ParrotEntity> {
	...
	public float method_4082(ParrotEntity parrotEntity, float f) {
		return this.method_4081(parrotEntity, f);
	}

	private float method_4081(ParrotEntity parrotEntity, float f) {
