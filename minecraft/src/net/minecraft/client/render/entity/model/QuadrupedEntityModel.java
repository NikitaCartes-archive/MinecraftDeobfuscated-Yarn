...
public class QuadrupedEntityModel<T extends Entity> extends AnimalModel<T> {
	...
	public QuadrupedEntityModel(
		...
		this.body.setPivot(0.0F, (float)(17 - legHeight), 2.0F);
	...
	protected Iterable<ModelPart> getBodyParts() {
		return ImmutableList.<ModelPart>of(this.body, this.backRightLeg, this.backLeftLeg, this.frontRightLeg, this.frontLeftLeg);
	}
