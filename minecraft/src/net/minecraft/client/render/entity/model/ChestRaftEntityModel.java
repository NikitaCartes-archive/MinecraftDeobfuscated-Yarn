...
public class ChestRaftEntityModel extends RaftEntityModel {
	...
	public static TexturedModelData method_45709() {
		...
		modelPartData.addChild(
			...
			ModelTransform.of(-2.0F, -11.0F, -6.0F, 0.0F, (float) (-Math.PI / 2), 0.0F)
		);
		modelPartData.addChild(
			"chest_lid",
			ModelPartBuilder.create().uv(0, 59).cuboid(0.0F, 0.0F, 0.0F, 12.0F, 4.0F, 12.0F),
			ModelTransform.of(-2.0F, -15.0F, -6.0F, 0.0F, (float) (-Math.PI / 2), 0.0F)
		);
		modelPartData.addChild(
			"chest_lock",
			ModelPartBuilder.create().uv(0, 59).cuboid(0.0F, 0.0F, 0.0F, 2.0F, 4.0F, 1.0F),
			ModelTransform.of(-1.0F, -12.0F, -1.0F, 0.0F, (float) (-Math.PI / 2), 0.0F)
		);
