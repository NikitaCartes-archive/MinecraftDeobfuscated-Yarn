...
public class BipedEntityModel<T extends LivingEntity> extends EntityModel<T> implements class_3881, class_3882 {
	...
	public void method_17087(T livingEntity, float f, float g, float h, float i, float j, float k) {
		...
		if (this.swingProgress > 0.0F) {
			...
			this.field_3401.yaw += this.field_3391.yaw;
			this.field_3390.yaw += this.field_3391.yaw;
			this.field_3390.pitch += this.field_3391.yaw;
			...
			cuboid.yaw += this.field_3391.yaw * 2.0F;
		...
		this.field_3401.roll += MathHelper.cos(h * 0.09F) * 0.05F + 0.05F;
		this.field_3390.roll -= MathHelper.cos(h * 0.09F) * 0.05F + 0.05F;
		this.field_3401.pitch += MathHelper.sin(h * 0.067F) * 0.05F;
		this.field_3390.pitch -= MathHelper.sin(h * 0.067F) * 0.05F;
		...
		if (this.field_3396 > 0.0F) {
			...
			if (q < 14.0F) {
				...
				this.field_3390.roll = this.method_2804(
					this.field_3390.roll, (float) Math.PI + 1.8707964F * this.method_2807(q) / this.method_2807(14.0F), this.field_3396
				);
