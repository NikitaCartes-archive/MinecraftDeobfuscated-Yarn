...
public class LlamaEntityModel<T extends AbstractDonkeyEntity> extends QuadrupedEntityModel<T> {
	...
	public LlamaEntityModel(float f) {
		...
		this.body.addCuboid(-6.0F, -10.0F, -7.0F, 12, 18, 10, f);
