...
public class DragonEntityModel extends Model {
	...
	public void render(Entity entity, float f, float g, float h, float i, float j, float k) {
		...
		float l = MathHelper.lerp(this.partialTicks, enderDragonEntity.field_7019, enderDragonEntity.field_7030);
		...
		float p = -12.0F;
		float q = 1.5F;
		double[] ds = enderDragonEntity.method_6817(6, this.partialTicks);
		float r = this.updateRotations(enderDragonEntity.method_6817(5, this.partialTicks)[0] - enderDragonEntity.method_6817(10, this.partialTicks)[0]);
		float s = this.updateRotations(enderDragonEntity.method_6817(5, this.partialTicks)[0] + (double)(r / 2.0F));
		float t = l * (float) (Math.PI * 2);

		for (int u = 0; u < 5; u++) {
			double[] es = enderDragonEntity.method_6817(5 - u, this.partialTicks);
		...
		double[] fs = enderDragonEntity.method_6817(0, this.partialTicks);
		...
		p = 60.0F;
		n = 0.0F;
		ds = enderDragonEntity.method_6817(11, this.partialTicks);

		for (int y = 0; y < 12; y++) {
			fs = enderDragonEntity.method_6817(12 + y, this.partialTicks);
