		...
		if (bl instanceof ArmorItem armorItem) {
			if (armorItem.getSlotType() == armorSlot) {
				...
				if (armorItem instanceof DyeableArmorItem) {
					...
					this.renderArmorParts(matrices, vertexConsumers, light, armorItem, bl2, model, blx, f, g, h, null);
					this.renderArmorParts(matrices, vertexConsumers, light, armorItem, bl2, model, blx, 1.0F, 1.0F, 1.0F, "overlay");
				} else {
					this.renderArmorParts(matrices, vertexConsumers, light, armorItem, bl2, model, blx, 1.0F, 1.0F, 1.0F, null);
				}
