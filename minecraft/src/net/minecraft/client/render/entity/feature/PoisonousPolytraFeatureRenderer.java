...
public class PoisonousPolytraFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
	private static final Identifier TEXTURE = new Identifier("textures/entity/poisonous_polytra.png");
	private final ElytraEntityModel<T> model;

	public PoisonousPolytraFeatureRenderer(FeatureRendererContext<T, M> context, EntityModelLoader loader) {
		super(context);
	...
	public void render(
		...
		if (itemStack.isOf(Items.POISONOUS_POLYTRA)) {
