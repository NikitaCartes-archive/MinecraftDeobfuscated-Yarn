...
public class MegaSpudOverlayFeatureRenderer<T extends LivingEntity> extends FeatureRenderer<T, MegaSpudEntityModel<T>> {
	private final EntityModel<T> model;

	public MegaSpudOverlayFeatureRenderer(FeatureRendererContext<T, MegaSpudEntityModel<T>> context, EntityModelLoader loader) {
		super(context);
		this.model = new SlimeEntityModel<>(loader.getModelPart(EntityModelLayers.MEGA_SPUD_OUTER));
	}
