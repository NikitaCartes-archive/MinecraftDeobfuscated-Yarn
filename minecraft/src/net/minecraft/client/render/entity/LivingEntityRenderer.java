...
public abstract class LivingEntityRenderer<T extends LivingEntity> extends EntityRenderer<T> {
	...
	protected float linearRotationInterpolation(float f, float g, float h) {
		float i = g - f;
	...
	public void method_4054(T livingEntity, double d, double e, double f, float g, float h) {
		...
		try {
			...
			if (livingEntity.hasVehicle() && livingEntity.getRiddenEntity() instanceof LivingEntity) {
				...
				i = this.linearRotationInterpolation(livingEntity2.field_6220, livingEntity2.field_6283, h);
				k = j - i;
			...
			float l = this.method_4045(livingEntity, h);
			this.method_4058(livingEntity, l, i, h);
			...
			this.model.setRotationAngles(p, o, l, k, m, n, livingEntity);
			if (this.field_4674) {
				...
				if (!(livingEntity instanceof PlayerEntity) || !((PlayerEntity)livingEntity).isSpectator()) {
					this.method_4051(livingEntity, p, o, h, l, k, m, n);
				}
				...
				boolean bl = this.method_4059(livingEntity, h);
				this.render(livingEntity, p, o, l, k, m, n);
				if (bl) {
					this.method_4040();
				}
			...
			field_4741.error("Couldn't render entity", var19);
		}
	...
	protected void method_4058(T livingEntity, float f, float g, float h) {
		...
		if (livingEntity.deathCounter > 0) {
			...
			if (string != null
				...
				GlStateManager.translatef(0.0F, livingEntity.height + 0.1F, 0.0F);
