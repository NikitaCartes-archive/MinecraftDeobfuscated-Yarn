...
public class CapeEntityRenderer implements LayerEntityRenderer<AbstractClientPlayerEntity> {
	private final PlayerEntityRenderer renderer;

	public CapeEntityRenderer(PlayerEntityRenderer playerEntityRenderer) {
		this.renderer = playerEntityRenderer;
	}
	...
	public void render(AbstractClientPlayerEntity abstractClientPlayerEntity, float f, float g, float h, float i, float j, float k, float l) {
		if (abstractClientPlayerEntity.method_3125()
			...
			if (itemStack.getItem() != Items.field_8833) {
				...
				this.renderer.bindTexture(abstractClientPlayerEntity.method_3119());
				...
				this.renderer.method_4214().method_2823(0.0625F);
