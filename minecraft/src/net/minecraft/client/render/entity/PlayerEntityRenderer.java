...
public class PlayerEntityRenderer extends LivingEntityRenderer<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> {
	...
	private void renderArm(
		...
		if (player.method_42803() == LivingEntity.class_7316.MOB) {
			...
			modelPart.roll += (modelPart == playerEntityModel.rightArm ? 30.0F : -30.0F) * (float) (Math.PI / 180.0);
			modelPart2.pitch -= (float) (Math.PI / 6);
			modelPart2.roll += (modelPart2 == playerEntityModel.rightSleeve ? 30.0F : -30.0F) * (float) (Math.PI / 180.0);
		}
