...
public class ItemFrameEntityRenderer extends EntityRenderer<ItemFrameEntity> {
	...
	protected void method_23175(
		ItemFrameEntity itemFrameEntity, String string, MatrixStack matrixStack, LayeredVertexConsumerStorage layeredVertexConsumerStorage
	) {
