...
public class GuardianEntityRenderer extends EntityMobRenderer<GuardianEntity> {
	...
	public boolean method_3978(GuardianEntity guardianEntity, class_856 arg, double d, double e, double f) {
		if (super.method_4068(guardianEntity, arg, d, e, f)) {
			...
			if (guardianEntity.method_7063()) {
				...
				if (livingEntity != null) {
					Vec3d vec3d = this.method_3979(livingEntity, (double)livingEntity.height * 0.5, 1.0F);
	...
	public void method_3977(GuardianEntity guardianEntity, double d, double e, double f, float g, float h) {
		...
		if (livingEntity != null) {
			...
			Vec3d vec3d = this.method_3979(livingEntity, (double)livingEntity.height * 0.5, h);
