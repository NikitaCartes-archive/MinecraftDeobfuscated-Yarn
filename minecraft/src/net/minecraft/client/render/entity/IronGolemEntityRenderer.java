...
public class IronGolemEntityRenderer extends EntityMobRenderer<IronGolemEntity> {
	...
	public IronGolemEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
		...
		this.addLayer(new IronGolemFlowerEntityRenderer(this));
	}
	...
	protected void method_3986(IronGolemEntity ironGolemEntity, float f, float g, float h) {
		super.method_4058(ironGolemEntity, f, g, h);
