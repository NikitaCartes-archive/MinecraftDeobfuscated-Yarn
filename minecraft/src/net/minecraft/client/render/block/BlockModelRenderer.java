...
public class BlockModelRenderer {
	...
	public boolean tesselate(
		...
		try {
			return bl2
				? this.tesselateSmooth(blockRenderView, bakedModel, blockState, blockPos, bufferBuilder, bl, random, l)
				: this.tesselateFlat(blockRenderView, bakedModel, blockState, blockPos, bufferBuilder, bl, random, l);
	...
	static class BrightnessCache {
		...
		public int getInt(BlockState blockState, BlockRenderView blockRenderView, BlockPos blockPos) {
			...
			int i = blockRenderView.getLightmapIndex(blockState, blockPos);
			if (this.enabled) {
