	...
	public boolean tesselate(BlockRenderView world, BlockPos pos, BufferBuilder bufferBuilder, FluidState state) {
		...
		if (!bl2 && !bl3 && !bl7 && !bl6 && !bl4 && !bl5) {
			...
			for(int aq = 0; aq < 4; ++aq) {
				...
				if (bl9 && !method_3344(world, pos, direction, Math.max(v, x))) {
					bl8 = true;
					...
					float aj = sprite2.getFrameV((double)((1.0F - v) * 16.0F * 0.5F));
					float ak = sprite2.getFrameV((double)((1.0F - x) * 16.0F * 0.5F));
