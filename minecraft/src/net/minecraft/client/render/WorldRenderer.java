...
public class WorldRenderer implements WorldListener, AutoCloseable, ResourceReloadListener {
	...
	private boolean method_3284(Entity entity, Entity entity2, class_856 arg) {
		...
		if (entity == entity2 && this.client.field_1690.field_1850 == 0 && !bl) {
			...
			return true;
		} else if (this.client.player.isSpectator() && this.client.field_1690.keySpectatorOutlines.method_1434() && entity instanceof PlayerEntity) {
			return entity.ignoreCameraFrustum || arg.method_3699(entity.getBoundingBox()) || entity.method_5821(this.client.player);
		} else {
			return false;
		}
	}
