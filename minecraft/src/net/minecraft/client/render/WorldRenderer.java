...
public class WorldRenderer implements AutoCloseable, SynchronousResourceReloadListener {
		...
		if (this.field_4076 > 0) {
			...
			if (!list2.isEmpty()) {
				for(Entity entity : list2) {
					this.field_4109.renderSecondPass(entity, f);
				}
			}
	...
	public String getChunksDebugString() {
		...
		return String.format(
			...
			this.renderDistance,
			this.field_4106 == null ? "null" : this.field_4106.getDebugString()
		);
	}
	...
	public void updateChunks(long l) {
		this.terrainUpdateNecessary |= this.field_4106.method_3631(l);
	...
	public void method_8563(ParticleParameters particleParameters, boolean bl, boolean bl2, double d, double e, double f, double g, double h, double i) {
		try {
			...
			crashReportSection.add("ID", Registry.PARTICLE_TYPE.method_10221(particleParameters.method_10295()));
	...
	public void method_8567(PlayerEntity playerEntity, int i, BlockPos blockPos, int j) {
		...
		switch(i) {
			...
			case 1015:
				this.world
					.method_2947(blockPos, SoundEvents.field_15130, SoundCategory.field_15251, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
				break;
			case 1016:
				this.world
					.method_2947(blockPos, SoundEvents.field_15231, SoundCategory.field_15251, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
				break;
			case 1017:
				this.world
					.method_2947(blockPos, SoundEvents.field_14934, SoundCategory.field_15251, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
				break;
			case 1018:
			...
			case 1025:
				this.world
					.method_2947(blockPos, SoundEvents.field_14610, SoundCategory.field_15254, 0.05F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
				break;
			case 1026:
			...
			case 2007:
				...
				for(int n = 0; n < 100; ++n) {
					...
					Particle particle = this.method_3282(
						particleParameters, particleParameters.method_10295().shouldAlwaysSpawn(), t + o * 0.1, u + 0.3, d + q * 0.1, o, p, q
					);
					if (particle != null) {
