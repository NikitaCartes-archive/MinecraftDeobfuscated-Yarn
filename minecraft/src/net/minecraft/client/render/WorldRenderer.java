...
public class WorldRenderer implements AutoCloseable, SynchronousResourceReloadListener {
	...
	public void render(
		...
		double e = vec3d.getY();
		double f = vec3d.getZ();
		Matrix4f matrix4f2 = matrix.peek().getModel();
		...
		GuiLighting.enable(matrix.peek().getModel());
					...
					if (sortedSet != null && !sortedSet.isEmpty()) {
						...
						if (l >= 0) {
							...
							vertexConsumerProvider2 = renderLayer -> {
								...
								return renderLayer.method_23037() ? class_4720.method_24037(vertexConsumer, vertexConsumer2xx) : vertexConsumer2xx;
							};
						}
					}
