	...
	public void updateEyeHeight() {
		if (this.focusedEntity != null) {
			...
			label18: {
				...
				if (!this.thirdPerson && this.focusedEntity.isInSneakingPose()) {
					Entity var3 = this.focusedEntity;
					if (var3 instanceof LivingEntity livingEntity && livingEntity.getEquippedStack(EquipmentSlot.HEAD).isOf(Items.BARREL)) {
						f = 0.875F;
						break label18;
					}
				}
