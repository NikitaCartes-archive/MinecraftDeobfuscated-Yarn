...
public class ChunkBatcher {
	...
	public ChunkBatcher(
		World world, WorldRenderer worldRenderer, Executor executor, boolean bl, BlockLayeredBufferBuilderStorage blockLayeredBufferBuilderStorage
	) {
		...
		if (!this.field_20827.isEmpty()) {
			...
			if (lv != null) {
				...
				CompletableFuture.runAsync(() -> {
					...
					this.field_20829.send((Runnable)() -> {
	...
	public class ChunkRenderer {
		...
		public boolean shouldBuild() {
			...
			if (!(this.getSquaredCameraDistance() > 576.0)) {
				...
				return this.isChunkNonEmpty(this.neighborPositions[Direction.WEST.ordinal()])
