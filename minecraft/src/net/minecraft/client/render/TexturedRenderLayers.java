...
public class TexturedRenderLayers {
	...
	public static final SpriteIdentifier DECORATED_POT_BASE = createDecoratedPotPatternTextureId(new Identifier("decorated_pot_base"));
	public static final SpriteIdentifier DECORATED_POT_SIDE = createDecoratedPotPatternTextureId(new Identifier("decorated_pot_side"));
