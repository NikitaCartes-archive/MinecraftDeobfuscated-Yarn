...
public class ItemBuiltinRenderer {
	...
	public static ItemBuiltinRenderer INSTANCE = new ItemBuiltinRenderer();
	...
	public void method_3166(ItemStack itemStack) {
		...
		if (item instanceof BannerItem) {
			...
			this.renderBed.method_11019(((BedBlock)((BlockItem)item).getBlock()).getColor());
			...
			if (itemStack.hasEnchantmentGlow()) {
				this.applyEnchantmentGlow(this.modelShield::method_2828);
			}
			...
			if (SkullBlockEntityRenderer.INSTANCE != null) {
				...
				SkullBlockEntityRenderer.INSTANCE
					.method_3581(0.0F, 0.0F, 0.0F, null, 180.0F, ((AbstractSkullBlock)((BlockItem)item).getBlock()).getSkullType(), gameProfile, -1, 0.0F);
			...
			GlStateManager.pushMatrix();
			GlStateManager.scalef(1.0F, -1.0F, -1.0F);
			this.modelTrident.method_2835();
			if (itemStack.hasEnchantmentGlow()) {
				this.applyEnchantmentGlow(this.modelTrident::method_2835);
			}
