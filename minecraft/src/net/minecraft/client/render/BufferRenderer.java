	...
	public static void draw(BufferBuilder bufferBuilder) {
		if (!RenderSystem.isOnRenderThreadOrInit()) {
			RenderSystem.recordRenderCall(
				() -> {
					Pair<BufferBuilder.DrawArrayParameters, ByteBuffer> pairxx = bufferBuilder.popData();
					BufferBuilder.DrawArrayParameters drawArrayParametersxx = pairxx.getFirst();
					draw(
						(ByteBuffer)pairxx.getSecond(),
						drawArrayParametersxx.getMode(),
						drawArrayParametersxx.getVertexFormat(),
						drawArrayParametersxx.getCount(),
						drawArrayParametersxx.getElementFormat(),
						drawArrayParametersxx.getVertexCount(),
						drawArrayParametersxx.hasNoIndexBuffer()
					);
				}
			);
		} else {
