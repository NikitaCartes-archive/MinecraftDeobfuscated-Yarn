...
public class VertexFormats {
	...
	public static final VertexFormat field_29336 = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("UV", field_29335).put("Color", COLOR_ELEMENT).build()
	);
	...
	public static final VertexFormat POSITION_TEXTURE_COLOR_LIGHT = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("UV0", TEXTURE_ELEMENT).put("Color", COLOR_ELEMENT).put("UV2", LIGHT_ELEMENT).build()
	);
	...
	public static final VertexFormat POSITION_TEXTURE = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("UV0", TEXTURE_ELEMENT).build()
	);
	public static final VertexFormat POSITION_COLOR_TEXTURE = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("Color", COLOR_ELEMENT).put("UV0", TEXTURE_ELEMENT).build()
	);
	public static final VertexFormat POSITION_TEXTURE_COLOR = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("UV0", TEXTURE_ELEMENT).put("Color", COLOR_ELEMENT).build()
	);
	public static final VertexFormat POSITION_COLOR_TEXTURE_LIGHT = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("Color", COLOR_ELEMENT).put("UV0", TEXTURE_ELEMENT).put("UV2", LIGHT_ELEMENT).build()
	);
	public static final VertexFormat POSITION_TEXTURE_LIGHT_COLOR = new VertexFormat(
		ImmutableMap.builder().put("Position", POSITION_ELEMENT).put("UV0", TEXTURE_ELEMENT).put("UV2", LIGHT_ELEMENT).put("Color", COLOR_ELEMENT).build()
	);
