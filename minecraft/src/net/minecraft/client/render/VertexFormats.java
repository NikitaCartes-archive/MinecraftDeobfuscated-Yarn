...
public class VertexFormats {
	...
	public static final VertexFormatElement COLOR_ELEMENT = new VertexFormatElement(
		0, VertexFormatElement.Format.UNSIGNED_BYTE, VertexFormatElement.Type.COLOR, 4
	);
	...
	public static final VertexFormat field_1582 = new VertexFormat().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(UV_ELEMENT).add(field_1583);
	public static final VertexFormat field_1590 = new VertexFormat()
		...
		.add(NORMAL_ELEMENT)
		.add(PADDING_ELEMENT);
	public static final VertexFormat field_1580 = new VertexFormat().add(POSITION_ELEMENT).add(UV_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT);
	public static final VertexFormat field_1584 = new VertexFormat().add(POSITION_ELEMENT).add(UV_ELEMENT).add(COLOR_ELEMENT).add(field_1583);
	...
	public static final VertexFormat field_1586 = new VertexFormat().add(POSITION_ELEMENT).add(UV_ELEMENT).add(field_1583).add(COLOR_ELEMENT);
