...
public abstract class SkyProperties {
	...
	public static class End extends SkyProperties {
		public End() {
			super(Float.NaN, false, SkyProperties.SkyType.field_25641, true, false);
		}
	...
	public static class Nether extends SkyProperties {
		public Nether() {
			super(Float.NaN, true, SkyProperties.SkyType.field_25639, false, true);
		}
	...
	public static class Overworld extends SkyProperties {
		public Overworld() {
			super(128.0F, true, SkyProperties.SkyType.field_25640, false, false);
		}
