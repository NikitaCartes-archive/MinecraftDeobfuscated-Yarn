...
public class VillageDebugRenderer implements DebugRenderer.Renderer {
	...
	private final Map<BlockPos, VillageDebugRenderer.class_4233> pointsOfInterest = Maps.<BlockPos, VillageDebugRenderer.class_4233>newHashMap();
	private final Set<ChunkSectionPos> field_18788 = Sets.<ChunkSectionPos>newHashSet();
	private final Map<UUID, VillageDebugRenderer.class_4232> field_18921 = Maps.<UUID, VillageDebugRenderer.class_4232>newHashMap();
	...
	public void method_19701(VillageDebugRenderer.class_4233 arg) {
	...
	public void method_19702(BlockPos blockPos, int i) {
		VillageDebugRenderer.class_4233 lv = (VillageDebugRenderer.class_4233)this.pointsOfInterest.get(blockPos);
		if (lv == null) {
	...
	public void addBrain(VillageDebugRenderer.class_4232 brain) {
	...
	private void method_19708(VillageDebugRenderer.class_4233 arg) {
		int i = 0;
	...
	private void method_20570(VillageDebugRenderer.class_4232 arg) {
		if (arg.field_19330 != null) {
			PathfindingDebugRenderer.method_20556(this.getCamera(), arg.field_19330, 0.5F, false, false);
		}
	}

	private void method_20571(VillageDebugRenderer.class_4232 arg) {
	...
	private static void method_20568(String string, VillageDebugRenderer.class_4233 arg, int i, int j) {
	...
	private Set<String> method_19712(VillageDebugRenderer.class_4233 arg) {
		return (Set<String>)this.method_19713(arg.field_18931).stream().map(DebugNameGenerator::getDebugName).collect(Collectors.toSet());
	}

	private boolean method_19711(VillageDebugRenderer.class_4232 arg) {
		return Objects.equals(this.field_18922, arg.field_18923);
	}

	private boolean method_19715(VillageDebugRenderer.class_4232 arg) {
	...
	private Collection<UUID> method_19713(BlockPos blockPos) {
		return (Collection<UUID>)this.field_18921
			...
			.map(VillageDebugRenderer.class_4232::method_19716)
	...
	private Map<BlockPos, List<String>> method_20572() {
		...
		for (VillageDebugRenderer.class_4232 lv : this.field_18921.values()) {
