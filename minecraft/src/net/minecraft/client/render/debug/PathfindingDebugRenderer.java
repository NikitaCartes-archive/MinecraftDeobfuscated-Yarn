		...
		if (!this.field_4616.isEmpty()) {
			...
			for(Integer integer : this.field_4616.keySet()) {
				...
				for(PathNode pathNode2 : path.method_43()) {
					if (!(this.method_3867(pathNode2) > 40.0F)) {
						DebugRenderer.method_3714(
							String.format("%s", pathNode2.type), (double)pathNode2.x + 0.5, (double)pathNode2.y + 0.75, (double)pathNode2.z + 0.5, -16776961
						);
						DebugRenderer.method_3714(
							String.format(Locale.ROOT, "%.2f", pathNode2.field_43), (double)pathNode2.x + 0.5, (double)pathNode2.y + 0.25, (double)pathNode2.z + 0.5, -16776961
						);
					}
				}
