...
public class ChunkLoadingDebugRenderer implements DebugRenderer.Renderer {
	...
	public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
		...
		if (this.loadingData != null) {
			...
			Map<ChunkPos, String> map = (Map)this.loadingData.serverStates.getNow(null);
				...
				if (serverWorld == null) {
					...
					for(int kxx = i - 12; kxx <= i + 12; ++kxx) {
						for(int lxx = j - 12; lxx <= j + 12; ++lxx) {
							...
							builderxx.put(chunkPosxx, "Server: " + serverChunkManager.getChunkLoadingDebugInfo(chunkPosxx));
						}
					}
