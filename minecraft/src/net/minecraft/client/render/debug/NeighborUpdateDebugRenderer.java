...
public class NeighborUpdateDebugRenderer implements RenderDebug.DebugRenderer {
	...
	public void method_3870(long l, BlockPos blockPos) {
		Map<BlockPos, Integer> map = (Map)this.field_4623.get(l);
		if (map == null) {
			map = Maps.newHashMap();
	...
	public void render(float f, long l) {
		...
		for(Entry<BlockPos, Integer> entry : map.entrySet()) {
			...
			RenderDebug.method_3711(String.valueOf(integer2), blockPos2.getX(), blockPos2.getY(), blockPos2.getZ(), f, -1);
		}
