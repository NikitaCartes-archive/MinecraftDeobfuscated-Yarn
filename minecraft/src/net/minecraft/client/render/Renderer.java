...
public class Renderer implements WorldListener, AutoCloseable, ResourceReloadListener {
	...
	public void renderEntities(Entity entity, class_856 arg, float f) {
		if (this.field_4076 > 0) {
			...
			this.entityRenderDispatcher
				.method_3941(this.world, this.client.fontRenderer, this.client.getCameraEntity(), this.client.field_1692, this.client.options, f);
	...
	private boolean method_3284(Entity entity, Entity entity2, class_856 arg) {
		...
		if (entity == entity2 && this.client.options.field_1850 == 0 && !bl) {
			...
			return true;
		} else if (this.client.player.isSpectator() && this.client.options.keySpectatorOutlines.method_1434() && entity instanceof PlayerEntity) {
			return entity.field_5985 || arg.method_3699(entity.getBoundingBox()) || entity.method_5821(this.client.player);
		} else {
			return false;
		}
	}
	...
	public void method_3269(long l) {
		this.field_4077 |= this.chunkBatcher.method_3631(l);
	...
	public void addParticle(Particle particle, boolean bl, boolean bl2, double d, double e, double f, double g, double h, double i) {
		try {
			...
			crashReportElement.add("ID", Registry.PARTICLE_TYPE.getId(particle.getParticleType()));
