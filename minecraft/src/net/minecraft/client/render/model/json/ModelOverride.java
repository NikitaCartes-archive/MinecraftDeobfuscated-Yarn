...
public class ModelOverride {
	...
	boolean matches(ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
		...
		for(Entry<Identifier, Float> entry : this.predicateToThresholds.entrySet()) {
			...
			if (modelPredicateProvider == null || modelPredicateProvider.call(stack, world, entity) < entry.getValue()) {
				return false;
			}
		}
	...
	public static class Deserializer implements JsonDeserializer<ModelOverride> {
		...
		public ModelOverride method_3475(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
