...
public class ModelOverrideList {
	...
	public ModelOverrideList(
		...
		this.models = (List)overrides.stream()
			.map(
				modelOverride -> {
					UnbakedModel unbakedModelxx = (UnbakedModel)unbakedModelGetter.apply(modelOverride.getModelId());
					return Objects.equals(unbakedModelxx, unbakedModel)
						? null
						: modelLoader.bake(modelOverride.getModelId(), net.minecraft.client.render.model.ModelRotation.field_5350);
				}
			)
