...
public class EmotionParticle extends Particle {
	...
	@Environment(EnvType.CLIENT)
	public static class FactoryAngry implements FactoryParticle<TexturedParticle> {
	...
	@Environment(EnvType.CLIENT)
	public static class FactoryLove implements FactoryParticle<TexturedParticle> {
		public Particle createParticle(TexturedParticle texturedParticle, World world, double d, double e, double f, double g, double h, double i) {
