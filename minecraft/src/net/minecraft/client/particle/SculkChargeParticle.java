...
public class SculkChargeParticle extends SpriteBillboardParticle {
	...
	@Environment(EnvType.CLIENT)
	public static record Factory(SpriteProvider sprite) implements ParticleFactory<SculkChargeParticleEffect> {
		public Particle createParticle(
			...
			SculkChargeParticle sculkChargeParticle = new SculkChargeParticle(clientWorld, d, e, f, g, h, i, this.sprite);
			sculkChargeParticle.setAlpha(1.0F);
			sculkChargeParticle.setVelocity(g, h, i);
			sculkChargeParticle.prevAngle = sculkChargeParticle.angle = sculkChargeParticleEffect.roll();
			int j = 8;
			int k = 20;
