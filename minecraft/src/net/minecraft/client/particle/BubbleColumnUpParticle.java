...
public class BubbleColumnUpParticle extends Particle {
	protected BubbleColumnUpParticle(World world, double d, double e, double f, double g, double h, double i) {
