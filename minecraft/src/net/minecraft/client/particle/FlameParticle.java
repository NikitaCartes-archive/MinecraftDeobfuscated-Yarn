...
public class FlameParticle extends SpriteBillboardParticle {
	private FlameParticle(World world, double d, double e, double f, double g, double h, double i) {
		...
		this.posX += (double)((this.random.nextFloat() - this.random.nextFloat()) * 0.05F);
		this.posY += (double)((this.random.nextFloat() - this.random.nextFloat()) * 0.05F);
		this.posZ += (double)((this.random.nextFloat() - this.random.nextFloat()) * 0.05F);
