...
public class ParticleManager implements ResourceReloadListener {
	...
	private void registerDefaultFactories() {
		...
		this.registerFactory(ParticleTypes.field_17430, CampfireSmokeParticle.class_3938::new);
		this.registerFactory(ParticleTypes.field_17431, CampfireSmokeParticle.class_3995::new);
		this.registerFactory(ParticleTypes.field_11204, CloudParticle.CloudFactory::new);
		this.registerFactory(ParticleTypes.field_17741, SuspendParticle.class_3991::new);
		this.registerFactory(ParticleTypes.field_11205, DamageParticle.class_3939::new);
		...
		this.registerFactory(ParticleTypes.field_11245, SpellParticle.InstantFactory::new);
		...
		this.registerFactory(ParticleTypes.field_11213, SpellParticle.DefaultFactory::new);
	...
	private <T extends ParticleParameters> void registerFactory(ParticleType<T> particleType, ParticleManager.class_4091<T> arg) {
	...
	private <T extends ParticleParameters> Particle createParticle(T particleParameters, double d, double e, double f, double g, double h, double i) {
		ParticleFactory<T> particleFactory = (ParticleFactory)this.factories.get(Registry.PARTICLE_TYPE.getRawId(particleParameters.getType()));
