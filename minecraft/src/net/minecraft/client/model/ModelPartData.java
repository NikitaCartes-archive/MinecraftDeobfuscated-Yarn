...
public class ModelPartData {
	...
	public ModelPart createPart(int textureWidth, int textureHeight) {
		Object2ObjectArrayMap<String, ModelPart> object2ObjectArrayMap = (Object2ObjectArrayMap)this.children
			.entrySet()
			.stream()
			.collect(
				Collectors.toMap(
		...
		List<ModelPart.Cuboid> list = (List)this.cuboidData
			.stream()
		...
		modelPart.method_42987(this.rotationData);
