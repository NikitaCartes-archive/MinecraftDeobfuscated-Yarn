...
public class RecipeBookGuiResults {
	...
	public void drawTooltip(int i, int j) {
		if (this.client.currentGui != null && this.field_3129 != null && !this.alternatesWidget.isVisible()) {
			this.client.currentGui.drawTooltip(this.field_3129.method_2644(this.client.currentGui), i, j);
		}
	}
