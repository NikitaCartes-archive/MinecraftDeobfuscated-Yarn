...
public class CartographyTableGui extends ContainerGui<CartographyTableContainer> {
	private static final Identifier TEXTURE = new Identifier("textures/gui/container/cartography_table.png");

	public CartographyTableGui(CartographyTableContainer cartographyTableContainer, PlayerInventory playerInventory, TextComponent textComponent) {
