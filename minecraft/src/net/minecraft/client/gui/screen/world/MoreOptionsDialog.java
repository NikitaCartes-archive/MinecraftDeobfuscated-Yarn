			...
			new ButtonWidget(
				...
				buttonWidget -> {
					while(this.generatorType.isPresent()) {
						int ixx = GeneratorType.VALUES.indexOf(this.generatorType.get()) + 1;
						if (ixx >= GeneratorType.VALUES.size()) {
							ixx = 0;
						}
		
						GeneratorType generatorType = (GeneratorType)GeneratorType.VALUES.get(ixx);
