			...
			new ButtonWidget(
				...
				buttonWidget -> {
					while(this.field_25049.isPresent()) {
						int ixx = class_5317.field_25052.indexOf(this.field_25049.get()) + 1;
						if (ixx >= class_5317.field_25052.size()) {
							ixx = 0;
						}
		
						class_5317 lv = (class_5317)class_5317.field_25052.get(ixx);
