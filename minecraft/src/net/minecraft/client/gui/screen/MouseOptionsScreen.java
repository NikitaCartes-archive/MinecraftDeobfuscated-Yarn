...
public class MouseOptionsScreen extends class_4667 {
	...
	protected void init() {
		...
		if (InputUtil.isRawMouseMotionSupported()) {
			this.buttonList.addAll((Option[])Stream.concat(Arrays.stream(OPTIONS), Stream.of(Option.RAW_MOUSE_INPUT)).toArray(i -> new Option[i]));
		} else {
