...
public class BeaconScreen extends HandledScreen<BeaconScreenHandler> {
	...
	protected void init() {
		...
		for(int i = 0; i <= 2; ++i) {
			...
			for(int l = 0; l < j; ++l) {
				RegistryEntry<StatusEffect> registryEntry = (RegistryEntry)((List)BeaconBlockEntity.EFFECTS_BY_LEVEL.get(i)).get(l);
		...
		RegistryEntry<StatusEffect> registryEntry2 = (RegistryEntry)((List)BeaconBlockEntity.EFFECTS_BY_LEVEL.get(0)).get(0);
