	...
	public void render(int mouseX, int mouseY, float delta) {
		...
		if (this.suggestionWindow != null) {
			...
			for(String string : this.exceptions) {
				fill(this.suggestionStartX - 1, 72 + 12 * i, this.suggestionStartX + this.suggestionWidth + 1, 84 + 12 * i, Integer.MIN_VALUE);
				this.font.drawWithShadow(string, (float)this.suggestionStartX, (float)(74 + 12 * i), -1);
				++i;
			}
		}
	}
