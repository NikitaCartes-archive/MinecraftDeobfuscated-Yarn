...
public class StructureBlockScreen extends Screen {
	...
	protected void init() {
		...
		this.buttonSave = this.addDrawableChild(
			new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, Text.translatable("structure_block.button.save"), button -> {
		...
		this.buttonLoad = this.addDrawableChild(
			new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, Text.translatable("structure_block.button.load"), button -> {
		...
		this.buttonDetect = this.addDrawableChild(
			new ButtonWidget(this.width / 2 + 4 + 100, 120, 50, 20, Text.translatable("structure_block.button.detect_size"), button -> {
				if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
