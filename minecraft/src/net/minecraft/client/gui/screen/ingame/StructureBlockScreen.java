...
public class StructureBlockScreen extends Screen {
	...
	protected void init() {
		...
		this.buttonSave = this.addDrawableChild(
			new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, Text.method_43471("structure_block.button.save"), button -> {
		...
		this.buttonLoad = this.addDrawableChild(
			new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, Text.method_43471("structure_block.button.load"), button -> {
		...
		this.addDrawableChild(
			CyclingButtonWidget.builder(value -> Text.method_43471("structure_block.mode." + value.asString()))
