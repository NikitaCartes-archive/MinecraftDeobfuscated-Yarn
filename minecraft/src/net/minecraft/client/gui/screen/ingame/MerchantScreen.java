	...
	public void render(int mouseX, int mouseY, float delta) {
		...
		if (!traderOfferList.isEmpty()) {
			...
			if (this.container.isLevelled()) {
				this.method_19413(i, j, tradeOffer);
			}

			if (tradeOffer.isDisabled() && this.isPointWithinBounds(186, 35, 22, 21, (double)mouseX, (double)mouseY) && this.container.canRefreshTrades()) {
