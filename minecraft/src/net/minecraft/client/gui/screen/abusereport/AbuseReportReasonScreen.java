...
public class AbuseReportReasonScreen extends Screen {
	...
	protected void init() {
		...
		this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 160, this.height - 32, 150, 20, ScreenTexts.DONE, buttonWidget -> {
			AbuseReportReasonScreen.ReasonListWidget.ReasonEntry reasonEntryxx = this.reasonList.getSelectedOrNull();
			if (reasonEntryxx != null) {
				this.reasonConsumer.accept(reasonEntryxx.getReason());
			}
