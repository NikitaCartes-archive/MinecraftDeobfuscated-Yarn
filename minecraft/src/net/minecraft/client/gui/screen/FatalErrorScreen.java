...
public class FatalErrorScreen extends Screen {
	...
	protected void init() {
		super.init();
		this.addButton(new ButtonWidget(this.width / 2 - 100, 140, 200, 20, I18n.translate("gui.cancel"), buttonWidget -> this.client.openScreen(null)));
	}

	@Override
	public void render(int mouseX, int mouseY, float delta) {
		this.fillGradient(0, 0, this.width, this.height, -12574688, -11530224);
		this.drawCenteredString(this.textRenderer, this.title.asFormattedString(), this.width / 2, 90, 16777215);
