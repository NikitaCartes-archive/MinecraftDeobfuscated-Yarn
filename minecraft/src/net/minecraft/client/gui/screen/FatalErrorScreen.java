...
public class FatalErrorScreen extends Screen {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		this.drawStringWithShadow(matrices, this.textRenderer, this.title, this.width / 2, 90, 16777215);
		this.drawStringWithShadow(matrices, this.textRenderer, this.message, this.width / 2, 110, 16777215);
