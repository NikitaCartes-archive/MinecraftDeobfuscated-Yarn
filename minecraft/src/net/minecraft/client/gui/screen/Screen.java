...
public abstract class Screen extends AbstractParentElement implements Drawable {
	...
	public static boolean hasControlDown() {
		if (MinecraftClient.IS_SYSTEM_MAC) {
			return InputUtil.isKeyPressed(MinecraftClient.getInstance().getWindow().getHandle(), GLFW.GLFW_KEY_LEFT_SUPER)
	...
	protected void addElementNarrations(NarrationMessageBuilder builder) {
		List<Selectable> list = (List)this.selectables.stream().filter(Selectable::isNarratable).collect(Collectors.toList());
