...
public class SoundOptionsScreen extends GameOptionsScreen {
	...
	protected void init() {
		...
		this.addDrawableChild(
			new SoundSliderWidget(this.client, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, 310)
		);
		i += 2;
		...
		this.addDrawableChild(
			new ButtonWidget(this.width / 2 - 100, this.height / 6 + 168, 200, 20, ScreenTexts.DONE, button -> this.client.openScreen(this.parent))
		);
	}
