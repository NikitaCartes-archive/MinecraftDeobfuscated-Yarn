...
public class VillagerGui extends ContainerGui<MerchantContainer> {
	...
	public VillagerGui(MerchantContainer merchantContainer, PlayerInventory playerInventory, TextComponent textComponent) {
	...
	protected void onInitialized() {
		...
		this.buttonPageNext = this.addButton(new VillagerGui.WidgetButtonPage(1, i + 120 + 27, j + 24 - 1, true) {
			...
			public void onPressed(double d, double e) {
				...
				VillagerRecipeList villagerRecipeList = VillagerGui.this.container.method_17438();
