...
public class HorseGui extends ContainerGui<HorseContainer> {
	...
	public HorseGui(HorseContainer horseContainer, PlayerInventory playerInventory, HorseBaseEntity horseBaseEntity) {
