...
public class EnchantingGui extends ContainerGui {
	...
	private final Nameable field_2903;

	public EnchantingGui(PlayerInventory playerInventory, World world, Nameable nameable) {
		super(new EnchantingTableContainer(playerInventory, world));
		this.playerInv = playerInventory;
		this.container = (EnchantingTableContainer)this.container;
		this.field_2903 = nameable;
	}

	@Override
	protected void drawForeground(int i, int j) {
		this.fontRenderer.draw(this.field_2903.getDisplayName().getFormattedText(), 12.0F, 5.0F, 4210752);
	...
	protected void drawBackground(float f, int i, int j) {
		...
		int m = (int)this.client.window.method_4495();
