...
public abstract class AbstractFurnaceGui<T extends AbstractFurnaceContainer> extends ContainerGui<T> implements RecipeBookProvider {
	...
	public AbstractFurnaceGui(
		T abstractFurnaceContainer, AbstractFurnaceRecipeBookGui abstractFurnaceRecipeBookGui, PlayerInventory playerInventory, TextComponent textComponent
	) {
