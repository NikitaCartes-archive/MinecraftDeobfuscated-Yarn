...
public class ShulkerBoxGui extends ContainerGui<ShulkerBoxContainer> {
	private static final Identifier TEXTURE = new Identifier("textures/gui/container/shulker_box.png");

	public ShulkerBoxGui(ShulkerBoxContainer shulkerBoxContainer, PlayerInventory playerInventory, TextComponent textComponent) {
