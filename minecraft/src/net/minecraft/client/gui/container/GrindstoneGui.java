...
public class GrindstoneGui extends ContainerGui<GrindstoneContainer> {
	private static final Identifier TEXTURE = new Identifier("textures/gui/container/grindstone.png");

	public GrindstoneGui(GrindstoneContainer grindstoneContainer, PlayerInventory playerInventory, TextComponent textComponent) {
