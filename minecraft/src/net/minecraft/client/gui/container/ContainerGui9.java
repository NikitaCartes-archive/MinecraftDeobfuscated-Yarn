...
public class ContainerGui9 extends ContainerGui<Generic3x3Container> {
	private static final Identifier TEXTURE = new Identifier("textures/gui/container/dispenser.png");

	public ContainerGui9(Generic3x3Container generic3x3Container, PlayerInventory playerInventory, TextComponent textComponent) {
