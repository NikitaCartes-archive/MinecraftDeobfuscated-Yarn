...
public class WrittenBookGui extends Gui {
	public static final WrittenBookGui.class_3931 EMPTY_PAGE_PROVIDER = new WrittenBookGui.class_3931() {
		@Override
	...
	private WrittenBookGui.class_3931 pageProvider;
	...
	public WrittenBookGui(WrittenBookGui.class_3931 arg) {
		this.pageProvider = arg;
	}

	public WrittenBookGui() {
		this(EMPTY_PAGE_PROVIDER);
	}

	public void setPageProvider(WrittenBookGui.class_3931 arg) {
		this.pageProvider = arg;
	...
	public interface class_3931 {
		...
		static WrittenBookGui.class_3931 method_17562(ItemStack itemStack) {
			Item item = itemStack.getItem();
			if (item == Items.field_8360) {
				return new WrittenBookGui.class_3933(itemStack);
			} else {
				return (WrittenBookGui.class_3931)(item == Items.field_8674 ? new WrittenBookGui.class_3932(itemStack) : WrittenBookGui.EMPTY_PAGE_PROVIDER);
			}
		}
	}

	@Environment(EnvType.CLIENT)
	public static class class_3932 implements WrittenBookGui.class_3931 {
		...
		private static List<String> method_17564(ItemStack itemStack) {
			...
			return (List<String>)(compoundTag != null ? WrittenBookGui.method_17555(compoundTag) : ImmutableList.of());
		}
	...
	@Environment(EnvType.CLIENT)
	public static class class_3933 implements WrittenBookGui.class_3931 {
