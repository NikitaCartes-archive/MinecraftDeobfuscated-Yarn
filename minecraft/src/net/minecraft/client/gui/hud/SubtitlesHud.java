...
public class SubtitlesHud extends DrawableHelper implements ListenerSoundInstance {
	...
	public void draw() {
		...
		if (this.enabled && !this.entries.isEmpty()) {
			...
			Vec3d vec3d = new Vec3d(
				this.client.field_1724.x, this.client.field_1724.y + (double)this.client.field_1724.getStandingEyeHeight(), this.client.field_1724.z
			);
			...
			for(SubtitlesHud.SubtitleEntry subtitleEntry : this.entries) {
				...
				drawRect(-l - 1, -n - 1, l + 1, n + 1, this.client.field_1690.method_19345(0.8F));
				GlStateManager.enableBlend();
				if (!bl) {
					if (d > 0.0) {
	...
	public void method_4884(SoundInstance soundInstance, WeightedSoundSet weightedSoundSet) {
		if (weightedSoundSet.method_4886() != null) {
			String string = weightedSoundSet.method_4886().getFormattedText();
