	...
	private void renderScoreboardSidebar(DrawContext context, ScoreboardObjective objective) {
		...
		context.draw(() -> {
			...
			for(int t = 0; t < kxx; ++t) {
				...
				int u = m - (kxx - t) * 9;
				context.drawText(this.getTextRenderer(), sidebarEntryxx.name, o, u, -1, false);
				context.drawText(this.getTextRenderer(), sidebarEntryxx.score, p - sidebarEntryxx.scoreWidth, u, -1, false);
			}
		});
	}
