...
public class PauseMenuScreen extends Screen {
	...
	protected void onInitialized() {
		...
		ButtonWidget buttonWidget = this.addButton(
			new ButtonWidget(this.width / 2 - 102, this.height / 4 + 120 + -16, 204, 20, I18n.translate("menu.returnToMenu")) {
				@Override
		...
		this.addButton(new ButtonWidget(this.width / 2 - 102, this.height / 4 + 24 + -16, 204, 20, I18n.translate("menu.returnToGame")) {
			@Override
			public void onPressed(double d, double e) {
		...
		this.addButton(new ButtonWidget(this.width / 2 - 102, this.height / 4 + 96 + -16, 98, 20, I18n.translate("menu.options")) {
			@Override
			public void onPressed(double d, double e) {
				PauseMenuScreen.this.client.openScreen(new SettingsScreen(PauseMenuScreen.this, PauseMenuScreen.this.client.options));
			}
		});
		ButtonWidget buttonWidget2 = this.addButton(new ButtonWidget(this.width / 2 + 4, this.height / 4 + 96 + -16, 98, 20, I18n.translate("menu.shareToLan")) {
			@Override
			public void onPressed(double d, double e) {
		...
		this.addButton(new ButtonWidget(this.width / 2 - 102, this.height / 4 + 48 + -16, 98, 20, I18n.translate("gui.advancements")) {
			@Override
			public void onPressed(double d, double e) {
		...
		this.addButton(new ButtonWidget(this.width / 2 + 4, this.height / 4 + 48 + -16, 98, 20, I18n.translate("gui.stats")) {
			@Override
			public void onPressed(double d, double e) {
				PauseMenuScreen.this.client.openScreen(new StatsScreen(PauseMenuScreen.this, PauseMenuScreen.this.client.player.getStats()));
			}
		});
		this.addButton(new ButtonWidget(this.width / 2 - 102, this.height / 4 + 72 + -16, 98, 20, I18n.translate("menu.sendFeedback")) {
			@Override
			public void onPressed(double d, double e) {
		...
		this.addButton(new ButtonWidget(this.width / 2 + 4, this.height / 4 + 72 + -16, 98, 20, I18n.translate("menu.reportBugs")) {
			@Override
			public void onPressed(double d, double e) {
				PauseMenuScreen.this.client.openScreen(new ConfirmChatLinkScreen((bl, i) -> {
					if (bl) {
