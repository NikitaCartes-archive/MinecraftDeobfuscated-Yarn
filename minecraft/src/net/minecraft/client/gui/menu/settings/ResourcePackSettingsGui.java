...
public class ResourcePackSettingsGui extends Gui {
	private final Gui parent;
	private class_522 field_3157;
	private class_523 field_3154;
	private boolean field_3155;

	public ResourcePackSettingsGui(Gui gui) {
		this.parent = gui;
	}
	...
	protected void onInitialized() {
		this.addButton(new OptionButtonWidget(2, this.width / 2 - 154, this.height - 48, I18n.translate("resourcePack.openFolder")) {
			...
			public void onPressed(double d, double e) {
				SystemUtil.getOperatingSystem().open(ResourcePackSettingsGui.this.client.method_1479());
			}
		});
		this.addButton(new OptionButtonWidget(1, this.width / 2 + 4, this.height - 48, I18n.translate("gui.done")) {
			...
			public void onPressed(double d, double e) {
				if (ResourcePackSettingsGui.this.field_3155) {
					...
					ResourcePackSettingsGui.this.client.method_1520().setEnabled(list);
				...
				ResourcePackSettingsGui.this.client.openGui(ResourcePackSettingsGui.this.parent);
			}
		});
