...
public class SnooperSettingsGui extends Gui {
	...
	private final List<String> field_2569 = Lists.newArrayList();
	private final List<String> field_2567 = Lists.newArrayList();
	...
	class class_439 extends AbstractListWidget {
		public class_439() {
			super(SnooperSettingsGui.this.client, SnooperSettingsGui.this.width, SnooperSettingsGui.this.height, 80, SnooperSettingsGui.this.height - 40, 9 + 1);
		}
