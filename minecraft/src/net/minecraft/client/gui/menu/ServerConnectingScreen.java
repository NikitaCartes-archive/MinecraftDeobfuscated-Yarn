		...
		Thread thread = new Thread("Server Connector #" + field_2408.incrementAndGet()) {
			public void run() {
				...
				try {
					...
					ServerConnectingScreen.this.field_2411 = ClientConnection.connect(
						inetAddress, i, ServerConnectingScreen.this.client.field_1690.shouldUseNativeTransport()
					);
					...
					ServerConnectingScreen.LOGGER.error("Couldn't connect to server", var4);
					ServerConnectingScreen.this.client
						.execute(
							() -> ServerConnectingScreen.this.client
									.method_1507(
					...
					ServerConnectingScreen.LOGGER.error("Couldn't connect to server", var5);
					String stringx = inetAddress == null ? var5.toString() : var5.toString().replaceAll(inetAddress + ":" + i, "");
					ServerConnectingScreen.this.client
						.execute(
							() -> ServerConnectingScreen.this.client
									.method_1507(
