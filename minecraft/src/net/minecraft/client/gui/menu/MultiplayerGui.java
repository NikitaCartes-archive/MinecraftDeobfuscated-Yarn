...
public class MultiplayerGui extends Gui {
	...
	public void method_2540() {
				...
				public void onPressed(double d, double e) {
					...
					if (entry instanceof RemoteServerListEntry) {
						...
						if (string != null) {
							...
							YesNoGui yesNoGui = new YesNoGui(MultiplayerGui.this, string2, string3, string4, string5, MultiplayerGui.this.field_3043.getIndex());
							MultiplayerGui.this.client.openGui(yesNoGui);
						}
					}
				}
			}
		...
		this.field_3050 = this.addButton(new ButtonWidget(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.translate("selectServer.select")) {
			@Override
			public void onPressed(double d, double e) {
				MultiplayerGui.this.method_2536();
			}
		});
		this.addButton(new ButtonWidget(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.translate("selectServer.direct")) {
			@Override
			public void onPressed(double d, double e) {
				MultiplayerGui.this.field_3035 = true;
				MultiplayerGui.this.field_3051 = new ServerEntry(I18n.translate("selectServer.defaultName"), "", false);
				MultiplayerGui.this.client.openGui(new DirectConnectServerGui(MultiplayerGui.this, MultiplayerGui.this.field_3051));
			}
		});
		this.addButton(new ButtonWidget(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.translate("selectServer.add")) {
			@Override
			public void onPressed(double d, double e) {
				MultiplayerGui.this.field_3038 = true;
				MultiplayerGui.this.field_3051 = new ServerEntry(I18n.translate("selectServer.defaultName"), "", false);
				MultiplayerGui.this.client.openGui(new AddServerGui(MultiplayerGui.this, MultiplayerGui.this.field_3051));
			}
		});
	...
	private void method_2534() {
		this.client.openGui(new MultiplayerGui(this.parent));
	}
	...
	private void method_2548(ServerEntry serverEntry) {
		this.client.openGui(new ServerConnectingGui(this, this.client, serverEntry));
	}
