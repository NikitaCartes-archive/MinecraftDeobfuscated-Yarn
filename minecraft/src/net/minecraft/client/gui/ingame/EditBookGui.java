...
public class EditBookGui extends Gui {
	...
	private void method_2430(String string) {
		if (!string.isEmpty()) {
			...
			if (lv.field_2853 == 0) {
				...
				int i = this.method_2404(string, new EditBookGui.class_475(lv.field_2854 + this.method_2412(string, this.field_2833) / 3, lv.field_2853 - 9));
				if (i >= 0) {
					this.field_2833 = i;
					if (!Gui.isShiftPressed()) {
						this.field_2829 = this.field_2833;
	...
	private void method_2435(String string) {
		if (!string.isEmpty()) {
			...
			if (lv.field_2853 + 9 == i) {
				...
				int j = this.method_2404(string, new EditBookGui.class_475(lv.field_2854 + this.method_2412(string, this.field_2833) / 3, lv.field_2853 + 9));
				if (j >= 0) {
					this.field_2833 = j;
					if (!Gui.isShiftPressed()) {
						this.field_2829 = this.field_2833;
	...
	public void draw(int i, int j, float f) {
		...
		this.client.getTextureManager().bindTexture(WrittenBookGui.BOOK_TEXTURE);
		...
		if (this.field_2828) {
			...
			if (this.field_2844 / 6 % 2 == 0) {
				...
				if (this.field_2833 < string2.length()) {
					Drawable.drawRect(lv.field_2854, lv.field_2853 - 1, lv.field_2854 + 1, lv.field_2853 + 9, -16777216);
				} else {
	...
	private void method_2441(String string) {
		if (this.field_2829 != this.field_2833) {
			...
			EditBookGui.class_475 lv2 = new EditBookGui.class_475(lv.field_2854, lv.field_2853 + 9);
