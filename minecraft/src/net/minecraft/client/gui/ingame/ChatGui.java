...
public class ChatGui extends Gui {
	...
	class class_409 {
		...
		public boolean method_2117(double d) {
			int i = (int)(ChatGui.this.client.mouse.getX() * (double)ChatGui.this.client.window.getScaledWidth() / (double)ChatGui.this.client.window.getWidth());
			int j = (int)(ChatGui.this.client.mouse.getY() * (double)ChatGui.this.client.window.getScaledHeight() / (double)ChatGui.this.client.window.getHeight());
			if (this.field_2396.method_3318(i, j)) {
