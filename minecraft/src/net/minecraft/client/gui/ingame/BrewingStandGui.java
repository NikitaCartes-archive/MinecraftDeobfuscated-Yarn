...
public class BrewingStandGui extends ContainerGui<BrewingStandContainer> {
	...
	public BrewingStandGui(BrewingStandContainer brewingStandContainer, PlayerInventory playerInventory, TextComponent textComponent) {
