...
public class PlayerInventoryGui extends AbstractPlayerInventoryGui<PlayerContainer> implements RecipeBookProvider {
			...
			this.addButton(
				new RecipeBookButtonWidget(10, this.left + 104, this.height / 2 - 22, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEX) {
					...
					public void onPressed(double d, double e) {
						PlayerInventoryGui.this.recipeBook.reset(PlayerInventoryGui.this.isNarrow);
						PlayerInventoryGui.this.recipeBook.toggleOpen();
						PlayerInventoryGui.this.left = PlayerInventoryGui.this.recipeBook
