...
public class PlayerInventoryGui extends AbstractPlayerInventoryGui implements RecipeBookProvider {
	...
	public PlayerInventoryGui(PlayerEntity playerEntity) {
	...
	public void update() {
		if (this.client.interactionManager.hasCreativeInventory()) {
			this.client.openGui(new CreativePlayerInventoryGui(this.client.player));
		} else {
	...
	protected void onInitialized() {
		if (this.client.interactionManager.hasCreativeInventory()) {
			...
			this.field_2929.initialize(this.width, this.height, this.client, this.isNarrow, (CraftingContainer)this.container);
			this.isOpen = true;
			...
			this.addButton(
				new RecipeBookButtonWidget(10, this.left + 104, this.height / 2 - 22, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEX) {
					...
					public void onPressed(double d, double e) {
						PlayerInventoryGui.this.field_2929.reset(PlayerInventoryGui.this.isNarrow);
						PlayerInventoryGui.this.field_2929.toggleOpen();
						PlayerInventoryGui.this.left = PlayerInventoryGui.this.field_2929
							.findLeftEdge(PlayerInventoryGui.this.isNarrow, PlayerInventoryGui.this.width, PlayerInventoryGui.this.containerWidth);
						this.setPos(PlayerInventoryGui.this.left + 104, PlayerInventoryGui.this.height / 2 - 22);
						PlayerInventoryGui.this.isMouseDown = true;
					}
				}
			);
		}
