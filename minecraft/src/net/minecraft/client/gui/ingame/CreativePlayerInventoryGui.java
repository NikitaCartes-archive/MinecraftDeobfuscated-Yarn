...
public class CreativePlayerInventoryGui extends AbstractPlayerInventoryGui<CreativePlayerInventoryGui.CreativeContainer> {
	...
	public CreativePlayerInventoryGui(PlayerEntity playerEntity) {
		super(new CreativePlayerInventoryGui.CreativeContainer(playerEntity), playerEntity.inventory, new StringTextComponent(""));
			...
			if (slot == this.deleteItemSlot && bl) {
				...
				if (slot == this.deleteItemSlot) {
					...
					this.client
						.player
						.containerPlayer
						.onSlotClick(slot == null ? i : ((CreativePlayerInventoryGui.CreativeSlot)slot).slot.id, j, slotActionType, this.client.player);
	...
	public static class CreativeContainer extends Container {
		...
		public boolean method_7613(ItemStack itemStack, Slot slot) {
			return slot.inventory != CreativePlayerInventoryGui.inventory;
		}
