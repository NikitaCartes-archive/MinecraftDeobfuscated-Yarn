...
public abstract class AbstractPlayerInventoryGui<T extends Container> extends ContainerGui<T> {
	protected boolean offsetGuiForEffects;

	public AbstractPlayerInventoryGui(T container, PlayerInventory playerInventory, TextComponent textComponent) {
