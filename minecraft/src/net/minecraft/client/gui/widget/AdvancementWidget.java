...
public class AdvancementWidget extends DrawableHelper {
	...
	public void method_2325(int i, int j) {
		if (!this.display.isHidden() || this.field_2714 != null && this.field_2714.isDone()) {
			...
			if (f >= 1.0F) {
				achievementObtainedStatus = AchievementObtainedStatus.field_2701;
			} else {
				achievementObtainedStatus = AchievementObtainedStatus.field_2699;
			}

			this.client.getTextureManager().bindTexture(WIDGETS_TEX);
			GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
			GlStateManager.enableBlend();
			this.drawTexturedRect(i + this.xPos + 3, j + this.yPos, this.display.getFrame().texV(), 128 + achievementObtainedStatus.getSpriteIndex() * 26, 26, 26);
	...
	public void method_2331(int i, int j, float f, int k, int l) {
		...
		if (g >= 1.0F) {
			n = this.field_2715 / 2;
			achievementObtainedStatus = AchievementObtainedStatus.field_2701;
			achievementObtainedStatus2 = AchievementObtainedStatus.field_2701;
			achievementObtainedStatus3 = AchievementObtainedStatus.field_2701;
		} else if (n < 2) {
			n = this.field_2715 / 2;
			achievementObtainedStatus = AchievementObtainedStatus.field_2699;
			achievementObtainedStatus2 = AchievementObtainedStatus.field_2699;
			achievementObtainedStatus3 = AchievementObtainedStatus.field_2699;
		...
		this.drawTexturedRect(q, p, 0, achievementObtainedStatus.getSpriteIndex() * 26, n, 26);
		this.drawTexturedRect(q + n, p, 200 - o, achievementObtainedStatus2.getSpriteIndex() * 26, o, 26);
		this.drawTexturedRect(i + this.xPos + 3, j + this.yPos, this.display.getFrame().texV(), 128 + achievementObtainedStatus3.getSpriteIndex() * 26, 26, 26);
		if (bl) {
