...
public class ItemPickupAnimationClientPacket implements Packet<ClientPlayPacketListener> {
	private int entityId;
	private int collectorEntityId;
	private int stackAmount;

	public ItemPickupAnimationClientPacket() {
	}

	public ItemPickupAnimationClientPacket(int i, int j, int k) {
		this.entityId = i;
