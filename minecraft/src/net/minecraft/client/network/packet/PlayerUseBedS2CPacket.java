...
public class PlayerUseBedS2CPacket implements Packet<ClientPlayPacketListener> {
	private int entityId;
	private BlockPos bedHeadPos;

	public PlayerUseBedS2CPacket() {
	}

	public PlayerUseBedS2CPacket(PlayerEntity playerEntity, BlockPos blockPos) {
