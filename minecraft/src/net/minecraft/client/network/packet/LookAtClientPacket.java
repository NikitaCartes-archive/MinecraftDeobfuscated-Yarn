...
public class LookAtClientPacket implements Packet<ClientPlayPacketListener> {
	...
	public LookAtClientPacket() {
	}

	public LookAtClientPacket(EntityAnchorArgumentType.EntityAnchor entityAnchor, double d, double e, double f) {
	...
	public LookAtClientPacket(EntityAnchorArgumentType.EntityAnchor entityAnchor, Entity entity, EntityAnchorArgumentType.EntityAnchor entityAnchor2) {
		this.selfAnchor = entityAnchor;
