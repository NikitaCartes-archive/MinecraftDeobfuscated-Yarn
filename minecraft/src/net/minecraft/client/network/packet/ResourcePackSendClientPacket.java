...
public class ResourcePackSendClientPacket implements Packet<ClientPlayPacketListener> {
	private String url;
	private String hash;

	public ResourcePackSendClientPacket() {
	}

	public ResourcePackSendClientPacket(String string, String string2) {
		this.url = string;
		this.hash = string2;
