...
public class PlaySoundFromEntityClientPacket implements Packet<ClientPlayPacketListener> {
	...
	public PlaySoundFromEntityClientPacket() {
	}

	public PlaySoundFromEntityClientPacket(SoundEvent soundEvent, SoundCategory soundCategory, Entity entity, float f, float g) {
