...
public class PlaySoundClientPacket implements Packet<ClientPlayPacketListener> {
	...
	public PlaySoundClientPacket() {
	}

	public PlaySoundClientPacket(SoundEvent soundEvent, SoundCategory soundCategory, double d, double e, double f, float g, float h) {
