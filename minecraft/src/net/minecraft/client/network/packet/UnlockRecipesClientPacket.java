...
public class UnlockRecipesClientPacket implements Packet<ClientPlayPacketListener> {
	private UnlockRecipesClientPacket.Action action;
	...
	public UnlockRecipesClientPacket(
		UnlockRecipesClientPacket.Action action,
	...
	public void read(PacketByteBuf packetByteBuf) throws IOException {
		this.action = packetByteBuf.readEnumConstant(UnlockRecipesClientPacket.Action.class);
		...
		if (this.action == UnlockRecipesClientPacket.Action.field_12416) {
	...
	@Environment(EnvType.CLIENT)
	public UnlockRecipesClientPacket.Action getAction() {
		return this.action;
	}
