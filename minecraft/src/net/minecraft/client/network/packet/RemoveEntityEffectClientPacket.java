...
public class RemoveEntityEffectClientPacket implements Packet<ClientPlayPacketListener> {
	private int entityId;
	private StatusEffect effectType;

	public RemoveEntityEffectClientPacket() {
	}

	public RemoveEntityEffectClientPacket(int i, StatusEffect statusEffect) {
		this.entityId = i;
