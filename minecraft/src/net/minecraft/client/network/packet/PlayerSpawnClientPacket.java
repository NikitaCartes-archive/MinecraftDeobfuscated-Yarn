...
public class PlayerSpawnClientPacket implements Packet<ClientPlayPacketListener> {
	private int id;
	private UUID uuid;
	private double x;
	private double y;
	...
	public PlayerSpawnClientPacket() {
	}

	public PlayerSpawnClientPacket(PlayerEntity playerEntity) {
