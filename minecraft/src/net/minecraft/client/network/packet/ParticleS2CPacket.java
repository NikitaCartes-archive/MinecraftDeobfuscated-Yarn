...
public class ParticleS2CPacket implements Packet<ClientPlayPacketListener> {
	...
	public <T extends ParticleParameters> ParticleS2CPacket(
	...
	public void read(PacketByteBuf packetByteBuf) throws IOException {
		...
		this.field_12259 = this.method_11542(packetByteBuf, particleType);
	}
	...
	public void write(PacketByteBuf packetByteBuf) throws IOException {
		packetByteBuf.writeInt(Registry.PARTICLE_TYPE.getRawId(this.field_12259.method_10295()));
