...
public class EntityPotionEffectClientPacket implements Packet<ClientPlayPacketListener> {
	...
	public EntityPotionEffectClientPacket() {
	}

	public EntityPotionEffectClientPacket(int i, StatusEffectInstance statusEffectInstance) {
		this.field_12727 = i;
