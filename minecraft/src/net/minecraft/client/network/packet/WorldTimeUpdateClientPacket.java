...
public class WorldTimeUpdateClientPacket implements Packet<ClientPlayPacketListener> {
	private long time;
	private long timeOfDay;

	public WorldTimeUpdateClientPacket() {
	}

	public WorldTimeUpdateClientPacket(long l, long m, boolean bl) {
		this.time = l;
		this.timeOfDay = m;
		if (!bl) {
