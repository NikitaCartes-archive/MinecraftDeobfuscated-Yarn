...
public class CraftResponseClientPacket implements Packet<ClientPlayPacketListener> {
	private int syncId;
	private Identifier recipeId;

	public CraftResponseClientPacket() {
	}

	public CraftResponseClientPacket(int i, Recipe recipe) {
		this.syncId = i;
