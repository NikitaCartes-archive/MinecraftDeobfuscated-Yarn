...
public class WorldBorderClientPacket implements Packet<ClientPlayPacketListener> {
	private WorldBorderClientPacket.Type type;
	...
	public WorldBorderClientPacket() {
	}

	public WorldBorderClientPacket(WorldBorder worldBorder, WorldBorderClientPacket.Type type) {
		this.type = type;
	...
	public void read(PacketByteBuf packetByteBuf) throws IOException {
		this.type = packetByteBuf.readEnumConstant(WorldBorderClientPacket.Type.class);
		switch (this.type) {
			case SET_SIZE:
	...
	public void apply(WorldBorder worldBorder) {
		switch (this.type) {
			case SET_SIZE:
				...
				break;
			case INTERPOLATE_SIZE:
				worldBorder.method_11957(this.oldSize, this.size, this.interpolationDuration);
				break;
			case SET_CENTER:
