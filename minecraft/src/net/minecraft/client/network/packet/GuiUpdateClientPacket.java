...
public class GuiUpdateClientPacket implements Packet<ClientPlayPacketListener> {
	private int id;
	private int propertyId;
	private int value;

	public GuiUpdateClientPacket() {
	}

	public GuiUpdateClientPacket(int i, int j, int k) {
		this.id = i;
		this.propertyId = j;
		this.value = k;
	}
