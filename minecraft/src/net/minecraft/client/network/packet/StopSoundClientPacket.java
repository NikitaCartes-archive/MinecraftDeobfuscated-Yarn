...
public class StopSoundClientPacket implements Packet<ClientPlayPacketListener> {
	private Identifier soundId;
	private SoundCategory category;

	public StopSoundClientPacket() {
	}

	public StopSoundClientPacket(@Nullable Identifier identifier, @Nullable SoundCategory soundCategory) {
