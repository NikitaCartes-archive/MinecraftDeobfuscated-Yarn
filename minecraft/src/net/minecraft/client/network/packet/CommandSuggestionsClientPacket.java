...
public class CommandSuggestionsClientPacket implements Packet<ClientPlayPacketListener> {
	private int field_12122;
	private Suggestions suggestions;

	public CommandSuggestionsClientPacket() {
	}

	public CommandSuggestionsClientPacket(int i, Suggestions suggestions) {
		this.field_12122 = i;
