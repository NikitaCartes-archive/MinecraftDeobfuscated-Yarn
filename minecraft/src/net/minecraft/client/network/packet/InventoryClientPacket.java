...
public class InventoryClientPacket implements Packet<ClientPlayPacketListener> {
	private int guiId;
	private List<ItemStack> slotStackList;

	public InventoryClientPacket() {
	}

	public InventoryClientPacket(int i, DefaultedList<ItemStack> defaultedList) {
		this.guiId = i;
