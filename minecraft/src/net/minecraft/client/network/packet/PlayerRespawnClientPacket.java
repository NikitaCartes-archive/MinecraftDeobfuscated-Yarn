...
public class PlayerRespawnClientPacket implements Packet<ClientPlayPacketListener> {
	private DimensionType dimension;
	private Difficulty difficulty;
	private GameMode gameMode;
	private LevelGeneratorType generatorType;

	public PlayerRespawnClientPacket() {
	}

	public PlayerRespawnClientPacket(DimensionType dimensionType, Difficulty difficulty, LevelGeneratorType levelGeneratorType, GameMode gameMode) {
