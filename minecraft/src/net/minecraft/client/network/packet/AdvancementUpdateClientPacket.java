...
public class AdvancementUpdateClientPacket implements Packet<ClientPlayPacketListener> {
	...
	public AdvancementUpdateClientPacket() {
	}

	public AdvancementUpdateClientPacket(boolean bl, Collection<SimpleAdvancement> collection, Set<Identifier> set, Map<Identifier, AdvancementProgress> map) {
