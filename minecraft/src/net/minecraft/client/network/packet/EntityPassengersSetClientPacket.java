...
public class EntityPassengersSetClientPacket implements Packet<ClientPlayPacketListener> {
	private int id;
	private int[] passengerIds;

	public EntityPassengersSetClientPacket() {
	}

	public EntityPassengersSetClientPacket(Entity entity) {
