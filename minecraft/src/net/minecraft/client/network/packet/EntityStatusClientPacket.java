...
public class EntityStatusClientPacket implements Packet<ClientPlayPacketListener> {
	private int id;
	private byte status;

	public EntityStatusClientPacket() {
	}

	public EntityStatusClientPacket(Entity entity, byte b) {
