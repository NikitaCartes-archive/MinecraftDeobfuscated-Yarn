...
public class ClientPlayerInteractionManager {
	...
	public boolean breakBlock(BlockPos blockPos) {
		if (this.gameMode.shouldLimitWorldModification()) {
			...
			if (!this.client.player.canModifyWorld()) {
				...
				if (!itemStack.getCustomCanHarvest(this.client.world.getTagManager(), blockProxy)) {
					return false;
				}
			}
		}
	...
	public ActionResult method_2896(
	...
	public ActionResult interactEntityAtLocation(PlayerEntity playerEntity, Entity entity, HitResult hitResult, Hand hand) {
		this.syncSelectedSlot();
