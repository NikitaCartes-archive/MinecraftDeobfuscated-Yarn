...
public class ClientPlayNetworkHandler implements ClientPlayPacketListener {
	...
	public void onExplosion(ExplosionS2CPacket explosionS2CPacket) {
		...
		this.client.player.velocityX += (double)explosionS2CPacket.getPlayerVelocityX();
		this.client.player.velocityY += (double)explosionS2CPacket.getPlayerVelocityY();
		this.client.player.velocityZ += (double)explosionS2CPacket.getPlayerVelocityZ();
	}
