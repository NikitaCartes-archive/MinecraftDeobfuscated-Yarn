...
public class PlayerListEntry {
	...
	private static CompletableFuture<SkinTextures> fetchSkinTextures(
		GameProfile profiles, PlayerSkinProvider skinProvider, MinecraftSessionService sessionService
	) {
