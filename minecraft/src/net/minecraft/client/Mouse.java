...
public class Mouse {
	...
	private final SmoothUtil field_1793 = new SmoothUtil();
	private final SmoothUtil field_1782 = new SmoothUtil();
	...
	private void onMouseButton(long l, int i, int j, int k) {
		if (l == this.client.window.getHandle()) {
			...
			if (!bls[0] && (this.client.field_1755 == null || this.client.field_1755.field_2558) && this.client.field_18175 == null) {
				if (m == 0) {
					this.field_1791 = bl;
				} else if (m == 2) {
					this.field_1790 = bl;
				...
				if (bl) {
					if (this.client.field_1724.isSpectator() && m == 2) {
						this.client.field_1705.method_1739().method_1983();
					} else {
			...
			if (this.client.field_18175 == null) {
				if (this.client.field_1755 != null) {
					...
					if (this.client.field_1724.isSpectator()) {
						if (this.client.field_1705.method_1739().method_1980()) {
							this.client.field_1705.method_1739().method_1976((double)(-i));
						} else {
							float j = MathHelper.clamp(this.client.field_1724.abilities.getFlySpeed() + i * 0.005F, 0.0F, 0.2F);
							this.client.field_1724.abilities.setFlySpeed(j);
						}
					} else {
						this.client.field_1724.inventory.method_7373((double)i);
					}
				}
			}
		}
	...
	private void onCursorPos(long l, double d, double e) {
		if (l == MinecraftClient.getInstance().window.getHandle()) {
			...
			InputListener inputListener = this.client.field_1755;
	...
	public void updateMouse() {
		...
		if (this.isCursorLocked() && this.client.isWindowFocused()) {
			...
			if (this.client.field_1690.smoothCameraEnabled) {
				double h = this.field_1793.smooth(this.cursorDeltaX * g, e * g);
				double i = this.field_1782.smooth(this.cursorDeltaY * g, e * g);
				j = h;
				k = i;
			} else {
			...
			this.client.method_1577().method_4908(j, k);
			if (this.client.field_1724 != null) {
				this.client.field_1724.method_5872(j, k * (double)l);
			}
		} else {
			this.cursorDeltaX = 0.0;
			this.cursorDeltaY = 0.0;
