...
public class RealmsGetServerDetailsTask extends LongRunningTask {
	...
	public void run() {
		...
		try {
					...
					setScreen(
						(Screen)(bl
							...
							: new RealmsGenericErrorScreen(
								Text.method_43471("mco.brokenworld.nonowner.title"), Text.method_43471("mco.brokenworld.nonowner.error"), this.lastScreen
							))
					);
					return;
				default:
					this.error(var5.toString());
					field_36356.error("Couldn't connect to world", var5);
					return;
			}
			...
			field_36356.error("Couldn't connect to world", var7);
