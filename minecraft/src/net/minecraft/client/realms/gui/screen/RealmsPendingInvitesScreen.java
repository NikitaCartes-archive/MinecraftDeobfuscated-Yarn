...
public class RealmsPendingInvitesScreen extends RealmsScreen {
	...
	public void init() {
		...
		(new Thread("Realms-pending-invitations-fetcher") {
				public void run() {
					...
					try {
						...
						List<RealmsPendingInvitesScreen.PendingInvitationSelectionListEntry> list2 = (List)list.stream()
		...
		this.addButton(
			new ButtonWidget(
				this.width / 2 - 50, this.height - 32, 100, 20, ScreenTexts.DONE, buttonWidget -> this.client.openScreen(new RealmsMainScreen(this.parent))
			)
		);
