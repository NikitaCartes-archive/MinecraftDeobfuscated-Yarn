...
public class Main {
	...
	public static void main(String[] args) {
		...
		String string6 = optionSet.has(optionSpec14)
			? (String)optionSpec14.value(optionSet)
			: Uuids.getOfflinePlayerUuid((String)optionSpec13.value(optionSet)).toString();
		...
		Session session = new Session(
			(String)optionSpec13.value(optionSet), string6, (String)optionSpec17.value(optionSet), toOptional(string8), toOptional(string9), accountType
		);
