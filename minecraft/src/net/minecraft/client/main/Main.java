...
public class Main {
	...
	public static void main(String[] strings) {
		...
		String string6 = optionSet.has(optionSpec11)
			...
			: class_1657.method_7310((String)optionSpec10.value(optionSet)).toString();
		...
		class_320 lv = new class_320((String)optionSpec10.value(optionSet), string6, (String)optionSpec12.value(optionSet), (String)optionSpec21.value(optionSet));
