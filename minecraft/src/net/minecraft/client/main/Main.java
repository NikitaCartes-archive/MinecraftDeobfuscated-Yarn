...
public class Main {
	...
	public static void main(String[] args) {
		...
		String string6 = optionSet.has(optionSpec12)
			...
			: DynamicSerializableUuid.getOfflinePlayerUuid((String)optionSpec11.value(optionSet)).toString();
		...
		Session session = new Session(
			(String)optionSpec11.value(optionSet), string6, (String)optionSpec15.value(optionSet), toOptional(string8), toOptional(string9), accountType
		);
