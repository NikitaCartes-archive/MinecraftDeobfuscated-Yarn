...
public class CyclingOption<T> extends Option {
	...
	public static CyclingOption<Boolean> create(
		String key, Text text, Text text2, Function<GameOptions, Boolean> getter, CyclingOption.class_5675<Boolean> setter
	) {
	...
	public AbstractButtonWidget createButton(GameOptions options, int x, int y, int width) {
		CyclingButtonWidget.class_5679<T> lv = (CyclingButtonWidget.class_5679)this.field_27955.apply(MinecraftClient.getInstance());
