...
public class BlockColors {
	...
	public static BlockColors create() {
		...
		blockColors.register(
			(blockState, extendedBlockView, blockPos, i) -> RedstoneWireBlock.getWireColor(blockState.method_11654(RedstoneWireBlock.field_11432)), Blocks.field_10091
		);
		blockColors.register(
		...
		blockColors.register((blockState, extendedBlockView, blockPos, i) -> {
			int j = blockState.method_11654(StemBlock.field_11584);
			int k = j * 32;
			int l = 255 - j * 8;
			int m = j * 4;
			return k << 16 | l << 8 | m;
