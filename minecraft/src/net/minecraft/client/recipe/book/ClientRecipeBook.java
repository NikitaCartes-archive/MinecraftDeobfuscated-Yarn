...
public class ClientRecipeBook extends RecipeBook {
	...
	private final Map<RecipeBookGroup, List<class_516>> field_1638 = Maps.newHashMap();
	...
	public static List<RecipeBookGroup> method_1395(Container container) {
		if (container instanceof CraftingTableContainer || container instanceof PlayerContainer) {
			...
			return container instanceof FurnaceContainer
				? Lists.newArrayList(RecipeBookGroup.field_1804, RecipeBookGroup.field_1808, RecipeBookGroup.field_1811, RecipeBookGroup.field_1812)
				: Lists.newArrayList();
		}
	}
