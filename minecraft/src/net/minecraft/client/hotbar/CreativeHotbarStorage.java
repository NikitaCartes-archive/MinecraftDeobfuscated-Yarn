package net.minecraft.client.hotbar;
...
public class CreativeHotbarStorage {
	...
	public CreativeHotbarStorage(File file, DataFixer dataFixer) {
		this.file = new File(file, "hotbar.nbt");
		this.dataFixer = dataFixer;

		for (int i = 0; i < 9; i++) {
			this.entries[i] = new HotbarEntry();
		}
	}
	...
	public HotbarEntry getSavedHotbar(int i) {
		if (!this.loaded) {
			this.load();
			this.loaded = true;
		}
