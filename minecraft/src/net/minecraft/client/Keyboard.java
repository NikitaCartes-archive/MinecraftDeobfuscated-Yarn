		...
		if (this.debugCrashStartTime > 0L && this.debugCrashStartTime < SystemUtil.getMeasuringTimeMs() - 100L) {
			...
			switch (i) {
				...
				default:
					return false;
				case 70:
					this.client.field_1690.updateOption(GameOptions.Option.RENDER_DISTANCE, Gui.isShiftPressed() ? -1 : 1);
					this.debugWarn("debug.cycle_renderdistance.message", this.client.field_1690.viewDistance);
					return true;
				case 71:
					...
					return true;
				case 72:
					this.client.field_1690.advancedItemTooltips = !this.client.field_1690.advancedItemTooltips;
					this.debugWarn(this.client.field_1690.advancedItemTooltips ? "debug.advanced_tooltips.on" : "debug.advanced_tooltips.off");
				...
				case 78:
					...
					return true;
				case 80:
					this.client.field_1690.pauseOnLostFocus = !this.client.field_1690.pauseOnLostFocus;
					this.client.field_1690.write();
					this.debugWarn(this.client.field_1690.pauseOnLostFocus ? "debug.pause_focus.on" : "debug.pause_focus.off");
					return true;
				case 81:
	...
	public void onKey(long l, int i, int j, int k, int m) {
		if (l == this.client.window.getHandle()) {
			...
			if (k == 1
			 ...
			 {
				if (this.client.field_1690.keyFullscreen.matchesKey(i, j)) {
					this.client.window.toggleFullscreen();
					this.client.field_1690.fullscreen = this.client.window.isFullscreen();
					return;
				}

				if (this.client.field_1690.keyScreenshot.matchesKey(i, j)) {
				...
				if (k == 0) {
					...
					if (i == 292) {
						if (this.switchF3State) {
							...
							this.client.field_1690.debugEnabled = !this.client.field_1690.debugEnabled;
							this.client.field_1690.debugProfilerEnabled = this.client.field_1690.debugEnabled && Gui.isShiftPressed();
							this.client.field_1690.debugTpsEnabled = this.client.field_1690.debugEnabled && Gui.isAltPressed();
						}
					}
				} else {
					if (i == 66 && Gui.isControlPressed()) {
						this.client.field_1690.updateOption(GameOptions.Option.NARRATOR, 1);
						if (guiEventListener instanceof ChatSettingsGui) {
							((ChatSettingsGui)guiEventListener).method_2096();
						}
					}

					if (i == 293 && this.client.field_1773 != null) {
						this.client.field_1773.method_3184();
					}
					...
					if (this.client.currentGui == null) {
						...
						if (i == 290) {
							this.client.field_1690.field_1842 = !this.client.field_1690.field_1842;
						}
					}
					...
					if (this.client.field_1690.debugProfilerEnabled) {
						if (i == 48) {
