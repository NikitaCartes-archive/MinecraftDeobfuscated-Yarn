...
public class CheatCodes {
	...
	public static final String[] ALL_CHEATS = new String[]{
		"POWEROVERWHELMING", "PIGSONTHEWING", "FLASHAAAAA", "MOREDAKKA", "IDKFA", "COWSCOWSCOWS", "HOWDOYOUTURNTHISON", "NEEEERD"
	};
	public static final int MAX_CHEAT_LEN = Stream.of(ALL_CHEATS).mapToInt(String::length).reduce(0, Math::max);
}
