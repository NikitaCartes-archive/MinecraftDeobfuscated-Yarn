...
public class SafeWorldView implements ExtendedBlockView {
	...
	public static SafeWorldView create(World world, BlockPos blockPos, BlockPos blockPos2, int i) {
		...
		if (bl) {
			...
			return new SafeWorldView(world, j, k, worldChunks, blockPos3, blockPos4);
		}
	}

	public SafeWorldView(World world, int i, int j, WorldChunk[][] worldChunks, BlockPos blockPos, BlockPos blockPos2) {
		this.world = world;
		this.chunkXOffset = i;
		this.chunkZOffset = j;
