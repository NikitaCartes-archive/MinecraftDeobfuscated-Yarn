...
public class PostProcessShader implements AutoCloseable {
	...
	private final List<String> field_1539 = Lists.newArrayList();
	private final List<Integer> field_1533 = Lists.newArrayList();
	private final List<Integer> field_1537 = Lists.newArrayList();
	...
	public void render(float f) {
		...
		this.program.getUniformByNameOrDummy("ScreenSize").put((float)minecraftClient.window.getWindowWidth(), (float)minecraftClient.window.getWindowHeight());
		this.program.enable();
