...
public class TextRenderer implements AutoCloseable {
	...
	private float drawLayer(
		...
		if (!list.isEmpty()) {
			...
			if (identifier2 != null) {
				VertexConsumer vertexConsumer2 = layeredVertexConsumerStorage.getBuffer(
					bl2 ? RenderLayer.getTextSeeThrough(identifier2) : RenderLayer.getText(identifier2)
				);
	...
	public String wrapStringToWidth(String string, int i) {
		String string2;
		String string3;
		for(string2 = ""; !string.isEmpty(); string2 = string2 + string3 + "\n") {
