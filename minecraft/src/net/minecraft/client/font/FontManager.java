...
public class FontManager implements AutoCloseable {
	...
	public TextRenderer createTextRenderer() {
		return new TextRenderer(
			identifier -> (FontStorage)this.fontStorages.getOrDefault(this.idOverrides.getOrDefault(identifier, identifier), this.missingStorage)
		);
	}
