...
public class SimpleOption<T> extends Option {
	...
	public static SimpleOption<Boolean> ofBoolean(
		String key, Function<MinecraftClient, Option.TooltipFactory<Boolean>> tooltipFactoryGetter, boolean defaultValue
	) {
	...
	public static SimpleOption<Boolean> ofBoolean(
		...
		return new SimpleOption<>(
			...
			new SimpleOption.PotentialValuesBasedCallbacks<>(ImmutableList.of((T)Boolean.TRUE, (T)Boolean.FALSE)),
			(T)defaultValue,
			changeCallback
		);
	}
	...
	public ClickableWidget createButton(GameOptions options, int x, int y, int width) {
		Option.TooltipFactory<T> tooltipFactory = (Option.TooltipFactory)this.tooltipFactoryGetter.apply(MinecraftClient.getInstance());
