...
public class MinecraftClient extends class_4093<Runnable> implements SnooperListener, WindowEventHandler, FocusedInputListener, AutoCloseable {
	...
	private void init() {
		...
		List<ResourcePack> list = (List)this.field_1715.getEnabledContainers().stream().map(ResourcePackContainer::createResourcePack).collect(Collectors.toList());
	...
	public CompletableFuture<Void> reloadResources() {
		if (this.field_18174 != null) {
			...
			if (this.field_18175 instanceof SplashScreen) {
				...
				this.field_1715.callCreators();
				List<ResourcePack> list = (List)this.field_1715
	...
	private void handleInputEvents() {
		for(; this.field_1690.keyTogglePerspective.wasPressed(); this.field_1769.method_3292()) {
