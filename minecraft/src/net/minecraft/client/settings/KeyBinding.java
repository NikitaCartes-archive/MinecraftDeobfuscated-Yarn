...
public class KeyBinding implements Comparable<KeyBinding> {
	private static final Map<String, KeyBinding> field_1657 = Maps.newHashMap();
	...
	private static final Map<String, Integer> field_1656 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	public boolean matches(int i, int j) {
		if (i == InputUtil.field_16237.getKeyCode()) {
