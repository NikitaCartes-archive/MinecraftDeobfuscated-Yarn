...
public class GameOptions {
	...
	public KeyBinding keySmoothCamera = new KeyBinding("key.smoothCamera", InputUtil.field_16237.getKeyCode(), "key.categories.misc");
	public KeyBinding keyFullscreen = new KeyBinding("key.fullscreen", 300, "key.categories.misc");
	public KeyBinding keySpectatorOutlines = new KeyBinding("key.spectatorOutlines", InputUtil.field_16237.getKeyCode(), "key.categories.misc");
	...
	public void method_1625(GameOptions.Option option, double d) {
		...
		if (option == GameOptions.Option.RENDER_DISTANCE) {
			...
			this.client.renderer.method_3292();
		}
	...
	public void updateOption(GameOptions.Option option, int i) {
		...
		if (option == GameOptions.Option.FORCE_UNICODE_FONT) {
			...
			this.client.method_1568().setForceUnicodeFont(this.forceUnicodeFont);
		}
			...
			for (String string : compoundTag.getKeys()) {
				...
				try {
					...
					for (KeyBinding keyBinding : this.keysAll) {
						if (string.equals("key_" + keyBinding.method_1431())) {
	...
	public void write() {
		...
		try {
			...
			for (KeyBinding keyBinding : this.keysAll) {
				printWriter.println("key_" + keyBinding.method_1431() + ":" + keyBinding.getName());
			}
