...
public class class_2806 {
	public static final class_2806 field_12798 = method_16555("empty", null, -1, false, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> {
	});
	public static final class_2806 field_16423 = method_16557(
		"structure_starts", field_12798, 0, false, class_2806.class_2808.field_12808, (arg, arg2, arg3, arg4, function, list, arg5) -> {
			if (!arg5.method_12009().method_12165(method_16561()) || !arg5.method_12038()) {
				class_1923 lv = arg5.method_12004();
				int i = lv.field_9181;
				int j = lv.field_9180;
				arg4.method_15557(i, j, true);
			}

			if (!arg5.method_12009().method_12165(arg) && arg2.method_8401().method_220()) {
				arg3.method_16129(arg5, arg3, arg2.method_8411().method_134());
			}

			return CompletableFuture.completedFuture(arg5);
		}
	);
	...
	public static final class_2806 field_12794 = method_16555(
		"biomes", field_16422, 0, false, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> arg2.method_12106(arg3)
	);
	public static final class_2806 field_12804 = method_16555(
		"noise", field_12794, 8, false, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> arg2.method_12088(new class_3233(arg, list), arg3)
	);
	public static final class_2806 field_12796 = method_16555(
		"surface", field_12804, 0, false, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> arg2.method_12110(arg3)
	);
	public static final class_2806 field_12801 = method_16555(
		"carvers", field_12796, 0, false, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> arg2.method_12108(arg3, class_2893.class_2894.field_13169)
	);
	...
	public static final class_2806 field_12805 = method_16557(
		"light", field_12795, 1, true, class_2806.class_2808.field_12808, (arg, arg2, arg3, arg4, function, list, arg5) -> {
			arg5.method_17032(arg4);
			class_1923 lv = arg5.method_12004();
			int i = lv.field_9181;
			int j = lv.field_9180;
			boolean bl = arg5.method_12009().method_12165(arg) && arg5.method_12038();
			if (!arg5.method_12009().method_12165(arg)) {
				((class_2839)arg5).method_12308(arg);
			}

			return arg4.method_17310(arg5, i, j, bl);
		}
	);
	public static final class_2806 field_12786 = method_16555(
		"spawn", field_12805, 0, true, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> arg2.method_12107(new class_3233(arg, list))
	);
	public static final class_2806 field_12800 = method_16555("heightmaps", field_12786, 0, true, class_2806.class_2808.field_12808, (arg, arg2, list, arg3) -> {
	});
	public static final class_2806 field_12803 = method_16557(
		...
		(arg, arg2, arg3, arg4, function, list, arg5) -> (CompletableFuture<class_2791>)function.apply(arg5)
	);
	...
	private static class_2806 method_16555(String string, @Nullable class_2806 arg, int i, boolean bl, class_2806.class_2808 arg2, class_2806.class_3768 arg3) {
		return method_16557(string, arg, i, bl, arg2, arg3);
	}

	private static class_2806 method_16557(String string, @Nullable class_2806 arg, int i, boolean bl, class_2806.class_2808 arg2, class_2806.class_2807 arg3) {
		return class_2378.method_10226(class_2378.field_16643, string, new class_2806(string, arg, i, bl, arg2, arg3));
	}
	...
	class_2806(String string, @Nullable class_2806 arg, int i, boolean bl, class_2806.class_2808 arg2, class_2806.class_2807 arg3) {
	...
	public CompletableFuture<class_2791> method_12154(
		class_1937 arg, class_2794<?> arg2, class_3227 arg3, Function<class_2791, CompletableFuture<class_2791>> function, List<class_2791> list
	) {
		class_2791 lv = (class_2791)list.get(list.size() / 2);
		CompletableFuture<class_2791> completableFuture = this.field_12792.doWork(this, arg, arg2, arg3, function, list, lv);
		return this.field_12787 == class_2806.class_2808.field_12808 ? completableFuture.thenApply(argx -> {
			((class_2839)argx).method_12308(this);
			return argx;
		}) : completableFuture;
	}
	...
	interface class_3768 extends class_2806.class_2807 {
		...
		default CompletableFuture<class_2791> doWork(
			...
			if (!arg5.method_12009().method_12165(arg)) {
				this.doWork(arg2, arg3, list, arg5);
			}

			return CompletableFuture.completedFuture(arg5);
		}

		void doWork(class_1937 arg, class_2794<?> arg2, List<class_2791> list, class_2791 arg3);
	}
}
