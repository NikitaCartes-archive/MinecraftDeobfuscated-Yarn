...
public class class_3193 {
	...
	public class_3193(class_1923 arg, int i, class_3568 arg2, class_3193.class_3896 arg3, class_3193.class_3897 arg4) {
		...
		this.field_16432 = class_3215.field_13922 + 1;
	...
	public CompletableFuture<Either<class_2791, class_3193.class_3724>> method_16146(class_2806 arg) {
		CompletableFuture<Either<class_2791, class_3193.class_3724>> completableFuture = (CompletableFuture)this.field_16425.get(arg.method_16559());
		return completableFuture == null ? field_16430 : completableFuture;
	}

	public CompletableFuture<Either<class_2791, class_3193.class_3724>> method_13997(class_2806 arg) {
		return method_14011(this.field_13862).method_12165(arg) ? this.method_16146(arg) : field_16430;
	}
	...
	public class_2818 method_16144() {
		...
		Either<class_2818, class_3193.class_3724> either = (Either)completableFuture.getNow(null);
	...
	public void method_14006(class_2818 arg) {
		if (this.field_13874 != 0 || this.field_13870 != 0 || this.field_13871 != 0) {
			...
			if (this.field_13870 != 0 || this.field_13871 != 0) {
				...
				this.field_13870 = 0;
				this.field_13871 = 0;
				this.field_16209 &= ~(this.field_13870 & this.field_13871);
			}
		}
	}
	...
	public CompletableFuture<Either<class_2791, class_3193.class_3724>> method_13993(class_2806 arg, class_3898 arg2) {
		...
		CompletableFuture<Either<class_2791, class_3193.class_3724>> completableFuture = (CompletableFuture)this.field_16425.get(i);
		if (completableFuture != null) {
			Either<class_2791, class_3193.class_3724> either = (Either)completableFuture.getNow(null);
	...
	protected void method_14007(class_3898 arg) {
		...
		boolean bl = this.field_16432 <= class_3215.field_13922;
		boolean bl2 = this.field_13862 <= class_3215.field_13922;
		if (bl2) {
			for(int i = bl ? lv.method_16559() + 1 : 0; i <= lv2.method_16559(); ++i) {
				this.method_13993((class_2806)field_13868.get(i), arg);
			}
		}
		...
		if (bl) {
			...
			for(int j = bl2 ? lv2.method_16559() + 1 : 0; j <= lv.method_16559(); ++j) {
				CompletableFuture<Either<class_2791, class_3193.class_3724>> completableFuture = (CompletableFuture)this.field_16425.get(j);
				if (completableFuture != null) {
					completableFuture.complete(either);
				} else {
					this.field_16425.set(j, CompletableFuture.completedFuture(either));
				}
			}
		}
		...
		boolean bl3 = lv3.method_14014(class_3193.class_3194.field_13875);
		boolean bl4 = lv4.method_14014(class_3193.class_3194.field_13875);
		if (!bl3 && bl4) {
		...
		boolean bl5 = lv3.method_14014(class_3193.class_3194.field_13877);
		boolean bl6 = lv4.method_14014(class_3193.class_3194.field_13877);
		if (!bl5 && bl6) {
	...
	public static class_2806 method_14011(int i) {
		return i <= 33 ? class_2806.field_12803 : class_2806.method_12161(i - 33 - 1);
	}

	public static class_3193.class_3194 method_14008(int i) {
		return field_13873[class_3532.method_15340(33 - i, 0, field_13873.length - 1)];
	}
	...
	public interface class_3897 {
		default Stream<class_3222> method_17210(class_1923 arg, boolean bl) {
			return this.method_17211(arg, bl, false);
		}

		Stream<class_3222> method_17211(class_1923 arg, boolean bl, boolean bl2);
	}
}
