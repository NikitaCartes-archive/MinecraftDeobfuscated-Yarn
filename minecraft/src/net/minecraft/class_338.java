...
public class class_338 extends class_332 {
	...
	public void method_1805(int i) {
		if (this.field_2062.field_1690.field_1877 != class_1657.class_1659.field_7536) {
			int j = this.method_1813();
			int k = this.field_2064.size();
			double d = this.field_2062.field_1690.field_1820 * 0.9F + 0.1F;
			if (k > 0) {
				boolean bl = false;
				if (this.method_1819()) {
					bl = true;
				...
				double e = this.method_1814();
				int l = class_3532.method_15384((double)this.method_1811() / e);
				...
				for (int n = 0; n + this.field_2066 < this.field_2064.size() && n < j; n++) {
					...
					if (lv != null) {
						...
						if (o < 200 || bl) {
							...
							f = 1.0 - f;
							f *= 10.0;
							f = class_3532.method_15350(f, 0.0, 1.0);
							f *= f;
							int p = (int)(255.0 * f);
							if (bl) {
								p = 255;
							...
							if (p > 3) {
								int q = 0;
								int r = -n * 9;
								method_1785(-2, r - 9, 0 + l + 4, r, p / 2 << 24);
								String string = lv.method_1412().method_10863();
								GlStateManager.enableBlend();
								this.field_2062.field_1772.method_1720(string, 0.0F, (float)(r - 8), 16777215 + (p << 24));
				...
				if (bl) {
					...
					if (s != o) {
						...
						method_1785(0, -t, 2, -t - u, q + (px << 24));
						method_1785(2, -t, 1, -t - u, 13421772 + (px << 24));
					}
				}
