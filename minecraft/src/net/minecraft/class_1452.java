...
public class class_1452 extends class_1429 {
	...
	public class_1452(class_1299<? extends class_1452> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public void method_5800(class_1538 arg) {
		class_1590 lv = class_1299.field_6050.method_5883(this.field_6002);
	...
	public void method_6091(class_243 arg) {
		if (this.method_5805()) {
			...
			if (this.method_5782() && this.method_5956()) {
				...
				if (this.method_5787()) {
					float f = (float)this.method_5996(class_1612.field_7357).method_6194() * 0.225F;
					if (this.field_6814) {
						f += f * 1.15F * class_3532.method_15374((float)this.field_6812 / (float)this.field_6813 * (float) Math.PI);
					}

					this.method_6125(f);
					super.method_6091(new class_243(0.0, 0.0, 1.0));
				} else {
				...
				float g = class_3532.method_15368(d * d + e * e) * 4.0F;
				if (g > 1.0F) {
					g = 1.0F;
				}
	...
	public class_1452 method_6574(class_1296 arg) {
		return class_1299.field_6093.method_5883(this.field_6002);
	}
