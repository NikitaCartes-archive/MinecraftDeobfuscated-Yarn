...
public class class_2216 implements ArgumentType<class_274> {
	...
	public class_274 method_9403(StringReader stringReader) throws CommandSyntaxException {
		...
		return (class_274)class_274.method_1224(string).orElseThrow(() -> {
			stringReader.setCursor(i);
			return field_9927.create(string);
		});
	}

	@Override
	public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandContext, SuggestionsBuilder suggestionsBuilder) {
		List<String> list = Lists.newArrayList(class_274.field_1455.keySet());
