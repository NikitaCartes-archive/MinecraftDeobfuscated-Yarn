...
public class class_1755 extends class_1792 {
	...
	public class_1271<class_1799> method_7836(class_1937 arg, class_1657 arg2, class_1268 arg3) {
		...
		class_239 lv2 = this.method_7872(arg, arg2, this.field_7905 == class_3612.field_15906);
		if (lv2 == null) {
			return new class_1271<>(class_1269.field_5811, lv);
		} else if (lv2.field_1330 == class_239.class_240.field_1332) {
			class_2338 lv3 = lv2.method_1015();
			if (!arg.method_8505(arg2, lv3) || !arg2.method_7343(lv3, lv2.field_1327, lv)) {
				...
				if (lv4.method_11614() instanceof class_2263) {
					class_3611 lv5 = ((class_2263)lv4.method_11614()).method_9700(arg, lv3, lv4);
					if (lv5 != class_3612.field_15906) {
						arg2.method_7259(class_3468.field_15372.method_14956(this));
						arg2.method_5783(lv5.method_15791(class_3486.field_15518) ? class_3417.field_15202 : class_3417.field_15126, 1.0F, 1.0F);
						class_1799 lv6 = this.method_7730(lv, arg2, lv5.method_15774());
						if (!arg.field_9236) {
							class_174.field_1208.method_8932((class_3222)arg2, new class_1799(lv5.method_15774()));
						}

						return new class_1271<>(class_1269.field_5812, lv6);
					}
				}
				...
				class_2680 lv4 = arg.method_8320(lv3);
				class_2338 lv7 = this.method_7729(lv4, lv3, lv2);
				if (this.method_7731(arg2, arg, lv7, lv2)) {
					this.method_7728(arg, lv, lv7);
					if (arg2 instanceof class_3222) {
						class_174.field_1191.method_9087((class_3222)arg2, lv7, lv);
					}
	...
	private class_2338 method_7729(class_2680 arg, class_2338 arg2, class_239 arg3) {
		return arg.method_11614() instanceof class_2402 ? arg2 : arg3.method_1015().method_10093(arg3.field_1327);
	}
	...
	public boolean method_7731(@Nullable class_1657 arg, class_1937 arg2, class_2338 arg3, @Nullable class_239 arg4) {
		if (!(this.field_7905 instanceof class_3609)) {
			...
			if (arg2.method_8623(arg3)
				...
				} else if (lv.method_11614() instanceof class_2402) {
				...
				return arg4 == null ? false : this.method_7731(arg, arg2, arg4.method_1015().method_10093(arg4.field_1327), null);
			}
		}
	}
