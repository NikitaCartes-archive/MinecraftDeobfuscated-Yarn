...
public class class_6609 extends ChunkPosDistanceLevelPropagator {
	...
	private SortedArraySet<ChunkTicket<?>> method_38644(long l) {
		return (SortedArraySet<ChunkTicket<?>>)this.field_34890.computeIfAbsent(l, lx -> SortedArraySet.create(4));
	}
	...
	protected int getInitialLevel(long id) {
		SortedArraySet<ChunkTicket<?>> sortedArraySet = (SortedArraySet)this.field_34890.get(id);
	...
	public String method_38643(long l) {
		SortedArraySet<ChunkTicket<?>> sortedArraySet = (SortedArraySet)this.field_34890.get(l);
