...
public class class_1477 extends class_1480 {
	...
	public void method_6007() {
		...
		if (this.method_5816()) {
			...
			this.field_6283 += (-((float)class_3532.method_15349(lv.field_1352, lv.field_1350)) * (180.0F / (float)Math.PI) - this.field_6283) * 0.1F;
			this.field_6031 = this.field_6283;
			this.field_6903 = (float)((double)this.field_6903 + Math.PI * (double)this.field_6913 * 1.5);
			this.field_6907 += (-((float)class_3532.method_15349((double)g, lv.field_1351)) * (180.0F / (float)Math.PI) - this.field_6907) * 0.1F;
		} else {
