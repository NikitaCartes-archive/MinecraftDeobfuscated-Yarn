...
public class class_1477 extends class_1480 {
	...
	public class_1477(class_1937 arg) {
		super(class_1299.field_6114, arg);
		this.method_5835(0.8F, 0.8F);
		this.field_5974.setSeed((long)(1 + this.method_5628()));
	...
	public void method_6007() {
		...
		if (this.method_5816()) {
			...
			if (!this.field_6002.field_9236) {
				this.field_5967 = (double)(this.field_6910 * this.field_6901);
				this.field_5984 = (double)(this.field_6911 * this.field_6901);
				this.field_6006 = (double)(this.field_6909 * this.field_6901);
			}

			float f = class_3532.method_15368(this.field_5967 * this.field_5967 + this.field_6006 * this.field_6006);
			this.field_6283 += (-((float)class_3532.method_15349(this.field_5967, this.field_6006)) * (180.0F / (float)Math.PI) - this.field_6283) * 0.1F;
			this.field_6031 = this.field_6283;
			this.field_6903 = (float)((double)this.field_6903 + Math.PI * (double)this.field_6913 * 1.5);
			this.field_6907 += (-((float)class_3532.method_15349((double)f, this.field_5984)) * (180.0F / (float)Math.PI) - this.field_6907) * 0.1F;
		} else {
			...
			if (!this.field_6002.field_9236) {
				...
				if (this.method_6059(class_1294.field_5902)) {
					this.field_5984 += 0.05 * (double)(this.method_6112(class_1294.field_5902).method_5578() + 1) - this.field_5984;
				} else if (!this.method_5740()) {
					this.field_5984 -= 0.08;
				}
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		return this.field_6010 > 45.0 && this.field_6010 < (double)arg.method_8615();
	}
	...
	class class_1478 extends class_1352 {
		...
		public boolean method_6264() {
			...
			if (class_1477.this.method_5799() && lv != null) {
				return class_1477.this.method_5858(lv) < 100.0;
			} else {
				return false;
			}
		}
