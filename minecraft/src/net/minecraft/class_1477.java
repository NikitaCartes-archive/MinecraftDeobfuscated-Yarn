...
public class class_1477 extends class_1480 {
	...
	public void method_6007() {
		...
		if (this.method_5816()) {
			...
			this.field_6283 = this.field_6283
				+ (-((float)class_3532.method_15349(this.field_5967, this.field_6006)) * (180.0F / (float)Math.PI) - this.field_6283) * 0.1F;
			this.field_6031 = this.field_6283;
			this.field_6903 = (float)((double)this.field_6903 + Math.PI * (double)this.field_6913 * 1.5);
			this.field_6907 = this.field_6907 + (-((float)class_3532.method_15349((double)f, this.field_5984)) * (180.0F / (float)Math.PI) - this.field_6907) * 0.1F;
		} else {
			...
			if (!this.field_6002.field_9236) {
				...
				if (this.method_6059(class_1294.field_5902)) {
					this.field_5984 = this.field_5984 + (0.05 * (double)(this.method_6112(class_1294.field_5902).method_5578() + 1) - this.field_5984);
