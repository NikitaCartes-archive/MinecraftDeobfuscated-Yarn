...
public class class_3174 extends class_3324 {
	...
	public class_3174(class_3176 arg) {
		...
		this.method_14608(lv.field_16844);
	...
	private void method_13932() {
		try {
			...
			field_13804.warn("Failed to save ip banlist: ", var2);
		}
	}
	...
	private void method_13930() {
		try {
			...
			field_13804.warn("Failed to save user banlist: ", var2);
		}
	}
	...
	private void method_13931() {
		try {
			...
			field_13804.warn("Failed to load ip banlist: ", var2);
		}
	}
	...
	private void method_13933() {
		try {
			...
			field_13804.warn("Failed to load user banlist: ", var2);
		}
	}
	...
	private void method_13934() {
		try {
			...
			field_13804.warn("Failed to load operators list: ", var2);
		}
	}
	...
	private void method_13935() {
		try {
			...
			field_13804.warn("Failed to save operators list: ", var2);
		}
	}
	...
	private void method_13936() {
		try {
			...
			field_13804.warn("Failed to load white-list: ", var2);
		}
	}
	...
	private void method_13937() {
		try {
			...
			field_13804.warn("Failed to save white-list: ", var2);
		}
	}
