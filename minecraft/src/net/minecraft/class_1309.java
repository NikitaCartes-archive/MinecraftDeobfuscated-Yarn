...
public abstract class class_1309 extends class_1297 {
	...
	protected void method_6108() {
		...
		if (this.field_6213 == 20) {
			if (!this.field_6002.field_9236
				&& (this.method_6071() || this.field_6238 > 0 && this.method_6054() && this.field_6002.method_8450().method_8355(class_1928.field_19391))) {
	...
	public void method_5652(class_2487 arg) {
		...
		for(class_1304 lv : class_1304.values()) {
			class_1799 lv2 = this.method_6118(lv);
			if (!lv2.method_7960()) {
				this.method_6127().method_6210(lv2.method_7926(lv));
			}
		}
	...
	public void method_5749(class_2487 arg) {
		...
		if (arg.method_10573("SleepingX", 99) && arg.method_10573("SleepingY", 99) && arg.method_10573("SleepingZ", 99)) {
			...
			this.field_6011.method_12778(field_18064, class_4050.field_18078);
			if (!this.field_5953) {
		...
		if (this.method_5679(arg)) {
			...
			if ((arg == class_1282.field_5865 || arg == class_1282.field_5847) && !this.method_6118(class_1304.field_6169).method_7960()) {
				this.method_6118(class_1304.field_6169)
					.method_7956((int)(f * 4.0F + this.field_5974.nextFloat() * f * 2.0F), this, argx -> argx.method_20235(class_1304.field_6169));
				f *= 0.75F;
			}
			...
			int i = 10;
			if (lv != null && lv instanceof class_1657) {
				i = Math.min((int)((class_1657)lv).method_26737(), i);
			}
			...
			if (lv != null) {
				if (lv instanceof class_1309) {
					this.method_6015((class_1309)lv);
				}

				if (lv instanceof class_1657) {
					this.field_6238 = 100;
					this.field_6258 = (class_1657)lv;
				} else if (lv instanceof class_1493) {
					class_1493 lv2 = (class_1493)lv;
					if (lv2.method_6181()) {
						this.field_6238 = 100;
						class_1309 lv3 = lv2.method_6177();
						if (lv3 != null && lv3.method_5864() == class_1299.field_6097) {
							this.field_6258 = (class_1657)lv3;
						} else {
							this.field_6258 = null;
						}
					}
			...
			if (bl2) {
				...
				if (lv != null) {
					...
					double e;
					for(e = lv.field_6035 - this.field_6035; d * d + e * e < 1.0E-4; e = (Math.random() - Math.random()) * 0.01) {
						d = (Math.random() - Math.random()) * 0.01;
					}

					this.field_6271 = (float)(class_3532.method_15349(e, d) * 180.0F / (float)Math.PI - (double)this.field_6031);
					this.method_6005(lv, 0.4F, d, e);
				} else {
			...
			if (lv instanceof class_3222) {
				class_174.field_1199.method_9097((class_3222)lv, this, arg, g, f, bl);
			}
	...
	protected void method_6060(class_1309 arg) {
		...
		if (this.method_6047().method_7909() instanceof class_1743) {
			float f = 0.5F + (float)class_1890.method_8234(this) * 0.1F;
			arg.method_26733(f);
		}
	}

	public boolean method_26733(float f) {
		return false;
	}
	...
	private boolean method_6061(class_1282 arg) {
		if (arg instanceof class_1285 && ((class_1285)arg).method_26730()) {
			return false;
		} else {
			class_1297 lv = arg.method_5526();
			boolean bl = false;
	...
	@Environment(EnvType.CLIENT)
	private void method_6045(class_1799 arg) {
		if (!arg.method_7960()) {
			if (!this.method_5701()) {
				this.field_6002
					.method_8486(
						...
						this.method_5634(),
						0.8F,
						0.8F + this.field_6002.field_9229.nextFloat() * 0.4F,
						false
					);
			}
	...
	protected void method_16080(class_1282 arg) {
		...
		if (this.method_6054() && this.field_6002.method_8450().method_8355(class_1928.field_19391)) {
	...
	public boolean method_6101() {
		if (this.method_7325()) {
			...
			if (lv2 != class_2246.field_9983 && lv2 != class_2246.field_10597 && lv2 != class_2246.field_16492) {
				return lv2 instanceof class_2533 && this.method_6077(new class_2338(this), lv);
			} else {
				return true;
			}
		}
	...
	private boolean method_6077(class_2338 arg, class_2680 arg2) {
		if (arg2.method_11654(class_2533.field_11631)) {
		...
		switch(b) {
			...
			case 46:
				...
				for(int j = 0; j < 128; ++j) {
					...
					float f = (this.field_5974.nextFloat() - 0.5F) * 0.2F;
					float g = (this.field_5974.nextFloat() - 0.5F) * 0.2F;
					float h = (this.field_5974.nextFloat() - 0.5F) * 0.2F;
					double e = class_3532.method_16436(d, this.field_6014, this.field_5987) + (this.field_5974.nextDouble() - 0.5) * (double)this.method_17681() * 2.0;
					double k = class_3532.method_16436(d, this.field_6036, this.field_6010) + this.field_5974.nextDouble() * (double)this.method_17682();
					double l = class_3532.method_16436(d, this.field_5969, this.field_6035) + (this.field_5974.nextDouble() - 0.5) * (double)this.method_17681() * 2.0;
					this.field_6002.method_8406(class_2398.field_11214, e, k, l, (double)f, (double)g, (double)h);
				}
				break;
			case 47:
				this.method_6045(this.method_6118(class_1304.field_6173));
				break;
			case 48:
				this.method_6045(this.method_6118(class_1304.field_6171));
				break;
			case 49:
				this.method_6045(this.method_6118(class_1304.field_6169));
				break;
			case 50:
				this.method_6045(this.method_6118(class_1304.field_6174));
				break;
			case 51:
				this.method_6045(this.method_6118(class_1304.field_6172));
				break;
			case 52:
				this.method_6045(this.method_6118(class_1304.field_6166));
		}
	}
			...
			if (lv != null) {
				...
				for(int[] js : is) {
					...
					if (this.field_6002.method_8587(this, lv4)) {
						...
						class_2338 lv5 = new class_2338(s, this.field_6010 + 1.0, t);
						if (this.field_6002.method_8587(this, lv4.method_989(0.0, 1.0, 0.0)) && this.field_6002.method_8320(lv5).method_11631(this.field_6002, lv5, this)) {
							k = s;
	...
	public void method_6091(class_243 arg) {
			...
			if (!this.method_5799() || this instanceof class_1657 && ((class_1657)this).field_7503.field_7479) {
				if (!this.method_5771() || this instanceof class_1657 && ((class_1657)this).field_7503.field_7479) {
					if (this.method_6128()) {
						...
						float f = this.field_5952 ? p * 0.91F : 0.91F;
						...
						this.method_18800(lv7.field_1352 * (double)f, q * 0.98F, lv7.field_1350 * (double)f);
					}
				} else {
				...
				double e = this.field_6010;
				float f = this.method_5624() ? 0.9F : this.method_6120();
				float g = 0.02F;
				...
				this.method_18799(lv.method_18805((double)f, 0.8F, (double)f));
				if (!this.method_5740() && !this.method_5624()) {
					...
					if (bl && Math.abs(lv2.field_1351 - 0.005) >= 0.003 && Math.abs(lv2.field_1351 - d / 16.0) < 0.003) {
						...
						i = lv2.field_1351 - d / 16.0;
					}

					this.method_18800(lv2.field_1352, i, lv2.field_1350);
				}

				class_243 lv2 = this.method_18798();
				if (this.field_5976 && this.method_5654(lv2.field_1352, lv2.field_1351 + 0.6F - this.field_6010 + e, lv2.field_1350)) {
		...
		float g = class_3532.method_15368(d * d + s * s + r * r) * 4.0F;
		if (g > 1.0F) {
			g = 1.0F;
		}

		this.field_6225 += (g - this.field_6225) * 0.4F;
		...
		if (bl && !this.field_5952 && !this.method_5765()) {
			...
			if (lv.method_7909() == class_1802.field_8833 && class_1770.method_7804(lv)) {
				...
				if (!this.field_6002.field_9236 && (this.field_6239 + 1) % 20 == 0) {
					lv.method_7956(1, this, arg -> arg.method_20235(class_1304.field_6174));
				}
			} else {
				bl = false;
			}
	...
	public boolean method_6039() {
		if (this.method_6115() && !this.field_6277.method_7960()) {
			...
			if (lv.method_7853(this.field_6277) == class_1839.field_8949) {
				return true;
			}
		}

		if ((this.method_5715() || this.method_5765()) && !this.method_6115()) {
			class_1799 lv2 = this.method_5998(class_1268.field_5810);
			if (!lv2.method_7960() && lv2.method_7909().method_7853(lv2) == class_1839.field_8949 && !this.method_26732(lv2)) {
				return true;
			}
		}
	...
	public boolean method_26732(class_1799 arg) {
		return false;
	}
	...
	public boolean method_20232() {
		return super.method_20232() || !this.method_6128() && this.method_18376() == class_4050.field_18077;
	}
	...
	public boolean method_6082(double d, double e, double f, boolean bl) {
		...
		class_1937 lv2 = this.field_6002;
	...
	private boolean method_18406() {
		return this.method_18398().map(arg -> this.field_6002.method_8320(arg).method_11614() instanceof class_2244).orElse(false);
	}
	...
	public void method_18400() {
		this.method_18398().filter(this.field_6002::method_8591).ifPresent(arg -> {
			class_2680 lv = this.field_6002.method_8320(arg);
			if (lv.method_11614() instanceof class_2244) {
				this.field_6002.method_8652(arg, lv.method_11657(class_2244.field_9968, Boolean.valueOf(false)), 3);
				class_243 lv2 = (class_243)class_2244.method_9484(this.method_5864(), this.field_6002, arg, 0).orElseGet(() -> {
					class_2338 lvxx = arg.method_10084();
					return new class_243((double)lvxx.method_10263() + 0.5, (double)lvxx.method_10264() + 0.1, (double)lvxx.method_10260() + 0.5);
				});
				this.method_5814(lv2.field_1352, lv2.field_1351, lv2.field_1350);
			}
		});
	...
	private static byte method_20237(class_1304 arg) {
		switch(arg) {
			case field_6173:
				return 47;
			case field_6171:
	...
	public void method_20235(class_1304 arg) {
		this.field_6002.method_8421(this, method_20237(arg));
	}

	public void method_20236(class_1268 arg) {
		this.method_20235(arg == class_1268.field_5808 ? class_1304.field_6173 : class_1304.field_6171);
	}
}
