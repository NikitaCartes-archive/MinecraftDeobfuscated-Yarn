...
public abstract class class_1309 extends class_1297 {
			...
			if (lv != null) {
				...
				for(int[] js : is) {
					...
					if (this.field_6002.method_8587(this, lv4)) {
						...
						if (this.field_6002.method_8587(this, lv4.method_989(0.0, 1.0, 0.0)) && this.field_6002.method_8320(lv5).method_11631(this.field_6002, lv5)) {
							k = s;
	...
	protected void method_6043() {
		...
		if (this.method_6059(class_1294.field_5913)) {
			this.field_5984 += (double)((float)(this.method_6112(class_1294.field_5913).method_5578() + 1) * 0.1F);
		}

		if (this.method_5624()) {
			float f = this.field_6031 * (float) (Math.PI / 180.0);
			this.field_5967 -= (double)(class_3532.method_15374(f) * 0.2F);
			this.field_6006 += (double)(class_3532.method_15362(f) * 0.2F);
		}
	...
	public void method_6091(float f, float g, float h) {
		if (this.method_6034() || this.method_5787()) {
			...
			if (!this.method_5799() || this instanceof class_1657 && ((class_1657)this).field_7503.field_7479) {
				if (!this.method_5771() || this instanceof class_1657 && ((class_1657)this).field_7503.field_7479) {
					if (this.method_6128()) {
						...
						if (this.field_5984 < 0.0 && m > 0.0) {
							...
							this.field_5984 += q;
							this.field_5967 += lv.field_1352 * q / m;
							this.field_6006 += lv.field_1350 * q / m;
						}
						...
						if (m > 0.0) {
							this.field_5967 += (lv.field_1352 / m * n - this.field_5967) * 0.1;
							this.field_6006 += (lv.field_1350 / m * n - this.field_6006) * 0.1;
						}
						...
						try (class_2338.class_2340 lv2 = class_2338.class_2340.method_10115(this.field_5987, this.method_5829().field_1322 - 1.0, this.field_6035)) {
							...
							if (this.method_6059(class_1294.field_5902)) {
								this.field_5984 += (0.05 * (double)(this.method_6112(class_1294.field_5902).method_5578() + 1) - this.field_5984) * 0.2;
								this.field_6017 = 0.0F;
							} else {
				...
				float j = 0.02F;
				float k = (float)class_1890.method_8232(this);
				if (k > 3.0F) {
					k = 3.0F;
				}
		...
		double m = this instanceof class_1432 ? this.field_6010 - this.field_6036 : 0.0;
		float k = class_3532.method_15368(d * d + m * m + e * e) * 4.0F;
		if (k > 1.0F) {
			k = 1.0F;
		}
	...
	public boolean method_6039() {
		if (this.method_6115() && !this.field_6277.method_7960()) {
			...
			if (lv.method_7853(this.field_6277) != class_1839.field_8949) {
				...
				return lv.method_7881(this.field_6277) - this.field_6222 >= 5;
			}
		} else {
			return false;
		}
