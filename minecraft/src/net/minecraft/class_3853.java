...
public class class_3853 {
				...
				method_16928(
					ImmutableMap.of(
						...
						new class_3853.class_1652[]{
							...
							new class_3853.class_4166(class_1294.field_5922, 160, 15)
						},
						5,
				...
				method_16928(
					ImmutableMap.builder()
						.put(
							1,
							new class_3853.class_1652[]{
								new class_3853.class_4161(class_1802.field_8407, 24, 8, 2),
								new class_3853.class_1648(1),
								new class_3853.class_4165(class_2246.field_10504, 6, 3, 6, 1)
							}
						)
						.put(
							2,
			...
			hashMap.put(
				...
				method_16928(
					ImmutableMap.of(
						...
						2,
						new class_3853.class_1652[]{
							new class_3853.class_4161(class_1802.field_8141, 10, 8, 10), new class_3853.class_1654(13, "Monument", class_20.class_21.field_98, 6, 5)
						},
						3,
						new class_3853.class_1652[]{
				...
				method_16928(
					ImmutableMap.of(
						...
						new class_3853.class_1652[]{
							...
							new class_3853.class_4163(class_1802.field_8527, 9, 2, 10, 0.2F)
						},
						4,
						new class_3853.class_1652[]{
	...
	static class class_4167 implements class_3853.class_1652 {
		...
		public class_1914 method_7246(class_1297 arg, Random random) {
			...
			List<class_1842> list = (List)class_2378.field_11143.method_10220().filter(argx -> !argx.method_8049().isEmpty()).collect(Collectors.toList());
