...
public class class_1214 extends DataFix {
	private static final Set<String> field_5739 = ImmutableSet.builder()
		...
		.build();
	private static final Map<String, String> field_5737 = ImmutableMap.builder()
	...
	private static final Map<String, String> field_5736 = ImmutableMap.builder()
		...
		.build();
	private static final Map<String, String> field_5735 = ImmutableMap.builder()
