	...
	private static void method_116(File file, File file2, class_1966 arg, int i, int j, class_3536 arg2) {
		...
		try (
			...
			for(int k = 0; k < 32; ++k) {
						...
						try {
							...
							try {
								if (dataInputStream == null) {
									field_133.warn("Failed to fetch input stream for chunk {}", lv3);
									continue;
								}
							...
							field_133.warn("Failed to read data for chunk {}", lv3, var106);
							continue;
						}

						class_2487 lv5 = lv4.method_10562("Level");
						class_2864.class_2865 lv6 = class_2864.method_12433(lv5);
						class_2487 lv7 = new class_2487();
						class_2487 lv8 = new class_2487();
						lv7.method_10566("Level", lv8);
						class_2864.method_12432(lv6, lv8, arg);
				...
				int l = (int)Math.round(100.0 * (double)(i * 1024) / (double)(j * 1024));
			...
			field_133.error("Failed to upgrade region file {}", file2, var111);
		}
	}
