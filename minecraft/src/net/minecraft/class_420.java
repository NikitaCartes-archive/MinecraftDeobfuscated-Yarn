...
public class class_420 extends class_437 {
	...
	protected void init() {
		...
		this.addButton(
			new class_4185(
				this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, class_1074.method_4662("gui.cancel"), arg -> this.field_2461.confirmResult(false, 0)
			)
		);
		this.field_2463 = new class_342(this.font, this.width / 2 - 100, 116, 200, 20);
