	...
	protected void init() {
		...
		class_4185 lv = this.addButton(
			new class_4185(this.width / 2 - 100, this.height / 4 + 24 + 5, 200, 20, class_1074.method_4662("selectWorld.edit.resetIcon"), arg -> {
				class_32 lvxx = this.minecraft.method_1586();
				FileUtils.deleteQuietly(lvxx.method_239(this.field_3167, "icon.png"));
				arg.active = false;
			})
		);
		this.addButton(new class_4185(this.width / 2 - 100, this.height / 4 + 48 + 5, 200, 20, class_1074.method_4662("selectWorld.edit.openFolder"), arg -> {
			class_32 lvxx = this.minecraft.method_1586();
			class_156.method_668().method_672(lvxx.method_239(this.field_3167, "icon.png").getParentFile());
		}));
		this.addButton(new class_4185(this.width / 2 - 100, this.height / 4 + 72 + 5, 200, 20, class_1074.method_4662("selectWorld.edit.backup"), arg -> {
			class_32 lvxx = this.minecraft.method_1586();
			method_2701(lvxx, this.field_3167);
			this.field_3169.confirmResult(false, 0);
		}));
		...
		this.addButton(
			new class_4185(
				...
				arg -> this.minecraft.method_1507(new class_405(this, bl -> {
						if (bl) {
							method_2701(this.minecraft.method_1586(), this.field_3167);
						}
		
						this.minecraft.method_1507(new class_527(this.field_3169, this.field_3167, this.minecraft.method_1586()));
					}, new class_2588("optimizeWorld.confirm.title"), new class_2588("optimizeWorld.confirm.description")))
			)
		);
		...
		this.addButton(
			new class_4185(this.width / 2 + 2, this.height / 4 + 144 + 5, 98, 20, class_1074.method_4662("gui.cancel"), arg -> this.field_3169.confirmResult(false, 0))
		);
		...
		this.field_3170 = new class_342(this.font, this.width / 2 - 100, 53, 200, 20);
