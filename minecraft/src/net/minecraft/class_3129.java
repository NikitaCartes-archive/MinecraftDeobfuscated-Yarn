			...
			if (!bl) {
				...
				for(int n = arg2.method_10264() + i; n >= arg2.method_10264() + j; --n) {
					for(int q = arg2.method_10263() - m; q <= arg2.method_10263() + m; ++q) {
						...
						for(int p = arg2.method_10260() - m; p <= arg2.method_10260() + m; ++p) {
							int r = p - arg2.method_10260();
							if (Math.abs(o) != m || Math.abs(r) != m || m <= 0) {
								class_2338 lv2 = new class_2338(q, n, p);
								if (method_16420(arg, lv2)) {
									this.method_12773(set, arg, lv2, field_13733, arg3);
								}
							}
						}
					}
				...
				for(int n = 0; n < i - 1; ++n) {
					if (method_16420(arg, arg2.method_10086(n))) {
						this.method_12773(set, arg, arg2.method_10086(n), field_13732, arg3);
					}
				}
