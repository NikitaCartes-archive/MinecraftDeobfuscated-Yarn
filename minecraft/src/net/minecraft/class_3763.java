...
public abstract class class_3763 extends class_3732 {
	...
	private static final Predicate<class_1542> field_16600 = arg -> !arg.method_6977()
			&& arg.method_5805()
			&& class_1799.method_7973(arg.method_6983(), class_3765.method_16515());
	@Nullable
	...
	public void method_6078(class_1282 arg) {
		if (this.field_6002 instanceof class_3218) {
			...
			class_3765 lv2 = this.method_16478();
			if (lv2 != null) {
				if (this.method_16219()) {
					lv2.method_16500(this.method_16486());
				}
				...
				lv2.method_16510(this, false);
			}

			if (this.method_16219() && lv2 == null && ((class_3218)this.field_6002).method_19502(new class_2338(this)) == null) {
				class_1799 lv3 = this.method_6118(class_1304.field_6169);
				class_1657 lv4 = null;
				if (lv instanceof class_1657) {
					lv4 = (class_1657)lv;
				} else if (lv instanceof class_1493) {
					class_1493 lv6 = (class_1493)lv;
					class_1309 lv7 = lv6.method_6177();
					if (lv6.method_6181() && lv7 instanceof class_1657) {
						lv4 = (class_1657)lv7;
					}
				}

				if (!lv3.method_7960() && class_1799.method_7973(lv3, class_3765.method_16515()) && lv4 != null) {
					class_1293 lv8 = lv4.method_6112(class_1294.field_16595);
					int i = 1;
					if (lv8 != null) {
						i += lv8.method_5578();
						lv4.method_6111(class_1294.field_16595);
					} else {
						--i;
					}

					i = class_3532.method_15340(i, 0, 5);
					class_1293 lv9 = new class_1293(class_1294.field_16595, 120000, i, false, false, true);
					lv4.method_6092(lv9);
				}
			}
		}
	...
	protected void method_5949(class_1542 arg) {
		...
		if (this.method_16482() && !bl && class_1799.method_7973(lv, class_3765.method_16515())) {
	...
	public class_1315 method_5943(class_1936 arg, class_1266 arg2, class_3730 arg3, @Nullable class_1315 arg4, @Nullable class_2487 arg5) {
		this.method_16480(this.method_5864() != class_1299.field_6145 || arg3 != class_3730.field_16459);
	...
	public class class_3764<T extends class_3763> extends class_1352 {
		...
		public boolean method_6264() {
			...
			if (this.field_16603.method_16482()
				...
				&& !class_1799.method_7973(this.field_16603.method_6118(class_1304.field_6169), class_3765.method_16515())) {
	...
	static class class_4261 extends class_1352 {
		...
		public boolean method_6264() {
			this.method_20041();
			return this.method_20039() && this.method_20040() && this.field_19035.method_5968() == null;
		}
		...
		public boolean method_6266() {
			if (this.field_19035.method_5942().method_6357()) {
				...
				return this.field_19035.method_5968() == null
					&& !this.field_19037.method_19769(this.field_19035.method_19538(), (double)(this.field_19035.method_17681() + (float)this.field_19039))
					&& !this.field_19040;
			}
		}
