	...
	public void method_17079(T arg, float f, float g, float h, float i, float j, float k) {
		...
		if (arg.method_6128()) {
			...
			if (lv.field_1351 < 0.0) {
				class_243 lv2 = lv.method_1029();
				p = 1.0F - (float)Math.pow(-lv2.field_1351, 1.5);
			}

			l = p * (float) (Math.PI / 9) + (1.0F - p) * l;
			m = p * (float) (-Math.PI / 2) + (1.0F - p) * m;
		} else if (arg.method_20231()) {
		...
		if (arg instanceof class_742) {
			class_742 lv3 = (class_742)arg;
			lv3.field_3900 = (float)((double)lv3.field_3900 + (double)(l - lv3.field_3900) * 0.1);
			lv3.field_3899 = (float)((double)lv3.field_3899 + (double)(o - lv3.field_3899) * 0.1);
			lv3.field_3898 = (float)((double)lv3.field_3898 + (double)(m - lv3.field_3898) * 0.1);
			this.field_3365.field_3654 = lv3.field_3900;
			this.field_3365.field_3675 = lv3.field_3899;
			this.field_3365.field_3674 = lv3.field_3898;
		} else {
