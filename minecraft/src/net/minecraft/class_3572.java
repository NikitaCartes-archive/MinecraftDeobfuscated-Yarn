	...
	protected int method_15488(long l, long m, int i) {
		if (m == Long.MAX_VALUE) {
			...
			if (i >= 15) {
				...
				class_2680 lv = this.method_20479(m, atomicInteger);
				if (atomicInteger.get() >= 15) {
					return 15;
				} else {
					int j = class_2338.method_10061(l);
					int k = class_2338.method_10071(l);
					int n = class_2338.method_10083(l);
					int o = class_2338.method_10061(m);
					int p = class_2338.method_10071(m);
					int q = class_2338.method_10083(m);
					boolean bl = j == o && n == q;
					...
					class_2350 lv2;
					if (l == Long.MAX_VALUE) {
						lv2 = class_2350.field_11033;
					} else {
						lv2 = class_2350.method_16365(r, s, t);
					}

					class_2680 lv3 = this.method_20479(l, null);
					if (lv2 != null) {
						class_265 lv4 = this.method_20710(lv3, l, lv2);
						class_265 lv5 = this.method_20710(lv, m, lv2.method_10153());
						if (class_259.method_20713(lv4, lv5)) {
							return 15;
						}
					} else {
						class_265 lv4 = this.method_20710(lv3, l, class_2350.field_11033);
						if (class_259.method_20713(lv4, class_259.method_1073())) {
							return 15;
						}

						int u = bl ? -1 : 0;
						class_2350 lv6 = class_2350.method_16365(r, u, t);
						if (lv6 == null) {
							return 15;
						}

						class_265 lv7 = this.method_20710(lv, m, lv6.method_10153());
						if (class_259.method_20713(class_259.method_1073(), lv7)) {
							return 15;
						}
					}
