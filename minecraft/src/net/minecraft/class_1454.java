...
public class class_1454 extends class_1422 {
	...
	private static final Predicate<class_1309> field_6834 = arg -> {
		if (arg == null) {
			...
			return !(arg instanceof class_1657) || !arg.method_7325() && !((class_1657)arg).method_7337() ? arg.method_6046() != class_1310.field_6292 : false;
		}
	};

	public class_1454(class_1299<? extends class_1454> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public void method_6007() {
		super.method_6007();
		if (this.method_5805() && this.method_6594() > 0) {
