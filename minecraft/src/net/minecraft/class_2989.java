...
public class class_2989 extends class_4309 {
	...
	protected void method_20724(Map<class_2960, JsonObject> map, class_3300 arg, class_3695 arg2) {
		...
		map.forEach((argx, jsonObject) -> {
			try {
				class_161.class_162 lvxx = field_13405.fromJson(jsonObject, class_161.class_162.class);
				map2.put(argx, lvxx);
			} catch (IllegalArgumentException | JsonParseException var4xx) {
				field_13406.error("Parsing error loading custom advancement {}: {}", argx, var4xx.getMessage());
			}
		});
