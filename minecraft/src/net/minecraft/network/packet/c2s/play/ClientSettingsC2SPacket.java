...
public class ClientSettingsC2SPacket implements Packet<ServerPlayPacketListener> {
	...
	public ClientSettingsC2SPacket(
		String language, int viewDistance, ChatVisibility chatVisibility, boolean chatColors, int modelBitMask, Arm mainArm, boolean bl
	) {
	...
	public void read(PacketByteBuf buf) throws IOException {
		...
		this.field_26818 = buf.readBoolean();
	}
	...
	public void write(PacketByteBuf buf) throws IOException {
		...
		buf.writeBoolean(this.field_26818);
	}
	...
	public boolean method_31265() {
		return this.field_26818;
	}
}
