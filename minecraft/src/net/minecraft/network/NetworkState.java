...
public enum NetworkState {
	...
	GAME(0) {
		{
			...
			this.method_10784(NetworkSide.CLIENT, SetTradeOffersPacket.class);
			...
			this.method_10784(NetworkSide.CLIENT, ChunkRenderDistanceCenterS2CPacket.class);
			this.method_10784(NetworkSide.CLIENT, ChunkLoadDistanceS2CPacket.class);
			...
			this.method_10784(NetworkSide.SERVER, UpdateJigsawC2SPacket.class);
	...
	protected NetworkState method_10784(NetworkSide networkSide, Class<? extends Packet<?>> class_) {
		BiMap<Integer, Class<? extends Packet<?>>> biMap = (BiMap)this.packetHandlerMap.get(networkSide);
		if (biMap == null) {
	...
	public Packet<?> getPacketHandler(NetworkSide networkSide, int i) throws IllegalAccessException, InstantiationException {
		Class<? extends Packet<?>> class_ = (Class)((BiMap)this.packetHandlerMap.get(networkSide)).get(i);
