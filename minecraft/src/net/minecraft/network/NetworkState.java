...
public enum NetworkState {
	...
	static class InternalPacketHandler<T extends PacketListener> {
		...
		private final List<Function<PacketByteBuf, ? extends Packet<? super T>>> packetFactories = Lists.newArrayList();
		...
		public Packet<?> createPacket(int id, PacketByteBuf buf) {
			Function<PacketByteBuf, ? extends Packet<? super T>> function = (Function)this.packetFactories.get(id);
