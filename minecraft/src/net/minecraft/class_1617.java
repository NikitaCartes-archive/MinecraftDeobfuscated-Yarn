...
public abstract class class_1617 extends class_1543 {
	...
	protected class_1617(class_1299<? extends class_1617> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public boolean method_7137() {
		if (this.field_6002.field_9236) {
			return this.field_6011.method_12789(field_7373) > 0;
		} else {
			return this.field_7372 > 0;
		}
	}
	...
	public abstract class class_1620 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			class_1309 lv = class_1617.this.method_5968();
			if (lv == null || !lv.method_5805()) {
				return false;
			} else if (class_1617.this.method_7137()) {
				return false;
			} else {
				return class_1617.this.field_6012 >= this.field_7384;
			}
		}
		...
		public boolean method_6266() {
			class_1309 lv = class_1617.this.method_5968();
			return lv != null && lv.method_5805() && this.field_7385 > 0;
		}
