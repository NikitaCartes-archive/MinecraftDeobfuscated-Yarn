...
public class ConsumeItemCriterion implements Criterion<ConsumeItemCriterion.Conditions> {
	...
	public static class Conditions extends AbstractCriterionConditions {
		...
		public static ConsumeItemCriterion.Conditions method_8828(ItemConvertible itemConvertible) {
	...
	static class Handler {
		...
		public void handle(ItemStack itemStack) {
			...
			if (list != null) {
				for(Criterion.ConditionsContainer<ConsumeItemCriterion.Conditions> conditionsContainer : list) {
