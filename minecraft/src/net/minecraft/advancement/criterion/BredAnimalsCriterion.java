...
public class BredAnimalsCriterion implements Criterion<BredAnimalsCriterion.Conditions> {
	...
	public static class Conditions extends AbstractCriterionConditions {
		...
		public boolean method_862(
			...
			if (!this.field_1275.method_8914(serverPlayerEntity, passiveEntity)) {
				return false;
			} else {
				return this.field_1276.method_8914(serverPlayerEntity, animalEntity) && this.field_1277.method_8914(serverPlayerEntity, animalEntity2)
	...
	static class Handler {
		...
		public void method_858(
			...
			if (list != null) {
				for(Criterion.ConditionsContainer<BredAnimalsCriterion.Conditions> conditionsContainer : list) {
					conditionsContainer.apply(this.field_1274);
				}
			}
		}
	}
