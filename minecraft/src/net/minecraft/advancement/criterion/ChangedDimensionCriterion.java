...
public class ChangedDimensionCriterion implements Criterion<ChangedDimensionCriterion.Conditions> {
	...
	public static class Conditions extends AbstractCriterionConditions {
		...
		public boolean method_8800(DimensionType dimensionType, DimensionType dimensionType2) {
			if (this.field_9497 != null && this.field_9497 != dimensionType) {
				return false;
			} else {
				return this.field_9498 == null || this.field_9498 == dimensionType2;
			}
		}
	...
	static class Handler {
		...
		public void method_8797(DimensionType dimensionType, DimensionType dimensionType2) {
			...
			if (list != null) {
				for(Criterion.ConditionsContainer<ChangedDimensionCriterion.Conditions> conditionsContainer : list) {
					conditionsContainer.apply(this.field_9496);
				}
			}
		}
	}
