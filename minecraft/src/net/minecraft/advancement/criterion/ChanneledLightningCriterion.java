...
public class ChanneledLightningCriterion implements Criterion<ChanneledLightningCriterion.Conditions> {
	...
	public void beginTrackingCondition(
		PlayerAdvancementTracker manager, Criterion.ConditionsContainer<ChanneledLightningCriterion.Conditions> conditionsContainer
	) {
	...
	static class Handler {
		...
		public void handle(ServerPlayerEntity serverPlayerEntity, Collection<? extends Entity> collection) {
			...
			if (list != null) {
				for(Criterion.ConditionsContainer<ChanneledLightningCriterion.Conditions> conditionsContainer : list) {
