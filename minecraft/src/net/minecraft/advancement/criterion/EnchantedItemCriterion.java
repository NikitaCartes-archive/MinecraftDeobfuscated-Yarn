...
public class EnchantedItemCriterion implements Criterion<EnchantedItemCriterion.Conditions> {
	...
	public static class Conditions extends AbstractCriterionConditions {
		...
		public boolean method_8878(ItemStack itemStack, int i) {
			if (!this.field_9567.test(itemStack)) {
				return false;
			} else {
	...
	static class Handler {
		...
		public void method_8875(ItemStack itemStack, int i) {
			...
			if (list != null) {
				for(Criterion.ConditionsContainer<EnchantedItemCriterion.Conditions> conditionsContainer : list) {
					conditionsContainer.apply(this.field_9566);
				}
			}
		}
	}
