...
public class VillageManager {
	...
	private VillageManager.class_4152 field_18479 = VillageManager.class_4152.field_18482;
	...
	public VillageManager(ServerWorld serverWorld) {
		this.field_6727 = serverWorld;
	}

	public void tick() {
		if (this.field_6727.isDaylight()) {
			this.field_18479 = VillageManager.class_4152.field_18482;
			this.field_6725 = false;
		} else {
			float f = this.field_6727.getSkyAngle(0.0F);
			if ((double)f == 0.5) {
				this.field_18479 = this.field_6727.random.nextInt(10) == 0 ? VillageManager.class_4152.field_18481 : VillageManager.class_4152.field_18482;
			}

			if (this.field_18479 != VillageManager.class_4152.field_18482) {
				if (!this.field_6725) {
					if (!this.method_6446()) {
						return;
					}
