...
public class TraderRecipe {
	...
	public TraderRecipe(ItemStack itemStack, ItemStack itemStack2) {
		this(itemStack, ItemStack.EMPTY, itemStack2);
	}

	public TraderRecipe(ItemStack itemStack, ItemStack itemStack2, ItemStack itemStack3) {
		this(itemStack, itemStack2, itemStack3, 0, 7);
	}

	public TraderRecipe(ItemStack itemStack, ItemStack itemStack2, ItemStack itemStack3, int i, int j) {
