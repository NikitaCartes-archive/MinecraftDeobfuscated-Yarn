...
public class Trades {
				...
				copyToFastUtilMap(
					ImmutableMap.builder()
						...
						.put(
							2,
							new Trades.Factory[]{
								new Trades.class_4161(Items.field_8529, 4, 4, 10), new Trades.EnchantBookFactory(5), new Trades.class_4165(Items.LANTERN, 1, 1, 5)
							}
						)
						.put(
							3,
							new Trades.Factory[]{
								new Trades.class_4161(Items.field_8794, 5, 4, 20), new Trades.EnchantBookFactory(10), new Trades.class_4165(Items.GLASS, 1, 4, 10)
							}
						)
						.put(
							4,
	...
	static class class_4167 implements Trades.Factory {
		...
		public TraderRecipe method_7246(Entity entity, Random random) {
			...
			List<Potion> list = (List)Registry.POTION.stream().filter(potionx -> !potionx.getEffects().isEmpty()).collect(Collectors.toList());
