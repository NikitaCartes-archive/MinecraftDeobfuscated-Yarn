				...
				copyToFastUtilMap(
					ImmutableMap.builder()
						...
						.put(
							2,
							new Trades.Factory[]{
								new Trades.class_4161(Items.field_8529, 4, 6, 10), new Trades.EnchantBookFactory(5), new Trades.class_4165(Items.LANTERN, 1, 1, 5)
							}
						)
						.put(
							3,
							new Trades.Factory[]{
								new Trades.class_4161(Items.field_8794, 5, 6, 20), new Trades.EnchantBookFactory(10), new Trades.class_4165(Items.GLASS, 1, 4, 10)
							}
						)
						.put(
							4,
