...
public class Trades {
	...
	public static final Int2ObjectMap<Trades.Factory[]> WANDERING_TRADER_TRADES = copyToFastUtilMap(
		ImmutableMap.of(
			1,
			new Trades.Factory[]{
				new Trades.BuyOrSellOnPriceFactory(Items.SEA_PICKLE, new Trades.PriceRange(2, 2)),
				new Trades.BuyOrSellOnPriceFactory(Items.field_8777, new Trades.PriceRange(4, 4)),
				new Trades.BuyOrSellOnPriceFactory(Items.GLOWSTONE, new Trades.PriceRange(2, 2)),
				new Trades.BuyOrSellOnPriceFactory(Items.field_8864, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.FERN, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.SUGAR_CANE, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.PUMPKIN, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.KELP, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.CACTUS, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.DANDELION, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.POPPY, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.BLUE_ORCHID, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.ALLIUM, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.AZURE_BLUET, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.RED_TULIP, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.ORANGE_TULIP, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.WHITE_TULIP, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.PINK_TULIP, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.OXEYE_DAISY, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.CORNFLOWER, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.LILY_OF_THE_VALLEY, new Trades.PriceRange(1, 1)),
				...
				new Trades.BuyOrSellOnPriceFactory(Items.ACACIA_SAPLING, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.BIRCH_SAPLING, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.DARK_OAK_SAPLING, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.JUNGLE_SAPLING, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.OAK_SAPLING, new Trades.PriceRange(5, 5)),
				new Trades.BuyOrSellOnPriceFactory(Items.SPRUCE_SAPLING, new Trades.PriceRange(5, 5)),
				...
				new Trades.BuyOrSellOnPriceFactory(Items.BRAIN_CORAL_BLOCK, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.BUBBLE_CORAL_BLOCK, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.FIRE_CORAL_BLOCK, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.HORN_CORAL_BLOCK, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.TUBE_CORAL_BLOCK, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.VINE, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.BROWN_MUSHROOM, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.RED_MUSHROOM, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.LILY_PAD, new Trades.PriceRange(-2, -2)),
				new Trades.BuyOrSellOnPriceFactory(Items.SAND, new Trades.PriceRange(-8, -8)),
				new Trades.BuyOrSellOnPriceFactory(Items.RED_SAND, new Trades.PriceRange(-4, -4))
			},
			2,
			new Trades.Factory[]{
				...
				new Trades.BuyOrSellOnPriceFactory(Items.PACKED_ICE, new Trades.PriceRange(3, 3)),
				new Trades.BuyOrSellOnPriceFactory(Items.BLUE_ICE, new Trades.PriceRange(6, 6)),
				new Trades.BuyOrSellOnPriceFactory(Items.field_8054, new Trades.PriceRange(1, 1)),
				new Trades.BuyOrSellOnPriceFactory(Items.PODZOL, new Trades.PriceRange(3, 3))
			}
		)
	);
