...
public class class_1440 extends class_1429 {
	...
	public class_1440(class_1299<? extends class_1440> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public boolean method_18397(class_1799 arg) {
		...
		if (!this.method_6118(lv).method_7960()) {
			return false;
		} else {
			return lv == class_1304.field_6173 && super.method_18397(arg);
		}
	}
	...
	public void method_6529(class_1440.class_1443 arg) {
		if (arg.method_6564() > 6) {
			arg = class_1440.class_1443.method_17688(this.field_5974);
		}
	...
	public class_1296 method_5613(class_1296 arg) {
		class_1440 lv = class_1299.field_6146.method_5883(this.field_6002);
	...
	protected void method_5959() {
		...
		this.field_6201.method_6277(3, new class_1440.class_4054(this, 1.2F, true));
		...
		this.field_6201.method_6277(9, new class_1440.class_4056(this, class_1657.class, 6.0F));
	...
	public void method_5773() {
		super.method_5773();
		if (this.method_6509()) {
			if (this.field_6002.method_8546() && !this.method_5799()) {
		...
		if (this.field_6767 > 32) {
			...
			if (!this.field_6002.field_9236) {
				...
				if (this.field_6767 == 1) {
					...
					this.field_18277 = new class_243(lv.field_1352 + (double)(-class_3532.method_15374(f) * g), 0.0, lv.field_1350 + (double)(class_3532.method_15362(f) * g));
					this.method_18799(this.field_18277.method_1031(0.0, 0.27, 0.0));
				} else if ((float)this.field_6767 != 7.0F && (float)this.field_6767 != 15.0F && (float)this.field_6767 != 23.0F) {
					this.method_18800(this.field_18277.field_1352, lv.field_1351, this.field_18277.field_1350);
				} else {
					this.method_18800(0.0, this.field_5952 ? 0.27 : lv.field_1351, 0.0);
				}
			}
		}
	}
	...
	private void method_6548() {
		...
		this.field_6002
			.method_8406(
				...
				this.field_5987 - (double)(this.method_17681() + 1.0F) * 0.5 * (double)class_3532.method_15374(this.field_6283 * (float) (Math.PI / 180.0)),
				this.field_6010 + (double)this.method_5751() - 0.1F,
				this.field_6035 + (double)(this.method_17681() + 1.0F) * 0.5 * (double)class_3532.method_15362(this.field_6283 * (float) (Math.PI / 180.0)),
				lv.field_1352,
				0.0,
				lv.field_1350
			);
		...
		for(class_1440 lv2 : this.field_6002.method_18467(class_1440.class, this.method_5829().method_1014(10.0))) {
			if (!lv2.method_6109() && lv2.field_5952 && !lv2.method_5799() && lv2.method_18442()) {
				lv2.method_6043();
			}
		}

		if (!this.field_6002.method_8608() && this.field_5974.nextInt(700) == 0 && this.field_6002.method_8450().method_8355(class_1928.field_19391)) {
	...
	public class_1315 method_5943(class_1936 arg, class_1266 arg2, class_3730 arg3, @Nullable class_1315 arg4, @Nullable class_2487 arg5) {
		...
		this.method_6529(class_1440.class_1443.method_17688(this.field_5974));
		this.method_6547(class_1440.class_1443.method_17688(this.field_5974));
		this.method_6538();
		if (arg4 instanceof class_1440.class_4055) {
			if (this.field_5974.nextInt(5) == 0) {
				this.method_5614(-24000);
			}
		} else {
			arg4 = new class_1440.class_4055();
		}
	...
	public boolean method_5992(class_1657 arg, class_1268 arg2) {
		...
		if (lv.method_7909() instanceof class_1826) {
			...
			if (this.method_6109()) {
				...
				if (this.field_6002.field_9236 || this.method_6535() || this.method_5799()) {
					return false;
				}
	...
	static class class_1441<T extends class_1309> extends class_1338<T> {
		private final class_1440 field_6782;

		public class_1441(class_1440 arg, Class<T> class_, float f, double d, double e) {
			super(arg, class_, f, d, e, class_1301.field_6155::test);
			this.field_6782 = arg;
		}

		@Override
		public boolean method_6264() {
			return this.field_6782.method_6509() && this.field_6782.method_18442() && super.method_6264();
		}
	}
			...
			if (!super.method_6264() || this.field_6784.method_6521() != 0) {
				...
				if (this.field_6783 <= this.field_6784.field_6012) {
					...
					if (this.field_6784.method_6034()) {
						class_1657 lv = this.field_6405.method_18462(field_18115, this.field_6784);
	...
	public static enum class_1443 {
		...
		private static final class_1440.class_1443[] field_6786 = (class_1440.class_1443[])Arrays.stream(values())
			...
			.toArray(i -> new class_1440.class_1443[i]);
		...
		public static class_1440.class_1443 method_17688(Random random) {
	...
	static class class_1445 extends class_1352 {
		...
		public boolean method_6264() {
			return this.field_6799 < this.field_6800.field_6012
				...
				&& this.field_6800.method_18442()
				&& this.field_6800.field_5974.nextInt(400) == 1;
		}

		@Override
		public boolean method_6266() {
			if (!this.field_6800.method_5799() && (this.field_6800.method_6549() || this.field_6800.field_5974.nextInt(600) != 1)) {
				return this.field_6800.field_5974.nextInt(2000) != 1;
			} else {
				return false;
			}
		}
	...
	static class class_1446 extends class_1335 {
		...
		public void method_6240() {
			if (this.field_6801.method_18442()) {
				super.method_6240();
			}
		}
	}
	...
	static class class_1448 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			if ((this.field_6803.method_6109() || this.field_6803.method_6522()) && this.field_6803.field_5952) {
				if (!this.field_6803.method_18442()) {
					...
					if (this.field_6803.field_6002.method_8320(new class_2338(this.field_6803).method_10069(i, -1, j)).method_11588()) {
						return true;
					} else if (this.field_6803.method_6522() && this.field_6803.field_5974.nextInt(60) == 1) {
						return true;
					} else {
						return this.field_6803.field_5974.nextInt(500) == 1;
					}
				}
			} else {
				return false;
	...
	class class_1449 extends class_1352 {
		...
		@Override
		public boolean method_6266() {
			if (!class_1440.this.method_5799() && (class_1440.this.method_6549() || class_1440.this.field_5974.nextInt(600) != 1)) {
				return class_1440.this.field_5974.nextInt(2000) != 1;
			} else {
				return false;
			}
		}
	...
	static class class_1450 extends class_1352 {
		...
		@Override
		public boolean method_6264() {
			if (this.field_6806.method_6109() && this.field_6806.method_18442()) {
				if (this.field_6806.method_6550() && this.field_6806.field_5974.nextInt(500) == 1) {
					return true;
				} else {
					return this.field_6806.field_5974.nextInt(6000) == 1;
				}
			} else {
				return false;
			}
	...
	static class class_4054 extends class_1366 {
		private final class_1440 field_18114;

		public class_4054(class_1440 arg, double d, boolean bl) {
			super(arg, d, bl);
			this.field_18114 = arg;
		}

		@Override
		public boolean method_6264() {
			return this.field_18114.method_18442() && super.method_6264();
		}
	}

	static class class_4055 implements class_1315 {
		private class_4055() {
		}
	}

	static class class_4056 extends class_1361 {
		private final class_1440 field_18116;

		public class_4056(class_1440 arg, Class<? extends class_1309> class_, float f) {
			super(arg, class_, f);
			this.field_18116 = arg;
		}

		@Override
		public boolean method_6264() {
			return this.field_18116.method_18442() && super.method_6264();
		}
	}
}
