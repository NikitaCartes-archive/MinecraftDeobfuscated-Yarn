...
public class class_1341 extends class_1352 {
	...
	private class_1429 method_6250() {
		List<class_1429> list = this.field_6405.method_8403(this.field_6403, this.field_6404.method_5829().method_1014(8.0));
	...
	protected void method_6251(Random random) {
		for(int i = 0; i < 7; ++i) {
			...
			double g = random.nextDouble() * (double)this.field_6404.field_5998 * 2.0 - (double)this.field_6404.field_5998;
			double h = 0.5 + random.nextDouble() * (double)this.field_6404.field_6019;
			double j = random.nextDouble() * (double)this.field_6404.field_5998 * 2.0 - (double)this.field_6404.field_5998;
			this.field_6405
				.method_8406(class_2398.field_11201, this.field_6404.field_5987 + g, this.field_6404.field_6010 + h, this.field_6404.field_6035 + j, d, e, f);
		}
	}
}
