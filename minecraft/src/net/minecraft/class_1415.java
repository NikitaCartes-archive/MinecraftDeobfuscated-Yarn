...
public class class_1415 {
	...
	private final Map<String, Integer> field_6702 = Maps.newHashMap();
	...
	private boolean method_6406(class_2338 arg) {
		if (!this.field_6701.method_8393(arg.method_10263() >> 4, arg.method_10260() >> 4)) {
			...
			if (lv2 instanceof class_2323) {
				return lv.method_11620() == class_3614.field_15932;
			} else {
				return false;
			}
		}
		...
		for(String string : this.field_6702.keySet()) {
			...
			try {
				...
				if (gameProfile != null) {
					...
					lv5.method_10569("S", this.field_6702.get(string));
