...
public class class_31 {
	...
	private final Set<String> field_155 = Sets.newHashSet();
	private final Set<String> field_171 = Sets.newLinkedHashSet();
	...
	public void method_140(class_1940 arg) {
		...
		this.method_175(Dynamic.convert(JsonOps.INSTANCE, class_2509.field_11560, arg.method_8584()));
	...
	private void method_185() {
		if (!this.field_172 && this.field_170 != null) {
			if (this.field_196 < class_155.method_16673().getWorldVersion()) {
				...
				this.field_170 = class_2512.method_10688(this.field_184, class_4284.field_19213, this.field_170, this.field_196);
			}
	...
	public void method_151(class_129 arg) {
		arg.method_577("Level name", () -> this.field_169);
		arg.method_577("Level seed", () -> String.valueOf(this.field_153));
		arg.method_577(
			"Level generator",
			() -> String.format(
