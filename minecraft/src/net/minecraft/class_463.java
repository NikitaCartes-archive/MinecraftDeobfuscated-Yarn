...
public abstract class class_463 extends class_437 {
	...
	protected final List<String> field_2761 = Lists.newArrayList();
	...
	protected void init() {
		...
		this.field_2753 = this.addButton(
			new class_4185(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, class_1074.method_4662("gui.cancel"), arg -> this.method_2358())
		);
		...
		this.field_2751 = new class_342(this.font, this.width / 2 - 150, 50, 300, 20);
		...
		this.field_2755 = new class_342(this.font, this.width / 2 - 150, this.method_2364(), 276, 20);
	...
	class class_464 {
			...
			if (bl3) {
				...
				if (bl2) {
					for(int n = 0; n < this.field_2771.method_3319(); ++n) {
						if (n % 2 == 0) {
							class_332.fill(
								this.field_2771.method_3321() + n,
								this.field_2771.method_3322() + this.field_2771.method_3320(),
								this.field_2771.method_3321() + n + 1,
								this.field_2771.method_3322() + this.field_2771.method_3320() + 1,
								-1
							);
						}
		...
		public void method_2374(int i) {
			...
			if (this.field_2766 < 0) {
				this.field_2766 += this.field_2764.getList().size();
			}
