...
public class class_3821 {
	...
	public static <T> class_3821 method_16765(Dynamic<T> dynamic) {
		Dynamic<T> dynamic2 = (Dynamic)dynamic.get("input_predicate").orElse(dynamic.emptyMap());
		Dynamic<T> dynamic3 = (Dynamic)dynamic.get("location_predicate").orElse(dynamic.emptyMap());
