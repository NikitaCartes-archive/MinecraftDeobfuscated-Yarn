		...
		if (this.minecraft.field_1687 != null) {
			...
			if (this.minecraft.method_1496() && !this.minecraft.field_1687.method_8401().method_152()) {
				...
				this.field_2503 = this.addButton(
					new class_347(
						this.field_2500.field_23658 + this.field_2500.getWidth(),
						this.field_2500.field_23659,
						arg -> this.minecraft
								.method_1507(
									new class_410(
										this::method_20374,
										...
										new class_2588(
											"difficulty.lock.question", new class_2588("options.difficulty." + this.minecraft.field_1687.method_8401().method_207().method_5460())
										)
									)
								)
					)
