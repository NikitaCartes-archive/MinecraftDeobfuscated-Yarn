...
public class class_4384 extends RealmsScreen {
	...
	public void method_21178() {
		for(Entry<Integer, RealmsWorldOptions> entry : this.field_19766.slots.entrySet()) {
			...
			boolean bl = entry.getKey() != this.field_19766.activeSlot || this.field_19766.worldType.equals(RealmsServer.class_4321.MINIGAME);
			RealmsButton realmsButton;
			if (bl) {
				realmsButton = new class_4384.class_4386(
					field_19774.get(entry.getKey() - 1), this.method_21179(entry.getKey()), getLocalizedString("mco.brokenworld.play")
				);
			} else {
				realmsButton = new class_4384.class_4385(
					field_19776.get(entry.getKey() - 1), this.method_21179(entry.getKey()), getLocalizedString("mco.brokenworld.download")
				);
			}
			...
			this.buttonsAdd(
				new RealmsButton(
					field_19775.get(entry.getKey() - 1), this.method_21179(entry.getKey()), class_4359.method_21072(10), 80, 20, getLocalizedString("mco.brokenworld.reset")
				) {
					@Override
					public void onPress() {
		...
		if (this.field_19766 != null) {
			for(Entry<Integer, RealmsWorldOptions> entry : this.field_19766.slots.entrySet()) {
				if (((RealmsWorldOptions)entry.getValue()).templateImage != null && ((RealmsWorldOptions)entry.getValue()).templateId != -1L) {
					this.method_21180(
						this.method_21179(entry.getKey()),
						class_4359.method_21072(1) + 5,
						i,
						j,
						this.field_19766.activeSlot == entry.getKey() && !this.method_21196(),
	...
	private void method_21187(int i) {
		...
		try {
			...
			class_4392 lv2 = new class_4392(
				this, worldDownload, this.field_19766.name + " (" + ((RealmsWorldOptions)this.field_19766.slots.get(i)).getSlotName(i) + ")"
			);
