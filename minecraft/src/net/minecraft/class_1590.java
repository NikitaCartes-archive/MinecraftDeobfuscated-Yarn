...
public class class_1590 extends class_1642 {
	...
	public class_1590(class_1299<? extends class_1590> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	protected void method_5958() {
		...
		if (this.method_7079()) {
			...
			this.field_7309--;
			class_1309 lv3 = lv2 != null ? lv2 : this.method_5968();
			if (!this.method_7079() && lv3 != null) {
				if (!this.method_6057(lv3)) {
					this.method_6015(null);
					this.method_5980(null);
				} else {
					this.field_7309 = this.method_20806();
				}
			}
		...
		if (this.method_7079() && this.field_7310 != null && lv2 == null) {
			class_1657 lv4 = this.field_6002.method_18470(this.field_7310);
			this.method_6015(lv4);
			this.field_6258 = lv4;
	...
	public static boolean method_20682(class_1299<class_1590> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
	...
	public void method_5749(class_2487 arg) {
		...
		if (!string.isEmpty()) {
			...
			class_1657 lv = this.field_6002.method_18470(this.field_7310);
			this.method_6015(lv);
			if (lv != null) {
				this.field_6258 = lv;
				this.field_6238 = this.method_6117();
	...
	public boolean method_5643(class_1282 arg, float f) {
		if (this.method_5679(arg)) {
			...
			if (lv instanceof class_1657 && !((class_1657)lv).method_7337() && this.method_6057(lv)) {
				this.method_20804(lv);
			}
	...
	private boolean method_20804(class_1297 arg) {
		this.field_7309 = this.method_20806();
	...
	private int method_20806() {
		return 400 + this.field_5974.nextInt(400);
	}

	private boolean method_7079() {
	...
	static class class_1592 extends class_1399 {
		...
		protected void method_6319(class_1308 arg, class_1309 arg2) {
			if (arg instanceof class_1590 && this.field_6660.method_6057(arg2) && ((class_1590)arg).method_20804(arg2)) {
