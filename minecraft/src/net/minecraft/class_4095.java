...
public class class_4095<E extends class_1309> implements class_4213 {
	private final Map<class_4140<?>, Optional<?>> field_18322 = Maps.newHashMap();
	...
	private long field_18853 = -9999L;
	...
	public <U> void method_18875(class_4140<U> arg) {
	...
	public boolean method_18876(class_4140<?> arg, class_4141 arg2) {
		...
		if (optional == null) {
			...
			return arg2 == class_4141.field_18458 || arg2 == class_4141.field_18456 && optional.isPresent() || arg2 == class_4141.field_18457 && !optional.isPresent();
		}
	}
	...
	public void method_18882(
		class_4168 arg, ImmutableList<Pair<Integer, ? extends class_4097<? super E>>> immutableList, Set<Pair<class_4140<?>, class_4141>> set
	) {
	...
	public <T> T method_19508(DynamicOps<T> dynamicOps) {
		T object = dynamicOps.createMap(
			(Map<T, T>)this.field_18322
				...
				.map(
					entry -> Pair.of(
							dynamicOps.createString(class_2378.field_18793.method_10221((class_4140<?>)entry.getKey()).toString()),
	...
	private void method_19544(class_3218 arg, E arg2) {
		this.field_18323.values().forEach(arg3 -> arg3.method_19100(arg, arg2));
	}
