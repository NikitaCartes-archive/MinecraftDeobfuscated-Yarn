...
public class class_3244 implements class_2792, class_3000 {
	...
	private final class_3525<Short> field_14132 = new class_3525();
	...
	public void method_14367(class_2561 arg) {
		...
		this.field_14148.method_5382(this.field_14127::method_10768).join();
	}
	...
	private static boolean method_14362(class_2828 arg) {
		if (Doubles.isFinite(arg.method_12269(0.0))
			...
			return Math.abs(arg.method_12269(0.0)) > 3.0E7 || Math.abs(arg.method_12268(0.0)) > 3.0E7 || Math.abs(arg.method_12274(0.0)) > 3.0E7;
		} else {
			return true;
		}
	}
	...
	public void method_12078(class_2833 arg) {
		...
		if (method_14371(arg)) {
			...
			if (lv != this.field_14140 && lv.method_5642() == this.field_14140 && lv == this.field_14147) {
				...
				double o = lv.field_5967 * lv.field_5967 + lv.field_5984 * lv.field_5984 + lv.field_6006 * lv.field_6006;
				double p = l * l + m * m + n * n;
				if (p - o > 100.0 && (!this.field_14148.method_3724() || !this.field_14148.method_3811().equals(lv.method_5477().getString()))) {
				...
				lv.method_5784(class_1313.field_6305, l, m, n);
				l = g - lv.field_5987;
				m = h - lv.field_6010;
				if (m > -0.5 || m < 0.5) {
					m = 0.0;
				...
				this.field_14148.method_3760().method_14575(this.field_14140);
	...
	public void method_12047(class_2853 arg) {
		...
		if (arg.method_12402() == class_2853.class_2854.field_13011) {
			class_1860 lv = this.field_14148.method_3772().method_8130(arg.method_12406());
			if (lv != null) {
				this.field_14140.method_14253().method_14886(lv);
			}
				...
				if (lv.method_7909() == class_1802.field_8674 && lv2.method_7909() == class_1802.field_8674) {
					if (arg.method_12238()) {
						...
						for(int i = 0; i < lv5.size(); ++i) {
							...
							lv5.method_10531(i, new class_2519(string));
						}
			...
			if (!this.field_14140.field_13989) {
				...
				if (this.field_14119 != null) {
					...
					if (this.field_14140.method_5765()) {
						...
						double p = this.field_14140.field_5967 * this.field_14140.field_5967
							+ this.field_14140.field_5984 * this.field_14140.field_5984
							+ this.field_14140.field_6006 * this.field_14140.field_6006;
						...
						if (this.field_14140.method_6113()) {
							...
							if (!this.field_14140.method_14208()
								&& (!this.field_14140.method_14220().method_8450().method_8355("disableElytraMovementCheck") || !this.field_14140.method_6128())) {
								float s = this.field_14140.method_6128() ? 300.0F : 100.0F;
								if (q - p > (double)(s * (float)r)
									&& (!this.field_14148.method_3724() || !this.field_14148.method_3811().equals(this.field_14140.method_7334().getName()))) {
							...
							boolean bl = lv.method_8587(this.field_14140, this.field_14140.method_5829().method_1011(0.0625));
							...
							this.field_14140.method_5784(class_1313.field_6305, m, n, o);
							...
							if (!this.field_14140.field_5960 && !this.field_14140.method_6113()) {
								boolean bl3 = lv.method_8587(this.field_14140, this.field_14140.method_5829().method_1011(0.0625));
								if (bl && (bl2 || !bl3)) {
	...
	public void method_12046(class_2885 arg) {
		...
		class_2338 lv4 = arg.method_12548();
		class_2350 lv5 = arg.method_12545();
		this.field_14140.method_14234();
		if (lv4.method_10264() < this.field_14148.method_3833() - 1 || lv5 != class_2350.field_11036 && lv4.method_10264() < this.field_14148.method_3833()) {
			if (this.field_14119 == null
				&& this.field_14140.method_5649((double)lv4.method_10263() + 0.5, (double)lv4.method_10264() + 0.5, (double)lv4.method_10260() + 0.5) < 64.0
				&& !this.field_14148.method_3785(lv, lv4, this.field_14140)
				&& lv.method_8621().method_11952(lv4)) {
				this.field_14140.field_13974.method_14262(this.field_14140, lv, lv3, lv2, lv4, lv5, arg.method_12549(), arg.method_12543(), arg.method_12544());
			}
		} else {
			class_2561 lv6 = new class_2588("build.tooHigh", this.field_14148.method_3833()).method_10854(class_124.field_1061);
			this.field_14140.field_13987.method_14364(new class_2635(lv6, class_2556.field_11733));
		}

		this.field_14140.field_13987.method_14364(new class_2626(lv, lv4));
		this.field_14140.field_13987.method_14364(new class_2626(lv, lv4.method_10093(lv5)));
	}
	...
	public void method_12073(class_2884 arg) {
		...
		if (this.field_14140.method_7325()) {
			...
			for(class_3218 lv2 : this.field_14148.method_3738()) {
				lv = arg.method_12541(lv2);
				if (lv != null) {
					break;
				}
			}
			...
			if (lv != null) {
				this.field_14140.method_14251((class_3218)lv.field_6002, lv.field_5987, lv.field_6010, lv.field_6035, lv.field_6031, lv.field_5965);
			}
		}
	}
	...
	public void method_10839(class_2561 arg) {
		...
		if (this.field_14148.method_3724() && this.field_14140.method_5477().getString().equals(this.field_14148.method_3811())) {
	...
	public void method_14369(class_2596<?> arg, @Nullable GenericFutureListener<? extends Future<? super Void>> genericFutureListener) {
		if (arg instanceof class_2635) {
			...
			class_1657.class_1659 lv2 = this.field_14140.method_14238();
			if (lv2 == class_1657.class_1659.field_7536 && lv.method_11389() != class_2556.field_11733) {
				return;
			}

			if (lv2 == class_1657.class_1659.field_7539 && !lv.method_11387()) {
				return;
			}
		}
	...
	public void method_12048(class_2797 arg) {
		class_2600.method_11073(arg, this, this.field_14140.method_14220());
		if (this.field_14140.method_14238() == class_1657.class_1659.field_7536) {
	...
	public void method_12045(class_2848 arg) {
		...
		switch(arg.method_12365()) {
			...
			case field_12988:
				...
				break;
			case field_12982:
				if (!this.field_14140.field_5952 && this.field_14140.field_5984 < 0.0 && !this.field_14140.method_6128() && !this.field_14140.method_5799()) {
			...
			case field_12774:
				if (this.field_14140.field_13989) {
					...
					if (this.field_14148.method_3754()) {
						...
						this.field_14140.method_14220().method_8450().method_8359("spectatorsGenerateChunks", "false", this.field_14148);
					}
				}
				break;
			case field_12775:
		...
		if (this.field_14140.field_7512.field_7763 == arg.method_12194() && this.field_14140.field_7512.method_7622(this.field_14140)) {
			if (this.field_14140.method_7325()) {
				...
				if (class_1799.method_7973(arg.method_12190(), lv2)) {
					...
					this.field_14132.method_15313(this.field_14140.field_7512.field_7763, arg.method_12189());
	...
	public void method_12061(class_2840 arg) {
		...
		if (!this.field_14140.method_7325()
			...
			class_1860 lv = this.field_14148.method_3772().method_8130(arg.method_12320());
			if (this.field_14140.field_7512 instanceof class_3858) {
				new class_2958().method_12826(this.field_14140, lv, arg.method_12319());
			} else {
				new class_2955().method_12826(this.field_14140, lv, arg.method_12319());
			}
		}
	}
	...
	public void method_12079(class_2809 arg) {
		class_2600.method_11073(arg, this, this.field_14140.method_14220());
		Short short_ = (Short)this.field_14132.method_15316(this.field_14140.field_7512.field_7763);
		if (short_ != null
			&& arg.method_12176() == short_
			&& this.field_14140.field_7512.field_7763 == arg.method_12178()
			&& !this.field_14140.field_7512.method_7622(this.field_14140)
			&& !this.field_14140.method_7325()) {
	...
	public void method_12082(class_2827 arg) {
		...
		} else if (!this.field_14140.method_5477().getString().equals(this.field_14148.method_3811())) {
			this.method_14367(new class_2588("disconnect.timeout"));
		}
	}
