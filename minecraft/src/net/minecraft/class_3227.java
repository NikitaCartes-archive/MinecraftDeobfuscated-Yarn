...
public class class_3227 extends class_3568 implements AutoCloseable {
	...
	public void method_15559(class_2338 arg) {
		...
		this.method_17308(
			...
			class_156.method_18839(() -> super.method_15559(lv), () -> "checkBlock " + lv)
		);
	}

	protected void method_20386(class_1923 arg) {
		this.method_17307(arg.field_9181, arg.field_9180, () -> 0, class_3227.class_3901.field_17261, class_156.method_18839(() -> {
			super.method_20601(arg, false);
			super.method_15557(arg, false);

			for(int i = -1; i < 17; ++i) {
				super.method_15558(class_1944.field_9282, class_4076.method_18681(arg, i), null);
				super.method_15558(class_1944.field_9284, class_4076.method_18681(arg, i), null);
			}

			for(int i = 0; i < 16; ++i) {
				super.method_15551(class_4076.method_18681(arg, i), true);
			}
	...
	public void method_15557(class_1923 arg, boolean bl) {
		this.method_17308(
			...
			arg.field_9180,
			class_3227.class_3901.field_17261,
			class_156.method_18839(() -> super.method_15557(arg, bl), () -> "enableLight " + arg + " " + bl)
		);
	}
	...
	public CompletableFuture<class_2791> method_17310(class_2791 arg, boolean bl) {
		...
		this.method_17308(lv.field_9181, lv.field_9180, class_3227.class_3901.field_17261, class_156.method_18839(() -> {
			...
			for(int i = 0; i < 16; ++i) {
				class_2826 lvxx = lvs[i];
				if (!class_2826.method_18090(lvxx)) {
					super.method_15551(class_4076.method_18681(lv, i), false);
				}
			}

			super.method_15557(lv, true);
			if (!bl) {
				arg.method_12018().forEach(arg2 -> super.method_15560(arg2, arg.method_8317(arg2)));
			}

			this.field_17257.method_20441(lv);
		}, () -> "lightChunk " + lv + " " + bl));
		return CompletableFuture.supplyAsync(() -> {
			arg.method_12020(true);
			super.method_20601(lv, false);
			return arg;
		}, runnable -> this.method_17308(lv.field_9181, lv.field_9180, class_3227.class_3901.field_17262, runnable));
	}
	...
	private void method_14277() {
		...
		for(j = 0; objectListIterator.hasNext() && j < i; ++j) {
			Pair<class_3227.class_3901, Runnable> pair = (Pair)objectListIterator.next();
