...
public class class_1894 extends class_1887 {
	...
	public static void method_8236(class_1309 arg, class_1937 arg2, class_2338 arg3, int i) {
		if (arg.field_5952) {
			...
			for(class_2338 lv3 : class_2338.method_10097(arg3.method_10080((double)(-f), -1.0, (double)(-f)), arg3.method_10080((double)f, -1.0, (double)f))) {
				if (lv3.method_19769(arg.method_19538(), (double)f)) {
					...
					if (lv4.method_11588()) {
						...
						if (lv5.method_11620() == class_3614.field_15920
							&& lv5.method_11654(class_2404.field_11278) == 0
							&& lv.method_11591(arg2, lv3)
							&& arg2.method_8628(lv, lv3, class_3726.method_16194())) {
							arg2.method_8501(lv3, lv);
							arg2.method_8397().method_8676(lv3, class_2246.field_10110, class_3532.method_15395(arg.method_6051(), 60, 120));
						}
					}
				}
			}
