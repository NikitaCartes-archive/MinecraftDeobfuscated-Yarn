...
public abstract class class_1425 extends class_1422 {
	...
	public class_1425(class_1299<?> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public void method_5773() {
		...
		if (this.method_6467() && this.field_6002.field_9229.nextInt(200) == 1) {
			List<class_1422> list = this.field_6002.method_8403(this.getClass(), this.method_5829().method_1009(8.0, 8.0, 8.0));
			if (list.size() <= 1) {
				this.field_6733 = 1;
			}
		}
