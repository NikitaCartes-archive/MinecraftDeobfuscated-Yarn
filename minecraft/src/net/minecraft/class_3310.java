...
public class class_3310 extends class_3031<class_3666> {
	...
	public static List<class_3310.class_3181> method_14506(class_1936 arg) {
		...
		return (List<class_3310.class_3181>)field_14309.getUnchecked(l);
	}
	...
	public boolean method_15887(class_1936 arg, class_2794<? extends class_2888> arg2, Random random, class_2338 arg3, class_3666 arg4) {
		...
		for(class_3310.class_3181 lv : list) {
			if (lv.method_13962(arg3)) {
				this.method_15888(arg, random, arg3, arg4, lv);
			}
		}
	...
	private void method_15888(class_1936 arg, Random random, class_2338 arg2, class_3666 arg3, class_3310.class_3181 arg4) {
		int i = arg4.method_13963();

		for(class_2338.class_2339 lv : class_2338.method_10082(
			new class_2338(arg2.method_10263() - i, 0, arg2.method_10260() - i),
			new class_2338(arg2.method_10263() + i, arg4.method_13964() + 10, arg2.method_10260() + i)
		)) {
			if (lv.method_10261((double)arg2.method_10263(), (double)lv.method_10264(), (double)arg2.method_10260()) <= (double)(i * i + 1)
				&& lv.method_10264() < arg4.method_13964()) {
				...
				for(int n = -2; n <= 2; ++n) {
					for(int o = 0; o <= 3; ++o) {
						...
						if (bl || bl2 || bl3) {
							...
							this.method_13153(arg, lv2.method_10103(arg2.method_10263() + m, arg4.method_13964() + o, arg2.method_10260() + n), lv3);
						}
					}
				}
			}
		...
		class_1511 lv4 = new class_1511(arg.method_8410());
		lv4.method_6837(arg3.method_15884());
		lv4.method_5684(arg3.method_15883());
		lv4.method_5808(
			(double)((float)arg2.method_10263() + 0.5F),
			(double)(arg4.method_13964() + 1),
			(double)((float)arg2.method_10260() + 0.5F),
			random.nextFloat() * 360.0F,
			0.0F
		);
		arg.method_8649(lv4);
		this.method_13153(arg, new class_2338(arg2.method_10263(), arg4.method_13964(), arg2.method_10260()), class_2246.field_9987.method_9564());
	}
	...
	public static class class_3181 {
		...
		public boolean method_13962(class_2338 arg) {
			int i = this.field_13836 - this.field_13833;
			int j = this.field_13834 - this.field_13833;
			return arg.method_10263() == (i & -16) && arg.method_10260() == (j & -16);
		}
	...
	static class class_3311 extends CacheLoader<Long, List<class_3310.class_3181>> {
		...
		public List<class_3310.class_3181> method_14507(Long long_) throws Exception {
