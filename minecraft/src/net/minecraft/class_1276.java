...
public class class_1276 {
	private final Map<String, Object> field_5825 = Maps.newHashMap();
	private final Map<String, Object> field_5826 = Maps.newHashMap();
	...
	public Map<String, String> method_5486() {
		Map<String, String> map = Maps.newLinkedHashMap();
		synchronized(this.field_5824) {
			this.method_5485();

			for(Entry<String, Object> entry : this.field_5825.entrySet()) {
				map.put(entry.getKey(), entry.getValue().toString());
			}

			for(Entry<String, Object> entry : this.field_5826.entrySet()) {
				map.put(entry.getKey(), entry.getValue().toString());
			}
