...
public class class_4041<T extends class_4019> extends class_583<T> {
	private final class_630 field_18015;
	...
	public class_4041() {
		...
		this.field_18015.method_2844(-5.0F, -2.0F, -5.0F, 8, 6, 6);
		this.field_18015.method_2851(-1.0F, 16.5F, -3.0F);
		this.field_18016 = new class_630(this, 8, 1);
		this.field_18016.method_2844(-5.0F, -4.0F, -4.0F, 2, 2, 1);
		this.field_18017 = new class_630(this, 15, 1);
		this.field_18017.method_2844(1.0F, -4.0F, -4.0F, 2, 2, 1);
		this.field_18018 = new class_630(this, 6, 18);
		this.field_18018.method_2844(-3.0F, 2.01F, -8.0F, 4, 2, 3);
	...
	public void method_18330(T arg, float f, float g, float h) {
		...
		if (arg.method_18276()) {
			...
			this.field_18019.method_2851(0.0F, 19.0F + arg.method_18300(h), -6.0F);
			this.field_18024.field_3654 = (float) (-Math.PI * 5.0 / 6.0);
			if (this.field_3448) {
				this.field_18024.field_3654 = -2.1816616F;
				this.field_18019.method_2851(0.0F, 19.0F + arg.method_18300(h), -2.0F);
			}
