...
public class class_1564 extends class_1617 {
	...
	public class_1564(class_1299<? extends class_1564> arg, class_1937 arg2) {
		super(arg, arg2);
		this.field_6194 = 10;
	}
	...
	class class_1565 extends class_1617.class_1620 {
		...
		private void method_7044(double d, double e, double f, double g, float h, int i) {
			...
			do {
				...
				class_2680 lv3 = class_1564.this.field_6002.method_8320(lv2);
				if (class_2248.method_20045(lv3, class_1564.this.field_6002, lv2, class_2350.field_11036)) {
					if (!class_1564.this.field_6002.method_8623(lv)) {
						class_2680 lv4 = class_1564.this.field_6002.method_8320(lv);
						class_265 lv5 = lv4.method_11628(class_1564.this.field_6002, lv);
						if (!lv5.method_1110()) {
							j = lv5.method_1105(class_2350.class_2351.field_11052);
						}
					}
			...
			if (bl) {
				class_1564.this.field_6002.method_8649(new class_1669(class_1564.this.field_6002, d, (double)lv.method_10264() + j, e, h, i, class_1564.this));
			}
		}
	...
	class class_1567 extends class_1617.class_1620 {
		...
		public boolean method_6264() {
			if (!super.method_6264()) {
				...
				int i = class_1564.this.field_6002
					.method_18466(class_1634.class, this.field_18129, class_1564.this, class_1564.this.method_5829().method_1014(16.0))
					.size();
		...
		protected void method_7148() {
			for (int i = 0; i < 3; i++) {
				...
				class_1634 lv2 = class_1299.field_6059.method_5883(class_1564.this.field_6002);
	...
	public class class_1568 extends class_1617.class_1620 {
		private final class_4051 field_7269 = new class_4051()
			.method_18418(16.0)
			.method_18417()
			.method_18420(argx -> ((class_1472)argx).method_6633() == class_1767.field_7966);
		...
		public boolean method_6264() {
			if (class_1564.this.method_5968() != null) {
				...
				return false;
			} else if (!class_1564.this.field_6002.method_8450().method_8355(class_1928.field_19388)) {
				return false;
			} else {
				List<class_1472> list = class_1564.this.field_6002
					.method_18466(class_1472.class, this.field_7269, class_1564.this, class_1564.this.method_5829().method_1009(16.0, 4.0, 16.0));
				if (list.isEmpty()) {
					return false;
				} else {
