...
public class class_1551 extends class_1642 implements class_1603 {
	...
	public static boolean method_20673(class_1299<class_1551> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		class_1959 lv = arg2.method_8310(arg4);
		boolean bl = arg2.method_8407() != class_1267.field_5801
			&& method_20679(arg2, arg4, random)
			&& (arg3 == class_3730.field_16469 || arg2.method_8316(arg4).method_15767(class_3486.field_15517));
		if (lv != class_1972.field_9438 && lv != class_1972.field_9463) {
			return random.nextInt(40) == 0 && method_20672(arg2, arg4) && bl;
		} else {
			return random.nextInt(15) == 0 && bl;
		}
	}

	private static boolean method_20672(class_1936 arg, class_2338 arg2) {
		return arg2.method_10264() < arg.method_8615() - 5;
	}
