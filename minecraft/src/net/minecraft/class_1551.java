...
public class class_1551 extends class_1642 implements class_1603 {
	...
	public class_1551(class_1937 arg) {
		super(class_1299.field_6123, arg);
		this.field_6013 = 1.0F;
		this.field_6207 = new class_1551.class_1556(this);
		this.method_5941(class_7.field_18, 0.0F);
		this.field_7234 = new class_1412(this, arg);
		this.field_7232 = new class_1409(this, arg);
	}
	...
	protected void method_7208() {
		...
		this.field_6185.method_6277(2, new class_1400(this, class_1657.class, 10, true, false, new class_1551.class_1553(this)));
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		...
		if (lv != class_1972.field_9438 && lv != class_1972.field_9463) {
			return this.field_5974.nextInt(40) == 0 && this.method_7015() && super.method_5979(arg, arg2);
		} else {
			return this.field_5974.nextInt(15) == 0 && super.method_5979(arg, arg2);
		}
	}
	...
	protected boolean method_5955(class_1799 arg, class_1799 arg2, class_1304 arg3) {
		if (arg2.method_7909() == class_1802.field_8864) {
			...
			if (arg.method_7909() == class_1802.field_8547) {
				return arg.method_7919() < arg2.method_7919();
			} else {
				return false;
			}
		} else {
	...
	public boolean method_7012(@Nullable class_1309 arg) {
		if (arg != null) {
			return !this.field_6002.method_8530() || arg.method_5799();
		} else {
			return false;
		}
	}
	...
	static class class_1553 implements Predicate<class_1657> {
		private final class_1551 field_7236;

		public class_1553(class_1551 arg) {
			this.field_7236 = arg;
		}

		public boolean method_7020(@Nullable class_1657 arg) {
			return this.field_7236.method_7012(arg);
		}
	}
	...
	static class class_1554 extends class_1367 {
		...
		protected boolean method_6296(class_1941 arg, class_2338 arg2) {
			...
			return arg.method_8623(lv) && arg.method_8623(lv.method_10084()) ? arg.method_8320(arg2).method_11631(arg, arg2) : false;
		}
		...
		public void method_6240() {
			...
			if (this.field_7244.method_7018() && this.field_7244.method_5799()) {
				if (lv != null && lv.field_6010 > this.field_7244.field_6010 || this.field_7244.field_7233) {
					this.field_7244.field_5984 += 0.002;
				}
				...
				this.field_7244.method_6125(class_3532.method_16439(0.125F, this.field_7244.method_6029(), i));
				this.field_7244.field_5984 += (double)this.field_7244.method_6029() * e * 0.1;
				this.field_7244.field_5967 += (double)this.field_7244.method_6029() * d * 0.005;
				this.field_7244.field_6006 += (double)this.field_7244.method_6029() * f * 0.005;
			} else {
				if (!this.field_7244.field_5952) {
					this.field_7244.field_5984 -= 0.008;
				}
	...
	static class class_1558 extends class_1381 {
		...
		public void method_6269() {
			super.method_6269();
			this.field_7249.method_7106(true);
		}

		@Override
		public void method_6270() {
			super.method_6270();
			this.field_7249.method_7106(false);
		}
	}
}
