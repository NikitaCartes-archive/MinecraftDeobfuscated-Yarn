			...
			if (i > 32768) {
				...
				if (serverWorld.method_8617(blockPos, blockPos2) && serverWorld.method_8617(blockPos3, blockPos4)) {
					...
					for (CloneCommand.class_3024 lv2x : list2) {
						BlockEntity blockEntity4 = serverWorld.method_8321(lv2x.field_13496);
						if (lv2x.field_13494 != null && blockEntity4 != null) {
							...
							blockEntity4.method_11014(lv2x.field_13494);
							blockEntity4.markDirty();
						}

						serverWorld.method_8652(lv2x.field_13496, lv2x.field_13495, 2);
					}

					for (CloneCommand.class_3024 lv2x : list5) {
						serverWorld.method_8408(lv2x.field_13496, lv2x.field_13495.getBlock());
					}
					...
					if (lx == 0) {
						...
						serverCommandSource.method_9226(new TranslatableTextComponent("commands.clone.success", lx), true);
						return lx;
					}
				} else {
