				...
				.then(
					method_13898(
						(argumentBuilder, arg) -> argumentBuilder.then(
								...
								.then(
									ServerCommandManager.literal("prepend")
										.then(arg.create((commandContext, compoundTag, argx, list) -> method_13910(0, false, compoundTag, argx, list)))
								)
								.then(
		...
		for(DataCommand.class_3167 lv : field_13798) {
			lv.method_13925(
				...
				argumentBuilder -> {
					...
					for(DataCommand.class_3167 lvxx : field_13792) {
						biConsumer.accept(
							argumentBuilder2,
							(DataCommand.class_3166)arg3 -> lvx.method_13925(
									ServerCommandManager.literal("from"), argumentBuilderx -> argumentBuilderx.executes(commandContext -> {
											...
											List<Tag> list = lv2.method_9366(lvxxx.method_13881());
											return method_13920(commandContext, lv, arg3, list);
										}))
								)
						);
