						...
						biConsumer.accept(
							...
							(DataCommand.class_3166)arg3 -> lvx.method_13925(
									ServerCommandManager.literal("from"), argumentBuilderx -> argumentBuilderx.executes(commandContext -> {
											...
											NbtPathArgumentType.class_2209 lvxxx = NbtPathArgumentType.method_9358(commandContext, "sourcePath");
											List<Tag> list = lvxxx.method_9366(dataCommandObject.method_13881());
											return method_13920(commandContext, lv, arg3, list);
										}))
								)
						);
