			...
			ServerCommandManager.literal("team")
				...
				.then(
					ServerCommandManager.literal("add")
						.then(
							((RequiredArgumentBuilder)ServerCommandManager.argument("team", StringArgumentType.word())
									.executes(commandContext -> method_13757((ServerCommandSource)commandContext.getSource(), StringArgumentType.getString(commandContext, "team"))))
								.then(
				...
				.then(
					ServerCommandManager.literal("join")
						.then(
							((RequiredArgumentBuilder)ServerCommandManager.argument("team", TeamArgumentType.create())
									.executes(
				...
				.then(
					ServerCommandManager.literal("modify")
						.then(
							((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ServerCommandManager.argument(
