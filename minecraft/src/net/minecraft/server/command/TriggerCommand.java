	...
	public static void register(CommandDispatcher<ServerCommandSource> commandDispatcher) {
		commandDispatcher.register(
			ServerCommandManager.literal("trigger")
				.then(
					((RequiredArgumentBuilder)((RequiredArgumentBuilder)ServerCommandManager.argument("objective", ObjectiveArgumentType.create())
								.suggests((commandContext, suggestionsBuilder) -> method_13819((ServerCommandSource)commandContext.getSource(), suggestionsBuilder))
								.executes(
									commandContext -> method_13818(
											(ServerCommandSource)commandContext.getSource(),
											method_13821(((ServerCommandSource)commandContext.getSource()).getPlayer(), ObjectiveArgumentType.getObjectiveArgument(commandContext, "objective"))
										)
								))
							.then(
