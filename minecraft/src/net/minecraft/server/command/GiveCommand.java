...
public class GiveCommand {
	...
	private static int method_13401(
		ServerCommandSource serverCommandSource, ItemStackArgument itemStackArgument, Collection<ServerPlayerEntity> collection, int i
