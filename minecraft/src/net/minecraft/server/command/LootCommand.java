											...
											ServerCommandManager.argument("pos", BlockPosArgumentType.create())
												.executes(
													commandContext -> method_13199(
															commandContext,
															ResourceLocationArgumentType.getIdentifierArgument(commandContext, "loot_table"),
						...
						.then(
							ServerCommandManager.literal("loot")
								.then(
									ServerCommandManager.argument("loot_table", ResourceLocationArgumentType.create())
										.suggests(field_13605)
										.executes(commandContext -> method_13197(commandContext, ResourceLocationArgumentType.getIdentifierArgument(commandContext, "loot_table"), arg))
								)
						)
						.then(
