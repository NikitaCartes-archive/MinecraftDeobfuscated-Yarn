				...
				.thenAcceptAsync(
					decoratedMessage -> {
						...
						for(ServerPlayerEntity serverPlayerEntity : targets) {
							...
							SignedMessage signedMessagexx = (SignedMessage)decoratedMessage.getFilterableFor(source, serverPlayerEntity);
							if (signedMessagexx != null) {
								serverPlayerEntity.sendChatMessage(signedMessagexx, source.getChatMessageSender(), MessageType.MSG_COMMAND);
							}
						}
					},
					source.getServer()
