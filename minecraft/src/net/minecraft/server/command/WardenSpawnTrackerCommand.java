...
public class WardenSpawnTrackerCommand {
	...
	private static int setWarningLevel(ServerCommandSource source, Collection<? extends PlayerEntity> players, int warningLevel) {
		for (PlayerEntity playerEntity : players) {
			playerEntity.getSculkShriekerWarningManager().setWarningCount(warningLevel);
		}
