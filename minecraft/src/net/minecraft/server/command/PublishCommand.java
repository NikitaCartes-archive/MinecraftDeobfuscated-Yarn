...
public class PublishCommand {
	...
	public static void register(CommandDispatcher<ServerCommandSource> commandDispatcher) {
		commandDispatcher.register(
			ServerCommandManager.literal("publish")
				...
				.executes(commandContext -> method_13509(commandContext.getSource(), NetworkUtils.choosePort()))
				.then(
	...
	private static int method_13509(ServerCommandSource serverCommandSource, int i) throws CommandSyntaxException {
		...
		} else if (!serverCommandSource.getMinecraftServer().method_3763(serverCommandSource.getMinecraftServer().getDefaultGameMode(), false, i)) {
