...
public class ExecuteCommand {
	...
	public static <T extends AbstractServerCommandSource<T>> void enqueueExecutions(
		...
		for(T abstractServerCommandSource : sources) {
			try {
				Collection<CommandFunction<T>> collection = (Collection)functionNamesGetter.get(commandContext.copyFor(abstractServerCommandSource));
	...
	private static <T extends AbstractServerCommandSource<T>> T createExecutionSource(
		...
		T abstractServerCommandSource = ((AbstractServerCommandSource)sourceTransformer.apply(currentSource)).withDummyResultStorer();
		if (singleFunction) {
