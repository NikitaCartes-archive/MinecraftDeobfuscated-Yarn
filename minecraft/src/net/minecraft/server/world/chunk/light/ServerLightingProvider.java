...
public class ServerLightingProvider extends LightingProvider implements LightingView, AutoCloseable {
	...
	private final Queue<Runnable> field_14018 = Queues.newConcurrentLinkedQueue();
	private final Queue<Runnable> field_14016 = Queues.newConcurrentLinkedQueue();
	private final Queue<Runnable> field_14021 = Queues.newConcurrentLinkedQueue();
