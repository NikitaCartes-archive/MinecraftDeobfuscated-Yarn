...
public class ChunkHolder {
	...
	public CompletableFuture<OptionalChunk<Chunk>> getFutureFor(ChunkStatus leastStatus) {
		CompletableFuture<OptionalChunk<Chunk>> completableFuture = (CompletableFuture)this.futuresByStatus.get(leastStatus.getIndex());
	...
	public CompletableFuture<OptionalChunk<Chunk>> getChunkAt(ChunkStatus targetStatus, ThreadedAnvilChunkStorage chunkStorage) {
		...
		CompletableFuture<OptionalChunk<Chunk>> completableFuture = (CompletableFuture)this.futuresByStatus.get(i);
		if (completableFuture != null) {
			OptionalChunk<Chunk> optionalChunk = (OptionalChunk)completableFuture.getNow(CHUNK_LOADING_NOT_FINISHED);
