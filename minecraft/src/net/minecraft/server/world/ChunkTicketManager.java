...
public abstract class ChunkTicketManager {
	...
	protected void purge() {
		...
		while(objectIterator.hasNext()) {
			Entry<class_4706<ChunkTicket<?>>> entry = (Entry)objectIterator.next();
	...
	private class_4706<ChunkTicket<?>> getTicketSet(long position) {
		return (class_4706<ChunkTicket<?>>)this.ticketsByPosition.computeIfAbsent(position, l -> class_4706.method_23859(4));
	}
	...
	protected String method_21623(long l) {
		class_4706<ChunkTicket<?>> lv = (class_4706)this.ticketsByPosition.get(l);
		String string;
	...
	class TicketDistanceLevelPropagator extends ChunkPosDistanceLevelPropagator {
		...
		@Override
		protected int getInitialLevel(long id) {
			class_4706<ChunkTicket<?>> lv = (class_4706)ChunkTicketManager.this.ticketsByPosition.get(id);
			if (lv == null) {
