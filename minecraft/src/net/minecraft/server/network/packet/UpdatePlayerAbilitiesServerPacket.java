...
public class UpdatePlayerAbilitiesServerPacket implements Packet<ServerPlayPacketListener> {
	...
	public UpdatePlayerAbilitiesServerPacket() {
	}

	public UpdatePlayerAbilitiesServerPacket(PlayerAbilities playerAbilities) {
