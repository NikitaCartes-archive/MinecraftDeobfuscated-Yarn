...
public class ClientSettingsServerPacket implements Packet<ServerPlayPacketListener> {
	...
	public ClientSettingsServerPacket() {
	}

	@Environment(EnvType.CLIENT)
	public ClientSettingsServerPacket(String string, int i, PlayerEntity.ChatVisibility chatVisibility, boolean bl, int j, OptionMainHand optionMainHand) {
