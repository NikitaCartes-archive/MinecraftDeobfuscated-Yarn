...
public class HandshakeServerPacket implements Packet<ServerHandshakePacketListener> {
	private int version;
	...
	public HandshakeServerPacket(String string, int i, NetworkState networkState) {
