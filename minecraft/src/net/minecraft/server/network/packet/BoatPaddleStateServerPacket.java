...
public class BoatPaddleStateServerPacket implements Packet<ServerPlayPacketListener> {
	private boolean leftPaddling;
	private boolean rightPaddling;

	public BoatPaddleStateServerPacket() {
	}

	public BoatPaddleStateServerPacket(boolean bl, boolean bl2) {
