...
public class ClickWindowServerPacket implements Packet<ServerPlayPacketListener> {
	private int syncId;
	private int slot;
	private int button;
	...
	public ClickWindowServerPacket() {
	}

	@Environment(EnvType.CLIENT)
	public ClickWindowServerPacket(int i, int j, int k, SlotActionType slotActionType, ItemStack itemStack, short s) {
		this.syncId = i;
		this.slot = j;
		this.button = k;
