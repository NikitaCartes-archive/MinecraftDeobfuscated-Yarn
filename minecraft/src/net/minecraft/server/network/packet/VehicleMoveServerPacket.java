...
public class VehicleMoveServerPacket implements Packet<ServerPlayPacketListener> {
	private double x;
	private double y;
	private double z;
	private float yaw;
	...
	public VehicleMoveServerPacket() {
	}

	public VehicleMoveServerPacket(Entity entity) {
		this.x = entity.x;
		this.y = entity.y;
		this.z = entity.z;
		this.yaw = entity.yaw;
