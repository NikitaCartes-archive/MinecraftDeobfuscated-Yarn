...
public class RenameItemServerPacket implements Packet<ServerPlayPacketListener> {
	private String itemName;

	public RenameItemServerPacket() {
	}

	public RenameItemServerPacket(String string) {
