...
public class QueryBlockNbtServerPacket implements Packet<ServerPlayPacketListener> {
	private int transactionId;
	private BlockPos pos;

	public QueryBlockNbtServerPacket() {
	}

	@Environment(EnvType.CLIENT)
	public QueryBlockNbtServerPacket(int i, BlockPos blockPos) {
