...
public class PlayerInteractItemServerPacket implements Packet<ServerPlayPacketListener> {
	private Hand hand;

	public PlayerInteractItemServerPacket() {
	}

	public PlayerInteractItemServerPacket(Hand hand) {
		this.hand = hand;
	}
