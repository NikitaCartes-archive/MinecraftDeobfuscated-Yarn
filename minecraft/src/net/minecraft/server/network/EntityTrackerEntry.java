...
public class EntityTrackerEntry {
	...
	public void tick() {
		...
		if (j instanceof ItemFrameEntity itemFrameEntity && this.trackingTick % 10 == 0) {
	...
	public void sendPackets(ServerPlayerEntity serverPlayerEntity, Consumer<Packet<ClientPlayPacketListener>> consumer) {
		...
		if (var14 instanceof LivingEntity livingEntity && livingEntity.getControllingPassenger() == serverPlayerEntity) {
