	...
	public void update() {
		...
		if (this.field_14001) {
			...
			if (blockState2.isAir()) {
				...
				float f = blockState2.method_11589(this.player, this.player.field_6002, this.field_14004) * (float)(k + 1);
				int j = (int)(f * 10.0F);
				if (j != this.field_14009) {
					this.world.method_8517(this.player.getEntityId(), this.field_14006, j);
					this.field_14009 = j;
				}
			}
		}
