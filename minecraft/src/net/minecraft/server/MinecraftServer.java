...
public abstract class MinecraftServer extends class_4093<class_3738> implements class_1279, class_2165, AutoCloseable, Runnable {
	...
	public static final class_1940 field_17704 = new class_1940((long)"North Carolina".hashCode(), class_1934.field_9215, true, false, class_1942.field_9265)
		.method_8575();
	...
	protected void method_3755(String string) {
		...
		if (this.field_4586) {
			...
			if (lv != null) {
				class_1257 lv2 = new class_1257(this.method_3865(), this.method_3781(), lv, this.field_19237);
				class_2561 lv3 = null;
	...
	private void method_17977(class_31 arg) {
		...
		arg.method_186(true);
		arg.method_146().method_20746(class_1928.field_19396).method_20758(false, this);
	}
	...
	protected void method_3774(class_3949 arg) {
		...
		for(class_2874 lv4 : class_2874.method_12482()) {
			class_1932 lv5 = this.method_3847(lv4).method_17983().method_20786(class_1932::new, "chunks");
			if (lv5 != null) {
		...
		for(class_3218 lv : this.method_3738()) {
			if (lv != null) {
				try {
					...
					field_4546.error("Exception closing the level", var4);
				}
			}
		}
	...
	public void method_3747(boolean bl) {
		...
		if (bl) {
			try {
				...
				field_4546.error("Error while shutting down", var3);
			}
		}
	}
	...
	public void method_3791(class_2926 arg) {
		...
		if (file.isFile()) {
			...
			try {
				...
				field_4546.error("Couldn't load server icon", var9);
			} finally {
				byteBuf.release();
			}
		}
		...
		for(class_3218 lv : this.method_3738()) {
			if (lv.field_9247.method_12460() == class_2874.field_13072 || this.method_3839()) {
				...
				if (this.field_4572 % 20 == 0) {
					...
					this.field_4550
						.method_14589(new class_2761(lv.method_8510(), lv.method_8532(), lv.method_8450().method_8355(class_1928.field_19396)), lv.field_9247.method_12460());
					this.field_16258.method_15407();
				}
				...
				try {
					...
					class_128 lv2 = class_128.method_560(var6, "Exception ticking world");
					lv.method_8538(lv2);
	...
	public static void main(String[] strings) {
		...
		try {
			...
			String string2 = (String)Optional.ofNullable(optionSet.valueOf(optionSpec10)).orElse(lv.method_16717().field_16820);
			...
			lv4.method_3817(optionSet.valueOf(optionSpec8));
			lv4.method_3779(optionSet.valueOf(optionSpec11));
			...
			lv4.method_20383(optionSet.has(optionSpec6));
			lv4.method_17819(optionSet.valueOf(optionSpec12));
			...
			field_4546.fatal("Failed to start the minecraft server", var29);
		}
	}
	...
	public int method_3829(@Nullable class_3218 arg) {
		return arg != null ? arg.method_8450().method_8356(class_1928.field_19403) : 10;
	}
	...
	private void method_3752(class_31 arg) {
		...
		try {
			...
			field_4546.error("Failed to reload data packs", var6);
		}
