...
public class class_3360 {
	private static final Map<String, String> field_14435 = class_156.method_654(Maps.newHashMap(), hashMap -> {
	...
	private static final Map<String, String> field_14436 = class_156.method_654(Maps.newHashMap(), hashMap -> {
	...
	private final Map<String, Long2ObjectMap<class_2487>> field_14432 = Maps.newHashMap();
	private final Map<String, class_3440> field_14433 = Maps.newHashMap();
	...
	private boolean method_14738(int i, int j, String string) {
		if (!this.field_14434) {
			...
			return this.field_14432.get(string) != null && ((class_3440)this.field_14433.get(field_14435.get(string))).method_14897(class_1923.method_8331(i, j));
		}
	}
	...
	private class_2487 method_14741(class_2487 arg, class_1923 arg2) {
		...
		for(String string : this.field_17659) {
			Long2ObjectMap<class_2487> long2ObjectMap = (Long2ObjectMap)this.field_14432.get(string);
