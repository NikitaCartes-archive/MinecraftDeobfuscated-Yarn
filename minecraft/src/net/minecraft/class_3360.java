...
public abstract class class_3360 {
	...
	private static final Map<String, String> field_14435 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	private static final Map<String, String> field_14436 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	private final Map<String, Long2ObjectMap<CompoundTag>> field_14432 = Maps.newHashMap();
	...
	private boolean method_14738(int i, int j, String string) {
		if (!this.field_14434) {
			...
			return this.field_14432.get(string) != null && ((class_3440)this.field_14433.get(field_14435.get(string))).method_14897(ChunkPos.toLong(i, j));
		}
	}
	...
	private CompoundTag method_14741(CompoundTag compoundTag, ChunkPos chunkPos) {
		...
		for(String string : this.method_14743()) {
			Long2ObjectMap<CompoundTag> long2ObjectMap = (Long2ObjectMap)this.field_14432.get(string);
