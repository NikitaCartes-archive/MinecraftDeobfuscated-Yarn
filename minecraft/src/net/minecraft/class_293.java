...
public class class_293 {
	...
	private final List<Integer> field_1597 = Lists.newArrayList();
	private int field_1600;
	private int field_1599 = -1;
	private final List<Integer> field_1598 = Lists.newArrayList();
	...
	public class_293 method_1361(class_296 arg) {
		if (arg.method_1388() && this.method_1371()) {
			...
			this.field_1600 += arg.method_1387();
			return this;
		}
	}
