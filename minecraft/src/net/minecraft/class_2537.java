...
public class class_2537 extends class_2248 {
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		boolean bl = method_9581(lv3.method_11614());
		return !bl && lv.method_10166().method_10179() && class_2248.method_9501(lv3.method_11628(arg2, lv2), lv) && !lv3.method_11634();
	}
	...
	public void method_10776(class_1937 arg, class_2338 arg2, class_2680 arg3, boolean bl, boolean bl2, int i, @Nullable class_2680 arg4) {
		...
		boolean bl3 = arg3.method_11654(field_11669);
		boolean bl4 = arg3.method_11654(field_11671);
		boolean bl5 = !bl;
		boolean bl6 = false;
		int j = 0;
		...
		for(int k = 1; k < 42; ++k) {
			...
			if (lv3.method_11614() != class_2246.field_10589 && k != i) {
				...
				boolean bl7 = !lv3.method_11654(class_2538.field_11679);
				boolean bl8 = lv3.method_11654(class_2538.field_11680);
				bl6 |= bl7 && bl8;
				lvs[k] = lv3;
				if (k == i) {
		...
		if (j > 0) {
			class_2338 lv2 = arg2.method_10079(lv, j);
			class_2350 lv5 = lv.method_10153();
			arg.method_8652(lv2, lv4.method_11657(field_11666, lv5), 3);
			this.method_10775(arg, lv2, lv5);
			this.method_10777(arg, lv2, bl5, bl6, bl3, bl4);
		}
	...
	public void method_9536(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2680 arg4, boolean bl) {
		if (!bl && arg.method_11614() != arg4.method_11614()) {
			boolean bl2 = arg.method_11654(field_11669);
			boolean bl3 = arg.method_11654(field_11671);
			if (bl2 || bl3) {
	...
	public int method_9603(class_2680 arg, class_1922 arg2, class_2338 arg3, class_2350 arg4) {
		if (!arg.method_11654(field_11671)) {
			return 0;
		} else {
