...
public class PointOfInterestType {
	...
	private static PointOfInterestType register(String id, Set<BlockState> set, int i, @Nullable SoundEvent soundEvent, int j) {
		return setup(Registry.POINT_OF_INTEREST_TYPE.add(new Identifier(id), new PointOfInterestType(id, set, i, soundEvent, j)));
	}

	private static PointOfInterestType register(
		String id, Set<BlockState> set, int i, @Nullable SoundEvent soundEvent, Predicate<PointOfInterestType> predicate, int j
	) {
		return setup(Registry.POINT_OF_INTEREST_TYPE.add(new Identifier(id), new PointOfInterestType(id, set, i, soundEvent, predicate, j)));
	}
