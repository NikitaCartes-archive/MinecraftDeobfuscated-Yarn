		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					...
					new Identifier("empty"),
					ImmutableList.of(new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13545, FeatureConfig.DEFAULT)), 1)),
					class_3785.Projection.RIGID
				)
			);
		class_3778.field_16666
			.method_16640(
				new class_3785(
					...
					ImmutableList.of(
						...
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13545, FeatureConfig.DEFAULT)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_16797, FeatureConfig.DEFAULT)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_17007, FeatureConfig.DEFAULT)), 1),
