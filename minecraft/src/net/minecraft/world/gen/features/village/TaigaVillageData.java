			...
			.method_16640(
				new class_3785(
					...
					ImmutableList.of(
						...
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13581, FeatureConfig.field_13603)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_17106, FeatureConfig.field_13603)), 2),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13521, FeatureConfig.field_13603)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_17004, FeatureConfig.field_13603)), 1),
