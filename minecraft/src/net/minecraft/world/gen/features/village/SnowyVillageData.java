		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					...
					new Identifier("empty"),
					ImmutableList.of(new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13577, FeatureConfig.field_13603)), 1)),
					class_3785.Projection.RIGID
				)
			);
		class_3778.field_16666
			.method_16640(
				new class_3785(
					...
					ImmutableList.of(
						...
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_13577, FeatureConfig.field_13603)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_17005, FeatureConfig.field_13603)), 4),
						new Pair<>(new class_3776(new ConfiguredFeature<>(Feature.field_17006, FeatureConfig.field_13603)), 1),
