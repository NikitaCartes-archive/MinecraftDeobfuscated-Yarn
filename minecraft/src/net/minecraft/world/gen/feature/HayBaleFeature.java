...
public abstract class HayBaleFeature extends Feature<DefaultFeatureConfig> {
	public HayBaleFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function) {
		super(function);
	}
	...
	private boolean method_16707(IWorld iWorld, BlockPos blockPos) {
		...
		return Block.method_9501(blockState.method_11628(iWorld, blockPos2), Direction.UP) || blockState.getBlock() == Blocks.field_10194;
	}
