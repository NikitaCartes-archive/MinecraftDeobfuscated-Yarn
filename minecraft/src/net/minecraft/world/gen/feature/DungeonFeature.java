				...
				for(int t = 3; t >= -1; --t) {
					for(int u = p; u <= q; ++u) {
						...
						if (s != k && t != -1 && u != p && s != l && t != 4 && u != q) {
							if (iWorld.method_8320(blockPos2).getBlock() != Blocks.field_10034) {
								iWorld.method_8652(blockPos2, AIR, 2);
							}
						} else if (blockPos2.getY() >= 0 && !iWorld.method_8320(blockPos2.down()).method_11620().method_15799()) {
							iWorld.method_8652(blockPos2, AIR, 2);
						} else if (iWorld.method_8320(blockPos2).method_11620().method_15799() && iWorld.method_8320(blockPos2).getBlock() != Blocks.field_10034) {
							if (t == -1 && random.nextInt(4) != 0) {
								iWorld.method_8652(blockPos2, Blocks.field_9989.method_9564(), 2);
							} else {
