...
public class MiscConfiguredFeatures {
	...
	public static final RegistryEntry<ConfiguredFeature<DefaultFeatureConfig, ?>> BONUS_CHEST = ConfiguredFeatures.method_40364(
		"bonus_chest", Feature.BONUS_CHEST
	);
	...
	public static final RegistryEntry<ConfiguredFeature<DefaultFeatureConfig, ?>> DESERT_WELL = ConfiguredFeatures.method_40364(
		"desert_well", Feature.DESERT_WELL
	);
