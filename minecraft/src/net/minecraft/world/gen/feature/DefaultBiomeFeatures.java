...
public class DefaultBiomeFeatures {
	...
	public static void addLandCarvers(GenerationSettings.Builder builder) {
		...
		builder.carver(GenerationStep.Carver.AIR, ConfiguredCarvers.CRACK);
	}
	...
	public static void addDefaultOres(GenerationSettings.Builder builder) {
		...
		builder.feature(GenerationStep.Feature.UNDERGROUND_ORES, ConfiguredFeatures.ORE_IRON_LOWER);
	...
	public static void method_35924(SpawnSettings.Builder builder) {
