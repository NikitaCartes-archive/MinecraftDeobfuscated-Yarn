...
public class SpringFeatureConfig implements FeatureConfig {
	public static final Codec<SpringFeatureConfig> CODEC = RecordCodecBuilder.create(
		instance -> instance.group(
					...
					RegistryCodecs.entryList(Registry.BLOCK_KEY).fieldOf("valid_blocks").forGetter(springFeatureConfig -> springFeatureConfig.validBlocks)
				)
	...
	public SpringFeatureConfig(FluidState state, boolean requiresBlockBelow, int rockCount, int holeCount, RegistryEntryList<Block> registryEntryList) {
		this.state = state;
