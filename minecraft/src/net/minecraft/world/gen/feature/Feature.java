...
public abstract class Feature<FC extends FeatureConfig> {
	...
	public static final StructureFeature<NewVillageFeatureConfig> NEW_VILLAGE = register(
		"new_village", new NewVillageFeature(NewVillageFeatureConfig::method_16752)
	);
