...
public class AbstractTreeFeature extends Feature<TreeFeatureConfig> {
	...
	private boolean generate(
		...
		if (blockPos.getY() < 1 || blockPos.getY() + i + 1 > 256) {
			...
			List<FoliagePlacer.class_5208> list = config.field_24136.generate(world, random, o, blockPos, logPositions, box, config);
			list.forEach(arg -> config.field_24135.method_27385(world, random, config, o, arg, j, l, leavesPositions));
			return true;
		}
	}
