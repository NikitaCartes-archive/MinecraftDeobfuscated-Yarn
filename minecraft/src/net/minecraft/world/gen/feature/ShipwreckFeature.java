...
public class ShipwreckFeature extends class_3145<ShipwreckFeatureConfig> {
	...
	public static class class_3171 extends class_3449 {
		...
		public void method_16655(ChunkGenerator<?> chunkGenerator, class_3485 arg, int i, int j, Biome biome) {
			...
			ShipwreckGenerator.method_14834(arg, blockPos, rotation, this.children, this.field_16715, shipwreckFeatureConfig);
			this.method_14969();
		}
	}
}
