...
public class SwampHutFeature extends class_3145<DefaultFeatureConfig> {
	...
	public boolean method_14029(IWorld iWorld, BlockPos blockPos) {
		class_3449 lv = this.method_14025(iWorld, blockPos, true);
		if (lv != class_3449.field_16713 && lv instanceof SwampHutFeature.class_3198 && !lv.method_14963().isEmpty()) {
