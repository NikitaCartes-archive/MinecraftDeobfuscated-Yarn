...
public class ConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> BASALT_BLOBS = register(
		...
		Feature.NETHERRACK_REPLACE_BLOBS
			.configure(
				new NetherrackReplaceBlobsFeatureConfig(
					ConfiguredFeatures.class_5467.field_26181, ConfiguredFeatures.class_5467.field_26195, class_5428.method_30315(3, 4)
				)
			)
			.method_30377(128)
			.method_30371()
	...
	public static final ConfiguredFeature<?, ?> BLACKSTONE_BLOBS = register(
		...
		Feature.NETHERRACK_REPLACE_BLOBS
			.configure(
				new NetherrackReplaceBlobsFeatureConfig(
					ConfiguredFeatures.class_5467.field_26181, ConfiguredFeatures.class_5467.field_26226, class_5428.method_30315(3, 4)
				)
			)
			.method_30377(128)
			.method_30371()
	...
	public static final ConfiguredFeature<?, ?> PATCH_WATERLILLY = register(
		...
		Feature.RANDOM_PATCH
			.configure(
				new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(ConfiguredFeatures.class_5467.field_26184), SimpleBlockPlacer.INSTANCE)
					.tries(10)
					.build()
			)
			.method_30374(ConfiguredFeatures.class_5466.field_26166)
	...
	public static final ConfiguredFeature<?, ?> SPRUCE_SNOVY = register(
		"spruce_snovy",
		SPRUCE.method_30374(ConfiguredFeatures.class_5466.field_26165)
	...
	public static final ConfiguredFeature<?, ?> FLOWER_SWAMP = register(
		...
		Feature.FLOWER
			.configure(
				new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(ConfiguredFeatures.class_5467.field_26172), SimpleBlockPlacer.INSTANCE)
					.tries(64)
					.build()
			)
			.method_30374(ConfiguredFeatures.class_5466.field_26164)
