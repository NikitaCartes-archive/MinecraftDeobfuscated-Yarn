...
public class ConfiguredFeatures {
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> field_26054 = register(
		"oak_bees_005",
		Feature.field_24134.configure(field_26036.getConfig().setTreeDecorators(ImmutableList.of(ConfiguredFeatures.Decorators.MORE_BEEHIVES_TREES)))
	);
		...
		Feature.field_13555
			.configure(
				new SimpleRandomFeatureConfig(
					ImmutableList.of(
						(Supplier)() -> Feature.field_13525.configure(FeatureConfig.DEFAULT),
						(Supplier)() -> Feature.field_13546.configure(FeatureConfig.DEFAULT),
						(Supplier)() -> Feature.field_13585.configure(FeatureConfig.DEFAULT)
					)
				)
			)
			.method_23388(ConfiguredFeatures.Decorators.TOP_SOLID_HEIGHTMAP)
