...
public class OceanPlacedFeatures {
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry.Reference<ConfiguredFeature<?, ?>> reference5 = registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEA_PICKLE);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>> reference6 = registryEntryLookup.getOrThrow(OceanConfiguredFeatures.KELP);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>> reference7 = registryEntryLookup.getOrThrow(OceanConfiguredFeatures.WARM_OCEAN_VEGETATION);
