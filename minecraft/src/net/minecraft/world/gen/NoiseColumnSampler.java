...
public class NoiseColumnSampler implements MultiNoiseUtil.MultiNoiseSampler {
	...
	public NoiseColumnSampler(
		...
		VanillaLayeredBiomeSource vanillaLayeredBiomeSource,
		boolean bl,
		long l
	) {
		...
		AbstractRandom abstractRandom2 = new AtomicSimpleRandom(l);
		...
		this.field_34632 = (NoiseSampler)(generationShapeConfig.hasSimplexSurfaceNoise()
		...
		if (generationShapeConfig.hasIslandNoiseOverride()) {
			AbstractRandom abstractRandom4 = new AtomicSimpleRandom(l);
		...
		int m = Stream.of(NoiseColumnSampler.VeinType.values()).mapToInt(veinType -> veinType.maxY).max().orElse(j);
		float f = 4.0F;
		AbstractRandom abstractRandom5 = abstractRandom.derive();
		this.field_34659 = method_38379(k, m, 0, 1.5, abstractRandom5.derive(), -8, 1.0);
		this.field_34660 = method_38379(k, m, 0, 4.0, abstractRandom5.derive(), -7, 1.0);
		this.field_34661 = method_38379(k, m, 0, 4.0, abstractRandom5.derive(), -7, 1.0);
		...
		this.field_34663 = method_38379(n, o, -1, 1.0, abstractRandom6.derive(), -8, 1.0);
		this.field_34664 = method_38379(n, o, 0, 1.0, abstractRandom6.derive(), -8, 1.0);
		this.field_34665 = method_38379(n, o, 0, 2.6666666666666665, abstractRandom6.derive(), -7, 1.0);
		this.field_34666 = method_38379(n, o, 0, 2.6666666666666665, abstractRandom6.derive(), -7, 1.0);
	...
	private static class_6568.class_6571 method_38379(int i, int j, int k, double d, AbstractRandom abstractRandom, int l, double... ds) {
		...
		class_6568.class_6572 lv = (lx, m, n) -> m <= j && m >= i ? doublePerlinNoiseSampler.sample((double)lx * d, (double)m * d, (double)n * d) : (double)k;
	...
	private double method_38381(int i, int j, int k, class_6576 arg, double d, boolean bl) {
		...
		if (this.densityFactor == 0.0 && this.densityOffset == -0.030078125) {
			...
			double f = this.method_38409(arg.comp_79(), (double)i, (double)k);
			double g = this.getDepth((double)j);
			double h = (g + arg.comp_77() + f) * arg.comp_78();
	...
	public class_6568.class_6569 method_38390(class_6568 arg, class_6568.class_6572 arg2, boolean bl) {
	...
	public int method_38383(int i, int j, class_6576 arg) {
	...
	public MultiNoiseUtil.NoiseValuePoint sample(int i, int j, int k) {
		...
		double l = (double)this.field_34655.getOffset(this.field_34655.createTerrainNoisePoint(f, g, h));
	...
	public class_6576 method_38376(int i, int j, float f, float g, float h) {
		if (this.islandNoise != null) {
			double d = (double)(TheEndBiomeSource.getNoiseAt(this.islandNoise, i / 8, j / 8) - 8.0F);
			double e;
			if (d > 0.0) {
				e = 0.001953125;
			} else {
			...
			return new class_6576(
				(double)this.field_34655.getOffset(terrainNoisePoint),
				(double)this.field_34655.getFactor(terrainNoisePoint),
				(double)this.field_34655.method_38221(terrainNoisePoint)
			);
		}
	}

	public double method_38377(int i, int j, int k) {
		return this.field_34654.sample((double)i, (double)j, (double)k) * 4.0;
	}
