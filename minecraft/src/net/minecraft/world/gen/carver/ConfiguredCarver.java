...
public class ConfiguredCarver<WC extends CarverConfig> {
	...
	public boolean carve(
		CarverContext context, Chunk chunk, Function<BlockPos, Biome> posToBiome, Random random, AquiferSampler aquiferSampler, ChunkPos pos, class_6643 arg
	) {
		return SharedConstants.method_37896(chunk.getPos().getStartX(), chunk.getPos().getStartZ())
			? false
			: this.carver.carve(context, this.config, chunk, posToBiome, random, aquiferSampler, pos, arg);
	}
}
