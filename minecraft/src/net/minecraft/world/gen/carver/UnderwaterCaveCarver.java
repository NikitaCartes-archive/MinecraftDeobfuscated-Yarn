		...
		if (o >= i) {
			...
			if (bitSet.get(q)) {
				...
				if (!carver.canAlwaysCarveBlock(blockState)) {
					...
					if ((double)f < 0.25) {
						chunk.method_12010(mutable, Blocks.field_10092.method_9564(), false);
						chunk.getBlockTickScheduler().method_8676(mutable, Blocks.field_10092, 0);
					} else {
						chunk.method_12010(mutable, Blocks.field_10540.method_9564(), false);
					}

					return true;
				} else if (o < 10) {
					chunk.method_12010(mutable, Blocks.field_10164.method_9564(), false);
					return false;
				} else {
					boolean bl = false;
					...
					for (Direction direction : Direction.Type.HORIZONTAL) {
						...
						if (r >> 4 != j || s >> 4 != k || chunk.method_8320(mutable.set(r, o, s)).isAir()) {
							chunk.method_12010(mutable, field_13305.getBlockState(), false);
							chunk.getFluidTickScheduler().method_8676(mutable, field_13305.getFluid(), 0);
							bl = true;
							break;
						}
					}
