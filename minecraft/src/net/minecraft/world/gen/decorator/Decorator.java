...
public abstract class Decorator<DC extends DecoratorConfig> {
	...
	public static final Decorator<ChanceDecoratorConfig> CHANCE = register("chance", new ChanceDecorator(ChanceDecoratorConfig.field_24980));
	public static final Decorator<CountConfig> COUNT = register("count", new CountDecorator(CountConfig.CODEC));
	public static final Decorator<NoiseHeightmapDecoratorConfig> COUNT_NOISE = register(
		"count_noise", new CountNoiseDecorator(NoiseHeightmapDecoratorConfig.CODEC)
	);
	public static final Decorator<TopSolidHeightmapNoiseBiasedDecoratorConfig> COUNT_NOISE_BIASED = register(
		"count_noise_biased", new CountNoiseBiasedDecorator(TopSolidHeightmapNoiseBiasedDecoratorConfig.CODEC)
	);
	public static final Decorator<CountExtraChanceDecoratorConfig> COUNT_EXTRA = register(
		"count_extra", new CountExtraDecorator(CountExtraChanceDecoratorConfig.CODEC)
	);
	...
	public static final Decorator<CountDepthDecoratorConfig> DEPTH_AVERAGE = register(
		"depth_average", new DepthAverageDecorator(CountDepthDecoratorConfig.field_24982)
	);
	...
	public abstract Stream<BlockPos> getPositions(DecoratorContext decoratorContext, Random random, DC decoratorConfig, BlockPos blockPos);
