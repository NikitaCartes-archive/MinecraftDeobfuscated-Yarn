...
public class NoiseHeightmapDoubleDecorator extends Decorator<NoiseHeightmapDecoratorConfig> {
	...
	public Stream<BlockPos> getPositions(
		WorldAccess worldAccess, ChunkGenerator chunkGenerator, Random random, NoiseHeightmapDecoratorConfig noiseHeightmapDecoratorConfig, BlockPos blockPos
	) {
		...
		return IntStream.range(0, i).mapToObj(ix -> {
			...
			int l = worldAccess.getTopY(Heightmap.Type.MOTION_BLOCKING, j, k) * 2;
