...
public class ConfiguredSurfaceBuilders {
	...
	public static final ConfiguredSurfaceBuilder<TernarySurfaceConfig> DESERT = register(
		"desert", SurfaceBuilder.DEFAULT.method_30478(SurfaceBuilder.SAND_CONFIG)
	);
