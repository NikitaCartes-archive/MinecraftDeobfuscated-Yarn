...
public interface AquiferSampler {
	...
	public static class Impl implements AquiferSampler {
		...
		private AquiferSampler.FluidLevel method_40463(int blockX, int blockY, int blockZ) {
			...
			return new AquiferSampler.FluidLevel(p, this.method_42353(blockX, blockY, blockZ, fluidLevel, p));
		}

		private int method_42354(int blockX, int blockY, int blockZ, AquiferSampler.FluidLevel fluidLevel, int surfaceHeightEstimate, boolean bl) {
			...
			if (e > 0.0) {
				...
				i = this.method_42352(blockX, blockY, blockZ, surfaceHeightEstimate);
			} else {
