...
public class FlatChunkGeneratorConfig extends ChunkGeneratorConfig {
	...
	private static final ConfiguredFeature<?> field_14075 = Biome.method_8699(
		Feature.MINESHAFT, new MineshaftFeatureConfig(0.004, MineshaftFeature.Type.NORMAL), Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14079 = Biome.method_8699(
		Feature.VILLAGE, new VillageFeatureConfig(0, VillageGenerator.Type.OAK), Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14063 = Biome.method_8699(
		Feature.STRONGHOLD, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14067 = Biome.method_8699(
		Feature.SWAMP_HUT, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14061 = Biome.method_8699(
		Feature.DESERT_PYRAMID, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14078 = Biome.method_8699(
		Feature.JUNGLE_TEMPLE, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14070 = Biome.method_8699(
		Feature.IGLOO, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14062 = Biome.method_8699(
		Feature.SHIPWRECK, new ShipwreckFeatureConfig(false), Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14076 = Biome.method_8699(
		Feature.OCEAN_MONUMENT, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14071 = Biome.method_8699(
	...
	private static final ConfiguredFeature<?> field_14066 = Biome.method_8699(
	...
	private static final ConfiguredFeature<?> field_14084 = Biome.method_8699(
		Feature.END_CITY, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14068 = Biome.method_8699(
		Feature.WOODLAND_MANSION, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14065 = Biome.method_8699(
		Feature.NETHER_BRIDGE, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436
	);
	private static final ConfiguredFeature<?> field_14085 = Biome.method_8699(
		Feature.OCEAN_RUIN, new OceanRuinFeatureConfig(OceanRuinFeature.BiomeTemperature.COLD, 0.3F, 0.1F), Decorator.NOPE, DecoratorConfig.field_13436
	);
	public static final Map<ConfiguredFeature<?>, GenerationStep.Feature> field_14069 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	public static final Map<String, ConfiguredFeature<?>[]> field_14073 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	public static final Map<ConfiguredFeature<?>, FeatureConfig> field_14080 = SystemUtil.consume(
		Maps.<ConfiguredFeature<?>, FeatureConfig>newHashMap(), hashMap -> {
			...
			hashMap.put(field_14063, FeatureConfig.field_13603);
			hashMap.put(field_14067, FeatureConfig.field_13603);
			hashMap.put(field_14061, FeatureConfig.field_13603);
			hashMap.put(field_14078, FeatureConfig.field_13603);
			hashMap.put(field_14070, FeatureConfig.field_13603);
			...
			hashMap.put(field_14076, FeatureConfig.field_13603);
			hashMap.put(field_14084, FeatureConfig.field_13603);
			hashMap.put(field_14068, FeatureConfig.field_13603);
			hashMap.put(field_14065, FeatureConfig.field_13603);
		}
	);
	...
	public void method_14330() {
		...
		for(class_3229 lv : this.layers) {
			...
			if (lv.method_14286().getBlock() == Blocks.field_10124) {
				...
				this.field_14083 += lv.method_14289() + i;
				i = 0;
			}
		}
	}
	...
	public static FlatChunkGeneratorConfig method_14323(Dynamic<?> dynamic) {
		...
		List<Pair<Integer, Block>> list = (List)((Stream)dynamic.get("layers").flatMap(Dynamic::getStream).orElse(Stream.empty()))
			.map(dynamicx -> Pair.of(dynamicx.getInt("height", 1), parseBlock(dynamicx.getString("block"))))
			.collect(Collectors.toList());
		if (list.stream().anyMatch(pair -> pair.getSecond() == null)) {
			return method_14309();
		} else {
			List<class_3229> list2 = (List)list.stream().map(pair -> new class_3229(pair.getFirst(), (Block)pair.getSecond())).collect(Collectors.toList());
			if (list2.isEmpty()) {
				return method_14309();
			} else {
				flatChunkGeneratorConfig.getLayers().addAll(list2);
				flatChunkGeneratorConfig.method_14330();
				flatChunkGeneratorConfig.setBiome(Registry.BIOME.get(new Identifier(dynamic.getString("biome"))));
				dynamic.get("structures")
					.flatMap(Dynamic::getMapValues)
					.ifPresent(
						map -> map.keySet()
								.forEach(dynamicx -> dynamicx.getStringValue().map(string -> (Map)flatChunkGeneratorConfig.getStructures().put(string, Maps.newHashMap())))
					);
