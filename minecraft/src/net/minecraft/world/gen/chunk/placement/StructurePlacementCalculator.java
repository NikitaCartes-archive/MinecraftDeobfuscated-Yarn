...
public class StructurePlacementCalculator {
	...
	public static StructurePlacementCalculator create(
		...
		List<RegistryEntry<StructureSet>> list = (List)structureSetRegistry.streamEntries()
	...
	public List<ChunkPos> getPlacementPositions(ConcentricRingsStructurePlacement placement) {
		this.tryCalculate();
		CompletableFuture<List<ChunkPos>> completableFuture = (CompletableFuture)this.concentricPlacementsToPositions.get(placement);
