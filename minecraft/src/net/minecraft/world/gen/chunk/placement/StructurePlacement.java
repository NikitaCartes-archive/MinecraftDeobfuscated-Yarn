...
public abstract class StructurePlacement {
	...
	public boolean method_41639(ChunkGenerator chunkGenerator, NoiseConfig noiseConfig, long l, int i, int j) {
		if (!this.isStartChunk(chunkGenerator, noiseConfig, l, i, j)) {
			return false;
		} else if (this.frequency < 1.0F && !this.frequencyReductionMethod.shouldGenerate(l, this.salt, i, j, this.frequency)) {
			return false;
		} else {
			return !this.exclusionZone.isPresent() || !((StructurePlacement.class_7152)this.exclusionZone.get()).method_41648(chunkGenerator, noiseConfig, l, i, j);
		}
	}
