...
public class IglooStructure extends StructureType {
	public static final Codec<IglooStructure> CODEC = createCodec(IglooStructure::new);

	public IglooStructure(StructureType.Config config) {
		super(config);
	}
	...
	private void addPieces(StructurePiecesCollector collector, StructureType.Context context) {
		...
		IglooGenerator.addPieces(context.structureManager(), blockPos, blockRotation, collector, chunkRandom);
	}

	@Override
	public net.minecraft.structure.StructureType<?> getType() {
		return net.minecraft.structure.StructureType.IGLOO;
	}
}
