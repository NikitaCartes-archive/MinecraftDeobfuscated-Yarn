...
public interface ParameterConsumer {
	...
	default void method_292(
		LootTableReporter lootTableReporter, Function<Identifier, LootSupplier> function, Set<Identifier> set, LootContextType lootContextType
	) {
