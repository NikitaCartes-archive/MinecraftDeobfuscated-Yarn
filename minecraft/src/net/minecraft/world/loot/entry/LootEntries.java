...
public class LootEntries {
	...
	private static void method_403(LootEntry.Serializer<?> serializer) {
		idSerializers.put(serializer.method_423(), serializer);
		classSerializers.put(serializer.getType(), serializer);
	}

	static {
		method_403(CombinedEntry.method_395(new Identifier("alternatives"), AlternativeEntry.class, AlternativeEntry::new));
		method_403(CombinedEntry.method_395(new Identifier("sequence"), SequenceEntry.class, SequenceEntry::new));
		method_403(CombinedEntry.method_395(new Identifier("group"), GroupEntry.class, GroupEntry::new));
	...
	public static class Serializer implements JsonDeserializer<LootEntry>, JsonSerializer<LootEntry> {
		...
		public JsonElement method_408(LootEntry lootEntry, Type type, JsonSerializationContext jsonSerializationContext) {
			...
			jsonObject.addProperty("type", serializer.method_423().toString());
