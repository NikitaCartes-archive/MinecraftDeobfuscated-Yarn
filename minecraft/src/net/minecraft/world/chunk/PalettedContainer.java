...
public class PalettedContainer<T> implements PaletteResizeListener<T> {
	 ...
	 */
	public static <T> Codec<PalettedContainer<T>> createCodec(
		IndexedIterable<T> idList, Codec<T> entryCodec, PalettedContainer.PaletteProvider provider, T object
	) {
	...
	public void method_39793(Consumer<T> consumer) {
		...
		if (palette instanceof IdListPalette idListPalette) {
