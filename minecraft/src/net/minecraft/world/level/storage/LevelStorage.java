...
public class LevelStorage {
	...
	private static <T> Pair<GeneratorOptions, Lifecycle> method_29010(Dynamic<T> dynamic, DataFixer dataFixer, int i) {
		...
		return Pair.of(
			(GeneratorOptions)dataResult.resultOrPartial(Util.method_29188("WorldGenSettings: ", LOGGER::error))
				.orElseGet(
					() -> {
						Registry<DimensionType> registry = (Registry)class_5505.method_31148(Registry.DIMENSION_TYPE_KEY)
							.codec()
							.parse(dynamic3)
						...
						Registry<Biome> registry2 = (Registry)class_5505.method_31148(Registry.BIOME_KEY)
							.codec()
							.parse(dynamic3)
						...
						Registry<ChunkGeneratorSettings> registry3 = (Registry)class_5505.method_31148(Registry.NOISE_SETTINGS_WORLDGEN)
							.codec()
							.parse(dynamic3)
	...
	public class Session implements AutoCloseable {
		...
		public SaveProperties readLevelProperties(DynamicOps<Tag> dynamicOps, DataPackSettings dataPackSettings) {
			this.checkValid();
			return LevelStorage.this.readLevelProperties(this.directory.toFile(), LevelStorage.readLevelProperties(dynamicOps, dataPackSettings));
		}
