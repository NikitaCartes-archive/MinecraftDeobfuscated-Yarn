	...
	private static <T> Pair<GeneratorOptions, Lifecycle> method_29010(Dynamic<T> dynamic, DataFixer dataFixer, int i) {
		...
		return Pair.of(
			(GeneratorOptions)dataResult.resultOrPartial(Util.method_29188("WorldGenSettings: ", LOGGER::error))
				.orElseGet(
					() -> {
						Registry<DimensionType> registry = (Registry)RegistryLookupCodec.of(Registry.DIMENSION_TYPE_KEY)
							.codec()
							.parse(dynamic3)
						...
						Registry<Biome> registry2 = (Registry)RegistryLookupCodec.of(Registry.BIOME_KEY)
							.codec()
							.parse(dynamic3)
						...
						Registry<ChunkGeneratorSettings> registry3 = (Registry)RegistryLookupCodec.of(Registry.NOISE_SETTINGS_WORLDGEN)
							.codec()
							.parse(dynamic3)
