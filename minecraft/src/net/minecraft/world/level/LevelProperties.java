...
public class LevelProperties {
	...
	public void loadLevelInfo(LevelInfo levelInfo) {
		...
		this.setGeneratorOptions(Dynamic.convert(JsonOps.INSTANCE, NbtOps.INSTANCE, levelInfo.getGeneratorOptions()));
	...
	public void populateCrashReport(CrashReportSection crashReportSection) {
		...
		crashReportSection.method_577("Level generator options", () -> this.generatorOptions.toString());
