...
public class LevelProperties {
	...
	private void updateProperties(CompoundTag compoundTag, CompoundTag compoundTag2) {
		...
		for(String string2 : this.disabledDataPacks) {
			listTag2.add((Tag)(new StringTag(string2)));
		}
	...
	public void populateCrashReport(CrashReportSection crashReportSection) {
		...
		crashReportSection.add(
			"Level spawn location", (ICrashCallable<String>)(() -> CrashReportSection.createPositionString(this.spawnX, this.spawnY, this.spawnZ))
		);
