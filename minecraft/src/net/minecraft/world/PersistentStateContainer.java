...
public interface PersistentStateContainer {
	...
	@Nullable
	default <T extends PersistentState> T getPersistentState(DimensionType dimensionType, Function<String, T> function, String string) {
	...
	default void setPersistentState(DimensionType dimensionType, String string, PersistentState persistentState) {
		PersistentStateManager persistentStateManager = this.getPersistentStateManager();
