		...
		return Streams.concat(StreamSupport.stream(new AbstractSpliterator<VoxelShape>(Long.MAX_VALUE, 1280) {
			...
			public boolean tryAdvance(Consumer<? super VoxelShape> consumer) {
				if (!this.field_19296) {
					...
					VoxelShape voxelShapex = ViewableWorld.this.method_8621().method_17903();
					boolean bl = VoxelShapes.method_1074(voxelShapex, VoxelShapes.method_1078(entity.method_5829().contract(1.0E-7)), BooleanBiFunction.AND);
					boolean bl2 = VoxelShapes.method_1074(voxelShapex, VoxelShapes.method_1078(entity.method_5829().expand(1.0E-7)), BooleanBiFunction.AND);
					if (!bl && bl2) {
