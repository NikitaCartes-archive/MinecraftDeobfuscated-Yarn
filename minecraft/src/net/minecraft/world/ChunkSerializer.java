...
public class ChunkSerializer {
	...
	public static ProtoChunk deserialize(World world, StructureManager structureManager, ChunkPos chunkPos, CompoundTag compoundTag) {
	...
	public static CompoundTag serialize(World world, Chunk chunk) {
		...
		if (chunk.getStatus().getChunkType() == ChunkStatus.ChunkType.LEVELCHUNK) {
			...
			compoundTag2.put("Lights", toNbt(protoChunk.method_12296()));
