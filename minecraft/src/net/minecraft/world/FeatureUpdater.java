...
public class FeatureUpdater {
	private static final Map<String, String> OLD_TO_NEW = Util.create(Maps.newHashMap(), hashMap -> {
	...
	private static final Map<String, String> ANCIENT_TO_OLD = Util.create(Maps.newHashMap(), hashMap -> {
