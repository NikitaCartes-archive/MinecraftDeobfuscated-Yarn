...
public class GameRules {
	...
	public static final GameRules.Key<GameRules.BooleanRule> DO_TILE_DROPS = register(
		"doTileDrops", GameRules.Category.DROPS, GameRules.BooleanRule.create(false)
	);
	...
	public GameRules() {
		this.rules = (Map)RULE_TYPES.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, e -> ((GameRules.Type)e.getValue()).createRule()));
	}
