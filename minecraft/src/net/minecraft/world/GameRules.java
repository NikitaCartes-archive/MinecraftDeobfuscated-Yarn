...
public class GameRules {
	...
	public static enum Type {
		...
		BOOLEAN(BoolArgumentType::bool, (commandContext, string) -> ((Boolean)commandContext.getArgument(string, Boolean.class)).toString()),
		INTEGER(IntegerArgumentType::integer, (commandContext, string) -> ((Integer)commandContext.getArgument(string, Integer.class)).toString());
