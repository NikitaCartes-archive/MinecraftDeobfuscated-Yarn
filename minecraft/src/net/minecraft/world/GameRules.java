...
public class GameRules {
	...
	public static enum Type {
		...
		field_9209(BoolArgumentType::bool, (commandContext, string) -> ((Boolean)commandContext.getArgument(string, Boolean.class)).toString()),
		field_9210(IntegerArgumentType::integer, (commandContext, string) -> ((Integer)commandContext.getArgument(string, Integer.class)).toString());
