...
public final class PlainsBiome extends Biome {
	protected PlainsBiome() {
		...
		this.addStructureFeature(Feature.NEW_VILLAGE, new NewVillageFeatureConfig("village/plains/town_centers", 6));
		...
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(Feature.PLAIN_FLOWER, FeatureConfig.DEFAULT, Decorator.field_14254, new NoiseHeightmapDecoratorConfig(-0.8, 15, 4))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(
		...
		this.addSpawn(EntityCategory.field_6294, new Biome.SpawnEntry(EntityType.HORSE, 5, 2, 6));
		this.addSpawn(EntityCategory.field_6294, new Biome.SpawnEntry(EntityType.DONKEY, 1, 1, 3));
