...
public final class Biome {
	...
	private Biome(
		...
		this.flowerFeatures = (List)generationSettings.features
			.stream()
	...
	static class SpawnSettings {
		...
		private SpawnSettings(float creatureSpawnProbability) {
			this(creatureSpawnProbability, Maps.newLinkedHashMap(), Maps.<EntityType<?>, Biome.SpawnDensity>newLinkedHashMap());
