...
public class DefaultBiomeFeatures {
	...
	public static void addDefaultStructures(Biome biome) {
		...
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.method_8699(Feature.IGLOO, FeatureConfig.field_13603, Decorator.NOPE, DecoratorConfig.field_13436)
		);
		biome.addFeature(
	...
	public static void addDefaultFlowers(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.method_8699(Feature.DEFAULT_FLOWER, FeatureConfig.field_13603, Decorator.field_14253, new CountDecoratorConfig(2))
		);
	}
	...
	public static void addExtraDefaultFlowers(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.method_8699(Feature.DEFAULT_FLOWER, FeatureConfig.field_13603, Decorator.field_14253, new CountDecoratorConfig(4))
		);
	}
