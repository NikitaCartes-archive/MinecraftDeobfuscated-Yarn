...
public class DefaultBiomeFeatures {
	...
	public static void addShatteredSavannaGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
				Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(5)
			)
		);
	}
	...
	public static void addBadlandsGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
				Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(1)
			)
		);
		biome.addFeature(
	...
	public static void addForestGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
				Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(2)
			)
		);
	}
	...
	public static void addDefaultMushrooms(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
				Feature.field_13519, new BushFeatureConfig(Blocks.field_10251.getDefaultState()), Decorator.field_14263, new ChanceDecoratorConfig(4)
			)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
				Feature.field_13519, new BushFeatureConfig(Blocks.field_10559.getDefaultState()), Decorator.field_14263, new ChanceDecoratorConfig(8)
			)
		);
	}
