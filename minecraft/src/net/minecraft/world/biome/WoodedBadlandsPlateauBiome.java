...
public final class WoodedBadlandsPlateauBiome extends Biome {
	public WoodedBadlandsPlateauBiome() {
		super(
			new Biome.Settings()
				.method_8737(SurfaceBuilder.WOODED_BADLANDS, SurfaceBuilder.field_15672)
		...
		this.method_8710(Feature.MINESHAFT, new MineshaftFeatureConfig(0.004, MineshaftFeature.Type.MESA));
