...
public final class TaigaBiome extends Biome {
	public TaigaBiome() {
		...
		this.addStructureFeature(Feature.VILLAGE, new VillageFeatureConfig(0, VillageGenerator.Type.SPRUCE));
		...
		this.addFeature(
			GenerationStep.Feature.field_13178, configureFeature(Feature.field_13521, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(
		...
		this.addFeature(
			GenerationStep.Feature.field_13178, configureFeature(Feature.field_17004, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
