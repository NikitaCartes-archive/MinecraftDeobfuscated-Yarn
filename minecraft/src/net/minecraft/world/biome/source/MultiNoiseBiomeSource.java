...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	public static final Codec<MultiNoiseBiomeSource> CODEC = Codec.mapEither(MultiNoiseBiomeSource.Preset.CODEC, field_24718)
		.<MultiNoiseBiomeSource>xmap(
			either -> either.map(pair -> ((MultiNoiseBiomeSource.Preset)pair.getFirst()).getBiomeSource(pair.getSecond()), Function.identity()),
	...
	private static MultiNoiseBiomeSource method_28467(long l) {
		return new MultiNoiseBiomeSource(
			l,
			ImmutableList.of(
				Pair.of(new Biome.MixedNoisePoint(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.NETHER_WASTES),
				Pair.of(new Biome.MixedNoisePoint(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.SOUL_SAND_VALLEY),
				Pair.of(new Biome.MixedNoisePoint(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.CRIMSON_FOREST),
				Pair.of(new Biome.MixedNoisePoint(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier)() -> Biomes.WARPED_FOREST),
				Pair.of(new Biome.MixedNoisePoint(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> Biomes.BASALT_DELTAS)
			),
