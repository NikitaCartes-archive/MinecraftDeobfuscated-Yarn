...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	private float method_26472(Biome biome, Biome.MixedNoisePoint mixedNoisePoint) {
		return ((List)this.field_23419.get(biome))
			.stream()
	...
	public <T> Dynamic<T> method_26466(DynamicOps<T> dynamicOps) {
		...
		return new Dynamic<>(
			dynamicOps, dynamicOps.createMap(ImmutableMap.of(dynamicOps.createString("biomes"), object, dynamicOps.createString("noises"), object2))
		);
	}
}
