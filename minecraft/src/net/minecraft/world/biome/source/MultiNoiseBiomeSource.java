	...
	public static class Preset {
		...
		public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
			...
			(preset, registry, long_) -> new MultiNoiseBiomeSource(
					long_,
					ImmutableList.of(
						Pair.of(new Biome.MixedNoisePoint(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.method_31140(Biomes.field_9461)),
						Pair.of(new Biome.MixedNoisePoint(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.method_31140(Biomes.field_22076)),
						Pair.of(new Biome.MixedNoisePoint(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.method_31140(Biomes.field_22077)),
						Pair.of(new Biome.MixedNoisePoint(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier)() -> registry.method_31140(Biomes.field_22075)),
						Pair.of(new Biome.MixedNoisePoint(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> registry.method_31140(Biomes.field_23859))
					),
