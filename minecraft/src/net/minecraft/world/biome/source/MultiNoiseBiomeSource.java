...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	public Biome getBiomeAtPoint(MultiNoiseUtil.NoiseValuePoint point) {
		return (Biome)((Supplier)this.biomeEntries.method_39529(point, (Supplier)() -> BuiltinBiomes.THE_VOID)).get();
	}
	...
	public static class Preset {
		...
		public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
			...
			registry -> new MultiNoiseUtil.Entries(
					ImmutableList.of(
						Pair.of(MultiNoiseUtil.createNoiseHypercube(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(BiomeKeys.NETHER_WASTES)),
						Pair.of(MultiNoiseUtil.createNoiseHypercube(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(BiomeKeys.SOUL_SAND_VALLEY)),
						Pair.of(MultiNoiseUtil.createNoiseHypercube(0.4F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(BiomeKeys.CRIMSON_FOREST)),
						Pair.of(MultiNoiseUtil.createNoiseHypercube(0.0F, 0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.375F), (Supplier)() -> registry.getOrThrow(BiomeKeys.WARPED_FOREST)),
						Pair.of(MultiNoiseUtil.createNoiseHypercube(-0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> registry.getOrThrow(BiomeKeys.BASALT_DELTAS))
					)
				)
		);
		...
		MultiNoiseBiomeSource method_39531(MultiNoiseBiomeSource.Instance instance, boolean bl) {
			MultiNoiseUtil.Entries<Supplier<Biome>> entries = (MultiNoiseUtil.Entries)this.biomeSourceFunction.apply(instance.biomeRegistry());
