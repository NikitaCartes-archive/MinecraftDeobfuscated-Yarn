...
public abstract class Biomes {
	...
	public static final Biome THE_END = register(9, "the_end", new EndBiome());
	...
	public static final Biome SMALL_END_ISLANDS = register(40, "small_end_islands", new EndIslandsSmallBiome());
