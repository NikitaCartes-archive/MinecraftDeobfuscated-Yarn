...
public class BiomeLayers {
	...
	public static <T extends LayerSampler, C extends LayerSampleContext<T>> ImmutableList<LayerFactory<T>> build(
		...
		layerFactory = class_3632.class_3926.field_17399.create((LayerSampleContext<T>)longFunction.apply(2L), layerFactory);
		layerFactory = class_3632.class_3927.field_17401.create((LayerSampleContext<T>)longFunction.apply(2L), layerFactory);
