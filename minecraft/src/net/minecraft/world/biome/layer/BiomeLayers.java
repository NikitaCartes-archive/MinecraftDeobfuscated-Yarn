...
public class BiomeLayers {
	...
	public static <T extends LayerSampler, C extends LayerSampleContext<T>> ImmutableList<LayerFactory<T>> build(
		...
		LayerFactory<T> layerFactory4 = new SetBaseBiomesLayer(generatorType, settings).create((LayerSampleContext<T>)contextProvider.apply(200L), layerFactory);
		...
		LayerFactory<T> layerFactory7 = CellScaleLayer.INSTANCE.create((LayerSampleContext<T>)contextProvider.apply(10L), layerFactory4);
