...
public final class SavannaBiome extends Biome {
	protected SavannaBiome() {
		...
		this.addStructureFeature(Feature.NEW_VILLAGE, new NewVillageFeatureConfig("village/savanna/town_centers", 6));
		...
		this.addFeature(
			...
			configureFeature(Feature.field_13576, new DoublePlantFeatureConfig(Blocks.field_10214.getDefaultState()), Decorator.field_14253, new CountDecoratorConfig(7))
		);
		this.addFeature(
		...
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(20))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
