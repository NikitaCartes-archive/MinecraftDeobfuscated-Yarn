...
public final class SwampBiome extends Biome {
	protected SwampBiome() {
		...
		this.addFeature(
			...
			configureFeature(Feature.field_13530, FeatureConfig.DEFAULT, Decorator.field_14267, new CountExtraChanceDecoratorConfig(2, 0.1F, 1))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178, configureFeature(Feature.SWAMP_FLOWER, FeatureConfig.DEFAULT, Decorator.field_14253, new CountDecoratorConfig(1))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(5))
		);
		this.addFeature(
		...
		this.addFeature(
			GenerationStep.Feature.field_13178, configureFeature(Feature.field_13542, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(4))
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(
		...
		this.addFeature(
			GenerationStep.Feature.field_13178, configureFeature(Feature.field_13583, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(20))
		);
		this.addFeature(
