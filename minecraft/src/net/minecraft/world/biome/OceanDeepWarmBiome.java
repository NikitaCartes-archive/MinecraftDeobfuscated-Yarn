...
public class OceanDeepWarmBiome extends Biome {
	public OceanDeepWarmBiome() {
		...
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(Feature.field_13567, new SeagrassFeatureConfig(80, 0.8), Decorator.field_14231, DecoratorConfig.DEFAULT)
		);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			configureFeature(
		...
		this.addSpawn(EntityCategory.field_6300, new Biome.SpawnEntry(EntityType.SQUID, 5, 1, 4));
