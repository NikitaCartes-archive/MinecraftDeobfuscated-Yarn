...
public final class OceanBiome extends Biome {
	public OceanBiome() {
		...
		this.addFeature(
			GenerationStep.Feature.field_13178, method_8699(Feature.field_13567, new SeagrassFeatureConfig(48, 0.3), Decorator.field_14231, DecoratorConfig.field_13436)
		);
		...
		this.addSpawn(EntityCategory.field_6300, new Biome.SpawnEntry(EntityType.COD, 10, 3, 6));
		this.addSpawn(EntityCategory.field_6300, new Biome.SpawnEntry(EntityType.DOLPHIN, 1, 1, 2));
