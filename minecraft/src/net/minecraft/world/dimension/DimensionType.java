...
public class DimensionType {
	...
	public static SimpleRegistry<DimensionOptions> method_28517(
		...
		simpleRegistry.add(
			...
			new DimensionOptions(() -> registry.getOrThrow(THE_NETHER_REGISTRY_KEY), createNetherGenerator(registry2, registry3, l)),
			Lifecycle.stable()
		);
		simpleRegistry.add(
			DimensionOptions.END,
			new DimensionOptions(() -> registry.getOrThrow(THE_END_REGISTRY_KEY), createEndGenerator(registry2, registry3, l)),
			Lifecycle.stable()
		);
