...
public class DimensionTypes {
	...
	public static final RegistryKey<DimensionType> POTATO = of("potato");
	...
	public static final Identifier field_50992 = new Identifier("potato");
	public static final int field_50993 = 112;
