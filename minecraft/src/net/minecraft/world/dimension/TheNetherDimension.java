		...
		MultiNoiseBiomeSourceConfig multiNoiseBiomeSourceConfig = BiomeSourceType.MULTI_NOISE
			...
			.withBiomes(
				ImmutableMap.of(
					...
					ImmutableList.<Biome.MixedNoisePoint>of(new Biome.MixedNoisePoint(0.0F, 0.0F, 0.0F, -0.5F, 1.0F)),
					Biomes.SOUL_SAND_VALLEY,
					ImmutableList.<Biome.MixedNoisePoint>of(new Biome.MixedNoisePoint(0.0F, 0.0F, 0.0F, 0.5F, 1.0F)),
					Biomes.CRIMSON_FOREST,
					ImmutableList.<Biome.MixedNoisePoint>of(new Biome.MixedNoisePoint(0.0F, -0.5F, 0.0F, 0.0F, 1.0F)),
