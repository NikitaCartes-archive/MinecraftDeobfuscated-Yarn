...
public class SimulationDistanceLevelPropagator extends ChunkPosDistanceLevelPropagator {
	...
	protected int getInitialLevel(long id) {
		SortedArraySet<ChunkTicket<?>> sortedArraySet = (SortedArraySet)this.tickets.get(id);
	...
	public String getTickingTicket(long pos) {
		SortedArraySet<ChunkTicket<?>> sortedArraySet = (SortedArraySet)this.tickets.get(pos);
