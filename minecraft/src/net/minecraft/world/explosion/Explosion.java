...
public class Explosion {
	...
	public void collectBlocksAndDamageEntities() {
		...
		List<Entity> list = this.world.getEntities(this.entity, new Box((double)k, (double)s, (double)u, (double)l, (double)t, (double)v));
		...
		if (this.createFire) {
			for(BlockPos blockPos : this.affectedBlocks) {
				if (this.world.getBlockState(blockPos).isAir()
					&& this.world.getBlockState(blockPos.method_10074()).isFullOpaque(this.world, blockPos.method_10074())
