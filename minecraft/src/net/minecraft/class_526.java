...
public class class_526 extends class_437 {
	...
	protected void method_2224() {
		...
		this.field_3224 = this.method_2219(
			new class_339(1, this.field_2561 / 2 - 154, this.field_2559 - 52, 150, 20, class_1074.method_4662("selectWorld.select")) {
				@Override
	...
	public void method_2214(int i, int j, float f) {
		...
		if (this.field_3222 != null) {
			this.method_2211(Lists.newArrayList(Splitter.on("\n").split(this.field_3222)), i, j);
		}
	}
