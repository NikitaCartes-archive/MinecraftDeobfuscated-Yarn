...
public class class_526 extends class_437 {
	...
	protected void init() {
		...
		this.field_3220 = new class_342(this.font, this.width / 2 - 100, 22, 200, 20, this.field_3220);
		this.field_3220.method_1863(string -> this.field_3218.method_2750(() -> string, false));
		this.field_3218 = new class_528(
			this, this.minecraft, this.width, this.height, 48, this.height - 64, 36, () -> this.field_3220.method_1882(), this.field_3218
		);
