...
public class class_3736 extends class_2248 implements class_3737 {
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		if (lv == null) {
			...
			return lv2.method_11614() != this || (Integer)lv2.method_11654(field_16495) + 1 <= 7;
		}
	}
		...
		if (lv.method_11614() == this) {
			...
			for (class_2350 lv3 : class_2350.class_2353.field_11062) {
				...
				if (lv4.method_11614() == this) {
					int j = (Integer)lv4.method_11654(field_16495);
					if (j < i) {
						i = j;
						lv2 = lv3;
					}
	...
	private int method_16371(class_1922 arg, class_2338 arg2) {
		...
		if (lv == null) {
			...
			return lv2.method_11614() == this
				? Math.min(7, (Integer)lv2.method_11654(field_16495) + (lv.method_10166() == class_2350.class_2351.field_11052 ? 0 : 1))
				: 0;
		}
	}
