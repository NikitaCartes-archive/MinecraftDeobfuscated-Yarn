...
public class class_3736 extends class_2248 implements class_3737 {
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		return method_16372(arg2, arg3) < 7;
	}
	...
	public static int method_16372(class_1922 arg, class_2338 arg2) {
		...
		int i = 7;
		if (lv2.method_11614() == class_2246.field_16492) {
			i = lv2.method_11654(field_16495);
		...
		for(class_2350 lv3 : class_2350.class_2353.field_11062) {
			...
			if (lv4.method_11614() == class_2246.field_16492) {
				i = Math.min(i, lv4.method_11654(field_16495) + 1);
				if (i == 1) {
					break;
				}
			}
