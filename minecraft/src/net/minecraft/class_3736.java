...
public class class_3736 extends class_2248 implements class_3737 {
	...
	public boolean method_9616(class_2680 arg, class_1750 arg2) {
		return arg2.method_8038().method_10166() == class_2350.class_2351.field_11052 && arg2.method_8041().method_7909() == this.method_8389();
	}

	@Override
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		class_2350 lv = this.method_16372(arg2, arg3);
		if (lv == null) {
			return false;
		} else {
			class_2680 lv2 = arg2.method_8320(arg3.method_10093(lv));
			return lv2.method_11614() != this || lv2.method_11654(field_16495) + 1 <= 7;
		}
	}
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		int i = this.method_16371(lv2, lv);
	...
	public class_2680 method_9559(class_2680 arg, class_2350 arg2, class_2680 arg3, class_1936 arg4, class_2338 arg5, class_2338 arg6) {
		if (arg.method_11654(field_16496)) {
	...
	public void method_9588(class_2680 arg, class_1937 arg2, class_2338 arg3, Random random) {
		int i = this.method_16371(arg2, arg3);
		...
		if (lv.method_11654(field_16495) == 7) {
			if (arg.method_11654(field_16495) == 7) {
				class_1540 lv2 = new class_1540(
					arg2,
	...
	public class_265 method_9549(class_2680 arg, class_1922 arg2, class_2338 arg3, class_3726 arg4) {
		return arg4.method_16192(class_259.method_1077(), arg3) && (!arg4.method_16193() || arg.method_11654(field_16495) != 0 && arg.method_11654(field_16547))
	...
	@Nullable
	private class_2350 method_16372(class_1922 arg, class_2338 arg2) {
		class_2680 lv = arg.method_8320(arg2.method_10074());
		if (lv.method_11614() == this) {
			return class_2350.field_11033;
		} else if (class_2248.method_9501(lv.method_11628(arg, arg2), class_2350.field_11036)) {
			return class_2350.field_11033;
		} else {
			class_2350 lv2 = null;
			int i = 7;
			...
			for(class_2350 lv3 : class_2350.class_2353.field_11062) {
				class_2680 lv4 = arg.method_8320(arg2.method_10093(lv3));
				if (lv4.method_11614() == this) {
					int j = lv4.method_11654(field_16495);
					if (j < i) {
						i = j;
						lv2 = lv3;
					}
	...
	private int method_16371(class_1922 arg, class_2338 arg2) {
		class_2350 lv = this.method_16372(arg, arg2);
		if (lv == null) {
			return 7;
		} else {
			class_2680 lv2 = arg.method_8320(arg2.method_10093(lv));
			return lv2.method_11614() == this ? Math.min(7, lv2.method_11654(field_16495) + (lv.method_10166() == class_2350.class_2351.field_11052 ? 0 : 1)) : 0;
		}
	}
	...
	static {
		...
		field_16494 = class_259.method_1084(lv, class_259.method_1084(lv2, class_259.method_1084(lv3, class_259.method_1084(lv4, lv5))));
		...
		field_16497 = class_259.method_1084(field_16494, class_259.method_1084(lv7, class_259.method_1084(lv6, class_259.method_1084(lv9, lv8))));
	}
}
