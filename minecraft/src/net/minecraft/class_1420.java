...
public class class_1420 extends class_1421 {
	...
	protected void method_5958() {
		...
		if (this.method_6450()) {
			...
			this.field_5967 += (Math.signum(d) * 0.5 - this.field_5967) * 0.1F;
			this.field_5984 += (Math.signum(e) * 0.7F - this.field_5984) * 0.1F;
			this.field_6006 += (Math.signum(f) * 0.5 - this.field_6006) * 0.1F;
