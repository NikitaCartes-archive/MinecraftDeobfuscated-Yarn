...
public class class_1420 extends class_1421 {
		...
		if (this.method_6450()) {
			...
			if (this.field_6729 == null || this.field_5974.nextInt(30) == 0 || this.field_6729.method_19769(this.method_19538(), 2.0)) {
				this.field_6729 = new class_2338(
					this.field_5987 + (double)this.field_5974.nextInt(7) - (double)this.field_5974.nextInt(7),
					this.field_6010 + (double)this.field_5974.nextInt(6) - 2.0,
					this.field_6035 + (double)this.field_5974.nextInt(7) - (double)this.field_5974.nextInt(7)
				);
			}
	...
	public static boolean method_20661(class_1299<class_1420> arg, class_1936 arg2, class_3730 arg3, class_2338 arg4, Random random) {
		if (arg4.method_10264() >= arg2.method_8615()) {
			return false;
		} else {
			int i = arg2.method_8602(arg4);
			int j = 4;
			if (method_6451()) {
				j = 7;
			...
			return i > random.nextInt(j) ? false : method_20636(arg, arg2, arg3, arg4, random);
		}
	}

	private static boolean method_6451() {
