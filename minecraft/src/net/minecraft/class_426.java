...
public class class_426 extends class_437 {
	...
	protected void init() {
		...
		this.field_2487 = this.addButton(
			new 1(this.width / 2 - 155, this.height - 38, 150, 20, class_316.field_18185, class_316.field_18185.method_18495(this.field_2489), arg -> {
		...
		this.field_2491 = this.addButton(new class_4185(this.width / 2 - 155 + 160, this.height - 38, 150, 20, class_1074.method_4662("gui.done"), arg -> {
			class_426.class_4195.class_4194 lv = this.field_2486.method_20064();
	...
	@Environment(EnvType.CLIENT)
	class class_4195 extends class_350<class_426.class_4195.class_4194> {
		...
		@Environment(EnvType.CLIENT)
		public class class_4194 extends class_350.class_351<class_426.class_4195.class_4194> {
			...
			public void method_1903(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
				...
				class_4195.this.drawCenteredString(class_426.this.font, this.field_18743.toString(), class_4195.this.field_19083 / 2, j + 1, 16777215);
