...
public abstract class AbstractScoreboardTeam {
	public boolean isEqual(@Nullable AbstractScoreboardTeam abstractScoreboardTeam) {
		if (abstractScoreboardTeam == null) {
			...
			return this == abstractScoreboardTeam;
		}
	}
	...
	public static enum CollisionRule {
		...
		private static final Map<String, AbstractScoreboardTeam.CollisionRule> field_1438 = (Map<String, AbstractScoreboardTeam.CollisionRule>)Arrays.stream(
				values()
			)
