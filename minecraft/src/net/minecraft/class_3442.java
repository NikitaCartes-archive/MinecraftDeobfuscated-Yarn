		...
		try {
			...
			try {
				...
				if (!jsonElement.isJsonNull()) {
					...
					lv = class_2512.method_10688(dataFixer, class_4284.field_19218, lv, lv.method_10550("DataVersion"));
						...
						for(String string2 : lv2.method_10541()) {
							if (lv2.method_10573(string2, 10)) {
								class_156.method_17974(
									...
									arg2 -> {
										class_2487 lvxx = lv2.method_10562(string2);
	
										for(String string2xx : lvxx.method_10541()) {
											if (lvxx.method_10573(string2xx, 99)) {
												class_156.method_17974(
													this.method_14905(arg2, string2xx),
												...
												field_15309.warn("Invalid statistic value in {}: Don't know what {} is for key {}", this.field_15305, lvxx.method_10580(string2xx), string2xx);
											}
										}
									},
