...
public class class_3442 extends class_3469 {
	...
	public void method_14912() {
		try {
			...
			field_15309.error("Couldn't save stats", var2);
		}
	}
	...
	public void method_14906(DataFixer dataFixer, String string) {
		try {
					...
					if (lv.method_10573("stats", 10)) {
						...
						for(String string2 : lv2.method_10541()) {
							if (lv2.method_10573(string2, 10)) {
								class_3448<?> lv3 = class_2378.field_11152.method_10223(new class_2960(string2));
								if (lv3 == null) {
									field_15309.warn("Invalid statistic type in {}: Don't know what {} is", this.field_15305, string2);
								} else {
									class_2487 lv4 = lv2.method_10562(string2);

									for(String string3 : lv4.method_10541()) {
										if (lv4.method_10573(string3, 99)) {
											class_3445<?> lv5 = this.method_14905(lv3, string3);
											if (lv5 == null) {
												field_15309.warn("Invalid statistic in {}: Don't know what {} is", this.field_15305, string3);
											} else {
												this.field_15431.put(lv5, lv4.method_10550(string3));
											}
										} else {
											field_15309.warn("Invalid statistic value in {}: Don't know what {} is for key {}", this.field_15305, lv4.method_10580(string3), string3);
										}
									}
								}
							}
			...
			field_15309.error("Unable to parse Stat data from {}", this.field_15305, var26);
		}
	}

	@Nullable
	private <T> class_3445<T> method_14905(class_3448<T> arg, String string) {
		class_2960 lv = class_2960.method_12829(string);
		if (lv == null) {
			return null;
		} else {
			T object = arg.method_14959().method_10223(lv);
			return object == null ? null : arg.method_14956(object);
		}
	}
