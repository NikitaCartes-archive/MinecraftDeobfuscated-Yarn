...
public enum class_2350 implements class_3542 {
	...
	@Nullable
	public static class_2350 method_16365(int i, int j, int k) {
		return field_16542.get(class_2338.method_10064(i, j, k));
	}
	...
	public static enum class_2351 implements class_3542, Predicate<class_2350> {
		field_11048("x") {
			@Override
