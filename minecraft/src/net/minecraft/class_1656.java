...
public class class_1656 {
	...
	private double field_7481 = 0.05F;
	...
	public void method_7251(class_2487 arg) {
		...
		lv.method_10548("flySpeed", (float)this.field_7481);
	...
	public void method_7249(class_2487 arg) {
		if (arg.method_10573("abilities", 10)) {
			...
			if (lv.method_10573("flySpeed", 99)) {
				this.field_7481 = (double)lv.method_10583("flySpeed");
	...
	public float method_7252() {
		return (float)this.field_7481;
	}

	@Environment(EnvType.CLIENT)
	public void method_7248(double d) {
		this.field_7481 = d;
	}
