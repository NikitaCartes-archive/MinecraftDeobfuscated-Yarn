...
public class class_304 implements Comparable<class_304> {
	...
	private static final Map<String, Integer> field_1656 = class_156.method_654(Maps.newHashMap(), hashMap -> {
	...
	public boolean method_1417(int i, int j) {
		if (i == class_3675.field_16237.method_1444()) {
			return this.field_1655.method_1442() == class_3675.class_307.field_1671 && this.field_1655.method_1444() == j;
		} else {
			return this.field_1655.method_1442() == class_3675.class_307.field_1668 && this.field_1655.method_1444() == i;
		}
	}
