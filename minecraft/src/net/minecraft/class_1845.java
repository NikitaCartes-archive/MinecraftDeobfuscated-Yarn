...
public class class_1845 {
	...
	public static boolean method_20361(class_1842 arg) {
		int i = 0;

		for(int j = field_8956.size(); i < j; ++i) {
			if (((class_1845.class_1846)field_8956.get(i)).field_8961 == arg) {
				return true;
			}
		}
	...
	public static boolean method_8072(class_1799 arg, class_1799 arg2) {
		if (!field_8958.test(arg)) {
			return false;
		} else {
			return method_8070(arg, arg2) || method_8075(arg, arg2);
		}
	}
	...
	protected static boolean method_8070(class_1799 arg, class_1799 arg2) {
		...
		for(int j = field_8959.size(); i < j; ++i) {
			class_1845.class_1846<class_1792> lv2 = (class_1845.class_1846)field_8959.get(i);
	...
	protected static boolean method_8075(class_1799 arg, class_1799 arg2) {
		...
		for(int j = field_8956.size(); i < j; ++i) {
			class_1845.class_1846<class_1842> lv2 = (class_1845.class_1846)field_8956.get(i);
			if (lv2.field_8962 == lv && lv2.field_8960.method_8093(arg2)) {
				return true;
			}
		}
	...
	public static class_1799 method_8078(class_1799 arg, class_1799 arg2) {
		if (!arg2.method_7960()) {
			...
			for(int j = field_8959.size(); i < j; ++i) {
				class_1845.class_1846<class_1792> lv3 = (class_1845.class_1846)field_8959.get(i);
			...
			for(int j = field_8956.size(); i < j; ++i) {
				class_1845.class_1846<class_1842> lv3 = (class_1845.class_1846)field_8956.get(i);
