...
public class class_759 {
			...
			if (arg.method_6115() && arg.method_6014() > 0 && arg.method_6058() == arg2) {
				...
				switch(arg3.method_7976()) {
					...
					case field_8953:
						...
						if (k > 0.1F) {
							float l = class_3532.method_15374((q - 0.1F) * 1.3F);
							float m = k - 0.1F;
							float n = l * m;
				...
				float q = 0.2F * class_3532.method_15374(class_3532.method_15355(h) * (float) (Math.PI * 2));
				float k = -0.2F * class_3532.method_15374(h * (float) Math.PI);
				int s = bl2 ? 1 : -1;
	...
	public void method_3220() {
		...
		if (lv.method_3144()) {
			...
			this.field_4043 += class_3532.method_15363((Objects.equals(this.field_4047, lv2) ? f * f * f : 0.0F) - this.field_4043, -0.4F, 0.4F);
