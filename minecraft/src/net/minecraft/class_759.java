...
public class class_759 {
	...
	public void method_3228(class_742 arg, float f, float g, class_1268 arg2, float h, class_1799 arg3, float i) {
		...
		if (arg3.method_7960()) {
			...
			if (arg.method_6115() && arg.method_6014() > 0 && arg.method_6058() == arg2) {
				...
				float k = -0.4F * class_3532.method_15374(class_3532.method_15355(h) * (float) Math.PI);
				float l = 0.2F * class_3532.method_15374(class_3532.method_15355(h) * (float) (Math.PI * 2));
			...
			if (bl3 || bl4) {
				...
				switch(arg3.method_7976()) {
					...
					case field_8953:
						...
						float l = (float)arg3.method_7935() - ((float)this.field_4050.field_1724.method_6014() - f + 1.0F);
						float m = l / 20.0F;
						m = (m * m + m * 2.0F) / 3.0F;
						if (m > 1.0F) {
							m = 1.0F;
						...
						if (m > 0.1F) {
							float n = class_3532.method_15374((l - 0.1F) * 1.3F);
							float o = m - 0.1F;
							float q = n * o;
	...
	public void method_3220() {
		...
		if (lv.method_3144()) {
			...
			f = f * f * f * 0.25F + 0.75F;
			this.field_4043 += class_3532.method_15363((Objects.equals(this.field_4047, lv2) ? f : 0.0F) - this.field_4043, -0.4F, 0.4F);
			this.field_4052 += class_3532.method_15363((float)(Objects.equals(this.field_4048, lv3) ? 1 : 0) - this.field_4052, -0.4F, 0.4F);
		}
