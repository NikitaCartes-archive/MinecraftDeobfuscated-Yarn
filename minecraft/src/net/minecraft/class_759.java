...
public class class_759 {
	...
	private void method_3214(float f) {
		...
		GlStateManager.rotatef((lv.method_5695(f) - g) * 0.1F, 1.0F, 0.0F, 0.0F);
		GlStateManager.rotatef((lv.method_5705(f) - h) * 0.1F, 0.0F, 1.0F, 0.0F);
	}
	...
	public void method_3225(float f) {
		...
		if (lv.method_6115()) {
			...
			class_1268 lv4 = lv.method_6058();
			if (lv4 == class_1268.field_5808) {
				class_1799 lv5 = lv.method_6079();
				if (lv5.method_7909() == class_1802.field_8399 && class_1764.method_7781(lv5)) {
					bl2 = false;
				}
			}
		} else {
			class_1799 lv3x = lv.method_6047();
			class_1799 lv6 = lv.method_6079();
			if (lv3x.method_7909() == class_1802.field_8399 && class_1764.method_7781(lv3x)) {
				bl2 = !bl;
			}

			if (lv6.method_7909() == class_1802.field_8399 && class_1764.method_7781(lv6)) {
				bl = !lv3x.method_7960();
				bl2 = !bl;
			}
		}
	...
	public void method_3228(class_742 arg, float f, float g, class_1268 arg2, float h, class_1799 arg3, float i) {
		...
		if (arg3.method_7960()) {
			...
			boolean bl3 = arg.method_6115() && arg.method_6058() == arg2;
			boolean bl4 = !bl3 && arg2 == class_1268.field_5810 && arg.method_6039();
			if (bl3 || bl4) {
				int p = bl2 ? 1 : -1;
				switch (arg3.method_7976()) {
					...
					case field_8953:
						...
						float lxx = (float)arg3.method_7935() - ((float)this.field_4050.field_1724.method_6014() - f + 1.0F);
						float mx = lxx / 20.0F;
						...
						if (mx > 0.1F) {
							float n = class_3532.method_15374((lxx - 0.1F) * 1.3F);
							float o = mx - 0.1F;
							float q = n * o;
					...
					case field_8951:
						...
						GlStateManager.rotatef((float)p * 35.3F, 0.0F, 1.0F, 0.0F);
						GlStateManager.rotatef((float)p * -9.785F, 0.0F, 0.0F, 1.0F);
						float lx = (float)arg3.method_7935() - ((float)this.field_4050.field_1724.method_6014() - f + 1.0F);
						float m = lx / 10.0F;
						if (m > 1.0F) {
							m = 1.0F;
						}
						...
						if (m > 0.1F) {
							float n = class_3532.method_15374((lx - 0.1F) * 1.3F);
							float o = m - 0.1F;
							float q = n * o;
							GlStateManager.translatef(q * 0.0F, q * 0.004F, q * 0.0F);
						}
				...
				float kx = -0.4F * class_3532.method_15374(class_3532.method_15355(h) * (float) Math.PI);
				float lxxx = 0.2F * class_3532.method_15374(class_3532.method_15355(h) * (float) (Math.PI * 2));
				float mxx = -0.2F * class_3532.method_15374(h * (float) Math.PI);
				int r = bl2 ? 1 : -1;
	...
	public void method_3232(float f) {
		...
		if (this.field_4050.field_1724.method_5757()) {
			...
			for (int i = 0; i < 8; i++) {
				double d = lv2.field_5987 + (double)(((float)((i >> 0) % 2) - 0.5F) * lv2.method_17681() * 0.8F);
				double e = lv2.field_6010 + (double)(((float)((i >> 1) % 2) - 0.5F) * 0.1F);
				double g = lv2.field_6035 + (double)(((float)((i >> 2) % 2) - 0.5F) * lv2.method_17681() * 0.8F);
	...
	public void method_3220() {
		...
		if (lv.method_3144()) {
			...
			float f = lv.method_7261(1.0F) * 0.5F;
			f = f * f * f * 0.25F + 0.75F;
			this.field_4043 = this.field_4043 + class_3532.method_15363((Objects.equals(this.field_4047, lv2) ? f : 0.0F) - this.field_4043, -0.4F, 0.4F);
	...
	public void method_3215(class_1268 arg) {
		if (arg == class_1268.field_5808) {
			...
			this.field_4053 = 0.0F;
		} else {
			this.field_4052 = 0.0F;
			this.field_4051 = 0.0F;
		}
	}
}
