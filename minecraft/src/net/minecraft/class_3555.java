...
public class class_3555 extends DataFix {
	private static final Map<String, String> field_15788 = ImmutableMap.builder()
	...
	public class_3555(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		return this.fixTypeEverywhereTyped(
			"AdvancementsFix",
			this.getInputSchema().getType(class_1208.field_5725),
