...
public class class_1359 extends class_1352 {
	...
	public boolean method_6264() {
		if (this.field_6476.method_5782()) {
			...
			if (this.field_6477 == null) {
				...
				if (d < 4.0 || d > 16.0) {
					return false;
				} else if (!this.field_6476.field_5952) {
					return false;
				} else {
					return this.field_6476.method_6051().nextInt(5) == 0;
				}
			}
		}
	}
	...
	public void method_6269() {
		...
		if ((double)f >= 1.0E-4) {
			this.field_6476.field_5967 += d / (double)f * 0.5 * 0.8F + this.field_6476.field_5967 * 0.2F;
			this.field_6476.field_6006 += e / (double)f * 0.5 * 0.8F + this.field_6476.field_6006 * 0.2F;
		}
