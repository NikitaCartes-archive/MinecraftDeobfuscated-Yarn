...
public class class_1359 extends Goal {
	...
	public boolean canStart() {
		if (this.field_6476.hasPassengers()) {
			...
			if (this.field_6477 == null) {
				...
				if (d < 4.0 || d > 16.0) {
					return false;
				} else if (!this.field_6476.onGround) {
					return false;
				} else {
					return this.field_6476.getRand().nextInt(5) == 0;
				}
			}
		}
	}
	...
	public void start() {
		...
		if ((double)f >= 1.0E-4) {
			this.field_6476.velocityX += d / (double)f * 0.5 * 0.8F + this.field_6476.velocityX * 0.2F;
			this.field_6476.velocityZ += e / (double)f * 0.5 * 0.8F + this.field_6476.velocityZ * 0.2F;
		}
