...
public final class class_1799 {
	...
	private class_1799(class_2487 arg) {
		class_1792 lv = class_2378.field_11142.method_10223(new class_2960(arg.method_10558("id")));
		this.field_8038 = lv == null ? class_1802.field_8162 : lv;
	...
	public boolean method_7960() {
		if (this == field_8037) {
			return true;
		} else if (this.method_7909() == null || this.method_7909() == class_1802.field_8162) {
			return true;
		} else {
			return this.field_8031 <= 0;
		}
	}
	...
	public void method_7956(int i, class_1309 arg) {
		if (!(arg instanceof class_1657) || !((class_1657)arg).field_7503.field_7477) {
			if (this.method_7963()) {
				if (this.method_7970(i, arg.method_6051(), arg instanceof class_3222 ? (class_3222)arg : null)) {
					arg.method_6045(this);
	...
	public static boolean method_7975(class_1799 arg, class_1799 arg2) {
		if (arg.method_7960() && arg2.method_7960()) {
			...
			return false;
		} else if (arg.field_8040 == null && arg2.field_8040 != null) {
			return false;
		} else {
			return arg.field_8040 == null || arg.field_8040.equals(arg2.field_8040);
		}
	}
	...
	private boolean method_7968(class_1799 arg) {
		if (this.field_8031 != arg.field_8031) {
			...
			return false;
		} else if (this.field_8040 == null && arg.field_8040 != null) {
			return false;
		} else {
			return this.field_8040 == null || this.field_8040.equals(arg.field_8040);
		}
	}
	...
	public String toString() {
		return this.field_8031 + "x" + this.method_7909().method_7876();
	}
	...
	public List<class_2561> method_7950(@Nullable class_1657 arg, class_1836 arg2) {
		...
		if (this.method_7985()) {
			if ((i & 1) == 0) {
				class_2499 lv2 = this.method_7921();

				for(int j = 0; j < lv2.size(); ++j) {
					class_2487 lv3 = lv2.method_10602(j);
					class_1887 lv4 = class_2378.field_11160.method_10223(class_2960.method_12829(lv3.method_10558("id")));
					if (lv4 != null) {
						list.add(lv4.method_8179(lv3.method_10550("lvl")));
					}
				}
			}

			if (this.field_8040.method_10573("display", 10)) {
				class_2487 lv5 = this.field_8040.method_10562("display");
				if (lv5.method_10573("color", 3)) {
					if (arg2.method_8035()) {
						list.add(new class_2588("item.color", String.format("#%06X", lv5.method_10550("color"))).method_10854(class_124.field_1080));
					} else {
						list.add(new class_2588("item.dyed").method_10856(new class_124[]{class_124.field_1080, class_124.field_1056}));
					}
				}

				if (lv5.method_10540("Lore") == 9) {
					class_2499 lv6 = lv5.method_10554("Lore", 8);

					for(int k = 0; k < lv6.size(); ++k) {
						String string = lv6.method_10608(k);

						try {
							class_2561 lv7 = class_2561.class_2562.method_10877(string);
							if (lv7 != null) {
								list.add(class_2564.method_10889(lv7, new class_2583().method_10977(class_124.field_1064).method_10978(true)));
							}
						} catch (JsonParseException var19) {
							lv5.method_10551("Lore");
						}
					}
				}
			}
		...
		for(class_1304 lv8 : class_1304.values()) {
			Multimap<String, class_1322> multimap = this.method_7926(lv8);
			if (!multimap.isEmpty() && (i & 2) == 0) {
				list.add(new class_2585(""));
				list.add(new class_2588("item.modifiers." + lv8.method_5923()).method_10854(class_124.field_1080));

				for(Entry<String, class_1322> entry : multimap.entries()) {
					class_1322 lv9 = (class_1322)entry.getValue();
					double d = lv9.method_6186();
					boolean bl = false;
					if (arg != null) {
						if (lv9.method_6189() == class_1792.field_8006) {
							d += arg.method_5996(class_1612.field_7363).method_6201();
							d += (double)class_1890.method_8218(this, class_1310.field_6290);
							bl = true;
						} else if (lv9.method_6189() == class_1792.field_8001) {
							d += arg.method_5996(class_1612.field_7356).method_6201();
							bl = true;
						}
					}

					double e;
					if (lv9.method_6182() != class_1322.class_1323.field_6330 && lv9.method_6182() != class_1322.class_1323.field_6331) {
						e = d;
					} else {
						e = d * 100.0;
					}
					...
					if (bl) {
						list.add(
							new class_2585(" ")
								.method_10852(
									new class_2588(
										"attribute.modifier.equals." + lv9.method_6182().method_6191(), field_8029.format(e), new class_2588("attribute.name." + (String)entry.getKey())
									)
								)
						...
						list.add(
							new class_2588(
									"attribute.modifier.plus." + lv9.method_6182().method_6191(), field_8029.format(e), new class_2588("attribute.name." + (String)entry.getKey())
								)
						...
						list.add(
							new class_2588(
									"attribute.modifier.take." + lv9.method_6182().method_6191(), field_8029.format(e), new class_2588("attribute.name." + (String)entry.getKey())
								)
		...
		if (this.method_7985() && this.field_8040.method_10573("CanDestroy", 9) && (i & 8) == 0) {
			class_2499 lv2 = this.field_8040.method_10554("CanDestroy", 8);
			if (!lv2.isEmpty()) {
				list.add(new class_2585(""));
				list.add(new class_2588("item.canBreak").method_10854(class_124.field_1080));

				for(int j = 0; j < lv2.size(); ++j) {
					list.addAll(method_7937(lv2.method_10608(j)));
				}
			}
		}

		if (this.method_7985() && this.field_8040.method_10573("CanPlaceOn", 9) && (i & 16) == 0) {
			class_2499 lv2 = this.field_8040.method_10554("CanPlaceOn", 8);
			if (!lv2.isEmpty()) {
				list.add(new class_2585(""));
	...
	public boolean method_7923() {
		if (!this.method_7909().method_7870(this)) {
			return false;
		} else {
			return !this.method_7942();
		}
	}
	...
	public boolean method_7942() {
		if (this.field_8040 != null && this.field_8040.method_10573("Enchantments", 9)) {
			return !this.field_8040.method_10554("Enchantments", 10).isEmpty();
		} else {
			return false;
		}
	}
