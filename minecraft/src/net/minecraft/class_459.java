...
public class class_459 extends class_4265<class_459.class_461> {
	...
	public class_459(class_458 arg, class_310 arg2) {
		...
		for(class_304 lv : lvs) {
			...
			if (!string2.equals(string)) {
				string = string2;
				this.addEntry(new class_459.class_460(string2));
			}
			...
			this.addEntry(new class_459.class_462(lv));
		}
	}
	...
	public class class_460 extends class_459.class_461 {
		...
		public class_460(String string) {
			...
			this.field_2737 = class_459.this.minecraft.field_1772.method_1727(this.field_2736);
		}

		@Override
		public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
			class_459.this.minecraft
				.field_1772
				.method_1729(this.field_2736, (float)(class_459.this.minecraft.field_1755.width / 2 - this.field_2737 / 2), (float)(j + m - 9 - 1), 16777215);
		}
	...
	public class class_462 extends class_459.class_461 {
		...
		private class_462(class_304 arg2) {
			...
			this.field_2739 = new class_4185(0, 0, 75, 20, this.field_2741, arg2x -> class_459.this.field_2735.field_2727 = arg2) {
				@Override
				protected String getNarrationMessage() {
					return arg2.method_1415()
						? class_1074.method_4662("narrator.controls.unbound", class_462.this.field_2741)
						: class_1074.method_4662("narrator.controls.bound", class_462.this.field_2741, super.getNarrationMessage());
				}
			};
			this.field_2743 = new class_4185(0, 0, 50, 20, class_1074.method_4662("controls.reset"), arg2x -> {
				class_459.this.minecraft.field_1690.method_1641(arg2, arg2.method_1429());
				class_304.method_1426();
			}) {
				@Override
				protected String getNarrationMessage() {
					return class_1074.method_4662("narrator.controls.reset", class_462.this.field_2741);
				}
			};
		}
		...
		public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
			...
			class_459.this.minecraft.field_1772.method_1729(this.field_2741, (float)(k + 90 - class_459.this.field_2733), (float)(j + m / 2 - 9 / 2), 16777215);
			this.field_2743.field_23658 = k + 190;
			this.field_2743.field_23659 = j;
			this.field_2743.active = !this.field_2740.method_1427();
			this.field_2743.render(n, o, f);
			this.field_2739.field_23658 = k + 105;
			this.field_2739.field_23659 = j;
			this.field_2739.setMessage(this.field_2740.method_16007());
			boolean bl3 = false;
			if (!this.field_2740.method_1415()) {
				for(class_304 lv : class_459.this.minecraft.field_1690.field_1839) {
		...
		public boolean mouseClicked(double d, double e, int i) {
			if (this.field_2739.mouseClicked(d, e, i)) {
				return true;
			} else {
				return this.field_2743.mouseClicked(d, e, i);
			}
		}
