...
public class class_525 extends class_437 {
	...
	protected void init() {
		...
		this.field_3188 = new class_342(this.font, this.width / 2 - 100, 60, 200, 20, class_1074.method_4662("selectWorld.enterName"));
		...
		this.field_3184 = new class_342(this.font, this.width / 2 - 100, 60, 200, 20, class_1074.method_4662("selectWorld.enterSeed"));
			...
			if (class_1942.field_9279[this.field_3204].method_8644()) {
				this.font
					.method_1712(
						...
						this.field_3189.field_23658 + 2,
						this.field_3189.field_23659 + 22,
