...
public class class_1686 extends class_1682 implements class_3856 {
	...
	public class_1686(class_1299<? extends class_1686> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public void method_7494(class_1799 arg) {
		this.method_5841().method_12778(field_7652, arg.method_7972());
	}
	...
	protected void method_7492(class_239 arg) {
		if (!this.field_6002.field_9236) {
			...
			if (arg.method_17783() == class_239.class_240.field_1332 && bl) {
				class_3965 lv3 = (class_3965)arg;
				class_2350 lv4 = lv3.method_17780();
				class_2338 lv5 = lv3.method_17777().method_10093(lv4);
				this.method_7499(lv5, lv4);
				this.method_7499(lv5.method_10093(lv4.method_10153()), lv4);

				for (class_2350 lv6 : class_2350.class_2353.field_11062) {
					this.method_7499(lv5.method_10093(lv6), lv6);
				}
			}
			...
			if (bl) {
				...
				if (this.method_7501()) {
					...
					this.method_7498(list, arg.method_17783() == class_239.class_240.field_1331 ? ((class_3966)arg).method_17782() : null);
				}
			}

			int i = lv2.method_8050() ? 2007 : 2002;
			this.field_6002.method_20290(i, new class_2338(this), class_1844.method_8064(lv));
			this.method_5650();
		}
	}
		...
		if (!list.isEmpty()) {
			for (class_1309 lv2 : list) {
				...
				if (d < 16.0 && method_7496(lv2)) {
					lv2.method_5643(class_1282.method_5536(lv2, this.method_7491()), 1.0F);
				}
			}
		}
	}

	private void method_7498(List<class_1293> list, @Nullable class_1297 arg) {
		class_238 lv = this.method_5829().method_1009(4.0, 2.0, 4.0);
		List<class_1309> list2 = this.field_6002.method_18467(class_1309.class, lv);
		if (!list2.isEmpty()) {
	...
	private void method_7499(class_2338 arg, class_2350 arg2) {
		...
		if (lv2 == class_2246.field_10036) {
			this.field_6002.method_8506(null, arg.method_10093(arg2), arg2.method_10153());
		} else if (lv2 == class_2246.field_17350 && (Boolean)lv.method_11654(class_3922.field_17352)) {
			this.field_6002.method_8444(null, 1009, arg, 0);
			this.field_6002.method_8501(arg, lv.method_11657(class_3922.field_17352, Boolean.valueOf(false)));
		}
	}
