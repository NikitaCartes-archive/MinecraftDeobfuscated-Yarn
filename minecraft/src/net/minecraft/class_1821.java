...
public class class_1821 extends class_1766 {
	...
	public class_1821(class_1832 arg, class_1792.class_1793 arg2) {
		super(arg, field_8913, arg2);
	}
		...
		if (arg.method_8038() != class_2350.field_11033 && lv.method_8320(lv2.method_10084()).method_11588()) {
			...
			if (lv3 != null) {
				...
				if (!lv.field_9236) {
					...
					if (lv4 != null) {
						arg.method_8041().method_7956(1, lv4, arg2 -> arg2.method_20236(arg.method_20287()));
					}
				}
