...
public class class_757 implements AutoCloseable, class_4013 {
	...
	public void method_3190(float f) {
		...
		if (lv != null) {
			if (this.field_4015.field_1687 != null) {
				...
				float g = this.field_4015.field_1761.method_26751();
				class_243 lv2 = lv.method_5828(1.0F);
				class_243 lv3 = lv.method_5836(f);
				class_243 lv4 = lv3.method_1031(lv2.field_1352 * (double)g, lv2.field_1351 * (double)g, lv2.field_1350 * (double)g);
				float h = 1.0F;
				class_238 lv5 = lv.method_5829().method_18804(lv2.method_1021((double)g)).method_1009(1.0, 1.0, 1.0);
				class_3966 lv6 = class_1675.method_18075(lv, lv3, lv4, lv5, arg -> !arg.method_7325() && arg.method_5863(), (double)(g * g));
				boolean bl = lv6 != null;
				double d = (double)this.field_4015.field_1761.method_26749();
				if (lv6 != null && (double)lv6.method_26747() < d) {
					d = (double)lv6.method_26747();
				} else if (d > (double)g) {
					d = (double)g;
				}
				...
				class_239 lv7 = null;
				if (bl) {
					lv7 = lv.method_26731(d, f);
				} else {
					lv7 = lv.method_5745(d, f, false);
				}

				if (lv7 != null && lv7.method_17783() != class_239.class_240.field_1333) {
					this.field_4015.field_1765 = lv7;
				} else if (lv6 != null) {
					this.field_4015.field_1765 = lv6;
					this.field_4015.field_1692 = lv6.method_17782();
				} else {
					this.field_4015.field_1765 = lv7;
				}
	...
	public void method_3192(float f, long l, boolean bl) {
		...
		if (!this.field_4015.field_1743) {
			int i = (int)(
				this.field_4015.field_1729.method_1603() * (double)this.field_4015.field_1704.method_4486() / (double)this.field_4015.field_1704.method_4480()
			);
			int j = (int)(
				this.field_4015.field_1729.method_1604() * (double)this.field_4015.field_1704.method_4502() / (double)this.field_4015.field_1704.method_4507()
			);
	...
	private void method_3176() {
		if (this.field_4015.field_1769.method_3246() > 10 && this.field_4015.field_1769.method_3281() && !this.field_4015.method_1576().method_3771()) {
			...
			class_3306.field_14301.execute(() -> {
				...
				try (class_1011 lvxx = new class_1011(64, 64, false)) {
					lv.method_4300(k, l, i, j, lvxx);
					lvxx.method_4325(this.field_4015.method_1576().method_3725());
				} catch (IOException var27) {
					field_3993.warn("Couldn't save auto screenshot", var27);
				} finally {
					lv.close();
				}
			});
				...
				if (lv3.method_10264() <= lv2.method_10264() + 10
					...
					if (p > -Double.MAX_VALUE) {
						if (!lv7.method_15767(class_3486.field_15518)
							...
							&& (lv6.method_11614() != class_2246.field_17350 || !lv6.method_11654(class_3922.field_17352))) {
