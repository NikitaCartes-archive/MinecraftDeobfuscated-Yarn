...
public abstract class class_3204 {
	...
	private final Long2ObjectMap<ObjectSet<class_3222>> field_18251 = new Long2ObjectOpenHashMap<>();
	private final Long2ObjectOpenHashMap<ObjectSortedSet<class_3228<?>>> field_13895 = new Long2ObjectOpenHashMap<>();
	private final class_3204.class_4077 field_18252 = new class_3204.class_4077();
	private final class_3204.class_4078 field_18253 = new class_3204.class_4078();
	...
	protected void method_18738(int i) {
		...
		for(Entry<ObjectSet<class_3222>> entry : this.field_18251.long2ObjectEntrySet()) {
	...
	protected void method_14045() {
		...
		while(objectIterator.hasNext()) {
			Entry<ObjectSortedSet<class_3228<?>>> entry = (Entry)objectIterator.next();
			if (((ObjectSortedSet)entry.getValue()).removeIf(arg -> arg.method_14281() == class_3230.field_14032 && arg.method_14284() != this.field_13894)) {
				this.field_18252.method_14027(entry.getLongKey(), this.method_14046((ObjectSortedSet<class_3228<?>>)entry.getValue()), false);
			}
	...
	private int method_14046(ObjectSortedSet<class_3228<?>> objectSortedSet) {
		...
		return objectBidirectionalIterator.hasNext() ? ((class_3228)objectBidirectionalIterator.next()).method_14283() : class_3898.field_18239 + 1;
	}
	...
	private void method_14042(long l, class_3228<?> arg) {
		...
		if (arg.method_14283() < i) {
			this.field_18252.method_14027(l, arg.method_14283(), true);
		}
	}
	...
	private void method_17645(long l, class_3228<?> arg) {
		...
		this.field_18252.method_14027(l, this.method_14046(objectSortedSet), false);
	}
	...
	public void method_14048(class_4076 arg, class_3222 arg2) {
		long l = arg.method_18692().method_8324();
		arg2.method_17668(arg);
		this.field_18251.computeIfAbsent(arg.method_18694(), lx -> new ObjectOpenHashSet()).add(arg2);
		this.field_17453.computeIfAbsent(l, lx -> new ObjectOpenHashSet()).add(arg2);
	...
	public void method_14051(class_4076 arg, class_3222 arg2) {
		long l = arg.method_18692().method_8324();
		ObjectSet<class_3222> objectSet = this.field_18251.get(arg.method_18694());
		if (objectSet != null) {
			objectSet.remove(arg2);
			if (objectSet.isEmpty()) {
				this.field_18251.remove(arg.method_18694());
				this.field_18253.method_18750(arg.method_18694(), Integer.MAX_VALUE, false);
			}

			ObjectSet<class_3222> objectSet2 = this.field_17453.get(l);
			objectSet2.remove(arg2);
	...
	public boolean method_18739(class_4076 arg) {
		return this.field_18253.method_15480(arg.method_18694()) <= 16;
	}
	...
	class class_4077 extends class_3196 {
		public class_4077() {
		...
		@Override
		protected int method_14028(long l) {
			ObjectSortedSet<class_3228<?>> objectSortedSet = class_3204.this.field_13895.get(l);
		...
		@Override
		protected int method_15480(long l) {
			if (!class_3204.this.method_14035(l)) {
				class_3193 lv = class_3204.this.method_14038(l);
				if (lv != null) {
					return lv.method_14005();
				}
			}

			return class_3898.field_18239 + 1;
		}

		@Override
		protected void method_15485(long l, int i) {
			class_3193 lv = class_3204.this.method_14038(l);
			int j = lv == null ? class_3898.field_18239 + 1 : lv.method_14005();
			if (j != i) {
				lv = class_3204.this.method_14053(l, i, lv, j);
				if (lv != null) {
					class_3204.this.field_16210.add(lv);
				}
			}
		}

		public int method_18746(int i) {
			return this.method_15492(i);
		}
	}
	...
	class class_4078 extends class_4079 {
		...
		protected int method_18749(long l) {
			return this.method_18748(l) ? class_3204.this.method_18742() : Integer.MAX_VALUE;
		}

		private boolean method_18748(long l) {
			ObjectSet<class_3222> objectSet = class_3204.this.field_18251.get(l);
			return objectSet != null && !objectSet.isEmpty();
		}
