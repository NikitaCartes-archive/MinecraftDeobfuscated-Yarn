...
public abstract class class_3204 {
	...
	protected void method_14045() {
		...
		while(objectIterator.hasNext()) {
			...
			if (((ObjectSortedSet)entry.getValue()).removeIf(arg -> arg.method_20627(this.field_13894))) {
	...
	public <T> void method_20444(class_3230<T> arg, class_1923 arg2, int i, T object) {
		class_3228<T> lv = new class_3228<>(arg, i, object, this.field_13894);
	...
	protected void method_14036(class_1923 arg, boolean bl) {
		class_3228<class_1923> lv = new class_3228<>(class_3230.field_14031, 31, arg, this.field_13894);
		if (bl) {
	...
	public boolean method_20800(long l) {
		this.field_17454.method_14057();
		return this.field_17454.field_13896.containsKey(l);
	}
