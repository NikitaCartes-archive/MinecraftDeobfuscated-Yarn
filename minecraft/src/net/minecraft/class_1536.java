...
public class class_1536 extends class_1297 {
	...
	private void method_6953() {
		...
		this.field_5967 *= 0.6 / (double)m + 0.5 + this.field_5974.nextGaussian() * 0.0045;
		this.field_5984 *= 0.6 / (double)m + 0.5 + this.field_5974.nextGaussian() * 0.0045;
		this.field_6006 *= 0.6 / (double)m + 0.5 + this.field_5974.nextGaussian() * 0.0045;
		...
		if (this.field_7177 == null) {
			...
			if (this.field_7175 == class_1536.class_1537.field_7180) {
				...
				if (this.field_7175 == class_1536.class_1537.field_7179) {
					...
					this.field_5984 -= d * (double)this.field_5974.nextFloat() * 0.2;
	...
	private void method_6958() {
		...
		List<class_1297> list = this.field_6002
			.method_8335(this, this.method_5829().method_1012(this.field_5967, this.field_5984, this.field_6006).method_1014(1.0));
		double d = 0.0;
	...
	private void method_6949(class_2338 arg) {
		...
		if (this.field_7173 > 0) {
			...
			if (this.field_7173 <= 0) {
				...
				this.field_5984 -= 0.2 * (double)this.field_5974.nextFloat() * (double)this.field_5974.nextFloat();
			}
