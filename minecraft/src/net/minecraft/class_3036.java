...
public class class_3036 {
	private static final DynamicCommandExceptionType field_13602 = new DynamicCommandExceptionType(
		object -> new class_2588("commands.difficulty.failure", object)
	);
	...
	public static void method_13169(CommandDispatcher<class_2168> commandDispatcher) {
		...
		commandDispatcher.register(literalArgumentBuilder.requires(arg -> arg.method_9259(2)).executes(commandContext -> {
			class_1267 lvxx = commandContext.getSource().method_9225().method_8407();
			commandContext.getSource().method_9226(new class_2588("commands.difficulty.query", lvxx.method_5463()), false);
			return lvxx.method_5461();
		}));
	}
	...
	public static int method_13173(class_2168 arg, class_1267 arg2) throws CommandSyntaxException {
		...
		if (minecraftServer.method_3847(class_2874.field_13072).method_8407() == arg2) {
			...
			minecraftServer.method_3776(arg2);
