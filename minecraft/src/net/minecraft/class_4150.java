...
public class class_4150 extends class_4148<LivingEntity> {
	private static final ImmutableMap<EntityType<?>, Float> field_18473 = ImmutableMap.builder()
		...
		lv.method_18904(class_4140.field_18442)
			.ifPresent(
				list -> list.stream()
						...
						.filter(livingEntity2 -> livingEntity2.squaredDistanceTo(livingEntity) <= (double)((Float)field_18473.get(livingEntity2.method_5864())).floatValue())
						.findFirst()
