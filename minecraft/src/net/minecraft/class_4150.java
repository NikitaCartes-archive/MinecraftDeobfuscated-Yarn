...
public class class_4150 extends class_4148<class_1309> {
	private static final ImmutableMap<class_1299<?>, Float> field_18473 = ImmutableMap.builder()
	...
	private boolean method_19105(class_1309 arg, class_1309 arg2) {
		return arg2.method_5858(arg) <= (double)((Float)field_18473.get(arg2.method_5864())).floatValue();
	}
