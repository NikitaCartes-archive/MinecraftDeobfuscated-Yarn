...
public class Items {
	...
	public static final Item LEATHER_LEGGINGS = register(
		"leather_leggings", new DyeableArmorItem(ArmorMaterials.LEATHER, EquipmentSlot.LEGS, new Item.Settings())
	);
	...
	public static final Item CHAINMAIL_CHESTPLATE = register(
		"chainmail_chestplate", new ArmorItem(ArmorMaterials.CHAIN, EquipmentSlot.CHEST, new Item.Settings())
	);
	...
	public static final Item POLAR_BEAR_SPAWN_EGG = register(
		"polar_bear_spawn_egg", new SpawnEggItem(EntityType.POLAR_BEAR, 15921906, 9803152, new Item.Settings())
	);
