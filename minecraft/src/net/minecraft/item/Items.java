...
public class Items {
	...
	public static final Item CUT_SANDSTONE_SLAB = method_7988(Blocks.field_18890, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CUT_RED_SANDSTONE_SLAB = method_7988(Blocks.field_18891, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item field_8403 = register(
		"iron_pickaxe", new PickaxeItem(ToolMaterials.field_8923, 1, -2.8F, new Item.Settings().group(ItemGroup.TOOLS))
	);
	...
	public static final Item field_8802 = register(
		"diamond_sword", new SwordItem(ToolMaterials.field_8930, 3, -2.4F, new Item.Settings().group(ItemGroup.COMBAT))
	);
	...
	public static final Item field_8288 = register(
		"totem_of_undying", new Item(new Item.Settings().maxCount(1).group(ItemGroup.COMBAT).rarity(Rarity.field_8907))
	);
