...
public class Items {
	...
	public static final Item CRIMSON_NYLIUM = register(Blocks.field_22120, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_NYLIUM = register(Blocks.field_22113, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_PLANKS = register(Blocks.field_22126, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_PLANKS = register(Blocks.field_22127, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item NETHER_GOLD_ORE = register(Blocks.field_23077, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_STEM = register(Blocks.field_22118, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_STEM = register(Blocks.field_22111, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item STRIPPED_CRIMSON_STEM = register(Blocks.field_22119, ItemGroup.BUILDING_BLOCKS);
	public static final Item STRIPPED_WARPED_STEM = register(Blocks.field_22112, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item STRIPPED_CRIMSON_HYPHAE = register(Blocks.field_22506, ItemGroup.BUILDING_BLOCKS);
	public static final Item STRIPPED_WARPED_HYPHAE = register(Blocks.field_22504, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_HYPHAE = register(Blocks.field_22505, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_HYPHAE = register(Blocks.field_22503, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_FUNGUS = register(Blocks.field_22121, ItemGroup.DECORATIONS);
	public static final Item WARPED_FUNGUS = register(Blocks.field_22114, ItemGroup.DECORATIONS);
	public static final Item CRIMSON_ROOTS = register(Blocks.field_22125, ItemGroup.DECORATIONS);
	public static final Item WARPED_ROOTS = register(Blocks.field_22116, ItemGroup.DECORATIONS);
	public static final Item NETHER_SPROUTS = register(Blocks.field_22117, ItemGroup.DECORATIONS);
	public static final Item WEEPING_VINES = register(Blocks.field_22123, ItemGroup.DECORATIONS);
	public static final Item TWISTING_VINES = register(Blocks.field_23078, ItemGroup.DECORATIONS);
	public static final Item SUGAR_CANE = register(Blocks.field_10424, ItemGroup.DECORATIONS);
	public static final Item KELP = register(Blocks.field_9993, ItemGroup.DECORATIONS);
	public static final Item BAMBOO = register(Blocks.field_10211, ItemGroup.DECORATIONS);
	...
	public static final Item CRIMSON_SLAB = register(Blocks.field_22128, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_SLAB = register(Blocks.field_22129, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_PRESSURE_PLATE = register(Blocks.field_22130, ItemGroup.REDSTONE);
	public static final Item WARPED_PRESSURE_PLATE = register(Blocks.field_22131, ItemGroup.REDSTONE);
	public static final Item POLISHED_BLACKSTONE_PRESSURE_PLATE = register(Blocks.field_23863, ItemGroup.REDSTONE);
	...
	public static final Item CRIMSON_FENCE = register(Blocks.field_22132, ItemGroup.DECORATIONS);
	public static final Item WARPED_FENCE = register(Blocks.field_22133, ItemGroup.DECORATIONS);
	...
	public static final Item SOUL_SOIL = register(Blocks.field_22090, ItemGroup.BUILDING_BLOCKS);
	public static final Item BASALT = register(Blocks.field_22091, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BASALT = register(Blocks.field_23151, ItemGroup.BUILDING_BLOCKS);
	public static final Item SOUL_TORCH = register(
		new WallStandingBlockItem(Blocks.field_22092, Blocks.field_22093, new Item.Settings().group(ItemGroup.DECORATIONS))
	);
	...
	public static final Item CRIMSON_TRAPDOOR = register(Blocks.field_22094, ItemGroup.REDSTONE);
	public static final Item WARPED_TRAPDOOR = register(Blocks.field_22095, ItemGroup.REDSTONE);
	...
	public static final Item CHAIN = register(Blocks.field_23985, ItemGroup.DECORATIONS);
	...
	public static final Item CRIMSON_FENCE_GATE = register(Blocks.field_22096, ItemGroup.REDSTONE);
	public static final Item WARPED_FENCE_GATE = register(Blocks.field_22097, ItemGroup.REDSTONE);
	...
	public static final Item CRACKED_NETHER_BRICKS = register(Blocks.field_23867, ItemGroup.BUILDING_BLOCKS);
	public static final Item CHISELED_NETHER_BRICKS = register(Blocks.field_23866, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_STAIRS = register(Blocks.field_22098, ItemGroup.BUILDING_BLOCKS);
	public static final Item WARPED_STAIRS = register(Blocks.field_22099, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item BLACKSTONE_WALL = register(Blocks.field_23871, ItemGroup.DECORATIONS);
	public static final Item POLISHED_BLACKSTONE_WALL = register(Blocks.field_23865, ItemGroup.DECORATIONS);
	public static final Item POLISHED_BLACKSTONE_BRICK_WALL = register(Blocks.field_23879, ItemGroup.DECORATIONS);
	...
	public static final Item CRIMSON_BUTTON = register(Blocks.field_22100, ItemGroup.REDSTONE);
	public static final Item WARPED_BUTTON = register(Blocks.field_22101, ItemGroup.REDSTONE);
	public static final Item POLISHED_BLACKSTONE_BUTTON = register(Blocks.field_23864, ItemGroup.REDSTONE);
	...
	public static final Item QUARTZ_BRICKS = register(Blocks.field_23868, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item WARPED_WART_BLOCK = register(Blocks.field_22115, ItemGroup.BUILDING_BLOCKS);
	...
	public static final Item CRIMSON_DOOR = register(new TallBlockItem(Blocks.field_22102, new Item.Settings().group(ItemGroup.REDSTONE)));
	public static final Item WARPED_DOOR = register(new TallBlockItem(Blocks.field_22103, new Item.Settings().group(ItemGroup.REDSTONE)));
	...
	public static final Item field_22020 = register("netherite_ingot", new Item(new Item.Settings().group(ItemGroup.MATERIALS).fireproof()));
	public static final Item field_22021 = register("netherite_scrap", new Item(new Item.Settings().group(ItemGroup.MATERIALS).fireproof()));
	public static final Item field_8091 = register("wooden_sword", new SwordItem(ToolMaterials.field_8922, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final Item field_8876 = register("wooden_shovel", new ShovelItem(ToolMaterials.field_8922, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8647 = register("wooden_pickaxe", new PickaxeItem(ToolMaterials.field_8922, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8406 = register("wooden_axe", new AxeItem(ToolMaterials.field_8922, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8167 = register("wooden_hoe", new HoeItem(ToolMaterials.field_8922, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8528 = register("stone_sword", new SwordItem(ToolMaterials.field_8927, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final Item field_8776 = register("stone_shovel", new ShovelItem(ToolMaterials.field_8927, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8387 = register("stone_pickaxe", new PickaxeItem(ToolMaterials.field_8927, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8062 = register("stone_axe", new AxeItem(ToolMaterials.field_8927, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8431 = register("stone_hoe", new HoeItem(ToolMaterials.field_8927, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8845 = register("golden_sword", new SwordItem(ToolMaterials.field_8929, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final Item field_8322 = register("golden_shovel", new ShovelItem(ToolMaterials.field_8929, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8335 = register("golden_pickaxe", new PickaxeItem(ToolMaterials.field_8929, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8825 = register("golden_axe", new AxeItem(ToolMaterials.field_8929, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8303 = register("golden_hoe", new HoeItem(ToolMaterials.field_8929, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8371 = register("iron_sword", new SwordItem(ToolMaterials.field_8923, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final Item field_8699 = register("iron_shovel", new ShovelItem(ToolMaterials.field_8923, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8403 = register("iron_pickaxe", new PickaxeItem(ToolMaterials.field_8923, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8475 = register("iron_axe", new AxeItem(ToolMaterials.field_8923, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8609 = register("iron_hoe", new HoeItem(ToolMaterials.field_8923, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8802 = register("diamond_sword", new SwordItem(ToolMaterials.field_8930, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final Item field_8250 = register("diamond_shovel", new ShovelItem(ToolMaterials.field_8930, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8377 = register("diamond_pickaxe", new PickaxeItem(ToolMaterials.field_8930, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8556 = register("diamond_axe", new AxeItem(ToolMaterials.field_8930, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_8527 = register("diamond_hoe", new HoeItem(ToolMaterials.field_8930, new Item.Settings().group(ItemGroup.TOOLS)));
	public static final Item field_22022 = register(
		"netherite_sword", new SwordItem(ToolMaterials.field_22033, new Item.Settings().group(ItemGroup.COMBAT).fireproof())
	);
	public static final Item field_22023 = register(
		"netherite_shovel", new ShovelItem(ToolMaterials.field_22033, new Item.Settings().group(ItemGroup.TOOLS).fireproof())
	);
	public static final Item field_22024 = register(
		"netherite_pickaxe", new PickaxeItem(ToolMaterials.field_22033, new Item.Settings().group(ItemGroup.TOOLS).fireproof())
	);
	public static final Item field_22025 = register(
		"netherite_axe", new AxeItem(ToolMaterials.field_22033, new Item.Settings().group(ItemGroup.TOOLS).fireproof())
	);
	public static final Item field_22026 = register(
		"netherite_hoe", new HoeItem(ToolMaterials.field_22033, new Item.Settings().group(ItemGroup.TOOLS).fireproof())
	);
	...
	public static final Item field_22027 = register(
		"netherite_helmet", new ArmorItem(ArmorMaterials.field_21977, EquipmentSlot.field_6169, new Item.Settings().group(ItemGroup.COMBAT).fireproof())
	);
	public static final Item field_22028 = register(
		"netherite_chestplate", new ArmorItem(ArmorMaterials.field_21977, EquipmentSlot.field_6174, new Item.Settings().group(ItemGroup.COMBAT).fireproof())
	);
	public static final Item field_22029 = register(
		"netherite_leggings", new ArmorItem(ArmorMaterials.field_21977, EquipmentSlot.field_6172, new Item.Settings().group(ItemGroup.COMBAT).fireproof())
	);
	public static final Item field_22030 = register(
		"netherite_boots", new ArmorItem(ArmorMaterials.field_21977, EquipmentSlot.field_6166, new Item.Settings().group(ItemGroup.COMBAT).fireproof())
	);
	...
	public static final Item field_22011 = register(
		"crimson_sign", new SignItem(new Item.Settings().maxCount(16).group(ItemGroup.DECORATIONS), Blocks.field_22104, Blocks.field_22106)
	);
	public static final Item field_22012 = register(
		"warped_sign", new SignItem(new Item.Settings().maxCount(16).group(ItemGroup.DECORATIONS), Blocks.field_22105, Blocks.field_22107)
	);
	...
	public static final Item field_8543 = register("snowball", new SnowballItem(new Item.Settings().group(ItemGroup.MISC)));
	...
	public static final Item field_8557 = register("clock", new Item(new Item.Settings().group(ItemGroup.TOOLS)));
	...
	public static final Item field_22014 = register(
		"hoglin_spawn_egg", new SpawnEggItem(EntityType.field_21973, 13004373, 6251620, new Item.Settings().group(ItemGroup.MISC))
	);
	...
	public static final Item field_22401 = register(
		"piglin_spawn_egg", new SpawnEggItem(EntityType.field_22281, 10051392, 16380836, new Item.Settings().group(ItemGroup.MISC))
	);
	public static final Item field_25777 = register(
		"piglin_brute_spawn_egg", new SpawnEggItem(EntityType.field_25751, 5843472, 16380836, new Item.Settings().group(ItemGroup.MISC))
	);
	...
	public static final Item field_23255 = register(
		"strider_spawn_egg", new SpawnEggItem(EntityType.field_23214, 10236982, 5065037, new Item.Settings().group(ItemGroup.MISC))
	);
	...
	public static final Item field_23744 = register(
		"zoglin_spawn_egg", new SpawnEggItem(EntityType.field_23696, 13004373, 15132390, new Item.Settings().group(ItemGroup.MISC))
	);
	...
	public static final Item field_8093 = register(
		"zombified_piglin_spawn_egg", new SpawnEggItem(EntityType.field_6050, 15373203, 5009705, new Item.Settings().group(ItemGroup.MISC))
	);
	...
	public static final Item field_8184 = register(
		"carrot_on_a_stick", new OnAStickItem<>(new Item.Settings().maxDamage(25).group(ItemGroup.TRANSPORTATION), EntityType.field_6093, 7)
	);
	public static final Item field_23254 = register(
		"warped_fungus_on_a_stick", new OnAStickItem<>(new Item.Settings().maxDamage(100).group(ItemGroup.TRANSPORTATION), EntityType.field_23214, 1)
	);
	...
	public static final Item field_23984 = register(
		"music_disc_pigstep", new MusicDiscItem(13, SoundEvents.field_23968, new Item.Settings().maxCount(1).group(ItemGroup.MISC).rarity(Rarity.field_8903))
	);
	...
	public static final Item field_23831 = register(
		"piglin_banner_pattern", new BannerPatternItem(BannerPattern.field_23882, new Item.Settings().maxCount(1).group(ItemGroup.MISC))
	);
	public static final Item COMPOSTER = register(Blocks.field_17563, ItemGroup.DECORATIONS);
	...
	public static final Item SOUL_LANTERN = register(Blocks.field_22110, ItemGroup.DECORATIONS);
	...
	public static final Item SOUL_CAMPFIRE = register(Blocks.field_23860, ItemGroup.DECORATIONS);
	public static final Item SHROOMLIGHT = register(Blocks.field_22122, ItemGroup.DECORATIONS);
	...
	public static final Item LODESTONE = register(Blocks.field_23261, ItemGroup.DECORATIONS);
	public static final Item NETHERITE_BLOCK = register(new BlockItem(Blocks.field_22108, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS).fireproof()));
	public static final Item ANCIENT_DEBRIS = register(new BlockItem(Blocks.field_22109, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS).fireproof()));
	public static final Item TARGET = register(Blocks.field_22422, ItemGroup.REDSTONE);
	public static final Item CRYING_OBSIDIAN = register(Blocks.field_22423, ItemGroup.BUILDING_BLOCKS);
	public static final Item BLACKSTONE = register(Blocks.field_23869, ItemGroup.BUILDING_BLOCKS);
	public static final Item BLACKSTONE_SLAB = register(Blocks.field_23872, ItemGroup.BUILDING_BLOCKS);
	public static final Item BLACKSTONE_STAIRS = register(Blocks.field_23870, ItemGroup.BUILDING_BLOCKS);
	public static final Item GILDED_BLACKSTONE = register(Blocks.field_23880, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE = register(Blocks.field_23873, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE_SLAB = register(Blocks.field_23862, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE_STAIRS = register(Blocks.field_23861, ItemGroup.BUILDING_BLOCKS);
	public static final Item CHISELED_POLISHED_BLACKSTONE = register(Blocks.field_23876, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE_BRICKS = register(Blocks.field_23874, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE_BRICK_SLAB = register(Blocks.field_23877, ItemGroup.BUILDING_BLOCKS);
	public static final Item POLISHED_BLACKSTONE_BRICK_STAIRS = register(Blocks.field_23878, ItemGroup.BUILDING_BLOCKS);
	public static final Item CRACKED_POLISHED_BLACKSTONE_BRICKS = register(Blocks.field_23875, ItemGroup.BUILDING_BLOCKS);
	public static final Item RESPAWN_ANCHOR = register(Blocks.field_23152, ItemGroup.DECORATIONS);
