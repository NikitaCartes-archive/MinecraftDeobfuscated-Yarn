...
public class Items {
	...
	public static final Item BRICK_WALL = registerBlock(Blocks.field_10269, ItemGroup.BUILDING_BLOCKS);
	public static final Item PRISMARINE_WALL = registerBlock(Blocks.field_10530, ItemGroup.BUILDING_BLOCKS);
	public static final Item RED_SANDSTONE_WALL = registerBlock(Blocks.field_10413, ItemGroup.BUILDING_BLOCKS);
	public static final Item MOSSY_STONE_BRICK_WALL = registerBlock(Blocks.field_10059, ItemGroup.BUILDING_BLOCKS);
	public static final Item GRANITE_WALL = registerBlock(Blocks.field_10072, ItemGroup.BUILDING_BLOCKS);
	public static final Item STONE_BRICK_WALL = registerBlock(Blocks.field_10252, ItemGroup.BUILDING_BLOCKS);
	public static final Item NETHER_BRICK_WALL = registerBlock(Blocks.field_10127, ItemGroup.BUILDING_BLOCKS);
	public static final Item ANDESITE_WALL = registerBlock(Blocks.field_10489, ItemGroup.BUILDING_BLOCKS);
	public static final Item RED_NETHER_BRICK_WALL = registerBlock(Blocks.field_10311, ItemGroup.BUILDING_BLOCKS);
	public static final Item SANDSTONE_WALL = registerBlock(Blocks.field_10630, ItemGroup.BUILDING_BLOCKS);
	public static final Item END_STONE_BRICK_WALL = registerBlock(Blocks.field_10001, ItemGroup.BUILDING_BLOCKS);
	public static final Item DIORITE_WALL = registerBlock(Blocks.field_10517, ItemGroup.BUILDING_BLOCKS);
