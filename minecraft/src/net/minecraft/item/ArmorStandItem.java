...
public class ArmorStandItem extends Item {
	...
	public ActionResult useOnBlock(ItemUsageContext itemUsageContext) {
		...
		if (direction == Direction.field_11033) {
			...
			if (itemPlacementContext.canPlace() && world.method_8320(blockPos2).canReplace(itemPlacementContext)) {
				...
				if (!list.isEmpty()) {
					...
					if (!world.isClient) {
						...
						EntityType.method_5881(world, itemUsageContext.getPlayer(), armorStandEntity, itemStack.getTag());
