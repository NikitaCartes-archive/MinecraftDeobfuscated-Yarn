...
public class ArmorTrimMaterials {
	...
	public static final RegistryKey<ArmorTrimMaterial> AMBER = of("amber");

	public static void bootstrap(Registerable<ArmorTrimMaterial> registry) {
		register(registry, QUARTZ, Items.QUARTZ, Style.EMPTY.withColor(14931140), 0.01F);
		register(registry, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(15527148), 0.02F, Map.of(ArmorMaterials.IRON, "iron_darker"));
		register(registry, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), 0.03F, Map.of(ArmorMaterials.NETHERITE, "netherite_darker"));
		register(registry, REDSTONE, Items.REDSTONE, Style.EMPTY.withColor(9901575), 0.04F);
		register(registry, COPPER, Items.COPPER_INGOT, Style.EMPTY.withColor(11823181), 0.05F);
		register(registry, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), 0.06F, Map.of(ArmorMaterials.GOLD, "gold_darker"));
		register(registry, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126), 0.07F);
		register(registry, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), 0.08F, Map.of(ArmorMaterials.DIAMOND, "diamond_darker"));
		register(registry, LAPIS, Items.LAPIS_LAZULI, Style.EMPTY.withColor(4288151), 0.09F);
		register(registry, AMETHYST, Items.AMETHYST_SHARD, Style.EMPTY.withColor(10116294), 0.1F);
		register(registry, AMBER, Items.AMBER_GEM, Style.EMPTY.withColor(15042820), 1.0F);
	}
