...
public class ArmorTrimMaterials {
	...
	public static void oneTwentyBootstrap(Registerable<ArmorTrimMaterial> registry) {
		register(registry, QUARTZ, Items.QUARTZ, Style.EMPTY.withColor(14931140), 0.1F, Optional.empty());
		register(registry, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(15527148), 0.2F, Optional.of(ArmorMaterials.IRON));
		register(registry, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), 0.3F, Optional.of(ArmorMaterials.NETHERITE));
		register(registry, REDSTONE, Items.REDSTONE, Style.EMPTY.withColor(9901575), 0.4F, Optional.empty());
		register(registry, COPPER, Items.COPPER_INGOT, Style.EMPTY.withColor(11823181), 0.5F, Optional.empty());
		register(registry, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), 0.6F, Optional.of(ArmorMaterials.GOLD));
		register(registry, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126), 0.7F, Optional.empty());
		register(registry, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), 0.8F, Optional.of(ArmorMaterials.DIAMOND));
		register(registry, LAPIS, Items.LAPIS_LAZULI, Style.EMPTY.withColor(4288151), 0.9F, Optional.empty());
		register(registry, AMETHYST, Items.AMETHYST_SHARD, Style.EMPTY.withColor(10116294), 1.0F, Optional.empty());
	}
	...
	private static void register(
		...
		Optional<ArmorMaterials> incompatibleArmorMaterial
	) {
