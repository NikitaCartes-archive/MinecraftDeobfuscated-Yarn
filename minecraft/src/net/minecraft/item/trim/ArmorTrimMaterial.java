...
public record ArmorTrimMaterial(
	String assetName, RegistryEntry<Item> ingredient, float itemModelIndex, Optional<ArmorMaterials> incompatibleArmorMaterial, Text description
) {
	public static final Codec<ArmorTrimMaterial> CODEC = RecordCodecBuilder.create(
		instance -> instance.group(
					...
					ArmorMaterials.CODEC.optionalFieldOf("incompatible_armor_material").forGetter(ArmorTrimMaterial::incompatibleArmorMaterial),
	...
	public static ArmorTrimMaterial of(
		String assetName, Item ingredient, float itemModelIndex, Optional<ArmorMaterials> incompatibleArmorMaterial, Text description
	) {
