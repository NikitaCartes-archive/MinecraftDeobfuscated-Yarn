...
public final class ItemStack {
	...
	public static boolean areTagsEqual(ItemStack itemStack, ItemStack itemStack2) {
		if (itemStack.isEmpty() && itemStack2.isEmpty()) {
			...
			return false;
		} else if (itemStack.field_8040 == null && itemStack2.field_8040 != null) {
			return false;
		} else {
			return itemStack.field_8040 == null || itemStack.field_8040.equals(itemStack2.field_8040);
		}
	}
	...
	private boolean isEqual(ItemStack itemStack) {
		if (this.amount != itemStack.amount) {
			...
			return false;
		} else if (this.field_8040 == null && itemStack.field_8040 != null) {
			return false;
		} else {
			return this.field_8040 == null || this.field_8040.equals(itemStack.field_8040);
		}
	}
	...
	public boolean isEnchantable() {
		if (!this.getItem().method_7870(this)) {
			return false;
		} else {
	...
	public boolean hasEnchantments() {
		if (this.field_8040 != null && this.field_8040.containsKey("Enchantments", 9)) {
