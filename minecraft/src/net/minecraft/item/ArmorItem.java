...
public class ArmorItem extends Item implements Equipment {
	...
	public ArmorItem(RegistryEntry<ArmorMaterial> material, ArmorItem.Type type, Item.Settings settings) {
		...
		this.attributeModifiers = Suppliers.memoize(
			() -> {
				...
				float f = ((ArmorMaterial)material.value()).getToughness();
				...
				float g = ((ArmorMaterial)material.value()).getKnockbackResistance();
				if (g > 0.0F) {
					builder.put(
	...
	public int getEnchantability() {
		return ((ArmorMaterial)this.material.value()).getEnchantability();
	}
	...
	public boolean canRepair(ItemStack stack, ItemStack ingredient) {
		return ((Ingredient)((ArmorMaterial)this.material.value()).getRepairIngredient().get()).test(ingredient) || super.canRepair(stack, ingredient);
	}
	...
	public float getToughness() {
		return ((ArmorMaterial)this.material.value()).getToughness();
	}
	...
	public RegistryEntry<SoundEvent> getEquipSound() {
		return ((ArmorMaterial)this.getMaterial().value()).getEquipSound();
	}
