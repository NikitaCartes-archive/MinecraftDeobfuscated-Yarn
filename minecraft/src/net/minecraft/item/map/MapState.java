...
public class MapState extends PersistentState {
	...
	public static MapState fromNbt(NbtCompound nbt) {
		RegistryKey<World> registryKey = (RegistryKey)DimensionType.worldFromDimensionNbt(new Dynamic<>(NbtOps.INSTANCE, nbt.get("dimension")))
	...
	private static Predicate<ItemStack> method_55784(ItemStack itemStack) {
		...
		return itemStack2 -> {
			if (itemStack2 == itemStack) {
				...
				return itemStack2.isOf(itemStack.getItem()) && Objects.equals(integer, FilledMapItem.getMapId(itemStack2));
			}
		};
	}
