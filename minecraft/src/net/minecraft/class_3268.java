...
public class class_3268 implements class_3262 {
	...
	private static final Map<class_3264, FileSystem> field_17917 = class_156.method_654(Maps.newHashMap(), hashMap -> {
		synchronized(class_3268.class) {
			for(class_3264 lv : class_3264.values()) {
				...
				try {
					...
					field_14195.error("Couldn't get a list of all vanilla resources", var12);
				}
			}
		}
	});
	...
	public Collection<class_2960> method_14408(class_3264 arg, String string, int i, Predicate<String> predicate) {
		...
		try {
			...
			field_14195.error("Couldn't get a list of all vanilla resources", var11);
		}
	...
	protected InputStream method_14416(class_3264 arg, class_2960 arg2) {
		String string = method_20729(arg, arg2);
		if (field_14196 != null) {
	...
	private static String method_20729(class_3264 arg, class_2960 arg2) {
		return "/" + arg.method_14413() + "/" + arg2.method_12836() + "/" + arg2.method_12832();
	}
	...
	public <T> T method_14407(class_3270<T> arg) throws IOException {
		try {
			...
			Object var4;
			try {
				var4 = class_3255.<T>method_14392(arg, inputStream);
