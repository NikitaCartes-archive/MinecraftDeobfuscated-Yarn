...
public class class_2488 extends class_2248 {
	...
	public boolean method_9516(class_2680 arg, class_1922 arg2, class_2338 arg3, class_10 arg4) {
		switch(arg4) {
			case field_50:
				return arg.method_11654(field_11518) < 5;
			case field_48:
				return false;
			case field_51:
				return false;
	...
	public boolean method_9558(class_2680 arg, class_1941 arg2, class_2338 arg3) {
		...
		if (lv2 != class_2246.field_10295 && lv2 != class_2246.field_10225 && lv2 != class_2246.field_10499) {
			return class_2248.method_9501(lv.method_11628(arg2, arg3.method_10074()), class_2350.field_11036) || lv2 == this && lv.method_11654(field_11518) == 8;
		} else {
			return false;
		}
	}
	...
	public boolean method_9616(class_2680 arg, class_1750 arg2) {
		int i = arg.method_11654(field_11518);
		if (arg2.method_8041().method_7909() != this.method_8389() || i >= 8) {
			return i == 1;
		} else if (arg2.method_7717()) {
			return arg2.method_8038() == class_2350.field_11036;
		} else {
			return true;
		}
	}
	...
	public class_2680 method_9605(class_1750 arg) {
		...
		if (lv.method_11614() == this) {
			int i = lv.method_11654(field_11518);
