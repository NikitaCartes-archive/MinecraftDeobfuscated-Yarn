		...
		if (!this.field_4616.isEmpty()) {
			...
			for(Integer integer : this.field_4616.keySet()) {
				...
				for(class_9 lv3 : lv.method_43()) {
					if (!(this.method_3867(lv3) > 40.0F)) {
						class_863.method_3714(
							String.format("%s", lv3.field_41), (double)lv3.field_40 + 0.5, (double)lv3.field_39 + 0.75, (double)lv3.field_38 + 0.5, f, -16776961
						);
						class_863.method_3714(
							String.format(Locale.ROOT, "%.2f", lv3.field_43), (double)lv3.field_40 + 0.5, (double)lv3.field_39 + 0.25, (double)lv3.field_38 + 0.5, f, -16776961
						);
					}
				}
