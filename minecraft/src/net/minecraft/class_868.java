...
public class class_868 implements class_863.class_864 {
	...
	private final Map<Integer, class_11> field_4616 = Maps.newHashMap();
	private final Map<Integer, Float> field_4617 = Maps.newHashMap();
	private final Map<Integer, Long> field_4615 = Maps.newHashMap();
	...
	private static void method_20558(class_4184 arg, class_11 arg2, float f, boolean bl, boolean bl2) {
		...
		if (bl) {
			...
			for(class_9 lv3 : arg2.method_43()) {
				if (method_20554(arg, lv3) <= 40.0F) {
					class_863.method_3714(String.format("%s", lv3.field_41), (double)lv3.field_40 + 0.5, (double)lv3.field_39 + 0.75, (double)lv3.field_38 + 0.5, -16776961);
					class_863.method_3714(
						String.format(Locale.ROOT, "%.2f", lv3.field_43), (double)lv3.field_40 + 0.5, (double)lv3.field_39 + 0.25, (double)lv3.field_38 + 0.5, -16776961
					);
				}
			}
		}
