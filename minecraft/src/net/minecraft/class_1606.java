...
public class class_1606 extends class_1427 implements class_1569 {
	...
	public class_1606(class_1299<? extends class_1606> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public void method_5773() {
		super.method_5773();
		class_2338 lv = (class_2338)((Optional)this.field_6011.method_12789(field_7338)).orElse(null);
		...
		if (this.method_5765()) {
			...
			if (!this.field_6002.method_8515(lv4, this)) {
				boolean bl = false;
			...
			if (this.field_6002.method_8515(lv6, this)) {
				this.method_7127();
			}
		}
		...
		if (lv != null) {
			...
			class_2350 lv7 = this.method_7119().method_10153();
			this.method_5857(
				new class_238(this.field_5987 - 0.5, this.field_6010, this.field_6035 - 0.5, this.field_5987 + 0.5, this.field_6010 + 1.0, this.field_6035 + 0.5)
					.method_1012((double)lv7.method_10148() * d, (double)lv7.method_10164() * d, (double)lv7.method_10165() * d)
			);
			double g = d - e;
			if (g > 0.0) {
				...
				if (!list.isEmpty()) {
					for(class_1297 lv8 : list) {
						if (!(lv8 instanceof class_1606) && !lv8.field_5960) {
							lv8.method_5784(class_1313.field_6309, new class_243(g * (double)lv7.method_10148(), g * (double)lv7.method_10164(), g * (double)lv7.method_10165()));
						}
					}
				}
			}
		...
		if (!this.method_5987() && this.method_5805()) {
			...
			for(int i = 0; i < 5; ++i) {
				...
				if (lv2.method_10264() > 0
					...
					&& this.field_6002.method_8621().method_11952(lv2)
					&& this.field_6002.method_8587(this, new class_238(lv2))) {
					boolean bl = false;

					for(class_2350 lv3 : class_2350.values()) {
						if (this.field_6002.method_8515(lv2.method_10093(lv3), this)) {
	...
	public class_2338 method_7123() {
		return (class_2338)((Optional)this.field_6011.method_12789(field_7338)).orElse(null);
	}
	...
	class class_1607 extends class_1352 {
		...
		public boolean method_6264() {
			...
			if (lv != null && lv.method_5805()) {
				return class_1606.this.field_6002.method_8407() != class_1267.field_5801;
			} else {
				return false;
			}
		}
			...
			if (class_1606.this.field_6002.method_8407() != class_1267.field_5801) {
				...
				if (d < 400.0) {
					if (this.field_7347 <= 0) {
						...
						class_1606.this.field_6002.method_8649(new class_1678(class_1606.this.field_6002, class_1606.this, lv, class_1606.this.method_7119().method_10166()));
						class_1606.this.method_5783(
							class_3417.field_15000, 2.0F, (class_1606.this.field_5974.nextFloat() - class_1606.this.field_5974.nextFloat()) * 0.2F + 1.0F
						);
					}
				} else {
	...
	class class_1608 extends class_1330 {
		public class_1608(class_1308 arg2) {
			super(arg2);
		}
