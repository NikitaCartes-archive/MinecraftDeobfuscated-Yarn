...
public class class_702 implements class_3302 {
	...
	private final Map<class_3999, Queue<class_703>> field_3830 = Maps.newIdentityHashMap();
	...
	private void method_3062() {
		...
		this.method_18834(class_2398.field_11247, class_655.class_656::new);
		this.method_18834(class_2398.field_11238, class_653.class_654::new);
		...
		this.method_18834(class_2398.field_11245, class_711.class_715::new);
		...
		this.method_18834(class_2398.field_11213, class_711.class_713::new);
	...
	public CompletableFuture<Void> method_26769(
		...
		Map<class_2960, List<class_2960>> map = Maps.newConcurrentMap();
		...
		return CompletableFuture.allOf(completableFutures)
			.thenApplyAsync(void_ -> {
				...
				Set<class_2960> set = (Set)map.values().stream().flatMap(Collection::stream).collect(Collectors.toSet());
	...
	private void method_18836(class_3300 arg, class_2960 arg2, Map<class_2960, List<class_2960>> map) {
		...
		try {
			...
			try {
				Reader reader;
				try {
					reader = new InputStreamReader(lv2.method_14482(), Charsets.UTF_8);
					Throwable var8 = null;
	...
	private <T extends class_2394> class_703 method_3055(T arg, double d, double e, double f, double g, double h, double i) {
		class_707<T> lv = (class_707)this.field_3835.get(class_2378.field_11141.method_10249(arg.method_10295()));
	...
	public void method_3049(class_4184 arg, float f) {
		...
		for(class_3999 lv : field_17820) {
			Iterable<class_703> iterable = (Iterable)this.field_3830.get(lv);
			if (iterable != null) {
