...
public class class_6603 {
	...
	public class_6603(WorldChunk worldChunk) {
		...
		for(Entry<BlockPos, BlockEntity> entry : worldChunk.getBlockEntities().entrySet()) {
			this.field_34865.add(class_6603.class_6604.method_38596((BlockEntity)entry.getValue()));
		}
	}
