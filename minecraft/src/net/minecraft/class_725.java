...
public class class_725 extends class_708 {
	private class_725(class_1937 arg, double d, double e, double f, double g, double h, double i, class_4002 arg2) {
		super(arg, d, e, f, arg2, 0.0F);
		this.field_17867 = 0.5F;
		this.method_3083(1.0F);
		this.method_3084(0.0F, 0.0F, 0.0F);
		this.field_3847 = (int)((double)(this.field_17867 * 12.0F) / (Math.random() * 0.8F + 0.2F));
	...
	public static class class_726 implements class_707<class_2400> {
		...
		public class_726(class_4002 arg) {
		...
		public class_703 method_3105(class_2400 arg, class_1937 arg2, double d, double e, double f, double g, double h, double i) {
			return new class_725(arg2, d, e, f, g, h, i, this.field_17878);
		}
	}
}
