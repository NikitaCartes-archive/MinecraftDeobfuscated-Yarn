...
public class class_3232 extends class_2888 {
	...
	private static final class_2975<?> field_19182 = class_1959.method_8699(
		class_3031.field_16655, new class_3772(0.004), class_3284.field_14250, class_2998.field_13436
	);
	public static final Map<class_2975<?>, class_2893.class_2895> field_14069 = class_156.method_654(Maps.newHashMap(), hashMap -> {
		...
		hashMap.put(field_19182, class_2893.class_2895.field_13173);
	});
	public static final Map<String, class_2975<?>[]> field_14073 = class_156.method_654(Maps.newHashMap(), hashMap -> {
		...
		hashMap.put("pillager_outpost", new class_2975[]{field_19182});
	});
	public static final Map<class_2975<?>, class_3037> field_14080 = class_156.method_654(Maps.<class_2975<?>, class_3037>newHashMap(), hashMap -> {
		...
		hashMap.put(field_19182, new class_3772(0.004));
	});
	...
	public static class_2248 method_14334(String string) {
		try {
			...
			return (class_2248)class_2378.field_11146.method_17966(lv).orElse(null);
	...
	public static class_3232 method_14323(Dynamic<?> dynamic) {
		...
		if (list.stream().anyMatch(pair -> pair.getSecond() == null)) {
			...
			List<class_3229> list2 = (List)list.stream().map(pair -> new class_3229(pair.getFirst(), (class_2248)pair.getSecond())).collect(Collectors.toList());
			if (list2.isEmpty()) {
				return method_14309();
			} else {
