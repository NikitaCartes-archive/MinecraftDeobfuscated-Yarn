...
public class class_2459 extends class_2527 {
	...
	private static final Map<class_1922, List<class_2459.class_2460>> field_11445 = new WeakHashMap();
	...
	public void method_9612(class_2680 arg, class_1937 arg2, class_2338 arg3, class_2248 arg4, class_2338 arg5, boolean bl) {
		if (arg.method_11654(field_11446) == this.method_10488(arg2, arg3, arg) && !arg2.method_8397().method_8677(arg3, this)) {
	...
	private static boolean method_10489(class_1937 arg, class_2338 arg2, boolean bl) {
		List<class_2459.class_2460> list = (List)field_11445.computeIfAbsent(arg, argx -> Lists.newArrayList());
		if (bl) {
