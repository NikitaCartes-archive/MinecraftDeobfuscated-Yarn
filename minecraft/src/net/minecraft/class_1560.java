...
public class class_1560 extends class_1588 {
	...
	private static final Predicate<class_1309> field_18126 = arg -> arg instanceof class_1559 && ((class_1559)arg).method_7023();
	private int field_7253;
	private int field_7254;

	public class_1560(class_1299<? extends class_1560> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	protected void method_5959() {
		...
		this.field_6185.method_6277(3, new class_1400(this, class_1559.class, 10, true, false, field_18126));
	}
	...
	public void method_7030() {
		if (this.field_6012 >= this.field_7253 + 400) {
			...
			if (!this.method_5701()) {
				this.field_6002
					.method_8486(
						this.field_5987, this.field_6010 + (double)this.method_5751(), this.field_6035, class_3417.field_14967, this.method_5634(), 2.5F, 1.0F, false
					);
			}
		}
	}
			...
			for(int i = 0; i < 2; ++i) {
				this.field_6002
					.method_8406(
						...
						this.field_6010 + this.field_5974.nextDouble() * (double)this.method_17682() - 0.25,
	...
	private boolean method_7025(class_1297 arg) {
		class_243 lv = new class_243(
			this.field_5987 - arg.field_5987,
			this.method_5829().field_1322 + (double)(this.method_17682() / 2.0F) - arg.field_6010 + (double)arg.method_5751(),
			this.field_6035 - arg.field_6035
		);
		lv = lv.method_1029();
		double d = 16.0;
	...
	private boolean method_7024(double d, double e, double f) {
		class_2338.class_2339 lv = new class_2338.class_2339(d, e, f);

		while(lv.method_10264() > 0 && !this.field_6002.method_8320(lv).method_11620().method_15801()) {
			lv.method_10098(class_2350.field_11033);
		}

		if (!this.field_6002.method_8320(lv).method_11620().method_15801()) {
			return false;
		} else {
	...
	public class_2680 method_7027() {
		return (class_2680)((Optional)this.field_6011.method_12789(field_7257)).orElse(null);
	}
	...
	public boolean method_5643(class_1282 arg, float f) {
		if (this.method_5679(arg)) {
			return false;
		} else if (!(arg instanceof class_1284) && arg != class_1282.field_5860) {
	...
	static class class_1561 extends class_1352 {
		...
		public boolean method_6264() {
			if (this.field_7258.method_7027() == null) {
				return false;
			} else if (!this.field_7258.field_6002.method_8450().method_8355(class_1928.field_19388)) {
				return false;
			} else {
				return this.field_7258.method_6051().nextInt(2000) == 0;
			}
		}
		...
		private boolean method_7033(class_1941 arg, class_2338 arg2, class_2680 arg3, class_2680 arg4, class_2680 arg5, class_2338 arg6) {
			return arg4.method_11588() && !arg5.method_11588() && class_2248.method_9614(arg5.method_11628(arg, arg6)) && arg3.method_11591(arg, arg2);
		}
	}
	...
	static class class_1562 extends class_1400<class_1657> {
		...
		private final class_4051 field_18876 = new class_4051().method_18422();

		public class_1562(class_1560 arg) {
			super(arg, class_1657.class, false);
			this.field_7260 = arg;
			this.field_18127 = new class_4051().method_18418(this.method_6326()).method_18420(arg2 -> arg.method_7026((class_1657)arg2));
		}
		...
		public boolean method_6266() {
			if (this.field_7259 != null) {
				...
				return this.field_6644 != null && this.field_18876.method_18419(this.field_7260, this.field_6644) ? true : super.method_6266();
			}
		}
		...
		public void method_6268() {
			if (this.field_7259 != null) {
				...
				if (this.field_6644 != null && !this.field_7260.method_5765()) {
					if (this.field_7260.method_7026((class_1657)this.field_6644)) {
	...
	static class class_1563 extends class_1352 {
		...
		public boolean method_6264() {
			if (this.field_7263.method_7027() != null) {
				return false;
			} else if (!this.field_7263.field_6002.method_8450().method_8355(class_1928.field_19388)) {
				return false;
			} else {
				return this.field_7263.method_6051().nextInt(20) == 0;
			}
		}
		...
		public void method_6268() {
			...
			class_243 lv5 = new class_243(
				(double)class_3532.method_15357(this.field_7263.field_5987) + 0.5, (double)j + 0.5, (double)class_3532.method_15357(this.field_7263.field_6035) + 0.5
			);
			class_243 lv6 = new class_243((double)i + 0.5, (double)j + 0.5, (double)k + 0.5);
			class_3965 lv7 = lv.method_17742(new class_3959(lv5, lv6, class_3959.class_3960.field_17558, class_3959.class_242.field_1348, this.field_7263));
			boolean bl = lv7.method_17783() != class_239.class_240.field_1333 && lv7.method_17777().equals(lv2);
	...
	static class class_4159 extends class_1352 {
		private final class_1560 field_18524;

		public class_4159(class_1560 arg) {
			this.field_18524 = arg;
			this.method_6265(EnumSet.of(class_1352.class_4134.field_18407, class_1352.class_4134.field_18405));
		}

		@Override
		public boolean method_6264() {
			class_1309 lv = this.field_18524.method_5968();
			if (!(lv instanceof class_1657)) {
				return false;
			} else {
				double d = lv.method_5858(this.field_18524);
				return d > 256.0 ? false : this.field_18524.method_7026((class_1657)lv);
			}
		}

		@Override
		public void method_6269() {
			this.field_18524.method_5942().method_6340();
		}
	}
}
