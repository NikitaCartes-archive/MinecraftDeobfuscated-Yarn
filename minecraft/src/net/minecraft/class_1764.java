...
public class class_1764 extends class_1811 {
	...
	public class_1271<class_1799> method_7836(class_1937 arg, class_1657 arg2, class_1268 arg3) {
		...
		if (method_7781(lv)) {
			method_7777(arg, arg2, lv, 3.15F, 1.0F);
	...
	private static void method_7767(class_1309 arg, class_1799 arg2) {
		...
		for (int k = 0; k < j; k++) {
			...
			method_7765(arg, arg2, lv, k > 0, bl);
		}
	}

	private static void method_7765(class_1309 arg, class_1799 arg2, class_1799 arg3, boolean bl, boolean bl2) {
	...
	private static void method_7763(class_1937 arg, class_1309 arg2, class_1799 arg3, class_1799 arg4, float f, boolean bl, float g, float h, float i) {
		if (!arg.field_9236) {
			boolean bl2 = arg4.method_7909() == class_1802.field_8639;
			class_1676 lv;
			if (bl2) {
				lv = new class_1671(arg, arg4, arg2.field_5987, arg2.field_6010 + (double)arg2.method_5751() - 0.15F, arg2.field_6035, true);
			} else {
				lv = method_18814(arg, arg2, arg3, arg4);
				if (bl || i != 0.0F) {
			...
			if (arg2 instanceof class_3745) {
				...
				lv2.method_18811(lv2.method_5968(), arg3, lv, i);
			} else {
	...
	public static void method_7777(class_1937 arg, class_1309 arg2, class_1799 arg3, float f, float g) {
		List<class_1799> list = method_7785(arg3);
		boolean bl = arg2 instanceof class_1657 && ((class_1657)arg2).field_7503.field_7477;
		int i = list.size();
		if (i == 1) {
			class_1799 lv = (class_1799)list.get(0);
			if (!lv.method_7960()) {
				method_7763(arg, arg2, arg3, lv, method_7780(arg2.method_6051()), bl, f, g, 0.0F);
			}
		} else {
			for (int j = 0; j < i; j++) {
				class_1799 lv2 = (class_1799)list.get(j);
				if (!lv2.method_7960()) {
					float h = -10.0F + (float)j * 20.0F / (float)i;
					method_7763(arg, arg2, arg3, lv2, method_7780(arg2.method_6051()), bl, f, g, h);
				}
			}
		}

		method_7769(arg, arg2, arg3);
	}

	private static float method_7780(Random random) {
		boolean bl = random.nextBoolean();
		return method_7784(bl);
	}
	...
	public void method_7851(class_1799 arg, @Nullable class_1937 arg2, List<class_2561> list, class_1836 arg3) {
		if (method_7781(arg)) {
			class_1799 lv = (class_1799)method_7785(arg).get(0);
			...
			if (arg3.method_8035() && lv.method_7909() == class_1802.field_8639) {
				...
				class_1802.field_8639.method_7851(lv, arg2, list2, arg3);
				if (!list2.isEmpty()) {
					for (int i = 0; i < list2.size(); i++) {
						list2.set(i, new class_2585("  ").method_10852((class_2561)list2.get(i)).method_10854(class_124.field_1080));
					}
