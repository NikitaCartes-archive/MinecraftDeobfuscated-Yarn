...
public class class_653 extends class_703 {
	protected class_653(class_1937 arg, double d, double e, double f, double g, double h, double i) {
		...
		this.field_3863 *= this.field_3840.nextFloat() * 0.6F + 0.2F;
	...
	public static class class_654 implements class_707<class_2400> {
		public class_703 method_3011(class_2400 arg, class_1937 arg2, double d, double e, double f, double g, double h, double i) {
			return new class_653(arg2, d, e, f, g, h, i);
		}
	}
}
