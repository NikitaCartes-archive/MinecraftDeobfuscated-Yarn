...
public class class_4251 extends class_4097<class_1309> {
	...
	protected Set<Pair<class_4140<?>, class_4141>> method_18914() {
		return ImmutableSet.of(Pair.of(class_4140.field_18440, class_4141.field_18456));
	}
	...
	protected void method_18920(class_3218 arg, class_1309 arg2, long l) {
		...
		class_2338 lv2 = ((class_4208)lv.method_19543(class_4140.field_18440).get()).method_19446();
		if (lv2.method_19771(new class_2338(arg2), 2.0)) {
			...
			if (lv3.method_11614() == class_2246.field_16332) {
				...
				for (class_2350 lv5 : class_2350.class_2353.field_11062) {
					if (lv4.method_19285(arg, lv3, arg.method_8321(lv2), new class_3965(new class_243(0.5, 0.5, 0.5), lv5, lv2, false))) {
						break;
					}
				}
			}
