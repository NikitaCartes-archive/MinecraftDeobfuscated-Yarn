...
public class class_1050 {
	...
	public class_1050(String string, InputStream inputStream) throws IOException {
		try (
			...
			class_1050.class_1051 lv = method_4542(inputStream);
	...
	private static class_1050.class_1051 method_4542(InputStream inputStream) {
		return (class_1050.class_1051)(inputStream instanceof FileInputStream
			? new class_1050.class_1053(((FileInputStream)inputStream).getChannel())
			: new class_1050.class_1052(Channels.newChannel(inputStream)));
	}
	...
	@Environment(EnvType.CLIENT)
	static class class_1052 extends class_1050.class_1051 {
	...
	@Environment(EnvType.CLIENT)
	static class class_1053 extends class_1050.class_1051 {
