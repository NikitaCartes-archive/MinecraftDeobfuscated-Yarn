	...
	public static void method_13813(CommandDispatcher<class_2168> commandDispatcher) {
		commandDispatcher.register(
			class_2170.method_9247("trigger")
				.then(
					((RequiredArgumentBuilder)((RequiredArgumentBuilder)class_2170.method_9244("objective", class_2214.method_9391())
								.suggests((commandContext, suggestionsBuilder) -> method_13819((class_2168)commandContext.getSource(), suggestionsBuilder))
								.executes(
									commandContext -> method_13818(
											(class_2168)commandContext.getSource(),
											method_13821(((class_2168)commandContext.getSource()).method_9207(), class_2214.method_9395(commandContext, "objective"))
										)
								))
							.then(
