...
public class class_677 {
	@Environment(EnvType.CLIENT)
	public static class class_678 extends class_703 {
		protected class_678(class_1937 arg, double d, double e, double f) {
			super(arg, d, e, f);
			this.field_3847 = 4;
		}
		...
		public void method_3074(class_287 arg, class_1297 arg2, float f, float g, float h, float i, float j, float k) {
			...
			float n = 0.125F;
			float o = 0.375F;
			float p = 7.1F * class_3532.method_15374(((float)this.field_3866 + f - 1.0F) * 0.25F * (float) Math.PI);
			...
			int u = t >> 16 & 65535;
			int v = t & 65535;
			arg.method_1315((double)(q - g * p - j * p), (double)(r - h * p), (double)(s - i * p - k * p))
				.method_1312(0.5, 0.375)
				.method_1336(this.field_3861, this.field_3842, this.field_3859, this.field_3841)
				.method_1313(u, v)
				.method_1344();
			arg.method_1315((double)(q - g * p + j * p), (double)(r + h * p), (double)(s - i * p + k * p))
				.method_1312(0.5, 0.125)
				.method_1336(this.field_3861, this.field_3842, this.field_3859, this.field_3841)
				.method_1313(u, v)
				.method_1344();
			arg.method_1315((double)(q + g * p + j * p), (double)(r + h * p), (double)(s + i * p + k * p))
				.method_1312(0.25, 0.125)
				.method_1336(this.field_3861, this.field_3842, this.field_3859, this.field_3841)
				.method_1313(u, v)
				.method_1344();
			arg.method_1315((double)(q + g * p - j * p), (double)(r - h * p), (double)(s + i * p - k * p))
				.method_1312(0.25, 0.375)
				.method_1336(this.field_3861, this.field_3842, this.field_3859, this.field_3841)
				.method_1313(u, v)
				.method_1344();
		}
	...
	public static class class_679 implements class_707<class_2400> {
		public class_703 method_3025(class_2400 arg, class_1937 arg2, double d, double e, double f, double g, double h, double i) {
			class_677.class_680 lv = new class_677.class_680(arg2, d, e, f, g, h, i, class_310.method_1551().field_1713);
	...
	@Environment(EnvType.CLIENT)
	public static class class_680 extends class_708 {
		...
		public class_680(class_1937 arg, double d, double e, double f, double g, double h, double i, class_702 arg2) {
			super(arg, d, e, f, 160, 8, -0.004F);
			this.field_3852 = g;
			this.field_3869 = h;
			this.field_3850 = i;
		...
		public void method_3070() {
			...
			if (this.field_3804 && this.field_3866 < this.field_3847 / 2 && (this.field_3866 + this.field_3847) % 2 == 0) {
				class_677.class_680 lv = new class_677.class_680(this.field_3851, this.field_3874, this.field_3854, this.field_3871, 0.0, 0.0, 0.0, this.field_3798);
				lv.method_3083(0.99F);
	...
	@Environment(EnvType.CLIENT)
	public static class class_681 extends class_703 {
		...
		public void method_3070() {
			...
			if (this.field_3808 % 2 == 0 && this.field_3806 != null && this.field_3808 / 2 < this.field_3806.size()) {
				...
				class_677.class_678 lv5 = new class_677.class_678(this.field_3851, this.field_3874, this.field_3854, this.field_3871);
				lv5.method_3084(f, g, h);
				this.field_3805.method_3058(lv5);
			}
			...
			if (this.field_3808 > this.field_3847) {
				if (this.field_3807) {
					boolean bl = this.method_3029();
					class_3414 lv6 = bl ? class_3417.field_14882 : class_3417.field_14800;
					this.field_3851
		...
		private boolean method_3029() {
			...
			return lv.method_1560() == null || !(lv.method_1560().method_5649(this.field_3874, this.field_3854, this.field_3871) < 256.0);
		}

		private void method_3030(double d, double e, double f, double g, double h, double i, int[] is, int[] js, boolean bl, boolean bl2) {
			class_677.class_680 lv = new class_677.class_680(this.field_3851, d, e, f, g, h, i, this.field_3805);
			lv.method_3083(0.99F);
			lv.method_3027(bl);
			lv.method_3026(bl2);
			...
			this.field_3805.method_3058(lv);
		}
