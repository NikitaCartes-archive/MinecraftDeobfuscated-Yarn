...
public class class_3569 extends class_3560<class_3569.class_3570> {
	...
	protected class_3569(ChunkView chunkView) {
		super(LightType.field_9284, chunkView, new class_3569.class_3570(new Long2ObjectOpenHashMap<>(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
	}
	...
	protected int method_15538(long l) {
		...
		int j = lv.field_15821.get(BlockPos.method_10065(m));
		if (j != lv.field_15822 && i < j) {
			class_2804 lv2 = this.method_15533(lv, m);
			if (lv2 == null) {
				for (l = BlockPos.method_10091(l); lv2 == null; lv2 = this.method_15533(lv, m)) {
			...
			return lv2.method_12139(BlockPos.unpackLongX(l) & 15, BlockPos.unpackLongY(l) & 15, BlockPos.unpackLongZ(l) & 15);
		} else {
			return 15;
		}
	}
	...
	protected void method_15523(long l) {
		...
		long m = BlockPos.method_10065(l);
	...
	protected void method_15534(long l) {
		...
		if (this.field_15796.field_15821.get(m) == i + 16) {
			long n;
			for (n = l; !this.method_15524(n) && this.method_15567(i); n = BlockPos.add(n, 0, -16, 0)) {
				i -= 16;
			}
	...
	@Override
	protected void method_15527(LightStorage<class_3569.class_3570, ?> lightStorage, boolean bl, boolean bl2) {
		super.method_15527(lightStorage, bl, bl2);
		if (bl) {
						...
						if (i == 1) {
								...
								if ((this.field_15816.contains(n) || !this.field_15820.contains(n) && !this.field_15815.contains(n)) && this.method_15524(n)) {
									for (int o = 0; o < 16; o++) {
										for (int p = 0; p < 16; p++) {
											...
											lightStorage.method_15478(q, r, lightStorage.method_15488(q, r, 0), true);
										}
									}
								}
							}
							...
							for (int s = 0; s < 16; s++) {
								for (int t = 0; t < 16; t++) {
									...
									lightStorage.method_15478(u, n, lightStorage.method_15488(u, n, 0), true);
								}
							}
						} else {
							for (int j = 0; j < 16; j++) {
								for (int k = 0; k < 16; k++) {
									...
									lightStorage.method_15478(-1L, v, 0, true);
								}
							}
						}
					}
					...
					if (this.field_15820.remove(l) && this.method_15524(l)) {
						for (int i = 0; i < 16; i++) {
							for (int j = 0; j < 16; j++) {
								...
								lightStorage.method_15478(-1L, w, 15, false);
							}
						}
					}
				}
	...
	protected boolean method_15565(long l) {
		...
		if ((i & 15) != 15) {
			...
			long m = BlockPos.method_10090(l);
			long n = BlockPos.method_10065(m);
	...
	protected boolean method_15568(long l) {
		...
		return i == this.field_15796.field_15822 || BlockPos.unpackLongY(l) >= i;
	}
