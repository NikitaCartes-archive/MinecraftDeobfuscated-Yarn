...
public class class_641 {
	...
	public void method_2981() {
		try {
			...
			field_3751.error("Couldn't load server list", var4);
		}
	}
	...
	public void method_2987() {
		try {
			...
			field_3751.error("Couldn't save server list", var4);
		}
	}
	...
	public void method_2983(class_642 arg) {
		this.field_3749.remove(arg);
	}
