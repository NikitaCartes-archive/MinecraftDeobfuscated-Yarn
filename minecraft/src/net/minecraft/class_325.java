	...
	public static class_325 method_1706(class_324 arg) {
		...
		lv.method_1708((argx, i) -> {
			if (i != 1) {
				...
				class_2487 lvxx = argx.method_7941("Explosion");
				int[] is = lvxx != null && lvxx.method_10573("Colors", 11) ? lvxx.method_10561("Colors") : null;
				if (is == null) {
					return 9079434;
				} else if (is.length == 1) {
					return is[0];
		...
		lv.method_1708(
			(arg2, i) -> {
				class_2680 lvxx = ((class_1747)arg2.method_7909()).method_7711().method_9564();
				return arg.method_1697(lvxx, null, null, i);
			},
