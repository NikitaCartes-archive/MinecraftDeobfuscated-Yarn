...
public class class_4174 {
	...
	private class_4174(int i, float f, boolean bl, boolean bl2, boolean bl3, List<Pair<class_1293, Float>> list) {
		this.field_18614 = i;
		this.field_18615 = f;
		this.field_18616 = bl;
	...
	public static class class_4175 {
		...
		private final List<Pair<class_1293, Float>> field_18625 = Lists.<Pair<class_1293, Float>>newArrayList();
		...
		public class_4174.class_4175 method_19239(class_1293 arg, float f) {
			this.field_18625.add(Pair.of(arg, f));
			return this;
		}
