...
public class class_408 extends class_437 {
	...
	protected void method_2224() {
		...
		this.field_2387 = this.field_2563.field_1705.method_1743().method_1809().size();
		this.field_2382 = new class_342(0, this.field_2554, 4, this.field_2559 - 12, this.field_2561 - 4, 12);
		this.field_2382.method_1880(256);
		this.field_2382.method_1858(false);
		this.field_2382.method_1876(true);
		this.field_2382.method_1852(this.field_2384);
		this.field_2382.method_1856(false);
		this.field_2382.method_1854(this::method_2102);
		this.field_2382.method_1863(this::method_2111);
		this.field_2557.add(this.field_2382);
		this.method_2110();
	}
	...
	public boolean method_16805(int i, int j, int k) {
		if (this.field_2385 != null && this.field_2385.method_2124(i, j, k)) {
			...
			this.field_2563.field_1705.method_1743().method_1802((double)(this.field_2563.field_1705.method_1743().method_1813() - 1));
			return true;
		} else if (i == 267) {
			this.field_2563.field_1705.method_1743().method_1802((double)(-this.field_2563.field_1705.method_1743().method_1813() + 1));
			return true;
			...
			return this.field_2382.method_16805(i, j, k);
		}
	}
	...
	public void method_2112() {
		if (this.field_2386 != null && this.field_2386.isDone()) {
			...
			if (!suggestions.getList().isEmpty()) {
				...
				int j = class_3532.method_15340(this.field_2382.method_1889(suggestions.getRange().getStart()), 0, this.field_2561 - i);
				this.field_2385 = new class_408.class_409(j, this.field_2559 - 12, i, suggestions);
			}
		}
	}
	...
	private void method_2110() {
		...
		if (stringReader.canRead() && stringReader.peek() == '/') {
			...
			this.field_2388 = commandDispatcher.parse(stringReader, this.field_2563.field_1724.field_3944.method_2875());
			if (this.field_2385 == null || !this.field_2378) {
				StringReader stringReader2 = new StringReader(string.substring(0, Math.min(string.length(), this.field_2382.method_1881())));
			...
			Collection<String> collection = this.field_2563.field_1724.field_3944.method_2875().method_9262();
	...
	private void method_2116() {
		...
		this.field_2381 = 0;
		this.field_2379 = this.field_2561;
		if (this.field_2383.isEmpty()) {
			this.method_2107(class_124.field_1080);
		}

		this.field_2385 = null;
		if (this.field_2380 && this.field_2563.field_1690.field_1873) {
			this.method_2112();
		}
	}
	...
	public boolean method_16802(double d) {
		...
		if (this.field_2385 != null && this.field_2385.method_2117(d)) {
			...
			this.field_2563.field_1705.method_1743().method_1802(d);
			return true;
		}
	}
	...
	public boolean method_16807(double d, double e, int i) {
		if (this.field_2385 != null && this.field_2385.method_2119((int)d, (int)e, i)) {
			...
			if (i == 0) {
				class_2561 lv = this.field_2563.field_1705.method_1743().method_1816(d, e);
				if (lv != null && this.method_2216(lv)) {
					return true;
				}
			}

			return this.field_2382.method_16807(d, e, i) ? true : super.method_16807(d, e, i);
		}
	}
	...
	public void method_2114(int i) {
		...
		int k = this.field_2563.field_1705.method_1743().method_1809().size();
		...
		if (j != this.field_2387) {
			if (j == k) {
				...
				this.field_2382.method_1852((String)this.field_2563.field_1705.method_1743().method_1809().get(j));
				this.field_2385 = null;
				this.field_2387 = j;
	...
	public void method_2214(int i, int j, float f) {
		method_1785(2, this.field_2559 - 14, this.field_2561 - 2, this.field_2559 - 2, Integer.MIN_VALUE);
		this.field_2382.method_1857(i, j, f);
		if (this.field_2385 != null) {
			...
			for (String string : this.field_2383) {
				method_1785(this.field_2381 - 1, this.field_2559 - 14 - 13 - 12 * k, this.field_2381 + this.field_2379 + 1, this.field_2559 - 2 - 13 - 12 * k, -16777216);
				this.field_2554.method_1720(string, (float)this.field_2381, (float)(this.field_2559 - 14 - 13 + 2 - 12 * k), -1);
				k++;
			}
		}

		class_2561 lv = this.field_2563.field_1705.method_1743().method_1816((double)i, (double)j);
	...
	private void method_2107(class_124 arg) {
		...
		if (!commandContextBuilder2.getNodes().isEmpty()) {
			...
			if (!list.isEmpty()) {
				...
				this.field_2381 = class_3532.method_15340(this.field_2382.method_1889(i) + this.field_2554.method_1727(" "), 0, this.field_2561 - j);
				this.field_2379 = j;
			}
		}
	}
	...
	class class_409 {
		...
		public void method_2120(int i, int j) {
			...
			if (bl5) {
				...
				if (message != null) {
					class_408.this.method_2215(class_2564.method_10883(message).method_10863(), i, j);
				}
			}
		}
		...
		public boolean method_2117(double d) {
			int i = (int)(
				class_408.this.field_2563.field_1729.method_1603()
					* (double)class_408.this.field_2563.field_1704.method_4486()
					/ (double)class_408.this.field_2563.field_1704.method_4480()
			);
			int j = (int)(
				class_408.this.field_2563.field_1729.method_1604()
					* (double)class_408.this.field_2563.field_1704.method_4502()
					/ (double)class_408.this.field_2563.field_1704.method_4507()
			);
			if (this.field_2396.method_3318(i, j)) {
		...
		public boolean method_2124(int i, int j, int k) {
			if (i == 265) {
				...
				if (this.field_2391) {
					this.method_2118(class_437.method_2223() ? -1 : 1);
				}
