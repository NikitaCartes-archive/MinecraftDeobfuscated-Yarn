...
public abstract class class_1314 extends class_1308 {
	...
	public boolean method_6146(class_2338 arg) {
		if (this.field_6311 == -1.0F) {
			return true;
		} else {
			return this.field_6312.method_10262(arg) < (double)(this.field_6311 * this.field_6311);
		}
	}
	...
	protected void method_5995() {
		...
		if (this.method_5934() && this.method_5933() != null && this.method_5933().field_6002 == this.field_6002) {
			...
			if (f > 10.0F) {
				...
				this.field_5967 += d * Math.abs(d) * 0.4;
				this.field_5984 += e * Math.abs(e) * 0.4;
				this.field_6006 += g * Math.abs(g) * 0.4;
			} else {
