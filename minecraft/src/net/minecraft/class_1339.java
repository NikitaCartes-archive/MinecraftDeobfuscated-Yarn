...
public class class_1339 extends class_1343 {
	...
	public boolean method_6264() {
		if (!super.method_6264()) {
			return false;
		} else if (!this.field_6413.field_6002.method_8450().method_8355(class_1928.field_19388)) {
			return false;
		} else {
			return this.method_19994(this.field_6413.field_6002.method_8407()) && !this.method_6256();
		}
	}
	...
	public void method_6268() {
		...
		if (this.field_6413.method_6051().nextInt(20) == 0) {
			this.field_6413.field_6002.method_20290(1019, this.field_6414, 0);
		...
		if (this.field_6398 == this.method_16462() && this.method_19994(this.field_6413.field_6002.method_8407())) {
			...
			this.field_6413.field_6002.method_20290(1021, this.field_6414, 0);
			this.field_6413.field_6002.method_20290(2001, this.field_6414, class_2248.method_9507(this.field_6413.field_6002.method_8320(this.field_6414)));
		}
	}
