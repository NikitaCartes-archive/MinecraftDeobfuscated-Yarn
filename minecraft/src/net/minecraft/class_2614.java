...
public class class_2614 extends class_2621 implements class_2615, class_3000 {
	...
	private boolean method_11243(Supplier<Boolean> supplier) {
		if (this.field_11863 != null && !this.field_11863.field_9236) {
			if (!this.method_11239() && this.method_11010().method_11654(class_2377.field_11126)) {
				boolean bl = false;
	...
	private static IntStream method_17767(class_1263 arg, class_2350 arg2) {
		return arg instanceof class_1278 ? IntStream.of(((class_1278)arg).method_5494(arg2)) : IntStream.range(0, arg.method_5439());
	}

	private boolean method_11258(class_1263 arg, class_2350 arg2) {
		return method_17767(arg, arg2).allMatch(i -> {
			class_1799 lv = arg.method_5438(i);
			return lv.method_7947() >= lv.method_7914();
		});
	}

	private static boolean method_11257(class_1263 arg, class_2350 arg2) {
		return method_17767(arg, arg2).allMatch(i -> arg.method_5438(i).method_7960());
	}
	...
	public static boolean method_11241(class_2615 arg) {
		...
		if (lv != null) {
			...
			return method_11257(lv, lv2) ? false : method_17767(lv, lv2).anyMatch(i -> method_11261(arg, lv, i, lv2));
		} else {
			for(class_1542 lv3 : method_11237(arg)) {
				if (method_11247(arg, lv3)) {
					return true;
				}
			}
	...
	private static boolean method_11244(class_1263 arg, class_1799 arg2, int i, @Nullable class_2350 arg3) {
		if (!arg.method_5437(i, arg2)) {
			...
			return !(arg instanceof class_1278) || ((class_1278)arg).method_5492(i, arg2, arg3);
		}
	}
	...
	public static class_1263 method_11251(class_1937 arg, double d, double e, double f) {
		...
		if (lv4 instanceof class_3954) {
			lv = ((class_3954)lv4).method_17680(lv3, arg, lv2);
		...
		if (lv == null) {
			List<class_1297> list = arg.method_8333((class_1297)null, new class_238(d - 0.5, e - 0.5, f - 0.5, d + 0.5, e + 0.5, f + 0.5), class_1301.field_6152);
			if (!list.isEmpty()) {
	...
	private static boolean method_11254(class_1799 arg, class_1799 arg2) {
		if (arg.method_7909() != arg2.method_7909()) {
			...
			return false;
		} else if (arg.method_7947() > arg.method_7914()) {
			return false;
		} else {
			return class_1799.method_7975(arg, arg2);
		}
	}
