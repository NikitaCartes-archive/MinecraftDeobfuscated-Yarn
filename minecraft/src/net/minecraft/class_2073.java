...
public class class_2073 {
		...
		if (jsonElement != null && !jsonElement.isJsonNull()) {
			...
			if (jsonObject.has("data")) {
				...
				if (jsonObject.has("item")) {
					...
					lv4 = (class_1792)class_2378.field_11142.method_17966(lv5).orElseThrow(() -> new JsonSyntaxException("Unknown item id '" + lv5 + "'"));
				}
				...
				if (jsonObject.has("potion")) {
					...
					lv8 = (class_1842)class_2378.field_11143.method_17966(lv9).orElseThrow(() -> new JsonSyntaxException("Unknown potion '" + lv9 + "'"));
				}
	...
	public static class class_2074 {
		...
		public class_2073.class_2074 method_20399(class_2487 arg) {
			this.field_9654 = new class_2105(arg);
			return this;
		}
