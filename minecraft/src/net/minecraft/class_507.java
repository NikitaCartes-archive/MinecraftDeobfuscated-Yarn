...
public class class_507 extends class_332 implements class_4068, class_364, class_515, class_2952<class_1856> {
	...
	public void method_2579(boolean bl) {
		...
		this.field_3089 = new class_342(this.field_3091.field_1772, i + 25, j + 14, 80, 9 + 5, class_1074.method_4662("itemGroup.search"));
		...
		this.field_3088 = new class_361(i + 110, j + 12, 26, 16, this.field_3096.method_14880(this.field_3095));
		this.method_2585();
		this.field_3094.clear();

		for (class_314 lv : class_299.method_1395(this.field_3095)) {
			this.field_3094.add(new class_512(lv));
		}
		...
		if (this.method_2605()) {
			...
			if (this.field_3088.isHovered()) {
				...
				if (this.field_3091.field_1755 != null) {
					this.field_3091.field_1755.renderTooltip(string, k, l);
				}
			}
	...
	private void method_2602(int i, int j, int k, int l) {
		...
		if (lv != null && this.field_3091.field_1755 != null) {
			this.field_3091.field_1755.renderTooltip(this.field_3091.field_1755.getTooltipFromItem(lv), k, l);
		}
	}
		...
		if (this.method_2605() && !this.field_3091.field_1724.method_7325()) {
			if (this.field_3086.method_2632(d, e, i, (this.field_3101 - 147) / 2 - this.field_3102, (this.field_3100 - 166) / 2, 147, 166)) {
				...
				if (lv != null && lv2 != null) {
					...
					this.field_3092.method_2571();
					this.field_3091.field_1761.method_2912(this.field_3091.field_1724.field_7512.field_7763, lv, class_437.hasShiftDown());
					if (!this.method_2604()) {
				...
				return true;
			} else if (this.field_3089.mouseClicked(d, e, i)) {
				return true;
	...
	public boolean keyPressed(int i, int j, int k) {
		...
		if (!this.method_2605() || this.field_3091.field_1724.method_7325()) {
			...
			this.method_2593(false);
			return true;
		} else if (this.field_3089.keyPressed(i, j, k)) {
			this.method_2586();
			return true;
		} else if (this.field_3089.isFocused() && this.field_3089.method_1885() && i != 256) {
			return true;
		} else if (this.field_3091.field_1690.field_1890.method_1417(i, j) && !this.field_3089.isFocused()) {
	...
	public boolean charTyped(char c, int i) {
		if (this.field_3087) {
			...
			return false;
		} else if (this.field_3089.charTyped(c, i)) {
			this.method_2586();
			return true;
		} else {
			return class_364.super.charTyped(c, i);
		}
	}
