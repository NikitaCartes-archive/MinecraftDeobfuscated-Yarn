...
public abstract class PlayerEntity extends LivingEntity {
	...
	public boolean isInvulnerableTo(DamageSource damageSource) {
		if (super.isInvulnerableTo(damageSource)) {
			...
			return !this.world.getGameRules().getBoolean(GameRules.field_20636);
		} else {
			return false;
		}
	}
	...
	public ItemStack eatFood(World world, ItemStack stack) {
		...
		world.playSound(
			null, this.getX(), this.getY(), this.getZ(), SoundEvents.field_19149, SoundCategory.field_15248, 0.5F, world.random.nextFloat() * 0.1F + 0.9F
		);
