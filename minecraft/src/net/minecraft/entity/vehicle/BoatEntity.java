...
public class BoatEntity extends Entity implements VariantHolder<BoatEntity.Type> {
	...
	@Override
	public void tick() {
		LivingEntity bl = this.getControllingPassenger();
		double d;
		if (bl instanceof ServerPlayerEntity serverPlayerEntity) {
	...
	public LivingEntity getControllingPassenger() {
		...
		return var2 instanceof LivingEntity livingEntity ? livingEntity : null;
	}
