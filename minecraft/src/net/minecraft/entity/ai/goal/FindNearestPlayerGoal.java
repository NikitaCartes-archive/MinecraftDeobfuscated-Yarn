	...
	public boolean shouldContinue() {
		...
		if (livingEntity == null) {
			...
			if (abstractScoreboardTeam != null && abstractScoreboardTeam2 == abstractScoreboardTeam) {
				...
				double d = this.method_6324();
				if (this.owner.squaredDistanceTo(livingEntity) > d * d) {
					return false;
				} else {
					return !(livingEntity instanceof ServerPlayerEntity) || !((ServerPlayerEntity)livingEntity).interactionManager.isCreative();
				}
			}
		}
	}
