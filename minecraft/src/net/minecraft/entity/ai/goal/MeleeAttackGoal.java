...
public class MeleeAttackGoal extends Goal {
	protected MobEntityWithAi entity;
	...
	public boolean canStart() {
		...
		if (livingEntity == null) {
			...
			if (this.field_6509 != null) {
				...
				return this.method_6289(livingEntity) >= this.entity.squaredDistanceTo(livingEntity.x, livingEntity.getBoundingBox().minY, livingEntity.z);
			}
		}
	}
	...
	protected double method_6289(LivingEntity livingEntity) {
		return (double)(this.entity.width * 2.0F * this.entity.width * 2.0F + livingEntity.width);
	}
}
