...
public class CatSitOnBlockGoal extends MoveToTargetPosGoal {
	...
	protected boolean method_6296(ViewableWorld viewableWorld, BlockPos blockPos) {
		if (!viewableWorld.method_8623(blockPos.up())) {
			...
			} else if (block == Blocks.field_10181 && blockState.method_11654(FurnaceBlock.field_11105)) {
				return true;
			} else {
				return block.method_9525(BlockTags.field_16443) && blockState.method_11654(BedBlock.field_9967) != BedPart.field_12560;
			}
		}
	}
}
