	...
	private Vec3d getTreeTarget() {
		...
		for (BlockPos blockPos2 : BlockPos.iterate(
			...
			if (!blockPos.equals(blockPos2)) {
				Block block = this.mob.world.getBlockState(mutable2.set(blockPos2, Direction.field_11033)).getBlock();
				boolean bl = block instanceof LeavesBlock || block.isIn(BlockTags.field_15475);
				if (bl && this.mob.world.isAir(blockPos2) && this.mob.world.isAir(mutable.set(blockPos2, Direction.field_11036))) {
