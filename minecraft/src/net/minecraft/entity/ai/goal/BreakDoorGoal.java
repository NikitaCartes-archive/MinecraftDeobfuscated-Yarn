...
public class BreakDoorGoal extends DoorInteractGoal {
	...
	public boolean canStart() {
		if (!super.canStart()) {
			return false;
		} else if (!this.mob.field_6002.getGameRules().getBoolean(GameRules.field_19388)) {
			return false;
		} else {
			return this.isDifficultySufficient(this.mob.field_6002.getDifficulty()) && !this.method_6256();
		}
	}
