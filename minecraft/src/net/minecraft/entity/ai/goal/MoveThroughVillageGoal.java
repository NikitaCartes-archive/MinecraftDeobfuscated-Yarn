			...
			Vec3d vec3d = class_1414.method_19108(
				...
				blockPos2x -> {
					if (!serverWorld.method_19500(blockPos2x)) {
						...
						Optional<BlockPos> optionalxx = serverWorld.method_19494()
							.method_19127(class_4158.field_18501, this::method_19052, blockPos2x, 10, class_4153.class_4155.field_18488);
						return !optionalxx.isPresent() ? Double.NEGATIVE_INFINITY : -((BlockPos)optionalxx.get()).squaredDistanceTo(blockPos);
					}
				}
			);
			if (vec3d == null) {
