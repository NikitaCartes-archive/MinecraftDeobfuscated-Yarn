...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<class_4844> ANGRY_AT = register("angry_at", Optional.of(class_4844::method_24815));
	public static final MemoryModuleType<Boolean> ADMIRING_ITEM = register("admiring_item");
	public static final MemoryModuleType<PlayerEntity> WAS_HIT_BY_PLAYER = register("was_hit_by_player");
	...
	public static final MemoryModuleType<class_4836> NEAREST_VISIBLE_BABY_PIGLIN = register("nearest_visible_baby_piglin");
	...
	public static final MemoryModuleType<List<class_4836>> NEAREST_VISIBLE_ADULT_PIGLINS = register("nearest_visible_adult_piglins");
	...
	public static final MemoryModuleType<class_4836> NEAREST_VISIBLE_ADULT_PIGLIN = register("nearest_visible_adult_piglin");
	public static final MemoryModuleType<ZombiePigmanEntity> NEAREST_VISIBLE_ZOMBIFIED_PIGLIN = register("nearest_visible_zombified_piglin");
