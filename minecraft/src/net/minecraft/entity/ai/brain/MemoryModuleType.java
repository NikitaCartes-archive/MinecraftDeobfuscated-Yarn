...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<Timestamp> LAST_SLEPT = register("last_slept", Timestamp.field_25121);
	public static final MemoryModuleType<Timestamp> LAST_WOKEN = register("last_woken", Timestamp.field_25121);
	public static final MemoryModuleType<Timestamp> LAST_WORKED_AT_POI = register("last_worked_at_poi", Timestamp.field_25121);
	public static final MemoryModuleType<ItemEntity> NEAREST_VISIBLE_WANTED_ITEM = register("nearest_visible_wanted_item");
	public static final MemoryModuleType<DynamicSerializableUuid> ANGRY_AT = register("angry_at", DynamicSerializableUuid.field_25122);
