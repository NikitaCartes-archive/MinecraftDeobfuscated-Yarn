...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<Unit> IS_IN_WATER = register("is_in_water", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> IS_PREGNANT = register("is_pregnant", Codec.unit((U)Unit.INSTANCE));
	...
	public static final MemoryModuleType<Unit> RECENT_PROJECTILE = register("recent_projectile", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> IS_SNIFFING = register("is_sniffing", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> IS_EMERGING = register("is_emerging", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> ROAR_SOUND_DELAY = register("roar_sound_delay", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> DIG_COOLDOWN = register("dig_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> ROAR_SOUND_COOLDOWN = register("roar_sound_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> SNIFF_COOLDOWN = register("sniff_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> TOUCH_COOLDOWN = register("touch_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> VIBRATION_COOLDOWN = register("vibration_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> SONIC_BOOM_COOLDOWN = register("sonic_boom_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> SONIC_BOOM_SOUND_COOLDOWN = register("sonic_boom_sound_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> SONIC_BOOM_SOUND_DELAY = register("sonic_boom_sound_delay", Codec.unit((U)Unit.INSTANCE));
	...
	public static final MemoryModuleType<Unit> BREEZE_JUMP_COOLDOWN = register("breeze_jump_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> BREEZE_SHOOT = register("breeze_shoot", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> BREEZE_SHOOT_CHARGING = register("breeze_shoot_charging", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> BREEZE_SHOOT_RECOVER = register("breeze_shoot_recover", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> BREEZE_SHOOT_COOLDOWN = register("breeze_shoot_cooldown", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<Unit> BREEZE_JUMP_INHALING = register("breeze_jump_inhaling", Codec.unit((U)Unit.INSTANCE));
	public static final MemoryModuleType<BlockPos> BREEZE_JUMP_TARGET = register("breeze_jump_target", BlockPos.CODEC);
	public static final MemoryModuleType<Unit> BREEZE_LEAVING_WATER = register("breeze_leaving_water", Codec.unit((U)Unit.INSTANCE));
