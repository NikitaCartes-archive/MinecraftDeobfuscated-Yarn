...
public class VillagerTaskListProvider {
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getCoreTasks(VillagerProfession villagerProfession, float f) {
		...
		return ImmutableList.of(
			...
			Pair.of(0, new WanderAroundTask()),
			...
			Pair.of(10, new FindPointOfInterestTask(villagerProfession.getWorkStation(), MemoryModuleType.field_18439)),
			Pair.of(10, new FindPointOfInterestTask(PointOfInterestType.field_18517, MemoryModuleType.field_18438)),
			Pair.of(10, new FindPointOfInterestTask(PointOfInterestType.field_18518, MemoryModuleType.field_18440)),
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getWorkTasks(VillagerProfession villagerProfession, float f) {
		return ImmutableList.of(
			Pair.of(5, new RandomTask<>(ImmutableList.of(Pair.of(new class_4133(), 5), Pair.of(new GoToIfNearbyTask(MemoryModuleType.field_18439, 16), 2)))),
			Pair.of(10, new InteractTask(400, 1600)),
			Pair.of(10, new FindInteractTargetTask(EntityType.PLAYER, 4)),
			Pair.of(2, new VillagerWalkTowardsTask(MemoryModuleType.field_18439, f, 3, 100)),
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getRestTasks(VillagerProfession villagerProfession, float f) {
		return ImmutableList.of(
			Pair.of(2, new VillagerWalkTowardsTask(MemoryModuleType.field_18438, f, 2, 150)),
		...
		return ImmutableList.of(
			...
			Pair.of(
				...
				new CompositeTask<>(
					...
					CompositeTask.RunMode.field_18352,
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getIdleTasks(VillagerProfession villagerProfession, float f) {
		return ImmutableList.of(
			Pair.of(
				...
				new RandomTask<>(
					ImmutableList.of(
						Pair.of(class_4106.method_18941(EntityType.VILLAGER, 8, MemoryModuleType.field_18447, f, 2), 2),
						Pair.of(new class_4106<>(EntityType.VILLAGER, 8, VillagerEntity::isReadyToBreed, VillagerEntity::isReadyToBreed, MemoryModuleType.field_18448, f, 2), 1),
						Pair.of(class_4106.method_18941(EntityType.CAT, 8, MemoryModuleType.field_18447, f, 2), 1),
						Pair.of(new FindWalkTarget(f), 1),
						Pair.of(new GoTowardsLookTarget(f, 2.0F), 1),
						Pair.of(new WaitTask(30, 60), 1)
					)
				)
			),
