...
public class CompositeTask<E extends LivingEntity> extends Task<E> {
	...
	public CompositeTask(
		...
		tasks.forEach(pair -> this.tasks.add((Task<? super E>)pair.getFirst(), pair.getSecond()));
	}
	...
	public String toString() {
		Set<? extends Task<? super E>> set = (Set)this.tasks.stream().filter(task -> task.getStatus() == Task.Status.field_18338).collect(Collectors.toSet());
