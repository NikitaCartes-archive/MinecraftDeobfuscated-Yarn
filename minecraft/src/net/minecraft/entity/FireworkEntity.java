...
public class FireworkEntity extends Entity implements FlyingItemEntity {
	...
	public void update() {
		...
		if (this.method_7476()) {
			if (this.field_7616 == null) {
				UUID uUID = (UUID)((Optional)this.dataTracker.get(field_7611)).orElse(null);
			...
			if (this.field_7616 != null) {
				if (this.field_7616.isFallFlying()) {
					...
					double d = 1.5;
					double e = 0.1;
					this.field_7616.velocityX += vec3d.x * 0.1 + (vec3d.x * 1.5 - this.field_7616.velocityX) * 0.5;
					this.field_7616.velocityY += vec3d.y * 0.1 + (vec3d.y * 1.5 - this.field_7616.velocityY) * 0.5;
					this.field_7616.velocityZ += vec3d.z * 0.1 + (vec3d.z * 1.5 - this.field_7616.velocityZ) * 0.5;
				}
	...
	private boolean method_7476() {
		return ((Optional)this.dataTracker.get(field_7611)).orElse(null) != null;
	}
