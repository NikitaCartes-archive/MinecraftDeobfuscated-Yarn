...
public class PhantomEntity extends FlyingEntity implements Monster {
	...
	class PhantomMoveControl extends MoveControl {
		...
		public void tick() {
			...
			PhantomEntity.this.velocityX += (p - PhantomEntity.this.velocityX) * 0.2;
			PhantomEntity.this.velocityY += (r - PhantomEntity.this.velocityY) * 0.2;
			PhantomEntity.this.velocityZ += (q - PhantomEntity.this.velocityZ) * 0.2;
		}
	}
		...
		public void tick() {
			if (PhantomEntity.this.field_7315 == PhantomEntity.class_1594.field_7318) {
				...
				if (this.field_7322 <= 0) {
					...
					PhantomEntity.this.playSoundAtEntity(SoundEvents.field_15238, 10.0F, 0.95F + PhantomEntity.this.random.nextFloat() * 0.1F);
				}
			}
		}
	...
	class class_1602 extends PhantomEntity.class_1601 {
		...
		public void tick() {
			LivingEntity livingEntity = PhantomEntity.this.getTarget();
			PhantomEntity.this.field_7314 = new Vec3d(livingEntity.x, livingEntity.y + (double)livingEntity.height * 0.5, livingEntity.z);
