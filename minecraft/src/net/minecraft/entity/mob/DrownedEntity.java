...
public class DrownedEntity extends ZombieEntity implements RangedAttacker {
	...
	public boolean method_5979(IWorld iWorld, class_3730 arg) {
		...
		if (biome != Biomes.field_9438 && biome != Biomes.field_9463) {
			return this.random.nextInt(40) == 0 && this.method_7015() && super.method_5979(iWorld, arg);
		} else {
			return this.random.nextInt(15) == 0 && super.method_5979(iWorld, arg);
		}
	}
	...
	static class DrownedMoveControl extends MoveControl {
		...
		public void tick() {
			...
			if (this.drowned.method_7018() && this.drowned.isInsideWater()) {
				...
				this.drowned.velocityY += (double)this.drowned.method_6029() * e * 0.1;
				this.drowned.velocityX += (double)this.drowned.method_6029() * d * 0.005;
				this.drowned.velocityZ += (double)this.drowned.method_6029() * f * 0.005;
			} else {
