	...
	static class DrownedMoveControl extends MoveControl {
		...
		public void tick() {
			...
			if (this.drowned.method_7018() && this.drowned.isInsideWater()) {
				...
				this.drowned.velocityY += (double)this.drowned.getMovementSpeed() * e * 0.1;
				this.drowned.velocityX += (double)this.drowned.getMovementSpeed() * d * 0.005;
				this.drowned.velocityZ += (double)this.drowned.getMovementSpeed() * f * 0.005;
			} else {
