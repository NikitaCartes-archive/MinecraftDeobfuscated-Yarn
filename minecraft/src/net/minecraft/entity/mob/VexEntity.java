...
public class VexEntity extends HostileEntity {
	...
	class ChargeTargetGoal extends Goal {
		...
		public boolean canStart() {
			if (VexEntity.this.getTarget() != null && !VexEntity.this.getMoveControl().method_6241() && VexEntity.this.random.nextInt(7) == 0) {
		...
		public void start() {
			...
			VexEntity.this.playSoundAtEntity(SoundEvents.field_14898, 1.0F, 1.0F);
		}
		...
		public void tick() {
			if (this.field_6374 == MoveControl.class_1336.field_6378) {
				...
				if (g < VexEntity.this.getBoundingBox().averageDimension()) {
					...
					VexEntity.this.velocityX += d / g * 0.05 * this.field_6372;
					VexEntity.this.velocityY += e / g * 0.05 * this.field_6372;
					VexEntity.this.velocityZ += f / g * 0.05 * this.field_6372;
					if (VexEntity.this.getTarget() == null) {
