			...
			if (this.method_7063()) {
				...
				if (livingEntity != null) {
					...
					while(j < h) {
						...
						this.world.method_8406(ParticleTypes.field_11247, this.x + e * j, this.y + f * j + (double)this.getEyeHeight(), this.z + g * j, 0.0, 0.0, 0.0);
					}
				}
			}
		}
	...
	static class GuardianMoveControl extends MoveControl {
		...
		public void tick() {
			if (this.field_6374 == MoveControl.class_1336.field_6378 && !this.guardian.getNavigation().method_6357()) {
				...
				this.guardian.velocityY += (double)this.guardian.method_6029() * e * 0.1;
