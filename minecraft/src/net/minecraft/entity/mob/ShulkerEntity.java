...
public class ShulkerEntity extends GolemEntity implements Monster {
	...
	protected static final TrackedData<Optional<BlockPos>> field_7338 = DataTracker.registerData(
	...
	public void update() {
		super.update();
		BlockPos blockPos = (BlockPos)((Optional)this.field_6011.get(field_7338)).orElse(null);
	...
	public BlockPos method_7123() {
		return (BlockPos)((Optional)this.field_6011.get(field_7338)).orElse(null);
	}
	...
	class ShootBulletGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isValid()) {
				return ShulkerEntity.this.field_6002.getDifficulty() != Difficulty.PEACEFUL;
			} else {
				return false;
			}
		}
