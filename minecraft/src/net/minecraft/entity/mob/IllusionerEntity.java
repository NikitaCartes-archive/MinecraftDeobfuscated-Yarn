...
public class IllusionerEntity extends SpellcastingIllagerEntity implements RangedAttackMob {
	...
	public static DefaultAttributeContainer.Builder createIllusionerAttributes() {
		return HostileEntity.createHostileAttributes()
			...
			.add(EntityAttributes.field_23717, 18.0)
			.add(EntityAttributes.field_23716, 32.0);
	}
	...
	class BlindTargetGoal extends SpellcastingIllagerEntity.CastSpellGoal {
		...
		public boolean canStart() {
			if (!super.canStart()) {
				...
				return IllusionerEntity.this.world.getLocalDifficulty(IllusionerEntity.this.getBlockPos()).isHarderThan((float)Difficulty.field_5802.ordinal());
			}
		}
	...
	class GiveInvisibilityGoal extends SpellcastingIllagerEntity.CastSpellGoal {
		...
		public boolean canStart() {
			if (!super.canStart()) {
				...
				return !IllusionerEntity.this.hasStatusEffect(StatusEffects.field_5905);
			}
		}
