...
public class EndermanEntity extends HostileEntity {
	...
	public BlockState method_7027() {
		return (BlockState)((Optional)this.field_6011.get(field_7257)).orElse(null);
	}
	...
	static class PickUpBlockGoal extends Goal {
		...
		public boolean canStart() {
			if (this.owner.method_7027() != null) {
				return false;
			} else if (!this.owner.field_6002.getGameRules().getBoolean("mobGriefing")) {
				return false;
			} else {
				return this.owner.getRand().nextInt(20) == 0;
			}
		}
	...
	static class PlaceBlockGoal extends Goal {
		...
		public boolean canStart() {
			if (this.owner.method_7027() == null) {
				...
				return this.owner.getRand().nextInt(2000) == 0;
			}
		}
		...
		private boolean method_7033(
			...
			return blockState2.isAir()
				&& !blockState3.isAir()
				&& blockState3.method_11604(viewableWorld, blockPos2)
				&& blockState.method_11591(viewableWorld, blockPos);
		}
	}
	...
	static class class_1562 extends FollowTargetGoal<PlayerEntity> {
		...
		public class_1562(EndermanEntity endermanEntity) {
			...
			this.field_18127 = new class_4051()
				.method_18418(this.getFollowRange())
				.method_18420(livingEntity -> endermanEntity.method_7026((PlayerEntity)livingEntity));
		}
