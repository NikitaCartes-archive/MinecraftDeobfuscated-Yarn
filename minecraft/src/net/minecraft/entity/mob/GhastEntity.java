		...
		public void tick() {
			...
			if (livingEntity.squaredDistanceTo(this.owner) < 4096.0 && this.owner.canSee(livingEntity)) {
				...
				if (this.cooldown == 20) {
					...
					double g = livingEntity.getBoundingBox().minY + (double)(livingEntity.height / 2.0F) - (0.5 + this.owner.y + (double)(this.owner.height / 2.0F));
					...
					fireballEntity.y = this.owner.y + (double)(this.owner.height / 2.0F) + 0.5;
