...
public abstract class SpellcastingIllagerEntity extends IllagerEntity {
	...
	public boolean method_7137() {
		if (this.world.isRemote) {
			return this.dataTracker.get(field_7373) > 0;
		} else {
	...
	public void update() {
		...
		if (this.world.isRemote && this.method_7137()) {
			...
			this.world.method_8406(ParticleTypes.field_11226, this.x + (double)h * 0.6, this.y + 1.8, this.z + (double)i * 0.6, d, e, f);
			this.world.method_8406(ParticleTypes.field_11226, this.x - (double)h * 0.6, this.y + 1.8, this.z - (double)i * 0.6, d, e, f);
		}
	}
	...
	public abstract class CastSpellGoal extends Goal {
		...
		public void start() {
			...
			if (soundEvent != null) {
				SpellcastingIllagerEntity.this.playSoundAtEntity(soundEvent, 1.0F, 1.0F);
			}
		...
		public void tick() {
			...
			if (this.spellCooldown == 0) {
				this.castSpell();
				SpellcastingIllagerEntity.this.playSoundAtEntity(SpellcastingIllagerEntity.this.method_7142(), 1.0F, 1.0F);
			}
		}
