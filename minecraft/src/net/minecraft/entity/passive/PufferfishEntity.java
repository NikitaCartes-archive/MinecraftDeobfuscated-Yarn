...
public class PufferfishEntity extends FishEntity {
	...
	private static final Predicate<LivingEntity> field_6834 = livingEntity -> {
		if (livingEntity == null) {
			...
			return livingEntity.method_6046() != EntityGroup.AQUATIC;
		} else {
			return false;
		}
	};
	...
	static class class_1455 extends Goal {
		...
		public boolean canStart() {
			List<LivingEntity> list = this.field_6836
				.field_6002
				.method_8390(LivingEntity.class, this.field_6836.method_5829().expand(2.0), PufferfishEntity.field_6834);
			return !list.isEmpty();
		}
