...
public class PufferfishEntity extends FishEntity {
	...
	private void sting(MobEntity mob) {
		...
		if (mob.damageWithModifier(this.getDamageSources().mobAttack(this), (float)(1 + i))) {
	...
	public void onPlayerCollision(PlayerEntity player) {
		int i = this.getPuffState();
		if (player instanceof ServerPlayerEntity && i > 0 && player.damageWithModifier(this.getDamageSources().mobAttack(this), (float)(1 + i))) {
			if (!this.isSilent()) {
