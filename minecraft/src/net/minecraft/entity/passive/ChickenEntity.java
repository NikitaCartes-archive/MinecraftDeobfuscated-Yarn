...
public class ChickenEntity extends AnimalEntity {
	...
	protected void playStepSound(BlockPos blockPos, BlockState blockState) {
		this.playSoundAtEntity(SoundEvents.field_14685, 0.15F, 1.0F);
	}
	...
	public void method_5865(Entity entity) {
		...
		float h = 0.1F;
		float i = 0.0F;
		entity.setPosition(this.x + (double)(0.1F * f), this.y + (double)(this.height * 0.5F) + entity.getHeightOffset() + 0.0, this.z - (double)(0.1F * g));
