...
public class VillagerEntity extends PassiveEntity implements RaidVictim, Npc, VillagerDataContainer, Villager {
	...
	private void addTrades() {
		...
		Int2ObjectMap<VillagerTrades.Factory[]> int2ObjectMap = (Int2ObjectMap)VillagerTrades.PROFESSION_TO_LEVELED_TRADE.get(villagerData.getProfession());
		if (int2ObjectMap != null && !int2ObjectMap.isEmpty()) {
			VillagerTrades.Factory[] factorys = (VillagerTrades.Factory[])int2ObjectMap.get(villagerData.getLevel());
			if (factorys != null) {
				VillagerRecipeList villagerRecipeList = this.getRecipes();
