...
public class StriderEntity extends AnimalEntity implements ItemSteerable, Saddleable {
	...
	public LivingEntity getControllingPassenger() {
		if (this.isSaddled()) {
			...
			if (var2 instanceof PlayerEntity playerEntity && playerEntity.isHolding(Items.WARPED_FUNGUS_ON_A_STICK)) {
				return playerEntity;
			}
		}
	...
	public void tick() {
		...
		if (!this.isAiDisabled()) {
			...
			label36: {
				...
				if (var6 instanceof StriderEntity striderEntity && striderEntity.isCold()) {
					var10000 = true;
					break label36;
				}
