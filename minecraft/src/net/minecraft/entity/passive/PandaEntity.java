...
public class PandaEntity extends AnimalEntity {
	...
	public static enum class_1443 {
		...
		private static final PandaEntity.class_1443[] field_6786 = (PandaEntity.class_1443[])Arrays.stream(values())
			...
			.toArray(i -> new PandaEntity.class_1443[i]);
	...
	static class class_1445 extends Goal {
		...
		@Override
		public boolean shouldContinue() {
			if (!this.field_6800.isInsideWater() && (this.field_6800.method_6549() || this.field_6800.random.nextInt(600) != 1)) {
		...
		public boolean canStart() {
			if ((this.field_6803.isChild() || this.field_6803.method_6522())
				...
				if (this.field_6803.world.getBlockState(new BlockPos(this.field_6803).add(i, -1, j)).isAir()) {
					return true;
				} else if (this.field_6803.method_6522() && this.field_6803.random.nextInt(60) == 1) {
					return true;
				} else {
	...
	class class_1449 extends Goal {
		...
		@Override
		public boolean shouldContinue() {
			if (!PandaEntity.this.isInsideWater() && (PandaEntity.this.method_6549() || PandaEntity.this.random.nextInt(600) != 1)) {
	...
	static class class_1450 extends Goal {
		...
		public boolean canStart() {
			if (this.field_6806.isChild() && !this.field_6806.method_6526()) {
				if (this.field_6806.method_6550() && this.field_6806.random.nextInt(500) == 1) {
					return true;
				} else {
