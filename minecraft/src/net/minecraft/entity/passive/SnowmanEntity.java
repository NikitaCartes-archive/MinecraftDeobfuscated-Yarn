...
public class SnowmanEntity extends GolemEntity implements RangedAttacker {
	...
	protected void method_5959() {
		...
		this.goalSelector.add(3, new class_1361(this, PlayerEntity.class, 6.0F));
	...
	public void attack(LivingEntity livingEntity, float f) {
		...
		this.playSoundAtEntity(SoundEvents.field_14745, 1.0F, 1.0F / (this.getRand().nextFloat() * 0.4F + 0.8F));
