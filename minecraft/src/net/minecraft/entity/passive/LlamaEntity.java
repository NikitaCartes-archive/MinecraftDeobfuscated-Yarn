...
public class LlamaEntity extends AbstractDonkeyEntity implements RangedAttacker {
	...
	protected void playStepSound(BlockPos blockPos, BlockState blockState) {
		this.playSoundAtEntity(SoundEvents.field_14795, 0.15F, 1.0F);
	}

	@Override
	protected void method_6705() {
		this.playSoundAtEntity(SoundEvents.field_15097, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
	}
	...
	public void onInvChange(Inventory inventory) {
		...
		if (this.age > 20 && dyeColor2 != null && dyeColor2 != dyeColor) {
			this.playSoundAtEntity(SoundEvents.field_14554, 0.5F, 1.0F);
		}
	}
	...
	private static DyeColor method_6794(ItemStack itemStack) {
		...
		return block instanceof CarpetBlock ? ((CarpetBlock)block).method_10925() : null;
	}
	...
	private void method_6792(LivingEntity livingEntity) {
		...
		double e = livingEntity.getBoundingBox().minY + (double)(livingEntity.height / 3.0F) - llamaSpitEntity.y;
