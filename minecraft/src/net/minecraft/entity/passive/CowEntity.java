...
public class CowEntity extends AnimalEntity {
	...
	public void tickMovement() {
		World f = this.world;
		if (f instanceof ServerWorld serverWorld) {
			...
			if (this.field_44103 > 0) {
				--this.field_44103;
				float fx = this.getDimensions(EntityPose.STANDING).width / 2.0F;
				serverWorld.spawnParticles(ParticleTypes.SMOKE, this.getX(), this.getY(), this.getZ(), 10, (double)fx, 0.0, (double)fx, 0.1);
