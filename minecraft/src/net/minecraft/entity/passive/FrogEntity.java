...
public class FrogEntity extends AnimalEntity implements VariantHolder<FrogVariant> {
	...
	public Optional<Entity> getFrogTarget() {
		return ((OptionalInt)this.dataTracker.get(TARGET)).stream().mapToObj(this.getWorld()::getEntityById).filter(Objects::nonNull).findFirst();
	}
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		FrogVariant frogVariant = (FrogVariant)Registries.FROG_VARIANT.get(Identifier.tryParse(nbt.getString("variant")));
		if (frogVariant != null) {
