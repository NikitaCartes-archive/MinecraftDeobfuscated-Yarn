...
public class WanderingTraderEntity extends AbstractTraderEntity {
	...
	protected void fillRecipes() {
		Trades.Factory[] factorys = (Trades.Factory[])Trades.WANDERING_TRADER_TRADES.get(1);
		Trades.Factory[] factorys2 = (Trades.Factory[])Trades.WANDERING_TRADER_TRADES.get(2);
