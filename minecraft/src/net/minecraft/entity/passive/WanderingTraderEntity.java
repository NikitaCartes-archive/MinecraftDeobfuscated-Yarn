...
public class WanderingTraderEntity extends AbstractVillagerEntity {
	...
	protected void method_7237() {
		VillagerTrades.Factory[] factorys = (VillagerTrades.Factory[])VillagerTrades.WANDERING_TRADER_TRADES.get(1);
		VillagerTrades.Factory[] factorys2 = (VillagerTrades.Factory[])VillagerTrades.WANDERING_TRADER_TRADES.get(2);
