...
public class RabbitEntity extends AnimalEntity {
	...
	public void doJump(boolean bl) {
		super.doJump(bl);
		if (bl) {
			this.playSoundAtEntity(this.method_6615(), this.getSoundVolume(), ((this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F) * 0.8F);
		}
	}
	...
	public void mobTick() {
		...
		if (this.field_6847 > 0) {
			this.field_6847 -= this.random.nextInt(3);
			if (this.field_6847 < 0) {
				this.field_6847 = 0;
			}
		}
	...
	public boolean method_6121(Entity entity) {
		if (this.getRabbitType() == 99) {
			this.playSoundAtEntity(SoundEvents.field_15147, 1.0F, (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
