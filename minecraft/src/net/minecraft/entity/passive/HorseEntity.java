...
public class HorseEntity extends HorseBaseEntity {
	...
	public void onInvChange(Inventory inventory) {
		...
		if (this.age > 20 && horseArmorType != horseArmorType2 && horseArmorType2 != HorseArmorType.NONE) {
			this.playSoundAtEntity(SoundEvents.field_15141, 0.5F, 1.0F);
		}
	}
	...
	protected void method_6761(BlockSoundGroup blockSoundGroup) {
		...
		if (this.random.nextInt(10) == 0) {
			this.playSoundAtEntity(SoundEvents.field_14556, blockSoundGroup.getVolume() * 0.6F, blockSoundGroup.getPitch());
		}
	}
