...
public class BatEntity extends AmbientEntity {
	...
	protected void mobTick() {
		...
		if (this.isRoosting()) {
			...
			this.velocityX += (Math.signum(d) * 0.5 - this.velocityX) * 0.1F;
			this.velocityY += (Math.signum(e) * 0.7F - this.velocityY) * 0.1F;
			this.velocityZ += (Math.signum(f) * 0.5 - this.velocityZ) * 0.1F;
