...
public class PolarBearEntity extends AnimalEntity {
	...
	public boolean canSpawn(IWorld iWorld, SpawnType spawnType) {
		...
		if (biome != Biomes.field_9435 && biome != Biomes.field_9418) {
			return super.canSpawn(iWorld, spawnType);
		} else {
			return iWorld.getLightLevel(blockPos, 0) > 8 && iWorld.getBlockState(blockPos.down()).getBlock() == Blocks.field_10295;
		}
	}
