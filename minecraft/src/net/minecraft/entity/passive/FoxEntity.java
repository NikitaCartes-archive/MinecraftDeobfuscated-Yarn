...
public class FoxEntity extends AnimalEntity {
	...
	private List<UUID> getTrustedUuids() {
		...
		list.add(((Optional)this.field_6011.get(field_17951)).orElse(null));
		list.add(((Optional)this.field_6011.get(field_17952)).orElse(null));
		return list;
	}

	private void addTrustedUuid(@Nullable UUID uUID) {
		if (((Optional)this.field_6011.get(field_17951)).isPresent()) {
	...
	public class EatSweetBerriesGoal extends MoveToTargetPosGoal {
		...
		protected boolean method_6296(ViewableWorld viewableWorld, BlockPos blockPos) {
			...
			return blockState.getBlock() == Blocks.field_16999 && blockState.method_11654(SweetBerryBushBlock.field_17000) >= 2;
		}
		...
		protected void eatSweetBerry() {
			if (FoxEntity.this.field_6002.getGameRules().getBoolean("mobGriefing")) {
				...
				if (blockState.getBlock() == Blocks.field_16999) {
					int i = blockState.method_11654(SweetBerryBushBlock.field_17000);
