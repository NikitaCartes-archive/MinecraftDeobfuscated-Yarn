...
public class CatEntity extends TameableEntity implements VariantHolder<CatVariant> {
	...
	protected void initDataTracker(DataTracker.Builder builder) {
		...
		builder.add(CAT_VARIANT, (CatVariant)Registries.CAT_VARIANT.getOrThrow(CatVariant.BLACK));
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		CatVariant catVariant = (CatVariant)Registries.CAT_VARIANT.get(Identifier.tryParse(nbt.getString("variant")));
		if (catVariant != null) {
