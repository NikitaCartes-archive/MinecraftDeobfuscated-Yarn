...
public class CatEntity extends TameableEntity {
	...
	public static final Map<Integer, Identifier> field_16283 = SystemUtil.consume(Maps.newHashMap(), hashMap -> {
	...
	public void method_16088(boolean bl) {
		this.dataTracker.set(field_16284, bl);
	}

	public boolean method_16086() {
		return this.dataTracker.get(field_16284);
	}
	...
	public void method_16089() {
		this.playSoundAtEntity(SoundEvents.field_14938, this.getSoundVolume(), this.getSoundPitch());
	}
	...
	public void update() {
		...
		if (this.field_6810 != null && this.field_6810.method_6313() && !this.isTamed() && this.age % 100 == 0) {
			this.playSoundAtEntity(SoundEvents.field_16438, 1.0F, 1.0F);
		}
	...
	private void method_16085() {
		if ((this.method_16086() || this.method_16093()) && this.age % 5 == 0) {
			this.playSoundAtEntity(SoundEvents.field_14741, 0.5F + this.random.nextFloat() - this.random.nextFloat(), 1.0F);
		}
