...
public class FishHookEntity extends Entity {
	...
	public FishHookEntity(PlayerEntity playerEntity, World world, int i, int j) {
		...
		this.velocityX *= 0.6 / (double)o + 0.5 + this.random.nextGaussian() * 0.0045;
		this.velocityY *= 0.6 / (double)o + 0.5 + this.random.nextGaussian() * 0.0045;
		this.velocityZ *= 0.6 / (double)o + 0.5 + this.random.nextGaussian() * 0.0045;
