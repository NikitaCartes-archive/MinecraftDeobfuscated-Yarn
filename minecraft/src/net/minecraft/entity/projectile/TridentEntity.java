...
public class TridentEntity extends ProjectileEntity {
	...
	public void update() {
		...
		if ((this.dealtDamage || this.isNoClip()) && entity != null) {
			...
			if (i > 0 && !this.method_7493()) {
				...
				this.velocityX += vec3d.x * d - this.velocityX * 0.05;
				this.velocityY += vec3d.y * d - this.velocityY * 0.05;
				this.velocityZ += vec3d.z * d - this.velocityZ * 0.05;
	...
	private boolean method_7493() {
		...
		if (entity == null || !entity.isValid()) {
			...
			return !(entity instanceof ServerPlayerEntity) || !((ServerPlayerEntity)entity).isSpectator();
		}
	}
