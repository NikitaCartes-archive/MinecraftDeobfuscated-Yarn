...
public class TridentEntity extends ProjectileEntity {
	...
	public void tick() {
		...
		if ((this.dealtDamage || this.isNoClip()) && entity != null) {
			...
			if (i > 0 && !this.isOwnerAlive()) {
				if (!this.field_6002.isClient && this.pickupType == ProjectileEntity.PickupPermission.field_7593) {
	...
	protected void method_7454(EntityHitResult entityHitResult) {
		...
		float g = 1.0F;
		if (this.field_6002 instanceof ServerWorld && this.field_6002.isThundering() && EnchantmentHelper.hasChanneling(this.tridentStack)) {
			BlockPos blockPos = entity.getBlockPos();
			if (this.field_6002.isSkyVisible(blockPos)) {
