...
public abstract class ProjectileEntity extends Entity implements Projectile {
	...
	protected void method_7457(HitResult hitResult) {
		...
		if (type == HitResult.Type.ENTITY) {
			...
			this.velocityX = (double)((float)(vec3d.x - this.x));
			this.velocityY = (double)((float)(vec3d.y - this.y));
			this.velocityZ = (double)((float)(vec3d.z - this.z));
	...
	public boolean isNoClip() {
		if (!this.world.isClient) {
			...
			return (this.dataTracker.get(FLAGS) & 2) != 0;
		}
	}
