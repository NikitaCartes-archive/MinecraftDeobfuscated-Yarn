...
public class EnderDragonEntity extends MobEntity implements Monster {
	...
	public void updateMovement() {
		...
		if (this.getHealth() <= 0.0F) {
			...
			this.field_6002.method_8406(ParticleTypes.field_11236, this.x + (double)f, this.y + 2.0 + (double)g, this.z + (double)h, 0.0, 0.0, 0.0);
		} else {
			this.method_6830();
			Vec3d vec3d = this.method_18798();
			float g = 2.0F / (MathHelper.sqrt(method_17996(vec3d)) + 1.0F);
