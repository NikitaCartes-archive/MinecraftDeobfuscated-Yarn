...
public class EnderDragonFight {
	...
	private void countAliveCrystals() {
		...
		for(EndSpikeFeature.Spike spike : EndSpikeFeature.getSpikes(this.field_13108)) {
			this.endCrystalsAlive += this.field_13108.method_18467(EnderCrystalEntity.class, spike.method_13968()).size();
		}
	...
	private void method_12516(BlockPos blockPos) {
		...
		Feature.field_13564
			.method_13151(this.field_13108, this.field_13108.method_14178().getChunkGenerator(), new Random(), blockPos, EndGatewayFeatureConfig.createConfig());
	}
	...
	private void generateEndPortal(boolean bl) {
		...
		endPortalFeature.method_13163(
			this.field_13108, this.field_13108.method_14178().getChunkGenerator(), new Random(), this.field_13117, FeatureConfig.field_13603
		);
	}
