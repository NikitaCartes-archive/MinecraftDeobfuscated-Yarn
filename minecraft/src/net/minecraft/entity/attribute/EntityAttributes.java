...
public class EntityAttributes {
	...
	public static final EntityAttribute GENERIC_ATTACK_REACH = register(
		"generic.attack_reach", new ClampedEntityAttribute("attribute.name.generic.attack_reach", 2.5, 0.0, 6.0).setTracked(true)
	);
