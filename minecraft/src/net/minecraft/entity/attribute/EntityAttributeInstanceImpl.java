...
public class EntityAttributeInstanceImpl implements EntityAttributeInstance {
	...
	private final Map<String, Set<EntityAttributeModifier>> field_6345 = Maps.newHashMap();
	private final Map<UUID, EntityAttributeModifier> field_6343 = Maps.newHashMap();
	...
	public void addModifier(EntityAttributeModifier entityAttributeModifier) {
		if (this.getModifier(entityAttributeModifier.getId()) != null) {
			...
			Set<EntityAttributeModifier> set = (Set)this.field_6345.computeIfAbsent(entityAttributeModifier.getName(), string -> Sets.newHashSet());
	...
	public void removeModifier(EntityAttributeModifier entityAttributeModifier) {
		...
		Set<EntityAttributeModifier> set = (Set)this.field_6345.get(entityAttributeModifier.getName());
		if (set != null) {
