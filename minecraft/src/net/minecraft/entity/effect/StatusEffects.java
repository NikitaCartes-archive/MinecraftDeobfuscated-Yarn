...
public class StatusEffects {
	public static final StatusEffect field_5904 = register(
		...
		new StatusEffect(StatusEffectType.field_18271, 8171462)
			.addAttributeModifier(EntityAttributes.field_23719, "91AEAA56-376B-4498-935B-2F7F68070635", 0.2F, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
	);
	public static final StatusEffect field_5909 = register(
		2,
		"slowness",
		new StatusEffect(StatusEffectType.field_18272, 5926017)
			.addAttributeModifier(EntityAttributes.field_23719, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15F, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
	);
	public static final StatusEffect field_5917 = register(
		3,
		"haste",
		new StatusEffect(StatusEffectType.field_18271, 14270531)
			.addAttributeModifier(EntityAttributes.field_23723, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 0.1F, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
	);
	public static final StatusEffect field_5901 = register(
		4,
		"mining_fatigue",
		new StatusEffect(StatusEffectType.field_18272, 4866583)
			.addAttributeModifier(EntityAttributes.field_23723, "55FCED67-E92A-486E-9800-B47F202C4386", -0.1F, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
	);
	public static final StatusEffect field_5910 = register(
		...
		new DamageModifierStatusEffect(StatusEffectType.field_18271, 9643043, 3.0)
			.addAttributeModifier(EntityAttributes.field_23721, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0, EntityAttributeModifier.Operation.ADDITION)
	);
	...
	public static final StatusEffect field_5911 = register(
		...
		new DamageModifierStatusEffect(StatusEffectType.field_18272, 4738376, -4.0)
			.addAttributeModifier(EntityAttributes.field_23721, "22653B89-116E-49DC-9B6B-9971489B5BE5", 0.0, EntityAttributeModifier.Operation.ADDITION)
	);
	...
	public static final StatusEffect field_5914 = register(
		...
		new HealthBoostStatusEffect(StatusEffectType.field_18271, 16284963)
			.addAttributeModifier(EntityAttributes.field_23716, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0, EntityAttributeModifier.Operation.ADDITION)
	);
	...
	public static final StatusEffect field_5926 = register(
		...
		new StatusEffect(StatusEffectType.field_18271, 3381504)
			.addAttributeModifier(EntityAttributes.field_23726, "03C3C89D-7037-4B42-869F-B146BCB64D2E", 1.0, EntityAttributeModifier.Operation.ADDITION)
	);
	public static final StatusEffect field_5908 = register(
		27,
		"unluck",
		new StatusEffect(StatusEffectType.field_18272, 12624973)
			.addAttributeModifier(EntityAttributes.field_23726, "CC5AF142-2BD2-4215-B636-2605AED11727", -1.0, EntityAttributeModifier.Operation.ADDITION)
	);
