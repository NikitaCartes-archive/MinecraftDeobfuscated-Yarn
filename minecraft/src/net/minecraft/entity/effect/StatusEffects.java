...
public class StatusEffects {
	...
	public static final StatusEffect field_5913 = register(8, "jump_boost", new StatusEffect(false, 2293580).method_5557());
	public static final StatusEffect field_5916 = register(9, "nausea", new StatusEffect(true, 5578058).method_5571(0.25));
	public static final StatusEffect field_5924 = register(10, "regeneration", new StatusEffect(false, 13458603).method_5571(0.25).method_5557());
	public static final StatusEffect field_5907 = register(11, "resistance", new StatusEffect(false, 10044730).method_5557());
	public static final StatusEffect field_5918 = register(12, "fire_resistance", new StatusEffect(false, 14981690).method_5557());
	public static final StatusEffect field_5923 = register(13, "water_breathing", new StatusEffect(false, 3035801).method_5557());
	public static final StatusEffect field_5905 = register(14, "invisibility", new StatusEffect(false, 8356754).method_5557());
	public static final StatusEffect field_5919 = register(15, "blindness", new StatusEffect(true, 2039587).method_5571(0.25));
	public static final StatusEffect field_5925 = register(16, "night_vision", new StatusEffect(false, 2039713).method_5557());
	public static final StatusEffect field_5903 = register(17, "hunger", new StatusEffect(true, 5797459));
	...
	public static final StatusEffect field_5899 = register(19, "poison", new StatusEffect(true, 5149489).method_5571(0.25));
	public static final StatusEffect field_5920 = register(20, "wither", new StatusEffect(true, 3484199).method_5571(0.25));
	...
	public static final StatusEffect field_5898 = register(22, "absorption", new AbsorptionStatusEffect(false, 2445989).method_5557());
	public static final StatusEffect field_5922 = register(23, "saturation", new InstantStatusEffect(false, 16262179).method_5557());
	public static final StatusEffect field_5912 = register(24, "glowing", new StatusEffect(false, 9740385));
	public static final StatusEffect field_5902 = register(25, "levitation", new StatusEffect(true, 13565951));
	...
	public static final StatusEffect field_5906 = register(28, "slow_falling", new StatusEffect(false, 16773073).method_5557());
	public static final StatusEffect field_5927 = register(29, "conduit_power", new StatusEffect(false, 1950417).method_5557());
	public static final StatusEffect field_5900 = register(30, "dolphins_grace", new StatusEffect(false, 8954814).method_5557());
	public static final StatusEffect field_16595 = register(31, "bad_omen", new StatusEffect(false, 745784));
