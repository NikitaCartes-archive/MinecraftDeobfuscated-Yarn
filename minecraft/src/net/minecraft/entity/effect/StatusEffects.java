...
public class StatusEffects {
	...
	public static final StatusEffect INSTANT_HEALTH = register(
		6, "instant_health", new InstantHealthOrDamageStatusEffect(StatusEffectCategory.BENEFICIAL, 16262179, false)
	);
	public static final StatusEffect INSTANT_DAMAGE = register(
		7, "instant_damage", new InstantHealthOrDamageStatusEffect(StatusEffectCategory.HARMFUL, 11101546, true)
	);
	...
	public static final StatusEffect REGENERATION = register(10, "regeneration", new RegenerationStatusEffect(StatusEffectCategory.BENEFICIAL, 13458603));
	...
	public static final StatusEffect HUNGER = register(17, "hunger", new HungerStatusEffect(StatusEffectCategory.HARMFUL, 5797459));
	...
	public static final StatusEffect POISON = register(19, "poison", new PoisonStatusEffect(StatusEffectCategory.HARMFUL, 8889187));
	public static final StatusEffect WITHER = register(20, "wither", new WitherStatusEffect(StatusEffectCategory.HARMFUL, 7561558));
	...
	public static final StatusEffect SATURATION = register(23, "saturation", new SaturationStatusEffect(StatusEffectCategory.BENEFICIAL, 16262179));
	...
	public static final StatusEffect BAD_OMEN = register(31, "bad_omen", new BadOmenStatusEffect(StatusEffectCategory.NEUTRAL, 745784));
