...
public interface DamageTypes {
	...
	RegistryKey<DamageType> SPIT = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, new Identifier("spit"));
	RegistryKey<DamageType> WIND_CHARGE = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, new Identifier("wind_charge"));
