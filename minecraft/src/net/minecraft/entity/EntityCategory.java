...
public enum EntityCategory {
	...
	public static EntityCategory method_17350(Entity entity) {
		for (EntityCategory entityCategory : values()) {
			if (entityCategory.entityClass.isAssignableFrom(entity.getClass())) {
