...
public record Transformation(TransformationType type, @Nullable Entity entity, @Nullable GameProfile playerSkin) {
	...
	public boolean canBreatheInWater() {
		if (this.entity == null) {
			...
			return var2 instanceof LivingEntity livingEntity ? livingEntity.canBreatheInWater() : true;
		}
	}

	public boolean isLandBased() {
		Entity var2 = this.entity;
		return var2 instanceof LivingEntity livingEntity ? livingEntity.isLandBased() : true;
	}

	public boolean isHurtByWater() {
		Entity var2 = this.entity;
		if (var2 instanceof LivingEntity livingEntity && livingEntity.hurtByWater()) {
			return true;
		}
