...
public abstract class LivingEntity extends Entity {
	...
	public void method_5652(CompoundTag compoundTag) {
		...
		for(EquipmentSlot equipmentSlot : EquipmentSlot.values()) {
			ItemStack itemStack = this.method_6118(equipmentSlot);
			if (!itemStack.isEmpty()) {
				this.method_6127().method_6210(itemStack.getAttributeModifiers(equipmentSlot));
			}
		}
				...
				for(int[] js : is) {
					...
					if (this.field_6002.method_8587(this, boundingBox2)) {
						...
						if (this.field_6002.method_8587(this, boundingBox2.offset(0.0, 1.0, 0.0))
							&& this.field_6002.method_8320(blockPos).method_11631(this.field_6002, blockPos)) {
							k = s;
							l = this.y + 2.0;
							e = t;
						}
	...
	public boolean method_6039() {
		if (this.isUsingItem() && !this.field_6277.isEmpty()) {
			...
			if (item.method_7853(this.field_6277) != UseAction.field_8949) {
				return false;
			} else {
				return item.method_7881(this.field_6277) - this.field_6222 >= 5;
			}
		} else {
			return false;
		}
