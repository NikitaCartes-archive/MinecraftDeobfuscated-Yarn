...
public abstract class ThrownEntity extends Entity implements Projectile {
	...
	public void tick() {
		...
		if (this.owner == null) {
			...
			for(Entity entity : this.world.getEntities(this, box, entity -> !entity.isSpectator() && entity.collides())) {
		...
		Predicate<Entity> predicate = entity -> !entity.isSpectator() && entity.collides() && (this.field_21975 || !this.method_24354(entity, this.owner));
