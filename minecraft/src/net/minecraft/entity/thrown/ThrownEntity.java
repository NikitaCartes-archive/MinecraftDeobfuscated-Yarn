...
public abstract class ThrownEntity extends Entity implements Projectile {
	...
	public void update() {
		...
		if (hitResult != null) {
			if (hitResult.type == HitResult.Type.BLOCK && this.world.getBlockState(hitResult.getBlockPos()).getBlock() == Blocks.field_10316) {
				this.setInPortal(hitResult.getBlockPos());
			} else {
