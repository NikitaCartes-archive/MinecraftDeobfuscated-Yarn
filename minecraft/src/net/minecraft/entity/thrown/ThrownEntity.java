...
public abstract class ThrownEntity extends Entity implements Projectile {
	...
	public void tick() {
		...
		for(Entity entity : this.world.getEntities(this, boundingBox, entity -> !entity.isSpectator() && entity.collides())) {
		...
		if (hitResult.getType() != HitResult.Type.field_1333) {
			if (hitResult.getType() == HitResult.Type.field_1332
				&& this.world.getBlockState(((BlockHitResult)hitResult).getBlockPos()).getBlock() == Blocks.field_10316) {
