...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<FoxEntity> FOX = register(
		...
		EntityType.Builder.<FoxEntity>create(FoxEntity::new, SpawnGroup.CREATURE)
			...
			.maxTrackingRange(8)
			.method_29497(Blocks.SWEET_BERRY_BUSH)
	);
	...
	public static final EntityType<PolarBearEntity> POLAR_BEAR = register(
		"polar_bear", EntityType.Builder.<PolarBearEntity>create(PolarBearEntity::new, SpawnGroup.CREATURE).setDimensions(1.4F, 1.4F).maxTrackingRange(10)
	);
	...
	public static final EntityType<SnowGolemEntity> SNOW_GOLEM = register(
		"snow_golem", EntityType.Builder.<SnowGolemEntity>create(SnowGolemEntity::new, SpawnGroup.MISC).setDimensions(0.7F, 1.9F).maxTrackingRange(8)
	);
	...
	public static final EntityType<StrayEntity> STRAY = register(
		"stray", EntityType.Builder.<StrayEntity>create(StrayEntity::new, SpawnGroup.MONSTER).setDimensions(0.6F, 1.99F).maxTrackingRange(8)
	);
