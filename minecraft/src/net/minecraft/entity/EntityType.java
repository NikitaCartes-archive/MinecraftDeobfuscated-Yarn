...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<BatEntity> field_6108 = register(
		"bat", EntityType.Builder.<BatEntity>create(BatEntity::new, SpawnGroup.field_6303).setDimensions(0.5F, 0.9F).maxTrackingRange(5)
	);
	public static final EntityType<BeeEntity> field_20346 = register(
		"bee", EntityType.Builder.<BeeEntity>create(BeeEntity::new, SpawnGroup.field_6294).setDimensions(0.7F, 0.6F).maxTrackingRange(8)
	);
	public static final EntityType<BlazeEntity> field_6099 = register(
		"blaze", EntityType.Builder.<BlazeEntity>create(BlazeEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(0.6F, 1.8F).maxTrackingRange(8)
	);
	...
	public static final EntityType<CatEntity> field_16281 = register(
		"cat", EntityType.Builder.<CatEntity>create(CatEntity::new, SpawnGroup.field_6294).setDimensions(0.6F, 0.7F).maxTrackingRange(8)
	);
	public static final EntityType<CaveSpiderEntity> field_6084 = register(
		"cave_spider", EntityType.Builder.<CaveSpiderEntity>create(CaveSpiderEntity::new, SpawnGroup.field_6302).setDimensions(0.7F, 0.5F).maxTrackingRange(8)
	);
	public static final EntityType<ChickenEntity> field_6132 = register(
		"chicken", EntityType.Builder.<ChickenEntity>create(ChickenEntity::new, SpawnGroup.field_6294).setDimensions(0.4F, 0.7F).maxTrackingRange(10)
	);
	public static final EntityType<CodEntity> field_6070 = register(
		"cod", EntityType.Builder.<CodEntity>create(CodEntity::new, SpawnGroup.field_24460).setDimensions(0.5F, 0.3F).maxTrackingRange(4)
	);
	public static final EntityType<CowEntity> field_6085 = register(
		"cow", EntityType.Builder.<CowEntity>create(CowEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 1.4F).maxTrackingRange(10)
	);
	public static final EntityType<CreeperEntity> field_6046 = register(
		"creeper", EntityType.Builder.<CreeperEntity>create(CreeperEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.7F).maxTrackingRange(8)
	);
	public static final EntityType<DolphinEntity> field_6087 = register(
		"dolphin", EntityType.Builder.<DolphinEntity>create(DolphinEntity::new, SpawnGroup.field_6300).setDimensions(0.9F, 0.6F)
	);
	public static final EntityType<DonkeyEntity> field_6067 = register(
		"donkey", EntityType.Builder.<DonkeyEntity>create(DonkeyEntity::new, SpawnGroup.field_6294).setDimensions(1.3964844F, 1.5F).maxTrackingRange(10)
	);
	...
	public static final EntityType<DrownedEntity> field_6123 = register(
		"drowned", EntityType.Builder.<DrownedEntity>create(DrownedEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<ElderGuardianEntity> field_6086 = register(
		"elder_guardian",
		EntityType.Builder.<ElderGuardianEntity>create(ElderGuardianEntity::new, SpawnGroup.field_6302).setDimensions(1.9975F, 1.9975F).maxTrackingRange(10)
	);
	...
	public static final EntityType<EnderDragonEntity> field_6116 = register(
		"ender_dragon",
		EntityType.Builder.<EnderDragonEntity>create(EnderDragonEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(16.0F, 8.0F).maxTrackingRange(10)
	);
	public static final EntityType<EndermanEntity> field_6091 = register(
		"enderman", EntityType.Builder.<EndermanEntity>create(EndermanEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 2.9F).maxTrackingRange(8)
	);
	public static final EntityType<EndermiteEntity> field_6128 = register(
		"endermite", EntityType.Builder.<EndermiteEntity>create(EndermiteEntity::new, SpawnGroup.field_6302).setDimensions(0.4F, 0.3F).maxTrackingRange(8)
	);
	public static final EntityType<EvokerEntity> field_6090 = register(
		"evoker", EntityType.Builder.<EvokerEntity>create(EvokerEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	...
	public static final EntityType<FoxEntity> field_17943 = register(
		"fox",
		EntityType.Builder.<FoxEntity>create(FoxEntity::new, SpawnGroup.field_6294)
			.setDimensions(0.6F, 0.7F)
			.maxTrackingRange(8)
			.allowSpawningInside(Blocks.field_16999)
	);
	public static final EntityType<GhastEntity> field_6107 = register(
		"ghast", EntityType.Builder.<GhastEntity>create(GhastEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(4.0F, 4.0F).maxTrackingRange(10)
	);
	public static final EntityType<GiantEntity> field_6095 = register(
		"giant", EntityType.Builder.<GiantEntity>create(GiantEntity::new, SpawnGroup.field_6302).setDimensions(3.6F, 12.0F).maxTrackingRange(10)
	);
	public static final EntityType<GuardianEntity> field_6118 = register(
		"guardian", EntityType.Builder.<GuardianEntity>create(GuardianEntity::new, SpawnGroup.field_6302).setDimensions(0.85F, 0.85F).maxTrackingRange(8)
	);
	public static final EntityType<HoglinEntity> field_21973 = register(
		"hoglin", EntityType.Builder.<HoglinEntity>create(HoglinEntity::new, SpawnGroup.field_6302).setDimensions(1.3964844F, 1.4F).maxTrackingRange(8)
	);
	public static final EntityType<HorseEntity> field_6139 = register(
		"horse", EntityType.Builder.<HorseEntity>create(HorseEntity::new, SpawnGroup.field_6294).setDimensions(1.3964844F, 1.6F).maxTrackingRange(10)
	);
	public static final EntityType<HuskEntity> field_6071 = register(
		"husk", EntityType.Builder.<HuskEntity>create(HuskEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<IllusionerEntity> field_6065 = register(
		"illusioner", EntityType.Builder.<IllusionerEntity>create(IllusionerEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<IronGolemEntity> field_6147 = register(
		"iron_golem", EntityType.Builder.<IronGolemEntity>create(IronGolemEntity::new, SpawnGroup.field_17715).setDimensions(1.4F, 2.7F).maxTrackingRange(10)
	);
	...
	public static final EntityType<FireballEntity> field_6066 = register(
		"fireball",
		EntityType.Builder.<FireballEntity>create(FireballEntity::new, SpawnGroup.field_17715)
			.setDimensions(1.0F, 1.0F)
			.maxTrackingRange(4)
			.trackingTickInterval(10)
	);
	...
	public static final EntityType<LightningEntity> field_6112 = register(
		"lightning_bolt",
		EntityType.Builder.<LightningEntity>create(LightningEntity::new, SpawnGroup.field_17715)
			.disableSaving()
	...
	public static final EntityType<LlamaEntity> field_6074 = register(
		"llama", EntityType.Builder.<LlamaEntity>create(LlamaEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 1.87F).maxTrackingRange(10)
	);
	...
	public static final EntityType<MagmaCubeEntity> field_6102 = register(
		"magma_cube",
		EntityType.Builder.<MagmaCubeEntity>create(MagmaCubeEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(2.04F, 2.04F).maxTrackingRange(8)
	);
	...
	public static final EntityType<CommandBlockMinecartEntity> field_6136 = register(
		...
		EntityType.Builder.<CommandBlockMinecartEntity>create(CommandBlockMinecartEntity::new, SpawnGroup.field_17715)
	...
	public static final EntityType<MuleEntity> field_6057 = register(
		"mule", EntityType.Builder.<MuleEntity>create(MuleEntity::new, SpawnGroup.field_6294).setDimensions(1.3964844F, 1.6F).maxTrackingRange(8)
	);
	public static final EntityType<MooshroomEntity> field_6143 = register(
		"mooshroom", EntityType.Builder.<MooshroomEntity>create(MooshroomEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 1.4F).maxTrackingRange(10)
	);
	public static final EntityType<OcelotEntity> field_6081 = register(
		"ocelot", EntityType.Builder.<OcelotEntity>create(OcelotEntity::new, SpawnGroup.field_6294).setDimensions(0.6F, 0.7F).maxTrackingRange(10)
	);
	...
	public static final EntityType<PandaEntity> field_6146 = register(
		"panda", EntityType.Builder.<PandaEntity>create(PandaEntity::new, SpawnGroup.field_6294).setDimensions(1.3F, 1.25F).maxTrackingRange(10)
	);
	public static final EntityType<ParrotEntity> field_6104 = register(
		"parrot", EntityType.Builder.<ParrotEntity>create(ParrotEntity::new, SpawnGroup.field_6294).setDimensions(0.5F, 0.9F).maxTrackingRange(8)
	);
	public static final EntityType<PhantomEntity> field_6078 = register(
		"phantom", EntityType.Builder.<PhantomEntity>create(PhantomEntity::new, SpawnGroup.field_6302).setDimensions(0.9F, 0.5F).maxTrackingRange(8)
	);
	public static final EntityType<PigEntity> field_6093 = register(
		"pig", EntityType.Builder.<PigEntity>create(PigEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 0.9F).maxTrackingRange(10)
	);
	public static final EntityType<PiglinEntity> field_22281 = register(
		"piglin", EntityType.Builder.<PiglinEntity>create(PiglinEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<PiglinBruteEntity> field_25751 = register(
		"piglin_brute", EntityType.Builder.<PiglinBruteEntity>create(PiglinBruteEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<PillagerEntity> field_6105 = register(
		"pillager",
		EntityType.Builder.<PillagerEntity>create(PillagerEntity::new, SpawnGroup.field_6302)
			.spawnableFarFromPlayer()
			.setDimensions(0.6F, 1.95F)
			.maxTrackingRange(8)
	);
	public static final EntityType<PolarBearEntity> field_6042 = register(
		"polar_bear", EntityType.Builder.<PolarBearEntity>create(PolarBearEntity::new, SpawnGroup.field_6294).setDimensions(1.4F, 1.4F).maxTrackingRange(10)
	);
	...
	public static final EntityType<PufferfishEntity> field_6062 = register(
		"pufferfish", EntityType.Builder.<PufferfishEntity>create(PufferfishEntity::new, SpawnGroup.field_24460).setDimensions(0.7F, 0.7F).maxTrackingRange(4)
	);
	public static final EntityType<RabbitEntity> field_6140 = register(
		"rabbit", EntityType.Builder.<RabbitEntity>create(RabbitEntity::new, SpawnGroup.field_6294).setDimensions(0.4F, 0.5F).maxTrackingRange(8)
	);
	public static final EntityType<RavagerEntity> field_6134 = register(
		"ravager", EntityType.Builder.<RavagerEntity>create(RavagerEntity::new, SpawnGroup.field_6302).setDimensions(1.95F, 2.2F).maxTrackingRange(10)
	);
	public static final EntityType<SalmonEntity> field_6073 = register(
		"salmon", EntityType.Builder.<SalmonEntity>create(SalmonEntity::new, SpawnGroup.field_24460).setDimensions(0.7F, 0.4F).maxTrackingRange(4)
	);
	public static final EntityType<SheepEntity> field_6115 = register(
		"sheep", EntityType.Builder.<SheepEntity>create(SheepEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 1.3F).maxTrackingRange(10)
	);
	public static final EntityType<ShulkerEntity> field_6109 = register(
		"shulker",
		EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, SpawnGroup.field_6302)
			.makeFireImmune()
			.spawnableFarFromPlayer()
			.setDimensions(1.0F, 1.0F)
			.maxTrackingRange(10)
	...
	public static final EntityType<SilverfishEntity> field_6125 = register(
		"silverfish", EntityType.Builder.<SilverfishEntity>create(SilverfishEntity::new, SpawnGroup.field_6302).setDimensions(0.4F, 0.3F).maxTrackingRange(8)
	);
	public static final EntityType<SkeletonEntity> field_6137 = register(
		"skeleton", EntityType.Builder.<SkeletonEntity>create(SkeletonEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.99F).maxTrackingRange(8)
	);
	public static final EntityType<SkeletonHorseEntity> field_6075 = register(
		"skeleton_horse",
		EntityType.Builder.<SkeletonHorseEntity>create(SkeletonHorseEntity::new, SpawnGroup.field_6294).setDimensions(1.3964844F, 1.6F).maxTrackingRange(10)
	);
	public static final EntityType<SlimeEntity> field_6069 = register(
		"slime", EntityType.Builder.<SlimeEntity>create(SlimeEntity::new, SpawnGroup.field_6302).setDimensions(2.04F, 2.04F).maxTrackingRange(10)
	);
	...
	public static final EntityType<SnowGolemEntity> field_6047 = register(
		"snow_golem", EntityType.Builder.<SnowGolemEntity>create(SnowGolemEntity::new, SpawnGroup.field_17715).setDimensions(0.7F, 1.9F).maxTrackingRange(8)
	);
	...
	public static final EntityType<SpiderEntity> field_6079 = register(
		"spider", EntityType.Builder.<SpiderEntity>create(SpiderEntity::new, SpawnGroup.field_6302).setDimensions(1.4F, 0.9F).maxTrackingRange(8)
	);
	public static final EntityType<SquidEntity> field_6114 = register(
		"squid", EntityType.Builder.<SquidEntity>create(SquidEntity::new, SpawnGroup.field_6300).setDimensions(0.8F, 0.8F).maxTrackingRange(8)
	);
	public static final EntityType<StrayEntity> field_6098 = register(
		"stray", EntityType.Builder.<StrayEntity>create(StrayEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.99F).maxTrackingRange(8)
	);
	public static final EntityType<StriderEntity> field_23214 = register(
		"strider",
		EntityType.Builder.<StriderEntity>create(StriderEntity::new, SpawnGroup.field_6294).makeFireImmune().setDimensions(0.9F, 1.7F).maxTrackingRange(10)
	);
	...
	public static final EntityType<TraderLlamaEntity> field_17714 = register(
		"trader_llama", EntityType.Builder.<TraderLlamaEntity>create(TraderLlamaEntity::new, SpawnGroup.field_6294).setDimensions(0.9F, 1.87F).maxTrackingRange(10)
	);
	public static final EntityType<TropicalFishEntity> field_6111 = register(
		"tropical_fish",
		EntityType.Builder.<TropicalFishEntity>create(TropicalFishEntity::new, SpawnGroup.field_24460).setDimensions(0.5F, 0.4F).maxTrackingRange(4)
	);
	public static final EntityType<TurtleEntity> field_6113 = register(
		"turtle", EntityType.Builder.<TurtleEntity>create(TurtleEntity::new, SpawnGroup.field_6294).setDimensions(1.2F, 0.4F).maxTrackingRange(10)
	);
	public static final EntityType<VexEntity> field_6059 = register(
		"vex", EntityType.Builder.<VexEntity>create(VexEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(0.4F, 0.8F).maxTrackingRange(8)
	);
	...
	public static final EntityType<VindicatorEntity> field_6117 = register(
		"vindicator", EntityType.Builder.<VindicatorEntity>create(VindicatorEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<WanderingTraderEntity> field_17713 = register(
		"wandering_trader",
		EntityType.Builder.<WanderingTraderEntity>create(WanderingTraderEntity::new, SpawnGroup.field_6294).setDimensions(0.6F, 1.95F).maxTrackingRange(10)
	);
	public static final EntityType<WitchEntity> field_6145 = register(
		"witch", EntityType.Builder.<WitchEntity>create(WitchEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<WitherEntity> field_6119 = register(
		"wither",
		EntityType.Builder.<WitherEntity>create(WitherEntity::new, SpawnGroup.field_6302)
			.makeFireImmune()
	...
	public static final EntityType<WitherSkeletonEntity> field_6076 = register(
		"wither_skeleton",
		EntityType.Builder.<WitherSkeletonEntity>create(WitherSkeletonEntity::new, SpawnGroup.field_6302)
			.makeFireImmune()
			.allowSpawningInside(Blocks.field_10606)
	...
	public static final EntityType<WolfEntity> field_6055 = register(
		"wolf", EntityType.Builder.<WolfEntity>create(WolfEntity::new, SpawnGroup.field_6294).setDimensions(0.6F, 0.85F).maxTrackingRange(10)
	);
	public static final EntityType<ZoglinEntity> field_23696 = register(
		"zoglin",
		EntityType.Builder.<ZoglinEntity>create(ZoglinEntity::new, SpawnGroup.field_6302).makeFireImmune().setDimensions(1.3964844F, 1.4F).maxTrackingRange(8)
	);
	...
	public static final EntityType<ZombieHorseEntity> field_6048 = register(
		"zombie_horse",
		EntityType.Builder.<ZombieHorseEntity>create(ZombieHorseEntity::new, SpawnGroup.field_6294).setDimensions(1.3964844F, 1.6F).maxTrackingRange(10)
	);
	public static final EntityType<ZombieVillagerEntity> field_6054 = register(
		"zombie_villager",
		EntityType.Builder.<ZombieVillagerEntity>create(ZombieVillagerEntity::new, SpawnGroup.field_6302).setDimensions(0.6F, 1.95F).maxTrackingRange(8)
	);
	public static final EntityType<ZombifiedPiglinEntity> field_6050 = register(
		"zombified_piglin",
		EntityType.Builder.<ZombifiedPiglinEntity>create(ZombifiedPiglinEntity::new, SpawnGroup.field_6302)
			.makeFireImmune()
			.setDimensions(0.6F, 1.95F)
			.maxTrackingRange(8)
	);
	...
	public boolean isInvalidSpawn(BlockState blockState) {
		if (this.canSpawnInside.contains(blockState.getBlock())) {
			...
			return blockState.isOf(Blocks.field_10606) || blockState.isOf(Blocks.field_16999) || blockState.isOf(Blocks.field_10029);
		} else {
			return true;
		}
	}
