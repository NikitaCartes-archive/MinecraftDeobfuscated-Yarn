...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<ShulkerEntity> SHULKER = register(
		"shulker", EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, EntityCategory.MONSTER).makeFireImmune().setDimensions(1.0F, 1.0F)
	);
	...
	public static final EntityType<PillagerEntity> PILLAGER = register(
		"pillager", EntityType.Builder.<PillagerEntity>create(PillagerEntity::new, EntityCategory.MONSTER).setDimensions(0.6F, 1.95F)
	);
