...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<FoxEntity> FOX = register(
		"fox", EntityType.Builder.<FoxEntity>create(FoxEntity::new, SpawnGroup.CREATURE).setDimensions(0.6F, 0.7F).maxTrackingRange(8)
	);
	...
	public static final EntityType<WitherEntity> WITHER = register(
		"wither", EntityType.Builder.<WitherEntity>create(WitherEntity::new, SpawnGroup.MONSTER).makeFireImmune().setDimensions(0.9F, 3.5F).maxTrackingRange(10)
	);
