...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<BatEntity> BAT = register(
		"bat", EntityType.Builder.<BatEntity>method_5903(BatEntity::new, EntityCategory.field_6303).setSize(0.5F, 0.9F)
	);
	public static final EntityType<BlazeEntity> BLAZE = register(
		"blaze", EntityType.Builder.<BlazeEntity>method_5903(BlazeEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.8F)
	);
	...
	public static final EntityType<CatEntity> CAT = register(
		"cat", EntityType.Builder.<CatEntity>method_5903(CatEntity::new, EntityCategory.field_6294).setSize(0.6F, 0.7F)
	);
	public static final EntityType<CaveSpiderEntity> CAVE_SPIDER = register(
		"cave_spider", EntityType.Builder.<CaveSpiderEntity>method_5903(CaveSpiderEntity::new, EntityCategory.field_6302).setSize(0.7F, 0.5F)
	);
	public static final EntityType<ChickenEntity> CHICKEN = register(
		"chicken", EntityType.Builder.<ChickenEntity>method_5903(ChickenEntity::new, EntityCategory.field_6294).setSize(0.4F, 0.7F)
	);
	public static final EntityType<CodEntity> COD = register(
		"cod", EntityType.Builder.<CodEntity>method_5903(CodEntity::new, EntityCategory.field_6300).setSize(0.5F, 0.3F)
	);
	public static final EntityType<CowEntity> COW = register(
		"cow", EntityType.Builder.<CowEntity>method_5903(CowEntity::new, EntityCategory.field_6294).setSize(0.9F, 1.4F)
	);
	public static final EntityType<CreeperEntity> CREEPER = register(
		"creeper", EntityType.Builder.<CreeperEntity>method_5903(CreeperEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.7F)
	);
	public static final EntityType<DonkeyEntity> DONKEY = register(
		"donkey", EntityType.Builder.<DonkeyEntity>method_5903(DonkeyEntity::new, EntityCategory.field_6294).setSize(1.3964844F, 1.6F)
	);
	public static final EntityType<DolphinEntity> DOLPHIN = register(
		"dolphin", EntityType.Builder.<DolphinEntity>method_5903(DolphinEntity::new, EntityCategory.field_6300).setSize(0.9F, 0.6F)
	);
	...
	public static final EntityType<DrownedEntity> DROWNED = register(
		"drowned", EntityType.Builder.<DrownedEntity>method_5903(DrownedEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<ElderGuardianEntity> ELDER_GUARDIAN = register(
		"elder_guardian", EntityType.Builder.<ElderGuardianEntity>method_5903(ElderGuardianEntity::new, EntityCategory.field_6302).setSize(1.9975F, 1.9975F)
	);
	...
	public static final EntityType<EnderDragonEntity> ENDER_DRAGON = register(
		"ender_dragon", EntityType.Builder.<EnderDragonEntity>method_5903(EnderDragonEntity::new, EntityCategory.field_6302).setSize(16.0F, 8.0F)
	);
	public static final EntityType<EndermanEntity> ENDERMAN = register(
		"enderman", EntityType.Builder.<EndermanEntity>method_5903(EndermanEntity::new, EntityCategory.field_6302).setSize(0.6F, 2.9F)
	);
	public static final EntityType<EndermiteEntity> ENDERMITE = register(
		"endermite", EntityType.Builder.<EndermiteEntity>method_5903(EndermiteEntity::new, EntityCategory.field_6302).setSize(0.4F, 0.3F)
	);
	...
	public static final EntityType<EvokerEntity> EVOKER = register(
		"evoker", EntityType.Builder.<EvokerEntity>method_5903(EvokerEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	...
	public static final EntityType<FoxEntity> field_17943 = register(
		"fox", EntityType.Builder.<FoxEntity>method_5903(FoxEntity::new, EntityCategory.field_6294).setSize(0.5F, 0.7F)
	);
	public static final EntityType<GhastEntity> GHAST = register(
		"ghast", EntityType.Builder.<GhastEntity>method_5903(GhastEntity::new, EntityCategory.field_6302).setSize(4.0F, 4.0F)
	);
	public static final EntityType<GiantEntity> GIANT = register(
		"giant", EntityType.Builder.<GiantEntity>method_5903(GiantEntity::new, EntityCategory.field_6302).setSize(3.6F, 11.7F)
	);
	public static final EntityType<GuardianEntity> GUARDIAN = register(
		"guardian", EntityType.Builder.<GuardianEntity>method_5903(GuardianEntity::new, EntityCategory.field_6302).setSize(0.85F, 0.85F)
	);
	public static final EntityType<HorseEntity> HORSE = register(
		"horse", EntityType.Builder.<HorseEntity>method_5903(HorseEntity::new, EntityCategory.field_6294).setSize(1.3964844F, 1.6F)
	);
	public static final EntityType<HuskEntity> HUSK = register(
		"husk", EntityType.Builder.<HuskEntity>method_5903(HuskEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<IllusionerEntity> ILLUSIONER = register(
		"illusioner", EntityType.Builder.<IllusionerEntity>method_5903(IllusionerEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	...
	public static final EntityType<LlamaEntity> LLAMA = register(
		"llama", EntityType.Builder.<LlamaEntity>method_5903(LlamaEntity::new, EntityCategory.field_6294).setSize(0.9F, 1.87F)
	);
	...
	public static final EntityType<MagmaCubeEntity> MAGMA_CUBE = register(
		"magma_cube", EntityType.Builder.<MagmaCubeEntity>method_5903(MagmaCubeEntity::new, EntityCategory.field_6302).setSize(2.04F, 2.04F)
	);
	...
	public static final EntityType<MuleEntity> MULE = register(
		"mule", EntityType.Builder.<MuleEntity>method_5903(MuleEntity::new, EntityCategory.field_6294).setSize(1.3964844F, 1.6F)
	);
	public static final EntityType<MooshroomEntity> MOOSHROOM = register(
		"mooshroom", EntityType.Builder.<MooshroomEntity>method_5903(MooshroomEntity::new, EntityCategory.field_6294).setSize(0.9F, 1.4F)
	);
	public static final EntityType<OcelotEntity> OCELOT = register(
		"ocelot", EntityType.Builder.<OcelotEntity>method_5903(OcelotEntity::new, EntityCategory.field_6294).setSize(0.6F, 0.7F)
	);
	...
	public static final EntityType<PandaEntity> PANDA = register(
		"panda", EntityType.Builder.<PandaEntity>method_5903(PandaEntity::new, EntityCategory.field_6294).setSize(1.3F, 1.25F)
	);
	public static final EntityType<ParrotEntity> PARROT = register(
		"parrot", EntityType.Builder.<ParrotEntity>method_5903(ParrotEntity::new, EntityCategory.field_6294).setSize(0.5F, 0.9F)
	);
	public static final EntityType<PigEntity> PIG = register(
		"pig", EntityType.Builder.<PigEntity>method_5903(PigEntity::new, EntityCategory.field_6294).setSize(0.9F, 0.9F)
	);
	public static final EntityType<PufferfishEntity> PUFFERFISH = register(
		"pufferfish", EntityType.Builder.<PufferfishEntity>method_5903(PufferfishEntity::new, EntityCategory.field_6300).setSize(0.7F, 0.7F)
	);
	public static final EntityType<PigZombieEntity> ZOMBIE_PIGMAN = register(
		"zombie_pigman", EntityType.Builder.<PigZombieEntity>method_5903(PigZombieEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<PolarBearEntity> POLAR_BEAR = register(
		"polar_bear", EntityType.Builder.<PolarBearEntity>method_5903(PolarBearEntity::new, EntityCategory.field_6294).setSize(1.3F, 1.4F)
	);
	...
	public static final EntityType<RabbitEntity> RABBIT = register(
		"rabbit", EntityType.Builder.<RabbitEntity>method_5903(RabbitEntity::new, EntityCategory.field_6294).setSize(0.4F, 0.5F)
	);
	public static final EntityType<SalmonEntity> SALMON = register(
		"salmon", EntityType.Builder.<SalmonEntity>method_5903(SalmonEntity::new, EntityCategory.field_6300).setSize(0.7F, 0.4F)
	);
	public static final EntityType<SheepEntity> SHEEP = register(
		"sheep", EntityType.Builder.<SheepEntity>method_5903(SheepEntity::new, EntityCategory.field_6294).setSize(0.9F, 1.3F)
	);
	public static final EntityType<ShulkerEntity> SHULKER = register(
		"shulker", EntityType.Builder.<ShulkerEntity>method_5903(ShulkerEntity::new, EntityCategory.field_6302).setSize(1.0F, 1.0F)
	);
	...
	public static final EntityType<SilverfishEntity> SILVERFISH = register(
		"silverfish", EntityType.Builder.<SilverfishEntity>method_5903(SilverfishEntity::new, EntityCategory.field_6302).setSize(0.4F, 0.3F)
	);
	public static final EntityType<SkeletonEntity> SKELETON = register(
		"skeleton", EntityType.Builder.<SkeletonEntity>method_5903(SkeletonEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.99F)
	);
	public static final EntityType<SkeletonHorseEntity> SKELETON_HORSE = register(
		"skeleton_horse", EntityType.Builder.<SkeletonHorseEntity>method_5903(SkeletonHorseEntity::new, EntityCategory.field_6294).setSize(1.3964844F, 1.6F)
	);
	public static final EntityType<SlimeEntity> SLIME = register(
		"slime", EntityType.Builder.<SlimeEntity>method_5903(SlimeEntity::new, EntityCategory.field_6302).setSize(2.04F, 2.04F)
	);
	...
	public static final EntityType<SnowmanEntity> SNOW_GOLEM = register(
		"snow_golem", EntityType.Builder.<SnowmanEntity>method_5903(SnowmanEntity::new, EntityCategory.field_6294).setSize(0.7F, 1.9F)
	);
	...
	public static final EntityType<SpiderEntity> SPIDER = register(
		"spider", EntityType.Builder.<SpiderEntity>method_5903(SpiderEntity::new, EntityCategory.field_6302).setSize(1.4F, 0.9F)
	);
	public static final EntityType<SquidEntity> SQUID = register(
		"squid", EntityType.Builder.<SquidEntity>method_5903(SquidEntity::new, EntityCategory.field_6300).setSize(0.8F, 0.8F)
	);
	public static final EntityType<StrayEntity> STRAY = register(
		"stray", EntityType.Builder.<StrayEntity>method_5903(StrayEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.99F)
	);
	public static final EntityType<TraderLlamaEntity> field_17714 = register(
		"trader_llama", EntityType.Builder.<TraderLlamaEntity>method_5903(TraderLlamaEntity::new, EntityCategory.field_6294).setSize(0.9F, 1.87F)
	);
	public static final EntityType<TropicalFishEntity> TROPICAL_FISH = register(
		"tropical_fish", EntityType.Builder.<TropicalFishEntity>method_5903(TropicalFishEntity::new, EntityCategory.field_6300).setSize(0.5F, 0.4F)
	);
	public static final EntityType<TurtleEntity> TURTLE = register(
		"turtle", EntityType.Builder.<TurtleEntity>method_5903(TurtleEntity::new, EntityCategory.field_6294).setSize(1.2F, 0.4F)
	);
	...
	public static final EntityType<VexEntity> VEX = register(
		"vex", EntityType.Builder.<VexEntity>method_5903(VexEntity::new, EntityCategory.field_6302).setSize(0.4F, 0.8F)
	);
	...
	public static final EntityType<IronGolemEntity> IRON_GOLEM = register(
		"iron_golem", EntityType.Builder.<IronGolemEntity>method_5903(IronGolemEntity::new, EntityCategory.field_6294).setSize(1.4F, 2.7F)
	);
	public static final EntityType<VindicatorEntity> VINDICATOR = register(
		"vindicator", EntityType.Builder.<VindicatorEntity>method_5903(VindicatorEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<PillagerEntity> PILLAGER = register(
		"pillager", EntityType.Builder.<PillagerEntity>method_5903(PillagerEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<WanderingTraderEntity> field_17713 = register(
		"wandering_trader", EntityType.Builder.<WanderingTraderEntity>method_5903(WanderingTraderEntity::new, EntityCategory.field_6294).setSize(0.6F, 1.95F)
	);
	public static final EntityType<WitchEntity> WITCH = register(
		"witch", EntityType.Builder.<WitchEntity>method_5903(WitchEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<WitherEntity> WITHER = register(
		"wither", EntityType.Builder.<WitherEntity>method_5903(WitherEntity::new, EntityCategory.field_6302).setSize(0.9F, 3.5F)
	);
	public static final EntityType<WitherSkeletonEntity> WITHER_SKELETON = register(
		"wither_skeleton", EntityType.Builder.<WitherSkeletonEntity>method_5903(WitherSkeletonEntity::new, EntityCategory.field_6302).setSize(0.7F, 2.4F)
	);
	...
	public static final EntityType<WolfEntity> WOLF = register(
		"wolf", EntityType.Builder.<WolfEntity>method_5903(WolfEntity::new, EntityCategory.field_6294).setSize(0.6F, 0.85F)
	);
	...
	public static final EntityType<ZombieHorseEntity> ZOMBIE_HORSE = register(
		"zombie_horse", EntityType.Builder.<ZombieHorseEntity>method_5903(ZombieHorseEntity::new, EntityCategory.field_6294).setSize(1.3964844F, 1.6F)
	);
	public static final EntityType<ZombieVillagerEntity> ZOMBIE_VILLAGER = register(
		"zombie_villager", EntityType.Builder.<ZombieVillagerEntity>method_5903(ZombieVillagerEntity::new, EntityCategory.field_6302).setSize(0.6F, 1.95F)
	);
	public static final EntityType<PhantomEntity> PHANTOM = register(
		"phantom", EntityType.Builder.<PhantomEntity>method_5903(PhantomEntity::new, EntityCategory.field_6302).setSize(0.9F, 0.5F)
	);
	public static final EntityType<RavagerEntity> RAVAGER = register(
		"ravager", EntityType.Builder.<RavagerEntity>method_5903(RavagerEntity::new, EntityCategory.field_6302).setSize(1.95F, 2.2F)
	);
