...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<BeeEntity> BEE = register(
		"bee", EntityType.Builder.<BeeEntity>create(BeeEntity::new, EntityCategory.CREATURE).setDimensions(0.7F, 0.7F)
	);
	...
	public static final EntityType<ShulkerEntity> SHULKER = register(
		"shulker", EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, EntityCategory.MONSTER).makeFireImmune().method_20815().setDimensions(1.0F, 1.0F)
	);
	...
	public static final EntityType<PillagerEntity> PILLAGER = register(
		"pillager", EntityType.Builder.<PillagerEntity>create(PillagerEntity::new, EntityCategory.MONSTER).method_20815().setDimensions(0.6F, 1.95F)
	);
