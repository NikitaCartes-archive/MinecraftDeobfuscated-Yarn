...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<AreaEffectCloudEntity> AREA_EFFECT_CLOUD = register(
		"area_effect_cloud",
		EntityType.Builder.<AreaEffectCloudEntity>create(AreaEffectCloudEntity::new, EntityCategory.field_17715).method_19947().setSize(6.0F, 0.5F)
	);
	...
	public static final EntityType<BlazeEntity> BLAZE = register(
		"blaze", EntityType.Builder.<BlazeEntity>create(BlazeEntity::new, EntityCategory.field_6302).method_19947().setSize(0.6F, 1.8F)
	);
	...
	public static final EntityType<EnderDragonEntity> ENDER_DRAGON = register(
		"ender_dragon", EntityType.Builder.<EnderDragonEntity>create(EnderDragonEntity::new, EntityCategory.field_6302).method_19947().setSize(16.0F, 8.0F)
	);
	...
	public static final EntityType<GhastEntity> GHAST = register(
		"ghast", EntityType.Builder.<GhastEntity>create(GhastEntity::new, EntityCategory.field_6302).method_19947().setSize(4.0F, 4.0F)
	);
	...
	public static final EntityType<MagmaCubeEntity> MAGMA_CUBE = register(
		"magma_cube", EntityType.Builder.<MagmaCubeEntity>create(MagmaCubeEntity::new, EntityCategory.field_6302).method_19947().setSize(2.04F, 2.04F)
	);
	...
	public static final EntityType<ZombiePigmanEntity> ZOMBIE_PIGMAN = register(
		"zombie_pigman", EntityType.Builder.<ZombiePigmanEntity>create(ZombiePigmanEntity::new, EntityCategory.field_6302).method_19947().setSize(0.6F, 1.95F)
	);
	...
	public static final EntityType<PrimedTntEntity> TNT = register(
		"tnt", EntityType.Builder.<PrimedTntEntity>create(PrimedTntEntity::new, EntityCategory.field_17715).method_19947().setSize(0.98F, 0.98F)
	);
	...
	public static final EntityType<ShulkerEntity> SHULKER = register(
		"shulker", EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, EntityCategory.field_6302).method_19947().setSize(1.0F, 1.0F)
	);
	...
	public static final EntityType<VexEntity> VEX = register(
		"vex", EntityType.Builder.<VexEntity>create(VexEntity::new, EntityCategory.field_6302).method_19947().setSize(0.4F, 0.8F)
	);
	...
	public static final EntityType<WitherEntity> WITHER = register(
		"wither", EntityType.Builder.<WitherEntity>create(WitherEntity::new, EntityCategory.field_6302).method_19947().setSize(0.9F, 3.5F)
	);
	public static final EntityType<WitherSkeletonEntity> WITHER_SKELETON = register(
		"wither_skeleton", EntityType.Builder.<WitherSkeletonEntity>create(WitherSkeletonEntity::new, EntityCategory.field_6302).method_19947().setSize(0.7F, 2.4F)
	);
	...
	public static class Builder<T extends Entity> {
		...
		public EntityType.Builder<T> method_19947() {
		...
		public EntityType<T> build(String string) {
			...
			return new EntityType<>(this.function, this.entityClass, this.saveable, this.summonable, this.field_18982, type, this.size);
		}
	}
