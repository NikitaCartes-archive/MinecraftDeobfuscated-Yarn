...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<ShulkerEntity> field_6109 = register(
		"shulker", EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, EntityCategory.field_6302).makeFireImmune().setDimensions(1.0F, 1.0F)
	);
	...
	public static final EntityType<PillagerEntity> field_6105 = register(
		"pillager", EntityType.Builder.<PillagerEntity>create(PillagerEntity::new, EntityCategory.field_6302).setDimensions(0.6F, 1.95F)
	);
