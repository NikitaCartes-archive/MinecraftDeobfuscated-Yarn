...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<BlazeEntity> field_6099 = register(
		"blaze", EntityType.Builder.<BlazeEntity>create(BlazeEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(0.6F, 1.8F)
	);
	...
	public static final EntityType<EnderDragonEntity> field_6116 = register(
		"ender_dragon", EntityType.Builder.<EnderDragonEntity>create(EnderDragonEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(16.0F, 8.0F)
	);
	...
	public static final EntityType<GhastEntity> field_6107 = register(
		"ghast", EntityType.Builder.<GhastEntity>create(GhastEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(4.0F, 4.0F)
	);
	...
	public static final EntityType<MagmaCubeEntity> field_6102 = register(
		"magma_cube", EntityType.Builder.<MagmaCubeEntity>create(MagmaCubeEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(2.04F, 2.04F)
	);
	...
	public static final EntityType<ZombiePigmanEntity> field_6050 = register(
		"zombie_pigman", EntityType.Builder.<ZombiePigmanEntity>create(ZombiePigmanEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(0.6F, 1.95F)
	);
	...
	public static final EntityType<ShulkerEntity> field_6109 = register(
		"shulker", EntityType.Builder.<ShulkerEntity>create(ShulkerEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(1.0F, 1.0F)
	);
	...
	public static final EntityType<SnowGolemEntity> field_6047 = register(
		"snow_golem", EntityType.Builder.<SnowGolemEntity>create(SnowGolemEntity::new, EntityCategory.field_17715).setSize(0.7F, 1.9F)
	);
	...
	public static final EntityType<VexEntity> field_6059 = register(
		"vex", EntityType.Builder.<VexEntity>create(VexEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(0.4F, 0.8F)
	);
	...
	public static final EntityType<IronGolemEntity> field_6147 = register(
		"iron_golem", EntityType.Builder.<IronGolemEntity>create(IronGolemEntity::new, EntityCategory.field_17715).setSize(1.4F, 2.7F)
	);
	...
	public static final EntityType<WitherEntity> field_6119 = register(
		"wither", EntityType.Builder.<WitherEntity>create(WitherEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(0.9F, 3.5F)
	);
	public static final EntityType<WitherSkeletonEntity> field_6076 = register(
		"wither_skeleton",
		EntityType.Builder.<WitherSkeletonEntity>create(WitherSkeletonEntity::new, EntityCategory.field_6302).makeFireImmune().setSize(0.7F, 2.4F)
	);
	...
	public Entity spawnFromItemStack(
		...
		return this.method_5899(
			...
			itemStack != null && itemStack.hasCustomName() ? itemStack.method_7964() : null,
			playerEntity,
			blockPos,
			spawnType,
			bl,
	...
	public Text method_5897() {
		if (this.field_6092 == null) {
			this.field_6092 = new TranslatableText(this.getTranslationKey());
		}
