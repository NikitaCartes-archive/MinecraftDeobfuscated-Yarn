...
public class EntityType<T extends Entity> {
	...
	public static final EntityType<BatEntity> BAT = register(
		"bat", EntityType.Builder.<BatEntity>create(BatEntity.class, BatEntity::new).method_17687(0.5F, 0.9F)
	);
	...
	public static final EntityType<CatEntity> CAT = register(
		"cat", EntityType.Builder.<CatEntity>create(CatEntity.class, CatEntity::new).method_17687(0.6F, 0.7F)
	);
	...
	public static final EntityType<CodEntity> COD = register(
		"cod", EntityType.Builder.<CodEntity>create(CodEntity.class, CodEntity::new).method_17687(0.5F, 0.3F)
	);
	public static final EntityType<CowEntity> COW = register(
		"cow", EntityType.Builder.<CowEntity>create(CowEntity.class, CowEntity::new).method_17687(0.9F, 1.4F)
	);
	...
	public static final EntityType<PigEntity> PIG = register(
		"pig", EntityType.Builder.<PigEntity>create(PigEntity.class, PigEntity::new).method_17687(0.9F, 0.9F)
	);
	...
	public static final EntityType<VexEntity> VEX = register(
		"vex", EntityType.Builder.<VexEntity>create(VexEntity.class, VexEntity::new).method_17687(0.4F, 0.8F)
	);
