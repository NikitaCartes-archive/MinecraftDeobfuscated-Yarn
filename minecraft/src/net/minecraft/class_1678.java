...
public class class_1678 extends class_1297 {
	...
	public class_1678(class_1299<? extends class_1678> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public class_1678(class_1937 arg, double d, double e, double f, double g, double h, double i) {
		this(class_1299.field_6100, arg);
	...
	private void method_7486(@Nullable class_2350.class_2351 arg) {
		...
		if (this.field_7626 == null) {
			...
			d = (double)this.field_7626.method_17682() * 0.5;
		...
		class_2350 lv2 = null;
		if (!lv.method_19769(this.method_19538(), 2.0)) {
			...
			if (!this.field_6002.field_9236) {
				if (this.field_7626 == null && this.field_7632 != null) {
					for(class_1309 lv : this.field_6002
						.method_18467(class_1309.class, new class_238(this.field_7631.method_10069(-2, -2, -2), this.field_7631.method_10069(2, 2, 2)))) {
				...
				if (this.field_7630 == null && this.field_7629 != null) {
					for(class_1309 lv : this.field_6002
						.method_18467(class_1309.class, new class_238(this.field_7634.method_10069(-2, -2, -2), this.field_7634.method_10069(2, 2, 2)))) {
						if (lv.method_5667().equals(this.field_7629)) {
							this.field_7630 = lv;
							break;
						}
					}
				...
				if (this.field_7626 == null || !this.field_7626.method_5805() || this.field_7626 instanceof class_1657 && ((class_1657)this.field_7626).method_7325()) {
					...
					this.method_18799(
						lv2.method_1031((this.field_7635 - lv2.field_1352) * 0.2, (this.field_7633 - lv2.field_1351) * 0.2, (this.field_7625 - lv2.field_1350) * 0.2)
					);
				}

				class_239 lv3 = class_1675.method_18076(this, true, false, this.field_7630, class_3959.class_3960.field_17558);
				if (lv3.method_17783() != class_239.class_240.field_1333) {
					this.method_7488(lv3);
				}
			}

			class_243 lv2 = this.method_18798();
			this.method_5814(this.field_5987 + lv2.field_1352, this.field_6010 + lv2.field_1351, this.field_6035 + lv2.field_1350);
			class_1675.method_7484(this, 0.5F);
			if (this.field_6002.field_9236) {
				this.field_6002
					.method_8406(
						class_2398.field_11207, this.field_5987 - lv2.field_1352, this.field_6010 - lv2.field_1351 + 0.15, this.field_6035 - lv2.field_1350, 0.0, 0.0, 0.0
					);
				...
				if (this.field_7628 != null) {
					class_2338 lv4 = new class_2338(this);
					class_2350.class_2351 lv5 = this.field_7628.method_10166();
					if (this.field_6002.method_8515(lv4.method_10093(this.field_7628), this)) {
						this.method_7486(lv5);
					} else {
						class_2338 lv6 = new class_2338(this.field_7626);
						if (lv5 == class_2350.class_2351.field_11048 && lv4.method_10263() == lv6.method_10263()
							|| lv5 == class_2350.class_2351.field_11051 && lv4.method_10260() == lv6.method_10260()
							|| lv5 == class_2350.class_2351.field_11052 && lv4.method_10264() == lv6.method_10264()) {
							this.method_7486(lv5);
						}
					}
				}
	...
	protected void method_7488(class_239 arg) {
		if (arg.method_17783() == class_239.class_240.field_1331) {
			...
			boolean bl = lv.method_5643(class_1282.method_5519(this, this.field_7630).method_5517(), 4.0F);
			if (bl) {
				this.method_5723(this.field_7630, lv);
				if (lv instanceof class_1309) {
					((class_1309)lv).method_6092(new class_1293(class_1294.field_5902, 200));
				}
			}
		} else {
