...
public final class BundleContentsComponent implements TooltipData {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			return this.occupancy == bundleContentsComponent.occupancy && ItemStack.stacksEqual(this.stacks, bundleContentsComponent.stacks);
		}
	}
	...
	public static class Builder {
		...
		public int add(ItemStack stack) {
			if (!stack.isEmpty() && stack.getItem().canBeNested()) {
				...
				if (i == 0) {
					...
					this.occupancy += BundleContentsComponent.getOccupancy(stack) * i;
		...
		public ItemStack removeFirst() {
			if (this.stacks.isEmpty()) {
				...
				this.occupancy -= BundleContentsComponent.getOccupancy(itemStack) * itemStack.getCount();
				return itemStack;
			}
		}
