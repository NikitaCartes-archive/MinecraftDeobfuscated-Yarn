...
public class class_1206 extends DataFix {
	private static final Map<String, String> field_5708 = ImmutableMap.<String, String>builder()
	...
	public class_1206(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		...
		if (!Objects.equals(type, this.getInputSchema().getType(class_1208.field_5711))) {
			...
			return this.fixTypeEverywhere("Recipes fix", type, dynamicOps -> pair -> pair.mapSecond(string -> (String)field_5708.getOrDefault(string, string)));
		}
	}
}
