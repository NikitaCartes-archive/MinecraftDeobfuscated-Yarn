...
public class class_1528 extends class_1588 implements class_1603 {
	...
	private final class_3213 field_7093 = (class_3213)new class_3213(this.method_5476(), class_1259.class_1260.field_5783, class_1259.class_1261.field_5795)
		.method_5406(true);
	private static final Predicate<class_1309> field_7086 = arg -> arg.method_6046() != class_1310.field_6289 && arg.method_6102();
	private static final class_4051 field_18125 = new class_4051().method_18418(20.0).method_18420(field_7086);

	public class_1528(class_1299<? extends class_1528> arg, class_1937 arg2) {
		super(arg, arg2);
	...
	public void method_6007() {
		class_243 lv = this.method_18798().method_18805(1.0, 0.6, 1.0);
		if (!this.field_6002.field_9236 && this.method_6882(0) > 0) {
			class_1297 lv2 = this.field_6002.method_8469(this.method_6882(0));
			if (lv2 != null) {
				double d = lv.field_1351;
				if (this.field_6010 < lv2.field_6010 || !this.method_6872() && this.field_6010 < lv2.field_6010 + 5.0) {
					d = Math.max(0.0, d);
					d += 0.3 - d * 0.6F;
				}

				lv = new class_243(lv.field_1352, d, lv.field_1350);
				class_243 lv3 = new class_243(lv2.field_5987 - this.field_5987, 0.0, lv2.field_6035 - this.field_6035);
				if (method_17996(lv3) > 9.0) {
					class_243 lv4 = lv3.method_1029();
					lv = lv.method_1031(lv4.field_1352 * 0.3 - lv.field_1352 * 0.6, 0.0, lv4.field_1350 * 0.3 - lv.field_1350 * 0.6);
				}
			}
		}

		this.method_18799(lv);
		if (method_17996(lv) > 0.05) {
			this.field_6031 = (float)class_3532.method_15349(lv.field_1350, lv.field_1352) * (180.0F / (float)Math.PI) - 90.0F;
		}
		...
		for(int i = 0; i < 2; ++i) {
			...
			class_1297 lv5 = null;
			if (j > 0) {
				lv5 = this.field_6002.method_8469(j);
			}
			...
			if (lv5 != null) {
				...
				double h = lv5.field_5987 - e;
				double k = lv5.field_6010 + (double)lv5.method_5751() - f;
				double l = lv5.field_6035 - g;
		...
		for(int j = 0; j < 3; ++j) {
			double p = this.method_6874(j);
			double q = this.method_6880(j);
			double r = this.method_6881(j);
			this.field_6002
				.method_8406(
	...
	protected void method_5958() {
		if (this.method_6884() > 0) {
			...
			if (i <= 0) {
				class_1927.class_4179 lv = this.field_6002.method_8450().method_8355(class_1928.field_19388)
					? class_1927.class_4179.field_18687
					: class_1927.class_4179.field_18685;
				this.field_6002.method_8537(this, this.field_5987, this.field_6010 + (double)this.method_5751(), this.field_6035, 7.0F, false, lv);
			...
			for(int i = 1; i < 3; ++i) {
				if (this.field_6012 >= this.field_7091[i - 1]) {
					this.field_7091[i - 1] = this.field_6012 + 10 + this.field_5974.nextInt(10);
					if ((this.field_6002.method_8407() == class_1267.field_5802 || this.field_6002.method_8407() == class_1267.field_5807) && this.field_7092[i - 1]++ > 15) {
						float f = 10.0F;
						float g = 5.0F;
					...
					int j = this.method_6882(i);
					if (j > 0) {
						class_1297 lv2 = this.field_6002.method_8469(j);
						if (lv2 == null || !lv2.method_5805() || this.method_5858(lv2) > 900.0 || !this.method_6057(lv2)) {
							this.method_6876(i, 0);
						} else if (lv2 instanceof class_1657 && ((class_1657)lv2).field_7503.field_7480) {
							this.method_6876(i, 0);
						} else {
							this.method_6878(i + 1, (class_1309)lv2);
							this.field_7091[i - 1] = this.field_6012 + 40 + this.field_5974.nextInt(20);
							this.field_7092[i - 1] = 0;
						}
					} else {
						List<class_1309> list = this.field_6002.method_18466(class_1309.class, field_18125, this, this.method_5829().method_1009(20.0, 8.0, 20.0));

						for(int k = 0; k < 10 && !list.isEmpty(); ++k) {
							class_1309 lv3 = (class_1309)list.get(this.field_5974.nextInt(list.size()));
							if (lv3 != this && lv3.method_5805() && this.method_6057(lv3)) {
								if (lv3 instanceof class_1657) {
									if (!((class_1657)lv3).field_7503.field_7480) {
										this.method_6876(i, lv3.method_5628());
									}
								} else {
									this.method_6876(i, lv3.method_5628());
								}
			...
			if (this.field_7082 > 0) {
				--this.field_7082;
				if (this.field_7082 == 0 && this.field_6002.method_8450().method_8355(class_1928.field_19388)) {
					int i = class_3532.method_15357(this.field_6010);
					...
					for(int m = -1; m <= 1; ++m) {
						for(int n = -1; n <= 1; ++n) {
							for(int o = 0; o <= 3; ++o) {
								...
								int q = i + o;
								int r = l + n;
								class_2338 lv4 = new class_2338(p, q, r);
								class_2680 lv5 = this.field_6002.method_8320(lv4);
								if (method_6883(lv5)) {
									bl = this.field_6002.method_8651(lv4, true) || bl;
								}
							}
						}
					}
	...
	public static boolean method_6883(class_2680 arg) {
		return !arg.method_11588() && !class_3481.field_17754.method_15141(arg.method_11614());
	}
	...
	public int method_6882(int i) {
		return this.field_6011.method_12789((class_2940)field_7087.get(i));
	}

	public void method_6876(int i, int j) {
		this.field_6011.method_12778((class_2940)field_7087.get(i), j);
	}
