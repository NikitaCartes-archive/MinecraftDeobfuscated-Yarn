...
public abstract class class_3096<T extends class_3037> extends class_2944<T> {
	...
	protected void method_13528(class_3747 arg, class_2338 arg2, int i, class_3341 arg3, Set<class_2338> set) {
		int j = i * i;
			...
			for (int l = -i; l <= i + 1; l++) {
				...
				if (m + n < 7 && m * m + n * n <= j) {
					...
					if (method_16420(arg, lv)) {
						this.method_12773(set, arg, lv, this.field_13684, arg3);
					}
				}
			}
		}
	...
	protected void method_13526(class_3747 arg, class_2338 arg2, int i, class_3341 arg3, Set<class_2338> set) {
		int j = i * i;
