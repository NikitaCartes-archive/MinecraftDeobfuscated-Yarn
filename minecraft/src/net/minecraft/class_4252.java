...
public class class_4252 extends class_4097<class_1309> {
	...
	public class_4252(int i, int j) {
		super(ImmutableMap.of(class_4140.field_19008, class_4141.field_18456, class_4140.field_19009, class_4141.field_18456));
	...
	protected void method_18920(class_3218 arg, class_1309 arg2, long l) {
		...
		Optional<Long> optional = lv.method_18904(class_4140.field_19009);
		boolean bl = optional.get() + 300L <= l;
		if (this.field_19001 <= this.field_19000 && !bl) {
			class_2338 lv2 = ((class_4208)lv.method_18904(class_4140.field_19008).get()).method_19446();
