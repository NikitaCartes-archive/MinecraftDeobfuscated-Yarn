...
public class class_3900 implements AutoCloseable, class_3193.class_3896 {
	...
	public class_3900(List<class_3906<?>> list, Executor executor, int i) {
		this.field_17249 = (Map)list.stream().collect(Collectors.toMap(Function.identity(), arg -> new class_3899(arg.method_16898() + "_queue", i)));
						...
						() -> {
							...
							arg2.method_16901(
								class_3906.method_17344(
									"chunk priority sorter around " + arg.method_16898(),
									arg2xx -> this.method_17282(arg, arg2xx.field_17446, arg2xx.field_17447, arg2xx.field_17448, bl)
								)
							);
						}
					)
	...
	private <T> class_3899<Function<class_3906<class_3902>, T>> method_17632(class_3906<T> arg) {
		class_3899<? extends Function<class_3906<class_3902>, ?>> lv = (class_3899)this.field_17249.get(arg);
		if (lv == null) {
