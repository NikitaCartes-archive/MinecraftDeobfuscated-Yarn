...
public class class_508 extends class_332 implements class_364 {
	...
	public void method_2617(class_310 arg, class_516 arg2, int i, int j, int k, int l, float f) {
		...
		if (arg.field_1724.field_7512 instanceof class_3858) {
	...
	private void method_2618(int i, int j, int k, int l, int m, int n) {
		this.method_1788(this.field_3105, this.field_3103, m, n, l, l);
		this.method_1788(this.field_3105 + l * 2 + i * k, this.field_3103, m + k + l, n, l, l);
		this.method_1788(this.field_3105, this.field_3103 + l * 2 + j * k, m, n + k + l, l, l);
		this.method_1788(this.field_3105 + l * 2 + i * k, this.field_3103 + l * 2 + j * k, m + k + l, n + k + l, l, l);

		for(int o = 0; o < i; ++o) {
			this.method_1788(this.field_3105 + l + o * k, this.field_3103, m + l, n, k, l);
			this.method_1788(this.field_3105 + l + (o + 1) * k, this.field_3103, m + l, n, l, l);

			for(int p = 0; p < j; ++p) {
				if (o == 0) {
					this.method_1788(this.field_3105, this.field_3103 + l + p * k, m, n + l, l, k);
					this.method_1788(this.field_3105, this.field_3103 + l + (p + 1) * k, m, n + l, l, l);
				}

				this.method_1788(this.field_3105 + l + o * k, this.field_3103 + l + p * k, m + l, n + l, k, k);
				this.method_1788(this.field_3105 + l + (o + 1) * k, this.field_3103 + l + p * k, m + l, n + l, l, k);
				this.method_1788(this.field_3105 + l + o * k, this.field_3103 + l + (p + 1) * k, m + l, n + l, k, l);
				this.method_1788(this.field_3105 + l + (o + 1) * k - 1, this.field_3103 + l + (p + 1) * k - 1, m + l, n + l, l + 1, l + 1);
				if (o == i - 1) {
					this.method_1788(this.field_3105 + l * 2 + i * k, this.field_3103 + l + p * k, m + k + l, n + l, l, k);
					this.method_1788(this.field_3105 + l * 2 + i * k, this.field_3103 + l + (p + 1) * k, m + k + l, n + l, l, l);
				}
			}

			this.method_1788(this.field_3105 + l + o * k, this.field_3103 + l * 2 + j * k, m + l, n + k + l, k, l);
			this.method_1788(this.field_3105 + l + (o + 1) * k, this.field_3103 + l * 2 + j * k, m + l, n + k + l, l, l);
		}
	}
	...
	class class_509 extends class_339 implements class_2952<class_1856> {
		...
		public void method_1824(int i, int j, float f) {
			...
			for(class_508.class_509.class_510 lv : this.field_3116) {
				GlStateManager.pushMatrix();
				float g = 0.42F;
				int m = (int)((float)(this.field_2069 + lv.field_3119) / 0.42F - 3.0F);
				int n = (int)((float)(this.field_2068 + lv.field_3118) / 0.42F - 3.0F);
				GlStateManager.scalef(0.42F, 0.42F, 1.0F);
				GlStateManager.enableLighting();
				class_508.this.field_3108
					.method_1480()
					.method_4023(lv.field_3120[class_3532.method_15375(class_508.this.field_3110 / 30.0F) % lv.field_3120.length], m, n);
