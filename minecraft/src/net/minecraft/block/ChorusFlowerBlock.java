...
public class ChorusFlowerBlock extends Block {
			...
			if (world.isAir(blockPos2) && blockPos2.getY() < 256) {
				...
				if (i < 5) {
					...
					if (bl && method_9746(world, blockPos2, null) && world.isAir(blockPos.up(2))) {
						world.setBlockState(blockPos, this.plantBlock.method_9759(world, blockPos), 2);
	...
	public static void method_9744(IWorld iWorld, BlockPos blockPos, Random random, int i) {
		iWorld.setBlockState(blockPos, ((ChorusPlantBlock)Blocks.field_10021).method_9759(iWorld, blockPos), 2);
	...
	private static void method_9748(IWorld iWorld, BlockPos blockPos, Random random, BlockPos blockPos2, int i, int j) {
		...
		for (int l = 0; l < k; l++) {
			...
			iWorld.setBlockState(blockPos3, chorusPlantBlock.method_9759(iWorld, blockPos3), 2);
			iWorld.setBlockState(blockPos3.down(), chorusPlantBlock.method_9759(iWorld, blockPos3.down()), 2);
		}
