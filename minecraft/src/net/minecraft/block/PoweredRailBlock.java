...
public class PoweredRailBlock extends AbstractRailBlock {
	...
	protected boolean method_10413(World world, BlockPos blockPos, BlockState blockState, boolean bl, int i) {
		if (i >= 8) {
			...
			if (this.method_10414(world, new BlockPos(j, k, l), bl, i, railShape)) {
				return true;
			} else {
				return bl2 && this.method_10414(world, new BlockPos(j, k - 1, l), bl, i, railShape);
			}
		}
	}
			...
			if (railShape != RailShape.field_12674 || railShape2 != RailShape.field_12665 && railShape2 != RailShape.field_12670 && railShape2 != RailShape.field_12668
				)
			 {
				if (railShape != RailShape.field_12665
					|| railShape2 != RailShape.field_12674 && railShape2 != RailShape.field_12667 && railShape2 != RailShape.field_12666) {
					if (!blockState.method_11654(field_11364)) {
						return false;
					} else {
						return world.method_8479(blockPos) ? true : this.method_10413(world, blockPos, blockState, bl, i + 1);
					}
				} else {
					return false;
				}
	...
	protected void method_9477(BlockState blockState, World world, BlockPos blockPos, Block block) {
		boolean bl = blockState.method_11654(field_11364);
		boolean bl2 = world.method_8479(blockPos)
