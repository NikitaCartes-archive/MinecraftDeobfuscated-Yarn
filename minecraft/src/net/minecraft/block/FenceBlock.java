	...
	public BlockState getPlacementState(ItemPlacementContext itemPlacementContext) {
		...
		return super.getPlacementState(itemPlacementContext)
			.with(
				NORTH,
				Boolean.valueOf(
					this.method_10184(blockState, Block.isFaceFullSquare(blockState.getCollisionShape(blockView, blockPos2), Direction.SOUTH), Direction.SOUTH)
				)
			)
			.with(
				EAST,
				Boolean.valueOf(
					this.method_10184(blockState2, Block.isFaceFullSquare(blockState2.getCollisionShape(blockView, blockPos3), Direction.WEST), Direction.WEST)
				)
			)
			.with(
				SOUTH,
			...
			.with(
				WEST,
				Boolean.valueOf(
					this.method_10184(blockState4, Block.isFaceFullSquare(blockState4.getCollisionShape(blockView, blockPos5), Direction.EAST), Direction.EAST)
				)
			)
