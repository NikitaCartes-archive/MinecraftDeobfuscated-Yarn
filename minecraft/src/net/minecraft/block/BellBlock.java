...
public class BellBlock extends BlockWithEntity {
	...
	public boolean activate(
		...
		if (blockEntity instanceof BellBlockEntity && this.method_17028(blockState, direction, g)) {
	...
	private boolean method_17028(BlockState blockState, Direction direction, float f) {
		if (direction.getAxis() != Direction.Axis.Y && !(f > 0.8124F)) {
