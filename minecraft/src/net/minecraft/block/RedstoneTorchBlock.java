...
public class RedstoneTorchBlock extends TorchBlock {
	...
	private static final Map<BlockView, List<RedstoneTorchBlock.class_2460>> field_11445 = Maps.newHashMap();
	...
	public static void method_10490(BlockState blockState, World world, BlockPos blockPos, Random random, boolean bl) {
		List<RedstoneTorchBlock.class_2460> list = (List)field_11445.get(world);
	...
	public void method_9612(BlockState blockState, World world, BlockPos blockPos, Block block, BlockPos blockPos2) {
		if (blockState.method_11654(field_11446) == this.method_10488(world, blockPos, blockState) && !world.method_8397().method_8677(blockPos, this)) {
