...
public class CocoaBlock extends HorizontalFacingBlock implements Fertilizable {
	...
	public void scheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (world.random.nextInt(5) == 0) {
			int i = blockState.get(field_10779);
			if (i < 2) {
	...
	public boolean isFertilizable(BlockView blockView, BlockPos blockPos, BlockState blockState, boolean bl) {
		return blockState.get(field_10779) < 2;
	}
	...
	public void grow(World world, Random random, BlockPos blockPos, BlockState blockState) {
		world.setBlockState(blockPos, blockState.with(field_10779, Integer.valueOf(blockState.get(field_10779) + 1)), 2);
	}
