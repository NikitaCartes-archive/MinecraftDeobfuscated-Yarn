...
public class PistonHeadBlock extends FacingBlock {
	...
	private VoxelShape method_11519(BlockState blockState) {
		boolean bl = blockState.get(field_12227);
		switch((Direction)blockState.get(field_10927)) {
			case DOWN:
			default:
	...
	public void onBlockRemoved(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2, boolean bl) {
		if (blockState.getBlock() != blockState2.getBlock()) {
			...
			if ((blockState3.getBlock() == Blocks.field_10560 || blockState3.getBlock() == Blocks.field_10615) && blockState3.get(PistonBlock.field_12191)) {
