...
public class SweetBerryBushBlock extends PlantBlock implements Fertilizable {
	public static final IntegerProperty field_17000 = Properties.field_12497;
	...
	public VoxelShape method_9530(BlockState blockState, BlockView blockView, BlockPos blockPos, VerticalEntityPosition verticalEntityPosition) {
		if (blockState.method_11654(field_17000) == 0) {
			return field_17001;
		} else {
			return blockState.method_11654(field_17000) < 3 ? field_17002 : super.method_9530(blockState, blockView, blockPos, verticalEntityPosition);
		}
	}
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		...
		int i = blockState.method_11654(field_17000);
	...
	public void method_9548(BlockState blockState, World world, BlockPos blockPos, Entity entity) {
		if (entity instanceof LivingEntity && entity.method_5864() != EntityType.field_17943) {
			entity.method_5844(blockState, new Vec3d(0.8F, 0.75, 0.8F));
			if (!world.isClient && blockState.method_11654(field_17000) > 0 && (entity.prevRenderX != entity.x || entity.prevRenderZ != entity.z)) {
	...
	public boolean method_9534(BlockState blockState, World world, BlockPos blockPos, PlayerEntity playerEntity, Hand hand, BlockHitResult blockHitResult) {
		int i = blockState.method_11654(field_17000);
		boolean bl = i == 3;
		if (!bl && playerEntity.method_5998(hand).getItem() == Items.field_8324) {
			return false;
		} else if (i > 1) {
			int j = 1 + world.random.nextInt(2);
			method_9577(world, blockPos, new ItemStack(Items.field_16998, j + (bl ? 1 : 0)));
			world.method_8396(null, blockPos, SoundEvents.field_17617, SoundCategory.field_15245, 1.0F, 0.8F + world.random.nextFloat() * 0.4F);
	...
	public boolean method_9651(BlockView blockView, BlockPos blockPos, BlockState blockState, boolean bl) {
		return blockState.method_11654(field_17000) < 3;
	}
	...
	public void method_9652(World world, Random random, BlockPos blockPos, BlockState blockState) {
		int i = Math.min(3, blockState.method_11654(field_17000) + 1);
