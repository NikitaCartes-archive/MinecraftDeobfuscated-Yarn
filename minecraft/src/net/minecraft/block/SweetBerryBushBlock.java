...
public class SweetBerryBushBlock extends PlantBlock implements Fertilizable {
	...
	public VoxelShape getOutlineShape(BlockState blockState, BlockView blockView, BlockPos blockPos, EntityContext entityContext) {
		if (blockState.get(field_17000) == 0) {
			return SMALL_SHAPE;
		} else {
	...
	public void onScheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		...
		int i = blockState.get(field_17000);
	...
	public void onEntityCollision(BlockState blockState, World world, BlockPos blockPos, Entity entity) {
		if (entity instanceof LivingEntity && entity.getType() != EntityType.field_17943) {
			...
			if (!world.isClient && blockState.get(field_17000) > 0 && (entity.prevRenderX != entity.x || entity.prevRenderZ != entity.z)) {
	...
	public boolean isFertilizable(BlockView blockView, BlockPos blockPos, BlockState blockState, boolean bl) {
		return blockState.get(field_17000) < 3;
	}
	...
	public void grow(World world, Random random, BlockPos blockPos, BlockState blockState) {
		int i = Math.min(3, blockState.get(field_17000) + 1);
