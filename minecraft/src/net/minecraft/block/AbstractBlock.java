...
public abstract class AbstractBlock {
	...
	public abstract static class AbstractBlockState extends AbstractState<Block, BlockState> implements State<BlockState> {
		...
		public MaterialColor getTopMaterialColor(BlockView world, BlockPos pos) {
			return (MaterialColor)this.materialColor.apply(this.asBlockState());
		}
		...
		public void onBlockRemoved(World world, BlockPos pos, BlockState state, boolean notify) {
			this.getBlock().onBlockRemoved(this.asBlockState(), world, pos, state, notify);
		}
	...
	public static class Settings {
		...
		private AbstractBlock.ContextPredicate inWallOverlayPredicate = (state, world, pos) -> false;
		...
		public AbstractBlock.Settings inWallOverlay(AbstractBlock.ContextPredicate predicate) {
