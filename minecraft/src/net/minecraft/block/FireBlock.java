...
public class FireBlock extends Block {
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		return this.method_10198(itemPlacementContext.method_8045(), itemPlacementContext.getBlockPos());
	}
	...
	public BlockState method_10198(BlockView blockView, BlockPos blockPos) {
		...
		if (!this.method_10195(blockState) && !Block.method_20045(blockState, blockView, blockPos2, Direction.field_11036)) {
			...
			for(Direction direction : Direction.values()) {
				...
				if (booleanProperty != null) {
					blockState2 = blockState2.method_11657(booleanProperty, Boolean.valueOf(this.method_10195(blockView.method_8320(blockPos.offset(direction)))));
				}
			}
	...
	public boolean method_9558(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		BlockPos blockPos2 = blockPos.down();
		return Block.method_20045(viewableWorld.method_8320(blockPos2), viewableWorld, blockPos2, Direction.field_11036)
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (world.getGameRules().getBoolean(GameRules.field_19387)) {
			...
			int i = blockState.method_11654(field_11092);
			if (!bl && world.isRaining() && this.isRainingAround(world, blockPos) && random.nextFloat() < 0.2F + (float)i * 0.03F) {
				...
				if (!bl) {
					world.method_8397().schedule(blockPos, this, this.getTickRate(world) + random.nextInt(10));
					if (!this.areBlocksAroundFlammable(world, blockPos)) {
						BlockPos blockPos2 = blockPos.down();
						if (!Block.method_20045(world.method_8320(blockPos2), world, blockPos2, Direction.field_11036) || i > 3) {
							world.clearBlockState(blockPos, false);
						}
	...
	private boolean areBlocksAroundFlammable(BlockView blockView, BlockPos blockPos) {
		for(Direction direction : Direction.values()) {
			if (this.method_10195(blockView.method_8320(blockPos.offset(direction)))) {
				return true;
			}
		}
	...
	private int getBurnChance(ViewableWorld viewableWorld, BlockPos blockPos) {
		if (!viewableWorld.isAir(blockPos)) {
			...
			for(Direction direction : Direction.values()) {
				BlockState blockState = viewableWorld.method_8320(blockPos.offset(direction));
		...
		if (blockState2.getBlock() != blockState.getBlock()) {
			if (world.field_9247.method_12460() != DimensionType.field_13072 && world.field_9247.method_12460() != DimensionType.field_13076
				...
				if (!blockState.canPlaceAt(world, blockPos)) {
					...
					world.method_8397().schedule(blockPos, this, this.getTickRate(world) + world.random.nextInt(10));
				}
			}
		}
	}
	...
	public void method_9496(BlockState blockState, World world, BlockPos blockPos, Random random) {
		...
		if (!this.method_10195(blockState2) && !Block.method_20045(blockState2, world, blockPos2, Direction.field_11036)) {
