...
public class PistonBlock extends FacingBlock {
	...
	public PistonBlock(boolean bl, Block.Settings settings) {
		super(settings);
		this.method_9590(this.field_10647.method_11664().method_11657(field_10927, Direction.NORTH).method_11657(field_12191, Boolean.valueOf(false)));
		this.isSticky = bl;
	}

	@Override
	public boolean method_16362(BlockState blockState, BlockView blockView, BlockPos blockPos) {
		return !blockState.method_11654(field_12191);
	}

	@Override
	public VoxelShape method_9530(BlockState blockState, BlockView blockView, BlockPos blockPos, VerticalEntityPosition verticalEntityPosition) {
		if (blockState.method_11654(field_12191)) {
	...
	public boolean method_9561(BlockState blockState, BlockView blockView, BlockPos blockPos) {
		return !blockState.method_11654(field_12191) || blockState.method_11654(field_10927) == Direction.DOWN;
	}
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		return this.method_9564().method_11657(field_10927, itemPlacementContext.method_7715().getOpposite()).method_11657(field_12191, Boolean.valueOf(false));
	}
	...
	public boolean method_9592(BlockState blockState, World world, BlockPos blockPos, int i, int j) {
		...
		if (i == 0) {
			...
			world.method_8396(null, blockPos, SoundEvents.field_15134, SoundCategory.field_15245, 0.5F, world.random.nextFloat() * 0.25F + 0.6F);
		} else if (i == 1 || i == 2) {
			BlockEntity blockEntity = world.method_8321(blockPos.method_10093(direction));
			if (blockEntity instanceof PistonBlockEntity) {
			...
			if (this.isSticky) {
				...
				if (!bl2) {
					if (i != 1
						...
						world.method_8650(blockPos.method_10093(direction));
					} else {
			...
			world.method_8396(null, blockPos, SoundEvents.field_15228, SoundCategory.field_15245, 0.5F, world.random.nextFloat() * 0.15F + 0.6F);
		}
	...
	public static boolean method_11484(BlockState blockState, World world, BlockPos blockPos, Direction direction, boolean bl, Direction direction2) {
		...
		if (block == Blocks.field_10540) {
			return false;
		} else if (!world.method_8621().method_11952(blockPos)) {
			return false;
			...
			if (blockPos.getY() <= world.getHeight() - 1 && (direction != Direction.UP || blockPos.getY() != world.getHeight() - 1)) {
				if (block != Blocks.field_10560 && block != Blocks.field_10615) {
					if (blockState.method_11579(world, blockPos) == -1.0F) {
						return false;
					}
				...
				} else if (blockState.method_11654(field_12191)) {
					return false;
				}
