...
public class TurtleEggBlock extends Block {
	...
	private boolean isSand(BlockView world, BlockPos pos) {
		return world.getBlockState(pos.method_10074()).getBlock() == Blocks.SAND;
	}
	...
	public BlockState getPlacementState(ItemPlacementContext ctx) {
		...
		return blockState.getBlock() == this ? blockState.with(EGGS, Integer.valueOf(Math.min(4, blockState.get(EGGS) + 1))) : super.getPlacementState(ctx);
	}
