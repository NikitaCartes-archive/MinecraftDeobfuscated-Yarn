...
public class MushroomPlantBlock extends PlantBlock implements Fertilizable {
	...
	public boolean method_9558(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		...
		if (block != Blocks.field_10402 && block != Blocks.field_10520) {
			return viewableWorld.getLightLevel(blockPos, 0) < 13 && this.method_9695(blockState2, viewableWorld, blockPos2);
		} else {
			return true;
		}
	}
	...
	public boolean method_10349(IWorld iWorld, BlockPos blockPos, BlockState blockState, Random random) {
		...
		if (feature != null && feature.method_13151(iWorld, iWorld.method_8398().getChunkGenerator(), random, blockPos, new PlantedFeatureConfig(true))) {
			return true;
		} else {
