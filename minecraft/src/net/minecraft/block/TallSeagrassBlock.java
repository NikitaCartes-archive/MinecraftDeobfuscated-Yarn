...
public class TallSeagrassBlock extends ReplaceableTallPlantBlock implements FluidFillable {
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		...
		if (blockState != null) {
			FluidState fluidState = itemPlacementContext.method_8045().method_8316(itemPlacementContext.getBlockPos().up());
	...
	public boolean method_9558(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		if (blockState.method_11654(field_11616) == DoubleBlockHalf.field_12609) {
			...
			return super.method_9558(blockState, viewableWorld, blockPos) && fluidState.matches(FluidTags.field_15517) && fluidState.getLevel() == 8;
		}
	}
