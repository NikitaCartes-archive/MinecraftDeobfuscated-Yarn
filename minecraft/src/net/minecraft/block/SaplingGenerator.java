...
public final class SaplingGenerator {
	...
	public boolean generate(ServerWorld world, ChunkGenerator chunkGenerator, BlockPos pos, BlockState state, Random random) {
		...
		if (registryKey != null) {
			RegistryEntry<ConfiguredFeature<?, ?>> registryEntry = (RegistryEntry)world.getRegistryManager()
		...
		if (registryKey2 == null) {
			...
			RegistryEntry<ConfiguredFeature<?, ?>> registryEntry2 = (RegistryEntry)world.getRegistryManager()
				.get(RegistryKeys.CONFIGURED_FEATURE)
