...
public class WitherSkullBlock extends SkullBlock {
	...
	public static boolean canDispense(World world, BlockPos blockPos, ItemStack itemStack) {
		if (itemStack.getItem() == Items.WITHER_SKELETON_SKULL && blockPos.getY() >= 2 && world.getDifficulty() != Difficulty.field_5801 && !world.isClient) {
			return method_10897().searchAround(world, blockPos) != null;
		} else {
			return false;
		}
	}
