...
public class ObserverBlock extends FacingBlock {
	...
	public BlockState getStateForNeighborUpdate(
		...
		if (blockState.get(field_10927) == direction && !blockState.get(field_11322)) {
	...
	public void onBlockAdded(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2) {
		if (blockState.getBlock() != blockState2.getBlock()) {
			if (!world.isClient() && blockState.get(field_11322) && !world.getBlockTickScheduler().isScheduled(blockPos, this)) {
