...
public class CampfireBlock extends BlockWithEntity implements Waterloggable {
	...
	public boolean method_9534(BlockState blockState, World world, BlockPos blockPos, PlayerEntity playerEntity, Hand hand, BlockHitResult blockHitResult) {
		if (blockState.method_11654(field_17352)) {
	...
	public void method_9548(BlockState blockState, World world, BlockPos blockPos, Entity entity) {
		if (!entity.isFireImmune()
			&& blockState.method_11654(field_17352)
	...
	public BlockState method_9559(BlockState blockState, Direction direction, BlockState blockState2, IWorld iWorld, BlockPos blockPos, BlockPos blockPos2) {
		if (blockState.method_11654(field_17354)) {
	...
	public boolean method_10311(IWorld iWorld, BlockPos blockPos, BlockState blockState, FluidState fluidState) {
		if (!blockState.method_11654(Properties.field_12508) && fluidState.getFluid() == Fluids.WATER) {
			boolean bl = blockState.method_11654(field_17352);
			if (bl) {
				if (iWorld.isClient()) {
					for(int i = 0; i < 20; ++i) {
						spawnSmokeParticle(iWorld.getWorld(), blockPos, blockState.method_11654(field_17353), true);
					}
				} else {
	...
	public void method_19286(World world, BlockState blockState, BlockHitResult blockHitResult, Entity entity) {
		if (!world.isClient && entity instanceof ProjectileEntity) {
			...
			if (projectileEntity.isOnFire() && !blockState.method_11654(field_17352) && !blockState.method_11654(field_17354)) {
