	...
	static void registerDefaults() {
			...
			public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
				...
				try {
					entityType.spawnFromItemStack(
						pointer.getWorld(), stack, null, pointer.getPos().offset(direction), SpawnReason.DISPENSER, direction != Direction.UP, false
					);
		...
		DispenserBlock.registerBehavior(Items.FIRE_CHARGE, new ItemDispenserBehavior() {
			...
			public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
				...
				double g = abstractRandom.nextPredictable((double)direction.getOffsetX(), 0.11485000000000001);
				double h = abstractRandom.nextPredictable((double)direction.getOffsetY(), 0.11485000000000001);
				double i = abstractRandom.nextPredictable((double)direction.getOffsetZ(), 0.11485000000000001);
