...
public class CampfireBlockEntity extends BlockEntity implements Clearable, Tickable {
	...
	@Override
	public void tick() {
		boolean bl = this.method_11010().method_11654(CampfireBlock.field_17352);
		...
		if (world != null) {
			...
			if (random.nextFloat() < 0.11F) {
				for(int i = 0; i < random.nextInt(2) + 2; ++i) {
					CampfireBlock.spawnSmokeParticle(world, blockPos, this.method_11010().method_11654(CampfireBlock.field_17353), false);
				}
			}
