...
public class SculkSpreadManager {
		...
		if (!this.cursors.isEmpty()) {
			...
			for(int i = 0; i < this.cursors.size(); ++i) {
				...
				if (cursor.charge <= 0) {
					...
					hashMap2.put(blockPos, hashMap2.getOrDefault(blockPos, 0) + cursor.charge);
	...
	public static class Cursor {
		...
		private class_6989 method_40811(BlockState blockState) {
			...
			return var3 instanceof class_6989 lv ? lv : class_6989.field_36845;
		}
