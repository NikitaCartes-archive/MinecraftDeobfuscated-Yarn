...
public class EndGatewayBlockEntity extends EndPortalBlockEntity implements Tickable {
	...
	private void createPortal() {
		...
		if (this.exitPortalPos == null) {
			...
			Feature.field_13574
				.method_13151(
					this.world, this.world.method_8398().getChunkGenerator(), new Random(this.exitPortalPos.asLong()), this.exitPortalPos, FeatureConfig.field_13603
				);
		} else {
	...
	private void createPortal(BlockPos blockPos) {
		Feature.field_13564
			.method_13151(this.world, this.world.method_8398().getChunkGenerator(), new Random(), blockPos, EndGatewayFeatureConfig.createConfig(this.getPos(), false));
	}
