...
public class EndGatewayBlockEntity extends EndPortalBlockEntity implements Tickable {
	...
	private void createPortal() {
		...
		if (this.field_12132 == null) {
			...
			Feature.field_13574
				.method_13151(this.world, this.world.method_8398().getChunkGenerator(), new Random(this.field_12132.asLong()), this.field_12132, FeatureConfig.field_13603);
		} else {
	...
	private void method_11416(BlockPos blockPos) {
		Feature.field_13564
			.method_13151(
				this.world, this.world.method_8398().getChunkGenerator(), new Random(), blockPos, EndGatewayFeatureConfig.method_18034(this.method_11016(), false)
			);
	}
