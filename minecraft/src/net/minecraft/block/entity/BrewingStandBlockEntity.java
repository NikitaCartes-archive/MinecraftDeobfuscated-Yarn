...
public class BrewingStandBlockEntity extends LockableContainerBlockEntity implements SidedInventory, Tickable {
	...
	public boolean isValidInvStack(int i, ItemStack itemStack) {
		if (i == 3) {
			...
			if (i == 4) {
				...
				return (item == Items.field_8574 || item == Items.field_8436 || item == Items.field_8150 || item == Items.field_8469) && this.getInvStack(i).isEmpty();
			}
		}
	}
	...
	public boolean canExtractInvStack(int i, ItemStack itemStack, Direction direction) {
		if (i == 3) {
			return itemStack.getItem() == Items.field_8469;
		} else {
			return true;
		}
	}
