...
public class ShulkerBoxBlockEntity extends LootableContainerBlockEntity implements SidedInventory, Tickable {
	...
	public Container createContainer(PlayerInventory playerInventory, PlayerEntity playerEntity) {
		return new ShulkerBoxContainer(playerInventory, this, playerEntity);
	}
	...
	public TextComponent getName() {
		...
		return (TextComponent)(textComponent != null ? textComponent : new TranslatableTextComponent("container.shulkerBox"));
	}
	...
	public CompoundTag method_11317(CompoundTag compoundTag) {
		...
		if (!compoundTag.containsKey("Lock") && this.hasContainerLock()) {
			this.getContainerLock().serialize(compoundTag);
		}
