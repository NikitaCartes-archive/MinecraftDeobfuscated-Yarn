...
public abstract class AbstractFurnaceBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
	...
	protected int getCookTime() {
		return (Integer)this.world.getRecipeManager().method_8132(this.recipeType, this, this.world).map(CookingRecipe::getCookTime).orElse(200);
	}
	...
	public boolean method_5443(PlayerEntity playerEntity) {
		return this.world.method_8321(this.field_11867) != this
			? false
			: playerEntity.squaredDistanceTo((double)this.field_11867.getX() + 0.5, (double)this.field_11867.getY() + 0.5, (double)this.field_11867.getZ() + 0.5)
				<= 64.0;
	}
