...
public class IceFrostedBlock extends IceBlock {
	public static final IntegerProperty field_11097 = Properties.AGE_3;

	public IceFrostedBlock(Block.Settings settings) {
		super(settings);
	...
	public void scheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if ((random.nextInt(3) == 0 || this.method_10202(world, blockPos, 4))
			&& world.method_8602(blockPos) > 11 - blockState.get(field_11097) - blockState.method_11581(world, blockPos)
	...
	private boolean method_10201(BlockState blockState, World world, BlockPos blockPos) {
		int i = blockState.get(field_11097);
		if (i < 3) {
