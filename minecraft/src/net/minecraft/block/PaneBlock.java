...
public class PaneBlock extends HorizontalConnectedBlock {
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		...
		return this.method_9564()
			.method_11657(
				field_10905, Boolean.valueOf(this.method_10281(blockState, Block.method_9501(blockState.method_11628(blockView, blockPos2), Direction.SOUTH)))
			)
			.method_11657(
	...
	public boolean method_9522(BlockState blockState, BlockState blockState2, Direction direction) {
		if (blockState2.getBlock() == this) {
			...
			if (blockState.method_11654((Property)FACING_PROPERTIES.get(direction))
				&& blockState2.method_11654((Property)FACING_PROPERTIES.get(direction.getOpposite()))) {
				return true;
			}
		}
