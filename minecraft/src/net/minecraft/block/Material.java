...
public final class Material {
	...
	public static final Material COBWEB = new Material.Builder(MaterialColor.WEB)
		.allowsMovement()
		.lightPassesThrough()
		.destroyedByPiston()
		.requiresTool()
	...
	public static class Builder {
		...
		public Material build() {
			return new Material(
				this.field_15961, this.liquid, this.solid, this.blocksMovement, this.blocksLight, this.breakByHand, this.burnable, this.replaceable, this.field_15968
			);
		}
	}
}
