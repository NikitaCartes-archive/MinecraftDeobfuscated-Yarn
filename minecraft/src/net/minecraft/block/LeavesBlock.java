...
public class LeavesBlock extends Block {
	...
	public boolean method_9542(BlockState blockState) {
		return blockState.method_11654(field_11199) == 7 && !blockState.method_11654(field_11200);
	}

	@Override
	public void method_9514(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (!blockState.method_11654(field_11200) && blockState.method_11654(field_11199) == 7) {
	...
	public BlockState method_9559(BlockState blockState, Direction direction, BlockState blockState2, IWorld iWorld, BlockPos blockPos, BlockPos blockPos2) {
		...
		if (i != 1 || blockState.method_11654(field_11199) != i) {
	...
	private static int method_10302(BlockState blockState) {
		if (BlockTags.field_15475.contains(blockState.getBlock())) {
			...
			return blockState.getBlock() instanceof LeavesBlock ? blockState.method_11654(field_11199) : 7;
		}
	}
