...
public class StandingBannerBlock extends AbstractBannerBlock {
	...
	public BlockState applyRotation(BlockState blockState, Rotation rotation) {
		return blockState.with(field_9924, Integer.valueOf(rotation.method_10502(blockState.get(field_9924), 16)));
	}

	@Override
	public BlockState applyMirror(BlockState blockState, Mirror mirror) {
		return blockState.with(field_9924, Integer.valueOf(mirror.method_10344(blockState.get(field_9924), 16)));
	}
