...
public class MushroomBlock extends Block {
	...
	public BlockState method_9598(BlockState blockState, BlockRotation blockRotation) {
		return blockState.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11043)), blockState.method_11654(field_11171))
			.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11035)), blockState.method_11654(field_11170))
			.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11034)), blockState.method_11654(field_11172))
			.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11039)), blockState.method_11654(field_11167))
			.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11036)), blockState.method_11654(field_11166))
			.method_11657((Property)FACING_PROPERTIES.get(blockRotation.rotate(Direction.field_11033)), blockState.method_11654(field_11169));
	}

	@Override
	public BlockState method_9569(BlockState blockState, BlockMirror blockMirror) {
		return blockState.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11043)), blockState.method_11654(field_11171))
			.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11035)), blockState.method_11654(field_11170))
			.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11034)), blockState.method_11654(field_11172))
			.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11039)), blockState.method_11654(field_11167))
			.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11036)), blockState.method_11654(field_11166))
			.method_11657((Property)FACING_PROPERTIES.get(blockMirror.apply(Direction.field_11033)), blockState.method_11654(field_11169));
	}
