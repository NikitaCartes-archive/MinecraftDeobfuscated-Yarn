...
public class SkullBlock extends AbstractSkullBlock {
	...
	public BlockState rotate(BlockState blockState, BlockRotation blockRotation) {
		return blockState.with(field_11505, Integer.valueOf(blockRotation.rotate(blockState.get(field_11505), 16)));
	}

	@Override
	public BlockState mirror(BlockState blockState, BlockMirror blockMirror) {
		return blockState.with(field_11505, Integer.valueOf(blockMirror.mirror(blockState.get(field_11505), 16)));
	}
