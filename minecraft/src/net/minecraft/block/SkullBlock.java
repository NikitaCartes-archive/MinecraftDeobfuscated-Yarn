...
public class SkullBlock extends AbstractSkullBlock {
	...
	public BlockState method_9598(BlockState blockState, Rotation rotation) {
		return blockState.method_11657(field_11505, Integer.valueOf(rotation.method_10502(blockState.method_11654(field_11505), 16)));
	}

	@Override
	public BlockState method_9569(BlockState blockState, Mirror mirror) {
		return blockState.method_11657(field_11505, Integer.valueOf(mirror.method_10344(blockState.method_11654(field_11505), 16)));
	}
