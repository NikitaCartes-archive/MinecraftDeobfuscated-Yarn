...
public class SkullBlock extends AbstractSkullBlock {
	...
	public BlockState getPlacementState(ItemPlacementContext itemPlacementContext) {
		return this.getDefaultState()
			.with(field_11505, Integer.valueOf(MathHelper.floor((double)(itemPlacementContext.getPlayerYaw() * 16.0F / 360.0F) + 0.5) & 15));
	}

	@Override
	public BlockState applyRotation(BlockState blockState, Rotation rotation) {
		return blockState.with(field_11505, Integer.valueOf(rotation.method_10502(blockState.get(field_11505), 16)));
	}

	@Override
	public BlockState applyMirror(BlockState blockState, Mirror mirror) {
		return blockState.with(field_11505, Integer.valueOf(mirror.method_10344(blockState.get(field_11505), 16)));
	}
