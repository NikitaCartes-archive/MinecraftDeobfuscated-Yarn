...
public class SnowBlock extends Block {
	...
	public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
		...
		if (blockState.isOf(Blocks.field_10295) || blockState.isOf(Blocks.field_10225) || blockState.isOf(Blocks.field_10499)) {
			return false;
		} else if (!blockState.isOf(Blocks.field_21211) && !blockState.isOf(Blocks.field_10114)) {
			return Block.isFaceFullSquare(blockState.getCollisionShape(world, pos.method_10074()), Direction.field_11036)
	...
	public boolean canReplace(BlockState state, ItemPlacementContext context) {
		...
		if (context.getStack().getItem() != this.asItem() || i >= 8) {
			...
			return context.getSide() == Direction.field_11036;
		} else {
			return true;
		}
	}
