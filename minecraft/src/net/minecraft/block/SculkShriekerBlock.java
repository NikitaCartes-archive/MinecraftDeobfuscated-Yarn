...
public class SculkShriekerBlock extends BlockWithEntity {
	...
	public static boolean method_40795(ServerWorld serverWorld, BlockPos blockPos, BlockState blockState) {
		return !blockState.get(SHRIEKING)
			&& method_40799(serverWorld, blockPos).map(sculkShriekerWarningManager -> sculkShriekerWarningManager.method_40721(serverWorld, blockPos)).orElse(false);
	}
