...
public class RepeaterBlock extends AbstractRedstoneGateBlock {
	...
	public static final IntegerProperty field_11451 = Properties.field_12494;
	...
	protected int method_9992(BlockState blockState) {
		return blockState.method_11654(field_11451) * 2;
	}
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		...
		return blockState.method_11657(
			field_11452, Boolean.valueOf(this.method_9996(itemPlacementContext.method_8045(), itemPlacementContext.method_8037(), blockState))
		);
	}
	...
	public void method_9496(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (blockState.method_11654(field_10911)) {
			...
			if (random.nextBoolean()) {
				g = (float)(blockState.method_11654(field_11451) * 2 - 1);
			}
