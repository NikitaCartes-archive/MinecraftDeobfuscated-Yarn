...
public class BannerBlock extends AbstractBannerBlock {
	...
	public BlockState method_9598(BlockState blockState, BlockRotation blockRotation) {
		return blockState.method_11657(field_9924, Integer.valueOf(blockRotation.rotate(blockState.method_11654(field_9924), 16)));
	}

	@Override
	public BlockState method_9569(BlockState blockState, BlockMirror blockMirror) {
		return blockState.method_11657(field_9924, Integer.valueOf(blockMirror.mirror(blockState.method_11654(field_9924), 16)));
	}
