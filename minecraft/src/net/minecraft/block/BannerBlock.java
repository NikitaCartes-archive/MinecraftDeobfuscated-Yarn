...
public class BannerBlock extends AbstractBannerBlock {
	...
	public BlockState rotate(BlockState blockState, BlockRotation blockRotation) {
		return blockState.with(field_9924, Integer.valueOf(blockRotation.rotate(blockState.get(field_9924), 16)));
	}

	@Override
	public BlockState mirror(BlockState blockState, BlockMirror blockMirror) {
		return blockState.with(field_9924, Integer.valueOf(blockMirror.mirror(blockState.get(field_9924), 16)));
	}
