...
public class SignBlock extends AbstractSignBlock {
	...
	public BlockState rotate(BlockState blockState, BlockRotation blockRotation) {
		return blockState.with(field_11559, Integer.valueOf(blockRotation.rotate(blockState.get(field_11559), 16)));
	}

	@Override
	public BlockState mirror(BlockState blockState, BlockMirror blockMirror) {
		return blockState.with(field_11559, Integer.valueOf(blockMirror.mirror(blockState.get(field_11559), 16)));
	}
