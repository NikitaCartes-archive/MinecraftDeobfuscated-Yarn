...
public class Blocks {
	...
	public static final Block field_10562 = register(
		"wet_sponge", new SpongeWetBlock(Block.Settings.of(Material.SPONGE).strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block field_10293 = register(
		"wheat", new CropBlock(Block.Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block field_10330 = register(
		"dark_oak_sign",
		new StandingSignBlock(Block.Settings.of(Material.WOOD, field_10010.materialColor).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_10450 = register(
		"repeater", new RepeaterBlock(Block.Settings.of(Material.PART).breakInstantly().sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_10277 = register(
		"infested_stone", new StoneInfestedBlock(field_10340, Block.Settings.of(Material.CLAY).strength(0.0F, 0.75F))
	);
	...
	public static final Block field_10331 = register(
		...
		new StemAttachedBlock((GourdBlock)field_10261, Block.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.WOOD))
	);
	public static final Block field_10150 = register(
		"attached_melon_stem",
		new StemAttachedBlock((GourdBlock)field_10545, Block.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_9974 = register(
		"nether_wart", new NetherWartBlock(Block.Settings.of(Material.PLANT, MaterialColor.RED).noCollision().ticksRandomly())
	);
	...
	public static final Block field_10589 = register(
		"tripwire", new TripwireBlock((TripwireHookBlock)field_10348, Block.Settings.of(Material.PART).noCollision())
	);
	...
	public static final Block field_10076 = register(
		"potted_dark_oak_sapling", new FlowerPotBlock(field_10160, Block.Settings.of(Material.PART).breakInstantly())
	);
	...
	public static final Block field_10609 = register(
		"carrots", new CarrotsBlock(Block.Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS))
	);
	public static final Block field_10247 = register(
		"potatoes", new PotatoesBlock(Block.Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block field_10452 = register(
		"light_blue_banner",
		new StandingBannerBlock(DyeColor.LIGHT_BLUE, Block.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_9985 = register(
		"light_gray_banner",
		new StandingBannerBlock(DyeColor.LIGHT_GRAY, Block.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_10341 = register(
		"beetroots", new BeetrootsBlock(Block.Settings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block field_10022 = register(
		...
		new ConcretePowderBlock(field_10210, Block.Settings.of(Material.SAND, DyeColor.ORANGE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	...
	public static final Block field_10145 = register(
		...
		new ConcretePowderBlock(field_10542, Block.Settings.of(Material.SAND, DyeColor.YELLOW).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	...
	public static final Block field_10404 = register(
		...
		new ConcretePowderBlock(field_10206, Block.Settings.of(Material.SAND, DyeColor.PURPLE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	...
	public static final Block field_10516 = register(
		"fire_coral_block",
		new CoralBlockBlock(field_10111, Block.Settings.of(Material.STONE, MaterialColor.RED).strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL))
	);
	...
	public static final Block field_10125 = register(
		"tube_coral",
		new CoralBlock(
			field_10082, Block.Settings.of(Material.UNDERWATER_PLANT, MaterialColor.BLUE).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS)
		)
	);
	public static final Block field_10339 = register(
		"brain_coral",
		new CoralBlock(
			field_10572, Block.Settings.of(Material.UNDERWATER_PLANT, MaterialColor.PINK).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS)
		)
	);
	...
	public static final Block field_16492 = register(
		"scaffolding", new ScaffoldingBlock(Block.Settings.of(Material.PART).noCollision().strength(2.0F, 3.0F).sounds(BlockSoundGroup.SCAFFOLDING))
	);
	...
	public static final Block field_16337 = register(
		"grindstone", new GrindstoneBlock(Block.Settings.of(Material.ANVIL, MaterialColor.IRON).strength(5.0F, 1200.0F).sounds(BlockSoundGroup.STONE))
	);
	...
	public static final Block field_16999 = register("sweet_berry_bush", new SweetBerryBushBlock(Block.Settings.of(Material.PLANT).ticksRandomly().noCollision()));
