...
public class Blocks {
	...
	public static final Block GRASS_BLOCK = register(
		"grass_block", new GrassBlock(Block.Settings.of(Material.SOLID_ORGANIC).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	public static final Block DIRT = register(
		"dirt", new Block(Block.Settings.of(Material.SOIL, MaterialColor.DIRT).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	public static final Block COARSE_DIRT = register(
		"coarse_dirt", new Block(Block.Settings.of(Material.SOIL, MaterialColor.DIRT).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	public static final Block PODZOL = register(
		"podzol", new SnowyBlock(Block.Settings.of(Material.SOIL, MaterialColor.SPRUCE).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	...
	public static final Block SAND = register(
		"sand", new SandBlock(14406560, Block.Settings.of(Material.AGGREGATE, MaterialColor.SAND).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block RED_SAND = register(
		"red_sand", new SandBlock(11098145, Block.Settings.of(Material.AGGREGATE, MaterialColor.ORANGE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block GRAVEL = register(
		"gravel", new GravelBlock(Block.Settings.of(Material.AGGREGATE, MaterialColor.STONE).strength(0.6F).sounds(BlockSoundGroup.GRAVEL))
	);
	...
	public static final Block POWERED_RAIL = register(
		"powered_rail", new PoweredRailBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	public static final Block DETECTOR_RAIL = register(
		"detector_rail", new DetectorRailBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block SEAGRASS = register(
		"seagrass", new SeagrassBlock(Block.Settings.of(Material.REPLACEABLE_UNDERWATER_PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS))
	);
	public static final Block TALL_SEAGRASS = register(
		"tall_seagrass",
		new TallSeagrassBlock(Block.Settings.of(Material.REPLACEABLE_UNDERWATER_PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS))
	);
	...
	public static final Block TORCH = register(
		"torch", new TorchBlock(Block.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(14).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block WALL_TORCH = register(
		"wall_torch",
		new WallTorchBlock(Block.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(14).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH))
	);
	...
	public static final Block REDSTONE_WIRE = register(
		"redstone_wire", new RedstoneWireBlock(Block.Settings.of(Material.SUPPORTED).noCollision().breakInstantly())
	);
	...
	public static final Block FARMLAND = register(
		"farmland", new FarmlandBlock(Block.Settings.of(Material.SOIL).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRAVEL))
	);
	...
	public static final Block LADDER = register(
		"ladder", new LadderBlock(Block.Settings.of(Material.SUPPORTED).strength(0.4F).sounds(BlockSoundGroup.LADDER).nonOpaque())
	);
	public static final Block RAIL = register(
		"rail", new RailBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block LEVER = register(
		"lever", new LeverBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block REDSTONE_TORCH = register(
		"redstone_torch", new RedstoneTorchBlock(Block.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(7).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block REDSTONE_WALL_TORCH = register(
		"redstone_wall_torch",
		new WallRedstoneTorchBlock(
			Block.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(7).sounds(BlockSoundGroup.WOOD).dropsLike(REDSTONE_TORCH)
		)
	);
	public static final Block STONE_BUTTON = register("stone_button", new StoneButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F)));
	public static final Block SNOW = register(
		"snow", new SnowBlock(Block.Settings.of(Material.SNOW_LAYER).ticksRandomly().strength(0.1F).sounds(BlockSoundGroup.SNOW))
	);
	...
	public static final Block CLAY = register("clay", new Block(Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.6F).sounds(BlockSoundGroup.GRAVEL)));
	...
	public static final Block PUMPKIN = register(
		"pumpkin", new PumpkinBlock(Block.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block SOUL_SAND = register(
		"soul_sand",
		new SoulSandBlock(
			Block.Settings.of(Material.AGGREGATE, MaterialColor.BROWN).ticksRandomly().strength(0.5F).velocityMultiplier(0.4F).sounds(BlockSoundGroup.SAND)
		)
	);
	...
	public static final Block CARVED_PUMPKIN = register(
		"carved_pumpkin", new CarvedPumpkinBlock(Block.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block JACK_O_LANTERN = register(
		"jack_o_lantern", new CarvedPumpkinBlock(Block.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0F).sounds(BlockSoundGroup.WOOD).lightLevel(15))
	);
	...
	public static final Block REPEATER = register(
		"repeater", new RepeaterBlock(Block.Settings.of(Material.SUPPORTED).breakInstantly().sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block INFESTED_STONE = register(
		"infested_stone", new InfestedBlock(STONE, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	public static final Block INFESTED_COBBLESTONE = register(
		"infested_cobblestone", new InfestedBlock(COBBLESTONE, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	public static final Block INFESTED_STONE_BRICKS = register(
		"infested_stone_bricks", new InfestedBlock(STONE_BRICKS, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	public static final Block INFESTED_MOSSY_STONE_BRICKS = register(
		"infested_mossy_stone_bricks", new InfestedBlock(MOSSY_STONE_BRICKS, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	public static final Block INFESTED_CRACKED_STONE_BRICKS = register(
		"infested_cracked_stone_bricks", new InfestedBlock(CRACKED_STONE_BRICKS, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	public static final Block INFESTED_CHISELED_STONE_BRICKS = register(
		"infested_chiseled_stone_bricks", new InfestedBlock(CHISELED_STONE_BRICKS, Block.Settings.of(Material.ORGANIC_PRODUCT).strength(0.0F, 0.75F))
	);
	...
	public static final Block MELON = register(
		"melon", new MelonBlock(Block.Settings.of(Material.GOURD, MaterialColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block MYCELIUM = register(
		"mycelium", new MyceliumBlock(Block.Settings.of(Material.SOLID_ORGANIC, MaterialColor.PURPLE).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block TRIPWIRE_HOOK = register("tripwire_hook", new TripwireHookBlock(Block.Settings.of(Material.SUPPORTED).noCollision()));
	public static final Block TRIPWIRE = register(
		"tripwire", new TripwireBlock((TripwireHookBlock)TRIPWIRE_HOOK, Block.Settings.of(Material.SUPPORTED).noCollision())
	);
	...
	public static final Block FLOWER_POT = register("flower_pot", new FlowerPotBlock(AIR, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
	public static final Block POTTED_OAK_SAPLING = register(
		"potted_oak_sapling", new FlowerPotBlock(OAK_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_SPRUCE_SAPLING = register(
		"potted_spruce_sapling", new FlowerPotBlock(SPRUCE_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_BIRCH_SAPLING = register(
		"potted_birch_sapling", new FlowerPotBlock(BIRCH_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_JUNGLE_SAPLING = register(
		"potted_jungle_sapling", new FlowerPotBlock(JUNGLE_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_ACACIA_SAPLING = register(
		"potted_acacia_sapling", new FlowerPotBlock(ACACIA_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_DARK_OAK_SAPLING = register(
		"potted_dark_oak_sapling", new FlowerPotBlock(DARK_OAK_SAPLING, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_FERN = register("potted_fern", new FlowerPotBlock(FERN, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque()));
	public static final Block POTTED_DANDELION = register(
		"potted_dandelion", new FlowerPotBlock(DANDELION, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_POPPY = register(
		"potted_poppy", new FlowerPotBlock(POPPY, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_BLUE_ORCHID = register(
		"potted_blue_orchid", new FlowerPotBlock(BLUE_ORCHID, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_ALLIUM = register(
		"potted_allium", new FlowerPotBlock(ALLIUM, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_AZURE_BLUET = register(
		"potted_azure_bluet", new FlowerPotBlock(AZURE_BLUET, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_RED_TULIP = register(
		"potted_red_tulip", new FlowerPotBlock(RED_TULIP, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_ORANGE_TULIP = register(
		"potted_orange_tulip", new FlowerPotBlock(ORANGE_TULIP, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_WHITE_TULIP = register(
		"potted_white_tulip", new FlowerPotBlock(WHITE_TULIP, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_PINK_TULIP = register(
		"potted_pink_tulip", new FlowerPotBlock(PINK_TULIP, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_OXEYE_DAISY = register(
		"potted_oxeye_daisy", new FlowerPotBlock(OXEYE_DAISY, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_CORNFLOWER = register(
		"potted_cornflower", new FlowerPotBlock(CORNFLOWER, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_LILY_OF_THE_VALLEY = register(
		"potted_lily_of_the_valley", new FlowerPotBlock(LILY_OF_THE_VALLEY, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_WITHER_ROSE = register(
		"potted_wither_rose", new FlowerPotBlock(WITHER_ROSE, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_RED_MUSHROOM = register(
		"potted_red_mushroom", new FlowerPotBlock(RED_MUSHROOM, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_BROWN_MUSHROOM = register(
		"potted_brown_mushroom", new FlowerPotBlock(BROWN_MUSHROOM, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_DEAD_BUSH = register(
		"potted_dead_bush", new FlowerPotBlock(DEAD_BUSH, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	public static final Block POTTED_CACTUS = register(
		"potted_cactus", new FlowerPotBlock(CACTUS, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	...
	public static final Block OAK_BUTTON = register(
		"oak_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block SPRUCE_BUTTON = register(
		"spruce_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block BIRCH_BUTTON = register(
		"birch_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block JUNGLE_BUTTON = register(
		"jungle_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block ACACIA_BUTTON = register(
		"acacia_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block DARK_OAK_BUTTON = register(
		"dark_oak_button", new WoodButtonBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block SKELETON_SKULL = register(
		"skeleton_skull", new SkullBlock(SkullBlock.Type.SKELETON, Block.Settings.of(Material.SUPPORTED).strength(1.0F))
	);
	public static final Block SKELETON_WALL_SKULL = register(
		"skeleton_wall_skull", new WallSkullBlock(SkullBlock.Type.SKELETON, Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(SKELETON_SKULL))
	);
	public static final Block WITHER_SKELETON_SKULL = register(
		"wither_skeleton_skull", new WitherSkullBlock(Block.Settings.of(Material.SUPPORTED).strength(1.0F))
	);
	public static final Block WITHER_SKELETON_WALL_SKULL = register(
		"wither_skeleton_wall_skull", new WallWitherSkullBlock(Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(WITHER_SKELETON_SKULL))
	);
	public static final Block ZOMBIE_HEAD = register("zombie_head", new SkullBlock(SkullBlock.Type.ZOMBIE, Block.Settings.of(Material.SUPPORTED).strength(1.0F)));
	public static final Block ZOMBIE_WALL_HEAD = register(
		"zombie_wall_head", new WallSkullBlock(SkullBlock.Type.ZOMBIE, Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(ZOMBIE_HEAD))
	);
	public static final Block PLAYER_HEAD = register("player_head", new PlayerSkullBlock(Block.Settings.of(Material.SUPPORTED).strength(1.0F)));
	public static final Block PLAYER_WALL_HEAD = register(
		"player_wall_head", new WallPlayerSkullBlock(Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(PLAYER_HEAD))
	);
	public static final Block CREEPER_HEAD = register(
		"creeper_head", new SkullBlock(SkullBlock.Type.CREEPER, Block.Settings.of(Material.SUPPORTED).strength(1.0F))
	);
	public static final Block CREEPER_WALL_HEAD = register(
		"creeper_wall_head", new WallSkullBlock(SkullBlock.Type.CREEPER, Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(CREEPER_HEAD))
	);
	public static final Block DRAGON_HEAD = register("dragon_head", new SkullBlock(SkullBlock.Type.DRAGON, Block.Settings.of(Material.SUPPORTED).strength(1.0F)));
	public static final Block DRAGON_WALL_HEAD = register(
		"dragon_wall_head", new WallSkullBlock(SkullBlock.Type.DRAGON, Block.Settings.of(Material.SUPPORTED).strength(1.0F).dropsLike(DRAGON_HEAD))
	);
	public static final Block ANVIL = register(
		"anvil", new AnvilBlock(Block.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).strength(5.0F, 1200.0F).sounds(BlockSoundGroup.ANVIL))
	);
	public static final Block CHIPPED_ANVIL = register(
		"chipped_anvil", new AnvilBlock(Block.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).strength(5.0F, 1200.0F).sounds(BlockSoundGroup.ANVIL))
	);
	public static final Block DAMAGED_ANVIL = register(
		"damaged_anvil", new AnvilBlock(Block.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).strength(5.0F, 1200.0F).sounds(BlockSoundGroup.ANVIL))
	);
	...
	public static final Block COMPARATOR = register(
		"comparator", new ComparatorBlock(Block.Settings.of(Material.SUPPORTED).breakInstantly().sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block ACTIVATOR_RAIL = register(
		"activator_rail", new PoweredRailBlock(Block.Settings.of(Material.SUPPORTED).noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block RED_STAINED_GLASS_PANE = register(
		...
		new StainedGlassPaneBlock(DyeColor.RED, Block.Settings.of(Material.GLASS).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	...
	public static final Block SLIME_BLOCK = register(
		"slime_block", new SlimeBlock(Block.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.GRASS).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME).nonOpaque())
	);
	...
	public static final Block HAY_BLOCK = register(
		"hay_block", new HayBlock(Block.Settings.of(Material.SOLID_ORGANIC, MaterialColor.YELLOW).strength(0.5F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block PACKED_ICE = register(
		"packed_ice", new Block(Block.Settings.of(Material.DENSE_ICE).slipperiness(0.98F).strength(0.5F).sounds(BlockSoundGroup.GLASS))
	);
	...
	public static final Block END_ROD = register(
		"end_rod", new EndRodBlock(Block.Settings.of(Material.SUPPORTED).breakInstantly().lightLevel(14).sounds(BlockSoundGroup.WOOD).nonOpaque())
	);
	...
	public static final Block GRASS_PATH = register(
		"grass_path", new GrassPathBlock(Block.Settings.of(Material.SOIL).strength(0.65F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block NETHER_WART_BLOCK = register(
		"nether_wart_block", new Block(Block.Settings.of(Material.SOLID_ORGANIC, MaterialColor.RED).strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block WHITE_CONCRETE_POWDER = register(
		...
		new ConcretePowderBlock(WHITE_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.WHITE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block ORANGE_CONCRETE_POWDER = register(
		"orange_concrete_powder",
		new ConcretePowderBlock(ORANGE_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.ORANGE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block MAGENTA_CONCRETE_POWDER = register(
		"magenta_concrete_powder",
		new ConcretePowderBlock(MAGENTA_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.MAGENTA).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block LIGHT_BLUE_CONCRETE_POWDER = register(
		"light_blue_concrete_powder",
		new ConcretePowderBlock(LIGHT_BLUE_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.LIGHT_BLUE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block YELLOW_CONCRETE_POWDER = register(
		"yellow_concrete_powder",
		new ConcretePowderBlock(YELLOW_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.YELLOW).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block LIME_CONCRETE_POWDER = register(
		"lime_concrete_powder",
		new ConcretePowderBlock(LIME_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.LIME).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block PINK_CONCRETE_POWDER = register(
		"pink_concrete_powder",
		new ConcretePowderBlock(PINK_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.PINK).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block GRAY_CONCRETE_POWDER = register(
		"gray_concrete_powder",
		new ConcretePowderBlock(GRAY_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.GRAY).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block LIGHT_GRAY_CONCRETE_POWDER = register(
		"light_gray_concrete_powder",
		new ConcretePowderBlock(LIGHT_GRAY_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.LIGHT_GRAY).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block CYAN_CONCRETE_POWDER = register(
		"cyan_concrete_powder",
		new ConcretePowderBlock(CYAN_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.CYAN).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block PURPLE_CONCRETE_POWDER = register(
		"purple_concrete_powder",
		new ConcretePowderBlock(PURPLE_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.PURPLE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block BLUE_CONCRETE_POWDER = register(
		"blue_concrete_powder",
		new ConcretePowderBlock(BLUE_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.BLUE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block BROWN_CONCRETE_POWDER = register(
		"brown_concrete_powder",
		new ConcretePowderBlock(BROWN_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.BROWN).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block GREEN_CONCRETE_POWDER = register(
		"green_concrete_powder",
		new ConcretePowderBlock(GREEN_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.GREEN).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block RED_CONCRETE_POWDER = register(
		"red_concrete_powder",
		new ConcretePowderBlock(RED_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.RED).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block BLACK_CONCRETE_POWDER = register(
		"black_concrete_powder",
		new ConcretePowderBlock(BLACK_CONCRETE, Block.Settings.of(Material.AGGREGATE, DyeColor.BLACK).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	...
	public static final Block DRIED_KELP_BLOCK = register(
		"dried_kelp_block", new Block(Block.Settings.of(Material.SOLID_ORGANIC, MaterialColor.GREEN).strength(0.5F, 2.5F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block BLUE_ICE = register(
		"blue_ice", new TransparentBlock(Block.Settings.of(Material.DENSE_ICE).strength(2.8F).slipperiness(0.989F).sounds(BlockSoundGroup.GLASS))
	);
	...
	public static final Block POTTED_BAMBOO = register(
		"potted_bamboo", new FlowerPotBlock(BAMBOO, Block.Settings.of(Material.SUPPORTED).breakInstantly().nonOpaque())
	);
	...
	public static final Block SCAFFOLDING = register(
		"scaffolding",
		new ScaffoldingBlock(Block.Settings.of(Material.SUPPORTED, MaterialColor.SAND).noCollision().sounds(BlockSoundGroup.SCAFFOLDING).hasDynamicBounds())
	);
	...
	public static final Block GRINDSTONE = register(
		"grindstone", new GrindstoneBlock(Block.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).strength(2.0F, 6.0F).sounds(BlockSoundGroup.STONE))
	);
	...
	public static final Block HONEY_BLOCK = register(
		"honey_block",
		new HoneyBlock(
			Block.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.ORANGE)
	...
	public static final Block HONEYCOMB_BLOCK = register(
		"honeycomb_block", new Block(Block.Settings.of(Material.ORGANIC_PRODUCT, MaterialColor.ORANGE).strength(0.6F).sounds(BlockSoundGroup.CORAL))
	);
