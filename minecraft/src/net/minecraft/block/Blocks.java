...
public class Blocks {
	...
	public static final Block LAPIS_BLOCK = register("lapis_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAPIS).strength(3.0F, 3.0F)));
	...
	public static final Block OBSIDIAN = register("obsidian", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).strength(50.0F, 1200.0F)));
	public static final Block TORCH = register(
		"torch",
		new TorchBlock(
			AbstractBlock.Settings.of(Material.PART).noCollision().breakInstantly().lightLevel(blockStatex -> 14).sounds(BlockSoundGroup.WOOD), ParticleTypes.FLAME
		)
	);
	public static final Block WALL_TORCH = register(
		"wall_torch",
		new WallTorchBlock(
			AbstractBlock.Settings.of(Material.PART).noCollision().breakInstantly().lightLevel(blockStatex -> 14).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH),
			ParticleTypes.FLAME
		)
	);
	...
	public static final Block DARK_OAK_SIGN = register(
		"dark_oak_sign",
		new SignBlock(
			AbstractBlock.Settings.of(Material.WOOD, DARK_OAK_LOG.getMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD), SignType.DARK_OAK
		)
	);
	public static final Block OAK_DOOR = register(
		"oak_door", new DoorBlock(AbstractBlock.Settings.of(Material.WOOD, OAK_PLANKS.getMaterialColor()).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque())
	);
	...
	public static final Block SPRUCE_WALL_SIGN = register(
		"spruce_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of(Material.WOOD, SPRUCE_LOG.getMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD).dropsLike(SPRUCE_SIGN),
			SignType.SPRUCE
		)
	);
	...
	public static final Block JUNGLE_WALL_SIGN = register(
		"jungle_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of(Material.WOOD, JUNGLE_LOG.getMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD).dropsLike(JUNGLE_SIGN),
			SignType.JUNGLE
		)
	);
	public static final Block DARK_OAK_WALL_SIGN = register(
		"dark_oak_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of(Material.WOOD, DARK_OAK_LOG.getMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD).dropsLike(DARK_OAK_SIGN),
			SignType.DARK_OAK
		)
	);
	...
	public static final Block REDSTONE_WALL_TORCH = register(
		...
		new WallRedstoneTorchBlock(
			AbstractBlock.Settings.of(Material.PART).noCollision().breakInstantly().lightLevel(method_26107(7)).sounds(BlockSoundGroup.WOOD).dropsLike(REDSTONE_TORCH)
		)
	);
	public static final Block STONE_BUTTON = register("stone_button", new StoneButtonBlock(AbstractBlock.Settings.of(Material.PART).noCollision().strength(0.5F)));
	...
	public static final Block SOUL_FIRE_TORCH = register(
		"soul_fire_torch",
		new TorchBlock(
			AbstractBlock.Settings.of(Material.PART).noCollision().breakInstantly().lightLevel(blockStatex -> 10).sounds(BlockSoundGroup.WOOD),
	...
	public static final Block CHISELED_STONE_BRICKS = register("chiseled_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE).strength(1.5F, 6.0F)));
	public static final Block INFESTED_STONE = register("infested_stone", new InfestedBlock(STONE, AbstractBlock.Settings.of(Material.CLAY).strength(0.0F, 0.75F)));
	...
	public static final Block MYCELIUM = register(
		"mycelium", new MyceliumBlock(AbstractBlock.Settings.of(Material.ORGANIC, MaterialColor.PURPLE).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block BREWING_STAND = register(
		"brewing_stand", new BrewingStandBlock(AbstractBlock.Settings.of(Material.METAL).strength(0.5F).lightLevel(blockStatex -> 1).nonOpaque())
	);
	...
	public static final Block ENDER_CHEST = register(
		"ender_chest", new EnderChestBlock(AbstractBlock.Settings.of(Material.STONE).strength(22.5F, 600.0F).lightLevel(blockStatex -> 7))
	);
	...
	public static final Block FLOWER_POT = register("flower_pot", new FlowerPotBlock(AIR, AbstractBlock.Settings.of(Material.PART).breakInstantly().nonOpaque()));
	...
	public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = register(
		...
		new WeightedPressurePlateBlock(15, AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block SLIME_BLOCK = register(
		"slime_block", new SlimeBlock(AbstractBlock.Settings.of(Material.CLAY, MaterialColor.GRASS).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME).nonOpaque())
	);
	...
	public static final Block TERRACOTTA = register("terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).strength(1.25F, 4.2F)));
	public static final Block COAL_BLOCK = register("coal_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).strength(5.0F, 6.0F)));
	...
	public static final Block RED_SANDSTONE = register("red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).strength(0.8F)));
	...
	public static final Block BRICK_SLAB = register("brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).strength(2.0F, 6.0F)));
	...
	public static final Block SPRUCE_FENCE = register(
		"spruce_fence", new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, SPRUCE_PLANKS.getMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block BIRCH_FENCE = register(
		"birch_fence", new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, BIRCH_PLANKS.getMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block JUNGLE_FENCE = register(
		"jungle_fence", new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, JUNGLE_PLANKS.getMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block ACACIA_FENCE = register(
		"acacia_fence", new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, ACACIA_PLANKS.getMaterialColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block ORANGE_CONCRETE = register("orange_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.ORANGE).strength(1.8F)));
	...
	public static final Block YELLOW_CONCRETE = register("yellow_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.YELLOW).strength(1.8F)));
	...
	public static final Block PURPLE_CONCRETE = register("purple_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.PURPLE).strength(1.8F)));
	...
	public static final Block TUBE_CORAL_BLOCK = register(
		"tube_coral_block",
		new CoralBlockBlock(DEAD_TUBE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLUE).strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL))
	);
	public static final Block BRAIN_CORAL_BLOCK = register(
		"brain_coral_block",
		new CoralBlockBlock(DEAD_BRAIN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK).strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL))
	);
	...
	public static final Block FIRE_CORAL_BLOCK = register(
		"fire_coral_block",
		new CoralBlockBlock(DEAD_FIRE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL))
	);
	public static final Block HORN_CORAL_BLOCK = register(
		"horn_coral_block",
		new CoralBlockBlock(DEAD_HORN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW).strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL))
	);
	...
	public static final Block SMOKER = register("smoker", new SmokerBlock(AbstractBlock.Settings.of(Material.STONE).strength(3.5F).lightLevel(method_26107(13))));
	...
	public static final Block LANTERN = register(
		"lantern",
		new LanternBlock(AbstractBlock.Settings.of(Material.METAL).strength(3.5F).sounds(BlockSoundGroup.LANTERN).lightLevel(blockStatex -> 15).nonOpaque())
	);
	public static final Block SOUL_FIRE_LANTERN = register(
		"soul_fire_lantern",
		new LanternBlock(AbstractBlock.Settings.of(Material.METAL).strength(3.5F).sounds(BlockSoundGroup.LANTERN).lightLevel(blockStatex -> 10).nonOpaque())
	);
	...
	public static final Block STRIPPED_WARPED_HYPHAE = register(
		"stripped_warped_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.WOOD, MaterialColor.CYAN).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM))
	);
	public static final Block WARPED_NYLIUM = register(
		"warped_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).strength(1.0F).sounds(BlockSoundGroup.NYLIUM).ticksRandomly())
	);
	...
	public static final Block STRIPPED_CRIMSON_HYPHAE = register(
		"stripped_crimson_hyphae", new PillarBlock(AbstractBlock.Settings.of(Material.WOOD, MaterialColor.RED).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM))
	);
	public static final Block CRIMSON_NYLIUM = register(
		"crimson_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).strength(1.0F).sounds(BlockSoundGroup.NYLIUM).ticksRandomly())
	);
	...
	public static final Block SHROOMLIGHT = register(
		"shroomlight",
		new Block(AbstractBlock.Settings.of(Material.ORGANIC, MaterialColor.RED).strength(1.0F).sounds(BlockSoundGroup.SHROOMLIGHT).lightLevel(blockStatex -> 15))
	);
	...
	public static final Block ANCIENT_DEBRIS = register(
		"ancient_debris", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BLACK).strength(30.0F, 1200.0F).sounds(BlockSoundGroup.ANCIENT_DEBRIS))
	);
	public static final Block CRYING_OBSIDIAN = register(
		"crying_obsidian",
		new CryingObsidianBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).strength(50.0F, 1200.0F).lightLevel(blockStatex -> 10))
	);
	...
	private static Boolean method_26126(BlockState blockState, BlockView blockView, BlockPos blockPos, EntityType<?> entityType) {
		return entityType == EntityType.OCELOT || entityType == EntityType.PARROT;
	}

	private static BedBlock method_26109(DyeColor dyeColor) {
		return new BedBlock(
			dyeColor,
			AbstractBlock.Settings.of(Material.WOOL, blockState -> blockState.get(BedBlock.PART) == BedPart.FOOT ? dyeColor.getMaterialColor() : MaterialColor.WEB)
				.sounds(BlockSoundGroup.WOOD)
				.strength(0.2F)
				.nonOpaque()
		);
	...
	private static PillarBlock method_26117(MaterialColor materialColor, MaterialColor materialColor2) {
		return new PillarBlock(
			AbstractBlock.Settings.of(Material.WOOD, blockState -> blockState.get(PillarBlock.AXIS) == Direction.Axis.Y ? materialColor : materialColor2)
				.strength(2.0F)
				.sounds(BlockSoundGroup.WOOD)
		);
	}

	private static Block method_26115(MaterialColor materialColor) {
		return new PillarBlock(AbstractBlock.Settings.of(Material.WOOD, blockState -> materialColor).strength(1.0F).sounds(BlockSoundGroup.NETHER_STEM));
	}
	...
	private static StainedGlassBlock method_26120(DyeColor dyeColor) {
		return new StainedGlassBlock(
			dyeColor,
			AbstractBlock.Settings.of(Material.GLASS, dyeColor)
				.strength(0.3F)
				.sounds(BlockSoundGroup.GLASS)
				.nonOpaque()
				.allowsSpawning(Blocks::method_26114)
	...
	private static ShulkerBoxBlock method_26110(DyeColor dyeColor, AbstractBlock.Settings settings) {
		return new ShulkerBoxBlock(dyeColor, settings.strength(2.0F).hasDynamicBounds().nonOpaque().suffocates(Blocks::method_26113));
	}
