...
public class Blocks {
	...
	public static final Block STONE = register(
		"stone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block GRANITE = register(
		"granite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block POLISHED_GRANITE = register(
		"polished_granite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block DIORITE = register(
		"diorite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block POLISHED_DIORITE = register(
		"polished_diorite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block ANDESITE = register(
		"andesite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block POLISHED_ANDESITE = register(
		"polished_andesite", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block GRASS_BLOCK = register(
		"grass_block", new GrassBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_GREEN).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	public static final Block DIRT = register(
		"dirt", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	public static final Block COARSE_DIRT = register(
		"coarse_dirt", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	public static final Block PODZOL = register(
		"podzol", new SnowyBlock(AbstractBlock.Settings.of().mapColor(MapColor.SPRUCE_BROWN).strength(0.5F).sounds(BlockSoundGroup.GRAVEL))
	);
	public static final Block COBBLESTONE = register(
		"cobblestone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block OAK_PLANKS = register(
		"oak_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block SPRUCE_PLANKS = register(
		"spruce_planks",
		new Block(
			AbstractBlock.Settings.of().mapColor(MapColor.SPRUCE_BROWN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block BIRCH_PLANKS = register(
		"birch_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block JUNGLE_PLANKS = register(
		"jungle_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block ACACIA_PLANKS = register(
		"acacia_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block DARK_OAK_PLANKS = register(
		"dark_oak_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block MANGROVE_PLANKS = register(
		"mangrove_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block BAMBOO_PLANKS = register(
		"bamboo_planks",
		new Block(
			AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable()
		)
	);
	...
	public static final Block SAND = register(
		"sand",
		new SandBlock(14406560, AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	...
	public static final Block RED_SAND = register(
		"red_sand",
		new SandBlock(11098145, AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND))
	);
	public static final Block GRAVEL = register(
		"gravel",
		new GravelBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.SNARE).strength(0.6F).sounds(BlockSoundGroup.GRAVEL))
	);
	...
	public static final Block GOLD_ORE = register(
		"gold_ore",
		new ExperienceDroppingBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(3.0F, 3.0F))
	);
	...
	public static final Block COAL_ORE = register(
		...
		new ExperienceDroppingBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(3.0F, 3.0F),
	...
	public static final Block MUDDY_MANGROVE_ROOTS = register(
		...
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.SPRUCE_BROWN).strength(0.7F).sounds(BlockSoundGroup.MUDDY_MANGROVE_ROOTS))
	);
	...
	public static final Block OAK_WOOD = register(
		"oak_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block SPRUCE_WOOD = register(
		"spruce_wood",
		new PillarBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.SPRUCE_BROWN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block BIRCH_WOOD = register(
		"birch_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block JUNGLE_WOOD = register(
		"jungle_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block ACACIA_WOOD = register(
		"acacia_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.GRAY).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block CHERRY_WOOD = register(
		"cherry_wood",
		new PillarBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.CHERRY_WOOD).burnable()
		)
	);
	public static final Block DARK_OAK_WOOD = register(
		"dark_oak_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block MANGROVE_WOOD = register(
		"mangrove_wood",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block STRIPPED_ACACIA_WOOD = register(
		...
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block STRIPPED_CHERRY_WOOD = register(
		"stripped_cherry_wood",
		new PillarBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_PINK).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.CHERRY_WOOD).burnable()
		)
	);
	...
	public static final Block SPONGE = register(
		"sponge", new SpongeBlock(AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	public static final Block WET_SPONGE = register(
		"wet_sponge", new WetSpongeBlock(AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block LAPIS_BLOCK = register(
		"lapis_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.LAPIS_BLUE).requiresTool().strength(3.0F, 3.0F))
	);
	public static final Block DISPENSER = register(
		"dispenser", new DispenserBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(3.5F))
	);
	public static final Block SANDSTONE = register(
		"sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block CHISELED_SANDSTONE = register(
		"chiseled_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block CUT_SANDSTONE = register(
		"cut_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block NOTE_BLOCK = register(
		"note_block",
		new NoteBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).sounds(BlockSoundGroup.WOOD).strength(0.8F).burnable())
	);
	...
	public static final Block POWERED_RAIL = register(
		"powered_rail", new PoweredRailBlock(AbstractBlock.Settings.of().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	public static final Block DETECTOR_RAIL = register(
		"detector_rail", new DetectorRailBlock(AbstractBlock.Settings.of().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block COBWEB = register(
		"cobweb",
		new CobwebBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.WHITE_GRAY).solid().noCollision().requiresTool().strength(4.0F).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	...
	public static final Block PISTON_HEAD = register(
		"piston_head",
		new PistonHeadBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).strength(1.5F).dropsNothing().pistonBehavior(PistonBehavior.BLOCK))
	);
	public static final Block WHITE_WOOL = register(
		"white_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.WHITE).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block ORANGE_WOOL = register(
		"orange_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block MAGENTA_WOOL = register(
		"magenta_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIGHT_BLUE_WOOL = register(
		"light_blue_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block YELLOW_WOOL = register(
		"yellow_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIME_WOOL = register(
		"lime_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.LIME).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block PINK_WOOL = register(
		"pink_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.PINK).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block GRAY_WOOL = register(
		"gray_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.GRAY).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIGHT_GRAY_WOOL = register(
		"light_gray_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_GRAY).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block CYAN_WOOL = register(
		"cyan_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.CYAN).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block PURPLE_WOOL = register(
		"purple_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BLUE_WOOL = register(
		"blue_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLUE).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BROWN_WOOL = register(
		"brown_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block GREEN_WOOL = register(
		"green_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.GREEN).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block RED_WOOL = register(
		"red_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BLACK_WOOL = register(
		"black_wool",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.GUITAR).strength(0.8F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	...
	public static final Block GOLD_BLOCK = register(
		"gold_block",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.GOLD).instrument(Instrument.BELL).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block BRICKS = register(
		"bricks", new Block(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block TNT = register(
		"tnt",
		new TntBlock(AbstractBlock.Settings.of().mapColor(MapColor.BRIGHT_RED).breakInstantly().sounds(BlockSoundGroup.GRASS).burnable().solidBlock(Blocks::never))
	);
	public static final Block BOOKSHELF = register(
		"bookshelf",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(1.5F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block CHISELED_BOOKSHELF = register(
		"chiseled_bookshelf",
		new ChiseledBookshelfBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(1.5F).sounds(BlockSoundGroup.CHISELED_BOOKSHELF).burnable()
		)
	);
	public static final Block MOSSY_COBBLESTONE = register(
		"mossy_cobblestone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block OBSIDIAN = register(
		"obsidian", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(50.0F, 1200.0F))
	);
	public static final Block TORCH = register(
		"torch",
		new TorchBlock(
			AbstractBlock.Settings.of().noCollision().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY),
			ParticleTypes.FLAME
		)
	);
	...
	public static final Block CHEST = register(
		"chest",
		new ChestBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.5F).sounds(BlockSoundGroup.WOOD).burnable(),
			() -> BlockEntityType.CHEST
		)
	);
	public static final Block REDSTONE_WIRE = register(
		"redstone_wire", new RedstoneWireBlock(AbstractBlock.Settings.of().noCollision().breakInstantly().pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block DIAMOND_BLOCK = register(
		"diamond_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIAMOND_BLUE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL))
	);
	...
	public static final Block OAK_SIGN = register(
		"oak_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.OAK
		)
	);
	public static final Block SPRUCE_SIGN = register(
		"spruce_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(SPRUCE_LOG.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.SPRUCE
		)
	);
	public static final Block BIRCH_SIGN = register(
		"birch_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.BIRCH
		)
	);
	public static final Block ACACIA_SIGN = register(
		"acacia_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.ACACIA
		)
	);
	public static final Block CHERRY_SIGN = register(
		"cherry_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(CHERRY_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.CHERRY
		)
	);
	public static final Block JUNGLE_SIGN = register(
		"jungle_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(JUNGLE_LOG.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.JUNGLE
		)
	);
	public static final Block DARK_OAK_SIGN = register(
		"dark_oak_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(DARK_OAK_LOG.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.DARK_OAK
		)
	);
	public static final Block MANGROVE_SIGN = register(
		"mangrove_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(MANGROVE_LOG.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.MANGROVE
		)
	);
	public static final Block BAMBOO_SIGN = register(
		"bamboo_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(BAMBOO_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(),
			WoodType.BAMBOO
		)
	);
	...
	public static final Block LADDER = register(
		"ladder",
		new LadderBlock(AbstractBlock.Settings.of().notSolid().strength(0.4F).sounds(BlockSoundGroup.LADDER).nonOpaque().pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block RAIL = register("rail", new RailBlock(AbstractBlock.Settings.of().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL)));
	...
	public static final Block OAK_WALL_SIGN = register(
		"oak_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).dropsLike(OAK_SIGN).burnable(),
			WoodType.OAK
		)
	);
	...
	public static final Block BIRCH_WALL_SIGN = register(
		"birch_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).dropsLike(BIRCH_SIGN).burnable(),
			WoodType.BIRCH
		)
	);
	public static final Block ACACIA_WALL_SIGN = register(
		"acacia_wall_sign",
		new WallSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).dropsLike(ACACIA_SIGN).burnable(),
			WoodType.ACACIA
		)
	);
	...
	public static final Block OAK_HANGING_SIGN = register(
		...
		new HangingSignBlock(
			AbstractBlock.Settings.of().mapColor(OAK_LOG.getDefaultMapColor()).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.OAK
		)
	);
	...
	public static final Block CHERRY_HANGING_SIGN = register(
		"cherry_hanging_sign",
		new HangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_PINK).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.CHERRY
		)
	);
	...
	public static final Block CRIMSON_HANGING_SIGN = register(
		...
		new HangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DULL_PINK).solid().instrument(Instrument.BASS).noCollision().strength(1.0F), WoodType.CRIMSON
		)
	);
	public static final Block WARPED_HANGING_SIGN = register(
		"warped_hanging_sign",
		new HangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_AQUA).solid().instrument(Instrument.BASS).noCollision().strength(1.0F), WoodType.WARPED
		)
	);
	...
	public static final Block BAMBOO_HANGING_SIGN = register(
		"bamboo_hanging_sign",
		new HangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).burnable(), WoodType.BAMBOO
		)
	);
	...
	public static final Block CRIMSON_WALL_HANGING_SIGN = register(
		...
		new WallHangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DULL_PINK).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).dropsLike(CRIMSON_HANGING_SIGN),
			WoodType.CRIMSON
		)
	);
	public static final Block WARPED_WALL_HANGING_SIGN = register(
		...
		new WallHangingSignBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_AQUA).solid().instrument(Instrument.BASS).noCollision().strength(1.0F).dropsLike(WARPED_HANGING_SIGN),
			WoodType.WARPED
		)
	);
	...
	public static final Block LEVER = register(
		"lever", new LeverBlock(AbstractBlock.Settings.of().noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block IRON_DOOR = register(
		"iron_door",
		new DoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.IRON_GRAY).requiresTool().strength(5.0F).nonOpaque().pistonBehavior(PistonBehavior.DESTROY), BlockSetType.IRON
		)
	);
	...
	public static final Block SNOW_BLOCK = register(
		"snow_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.WHITE).requiresTool().strength(0.2F).sounds(BlockSoundGroup.SNOW))
	);
	public static final Block CACTUS = register(
		"cactus",
		new CactusBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_GREEN).ticksRandomly().strength(0.4F).sounds(BlockSoundGroup.WOOL).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block CLAY = register(
		"clay", new Block(AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY).instrument(Instrument.FLUTE).strength(0.6F).sounds(BlockSoundGroup.GRAVEL))
	);
	...
	public static final Block JUKEBOX = register(
		"jukebox", new JukeboxBlock(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(2.0F, 6.0F).burnable())
	);
	...
	public static final Block NETHERRACK = register(
		"netherrack",
		new NetherrackBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_RED).instrument(Instrument.BASEDRUM).requiresTool().strength(0.4F).sounds(BlockSoundGroup.NETHERRACK)
		)
	);
	...
	public static final Block SOUL_SOIL = register(
		"soul_soil", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).strength(0.5F).sounds(BlockSoundGroup.SOUL_SOIL))
	);
	public static final Block BASALT = register(
		"basalt",
		new PillarBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F).sounds(BlockSoundGroup.BASALT)
		)
	);
	...
	public static final Block SOUL_TORCH = register(
		"soul_torch",
		new TorchBlock(
			AbstractBlock.Settings.of().noCollision().breakInstantly().luminance(state -> 10).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY),
	...
	public static final Block CAKE = register(
		"cake", new CakeBlock(AbstractBlock.Settings.of().solid().strength(0.5F).sounds(BlockSoundGroup.WOOL).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block REPEATER = register(
		"repeater", new RepeaterBlock(AbstractBlock.Settings.of().breakInstantly().sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block OAK_TRAPDOOR = register(
		"oak_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.OAK
		)
	);
	public static final Block SPRUCE_TRAPDOOR = register(
		"spruce_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.SPRUCE_BROWN).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.SPRUCE
		)
	);
	public static final Block BIRCH_TRAPDOOR = register(
		"birch_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.BIRCH
		)
	);
	public static final Block JUNGLE_TRAPDOOR = register(
		"jungle_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.JUNGLE
		)
	);
	public static final Block ACACIA_TRAPDOOR = register(
		"acacia_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.ACACIA
		)
	);
	...
	public static final Block DARK_OAK_TRAPDOOR = register(
		"dark_oak_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.BROWN).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.DARK_OAK
		)
	);
	public static final Block MANGROVE_TRAPDOOR = register(
		"mangrove_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.MANGROVE
		)
	);
	public static final Block BAMBOO_TRAPDOOR = register(
		"bamboo_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.BASS).strength(3.0F).nonOpaque().allowsSpawning(Blocks::never).burnable(),
			BlockSetType.BAMBOO
		)
	);
	public static final Block STONE_BRICKS = register(
		"stone_bricks", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block MOSSY_STONE_BRICKS = register(
		"mossy_stone_bricks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block INFESTED_STONE = register("infested_stone", new InfestedBlock(STONE, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY)));
	public static final Block INFESTED_COBBLESTONE = register(
		"infested_cobblestone", new InfestedBlock(COBBLESTONE, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY))
	);
	public static final Block INFESTED_STONE_BRICKS = register(
		"infested_stone_bricks", new InfestedBlock(STONE_BRICKS, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY))
	);
	public static final Block INFESTED_MOSSY_STONE_BRICKS = register(
		"infested_mossy_stone_bricks", new InfestedBlock(MOSSY_STONE_BRICKS, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY))
	);
	public static final Block INFESTED_CRACKED_STONE_BRICKS = register(
		"infested_cracked_stone_bricks", new InfestedBlock(CRACKED_STONE_BRICKS, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY))
	);
	public static final Block INFESTED_CHISELED_STONE_BRICKS = register(
		"infested_chiseled_stone_bricks", new InfestedBlock(CHISELED_STONE_BRICKS, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE_GRAY))
	);
	public static final Block BROWN_MUSHROOM_BLOCK = register(
		"brown_mushroom_block",
		new MushroomBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(0.2F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block RED_MUSHROOM_BLOCK = register(
		"red_mushroom_block",
		new MushroomBlock(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASS).strength(0.2F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block MUSHROOM_STEM = register(
		"mushroom_stem",
		new MushroomBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.WHITE_GRAY).instrument(Instrument.BASS).strength(0.2F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block IRON_BARS = register(
		"iron_bars", new PaneBlock(AbstractBlock.Settings.of().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).nonOpaque())
	);
	public static final Block CHAIN = register(
		"chain", new ChainBlock(AbstractBlock.Settings.of().solid().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.CHAIN).nonOpaque())
	);
	public static final Block GLASS_PANE = register(
		"glass_pane", new PaneBlock(AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block MELON = register(
		"melon",
		new MelonBlock(AbstractBlock.Settings.of().mapColor(MapColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block OAK_FENCE_GATE = register(
		"oak_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(), WoodType.OAK
		)
	);
	...
	public static final Block MYCELIUM = register(
		"mycelium", new MyceliumBlock(AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).ticksRandomly().strength(0.6F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block NETHER_WART = register(
		"nether_wart",
		new NetherWartBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.RED).noCollision().ticksRandomly().sounds(BlockSoundGroup.NETHER_WART).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block ENCHANTING_TABLE = register(
		"enchanting_table",
		new EnchantingTableBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASEDRUM).requiresTool().luminance(state -> 7).strength(5.0F, 1200.0F)
		)
	);
	public static final Block BREWING_STAND = register(
		"brewing_stand",
		new BrewingStandBlock(AbstractBlock.Settings.of().mapColor(MapColor.IRON_GRAY).requiresTool().strength(0.5F).luminance(state -> 1).nonOpaque())
	);
	public static final Block CAULDRON = register(
		"cauldron", new CauldronBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).requiresTool().strength(2.0F).nonOpaque())
	);
	...
	public static final Block END_STONE = register(
		"end_stone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(3.0F, 9.0F))
	);
	public static final Block DRAGON_EGG = register(
		"dragon_egg",
		new DragonEggBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.BLACK).strength(3.0F, 9.0F).luminance(state -> 1).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block REDSTONE_LAMP = register(
		"redstone_lamp",
		new RedstoneLampBlock(
			AbstractBlock.Settings.of().luminance(createLightLevelFromLitBlockState(15)).strength(0.3F).sounds(BlockSoundGroup.GLASS).allowsSpawning(Blocks::always)
		)
	);
	...
	public static final Block ENDER_CHEST = register(
		"ender_chest",
		new EnderChestBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(22.5F, 600.0F).luminance(state -> 7)
		)
	);
	public static final Block TRIPWIRE_HOOK = register(
		"tripwire_hook", new TripwireHookBlock(AbstractBlock.Settings.of().noCollision().pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block TRIPWIRE = register(
		"tripwire", new TripwireBlock((TripwireHookBlock)TRIPWIRE_HOOK, AbstractBlock.Settings.of().noCollision().pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block EMERALD_BLOCK = register(
		"emerald_block",
		new Block(
			AbstractBlock.Settings.of().mapColor(MapColor.EMERALD_GREEN).instrument(Instrument.BIT).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)
		)
	);
	...
	public static final Block COMMAND_BLOCK = register(
		"command_block", new CommandBlock(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing(), false)
	);
	...
	public static final Block SKELETON_SKULL = register(
		"skeleton_skull",
		new SkullBlock(SkullBlock.Type.SKELETON, AbstractBlock.Settings.of().instrument(Instrument.SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block SKELETON_WALL_SKULL = register(
		"skeleton_wall_skull",
		new WallSkullBlock(SkullBlock.Type.SKELETON, AbstractBlock.Settings.of().strength(1.0F).dropsLike(SKELETON_SKULL).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block WITHER_SKELETON_SKULL = register(
		"wither_skeleton_skull",
		new WitherSkullBlock(AbstractBlock.Settings.of().instrument(Instrument.WITHER_SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block WITHER_SKELETON_WALL_SKULL = register(
		"wither_skeleton_wall_skull",
		new WallWitherSkullBlock(AbstractBlock.Settings.of().strength(1.0F).dropsLike(WITHER_SKELETON_SKULL).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block ZOMBIE_HEAD = register(
		"zombie_head",
		new SkullBlock(SkullBlock.Type.ZOMBIE, AbstractBlock.Settings.of().instrument(Instrument.ZOMBIE).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block ZOMBIE_WALL_HEAD = register(
		"zombie_wall_head",
		new WallSkullBlock(SkullBlock.Type.ZOMBIE, AbstractBlock.Settings.of().strength(1.0F).dropsLike(ZOMBIE_HEAD).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block PLAYER_HEAD = register(
		"player_head", new PlayerSkullBlock(AbstractBlock.Settings.of().instrument(Instrument.CUSTOM_HEAD).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block PLAYER_WALL_HEAD = register(
		"player_wall_head", new WallPlayerSkullBlock(AbstractBlock.Settings.of().strength(1.0F).dropsLike(PLAYER_HEAD).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block CREEPER_HEAD = register(
		"creeper_head",
		new SkullBlock(SkullBlock.Type.CREEPER, AbstractBlock.Settings.of().instrument(Instrument.CREEPER).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block CREEPER_WALL_HEAD = register(
		"creeper_wall_head",
		new WallSkullBlock(SkullBlock.Type.CREEPER, AbstractBlock.Settings.of().strength(1.0F).dropsLike(CREEPER_HEAD).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block DRAGON_HEAD = register(
		"dragon_head",
		new SkullBlock(SkullBlock.Type.DRAGON, AbstractBlock.Settings.of().instrument(Instrument.DRAGON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block DRAGON_WALL_HEAD = register(
		"dragon_wall_head",
		new WallSkullBlock(SkullBlock.Type.DRAGON, AbstractBlock.Settings.of().strength(1.0F).dropsLike(DRAGON_HEAD).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block PIGLIN_HEAD = register(
		"piglin_head",
		new SkullBlock(SkullBlock.Type.PIGLIN, AbstractBlock.Settings.of().instrument(Instrument.PIGLIN).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block PIGLIN_WALL_HEAD = register(
		"piglin_wall_head", new WallPiglinHeadBlock(AbstractBlock.Settings.of().strength(1.0F).dropsLike(PIGLIN_HEAD).pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = register(
		...
		new WeightedPressurePlateBlock(
			15,
			AbstractBlock.Settings.of().mapColor(MapColor.GOLD).solid().requiresTool().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY),
			BlockSetType.GOLD
		)
	);
	public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register(
		...
		new WeightedPressurePlateBlock(
			150,
			AbstractBlock.Settings.of().mapColor(MapColor.IRON_GRAY).solid().requiresTool().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY),
			BlockSetType.IRON
		)
	);
	public static final Block COMPARATOR = register(
		"comparator", new ComparatorBlock(AbstractBlock.Settings.of().breakInstantly().sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block DAYLIGHT_DETECTOR = register(
		"daylight_detector",
		new DaylightDetectorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(0.2F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block REDSTONE_BLOCK = register(
		"redstone_block",
		new RedstoneBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.BRIGHT_RED).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL).solidBlock(Blocks::never)
		)
	);
	...
	public static final Block HOPPER = register(
		"hopper",
		new HopperBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).requiresTool().strength(3.0F, 4.8F).sounds(BlockSoundGroup.METAL).nonOpaque())
	);
	public static final Block QUARTZ_BLOCK = register(
		"quartz_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block CHISELED_QUARTZ_BLOCK = register(
		"chiseled_quartz_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block QUARTZ_PILLAR = register(
		"quartz_pillar", new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	...
	public static final Block ACTIVATOR_RAIL = register(
		"activator_rail", new PoweredRailBlock(AbstractBlock.Settings.of().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL))
	);
	public static final Block DROPPER = register(
		"dropper", new DropperBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(3.5F))
	);
	public static final Block WHITE_TERRACOTTA = register(
		"white_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block ORANGE_TERRACOTTA = register(
		"orange_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block MAGENTA_TERRACOTTA = register(
		"magenta_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block LIGHT_BLUE_TERRACOTTA = register(
		"light_blue_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block YELLOW_TERRACOTTA = register(
		"yellow_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block LIME_TERRACOTTA = register(
		"lime_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block PINK_TERRACOTTA = register(
		"pink_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block GRAY_TERRACOTTA = register(
		"gray_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block LIGHT_GRAY_TERRACOTTA = register(
		"light_gray_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block CYAN_TERRACOTTA = register(
		"cyan_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block PURPLE_TERRACOTTA = register(
		"purple_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block BLUE_TERRACOTTA = register(
		"blue_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block BROWN_TERRACOTTA = register(
		"brown_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block GREEN_TERRACOTTA = register(
		"green_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block RED_TERRACOTTA = register(
		"red_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block BLACK_TERRACOTTA = register(
		"black_terracotta",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block WHITE_STAINED_GLASS_PANE = register(
		"white_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.WHITE, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block ORANGE_STAINED_GLASS_PANE = register(
		"orange_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.ORANGE, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block MAGENTA_STAINED_GLASS_PANE = register(
		"magenta_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.MAGENTA, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block LIGHT_BLUE_STAINED_GLASS_PANE = register(
		"light_blue_stained_glass_pane",
		new StainedGlassPaneBlock(
			DyeColor.LIGHT_BLUE, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque()
		)
	);
	public static final Block YELLOW_STAINED_GLASS_PANE = register(
		"yellow_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.YELLOW, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block LIME_STAINED_GLASS_PANE = register(
		"lime_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.LIME, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block PINK_STAINED_GLASS_PANE = register(
		"pink_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.PINK, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block GRAY_STAINED_GLASS_PANE = register(
		"gray_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.GRAY, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block LIGHT_GRAY_STAINED_GLASS_PANE = register(
		"light_gray_stained_glass_pane",
		new StainedGlassPaneBlock(
			DyeColor.LIGHT_GRAY, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque()
		)
	);
	public static final Block CYAN_STAINED_GLASS_PANE = register(
		"cyan_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.CYAN, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block PURPLE_STAINED_GLASS_PANE = register(
		"purple_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.PURPLE, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block BLUE_STAINED_GLASS_PANE = register(
		"blue_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.BLUE, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block BROWN_STAINED_GLASS_PANE = register(
		"brown_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.BROWN, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block GREEN_STAINED_GLASS_PANE = register(
		"green_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.GREEN, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block RED_STAINED_GLASS_PANE = register(
		"red_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.RED, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	public static final Block BLACK_STAINED_GLASS_PANE = register(
		"black_stained_glass_pane",
		new StainedGlassPaneBlock(DyeColor.BLACK, AbstractBlock.Settings.of().instrument(Instrument.HAT).strength(0.3F).sounds(BlockSoundGroup.GLASS).nonOpaque())
	);
	...
	public static final Block SLIME_BLOCK = register(
		"slime_block", new SlimeBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_GREEN).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME).nonOpaque())
	);
	...
	public static final Block LIGHT = register(
		"light",
		new LightBlock(AbstractBlock.Settings.of().replaceable().strength(-1.0F, 3600000.8F).dropsNothing().nonOpaque().luminance(LightBlock.STATE_TO_LUMINANCE))
	);
	public static final Block IRON_TRAPDOOR = register(
		"iron_trapdoor",
		new TrapdoorBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.IRON_GRAY).requiresTool().strength(5.0F).nonOpaque().allowsSpawning(Blocks::never), BlockSetType.IRON
		)
	);
	public static final Block PRISMARINE = register(
		"prismarine", new Block(AbstractBlock.Settings.of().mapColor(MapColor.CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block PRISMARINE_BRICKS = register(
		"prismarine_bricks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIAMOND_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block DARK_PRISMARINE = register(
		"dark_prismarine", new Block(AbstractBlock.Settings.of().mapColor(MapColor.DIAMOND_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block PRISMARINE_SLAB = register(
		"prismarine_slab", new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block PRISMARINE_BRICK_SLAB = register(
		"prismarine_brick_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.DIAMOND_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block HAY_BLOCK = register(
		"hay_block", new HayBlock(AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.BANJO).strength(0.5F).sounds(BlockSoundGroup.GRASS))
	);
	public static final Block WHITE_CARPET = register(
		"white_carpet",
		new DyedCarpetBlock(DyeColor.WHITE, AbstractBlock.Settings.of().mapColor(MapColor.WHITE).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block ORANGE_CARPET = register(
		"orange_carpet",
		new DyedCarpetBlock(DyeColor.ORANGE, AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block MAGENTA_CARPET = register(
		"magenta_carpet",
		new DyedCarpetBlock(DyeColor.MAGENTA, AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIGHT_BLUE_CARPET = register(
		"light_blue_carpet",
		new DyedCarpetBlock(DyeColor.LIGHT_BLUE, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block YELLOW_CARPET = register(
		"yellow_carpet",
		new DyedCarpetBlock(DyeColor.YELLOW, AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIME_CARPET = register(
		"lime_carpet", new DyedCarpetBlock(DyeColor.LIME, AbstractBlock.Settings.of().mapColor(MapColor.LIME).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block PINK_CARPET = register(
		"pink_carpet", new DyedCarpetBlock(DyeColor.PINK, AbstractBlock.Settings.of().mapColor(MapColor.PINK).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block GRAY_CARPET = register(
		"gray_carpet", new DyedCarpetBlock(DyeColor.GRAY, AbstractBlock.Settings.of().mapColor(MapColor.GRAY).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block LIGHT_GRAY_CARPET = register(
		"light_gray_carpet",
		new DyedCarpetBlock(DyeColor.LIGHT_GRAY, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_GRAY).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block CYAN_CARPET = register(
		"cyan_carpet", new DyedCarpetBlock(DyeColor.CYAN, AbstractBlock.Settings.of().mapColor(MapColor.CYAN).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block PURPLE_CARPET = register(
		"purple_carpet",
		new DyedCarpetBlock(DyeColor.PURPLE, AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BLUE_CARPET = register(
		"blue_carpet", new DyedCarpetBlock(DyeColor.BLUE, AbstractBlock.Settings.of().mapColor(MapColor.BLUE).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BROWN_CARPET = register(
		"brown_carpet",
		new DyedCarpetBlock(DyeColor.BROWN, AbstractBlock.Settings.of().mapColor(MapColor.BROWN).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block GREEN_CARPET = register(
		"green_carpet",
		new DyedCarpetBlock(DyeColor.GREEN, AbstractBlock.Settings.of().mapColor(MapColor.GREEN).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block RED_CARPET = register(
		"red_carpet", new DyedCarpetBlock(DyeColor.RED, AbstractBlock.Settings.of().mapColor(MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block BLACK_CARPET = register(
		"black_carpet",
		new DyedCarpetBlock(DyeColor.BLACK, AbstractBlock.Settings.of().mapColor(MapColor.BLACK).strength(0.1F).sounds(BlockSoundGroup.WOOL).burnable())
	);
	public static final Block TERRACOTTA = register(
		"terracotta", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F))
	);
	public static final Block COAL_BLOCK = register(
		"coal_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(5.0F, 6.0F))
	);
	public static final Block PACKED_ICE = register(
		"packed_ice",
		new Block(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_PURPLE).instrument(Instrument.CHIME).slipperiness(0.98F).strength(0.5F).sounds(BlockSoundGroup.GLASS)
		)
	);
	...
	public static final Block RED_SANDSTONE = register(
		"red_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block CHISELED_RED_SANDSTONE = register(
		"chiseled_red_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	public static final Block CUT_RED_SANDSTONE = register(
		"cut_red_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F))
	);
	...
	public static final Block OAK_SLAB = register(
		"oak_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block BIRCH_SLAB = register(
		"birch_slab",
		new SlabBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block JUNGLE_SLAB = register(
		"jungle_slab",
		new SlabBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable()
		)
	);
	public static final Block ACACIA_SLAB = register(
		"acacia_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block DARK_OAK_SLAB = register(
		"dark_oak_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.BROWN).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block MANGROVE_SLAB = register(
		"mangrove_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block STONE_SLAB = register(
		"stone_slab", new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SMOOTH_STONE_SLAB = register(
		"smooth_stone_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SANDSTONE_SLAB = register(
		"sandstone_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	...
	public static final Block PETRIFIED_OAK_SLAB = register(
		"petrified_oak_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	...
	public static final Block BRICK_SLAB = register(
		"brick_slab", new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	...
	public static final Block QUARTZ_SLAB = register(
		"quartz_slab", new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block RED_SANDSTONE_SLAB = register(
		"red_sandstone_slab",
		new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	...
	public static final Block PURPUR_SLAB = register(
		"purpur_slab", new SlabBlock(AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SMOOTH_STONE = register(
		"smooth_stone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SMOOTH_SANDSTONE = register(
		"smooth_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SMOOTH_QUARTZ = register(
		"smooth_quartz", new Block(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SMOOTH_RED_SANDSTONE = register(
		"smooth_red_sandstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F))
	);
	public static final Block SPRUCE_FENCE_GATE = register(
		"spruce_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(SPRUCE_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.SPRUCE
		)
	);
	public static final Block BIRCH_FENCE_GATE = register(
		"birch_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(BIRCH_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(), WoodType.BIRCH
		)
	);
	public static final Block JUNGLE_FENCE_GATE = register(
		"jungle_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(JUNGLE_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.JUNGLE
		)
	);
	public static final Block ACACIA_FENCE_GATE = register(
		"acacia_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(ACACIA_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.ACACIA
		)
	);
	public static final Block CHERRY_FENCE_GATE = register(
		"cherry_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(CHERRY_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.CHERRY
		)
	);
	public static final Block DARK_OAK_FENCE_GATE = register(
		"dark_oak_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(DARK_OAK_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.DARK_OAK
		)
	);
	public static final Block MANGROVE_FENCE_GATE = register(
		"mangrove_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(MANGROVE_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.MANGROVE
		)
	);
	public static final Block BAMBOO_FENCE_GATE = register(
		"bamboo_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(BAMBOO_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F).burnable(),
			WoodType.BAMBOO
		)
	);
	...
	public static final Block END_ROD = register(
		"end_rod", new EndRodBlock(AbstractBlock.Settings.of().notSolid().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque())
	);
	...
	public static final Block PURPUR_BLOCK = register(
		"purpur_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	public static final Block PURPUR_PILLAR = register(
		"purpur_pillar", new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block END_STONE_BRICKS = register(
		"end_stone_bricks", new Block(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(3.0F, 9.0F))
	);
	...
	public static final Block REPEATING_COMMAND_BLOCK = register(
		...
		new CommandBlock(AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing(), false)
	);
	public static final Block CHAIN_COMMAND_BLOCK = register(
		"chain_command_block", new CommandBlock(AbstractBlock.Settings.of().mapColor(MapColor.GREEN).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing(), true)
	);
	...
	public static final Block NETHER_WART_BLOCK = register(
		"nether_wart_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.RED).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK))
	);
	...
	public static final Block BONE_BLOCK = register(
		"bone_block",
		new PillarBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.XYLOPHONE).requiresTool().strength(2.0F).sounds(BlockSoundGroup.BONE)
		)
	);
	public static final Block STRUCTURE_VOID = register(
		"structure_void",
		new StructureVoidBlock(AbstractBlock.Settings.of().replaceable().noCollision().dropsNothing().noBlockBreakParticles().pistonBehavior(PistonBehavior.DESTROY))
	);
	public static final Block OBSERVER = register(
		"observer",
		new ObserverBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).strength(3.0F).requiresTool().solidBlock(Blocks::never)
		)
	);
	public static final Block SHULKER_BOX = register("shulker_box", createShulkerBoxBlock(null, AbstractBlock.Settings.of().mapColor(MapColor.PURPLE)));
	public static final Block WHITE_SHULKER_BOX = register(
		"white_shulker_box", createShulkerBoxBlock(DyeColor.WHITE, AbstractBlock.Settings.of().mapColor(MapColor.WHITE))
	);
	public static final Block ORANGE_SHULKER_BOX = register(
		"orange_shulker_box", createShulkerBoxBlock(DyeColor.ORANGE, AbstractBlock.Settings.of().mapColor(MapColor.ORANGE))
	);
	public static final Block MAGENTA_SHULKER_BOX = register(
		"magenta_shulker_box", createShulkerBoxBlock(DyeColor.MAGENTA, AbstractBlock.Settings.of().mapColor(MapColor.MAGENTA))
	);
	public static final Block LIGHT_BLUE_SHULKER_BOX = register(
		"light_blue_shulker_box", createShulkerBoxBlock(DyeColor.LIGHT_BLUE, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_BLUE))
	);
	public static final Block YELLOW_SHULKER_BOX = register(
		"yellow_shulker_box", createShulkerBoxBlock(DyeColor.YELLOW, AbstractBlock.Settings.of().mapColor(MapColor.YELLOW))
	);
	public static final Block LIME_SHULKER_BOX = register(
		"lime_shulker_box", createShulkerBoxBlock(DyeColor.LIME, AbstractBlock.Settings.of().mapColor(MapColor.LIME))
	);
	public static final Block PINK_SHULKER_BOX = register(
		"pink_shulker_box", createShulkerBoxBlock(DyeColor.PINK, AbstractBlock.Settings.of().mapColor(MapColor.PINK))
	);
	public static final Block GRAY_SHULKER_BOX = register(
		"gray_shulker_box", createShulkerBoxBlock(DyeColor.GRAY, AbstractBlock.Settings.of().mapColor(MapColor.GRAY))
	);
	public static final Block LIGHT_GRAY_SHULKER_BOX = register(
		"light_gray_shulker_box", createShulkerBoxBlock(DyeColor.LIGHT_GRAY, AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_GRAY))
	);
	public static final Block CYAN_SHULKER_BOX = register(
		"cyan_shulker_box", createShulkerBoxBlock(DyeColor.CYAN, AbstractBlock.Settings.of().mapColor(MapColor.CYAN))
	);
	public static final Block PURPLE_SHULKER_BOX = register(
		"purple_shulker_box", createShulkerBoxBlock(DyeColor.PURPLE, AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_PURPLE))
	);
	public static final Block BLUE_SHULKER_BOX = register(
		"blue_shulker_box", createShulkerBoxBlock(DyeColor.BLUE, AbstractBlock.Settings.of().mapColor(MapColor.BLUE))
	);
	public static final Block BROWN_SHULKER_BOX = register(
		"brown_shulker_box", createShulkerBoxBlock(DyeColor.BROWN, AbstractBlock.Settings.of().mapColor(MapColor.BROWN))
	);
	public static final Block GREEN_SHULKER_BOX = register(
		"green_shulker_box", createShulkerBoxBlock(DyeColor.GREEN, AbstractBlock.Settings.of().mapColor(MapColor.GREEN))
	);
	public static final Block RED_SHULKER_BOX = register(
		"red_shulker_box", createShulkerBoxBlock(DyeColor.RED, AbstractBlock.Settings.of().mapColor(MapColor.RED))
	);
	public static final Block BLACK_SHULKER_BOX = register(
		"black_shulker_box", createShulkerBoxBlock(DyeColor.BLACK, AbstractBlock.Settings.of().mapColor(MapColor.BLACK))
	);
	public static final Block WHITE_GLAZED_TERRACOTTA = register(
		"white_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block ORANGE_GLAZED_TERRACOTTA = register(
		"orange_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	...
	public static final Block YELLOW_GLAZED_TERRACOTTA = register(
		...
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block LIME_GLAZED_TERRACOTTA = register(
		"lime_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block PINK_GLAZED_TERRACOTTA = register(
		"pink_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block GRAY_GLAZED_TERRACOTTA = register(
		"gray_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	...
	public static final Block CYAN_GLAZED_TERRACOTTA = register(
		...
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block PURPLE_GLAZED_TERRACOTTA = register(
		"purple_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block BLUE_GLAZED_TERRACOTTA = register(
		"blue_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block BROWN_GLAZED_TERRACOTTA = register(
		"brown_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block GREEN_GLAZED_TERRACOTTA = register(
		"green_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block RED_GLAZED_TERRACOTTA = register(
		"red_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block BLACK_GLAZED_TERRACOTTA = register(
		"black_glazed_terracotta",
		new GlazedTerracottaBlock(
			AbstractBlock.Settings.of().mapColor(DyeColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.4F).pistonBehavior(PistonBehavior.PUSH_ONLY)
		)
	);
	public static final Block WHITE_CONCRETE = register(
		"white_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block ORANGE_CONCRETE = register(
		"orange_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block MAGENTA_CONCRETE = register(
		"magenta_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block LIGHT_BLUE_CONCRETE = register(
		"light_blue_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.LIGHT_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block YELLOW_CONCRETE = register(
		"yellow_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block LIME_CONCRETE = register(
		"lime_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block PINK_CONCRETE = register(
		"pink_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block GRAY_CONCRETE = register(
		"gray_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block LIGHT_GRAY_CONCRETE = register(
		"light_gray_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.LIGHT_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block CYAN_CONCRETE = register(
		"cyan_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block PURPLE_CONCRETE = register(
		"purple_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block BLUE_CONCRETE = register(
		"blue_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block BROWN_CONCRETE = register(
		"brown_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block GREEN_CONCRETE = register(
		"green_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block RED_CONCRETE = register(
		"red_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block BLACK_CONCRETE = register(
		"black_concrete", new Block(AbstractBlock.Settings.of().mapColor(DyeColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.8F))
	);
	public static final Block WHITE_CONCRETE_POWDER = register(
		"white_concrete_powder",
		new ConcretePowderBlock(
			WHITE_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.WHITE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block ORANGE_CONCRETE_POWDER = register(
		"orange_concrete_powder",
		new ConcretePowderBlock(
			ORANGE_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.ORANGE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block MAGENTA_CONCRETE_POWDER = register(
		"magenta_concrete_powder",
		new ConcretePowderBlock(
			MAGENTA_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.MAGENTA).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block LIGHT_BLUE_CONCRETE_POWDER = register(
		"light_blue_concrete_powder",
		new ConcretePowderBlock(
			LIGHT_BLUE_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.LIGHT_BLUE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block YELLOW_CONCRETE_POWDER = register(
		"yellow_concrete_powder",
		new ConcretePowderBlock(
			YELLOW_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.YELLOW).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block LIME_CONCRETE_POWDER = register(
		"lime_concrete_powder",
		new ConcretePowderBlock(
			LIME_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.LIME).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block PINK_CONCRETE_POWDER = register(
		"pink_concrete_powder",
		new ConcretePowderBlock(
			PINK_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.PINK).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block GRAY_CONCRETE_POWDER = register(
		"gray_concrete_powder",
		new ConcretePowderBlock(
			GRAY_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.GRAY).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block LIGHT_GRAY_CONCRETE_POWDER = register(
		"light_gray_concrete_powder",
		new ConcretePowderBlock(
			LIGHT_GRAY_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.LIGHT_GRAY).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block CYAN_CONCRETE_POWDER = register(
		"cyan_concrete_powder",
		new ConcretePowderBlock(
			CYAN_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.CYAN).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block PURPLE_CONCRETE_POWDER = register(
		"purple_concrete_powder",
		new ConcretePowderBlock(
			PURPLE_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.PURPLE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block BLUE_CONCRETE_POWDER = register(
		"blue_concrete_powder",
		new ConcretePowderBlock(
			BLUE_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.BLUE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block BROWN_CONCRETE_POWDER = register(
		"brown_concrete_powder",
		new ConcretePowderBlock(
			BROWN_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.BROWN).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block GREEN_CONCRETE_POWDER = register(
		"green_concrete_powder",
		new ConcretePowderBlock(
			GREEN_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.GREEN).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block RED_CONCRETE_POWDER = register(
		"red_concrete_powder",
		new ConcretePowderBlock(
			RED_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.RED).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	public static final Block BLACK_CONCRETE_POWDER = register(
		"black_concrete_powder",
		new ConcretePowderBlock(
			BLACK_CONCRETE, AbstractBlock.Settings.of().mapColor(DyeColor.BLACK).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
		)
	);
	...
	public static final Block DRIED_KELP_BLOCK = register(
		"dried_kelp_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.GREEN).strength(0.5F, 2.5F).sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block SNIFFER_EGG = register(
		"sniffer_egg", new SnifferEggBlock(AbstractBlock.Settings.of().mapColor(MapColor.RED).strength(0.5F).sounds(BlockSoundGroup.METAL).nonOpaque())
	);
	public static final Block DEAD_TUBE_CORAL_BLOCK = register(
		"dead_tube_coral_block",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.GRAY).solid().instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block TUBE_CORAL_BLOCK = register(
		...
		new CoralBlockBlock(
			DEAD_TUBE_CORAL_BLOCK,
			AbstractBlock.Settings.of().mapColor(MapColor.BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
		)
	);
	public static final Block BRAIN_CORAL_BLOCK = register(
		...
		new CoralBlockBlock(
			DEAD_BRAIN_CORAL_BLOCK,
			AbstractBlock.Settings.of().mapColor(MapColor.PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
		)
	);
	public static final Block BUBBLE_CORAL_BLOCK = register(
		...
		new CoralBlockBlock(
			DEAD_BUBBLE_CORAL_BLOCK,
			AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
		)
	);
	public static final Block FIRE_CORAL_BLOCK = register(
		...
		new CoralBlockBlock(
			DEAD_FIRE_CORAL_BLOCK,
			AbstractBlock.Settings.of().mapColor(MapColor.RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
		)
	);
	public static final Block HORN_CORAL_BLOCK = register(
		...
		new CoralBlockBlock(
			DEAD_HORN_CORAL_BLOCK,
			AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F).sounds(BlockSoundGroup.CORAL)
		)
	);
	public static final Block DEAD_TUBE_CORAL = register(
		"dead_tube_coral",
		new DeadCoralBlock(AbstractBlock.Settings.of().mapColor(MapColor.GRAY).solid().instrument(Instrument.BASEDRUM).requiresTool().noCollision().breakInstantly())
	);
	...
	public static final Block TUBE_CORAL = register(
		...
		new CoralBlock(
			DEAD_TUBE_CORAL,
			AbstractBlock.Settings.of().mapColor(MapColor.BLUE).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block BRAIN_CORAL = register(
		...
		new CoralBlock(
			DEAD_BRAIN_CORAL,
			AbstractBlock.Settings.of().mapColor(MapColor.PINK).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	...
	public static final Block FIRE_CORAL = register(
		...
		new CoralBlock(
			DEAD_FIRE_CORAL,
			AbstractBlock.Settings.of().mapColor(MapColor.RED).noCollision().breakInstantly().sounds(BlockSoundGroup.WET_GRASS).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	...
	public static final Block DEAD_TUBE_CORAL_FAN = register(
		...
		new DeadCoralFanBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.GRAY).solid().instrument(Instrument.BASEDRUM).requiresTool().noCollision().breakInstantly()
		)
	);
	...
	public static final Block BLUE_ICE = register(
		"blue_ice",
		new TransparentBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_PURPLE).strength(2.8F).slipperiness(0.989F).sounds(BlockSoundGroup.GLASS))
	);
	public static final Block CONDUIT = register(
		"conduit",
		new ConduitBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DIAMOND_BLUE).solid().instrument(Instrument.HAT).strength(3.0F).luminance(state -> 15).nonOpaque()
		)
	);
	...
	public static final Block VOID_AIR = register("void_air", new AirBlock(AbstractBlock.Settings.of().replaceable().noCollision().dropsNothing().air()));
	public static final Block CAVE_AIR = register("cave_air", new AirBlock(AbstractBlock.Settings.of().replaceable().noCollision().dropsNothing().air()));
	...
	public static final Block LOOM = register(
		"loom",
		new LoomBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.5F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block BARREL = register(
		"barrel",
		new BarrelBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.5F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block LECTERN = register(
		"lectern",
		new LecternBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(2.5F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	...
	public static final Block STONECUTTER = register(
		"stonecutter", new StonecutterBlock(AbstractBlock.Settings.of().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(3.5F))
	);
	...
	public static final Block WARPED_HYPHAE = register(
		"warped_hyphae",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.DARK_DULL_PINK).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM))
	);
	...
	public static final Block WARPED_FUNGUS = register(
		"warped_fungus",
		new FungusBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.CYAN).breakInstantly().noCollision().sounds(BlockSoundGroup.FUNGUS).pistonBehavior(PistonBehavior.DESTROY),
			TreeConfiguredFeatures.WARPED_FUNGUS_PLANTED,
			WARPED_NYLIUM
		)
	);
	public static final Block WARPED_WART_BLOCK = register(
		"warped_wart_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BRIGHT_TEAL).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK))
	);
	...
	public static final Block CRIMSON_HYPHAE = register(
		"crimson_hyphae",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.DARK_CRIMSON).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM))
	);
	...
	public static final Block CRIMSON_FUNGUS = register(
		"crimson_fungus",
		new FungusBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_RED).breakInstantly().noCollision().sounds(BlockSoundGroup.FUNGUS).pistonBehavior(PistonBehavior.DESTROY),
			TreeConfiguredFeatures.CRIMSON_FUNGUS_PLANTED,
			CRIMSON_NYLIUM
		)
	);
	public static final Block SHROOMLIGHT = register(
		"shroomlight", new Block(AbstractBlock.Settings.of().mapColor(MapColor.RED).strength(1.0F).sounds(BlockSoundGroup.SHROOMLIGHT).luminance(state -> 15))
	);
	...
	public static final Block CRIMSON_PLANKS = register(
		"crimson_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.DULL_PINK).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.NETHER_WOOD))
	);
	public static final Block WARPED_PLANKS = register(
		"warped_planks",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.DARK_AQUA).instrument(Instrument.BASS).strength(2.0F, 3.0F).sounds(BlockSoundGroup.NETHER_WOOD))
	);
	...
	public static final Block CRIMSON_FENCE_GATE = register(
		"crimson_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(CRIMSON_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F), WoodType.CRIMSON
		)
	);
	public static final Block WARPED_FENCE_GATE = register(
		"warped_fence_gate",
		new FenceGateBlock(
			AbstractBlock.Settings.of().mapColor(WARPED_PLANKS.getDefaultMapColor()).solid().instrument(Instrument.BASS).strength(2.0F, 3.0F), WoodType.WARPED
		)
	);
	...
	public static final Block CRIMSON_SIGN = register(
		"crimson_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(CRIMSON_PLANKS.getDefaultMapColor()).instrument(Instrument.BASS).solid().noCollision().strength(1.0F), WoodType.CRIMSON
		)
	);
	public static final Block WARPED_SIGN = register(
		"warped_sign",
		new SignBlock(
			AbstractBlock.Settings.of().mapColor(WARPED_PLANKS.getDefaultMapColor()).instrument(Instrument.BASS).solid().noCollision().strength(1.0F), WoodType.WARPED
		)
	);
	...
	public static final Block STRUCTURE_BLOCK = register(
		"structure_block", new StructureBlock(AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_GRAY).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing())
	);
	public static final Block JIGSAW = register(
		"jigsaw", new JigsawBlock(AbstractBlock.Settings.of().mapColor(MapColor.LIGHT_GRAY).requiresTool().strength(-1.0F, 3600000.0F).dropsNothing())
	);
	public static final Block COMPOSTER = register(
		"composter",
		new ComposterBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(0.6F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block TARGET = register(
		"target", new TargetBlock(AbstractBlock.Settings.of().mapColor(MapColor.OFF_WHITE).strength(0.5F).sounds(BlockSoundGroup.GRASS))
	);
	public static final Block BEE_NEST = register(
		"bee_nest",
		new BeehiveBlock(AbstractBlock.Settings.of().mapColor(MapColor.YELLOW).instrument(Instrument.BASS).strength(0.3F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block BEEHIVE = register(
		"beehive",
		new BeehiveBlock(AbstractBlock.Settings.of().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASS).strength(0.6F).sounds(BlockSoundGroup.WOOD).burnable())
	);
	public static final Block HONEY_BLOCK = register(
		"honey_block",
		new HoneyBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).velocityMultiplier(0.4F).jumpVelocityMultiplier(0.5F).nonOpaque().sounds(BlockSoundGroup.HONEY)
		)
	);
	public static final Block HONEYCOMB_BLOCK = register(
		"honeycomb_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).strength(0.6F).sounds(BlockSoundGroup.CORAL))
	);
	public static final Block NETHERITE_BLOCK = register(
		"netherite_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).requiresTool().strength(50.0F, 1200.0F).sounds(BlockSoundGroup.NETHERITE))
	);
	public static final Block ANCIENT_DEBRIS = register(
		"ancient_debris",
		new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).requiresTool().strength(30.0F, 1200.0F).sounds(BlockSoundGroup.ANCIENT_DEBRIS))
	);
	public static final Block CRYING_OBSIDIAN = register(
		"crying_obsidian",
		new CryingObsidianBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(50.0F, 1200.0F).luminance(state -> 10)
		)
	);
	...
	public static final Block BLACKSTONE = register(
		"blackstone", new Block(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.5F, 6.0F))
	);
	...
	public static final Block AMETHYST_BLOCK = register(
		"amethyst_block",
		new AmethystBlock(AbstractBlock.Settings.of().mapColor(MapColor.PURPLE).strength(1.5F).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool())
	);
	...
	public static final Block POWDER_SNOW = register(
		"powder_snow",
		new PowderSnowBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.WHITE).strength(0.25F).sounds(BlockSoundGroup.POWDER_SNOW).dynamicBounds().solidBlock(Blocks::never)
		)
	);
	...
	public static final Block SCULK = register(
		"sculk", new SculkBlock(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).strength(0.2F).sounds(BlockSoundGroup.SCULK))
	);
	...
	public static final Block SCULK_CATALYST = register(
		"sculk_catalyst",
		new SculkCatalystBlock(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).strength(3.0F, 3.0F).sounds(BlockSoundGroup.SCULK_CATALYST).luminance(state -> 6))
	);
	public static final Block SCULK_SHRIEKER = register(
		"sculk_shrieker", new SculkShriekerBlock(AbstractBlock.Settings.of().mapColor(MapColor.BLACK).strength(3.0F, 3.0F).sounds(BlockSoundGroup.SCULK_SHRIEKER))
	);
	public static final Block OXIDIZED_COPPER = register(
		"oxidized_copper",
		new OxidizableBlock(
			Oxidizable.OxidationLevel.OXIDIZED, AbstractBlock.Settings.of().mapColor(MapColor.TEAL).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)
		)
	);
	public static final Block WEATHERED_COPPER = register(
		...
		new OxidizableBlock(
			...
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_AQUA).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)
		)
	);
	public static final Block EXPOSED_COPPER = register(
		...
		new OxidizableBlock(
			...
			AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)
		)
	);
	public static final Block COPPER_BLOCK = register(
		...
		new OxidizableBlock(
			...
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER)
		)
	);
	...
	public static final Block LIGHTNING_ROD = register(
		...
		new LightningRodBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).solid().requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER).nonOpaque()
		)
	);
	...
	public static final Block MOSS_CARPET = register(
		"moss_carpet",
		new CarpetBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.GREEN).strength(0.1F).sounds(BlockSoundGroup.MOSS_CARPET).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block PINK_PETALS = register(
		"pink_petals",
		new FlowerbedBlock(
			AbstractBlock.Settings.of().mapColor(MapColor.DARK_GREEN).noCollision().sounds(BlockSoundGroup.PINK_PETALS).pistonBehavior(PistonBehavior.DESTROY)
		)
	);
	public static final Block MOSS_BLOCK = register(
		"moss_block",
		new MossBlock(AbstractBlock.Settings.of().mapColor(MapColor.GREEN).strength(0.1F).sounds(BlockSoundGroup.MOSS_BLOCK).pistonBehavior(PistonBehavior.DESTROY))
	);
	...
	public static final Block ROOTED_DIRT = register(
		"rooted_dirt", new RootedDirtBlock(AbstractBlock.Settings.of().mapColor(MapColor.DIRT_BROWN).strength(0.5F).sounds(BlockSoundGroup.ROOTED_DIRT))
	);
	...
	public static final Block INFESTED_DEEPSLATE = register(
		"infested_deepslate", new RotatedInfestedBlock(DEEPSLATE, AbstractBlock.Settings.of().mapColor(MapColor.DEEPSLATE_GRAY).sounds(BlockSoundGroup.DEEPSLATE))
	);
	...
	public static final Block RAW_IRON_BLOCK = register(
		"raw_iron_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.RAW_IRON_PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(5.0F, 6.0F))
	);
	public static final Block RAW_COPPER_BLOCK = register(
		"raw_copper_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(5.0F, 6.0F))
	);
	public static final Block RAW_GOLD_BLOCK = register(
		"raw_gold_block", new Block(AbstractBlock.Settings.of().mapColor(MapColor.GOLD).instrument(Instrument.BASEDRUM).requiresTool().strength(5.0F, 6.0F))
	);
	...
	public static final Block OCHRE_FROGLIGHT = register(
		"ochre_froglight",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.PALE_YELLOW).strength(0.3F).luminance(state -> 15).sounds(BlockSoundGroup.FROGLIGHT))
	);
	public static final Block VERDANT_FROGLIGHT = register(
		"verdant_froglight",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.LICHEN_GREEN).strength(0.3F).luminance(state -> 15).sounds(BlockSoundGroup.FROGLIGHT))
	);
	public static final Block PEARLESCENT_FROGLIGHT = register(
		"pearlescent_froglight",
		new PillarBlock(AbstractBlock.Settings.of().mapColor(MapColor.PINK).strength(0.3F).luminance(state -> 15).sounds(BlockSoundGroup.FROGLIGHT))
	);
	...
	public static final Block REINFORCED_DEEPSLATE = register(
		...
		new Block(
			AbstractBlock.Settings.of().mapColor(MapColor.DEEPSLATE_GRAY).instrument(Instrument.BASEDRUM).sounds(BlockSoundGroup.DEEPSLATE).strength(55.0F, 1200.0F)
		)
	);
	public static final Block DECORATED_POT = register(
		"decorated_pot",
		new DecoratedPotBlock(AbstractBlock.Settings.of().mapColor(MapColor.TERRACOTTA_RED).strength(0.0F, 0.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque())
	);
	...
	private static Block createNetherStemBlock(MapColor mapColor) {
		return new PillarBlock(AbstractBlock.Settings.of().mapColor(state -> mapColor).instrument(Instrument.BASS).strength(2.0F).sounds(BlockSoundGroup.NETHER_STEM));
	}
	...
	private static ButtonBlock createWoodenButtonBlock(BlockSetType blockSetType, FeatureFlag... requiredFeatures) {
		AbstractBlock.Settings settings = AbstractBlock.Settings.of().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY);
	...
	private static FlowerPotBlock createFlowerPotBlock(Block flower, FeatureFlag... requiredFeatures) {
		AbstractBlock.Settings settings = AbstractBlock.Settings.of().breakInstantly().nonOpaque().pistonBehavior(PistonBehavior.DESTROY);
		if (requiredFeatures.length > 0) {
			settings = settings.requires(requiredFeatures);
		}
