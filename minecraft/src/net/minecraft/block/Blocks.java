...
public class Blocks {
	...
	public static final Block REDSTONE_TORCH = register(
		...
		new RedstoneTorchBlock(
			AbstractBlock.Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance(createLightLevelFromBlockState(7)).sounds(BlockSoundGroup.WOOD)
		)
	);
	...
	public static final Block NETHER_QUARTZ_ORE = register(
		"nether_quartz_ore",
		new OreBlock(
			AbstractBlock.Settings.of(Material.STONE, MapColor.DARK_RED).requiresTool().strength(3.0F, 3.0F).sounds(BlockSoundGroup.NETHER_ORE), IntRange.between(2, 5)
		)
	);
	...
	public static final Block BAMBOO = register(
		"bamboo",
		new BambooBlock(
			AbstractBlock.Settings.of(Material.BAMBOO, MapColor.DARK_GREEN).ticksRandomly().breakInstantly().strength(1.0F).sounds(BlockSoundGroup.BAMBOO).nonOpaque()
		)
	);
	...
	public static final Block CRIMSON_ROOTS = register(
		"crimson_roots",
		new RootsBlock(AbstractBlock.Settings.of(Material.NETHER_SHOOTS, MapColor.DARK_RED).noCollision().breakInstantly().sounds(BlockSoundGroup.ROOTS))
	);
	...
	public static final Block WEATHERED_COPPER_BLOCK = register(
		...
		new Block(AbstractBlock.Settings.of(Material.METAL, MapColor.TEAL).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER))
	);
	public static final Block SEMI_WEATHERED_COPPER_BLOCK = register(
		"semi_weathered_copper_block",
		new CopperBlock(
			AbstractBlock.Settings.of(Material.METAL, MapColor.DARK_AQUA).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER), WEATHERED_COPPER_BLOCK
		)
	);
