...
public class Blocks {
	...
	public static final Block TORCH = register(
		"torch",
		new TorchBlock(
			AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(blockStatex -> 14).sounds(BlockSoundGroup.WOOD),
			ParticleTypes.FLAME
		)
	);
	...
	public static final Block SOUL_FIRE = register(
		"soul_fire",
		new SoulFireBlock(
			AbstractBlock.Settings.of(Material.FIRE, MaterialColor.LIGHT_BLUE)
				.noCollision()
				.breakInstantly()
	...
	public static final Block SEA_PICKLE = register(
		...
		new SeaPickleBlock(
			AbstractBlock.Settings.of(Material.UNDERWATER_PLANT, MaterialColor.GREEN)
				.lightLevel(blockStatex -> SeaPickleBlock.isDry(blockStatex) ? 0 : 3 + 3 * blockStatex.get(SeaPickleBlock.PICKLES))
