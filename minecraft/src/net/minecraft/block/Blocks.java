...
public class Blocks {
	...
	public static final Block field_10482 = register(
		"magenta_carpet",
		new CarpetBlock(DyeColor.field_7958, Block.Settings.of(Material.CARPET, MaterialColor.MAGENTA).strength(0.1F).sounds(BlockSoundGroup.WOOL))
	);
	...
	public static final Block field_10452 = register(
		"light_blue_banner",
		new StandingBannerBlock(DyeColor.field_7951, Block.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_9985 = register(
		"light_gray_banner",
		new StandingBannerBlock(DyeColor.field_7967, Block.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_10199 = register(
		"white_shulker_box",
		new ShulkerBoxBlock(DyeColor.field_7952, Block.Settings.of(Material.SHULKER_BOX, MaterialColor.WHITE).strength(2.0F).hasDynamicBounds())
	);
	...
	public static final Block field_10373 = register(
		"brown_shulker_box",
		new ShulkerBoxBlock(DyeColor.field_7957, Block.Settings.of(Material.SHULKER_BOX, MaterialColor.BROWN).strength(2.0F).hasDynamicBounds())
	);
	public static final Block field_10055 = register(
		"green_shulker_box",
		new ShulkerBoxBlock(DyeColor.field_7942, Block.Settings.of(Material.SHULKER_BOX, MaterialColor.GREEN).strength(2.0F).hasDynamicBounds())
	);
	...
	public static final Block field_17563 = register(
		"composter", new ComposterBlock(Block.Settings.of(Material.WOOD).strength(0.6F).sounds(BlockSoundGroup.WOOD))
	);
