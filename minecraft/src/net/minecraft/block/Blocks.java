...
public class Blocks {
	...
	public static final Block GLASS = register("glass", new GlassBlock(Block.Settings.of(Material.GLASS).strength(0.3F).sounds(BlockSoundGroup.GLASS)));
	...
	public static final Block SPAWNER = register("spawner", new SpawnerBlock(Block.Settings.of(Material.STONE).strength(5.0F).sounds(BlockSoundGroup.METAL)));
	...
	public static final Block OAK_DOOR = register(
		"oak_door", new DoorBlock(Block.Settings.of(Material.WOOD, OAK_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block LADDER = register("ladder", new LadderBlock(Block.Settings.of(Material.PART).strength(0.4F).sounds(BlockSoundGroup.LADDER)));
	...
	public static final Block GLASS_PANE = register("glass_pane", new PaneBlock(Block.Settings.of(Material.GLASS).strength(0.3F).sounds(BlockSoundGroup.GLASS)));
	...
	public static final Block LILY_PAD = register("lily_pad", new LilyPadBlock(Block.Settings.of(Material.PLANT).breakInstantly().sounds(BlockSoundGroup.GRASS)));
	...
	public static final Block BREWING_STAND = register("brewing_stand", new BrewingStandBlock(Block.Settings.of(Material.METAL).strength(0.5F).lightLevel(1)));
	public static final Block CAULDRON = register("cauldron", new CauldronBlock(Block.Settings.of(Material.METAL, MaterialColor.STONE).strength(2.0F)));
	...
	public static final Block BEACON = register("beacon", new BeaconBlock(Block.Settings.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0F).lightLevel(15)));
	...
	public static final Block FLOWER_POT = register("flower_pot", new FlowerPotBlock(AIR, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_OAK_SAPLING = register(
		"potted_oak_sapling", new FlowerPotBlock(OAK_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_SPRUCE_SAPLING = register(
		"potted_spruce_sapling", new FlowerPotBlock(SPRUCE_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_BIRCH_SAPLING = register(
		"potted_birch_sapling", new FlowerPotBlock(BIRCH_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_JUNGLE_SAPLING = register(
		"potted_jungle_sapling", new FlowerPotBlock(JUNGLE_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_ACACIA_SAPLING = register(
		"potted_acacia_sapling", new FlowerPotBlock(ACACIA_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_DARK_OAK_SAPLING = register(
		"potted_dark_oak_sapling", new FlowerPotBlock(DARK_OAK_SAPLING, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_FERN = register("potted_fern", new FlowerPotBlock(FERN, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_DANDELION = register("potted_dandelion", new FlowerPotBlock(DANDELION, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_POPPY = register("potted_poppy", new FlowerPotBlock(POPPY, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_BLUE_ORCHID = register(
		"potted_blue_orchid", new FlowerPotBlock(BLUE_ORCHID, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_ALLIUM = register("potted_allium", new FlowerPotBlock(ALLIUM, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_AZURE_BLUET = register(
		"potted_azure_bluet", new FlowerPotBlock(AZURE_BLUET, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_RED_TULIP = register("potted_red_tulip", new FlowerPotBlock(RED_TULIP, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_ORANGE_TULIP = register(
		"potted_orange_tulip", new FlowerPotBlock(ORANGE_TULIP, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_WHITE_TULIP = register(
		"potted_white_tulip", new FlowerPotBlock(WHITE_TULIP, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_PINK_TULIP = register("potted_pink_tulip", new FlowerPotBlock(PINK_TULIP, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_OXEYE_DAISY = register(
		"potted_oxeye_daisy", new FlowerPotBlock(OXEYE_DAISY, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_CORNFLOWER = register("potted_cornflower", new FlowerPotBlock(CORNFLOWER, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_LILY_OF_THE_VALLEY = register(
		"potted_lily_of_the_valley", new FlowerPotBlock(LILY_OF_THE_VALLEY, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_WITHER_ROSE = register(
		"potted_wither_rose", new FlowerPotBlock(WITHER_ROSE, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_RED_MUSHROOM = register(
		"potted_red_mushroom", new FlowerPotBlock(RED_MUSHROOM, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_BROWN_MUSHROOM = register(
		"potted_brown_mushroom", new FlowerPotBlock(BROWN_MUSHROOM, Block.Settings.of(Material.PART).breakInstantly())
	);
	public static final Block POTTED_DEAD_BUSH = register("potted_dead_bush", new FlowerPotBlock(DEAD_BUSH, Block.Settings.of(Material.PART).breakInstantly()));
	public static final Block POTTED_CACTUS = register("potted_cactus", new FlowerPotBlock(CACTUS, Block.Settings.of(Material.PART).breakInstantly()));
	...
	public static final Block BARRIER = register("barrier", new BarrierBlock(Block.Settings.of(Material.BARRIER).strength(-1.0F, 3600000.8F).dropsNothing()));
	...
	public static final Block SPRUCE_DOOR = register(
		"spruce_door", new DoorBlock(Block.Settings.of(Material.WOOD, SPRUCE_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block BIRCH_DOOR = register(
		"birch_door", new DoorBlock(Block.Settings.of(Material.WOOD, BIRCH_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block JUNGLE_DOOR = register(
		"jungle_door", new DoorBlock(Block.Settings.of(Material.WOOD, JUNGLE_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block ACACIA_DOOR = register(
		"acacia_door", new DoorBlock(Block.Settings.of(Material.WOOD, ACACIA_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	public static final Block DARK_OAK_DOOR = register(
		"dark_oak_door", new DoorBlock(Block.Settings.of(Material.WOOD, DARK_OAK_PLANKS.materialColor).strength(3.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block CHORUS_FLOWER = register(
		...
		new ChorusFlowerBlock(
			(ChorusPlantBlock)CHORUS_PLANT, Block.Settings.of(Material.PLANT, MaterialColor.PURPLE).ticksRandomly().strength(0.4F).sounds(BlockSoundGroup.WOOD)
		)
	);
	...
	public static final Block POTTED_BAMBOO = register("potted_bamboo", new FlowerPotBlock(BAMBOO, Block.Settings.of(Material.PART).breakInstantly()));
