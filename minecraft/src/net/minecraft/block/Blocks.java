...
public class Blocks {
	...
	public static final Block field_10158 = register(
		...
		new PressurePlateBlock(PressurePlateBlock.ActivationRule.field_11362, Block.Settings.of(Material.STONE).noCollision().strength(0.5F))
	);
	...
	public static final Block field_10371 = register(
		"black_shulker_box",
		new ShulkerBoxBlock(DyeColor.field_7963, Block.Settings.of(Material.SHULKER_BOX, MaterialColor.BLACK).strength(2.0F).hasDynamicBounds())
	);
