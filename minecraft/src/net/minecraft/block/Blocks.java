...
public class Blocks {
	...
	public static final Block field_10449 = register(
		"poppy",
		new FlowerBlock(StatusEffects.field_5925, 5, AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS))
	);
	...
	public static final Block field_10336 = register(
		"torch",
		new TorchBlock(
			AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(state -> 14).sounds(BlockSoundGroup.WOOD),
	...
	public static final Block field_10330 = register(
		"dark_oak_sign",
		new SignBlock(
			AbstractBlock.Settings.of(Material.WOOD, field_10010.getDefaultMaterialColor()).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD),
			SignType.DARK_OAK
		)
	);
	...
	public static final Block field_10350 = register(
		"prismarine_stairs", new StairsBlock(field_10135.getDefaultState(), AbstractBlock.Settings.copy(field_10135))
	);
	...
	public static final Block field_10536 = register(
		"red_carpet",
		new CarpetBlock(DyeColor.field_7964, AbstractBlock.Settings.of(Material.CARPET, MaterialColor.RED).strength(0.1F).sounds(BlockSoundGroup.WOOL))
	);
	...
	public static final Block field_10452 = register(
		"light_blue_banner",
		new BannerBlock(DyeColor.field_7951, AbstractBlock.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_9985 = register(
		"light_gray_banner",
		new BannerBlock(DyeColor.field_7967, AbstractBlock.Settings.of(Material.WOOD).noCollision().strength(1.0F).sounds(BlockSoundGroup.WOOD))
	);
	...
	public static final Block field_23870 = register(
		"blackstone_stairs", new StairsBlock(field_23869.getDefaultState(), AbstractBlock.Settings.copy(field_23869))
	);
	...
	private static PillarBlock createLogBlock(MaterialColor topMaterialColor, MaterialColor sideMaterialColor) {
		return new PillarBlock(
			AbstractBlock.Settings.of(
					Material.WOOD, blockState -> blockState.get(PillarBlock.AXIS) == Direction.Axis.field_11052 ? topMaterialColor : sideMaterialColor
				)
				.strength(2.0F)
				.sounds(BlockSoundGroup.WOOD)
		);
