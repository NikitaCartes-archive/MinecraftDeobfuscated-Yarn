...
public class BubbleColumnBlock extends Block implements FluidDrainable {
	...
	public void onEntityCollision(BlockState blockState, World world, BlockPos blockPos, Entity entity) {
		...
		if (blockState2.isAir()) {
			entity.method_5700(blockState.get(field_10680));
			if (!world.isClient) {
			...
			entity.method_5764(blockState.get(field_10680));
		}
	}
	...
	private static boolean method_9656(BlockView blockView, BlockPos blockPos) {
		...
		if (block == Blocks.field_10422) {
			return blockState.get(field_10680);
		} else {
