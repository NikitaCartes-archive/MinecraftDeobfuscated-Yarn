...
public class StandingSignBlock extends SignBlock {
	...
	public BlockState method_9598(BlockState blockState, Rotation rotation) {
		return blockState.method_11657(field_11559, Integer.valueOf(rotation.method_10502(blockState.method_11654(field_11559), 16)));
	}

	@Override
	public BlockState method_9569(BlockState blockState, Mirror mirror) {
		return blockState.method_11657(field_11559, Integer.valueOf(mirror.method_10344(blockState.method_11654(field_11559), 16)));
	}
