...
public class TripwireBlock extends Block {
	...
	public void scheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (!world.isRemote) {
			if (world.getBlockState(blockPos).get(field_11680)) {
				this.method_10780(world, blockPos);
			}
		}
	}
	...
	private void method_10780(World world, BlockPos blockPos) {
		...
		boolean bl = blockState.get(field_11680);
		boolean bl2 = false;
	...
	public boolean method_10778(BlockState blockState, Direction direction) {
		...
		if (block == this.field_11677) {
			return blockState.get(TripwireHookBlock.field_11666) == direction.getOpposite();
		} else {
			return block == this;
		}
	}
