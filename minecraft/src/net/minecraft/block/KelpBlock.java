...
public class KelpBlock extends Block implements FluidFillable {
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (!blockState.canPlaceAt(world, blockPos)) {
			...
			if (blockState2.getBlock() == Blocks.field_10382 && blockState.method_11654(field_11194) < 25 && random.nextDouble() < 0.14) {
	...
	public boolean method_9558(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		...
		if (block == Blocks.field_10092) {
			...
			return block == this || block == Blocks.field_10463 || Block.method_20045(blockState2, viewableWorld, blockPos2, Direction.field_11036);
		}
	}
