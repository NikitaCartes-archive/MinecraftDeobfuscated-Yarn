...
public class KelpBlock extends Block implements FluidFillable {
	...
	public void onScheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (!blockState.canPlaceAt(world, blockPos)) {
			...
			if (blockState2.getBlock() == Blocks.field_10382 && blockState.get(field_11194) < 25 && random.nextDouble() < 0.14) {
	...
	public boolean canPlaceAt(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		...
		if (block == Blocks.field_10092) {
			...
			return block == this || block == Blocks.field_10463 || Block.isSolidFullSquare(blockState2, viewableWorld, blockPos2, Direction.field_11036);
		}
	}
