...
public abstract class AbstractButtonBlock extends WallMountedBlock {
	...
	public VoxelShape getOutlineShape(BlockState blockState, BlockView blockView, BlockPos blockPos, VerticalEntityPosition verticalEntityPosition) {
		...
		boolean bl = blockState.get(field_10729);
	...
	public void scheduledTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (!world.isClient && blockState.get(field_10729)) {
			if (this.field_10725) {
	...
	public void onEntityCollision(BlockState blockState, World world, BlockPos blockPos, Entity entity) {
		if (!world.isClient && this.field_10725 && !blockState.get(field_10729)) {
			this.method_9715(blockState, world, blockPos);
		}
	}
	...
	private void method_9715(BlockState blockState, World world, BlockPos blockPos) {
		...
		boolean bl2 = blockState.get(field_10729);
		if (bl != bl2) {
