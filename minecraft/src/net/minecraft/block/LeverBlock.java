...
public class LeverBlock extends WallMountedBlock {
	...
	public boolean activate(
		...
		boolean bl = blockState.get(field_11265);
		if (world.isClient) {
			if (bl) {
			...
			world.playSound(null, blockPos, SoundEvents.field_14962, SoundCategory.field_15245, 0.3F, i);
	...
	public void randomDisplayTick(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (blockState.get(field_11265) && random.nextFloat() < 0.25F) {
