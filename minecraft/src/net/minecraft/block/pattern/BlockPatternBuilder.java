...
public class BlockPatternBuilder {
	...
	private final Map<Character, Predicate<BlockProxy>> charMap = Maps.newHashMap();
	private int height;
	private int width;
	...
	private Predicate<BlockProxy>[][][] bakePredicates() {
		this.validate();
		Predicate<BlockProxy>[][][] predicates = (Predicate[][][])Array.newInstance(Predicate.class, new int[]{this.aisles.size(), this.height, this.width});
