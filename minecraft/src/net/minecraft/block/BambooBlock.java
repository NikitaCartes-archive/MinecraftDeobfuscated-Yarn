...
public class BambooBlock extends Block implements Fertilizable {
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if (blockState.method_11654(field_9916) == 0) {
	...
	public BlockState method_9559(BlockState blockState, Direction direction, BlockState blockState2, IWorld iWorld, BlockPos blockPos, BlockPos blockPos2) {
		if (!blockState.method_11591(iWorld, blockPos)) {
			...
			if (direction == Direction.UP && blockState2.getBlock() == Blocks.field_10211 && blockState2.method_11654(field_9914) > blockState.method_11654(field_9914)
				)
			 {
	...
	public void method_9652(World world, Random random, BlockPos blockPos, BlockState blockState) {
		...
		for(int m = 0; m < l; ++m) {
			...
			if (k >= 16 || blockState2.method_11654(field_9916) == 1 || !world.method_8623(blockPos2.up())) {
				return;
			}
