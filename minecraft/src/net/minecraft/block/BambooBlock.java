...
public class BambooBlock extends Block implements Fertilizable {
	...
	public BambooBlock(Block.Settings settings) {
		...
		this.setDefaultState(
			this.stateFactory.getDefaultState().with(AGE, Integer.valueOf(0)).with(LEAVES, BambooLeaves.field_12469).with(STAGE, Integer.valueOf(0))
		);
	}
	...
	public BlockState getStateForNeighborUpdate(
		...
		if (direction == Direction.field_11036 && blockState2.getBlock() == Blocks.field_10211 && blockState2.get(AGE) > blockState.get(AGE)) {
