...
public class BambooBlock extends Block implements Fertilizable {
	...
	public BambooBlock(AbstractBlock.Settings settings) {
		...
		this.setDefaultState(
			this.stateManager.getDefaultState().with(AGE, Integer.valueOf(0)).with(LEAVES, BambooLeaves.field_12469).with(STAGE, Integer.valueOf(0))
		);
	}
	...
	public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState newState, WorldAccess world, BlockPos pos, BlockPos posFrom) {
		...
		if (direction == Direction.field_11036 && newState.isOf(Blocks.field_10211) && newState.get(AGE) > state.get(AGE)) {
