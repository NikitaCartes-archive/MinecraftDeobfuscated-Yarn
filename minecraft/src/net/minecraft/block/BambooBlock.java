...
public class BambooBlock extends Block implements Fertilizable {
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		...
		if (!fluidState.isEmpty()) {
			...
			BlockState blockState = itemPlacementContext.method_8045().method_8320(itemPlacementContext.getBlockPos().down());
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		...
		} else if (blockState.method_11654(field_9916) == 0) {
	...
	public BlockState method_9559(BlockState blockState, Direction direction, BlockState blockState2, IWorld iWorld, BlockPos blockPos, BlockPos blockPos2) {
		...
		if (direction == Direction.field_11036
			...
			&& blockState2.method_11654(field_9914) > blockState.method_11654(field_9914)) {
	...
	public boolean method_9651(BlockView blockView, BlockPos blockPos, BlockState blockState, boolean bl) {
		...
		return i + j + 1 < 16 && blockView.method_8320(blockPos.up(i)).method_11654(field_9916) != 1;
	}
	...
	public void method_9652(World world, Random random, BlockPos blockPos, BlockState blockState) {
		...
		for(int m = 0; m < l; ++m) {
			...
			if (k >= 16 || blockState2.method_11654(field_9916) == 1 || !world.isAir(blockPos2.up())) {
				return;
			}
