...
public class DoorBlock extends Block {
	...
	public VoxelShape method_9530(BlockState blockState, BlockView blockView, BlockPos blockPos, EntityContext entityContext) {
		...
		boolean bl = !blockState.method_11654(field_10945);
	...
	public boolean method_9516(BlockState blockState, BlockView blockView, BlockPos blockPos, BlockPlacementEnvironment blockPlacementEnvironment) {
		switch(blockPlacementEnvironment) {
			case field_50:
				return blockState.method_11654(field_10945);
			case field_48:
				return false;
			case field_51:
				return blockState.method_11654(field_10945);
	...
	public void setOpen(World world, BlockPos blockPos, boolean bl) {
		...
		if (blockState.getBlock() == this && blockState.method_11654(field_10945) != bl) {
	...
	public void method_9612(BlockState blockState, World world, BlockPos blockPos, Block block, BlockPos blockPos2, boolean bl) {
		...
		if (block != this && bl2 != blockState.method_11654(field_10940)) {
			if (bl2 != blockState.method_11654(field_10945)) {
	...
	public boolean method_9558(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		...
		if (blockState.method_11654(field_10946) == DoubleBlockHalf.field_12607) {
			return Block.method_20045(blockState2, viewableWorld, blockPos2, Direction.field_11036);
		} else {
