...
public class DoorBlock extends Block {
	...
	public VoxelShape getOutlineShape(BlockState blockState, BlockView blockView, BlockPos blockPos, VerticalEntityPosition verticalEntityPosition) {
		...
		boolean bl = !blockState.get(field_10945);
	...
	public boolean canPlaceAtSide(BlockState blockState, BlockView blockView, BlockPos blockPos, BlockPlacementEnvironment blockPlacementEnvironment) {
		switch(blockPlacementEnvironment) {
			case field_50:
				return blockState.get(field_10945);
			case field_48:
				return false;
			case field_51:
				return blockState.get(field_10945);
	...
	public void method_10033(World world, BlockPos blockPos, boolean bl) {
		...
		if (blockState.getBlock() == this && blockState.get(field_10945) != bl) {
	...
	public void neighborUpdate(BlockState blockState, World world, BlockPos blockPos, Block block, BlockPos blockPos2) {
		...
		if (block != this && bl != blockState.get(field_10940)) {
			if (bl != blockState.get(field_10945)) {
				this.method_10036(world, blockPos, bl);
			}
	...
	public boolean canPlaceAt(BlockState blockState, ViewableWorld viewableWorld, BlockPos blockPos) {
		...
		if (blockState.get(field_10946) == DoubleBlockHalf.field_12607) {
