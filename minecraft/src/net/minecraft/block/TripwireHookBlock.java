...
public class TripwireHookBlock extends Block {
	...
	public void method_10776(World world, BlockPos blockPos, BlockState blockState, boolean bl, boolean bl2, int i, @Nullable BlockState blockState2) {
		Direction direction = blockState.method_11654(field_11666);
		boolean bl3 = blockState.method_11654(field_11669);
		boolean bl4 = blockState.method_11654(field_11671);
		boolean bl5 = !bl;
		boolean bl6 = false;
		int j = 0;
		...
		for(int k = 1; k < 42; ++k) {
			...
			if (blockState3.getBlock() != Blocks.field_10589 && k != i) {
				...
				boolean bl7 = !blockState3.method_11654(TripwireBlock.field_11679);
				boolean bl8 = blockState3.method_11654(TripwireBlock.field_11680);
				bl6 |= bl7 && bl8;
		...
		if (j > 0) {
			BlockPos blockPos2 = blockPos.method_10079(direction, j);
			Direction direction2 = direction.getOpposite();
			world.method_8652(blockPos2, blockState4.method_11657(field_11666, direction2), 3);
			this.method_10775(world, blockPos2, direction2);
			this.method_10777(world, blockPos2, bl5, bl6, bl3, bl4);
		}
	...
	public void method_9536(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2, boolean bl) {
		if (!bl && blockState.getBlock() != blockState2.getBlock()) {
			boolean bl2 = blockState.method_11654(field_11669);
			boolean bl3 = blockState.method_11654(field_11671);
			if (bl2 || bl3) {
	...
	public int method_9603(BlockState blockState, BlockView blockView, BlockPos blockPos, Direction direction) {
		if (!blockState.method_11654(field_11671)) {
			return 0;
		} else {
