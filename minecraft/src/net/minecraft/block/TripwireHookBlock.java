...
public class TripwireHookBlock extends Block {
	...
	public void method_10776(World world, BlockPos blockPos, BlockState blockState, boolean bl, boolean bl2, int i, @Nullable BlockState blockState2) {
		Direction direction = blockState.get(field_11666);
		boolean bl3 = blockState.get(field_11669);
		boolean bl4 = blockState.get(field_11671);
		boolean bl5 = !bl;
		boolean bl6 = false;
		int j = 0;
		...
		for(int k = 1; k < 42; ++k) {
			...
			if (blockState3.getBlock() != Blocks.field_10589 && k != i) {
				...
				boolean bl7 = !blockState3.get(TripwireBlock.field_11679);
				boolean bl8 = blockState3.get(TripwireBlock.field_11680);
				bl6 |= bl7 && bl8;
		...
		if (j > 0) {
			...
			Direction direction2 = direction.getOpposite();
			world.setBlockState(blockPos2, blockState4.with(field_11666, direction2), 3);
	...
	public void onBlockRemoved(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2, boolean bl) {
		if (!bl && blockState.getBlock() != blockState2.getBlock()) {
			boolean bl2 = blockState.get(field_11669);
			boolean bl3 = blockState.get(field_11671);
			if (bl2 || bl3) {
