...
public class CandleBlock extends AbstractCandleBlock implements Waterloggable {
	...
	private static final Int2ObjectMap<List<Vec3d>> CANDLES_TO_PARTICLE_OFFSETS = Util.make(
		() -> {
			...
			int2ObjectMap.put(1, ImmutableList.<Vec3d>of(new Vec3d(0.5, 0.5, 0.5)));
			int2ObjectMap.put(2, ImmutableList.<Vec3d>of(new Vec3d(0.375, 0.44, 0.5), new Vec3d(0.625, 0.5, 0.44)));
			int2ObjectMap.put(3, ImmutableList.<Vec3d>of(new Vec3d(0.5, 0.313, 0.625), new Vec3d(0.375, 0.44, 0.5), new Vec3d(0.56, 0.5, 0.44)));
			int2ObjectMap.put(
				4, ImmutableList.<Vec3d>of(new Vec3d(0.44, 0.313, 0.56), new Vec3d(0.625, 0.44, 0.56), new Vec3d(0.375, 0.44, 0.375), new Vec3d(0.56, 0.5, 0.375))
			);
	...
	public class_9062 method_55765(
		...
		if (itemStack.isEmpty() && playerEntity.getAbilities().allowModifyWorld && blockState.get(LIT)) {
