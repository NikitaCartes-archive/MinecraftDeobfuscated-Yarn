...
public class FrostedIceBlock extends IceBlock {
	...
	public void method_9588(BlockState blockState, World world, BlockPos blockPos, Random random) {
		if ((random.nextInt(3) == 0 || this.canMelt(world, blockPos, 4))
			&& world.getLightLevel(blockPos) > 11 - blockState.method_11654(field_11097) - blockState.getLightSubtracted(world, blockPos)
	...
	private boolean method_10201(BlockState blockState, World world, BlockPos blockPos) {
		int i = blockState.method_11654(field_11097);
		if (i < 3) {
