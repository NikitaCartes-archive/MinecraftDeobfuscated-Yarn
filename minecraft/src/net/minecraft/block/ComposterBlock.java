...
public class ComposterBlock extends Block implements InventoryProvider {
	...
	public void method_9615(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2, boolean bl) {
		if (blockState.method_11654(field_17565) == 7) {
			world.method_8397().schedule(blockPos, blockState.getBlock(), 20);
		}
	}

	@Override
	public boolean method_9534(BlockState blockState, World world, BlockPos blockPos, PlayerEntity playerEntity, Hand hand, BlockHitResult blockHitResult) {
		int i = blockState.method_11654(field_17565);
	...
	private static boolean method_17756(BlockState blockState, IWorld iWorld, BlockPos blockPos, ItemStack itemStack) {
		...
		if ((i != 0 || !(f > 0.0F)) && !(iWorld.getRandom().nextDouble() < (double)f)) {
			...
			if (j == 7) {
				iWorld.method_8397().schedule(blockPos, blockState.getBlock(), 20);
			}
	...
	public int method_9572(BlockState blockState, World world, BlockPos blockPos) {
		return blockState.method_11654(field_17565);
	}
	...
	static class ComposterInventory extends BasicInventory implements SidedInventory {
		...
		public void markDirty() {
			...
			if (!itemStack.isEmpty()) {
				this.dirty = true;
				ComposterBlock.method_17756(this.field_17569, this.world, this.pos, itemStack);
	...
	static class FullComposterInventory extends BasicInventory implements SidedInventory {
		...
		@Override
		public void markDirty() {
			ComposterBlock.method_17759(this.field_17573, this.world, this.pos);
			this.dirty = true;
		}
	}
}
