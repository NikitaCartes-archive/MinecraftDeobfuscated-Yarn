...
public class LecternBlock extends BlockWithEntity {
	...
	protected LecternBlock(Block.Settings settings) {
		...
		this.method_9590(
			this.field_10647
				.method_11664()
				.method_11657(field_16404, Direction.field_11043)
	...
	public BlockState method_9605(ItemPlacementContext itemPlacementContext) {
		return this.method_9564().method_11657(field_16404, itemPlacementContext.getPlayerFacing().getOpposite());
	}
	...
	public BlockState method_9598(BlockState blockState, BlockRotation blockRotation) {
		return blockState.method_11657(field_16404, blockRotation.rotate(blockState.method_11654(field_16404)));
	}

	@Override
	public BlockState method_9569(BlockState blockState, BlockMirror blockMirror) {
		return blockState.rotate(blockMirror.method_10345(blockState.method_11654(field_16404)));
	}
	...
	public static boolean method_17472(World world, BlockPos blockPos, BlockState blockState, ItemStack itemStack) {
		if (!blockState.method_11654(field_17366)) {
			if (!world.isClient) {
	...
	public static void method_17471(World world, BlockPos blockPos, BlockState blockState) {
		...
		world.method_8397().schedule(blockPos, blockState.getBlock(), 2);
	...
	public void method_9536(BlockState blockState, World world, BlockPos blockPos, BlockState blockState2, boolean bl) {
		if (blockState.getBlock() != blockState2.getBlock()) {
			...
			if (blockState.method_11654(field_17365)) {
	...
	public int method_9603(BlockState blockState, BlockView blockView, BlockPos blockPos, Direction direction) {
		return direction == Direction.field_11036 && blockState.method_11654(field_17365) ? 15 : 0;
	}
