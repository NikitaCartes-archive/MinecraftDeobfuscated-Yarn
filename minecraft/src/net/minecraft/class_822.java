...
public class class_822 extends class_827<class_2580> {
	...
	public void method_3541(class_2580 arg, double d, double e, double f, float g, int i) {
		this.method_3543(d, e, f, (double)g, arg.method_10937(), arg.method_10997().method_8510());
	}

	private void method_3543(double d, double e, double f, double g, List<class_2580.class_2581> list, long l) {
		...
		for (int j = 0; j < list.size(); j++) {
			...
			method_3544(d, e, f, g, l, i, j == list.size() - 1 ? 1024 : lv.method_10943(), lv.method_10944());
			i += lv.method_10943();
		}
	...
	private static void method_3544(double d, double e, double f, double g, long l, int i, int j, float[] fs) {
		method_3545(d, e, f, g, 1.0, l, i, j, fs, 0.2, 0.25);
	}
