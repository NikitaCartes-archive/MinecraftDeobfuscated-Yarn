...
public class class_775 {
	...
	public boolean method_3347(class_1920 arg, class_2338 arg2, class_287 arg3, class_3610 arg4) {
		...
		if (!bl2 && !bl3 && !bl7 && !bl6 && !bl4 && !bl5) {
			...
			if (bl3) {
				float t = lvs[0].method_4594();
				float v = lvs[0].method_4577();
				float x = lvs[0].method_4593();
				float z = lvs[0].method_4575();
				...
				float ap = 0.5F * g;
				float af = 0.5F * h;
				arg3.method_1315(d, e, r + 1.0).method_1336(aa, ap, af, 1.0F).method_1312((double)t, (double)z).method_1313(an, ao).method_1344();
				arg3.method_1315(d, e, r).method_1336(aa, ap, af, 1.0F).method_1312((double)t, (double)x).method_1313(an, ao).method_1344();
				arg3.method_1315(d + 1.0, e, r).method_1336(aa, ap, af, 1.0F).method_1312((double)v, (double)x).method_1313(an, ao).method_1344();
				arg3.method_1315(d + 1.0, e, r + 1.0).method_1336(aa, ap, af, 1.0F).method_1312((double)v, (double)z).method_1313(an, ao).method_1344();
				bl8 = true;
			}
			...
			for(int aq = 0; aq < 4; ++aq) {
				...
				if (bl9 && !method_3344(arg, arg2, lv3, Math.max(v, x))) {
					bl8 = true;
					...
					float aj = lv5.method_4570((double)((1.0F - v) * 16.0F * 0.5F));
					float ak = lv5.method_4570((double)((1.0F - x) * 16.0F * 0.5F));
					...
					float bc = 1.0F * ba * g;
					float bd = 1.0F * ba * h;
					arg3.method_1315(ar, e + (double)v, at).method_1336(bb, bc, bd, 1.0F).method_1312((double)av, (double)aj).method_1313(ay, az).method_1344();
					arg3.method_1315(as, e + (double)x, au).method_1336(bb, bc, bd, 1.0F).method_1312((double)aw, (double)ak).method_1313(ay, az).method_1344();
	...
	private float method_3346(class_1922 arg, class_2338 arg2, class_3611 arg3) {
		...
		for(int j = 0; j < 4; ++j) {
			...
			if (lv2.method_15772().method_15780(arg3)) {
				if (lv2.method_15763() >= 0.8F) {
					f += lv2.method_15763() * 10.0F;
					i += 10;
				} else {
					f += lv2.method_15763();
					++i;
