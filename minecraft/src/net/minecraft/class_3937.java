...
public class class_3937 extends class_3940 {
	...
	public void method_3070() {
		...
		this.field_3852 += (double)(this.field_3840.nextFloat() / 5000.0F * (float)(this.field_3840.nextBoolean() ? 1 : -1));
		this.field_3850 += (double)(this.field_3840.nextFloat() / 5000.0F * (float)(this.field_3840.nextBoolean() ? 1 : -1));
