...
public class class_1542 extends class_1297 {
	...
	public class_1542(class_1299<? extends class_1542> arg, class_1937 arg2) {
		super(arg, arg2);
	}

	public class_1542(class_1937 arg, double d, double e, double f) {
		this(class_1299.field_6052, arg);
		this.method_5814(d, e, f);
		this.field_6031 = this.field_5974.nextFloat() * 360.0F;
		this.method_18800(this.field_5974.nextDouble() * 0.2 - 0.1, 0.2, this.field_5974.nextDouble() * 0.2 - 0.1);
	}
	...
	public void method_5773() {
		if (this.method_6983().method_7960()) {
			...
			if (this.field_6002.field_9236) {
				...
				this.field_5960 = !this.field_6002.method_17892(this);
				if (this.field_5960) {
					this.method_5632(this.field_5987, (this.method_5829().field_1322 + this.method_5829().field_1325) / 2.0, this.field_6035);
				}
			}

			if (!this.field_5952 || method_17996(this.method_18798()) > 1.0E-5F || (this.field_6012 + this.method_5628()) % 4 == 0) {
				this.method_5784(class_1313.field_6308, this.method_18798());
				float f = 0.98F;
				if (this.field_5952) {
					f = this.field_6002.method_8320(new class_2338(this.field_5987, this.method_5829().field_1322 - 1.0, this.field_6035)).method_11614().method_9499()
						* 0.98F;
				}
			...
			boolean bl = class_3532.method_15357(this.field_6014) != class_3532.method_15357(this.field_5987)
				|| class_3532.method_15357(this.field_6036) != class_3532.method_15357(this.field_6010)
				|| class_3532.method_15357(this.field_5969) != class_3532.method_15357(this.field_6035);
			int i = bl ? 2 : 40;
			if (this.field_6012 % i == 0) {
				...
				if (!this.field_6002.field_9236 && this.method_20397()) {
					this.method_6973();
				}
			}
			...
			this.field_6007 |= this.method_5713();
			if (!this.field_6002.field_9236) {
				double d = this.method_18798().method_1020(lv).method_1027();
				if (d > 0.01) {
	...
	private void method_6974() {
		class_243 lv = this.method_18798();
		this.method_18800(lv.field_1352 * 0.99F, lv.field_1351 + (double)(lv.field_1351 < 0.06F ? 5.0E-4F : 0.0F), lv.field_1350 * 0.99F);
	}

	private void method_6973() {
		List<class_1542> list = this.field_6002
			.method_8390(class_1542.class, this.method_5829().method_1009(0.5, 0.0, 0.5), arg -> arg != this && arg.method_20397());
		if (!list.isEmpty()) {
			for(class_1542 lv : list) {
	...
	private boolean method_20397() {
		...
		return this.method_5805() && this.field_7202 != 32767 && this.field_7204 != -32768 && this.field_7204 < 6000 && lv.method_7947() < lv.method_7914();
	}

	private void method_6972(class_1542 arg) {
		class_1799 lv = this.method_6983();
		class_1799 lv2 = arg.method_6983();
		if (lv2.method_7909() == lv.method_7909()) {
			if (lv2.method_7947() + lv.method_7947() <= lv2.method_7914()) {
				if (!(lv2.method_7985() ^ lv.method_7985())) {
					if (!lv2.method_7985() || lv2.method_7969().equals(lv.method_7969())) {
						if (lv2.method_7947() < lv.method_7947()) {
							method_18006(this, lv, arg, lv2);
						} else {
							method_18006(arg, lv2, this, lv);
						}
					}
				}
			}
	...
	private static void method_18006(class_1542 arg, class_1799 arg2, class_1542 arg3, class_1799 arg4) {
		int i = Math.min(arg2.method_7914() - arg2.method_7947(), arg4.method_7947());
		class_1799 lv = arg2.method_7972();
		lv.method_7933(i);
		arg.method_6979(lv);
		arg4.method_7934(i);
		arg3.method_6979(arg4);
		arg.field_7202 = Math.max(arg.field_7202, arg3.field_7202);
		arg.field_7204 = Math.min(arg.field_7204, arg3.field_7204);
		if (arg4.method_7960()) {
			arg3.method_5650();
		}
	}
