...
public class class_1542 extends class_1297 {
	...
	private void method_6973() {
		List<class_1542> list = this.field_6002.method_18467(class_1542.class, this.method_5829().method_1009(0.5, 0.0, 0.5));
		if (!list.isEmpty()) {
	...
	private boolean method_6972(class_1542 arg) {
		if (arg == this) {
			...
			return false;
		} else if (this.field_7202 == 32767 || arg.field_7202 == 32767) {
			return false;
	...
	private static void method_18006(class_1542 arg, class_1799 arg2, class_1542 arg3, class_1799 arg4) {
		...
		lv.method_7933(arg4.method_7947());
		arg.method_6979(lv);
