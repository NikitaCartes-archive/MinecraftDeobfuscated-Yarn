		...
		if (arg3.method_10264() <= 4) {
			...
			for(int j = 0; j < 16; ++j) {
				for(int s = 0; s < 16; ++s) {
					for(int t = 0; t < 8; ++t) {
						...
						if (bl) {
							class_3614 lv = arg.method_8320(arg3.method_10069(j, t, s)).method_11620();
							if (t >= 4 && lv.method_15797()) {
								return false;
							}

							if (t < 4 && !lv.method_15799() && arg.method_8320(arg3.method_10069(j, t, s)) != arg4.field_13670) {
								return false;
							}
						}
					}
			...
			for(int j = 0; j < 16; ++j) {
				for(int s = 0; s < 16; ++s) {
					for(int t = 0; t < 8; ++t) {
						if (bls[(j * 16 + s) * 8 + t]) {
							arg.method_8652(arg3.method_10069(j, t, s), t >= 4 ? field_13668 : arg4.field_13670, 2);
						}
					}
				}
			}
			...
			for(int j = 0; j < 16; ++j) {
				for(int s = 0; s < 16; ++s) {
					for(int t = 4; t < 8; ++t) {
						if (bls[(j * 16 + s) * 8 + t]) {
							class_2338 lv2 = arg3.method_10069(j, t - 1, s);
							if (class_2248.method_9519(arg.method_8320(lv2).method_11614()) && arg.method_8314(class_1944.field_9284, arg3.method_10069(j, t, s)) > 0) {
								class_1959 lv3 = arg.method_8310(lv2);
								if (lv3.method_8722().method_15337().method_11614() == class_2246.field_10402) {
									arg.method_8652(lv2, class_2246.field_10402.method_9564(), 2);
								} else {
									arg.method_8652(lv2, class_2246.field_10219.method_9564(), 2);
								}
							}
						}
					}
				...
				for(int j = 0; j < 16; ++j) {
					for(int s = 0; s < 16; ++s) {
						for(int t = 0; t < 8; ++t) {
							...
							if (bl && (t < 4 || random.nextInt(2) != 0) && arg.method_8320(arg3.method_10069(j, t, s)).method_11620().method_15799()) {
								arg.method_8652(arg3.method_10069(j, t, s), class_2246.field_10340.method_9564(), 2);
							}
						}
					}
				}
			...
			if (arg4.field_13670.method_11620() == class_3614.field_15920) {
				for(int j = 0; j < 16; ++j) {
					for(int s = 0; s < 16; ++s) {
						int t = 4;
						class_2338 lv2 = arg3.method_10069(j, 4, s);
						if (arg.method_8310(lv2).method_8685(arg, lv2, false)) {
