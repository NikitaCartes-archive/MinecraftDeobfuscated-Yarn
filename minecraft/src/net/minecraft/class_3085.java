			...
			for (int j = 0; j < 16; j++) {
				for (int s = 0; s < 16; s++) {
					for (int txx = 4; txx < 8; txx++) {
						if (bls[(j * 16 + s) * 8 + txx]) {
							class_2338 lv2 = arg3.method_10069(j, txx - 1, s);
							if (class_2248.method_9519(arg.method_8320(lv2).method_11614()) && arg.method_8314(class_1944.field_9284, arg3.method_10069(j, txx, s)) > 0) {
