			...
			if (!arg.method_16956(lv.field_9181, lv.field_9180, class_2806.field_16422).method_12180(class_3031.field_13587.method_14019()).isEmpty()) {
				...
				for(int j = 0; j < 16; ++j) {
					for(int s = 0; s < 16; ++s) {
						for(int t = 4; t < 8; ++t) {
							if (bls[(j * 16 + s) * 8 + t]) {
								class_2338 lv3 = arg3.method_10069(j, t - 1, s);
								if (class_2248.method_9519(arg.method_8320(lv3).method_11614()) && arg.method_8314(class_1944.field_9284, arg3.method_10069(j, t, s)) > 0) {
