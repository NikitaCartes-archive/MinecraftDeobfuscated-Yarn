...
public class class_2643 extends class_2640 implements class_3000 {
	...
	public void method_16896() {
		...
		if (bl2) {
			...
			List<class_1297> list = this.field_11863.method_18467(class_1297.class, new class_238(this.method_11016()));
			if (!list.isEmpty()) {
	...
	public void method_11409(class_1297 arg) {
		if (!this.field_11863.field_9236 && !this.method_11421()) {
			...
			if (this.field_12132 != null) {
				...
				arg.method_20620((double)lv.method_10263() + 0.5, (double)lv.method_10264() + 0.5, (double)lv.method_10260() + 0.5);
			}
	...
	private void method_11422() {
		...
		if (this.field_12132 == null) {
			...
			class_3031.field_13574
				.method_13151(
					this.field_11863, this.field_11863.method_8398().method_12129(), new Random(this.field_12132.method_10063()), this.field_12132, class_3037.field_13603
				);
		} else {
			...
			for(int k = -i; k <= i; ++k) {
				if (j != 0 || k != 0 || bl) {
					for(int l = 255; l > (lv == null ? 0 : lv.method_10264()); --l) {
						...
						if (class_2248.method_9614(lv3.method_11628(arg, lv2)) && (bl || lv3.method_11614() != class_2246.field_9987)) {
							lv = lv2;
							break;
						}
					}
	...
	private static class_2338 method_11413(class_2818 arg) {
		...
		for(class_2338 lv5 : class_2338.method_10097(lv2, lv3)) {
			...
			if (lv6.method_11614() == class_2246.field_10471
				&& !class_2248.method_9614(arg.method_8320(lv7).method_11628(arg, lv7))
				&& !class_2248.method_9614(arg.method_8320(lv8).method_11628(arg, lv8))) {
				double e = lv5.method_10268(0.0, 0.0, 0.0, true);
				if (lv4 == null || e < d) {
					lv4 = lv5;
					d = e;
				}
	...
	private void method_11416(class_2338 arg) {
		class_3031.field_13564
			.method_13151(this.field_11863, this.field_11863.method_8398().method_12129(), new Random(), arg, class_3018.method_18034(this.method_11016(), false));
	}
	...
	public void method_11418(class_2338 arg, boolean bl) {
		this.field_12129 = bl;
