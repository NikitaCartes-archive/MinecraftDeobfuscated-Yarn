...
public class class_2214 implements ArgumentType<String> {
	...
	private static final DynamicCommandExceptionType field_9922 = new DynamicCommandExceptionType(
		object -> new class_2588("arguments.objective.notFound", object)
	);
	private static final DynamicCommandExceptionType field_9921 = new DynamicCommandExceptionType(
		object -> new class_2588("arguments.objective.readonly", object)
	);
