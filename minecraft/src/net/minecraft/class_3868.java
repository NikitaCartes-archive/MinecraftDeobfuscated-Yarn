...
public class class_3868 {
	...
	static {
		ImmutableList<class_3491> immutableList = ImmutableList.of(
			new class_3826(
				ImmutableList.of(
					...
					new class_3821(new class_3824(class_2246.field_10467, 0.08F), class_3818.field_16868, class_2246.field_10343.method_9564()),
					new class_3821(new class_3824(class_2246.field_10361, 0.1F), class_3818.field_16868, class_2246.field_10343.method_9564()),
					new class_3821(new class_3824(class_2246.field_10415, 0.08F), class_3818.field_16868, class_2246.field_10343.method_9564()),
					new class_3821(new class_3824(class_2246.field_10549, 0.08F), class_3818.field_16868, class_2246.field_10343.method_9564()),
					new class_3821(new class_3824(class_2246.field_10262, 0.08F), class_3818.field_16868, class_2246.field_10343.method_9564()),
					new class_3821(new class_3824(class_2246.field_10293, 0.2F), class_3818.field_16868, class_2246.field_10341.method_9564()),
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/town_centers"),
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/streets"),
					new class_2960("village/desert/terminators"),
					ImmutableList.of(
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/zombie/streets"),
					new class_2960("village/desert/zombie/terminators"),
					ImmutableList.of(
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/houses"),
					new class_2960("village/desert/terminators"),
					ImmutableList.of(
						...
						new Pair<>(new class_3781("village/desert/houses/desert_large_farm_1", immutableList2), 11),
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/zombie/houses"),
					new class_2960("village/desert/zombie/terminators"),
					ImmutableList.of(
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/decor"),
					new class_2960("empty"),
					ImmutableList.of(
						new Pair<>(new class_3781("village/desert/desert_lamp_1"), 10),
						new Pair<>(new class_3776(new class_2975<>(class_3031.field_13554, class_3037.field_13603)), 4),
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/zombie/decor"),
					new class_2960("empty"),
					ImmutableList.of(
		...
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/villagers"),
					new class_2960("empty"),
					ImmutableList.of(
						new Pair<>(new class_3781("village/desert/villagers/nitwit"), 1),
						new Pair<>(new class_3781("village/desert/villagers/baby"), 1),
						new Pair<>(new class_3781("village/desert/villagers/unemployed"), 10)
					),
					class_3785.class_3786.field_16687
				)
			);
		class_3778.field_16666
			.method_16640(
				new class_3785(
					new class_2960("village/desert/zombie/villagers"),
					new class_2960("empty"),
					ImmutableList.of(
						new Pair<>(new class_3781("village/desert/zombie/villagers/nitwit"), 1), new Pair<>(new class_3781("village/desert/zombie/villagers/unemployed"), 10)
					),
					class_3785.class_3786.field_16687
				)
			);
