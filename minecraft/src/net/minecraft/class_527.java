...
public class class_527 extends class_437 {
	...
	private final BooleanConsumer field_3233;
	private final class_1257 field_3234;

	public class_527(BooleanConsumer booleanConsumer, String string, class_32 arg, boolean bl) {
		super(new class_2588("optimizeWorld.title", arg.method_231(string).method_150()));
		this.field_3233 = booleanConsumer;
		this.field_3234 = new class_1257(string, arg, arg.method_231(string), bl);
	}
