...
public class class_1007 extends class_922<class_742, class_591<class_742>> {
	...
	public void method_4215(class_742 arg, double d, double e, double f, float g, float h) {
		if (!arg.method_7340() || this.field_4676.field_4686 != null && this.field_4676.field_4686.method_19331() == arg) {
			double i = e;
			if (arg.method_20231()) {
				i = e - 0.125;
			}
	...
	private void method_4218(class_742 arg) {
		...
		if (arg.method_7325()) {
			...
			lv.field_3400 = arg.method_20231();
	...
	private class_572.class_573 method_4210(class_742 arg, class_1799 arg2, class_1799 arg3, class_1268 arg4) {
		...
		if (!lv2.method_7960()) {
			...
			boolean bl = arg.method_6115() && lv2 == arg.method_6030();
			boolean bl2 = !bl && arg4 == class_1268.field_5810 && arg.method_6039();
			if (!bl && !bl2) {
				boolean bl3 = arg2.method_7909() == class_1802.field_8399;
				boolean bl4 = class_1764.method_7781(arg2);
				boolean bl5 = arg3.method_7909() == class_1802.field_8399;
				boolean bl6 = class_1764.method_7781(arg3);
				if (bl3 && bl4) {
					lv = class_572.class_573.field_3408;
				}

				if (bl5 && bl6 && arg2.method_7909().method_7853(arg2) == class_1839.field_8952) {
					lv = class_572.class_573.field_3408;
				}
			} else {
	...
	protected void method_4212(class_742 arg, float f, float g, float h) {
		...
		if (arg.method_6128()) {
			...
			super.method_4058(arg, f, g, h);
			float jx = arg.method_5799() ? -90.0F - arg.field_5965 : -90.0F;
			float kx = class_3532.method_16439(i, 0.0F, jx);
