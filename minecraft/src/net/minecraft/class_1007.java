...
public class class_1007 extends class_922<class_742, class_591<class_742>> {
	...
	public void method_4215(class_742 arg, double d, double e, double f, float g, float h) {
		if (!arg.method_7340() || this.field_4676.field_4686 == arg) {
			double i = e;
			if (arg.method_5715()) {
				i = e - 0.125;
			}
	...
	protected void method_4219(class_742 arg, double d, double e, double f) {
		if (arg.method_5805() && arg.method_6113()) {
			super.method_4048(arg, d + (double)arg.field_7516, e + (double)arg.field_7485, f + (double)arg.field_7497);
		} else {
			super.method_4048(arg, d, e, f);
		}
	}
	...
	protected void method_4212(class_742 arg, float f, float g, float h) {
		...
		if (arg.method_5805() && arg.method_6113()) {
			...
			double d = arg.field_5967 * arg.field_5967 + arg.field_6006 * arg.field_6006;
			double e = lv.field_1352 * lv.field_1352 + lv.field_1350 * lv.field_1350;
			if (d > 0.0 && e > 0.0) {
				double l = (arg.field_5967 * lv.field_1352 + arg.field_6006 * lv.field_1350) / (Math.sqrt(d) * Math.sqrt(e));
				double m = arg.field_5967 * lv.field_1350 - arg.field_6006 * lv.field_1352;
