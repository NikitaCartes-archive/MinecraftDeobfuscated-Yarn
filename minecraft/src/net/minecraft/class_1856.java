...
public final class class_1856 implements Predicate<class_1799> {
	...
	private class_1856(Stream<? extends class_1856.class_1859> stream) {
		this.field_9019 = (class_1856.class_1859[])stream.filter(field_9020).toArray(i -> new class_1856.class_1859[i]);
	}
	...
	private void method_8096() {
		if (this.field_9018 == null) {
			this.field_9018 = (class_1799[])Arrays.stream(this.field_9019).flatMap(arg -> arg.method_8108().stream()).distinct().toArray(i -> new class_1799[i]);
		}
	}
	...
	public static class_1856.class_1859 method_8107(JsonObject jsonObject) {
		if (jsonObject.has("item") && jsonObject.has("tag")) {
			...
			class_1792 lv2 = class_2378.field_11142.method_10223(lv);
			if (lv2 == null) {
				throw new JsonSyntaxException("Unknown item '" + lv + "'");
			} else {
