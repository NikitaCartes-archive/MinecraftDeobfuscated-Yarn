...
public class class_1382 extends class_1367 {
	...
	public boolean method_6264() {
		if (!this.field_6589.field_6002.method_8450().method_8355(class_1928.field_19388)) {
			return false;
		} else if (this.field_6518 > 0) {
			this.field_6518--;
			return false;
		} else if (this.method_20307()) {
			this.field_6518 = 20;
			return true;
		} else {
	...
	private boolean method_20307() {
		return this.field_6512 != null && this.field_6516.field_6002.method_8591(this.field_6512) && this.method_6296(this.field_6516.field_6002, this.field_6512)
			? true
			: this.method_6292();
	}
	...
	public void method_6268() {
		...
		if (this.method_6295() && lv3 != null) {
			if (this.field_6588 > 0) {
				class_243 lv4 = this.field_6589.method_18798();
				this.field_6589.method_18800(lv4.field_1352, 0.3, lv4.field_1350);
				if (!lv.field_9236) {
					double d = 0.08;
					((class_3218)lv)
						.method_14199(
			...
			if (this.field_6588 > 60) {
				...
				if (!lv.field_9236) {
					for (int i = 0; i < 20; i++) {
						...
						((class_3218)lv)
							.method_14199(class_2398.field_11203, (double)lv3.method_10263() + 0.5, (double)lv3.method_10264(), (double)lv3.method_10260() + 0.5, 1, d, e, f, 0.15F);
					}

					this.method_6309(lv, lv3);
				}
			}
