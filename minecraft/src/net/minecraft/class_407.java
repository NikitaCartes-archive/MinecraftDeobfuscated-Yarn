...
public class class_407 extends class_410 {
	...
	public class_407(BooleanConsumer booleanConsumer, String string, boolean bl) {
		super(booleanConsumer, new class_2588(bl ? "chat.link.confirmTrusted" : "chat.link.confirm"), new class_2585(string));
	...
	protected void init() {
		...
		this.buttons.clear();
		this.children.clear();
		this.addButton(new class_4185(this.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.field_2402, arg -> this.field_2403.accept(true)));
		this.addButton(new class_4185(this.width / 2 - 50, this.height / 6 + 96, 100, 20, this.field_2373, arg -> {
			this.method_2100();
			this.field_2403.accept(false);
		}));
		this.addButton(new class_4185(this.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.field_2399, arg -> this.field_2403.accept(false)));
	}
