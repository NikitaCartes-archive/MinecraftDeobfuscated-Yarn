...
public class class_746 extends class_742 {
	...
	public class_746(class_310 arg, class_1937 arg2, class_634 arg3, class_3469 arg4, class_299 arg5) {
	...
	private void method_3136() {
		...
		if (bl != this.field_3919) {
			if (bl) {
				this.field_3944.method_2883(new class_2848(this, class_2848.class_2849.field_12981));
			} else {
				this.field_3944.method_2883(new class_2848(this, class_2848.class_2849.field_12985));
			}

			this.field_3919 = bl;
		}

		boolean bl2 = this.method_5715();
		if (bl2 != this.field_3936) {
			if (bl2) {
				this.field_3944.method_2883(new class_2848(this, class_2848.class_2849.field_12979));
			} else {
				this.field_3944.method_2883(new class_2848(this, class_2848.class_2849.field_12984));
			}
		...
		if (this.method_3134()) {
			...
			double e = lv.field_1322 - this.field_3940;
			...
			if (this.method_5765()) {
				this.field_3944.method_2883(new class_2828.class_2830(this.field_5967, -999.0, this.field_6006, this.field_6031, this.field_5965, this.field_5952));
				bl3 = false;
			} else if (bl3 && bl4) {
				this.field_3944.method_2883(new class_2828.class_2830(this.field_5987, lv.field_1322, this.field_6035, this.field_6031, this.field_5965, this.field_5952));
			} else if (bl3) {
				this.field_3944.method_2883(new class_2828.class_2829(this.field_5987, lv.field_1322, this.field_6035, this.field_5952));
			} else if (bl4) {
				this.field_3944.method_2883(new class_2828.class_2831(this.field_6031, this.field_5965, this.field_5952));
	...
	protected boolean method_5632(double d, double e, double f) {
		if (this.field_5960) {
			...
			if (this.method_3150(lv)) {
				int i = -1;
				double j = 9999.0;
				if (this.method_7352(lv.method_10067()) && g < j) {
					j = g;
					i = 0;
				}

				if (this.method_7352(lv.method_10078()) && 1.0 - g < j) {
					j = 1.0 - g;
					i = 1;
				}

				if (this.method_7352(lv.method_10095()) && h < j) {
					j = h;
					i = 4;
				}

				if (this.method_7352(lv.method_10072()) && 1.0 - h < j) {
					j = 1.0 - h;
					i = 5;
				}
	...
	private boolean method_3150(class_2338 arg) {
		return this.method_5681() ? !this.method_7326(arg) : !this.method_7352(arg);
	}
	...
	public boolean method_5715() {
		boolean bl = this.field_3913 != null && this.field_3913.field_3903;
		return bl && !this.field_7492;
	}
	...
	public void method_6007() {
		...
		if (this.field_5963) {
			if (this.field_3937.field_1755 != null && !this.field_3937.field_1755.method_2222()) {
		...
		float f = 0.8F;
		boolean bl3 = this.field_3913.field_3905 >= 0.8F;
		...
		class_238 lv = this.method_5829();
		this.method_5632(this.field_5987 - (double)this.field_5998 * 0.35, lv.field_1322 + 0.5, this.field_6035 + (double)this.field_5998 * 0.35);
		this.method_5632(this.field_5987 - (double)this.field_5998 * 0.35, lv.field_1322 + 0.5, this.field_6035 - (double)this.field_5998 * 0.35);
		this.method_5632(this.field_5987 + (double)this.field_5998 * 0.35, lv.field_1322 + 0.5, this.field_6035 - (double)this.field_5998 * 0.35);
		this.method_5632(this.field_5987 + (double)this.field_5998 * 0.35, lv.field_1322 + 0.5, this.field_6035 + (double)this.field_5998 * 0.35);
		boolean bl5 = (float)this.method_7344().method_7586() > 6.0F || this.field_7503.field_7478;
		if ((this.field_5952 || this.method_5869())
			&& !bl2
			&& !bl3
			&& this.field_3913.field_3905 >= 0.8F
			&& !this.method_5624()
			&& bl5
			&& !this.method_6115()
		...
		if (this.method_5624()) {
			boolean bl6 = this.field_3913.field_3905 < 0.8F || !bl5;
			boolean bl7 = bl6 || this.field_5976 || this.method_5799() && !this.method_5869();
			if (this.method_5681()) {
				if (!this.field_5952 && !this.field_3913.field_3903 && bl6 || !this.method_5799()) {
		...
		if (this.field_7503.field_7478) {
			...
			} else if (!bl && this.field_3913.field_3904 && !bl4) {
		...
		if (this.field_3913.field_3904 && !bl && !this.field_5952 && this.field_5984 < 0.0 && !this.method_6128() && !this.field_7503.field_7479) {
		...
		if (this.field_7503.field_7479 && this.method_3134()) {
			if (this.field_3913.field_3903) {
				...
				this.field_5984 = this.field_5984 - (double)(this.field_7503.method_7252() * 3.0F);
			}
	...
	public void method_5784(class_1313 arg, double d, double e, double f) {
		...
		this.method_3148((float)(this.field_5987 - g), (float)(this.field_6035 - h));
	}
					...
					if (!(m < -0.15F)) {
						...
						if (lv9.method_16337(this.field_6002, lv8, lv7).method_1110()) {
							...
							if (lv10.method_16337(this.field_6002, lv8, lv7).method_1110()) {
								...
								float q = this.field_5998;
								float r = this.field_6019;
								...
								Iterator<class_238> iterator = this.field_6002.method_8607(this, lv13).flatMap(arg -> arg.method_1090().stream()).iterator();
