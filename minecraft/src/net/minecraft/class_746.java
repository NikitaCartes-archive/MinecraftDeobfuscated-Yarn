...
public class class_746 extends class_742 {
	...
	private void method_3136() {
		...
		if (this.method_3134()) {
			...
			if (this.method_5765()) {
				...
				this.field_3944
					.method_2883(new class_2828.class_2830(this.field_5987, lv3.field_1322, this.field_6035, this.field_6031, this.field_5965, this.field_5952));
			} else if (bl3) {
	...
	public boolean method_20231() {
		if (!this.field_7503.field_7479 && !this.method_5681() && this.method_20233(class_4050.field_18081)) {
			return this.method_20303() || !this.method_20233(class_4050.field_18076);
		} else {
			return false;
		}
	}
