...
public class class_430 extends class_437 {
	...
	protected void init() {
		...
		this.field_2523 = new class_342(this.font, 50, 40, this.width - 100, 20);
		...
		this.method_20102(this.field_2521.method_20064() != null);
	}
	...
	@Environment(EnvType.CLIENT)
	class class_4196 extends class_350<class_430.class_4196.class_432> {
		public class_4196() {
			...
			for (int i = 0; i < class_430.field_2518.size(); i++) {
				this.method_1901(new class_430.class_4196.class_432());
			}
		}
		...
		public boolean keyPressed(int i, int j, int k) {
			if (super.keyPressed(i, j, k)) {
				...
				if ((i == 257 || i == 335) && this.method_20064() != null) {
					this.method_20064().method_19389();
				}
		...
		@Environment(EnvType.CLIENT)
		public class class_432 extends class_350.class_351<class_430.class_4196.class_432> {
			@Override
			...
			private void method_2199(int i, int j, int k, int l) {
				...
				class_4196.this.field_19081.method_1531().method_4618(class_332.STATS_ICON_LOCATION);
				float f = 0.0078125F;
				float g = 0.0078125F;
				int m = 18;
				int n = 18;
				...
				lv2.method_1315((double)(i + 0), (double)(j + 18), (double)class_4196.this.blitOffset)
					.method_1312((double)((float)(k + 0) * 0.0078125F), (double)((float)(l + 18) * 0.0078125F))
					.method_1344();
				lv2.method_1315((double)(i + 18), (double)(j + 18), (double)class_4196.this.blitOffset)
					.method_1312((double)((float)(k + 18) * 0.0078125F), (double)((float)(l + 18) * 0.0078125F))
					.method_1344();
				lv2.method_1315((double)(i + 18), (double)(j + 0), (double)class_4196.this.blitOffset)
					.method_1312((double)((float)(k + 18) * 0.0078125F), (double)((float)(l + 0) * 0.0078125F))
					.method_1344();
				lv2.method_1315((double)(i + 0), (double)(j + 0), (double)class_4196.this.blitOffset)
