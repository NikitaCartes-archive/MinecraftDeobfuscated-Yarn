...
public class class_1690 extends class_1297 {
	...
	private void method_7534() {
		...
		if (this.field_7701 == class_1690.class_1691.field_7720
			...
			this.field_5967 = this.field_5967 * (double)this.field_7692;
			this.field_6006 = this.field_6006 * (double)this.field_7692;
	...
	private void method_7549() {
		if (this.method_5782()) {
			...
			this.field_5967 = this.field_5967 + (double)(class_3532.method_15374(-this.field_6031 * (float) (Math.PI / 180.0)) * f);
			this.field_6006 = this.field_6006 + (double)(class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0)) * f);
