...
public class class_1690 extends class_1297 {
	...
	public class_1690(class_1937 arg) {
		super(class_1299.field_6121, arg);
		this.field_6033 = true;
		this.method_5835(1.375F, 0.5625F);
	}
	...
	public boolean method_5643(class_1282 arg, float f) {
		if (this.method_5679(arg)) {
			...
			if (bl || this.method_7554() > 40.0F) {
				if (!bl && this.field_6002.method_8450().method_8355("doEntityDrops")) {
			...
			for(int j = 0; j < list.size(); ++j) {
				...
				if (!lv3.method_5626(this)) {
					if (bl
						...
						&& !lv3.method_5765()
						&& lv3.field_5998 < this.field_5998
			...
			if (i > 0) {
				...
				if (j > 0 && i == 0) {
					...
					if (this.field_7703) {
						...
						this.field_5984 = this.method_5703(class_1657.class) ? 2.7 : 0.6;
					}
				}
	...
	public float method_7551(int i, float f) {
		return this.method_7556(i)
			? (float)class_3532.method_15390((double)this.field_7704[i] - (float) (Math.PI / 8), (double)this.field_7704[i], (double)f)
			: 0.0F;
	}
					...
					if (p < j) {
						for(int q = m; q < n; ++q) {
							...
							if (lv3.method_15767(class_3486.field_15517)) {
								f = Math.max(f, (float)o + lv3.method_15763());
							}
			...
			for(int o = i; o < j; ++o) {
				for(int p = k; p < l; ++p) {
					for(int q = m; q < n; ++q) {
						...
						class_3610 lv3 = this.field_6002.method_8316(lv2);
						if (lv3.method_15767(class_3486.field_15517)) {
							float f = (float)p + lv3.method_15763();
			...
			for(int o = i; o < j; ++o) {
				for(int p = k; p < l; ++p) {
					for(int q = m; q < n; ++q) {
						lv2.method_10113(o, p, q);
						class_3610 lv3 = this.field_6002.method_8316(lv2);
						if (lv3.method_15767(class_3486.field_15517) && d < (double)((float)lv2.method_10264() + lv3.method_15763())) {
							if (!lv3.method_15771()) {
	...
	private void method_7534() {
		...
		if (this.field_7701 == class_1690.class_1691.field_7720
			...
			this.field_7697 = this.method_5829().field_1322 + (double)this.field_6019;
			this.method_5814(this.field_5987, (double)(this.method_7544() - this.field_6019) + 0.101, this.field_6035);
			this.field_5984 = 0.0;
			this.field_7696 = 0.0;
			this.field_7702 = class_1690.class_1691.field_7718;
		} else {
			if (this.field_7702 == class_1690.class_1691.field_7718) {
				f = (this.field_7697 - this.method_5829().field_1322) / (double)this.field_6019;
			...
			this.field_5967 *= (double)this.field_7692;
			this.field_6006 *= (double)this.field_7692;
			this.field_7690 *= this.field_7692;
			this.field_5984 += e;
			if (f > 0.0) {
				double g = 0.65;
				this.field_5984 += f * 0.06153846016296973;
				double h = 0.75;
	...
	private void method_7549() {
		if (this.method_5782()) {
			...
			this.field_6031 += this.field_7690;
			if (this.field_7709) {
				f += 0.04F;
			}
			...
			this.field_5967 += (double)(class_3532.method_15374(-this.field_6031 * (float) (Math.PI / 180.0)) * f);
			this.field_6006 += (double)(class_3532.method_15362(this.field_6031 * (float) (Math.PI / 180.0)) * f);
	...
	public void method_5865(class_1297 arg) {
		if (this.method_5626(arg)) {
			...
			arg.field_6031 += this.field_7690;
	...
	protected void method_5623(double d, boolean bl, class_2680 arg, class_2338 arg2) {
		this.field_7696 = this.field_5984;
		if (!this.method_5765()) {
			if (bl) {
