...
public class class_1777 extends class_1792 {
	...
	public class_1269 method_7884(class_1838 arg) {
		...
		if (lv3.method_11614() != class_2246.field_10398 || lv3.method_11654(class_2333.field_10958)) {
			...
			for(int i = 0; i < 16; ++i) {
				double d = (double)((float)lv2.method_10263() + (5.0F + field_8005.nextFloat() * 6.0F) / 16.0F);
				double e = (double)((float)lv2.method_10264() + 0.8125F);
				double f = (double)((float)lv2.method_10260() + (5.0F + field_8005.nextFloat() * 6.0F) / 16.0F);
				double g = 0.0;
				double h = 0.0;
				double j = 0.0;
			...
			lv.method_8396(null, lv2, class_3417.field_14874, class_3419.field_15245, 1.0F, 1.0F);
			...
			if (lv5 != null) {
				...
				for(int k = 0; k < 3; ++k) {
					for(int l = 0; l < 3; ++l) {
						lv.method_8652(lv6.method_10069(k, 0, l), class_2246.field_10027.method_9564(), 2);
					}
				}
	...
	public class_1271<class_1799> method_7836(class_1937 arg, class_1657 arg2, class_1268 arg3) {
		...
		class_239 lv2 = this.method_7872(arg, arg2, false);
		if (lv2 != null && lv2.field_1330 == class_239.class_240.field_1332 && arg.method_8320(lv2.method_1015()).method_11614() == class_2246.field_10398) {
			...
			if (!arg.field_9236) {
				...
				if (lv3 != null) {
					class_1672 lv4 = new class_1672(arg, arg2.field_5987, arg2.field_6010 + (double)(arg2.field_6019 / 2.0F), arg2.field_6035);
					lv4.method_16933(lv);
					lv4.method_7478(lv3);
					arg.method_8649(lv4);
