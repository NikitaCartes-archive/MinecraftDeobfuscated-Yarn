...
public class class_3494<T> {
	...
	public static class class_3495<T> {
		...
		public class_3494.class_3495<T> method_15147(Predicate<class_2960> predicate, Function<class_2960, T> function, JsonObject jsonObject) {
			...
			for(JsonElement jsonElement : jsonArray) {
				...
				if (!string.startsWith("#")) {
					...
					T object = (T)function.apply(lv);
					if (object == null || !predicate.test(lv)) {
						throw new JsonParseException("Unknown value '" + lv + "'");
					}

					this.method_15153(object);
				} else {
