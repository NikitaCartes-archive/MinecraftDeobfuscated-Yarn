...
public class class_3924 extends class_2586 implements class_3829, class_3000 {
	...
	public void method_16896() {
		boolean bl = this.method_11010().method_11654(class_3922.field_17352);
		...
		if (lv != null) {
			...
			if (random.nextFloat() < 0.11F) {
				for(int i = 0; i < random.nextInt(2) + 2; ++i) {
					class_3922.method_17455(lv, lv2, this.method_11010().method_11654(class_3922.field_17353), false);
				}
			}
			...
			for(int j = 0; j < this.field_17383.size(); ++j) {
				if (!this.field_17383.get(j).method_7960() && random.nextFloat() < 0.2F) {
					...
					float f = 0.3125F;
					double d = (double)lv2.method_10263()
						+ 0.5
						- (double)((float)lv3.method_10148() * 0.3125F)
						+ (double)((float)lv3.method_10170().method_10148() * 0.3125F);
					double e = (double)lv2.method_10264() + 0.5;
					double g = (double)lv2.method_10260()
						+ 0.5
						- (double)((float)lv3.method_10165() * 0.3125F)
						+ (double)((float)lv3.method_10170().method_10165() * 0.3125F);
