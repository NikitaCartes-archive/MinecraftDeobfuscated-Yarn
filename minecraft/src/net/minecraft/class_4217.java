...
public class class_4217 extends class_4097<class_1646> {
	...
	protected boolean method_19564(class_3218 arg, class_1646 arg2) {
		if (!arg.method_8450().method_8355("mobGriefing")) {
			...
			Set<class_2338> set = (Set)((List)arg2.method_18868().method_19543(class_4140.field_18873).get())
				.stream()
				.map(class_4208::method_19446)
				.collect(Collectors.toSet());
			class_2338 lv = new class_2338(arg2);
			List<class_2338> list = (List)ImmutableList.of(lv.method_10074(), lv.method_10072(), lv.method_10095(), lv.method_10078(), lv.method_10067())
				.stream()
				.filter(set::contains)
