...
public class class_3701 extends class_1429 {
	...
	public class_3701(class_1937 arg) {
		super(class_1299.field_6081, arg);
	...
	public class_3701 method_16104(class_1296 arg) {
		return new class_3701(this.field_6002);
	}
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		return this.field_5974.nextInt(3) != 0;
	}

	@Override
	public boolean method_5957(class_1941 arg) {
		if (arg.method_8606(this, this.method_5829()) && arg.method_8587(this, this.method_5829()) && !arg.method_8599(this.method_5829())) {
	...
	protected void method_16105() {
		for (int i = 0; i < 2; i++) {
			class_3701 lv = new class_3701(this.field_6002);
	...
	static class class_3702<T extends class_1297> extends class_1338<T> {
