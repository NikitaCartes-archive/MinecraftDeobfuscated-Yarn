...
public class class_4267 extends class_4280<class_4267.class_504> {
	...
	public void method_20122(class_4267.class_504 arg) {
		...
		if (this.getSelected() instanceof class_4267.class_4270) {
			class_333.field_2054.method_19788(new class_2588("narrator.select", ((class_4267.class_4270)this.getSelected()).field_19120.field_3752).getString());
		}
	}
	...
	public class class_4270 extends class_4267.class_504 {
		...
		public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
			...
			class_332.blit(k + l - 15, j, (float)(r * 10), (float)(176 + s * 8), 10, 8, 256, 256);
		...
		protected void method_20134(int i, int j, class_2960 arg) {
			...
			class_332.blit(i, j, 0.0F, 0.0F, 32, 32, 32, 32);
		...
		@Override
		public boolean mouseClicked(double d, double e, int i) {
			double f = d - (double)class_4267.this.getRowLeft();
			double g = e - (double)class_4267.this.getRowTop(class_4267.this.children().indexOf(this));
			if (f <= 32.0) {
				...
				if (f < 16.0 && g < 16.0 && j > 0) {
					...
					if (this.field_19118.field_3043.getSelected() == this) {
						this.field_19118.method_2531(this);
					}
	...
	@Environment(EnvType.CLIENT)
	public abstract static class class_504 extends class_4280.class_4281<class_4267.class_504> {
	}
}
