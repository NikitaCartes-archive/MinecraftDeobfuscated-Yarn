...
public final class class_259 {
	...
	public static double method_1085(class_2350.class_2351 arg, class_238 arg2, Stream<class_265> stream, double d) {
		for(Iterator<class_265> iterator = stream.iterator(); iterator.hasNext(); d = ((class_265)iterator.next()).method_1108(arg, arg2, d)) {
			...
			for(int p = m; bl ? p <= n : p >= n; p += o) {
				for(int q = i; q <= j; ++q) {
					for(int r = k; r <= l; ++r) {
						...
						if (s < 3) {
							lv5.method_17965(lv, q, r, p);
							class_2680 lv6 = arg2.method_8320(lv5);
							if ((s != 1 || lv6.method_17900()) && (s != 2 || lv6.method_11614() == class_2246.field_10008)) {
	...
	public static boolean method_20713(class_265 arg, class_265 arg2) {
		if (arg == method_1077() || arg2 == method_1077()) {
			return true;
		} else if (arg.method_1110() && arg2.method_1110()) {
			return false;
		} else {
			return !method_1074(method_1077(), method_1082(arg, arg2, class_247.field_1366), class_247.field_16886);
		}
	}
