...
public abstract class class_1429 extends class_1296 implements class_1298 {
	protected class_2248 field_6746 = class_2246.field_10219;
	private int field_6745;
	private UUID field_6744;

	protected class_1429(class_1299<?> arg, class_1937 arg2) {
		super(arg, arg2);
	}
	...
	public float method_6144(class_2338 arg, class_1941 arg2) {
		return arg2.method_8320(arg.method_10074()).method_11614() == this.field_6746 ? 10.0F : arg2.method_8610(arg) - 0.5F;
	}
	...
	public boolean method_5979(class_1936 arg, class_3730 arg2) {
		...
		return arg.method_8320(lv.method_10074()).method_11614() == this.field_6746 && arg.method_8624(lv, 0) > 8 && super.method_5979(arg, arg2);
	}
	...
	public class_3222 method_6478() {
		if (this.field_6744 == null) {
			...
			class_1657 lv = this.field_6002.method_8420(this.field_6744);
	...
	public boolean method_6474(class_1429 arg) {
		if (arg == this) {
			return false;
		} else if (arg.getClass() != this.getClass()) {
			return false;
		} else {
			return this.method_6479() && arg.method_6479();
		}
	}
