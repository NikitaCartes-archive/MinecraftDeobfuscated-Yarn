...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_20169 = new RealmsButton(1, i, class_4359.method_21072(12), j, 20, class_4426.getLocalizedString("mco.terms.buttons.agree")){
        ...
        this.buttonsAdd(this.field_20169);
        this.buttonsAdd(new RealmsButton(2, k, class_4359.method_21072(12), j, 20, class_4426.getLocalizedString("mco.terms.buttons.disagree")){
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(class_4426.getLocalizedString("mco.terms.title"), this.width() / 2, 17, 0xFFFFFF);
        this.drawString(class_4426.getLocalizedString("mco.terms.sentence.1"), this.width() / 2 - 120, class_4359.method_21072(5), 0xFFFFFF);
        int k = this.fontWidth(class_4426.getLocalizedString("mco.terms.sentence.1"));
        ...
        if (l <= i && i <= n && m <= j && j <= o) {
            ...
            this.drawString(" " + class_4426.getLocalizedString("mco.terms.sentence.2"), this.width() / 2 - 120 + k, class_4359.method_21072(5), 7107012);
        } else {
            this.field_20170 = false;
            this.drawString(" " + class_4426.getLocalizedString("mco.terms.sentence.2"), this.width() / 2 - 120 + k, class_4359.method_21072(5), 0x3366BB);
        }
        super.render(i, j, f);
    }
}
