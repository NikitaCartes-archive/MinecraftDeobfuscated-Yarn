...
public class class_4396
extends RealmsScreen {
    private final class_4397 field_19895;
    ...
    public class_4396(RealmsConfirmResultListener realmsConfirmResultListener, class_4397 arg, String string, String string2, boolean bl, int i) {
        ...
        this.field_19899 = bl;
        this.field_19892 = class_4396.getLocalizedString("gui.yes");
        this.field_19893 = class_4396.getLocalizedString("gui.no");
        this.field_19898 = class_4396.getLocalizedString("mco.gui.ok");
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.field_19896, this.width() / 2, class_4359.method_21072(4), 0xFFFFFF);
        this.drawCenteredString(this.field_19897, this.width() / 2, class_4359.method_21072(6), 0xFFFFFF);
        super.render(i, j, f);
    }
