...
public class class_4820<E extends LivingEntity>
extends Task<E> {
    ...
    public class_4820(Map<MemoryModuleType<?>, MemoryModuleState> map, Predicate<E> predicate, Task<? super E> task, boolean bl) {
        super(class_4820.method_24597(map, task.requiredMemoryState));
        this.field_22313 = predicate;
        this.field_22314 = task;
        this.field_22315 = bl;
    }

    private static Map<MemoryModuleType<?>, MemoryModuleState> method_24597(Map<MemoryModuleType<?>, MemoryModuleState> map, Map<MemoryModuleType<?>, MemoryModuleState> map2) {
        HashMap<MemoryModuleType<?>, MemoryModuleState> map3 = Maps.newHashMap();
        map3.putAll(map);
        map3.putAll(map2);
        return map3;
    }
