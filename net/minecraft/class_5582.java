...
public class class_5582<T extends EntityLike> {
    ...
    public class_5582(Class<T> class_, EntityLoader<T> entityLoader) {
        ...
        this.field_27282 = new class_5573<T>(class_, l -> this.field_27283.contains(l) ? class_5584.TICKING : class_5584.TRACKED);
        this.field_27280 = entityLoader;
        this.field_27284 = new class_5578<T>(this.field_27281, this.field_27282);
    }
    ...
    implements class_5569 {
        ...
        private class_5583(T entity, long l, class_5572<T> arg2) {
            void var3_3;
            this.field_27285 = arg;
            this.entity = entity;
            this.field_27287 = var3_3;
        ...
        public void updateEntityPosition() {
            ...
            if (l != this.field_27287) {
                ...
                if (!this.field_27288.method_31767(this.entity)) {
                    field_27279.warn("Entity {} wasn't found in section {} (moving to {})", this.entity, (Object)ChunkSectionPos.from(this.field_27287), (Object)l);
                }
                this.field_27285.method_31868(this.field_27287, this.field_27288);
                class_5572 lv2 = this.field_27285.field_27282.method_31784(l);
                ...
                if (!this.entity.isPlayer()) {
                    ...
                    if (bl && !bl2) {
                        this.field_27285.field_27280.removeEntity(this.entity);
                    } else if (!bl && bl2) {
                        this.field_27285.field_27280.addEntity(this.entity);
                    }
                }
            }
        }
        ...
        public void remove(Entity.RemovalReason reason) {
            class_5584 lv;
            if (!this.field_27288.method_31767(this.entity)) {
                field_27279.warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, (Object)ChunkSectionPos.from(this.field_27287), (Object)reason);
            }
            if ((lv = this.field_27288.method_31768()).shouldTick() || this.entity.isPlayer()) {
                this.field_27285.field_27280.removeEntity(this.entity);
            }
            this.field_27285.field_27280.onUnloadEntity(this.entity);
            this.field_27285.field_27280.destroyEntity(this.entity);
            this.field_27285.field_27281.removeEntity(this.entity);
