...
extends class_4629 {
    ...
    public <T> T serialize(DynamicOps<T> dynamicOps) {
        return new Dynamic<T>(dynamicOps, dynamicOps.createMap(ImmutableMap.of(dynamicOps.createString("type"), dynamicOps.createString(Registry.BLOCK_PLACER_TYPE.getId(this.field_21222).toString()), dynamicOps.createString("min_size"), dynamicOps.createInt(this.field_21227), dynamicOps.createString("extra_size"), dynamicOps.createInt(this.field_21228)))).getValue();
    }
}
