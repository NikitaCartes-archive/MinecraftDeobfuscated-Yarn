...
public class CookingRecipeSerializer<T extends CookingRecipe>
implements RecipeSerializer<T> {
    ...
    public void method_17735(PacketByteBuf packetByteBuf, T cookingRecipe) {
        packetByteBuf.writeString(((CookingRecipe)cookingRecipe).group);
        ((CookingRecipe)cookingRecipe).input.write(packetByteBuf);
        packetByteBuf.writeItemStack(((CookingRecipe)cookingRecipe).output);
        packetByteBuf.writeFloat(((CookingRecipe)cookingRecipe).experience);
        packetByteBuf.writeVarInt(((CookingRecipe)cookingRecipe).cookTime);
    }
    ...
    static interface RecipeFactory<T extends CookingRecipe> {
