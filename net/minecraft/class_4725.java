...
public class class_4725 {
    ...
    public static NativeImage[] method_24102(NativeImage nativeImage, int i) {
        ...
        if (i > 0) {
            ...
            for (j = 1; j <= i; ++j) {
                ...
                for (int n = 0; n < l; ++n) {
                    for (int o = 0; o < m; ++o) {
                        nativeImage3.setPixelRgba(n, o, class_4725.method_24101(nativeImage2.getPixelRgba(n * 2 + 0, o * 2 + 0), nativeImage2.getPixelRgba(n * 2 + 1, o * 2 + 0), nativeImage2.getPixelRgba(n * 2 + 0, o * 2 + 1), nativeImage2.getPixelRgba(n * 2 + 1, o * 2 + 1), bl));
                    }
                }
    ...
    private static int method_24101(int i, int j, int k, int l, boolean bl) {
        if (bl) {
            ...
            float m = 0.0f;
            if (i >> 24 != 0) {
                f += class_4725.method_24099(i >> 24);
                g += class_4725.method_24099(i >> 16);
                h += class_4725.method_24099(i >> 8);
                m += class_4725.method_24099(i >> 0);
            }
            if (j >> 24 != 0) {
                f += class_4725.method_24099(j >> 24);
                g += class_4725.method_24099(j >> 16);
                h += class_4725.method_24099(j >> 8);
                m += class_4725.method_24099(j >> 0);
            }
            if (k >> 24 != 0) {
                f += class_4725.method_24099(k >> 24);
                g += class_4725.method_24099(k >> 16);
                h += class_4725.method_24099(k >> 8);
                m += class_4725.method_24099(k >> 0);
            }
            if (l >> 24 != 0) {
                f += class_4725.method_24099(l >> 24);
                g += class_4725.method_24099(l >> 16);
                h += class_4725.method_24099(l >> 8);
                m += class_4725.method_24099(l >> 0);
            }
        ...
        int r = class_4725.method_24100(i, j, k, l, 24);
        int s = class_4725.method_24100(i, j, k, l, 16);
        int t = class_4725.method_24100(i, j, k, l, 8);
        int u = class_4725.method_24100(i, j, k, l, 0);
        return r << 24 | s << 16 | t << 8 | u;
    }

    private static int method_24100(int i, int j, int k, int l, int m) {
        float f = class_4725.method_24099(i >> m);
        float g = class_4725.method_24099(j >> m);
        float h = class_4725.method_24099(k >> m);
        float n = class_4725.method_24099(l >> m);
