...
public class Properties {
    ...
    public static final EnumProperty<Direction.Axis> AXIS_XZ = EnumProperty.create((String)"axis", Direction.Axis.class, (Enum[])new Direction.Axis[]{Direction.Axis.X, Direction.Axis.Z});
    ...
    public static final DirectionProperty HOPPER_FACING = DirectionProperty.create("facing", direction -> direction != Direction.UP);
    ...
    public static final EnumProperty<RailShape> STRAIGHT_RAIL_SHAPE = EnumProperty.create("shape", RailShape.class, railShape -> railShape != RailShape.NORTH_EAST && railShape != RailShape.NORTH_WEST && railShape != RailShape.SOUTH_EAST && railShape != RailShape.SOUTH_WEST);
