...
public class class_5950 {
    ...
    public Map<class_5949, List<class_5948>> method_34701() {
        return this.field_29556.keySet().stream().flatMap(arg -> arg.method_34705().stream()).collect(Collectors.collectingAndThen(Collectors.groupingBy(class_5948::method_34699), EnumMap::new));
    }
}
