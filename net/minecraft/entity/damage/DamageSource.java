...
public class DamageSource {
    ...
    public static DamageSource explosiveProjectile(ExplosiveProjectileEntity explosiveProjectileEntity, @Nullable Entity entity) {
        if (entity == null) {
            return new ProjectileDamageSource("onFire", explosiveProjectileEntity, explosiveProjectileEntity).setFire().setProjectile();
        }
        return new ProjectileDamageSource("fireball", explosiveProjectileEntity, entity).setFire().setProjectile();
    }
    ...
    public static DamageSource explosion(@Nullable LivingEntity livingEntity) {
        if (livingEntity != null) {
            return new EntityDamageSource("explosion.player", livingEntity).setScaledWithDifficulty().setExplosive();
        }
        return new DamageSource("explosion").setScaledWithDifficulty().setExplosive();
    }
