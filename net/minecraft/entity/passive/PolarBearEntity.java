...
extends AnimalEntity {
    ...
    public static DefaultAttributeContainer.Builder createPolarBearAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.GENERIC_MAX_HEALTH, 30.0).add(Attributes.GENERIC_FOLLOW_RANGE, 20.0).add(Attributes.GENERIC_MOVEMENT_SPEED, 0.25).add(Attributes.GENERIC_ATTACK_DAMAGE, 6.0);
    }
