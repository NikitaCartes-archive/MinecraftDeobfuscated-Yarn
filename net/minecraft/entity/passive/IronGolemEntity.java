...
extends GolemEntity {
    ...
    public static DefaultAttributeContainer.Builder createIronGolemAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.GENERIC_MAX_HEALTH, 100.0).add(Attributes.GENERIC_MOVEMENT_SPEED, 0.25).add(Attributes.GENERIC_KNOCKBACK_RESISTANCE, 1.0).add(Attributes.GENERIC_ATTACK_DAMAGE, 15.0);
    }
