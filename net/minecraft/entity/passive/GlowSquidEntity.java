...
extends SquidEntity {
    ...
    public static boolean canSpawn(EntityType<? extends LivingEntity> type, ServerWorldAccess serverWorldAccess, SpawnReason reason, BlockPos blockPos, Random random) {
        return blockPos.getY() <= serverWorldAccess.getSeaLevel() - 33 && serverWorldAccess.getBaseLightLevel(blockPos, 0) == 0 && serverWorldAccess.getBlockState(blockPos).isOf(Blocks.WATER);
    }
}
