...
implements RangedAttackMob {
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            if (this.world.method_23753(blockPos).getTemperature(blockPos2) > 1.0f) {
            ...
            for (int l = 0; l < 4; ++l) {
                ...
                if (!this.world.getBlockState(blockPos3).isAir() || !(this.world.method_23753(blockPos3).getTemperature(blockPos3) < 0.8f) || !blockState.canPlaceAt(this.world, blockPos3)) continue;
