...
Saddleable {
    ...
    protected void setChildAttributes(PassiveEntity mate, HorseBaseEntity child) {
        double d = this.method_26826(EntityAttributes.GENERIC_MAX_HEALTH) + mate.method_26826(EntityAttributes.GENERIC_MAX_HEALTH) + (double)this.getChildHealthBonus();
        child.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(d / 3.0);
        double e = this.method_26826(EntityAttributes.HORSE_JUMP_STRENGTH) + mate.method_26826(EntityAttributes.HORSE_JUMP_STRENGTH) + this.getChildJumpStrengthBonus();
        child.getAttributeInstance(EntityAttributes.HORSE_JUMP_STRENGTH).setBaseValue(e / 3.0);
        double f = this.method_26826(EntityAttributes.GENERIC_MOVEMENT_SPEED) + mate.method_26826(EntityAttributes.GENERIC_MOVEMENT_SPEED) + this.getChildMovementSpeedBonus();
