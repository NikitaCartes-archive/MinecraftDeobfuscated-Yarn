...
JumpingMount {
    ...
    public void handleFallDamage(float f, float g) {
        ...
        if ((i = MathHelper.ceil((f * 0.5f - 3.0f) * g)) <= 0) {
            return;
        }
    ...
    protected void walkToParent() {
        ...
        if (this.isBred() && this.isBaby() && !this.isEatingGrass() && (livingEntity = this.world.getClosestEntity(HorseBaseEntity.class, PARENT_HORSE_PREDICATE, this, this.x, this.y, this.z, this.getBoundingBox().stretch(16.0, 16.0, 16.0))) != null && this.squaredDistanceTo(livingEntity) > 4.0) {
