...
extends FishEntity {
    ...
    private static final TargetPredicate field_33692 = new TargetPredicate().includeInvulnerable().ignoreDistanceScalingFactor().ignoreEntityTargetRules().includeTeammates().includeHidden().setPredicate(BLOW_UP_FILTER);
