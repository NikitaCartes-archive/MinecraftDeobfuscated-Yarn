...
public class EntityType<T extends Entity> {
    ...
    public EntityType(EntityFactory<T> factory, EntityCategory category, boolean saveable, boolean summonable, boolean fireImmune, boolean spawnableFarFromPlayer, int immediateDespawnRange, int despawnStartRange, EntityDimensions dimensions, int maxTrackDistance, int trackTickInterval) {
    ...
    public static class Builder<T extends Entity> {
        ...
        public Builder<T> immediateDespawnRange(int immediateDespawnRange) {
            this.immediateDespawnRange = immediateDespawnRange;
            return this;
        }
