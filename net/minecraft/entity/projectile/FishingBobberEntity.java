...
extends ProjectileEntity {
    ...
    public FishingBobberEntity(PlayerEntity thrower, World world, int luckOfTheSeaLevel, int lureLevel) {
        ...
        vec3d = vec3d.multiply(0.6 / m + this.random.method_43385(0.5, 0.0103365), 0.6 / m + this.random.method_43385(0.5, 0.0103365), 0.6 / m + this.random.method_43385(0.5, 0.0103365));
    ...
    private void tickFishingLogic(BlockPos pos) {
        ...
        if (this.hookCountdown > 0) {
            ...
            if (this.fishTravelCountdown > 0) {
                double j;
                double e;
                this.fishAngle += (float)this.random.method_43385(0.0, 9.188);
