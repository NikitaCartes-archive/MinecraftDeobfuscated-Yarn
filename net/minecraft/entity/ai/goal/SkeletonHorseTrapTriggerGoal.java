...
extends Goal {
    ...
    private SkeletonEntity getSkeleton(LocalDifficulty localDifficulty, HorseBaseEntity horseBaseEntity) {
        ...
        skeletonEntity.setEquippedStack(EquipmentSlot.MAINHAND, EnchantmentHelper.enchant(skeletonEntity.getRand(), skeletonEntity.getMainHandStack(), (int)(5.0f + localDifficulty.getClampedLocalDifficulty() * (float)skeletonEntity.getRand().nextInt(18)), false));
        skeletonEntity.setEquippedStack(EquipmentSlot.HEAD, EnchantmentHelper.enchant(skeletonEntity.getRand(), skeletonEntity.getEquippedStack(EquipmentSlot.HEAD), (int)(5.0f + localDifficulty.getClampedLocalDifficulty() * (float)skeletonEntity.getRand().nextInt(18)), false));
