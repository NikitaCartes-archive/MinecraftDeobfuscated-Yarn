...
extends Goal {
    ...
    @Override
    public void tick() {
        this.wolf.getLookControl().lookAt(this.begFrom.x, this.begFrom.y + (double)this.begFrom.getStandingEyeHeight(), this.begFrom.z, 10.0f, this.wolf.getLookPitchSpeed());
        --this.timer;
    }
