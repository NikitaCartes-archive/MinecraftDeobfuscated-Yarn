...
public abstract class EntityNavigation {
    ...
    protected static boolean method_43394(MobEntity mobEntity, Vec3d vec3d, Vec3d vec3d2) {
        ...
        return mobEntity.world.raycast(new RaycastContext(vec3d, vec3d3, RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.NONE, mobEntity)).getType() == HitResult.Type.MISS;
    }
