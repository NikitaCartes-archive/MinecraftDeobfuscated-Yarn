...
public class BodyControl {
    ...
    private void method_20243() {
        this.entity.field_6283 = MathHelper.method_20306(this.entity.field_6283, this.entity.headYaw, this.entity.method_5986());
    }

    private void method_20244() {
        this.entity.headYaw = MathHelper.method_20306(this.entity.headYaw, this.entity.field_6283, this.entity.method_5986());
    }
