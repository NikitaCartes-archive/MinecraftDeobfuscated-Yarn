...
extends MoveControl {
    ...
    public void tick() {
        if (this.state == MoveControl.State.MOVE_TO) {
            ...
            float i = this.entity.isOnGround() ? (float)(this.speed * this.entity.method_26825(EntityAttributes.GENERIC_MOVEMENT_SPEED)) : (float)(this.speed * this.entity.method_26825(EntityAttributes.GENERIC_FLYING_SPEED));
