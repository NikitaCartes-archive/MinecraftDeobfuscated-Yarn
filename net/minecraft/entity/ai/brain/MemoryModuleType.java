...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<class_4844> ANGRY_AT = MemoryModuleType.register("angry_at", Optional.of(class_4844::method_24815));
    public static final MemoryModuleType<Boolean> ADMIRING_ITEM = MemoryModuleType.register("admiring_item");
    public static final MemoryModuleType<PlayerEntity> WAS_HIT_BY_PLAYER = MemoryModuleType.register("was_hit_by_player");
    ...
    public static final MemoryModuleType<HoglinEntity> NEAREST_VISIBLE_ADULT_HOGLIN = MemoryModuleType.register("nearest_visible_adult_hoglin");
    ...
    public static final MemoryModuleType<class_4836> NEAREST_VISIBLE_BABY_PIGLIN = MemoryModuleType.register("nearest_visible_baby_piglin");
    ...
    public static final MemoryModuleType<List<class_4836>> NEAREST_VISIBLE_ADULT_PIGLINS = MemoryModuleType.register("nearest_visible_adult_piglins");
    ...
    public static final MemoryModuleType<class_4836> NEAREST_VISIBLE_ADULT_PIGLIN = MemoryModuleType.register("nearest_visible_adult_piglin");
    public static final MemoryModuleType<ZombiePigmanEntity> NEAREST_VISIBLE_ZOMBIFIED_PIGLIN = MemoryModuleType.register("nearest_visible_zombified_piglin");
    ...
    public static final MemoryModuleType<BlockPos> NEAREST_VISIBLE_WARPED_FUNGI = MemoryModuleType.register("nearest_visible_warped_fungi");
    public static final MemoryModuleType<BlockPos> NEAREST_VISIBLE_SOUL_FIRE_ITEM = MemoryModuleType.register("nearest_visible_soul_fire_item");
