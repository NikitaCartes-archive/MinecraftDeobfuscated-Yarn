...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<ZombifiedPiglinEntity> NEAREST_VISIBLE_ZOMBIFIED_PIGLIN = MemoryModuleType.register("nearest_visible_zombified_piglin");
