...
extends Task<MobEntity> {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, MobEntity mobEntity) {
        ...
        return !this.isHoldingUsableRangedWeapon(mobEntity) && LookTargetUtil.isVisibleInMemory(mobEntity, livingEntity) && LookTargetUtil.method_25941(mobEntity, livingEntity);
    }
