...
extends Task<LivingEntity> {
    ...
    public FollowMobTask(EntityCategory entityCategory, float f) {
        this((LivingEntity livingEntity) -> entityCategory.equals((Object)livingEntity.getType().getCategory()), f);
    }
    ...
    protected boolean shouldRun(ServerWorld serverWorld, LivingEntity livingEntity) {
        return livingEntity.getBrain().getOptionalMemory(MemoryModuleType.VISIBLE_MOBS).get().stream().anyMatch(this.mobType);
    }
