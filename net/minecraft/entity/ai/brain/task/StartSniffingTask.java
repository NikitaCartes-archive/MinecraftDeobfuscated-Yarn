...
extends Task<WardenEntity> {
    ...
    public StartSniffingTask() {
        super(ImmutableMap.of(MemoryModuleType.SNIFF_COOLDOWN, MemoryModuleState.VALUE_ABSENT, MemoryModuleType.NEAREST_ATTACKABLE, MemoryModuleState.VALUE_PRESENT, MemoryModuleType.DISTURBANCE_LOCATION, MemoryModuleState.VALUE_ABSENT));
    }
