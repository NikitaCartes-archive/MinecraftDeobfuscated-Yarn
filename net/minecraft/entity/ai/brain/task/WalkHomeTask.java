...
public class WalkHomeTask {
    ...
    public static Task<PathAwareEntity> create(float speed) {
        ...
        return TaskTriggerer.task(taskContext -> taskContext.group(taskContext.queryMemoryAbsent(MemoryModuleType.WALK_TARGET), taskContext.queryMemoryAbsent(MemoryModuleType.HOME)).apply(taskContext, (walkTarget, home) -> (world, entity, time) -> {
