...
extends Task<VillagerEntity> {
    ...
    private boolean method_19028(TradeOffer tradeOffer) {
        return ItemStack.areEqualIgnoreTags(this.field_18392, tradeOffer.getAdjustedFirstBuyItem()) || ItemStack.areEqualIgnoreTags(this.field_18392, tradeOffer.getSecondBuyItem());
    }
