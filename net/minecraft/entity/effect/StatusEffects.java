...
public class StatusEffects {
    ...
    public static final StatusEffect SPEED = StatusEffects.register(1, "speed", new StatusEffect(StatusEffectCategory.BENEFICIAL, 3402751).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 0.2f, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
    public static final StatusEffect SLOWNESS = StatusEffects.register(2, "slowness", new StatusEffect(StatusEffectCategory.HARMFUL, 9154528).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15f, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
    ...
    public static final StatusEffect STRENGTH = StatusEffects.register(5, "strength", new DamageModifierStatusEffect(StatusEffectCategory.BENEFICIAL, 16762624, 3.0).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0, EntityAttributeModifier.Operation.ADDITION));
    ...
    public static final StatusEffect INSTANT_DAMAGE = StatusEffects.register(7, "instant_damage", new InstantStatusEffect(StatusEffectCategory.HARMFUL, 11101546));
    public static final StatusEffect JUMP_BOOST = StatusEffects.register(8, "jump_boost", new StatusEffect(StatusEffectCategory.BENEFICIAL, 16646020));
    ...
    public static final StatusEffect RESISTANCE = StatusEffects.register(11, "resistance", new StatusEffect(StatusEffectCategory.BENEFICIAL, 9520880));
    public static final StatusEffect FIRE_RESISTANCE = StatusEffects.register(12, "fire_resistance", new StatusEffect(StatusEffectCategory.BENEFICIAL, 0xFF9900));
    public static final StatusEffect WATER_BREATHING = StatusEffects.register(13, "water_breathing", new StatusEffect(StatusEffectCategory.BENEFICIAL, 10017472));
    public static final StatusEffect INVISIBILITY = StatusEffects.register(14, "invisibility", new StatusEffect(StatusEffectCategory.BENEFICIAL, 0xF6F6F6));
    ...
    public static final StatusEffect NIGHT_VISION = StatusEffects.register(16, "night_vision", new StatusEffect(StatusEffectCategory.BENEFICIAL, 12779366));
