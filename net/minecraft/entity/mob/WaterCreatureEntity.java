...
extends PathAwareEntity {
    ...
    public static boolean canSpawn(EntityType<? extends WaterCreatureEntity> type, WorldAccess worldAccess, SpawnReason reason, BlockPos blockPos, Random random) {
        ...
        int j = i - 13;
        return blockPos.getY() >= j && blockPos.getY() <= i && worldAccess.getFluidState(blockPos.down()).isIn(FluidTags.WATER) && worldAccess.getBlockState(blockPos.up()).isOf(Blocks.WATER);
    }
}
