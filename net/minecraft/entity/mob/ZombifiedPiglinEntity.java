...
extends ZombieEntity {
    ...
    public static DefaultAttributeContainer.Builder createZombifiedPiglinAttributes() {
        return ZombieEntity.createZombieAttributes().add(Attributes.ZOMBIE_SPAWN_REINFORCEMENTS, 0.0).add(Attributes.GENERIC_MOVEMENT_SPEED, 0.23f).add(Attributes.GENERIC_ATTACK_DAMAGE, 5.0);
    }
