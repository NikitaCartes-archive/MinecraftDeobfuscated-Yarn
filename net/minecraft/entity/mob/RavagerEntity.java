...
extends RaiderEntity {
    ...
    public static DefaultAttributeContainer.Builder createRavagerAttributes() {
        return HostileEntity.createHostileAttributes().add(Attributes.GENERIC_MAX_HEALTH, 100.0).add(Attributes.GENERIC_MOVEMENT_SPEED, 0.3).add(Attributes.GENERIC_KNOCKBACK_RESISTANCE, 0.5).add(Attributes.GENERIC_ATTACK_DAMAGE, 12.0).add(Attributes.GENERIC_ATTACK_KNOCKBACK, 1.5).add(Attributes.GENERIC_FOLLOW_RANGE, 32.0);
    }
