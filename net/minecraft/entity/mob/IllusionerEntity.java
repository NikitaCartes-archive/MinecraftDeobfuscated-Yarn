...
implements RangedAttackMob {
    ...
    public static DefaultAttributeContainer.Builder createIllusionerAttributes() {
        return HostileEntity.createHostileAttributes().add(Attributes.GENERIC_MOVEMENT_SPEED, 0.5).add(Attributes.GENERIC_FOLLOW_RANGE, 18.0).add(Attributes.GENERIC_MAX_HEALTH, 32.0);
    }
