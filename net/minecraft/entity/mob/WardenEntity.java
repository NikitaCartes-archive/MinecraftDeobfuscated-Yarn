...
implements SculkSensorListener.Callback {
    ...
    protected void mobTick() {
        ...
        if ((this.age + this.getId()) % 120 == 0) {
            WardenEntity.addDarknessToClosePlayers((ServerWorld)this.world, this.getPos(), this, 20);
        }
        if (this.age % 20 == 0) {
    ...
    @VisibleForTesting
    public void increaseAngerAt(@Nullable Entity entity2, int amount) {
        if (WardenEntity.isValidTarget(entity2)) {
            WardenBrain.resetDigCooldown(this);
            ...
            if (entity2 instanceof PlayerEntity) {
                ...
                if (bl && Angriness.getForAnger(i) == Angriness.ANGRY) {
    ...
    public Optional<LivingEntity> getPrimeSuspect() {
        if (this.getAngriness() == Angriness.ANGRY) {
            return this.angerManager.getPrimeSuspect(this.world);
        }
    ...
    public boolean accepts(ServerWorld world, GameEventListener listener, BlockPos pos, GameEvent event, @Nullable Entity entity) {
        ...
        return !(entity instanceof LivingEntity) || WardenEntity.isValidTarget(entity);
    }
