...
extends HostileEntity {
    ...
    public static DefaultAttributeContainer.Builder createSilverfishAttributes() {
        return HostileEntity.createHostileAttributes().add(Attributes.GENERIC_MAX_HEALTH, 8.0).add(Attributes.GENERIC_MOVEMENT_SPEED, 0.25).add(Attributes.GENERIC_ATTACK_DAMAGE, 1.0);
    }
