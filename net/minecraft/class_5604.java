...
public final class class_5604 {
    ...
    protected class_5604(@Nullable String string, float f, float g, float h, float i, float j, float k, float l, float m, class_5605 arg, boolean bl, float n, float o) {
    ...
    public ModelPart.Cuboid method_32093(int i, int j) {
        return new ModelPart.Cuboid((int)this.field_27713.method_32118(), (int)this.field_27713.method_32119(), this.field_27709.getX(), this.field_27709.getY(), this.field_27709.getZ(), this.field_27710.getX(), this.field_27710.getY(), this.field_27710.getZ(), this.field_27711.field_27716, this.field_27711.field_27717, this.field_27711.field_27718, this.field_27712, (float)i * this.field_27714.method_32118(), (float)j * this.field_27714.method_32119());
    }
}
