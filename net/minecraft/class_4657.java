...
extends class_4651 {
    ...
    public <T> T serialize(DynamicOps<T> dynamicOps) {
        ...
        builder.put(dynamicOps.createString("type"), dynamicOps.createString(Registry.BLOCK_STATE_PROVIDER_TYPE.getId(this.field_21304).toString())).put(dynamicOps.createString("entries"), this.field_21315.method_23330(dynamicOps, blockState -> BlockState.serialize(dynamicOps, blockState)));
