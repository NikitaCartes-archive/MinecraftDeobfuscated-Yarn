...
public class class_5872 {
    ...
    public static final Codec<class_5872> field_29056 = RecordCodecBuilder.create(instance -> instance.group(Codec.BOOL.optionalFieldOf("debug_mode", false).forGetter(class_5872::method_33970), BlockState.CODEC.optionalFieldOf("air_state", field_29055.method_33973()).forGetter(class_5872::method_33973)).apply((Applicative<class_5872, ?>)instance, class_5872::new));
