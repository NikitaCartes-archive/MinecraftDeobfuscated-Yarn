...
import net.minecraft.class_5622;
...
implements TestListener {
    ...
    public void onStarted(GameTest test) {
        class_5624.method_32253(this.field_27810, Blocks.LIGHT_GRAY_STAINED_GLASS);
        ++this.field_27808;
    }
    ...
    public void onFailed(GameTest test) {
        ...
        class_5624.method_32248(this.field_27810.getWorld(), Formatting.YELLOW, string);
    ...
    protected static void method_32254(GameTest gameTest, Throwable throwable) {
        class_5624.method_32253(gameTest, gameTest.isRequired() ? Blocks.RED_STAINED_GLASS : Blocks.ORANGE_STAINED_GLASS);
        class_5624.method_32256(gameTest, Util.getInnermostMessage(throwable));
        class_5624.method_32255(gameTest, throwable);
    }
    ...
    protected static void method_32255(GameTest gameTest, Throwable throwable) {
        ...
        class_5624.method_32248(gameTest.getWorld(), gameTest.isRequired() ? Formatting.RED : Formatting.YELLOW, string2);
        ...
        if (throwable2 instanceof PositionedException) {
            ...
            class_5624.method_32247(gameTest.getWorld(), positionedException.getPos(), positionedException.getDebugMessage());
        }
    ...
    private static void method_32256(GameTest gameTest, String string) {
        ...
        ItemStack itemStack = class_5624.method_32251(gameTest.getStructurePath(), gameTest.isRequired(), string);
        LecternBlock.putBookIfAbsent(serverWorld, blockPos3, blockState, itemStack);
    }

    private static ItemStack method_32251(String string2, boolean bl, String string22) {
        ...
        stringBuffer.append("-------------------\n");
        listTag.add(StringTag.of(stringBuffer + string22));
    ...
    protected static void method_32248(ServerWorld serverWorld, Formatting formatting, String string) {
        serverWorld.getPlayers(serverPlayerEntity -> true).forEach(serverPlayerEntity -> serverPlayerEntity.sendSystemMessage(new LiteralText(string).formatted(formatting), Util.NIL_UUID));
    }
