...
public enum class_4990 implements StringIdentifiable
{
    ...
    private static final class_4990[][] field_23296;
    private static final class_4990[] field_23297;
    ...
    public Direction method_26388(Direction direction) {
        ...
        return this.field_23290.get(direction);
    }
    ...
    static {
        field_23296 = Util.make(new class_4990[class_4990.values().length][class_4990.values().length], args -> {
            Map<Pair, class_4990> map = Arrays.stream(class_4990.values()).collect(Collectors.toMap(arg -> Pair.of(arg.field_23295, arg.method_26391()), arg -> arg));
            for (class_4990 lv : class_4990.values()) {
                for (class_4990 lv2 : class_4990.values()) {
        ...
        field_23297 = (class_4990[])Arrays.stream(class_4990.values()).map(arg -> Arrays.stream(class_4990.values()).filter(arg2 -> arg.method_26385((class_4990)arg2) == field_23292).findAny().get()).toArray(class_4990[]::new);
    }
}
