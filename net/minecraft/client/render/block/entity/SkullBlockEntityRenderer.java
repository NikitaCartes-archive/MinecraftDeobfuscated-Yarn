...
extends BlockEntityRenderer<SkullBlockEntity> {
    ...
    public void method_3577(SkullBlockEntity skullBlockEntity, double d, double e, double f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        SkullBlockEntityRenderer.render(direction, k, ((AbstractSkullBlock)blockState.getBlock()).getSkullType(), skullBlockEntity.getOwner(), h, matrixStack, vertexConsumerProvider, i);
    }
