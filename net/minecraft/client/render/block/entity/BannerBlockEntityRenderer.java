    ...
    public void method_3546(BannerBlockEntity bannerBlockEntity, double d, double e, double f, float g, class_4587 arg, class_4597 arg2, int i) {
        ...
        if (bl) {
            ...
            if (blockState.getBlock() instanceof BannerBlock) {
                ...
                arg.method_22907(Vector3f.field_20705.method_23214((float)(-blockState.get(BannerBlock.ROTATION).intValue() * 360) / 16.0f, true));
                this.field_20811.visible = true;
            } else {
                arg.method_22904(0.5, -0.1666666716337204, 0.5);
                arg.method_22907(Vector3f.field_20705.method_23214(-blockState.get(WallBannerBlock.FACING).asRotation(), true));
