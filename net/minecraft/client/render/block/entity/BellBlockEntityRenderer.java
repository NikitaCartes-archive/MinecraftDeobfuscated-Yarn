...
extends BlockEntityRenderer<BellBlockEntity> {
    ...
    public void method_17139(BellBlockEntity bellBlockEntity, double d, double e, double f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
