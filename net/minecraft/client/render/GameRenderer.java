...
AutoCloseable {
    ...
    public void loadShaders(ResourceManager manager) {
        ...
        try {
            ...
            renderTypeEntityCutoutNoNullZOffsetShader = this.loadShader(manager, "rendertype_entity_cutout_no_cull_z_offset", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL);
            renderTypeItemEntityTranslucentCullShader = this.loadShader(manager, "rendertype_item_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL);
            renderTypeEntityTranslucentCullShader = this.loadShader(manager, "rendertype_entity_translucent_cull", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL);
