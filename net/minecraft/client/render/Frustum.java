...
public class Frustum {
    ...
    public boolean intersects(double d, double e, double f, double g, double h, double i) {
        for (int j = 0; j < 6; ++j) {
            ...
            if (this.getDistanceFromPlane(fs, d, e, f) > 0.0 || this.getDistanceFromPlane(fs, g, e, f) > 0.0 || this.getDistanceFromPlane(fs, d, h, f) > 0.0 || this.getDistanceFromPlane(fs, g, h, f) > 0.0 || this.getDistanceFromPlane(fs, d, e, i) > 0.0 || this.getDistanceFromPlane(fs, g, e, i) > 0.0 || this.getDistanceFromPlane(fs, d, h, i) > 0.0 || this.getDistanceFromPlane(fs, g, h, i) > 0.0) continue;
            return false;
        }
        return true;
    }
