...
implements DebugRenderer.Renderer {
    ...
    private void method_20571(class_4232 arg) {
        ...
        if (bl && !arg.field_19372.equals("")) {
            PointOfInterestDebugRenderer.method_19704(arg.field_18926, i, arg.field_19372, -98404, 0.02f);
            ++i;
        }
        if (bl) {
        ...
        if (arg.field_19373) {
            PointOfInterestDebugRenderer.method_19704(arg.field_18926, i, "Wants Golem", -23296, 0.02f);
            ++i;
        }
        if (bl) {
            for (String string : arg.field_19375) {
                if (string.startsWith(arg.field_19328)) {
                    PointOfInterestDebugRenderer.method_19704(arg.field_18926, i, string, -1, 0.02f);
                } else {
                    PointOfInterestDebugRenderer.method_19704(arg.field_18926, i, string, -23296, 0.02f);
                }
                ++i;
            }
        }
