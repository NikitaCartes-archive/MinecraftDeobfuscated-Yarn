...
extends IllagerEntityRenderer<IllusionerEntity> {
    ...
    public IllusionerEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
        ...
        this.addFeature(new HeldItemFeatureRenderer<IllusionerEntity, EvilVillagerEntityModel<IllusionerEntity>>((FeatureRendererContext)this){
            ...
            public void method_17149(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, IllusionerEntity illusionerEntity, float f, float g, float h, float j, float k, float l, float m) {
    ...
    public void method_3991(IllusionerEntity illusionerEntity, double d, double e, double f, float g, float h, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider) {
