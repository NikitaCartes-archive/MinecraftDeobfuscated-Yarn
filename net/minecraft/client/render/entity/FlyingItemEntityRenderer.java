...
extends EntityRenderer<T> {
    ...
    public void render(T entity, double d, double e, double f, float g, float h, MatrixStack matrixStack, LayeredVertexConsumerStorage layeredVertexConsumerStorage) {
        ...
        this.item.method_23178(((FlyingItemEntity)entity).getStack(), ModelTransformation.Type.GROUND, ((Entity)entity).getLightmapCoordinates(), matrixStack, layeredVertexConsumerStorage);
        matrixStack.pop();
