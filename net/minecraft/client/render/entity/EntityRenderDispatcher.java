...
import net.minecraft.client.render.entity.ExplodingWitherSkullEntityRenderer;
import net.minecraft.client.render.entity.FallingBlockEntityRenderer;
import net.minecraft.client.render.entity.FireworkEntityRenderer;
import net.minecraft.client.render.entity.FishHookEntityRenderer;
...
import net.minecraft.client.render.entity.IllagerBeastEntityRenderer;
...
import net.minecraft.client.render.entity.MinecartTNTEntityRenderer;
...
public class EntityRenderDispatcher {
    ...
    public EntityRenderDispatcher(TextureManager textureManager, ItemRenderer itemRenderer, ReloadableResourceManager reloadableResourceManager) {
        ...
        this.register(SnowGolemEntity.class, new SnowmanEntityRenderer(this));
        ...
        this.register(ZombiePigmanEntity.class, new PigZombieEntityRenderer(this));
        ...
        this.register(ExplodingWitherSkullEntity.class, new ExplodingWitherSkullEntityRenderer(this));
        ...
        this.register(TNTMinecartEntity.class, new MinecartTNTEntityRenderer(this));
        this.register(MobSpawnerMinecartEntity.class, new MinecartEntityRenderer(this));
        ...
        this.register(FishHookEntity.class, new FishHookEntityRenderer(this));
