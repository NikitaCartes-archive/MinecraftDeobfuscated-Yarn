...
extends EntityRenderer<PaintingEntity> {
    ...
    public void method_4075(PaintingEntity paintingEntity, double d, double e, double f, float g, float h, class_4587 arg, class_4597 arg2) {
        ...
        this.method_4074(arg.method_22910(), lv, paintingEntity, paintingMotive.getWidth(), paintingMotive.getHeight(), paintingManager.getPaintingSprite(paintingMotive), paintingManager.getBackSprite());
        lv.method_22923();
        arg.method_22909();
    ...
    private void method_23188(Matrix4f matrix4f, class_4588 arg, float f, float g, float h, float i, float j, int k, int l, int m, int n) {
        arg.method_22918(matrix4f, f, g, j).color(255, 255, 255, 255).texture(h, i).method_22916(n).method_22914(k, l, m).next();
    }
}
