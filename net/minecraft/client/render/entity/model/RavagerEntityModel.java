...
extends EntityModel<RavagerEntity> {
    ...
    public RavagerEntityModel() {
        ...
        this.field_3384.setTextureOffset(68, 73).addCuboid(-5.0f, -1.0f, -18.0f, 10, 10, 18, 0.0f);
        this.field_3386 = new ModelPart(this);
        this.field_3386.setPivot(0.0f, 16.0f, -17.0f);
        this.field_3386.setTextureOffset(0, 0).addCuboid(-8.0f, -20.0f, -14.0f, 16, 20, 16, 0.0f);
        this.field_3386.setTextureOffset(0, 0).addCuboid(-2.0f, -6.0f, -18.0f, 4, 8, 4, 0.0f);
        ModelPart modelPart = new ModelPart(this);
        modelPart.setPivot(-10.0f, -14.0f, -8.0f);
        modelPart.setTextureOffset(74, 55).addCuboid(0.0f, -14.0f, -2.0f, 2, 14, 4, 0.0f);
        ...
        modelPart2.setTextureOffset(74, 55).addCuboid(0.0f, -14.0f, -2.0f, 2, 14, 4, 0.0f);
        ...
        this.field_3388.setTextureOffset(0, 36).addCuboid(-8.0f, 0.0f, -16.0f, 16, 3, 16, 0.0f);
        this.field_3386.addChild(this.field_3388);
        this.field_3384.addChild(this.field_3386);
        this.field_3387 = new ModelPart(this);
        this.field_3387.setTextureOffset(0, 55).addCuboid(-7.0f, -10.0f, -7.0f, 14, 16, 20, 0.0f);
        this.field_3387.setTextureOffset(0, 91).addCuboid(-6.0f, 6.0f, -7.0f, 12, 13, 18, 0.0f);
        this.field_3387.setPivot(0.0f, 1.0f, 2.0f);
        this.field_3385 = new ModelPart(this, 96, 0);
        this.field_3385.addCuboid(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
        this.field_3385.setPivot(-8.0f, -13.0f, 18.0f);
        this.field_3383 = new ModelPart(this, 96, 0);
        this.field_3383.mirror = true;
        this.field_3383.addCuboid(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
        this.field_3383.setPivot(8.0f, -13.0f, 18.0f);
        this.field_3389 = new ModelPart(this, 64, 0);
        this.field_3389.addCuboid(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
        this.field_3389.setPivot(-8.0f, -13.0f, -5.0f);
        this.field_3382 = new ModelPart(this, 64, 0);
        this.field_3382.mirror = true;
        this.field_3382.addCuboid(-4.0f, 0.0f, -4.0f, 8, 37, 8, 0.0f);
        this.field_3382.setPivot(8.0f, -13.0f, -5.0f);
    }

    @Override
    public void render(RavagerEntity ravagerEntity, float f, float g, float h, float i, float j, float k) {
        this.setAngles(ravagerEntity, f, g, h, i, j, k);
    ...
    @Override
    public void setAngles(RavagerEntity ravagerEntity, float f, float g, float h, float i, float j, float k) {
    ...
    public /* synthetic */ void setAngles(Entity entity, float f, float g, float h, float i, float j, float k) {
        this.setAngles((RavagerEntity)entity, f, g, h, i, j, k);
    }

    @Override
    public /* synthetic */ void render(Entity entity, float f, float g, float h, float i, float j, float k) {
        this.render((RavagerEntity)entity, f, g, h, i, j, k);
    }
}
