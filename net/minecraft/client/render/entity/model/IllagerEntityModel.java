...
ModelWithHead {
    ...
    public IllagerEntityModel(float f, float g, int i, int j) {
        ...
        this.field_3421.setPivot(0.0f, g - 2.0f, 0.0f);
    ...
    @Override
    public void setAngles(T illagerEntity, float f, float g, float h, float i, float j, float k) {
    ...
    public /* synthetic */ void setAngles(Entity entity, float f, float g, float h, float i, float j, float k) {
        this.setAngles((T)((IllagerEntity)entity), f, g, h, i, j, k);
    }
