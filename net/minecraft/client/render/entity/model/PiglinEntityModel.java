...
public class PiglinEntityModel<T extends PiglinEntity>
extends BipedEntityModel<T> {
    ...
    public void setAngles(T piglinEntity, float f, float g, float h, float i, float j) {
        ...
        PiglinEntity.Activity activity = ((PiglinEntity)piglinEntity).getActivity();
        if (activity == PiglinEntity.Activity.CROSSBOW_HOLD) {
            ...
            float n = MathHelper.clamp(((LivingEntity)piglinEntity).getItemUseTime(), 0, 25);
            float o = n / 25.0f;
