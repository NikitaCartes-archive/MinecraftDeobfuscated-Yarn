...
extends CompositeEntityModel<BoatEntity> {
    ...
    public static TexturedModelData getTexturedModelData(boolean chest) {
        ...
        if (chest) {
            ...
            modelPartData.addChild(CHEST_LOCK, ModelPartBuilder.create().uv(0, 59).cuboid(0.0f, 0.0f, 0.0f, 2.0f, 4.0f, 1.0f), ModelTransform.of(-1.0f, -7.0f, -1.0f, 0.0f, -1.5707964f, 0.0f));
        }
        int n = 20;
        int o = 7;
        int p = 6;
