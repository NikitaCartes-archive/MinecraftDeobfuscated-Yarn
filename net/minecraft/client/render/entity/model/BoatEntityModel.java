...
extends EntityModel<BoatEntity> {
    ...
    public BoatEntityModel() {
        ...
        this.field_3327[0].pitch = 1.5707964f;
        this.field_3327[1].yaw = 4.712389f;
        this.field_3327[2].yaw = 1.5707964f;
        ...
        this.field_3325[0].roll = 0.19634955f;
        this.field_3325[1].roll = 0.19634955f;
