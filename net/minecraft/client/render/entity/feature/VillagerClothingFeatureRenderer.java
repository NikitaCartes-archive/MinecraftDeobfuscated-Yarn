...
implements SynchronousResourceReloadListener {
    ...
    public void method_17151(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, T livingEntity, float f, float g, float h, float j, float k, float l, float m) {
