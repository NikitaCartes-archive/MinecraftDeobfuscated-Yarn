...
extends FeatureRenderer<T, M> {
    ...
    public void method_17162(T livingEntity, float f, float g, float h, float i, float j, float k, float l) {
        ...
        boolean bl = ((LivingEntity)livingEntity).getMainHand() == AbsoluteHand.RIGHT;
        ...
        this.method_4192((LivingEntity)livingEntity, itemStack2, ModelTransformation.Type.THIRD_PERSON_RIGHT_HAND, AbsoluteHand.RIGHT);
        this.method_4192((LivingEntity)livingEntity, itemStack, ModelTransformation.Type.THIRD_PERSON_LEFT_HAND, AbsoluteHand.LEFT);
    ...
    protected void method_4193(AbsoluteHand absoluteHand) {
        ((ModelWithArms)this.getModel()).setArmAngle(0.0625f, absoluteHand);
    }
