...
extends EntityRenderer<LlamaSpitEntity> {
    ...
    public void method_4061(LlamaSpitEntity llamaSpitEntity, double d, double e, double f, float g, float h, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider) {
        matrixStack.push();
        ...
        matrixStack.pop();
        super.render(llamaSpitEntity, d, e, f, g, h, matrixStack, vertexConsumerProvider);
    }
