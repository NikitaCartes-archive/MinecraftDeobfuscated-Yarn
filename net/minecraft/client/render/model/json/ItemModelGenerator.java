...
public class ItemModelGenerator {
    ...
    public JsonUnbakedModel create(Function<SpriteIdentifier, Sprite> textureGetter, JsonUnbakedModel blockModel) {
        ...
        JsonUnbakedModel jsonUnbakedModel = new JsonUnbakedModel(null, list, map, false, blockModel.method_24298(), blockModel.getTransformations(), blockModel.getOverrides());
