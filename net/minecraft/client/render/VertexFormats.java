...
public class VertexFormats {
    ...
    public static final VertexFormat POSITION_COLOR_UV_NORMAL = new VertexFormat().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(UV_ELEMENT).add(LMAP_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT);
