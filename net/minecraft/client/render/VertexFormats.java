...
public class VertexFormats {
    ...
    public static final VertexFormat POSITION_COLOR_UV_LMAP = new VertexFormat().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).add(OVERLAY_ELEMENT);
    public static final VertexFormat POSITION_COLOR_TEXTURE_LIGHT_NORMAL = new VertexFormat().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT);
    public static final VertexFormat POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL = new VertexFormat().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT);
    public static final VertexFormat POSITION_TEXTURE_COLOR_LIGHT = new VertexFormat().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(COLOR_ELEMENT).add(OVERLAY_ELEMENT);
    ...
    public static final VertexFormat POSITION_TEXTURE_LIGHT_COLOR = new VertexFormat().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(OVERLAY_ELEMENT).add(COLOR_ELEMENT);
    public static final VertexFormat POSITION_TEXTURE_COLOR_NORMAL = new VertexFormat().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(COLOR_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT);
}
