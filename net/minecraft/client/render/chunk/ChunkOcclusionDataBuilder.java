...
public class ChunkOcclusionDataBuilder {
    ...
    public void markClosed(BlockPos blockPos) {
        this.closed.set(ChunkOcclusionDataBuilder.pack(blockPos), true);
        --this.openCount;
    }

    private static int pack(BlockPos blockPos) {
        return ChunkOcclusionDataBuilder.pack(blockPos.getX() & 0xF, blockPos.getY() & 0xF, blockPos.getZ() & 0xF);
    }
    ...
    public Set<Direction> getOpenFaces(BlockPos blockPos) {
        return this.getOpenFaces(ChunkOcclusionDataBuilder.pack(blockPos));
    }
