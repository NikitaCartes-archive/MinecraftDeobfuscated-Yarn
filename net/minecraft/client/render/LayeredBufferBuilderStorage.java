...
public class LayeredBufferBuilderStorage {
    ...
    private final SortedMap<RenderLayer, BufferBuilder> bufferBuilders = SystemUtil.consume(new Object2ObjectLinkedOpenHashMap(), object2ObjectLinkedOpenHashMap -> {
        ...
        object2ObjectLinkedOpenHashMap.put(RenderLayer.getEntityNoOutline(SpriteAtlasTexture.BLOCK_ATLAS_TEX), this.blockBufferBuilders.get(RenderLayer.getCutoutMipped()));
        object2ObjectLinkedOpenHashMap.put(RenderLayer.getEntityTranslucent(SpriteAtlasTexture.BLOCK_ATLAS_TEX), this.blockBufferBuilders.get(RenderLayer.getTranslucent()));
