...
public class BufferRenderer {
    ...
    public static void method_43433(BufferBuilder bufferBuilder) {
        if (!RenderSystem.isOnRenderThreadOrInit()) {
            RenderSystem.recordRenderCall(() -> BufferRenderer.method_43438(bufferBuilder));
        } else {
            BufferRenderer.method_43438(bufferBuilder);
        }
    }

    private static void method_43438(BufferBuilder bufferBuilder) {
        VertexBuffer vertexBuffer = BufferRenderer.method_43439(bufferBuilder);
    ...
    private static VertexBuffer method_43439(BufferBuilder bufferBuilder) {
        ...
        VertexBuffer vertexBuffer = BufferRenderer.method_43435(drawArrayParameters.getVertexFormat());
    ...
    private static VertexBuffer method_43435(VertexFormat vertexFormat) {
        ...
        BufferRenderer.method_43434(vertexBuffer);
        return vertexBuffer;
    }
