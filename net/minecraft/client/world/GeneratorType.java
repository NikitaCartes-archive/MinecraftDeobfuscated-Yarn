...
public abstract class GeneratorType {
    ...
    }, Optional.of(SINGLE_BIOME_SURFACE), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(GeneratorType.method_29079(generatorOptions, SINGLE_BIOME_SURFACE, biome)), GeneratorType.method_29083(generatorOptions)), Optional.of(SINGLE_BIOME_CAVES), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(GeneratorType.method_29079(generatorOptions, SINGLE_BIOME_CAVES, biome)), GeneratorType.method_29083(generatorOptions)), Optional.of(SINGLE_BIOME_FLOATING_ISLANDS), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(GeneratorType.method_29079(generatorOptions, SINGLE_BIOME_FLOATING_ISLANDS, biome)), GeneratorType.method_29083(generatorOptions)));
