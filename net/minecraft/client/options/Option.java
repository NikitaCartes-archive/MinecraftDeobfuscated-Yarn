...
public abstract class Option {
    ...
    public static final CyclingOption GRAPHICS = new CyclingOption("options.graphics", (gameOptions, integer) -> {
        ...
        if (gameOptions.field_25444 == class_5365.field_25429) {
            return cyclingOption.getDisplayPrefix().append(new LiteralText("").append(translatableText).formatted(Formatting.ITALIC));
        }
