...
import net.minecraft.client.gui.widget.AchievementObtainedStatus;
...
extends DrawableHelper {
    ...
    public void method_2325(int i, int j) {
        if (!this.display.isHidden() || this.field_2714 != null && this.field_2714.isDone()) {
            ...
            AchievementObtainedStatus achievementObtainedStatus = f >= 1.0f ? AchievementObtainedStatus.OBTAINED : AchievementObtainedStatus.UNOBTAINED;
            this.client.getTextureManager().bindTexture(WIDGETS_TEX);
            GlStateManager.color4f(1.0f, 1.0f, 1.0f, 1.0f);
            GlStateManager.enableBlend();
            this.blit(i + this.xPos + 3, j + this.yPos, this.display.getFrame().texV(), 128 + achievementObtainedStatus.getSpriteIndex() * 26, 26, 26);
    ...
    public void method_2331(int i, int j, float f, int k, int l) {
        AchievementObtainedStatus achievementObtainedStatus3;
        AchievementObtainedStatus achievementObtainedStatus2;
        AchievementObtainedStatus achievementObtainedStatus;
        ...
        if (g >= 1.0f) {
            n = this.field_2715 / 2;
            achievementObtainedStatus = AchievementObtainedStatus.OBTAINED;
            achievementObtainedStatus2 = AchievementObtainedStatus.OBTAINED;
            achievementObtainedStatus3 = AchievementObtainedStatus.OBTAINED;
        } else if (n < 2) {
            n = this.field_2715 / 2;
            achievementObtainedStatus = AchievementObtainedStatus.UNOBTAINED;
            achievementObtainedStatus2 = AchievementObtainedStatus.UNOBTAINED;
            achievementObtainedStatus3 = AchievementObtainedStatus.UNOBTAINED;
        ...
        this.blit(q, p, 0, achievementObtainedStatus.getSpriteIndex() * 26, n, 26);
        this.blit(q + n, p, 200 - o, achievementObtainedStatus2.getSpriteIndex() * 26, o, 26);
        this.blit(i + this.xPos + 3, j + this.yPos, this.display.getFrame().texV(), 128 + achievementObtainedStatus3.getSpriteIndex() * 26, 26, 26);
        if (bl) {
