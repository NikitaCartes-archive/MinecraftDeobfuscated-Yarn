...
extends ElementListWidget<Entry> {
    ...
    extends Entry {
        ...
        private KeyBindingEntry(final KeyBinding keyBinding) {
            ...
            this.editButton = new ButtonWidget(0, 0, 75, 20, this.bindingName, buttonWidget -> {
                ((KeyBindingListWidget)KeyBindingListWidget.this).gui.focusedBinding = keyBinding;
            }){
            ...
            this.resetButton = new ButtonWidget(0, 0, 50, 20, I18n.translate("controls.reset", new Object[0]), buttonWidget -> {
                ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.options.setKeyCode(keyBinding, keyBinding.getDefaultKeyCode());
        ...
        public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
            boolean bl2 = ((KeyBindingListWidget)KeyBindingListWidget.this).gui.focusedBinding == this.binding;
            ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.textRenderer.draw(this.bindingName, k + 90 - KeyBindingListWidget.this.field_2733, j + m / 2 - ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.textRenderer.fontHeight / 2, 0xFFFFFF);
            ...
            if (!this.binding.isNotBound()) {
                for (KeyBinding keyBinding : ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.options.keysAll) {
    ...
    extends Entry {
        ...
        public CategoryEntry(String string) {
            ...
            this.nameWidth = ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.textRenderer.getStringWidth(this.name);
        }

        @Override
        public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
            ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.textRenderer.draw(this.name, ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.currentScreen.width / 2 - this.nameWidth / 2, j + m - ((KeyBindingListWidget)KeyBindingListWidget.this).minecraft.textRenderer.fontHeight - 1, 0xFFFFFF);
        }
