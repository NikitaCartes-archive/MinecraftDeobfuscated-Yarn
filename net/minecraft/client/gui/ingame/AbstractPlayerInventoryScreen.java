...
public abstract class AbstractPlayerInventoryScreen<T extends Container>
extends ContainerScreen<T> {
    ...
    private void method_18643(int i, int j, Iterable<StatusEffectInstance> iterable) {
        ...
        for (StatusEffectInstance statusEffectInstance : iterable) {
            ...
            AbstractPlayerInventoryScreen.blit(i + 6, k + 7, this.blitOffset, 18, 18, statusEffectSpriteManager.getSprite(statusEffect));
            k += j;
        }
    }
