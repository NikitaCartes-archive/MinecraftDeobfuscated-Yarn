...
import net.minecraft.client.gui.ingame.CreativePlayerInventoryContainerListener;
...
public class CreativePlayerInventoryScreen
extends AbstractPlayerInventoryScreen<CreativeContainer> {
    ...
    protected void drawBackground(float f, int i, int j) {
        ...
        if (itemGroup == ItemGroup.INVENTORY) {
            PlayerInventoryScreen.drawEntity(this.left + 88, this.top + 45, 20, this.left + 88 - i, this.top + 45 - 30 - j, this.minecraft.player);
        }
    }
