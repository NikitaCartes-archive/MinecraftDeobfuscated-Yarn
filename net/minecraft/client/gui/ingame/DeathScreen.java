...
extends Screen {
    ...
    protected void init() {
        ...
        ButtonWidget buttonWidget2 = this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 96, 200, 20, string2, buttonWidget -> {
            ...
            YesNoScreen yesNoScreen = new YesNoScreen(this::method_20373, new TranslatableComponent("deathScreen.quit.confirm", new Object[0]), new TextComponent(""), I18n.translate("deathScreen.titleScreen", new Object[0]), I18n.translate("deathScreen.respawn", new Object[0]));
    ...
    private void method_20373(boolean bl) {
        if (bl) {
            ...
            this.minecraft.disconnect(new CloseWorldScreen(new TranslatableComponent("menu.savingLevel", new Object[0])));
            this.minecraft.openScreen(new MainMenuScreen());
        } else {
            this.minecraft.player.requestRespawn();
            this.minecraft.openScreen(null);
