...
Element {
    ...
    public void showAlternativesForResult(MinecraftClient minecraftClient, RecipeResultCollection recipeResultCollection, int i, int j, int k, int l, float f) {
        ...
        for (int v = 0; v < n; ++v) {
            ...
            if (this.furnace) {
                this.alternativeButtons.add(new class_511(w, x, recipe, bl2));
                continue;
            }
            this.alternativeButtons.add(new AlternateButtonWidget(w, x, recipe, bl2));
        }
    ...
    implements RecipeGridAligner<Ingredient> {
        ...
        public void renderButton(int i, int j, float f) {
            ...
            for (InputSlot inputSlot : this.slots) {
                ...
                RecipeAlternativesWidget.this.client.getItemRenderer().renderGuiItem(inputSlot.field_3120[MathHelper.floor(RecipeAlternativesWidget.this.time / 30.0f) % inputSlot.field_3120.length], m, n2);
