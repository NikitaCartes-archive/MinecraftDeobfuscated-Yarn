...
extends WarningScreen {
    ...
    protected void initButtons(int yOffset) {
        ...
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.BACK, buttonWidget -> this.client.setScreen(this.parent)).setPositionAndSize(this.width / 2 - 155 + 160, 100 + yOffset, 150, 20).build());
    }
}
