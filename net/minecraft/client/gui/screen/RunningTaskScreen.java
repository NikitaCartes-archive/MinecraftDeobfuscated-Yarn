...
public class RunningTaskScreen
extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        RunningTaskScreen.drawCenteredText(matrices, this.textRenderer, this.title, this.width / 2, 80, 0xFFFFFF);
        if (this.description == null) {
            String string = LoadingDisplay.get(Util.getMeasuringTimeMs());
            RunningTaskScreen.drawCenteredText(matrices, this.textRenderer, string, this.width / 2, 120, 0xA0A0A0);
        } else {
