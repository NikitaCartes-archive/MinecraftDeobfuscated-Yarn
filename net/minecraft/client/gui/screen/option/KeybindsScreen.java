...
extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.DONE, button -> this.client.setScreen(this.parent)).setPositionAndSize(this.width / 2 - 155 + 160, this.height - 29, 150, 20).build());
    }
