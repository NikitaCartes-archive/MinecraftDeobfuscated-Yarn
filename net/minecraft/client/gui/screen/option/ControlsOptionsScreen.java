...
extends GameOptionsScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(i, k, 150, 20, Text.method_43471("options.mouse_settings"), button -> this.client.setScreen(new MouseOptionsScreen(this, this.gameOptions))));
        this.addDrawableChild(new ButtonWidget(j, k, 150, 20, Text.method_43471("controls.keybinds"), button -> this.client.setScreen(new KeybindsScreen(this, this.gameOptions))));
