...
extends Screen {
    ...
    protected void init() {
        ...
        this.buttonAllowCommands = this.addButton(new ButtonWidget(this.width / 2 + 5, 100, 150, 20, new TranslatableText("selectWorld.allowCommands"), buttonWidget -> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.drawStringWithShadow(matrices, this.textRenderer, this.title, this.width / 2, 50, 0xFFFFFF);
