...
extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.CANCEL, button -> this.ruleSaver.accept(Optional.empty())).setPositionAndSize(this.width / 2 - 155 + 160, this.height - 29, 150, 20).build());
        this.doneButton = this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.DONE, button -> this.ruleSaver.accept(Optional.of(this.gameRules))).setPositionAndSize(this.width / 2 - 155, this.height - 29, 150, 20).build());
    }
