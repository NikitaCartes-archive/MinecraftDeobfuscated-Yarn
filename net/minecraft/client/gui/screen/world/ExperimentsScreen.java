...
extends Screen {
    ...
    protected void init() {
        ...
        this.experiments.forEach((pack, enabled2) -> builder.add(ExperimentsScreen.getDataPackName(pack), () -> this.experiments.getBoolean(pack), enabled -> this.experiments.put((ResourcePackProfile)pack, (boolean)enabled)).tooltip(pack.getDescription()));
