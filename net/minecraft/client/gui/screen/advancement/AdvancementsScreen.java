...
implements ClientAdvancementManager.Listener {
    ...
    private void drawAdvancementTree(MatrixStack matrixStack, int mouseY, int i, int j, int k) {
        ...
        if (advancementTab == null) {
            ...
            int l = j + 9 + 117;
            AdvancementsScreen.drawCenteredText(matrixStack, this.textRenderer, EMPTY_TEXT, l, k + 18 + 56 - this.textRenderer.fontHeight / 2, -1);
            AdvancementsScreen.drawCenteredText(matrixStack, this.textRenderer, SAD_LABEL_TEXT, l, k + 18 + 113 - this.textRenderer.fontHeight, -1);
            return;
        }
    ...
    public void drawWidgets(MatrixStack matrixStack, int i, int j) {
        ...
        this.textRenderer.draw(matrixStack, ADVANCEMENTS_TEXT, (float)(i + 8), (float)(j + 6), 0x404040);
    }
