...
extends Screen {
    ...
    protected void init() {
        ...
        this.movementText = MultilineText.create(this.textRenderer, Text.method_43469("demo.help.movementShort", gameOptions.forwardKey.getBoundKeyLocalizedText(), gameOptions.leftKey.getBoundKeyLocalizedText(), gameOptions.backKey.getBoundKeyLocalizedText(), gameOptions.rightKey.getBoundKeyLocalizedText()), Text.method_43471("demo.help.movementMouse"), Text.method_43469("demo.help.jump", gameOptions.jumpKey.getBoundKeyLocalizedText()), Text.method_43469("demo.help.inventory", gameOptions.inventoryKey.getBoundKeyLocalizedText()));
        this.fullWrappedText = MultilineText.create(this.textRenderer, (StringVisitable)Text.method_43471("demo.help.fullWrapped"), 218);
    }
