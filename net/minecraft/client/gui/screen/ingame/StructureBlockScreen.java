...
extends Screen {
    ...
    private static final ImmutableList<StructureBlockMode> MODES_EXCEPT_DATA = MODES.stream().filter(structureBlockMode -> structureBlockMode != StructureBlockMode.DATA).collect(ImmutableList.toImmutableList());
