...
extends ForgingScreen<SmithingScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        InventoryScreen.drawEntity(this.x + 141, this.y + 65, 25, ARMOR_STAND_ROTATION, null, (LivingEntity)this.armorStand);
    }
    ...
    private void renderSlotTooltip(MatrixStack matrices, int mouseX, int mouseY) {
        ...
        if (this.hasInvalidRecipe() && this.isPointWithinBounds(95, 45, 28, 21, mouseX, mouseY)) {
