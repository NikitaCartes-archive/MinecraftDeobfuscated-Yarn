...
extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (this.signing) {
            ...
            this.textRenderer.method_30883(matrices, field_25893, i + 36 + (114 - k) / 2, 34.0f, 0);
            ...
            this.textRenderer.method_30883(matrices, this.field_25892, i + 36 + (114 - m) / 2, 60.0f, 0);
            this.textRenderer.drawTrimmed(field_25894, i + 36, 82, 114, 0);
        } else {
            int n = this.textRenderer.getWidth(this.field_25891);
            this.textRenderer.method_30883(matrices, this.field_25891, i - n + 192 - 44, 18.0f, 0);
            PageContent pageContent = this.getPageContent();
            for (Line line : pageContent.lines) {
                this.textRenderer.method_30883(matrices, line.text, line.x, line.y, -16777216);
            }
