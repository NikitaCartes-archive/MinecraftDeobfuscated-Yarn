...
extends Screen {
    ...
    public static final String OUTDATED_GL_TEXT = "Please click " + (Object)((Object)ChatFormat.UNDERLINE) + "here" + (Object)((Object)ChatFormat.RESET) + " for more information.";
    ...
    public MainMenuScreen(boolean bl) {
        ...
        if (!GLX.supportsOpenGL2() && !GLX.isNextGen()) {
            this.warningTitle = I18n.translate("title.oldgl1", new Object[0]);
            this.warningText = I18n.translate("title.oldgl2", new Object[0]);
    ...
    public static CompletableFuture<Void> loadTexturesAsync(TextureManager textureManager, Executor executor) {
        return CompletableFuture.allOf(textureManager.loadTextureAsync(MINECRAFT_TITLE_TEXTURE, executor), textureManager.loadTextureAsync(EDITION_TITLE_TEXTURE, executor), textureManager.loadTextureAsync(panoramaOverlay, executor), panoramaCubeMap.loadTexturesAsync(textureManager, executor));
    }
    ...
    protected void init() {
        ...
        this.addButton(new RecipeBookButtonWidget(this.width / 2 - 124, j + 72 + 12, 20, 20, 0, 106, 20, ButtonWidget.WIDGETS_LOCATION, 256, 256, buttonWidget -> this.minecraft.openScreen(new LanguageOptionsScreen(this, this.minecraft.options, this.minecraft.getLanguageManager())), I18n.translate("narrator.button.language", new Object[0])));
        ...
        this.addButton(new RecipeBookButtonWidget(this.width / 2 + 104, j + 72 + 12, 20, 20, 0, 0, 20, field_19102, 32, 64, buttonWidget -> this.minecraft.openScreen(new AccessibilityScreen(this, this.minecraft.options)), I18n.translate("narrator.button.accessibility", new Object[0])));
    ...
    private void initWidgetsNormal(int i, int j) {
        this.addButton(new ButtonWidget(this.width / 2 - 100, i, 200, 20, I18n.translate("menu.singleplayer", new Object[0]), buttonWidget -> this.minecraft.openScreen(new LevelSelectScreen(this))));
    ...
    private void initWidgetsDemo(int i, int j) {
        ...
        this.buttonResetDemo = this.addButton(new ButtonWidget(this.width / 2 - 100, i + j * 1, 200, 20, I18n.translate("menu.resetdemo", new Object[0]), buttonWidget -> {
            ...
            if (levelProperties != null) {
                this.minecraft.openScreen(new YesNoScreen(this::method_20375, new TranslatableComponent("selectWorld.deleteQuestion", new Object[0]), new TranslatableComponent("selectWorld.deleteWarning", levelProperties.getLevelName()), I18n.translate("selectWorld.deleteButton", new Object[0]), I18n.translate("gui.cancel", new Object[0])));
            }
        }));
        LevelStorage levelStorage = this.minecraft.getLevelStorage();
        LevelProperties levelProperties = levelStorage.getLevelProperties("Demo_World");
    ...
    public void render(int i, int j, float f) {
        ...
        MainMenuScreen.blit(l + 88, 67, 0.0f, 0.0f, 98, 14, 128, 16);
        if (this.splashText != null) {
        ...
        if (i > this.copyrightTextX && i < this.copyrightTextX + this.copyrightTextWidth && j > this.height - 10 && j < this.height) {
            MainMenuScreen.fill(this.copyrightTextX, this.height - 1, this.copyrightTextX + this.copyrightTextWidth, this.height, 0xFFFFFF | n);
        }
        if (this.warningTitle != null && !this.warningTitle.isEmpty()) {
            MainMenuScreen.fill(this.warningAlignLeft - 2, this.warningAlignTop - 2, this.warningAlignRight + 2, this.warningAlignBottom - 1, 0x55200000);
            this.drawString(this.font, this.warningTitle, this.warningAlignLeft, this.warningAlignTop, 0xFFFFFF | n);
            this.drawString(this.font, this.warningText, (this.width - this.warningTextWidth) / 2, this.warningAlignTop + 12, 0xFFFFFF | n);
        }
    ...
    public boolean mouseClicked(double d, double e, int i) {
        ...
        Object object = this.mutex;
        synchronized (object) {
            if (!this.warningTitle.isEmpty() && !ChatUtil.isEmpty(this.warningLink) && d >= (double)this.warningAlignLeft && d <= (double)this.warningAlignRight && e >= (double)this.warningAlignTop && e <= (double)this.warningAlignBottom) {
