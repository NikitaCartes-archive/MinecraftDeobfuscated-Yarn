...
implements TooltipComponent {
    ...
    private void method_33287(int i, int j, int k, boolean bl, TextRenderer textRenderer, MatrixStack matrixStack, ItemRenderer itemRenderer, int l, TextureManager textureManager) {
        if (k >= this.inventory.size()) {
            this.method_33288(matrixStack, i, j, l, textureManager, bl ? class_5771.field_28362 : class_5771.field_28361);
            return;
        }
    ...
    private void method_33286(int i, int j, int k, int l, MatrixStack matrixStack, int m, TextureManager textureManager) {
        int n;
        this.method_33288(matrixStack, i, j, m, textureManager, class_5771.field_28366);
        this.method_33288(matrixStack, i + k * 18 + 1, j, m, textureManager, class_5771.field_28366);
        for (n = 0; n < k; ++n) {
            this.method_33288(matrixStack, i + 1 + n * 18, j, m, textureManager, class_5771.field_28364);
            this.method_33288(matrixStack, i + 1 + n * 18, j + l * 20, m, textureManager, class_5771.field_28365);
        }
        for (n = 0; n < l; ++n) {
            this.method_33288(matrixStack, i, j + n * 20 + 1, m, textureManager, class_5771.field_28363);
            this.method_33288(matrixStack, i + k * 18 + 1, j + n * 20 + 1, m, textureManager, class_5771.field_28363);
        }
        this.method_33288(matrixStack, i, j + l * 20, m, textureManager, class_5771.field_28367);
        this.method_33288(matrixStack, i + k * 18 + 1, j + l * 20, m, textureManager, class_5771.field_28367);
    }
