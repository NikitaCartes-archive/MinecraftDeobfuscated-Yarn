...
import net.minecraft.client.gui.menu.AddServerScreen;
import net.minecraft.client.gui.menu.DirectConnectServerScreen;
...
extends Screen {
    ...
    public boolean keyPressed(int i, int j, int k) {
        ...
        if (this.serverListWidget.getSelected() != null && (i == 257 || i == 335)) {
            this.connect();
            return true;
        }
        return false;
