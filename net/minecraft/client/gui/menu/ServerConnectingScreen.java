...
public class ServerConnectingScreen
extends Screen {
        ...
        Thread thread = new Thread("Server Connector #" + field_2408.incrementAndGet()){
            ...
            public void run() {
                ...
                try {
                    ...
                    ServerConnectingScreen.this.connection.setPacketListener(new ClientLoginNetworkHandler(ServerConnectingScreen.this.connection, ServerConnectingScreen.this.minecraft, ServerConnectingScreen.this.parent, component -> ServerConnectingScreen.this.setStatus(component)));
                    ...
                    ServerConnectingScreen.this.minecraft.execute(() -> ServerConnectingScreen.this.minecraft.openScreen(new DisconnectedScreen(ServerConnectingScreen.this.parent, "connect.failed", new TranslatableComponent("disconnect.genericReason", "Unknown host"))));
                    ...
                    ServerConnectingScreen.this.minecraft.execute(() -> ServerConnectingScreen.this.minecraft.openScreen(new DisconnectedScreen(ServerConnectingScreen.this.parent, "connect.failed", new TranslatableComponent("disconnect.genericReason", string2))));
                }
            }
        };
    ...
    public void render(int i, int j, float f) {
        ...
        if (l - this.field_19097 > 2000L) {
            this.field_19097 = l;
            NarratorManager.INSTANCE.method_19788(new TranslatableComponent("narrator.joining", new Object[0]).getString());
        }
        this.drawCenteredString(this.font, this.status.getFormattedText(), this.width / 2, this.height / 2 - 50, 0xFFFFFF);
        super.render(i, j, f);
    }
}
