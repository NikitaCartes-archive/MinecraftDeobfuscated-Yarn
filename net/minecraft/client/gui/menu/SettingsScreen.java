...
extends Screen {
    ...
    protected void init() {
        ...
        if (this.minecraft.world != null) {
            ...
            if (this.minecraft.isIntegratedServerRunning() && !this.minecraft.world.getLevelProperties().isHardcore()) {
                ...
                this.lockDifficultyButton = this.addButton(new LockButtonWidget(this.difficultyButton.x + this.difficultyButton.getWidth(), this.difficultyButton.y, buttonWidget -> this.minecraft.openScreen(new YesNoScreen(this::lockDifficulty, new TranslatableComponent("difficulty.lock.title", new Object[0]), new TranslatableComponent("difficulty.lock.question", new TranslatableComponent("options.difficulty." + this.minecraft.world.getLevelProperties().getDifficulty().getTranslationKey(), new Object[0]))))));
        ...
        this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, I18n.translate("options.sounds", new Object[0]), buttonWidget -> this.minecraft.openScreen(new AudioOptionsScreen(this, this.settings))));
    ...
    public String getDifficultyButtonText(Difficulty difficulty) {
        return new TranslatableComponent("options.difficulty", new Object[0]).append(": ").append(difficulty.toTextComponent()).getFormattedText();
    }
