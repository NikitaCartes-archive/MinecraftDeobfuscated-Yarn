...
extends Screen {
    ...
    @Override
    protected void init() {
        this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, I18n.translate("gui.toTitle", new Object[0]), buttonWidget -> this.minecraft.openScreen(new MainMenuScreen())));
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.font, this.title.getFormattedText(), this.width / 2, this.height / 4 - 60 + 20, 0xFFFFFF);
