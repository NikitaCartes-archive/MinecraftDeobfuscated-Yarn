...
extends Screen {
    ...
    protected void init() {
        ...
        this.selectButton = this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 52, 150, 20, I18n.translate("selectWorld.select", new Object[0]), buttonWidget -> this.levelList.method_20159().ifPresent(LevelListWidget.LevelItem::play)));
        this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 52, 150, 20, I18n.translate("selectWorld.create", new Object[0]), buttonWidget -> this.minecraft.openScreen(new NewLevelScreen(this))));
        this.editButton = this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 28, 72, 20, I18n.translate("selectWorld.edit", new Object[0]), buttonWidget -> this.levelList.method_20159().ifPresent(LevelListWidget.LevelItem::edit)));
        this.deleteButton = this.addButton(new ButtonWidget(this.width / 2 - 76, this.height - 28, 72, 20, I18n.translate("selectWorld.delete", new Object[0]), buttonWidget -> this.levelList.method_20159().ifPresent(LevelListWidget.LevelItem::delete)));
        this.recreateButton = this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 28, 72, 20, I18n.translate("selectWorld.recreate", new Object[0]), buttonWidget -> this.levelList.method_20159().ifPresent(LevelListWidget.LevelItem::recreate)));
