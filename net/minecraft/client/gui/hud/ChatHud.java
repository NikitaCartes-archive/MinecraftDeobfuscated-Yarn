...
extends DrawableHelper {
    ...
    public Text getText(double d, double e) {
        ...
        if (g <= (double)MathHelper.floor((double)this.getWidth() / this.getScale()) && h < (double)(this.client.textRenderer.fontHeight * i + i)) {
            int j = (int)(h / (double)this.client.textRenderer.fontHeight + (double)this.field_2066);
