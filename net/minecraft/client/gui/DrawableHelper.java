...
public abstract class DrawableHelper {
    ...
    public static void fill(int i, int j, int k, int l, int m) {
        DrawableHelper.fill(class_4590.method_22931().method_22936(), i, j, k, l, m);
    }
    ...
    public static void fill(Matrix4f matrix4f, int i, int j, int k, int l, int m) {
        ...
        bufferBuilder.method_22918(matrix4f, i, l, 0.0f).method_22915(g, h, o, f).next();
        bufferBuilder.method_22918(matrix4f, k, l, 0.0f).method_22915(g, h, o, f).next();
        bufferBuilder.method_22918(matrix4f, k, j, 0.0f).method_22915(g, h, o, f).next();
        bufferBuilder.method_22918(matrix4f, i, j, 0.0f).method_22915(g, h, o, f).next();
        bufferBuilder.end();
    ...
    protected void fillGradient(int i, int j, int k, int l, int m, int n) {
        ...
        bufferBuilder.begin(7, VertexFormats.POSITION_COLOR);
        bufferBuilder.vertex(k, j, this.blitOffset).method_22915(g, h, o, f).next();
        bufferBuilder.vertex(i, j, this.blitOffset).method_22915(g, h, o, f).next();
        bufferBuilder.vertex(i, l, this.blitOffset).method_22915(q, r, s, p).next();
        bufferBuilder.vertex(k, l, this.blitOffset).method_22915(q, r, s, p).next();
        tessellator.draw();
