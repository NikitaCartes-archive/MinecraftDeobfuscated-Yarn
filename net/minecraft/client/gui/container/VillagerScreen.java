...
extends ContainerScreen<MerchantContainer> {
    ...
    protected void drawForeground(int i, int j) {
        ...
        if (k > 0 && k <= 5 && ((MerchantContainer)this.container).isLevelled()) {
            string = this.title.getFormattedText();
            ...
            this.font.draw(this.playerInventory.getDisplayName().getFormattedText(), 107.0f, l, 0x404040);
    ...
    protected void drawBackground(float f, int i, int j) {
        ...
        VillagerScreen.blit(k, l, this.blitOffset, 0.0f, 0.0f, this.containerWidth, this.containerHeight, 256, 512);
        ...
        if (!traderOfferList.isEmpty()) {
            ...
            if (tradeOffer.isDisabled()) {
                ...
                VillagerScreen.blit(this.left + 83 + 99, this.top + 35, this.blitOffset, 311.0f, 0.0f, 28, 21, 256, 512);
            }
        }
    }
    ...
    private void method_19413(int i, int j, TradeOffer tradeOffer) {
        ...
        VillagerScreen.blit(i + 136, j + 16, this.blitOffset, 0.0f, 186.0f, 102, 5, 256, 512);
        ...
        VillagerScreen.blit(i + 136, j + 16, this.blitOffset, 0.0f, 191.0f, o + 1, 5, 256, 512);
        int p = ((MerchantContainer)this.container).getTraderRewardedExperience();
        if (p > 0) {
            int q = Math.min(MathHelper.floor((float)p * f), 100 - o);
            VillagerScreen.blit(i + 136 + o + 1, j + 16 + 1, this.blitOffset, 2.0f, 182.0f, q, 3, 256, 512);
        }
    }
    ...
    private void method_20221(int i, int j, TraderOfferList traderOfferList) {
        ...
        if (k > 1) {
            ...
            VillagerScreen.blit(i + 94, j + 18 + o, this.blitOffset, 0.0f, 199.0f, 6, 27, 256, 512);
        } else {
            VillagerScreen.blit(i + 94, j + 18, this.blitOffset, 6.0f, 199.0f, 6, 27, 256, 512);
        }
    ...
    public void render(int i, int j, float f) {
        ...
        if (!traderOfferList.isEmpty()) {
            ...
            if (tradeOffer2.isDisabled() && this.isPointWithinBounds(186, 35, 22, 21, i, j)) {
    ...
    private void method_20223(TradeOffer tradeOffer, int i, int j) {
        ...
        this.minecraft.getTextureManager().bindTexture(TEXTURE);
        if (tradeOffer.isDisabled()) {
            VillagerScreen.blit(i + 5 + 35 + 20, j + 3, this.blitOffset, 25.0f, 171.0f, 10, 9, 256, 512);
        } else {
            VillagerScreen.blit(i + 5 + 35 + 20, j + 3, this.blitOffset, 15.0f, 171.0f, 10, 9, 256, 512);
        }
        GuiLighting.enableForItems();
    }
    ...
    private void method_20222(ItemStack itemStack, ItemStack itemStack2, int i, int j) {
        ...
        if (itemStack2.getAmount() == itemStack.getAmount()) {
            ...
            this.blitOffset += 300;
            GuiLighting.disable();
            VillagerScreen.blit(i + 7, j + 12, this.blitOffset, 0.0f, 176.0f, 9, 2, 256, 512);
            GuiLighting.enableForItems();
            this.blitOffset -= 300;
        }
    }
    ...
    extends ButtonWidget {
        ...
        public void renderToolTip(int i, int j) {
            if (this.isHovered && ((MerchantContainer)VillagerScreen.this.container).getRecipes().size() > this.field_19165 + VillagerScreen.this.field_19163) {
                if (i < this.x + 20) {
                    ItemStack itemStack = ((TradeOffer)((MerchantContainer)VillagerScreen.this.container).getRecipes().get(this.field_19165 + VillagerScreen.this.field_19163)).getAdjustedFirstBuyItem();
                    VillagerScreen.this.renderTooltip(itemStack, i, j);
                } else if (i < this.x + 50 && i > this.x + 30) {
                    ItemStack itemStack = ((TradeOffer)((MerchantContainer)VillagerScreen.this.container).getRecipes().get(this.field_19165 + VillagerScreen.this.field_19163)).getSecondBuyItem();
                    if (!itemStack.isEmpty()) {
                        VillagerScreen.this.renderTooltip(itemStack, i, j);
                    }
                } else if (i > this.x + 65) {
                    ItemStack itemStack = ((TradeOffer)((MerchantContainer)VillagerScreen.this.container).getRecipes().get(this.field_19165 + VillagerScreen.this.field_19163)).getMutableSellItem();
                    VillagerScreen.this.renderTooltip(itemStack, i, j);
                }
            }
        }
