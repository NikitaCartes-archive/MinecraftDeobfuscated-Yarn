...
extends ContainerScreen<LoomContainer> {
    ...
    private static final List<DyeColor> PATTERN_BUTTON_COLORS = Lists.newArrayList(PATTERN_BUTTON_BACKGROUND_COLOR, PATTERN_BUTTON_FOREGROUND_COLOR);
    ...
    public void tick() {
        ...
        if (this.lastCachedPatternButtonTextureId < BannerPattern.COUNT) {
            ...
            this.patternButtonTextureIds[this.lastCachedPatternButtonTextureId] = TextureCache.BANNER.get(string + string2, Lists.newArrayList(BannerPattern.BASE, bannerPattern), PATTERN_BUTTON_COLORS);
    ...
    protected void drawBackground(float f, int i, int j) {
        ...
        if (this.canApplyDyePattern) {
            ...
            for (int q = this.firstPatternButtonId; q < p && q < this.patternButtonTextureIds.length - 5; ++q) {
                ...
                if (this.patternButtonTextureIds[q] == null) continue;
