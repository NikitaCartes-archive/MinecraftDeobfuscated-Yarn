...
public final class Rotation3 {
    ...
    public Rotation3(@Nullable Matrix4f matrix4f) {
        this.matrix = matrix4f == null ? Rotation3.IDENTITY.matrix : matrix4f;
    }
    ...
    public Rotation3(@Nullable Vector3f vector3f, @Nullable Quaternion quaternion, @Nullable Vector3f vector3f2, @Nullable Quaternion quaternion2) {
        this.matrix = Rotation3.setup(vector3f, quaternion, vector3f2, quaternion2);
    ...
    private void init() {
        if (!this.initialized) {
            Pair<Matrix3f, Vector3f> pair = Rotation3.method_22932(this.matrix);
