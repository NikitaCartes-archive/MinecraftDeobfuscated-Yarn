...
public class MusicType {
    ...
    public static final MusicSound UNDERWATER = MusicType.method_27283(SoundEvents.MUSIC_UNDER_WATER);
    public static final MusicSound GAME = MusicType.method_27283(SoundEvents.MUSIC_GAME);
