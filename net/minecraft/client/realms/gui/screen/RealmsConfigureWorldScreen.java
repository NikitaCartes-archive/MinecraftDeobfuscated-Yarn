...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.playersButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.players"), button -> this.client.setScreen(new RealmsPlayerScreen(this, this.server))).setPositionAndSize(this.buttonCenter(0, 3), RealmsConfigureWorldScreen.row(0), 100, 20).build());
        this.settingsButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.settings"), button -> this.client.setScreen(new RealmsSettingsScreen(this, this.server.clone()))).setPositionAndSize(this.buttonCenter(1, 3), RealmsConfigureWorldScreen.row(0), 100, 20).build());
        this.subscriptionButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.subscription"), button -> this.client.setScreen(new RealmsSubscriptionInfoScreen(this, this.server.clone(), this.parent))).setPositionAndSize(this.buttonCenter(2, 3), RealmsConfigureWorldScreen.row(0), 100, 20).build());
        this.slotButtons.clear();
        for (int i = 1; i < 5; ++i) {
            this.slotButtons.add(this.addSlotButton(i));
        }
        this.switchMinigameButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.switchminigame"), button -> this.client.setScreen(new RealmsSelectWorldTemplateScreen(Text.translatable("mco.template.title.minigame"), this::switchMinigame, RealmsServer.WorldType.MINIGAME))).setPositionAndSize(this.buttonLeft(0), RealmsConfigureWorldScreen.row(13) - 5, 100, 20).build());
        this.optionsButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.options"), button -> this.client.setScreen(new RealmsSlotOptionsScreen(this, this.server.slots.get(this.server.activeSlot).clone(), this.server.worldType, this.server.activeSlot))).setPositionAndSize(this.buttonLeft(0), RealmsConfigureWorldScreen.row(13) - 5, 90, 20).build());
        this.backupButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.backup"), button -> this.client.setScreen(new RealmsBackupScreen(this, this.server.clone(), this.server.activeSlot))).setPositionAndSize(this.buttonLeft(1), RealmsConfigureWorldScreen.row(13) - 5, 90, 20).build());
        this.resetWorldButton = this.addDrawableChild(ButtonWidget.createBuilder(Text.translatable("mco.configure.world.buttons.resetworld"), button -> this.client.setScreen(new RealmsResetWorldScreen(this, this.server.clone(), () -> this.client.execute(() -> this.client.setScreen(this.getNewScreen())), () -> this.client.setScreen(this.getNewScreen())))).setPositionAndSize(this.buttonLeft(2), RealmsConfigureWorldScreen.row(13) - 5, 90, 20).build());
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.BACK, button -> this.backButtonClicked()).setPositionAndSize(this.right_x - 80 + 8, RealmsConfigureWorldScreen.row(13) - 5, 70, 20).build());
