...
extends RealmsScreen {
    ...
    @Override
    public void init() {
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.YES, button -> this.callback.accept(true)).setPositionAndSize(this.width / 2 - 105, RealmsConfirmScreen.row(9), 100, 20).build());
        this.addDrawableChild(ButtonWidget.createBuilder(ScreenTexts.NO, button -> this.callback.accept(false)).setPositionAndSize(this.width / 2 + 5, RealmsConfirmScreen.row(9), 100, 20).build());
    }
