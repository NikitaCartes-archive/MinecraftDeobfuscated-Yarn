...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.createButton = this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, Text.method_43471("mco.create.world"), button -> this.createWorld()));
        ...
        this.descriptionBox = new TextFieldWidget(this.client.textRenderer, this.width / 2 - 100, 115, 200, 20, null, Text.method_43471("mco.configure.world.description"));
    ...
    private void createWorld() {
        if (this.valid()) {
            RealmsResetWorldScreen realmsResetWorldScreen = new RealmsResetWorldScreen(this.parent, this.server, Text.method_43471("mco.selectServer.create"), Text.method_43471("mco.create.world.subtitle"), 0xA0A0A0, Text.method_43471("mco.create.world.skip"), () -> this.client.execute(() -> this.client.setScreen(this.parent.newScreen())), () -> this.client.setScreen(this.parent.newScreen()));
