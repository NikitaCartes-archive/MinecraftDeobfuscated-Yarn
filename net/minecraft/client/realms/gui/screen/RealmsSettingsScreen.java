...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.doneButton = this.addDrawableChild(new ButtonWidget(i - 2, RealmsSettingsScreen.row(12), 106, 20, Text.method_43471("mco.configure.world.buttons.done"), button -> this.save()));
        ...
        ButtonWidget buttonWidget = new ButtonWidget(this.width / 2 - 53, RealmsSettingsScreen.row(0), 106, 20, Text.method_43471(string), button -> {
            if (this.serverData.state == RealmsServer.State.OPEN) {
                MutableText text = Text.method_43471("mco.configure.world.close.question.line1");
                MutableText text2 = Text.method_43471("mco.configure.world.close.question.line2");
        ...
        this.nameEdit = new TextFieldWidget(this.client.textRenderer, i, RealmsSettingsScreen.row(4), 212, 20, null, Text.method_43471("mco.configure.world.name"));
        this.nameEdit.setMaxLength(32);
        this.nameEdit.setText(this.serverData.getName());
        this.addSelectableChild(this.nameEdit);
        this.focusOn(this.nameEdit);
        this.descEdit = new TextFieldWidget(this.client.textRenderer, i, RealmsSettingsScreen.row(8), 212, 20, null, Text.method_43471("mco.configure.world.description"));
