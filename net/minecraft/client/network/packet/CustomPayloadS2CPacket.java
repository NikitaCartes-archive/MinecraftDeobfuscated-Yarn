...
implements Packet<ClientPlayPacketListener> {
    ...
    public static final Identifier field_20599 = new Identifier("debug/game_test_add_marker");
    public static final Identifier field_20600 = new Identifier("debug/game_test_clear");
    ...
    public CustomPayloadS2CPacket(Identifier identifier, PacketByteBuf packetByteBuf) {
        ...
        if (packetByteBuf.writerIndex() > 0x100000) {
