...
public class EntityPotionEffectS2CPacket
implements Packet<ClientPlayPacketListener> {
    ...
    public EntityPotionEffectS2CPacket(int i, StatusEffectInstance statusEffectInstance) {
        ...
        this.duration = statusEffectInstance.getDuration() > Short.MAX_VALUE ? Short.MAX_VALUE : statusEffectInstance.getDuration();
        this.flags = 0;
