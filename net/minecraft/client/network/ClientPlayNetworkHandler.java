...
implements ClientPlayPacketListener {
    ...
    public void onTeam(class_5900 packet) {
        ...
        Team team = lv == class_5900.class_5901.field_29155 ? scoreboard.addTeam(packet.method_34177()) : scoreboard.getTeam(packet.method_34177());
        ...
        optional.ifPresent(arg -> {
            ...
            if ((collisionRule = AbstractTeam.CollisionRule.getRule(arg.method_34186())) != null) {
