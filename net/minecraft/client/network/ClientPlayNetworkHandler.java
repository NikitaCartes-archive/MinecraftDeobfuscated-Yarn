...
implements ClientPlayPacketListener {
    ...
    public void onEntitySpawn(EntitySpawnS2CPacket entitySpawnS2CPacket) {
        ...
        if (entityType == EntityType.CHEST_MINECART) {
            ...
            entity2 = this.world.getEntityById(entitySpawnS2CPacket.getEntityData());
            ...
            entity = entityType == EntityType.SNOWBALL ? new SnowballEntity(this.world, d, e, f) : (entityType == EntityType.LLAMA_SPIT ? new LlamaSpitEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.ITEM_FRAME ? new ItemFrameEntity(this.world, new BlockPos(d, e, f), Direction.byId(entitySpawnS2CPacket.getEntityData())) : (entityType == EntityType.LEASH_KNOT ? new LeadKnotEntity(this.world, new BlockPos(d, e, f)) : (entityType == EntityType.ENDER_PEARL ? new ThrownEnderpearlEntity(this.world, d, e, f) : (entityType == EntityType.EYE_OF_ENDER ? new EnderEyeEntity(this.world, d, e, f) : (entityType == EntityType.FIREWORK_ROCKET ? new FireworkEntity(this.world, d, e, f, ItemStack.EMPTY) : (entityType == EntityType.FIREBALL ? new FireballEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.DRAGON_FIREBALL ? new DragonFireballEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.SMALL_FIREBALL ? new SmallFireballEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.WITHER_SKULL ? new WitherSkullEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.SHULKER_BULLET ? new ShulkerBulletEntity(this.world, d, e, f, entitySpawnS2CPacket.getVelocityX(), entitySpawnS2CPacket.getVelocityY(), entitySpawnS2CPacket.getVelocityz()) : (entityType == EntityType.EGG ? new ThrownEggEntity(this.world, d, e, f) : (entityType == EntityType.EVOKER_FANGS ? new EvokerFangsEntity(this.world, d, e, f, 0.0f, 0, null) : (entityType == EntityType.POTION ? new ThrownPotionEntity(this.world, d, e, f) : (entityType == EntityType.EXPERIENCE_BOTTLE ? new ThrownExperienceBottleEntity(this.world, d, e, f) : (entityType == EntityType.BOAT ? new BoatEntity(this.world, d, e, f) : (entityType == EntityType.TNT ? new TntEntity(this.world, d, e, f, null) : (entityType == EntityType.ARMOR_STAND ? new ArmorStandEntity(this.world, d, e, f) : (entityType == EntityType.END_CRYSTAL ? new EnderCrystalEntity(this.world, d, e, f) : (entityType == EntityType.ITEM ? new ItemEntity(this.world, d, e, f) : (entityType == EntityType.FALLING_BLOCK ? new FallingBlockEntity(this.world, d, e, f, Block.getStateFromRawId(entitySpawnS2CPacket.getEntityData())) : (entityType == EntityType.AREA_EFFECT_CLOUD ? new AreaEffectCloudEntity(this.world, d, e, f) : null))))))))))))))))))))));
        }
        if (entity != null) {
    ...
    public void onPaintingSpawn(PaintingSpawnS2CPacket paintingSpawnS2CPacket) {
        ...
        PaintingEntity paintingEntity = new PaintingEntity(this.world, paintingSpawnS2CPacket.getPos(), paintingSpawnS2CPacket.getFacing(), paintingSpawnS2CPacket.getMotive());
    ...
    public void onVelocityUpdate(EntityVelocityUpdateS2CPacket entityVelocityUpdateS2CPacket) {
        ...
        entity.setVelocityClient((double)entityVelocityUpdateS2CPacket.getVelocityX() / 8000.0, (double)entityVelocityUpdateS2CPacket.getVelocityY() / 8000.0, (double)entityVelocityUpdateS2CPacket.getVelocityZ() / 8000.0);
    }
    ...
    public void onPlayerPositionLook(PlayerPositionLookS2CPacket playerPositionLookS2CPacket) {
        ...
        boolean bl = playerPositionLookS2CPacket.getFlags().contains((Object)PlayerPositionLookS2CPacket.Flag.X);
        boolean bl2 = playerPositionLookS2CPacket.getFlags().contains((Object)PlayerPositionLookS2CPacket.Flag.Y);
        ...
        if (playerPositionLookS2CPacket.getFlags().contains((Object)PlayerPositionLookS2CPacket.Flag.X_ROT)) {
    ...
    public void onExplosion(ExplosionS2CPacket explosionS2CPacket) {
        ...
        Explosion explosion = new Explosion(this.client.world, null, explosionS2CPacket.getX(), explosionS2CPacket.getY(), explosionS2CPacket.getZ(), explosionS2CPacket.getRadius(), explosionS2CPacket.getAffectedBlocks());
        explosion.affectWorld(true);
        this.client.player.setVelocity(this.client.player.getVelocity().add(explosionS2CPacket.getPlayerVelocityX(), explosionS2CPacket.getPlayerVelocityY(), explosionS2CPacket.getPlayerVelocityZ()));
    }
    ...
    public void onBlockAction(BlockActionS2CPacket blockActionS2CPacket) {
        ...
        this.client.world.addBlockAction(blockActionS2CPacket.getPos(), blockActionS2CPacket.getBlock(), blockActionS2CPacket.getType(), blockActionS2CPacket.getData());
    }
    ...
    public void onCommandTree(CommandTreeS2CPacket commandTreeS2CPacket) {
        ...
        this.commandDispatcher = new CommandDispatcher<CommandSource>(commandTreeS2CPacket.getCommandTree());
    }
    ...
    public void onTagQuery(TagQueryResponseS2CPacket tagQueryResponseS2CPacket) {
        ...
        if (!this.dataQueryHandler.handleQueryResponse(tagQueryResponseS2CPacket.getTransactionId(), tagQueryResponseS2CPacket.getTag())) {
            LOGGER.debug("Got unhandled response to tag query {}", (Object)tagQueryResponseS2CPacket.getTransactionId());
        }
    }
    ...
    public void onPlaySound(PlaySoundS2CPacket playSoundS2CPacket) {
        ...
        this.client.world.playSound(this.client.player, playSoundS2CPacket.getX(), playSoundS2CPacket.getY(), playSoundS2CPacket.getZ(), playSoundS2CPacket.getSound(), playSoundS2CPacket.getCategory(), playSoundS2CPacket.getVolume(), playSoundS2CPacket.getPitch());
    }
    ...
    public void onPlaySoundFromEntity(PlaySoundFromEntityS2CPacket playSoundFromEntityS2CPacket) {
        ...
        this.client.world.playSoundFromEntity(this.client.player, entity, playSoundFromEntityS2CPacket.getSound(), playSoundFromEntityS2CPacket.getCategory(), playSoundFromEntityS2CPacket.getVolume(), playSoundFromEntityS2CPacket.getPitch());
    }
    ...
    public void onPlaySoundId(PlaySoundIdS2CPacket playSoundIdS2CPacket) {
        ...
        this.client.getSoundManager().play(new PositionedSoundInstance(playSoundIdS2CPacket.getSoundId(), playSoundIdS2CPacket.getCategory(), playSoundIdS2CPacket.getVolume(), playSoundIdS2CPacket.getPitch(), false, 0, SoundInstance.AttenuationType.LINEAR, (float)playSoundIdS2CPacket.getX(), (float)playSoundIdS2CPacket.getY(), (float)playSoundIdS2CPacket.getZ(), false));
    }
    ...
    public void onTeam(TeamS2CPacket teamS2CPacket) {
        ...
        Scoreboard scoreboard = this.world.getScoreboard();
        Team team = teamS2CPacket.getMode() == 0 ? scoreboard.addTeam(teamS2CPacket.getTeamName()) : scoreboard.getTeam(teamS2CPacket.getTeamName());
        if (teamS2CPacket.getMode() == 0 || teamS2CPacket.getMode() == 2) {
            ...
            if ((collisionRule = AbstractTeam.CollisionRule.getRule(teamS2CPacket.getCollisionRule())) != null) {
    ...
    public void onParticle(ParticleS2CPacket particleS2CPacket) {
        ...
        if (particleS2CPacket.getCount() == 0) {
            double d = particleS2CPacket.getSpeed() * particleS2CPacket.getOffsetX();
            double e = particleS2CPacket.getSpeed() * particleS2CPacket.getOffsetY();
            double f = particleS2CPacket.getSpeed() * particleS2CPacket.getOffsetZ();
            try {
                this.world.addParticle(particleS2CPacket.getParameters(), particleS2CPacket.isLongDistance(), particleS2CPacket.getX(), particleS2CPacket.getY(), particleS2CPacket.getZ(), d, e, f);
            } catch (Throwable throwable) {
                LOGGER.warn("Could not spawn particle effect {}", (Object)particleS2CPacket.getParameters());
            }
        } else {
            for (int i = 0; i < particleS2CPacket.getCount(); ++i) {
                ...
                try {
                    this.world.addParticle(particleS2CPacket.getParameters(), particleS2CPacket.isLongDistance(), particleS2CPacket.getX() + g, particleS2CPacket.getY() + h, particleS2CPacket.getZ() + j, k, l, m);
                    continue;
    ...
    public void handlePlayerActionResponse(PlayerActionResponseS2CPacket playerActionResponseS2CPacket) {
        ...
        this.client.interactionManager.processPlayerActionResponse(this.world, playerActionResponseS2CPacket.getBlockPos(), playerActionResponseS2CPacket.getBlockState(), playerActionResponseS2CPacket.getAction(), playerActionResponseS2CPacket.isApproved());
    }
    ...
    public PlayerListEntry getPlayerListEntry(String string) {
        for (PlayerListEntry playerListEntry : this.playerListEntries.values()) {
            if (!playerListEntry.getProfile().getName().equals(string)) continue;
