...
public abstract class Particle {
    ...
    protected void setBoundingBoxSpacing(float f, float g) {
        if (f != this.spacingXZ || g != this.spacingY) {
            ...
            this.setBoundingBox(new BoundingBox(d, boundingBox.minY, e, d + (double)this.spacingXZ, boundingBox.minY + (double)this.spacingY, e + (double)this.spacingXZ));
        }
    }
    ...
    public void move(double d, double e, double f) {
        ...
        if (this.collidesWithWorld && d != 0.0 || e != 0.0 || f != 0.0) {
            Vec3d vec3d = Entity.method_17833(new Vec3d(d, e, f), this.getBoundingBox(), this.world, EntityContext.absent(), new LoopingStream<VoxelShape>(Stream.empty()));
            d = vec3d.x;
            e = vec3d.y;
            f = vec3d.z;
        }
