...
extends Particle {
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        this.entityRenderDispatcher.render(this.item, h - vec3d.getX(), i - vec3d.getY(), j - vec3d.getZ(), this.item.yaw, tickDelta, new MatrixStack(), immediate, this.entityRenderDispatcher.getLight(this.item, tickDelta));
        immediate.draw();
    }
