...
public class Program {
    ...
    public static Program createFromResource(Type type, String name, InputStream sourceCode, String domain) throws IOException {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
    ...
    public static enum Type {
        ...
        private final Map<String, Program> loadedShaders = Maps.newHashMap();
