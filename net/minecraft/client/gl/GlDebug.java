    ...
    public static void enableDebug(int verbosity, boolean sync) {
        ...
        if (gLCapabilities.GL_KHR_debug) {
            ...
            for (int i = 0; i < KHR_VERBOSITY_LEVELS.size(); ++i) {
                ...
                KHRDebug.glDebugMessageControl(GL11.GL_DONT_CARE, GL11.GL_DONT_CARE, (int)KHR_VERBOSITY_LEVELS.get(i), (int[])null, bl);
            }
            ...
            for (int i = 0; i < ARB_VERBOSITY_LEVELS.size(); ++i) {
                boolean bl = i < verbosity;
                ARBDebugOutput.glDebugMessageControlARB(GL11.GL_DONT_CARE, GL11.GL_DONT_CARE, (int)ARB_VERBOSITY_LEVELS.get(i), (int[])null, bl);
            }
