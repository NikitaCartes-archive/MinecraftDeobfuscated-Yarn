...
public class Keyboard {
    ...
    private void addDebugMessage(Formatting formatting, Text text) {
        this.client.inGameHud.getChatHud().addMessage(Text.method_43473().append(Text.method_43471("debug.prefix").formatted(formatting, Formatting.BOLD)).append(" ").append(text));
    }
