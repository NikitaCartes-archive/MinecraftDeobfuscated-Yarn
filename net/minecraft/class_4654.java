...
public class class_4654
extends class_4651 {
    private static final BlockState[] field_21311 = new BlockState[]{Blocks.ORANGE_TULIP.getDefaultState(), Blocks.RED_TULIP.getDefaultState(), Blocks.PINK_TULIP.getDefaultState(), Blocks.WHITE_TULIP.getDefaultState()};
    private static final BlockState[] field_21312 = new BlockState[]{Blocks.POPPY.getDefaultState(), Blocks.AZURE_BLUET.getDefaultState(), Blocks.OXEYE_DAISY.getDefaultState(), Blocks.CORNFLOWER.getDefaultState()};
    ...
    public BlockState method_23455(Random random, BlockPos blockPos) {
        ...
        if (random.nextInt(3) > 0) {
            return field_21312[random.nextInt(field_21312.length)];
        }
