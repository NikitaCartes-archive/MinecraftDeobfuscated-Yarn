...
public class class_6121
extends class_6122 {
    public static final class_6121 field_31536 = new class_6121(YOffset.fixed(0));
    public static final Codec<class_6121> field_31537 = Codec.either(YOffset.OFFSET_CODEC, RecordCodecBuilder.create(instance -> instance.group(((MapCodec)YOffset.OFFSET_CODEC.fieldOf("value")).forGetter(arg -> arg.field_31538)).apply((Applicative<class_6121, ?>)instance, class_6121::new))).xmap(either -> either.map(class_6121::method_35383, arg -> arg), arg -> Either.left(arg.field_31538));
