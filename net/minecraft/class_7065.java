...
public abstract class class_7065
extends Screen {
    ...
    protected abstract void method_41160(int var1);

    @Override
    protected void init() {
        super.init();
        this.field_37222 = MultilineText.create(this.textRenderer, (StringVisitable)this.field_37219, this.width - 50);
        int i = (this.field_37222.count() + 1) * this.textRenderer.fontHeight * 2;
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        class_7065.drawTextWithShadow(matrices, this.textRenderer, this.field_37218, 25, 30, 0xFFFFFF);
        this.field_37222.drawWithShadow(matrices, 25, 70, this.textRenderer.fontHeight * 2, 0xFFFFFF);
