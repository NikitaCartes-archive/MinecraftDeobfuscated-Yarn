...
public final class class_4590 {
    ...
    public class_4590(@Nullable Matrix4f matrix4f) {
        this.field_20900 = matrix4f == null ? class_4590.field_20906.field_20900 : matrix4f;
    }
    ...
    public class_4590(@Nullable Vector3f vector3f, @Nullable Quaternion quaternion, @Nullable Vector3f vector3f2, @Nullable Quaternion quaternion2) {
        this.field_20900 = class_4590.method_22934(vector3f, quaternion, vector3f2, quaternion2);
    ...
    private void method_22938() {
        if (!this.field_20901) {
            Pair<class_4581, Vector3f> pair = class_4590.method_22932(this.field_20900);
    ...
    private static Matrix4f method_22934(@Nullable Vector3f vector3f, @Nullable Quaternion quaternion, @Nullable Vector3f vector3f2, @Nullable Quaternion quaternion2) {
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.method_22668();
        if (quaternion != null) {
    ...
    public int hashCode() {
        return Objects.hash(this.field_20900);
    }
}
