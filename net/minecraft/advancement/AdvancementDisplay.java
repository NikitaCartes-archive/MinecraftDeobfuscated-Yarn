...
public class AdvancementDisplay {
    ...
    public AdvancementDisplay(ItemStack itemStack, Component component, Component component2, @Nullable Identifier identifier, AdvancementFrame advancementFrame, boolean bl, boolean bl2, boolean bl3) {
    ...
    public static AdvancementDisplay fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
        ...
        ItemStack itemStack = AdvancementDisplay.iconFromJson(JsonHelper.getObject(jsonObject, "icon"));
