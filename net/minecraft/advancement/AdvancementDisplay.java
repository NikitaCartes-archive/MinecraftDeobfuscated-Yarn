...
public class AdvancementDisplay {
    ...
    public AdvancementDisplay(ItemStack itemStack, Text text, Text text2, @Nullable Identifier identifier, AdvancementFrame advancementFrame, boolean bl, boolean bl2, boolean bl3) {
        this.title = text;
