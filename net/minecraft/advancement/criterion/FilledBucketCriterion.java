...
implements Criterion<Conditions> {
    ...
    private final Map<PlayerAdvancementTracker, Handler> field_9613 = Maps.newHashMap();
    ...
    public void beginTrackingCondition(PlayerAdvancementTracker playerAdvancementTracker, Criterion.ConditionsContainer<Conditions> conditionsContainer) {
        Handler handler = this.field_9613.get(playerAdvancementTracker);
        if (handler == null) {
    ...
    public void handle(ServerPlayerEntity serverPlayerEntity, ItemStack itemStack) {
        Handler handler = this.field_9613.get(serverPlayerEntity.getAdvancementManager());
        if (handler != null) {
