...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions method_23911(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
    ...
    public void test(ServerPlayerEntity serverPlayerEntity, BlockState blockState) {
        this.test(serverPlayerEntity.getAdvancementManager(), (T conditions) -> conditions.test(blockState));
    }

    @Override
    public /* synthetic */ CriterionConditions conditionsFromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
        return this.method_23911(jsonObject, jsonDeserializationContext);
    }
