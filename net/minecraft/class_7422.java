...
public class class_7422 {
    ...
    public Vec3d method_43489(long l, long m, long n) {
        ...
        double d = l == 0L ? this.field_39016.x : class_7422.method_43488(class_7422.method_43487(this.field_39016.x) + l);
        double e = m == 0L ? this.field_39016.y : class_7422.method_43488(class_7422.method_43487(this.field_39016.y) + m);
        double f = n == 0L ? this.field_39016.z : class_7422.method_43488(class_7422.method_43487(this.field_39016.z) + n);
        return new Vec3d(d, e, f);
    }

    public long method_43490(Vec3d vec3d) {
        return class_7422.method_43487(vec3d.x - this.field_39016.x);
    }

    public long method_43491(Vec3d vec3d) {
        return class_7422.method_43487(vec3d.y - this.field_39016.y);
    }

    public long method_43492(Vec3d vec3d) {
        return class_7422.method_43487(vec3d.z - this.field_39016.z);
    }
