...
extends AbstractCriterion<class_5410> {
    ...
    @Override
    protected class_5410 conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new class_5410(extended, itemPredicate, extended2);
    }
    ...
    extends AbstractCriterionConditions {
        ...
        public class_5410(EntityPredicate.Extended extended, ItemPredicate itemPredicate, EntityPredicate.Extended extended2) {
            super(field_25699, extended);
            this.field_25700 = itemPredicate;
            this.field_25701 = extended2;
        }

        public static class_5410 method_30099(EntityPredicate.Extended extended, ItemPredicate.Builder builder, EntityPredicate.Extended extended2) {
            return new class_5410(extended, builder.build(), extended2);
        }

        public boolean method_30100(ItemStack itemStack, LootContext lootContext) {
            if (!this.field_25700.test(itemStack)) {
                return false;
            }
            return this.field_25701.test(lootContext);
        }
