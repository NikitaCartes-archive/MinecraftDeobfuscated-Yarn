...
extends BlockWithEntity {
    ...
    public ChiseledBookshelfBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with(BOOKS_STORED, 0)).with(HorizontalFacingBlock.FACING, Direction.NORTH)).with(LAST_INTERACTION_BOOK_SLOT, 0));
    }
