...
public class MapColor {
    ...
    public static final MapColor WEB = new MapColor(3, 0xC7C7C7);
    public static final MapColor LAVA = new MapColor(4, 0xFF0000);
    ...
    public static final MapColor GRAY_TERRACOTTA = new MapColor(43, 0x392923);
    public static final MapColor LIGHT_GRAY_TERRACOTTA = new MapColor(44, 8874850);
    public static final MapColor CYAN_TERRACOTTA = new MapColor(45, 0x575C5C);
