...
public final class Material {
    ...
    public static final Material DRAGON_EGG = new Builder(MaterialColor.FOLIAGE).destroyedByPiston().build();
    ...
    public Material(MaterialColor materialColor, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5, boolean bl6, boolean bl7, PistonBehavior pistonBehavior) {
