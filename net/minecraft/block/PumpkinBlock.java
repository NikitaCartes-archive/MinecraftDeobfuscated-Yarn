    ...
    public boolean onUse(BlockState blockState, World world, BlockPos blockPos, PlayerEntity playerEntity2, Hand hand, BlockHitResult blockHitResult) {
        ...
        if (itemStack.getItem() == Items.SHEARS) {
            if (!world.isClient) {
                ...
                Direction direction2 = direction.getAxis() == Direction.Axis.Y ? playerEntity2.getHorizontalFacing().getOpposite() : direction;
                world.playSound(null, blockPos, SoundEvents.BLOCK_PUMPKIN_CARVE, SoundCategory.BLOCKS, 1.0f, 1.0f);
                world.setBlockState(blockPos, (BlockState)Blocks.CARVED_PUMPKIN.getDefaultState().with(CarvedPumpkinBlock.FACING, direction2), 11);
