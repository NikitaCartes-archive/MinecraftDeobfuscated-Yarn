...
implements FluidFillable {
    ...
    public BlockState getPlacementState(ItemPlacementContext itemPlacementContext) {
        ...
        if (blockState != null && (fluidState = itemPlacementContext.getWorld().getFluidState(itemPlacementContext.getBlockPos().up())).matches(FluidTags.WATER) && fluidState.getLevel() == 8) {
            return blockState;
        }
        return null;
    }
