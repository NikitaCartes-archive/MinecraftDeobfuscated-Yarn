...
public class Blocks {
    ...
    public static final Block BROWN_MUSHROOM = Blocks.register("brown_mushroom", new MushroomPlantBlock(AbstractBlock.Settings.of(Material.PLANT, MaterialColor.BROWN).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).lightLevel(blockState -> 1).postProcess(Blocks::always)));
    ...
    public static final Block TORCH = Blocks.register("torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(blockState -> 14).sounds(BlockSoundGroup.WOOD), ParticleTypes.FLAME));
    public static final Block WALL_TORCH = Blocks.register("wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(blockState -> 14).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH), ParticleTypes.FLAME));
    ...
    public static final Block SOUL_TORCH = Blocks.register("soul_torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(blockState -> 10).sounds(BlockSoundGroup.WOOD), ParticleTypes.SOUL_FIRE_FLAME));
    public static final Block SOUL_WALL_TORCH = Blocks.register("soul_wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(blockState -> 10).sounds(BlockSoundGroup.WOOD).dropsLike(SOUL_TORCH), ParticleTypes.SOUL_FIRE_FLAME));
    ...
    public static final Block JACK_O_LANTERN = Blocks.register("jack_o_lantern", new CarvedPumpkinBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0f).sounds(BlockSoundGroup.WOOD).lightLevel(blockState -> 15).allowsSpawning(Blocks::always)));
    ...
    public static final Block BREWING_STAND = Blocks.register("brewing_stand", new BrewingStandBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(0.5f).lightLevel(blockState -> 1).nonOpaque()));
    ...
    public static final Block ENDER_CHEST = Blocks.register("ender_chest", new EnderChestBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(22.5f, 600.0f).lightLevel(blockState -> 7)));
    ...
    public static final Block BEACON = Blocks.register("beacon", new BeaconBlock(AbstractBlock.Settings.of(Material.GLASS, MaterialColor.DIAMOND).strength(3.0f).lightLevel(blockState -> 15).nonOpaque().solidBlock(Blocks::never)));
    ...
    public static final Block END_ROD = Blocks.register("end_rod", new EndRodBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().lightLevel(blockState -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    ...
    public static final Block MAGMA_BLOCK = Blocks.register("magma_block", new MagmaBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().lightLevel(blockState -> 3).ticksRandomly().strength(0.5f).allowsSpawning((blockState, blockView, blockPos, entityType) -> entityType.isFireImmune()).postProcess(Blocks::always).emissiveLighting(Blocks::always)));
    ...
    public static final Block LANTERN = Blocks.register("lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(blockState -> 15).nonOpaque()));
    public static final Block SOUL_LANTERN = Blocks.register("soul_lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(blockState -> 10).nonOpaque()));
    ...
    public static final Block SHROOMLIGHT = Blocks.register("shroomlight", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.RED).strength(1.0f).sounds(BlockSoundGroup.SHROOMLIGHT).lightLevel(blockState -> 15)));
