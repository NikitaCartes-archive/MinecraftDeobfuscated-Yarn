...
public class Blocks {
    ...
    public static final Block WARPED_ROOTS = Blocks.register("warped_roots", new RootsBlock(AbstractBlock.Settings.of(Material.field_26708, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.ROOTS)));
    public static final Block NETHER_SPROUTS = Blocks.register("nether_sprouts", new SproutsBlock(AbstractBlock.Settings.of(Material.field_26708, MaterialColor.CYAN).noCollision().breakInstantly().sounds(BlockSoundGroup.NETHER_SPROUTS)));
    ...
    public static final Block CRIMSON_ROOTS = Blocks.register("crimson_roots", new RootsBlock(AbstractBlock.Settings.of(Material.field_26708, MaterialColor.NETHER).noCollision().breakInstantly().sounds(BlockSoundGroup.ROOTS)));
