...
extends Block {
    ...
    private DoorHinge getHinge(ItemPlacementContext itemPlacementContext) {
        ...
        int i = (DoorBlock.isShapeFullCube(blockState.getCollisionShape(blockView, blockPos3)) ? -1 : 0) + (DoorBlock.isShapeFullCube(blockState2.getCollisionShape(blockView, blockPos4)) ? -1 : 0) + (DoorBlock.isShapeFullCube(blockState3.getCollisionShape(blockView, blockPos5)) ? 1 : 0) + (DoorBlock.isShapeFullCube(blockState4.getCollisionShape(blockView, blockPos6)) ? 1 : 0);
