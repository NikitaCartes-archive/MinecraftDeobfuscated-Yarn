...
public class BlockRenderLayer {
    public static final BlockRenderLayer SOLID = new BlockRenderLayer("solid", VertexFormats.POSITION_COLOR_UV_NORMAL, 7, 0x200000, false, true, () -> {
    ...
    public static final BlockRenderLayer CUTOUT_MIPPED = new BlockRenderLayer("cutout_mipped", VertexFormats.POSITION_COLOR_UV_NORMAL, 7, 131072, false, true, () -> {
        MinecraftClient.getInstance().getTextureManager().bindTexture(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
    ...
    public static final BlockRenderLayer TRANSLUCENT_NO_CRUMBLING = new BlockRenderLayer("translucent_no_crumbling", VertexFormats.POSITION_COLOR_UV_NORMAL, 7, 256, false, false, TRANSLUCENT::method_22723, TRANSLUCENT::method_22724);
    ...
    public static final BlockRenderLayer GLINT = new BlockRenderLayer("glint", VertexFormats.POSITION_UV, 7, 256, false, false, () -> BlockRenderLayer.method_23010(8.0f), () -> BlockRenderLayer.method_23039());
    public static final BlockRenderLayer ENTITY_GLINT = new BlockRenderLayer("entity_glint", VertexFormats.POSITION_UV, 7, 256, false, false, () -> BlockRenderLayer.method_23010(0.16f), () -> BlockRenderLayer.method_23039());
    ...
    private static final Map<Block, BlockRenderLayer> field_20803;
    private static final Map<Fluid, BlockRenderLayer> field_20804;
    ...
    public static BlockRenderLayer method_23017(Identifier identifier) {
        return BlockRenderLayer.method_23019(identifier, false, true, false);
    }

    public static BlockRenderLayer method_23019(Identifier identifier, boolean bl, boolean bl2, boolean bl3) {
        return BlockRenderLayer.method_23020(identifier, bl, bl2, bl3, 0.1f, false);
    }

    public static BlockRenderLayer method_23020(Identifier identifier, boolean bl, boolean bl2, boolean bl3, float f, boolean bl4) {
        return new class_4601<class_4600>("new_entity", VertexFormats.POSITION_UV_NORMAL_2, 256, new class_4600(identifier, bl, bl2, bl3, f, bl4), true, false, arg -> {
            RenderSystem.disableCull();
    ...
    public static BlockRenderLayer method_23026(Identifier identifier2) {
        return new class_4601<Identifier>("eyes", VertexFormats.POSITION_UV_NORMAL_2, 256, identifier2, false, false, identifier -> {
    ...
    public static BlockRenderLayer method_23018(Identifier identifier, float f, float g) {
        BlockRenderLayer blockRenderLayer = BlockRenderLayer.method_23017(identifier);
        return new class_4601<class_4602>("power_swirl", VertexFormats.POSITION_UV_NORMAL_2, 256, new class_4602(identifier, f, g), false, false, arg -> {
    ...
    public static BlockRenderLayer method_23011(int i) {
        return new class_4601<Integer>("crumbling", VertexFormats.POSITION_COLOR_UV_NORMAL, 256, Integer.valueOf(i), false, false, integer -> {
    ...
    public static BlockRenderLayer method_23028(Identifier identifier2) {
        return new class_4601<Identifier>("text", VertexFormats.field_20888, 256, identifier2, false, false, identifier -> {
            MinecraftClient.getInstance().getTextureManager().bindTexture((Identifier)identifier);
            RenderSystem.enableAlphaTest();
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
    ...
    public static BlockRenderLayer method_23030(Identifier identifier2) {
        BlockRenderLayer blockRenderLayer = BlockRenderLayer.method_23028(identifier2);
        return new class_4601<Identifier>("text_see_through", VertexFormats.field_20888, 256, identifier2, false, false, identifier -> {
            blockRenderLayer.method_22723();
    ...
    public static BlockRenderLayer method_23021(int i) {
        return new class_4601<Integer>("portal", VertexFormats.POSITION_COLOR, 256, Integer.valueOf(i), false, false, integer -> {
            RenderSystem.enableBlend();
            if (integer >= 2) {
    ...
    public static BlockRenderLayer method_22715(BlockState blockState) {
        ...
        BlockRenderLayer blockRenderLayer = field_20803.get(block);
    ...
    public static BlockRenderLayer method_22716(FluidState fluidState) {
        BlockRenderLayer blockRenderLayer = field_20804.get(fluidState.getFluid());
        if (blockRenderLayer != null) {
            return blockRenderLayer;
        }
        return SOLID;
