...
public class BlockRenderLayer {
    private static final Set<BlockRenderLayer> field_20801 = Sets.newHashSet();
    public static final BlockRenderLayer field_9178 = BlockRenderLayer.method_22717(new BlockRenderLayer("solid", 0x200000, () -> {}, () -> {}));
    public static final BlockRenderLayer CUTOUT_MIPPED = BlockRenderLayer.method_22717(new BlockRenderLayer("cutout_mipped", 131072, () -> {
    ...
    public static final BlockRenderLayer field_9174 = BlockRenderLayer.method_22717(new BlockRenderLayer("cutout", 131072, () -> {
    ...
    public static final BlockRenderLayer field_9179 = BlockRenderLayer.method_22717(new BlockRenderLayer("translucent", 262144, () -> {
    ...
    public static final BlockRenderLayer field_20799 = BlockRenderLayer.method_22717(new BlockRenderLayer("entity", 262144, () -> {
        Texture texture = MinecraftClient.getInstance().getTextureManager().getTexture(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
        texture.bindTexture();
        GuiLighting.disable();
    ...
    public static final BlockRenderLayer field_20800 = BlockRenderLayer.method_22717(new BlockRenderLayer("crumbling", 262144, () -> {
