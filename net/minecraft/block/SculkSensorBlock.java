...
implements Waterloggable {
    ...
    public SculkSensorBlock(AbstractBlock.Settings settings, int range) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)this.stateManager.getDefaultState()).with(SCULK_SENSOR_PHASE, SculkSensorPhase.COOLDOWN)).with(POWER, 0)).with(WATERLOGGED, false));
        this.range = range;
    }
