...
public class BlockEntityType<T extends BlockEntity> {
    ...
    public static final BlockEntityType<SuspiciousSandBlockEntity> SUSPICIOUS_SAND = BlockEntityType.create("suspicious_sand", Builder.create(SuspiciousSandBlockEntity::new, Blocks.SUSPICIOUS_SAND));
