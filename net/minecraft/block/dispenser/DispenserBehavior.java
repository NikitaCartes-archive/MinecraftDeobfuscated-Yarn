...
public interface DispenserBehavior {
    ...
    public static void registerDefaults() {
        ...
        DispenserBlock.registerBehavior(Items.SPECTRAL_ARROW, new ProjectileDispenserBehavior(){
            ...
            @Override
            protected Projectile createProjectile(World world, Position position, ItemStack itemStack) {
                SpectralArrowEntity projectileEntity = new SpectralArrowEntity(world, position.getX(), position.getY(), position.getZ());
        ...
        ItemDispenserBehavior itemDispenserBehavior = new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseStack(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                entityType.spawnFromItemStack(blockPointer.getWorld(), itemStack, null, blockPointer.getBlockPos().offset(direction), SpawnType.DISPENSER, direction != Direction.UP, false);
        ...
        DispenserBlock.registerBehavior(Items.BUCKET, new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseStack(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                if (((DispenserBlockEntity)blockPointer.getBlockEntity()).addToFirstFreeSlot(new ItemStack(item)) < 0) {
        ...
        DispenserBlock.registerBehavior(Items.BONE_MEAL, new FallibleItemDispenserBehavior(){
            ...
            protected ItemStack dispenseStack(BlockPointer blockPointer, ItemStack itemStack) {
                ...
                this.success = true;
                World world = blockPointer.getWorld();
                if (BoneMealItem.useOnFertilizable(itemStack, world, blockPos = blockPointer.getBlockPos().offset(blockPointer.getBlockState().get(DispenserBlock.FACING))) || BoneMealItem.useOnGround(itemStack, world, blockPos, null)) {
                    if (!world.isClient) {
        ...
        DispenserBlock.registerBehavior(Blocks.TNT, new ItemDispenserBehavior(){
            ...
            protected ItemStack dispenseStack(BlockPointer blockPointer, ItemStack itemStack) {
                World world = blockPointer.getWorld();
                BlockPos blockPos = blockPointer.getBlockPos().offset(blockPointer.getBlockState().get(DispenserBlock.FACING));
                PrimedTntEntity primedTntEntity = new PrimedTntEntity(world, (double)blockPos.getX() + 0.5, blockPos.getY(), (double)blockPos.getZ() + 0.5, null);
