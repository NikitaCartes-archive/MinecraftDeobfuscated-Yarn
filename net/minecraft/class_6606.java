...
public class class_6606 {
    ...
    public class_6606(ChunkPos chunkPos, LightingProvider lightingProvider, @Nullable BitSet bitSet, @Nullable BitSet bitSet2, boolean bl) {
        ...
        this.field_34877 = Lists.newArrayList();
        this.field_34878 = Lists.newArrayList();
    ...
    public class_6606(PacketByteBuf packetByteBuf2, int i, int j) {
        this.field_34879 = packetByteBuf2.readBoolean();
        this.field_34873 = packetByteBuf2.readBitSet();
        this.field_34874 = packetByteBuf2.readBitSet();
        this.field_34875 = packetByteBuf2.readBitSet();
        this.field_34876 = packetByteBuf2.readBitSet();
        this.field_34877 = packetByteBuf2.readList(packetByteBuf -> packetByteBuf.readByteArray(2048));
        this.field_34878 = packetByteBuf2.readList(packetByteBuf -> packetByteBuf.readByteArray(2048));
    }
