...
public class class_5330 {
    public static <E, T extends JsonSerializableType<E>> class_5331<E, T> method_29306(Registry<T> registry, String string, String string2, Function<E, T> function) {
        return new class_5331(registry, string, string2, function);
    }
    ...
    JsonSerializer<E> {
        ...
        private class_5333(Registry<T> registry, String string, String string2, Function<E, T> function, @Nullable Pair<T, class_5332<? extends E>> pair) {
        ...
        public E deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            if (jsonElement.isJsonObject()) {
                ...
                JsonSerializableType jsonSerializableType = (JsonSerializableType)this.field_25197.get(identifier);
        ...
        public JsonElement serialize(E object, Type type, JsonSerializationContext jsonSerializationContext) {
            JsonSerializableType jsonSerializableType = (JsonSerializableType)this.field_25200.apply(object);
