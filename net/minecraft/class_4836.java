...
implements CrossbowUser {
    ...
    private static final EntityAttributeModifier field_22380 = new EntityAttributeModifier(field_22379, "Baby speed boost", (double)0.2f, EntityAttributeModifier.Operation.MULTIPLY_BASE);
    ...
    protected static final ImmutableList<SensorType<? extends Sensor<? super class_4836>>> field_22376 = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.NEAREST_ITEMS, SensorType.HURT_BY, SensorType.INTERACTABLE_DOORS, SensorType.PIGLIN_SPECIFIC_SENSOR);
    protected static final ImmutableList<MemoryModuleType<?>> field_22381 = ImmutableList.of(MemoryModuleType.LOOK_TARGET, MemoryModuleType.INTERACTABLE_DOORS, MemoryModuleType.OPENED_DOORS, MemoryModuleType.MOBS, MemoryModuleType.VISIBLE_MOBS, MemoryModuleType.NEAREST_VISIBLE_PLAYER, MemoryModuleType.NEAREST_VISIBLE_TARGETABLE_PLAYER, MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLINS, MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM, MemoryModuleType.HURT_BY, MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.WALK_TARGET, new MemoryModuleType[]{MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.INTERACTION_TARGET, MemoryModuleType.PATH, MemoryModuleType.ANGRY_AT, MemoryModuleType.AVOID_TARGET, MemoryModuleType.ADMIRING_ITEM, MemoryModuleType.WAS_HIT_BY_PLAYER, MemoryModuleType.CELEBRATE_LOCATION, MemoryModuleType.HUNTED_RECENTLY, MemoryModuleType.NEAREST_VISIBLE_BABY_HOGLIN, MemoryModuleType.NEAREST_VISIBLE_BABY_PIGLIN, MemoryModuleType.NEAREST_VISIBLE_ZOMBIFIED_PIGLIN, MemoryModuleType.RIDE_TARGET, MemoryModuleType.VISIBLE_ADULT_PIGLIN_COUNT, MemoryModuleType.VISIBLE_ADULT_HOGLIN_COUNT, MemoryModuleType.NEAREST_TARGETABLE_PLAYER_NOT_WEARING_GOLD, MemoryModuleType.NEAREST_PLAYER_HOLDING_WANTED_ITEM, MemoryModuleType.ATE_RECENTLY, MemoryModuleType.NEAREST_VISIBLE_SOUL_FIRE_ITEM});
    ...
    public void writeCustomDataToTag(CompoundTag tag) {
        ...
        tag.put("Inventory", class_4836.method_24692(this.field_22371));
    }
    ...
    public void readCustomDataFromTag(CompoundTag tag) {
        ...
        class_4836.method_24693(this.field_22371, tag.getList("Inventory", 10));
    }
    ...
    public boolean interactMob(PlayerEntity player, Hand hand) {
        ...
        return class_4838.method_24728(this, player, hand);
    }
    ...
    protected void mobTick() {
        ...
        this.field_22370 = this.world.dimension.getType() == DimensionType.OVERWORLD ? ++this.field_22370 : 0;
    ...
    public class_4837 method_24705() {
        if (this.isHandSwinging) {
            return class_4837.field_22386;
        }
        if (class_4838.method_24735(this.getOffHandStack().getItem())) {
            return class_4837.field_22385;
        }
        if (this.method_24703()) {
            return class_4837.field_22384;
        }
        if (this.method_24518(Items.CROSSBOW) && this.isAttacking()) {
            return class_4837.field_22383;
        }
        return class_4837.field_22386;
    }
