...
public class class_6603 {
    private static final int field_34862 = 0x200000;
    ...
    public class_6603(WorldChunk worldChunk) {
        ...
        for (Map.Entry<Heightmap.Type, Heightmap> entry : worldChunk.getHeightmaps()) {
            ...
            this.field_34863.put(entry.getKey().getName(), new NbtLongArray(entry.getValue().asLongArray()));
        }
        this.field_34864 = new byte[class_6603.method_38589(worldChunk)];
        class_6603.method_38591(new PacketByteBuf(this.method_38595()), worldChunk);
        this.field_34865 = Lists.newArrayList();
        for (Map.Entry<Object, Object> entry : worldChunk.getBlockEntities().entrySet()) {
            this.field_34865.add(class_6604.method_38596((BlockEntity)entry.getValue()));
        }
    }
    ...
    public class_6603(PacketByteBuf packetByteBuf, int i, int j) {
        ...
        this.field_34865 = packetByteBuf.readList(class_6604::new);
    }

    public void method_38590(PacketByteBuf packetByteBuf2) {
        packetByteBuf2.writeNbt(this.field_34863);
        packetByteBuf2.writeVarInt(this.field_34864.length);
        packetByteBuf2.writeBytes(this.field_34864);
        packetByteBuf2.writeCollection(this.field_34865, (packetByteBuf, arg) -> arg.method_38597((PacketByteBuf)packetByteBuf));
    }
    ...
    public Consumer<class_6605> method_38587(int i, int j) {
        return arg -> this.method_38593((class_6605)arg, i, j);
    }

    private void method_38593(class_6605 arg, int i, int j) {
        int k = 16 * i;
        int l = 16 * j;
        BlockPos.Mutable mutable = new BlockPos.Mutable();
        for (class_6604 lv : this.field_34865) {
    ...
    static class class_6604 {
        ...
        private class_6604(PacketByteBuf packetByteBuf) {
            ...
            this.field_34868 = (BlockEntityType)Registry.BLOCK_ENTITY_TYPE.get(i);
        ...
        static class_6604 method_38596(BlockEntity blockEntity) {
            ...
            return new class_6604(i, blockPos.getY(), blockEntity.getType(), nbtCompound.isEmpty() ? null : nbtCompound);
        }
    }

    @FunctionalInterface
    public static interface class_6605 {
