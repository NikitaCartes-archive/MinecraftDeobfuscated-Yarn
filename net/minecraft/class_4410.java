...
extends class_4415<WorldTemplate> {
    ...
    private String field_20005 = class_4410.getLocalizedString("mco.reset.world.title");
    private String field_20006 = class_4410.getLocalizedString("mco.reset.world.warning");
    private String field_20007 = class_4410.getLocalizedString("gui.cancel");
    private int field_20008 = 0xFF0000;
    ...
    private class_4412 field_20015 = class_4412.NONE;
    private class_4413 field_20016 = null;
    ...
    public void init() {
        ...
        new Thread("Realms-reset-world-fetcher"){
            ...
            public void run() {
                ...
                try {
                    ...
                    field_19999.error("Couldn't fetch templates in reset world", (Throwable)lv2);
                }
            }
        }.start();
        this.field_20003 = new RealmsLabel(this.field_20005, this.width() / 2, 7, 0xFFFFFF);
        this.addWidget(this.field_20003);
        this.field_20004 = new RealmsLabel(this.field_20006, this.width() / 2, 22, this.field_20008);
        this.addWidget(this.field_20004);
        this.buttonsAdd(new class_4411(this.method_21384(1), class_4359.method_21072(0) + 10, class_4410.getLocalizedString("mco.reset.world.generate"), -1L, "realms:textures/gui/realms/new_world.png", class_4412.GENERATE){
        ...
        this.buttonsAdd(new class_4411(this.method_21384(2), class_4359.method_21072(0) + 10, class_4410.getLocalizedString("mco.reset.world.upload"), -1L, "realms:textures/gui/realms/upload.png", class_4412.UPLOAD){

            @Override
            public void onPress() {
                Realms.setScreen(new class_4416(((class_4410)class_4410.this).field_20001.id, class_4410.this.field_19998 != -1 ? class_4410.this.field_19998 : ((class_4410)class_4410.this).field_20001.activeSlot, class_4410.this));
            }
        });
        this.buttonsAdd(new class_4411(this.method_21384(3), class_4359.method_21072(0) + 10, class_4410.getLocalizedString("mco.reset.world.template"), -1L, "realms:textures/gui/realms/survival_spawn.png", class_4412.SURVIVAL_SPAWN){
        ...
        this.buttonsAdd(new class_4411(this.method_21384(1), class_4359.method_21072(6) + 20, class_4410.getLocalizedString("mco.reset.world.adventure"), -1L, "realms:textures/gui/realms/adventure.png", class_4412.ADVENTURE){
        ...
        this.buttonsAdd(new class_4411(this.method_21384(2), class_4359.method_21072(6) + 20, class_4410.getLocalizedString("mco.reset.world.experience"), -1L, "realms:textures/gui/realms/experience.png", class_4412.EXPERIENCE){
        ...
        this.buttonsAdd(new class_4411(this.method_21384(3), class_4359.method_21072(6) + 20, class_4410.getLocalizedString("mco.reset.world.inspiration"), -1L, "realms:textures/gui/realms/inspiration.png", class_4412.INSPIRATION){
    ...
    private void method_21370(int i, int j, String string, long l, String string2, class_4412 arg, boolean bl, boolean bl2) {
        if (l == -1L) {
            class_4410.bind(string2);
        } else {
        ...
        class_4410.bind("realms:textures/gui/realms/slot_frame.png");
        if (bl) {
            GlStateManager.color4f(0.56f, 0.56f, 0.56f, 1.0f);
        } else {
            GlStateManager.color4f(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        if (worldTemplate != null) {
            if (this.field_19998 == -1) {
                ...
                switch (worldTemplate.type) {
                    case WORLD_TEMPLATE: {
                        this.field_20015 = class_4412.SURVIVAL_SPAWN;
                        break;
                    }
                    case ADVENTUREMAP: {
                        this.field_20015 = class_4412.ADVENTURE;
                        break;
                    }
                    case EXPERIENCE: {
                        this.field_20015 = class_4412.EXPERIENCE;
                        break;
                    }
                    case INSPIRATION: {
                        this.field_20015 = class_4412.INSPIRATION;
                    }
                }
    ...
    public void confirmResult(boolean bl, int i) {
        if (i == 100 && bl) {
            switch (this.field_20015) {
                ...
                case EXPERIENCE: 
                case INSPIRATION: {
                    if (this.field_20017 == null) break;
                    this.method_21380(this.field_20017);
                    break;
                }
                case GENERATE: {
                    if (this.field_20016 == null) break;
    ...
    public void method_21372(class_4413 arg) {
        if (this.field_19998 == -1) {
            this.method_21381(arg);
        } else {
            this.field_20015 = class_4412.GENERATE;
            this.field_20016 = arg;
            this.method_21378();
        }
    }

    private void method_21381(class_4413 arg) {
    ...
    @Environment(value=EnvType.CLIENT)
    abstract class class_4411
    extends RealmsButton {
        private final long field_20030;
        private final String field_20032;
        private final class_4412 field_20033;

        public class_4411(int i, int j, String string, long l, String string2, class_4412 arg2) {
        ...
        public void renderButton(int i, int j, float f) {
            class_4410.this.method_21370(this.x(), this.y(), this.getProxy().getMessage(), this.field_20030, this.field_20032, this.field_20033, this.getProxy().isHovered(), this.getProxy().isMouseOver(i, j));
        }
    }
