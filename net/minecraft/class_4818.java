...
extends Task<MobEntityWithAi> {
    ...
    protected void run(ServerWorld serverWorld, MobEntityWithAi mobEntityWithAi, long l) {
        ...
        mobEntityWithAi.getBrain().setMemory(MemoryModuleType.WALK_TARGET, optional.map(vec3d -> new WalkTarget((Vec3d)vec3d, this.field_22310, 0)));
    }
}
