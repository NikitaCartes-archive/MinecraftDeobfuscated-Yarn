...
public class class_4515 {
    ...
    private final List<class_4517> field_20551 = Lists.newArrayList();
    ...
    public class_4515(Collection<GameTestBatch> collection, BlockPos blockPos, ServerWorld serverWorld, class_4521 arg) {
        this.field_20547 = Lists.newArrayList(collection);
    ...
    private void method_22163() {
        this.field_20547.forEach(gameTestBatch -> {
            ArrayList<class_4517> collection = Lists.newArrayList();
            Collection<TestFunction> collection2 = gameTestBatch.method_22154();
            for (TestFunction testFunction : collection2) {
                ...
                if (this.field_20551.size() % 8 != 0) continue;
    ...
    private void method_22157(GameTestBatch gameTestBatch) {
        Collection<class_4517> collection = this.field_20552.get(gameTestBatch.method_22152());
