...
public record class_7056(DensityFunction barrierNoise, DensityFunction fluidLevelFloodednessNoise, DensityFunction fluidLevelSpreadNoise, DensityFunction lavaNoise, DensityFunction temperature, DensityFunction vegetation, DensityFunction continents, DensityFunction erosion, DensityFunction depth, DensityFunction ridges, DensityFunction initialDensityWithoutJaggedness, DensityFunction finalDensity, DensityFunction veinToggle, DensityFunction veinRidged, DensityFunction veinGap) {
    ...
    public class_7056 method_41124(DensityFunction.DensityFunctionVisitor densityFunctionVisitor) {
        return new class_7056(this.barrierNoise.method_40469(densityFunctionVisitor), this.fluidLevelFloodednessNoise.method_40469(densityFunctionVisitor), this.fluidLevelSpreadNoise.method_40469(densityFunctionVisitor), this.lavaNoise.method_40469(densityFunctionVisitor), this.temperature.method_40469(densityFunctionVisitor), this.vegetation.method_40469(densityFunctionVisitor), this.continents.method_40469(densityFunctionVisitor), this.erosion.method_40469(densityFunctionVisitor), this.depth.method_40469(densityFunctionVisitor), this.ridges.method_40469(densityFunctionVisitor), this.initialDensityWithoutJaggedness.method_40469(densityFunctionVisitor), this.finalDensity.method_40469(densityFunctionVisitor), this.veinToggle.method_40469(densityFunctionVisitor), this.veinRidged.method_40469(densityFunctionVisitor), this.veinGap.method_40469(densityFunctionVisitor));
    }
}
