...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_20099 = new RealmsButton(1, i - 2, class_4359.method_21072(12), 106, 20, class_4422.getLocalizedString("mco.configure.world.buttons.done")){
        ...
        this.buttonsAdd(this.field_20099);
        this.buttonsAdd(new RealmsButton(0, this.width() / 2 + 2, class_4359.method_21072(12), 106, 20, class_4422.getLocalizedString("gui.cancel")){
        ...
        this.buttonsAdd(new RealmsButton(5, this.width() / 2 - 53, class_4359.method_21072(0), 106, 20, class_4422.getLocalizedString(this.field_20097.state.equals((Object)RealmsServer.class_4320.OPEN) ? "mco.configure.world.buttons.close" : "mco.configure.world.buttons.open")){

            @Override
            public void onPress() {
                if (((class_4422)class_4422.this).field_20097.state.equals((Object)RealmsServer.class_4320.OPEN)) {
        ...
        this.field_20101 = this.newEditBox(2, i, class_4359.method_21072(4), 212, 20, class_4422.getLocalizedString("mco.configure.world.name"));
        ...
        this.field_20100 = this.newEditBox(3, i, class_4359.method_21072(8), 212, 20, class_4422.getLocalizedString("mco.configure.world.description"));
        ...
        this.field_20102 = new RealmsLabel(class_4422.getLocalizedString("mco.configure.world.settings.title"), this.width() / 2, 17, 0xFFFFFF);
        this.addWidget(this.field_20102);
        this.narrateLabels();
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawString(class_4422.getLocalizedString("mco.configure.world.name"), this.width() / 2 - 106, class_4359.method_21072(3), 0xA0A0A0);
        this.drawString(class_4422.getLocalizedString("mco.configure.world.description"), this.width() / 2 - 106, class_4359.method_21072(7), 0xA0A0A0);
