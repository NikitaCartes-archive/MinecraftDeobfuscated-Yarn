...
import net.minecraft.class_4515;
...
public class class_4520 {
    ...
    public static Collection<class_4517> method_22222(Collection<TestFunction> collection, BlockPos blockPos, ServerWorld serverWorld, class_4521 arg) {
        return class_4520.method_22210(class_4520.method_22209(collection), blockPos, serverWorld, arg);
    }
    ...
    public static Collection<GameTestBatch> method_22209(Collection<TestFunction> collection) {
        ...
        collection.forEach(testFunction -> {
            String string2 = testFunction.method_22301();
    ...
    private static void method_22224(class_4517 arg) {
        ...
        class_4520.method_22214(arg.getWorld(), Formatting.RED, string);
        if (throwable instanceof class_4513) {
            class_4513 lv = (class_4513)throwable;
            class_4520.method_22217(arg.getWorld(), lv.method_22151(), lv.method_22150());
        }
        field_20573.method_22304(arg);
    }

    private static void method_22225(class_4517 arg) {
        class_4520.method_22214(arg.getWorld(), Formatting.GREEN, arg.method_22169() + " passed!");
    ...
    private static void method_22221(class_4517 arg, String string) {
        ...
        ItemStack itemStack = class_4520.method_22207(arg.method_22169(), arg.method_22183(), string);
        LecternBlock.putBookIfAbsent(serverWorld, blockPos2, blockState, itemStack);
    }

    private static ItemStack method_22207(String string2, boolean bl, String string22) {
    ...
    public static void method_22216(ServerWorld serverWorld, BlockPos blockPos2, class_4521 arg, int i) {
        arg.method_22226();
