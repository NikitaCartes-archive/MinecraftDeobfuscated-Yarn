...
implements FeatureConfig {
    ...
    public static <T> class_4638 method_23413(Dynamic<T> dynamic) {
        ...
        class_4630<T> lv2 = Registry.BLOCK_PLACER_TYPE.get(new Identifier(dynamic.get("block_placer").get("type").asString().orElseThrow(RuntimeException::new)));
        return new class_4638((class_4651)lv.method_23456(dynamic.get("state_provider").orElseEmptyMap()), (class_4629)lv2.method_23404(dynamic.get("block_placer").orElseEmptyMap()), dynamic.get("whitelist").asList(BlockState::deserialize).stream().map(BlockState::getBlock).collect(Collectors.toSet()), (Set<BlockState>)Sets.newHashSet(dynamic.get("blacklist").asList(BlockState::deserialize)), dynamic.get("tries").asInt(128), dynamic.get("xspread").asInt(7), dynamic.get("yspread").asInt(3), dynamic.get("zspread").asInt(7), dynamic.get("can_replace").asBoolean(false), dynamic.get("project").asBoolean(true), dynamic.get("need_water").asBoolean(false));
    }
    ...
    public static class class_4639 {
        ...
        public class_4638 method_23424() {
            return new class_4638(this.field_21248, this.field_21249, this.field_21250, this.field_21251, this.field_21252, this.field_21253, this.field_21254, this.field_21255, this.field_21256, this.field_21257, this.field_21258);
        }
    }
}
