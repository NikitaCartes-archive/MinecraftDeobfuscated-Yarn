...
public abstract class class_5317 {
    ...
    protected static final List<class_5317> field_25052 = Lists.newArrayList(field_25050, field_25054, field_25055, field_25051, field_25056, field_25057, field_25058, field_25059);
    protected static final Map<Optional<class_5317>, class_5293> field_25053 = ImmutableMap.of(Optional.of(field_25054), (createWorldScreen, generatorOptions) -> {
        ChunkGenerator chunkGenerator = generatorOptions.getChunkGenerator();
        return new CustomizeFlatLevelScreen(createWorldScreen, flatChunkGeneratorConfig -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(new GeneratorOptions(generatorOptions.getSeed(), generatorOptions.shouldGenerateStructures(), generatorOptions.hasBonusChest(), GeneratorOptions.method_28608(generatorOptions.method_28609(), new FlatChunkGenerator((FlatChunkGeneratorConfig)flatChunkGeneratorConfig)))), chunkGenerator instanceof FlatChunkGenerator ? ((FlatChunkGenerator)chunkGenerator).method_28545() : FlatChunkGeneratorConfig.getDefaultConfig());
    }, Optional.of(field_25056), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(class_5317.method_29079(generatorOptions, field_25056, biome)), class_5317.method_29083(generatorOptions)), Optional.of(field_25057), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(class_5317.method_29079(generatorOptions, field_25057, biome)), class_5317.method_29083(generatorOptions)), Optional.of(field_25058), (createWorldScreen, generatorOptions) -> new CustomizeBuffetLevelScreen(createWorldScreen, biome -> createWorldScreen.moreOptionsDialog.setGeneratorOptions(class_5317.method_29079(generatorOptions, field_25058, biome)), class_5317.method_29083(generatorOptions)));
    ...
    private static GeneratorOptions method_29079(GeneratorOptions generatorOptions, class_5317 arg, Biome biome) {
        ...
        ChunkGeneratorType chunkGeneratorType = arg == field_25057 ? ChunkGeneratorType.Preset.NETHER.getChunkGeneratorType() : (arg == field_25058 ? ChunkGeneratorType.Preset.END.getChunkGeneratorType() : ChunkGeneratorType.Preset.OVERWORLD.getChunkGeneratorType());
        return new GeneratorOptions(generatorOptions.getSeed(), generatorOptions.shouldGenerateStructures(), generatorOptions.hasBonusChest(), GeneratorOptions.method_28608(generatorOptions.method_28609(), new SurfaceChunkGenerator(biomeSource, generatorOptions.getSeed(), chunkGeneratorType)));
    }
