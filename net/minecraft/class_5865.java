...
public class class_5865
extends class_5863 {
    public static final Codec<class_5865> field_29012 = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.FLOAT.fieldOf("min")).forGetter(arg -> Float.valueOf(arg.field_29013)), ((MapCodec)Codec.FLOAT.fieldOf("max")).forGetter(arg -> Float.valueOf(arg.field_29014)), ((MapCodec)Codec.FLOAT.fieldOf("plateau")).forGetter(arg -> Float.valueOf(arg.field_29015))).apply((Applicative<class_5865, ?>)instance, class_5865::new)).comapFlatMap(arg -> {
        if (arg.field_29014 < arg.field_29013) {
            return DataResult.error("Max must be larger than min: [" + arg.field_29013 + ", " + arg.field_29014 + "]");
        }
        if (arg.field_29015 > arg.field_29014 - arg.field_29013) {
            return DataResult.error("Plateau can at most be the full span: [" + arg.field_29013 + ", " + arg.field_29014 + "]");
        }
    ...
    public int hashCode() {
        return Objects.hash(Float.valueOf(this.field_29013), Float.valueOf(this.field_29014), Float.valueOf(this.field_29015));
    }
