 ...
 */
public record ChatMessageS2CPacket(Text content, int typeId, MessageSender sender, Instant time, NetworkEncryptionUtils.SignatureData saltSignature) implements Packet<ClientPlayPacketListener>
{
    ...
    public MessageType getMessageType(Registry<MessageType> registry) {
        return Objects.requireNonNull((MessageType)registry.get(this.typeId), "Invalid chat type");
    }
}
