...
public record CommandExecutionC2SPacket(String command, Instant timestamp, long salt, ArgumentSignatureDataMap argumentSignatures, boolean signedPreview, LastSeenMessageList.Acknowledgment acknowledgment) implements Packet<ServerPlayPacketListener>
{
    ...
    public SignedCommandArguments createSignedArguments(ServerPlayerEntity player) {
        ...
        return new SignedCommandArguments.Impl(player.networkHandler.getMessageUnpacker(), messageMetadata, this.argumentSignatures, this.signedPreview, this.acknowledgment.lastSeen());
    }
}
