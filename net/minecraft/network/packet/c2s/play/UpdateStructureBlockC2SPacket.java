...
implements Packet<ServerPlayPacketListener> {
    ...
    public UpdateStructureBlockC2SPacket(PacketByteBuf packetByteBuf) {
        ...
        int i = 48;
        this.offset = new BlockPos(MathHelper.clamp(packetByteBuf.readByte(), -48, 48), MathHelper.clamp(packetByteBuf.readByte(), -48, 48), MathHelper.clamp(packetByteBuf.readByte(), -48, 48));
        int j = 48;
        this.size = new BlockPos(MathHelper.clamp(packetByteBuf.readByte(), 0, 48), MathHelper.clamp(packetByteBuf.readByte(), 0, 48), MathHelper.clamp(packetByteBuf.readByte(), 0, 48));
