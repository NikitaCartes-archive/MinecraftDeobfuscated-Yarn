...
public interface ChatDecorator {
     ...
     */
    public static final ChatDecorator NOOP = (sender, message) -> CompletableFuture.completedFuture(message);
     ...
     */
    default public CompletableFuture<FilteredMessage<SignedChatMessage>> decorateChat(@Nullable ServerPlayerEntity sender, FilteredMessage<Text> message, ChatMessageSignature signature, boolean previewed) {
