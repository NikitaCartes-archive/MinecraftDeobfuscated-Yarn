...
public enum NetworkState {
    ...
    public Packet<?> getPacketHandler(NetworkSide side, int packetId, PacketByteBuf packetByteBuf) {
        return this.packetHandlers.get((Object)side).createPacket(packetId, packetByteBuf);
    }
    ...
    static class PacketHandler<T extends PacketListener> {
        ...
        public Packet<?> createPacket(int id, PacketByteBuf packetByteBuf) {
            Function<PacketByteBuf, Packet<PacketByteBuf>> function = this.packetFactories.get(id);
            return function != null ? function.apply(packetByteBuf) : null;
        }
