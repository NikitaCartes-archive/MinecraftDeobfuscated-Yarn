...
public enum NetworkState {
    ...
    public Packet<?> getPacketHandler(NetworkSide side, int packetId, PacketByteBuf buf) {
        return this.packetHandlers.get((Object)side).createPacket(packetId, buf);
    }
