...
public class class_6124
extends class_6122 {
    public static final Codec<class_6124> field_31544 = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)YOffset.OFFSET_CODEC.fieldOf("min_inclusive")).forGetter(arg -> arg.field_31546), ((MapCodec)YOffset.OFFSET_CODEC.fieldOf("max_inclusive")).forGetter(arg -> arg.field_31547)).apply((Applicative<class_6124, ?>)instance, class_6124::new)).comapFlatMap(DataResult::success, Function.identity());
    ...
    public int method_35391(Random random, HeightContext heightContext) {
        ...
        if (i > (j = this.field_31547.getY(heightContext))) {
            field_31545.warn("Empty height range: {}", (Object)this);
            return i;
        }
    ...
    public int hashCode() {
        return Objects.hash(this.field_31546, this.field_31547);
    }
