...
import net.minecraft.class_4843;
...
public class class_4842
extends BipedEntityRenderer<class_4836, class_4840<class_4836>> {
    ...
    public class_4842(EntityRenderDispatcher entityRenderDispatcher) {
        ...
        this.addFeature(new class_4843(this, new BipedEntityModel(0.5f), new BipedEntityModel(1.0f), class_4842.method_24813()));
    }

    private static <T extends class_4836> class_4840<T> method_24813() {
        class_4840 lv = new class_4840(1.0f, 64, 16);
