...
extends RealmsScreen {
    ...
    public class_4425(RealmsScreen realmsScreen, RealmsServer realmsServer, RealmsScreen realmsScreen2) {
        ...
        this.field_20153 = class_4425.getLocalizedString("mco.configure.world.subscription.title");
        this.field_20154 = class_4425.getLocalizedString("mco.configure.world.subscription.start");
        this.field_20155 = class_4425.getLocalizedString("mco.configure.world.subscription.timeleft");
        this.field_20156 = class_4425.getLocalizedString("mco.configure.world.subscription.recurring.daysleft");
    }
    ...
    public void init() {
        ...
        this.buttonsAdd(new RealmsButton(2, this.width() / 2 - 100, class_4359.method_21072(6), class_4425.getLocalizedString("mco.configure.world.subscription.extend")){

            @Override
            public void onPress() {
                String string = "https://account.mojang.com/buy/realms?sid=" + ((class_4425)class_4425.this).field_20148.remoteSubscriptionId + "&pid=" + Realms.getUUID();
                Realms.setClipboard(string);
                class_4448.method_21570(string);
            }
        });
        this.buttonsAdd(new RealmsButton(0, this.width() / 2 - 100, class_4359.method_21072(12), class_4425.getLocalizedString("gui.back")){
        ...
        if (this.field_20148.expired) {
            this.buttonsAdd(new RealmsButton(1, this.width() / 2 - 100, class_4359.method_21072(10), class_4425.getLocalizedString("mco.configure.world.delete.button")){
    ...
    private void method_21500(long l) {
        ...
        try {
            ...
            Realms.setScreen(new class_4394(lv2, this.field_20147));
        ...
        if (i == 1 && bl) {
            new Thread("Realms-delete-realm"){
                ...
                public void run() {
                    try {
                        class_4341 lv = class_4341.method_20989();
                        lv.method_21028(((class_4425)class_4425.this).field_20148.id);
                    } catch (class_4355 lv2) {
                        field_20146.error("Couldn't delete world");
                        field_20146.error(lv2);
                    } catch (IOException iOException) {
                        field_20146.error("Couldn't delete world");
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.field_20153, this.width() / 2, 17, 0xFFFFFF);
        this.drawString(this.field_20154, k, class_4359.method_21072(0), 0xA0A0A0);
        this.drawString(this.field_20158, k, class_4359.method_21072(1), 0xFFFFFF);
        if (this.field_20159 == Subscription.class_4322.NORMAL) {
            this.drawString(this.field_20155, k, class_4359.method_21072(3), 0xA0A0A0);
        } else if (this.field_20159 == Subscription.class_4322.RECURRING) {
            this.drawString(this.field_20156, k, class_4359.method_21072(3), 0xA0A0A0);
        }
        this.drawString(this.method_21499(this.field_20157), k, class_4359.method_21072(4), 0xFFFFFF);
        super.render(i, j, f);
    }

    private String method_21499(int i) {
        if (i == -1 && this.field_20148.expired) {
            return class_4425.getLocalizedString("mco.configure.world.subscription.expired");
        }
        if (i <= 1) {
            return class_4425.getLocalizedString("mco.configure.world.subscription.less_than_a_day");
        }
        int j = i / 30;
        int k = i % 30;
        ...
        if (j > 0) {
            ...
            if (j == 1) {
                stringBuilder.append(class_4425.getLocalizedString("mco.configure.world.subscription.month").toLowerCase(Locale.ROOT));
            } else {
                stringBuilder.append(class_4425.getLocalizedString("mco.configure.world.subscription.months").toLowerCase(Locale.ROOT));
            }
        }
        if (k > 0) {
            ...
            if (k == 1) {
                stringBuilder.append(class_4425.getLocalizedString("mco.configure.world.subscription.day").toLowerCase(Locale.ROOT));
            } else {
                stringBuilder.append(class_4425.getLocalizedString("mco.configure.world.subscription.days").toLowerCase(Locale.ROOT));
            }
        }
