...
implements ArgumentType<Integer> {
    ...
    private static final DynamicCommandExceptionType INVALID_COUNT_EXCEPTION = new DynamicCommandExceptionType(time -> Text.method_43469("argument.time.invalid_tick_count", time));
