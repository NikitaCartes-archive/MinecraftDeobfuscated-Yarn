...
implements ArgumentType<Identifier> {
    ...
    private static final DynamicCommandExceptionType UNKNOWN_ADVANCEMENT_EXCEPTION = new DynamicCommandExceptionType(id -> Text.method_43469("advancement.advancementNotFound", id));
    ...
    private static final DynamicCommandExceptionType UNKNOWN_PREDICATE_EXCEPTION = new DynamicCommandExceptionType(id -> Text.method_43469("predicate.unknown", id));
    private static final DynamicCommandExceptionType UNKNOWN_ITEM_MODIFIER_EXCEPTION = new DynamicCommandExceptionType(id -> Text.method_43469("item_modifier.unknown", id));
