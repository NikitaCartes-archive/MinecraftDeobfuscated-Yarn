...
public class SuggestionProviders {
    ...
    public static final SuggestionProvider<CommandSource> ASK_SERVER = SuggestionProviders.register(ASK_SERVER_NAME, (context, builder) -> ((CommandSource)context.getSource()).getCompletions(context, builder));
    ...
    public static final SuggestionProvider<ServerCommandSource> AVAILABLE_BIOMES = SuggestionProviders.register(new Identifier("available_biomes"), (context, builder) -> CommandSource.suggestIdentifiers(((CommandSource)context.getSource()).getRegistryManager().get(Registry.BIOME_KEY).getIds(), builder));
    public static final SuggestionProvider<ServerCommandSource> AVAILABLE_FEATURES = SuggestionProviders.register(new Identifier("available_features"), (context, builder) -> CommandSource.suggestIdentifiers(((CommandSource)context.getSource()).getRegistryManager().get(Registry.CONFIGURED_FEATURE_KEY).getIds(), builder));
    public static final SuggestionProvider<ServerCommandSource> AVAILABLE_STRUCTURES = SuggestionProviders.register(new Identifier("available_structures"), (context, builder) -> CommandSource.suggestIdentifiers(((CommandSource)context.getSource()).getRegistryManager().get(Registry.STRUCTURE_FEATURE_KEY).getIds(), builder));
