...
public class SuggestionProviders {
    ...
    public static final SuggestionProvider<ServerCommandSource> ALL_BIOMES = SuggestionProviders.register(new Identifier("available_biomes"), (context, builder) -> CommandSource.suggestIdentifiers(((CommandSource)context.getSource()).getRegistryManager().get(Registry.BIOME_KEY).getIds(), builder));
