...
implements ArgumentType<ScoreboardCriterion> {
    ...
    public static final DynamicCommandExceptionType INVALID_CRITERIA_EXCEPTION = new DynamicCommandExceptionType(object -> new TranslatableComponent("argument.criteria.invalid", object));
