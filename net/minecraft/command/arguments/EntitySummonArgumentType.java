...
implements ArgumentType<Identifier> {
    ...
    public static final DynamicCommandExceptionType NOT_FOUND_EXCEPTION = new DynamicCommandExceptionType(object -> new TranslatableComponent("entity.notFound", object));
    ...
    public Identifier method_9325(StringReader stringReader) throws CommandSyntaxException {
        return EntitySummonArgumentType.validate(Identifier.parse(stringReader));
    }
