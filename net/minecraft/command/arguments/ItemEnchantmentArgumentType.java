...
implements ArgumentType<Enchantment> {
    ...
    public static final DynamicCommandExceptionType UNKNOWN_ENCHANTMENT_EXCEPTION = new DynamicCommandExceptionType(object -> new TranslatableComponent("enchantment.unknown", object));
