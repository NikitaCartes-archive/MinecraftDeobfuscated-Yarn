...
extends RealmsScreen {
    ...
    private void method_21280(class_4355 arg) {
        if (arg.field_19606 == -1) {
            ...
            String string2 = class_4394.getLocalizedString(string);
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.field_19875, this.width() / 2, 80, 0xFFFFFF);
        this.drawCenteredString(this.field_19876, this.width() / 2, 100, 0xFF0000);
        super.render(i, j, f);
    }
}
