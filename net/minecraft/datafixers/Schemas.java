...
public class Schemas {
    ...
    private static void build(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema18, "cooked_fished item renamer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : string));
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema52, "Colorless shulker item fixer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
