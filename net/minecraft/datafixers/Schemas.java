...
public class Schemas {
    ...
    private static void build(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema18, "cooked_fished item renamer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : string));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema32, "totem item renamer", string -> Objects.equals(string, "minecraft:totem") ? "minecraft:totem_of_undying" : string));
        ...
        dataFixerBuilder.addFixer(BlockNameFix.create(schema52, "Colorless shulker block fixer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        dataFixerBuilder.addFixer(FixItemName.create(schema52, "Colorless shulker item fixer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema54, "Rename coral items", string -> LegacyCoralBlockMapping.MAP.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema56, "Rename pufferfish egg item", string -> EntityPufferfishRenameFix.RENAMED_FISHES.getOrDefault(string, (String)string)));
        Schema schema57 = dataFixerBuilder.addSchema(1484, identNormalize);
        dataFixerBuilder.addFixer(FixItemName.create(schema57, "Rename seagrass items", string -> ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema58, "Rename cod/salmon egg items", string -> EntityCodSalmonFix.SPAWN_EGGS.getOrDefault(string, (String)string)));
        Schema schema59 = dataFixerBuilder.addSchema(1487, identNormalize);
        dataFixerBuilder.addFixer(FixItemName.create(schema59, "Rename prismarine_brick(s)_* blocks", string -> ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema61, "Rename melon_block/melon/speckled_melon", string -> ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice").getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema70, "Item renamening fix", string -> EntityTheRenameningBlock.ITEMS.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema74, "Rename dye items", string -> LegacyDyeItemMapping.MAP.getOrDefault(string, (String)string)));
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema76, "Rename sign item & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign").getOrDefault(string, (String)string)));
        ...
        Schema schema81 = dataFixerBuilder.addSchema(1907, identNormalize);
        dataFixerBuilder.addFixer(new ChunkLightRemoveFix(schema81, false));
        Schema schema82 = dataFixerBuilder.addSchema(1909, Schema1909::new);
        ...
        Schema schema86 = dataFixerBuilder.addSchema(1920, Schema1920::new);
        dataFixerBuilder.addFixer(new NewVillageFix(schema86, false));
        ...
        dataFixerBuilder.addFixer(new MapIdFix(schema87, false));
        Schema schema88 = dataFixerBuilder.addSchema(1928, Schema1928::new);
        dataFixerBuilder.addFixer(new EntityRavagerRenameFix(schema88, true));
        dataFixerBuilder.addFixer(FixItemName.create(schema88, "Rename ravager egg item", string -> EntityRavagerRenameFix.ITEMS.getOrDefault(string, (String)string)));
        Schema schema89 = dataFixerBuilder.addSchema(1929, Schema1929::new);
        ...
        dataFixerBuilder.addFixer(new OminousBannerItemRenameFix(schema93, false));
