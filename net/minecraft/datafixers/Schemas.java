...
public class Schemas {
    ...
    private static void build(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer(FixItemName.create(schema87, "Rename ravager egg item", string -> EntityRavagerRenameFix.ITEMS.getOrDefault(string, (String)string)));
        ...
        Schema schema96 = dataFixerBuilder.addSchema(2100, class_4465::new);
