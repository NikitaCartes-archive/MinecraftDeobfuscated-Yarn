...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhere("BlockNameFlatteningFix", type3, type4, dynamicOps -> pair -> pair.mapSecond(either -> either.map(BlockStateFlattening::lookup, string -> BlockStateFlattening.lookup(SchemaIdentifierNormalize.normalize(string)))));
    }
}
