...
extends DataFix {
    private static final Map<String, String> RENAMED_ENTITIES = DataFixUtils.make(Maps.newHashMap(), hashMap -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type, type2), this.fixTypeEverywhere("EntityIdFix", taggedChoiceType, taggedChoiceType2, dynamicOps -> pair -> pair.mapFirst(string -> RENAMED_ENTITIES.getOrDefault(string, (String)string))));
    }
}
