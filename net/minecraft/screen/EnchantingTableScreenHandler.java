...
extends ScreenHandler {
    private final Inventory inventory = new BasicInventory(2){
        ...
        public void markDirty() {
            super.markDirty();
            EnchantingTableScreenHandler.this.onContentChanged(this);
        }
    };
    ...
    public EnchantingTableScreenHandler(int syncId, PlayerInventory playerInventory, BlockContext blockContext) {
    ...
    public boolean canUse(PlayerEntity player) {
        return EnchantingTableScreenHandler.canUse(this.context, player, Blocks.ENCHANTING_TABLE);
    }
