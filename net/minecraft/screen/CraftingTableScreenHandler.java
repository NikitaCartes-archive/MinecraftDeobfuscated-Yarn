...
public class CraftingTableScreenHandler
extends CraftingScreenHandler<CraftingInventory> {
    ...
    public void onContentChanged(Inventory inventory) {
        this.context.run((world, blockPos) -> CraftingTableScreenHandler.updateResult(this.syncId, world, this.player, this.craftingInv, this.resultInv));
    }
    ...
    public boolean canUse(PlayerEntity player) {
        return CraftingTableScreenHandler.canUse(this.context, player, Blocks.CRAFTING_TABLE);
    }
