...
public class ScreenHandlerType<T extends ScreenHandler> {
    ...
    public static final ScreenHandlerType<CraftingTableScreenHandler> CRAFTING = ScreenHandlerType.register("crafting", CraftingTableScreenHandler::new);
    public static final ScreenHandlerType<EnchantingTableScreenHandler> ENCHANTMENT = ScreenHandlerType.register("enchantment", EnchantingTableScreenHandler::new);
