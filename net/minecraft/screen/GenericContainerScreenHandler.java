...
extends ScreenHandler {
    ...
    public GenericContainerScreenHandler(ScreenHandlerType<?> screenHandlerType, int syncId, PlayerInventory playerInventory, Inventory inventory, int rows) {
        ...
        int k;
        int j;
        GenericContainerScreenHandler.checkContainerSize(inventory, rows * 9);
    ...
    public ItemStack transferSlot(PlayerEntity player, int invSlot) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (invSlot < this.rows * 9 ? !this.insertItem(itemStack2, this.rows * 9, this.slots.size(), true) : !this.insertItem(itemStack2, 0, this.rows * 9, false)) {
