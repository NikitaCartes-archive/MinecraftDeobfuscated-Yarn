...
implements LayeredVertexConsumerStorage {
    ...
    public VertexConsumer getBuffer(RenderLayer renderLayer) {
        ...
        if (optional.isPresent()) {
            VertexConsumer vertexConsumer2 = this.field_21059.getBuffer(RenderLayer.method_23287(optional.get()));
            class_4586 lv = new class_4586(vertexConsumer2, this.field_21060, this.field_21061, this.field_21062, this.field_21063);
    ...
    extends AbstractVertexConsumer {
        ...
        @Override
        public void next() {
            this.field_20897.vertex(this.field_21064, this.field_21065, this.field_21066).color(this.field_20890, this.field_20891, this.field_20892, this.field_20893).texture(this.field_21067, this.field_21068).next();
        }
    }
}
