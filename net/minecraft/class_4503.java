...
public class class_4503
implements DebugRenderer.Renderer {
    private final Map<BlockPos, class_4504> field_20520 = Maps.newHashMap();

    public void method_22123(BlockPos blockPos, int i, String string, int j) {
        this.field_20520.put(blockPos, new class_4504(i, string, SystemUtil.getMeasuringTimeMs() + (long)j));
    }
    ...
    public void render(long l) {
        ...
        this.field_20520.entrySet().removeIf(entry -> m > ((class_4504)entry.getValue()).field_20523);
        this.field_20520.forEach(this::method_22124);
    }

    private void method_22124(BlockPos blockPos, class_4504 arg) {
