...
public class class_5279
extends AbstractCriterion<class_5280> {
    ...
    @Override
    protected class_5280 conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new class_5280(extended, itemPredicate, extended2);
    }
    ...
    public static class class_5280
    extends AbstractCriterionConditions {
        ...
        public class_5280(EntityPredicate.Extended extended, ItemPredicate itemPredicate, EntityPredicate.Extended extended2) {
            super(field_24492, extended);
            this.field_24493 = itemPredicate;
            this.field_24494 = extended2;
        }

        public static class_5280 method_27978(EntityPredicate.Extended extended, ItemPredicate.Builder builder, EntityPredicate.Extended extended2) {
            return new class_5280(extended, builder.build(), extended2);
        }

        public boolean method_27979(ServerPlayerEntity serverPlayerEntity, ItemStack itemStack, LootContext lootContext) {
            if (!this.field_24493.test(itemStack)) {
                return false;
            }
            return this.field_24494.test(lootContext);
        }
