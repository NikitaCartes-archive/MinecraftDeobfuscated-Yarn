...
public class class_5493 {
    ...
    public static boolean method_31517(PathAwareEntity pathAwareEntity, int i) {
        return pathAwareEntity.hasPositionTarget() && pathAwareEntity.getPositionTarget().isWithinDistance(pathAwareEntity.getPos(), (double)(pathAwareEntity.getPositionTargetRange() + (float)i) + 1.0);
    }
