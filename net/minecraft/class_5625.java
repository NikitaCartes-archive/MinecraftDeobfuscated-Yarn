...
public class class_5625
implements class_5627 {
    private static final Map<String, List<String>> field_27820 = Util.make(Maps.newHashMap(), hashMap -> {
    ...
    public void method_32298(ListTag listTag) {
        ...
        this.method_32285("[]");
        String string2 = string = field_27821.contains(this.method_32280()) ? "" : this.field_27825;
        if (!string.isEmpty()) {
            stringBuilder.append("\n");
        }
    ...
    public void method_32292(CompoundTag compoundTag) {
        ...
        List<String> collection = this.method_32286(compoundTag);
        Iterator iterator = collection.iterator();
        while (iterator.hasNext()) {
            String string22 = (String)iterator.next();
            Tag tag = compoundTag.get(string22);
            this.method_32285(string22);
            stringBuilder.append(Strings.repeat(string, this.field_27826 + 1)).append(class_5625.method_32281(string22)).append(field_27823).append(" ").append(new class_5625(string, this.field_27826 + 1, this.field_27827).method_32283(tag));
            this.method_32284();
    ...
    protected List<String> method_32286(CompoundTag compoundTag) {
        HashSet<String> set = Sets.newHashSet(compoundTag.getKeys());
        ArrayList<String> list = Lists.newArrayList();
        List<String> list2 = field_27820.get(this.method_32280());
        if (list2 != null) {
    ...
    public String method_32280() {
        return String.join((CharSequence)".", this.field_27827);
    }

    protected static String method_32281(String string) {
        if (field_27822.matcher(string).matches()) {
            return string;
        }
