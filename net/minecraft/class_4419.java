...
extends RealmsScreen {
    ...
    private class_4420 field_20071;
    ...
    public class_4419(class_4415<WorldTemplate> arg, RealmsServer.class_4321 arg2, @Nullable WorldTemplatePaginatedList worldTemplatePaginatedList) {
        ...
        if (worldTemplatePaginatedList == null) {
            this.field_20071 = new class_4420();
            this.method_21415(new WorldTemplatePaginatedList(10));
        } else {
            this.field_20071 = new class_4420(new ArrayList<WorldTemplate>(worldTemplatePaginatedList.templates));
            this.method_21415(worldTemplatePaginatedList);
        }
        this.field_20073 = class_4419.getLocalizedString("mco.template.title");
    }
    ...
    public void init() {
        ...
        this.field_20075 = new RealmsButton(2, this.width() / 2 - 206, this.height() - 32, 100, 20, class_4419.getLocalizedString("mco.template.button.trailer")){
        ...
        this.buttonsAdd(this.field_20075);
        this.field_20074 = new RealmsButton(1, this.width() / 2 - 100, this.height() - 32, 100, 20, class_4419.getLocalizedString("mco.template.button.select")){
        ...
        this.buttonsAdd(this.field_20074);
        this.buttonsAdd(new RealmsButton(0, this.width() / 2 + 6, this.height() - 32, 100, 20, class_4419.getLocalizedString(this.field_20079 == RealmsServer.class_4321.MINIGAME ? "gui.cancel" : "gui.back")){
        ...
        this.field_20076 = new RealmsButton(3, this.width() / 2 + 112, this.height() - 32, 100, 20, class_4419.getLocalizedString("mco.template.button.publisher")){
        ...
        Realms.narrateNow(Stream.of(this.field_20073, this.field_20081).filter(Objects::nonNull).collect(Collectors.toList()));
    }
        ...
        new Thread("realms-template-fetcher"){
            ...
            public void run() {
                ...
                while (worldTemplatePaginatedList2 != null) {
                    Either either = class_4419.this.method_21416(worldTemplatePaginatedList2, lv);
                    worldTemplatePaginatedList2 = Realms.execute(() -> {
                        if (either.right().isPresent()) {
                            field_20069.error("Couldn't fetch templates: {}", either.right().get());
                            if (class_4419.this.field_20071.method_21446()) {
                                class_4419.this.field_20085 = class_4450.method_21578(RealmsScreen.getLocalizedString("mco.template.select.failure"), new class_4450.class_4452[0]);
                            }
                            return null;
                        }
                        ...
                        if (worldTemplatePaginatedList2.templates.isEmpty()) {
                            if (class_4419.this.field_20071.method_21446()) {
                                ...
                                class_4450.class_4452 lv = class_4450.class_4452.method_21582(RealmsScreen.getLocalizedString("mco.template.select.none.linkTitle"), "https://minecraft.net/realms/content-creator/");
                                class_4419.this.field_20085 = class_4450.method_21578(string, lv);
                            }
                            return null;
                        }
    ...
    private Either<WorldTemplatePaginatedList, String> method_21416(WorldTemplatePaginatedList worldTemplatePaginatedList, class_4341 arg) {
        try {
            ...
            return Either.right(lv.getMessage());
        }
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.field_20073, this.width() / 2, 13, 0xFFFFFF);
        if (this.field_20083) {
            int m;
            int k;
    ...
    private void method_21414(int i, int j, List<class_4450.class_4451> list) {
        for (int k = 0; k < list.size(); ++k) {
            class_4450.class_4451 lv = list.get(k);
            ...
            for (class_4450.class_4452 lv2 : lv.field_20266) {
                int o = lv2.method_21583() ? 0x3366BB : 0xFFFFFF;
    ...
    extends RealmListEntry {
        ...
        private void method_21453(WorldTemplate worldTemplate, int i, int j, int k, int l) {
            int m = i + 45 + 20;
            class_4419.this.drawString(worldTemplate.name, m, j + 2, 0xFFFFFF);
            class_4419.this.drawString(worldTemplate.author, m, j + 15, 0x6C6C6C);
            class_4419.this.drawString(worldTemplate.version, m + 227 - class_4419.this.fontWidth(worldTemplate.version), j + 1, 0x6C6C6C);
        ...
        private void method_21452(int i, int j, int k, int l, String string, String string2, String string3) {
            if (!"".equals(string3)) {
                class_4419.this.drawString(string3, i, j + 4, 0x4C4C4C);
            }
    ...
    @Environment(value=EnvType.CLIENT)
    class class_4420
    extends RealmsObjectSelectionList<class_4421> {
        public class_4420() {
        ...
        public void method_21448(WorldTemplate worldTemplate) {
            this.addEntry(new class_4421(worldTemplate));
        }
        ...
        public WorldTemplate method_21447(int i) {
            return ((class_4421)this.children().get((int)i)).field_20094;
        }

        public List<WorldTemplate> method_21450() {
            return this.children().stream().map(arg -> arg.field_20094).collect(Collectors.toList());
        }
    }
}
