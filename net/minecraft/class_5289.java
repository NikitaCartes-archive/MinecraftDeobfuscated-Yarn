...
public class class_5289
extends Screen {
    private static final Identifier field_24566 = new Identifier("textures/gui/container/gamemode_switcher.png");
    private static final int field_24567 = class_5290.values().length * 30 - 5;
    private final Optional<class_5290> field_24568;
    private Optional<class_5290> field_24569 = Optional.empty();
    private int field_24570;
    private int field_24571;
    private boolean field_24572;
    private final List<class_5291> field_24573 = Lists.newArrayList();

    public class_5289() {
        super(NarratorManager.EMPTY);
        this.field_24568 = class_5290.method_28076(MinecraftClient.getInstance().interactionManager.method_28107());
    }

    @Override
    protected void init() {
        super.init();
        this.field_24569 = this.field_24568.isPresent() ? this.field_24568 : class_5290.method_28076(this.client.interactionManager.getCurrentGameMode());
        for (int i = 0; i < class_5290.field_24580.length; ++i) {
            class_5290 lv = class_5290.field_24580[i];
            this.field_24573.add(new class_5291(lv, this.width / 2 - field_24567 / 2 + i * 30, this.height / 2 - 30));
        }
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        class_5289.drawTexture(matrices, i, j, 0.0f, 0.0f, 125, 75, 128, 128);
        matrices.pop();
        super.render(matrices, mouseX, mouseY, delta);
        this.field_24569.ifPresent(arg -> this.drawCenteredText(matrices, this.textRenderer, ((class_5290)arg).method_28070(), this.width / 2, this.height / 2 - 30 - 20, -1));
        int k = this.textRenderer.getWidth(I18n.translate("debug.gamemodes.press_f4", new Object[0]));
        this.method_28063(matrices, I18n.translate("debug.gamemodes.press_f4", new Object[0]), I18n.translate("debug.gamemodes.select_next", new Object[0]), 5, k);
        if (!this.field_24572) {
        ...
        for (class_5291 lv : this.field_24573) {
    ...
    private void method_28063(MatrixStack matrixStack, String string, String string2, int i, int j) {
        int k = 0x55FFFF;
        int l = 0xFFFFFF;
        this.drawStringWithShadow(matrixStack, this.textRenderer, "[", this.width / 2 - j - 18, this.height / 2 + i, 0x55FFFF);
        this.drawCenteredString(matrixStack, this.textRenderer, string, this.width / 2 - j / 2 - 10, this.height / 2 + i, 0x55FFFF);
        this.drawCenteredString(matrixStack, this.textRenderer, "]", this.width / 2 - 5, this.height / 2 + i, 0x55FFFF);
        this.drawStringWithShadow(matrixStack, this.textRenderer, string2, this.width / 2 + 5, this.height / 2 + i, 0xFFFFFF);
    }

    private void method_28068() {
        class_5289.method_28064(this.client, this.field_24569);
    }

    private static void method_28064(MinecraftClient minecraftClient, Optional<class_5290> optional) {
        if (minecraftClient.interactionManager == null || minecraftClient.player == null || !optional.isPresent()) {
            return;
        }
        Optional optional2 = class_5290.method_28076(minecraftClient.interactionManager.getCurrentGameMode());
        class_5290 lv = optional.get();
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == 293 && this.field_24569.isPresent()) {
            ...
            this.field_24569 = this.field_24569.get().method_28078();
            return true;
        }
    ...
    @Environment(value=EnvType.CLIENT)
    public class class_5291
    extends AbstractButtonWidget {
        private final class_5290 field_24586;
        private boolean field_24587;

        public class_5291(class_5290 arg2, int i, int j) {
        ...
        private void method_28080(MatrixStack matrixStack, TextureManager textureManager) {
            textureManager.bindTexture(field_24566);
            matrixStack.push();
            matrixStack.translate(this.x, this.y, 0.0);
            class_5291.drawTexture(matrixStack, 0, 0, 0.0f, 75.0f, 25, 25, 128, 128);
            matrixStack.pop();
        }
        ...
        private void method_28082(MatrixStack matrixStack, TextureManager textureManager) {
            ...
            matrixStack.push();
            matrixStack.translate(this.x, this.y, 0.0);
            class_5291.drawTexture(matrixStack, 0, 0, 25.0f, 75.0f, 25, 25, 128, 128);
            matrixStack.pop();
        }
    }
    ...
    static enum class_5290 {
        ...
        protected static final class_5290[] field_24580;
        ...
        private Optional<class_5290> method_28078() {
            switch (this) {
                case field_24576: {
        ...
        private static Optional<class_5290> method_28076(GameMode gameMode) {
            switch (gameMode) {
                case SPECTATOR: {
                    return Optional.of(field_24579);
                }
