...
public class class_4817<E extends LivingEntity>
extends Task<E> {
    public class_4817() {
    ...
    protected void run(ServerWorld world, E entity, long time) {
        if (this.method_24591(entity)) {
            ((Entity)entity).startRiding(this.method_24592(entity));
        } else {
    ...
    private boolean method_24591(E livingEntity) {
        return this.method_24592(livingEntity).method_24516((Entity)livingEntity, 1.0);
    }

    private Entity method_24592(E livingEntity) {
        return ((LivingEntity)livingEntity).getBrain().getOptionalMemory(MemoryModuleType.RIDE_TARGET).get();
    }
}
