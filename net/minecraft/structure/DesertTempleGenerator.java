...
extends StructurePieceWithDimensions {
    ...
    public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
        ...
        for (i = 1; i <= 9; ++i) {
            this.fillWithOutline(structureWorldAccess, boundingBox, i, i, i, this.width - 1 - i, i, this.depth - 1 - i, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
            this.fillWithOutline(structureWorldAccess, boundingBox, i + 1, i, i + 1, this.width - 2 - i, i, this.depth - 2 - i, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
        }
        ...
        for (l = 5; l <= 17; l += 2) {
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, l, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, l, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, l, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, l, boundingBox);
        }
        ...
        for (l = 0; l <= this.width - 1; l += this.width - 1) {
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 2, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 2, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 2, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 3, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 3, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 3, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 4, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), l, 4, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 4, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 5, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 5, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 5, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 6, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), l, 6, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 6, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 7, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 7, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 7, 3, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 8, 1, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 8, 2, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 8, 3, boundingBox);
        }
        for (l = 2; l <= this.width - 3; l += this.width - 3 - 2) {
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l - 1, 2, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 2, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l + 1, 2, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l - 1, 3, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 3, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l + 1, 3, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l - 1, 4, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), l, 4, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l + 1, 4, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l - 1, 5, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 5, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l + 1, 5, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l - 1, 6, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), l, 6, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l + 1, 6, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l - 1, 7, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l, 7, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l + 1, 7, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l - 1, 8, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l, 8, 0, boundingBox);
            this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), l + 1, 8, 0, boundingBox);
        }
        ...
        for (Direction direction : Direction.Type.HORIZONTAL) {
            ...
            this.hasPlacedChest[direction.getHorizontal()] = this.addChest(structureWorldAccess, boundingBox, random, 10 + m, -11, 10 + n, LootTables.DESERT_PYRAMID_CHEST);
        }
        return true;
    }
}
