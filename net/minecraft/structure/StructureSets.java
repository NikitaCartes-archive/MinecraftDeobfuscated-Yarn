...
public interface StructureSets {
    ...
    public static final RegistryEntry<StructureSet> PILLAGER_OUTPOSTS = StructureSets.register(StructureSetKeys.PILLAGER_OUTPOSTS, ConfiguredStructureFeatures.PILLAGER_OUTPOST, new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 0.2f, 165745296, Optional.of(new StructurePlacement.class_7152(VILLAGES, 10)), 32, 8, SpreadType.LINEAR));
