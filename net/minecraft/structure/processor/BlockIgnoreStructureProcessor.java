...
extends StructureProcessor {
    public static final Codec<BlockIgnoreStructureProcessor> CODEC = ((MapCodec)BlockState.CODEC.xmap(AbstractBlock.AbstractBlockState::getBlock, Block::getDefaultState).listOf().fieldOf("blocks")).xmap(BlockIgnoreStructureProcessor::new, processor -> processor.blocks).codec();
