...
public class StrongholdGenerator {
    ...
    extends Piece {
        ...
        public static PortalRoom method_14863(List<StructurePiece> list, int i, int j, int k, Direction direction, int l) {
            ...
            if (!PortalRoom.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            int j;
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 10, 7, 15, false, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, Piece.EntranceType.GRATES, 4, 1, 0);
            int i = 6;
            this.fillWithOutline(iWorld, blockBox, 1, i, 1, 1, i, 14, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 9, i, 1, 9, i, 14, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 2, i, 1, 8, i, 2, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 2, i, 14, 8, i, 14, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 1, 1, 1, 2, 1, 4, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 8, 1, 1, 9, 1, 4, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 1, 1, 1, 1, 1, 3, Blocks.LAVA.getDefaultState(), Blocks.LAVA.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 9, 1, 1, 9, 1, 3, Blocks.LAVA.getDefaultState(), Blocks.LAVA.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 3, 1, 8, 7, 1, 12, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 9, 6, 1, 11, Blocks.LAVA.getDefaultState(), Blocks.LAVA.getDefaultState(), false);
            ...
            for (j = 2; j < 9; j += 2) {
                this.fillWithOutline(iWorld, blockBox, j, 3, 15, j, 4, 15, blockState2, blockState2, false);
            }
            BlockState blockState3 = (BlockState)Blocks.STONE_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 5, 6, 1, 7, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 2, 6, 6, 2, 7, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 3, 7, 6, 3, 7, false, random, field_15263);
            for (int k = 4; k <= 6; ++k) {
                this.addBlock(iWorld, blockState3, k, 1, 4, blockBox);
                this.addBlock(iWorld, blockState3, k, 2, 5, blockBox);
                this.addBlock(iWorld, blockState3, k, 3, 6, blockBox);
            }
            ...
            this.addBlock(iWorld, (BlockState)blockState4.with(EndPortalFrameBlock.EYE, bls[0]), 4, 3, 8, blockBox);
            this.addBlock(iWorld, (BlockState)blockState4.with(EndPortalFrameBlock.EYE, bls[1]), 5, 3, 8, blockBox);
            this.addBlock(iWorld, (BlockState)blockState4.with(EndPortalFrameBlock.EYE, bls[2]), 6, 3, 8, blockBox);
            this.addBlock(iWorld, (BlockState)blockState5.with(EndPortalFrameBlock.EYE, bls[3]), 4, 3, 12, blockBox);
            this.addBlock(iWorld, (BlockState)blockState5.with(EndPortalFrameBlock.EYE, bls[4]), 5, 3, 12, blockBox);
            this.addBlock(iWorld, (BlockState)blockState5.with(EndPortalFrameBlock.EYE, bls[5]), 6, 3, 12, blockBox);
            this.addBlock(iWorld, (BlockState)blockState6.with(EndPortalFrameBlock.EYE, bls[6]), 3, 3, 9, blockBox);
            this.addBlock(iWorld, (BlockState)blockState6.with(EndPortalFrameBlock.EYE, bls[7]), 3, 3, 10, blockBox);
            this.addBlock(iWorld, (BlockState)blockState6.with(EndPortalFrameBlock.EYE, bls[8]), 3, 3, 11, blockBox);
            this.addBlock(iWorld, (BlockState)blockState7.with(EndPortalFrameBlock.EYE, bls[9]), 7, 3, 9, blockBox);
            this.addBlock(iWorld, (BlockState)blockState7.with(EndPortalFrameBlock.EYE, bls[10]), 7, 3, 10, blockBox);
            this.addBlock(iWorld, (BlockState)blockState7.with(EndPortalFrameBlock.EYE, bls[11]), 7, 3, 11, blockBox);
            if (bl) {
    ...
    extends Piece {
        ...
        public static FiveWayCrossing method_14858(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!FiveWayCrossing.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 9, 8, 10, true, random, field_15263);
            ...
            this.fillWithOutline(iWorld, blockBox, 1, 2, 1, 8, 2, 6, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 5, 4, 4, 9, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 8, 1, 5, 8, 4, 9, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 1, 4, 7, 3, 4, 9, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 1, 3, 5, 3, 3, 6, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 1, 3, 4, 3, 3, 4, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 1, 4, 6, 3, 4, 6, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 5, 1, 7, 7, 1, 8, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 5, 1, 9, 7, 1, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 5, 2, 7, 7, 2, 7, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 4, 5, 7, 4, 5, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 8, 5, 7, 8, 5, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false);
            this.fillWithOutline(iWorld, blockBox, 5, 5, 7, 7, 5, 9, (BlockState)Blocks.SMOOTH_STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), (BlockState)Blocks.SMOOTH_STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), false);
            this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 6, 5, 6, blockBox);
            return true;
        }
    }
    ...
    extends Piece {
        ...
        public static Library method_14860(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!(Library.method_14871(blockBox) && StructurePiece.method_14932(list, blockBox) == null || Library.method_14871(blockBox = BlockBox.rotated(i, j, k, -4, -1, 0, 14, 6, 15, direction)) && StructurePiece.method_14932(list, blockBox) == null)) {
                return null;
            }
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 13, i - 1, 14, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 4, 1, 0);
            this.fillWithOutlineUnderSealevel(iWorld, blockBox, random, 0.07f, 2, 1, 1, 11, 4, 13, Blocks.COBWEB.getDefaultState(), Blocks.COBWEB.getDefaultState(), false, false);
            boolean j = true;
            int k = 12;
            for (l = 1; l <= 13; ++l) {
                if ((l - 1) % 4 == 0) {
                    this.fillWithOutline(iWorld, blockBox, 1, 1, l, 1, 4, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    this.fillWithOutline(iWorld, blockBox, 12, 1, l, 12, 4, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 2, 3, l, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 11, 3, l, blockBox);
                    if (!this.tall) continue;
                    this.fillWithOutline(iWorld, blockBox, 1, 6, l, 1, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    this.fillWithOutline(iWorld, blockBox, 12, 6, l, 12, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    continue;
                }
                this.fillWithOutline(iWorld, blockBox, 1, 1, l, 1, 4, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 12, 1, l, 12, 4, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                if (!this.tall) continue;
                this.fillWithOutline(iWorld, blockBox, 1, 6, l, 1, 9, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 12, 6, l, 12, 9, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            }
            for (l = 3; l < 12; l += 2) {
                this.fillWithOutline(iWorld, blockBox, 3, 1, l, 4, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 6, 1, l, 7, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 9, 1, l, 10, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            }
            if (this.tall) {
                this.fillWithOutline(iWorld, blockBox, 1, 5, 1, 3, 5, 13, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 10, 5, 1, 12, 5, 13, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 4, 5, 1, 9, 5, 2, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                this.fillWithOutline(iWorld, blockBox, 4, 5, 12, 9, 5, 13, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 9, 5, 11, blockBox);
                this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 8, 5, 11, blockBox);
                this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 9, 5, 10, blockBox);
                ...
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 3, 6, 2, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.EAST, true), 3, 6, 12, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.WEST, true), 10, 6, 2, blockBox);
                for (int m = 0; m <= 2; ++m) {
                    this.addBlock(iWorld, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.WEST, true), 8 + m, 6, 12 - m, blockBox);
                    if (m == 2) continue;
                    this.addBlock(iWorld, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 8 + m, 6, 11 - m, blockBox);
                }
                ...
                this.addBlock(iWorld, (BlockState)blockState4.with(FenceBlock.NORTH, true), 6, 7, 6, blockBox);
                this.addBlock(iWorld, (BlockState)blockState4.with(FenceBlock.SOUTH, true), 6, 7, 8, blockBox);
                this.addBlock(iWorld, (BlockState)blockState5.with(FenceBlock.NORTH, true), 7, 7, 6, blockBox);
                this.addBlock(iWorld, (BlockState)blockState5.with(FenceBlock.SOUTH, true), 7, 7, 8, blockBox);
            ...
            this.addChest(iWorld, blockBox, random, 3, 3, 5, LootTables.STRONGHOLD_LIBRARY_CHEST);
            if (this.tall) {
                this.addBlock(iWorld, AIR, 12, 9, 1, blockBox);
                this.addChest(iWorld, blockBox, random, 12, 8, 1, LootTables.STRONGHOLD_LIBRARY_CHEST);
            }
            return true;
        }
    }
    ...
    extends Piece {
        ...
        public static PrisonHall method_14864(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!PrisonHall.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 8, 4, 10, true, random, field_15263);
            ...
            this.fillWithOutline(iWorld, blockBox, 4, 1, 1, 4, 3, 1, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 3, 4, 3, 3, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 7, 4, 3, 7, false, random, field_15263);
            this.fillWithOutline(iWorld, blockBox, 4, 1, 9, 4, 3, 9, false, random, field_15263);
            for (int i = 1; i <= 3; ++i) {
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 4, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true)).with(PaneBlock.EAST, true), 4, i, 5, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 6, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 5, i, 5, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 6, i, 5, blockBox);
                this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 7, i, 5, blockBox);
            }
            this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 2, blockBox);
            this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 8, blockBox);
    ...
    extends Piece {
        ...
        public static SquareRoom method_14865(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!SquareRoom.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 10, 6, 10, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 4, 1, 0);
            ...
            switch (this.roomType) {
                ...
                case 0: {
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 2, 5, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 3, 5, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 4, 3, 5, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 6, 3, 5, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 5, 3, 4, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.NORTH), 5, 3, 6, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 4, 1, 4, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 4, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 4, 1, 6, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 6, 1, 4, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 6, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 6, 1, 6, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 5, 1, 4, blockBox);
                    this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 5, 1, 6, blockBox);
                    break;
                }
                case 1: {
                    for (int i = 0; i < 5; ++i) {
                        this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 1, 3 + i, blockBox);
                        this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 7, 1, 3 + i, blockBox);
                        this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3 + i, 1, 3, blockBox);
                        this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3 + i, 1, 7, blockBox);
                    }
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 2, 5, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 5, 3, 5, blockBox);
                    this.addBlock(iWorld, Blocks.WATER.getDefaultState(), 5, 4, 5, blockBox);
                    break;
                }
                case 2: {
                    int i;
                    for (i = 1; i <= 9; ++i) {
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 1, 3, i, blockBox);
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 9, 3, i, blockBox);
                    }
                    for (i = 1; i <= 9; ++i) {
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), i, 3, 1, blockBox);
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), i, 3, 9, blockBox);
                    }
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 5, 1, 4, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 5, 1, 6, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 5, 3, 4, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 5, 3, 6, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 4, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 6, 1, 5, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 4, 3, 5, blockBox);
                    this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 6, 3, 5, blockBox);
                    for (i = 1; i <= 3; ++i) {
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 4, i, 4, blockBox);
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 6, i, 4, blockBox);
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 4, i, 6, blockBox);
                        this.addBlock(iWorld, Blocks.COBBLESTONE.getDefaultState(), 6, i, 6, blockBox);
                    }
                    this.addBlock(iWorld, Blocks.TORCH.getDefaultState(), 5, 3, 5, blockBox);
                    for (i = 2; i <= 8; ++i) {
                        this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 2, 3, i, blockBox);
                        this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 3, 3, i, blockBox);
                        if (i <= 3 || i >= 7) {
                            this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 4, 3, i, blockBox);
                            this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 5, 3, i, blockBox);
                            this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 6, 3, i, blockBox);
                        }
                        this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 7, 3, i, blockBox);
                        this.addBlock(iWorld, Blocks.OAK_PLANKS.getDefaultState(), 8, 3, i, blockBox);
                    }
                    ...
                    this.addChest(iWorld, blockBox, random, 3, 4, 8, LootTables.STRONGHOLD_CROSSING_CHEST);
                }
            }
            return true;
        }
    ...
    extends class_3466 {
        ...
        public static RightTurn method_16652(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!RightTurn.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 4, 4, 4, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 1, 1, 0);
            Direction direction = this.getFacing();
            if (direction == Direction.NORTH || direction == Direction.EAST) {
    ...
    extends class_3466 {
        ...
        public static LeftTurn method_14859(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 5, direction);
            if (!LeftTurn.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
    ...
    extends Piece {
        ...
        public static Stairs method_14868(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!Stairs.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 4, 10, 7, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 1, 7, 0);
            this.generateEntrance(iWorld, random, blockBox, Piece.EntranceType.OPENING, 1, 1, 7);
            ...
            for (int i = 0; i < 6; ++i) {
                ...
                if (i >= 5) continue;
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 5 - i, 1 + i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 5 - i, 1 + i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 5 - i, 1 + i, blockBox);
            }
            return true;
        }
    }
    ...
    extends Piece {
        ...
        public static ChestCorridor method_14856(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!ChestCorridor.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 4, 4, 6, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 1, 1, 0);
            this.generateEntrance(iWorld, random, blockBox, Piece.EntranceType.OPENING, 1, 1, 6);
            this.fillWithOutline(iWorld, blockBox, 3, 1, 2, 3, 1, 4, Blocks.STONE_BRICKS.getDefaultState(), Blocks.STONE_BRICKS.getDefaultState(), false);
            this.addBlock(iWorld, Blocks.STONE_BRICK_SLAB.getDefaultState(), 3, 1, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICK_SLAB.getDefaultState(), 3, 1, 5, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICK_SLAB.getDefaultState(), 3, 2, 2, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICK_SLAB.getDefaultState(), 3, 2, 4, blockBox);
            for (int i = 2; i <= 4; ++i) {
                this.addBlock(iWorld, Blocks.STONE_BRICK_SLAB.getDefaultState(), 2, 1, i, blockBox);
            }
            if (!this.chestGenerated && blockBox.contains(new BlockPos(this.applyXTransform(3, 3), this.applyYTransform(2), this.applyZTransform(3, 3)))) {
                ...
                this.addChest(iWorld, blockBox, random, 3, 2, 3, LootTables.STRONGHOLD_CORRIDOR_CHEST);
            }
            return true;
        }
    }
    ...
    extends Piece {
        ...
        public static Corridor method_14867(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            BlockBox blockBox = BlockBox.rotated(i, j, k, -1, -1, 0, 5, 5, 7, direction);
            if (!Corridor.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
    ...
    extends Piece {
        ...
        public static SpiralStaircase method_14866(List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
            ...
            if (!SpiralStaircase.method_14871(blockBox) || StructurePiece.method_14932(list, blockBox) != null) {
                return null;
            }
        ...
        @Override
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            this.fillWithOutline(iWorld, blockBox, 0, 0, 0, 4, 10, 4, true, random, field_15263);
            this.generateEntrance(iWorld, random, blockBox, this.entryDoor, 1, 7, 0);
            this.generateEntrance(iWorld, random, blockBox, Piece.EntranceType.OPENING, 1, 1, 4);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 6, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 5, 1, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 1, 6, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 5, 2, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 4, 3, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 1, 5, 3, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 4, 3, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 3, 3, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 3, 4, 3, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 3, 2, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 2, 1, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 3, 3, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 2, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 1, 1, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 1, 2, 1, blockBox);
            this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 1, 2, blockBox);
            this.addBlock(iWorld, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), 1, 1, 3, blockBox);
            return true;
        }
    }
    ...
    extends Piece {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            for (int i = 0; i < this.length; ++i) {
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 0, 0, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 0, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 0, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 0, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 4, 0, i, blockBox);
                for (int j = 1; j <= 3; ++j) {
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 0, j, i, blockBox);
                    this.addBlock(iWorld, Blocks.CAVE_AIR.getDefaultState(), 1, j, i, blockBox);
                    this.addBlock(iWorld, Blocks.CAVE_AIR.getDefaultState(), 2, j, i, blockBox);
                    this.addBlock(iWorld, Blocks.CAVE_AIR.getDefaultState(), 3, j, i, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 4, j, i, blockBox);
                }
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 0, 4, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 1, 4, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 2, 4, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 3, 4, i, blockBox);
                this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), 4, 4, i, blockBox);
            }
            return true;
        }
    }
    ...
    extends StructurePiece {
        ...
        protected void generateEntrance(IWorld iWorld, Random random, BlockBox blockBox, EntranceType entranceType, int i, int j, int k) {
            switch (entranceType) {
                case OPENING: {
                ...
                case WOOD_DOOR: {
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j + 1, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j + 2, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 1, j + 2, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 2, j + 2, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 2, j + 1, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 2, j, k, blockBox);
                    this.addBlock(iWorld, Blocks.OAK_DOOR.getDefaultState(), i + 1, j, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.OAK_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), i + 1, j + 1, k, blockBox);
                    break;
                }
                case GRATES: {
                    this.addBlock(iWorld, Blocks.CAVE_AIR.getDefaultState(), i + 1, j, k, blockBox);
                    this.addBlock(iWorld, Blocks.CAVE_AIR.getDefaultState(), i + 1, j + 1, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), i, j, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), i, j + 1, k, blockBox);
                    this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), i, j + 2, k, blockBox);
                    this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), i + 1, j + 2, k, blockBox);
                    this.addBlock(iWorld, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), i + 2, j + 2, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), i + 2, j + 1, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), i + 2, j, k, blockBox);
                    break;
                }
                case IRON_DOOR: {
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i, j, k, blockBox);
                    ...
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 2, j + 1, k, blockBox);
                    this.addBlock(iWorld, Blocks.STONE_BRICKS.getDefaultState(), i + 2, j, k, blockBox);
                    this.addBlock(iWorld, Blocks.IRON_DOOR.getDefaultState(), i + 1, j, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.IRON_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), i + 1, j + 1, k, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.NORTH), i + 2, j + 1, k + 1, blockBox);
                    this.addBlock(iWorld, (BlockState)Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.FACING, Direction.SOUTH), i + 2, j + 1, k - 1, blockBox);
                }
            }
        }
