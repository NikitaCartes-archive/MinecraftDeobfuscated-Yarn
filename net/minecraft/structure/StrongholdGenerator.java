...
public class StrongholdGenerator {
    ...
    extends Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 13, i - 1, 14, true, random, STONE_BRICK_RANDOMIZER);
            ...
            for (l = 1; l <= 13; ++l) {
                if ((l - 1) % 4 == 0) {
                    ...
                    this.fillWithOutline(structureWorldAccess, boundingBox, 12, 1, l, 12, 4, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 2, 3, l, boundingBox);
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 11, 3, l, boundingBox);
                    ...
                    this.fillWithOutline(structureWorldAccess, boundingBox, 12, 6, l, 12, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                    continue;
                }
            ...
            for (l = 3; l < 12; l += 2) {
                this.fillWithOutline(structureWorldAccess, boundingBox, 3, 1, l, 4, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(structureWorldAccess, boundingBox, 6, 1, l, 7, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(structureWorldAccess, boundingBox, 9, 1, l, 10, 3, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            }
            if (this.tall) {
                ...
                for (int m = 0; m <= 2; ++m) {
                    this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.WEST, true), 8 + m, 6, 12 - m, boundingBox);
                    if (m == 2) continue;
                    this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 8 + m, 6, 11 - m, boundingBox);
                }
                ...
                this.addBlock(structureWorldAccess, (BlockState)blockState4.with(FenceBlock.NORTH, true), 6, 7, 6, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)blockState4.with(FenceBlock.SOUTH, true), 6, 7, 8, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)blockState5.with(FenceBlock.NORTH, true), 7, 7, 6, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)blockState5.with(FenceBlock.SOUTH, true), 7, 7, 8, boundingBox);
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 8, 4, 10, true, random, STONE_BRICK_RANDOMIZER);
            ...
            this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 1, 4, 3, 1, false, random, STONE_BRICK_RANDOMIZER);
            this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 3, 4, 3, 3, false, random, STONE_BRICK_RANDOMIZER);
            this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 7, 4, 3, 7, false, random, STONE_BRICK_RANDOMIZER);
            this.fillWithOutline(structureWorldAccess, boundingBox, 4, 1, 9, 4, 3, 9, false, random, STONE_BRICK_RANDOMIZER);
            for (int i = 1; i <= 3; ++i) {
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 4, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true)).with(PaneBlock.EAST, true), 4, i, 5, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, i, 6, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 5, i, 5, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 6, i, 5, boundingBox);
                this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 7, i, 5, boundingBox);
            }
            this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 2, boundingBox);
            this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 8, boundingBox);
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            this.fillWithOutline(structureWorldAccess, boundingBox, 0, 0, 0, 10, 6, 10, true, random, STONE_BRICK_RANDOMIZER);
            this.generateEntrance(structureWorldAccess, random, boundingBox, this.entryDoor, 4, 1, 0);
            ...
            switch (this.roomType) {
                ...
                case 0: {
                    ...
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.WEST), 4, 3, 5, boundingBox);
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.EAST), 6, 3, 5, boundingBox);
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.SOUTH), 5, 3, 4, boundingBox);
                    this.addBlock(structureWorldAccess, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.FACING, Direction.NORTH), 5, 3, 6, boundingBox);
                ...
                case 2: {
                    int i;
                    for (i = 1; i <= 9; ++i) {
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 1, 3, i, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 9, 3, i, boundingBox);
                    }
                    for (i = 1; i <= 9; ++i) {
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), i, 3, 1, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), i, 3, 9, boundingBox);
                    }
                    ...
                    for (i = 1; i <= 3; ++i) {
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 4, i, 4, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 6, i, 4, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 4, i, 6, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 6, i, 6, boundingBox);
                    }
                    this.addBlock(structureWorldAccess, Blocks.TORCH.getDefaultState(), 5, 3, 5, boundingBox);
                    for (i = 2; i <= 8; ++i) {
                        this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 2, 3, i, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 3, 3, i, boundingBox);
                        if (i <= 3 || i >= 7) {
                            this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 4, 3, i, boundingBox);
                            this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 5, 3, i, boundingBox);
                            this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 6, 3, i, boundingBox);
                        }
                        this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 7, 3, i, boundingBox);
                        this.addBlock(structureWorldAccess, Blocks.OAK_PLANKS.getDefaultState(), 8, 3, i, boundingBox);
                    }
    ...
    extends Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            this.fillWithOutline(structureWorldAccess, boundingBox, 3, 1, 2, 3, 1, 4, Blocks.STONE_BRICKS.getDefaultState(), Blocks.STONE_BRICKS.getDefaultState(), false);
