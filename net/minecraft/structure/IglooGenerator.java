...
public class IglooGenerator {
    ...
    extends SimpleStructurePiece {
        public Piece(StructureManager manager, Identifier identifier, BlockPos pos, BlockRotation rotation, int yOffset) {
            super(StructurePieceType.IGLOO, 0, manager, identifier, identifier.toString(), Piece.method_35428(rotation, identifier), Piece.method_35430(identifier, pos, yOffset));
        }

        public Piece(ServerWorld world, NbtCompound nbt) {
            super(StructurePieceType.IGLOO, nbt, world, identifier -> Piece.method_35428(BlockRotation.valueOf(nbt.getString("Rot")), identifier));
        }
