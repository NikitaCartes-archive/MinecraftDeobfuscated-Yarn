...
public class StructurePool {
    ...
    public static final Codec<RegistryEntry<StructurePool>> REGISTRY_CODEC = Util.make(RegistryElementCodec.of(Registry.STRUCTURE_POOL_KEY, CODEC), FALLBACK::setValue);
