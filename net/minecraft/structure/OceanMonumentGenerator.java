    ...
    extends Piece {
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            if (this.field_14481 == 0) {
                ...
                i = 10;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(structureWorldAccess, boundingBox, i, 0, 10, i, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(structureWorldAccess, boundingBox, i, 0, 12, i, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(structureWorldAccess, SEA_LANTERN, i, 0, 10, boundingBox);
                    this.addBlock(structureWorldAccess, SEA_LANTERN, i, 0, 12, boundingBox);
                    this.addBlock(structureWorldAccess, SEA_LANTERN, i, 4, 10, boundingBox);
                    this.addBlock(structureWorldAccess, SEA_LANTERN, i, 4, 12, boundingBox);
                    i = 12;
                }
                i = 8;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(structureWorldAccess, boundingBox, i, 0, 7, i, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(structureWorldAccess, boundingBox, i, 0, 14, i, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    i = 14;
                }
        ...
        public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
            ...
            for (i = 1; i <= 6; ++i) {
                ...
                for (int j = 0; j <= 15; j += 15) {
                    this.fillWithOutline(structureWorldAccess, boundingBox, j, i, 0, j, i, 1, blockState, blockState, false);
                    this.fillWithOutline(structureWorldAccess, boundingBox, j, i, 6, j, i, 9, blockState, blockState, false);
                    this.fillWithOutline(structureWorldAccess, boundingBox, j, i, 14, j, i, 15, blockState, blockState, false);
                }
                this.fillWithOutline(structureWorldAccess, boundingBox, 1, i, 0, 1, i, 0, blockState, blockState, false);
                this.fillWithOutline(structureWorldAccess, boundingBox, 6, i, 0, 9, i, 0, blockState, blockState, false);
                this.fillWithOutline(structureWorldAccess, boundingBox, 14, i, 0, 14, i, 0, blockState, blockState, false);
                this.fillWithOutline(structureWorldAccess, boundingBox, 1, i, 15, 14, i, 15, blockState, blockState, false);
            }
            ...
            for (i = 3; i <= 6; i += 3) {
                for (int k = 6; k <= 9; k += 3) {
                    this.addBlock(structureWorldAccess, SEA_LANTERN, k, i, 6, boundingBox);
                    this.addBlock(structureWorldAccess, SEA_LANTERN, k, i, 9, boundingBox);
                }
            }
    ...
    extends StructurePiece {
        ...
        protected void method_14771(StructureWorldAccess structureWorldAccess, BlockBox blockBox, int i, int j, int k, int l, int m, int n, BlockState blockState) {
            for (int o = j; o <= m; ++o) {
                for (int p = i; p <= l; ++p) {
                    for (int q = k; q <= n; ++q) {
                        if (this.getBlockAt(structureWorldAccess, p, o, q, blockBox) != WATER) continue;
