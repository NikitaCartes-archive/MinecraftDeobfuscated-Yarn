...
public class OceanMonumentGenerator {
    ...
    implements class_3375 {
        ...
        @Override
        public class_3384 method_14768(Direction direction, class_3388 arg, Random random) {
    ...
    static interface class_3375 {
        ...
        public class_3384 method_14768(Direction var1, class_3388 var2, Random var3);
    }
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
            if (this.field_14481 == 0) {
                ...
                i = 10;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, i, 0, 10, i, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, i, 0, 12, i, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(iWorld, SEA_LANTERN, i, 0, 10, mutableIntBoundingBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 0, 12, mutableIntBoundingBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 4, 10, mutableIntBoundingBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 4, 12, mutableIntBoundingBox);
                    i = 12;
                }
                i = 8;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, i, 0, 7, i, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, i, 0, 14, i, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    i = 14;
                }
        ...
        public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
            ...
            for (i = 1; i <= 6; ++i) {
                ...
                for (int j = 0; j <= 15; j += 15) {
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, j, i, 0, j, i, 1, blockState, blockState, false);
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, j, i, 6, j, i, 9, blockState, blockState, false);
                    this.fillWithOutline(iWorld, mutableIntBoundingBox, j, i, 14, j, i, 15, blockState, blockState, false);
                }
                this.fillWithOutline(iWorld, mutableIntBoundingBox, 1, i, 0, 1, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, mutableIntBoundingBox, 6, i, 0, 9, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, mutableIntBoundingBox, 14, i, 0, 14, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, mutableIntBoundingBox, 1, i, 15, 14, i, 15, blockState, blockState, false);
            }
            ...
            for (i = 3; i <= 6; i += 3) {
                for (int k = 6; k <= 9; k += 3) {
                    this.addBlock(iWorld, SEA_LANTERN, k, i, 6, mutableIntBoundingBox);
                    this.addBlock(iWorld, SEA_LANTERN, k, i, 9, mutableIntBoundingBox);
                }
            }
    ...
    extends class_3384 {
        ...
        private final List<class_3384> field_14465 = Lists.newArrayList();
        ...
        public Base(Random random, int i, int j, Direction direction) {
            ...
            this.boundingBox = direction2.getAxis() == Direction.Axis.Z ? new MutableIntBoundingBox(i, 39, j, i + 58 - 1, 61, j + 58 - 1) : new MutableIntBoundingBox(i, 39, j, i + 58 - 1, 61, j + 58 - 1);
            ...
            ArrayList<class_3375> list2 = Lists.newArrayList();
            ...
            block0: for (class_3388 lv : list) {
                ...
                for (class_3375 class_33752 : list2) {
                    if (!class_33752.method_14769(lv)) continue;
                    this.field_14465.add(class_33752.method_14768(direction2, lv, random));
                    continue block0;
                }
            }
            ...
            for (class_3384 lv3 : this.field_14465) {
                lv3.getBoundingBox().translate(l, k, m);
            }
            MutableIntBoundingBox mutableIntBoundingBox = MutableIntBoundingBox.create(this.applyXTransform(1, 1), this.applyYTransform(1), this.applyZTransform(1, 1), this.applyXTransform(23, 21), this.applyYTransform(8), this.applyZTransform(23, 21));
            MutableIntBoundingBox mutableIntBoundingBox2 = MutableIntBoundingBox.create(this.applyXTransform(34, 1), this.applyYTransform(1), this.applyZTransform(34, 1), this.applyXTransform(56, 21), this.applyYTransform(8), this.applyZTransform(56, 21));
            MutableIntBoundingBox mutableIntBoundingBox3 = MutableIntBoundingBox.create(this.applyXTransform(22, 22), this.applyYTransform(13), this.applyZTransform(22, 22), this.applyXTransform(35, 35), this.applyYTransform(17), this.applyZTransform(35, 35));
            int n = random.nextInt();
            this.field_14465.add(new WingRoom(direction2, mutableIntBoundingBox, n++));
            this.field_14465.add(new WingRoom(direction2, mutableIntBoundingBox2, n++));
            this.field_14465.add(new Penthouse(direction2, mutableIntBoundingBox3));
        }
        ...
        private List<class_3388> method_14760(Random random) {
            ...
            ArrayList<class_3388> list = Lists.newArrayList();
        ...
        public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
            ...
            for (class_3384 lv : this.field_14465) {
                if (!lv.getBoundingBox().intersects(mutableIntBoundingBox)) continue;
    ...
    public static abstract class class_3384
    extends StructurePiece {
        ...
        protected static final int field_14469 = class_3384.method_14770(2, 0, 0);
        protected static final int field_14468 = class_3384.method_14770(2, 2, 0);
        protected static final int field_14478 = class_3384.method_14770(0, 1, 0);
        protected static final int field_14477 = class_3384.method_14770(4, 1, 0);
        ...
        protected class_3384(StructurePieceType structurePieceType, int i, Direction direction, class_3388 arg, int j, int k, int l) {
            super(structurePieceType, i);
            this.setOrientation(direction);
            ...
            int o = m / 5 % 5;
            int p = m / 25;
            this.boundingBox = direction == Direction.NORTH || direction == Direction.SOUTH ? new MutableIntBoundingBox(0, 0, 0, j * 8 - 1, k * 4 - 1, l * 8 - 1) : new MutableIntBoundingBox(0, 0, 0, l * 8 - 1, k * 4 - 1, j * 8 - 1);
            switch (direction) {
                case NORTH: {
        ...
        protected void method_14771(IWorld iWorld, MutableIntBoundingBox mutableIntBoundingBox, int i, int j, int k, int l, int m, int n, BlockState blockState) {
            for (int o = j; o <= m; ++o) {
                for (int p = i; p <= l; ++p) {
                    for (int q = k; q <= n; ++q) {
                        if (this.getBlockAt(iWorld, p, o, q, mutableIntBoundingBox) != WATER) continue;
        ...
        protected boolean method_14772(IWorld iWorld, MutableIntBoundingBox mutableIntBoundingBox, int i, int j, int k) {
            ...
            if (mutableIntBoundingBox.contains(new BlockPos(l, m = this.applyYTransform(j), n = this.applyZTransform(i, k)))) {
                ...
                elderGuardianEntity.setPositionAndAngles((double)l + 0.5, m, (double)n + 0.5, 0.0f, 0.0f);
