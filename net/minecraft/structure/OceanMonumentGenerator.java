...
public class OceanMonumentGenerator {
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            this.method_14773(iWorld, blockBox, 6, -1, 3, 7, -1, 4);
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            if (this.field_14481 == 0) {
                ...
                i = 10;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(iWorld, blockBox, i, 0, 10, i, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(iWorld, blockBox, i, 0, 12, i, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(iWorld, SEA_LANTERN, i, 0, 10, blockBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 0, 12, blockBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 4, 10, blockBox);
                    this.addBlock(iWorld, SEA_LANTERN, i, 4, 12, blockBox);
                    i = 12;
                }
                i = 8;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(iWorld, blockBox, i, 0, 7, i, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(iWorld, blockBox, i, 0, 14, i, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    i = 14;
                }
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            for (i = 1; i <= 6; ++i) {
                ...
                for (int j = 0; j <= 15; j += 15) {
                    this.fillWithOutline(iWorld, blockBox, j, i, 0, j, i, 1, blockState, blockState, false);
                    this.fillWithOutline(iWorld, blockBox, j, i, 6, j, i, 9, blockState, blockState, false);
                    this.fillWithOutline(iWorld, blockBox, j, i, 14, j, i, 15, blockState, blockState, false);
                }
                this.fillWithOutline(iWorld, blockBox, 1, i, 0, 1, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, blockBox, 6, i, 0, 9, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, blockBox, 14, i, 0, 14, i, 0, blockState, blockState, false);
                this.fillWithOutline(iWorld, blockBox, 1, i, 15, 14, i, 15, blockState, blockState, false);
            }
            ...
            for (i = 3; i <= 6; i += 3) {
                for (int k = 6; k <= 9; k += 3) {
                    this.addBlock(iWorld, SEA_LANTERN, k, i, 6, blockBox);
                    this.addBlock(iWorld, SEA_LANTERN, k, i, 9, blockBox);
                }
            }
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            if (lv2.field_14482[Direction.SOUTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 1, 0, 4, 2, 0);
            }
            if (lv2.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 7, 1, 3, 7, 2, 4);
            }
            if (lv2.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 1, 3, 0, 2, 4);
            }
            if (lv.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 1, 15, 4, 2, 15);
            }
            if (lv.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 1, 11, 0, 2, 12);
            }
            if (lv.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 7, 1, 11, 7, 2, 12);
            }
            if (lv4.field_14482[Direction.SOUTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 5, 0, 4, 6, 0);
            }
            if (lv4.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 7, 5, 3, 7, 6, 4);
            ...
            if (lv4.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 5, 3, 0, 6, 4);
            ...
            if (lv3.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 5, 15, 4, 6, 15);
            }
            if (lv3.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 5, 11, 0, 6, 12);
            ...
            if (lv3.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 7, 5, 11, 7, 6, 12);
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            if (lv2.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 1, 7, 4, 2, 7);
            }
            if (lv2.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 1, 3, 0, 2, 4);
            }
            if (lv.field_14482[Direction.SOUTH.getId()]) {
                this.method_14773(iWorld, blockBox, 11, 1, 0, 12, 2, 0);
            }
            if (lv.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 11, 1, 7, 12, 2, 7);
            }
            if (lv.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 15, 1, 3, 15, 2, 4);
            }
            if (lv3.field_14482[Direction.SOUTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 5, 0, 4, 6, 0);
            }
            if (lv3.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 3, 5, 7, 4, 6, 7);
            }
            if (lv3.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 5, 3, 0, 6, 4);
            }
            if (lv4.field_14482[Direction.SOUTH.getId()]) {
                this.method_14773(iWorld, blockBox, 11, 5, 0, 12, 6, 0);
            }
            if (lv4.field_14482[Direction.NORTH.getId()]) {
                this.method_14773(iWorld, blockBox, 11, 5, 7, 12, 6, 7);
            }
            if (lv4.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 15, 5, 3, 15, 6, 4);
            }
            return true;
        }
    }
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            if (this.field_14479.field_14482[Direction.WEST.getId()]) {
                this.method_14773(iWorld, blockBox, 0, 1, 3, 1, 2, 4);
            }
            if (this.field_14479.field_14482[Direction.EAST.getId()]) {
                this.method_14773(iWorld, blockBox, 6, 1, 3, 7, 2, 4);
            }
            return true;
        }
    }
    ...
    extends class_3384 {
        ...
        public boolean generate(IWorld iWorld, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            this.method_14773(iWorld, blockBox, 0, 0, 0, 58, i, 58);
            ...
            for (j = 0; j < 5; ++j) {
                this.method_14773(iWorld, blockBox, -1 - j, 0 + j * 2, -1 - j, -1 - j, 23, 58 + j);
                this.method_14773(iWorld, blockBox, 58 + j, 0 + j * 2, -1 - j, 58 + j, 23, 58 + j);
                this.method_14773(iWorld, blockBox, 0 - j, 0 + j * 2, -1 - j, 57 + j, 23, -1 - j);
                this.method_14773(iWorld, blockBox, 0 - j, 0 + j * 2, 58 + j, 57 + j, 23, 58 + j);
            }
            for (class_3384 lv : this.field_14465) {
                if (!lv.getBoundingBox().intersects(blockBox)) continue;
                lv.generate(iWorld, random, blockBox, chunkPos);
            }
            return true;
        }
