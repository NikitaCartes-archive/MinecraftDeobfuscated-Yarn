    ...
    extends Piece {
        ...
        public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            if (this.field_14481 == 0) {
                ...
                i = 10;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(world, blockBox, i, 0, 10, i, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, blockBox, i, 0, 12, i, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(world, SEA_LANTERN, i, 0, 10, blockBox);
                    this.addBlock(world, SEA_LANTERN, i, 0, 12, blockBox);
                    this.addBlock(world, SEA_LANTERN, i, 4, 10, blockBox);
                    this.addBlock(world, SEA_LANTERN, i, 4, 12, blockBox);
                    i = 12;
                }
                i = 8;
                for (l = 0; l < 2; ++l) {
                    this.fillWithOutline(world, blockBox, i, 0, 7, i, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, blockBox, i, 0, 14, i, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    i = 14;
                }
        ...
        public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
            ...
            for (i = 1; i <= 6; ++i) {
                ...
                for (int j = 0; j <= 15; j += 15) {
                    this.fillWithOutline(world, blockBox, j, i, 0, j, i, 1, blockState, blockState, false);
                    this.fillWithOutline(world, blockBox, j, i, 6, j, i, 9, blockState, blockState, false);
                    this.fillWithOutline(world, blockBox, j, i, 14, j, i, 15, blockState, blockState, false);
                }
                this.fillWithOutline(world, blockBox, 1, i, 0, 1, i, 0, blockState, blockState, false);
                this.fillWithOutline(world, blockBox, 6, i, 0, 9, i, 0, blockState, blockState, false);
                this.fillWithOutline(world, blockBox, 14, i, 0, 14, i, 0, blockState, blockState, false);
                this.fillWithOutline(world, blockBox, 1, i, 15, 14, i, 15, blockState, blockState, false);
            }
            ...
            for (i = 3; i <= 6; i += 3) {
                for (int k = 6; k <= 9; k += 3) {
                    this.addBlock(world, SEA_LANTERN, k, i, 6, blockBox);
                    this.addBlock(world, SEA_LANTERN, k, i, 9, blockBox);
                }
            }
