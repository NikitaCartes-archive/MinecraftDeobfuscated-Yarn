...
extends PosRuleTest {
    public static final Codec<AxisAlignedLinearPosRuleTest> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.FLOAT.fieldOf("min_chance")).withDefault(Float.valueOf(0.0f)).forGetter(axisAlignedLinearPosRuleTest -> Float.valueOf(axisAlignedLinearPosRuleTest.minChance)), ((MapCodec)Codec.FLOAT.fieldOf("max_chance")).withDefault(Float.valueOf(0.0f)).forGetter(axisAlignedLinearPosRuleTest -> Float.valueOf(axisAlignedLinearPosRuleTest.maxChance)), ((MapCodec)Codec.INT.fieldOf("min_dist")).withDefault(0).forGetter(axisAlignedLinearPosRuleTest -> axisAlignedLinearPosRuleTest.minDistance), ((MapCodec)Codec.INT.fieldOf("max_dist")).withDefault(0).forGetter(axisAlignedLinearPosRuleTest -> axisAlignedLinearPosRuleTest.maxDistance), ((MapCodec)Direction.Axis.field_25065.fieldOf("axis")).withDefault(Direction.Axis.Y).forGetter(axisAlignedLinearPosRuleTest -> axisAlignedLinearPosRuleTest.axis)).apply((Applicative<AxisAlignedLinearPosRuleTest, ?>)instance, AxisAlignedLinearPosRuleTest::new));
