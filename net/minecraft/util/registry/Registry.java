...
implements IndexedIterable<T> {
    ...
    public static final Registry<class_4652<?>> BLOCK_STATE_PROVIDER_TYPE = Registry.create("block_state_provider_type", () -> class_4652.SIMPLE_STATE_PROVIDER);
    public static final Registry<class_4630<?>> BLOCK_PLACER_TYPE = Registry.create("block_placer_type", () -> class_4630.SIMPLE_BLOCK_PLACER);
    public static final Registry<class_4648<?>> FOLIAGE_PLACER_TYPE = Registry.create("foliage_placer_type", () -> class_4648.BLOB_FOLIAGE_PLACER);
