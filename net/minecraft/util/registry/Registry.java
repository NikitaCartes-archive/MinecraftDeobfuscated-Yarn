...
IndexedIterable<T> {
    ...
    public static final RegistryKey<Registry<PaintingVariant>> PAINTING_VARIANT_KEY = Registry.createRegistryKey("painting_variant");
    ...
    public static final RegistryKey<Registry<ArgumentSerializer<?, ?>>> COMMAND_ARGUMENT_TYPE_KEY = Registry.createRegistryKey("command_argument_type");
    ...
    public static final DefaultedRegistry<PaintingVariant> PAINTING_VARIANT = Registry.create(PAINTING_VARIANT_KEY, "kebab", PaintingVariants::registerAndGetDefault);
    ...
    public static final Registry<ArgumentSerializer<?, ?>> COMMAND_ARGUMENT_TYPE = Registry.create(COMMAND_ARGUMENT_TYPE_KEY, ArgumentTypes::register);
    ...
    public static final RegistryKey<Registry<Structure>> STRUCTURE_KEY = Registry.createRegistryKey("worldgen/structure");
    ...
    public static final RegistryKey<Registry<StructureType<?>>> STRUCTURE_TYPE_KEY = Registry.createRegistryKey("worldgen/structure_type");
    public static final Registry<StructureType<?>> STRUCTURE_TYPE = Registry.create(STRUCTURE_TYPE_KEY, registry -> StructureType.JIGSAW);
    ...
    public static final RegistryKey<Registry<Codec<? extends DensityFunction>>> DENSITY_FUNCTION_TYPE_KEY = Registry.createRegistryKey("worldgen/density_function_type");
    ...
    public static final Registry<Codec<? extends BiomeSource>> BIOME_SOURCE = Registry.create(BIOME_SOURCE_KEY, Lifecycle.stable(), BiomeSources::registerAndGetDefault);
    public static final Registry<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR = Registry.create(CHUNK_GENERATOR_KEY, Lifecycle.stable(), ChunkGenerators::registerAndGetDefault);
