...
IndexedIterable<T> {
    ...
    public static final RegistryKey<Registry<class_7059>> STRUCTURE_SET_WORLDGEN = Registry.createRegistryKey("worldgen/structure_set");
    ...
    public static final RegistryKey<Registry<NoiseType>> DENSITY_FUNCTION_WORLDGEN = Registry.createRegistryKey("worldgen/density_function");
    ...
    public static final RegistryKey<Registry<Codec<? extends NoiseType>>> DENSITY_FUNCTION_TYPE_WORLDGEN = Registry.createRegistryKey("worldgen/density_function_type");
    ...
    public static final Registry<Codec<? extends NoiseType>> field_37230 = Registry.create(DENSITY_FUNCTION_TYPE_WORLDGEN, class_6916::method_41066);
