...
public class BuiltinRegistries {
    ...
    public static final Registry<ChunkGeneratorSettings> CHUNK_GENERATOR_SETTINGS = BuiltinRegistries.addRegistry(Registry.NOISE_SETTINGS_WORLDGEN, () -> ChunkGeneratorSettings.OVERWORLD);
    ...
    private static <T, R extends MutableRegistry<T>> R addRegistry(RegistryKey<? extends Registry<T>> registryRef, R registry, Supplier<T> defaultValueSupplier) {
        ...
        return mutableRegistry.add(registryRef, registry);
    }
