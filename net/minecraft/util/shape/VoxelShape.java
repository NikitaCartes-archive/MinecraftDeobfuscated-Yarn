...
public abstract class VoxelShape {
    ...
    public VoxelShape simplify() {
        ...
        this.forEachBox((xMin, yMin, zMin, xMax, yMax, zMax) -> {
            voxelShapes[0] = VoxelShapes.combine(voxelShapes[0], VoxelShapes.cuboid(xMin, yMin, zMin, xMax, yMax, zMax), BooleanBiFunction.OR);
        });
