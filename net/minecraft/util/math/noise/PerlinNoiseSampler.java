...
public final class PerlinNoiseSampler {
    ...
    public double method_16450(int i, int j, int k, double d, double e, double f, double g, double h, double l) {
        ...
        double s = PerlinNoiseSampler.method_16448(this.method_16449(n), d, e, f);
        double t = PerlinNoiseSampler.method_16448(this.method_16449(q), d - 1.0, e, f);
        double u = PerlinNoiseSampler.method_16448(this.method_16449(o), d, e - 1.0, f);
        double v = PerlinNoiseSampler.method_16448(this.method_16449(r), d - 1.0, e - 1.0, f);
        double w = PerlinNoiseSampler.method_16448(this.method_16449(n + 1), d, e, f - 1.0);
        double x = PerlinNoiseSampler.method_16448(this.method_16449(q + 1), d - 1.0, e, f - 1.0);
        double y = PerlinNoiseSampler.method_16448(this.method_16449(o + 1), d, e - 1.0, f - 1.0);
        double z = PerlinNoiseSampler.method_16448(this.method_16449(r + 1), d - 1.0, e - 1.0, f - 1.0);
