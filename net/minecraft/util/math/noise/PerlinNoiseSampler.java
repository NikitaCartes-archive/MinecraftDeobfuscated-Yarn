...
public final class PerlinNoiseSampler {
    ...
    private double sample(int sectionX, int sectionY, int sectionZ, double localX, double localY, double localZ, double fadeLocalY) {
        ...
        double d = PerlinNoiseSampler.grad(this.map(k + sectionZ), localX, localY, localZ);
        double e = PerlinNoiseSampler.grad(this.map(m + sectionZ), localX - 1.0, localY, localZ);
        double f = PerlinNoiseSampler.grad(this.map(l + sectionZ), localX, localY - 1.0, localZ);
        double g = PerlinNoiseSampler.grad(this.map(n + sectionZ), localX - 1.0, localY - 1.0, localZ);
        double h = PerlinNoiseSampler.grad(this.map(k + sectionZ + 1), localX, localY, localZ - 1.0);
        double o = PerlinNoiseSampler.grad(this.map(m + sectionZ + 1), localX - 1.0, localY, localZ - 1.0);
        double p = PerlinNoiseSampler.grad(this.map(l + sectionZ + 1), localX, localY - 1.0, localZ - 1.0);
        double q = PerlinNoiseSampler.grad(this.map(n + sectionZ + 1), localX - 1.0, localY - 1.0, localZ - 1.0);
