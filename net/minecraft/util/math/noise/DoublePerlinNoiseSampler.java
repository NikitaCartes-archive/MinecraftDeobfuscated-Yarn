...
public class DoublePerlinNoiseSampler {
    ...
    @Deprecated
    public static DoublePerlinNoiseSampler method_39123(AbstractRandom abstractRandom, NoiseParameters noiseParameters) {
        return DoublePerlinNoiseSampler.method_39121(abstractRandom, noiseParameters.getFirstOctave(), noiseParameters.getAmplitudes());
    }
    ...
    public NoiseParameters method_38475() {
        return new NoiseParameters(this.firstSampler.method_38477(), this.firstSampler.method_38478());
    }
