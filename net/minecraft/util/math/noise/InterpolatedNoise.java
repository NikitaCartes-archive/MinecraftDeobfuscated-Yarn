...
public class InterpolatedNoise {
    ...
    public InterpolatedNoise(OctavePerlinNoiseSampler lowerInterpolatedNoise, OctavePerlinNoiseSampler upperInterpolatedNoise, OctavePerlinNoiseSampler interpolationNoise) {
