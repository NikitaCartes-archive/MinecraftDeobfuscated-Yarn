...
public class class_4341 {
    ...
    private static final Logger field_19578;
    private final String field_19579;
    private final String field_19580;
    private static final Gson field_19581;
    ...
    public class_4342 method_21027() throws class_4355, IOException {
        class_4342 lv;
        String string = this.method_21011("mco/client/compatible");
        String string2 = this.method_20998(class_4346.method_21040(string));
        try {
            lv = class_4342.valueOf(string2);
    ...
    public WorldDownload method_21003(long l, int i) throws class_4355 {
        String string = this.method_21011("worlds" + "/$WORLD_ID/slot/$SLOT_ID/download".replace("$WORLD_ID", String.valueOf(l)).replace("$SLOT_ID", String.valueOf(i)));
        String string2 = this.method_20998(class_4346.method_21040(string));
    ...
    private String method_21007(String string, String string2) {
        try {
            URI uRI = new URI(class_4341.field_19576.field_19590, class_4341.field_19576.field_19589, "/" + string, string2, null);
    ...
    private String method_20998(class_4346<?> arg) throws class_4355 {
        ...
        try {
            ...
            return string;
        } catch (class_4354 lv2) {
            throw new class_4355(500, "Could not connect to Realms: " + lv2.getMessage(), -1, "");
        }
    }

    static {
        field_19578 = LogManager.getLogger();
        field_19581 = new Gson();
    }
