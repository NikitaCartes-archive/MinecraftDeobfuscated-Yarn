...
extends RealmsScreen {
    ...
    @Override
    public void init() {
        Realms.narrateNow(class_4400.getLocalizedString("mco.account.privacyinfo"));
        String string = class_4400.getLocalizedString("mco.account.update");
        String string2 = class_4400.getLocalizedString("gui.back");
        int i = Math.max(this.fontWidth(string), this.fontWidth(string2)) + 30;
        String string3 = class_4400.getLocalizedString("mco.account.privacy.info");
