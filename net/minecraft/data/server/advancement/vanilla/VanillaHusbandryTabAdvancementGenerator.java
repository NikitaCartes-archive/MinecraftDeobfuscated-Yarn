...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<Advancement> exporter) {
        ...
        VanillaHusbandryTabAdvancementGenerator.createBreedAllAnimalsAdvancement(advancement3, exporter, BREEDABLE_ANIMALS.stream(), EGG_LAYING_ANIMALS.stream());
    ...
    public static Advancement createBreedAllAnimalsAdvancement(Advancement parent, Consumer<Advancement> exporter, Stream<EntityType<?>> breedableAnimals, Stream<EntityType<?>> eggLayingAnimals) {
    ...
    private static Advancement.Builder requireListedAnimalsBred(Advancement.Builder advancementBuilder, Stream<EntityType<?>> breedableAnimals, Stream<EntityType<?>> eggLayingAnimals) {
        ...
        eggLayingAnimals.forEach(type -> advancementBuilder.criterion(EntityType.getId(type).toString(), BredAnimalsCriterion.Conditions.create(EntityPredicate.Builder.create().type((EntityType<?>)type).build(), EntityPredicate.Builder.create().type((EntityType<?>)type).build(), EntityPredicate.ANY)));
