...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<Advancement> exporter) {
        ...
        Advancement advancement4 = Advancement.Builder.create().parent(advancement3).display(Items.IRON_INGOT, (Text)Text.translatable("advancements.story.smelt_iron.title"), (Text)Text.translatable("advancements.story.smelt_iron.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron", InventoryChangedCriterion.Conditions.items(Items.IRON_INGOT)).build(exporter, "story/smelt_iron");
        Advancement advancement5 = Advancement.Builder.create().parent(advancement4).display(Items.IRON_PICKAXE, (Text)Text.translatable("advancements.story.iron_tools.title"), (Text)Text.translatable("advancements.story.iron_tools.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron_pickaxe", InventoryChangedCriterion.Conditions.items(Items.IRON_PICKAXE)).build(exporter, "story/iron_tools");
        Advancement advancement6 = Advancement.Builder.create().parent(advancement5).display(Items.DIAMOND, (Text)Text.translatable("advancements.story.mine_diamond.title"), (Text)Text.translatable("advancements.story.mine_diamond.description"), null, AdvancementFrame.TASK, true, true, false).criterion("diamond", InventoryChangedCriterion.Conditions.items(Items.DIAMOND)).build(exporter, "story/mine_diamond");
        Advancement advancement7 = Advancement.Builder.create().parent(advancement4).display(Items.LAVA_BUCKET, (Text)Text.translatable("advancements.story.lava_bucket.title"), (Text)Text.translatable("advancements.story.lava_bucket.description"), null, AdvancementFrame.TASK, true, true, false).criterion("lava_bucket", InventoryChangedCriterion.Conditions.items(Items.LAVA_BUCKET)).build(exporter, "story/lava_bucket");
        Advancement advancement8 = Advancement.Builder.create().parent(advancement4).display(Items.IRON_CHESTPLATE, (Text)Text.translatable("advancements.story.obtain_armor.title"), (Text)Text.translatable("advancements.story.obtain_armor.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("iron_helmet", InventoryChangedCriterion.Conditions.items(Items.IRON_HELMET)).criterion("iron_chestplate", InventoryChangedCriterion.Conditions.items(Items.IRON_CHESTPLATE)).criterion("iron_leggings", InventoryChangedCriterion.Conditions.items(Items.IRON_LEGGINGS)).criterion("iron_boots", InventoryChangedCriterion.Conditions.items(Items.IRON_BOOTS)).build(exporter, "story/obtain_armor");
        Advancement.Builder.create().parent(advancement6).display(Items.ENCHANTED_BOOK, (Text)Text.translatable("advancements.story.enchant_item.title"), (Text)Text.translatable("advancements.story.enchant_item.description"), null, AdvancementFrame.TASK, true, true, false).criterion("enchanted_item", EnchantedItemCriterion.Conditions.any()).build(exporter, "story/enchant_item");
        Advancement advancement9 = Advancement.Builder.create().parent(advancement7).display(Blocks.OBSIDIAN, (Text)Text.translatable("advancements.story.form_obsidian.title"), (Text)Text.translatable("advancements.story.form_obsidian.description"), null, AdvancementFrame.TASK, true, true, false).criterion("obsidian", InventoryChangedCriterion.Conditions.items(Blocks.OBSIDIAN)).build(exporter, "story/form_obsidian");
        Advancement.Builder.create().parent(advancement8).display(Items.SHIELD, (Text)Text.translatable("advancements.story.deflect_arrow.title"), (Text)Text.translatable("advancements.story.deflect_arrow.description"), null, AdvancementFrame.TASK, true, true, false).criterion("deflected_projectile", EntityHurtPlayerCriterion.Conditions.create(DamagePredicate.Builder.create().type(DamageSourcePredicate.Builder.create().projectile(true)).blocked(true))).build(exporter, "story/deflect_arrow");
        ...
        Advancement advancement10 = Advancement.Builder.create().parent(advancement9).display(Items.FLINT_AND_STEEL, (Text)Text.translatable("advancements.story.enter_the_nether.title"), (Text)Text.translatable("advancements.story.enter_the_nether.description"), null, AdvancementFrame.TASK, true, true, false).criterion("entered_nether", ChangedDimensionCriterion.Conditions.to(World.NETHER)).build(exporter, "story/enter_the_nether");
        ...
        Advancement advancement11 = Advancement.Builder.create().parent(advancement10).display(Items.ENDER_EYE, (Text)Text.translatable("advancements.story.follow_ender_eye.title"), (Text)Text.translatable("advancements.story.follow_ender_eye.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_stronghold", TickCriterion.Conditions.createLocation(LocationPredicate.feature(StructureKeys.STRONGHOLD))).build(exporter, "story/follow_ender_eye");
