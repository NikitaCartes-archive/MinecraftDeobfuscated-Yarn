...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<Advancement> exporter) {
        ...
        Advancement.Builder.create().parent(advancement2).display(Blocks.DRAGON_EGG, (Text)Text.translatable("advancements.end.dragon_egg.title"), (Text)Text.translatable("advancements.end.dragon_egg.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("dragon_egg", InventoryChangedCriterion.Conditions.items(Blocks.DRAGON_EGG)).build(exporter, "end/dragon_egg");
    }
}
