...
implements Consumer<Consumer<Advancement>> {
    private static final List<RegistryKey<Biome>> BIOMES = ImmutableList.of(BuiltInBiomes.BIRCH_FOREST_HILLS, BuiltInBiomes.RIVER, BuiltInBiomes.SWAMP, BuiltInBiomes.DESERT, BuiltInBiomes.WOODED_HILLS, BuiltInBiomes.GIANT_TREE_TAIGA_HILLS, BuiltInBiomes.SNOWY_TAIGA, BuiltInBiomes.BADLANDS, BuiltInBiomes.FOREST, BuiltInBiomes.STONE_SHORE, BuiltInBiomes.SNOWY_TUNDRA, BuiltInBiomes.TAIGA_HILLS, new RegistryKey[]{BuiltInBiomes.SNOWY_MOUNTAINS, BuiltInBiomes.WOODED_BADLANDS_PLATEAU, BuiltInBiomes.SAVANNA, BuiltInBiomes.PLAINS, BuiltInBiomes.FROZEN_RIVER, BuiltInBiomes.GIANT_TREE_TAIGA, BuiltInBiomes.SNOWY_BEACH, BuiltInBiomes.JUNGLE_HILLS, BuiltInBiomes.JUNGLE_EDGE, BuiltInBiomes.MUSHROOM_FIELD_SHORE, BuiltInBiomes.MOUNTAINS, BuiltInBiomes.DESERT_HILLS, BuiltInBiomes.JUNGLE, BuiltInBiomes.BEACH, BuiltInBiomes.SAVANNA_PLATEAU, BuiltInBiomes.SNOWY_TAIGA_HILLS, BuiltInBiomes.BADLANDS_PLATEAU, BuiltInBiomes.DARK_FOREST, BuiltInBiomes.TAIGA, BuiltInBiomes.BIRCH_FOREST, BuiltInBiomes.MUSHROOM_FIELDS, BuiltInBiomes.WOODED_MOUNTAINS, BuiltInBiomes.WARM_OCEAN, BuiltInBiomes.LUKEWARM_OCEAN, BuiltInBiomes.COLD_OCEAN, BuiltInBiomes.DEEP_LUKEWARM_OCEAN, BuiltInBiomes.DEEP_COLD_OCEAN, BuiltInBiomes.DEEP_FROZEN_OCEAN, BuiltInBiomes.BAMBOO_JUNGLE, BuiltInBiomes.BAMBOO_JUNGLE_HILLS});
