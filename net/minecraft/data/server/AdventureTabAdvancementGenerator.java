...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement2 = Advancement.Builder.create().parent(advancement).display(Blocks.RED_BED, (Text)new TranslatableText("advancements.adventure.sleep_in_bed.title"), (Text)new TranslatableText("advancements.adventure.sleep_in_bed.description"), null, AdvancementFrame.TASK, true, true, false).criterion("slept_in_bed", TickCriterion.Conditions.createSleptInBed()).build(consumer, "adventure/sleep_in_bed");
        AdventureTabAdvancementGenerator.requireListedBiomesVisited(Advancement.Builder.create(), MultiNoiseBiomeSource.Preset.OVERWORLD.stream().toList()).parent(advancement2).display(Items.DIAMOND_BOOTS, (Text)new TranslatableText("advancements.adventure.adventuring_time.title"), (Text)new TranslatableText("advancements.adventure.adventuring_time.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(500)).build(consumer, "adventure/adventuring_time");
        ...
        Advancement.Builder.create().parent(advancement2).display(Items.LEATHER_BOOTS, (Text)new TranslatableText("advancements.adventure.walk_on_powder_snow_with_leather_boots.title"), (Text)new TranslatableText("advancements.adventure.walk_on_powder_snow_with_leather_boots.description"), null, AdvancementFrame.TASK, true, true, false).criterion("walk_on_powder_snow_with_leather_boots", TickCriterion.Conditions.createLocation(Blocks.POWDER_SNOW, Items.LEATHER_BOOTS)).build(consumer, "adventure/walk_on_powder_snow_with_leather_boots");
        ...
        Advancement.Builder.create().parent(advancement).display(Blocks.SCULK_SENSOR, (Text)new TranslatableText("advancements.adventure.avoid_vibration.title"), (Text)new TranslatableText("advancements.adventure.avoid_vibration.description"), null, AdvancementFrame.TASK, true, true, false).criterion("avoid_vibration", TickCriterion.Conditions.createAvoidVibration()).build(consumer, "adventure/avoid_vibration");
    }
