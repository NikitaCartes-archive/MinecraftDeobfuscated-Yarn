...
implements Consumer<Consumer<Advancement>> {
    ...
    public void method_10335(Consumer<Advancement> consumer) {
        Advancement advancement = Advancement.Task.create().display(Items.MAP, (Component)new TranslatableComponent("advancements.adventure.root.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.root.description", new Object[0]), new Identifier("textures/gui/advancements/backgrounds/adventure.png"), AdvancementFrame.TASK, false, false, false).criteriaMerger(CriteriaMerger.OR).criterion("killed_something", OnKilledCriterion.Conditions.createPlayerKilledEntity()).criterion("killed_by_something", OnKilledCriterion.Conditions.createEntityKilledPlayer()).build(consumer, "adventure/root");
        Advancement advancement2 = Advancement.Task.create().parent(advancement).display(Blocks.RED_BED, (Component)new TranslatableComponent("advancements.adventure.sleep_in_bed.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.sleep_in_bed.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("slept_in_bed", LocationArrivalCriterion.Conditions.createSleptInBed()).build(consumer, "adventure/sleep_in_bed");
        Advancement advancement3 = this.method_10337(Advancement.Task.create()).parent(advancement2).display(Items.DIAMOND_BOOTS, (Component)new TranslatableComponent("advancements.adventure.adventuring_time.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.adventuring_time.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(500)).build(consumer, "adventure/adventuring_time");
        Advancement advancement4 = Advancement.Task.create().parent(advancement).display(Items.EMERALD, (Component)new TranslatableComponent("advancements.adventure.trade.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.trade.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("traded", VillagerTradeCriterion.Conditions.any()).build(consumer, "adventure/trade");
        Advancement advancement5 = this.method_10336(Advancement.Task.create()).parent(advancement).display(Items.IRON_SWORD, (Component)new TranslatableComponent("advancements.adventure.kill_a_mob.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.kill_a_mob.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriteriaMerger.OR).build(consumer, "adventure/kill_a_mob");
        Advancement advancement6 = this.method_10336(Advancement.Task.create()).parent(advancement5).display(Items.DIAMOND_SWORD, (Component)new TranslatableComponent("advancements.adventure.kill_all_mobs.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.kill_all_mobs.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "adventure/kill_all_mobs");
        Advancement advancement7 = Advancement.Task.create().parent(advancement5).display(Items.BOW, (Component)new TranslatableComponent("advancements.adventure.shoot_arrow.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.shoot_arrow.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("shot_arrow", PlayerHurtEntityCriterion.Conditions.create(DamagePredicate.Builder.create().type(DamageSourcePredicate.Builder.create().projectile(true).directEntity(EntityPredicate.Builder.create().type(EntityType.ARROW))))).build(consumer, "adventure/shoot_arrow");
        Advancement advancement8 = Advancement.Task.create().parent(advancement5).display(Items.TRIDENT, (Component)new TranslatableComponent("advancements.adventure.throw_trident.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.throw_trident.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("shot_trident", PlayerHurtEntityCriterion.Conditions.create(DamagePredicate.Builder.create().type(DamageSourcePredicate.Builder.create().projectile(true).directEntity(EntityPredicate.Builder.create().type(EntityType.TRIDENT))))).build(consumer, "adventure/throw_trident");
        ...
        Advancement advancement10 = Advancement.Task.create().parent(advancement4).display(Blocks.CARVED_PUMPKIN, (Component)new TranslatableComponent("advancements.adventure.summon_iron_golem.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.summon_iron_golem.description", new Object[0]), null, AdvancementFrame.GOAL, true, true, false).criterion("summoned_golem", SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.IRON_GOLEM))).build(consumer, "adventure/summon_iron_golem");
        Advancement advancement11 = Advancement.Task.create().parent(advancement7).display(Items.ARROW, (Component)new TranslatableComponent("advancements.adventure.sniper_duel.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.sniper_duel.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("killed_skeleton", OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(EntityType.SKELETON).distance(DistancePredicate.horizontal(NumberRange.FloatRange.atLeast(50.0f))), DamageSourcePredicate.Builder.create().projectile(true))).build(consumer, "adventure/sniper_duel");
        Advancement advancement12 = Advancement.Task.create().parent(advancement5).display(Items.TOTEM_OF_UNDYING, (Component)new TranslatableComponent("advancements.adventure.totem_of_undying.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.totem_of_undying.description", new Object[0]), null, AdvancementFrame.GOAL, true, true, false).criterion("used_totem", UsedTotemCriterion.Conditions.create(Items.TOTEM_OF_UNDYING)).build(consumer, "adventure/totem_of_undying");
        Advancement advancement13 = Advancement.Task.create().parent(advancement).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.ol_betsy.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.ol_betsy.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("shot_crossbow", ShotCrossbowCriterion.Conditions.create(Items.CROSSBOW)).build(consumer, "adventure/ol_betsy");
        Advancement advancement14 = Advancement.Task.create().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.whos_the_pillager_now.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.whos_the_pillager_now.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("kill_pillager", KilledByCrossbowCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.PILLAGER))).build(consumer, "adventure/whos_the_pillager_now");
        Advancement advancement15 = Advancement.Task.create().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.two_birds_one_arrow.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.two_birds_one_arrow.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(65)).criterion("two_birds", KilledByCrossbowCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.PHANTOM), EntityPredicate.Builder.create().type(EntityType.PHANTOM))).build(consumer, "adventure/two_birds_one_arrow");
        Advancement advancement16 = Advancement.Task.create().parent(advancement13).display(Items.CROSSBOW, (Component)new TranslatableComponent("advancements.adventure.arbalistic.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.arbalistic.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, true).rewards(AdvancementRewards.Builder.experience(85)).criterion("arbalistic", KilledByCrossbowCriterion.Conditions.create(NumberRange.IntRange.exactly(5))).build(consumer, "adventure/arbalistic");
        Advancement advancement17 = Advancement.Task.create().parent(advancement).display(Raid.OMINOUS_BANNER, (Component)new TranslatableComponent("advancements.adventure.voluntary_exile.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.voluntary_exile.description", new Object[0]), null, AdvancementFrame.TASK, true, true, true).criterion("voluntary_exile", OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(EntityTypeTags.RAIDERS).equipment(EntityEquipmentPredicate.field_19240))).build(consumer, "adventure/voluntary_exile");
        Advancement advancement18 = Advancement.Task.create().parent(advancement17).display(Raid.OMINOUS_BANNER, (Component)new TranslatableComponent("advancements.adventure.hero_of_the_village.title", new Object[0]), (Component)new TranslatableComponent("advancements.adventure.hero_of_the_village.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, true).rewards(AdvancementRewards.Builder.experience(100)).criterion("hero_of_the_village", LocationArrivalCriterion.Conditions.createHeroOfTheVillage()).build(consumer, "adventure/hero_of_the_village");
    }
