...
implements LootTableGenerator {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> exporter) {
        ...
        exporter.accept(LootTables.BASTION_HOGLIN_STABLE_CHEST, VanillaChestLootTableGenerator.createBastionBridgeChestTableBuilder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)EmptyEntry.builder().weight(11)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE).weight(1))).pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)EmptyEntry.builder().weight(9)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE).weight(1))));
