...
extends AbstractTagProvider<Block> {
    ...
    protected void configure() {
        ...
        this.getOrCreateTagBuilder(BlockTags.WOODEN_STAIRS).add((Block[])new Block[]{Blocks.BAMBOO_STAIRS, Blocks.BAMBOO_MOSAIC_STAIRS});
        this.getOrCreateTagBuilder(BlockTags.WOODEN_SLABS).add((Block[])new Block[]{Blocks.BAMBOO_SLAB, Blocks.BAMBOO_MOSAIC_SLAB});
        ...
        this.getOrCreateTagBuilder(BlockTags.AXE_MINEABLE).addTag(BlockTags.ALL_HANGING_SIGNS).add((Block[])new Block[]{Blocks.BAMBOO_MOSAIC, Blocks.CHISELED_BOOKSHELF});
    }
}
