...
implements DataProvider {
    ...
    private static void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_SLAB, Blocks.STONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_STAIRS, Blocks.STONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_BRICKS, Blocks.STONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_BRICK_SLAB, Blocks.STONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_BRICK_STAIRS, Blocks.STONE);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_SANDSTONE, Blocks.SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SANDSTONE_SLAB, Blocks.SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_SANDSTONE_SLAB, Blocks.SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_SANDSTONE_SLAB, Blocks.CUT_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SANDSTONE_STAIRS, Blocks.SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SANDSTONE_WALL, Blocks.SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_SANDSTONE, Blocks.SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_RED_SANDSTONE, Blocks.RED_SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_SANDSTONE_SLAB, Blocks.RED_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_RED_SANDSTONE_SLAB, Blocks.RED_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_RED_SANDSTONE_SLAB, Blocks.CUT_RED_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_SANDSTONE_STAIRS, Blocks.RED_SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_SANDSTONE_WALL, Blocks.RED_SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_RED_SANDSTONE, Blocks.RED_SANDSTONE);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.QUARTZ_STAIRS, Blocks.QUARTZ_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.QUARTZ_PILLAR, Blocks.QUARTZ_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.QUARTZ_BRICKS, Blocks.QUARTZ_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLESTONE_STAIRS, Blocks.COBBLESTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLESTONE_SLAB, Blocks.COBBLESTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLESTONE_WALL, Blocks.COBBLESTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_BRICK_SLAB, Blocks.STONE_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.STONE_BRICK_STAIRS, Blocks.STONE_BRICKS);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_STONE_BRICKS, Blocks.STONE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BRICK_SLAB, Blocks.BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BRICK_STAIRS, Blocks.BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BRICK_WALL, Blocks.BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.NETHER_BRICK_SLAB, Blocks.NETHER_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.NETHER_BRICK_STAIRS, Blocks.NETHER_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.NETHER_BRICK_WALL, Blocks.NETHER_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_NETHER_BRICKS, Blocks.NETHER_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_NETHER_BRICK_SLAB, Blocks.RED_NETHER_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_NETHER_BRICK_STAIRS, Blocks.RED_NETHER_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.RED_NETHER_BRICK_WALL, Blocks.RED_NETHER_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PURPUR_SLAB, Blocks.PURPUR_BLOCK, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PURPUR_STAIRS, Blocks.PURPUR_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PURPUR_PILLAR, Blocks.PURPUR_BLOCK);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PRISMARINE_SLAB, Blocks.PRISMARINE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PRISMARINE_STAIRS, Blocks.PRISMARINE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.PRISMARINE_WALL, Blocks.PRISMARINE);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DARK_PRISMARINE_SLAB, Blocks.DARK_PRISMARINE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DARK_PRISMARINE_STAIRS, Blocks.DARK_PRISMARINE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.ANDESITE_SLAB, Blocks.ANDESITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.ANDESITE_STAIRS, Blocks.ANDESITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.ANDESITE_WALL, Blocks.ANDESITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_ANDESITE, Blocks.ANDESITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_ANDESITE_SLAB, Blocks.ANDESITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_ANDESITE_STAIRS, Blocks.ANDESITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_ANDESITE_SLAB, Blocks.POLISHED_ANDESITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_ANDESITE_STAIRS, Blocks.POLISHED_ANDESITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BASALT, Blocks.BASALT);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.GRANITE_SLAB, Blocks.GRANITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.GRANITE_STAIRS, Blocks.GRANITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.GRANITE_WALL, Blocks.GRANITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_GRANITE, Blocks.GRANITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_GRANITE_SLAB, Blocks.GRANITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_GRANITE_STAIRS, Blocks.GRANITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_GRANITE_SLAB, Blocks.POLISHED_GRANITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_GRANITE_STAIRS, Blocks.POLISHED_GRANITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DIORITE_SLAB, Blocks.DIORITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DIORITE_STAIRS, Blocks.DIORITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DIORITE_WALL, Blocks.DIORITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DIORITE, Blocks.DIORITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DIORITE_SLAB, Blocks.DIORITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DIORITE_STAIRS, Blocks.DIORITE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DIORITE_SLAB, Blocks.POLISHED_DIORITE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DIORITE_STAIRS, Blocks.POLISHED_DIORITE);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.MOSSY_COBBLESTONE_SLAB, Blocks.MOSSY_COBBLESTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.MOSSY_COBBLESTONE_STAIRS, Blocks.MOSSY_COBBLESTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.MOSSY_COBBLESTONE_WALL, Blocks.MOSSY_COBBLESTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_SANDSTONE_SLAB, Blocks.SMOOTH_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_SANDSTONE_STAIRS, Blocks.SMOOTH_SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_RED_SANDSTONE_SLAB, Blocks.SMOOTH_RED_SANDSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_RED_SANDSTONE_STAIRS, Blocks.SMOOTH_RED_SANDSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_QUARTZ_SLAB, Blocks.SMOOTH_QUARTZ, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_QUARTZ_STAIRS, Blocks.SMOOTH_QUARTZ);
        ...
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.END_STONE_BRICKS, Blocks.END_STONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.END_STONE_BRICK_SLAB, Blocks.END_STONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.END_STONE_BRICK_STAIRS, Blocks.END_STONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.END_STONE_BRICK_WALL, Blocks.END_STONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.SMOOTH_STONE_SLAB, Blocks.SMOOTH_STONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BLACKSTONE_SLAB, Blocks.BLACKSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BLACKSTONE_STAIRS, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.BLACKSTONE_WALL, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_WALL, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_SLAB, Blocks.BLACKSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_STAIRS, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_POLISHED_BLACKSTONE, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICKS, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, Blocks.BLACKSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_WALL, Blocks.BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_SLAB, Blocks.POLISHED_BLACKSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_STAIRS, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICKS, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_WALL, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, Blocks.POLISHED_BLACKSTONE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_WALL, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_POLISHED_BLACKSTONE, Blocks.POLISHED_BLACKSTONE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, Blocks.POLISHED_BLACKSTONE_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS, Blocks.POLISHED_BLACKSTONE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_BLACKSTONE_BRICK_WALL, Blocks.POLISHED_BLACKSTONE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_COPPER_SLAB, Blocks.CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_COPPER_STAIRS, Blocks.CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.EXPOSED_CUT_COPPER_SLAB, Blocks.EXPOSED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.EXPOSED_CUT_COPPER_STAIRS, Blocks.EXPOSED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WEATHERED_CUT_COPPER_SLAB, Blocks.WEATHERED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WEATHERED_CUT_COPPER_STAIRS, Blocks.WEATHERED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.OXIDIZED_CUT_COPPER_SLAB, Blocks.OXIDIZED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.OXIDIZED_CUT_COPPER_STAIRS, Blocks.OXIDIZED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_CUT_COPPER_SLAB, Blocks.WAXED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_CUT_COPPER_STAIRS, Blocks.WAXED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, Blocks.WAXED_EXPOSED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS, Blocks.WAXED_EXPOSED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, Blocks.WAXED_WEATHERED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS, Blocks.WAXED_WEATHERED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, Blocks.WAXED_OXIDIZED_CUT_COPPER, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS, Blocks.WAXED_OXIDIZED_CUT_COPPER);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_COPPER, Blocks.COPPER_BLOCK, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_COPPER_STAIRS, Blocks.COPPER_BLOCK, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CUT_COPPER_SLAB, Blocks.COPPER_BLOCK, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.EXPOSED_CUT_COPPER, Blocks.EXPOSED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.EXPOSED_CUT_COPPER_STAIRS, Blocks.EXPOSED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.EXPOSED_CUT_COPPER_SLAB, Blocks.EXPOSED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WEATHERED_CUT_COPPER, Blocks.WEATHERED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WEATHERED_CUT_COPPER_STAIRS, Blocks.WEATHERED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WEATHERED_CUT_COPPER_SLAB, Blocks.WEATHERED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.OXIDIZED_CUT_COPPER, Blocks.OXIDIZED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.OXIDIZED_CUT_COPPER_STAIRS, Blocks.OXIDIZED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.OXIDIZED_CUT_COPPER_SLAB, Blocks.OXIDIZED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_CUT_COPPER, Blocks.WAXED_COPPER_BLOCK, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_CUT_COPPER_STAIRS, Blocks.WAXED_COPPER_BLOCK, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_CUT_COPPER_SLAB, Blocks.WAXED_COPPER_BLOCK, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_EXPOSED_CUT_COPPER, Blocks.WAXED_EXPOSED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS, Blocks.WAXED_EXPOSED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, Blocks.WAXED_EXPOSED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_WEATHERED_CUT_COPPER, Blocks.WAXED_WEATHERED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS, Blocks.WAXED_WEATHERED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, Blocks.WAXED_WEATHERED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_OXIDIZED_CUT_COPPER, Blocks.WAXED_OXIDIZED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS, Blocks.WAXED_OXIDIZED_COPPER, 4);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, Blocks.WAXED_OXIDIZED_COPPER, 8);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLED_DEEPSLATE_SLAB, Blocks.COBBLED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLED_DEEPSLATE_STAIRS, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.COBBLED_DEEPSLATE_WALL, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.CHISELED_DEEPSLATE, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_SLAB, Blocks.COBBLED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_STAIRS, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_WALL, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICKS, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_SLAB, Blocks.COBBLED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_STAIRS, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_WALL, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILES, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_SLAB, Blocks.COBBLED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_STAIRS, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_WALL, Blocks.COBBLED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_SLAB, Blocks.POLISHED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_STAIRS, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.POLISHED_DEEPSLATE_WALL, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICKS, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_SLAB, Blocks.POLISHED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_STAIRS, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_WALL, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILES, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_SLAB, Blocks.POLISHED_DEEPSLATE, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_STAIRS, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_WALL, Blocks.POLISHED_DEEPSLATE);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_SLAB, Blocks.DEEPSLATE_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_STAIRS, Blocks.DEEPSLATE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_BRICK_WALL, Blocks.DEEPSLATE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILES, Blocks.DEEPSLATE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_SLAB, Blocks.DEEPSLATE_BRICKS, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_STAIRS, Blocks.DEEPSLATE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_WALL, Blocks.DEEPSLATE_BRICKS);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_SLAB, Blocks.DEEPSLATE_TILES, 2);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_STAIRS, Blocks.DEEPSLATE_TILES);
        RecipesProvider.offerStonecuttingRecipe(exporter, Blocks.DEEPSLATE_TILE_WALL, Blocks.DEEPSLATE_TILES);
    ...
    private static void offerStonecuttingRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible input) {
        RecipesProvider.offerStonecuttingRecipe(exporter, output, input, 1);
    }
