...
implements DataProvider {
    ...
    private static void generate(Consumer<RecipeJsonProvider> consumer) {
        ...
        ShapedRecipeJsonFactory.create(Blocks.FURNACE).input(Character.valueOf('#'), Blocks.COBBLESTONE).pattern("###").pattern("# #").pattern("###").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ...
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_SWORD).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_SWORD).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_SHOVEL).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_SHOVEL).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_PICKAXE).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_PICKAXE).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_AXE).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_AXE).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_HOE).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_HOE).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_HELMET).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_HELMET).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_CHESTPLATE).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_CHESTPLATE).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_LEGGINGS).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_LEGGINGS).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ShapelessRecipeJsonFactory.create(Items.NETHERITE_BOOTS).input(Items.NETHERITE_INGOT).input(Items.DIAMOND_BOOTS).criterion("has_netherite_ingot", RecipesProvider.conditionsFromItem(Items.NETHERITE_INGOT)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Items.STONE_AXE).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XX").pattern("X#").pattern(" #").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Items.STONE_HOE).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XX").pattern(" #").pattern(" #").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ShapedRecipeJsonFactory.create(Items.STONE_PICKAXE).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("XXX").pattern(" # ").pattern(" # ").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Items.STONE_SHOVEL).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("X").pattern("#").pattern("#").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Items.STONE_SWORD).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('X'), Blocks.COBBLESTONE).pattern("X").pattern("X").pattern("#").criterion("has_cobblestone", RecipesProvider.conditionsFromItem(Blocks.COBBLESTONE)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Blocks.SOUL_FIRE_TORCH, 4).input(Character.valueOf('X'), Ingredient.ofItems(Items.COAL, Items.CHARCOAL)).input(Character.valueOf('#'), Items.STICK).input(Character.valueOf('S'), Items.SOUL_SOIL).pattern("X").pattern("#").pattern("S").criterion("has_soul_soil", RecipesProvider.conditionsFromItem(Items.SOUL_SOIL)).offerTo(consumer);
        ...
        ShapedRecipeJsonFactory.create(Blocks.SOUL_FIRE_LANTERN).input(Character.valueOf('#'), Items.SOUL_FIRE_TORCH).input(Character.valueOf('X'), Items.IRON_NUGGET).pattern("XXX").pattern("X#X").pattern("XXX").criterion("has_soul_fire_torch", RecipesProvider.conditionsFromItem(Items.SOUL_FIRE_TORCH)).offerTo(consumer);
        ...
        CookingRecipeJsonFactory.createSmelting(Ingredient.fromTag(ItemTags.LOGS), Items.CHARCOAL, 0.15f, 200).criterion("has_log", RecipesProvider.conditionsFromTag(ItemTags.LOGS)).offerTo(consumer);
        ...
        CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Blocks.GOLD_ORE.asItem()), Items.GOLD_INGOT, 1.0f, 200).criterion("has_gold_ore", RecipesProvider.conditionsFromItem(Blocks.GOLD_ORE)).offerTo(consumer);
        ...
        CookingRecipeJsonFactory.createBlasting(Ingredient.ofItems(Blocks.GOLD_ORE.asItem()), Items.GOLD_INGOT, 1.0f, 100).criterion("has_gold_ore", RecipesProvider.conditionsFromItem(Blocks.GOLD_ORE)).offerTo(consumer, "gold_ingot_from_blasting");
