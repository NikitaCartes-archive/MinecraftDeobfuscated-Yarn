...
implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
    ...
    private static final Set<Item> ALWAYS_DROPPED_FROM_EXPLOSION = Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(ItemConvertible::asItem).collect(ImmutableSet.toImmutableSet());
    ...
    private static <T> T addExplosionDecayLootFunction(ItemConvertible itemConvertible, LootFunctionConsumingBuilder<T> lootFunctionConsumingBuilder) {
        if (!ALWAYS_DROPPED_FROM_EXPLOSION.contains(itemConvertible.asItem())) {
    ...
    private static LootTable.Builder create(ItemConvertible itemConvertible) {
        return LootTable.builder().withPool(BlockLootTableGenerator.addSurvivesExplosionLootCondition(itemConvertible, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(itemConvertible))));
    }
    ...
    private static LootTable.Builder createForNeedingSilkTouch(Block block, LootEntry.Builder<?> child) {
        return BlockLootTableGenerator.create(block, NEEDS_SILK_TOUCH, child);
    }

    private static LootTable.Builder createForNeedingShears(Block block, LootEntry.Builder<?> child) {
        return BlockLootTableGenerator.create(block, NEEDS_SHEARS, child);
    }

    private static LootTable.Builder createForNeedingSilkTouchShears(Block block, LootEntry.Builder<?> child) {
        return BlockLootTableGenerator.create(block, NEEDS_SILK_TOUCH_SHEARS, child);
    }

    private static LootTable.Builder createForBlockWithItemDrops(Block block, ItemConvertible lootWithoutSilkTouch) {
        return BlockLootTableGenerator.createForNeedingSilkTouch(block, (LootEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, ItemEntry.builder(lootWithoutSilkTouch)));
    }

    private static LootTable.Builder create(ItemConvertible itemConvertible, LootTableRange count) {
        return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder)BlockLootTableGenerator.addExplosionDecayLootFunction(itemConvertible, ItemEntry.builder(itemConvertible).withFunction(SetCountLootFunction.builder(count)))));
    }
    ...
    private static LootTable.Builder createForBlockWithItemDrops(Block block, ItemConvertible lootWithoutSilkTouch, LootTableRange count) {
        return BlockLootTableGenerator.createForNeedingSilkTouch(block, (LootEntry.Builder)BlockLootTableGenerator.addExplosionDecayLootFunction(block, ItemEntry.builder(lootWithoutSilkTouch).withFunction(SetCountLootFunction.builder(count))));
    }
    ...
    private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder createForMultiblock(Block block, Property<T> property, T comparable) {
        return LootTable.builder().withPool(BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder<?>)ItemEntry.builder(block).withCondition(BlockStatePropertyLootCondition.builder(block).method_22584(StatePredicate.Builder.create().exactMatch(property, comparable))))));
    }

    private static LootTable.Builder createForNameableContainer(Block block) {
        return LootTable.builder().withPool(BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder<?>)ItemEntry.builder(block).withFunction(CopyNameLootFunction.builder(CopyNameLootFunction.Source.BLOCK_ENTITY)))));
    }
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
        ...
        this.registerWithFunction(Blocks.STONE, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.COBBLESTONE));
        this.registerWithFunction(Blocks.GRASS_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DIRT));
        this.registerWithFunction(Blocks.PODZOL, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DIRT));
        this.registerWithFunction(Blocks.MYCELIUM, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DIRT));
        this.registerWithFunction(Blocks.TUBE_CORAL_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DEAD_TUBE_CORAL_BLOCK));
        this.registerWithFunction(Blocks.BRAIN_CORAL_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DEAD_BRAIN_CORAL_BLOCK));
        this.registerWithFunction(Blocks.BUBBLE_CORAL_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
        this.registerWithFunction(Blocks.FIRE_CORAL_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DEAD_FIRE_CORAL_BLOCK));
        this.registerWithFunction(Blocks.HORN_CORAL_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.DEAD_HORN_CORAL_BLOCK));
        this.registerWithFunction(Blocks.BOOKSHELF, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Items.BOOK, ConstantLootTableRange.create(3)));
        this.registerWithFunction(Blocks.CLAY, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Items.CLAY_BALL, ConstantLootTableRange.create(4)));
        this.registerWithFunction(Blocks.ENDER_CHEST, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Blocks.OBSIDIAN, ConstantLootTableRange.create(8)));
        this.registerWithFunction(Blocks.SNOW_BLOCK, block -> BlockLootTableGenerator.createForBlockWithItemDrops(block, Items.SNOWBALL, ConstantLootTableRange.create(4)));
        ...
        this.registerWithFunction(Blocks.CYAN_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.GRAY_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.GREEN_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.LIGHT_BLUE_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.LIGHT_GRAY_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.LIME_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.MAGENTA_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.PURPLE_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.ORANGE_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.PINK_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.RED_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.WHITE_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.YELLOW_BED, block -> BlockLootTableGenerator.createForMultiblock(block, BedBlock.PART, BedPart.HEAD));
        this.registerWithFunction(Blocks.LILAC, block -> BlockLootTableGenerator.createForMultiblock(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.registerWithFunction(Blocks.SUNFLOWER, block -> BlockLootTableGenerator.createForMultiblock(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.registerWithFunction(Blocks.PEONY, block -> BlockLootTableGenerator.createForMultiblock(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.registerWithFunction(Blocks.ROSE_BUSH, block -> BlockLootTableGenerator.createForMultiblock(block, TallPlantBlock.HALF, DoubleBlockHalf.LOWER));
        ...
        this.registerWithFunction(Blocks.PLAYER_HEAD, block -> LootTable.builder().withPool(BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder<?>)ItemEntry.builder(block).withFunction(CopyNbtLootFunction.builder(CopyNbtLootFunction.Source.BLOCK_ENTITY).withOperation("SkullOwner", "SkullOwner"))))));
        ...
        this.registerWithFunction(Blocks.BIRCH_LEAVES, block -> BlockLootTableGenerator.createForLeaves(block, Blocks.BIRCH_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES));
        this.registerWithFunction(Blocks.ACACIA_LEAVES, block -> BlockLootTableGenerator.createForLeaves(block, Blocks.ACACIA_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES));
        this.registerWithFunction(Blocks.JUNGLE_LEAVES, block -> BlockLootTableGenerator.createForLeaves(block, Blocks.JUNGLE_SAPLING, JUNGLE_SAPLING_DROP_CHANCES_FROM_LEAVES));
        this.registerWithFunction(Blocks.SPRUCE_LEAVES, block -> BlockLootTableGenerator.createForLeaves(block, Blocks.SPRUCE_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES));
        this.registerWithFunction(Blocks.OAK_LEAVES, block -> BlockLootTableGenerator.createForOakLeaves(block, Blocks.OAK_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES));
        this.registerWithFunction(Blocks.DARK_OAK_LEAVES, block -> BlockLootTableGenerator.createForOakLeaves(block, Blocks.DARK_OAK_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES));
        ...
        this.register(Blocks.BEETROOTS, BlockLootTableGenerator.createForCrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, builder));
        ...
        this.register(Blocks.WHEAT, BlockLootTableGenerator.createForCrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, builder2));
        ...
        this.registerWithFunction(Blocks.SWEET_BERRY_BUSH, block -> BlockLootTableGenerator.addExplosionDecayLootFunction(block, LootTable.builder().withPool(LootPool.builder().withCondition(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).method_22584(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 3))).withEntry(ItemEntry.builder(Items.SWEET_BERRIES)).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0f, 3.0f))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE))).withPool(LootPool.builder().withCondition(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).method_22584(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 2))).withEntry(ItemEntry.builder(Items.SWEET_BERRIES)).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0f, 2.0f))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE)))));
        this.registerWithFunction(Blocks.BROWN_MUSHROOM_BLOCK, block -> BlockLootTableGenerator.createForLargeMushroomBlock(block, Blocks.BROWN_MUSHROOM));
        this.registerWithFunction(Blocks.RED_MUSHROOM_BLOCK, block -> BlockLootTableGenerator.createForLargeMushroomBlock(block, Blocks.RED_MUSHROOM));
        this.registerWithFunction(Blocks.COAL_ORE, block -> BlockLootTableGenerator.createForOreWithSingleItemDrop(block, Items.COAL));
        this.registerWithFunction(Blocks.EMERALD_ORE, block -> BlockLootTableGenerator.createForOreWithSingleItemDrop(block, Items.EMERALD));
        this.registerWithFunction(Blocks.NETHER_QUARTZ_ORE, block -> BlockLootTableGenerator.createForOreWithSingleItemDrop(block, Items.QUARTZ));
        this.registerWithFunction(Blocks.DIAMOND_ORE, block -> BlockLootTableGenerator.createForOreWithSingleItemDrop(block, Items.DIAMOND));
        this.registerWithFunction(Blocks.NETHER_GOLD_ORE, block -> BlockLootTableGenerator.createForNeedingSilkTouch(block, (LootEntry.Builder)BlockLootTableGenerator.addExplosionDecayLootFunction(block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0f, 6.0f)))).withFunction(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)))));
        this.registerWithFunction(Blocks.LAPIS_ORE, block -> BlockLootTableGenerator.createForNeedingSilkTouch(block, (LootEntry.Builder)BlockLootTableGenerator.addExplosionDecayLootFunction(block, ((LeafEntry.Builder)ItemEntry.builder(Items.LAPIS_LAZULI).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(4.0f, 9.0f)))).withFunction(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)))));
        this.registerWithFunction(Blocks.COBWEB, block -> BlockLootTableGenerator.createForNeedingSilkTouchShears(block, (LootEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, ItemEntry.builder(Items.STRING))));
        this.registerWithFunction(Blocks.DEAD_BUSH, block -> BlockLootTableGenerator.createForNeedingShears(block, (LootEntry.Builder)BlockLootTableGenerator.addExplosionDecayLootFunction(block, ItemEntry.builder(Items.STICK).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(0.0f, 2.0f))))));
        this.registerWithFunction(Blocks.NETHER_SPROUTS, block -> BlockLootTableGenerator.createForNeedingSilkTouchShears(block, (LootEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, ItemEntry.builder(Blocks.NETHER_SPROUTS))));
        ...
        this.registerWithFunction(Blocks.MELON_STEM, block -> BlockLootTableGenerator.createForCropStem(block, Items.MELON_SEEDS));
        this.registerWithFunction(Blocks.ATTACHED_MELON_STEM, block -> BlockLootTableGenerator.createForAttachedCropStem(block, Items.MELON_SEEDS));
        this.registerWithFunction(Blocks.PUMPKIN_STEM, block -> BlockLootTableGenerator.createForCropStem(block, Items.PUMPKIN_SEEDS));
        this.registerWithFunction(Blocks.ATTACHED_PUMPKIN_STEM, block -> BlockLootTableGenerator.createForAttachedCropStem(block, Items.PUMPKIN_SEEDS));
        this.registerWithFunction(Blocks.CHORUS_FLOWER, block -> LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder<?>)((LeafEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionLootCondition(block, ItemEntry.builder(block))).withCondition(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS)))));
    ...
    public void registerForPottedPlant(Block block2) {
        this.registerWithFunction(block2, block -> BlockLootTableGenerator.createForPottedPlant(((FlowerPotBlock)block).getContent()));
    }

    public void registerForNeedingSilkTouch(Block block, Block droppedBlock) {
        this.register(block, BlockLootTableGenerator.createForNeedingSilkTouch(droppedBlock));
    }

    public void register(Block block, ItemConvertible loot) {
        this.register(block, BlockLootTableGenerator.create(loot));
    }
