...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement4 = Advancement.Builder.create().parent(advancement3).display(Items.IRON_INGOT, (Text)Text.translatable("advancements.story.smelt_iron.title"), (Text)Text.translatable("advancements.story.smelt_iron.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron", InventoryChangedCriterion.Conditions.items(Items.IRON_INGOT)).build(consumer, "story/smelt_iron");
        Advancement advancement5 = Advancement.Builder.create().parent(advancement4).display(Items.IRON_PICKAXE, (Text)Text.translatable("advancements.story.iron_tools.title"), (Text)Text.translatable("advancements.story.iron_tools.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron_pickaxe", InventoryChangedCriterion.Conditions.items(Items.IRON_PICKAXE)).build(consumer, "story/iron_tools");
        ...
        Advancement advancement7 = Advancement.Builder.create().parent(advancement4).display(Items.LAVA_BUCKET, (Text)Text.translatable("advancements.story.lava_bucket.title"), (Text)Text.translatable("advancements.story.lava_bucket.description"), null, AdvancementFrame.TASK, true, true, false).criterion("lava_bucket", InventoryChangedCriterion.Conditions.items(Items.LAVA_BUCKET)).build(consumer, "story/lava_bucket");
        ...
        Advancement.Builder.create().parent(advancement6).display(Items.ENCHANTED_BOOK, (Text)Text.translatable("advancements.story.enchant_item.title"), (Text)Text.translatable("advancements.story.enchant_item.description"), null, AdvancementFrame.TASK, true, true, false).criterion("enchanted_item", EnchantedItemCriterion.Conditions.any()).build(consumer, "story/enchant_item");
        Advancement advancement9 = Advancement.Builder.create().parent(advancement7).display(Blocks.OBSIDIAN, (Text)Text.translatable("advancements.story.form_obsidian.title"), (Text)Text.translatable("advancements.story.form_obsidian.description"), null, AdvancementFrame.TASK, true, true, false).criterion("obsidian", InventoryChangedCriterion.Conditions.items(Blocks.OBSIDIAN)).build(consumer, "story/form_obsidian");
