...
public class WorldPresetTagProvider
extends AbstractTagProvider<WorldPreset> {
    ...
    protected void configure() {
        this.getOrCreateTagBuilder(WorldPresetTags.NORMAL).add(WorldPresets.DEFAULT).add(WorldPresets.FLAT).add(WorldPresets.LARGE_BIOMES).add(WorldPresets.AMPLIFIED).add(WorldPresets.SINGLE_BIOME_SURFACE);
