...
public class CookingRecipeJsonFactory {
    ...
    public static CookingRecipeJsonFactory create(Ingredient ingredient, ItemConvertible itemConvertible, float f, int i, CookingRecipeSerializer<?> cookingRecipeSerializer) {
    ...
    public static CookingRecipeJsonFactory createBlasting(Ingredient ingredient, ItemConvertible itemConvertible, float f, int i) {
        return CookingRecipeJsonFactory.create(ingredient, itemConvertible, f, i, RecipeSerializer.BLASTING);
    }
    ...
    public static CookingRecipeJsonFactory createSmelting(Ingredient ingredient, ItemConvertible itemConvertible, float f, int i) {
        return CookingRecipeJsonFactory.create(ingredient, itemConvertible, f, i, RecipeSerializer.SMELTING);
    }
    ...
    public void offerTo(Consumer<RecipeJsonProvider> consumer, Identifier identifier) {
        ...
        consumer.accept(new CookingRecipeJsonProvider(identifier, this.group == null ? "" : this.group, this.input, this.output, this.exp, this.time, this.builder, new Identifier(identifier.getNamespace(), "recipes/" + this.output.getItemGroup().getName() + "/" + identifier.getPath()), this.serializer));
    }
