...
extends RecipeProvider {
    ...
    protected void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        OneTwentyRecipeProvider.offer2x2CompactingRecipe(exporter, RecipeCategory.DECORATIONS, Blocks.BAMBOO_PLANKS, Items.BAMBOO);
        ...
        OneTwentyRecipeProvider.offerHangingSignRecipe(exporter, Items.ACACIA_HANGING_SIGN, Blocks.STRIPPED_OAK_LOG);
        ...
        OneTwentyRecipeProvider.offerHangingSignRecipe(exporter, Items.BAMBOO_HANGING_SIGN, Blocks.BAMBOO_PLANKS, 2);
