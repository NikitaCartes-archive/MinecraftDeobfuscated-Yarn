...
public class ShapedRecipeJsonFactory {
    ...
    public void offerTo(Consumer<RecipeJsonProvider> consumer, Identifier identifier) {
        ...
        consumer.accept(new ShapedRecipeJsonProvider(identifier, this.output, this.outputCount, this.group == null ? "" : this.group, this.pattern, this.inputs, this.builder, new Identifier(identifier.getNamespace(), "recipes/" + this.output.getGroup().getName() + "/" + identifier.getPath())));
    }
