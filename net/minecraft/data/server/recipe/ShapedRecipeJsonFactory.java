...
public class ShapedRecipeJsonFactory {
    ...
    public static ShapedRecipeJsonFactory create(ItemConvertible itemConvertible) {
        return ShapedRecipeJsonFactory.create(itemConvertible, 1);
    }
    ...
    public void offerTo(Consumer<RecipeJsonProvider> consumer, Identifier identifier) {
        ...
        consumer.accept(new ShapedRecipeJsonProvider(identifier, this.output, this.outputCount, this.group == null ? "" : this.group, this.pattern, this.inputs, this.builder, new Identifier(identifier.getNamespace(), "recipes/" + this.output.getItemGroup().getName() + "/" + identifier.getPath())));
    }
    ...
    implements RecipeJsonProvider {
        ...
        public ShapedRecipeJsonProvider(Identifier identifier, Item item, int i, String string, List<String> list, Map<Character, Ingredient> map, Advancement.Task task, Identifier identifier2) {
