...
public class PointOfInterestTypeTagProvider
extends AbstractTagProvider<PointOfInterestType> {
    ...
    protected void configure() {
        this.getOrCreateTagBuilder(PointOfInterestTypeTags.ACQUIRABLE_JOB_SITE).add(PointOfInterestTypes.ARMORER, PointOfInterestTypes.BUTCHER, PointOfInterestTypes.CARTOGRAPHER, PointOfInterestTypes.CLERIC, PointOfInterestTypes.FARMER, PointOfInterestTypes.FISHERMAN, PointOfInterestTypes.FLETCHER, PointOfInterestTypes.LEATHERWORKER, PointOfInterestTypes.LIBRARIAN, PointOfInterestTypes.MASON, PointOfInterestTypes.SHEPHERD, PointOfInterestTypes.TOOLSMITH, PointOfInterestTypes.WEAPONSMITH);
        this.getOrCreateTagBuilder(PointOfInterestTypeTags.VILLAGE).addTag(PointOfInterestTypeTags.ACQUIRABLE_JOB_SITE).add(PointOfInterestTypes.HOME, PointOfInterestTypes.MEETING);
