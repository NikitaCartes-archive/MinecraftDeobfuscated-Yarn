...
implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
        ...
        biConsumer.accept(LootTables.HERO_OF_THE_VILLAGE_FLETCHER_GIFT_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.ARROW).weight(26)).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.SWIFTNESS))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.SLOWNESS))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.STRENGTH))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.HEALING))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.HARMING))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.LEAPING))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.REGENERATION))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.FIRE_RESISTANCE))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.WATER_BREATHING))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.INVISIBILITY))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.NIGHT_VISION))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.WEAKNESS))).with((LootPoolEntry.Builder<?>)((LeafEntry.Builder)ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 1.0f)))).apply(SetPotionLootFunction.builder(Potions.POISON)))));
