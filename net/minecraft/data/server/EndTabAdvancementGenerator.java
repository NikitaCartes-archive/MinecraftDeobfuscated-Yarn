...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement8 = Advancement.Task.create().parent(advancement5).display(Items.ELYTRA, (Text)new TranslatableText("advancements.end.elytra.title"), (Text)new TranslatableText("advancements.end.elytra.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("elytra", InventoryChangedCriterion.Conditions.items(Items.ELYTRA)).build(consumer, "end/elytra");
