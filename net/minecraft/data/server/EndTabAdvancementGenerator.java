...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement4 = Advancement.Builder.create().parent(advancement3).display(Blocks.PURPUR_BLOCK, (Text)Text.translatable("advancements.end.find_end_city.title"), (Text)Text.translatable("advancements.end.find_end_city.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_city", TickCriterion.Conditions.createLocation(LocationPredicate.feature(StructureTypeKeys.END_CITY))).build(consumer, "end/find_end_city");
        ...
        Advancement.Builder.create().parent(advancement4).display(Items.SHULKER_SHELL, (Text)Text.translatable("advancements.end.levitate.title"), (Text)Text.translatable("advancements.end.levitate.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("levitated", LevitationCriterion.Conditions.create(DistancePredicate.y(NumberRange.FloatRange.atLeast(50.0)))).build(consumer, "end/levitate");
        Advancement.Builder.create().parent(advancement4).display(Items.ELYTRA, (Text)Text.translatable("advancements.end.elytra.title"), (Text)Text.translatable("advancements.end.elytra.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("elytra", InventoryChangedCriterion.Conditions.items(Items.ELYTRA)).build(consumer, "end/elytra");
        Advancement.Builder.create().parent(advancement2).display(Blocks.DRAGON_EGG, (Text)Text.translatable("advancements.end.dragon_egg.title"), (Text)Text.translatable("advancements.end.dragon_egg.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("dragon_egg", InventoryChangedCriterion.Conditions.items(Blocks.DRAGON_EGG)).build(consumer, "end/dragon_egg");
    }
