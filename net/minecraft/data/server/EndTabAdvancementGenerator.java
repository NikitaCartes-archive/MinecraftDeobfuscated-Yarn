...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement2 = Advancement.Task.create().parent(advancement).display(Blocks.DRAGON_HEAD, (Text)new TranslatableText("advancements.end.kill_dragon.title"), (Text)new TranslatableText("advancements.end.kill_dragon.description"), null, AdvancementFrame.TASK, true, true, false).criterion("killed_dragon", OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(EntityType.ENDER_DRAGON))).build(consumer, "end/kill_dragon");
        Advancement advancement3 = Advancement.Task.create().parent(advancement2).display(Items.ENDER_PEARL, (Text)new TranslatableText("advancements.end.enter_end_gateway.title"), (Text)new TranslatableText("advancements.end.enter_end_gateway.description"), null, AdvancementFrame.TASK, true, true, false).criterion("entered_end_gateway", EnterBlockCriterion.Conditions.block(Blocks.END_GATEWAY)).build(consumer, "end/enter_end_gateway");
        ...
        Advancement advancement4 = Advancement.Task.create().parent(advancement3).display(Blocks.PURPUR_BLOCK, (Text)new TranslatableText("advancements.end.find_end_city.title"), (Text)new TranslatableText("advancements.end.find_end_city.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_city", LocationArrivalCriterion.Conditions.create(LocationPredicate.feature(StructureFeature.END_CITY))).build(consumer, "end/find_end_city");
        ...
        Advancement.Task.create().parent(advancement4).display(Items.SHULKER_SHELL, (Text)new TranslatableText("advancements.end.levitate.title"), (Text)new TranslatableText("advancements.end.levitate.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("levitated", LevitationCriterion.Conditions.create(DistancePredicate.y(NumberRange.FloatRange.atLeast(50.0)))).build(consumer, "end/levitate");
        Advancement.Task.create().parent(advancement4).display(Items.ELYTRA, (Text)new TranslatableText("advancements.end.elytra.title"), (Text)new TranslatableText("advancements.end.elytra.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("elytra", InventoryChangedCriterion.Conditions.items(Items.ELYTRA)).build(consumer, "end/elytra");
        Advancement.Task.create().parent(advancement2).display(Blocks.DRAGON_EGG, (Text)new TranslatableText("advancements.end.dragon_egg.title"), (Text)new TranslatableText("advancements.end.dragon_egg.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("dragon_egg", InventoryChangedCriterion.Conditions.items(Blocks.DRAGON_EGG)).build(consumer, "end/dragon_egg");
    }
