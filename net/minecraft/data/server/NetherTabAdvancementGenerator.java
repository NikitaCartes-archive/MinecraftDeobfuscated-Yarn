...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement.Task.create().parent(advancement11).display(Items.RESPAWN_ANCHOR, (Text)new TranslatableText("advancements.nether.charge_respawn_anchor.title"), (Text)new TranslatableText("advancements.nether.charge_respawn_anchor.description"), null, AdvancementFrame.TASK, true, true, false).criterion("charge_respawn_anchor", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().block(Blocks.RESPAWN_ANCHOR).state(StatePredicate.Builder.create().exactMatch(RespawnAnchorBlock.CHARGES, 4).build()).build()), ItemPredicate.Builder.create().item(Blocks.GLOWSTONE))).build(consumer, "nether/charge_respawn_anchor");
