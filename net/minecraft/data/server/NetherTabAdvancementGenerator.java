...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement.Task.create().parent(advancement10).display(Items.NETHERITE_CHESTPLATE, (Text)new TranslatableText("advancements.nether.netherite_armor.title"), (Text)new TranslatableText("advancements.nether.netherite_armor.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).criterion("netherite_armor", InventoryChangedCriterion.Conditions.items(Items.NETHERITE_HELMET, Items.NETHERITE_CHESTPLATE, Items.NETHERITE_LEGGINGS, Items.NETHERITE_BOOTS)).build(consumer, "nether/netherite_armor");
        Advancement.Task.create().parent(advancement10).display(Items.LODESTONE, (Text)new TranslatableText("advancements.nether.use_lodestone.title"), (Text)new TranslatableText("advancements.nether.use_lodestone.description"), null, AdvancementFrame.TASK, true, true, false).criterion("use_lodestone", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(Blocks.LODESTONE).build()), ItemPredicate.Builder.create().items(Items.COMPASS))).build(consumer, "nether/use_lodestone");
        ...
        Advancement.Task.create().parent(advancement11).display(Items.RESPAWN_ANCHOR, (Text)new TranslatableText("advancements.nether.charge_respawn_anchor.title"), (Text)new TranslatableText("advancements.nether.charge_respawn_anchor.description"), null, AdvancementFrame.TASK, true, true, false).criterion("charge_respawn_anchor", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(Blocks.RESPAWN_ANCHOR).state(StatePredicate.Builder.create().exactMatch(RespawnAnchorBlock.CHARGES, 4).build()).build()), ItemPredicate.Builder.create().items(Blocks.GLOWSTONE))).build(consumer, "nether/charge_respawn_anchor");
        Advancement advancement12 = Advancement.Task.create().parent(advancement).display(Items.WARPED_FUNGUS_ON_A_STICK, (Text)new TranslatableText("advancements.nether.ride_strider.title"), (Text)new TranslatableText("advancements.nether.ride_strider.description"), null, AdvancementFrame.TASK, true, true, false).criterion("used_warped_fungus_on_a_stick", ItemDurabilityChangedCriterion.Conditions.create(EntityPredicate.Extended.ofLegacy(EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create().type(EntityType.STRIDER).build()).build()), ItemPredicate.Builder.create().items(Items.WARPED_FUNGUS_ON_A_STICK).build(), NumberRange.IntRange.ANY)).build(consumer, "nether/ride_strider");
        AdventureTabAdvancementGenerator.requireListedBiomesVisited(Advancement.Task.create(), NETHER_BIOMES).parent(advancement12).display(Items.NETHERITE_BOOTS, (Text)new TranslatableText("advancements.nether.explore_nether.title"), (Text)new TranslatableText("advancements.nether.explore_nether.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(500)).build(consumer, "nether/explore_nether");
