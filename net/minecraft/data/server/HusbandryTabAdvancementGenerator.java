...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement advancement7 = Advancement.Task.create().parent(advancement6).criteriaMerger(CriterionMerger.OR).criterion(Registry.ITEM.getId(Items.AXOLOTL_BUCKET).getPath(), FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().items(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.title"), (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/axolotl_in_a_bucket");
        ...
        Advancement.Task.create().parent(advancement9).display(Items.STONE_AXE, (Text)new TranslatableText("advancements.husbandry.wax_off.title"), (Text)new TranslatableText("advancements.husbandry.wax_off.description"), null, AdvancementFrame.TASK, true, true, false).criterion("wax_off", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(HoneycombItem.WAXED_TO_UNWAXED_BLOCKS.get().keySet()).build()), ItemPredicate.Builder.create().items(field_33964))).build(consumer, "husbandry/wax_off");
