...
implements Consumer<Consumer<Advancement>> {
    ...
    private Advancement.Task requireListedAnimalsBred(Advancement.Task task) {
        ...
        task.criterion(EntityType.getId(EntityType.TURTLE).toString(), BredAnimalsCriterion.Conditions.method_29918(EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.ANY));
        return task;
    }
