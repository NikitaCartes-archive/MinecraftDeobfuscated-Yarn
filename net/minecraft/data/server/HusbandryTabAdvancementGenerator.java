...
implements Consumer<Consumer<Advancement>> {
    ...
    public void method_10338(Consumer<Advancement> consumer) {
        Advancement advancement = Advancement.Task.create().display(Blocks.HAY_BLOCK, (Component)new TranslatableComponent("advancements.husbandry.root.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.root.description", new Object[0]), new Identifier("textures/gui/advancements/backgrounds/husbandry.png"), AdvancementFrame.TASK, false, false, false).criterion("consumed_item", ConsumeItemCriterion.Conditions.any()).build(consumer, "husbandry/root");
        Advancement advancement2 = Advancement.Task.create().parent(advancement).display(Items.WHEAT, (Component)new TranslatableComponent("advancements.husbandry.plant_seed.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.plant_seed.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriteriaMerger.OR).criterion("wheat", PlacedBlockCriterion.Conditions.block(Blocks.WHEAT)).criterion("pumpkin_stem", PlacedBlockCriterion.Conditions.block(Blocks.PUMPKIN_STEM)).criterion("melon_stem", PlacedBlockCriterion.Conditions.block(Blocks.MELON_STEM)).criterion("beetroots", PlacedBlockCriterion.Conditions.block(Blocks.BEETROOTS)).criterion("nether_wart", PlacedBlockCriterion.Conditions.block(Blocks.NETHER_WART)).build(consumer, "husbandry/plant_seed");
        Advancement advancement3 = Advancement.Task.create().parent(advancement).display(Items.WHEAT, (Component)new TranslatableComponent("advancements.husbandry.breed_an_animal.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.breed_an_animal.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriteriaMerger.OR).criterion("bred", BredAnimalsCriterion.Conditions.any()).build(consumer, "husbandry/breed_an_animal");
        Advancement advancement4 = this.method_10341(Advancement.Task.create()).parent(advancement2).display(Items.APPLE, (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.balanced_diet.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/balanced_diet");
        Advancement advancement5 = Advancement.Task.create().parent(advancement2).display(Items.DIAMOND_HOE, (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.break_diamond_hoe.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).criterion("broke_hoe", ItemDurabilityChangedCriterion.Conditions.create(ItemPredicate.Builder.create().item(Items.DIAMOND_HOE).build(), NumberRange.IntRange.exactly(0))).build(consumer, "husbandry/break_diamond_hoe");
        Advancement advancement6 = Advancement.Task.create().parent(advancement).display(Items.LEAD, (Component)new TranslatableComponent("advancements.husbandry.tame_an_animal.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.tame_an_animal.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).criterion("tamed_animal", TameAnimalCriterion.Conditions.any()).build(consumer, "husbandry/tame_an_animal");
        Advancement advancement7 = this.method_10342(Advancement.Task.create()).parent(advancement3).display(Items.GOLDEN_CARROT, (Component)new TranslatableComponent("advancements.husbandry.breed_all_animals.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.breed_all_animals.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/bred_all_animals");
        Advancement advancement8 = this.method_10339(Advancement.Task.create()).parent(advancement).criteriaMerger(CriteriaMerger.OR).display(Items.FISHING_ROD, (Component)new TranslatableComponent("advancements.husbandry.fishy_business.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.fishy_business.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/fishy_business");
        Advancement advancement9 = this.method_10340(Advancement.Task.create()).parent(advancement8).criteriaMerger(CriteriaMerger.OR).display(Items.PUFFERFISH_BUCKET, (Component)new TranslatableComponent("advancements.husbandry.tactical_fishing.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.tactical_fishing.description", new Object[0]), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
        Advancement advancement10 = this.method_16118(Advancement.Task.create()).parent(advancement6).display(Items.COD, (Component)new TranslatableComponent("advancements.husbandry.complete_catalogue.title", new Object[0]), (Component)new TranslatableComponent("advancements.husbandry.complete_catalogue.description", new Object[0]), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(consumer, "husbandry/complete_catalogue");
    }
