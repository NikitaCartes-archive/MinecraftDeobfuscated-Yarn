...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        Advancement advancement = Advancement.Builder.create().display(Blocks.HAY_BLOCK, (Text)new TranslatableText("advancements.husbandry.root.title"), (Text)new TranslatableText("advancements.husbandry.root.description"), new Identifier("textures/gui/advancements/backgrounds/husbandry.png"), AdvancementFrame.TASK, false, false, false).criterion("consumed_item", ConsumeItemCriterion.Conditions.any()).build(consumer, "husbandry/root");
        Advancement advancement2 = Advancement.Builder.create().parent(advancement).display(Items.WHEAT, (Text)new TranslatableText("advancements.husbandry.plant_seed.title"), (Text)new TranslatableText("advancements.husbandry.plant_seed.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("wheat", PlacedBlockCriterion.Conditions.block(Blocks.WHEAT)).criterion("pumpkin_stem", PlacedBlockCriterion.Conditions.block(Blocks.PUMPKIN_STEM)).criterion("melon_stem", PlacedBlockCriterion.Conditions.block(Blocks.MELON_STEM)).criterion("beetroots", PlacedBlockCriterion.Conditions.block(Blocks.BEETROOTS)).criterion("nether_wart", PlacedBlockCriterion.Conditions.block(Blocks.NETHER_WART)).build(consumer, "husbandry/plant_seed");
        Advancement advancement3 = Advancement.Builder.create().parent(advancement).display(Items.WHEAT, (Text)new TranslatableText("advancements.husbandry.breed_an_animal.title"), (Text)new TranslatableText("advancements.husbandry.breed_an_animal.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("bred", BredAnimalsCriterion.Conditions.any()).build(consumer, "husbandry/breed_an_animal");
        this.requireFoodItemsEaten(Advancement.Builder.create()).parent(advancement2).display(Items.APPLE, (Text)new TranslatableText("advancements.husbandry.balanced_diet.title"), (Text)new TranslatableText("advancements.husbandry.balanced_diet.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/balanced_diet");
        ...
        Advancement advancement4 = Advancement.Builder.create().parent(advancement).display(Items.LEAD, (Text)new TranslatableText("advancements.husbandry.tame_an_animal.title"), (Text)new TranslatableText("advancements.husbandry.tame_an_animal.description"), null, AdvancementFrame.TASK, true, true, false).criterion("tamed_animal", TameAnimalCriterion.Conditions.any()).build(consumer, "husbandry/tame_an_animal");
        this.requireListedAnimalsBred(Advancement.Builder.create()).parent(advancement3).display(Items.GOLDEN_CARROT, (Text)new TranslatableText("advancements.husbandry.breed_all_animals.title"), (Text)new TranslatableText("advancements.husbandry.breed_all_animals.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/bred_all_animals");
        ...
        Advancement advancement6 = this.requireListedFishBucketsFilled(Advancement.Builder.create()).parent(advancement5).criteriaMerger(CriterionMerger.OR).display(Items.PUFFERFISH_BUCKET, (Text)new TranslatableText("advancements.husbandry.tactical_fishing.title"), (Text)new TranslatableText("advancements.husbandry.tactical_fishing.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
        Advancement advancement7 = Advancement.Builder.create().parent(advancement6).criteriaMerger(CriterionMerger.OR).criterion(Registry.ITEM.getId(Items.AXOLOTL_BUCKET).getPath(), FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().items(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.title"), (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/axolotl_in_a_bucket");
        Advancement.Builder.create().parent(advancement7).criterion("kill_axolotl_target", EffectsChangedCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.AXOLOTL).build())).display(Items.TROPICAL_FISH_BUCKET, (Text)new TranslatableText("advancements.husbandry.kill_axolotl_target.title"), (Text)new TranslatableText("advancements.husbandry.kill_axolotl_target.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/kill_axolotl_target");
        this.requireAllCatsTamed(Advancement.Builder.create()).parent(advancement4).display(Items.COD, (Text)new TranslatableText("advancements.husbandry.complete_catalogue.title"), (Text)new TranslatableText("advancements.husbandry.complete_catalogue.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(consumer, "husbandry/complete_catalogue");
        ...
        Advancement advancement11 = this.requireAllFrogsOnLeads(Advancement.Builder.create()).parent(advancement10).display(Items.LEAD, (Text)new TranslatableText("advancements.husbandry.leash_all_frog_variants.title"), (Text)new TranslatableText("advancements.husbandry.leash_all_frog_variants.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/leash_all_frog_variants");
        ...
        Advancement.Builder.create().parent(advancement).display(Items.GLOW_INK_SAC, (Text)new TranslatableText("advancements.husbandry.make_a_sign_glow.title"), (Text)new TranslatableText("advancements.husbandry.make_a_sign_glow.description"), null, AdvancementFrame.TASK, true, true, false).criterion("make_a_sign_glow", ItemCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().tag(BlockTags.SIGNS).build()), ItemPredicate.Builder.create().items(Items.GLOW_INK_SAC))).build(consumer, "husbandry/make_a_sign_glow");
        Advancement advancement12 = Advancement.Builder.create().parent(advancement).display(Items.COOKIE, (Text)new TranslatableText("advancements.husbandry.allay_deliver_item_to_player.title"), (Text)new TranslatableText("advancements.husbandry.allay_deliver_item_to_player.description"), null, AdvancementFrame.TASK, true, true, true).criterion("allay_deliver_item_to_player", ThrownItemPickedUpByEntityCriterion.Conditions.createThrownItemPickedUpByPlayer(EntityPredicate.Extended.EMPTY, ItemPredicate.ANY, EntityPredicate.Extended.ofLegacy(EntityPredicate.Builder.create().type(EntityType.ALLAY).build()))).build(consumer, "husbandry/allay_deliver_item_to_player");
        Advancement.Builder.create().parent(advancement12).display(Items.NOTE_BLOCK, (Text)new TranslatableText("advancements.husbandry.allay_deliver_cake_to_note_block.title"), (Text)new TranslatableText("advancements.husbandry.allay_deliver_cake_to_note_block.description"), null, AdvancementFrame.CHALLENGE, true, true, true).criterion("allay_deliver_cake_to_note_block", ItemCriterion.Conditions.createAllayDropItemOnBlock(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(Blocks.NOTE_BLOCK).build()), ItemPredicate.Builder.create().items(Items.CAKE))).build(consumer, "husbandry/allay_deliver_cake_to_note_block");
    }
