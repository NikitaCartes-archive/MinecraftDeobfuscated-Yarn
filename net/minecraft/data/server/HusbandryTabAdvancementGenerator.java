...
implements Consumer<Consumer<Advancement>> {
    ...
    private static final Item[] field_33964 = new Item[]{Items.WOODEN_AXE, Items.GOLDEN_AXE, Items.STONE_AXE, Items.IRON_AXE, Items.DIAMOND_AXE, Items.NETHERITE_AXE};
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        this.requireListedAnimalsBred(Advancement.Task.create()).parent(advancement3).display(Items.GOLDEN_CARROT, (Text)new TranslatableText("advancements.husbandry.breed_all_animals.title"), (Text)new TranslatableText("advancements.husbandry.breed_all_animals.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/bred_all_animals");
        ...
        Advancement advancement6 = this.requireListedFishBucketsFilled(Advancement.Task.create()).parent(advancement5).criteriaMerger(CriterionMerger.OR).display(Items.PUFFERFISH_BUCKET, (Text)new TranslatableText("advancements.husbandry.tactical_fishing.title"), (Text)new TranslatableText("advancements.husbandry.tactical_fishing.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
        Advancement advancement7 = Advancement.Task.create().parent(advancement6).criteriaMerger(CriterionMerger.OR).criterion(Registry.ITEM.getId(Items.AXOLOTL_BUCKET).getPath(), FilledBucketCriterion.Conditions.create(ItemPredicate.Builder.create().item(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.title"), (Text)new TranslatableText("advancements.husbandry.axolotl_in_a_bucket.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/axolotl_in_a_bucket");
        Advancement.Task.create().parent(advancement7).criterion("kill_axolotl_target", EffectsChangedCriterion.Conditions.method_37224(EntityPredicate.Builder.create().type(EntityType.AXOLOTL).build())).display(Items.TROPICAL_FISH_BUCKET, (Text)new TranslatableText("advancements.husbandry.kill_axolotl_target.title"), (Text)new TranslatableText("advancements.husbandry.kill_axolotl_target.description"), null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/kill_axolotl_target");
        ...
        Advancement.Task.create().parent(advancement).display(Items.OAK_BOAT, (Text)new TranslatableText("advancements.husbandry.ride_a_boat_with_a_goat.title"), (Text)new TranslatableText("advancements.husbandry.ride_a_boat_with_a_goat.description"), null, AdvancementFrame.TASK, true, true, false).criterion("ride_a_boat_with_a_goat", StartedRidingCriterion.Conditions.create(EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create().type(EntityType.BOAT).method_37229(EntityPredicate.Builder.create().type(EntityType.GOAT).build()).build()))).build(consumer, "husbandry/ride_a_boat_with_a_goat");
        Advancement.Task.create().parent(advancement).display(Items.GLOW_INK_SAC, (Text)new TranslatableText("advancements.husbandry.make_a_sign_glow.title"), (Text)new TranslatableText("advancements.husbandry.make_a_sign_glow.description"), null, AdvancementFrame.TASK, true, true, false).criterion("make_a_sign_glow", ItemUsedOnBlockCriterion.Conditions.create(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().tag(BlockTags.SIGNS).build()), ItemPredicate.Builder.create().item(Items.GLOW_INK_SAC))).build(consumer, "husbandry/make_a_sign_glow");
    }
