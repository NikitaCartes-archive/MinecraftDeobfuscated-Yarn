...
implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
    ...
    public static final LootCondition.Builder field_11351 = LocationCheckLootCondition.builder(LocationPredicate.Builder.create().biome(Biomes.MODIFIED_JUNGLE_EDGE));
    public static final LootCondition.Builder field_11352 = LocationCheckLootCondition.builder(LocationPredicate.Builder.create().biome(Biomes.BAMBOO_JUNGLE_HILLS));
