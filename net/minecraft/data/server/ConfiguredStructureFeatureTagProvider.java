...
extends AbstractTagProvider<ConfiguredStructureFeature<?, ?>> {
    ...
    protected void configure() {
        this.getOrCreateTagBuilder(ConfiguredStructureFeatureTags.VILLAGE).add(ConfiguredStructureFeatureKeys.VILLAGE_PLAINS).add(ConfiguredStructureFeatureKeys.VILLAGE_DESERT).add(ConfiguredStructureFeatureKeys.VILLAGE_SAVANNA).add(ConfiguredStructureFeatureKeys.VILLAGE_SNOWY).add(ConfiguredStructureFeatureKeys.VILLAGE_TAIGA);
        this.getOrCreateTagBuilder(ConfiguredStructureFeatureTags.MINESHAFT).add(ConfiguredStructureFeatureKeys.MINESHAFT).add(ConfiguredStructureFeatureKeys.MINESHAFT_MESA);
