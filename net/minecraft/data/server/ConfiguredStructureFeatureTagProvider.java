...
extends AbstractTagProvider<StructureType> {
    ...
    protected void configure() {
        this.getOrCreateTagBuilder(ConfiguredStructureFeatureTags.VILLAGE).add(StructureTypeKeys.VILLAGE_PLAINS).add(StructureTypeKeys.VILLAGE_DESERT).add(StructureTypeKeys.VILLAGE_SAVANNA).add(StructureTypeKeys.VILLAGE_SNOWY).add(StructureTypeKeys.VILLAGE_TAIGA);
        ...
        this.getOrCreateTagBuilder(ConfiguredStructureFeatureTags.RUINED_PORTAL).add(StructureTypeKeys.RUINED_PORTAL_DESERT).add(StructureTypeKeys.RUINED_PORTAL_JUNGLE).add(StructureTypeKeys.RUINED_PORTAL_MOUNTAIN).add(StructureTypeKeys.RUINED_PORTAL_NETHER).add(StructureTypeKeys.RUINED_PORTAL_OCEAN).add(StructureTypeKeys.RUINED_PORTAL).add(StructureTypeKeys.RUINED_PORTAL_SWAMP);
