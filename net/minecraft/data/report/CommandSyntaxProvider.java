...
implements DataProvider {
    ...
    public void run(DataWriter writer) throws IOException {
        ...
        CommandDispatcher<ServerCommandSource> commandDispatcher = new CommandManager(CommandManager.RegistrationEnvironment.ALL, new CommandRegistryAccess(BuiltinRegistries.createBuiltinRegistryManager(), FeatureFlags.FEATURE_MANAGER.getFeatureSet())).getDispatcher();
