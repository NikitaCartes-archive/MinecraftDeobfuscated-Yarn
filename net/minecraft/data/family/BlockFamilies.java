...
public class BlockFamilies {
    ...
    public static final BlockFamily CUT_COPPER = BlockFamilies.register(Blocks.CUT_COPPER).slab(Blocks.CUT_COPPER_SLAB).stairs(Blocks.CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WAXED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.EXPOSED_CUT_COPPER).slab(Blocks.EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WAXED_LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily SEMI_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WAXED_SEMI_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).build();
    ...
    public static final BlockFamily NETHER_BRICK = BlockFamilies.register(Blocks.NETHER_BRICKS).fence(Blocks.NETHER_BRICK_FENCE).wall(Blocks.NETHER_BRICK_WALL).stairs(Blocks.NETHER_BRICK_STAIRS).slab(Blocks.NETHER_BRICK_SLAB).chsieled(Blocks.CHISELED_NETHER_BRICKS).method_34593(Blocks.CRACKED_NETHER_BRICKS).build();
    ...
    public static final BlockFamily QUARTZ_BLOCK = BlockFamilies.register(Blocks.QUARTZ_BLOCK).stairs(Blocks.QUARTZ_STAIRS).slab(Blocks.QUARTZ_SLAB).chsieled(Blocks.CHISELED_QUARTZ_BLOCK).noGenerateRecipes().build();
    ...
    public static final BlockFamily SANDSTONE = BlockFamilies.register(Blocks.SANDSTONE).wall(Blocks.SANDSTONE_WALL).stairs(Blocks.SANDSTONE_STAIRS).slab(Blocks.SANDSTONE_SLAB).chsieled(Blocks.CHISELED_SANDSTONE).noGenerateRecipes().build();
    ...
    public static final BlockFamily RED_SANDSTONE = BlockFamilies.register(Blocks.RED_SANDSTONE).wall(Blocks.RED_SANDSTONE_WALL).stairs(Blocks.RED_SANDSTONE_STAIRS).slab(Blocks.RED_SANDSTONE_SLAB).chsieled(Blocks.CHISELED_RED_SANDSTONE).noGenerateRecipes().build();
    ...
    public static final BlockFamily STONE_BRICK = BlockFamilies.register(Blocks.STONE_BRICKS).wall(Blocks.STONE_BRICK_WALL).stairs(Blocks.STONE_BRICK_STAIRS).slab(Blocks.STONE_BRICK_SLAB).chsieled(Blocks.CHISELED_STONE_BRICKS).method_34593(Blocks.CRACKED_STONE_BRICKS).noGenerateRecipes().build();
    public static final BlockFamily field_28946 = BlockFamilies.register(Blocks.DEEPSLATE).build();
    public static final BlockFamily field_29079 = BlockFamilies.register(Blocks.COBBLED_DEEPSLATE).slab(Blocks.COBBLED_DEEPSLATE_SLAB).stairs(Blocks.COBBLED_DEEPSLATE_STAIRS).wall(Blocks.COBBLED_DEEPSLATE_WALL).chsieled(Blocks.CHISELED_DEEPSLATE).polished(Blocks.POLISHED_DEEPSLATE).build();
    ...
    public static final BlockFamily field_28949 = BlockFamilies.register(Blocks.DEEPSLATE_BRICKS).slab(Blocks.DEEPSLATE_BRICK_SLAB).stairs(Blocks.DEEPSLATE_BRICK_STAIRS).wall(Blocks.DEEPSLATE_BRICK_WALL).method_34593(Blocks.CRACKED_DEEPSLATE_BRICKS).build();
    public static final BlockFamily field_28948 = BlockFamilies.register(Blocks.DEEPSLATE_TILES).slab(Blocks.DEEPSLATE_TILE_SLAB).stairs(Blocks.DEEPSLATE_TILE_STAIRS).wall(Blocks.DEEPSLATE_TILE_WALL).method_34593(Blocks.CRACKED_DEEPSLATE_TILES).build();
