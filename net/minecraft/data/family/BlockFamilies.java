...
public class BlockFamilies {
    ...
    public static final BlockFamily field_33684 = BlockFamilies.register(Blocks.COPPER_BLOCK).method_36544(Blocks.CUT_COPPER).noGenerateModels().build();
    ...
    public static final BlockFamily field_33685 = BlockFamilies.register(Blocks.WAXED_COPPER_BLOCK).method_36544(Blocks.WAXED_CUT_COPPER).group("waxed_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily field_33686 = BlockFamilies.register(Blocks.EXPOSED_COPPER).method_36544(Blocks.EXPOSED_CUT_COPPER).noGenerateModels().build();
    public static final BlockFamily EXPOSED_CUT_COPPER = BlockFamilies.register(Blocks.EXPOSED_CUT_COPPER).slab(Blocks.EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily field_33687 = BlockFamilies.register(Blocks.WAXED_EXPOSED_COPPER).method_36544(Blocks.WAXED_EXPOSED_CUT_COPPER).group("waxed_exposed_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily field_33688 = BlockFamilies.register(Blocks.WEATHERED_COPPER).method_36544(Blocks.WEATHERED_CUT_COPPER).noGenerateModels().build();
    public static final BlockFamily WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily field_33681 = BlockFamilies.register(Blocks.WAXED_WEATHERED_COPPER).method_36544(Blocks.WAXED_WEATHERED_CUT_COPPER).group("waxed_weathered_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily field_33682 = BlockFamilies.register(Blocks.OXIDIZED_COPPER).method_36544(Blocks.OXIDIZED_CUT_COPPER).noGenerateModels().build();
    public static final BlockFamily OXIDIZED_CUT_COPPER = BlockFamilies.register(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily field_33683 = BlockFamilies.register(Blocks.WAXED_OXIDIZED_COPPER).method_36544(Blocks.WAXED_OXIDIZED_CUT_COPPER).group("waxed_oxidized_cut_copper").noGenerateModels().build();
    ...
    public static final BlockFamily SANDSTONE = BlockFamilies.register(Blocks.SANDSTONE).wall(Blocks.SANDSTONE_WALL).stairs(Blocks.SANDSTONE_STAIRS).slab(Blocks.SANDSTONE_SLAB).chiseled(Blocks.CHISELED_SANDSTONE).method_36544(Blocks.CUT_SANDSTONE).noGenerateRecipes().build();
    ...
    public static final BlockFamily RED_SANDSTONE = BlockFamilies.register(Blocks.RED_SANDSTONE).wall(Blocks.RED_SANDSTONE_WALL).stairs(Blocks.RED_SANDSTONE_STAIRS).slab(Blocks.RED_SANDSTONE_SLAB).chiseled(Blocks.CHISELED_RED_SANDSTONE).method_36544(Blocks.CUT_RED_SANDSTONE).noGenerateRecipes().build();
