...
public class BlockFamilies {
    ...
    public static final BlockFamily WAXED_EXPOSED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).noGenerateModels().build();
    ...
    public static final BlockFamily WAXED_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    ...
    public static final BlockFamily WAXED_OXIDIZED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).noGenerateModels().build();
    ...
    public static final BlockFamily SANDSTONE = BlockFamilies.register(Blocks.SANDSTONE).wall(Blocks.SANDSTONE_WALL).stairs(Blocks.SANDSTONE_STAIRS).slab(Blocks.SANDSTONE_SLAB).chiseled(Blocks.CHISELED_SANDSTONE).noGenerateRecipes().build();
    ...
    public static final BlockFamily RED_SANDSTONE = BlockFamilies.register(Blocks.RED_SANDSTONE).wall(Blocks.RED_SANDSTONE_WALL).stairs(Blocks.RED_SANDSTONE_STAIRS).slab(Blocks.RED_SANDSTONE_SLAB).chiseled(Blocks.CHISELED_RED_SANDSTONE).noGenerateRecipes().build();
