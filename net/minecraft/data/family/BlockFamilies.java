...
public class BlockFamilies {
    ...
    public static final BlockFamily POLISHED_BLACKSTONE_BRICK = BlockFamilies.register(Blocks.POLISHED_BLACKSTONE_BRICKS).wall(Blocks.POLISHED_BLACKSTONE_BRICK_WALL).stairs(Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS).slab(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB).build();
    ...
    public static final BlockFamily LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.LIGHTLY_WEATHERED_CUT_COPPER).slab(Blocks.LIGHTLY_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.LIGHTLY_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WAXED_LIGHTLY_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_LIGHTLY_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily SEMI_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.SEMI_WEATHERED_CUT_COPPER).slab(Blocks.SEMI_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.SEMI_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WAXED_SEMI_WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_SEMI_WEATHERED_CUT_COPPER_STAIRS).noGenerateModels().build();
    public static final BlockFamily WEATHERED_CUT_COPPER = BlockFamilies.register(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).build();
    ...
    public static final BlockFamily NETHER_BRICK = BlockFamilies.register(Blocks.NETHER_BRICKS).fence(Blocks.NETHER_BRICK_FENCE).wall(Blocks.NETHER_BRICK_WALL).stairs(Blocks.NETHER_BRICK_STAIRS).slab(Blocks.NETHER_BRICK_SLAB).chsieled(Blocks.CHISELED_NETHER_BRICKS).build();
