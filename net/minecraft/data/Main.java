...
public class Main {
    ...
    public static DataGenerator create(Path output2, Collection<Path> inputs, boolean includeClient, boolean includeServer, boolean includeDev, boolean includeReports, boolean validate, GameVersion gameVersion, boolean ignoreCache) {
        ...
        TagProvider tagProvider2 = pack3.addProvider(Main.toFactory(OneTwentyBlockTagProvider::new, completableFuture2));
        pack3.addProvider(output -> new OneTwentyItemTagProvider(output, completableFuture2, tagProvider2));
        pack3.addProvider(Main.toFactory(OneTwentyBiomeTagProvider::new, completableFuture2));
        pack3.addProvider(OneTwentyLootTableProviders::createOneTwentyProvider);
        pack3.addProvider(Main.toFactory(OneTwentyAdvancementProviders::createOneTwentyProvider, completableFuture2));
