...
public class BlockStateModelGenerator {
    ...
    private void registerCommandBlock(Block commandBlock) {
        ...
        Identifier identifier2 = this.createSubModel(commandBlock, "_conditional", Models.TEMPLATE_COMMAND_BLOCK, id -> texture.copyAndAdd(TextureKey.SIDE, (Identifier)id));
    ...
    private void registerChorusFlower() {
        ...
        Identifier identifier2 = this.createSubModel(Blocks.CHORUS_FLOWER, "_dead", Models.TEMPLATE_CHORUS_FLOWER, id -> texture.copyAndAdd(TextureKey.TEXTURE, (Identifier)id));
