...
public class BlockStateModelGenerator {
    ...
    private static BlockStateSupplier method_34608(Block block, Identifier identifier, Texture texture, BiConsumer<Identifier, Supplier<JsonElement>> biConsumer) {
        Identifier identifier2 = Models.CUBE_MIRRORED_ALL.upload(block, texture, biConsumer);
        return BlockStateModelGenerator.createBlockStateWithTwoModelAndRandomInversion(block, identifier, identifier2);
    }

    private static BlockStateSupplier method_34631(Block block, Identifier identifier, Texture texture, BiConsumer<Identifier, Supplier<JsonElement>> biConsumer) {
        Identifier identifier2 = Models.CUBE_COLUMN_MIRRORED.upload(block, texture, biConsumer);
        return BlockStateModelGenerator.createBlockStateWithTwoModelAndRandomInversion(block, identifier, identifier2).coordinate(BlockStateModelGenerator.createAxisRotatedVariantMap());
    }
    ...
    private BlockTexturePool registerCubeAllModelTexturePool(Block block) {
        TexturedModel texturedModel = this.field_28551.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
    ...
    private void registerGourd(Block stemBlock, Block attachedStemBlock) {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(stemBlock).coordinate(BlockStateVariantMap.create(Properties.AGE_7).register(integer -> BlockStateVariant.create().put(VariantSettings.MODEL, Models.STEM_GROWTH_STAGES[integer].upload(stemBlock, texture, this.modelCollector)))));
    }
    ...
    private void registerSunflower() {
        ...
        Identifier identifier2 = this.createSubModel(Blocks.SUNFLOWER, "_bottom", TintType.NOT_TINTED.getCrossModel(), Texture::cross);
    ...
    private void method_33712() {
        ...
        List<BlockStateVariant> list = Arrays.asList(BlockStateModelGenerator.createModelVariantWithRandomHorizontalRotations(identifier));
        List<BlockStateVariant> list2 = Arrays.asList(BlockStateModelGenerator.createModelVariantWithRandomHorizontalRotations(identifier2));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.SMALL_DRIPLEAF).coordinate(BlockStateVariantMap.create(Properties.DOUBLE_BLOCK_HALF).register(DoubleBlockHalf.LOWER, list2).register(DoubleBlockHalf.UPPER, list)));
    }
    ...
    private void registerCommandBlock(Block commandBlock) {
        ...
        Identifier identifier2 = Models.TEMPLATE_COMMAND_BLOCK.upload(commandBlock, texture, this.modelCollector);
        Identifier identifier22 = this.createSubModel(commandBlock, "_conditional", Models.TEMPLATE_COMMAND_BLOCK, identifier -> texture.copyAndAdd(TextureKey.SIDE, (Identifier)identifier));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(commandBlock).coordinate(BlockStateModelGenerator.createBooleanModelMap(Properties.CONDITIONAL, identifier22, identifier2)).coordinate(BlockStateModelGenerator.createNorthDefaultRotationStates()));
    }
    ...
    private void registerCauldron() {
        ...
        this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(Blocks.LAVA_CAULDRON, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.LAVA_CAULDRON, Texture.method_32232(Texture.getSubId(Blocks.LAVA, "_still")), this.modelCollector)));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.WATER_CAULDRON).coordinate(BlockStateVariantMap.create(LeveledCauldronBlock.LEVEL).register((Integer)1, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL1.upload(Blocks.WATER_CAULDRON, "_level1", Texture.method_32232(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector))).register((Integer)2, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL2.upload(Blocks.WATER_CAULDRON, "_level2", Texture.method_32232(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector))).register((Integer)3, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.WATER_CAULDRON, "_full", Texture.method_32232(Texture.getSubId(Blocks.WATER, "_still")), this.modelCollector)))));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.POWDER_SNOW_CAULDRON).coordinate(BlockStateVariantMap.create(LeveledCauldronBlock.LEVEL).register((Integer)1, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL1.upload(Blocks.POWDER_SNOW_CAULDRON, "_level1", Texture.method_32232(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector))).register((Integer)2, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_LEVEL2.upload(Blocks.POWDER_SNOW_CAULDRON, "_level2", Texture.method_32232(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector))).register((Integer)3, BlockStateVariant.create().put(VariantSettings.MODEL, Models.TEMPLATE_CAULDRON_FULL.upload(Blocks.POWDER_SNOW_CAULDRON, "_full", Texture.method_32232(Texture.getId(Blocks.POWDER_SNOW)), this.modelCollector)))));
    }

    private void registerChorusFlower() {
        Texture texture = Texture.texture(Blocks.CHORUS_FLOWER);
        Identifier identifier2 = Models.TEMPLATE_CHORUS_FLOWER.upload(Blocks.CHORUS_FLOWER, texture, this.modelCollector);
        Identifier identifier22 = this.createSubModel(Blocks.CHORUS_FLOWER, "_dead", Models.TEMPLATE_CHORUS_FLOWER, identifier -> texture.copyAndAdd(TextureKey.TEXTURE, (Identifier)identifier));
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.CHORUS_FLOWER).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.AGE_5, 5, identifier22, identifier2)));
    }
    ...
    private void registerTopSoils() {
        ...
        Texture texture2 = new Texture().put(TextureKey.BOTTOM, identifier).inherit(TextureKey.BOTTOM, TextureKey.PARTICLE).put(TextureKey.TOP, Texture.getSubId(Blocks.GRASS_BLOCK, "_top")).put(TextureKey.SIDE, Texture.getSubId(Blocks.GRASS_BLOCK, "_snow"));
        BlockStateVariant blockStateVariant = BlockStateVariant.create().put(VariantSettings.MODEL, Models.CUBE_BOTTOM_TOP.upload(Blocks.GRASS_BLOCK, "_snow", texture2, this.modelCollector));
        this.registerTopSoil(Blocks.GRASS_BLOCK, ModelIds.getBlockModelId(Blocks.GRASS_BLOCK), blockStateVariant);
        Identifier identifier2 = TexturedModel.CUBE_BOTTOM_TOP.get(Blocks.MYCELIUM).texture(texture -> texture.put(TextureKey.BOTTOM, identifier)).upload(Blocks.MYCELIUM, this.modelCollector);
        this.registerTopSoil(Blocks.MYCELIUM, identifier2, blockStateVariant);
        Identifier identifier3 = TexturedModel.CUBE_BOTTOM_TOP.get(Blocks.PODZOL).texture(texture -> texture.put(TextureKey.BOTTOM, identifier)).upload(Blocks.PODZOL, this.modelCollector);
    ...
    private void method_33520(Block block) {
        ...
        field_28548.forEach((booleanProperty, function) -> {
    ...
    private void registerRoots(Block root, Block pottedRoot) {
        ...
        Identifier identifier = TintType.NOT_TINTED.getFlowerPotCrossModel().upload(pottedRoot, texture, this.modelCollector);
    ...
    public void register() {
        ...
        this.registerCubeAllModelTexturePool(Blocks.CUT_COPPER).family(BlockFamilies.CUT_COPPER).method_32230(Blocks.WAXED_CUT_COPPER).family(BlockFamilies.WAXED_CUT_COPPER);
        this.registerCubeAllModelTexturePool(Blocks.EXPOSED_CUT_COPPER).family(BlockFamilies.LIGHTLY_WEATHERED_CUT_COPPER).method_32230(Blocks.WAXED_EXPOSED_CUT_COPPER).family(BlockFamilies.WAXED_LIGHTLY_WEATHERED_CUT_COPPER);
        this.registerCubeAllModelTexturePool(Blocks.WEATHERED_CUT_COPPER).family(BlockFamilies.SEMI_WEATHERED_CUT_COPPER).method_32230(Blocks.WAXED_WEATHERED_CUT_COPPER).family(BlockFamilies.WAXED_SEMI_WEATHERED_CUT_COPPER);
        ...
        this.method_33520(Blocks.VINE);
        this.method_33520(Blocks.GLOW_LICHEN);
    ...
    class BlockTexturePool {
        private final Texture texture;
        private final Map<Model, Identifier> field_28553 = Maps.newHashMap();
        @Nullable
        ...
        public BlockTexturePool base(Block block, Model model) {
            ...
            if (BlockStateModelGenerator.this.field_29504.containsKey(block)) {
                BlockStateModelGenerator.this.blockStateCollector.accept(((class_5879)BlockStateModelGenerator.this.field_29504.get(block)).create(block, this.baseModelId, this.texture, BlockStateModelGenerator.this.modelCollector));
            } else {
        ...
        public BlockTexturePool slab(Block block) {
            ...
            Identifier identifier = this.method_33524(Models.SLAB, block);
            Identifier identifier2 = this.method_33524(Models.SLAB_TOP, block);
        ...
        public BlockTexturePool stairs(Block block) {
            Identifier identifier = this.method_33524(Models.INNER_STAIRS, block);
            Identifier identifier2 = this.method_33524(Models.STAIRS, block);
            Identifier identifier3 = this.method_33524(Models.OUTER_STAIRS, block);
        ...
        private BlockTexturePool method_34661(Block block) {
            TexturedModel texturedModel = BlockStateModelGenerator.this.field_28551.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
        ...
        private BlockTexturePool method_33527(Block block) {
            BlockStateModelGenerator.this.registerDoor(block);
            return this;
        }

        private void method_33528(Block block) {
            if (BlockStateModelGenerator.this.field_28549.contains(block)) {
        ...
        private Identifier method_33524(Model model2, Block block) {
            return this.field_28553.computeIfAbsent(model2, model -> model.upload(block, this.texture, (BiConsumer<Identifier, Supplier<JsonElement>>)BlockStateModelGenerator.this.modelCollector));
        }

        public BlockTexturePool family(BlockFamily family) {
            this.family = family;
            family.getVariants().forEach((variant, block) -> {
                BiConsumer biConsumer = (BiConsumer)VARIANT_POOL_FUNCTIONS.get(variant);
                if (biConsumer != null) {
