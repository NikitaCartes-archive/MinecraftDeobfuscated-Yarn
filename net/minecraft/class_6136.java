...
public class class_6136
extends LongLinkedOpenHashSet {
    private final class_6137 field_31715;

    public class_6136(int i, float f) {
        super(i, f);
        this.field_31715 = new class_6137(i / 64, f);
    }
    ...
    public static class class_6137
    extends Long2LongLinkedOpenHashMap {
        ...
        private static final int field_31718;
        private static final int field_31719 = 0;
        private static final int field_31720;
        private static final int field_31721;
        private static final long field_31722;
        ...
        static long method_35483(long l) {
            return l & (field_31722 ^ 0xFFFFFFFFFFFFFFFFL);
        }
        ...
        public boolean method_35487(long l) {
            int j;
            long m = class_6137.method_35483(l);
            int i = class_6137.method_35486(l);
            long n = 1L << i;
            if (m == 0L) {
        ...
        public long method_35481() {
            ...
            return class_6137.method_35484(l, j);
        }
        ...
        static {
            field_31720 = field_31718 = 64 - field_31716 - field_31717;
            field_31721 = field_31718 + field_31717;
            field_31722 = 3L << field_31721 | 3L | 3L << field_31720;
        }
    }
}
