...
extends class_4585 {
    ...
    public void next() {
        ...
        this.field_20866.vertex(this.field_20870, this.field_20871, this.field_20872).color(this.field_20873, this.field_20874, this.field_20875, this.field_20876).texture(i, j).method_22917(this.field_20877, this.field_20878).method_22916(this.field_20879).method_22914(this.field_20880, this.field_20881, this.field_20882).next();
        this.method_22891();
    }
