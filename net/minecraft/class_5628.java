...
implements class_5627 {
    ...
    public void method_32302(StringTag stringTag) {
        ...
        MutableText text = new LiteralText(string.substring(1, string.length() - 1)).formatted(field_27834);
        this.field_27842 = new LiteralText(string2).append(text).append(string2);
    }

    @Override
    public void method_32291(ByteTag byteTag) {
        MutableText text = new LiteralText("b").formatted(field_27836);
    ...
    public void method_32301(ShortTag shortTag) {
        MutableText text = new LiteralText("s").formatted(field_27836);
    ...
    public void method_32300(LongTag longTag) {
        MutableText text = new LiteralText("L").formatted(field_27836);
    ...
    public void method_32295(FloatTag floatTag) {
        MutableText text = new LiteralText("f").formatted(field_27836);
    ...
    public void method_32293(DoubleTag doubleTag) {
        MutableText text = new LiteralText("d").formatted(field_27836);
    ...
    public void method_32296(IntArrayTag intArrayTag) {
        MutableText text = new LiteralText("I").formatted(field_27836);
        MutableText mutableText = new LiteralText("[").append(text).append(";");
    ...
    public void method_32299(LongArrayTag longArrayTag) {
        ...
        for (int i = 0; i < ls.length; ++i) {
            MutableText text2 = new LiteralText(String.valueOf(ls[i])).formatted(field_27835);
    ...
    public void method_32298(ListTag listTag) {
        ...
        if (field_27832.contains(listTag.getElementType()) && listTag.size() <= 8) {
        ...
        for (int j = 0; j < listTag.size(); ++j) {
            LiteralText mutableText3 = new LiteralText(Strings.repeat(this.field_27840, this.field_27841 + 1));
    ...
    public void method_32292(CompoundTag compoundTag) {
        ...
        while (iterator.hasNext()) {
            ...
            MutableText mutableText2 = new LiteralText(Strings.repeat(this.field_27840, this.field_27841 + 1)).append(class_5628.method_32304(string)).append(field_27838).append(" ").append(new class_5628(this.field_27840, this.field_27841 + 1).method_32305(compoundTag.get(string)));
            if (iterator.hasNext()) {
    ...
    protected static Text method_32304(String string) {
        ...
        MutableText text = new LiteralText(string2.substring(1, string2.length() - 1)).formatted(field_27833);
