...
extends class_4588 {
    ...
    @Override
    default public class_4588 vertex(double d, double e, double f) {
    ...
    @Override
    default public class_4588 color(int i, int j, int k, int l) {
    ...
    @Override
    default public class_4588 texture(float f, float g) {
    ...
    @Override
    default public class_4588 method_22917(int i, int j) {
        return this.method_22899((short)i, (short)j, 1);
    }

    @Override
    default public class_4588 method_22921(int i, int j) {
        return this.method_22899((short)i, (short)j, 2);
    }

    default public class_4588 method_22899(short s, short t, int i) {
    ...
    @Override
    default public class_4588 method_22914(float f, float g, float h) {
