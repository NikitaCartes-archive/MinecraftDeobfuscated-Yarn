...
public enum class_5000 implements StringIdentifiable
{
    ...
    private static final Int2ObjectMap<class_5000> field_23393;
    ...
    public static class_5000 method_26425(Direction direction, Direction direction2) {
        int i = class_5000.method_26427(direction2, direction);
        return (class_5000)field_23393.get(i);
    }
    ...
    static {
        field_23393 = new Int2ObjectOpenHashMap<class_5000>(class_5000.values().length);
        for (class_5000 lv : class_5000.values()) {
            field_23393.put(class_5000.method_26427(lv.field_23395, lv.field_23396), lv);
        }
    }
}
