...
extends Fluid {
    ...
    protected FluidState getUpdatedState(WorldView worldView, BlockPos blockPos, BlockState blockState) {
        ...
        for (Direction direction : Direction.Type.HORIZONTAL) {
            ...
            if (!fluidState.getFluid().matchesType(this) || !this.receivesFlow(direction, worldView, blockPos, blockState, blockPos2, blockState2)) continue;
        ...
        if (!(fluidState3 = (blockState4 = worldView.getBlockState(blockPos3 = blockPos.up())).getFluidState()).isEmpty() && fluidState3.getFluid().matchesType(this) && this.receivesFlow(Direction.UP, worldView, blockPos, blockState, blockPos3, blockState4)) {
