...
public class class_5377 {
    ...
    public void method_29732(Consumer<RecipeJsonProvider> consumer, Identifier identifier) {
        ...
        this.field_25494.parent(new Identifier("recipes/root")).criterion("has_the_recipe", RecipeUnlockedCriterion.create(identifier)).rewards(AdvancementRewards.Builder.recipe(identifier)).criteriaMerger(CriteriaMerger.OR);
        consumer.accept(new class_5378(identifier, this.field_25495, this.field_25491, this.field_25492, this.field_25493, this.field_25494, new Identifier(identifier.getNamespace(), "recipes/" + this.field_25493.getGroup().getName() + "/" + identifier.getPath())));
    }
    ...
    implements RecipeJsonProvider {
        ...
        public class_5378(Identifier identifier, RecipeSerializer<?> recipeSerializer, Ingredient ingredient, Ingredient ingredient2, Item item, Advancement.Task task, Identifier identifier2) {
