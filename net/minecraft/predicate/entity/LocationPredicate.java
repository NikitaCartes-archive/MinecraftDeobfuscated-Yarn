...
public class LocationPredicate {
    public static final LocationPredicate ANY = new LocationPredicate(NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, null, null, null, class_4552.field_20712, class_4550.field_20692, class_4551.field_20708);
    ...
    public LocationPredicate(NumberRange.FloatRange floatRange, NumberRange.FloatRange floatRange2, NumberRange.FloatRange floatRange3, @Nullable Biome biome, @Nullable StructureFeature<?> structureFeature, @Nullable DimensionType dimensionType, class_4552 arg, class_4550 arg2, class_4551 arg3) {
        this.x = floatRange;
        this.y = floatRange2;
        this.z = floatRange3;
        this.biome = biome;
    ...
    public static LocationPredicate biome(Biome biome) {
        return new LocationPredicate(NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, biome, null, null, class_4552.field_20712, class_4550.field_20692, class_4551.field_20708);
    }

    public static LocationPredicate dimension(DimensionType dimensionType) {
        return new LocationPredicate(NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, null, null, dimensionType, class_4552.field_20712, class_4550.field_20692, class_4551.field_20708);
    }

    public static LocationPredicate feature(StructureFeature<?> structureFeature) {
        return new LocationPredicate(NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, NumberRange.FloatRange.ANY, null, structureFeature, null, class_4552.field_20712, class_4550.field_20692, class_4551.field_20708);
    }
    ...
    public boolean test(ServerWorld serverWorld, float f, float g, float h) {
        ...
        if (!this.field_20714.method_22483(serverWorld, blockPos)) {
            return false;
        }
        if (!this.field_20715.method_22454(serverWorld, blockPos)) {
            return false;
        }
        return this.field_20716.method_22475(serverWorld, blockPos);
    }
    ...
    public static class Builder {
        ...
        public static Builder method_22484() {
            return new Builder();
        }
