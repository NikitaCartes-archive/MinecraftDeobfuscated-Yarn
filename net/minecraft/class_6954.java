...
public class class_6954 {
    ...
    public static class_6953 method_40544(GenerationShapeConfig generationShapeConfig, boolean bl, boolean bl2, long l, Registry<DoublePerlinNoiseSampler.NoiseParameters> registry, ChunkRandom.RandomProvider randomProvider) {
        class_6910 lv64;
        class_6910 lv63;
        class_6910 lv57;
        class_6910 lv56;
        ...
        class_6910 lv2 = class_6916.method_40494(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.AQUIFER_FLUID_LEVEL_FLOODEDNESS), 0.67);
        ...
        class_6910 lv4 = class_6916.method_40494(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.AQUIFER_FLUID_LEVEL_SPREAD), 0.7142857142857143);
        ...
        class_6910 lv11 = class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_2D_MODULATOR), 2.0, 1.0);
        class_6910 lv12 = class_6916.method_40491(lv11, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_2D), CaveScaler::scaleCaves, 3.0);
        class_6910 lv13 = class_6916.method_40496(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_2D_ELEVATION), 0.0, generationShapeConfig.minimumBlockY(), 8.0);
        class_6910 lv14 = class_6916.method_40507(class_6916.method_40497(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_2D_THICKNESS), 2.0, 1.0, -0.6, -1.3));
        ...
        class_6910 lv19 = class_6916.method_40507(class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_3D_RARITY), 2.0, 1.0));
        class_6910 lv20 = class_6916.method_40495(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_3D_THICKNESS), -0.065, -0.088);
        class_6910 lv21 = class_6916.method_40491(lv19, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_3D_1), CaveScaler::scaleTunnels, 2.0);
        class_6910 lv22 = class_6916.method_40491(lv19, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_3D_2), CaveScaler::scaleTunnels, 2.0);
        ...
        class_6910 lv25 = class_6916.method_40495(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.SPAGHETTI_ROUGHNESS_MODULATOR), 0.0, -0.1);
        ...
        class_6910 lv32 = class_6916.method_40494(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.CAVE_CHEESE), 0.6666666666666666);
        int i = DimensionType.MIN_HEIGHT * 2;
        int j = DimensionType.MAX_COLUMN_HEIGHT * 2;
        class_6910 lv33 = class_6916.method_40481(i, j, i, j);
        ...
        class_6910 lv34 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.ORE_VEININESS), 1.5, 1.5), m, n, 0);
        float g = 4.0f;
        class_6910 lv35 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.ORE_VEIN_A), 4.0, 4.0), m, n, 0).method_40471();
        class_6910 lv36 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.ORE_VEIN_B), 4.0, 4.0), m, n, 0).method_40471();
        ...
        if (bl2) {
            lv39 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.NOODLE), 1.0, 1.0), o, p, -1);
            class_6910 lv40 = class_6954.method_40539(lv33, class_6916.method_40497(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.NOODLE_THICKNESS), 1.0, 1.0, -0.05, -0.1), o, p, 0);
            double h = 2.6666666666666665;
            class_6910 lv41 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.NOODLE_RIDGE_A), 2.6666666666666665, 2.6666666666666665), o, p, 0);
            lv42 = class_6954.method_40539(lv33, class_6916.method_40502(NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.NOODLE_RIDGE_B), 2.6666666666666665, 2.6666666666666665), o, p, 0);
            lv43 = class_6916.method_40500(class_6916.method_40480(1.5), class_6916.method_40508(lv41.method_40471(), lv42.method_40471()));
        ...
        if (randomProvider != ChunkRandom.RandomProvider.LEGACY) {
            lv39 = new InterpolatedNoiseSampler(randomDeriver.createRandom(new Identifier("terrain")), generationShapeConfig.sampling(), generationShapeConfig.horizontalBlockSize(), generationShapeConfig.verticalBlockSize());
            doublePerlinNoiseSampler = NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, bl3 ? NoiseParametersKeys.TEMPERATURE_LARGE : NoiseParametersKeys.TEMPERATURE);
            doublePerlinNoiseSampler2 = NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, bl3 ? NoiseParametersKeys.VEGETATION_LARGE : NoiseParametersKeys.VEGETATION);
            doublePerlinNoiseSampler3 = NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.OFFSET);
        } else {
            lv39 = new InterpolatedNoiseSampler(randomProvider.create(l), generationShapeConfig.sampling(), generationShapeConfig.horizontalBlockSize(), generationShapeConfig.verticalBlockSize());
            ...
            doublePerlinNoiseSampler3 = DoublePerlinNoiseSampler.create(randomDeriver.createRandom(NoiseParametersKeys.OFFSET.getValue()), new DoublePerlinNoiseSampler.NoiseParameters(0, 0.0, new double[0]));
        }
        lv42 = class_6916.method_40499(class_6916.method_40504(class_6916.method_40501(doublePerlinNoiseSampler3)));
        lv43 = class_6916.method_40499(class_6916.method_40504(class_6916.method_40506(doublePerlinNoiseSampler3)));
        ...
        class_6910 lv47 = class_6916.method_40499(class_6916.method_40487(lv42, lv43, 0.25, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, bl3 ? NoiseParametersKeys.CONTINENTALNESS_LARGE : NoiseParametersKeys.CONTINENTALNESS)));
        class_6910 lv48 = class_6916.method_40499(class_6916.method_40487(lv42, lv43, 0.25, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, bl3 ? NoiseParametersKeys.EROSION_LARGE : NoiseParametersKeys.EROSION)));
        class_6910 lv49 = class_6916.method_40499(class_6916.method_40487(lv42, lv43, 0.25, NoiseParametersKeys.createNoiseSampler(registry, randomDeriver, NoiseParametersKeys.RIDGE)));
        VanillaTerrainParameters vanillaTerrainParameters = generationShapeConfig.terrainParameters();
        class_6910 lv50 = class_6954.method_40541(lv47, lv48, lv49, vanillaTerrainParameters::getOffset, -0.81, 2.5, class_6916.method_40503());
        class_6910 lv51 = class_6954.method_40541(lv47, lv48, lv49, vanillaTerrainParameters::getFactor, 0.0, 8.0, field_36618);
        class_6910 lv52 = class_6954.method_40541(lv47, lv48, lv49, vanillaTerrainParameters::getPeak, 0.0, 1.28, field_36619);
        ...
        if (generationShapeConfig.islandNoiseOverride()) {
            ...
            lv56 = class_6954.method_40540(lv53, lv51, lv55);
            lv57 = class_6954.method_40540(lv53, class_6916.method_40504(lv51), class_6916.method_40479());
        }
        boolean bl4 = !bl;
        class_6910 lv58 = class_6916.method_40507(class_6916.method_40486(lv56, lv39));
        class_6910 lv59 = class_6916.method_40486(class_6916.method_40486(class_6916.method_40480(0.27), lv32).method_40468(-1.0, 1.0), class_6916.method_40486(class_6916.method_40480(1.5), class_6916.method_40500(class_6916.method_40480(-0.64), lv58)).method_40468(0.0, 0.5));
        ...
        if (bl4) {
            ...
            lv64 = class_6916.method_40505(lv58, class_6916.method_40500(class_6916.method_40480(5.0), lv29));
            lv63 = class_6916.method_40485(lv58, Double.NEGATIVE_INFINITY, 1.5625, lv64, lv62);
        }
        lv64 = class_6916.method_40492(generationShapeConfig, lv63);
        ...
        return new class_6953(lv, lv2, lv4, lv3, randomDeriver2, randomDeriver3, lv45, lv46, lv47, lv48, lv53, lv49, lv57, lv67, lv34, lv37, lv38, new VanillaBiomeParameters().getSpawnSuitabilityNoises());
    }

    private static class_6910 method_40541(class_6910 arg, class_6910 arg2, class_6910 arg3, ToFloatFunction<VanillaTerrainParameters.NoisePoint> toFloatFunction, double d, double e, class_6910 arg4) {
    ...
    private static class_6910 method_40539(class_6910 arg, class_6910 arg2, int i, int j, int k) {
        return class_6916.method_40483(class_6916.method_40485(arg, i, j + 1, arg2, class_6916.method_40480(k)));
    }
    ...
    protected static double method_40543(GenerationShapeConfig generationShapeConfig, class_6910 arg, int i, int j) {
