...
import net.minecraft.class_4586;
...
public class class_4599 {
    ...
    private final SortedMap<BlockRenderLayer, BufferBuilder> field_20957 = SystemUtil.consume(new Object2ObjectLinkedOpenHashMap(), object2ObjectLinkedOpenHashMap -> {
    ...
    private final class_4597 field_20962 = blockRenderLayer -> {
        ...
        if (blockRenderLayer.method_23035()) {
            return new class_4589(ImmutableList.of(this.field_20961, lv));
        }
        return lv;
    };
