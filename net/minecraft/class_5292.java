...
Drawable {
    private static final Map<class_5285.class_5288, class_5293> field_24590 = ImmutableMap.of(class_5285.class_5288.field_24553, (createWorldScreen, arg) -> new CustomizeFlatLevelScreen(createWorldScreen, flatChunkGeneratorConfig -> createWorldScreen.field_24588.method_28086(arg.method_28019((FlatChunkGeneratorConfig)flatChunkGeneratorConfig)), arg.method_28040()), class_5285.class_5288.field_24555, (createWorldScreen, arg) -> new CustomizeBuffetLevelScreen(createWorldScreen, pair -> createWorldScreen.field_24588.method_28086(arg.method_28012((class_5285.class_5286)((Object)((Object)((Object)pair.getFirst()))), (Set)pair.getSecond())), arg.method_28041()));
    ...
    public void method_28092(final CreateWorldScreen createWorldScreen, MinecraftClient minecraftClient, TextRenderer textRenderer) {
        ...
        this.field_24595 = createWorldScreen.addButton(new ButtonWidget(this.field_24593 / 2 - 155, 100, 150, 20, new TranslatableText("selectWorld.mapFeatures"), buttonWidget -> {
        ...
        this.field_24596 = createWorldScreen.addButton(new ButtonWidget(this.field_24593 / 2 + 5, 100, 150, 20, new TranslatableText("selectWorld.mapType"), buttonWidget -> {
            do {
                ++this.field_24599;
        ...
        this.field_24597 = createWorldScreen.addButton(new ButtonWidget(createWorldScreen.width / 2 + 5, 120, 150, 20, new TranslatableText("selectWorld.customizeType"), buttonWidget -> {
        ...
        this.field_24589 = createWorldScreen.addButton(new ButtonWidget(createWorldScreen.width / 2 + 5, 151, 150, 20, new TranslatableText("selectWorld.bonusItems"), buttonWidget -> {
            ...
            @Override
            public Text getMessage() {
                return super.getMessage().shallowCopy().append(" ").append(ScreenTexts.getToggleText(class_5292.this.field_24598.method_28030() && !createWorldScreen.hardcore));
            }
        });
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.field_24595.visible) {
            this.field_24592.drawWithShadow(matrices, I18n.translate("selectWorld.mapFeatures.info", new Object[0]), (float)(this.field_24593 / 2 - 150), 122.0f, -6250336);
        }
    ...
    public class_5285 method_28096(boolean bl) {
        ...
        OptionalLong optionalLong = StringUtils.isEmpty(string) ? OptionalLong.empty() : ((optionalLong2 = class_5292.method_28095(string)).isPresent() && optionalLong2.getAsLong() == 0L ? OptionalLong.empty() : optionalLong2);
