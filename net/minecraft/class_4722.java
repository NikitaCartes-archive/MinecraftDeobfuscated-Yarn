...
public class class_4722 {
    ...
    public static final List<class_4730> field_21711 = Stream.of("white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown", "green", "red", "black").map(string -> new class_4730(field_21704, new Identifier("entity/shulker/shulker_" + string))).collect(ImmutableList.toImmutableList());
    public static final Map<WoodType, class_4730> field_21712 = WoodType.stream().collect(Collectors.toMap(Function.identity(), class_4722::method_24064));
    public static final class_4730[] field_21713 = (class_4730[])Arrays.stream(DyeColor.values()).sorted(Comparator.comparingInt(DyeColor::getId)).map(dyeColor -> new class_4730(field_21705, new Identifier("entity/bed/" + dyeColor.getName()))).toArray(class_4730[]::new);
    public static final class_4730 TRAPPED = class_4722.method_24065("trapped");
    public static final class_4730 TRAPPED_LEFT = class_4722.method_24065("trapped_left");
    public static final class_4730 TRAPPED_RIGHT = class_4722.method_24065("trapped_right");
    public static final class_4730 CHRISTMAS = class_4722.method_24065("christmas");
    public static final class_4730 CHRISTMAS_LEFT = class_4722.method_24065("christmas_left");
    public static final class_4730 CHRISTMAS_RIGHT = class_4722.method_24065("christmas_right");
    public static final class_4730 NORMAL = class_4722.method_24065("normal");
    public static final class_4730 NORMAL_LEFT = class_4722.method_24065("normal_left");
    public static final class_4730 NORMAL_RIGHT = class_4722.method_24065("normal_right");
    public static final class_4730 ENDER = class_4722.method_24065("ender");
    ...
    public static void method_24066(Consumer<class_4730> consumer) {
        ...
        for (class_4730 class_47302 : field_21713) {
            consumer.accept(class_47302);
        }
    ...
    public static class_4730 method_24062(BlockEntity blockEntity, ChestType chestType, boolean bl) {
        if (bl) {
            return class_4722.method_24063(chestType, CHRISTMAS, CHRISTMAS_LEFT, CHRISTMAS_RIGHT);
        }
        if (blockEntity instanceof TrappedChestBlockEntity) {
            return class_4722.method_24063(chestType, TRAPPED, TRAPPED_LEFT, TRAPPED_RIGHT);
        }
        if (blockEntity instanceof EnderChestBlockEntity) {
            return ENDER;
        }
        return class_4722.method_24063(chestType, NORMAL, NORMAL_LEFT, NORMAL_RIGHT);
    }
