...
extends class_5201 {
    ...
    public int method_27378(int i, int j) {
        ...
        if (j >= i - this.field_24151) {
            return this.field_24154;
        }
        return this.field_24153;
    }

    @Override
    public <T> T method_27380(DynamicOps<T> dynamicOps) {
        ImmutableMap.Builder<T, T> builder = ImmutableMap.builder();
        builder.put(dynamicOps.createString("limit"), dynamicOps.createInt(this.field_24150)).put(dynamicOps.createString("upper_limit"), dynamicOps.createInt(this.field_24151)).put(dynamicOps.createString("lower_size"), dynamicOps.createInt(this.field_24152)).put(dynamicOps.createString("middle_size"), dynamicOps.createInt(this.field_24153)).put(dynamicOps.createString("upper_size"), dynamicOps.createInt(this.field_24154));
