...
public class class_5215
extends class_5214 {
    public class_5215(int i, int j, int k) {
        super(i, j, k, (TrunkPlacerType<? extends class_5214>)TrunkPlacerType.MEGA_JUNGLE_TRUNK_PLACER);
    }
    ...
    public List<FoliagePlacer.class_5208> generate(ModifiableTestableWorld world, Random random, int trunkHeight, BlockPos pos, Set<BlockPos> set, BlockBox blockBox, TreeFeatureConfig treeFeatureConfig) {
        ...
        for (int i = trunkHeight - 2 - random.nextInt(4); i > trunkHeight / 2; i -= 2 + random.nextInt(4)) {
            ...
            for (int l = 0; l < 5; ++l) {
                ...
                class_5215.method_27402(world, random, blockPos, set, blockBox, treeFeatureConfig);
            }
