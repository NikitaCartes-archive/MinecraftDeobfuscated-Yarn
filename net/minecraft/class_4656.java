...
extends class_4651 {
    ...
    public <T> T serialize(DynamicOps<T> dynamicOps) {
        ...
        builder.put(dynamicOps.createString("type"), dynamicOps.createString(Registry.BLOCK_STATE_PROVIDER_TYPE.getId(this.field_21304).toString())).put(dynamicOps.createString("state"), BlockState.serialize(dynamicOps, this.field_21314).getValue());
