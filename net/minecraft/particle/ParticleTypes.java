...
public class ParticleTypes {
    ...
    public static final ParticleType<BlockStateParticleEffect> BLOCK = ParticleTypes.method_42022("block", false, BlockStateParticleEffect.PARAMETERS_FACTORY, BlockStateParticleEffect::createCodec);
    public static final ParticleType<BlockStateParticleEffect> BLOCK_MARKER = ParticleTypes.method_42022("block_marker", false, BlockStateParticleEffect.PARAMETERS_FACTORY, BlockStateParticleEffect::createCodec);
    ...
    public static final ParticleType<DustParticleEffect> DUST = ParticleTypes.method_42022("dust", false, DustParticleEffect.PARAMETERS_FACTORY, particleType -> DustParticleEffect.CODEC);
    public static final ParticleType<DustColorTransitionParticleEffect> DUST_COLOR_TRANSITION = ParticleTypes.method_42022("dust_color_transition", false, DustColorTransitionParticleEffect.FACTORY, particleType -> DustColorTransitionParticleEffect.CODEC);
    ...
    public static final ParticleType<BlockStateParticleEffect> FALLING_DUST = ParticleTypes.method_42022("falling_dust", false, BlockStateParticleEffect.PARAMETERS_FACTORY, BlockStateParticleEffect::createCodec);
    ...
    public static final ParticleType<SculkChargeParticleEffect> SCULK_CHARGE = ParticleTypes.method_42022("sculk_charge", true, SculkChargeParticleEffect.FACTORY, particleType -> SculkChargeParticleEffect.CODEC);
    ...
    public static final ParticleType<ItemStackParticleEffect> ITEM = ParticleTypes.method_42022("item", false, ItemStackParticleEffect.PARAMETERS_FACTORY, ItemStackParticleEffect::createCodec);
    public static final ParticleType<VibrationParticleEffect> VIBRATION = ParticleTypes.method_42022("vibration", true, VibrationParticleEffect.PARAMETERS_FACTORY, particleType -> VibrationParticleEffect.CODEC);
    ...
    public static final ParticleType<ShriekParticleEffect> SHRIEK = ParticleTypes.method_42022("shriek", false, ShriekParticleEffect.FACTORY, particleType -> ShriekParticleEffect.CODEC);
    ...
    private static <T extends ParticleEffect> ParticleType<T> method_42022(String string, boolean bl, ParticleEffect.Factory<T> factory, final Function<ParticleType<T>, Codec<T>> function) {
