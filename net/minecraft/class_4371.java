...
public abstract class class_4371 {
    ...
    protected abstract void method_21112(int var1, int var2, boolean var3);
    ...
    public abstract void method_21110(int var1);
    ...
    public static void method_21113(List<class_4371> list, RealmsObjectSelectionList realmsObjectSelectionList, int i, int j, int k, int l) {
        for (class_4371 lv : list) {
            if (realmsObjectSelectionList.getRowWidth() <= lv.method_21109()) continue;
            lv.method_21111(i, j, k, l);
        }
    }

    public static void method_21114(RealmsObjectSelectionList realmsObjectSelectionList, RealmListEntry realmListEntry, List<class_4371> list, int i, double d, double e) {
        int j;
        if (i == 0 && (j = realmsObjectSelectionList.children().indexOf(realmListEntry)) > -1) {
            ...
            for (class_4371 lv : list) {
                if (m < lv.field_19692 || m > lv.method_21109() || n < lv.field_19693 || n > lv.method_21115()) continue;
                lv.method_21110(j);
            }
        }
    }
