...
implements DataCommandObject {
    private static final SuggestionProvider<ServerCommandSource> field_20856 = (commandContext, suggestionsBuilder) -> CommandSource.suggestIdentifiers(class_4580.method_22842(commandContext).method_22542(), suggestionsBuilder);
    public static final Function<String, DataCommand.ObjectType> field_20855 = string -> new DataCommand.ObjectType((String)string){
        ...
        public DataCommandObject getObject(CommandContext<ServerCommandSource> commandContext) {
            return new class_4580(class_4580.method_22842(commandContext), IdentifierArgumentType.getIdentifier(commandContext, this.field_20859));
        }
        ...
        public ArgumentBuilder<ServerCommandSource, ?> addArgumentsToBuilder(ArgumentBuilder<ServerCommandSource, ?> argumentBuilder, Function<ArgumentBuilder<ServerCommandSource, ?>, ArgumentBuilder<ServerCommandSource, ?>> function) {
            return argumentBuilder.then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("storage").then(function.apply(CommandManager.argument(this.field_20859, IdentifierArgumentType.identifier()).suggests(field_20856))));
        }
    };
