...
public class class_4587 {
    private final Deque<Matrix4f> field_20898 = SystemUtil.consume(Queues.newArrayDeque(), arrayDeque -> {
    ...
    public void method_22906(Matrix4f matrix4f) {
        Matrix4f matrix4f2 = this.field_20898.getLast();
        matrix4f2.method_22672(matrix4f);
    }

    public void method_22907(Quaternion quaternion) {
        Matrix4f matrix4f = this.field_20898.getLast();
        matrix4f.method_22670(quaternion);
    }

    public void method_22903() {
        this.field_20898.addLast(this.field_20898.getLast().method_22673());
    }
