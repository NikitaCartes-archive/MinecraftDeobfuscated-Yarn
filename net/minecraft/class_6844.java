...
public class class_6844
implements class_6836 {
    private String field_36261 = "";
    @Nullable
    private NbtElement field_36262;
    private final Deque<Consumer<NbtElement>> field_36263 = new ArrayDeque<Consumer<NbtElement>>();
    ...
    private void method_39883(NbtElement nbtElement) {
        this.field_36263.getLast().accept(nbtElement);
    }
    ...
    private void method_39886(NbtType<?> nbtType) {
        if (nbtType == NbtList.TYPE) {
            ...
            this.field_36263.addLast(nbtElement -> nbtCompound.put(this.field_36261, (NbtElement)nbtElement));
        }
    }
    ...
    public class_6836.class_6838 method_39871(NbtType<?> nbtType) {
        if (nbtType == NbtList.TYPE) {
            ...
            this.field_36263.addLast(nbtElement -> {
                this.field_36262 = nbtElement;
            });
        }
        return class_6836.class_6838.CONTINUE;
    }
