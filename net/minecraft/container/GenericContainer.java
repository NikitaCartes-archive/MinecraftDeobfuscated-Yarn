...
extends Container {
    ...
    public GenericContainer(ContainerType<?> containerType, int syncId, PlayerInventory playerInventory, Inventory inventory, int rows) {
        ...
        int k;
        int j;
        GenericContainer.checkContainerSize(inventory, rows * 9);
    ...
    public ItemStack transferSlot(PlayerEntity player, int invSlot) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (invSlot < this.rows * 9 ? !this.insertItem(itemStack2, this.rows * 9, this.slotList.size(), true) : !this.insertItem(itemStack2, 0, this.rows * 9, false)) {
