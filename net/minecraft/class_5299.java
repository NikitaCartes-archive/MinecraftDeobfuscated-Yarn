...
extends DataFix {
    private static final ImmutableMap<String, class_5300> field_24647 = ImmutableMap.builder().put("minecraft:village", new class_5300(32, 8, 10387312)).put("minecraft:desert_pyramid", new class_5300(32, 8, 14357617)).put("minecraft:igloo", new class_5300(32, 8, 14357618)).put("minecraft:jungle_pyramid", new class_5300(32, 8, 14357619)).put("minecraft:swamp_hut", new class_5300(32, 8, 14357620)).put("minecraft:pillager_outpost", new class_5300(32, 8, 165745296)).put("minecraft:monument", new class_5300(32, 5, 10387313)).put("minecraft:endcity", new class_5300(20, 11, 10387313)).put("minecraft:mansion", new class_5300(80, 20, 10387319)).build();
    ...
    private static <T> Dynamic<T> method_28271(Dynamic<T> dynamic2) {
        ...
        if (optional.equals(Optional.of("customized"))) {
            dynamic22 = class_5299.method_28268(l, dynamic2, dynamic2.createString("minecraft:overworld"), class_5299.method_28272(dynamic2, l, false, false));
            ...
            switch (optional.get()) {
                case "flat": {
                    Map map = class_5299.method_28275(dynamicOps, optionalDynamic);
                ...
                case "buffet": {
                    ...
                    dynamic22 = class_5299.method_28268(l, dynamic2, dynamic3, dynamic5);
                    break;
                }
                default: {
                    ...
                    dynamic22 = class_5299.method_28268(l, dynamic2, dynamic2.createString(bl3 ? "minecraft:amplified" : "minecraft:overworld"), class_5299.method_28272(dynamic2, l, bl2, bl4));
                }
            }
        }
    ...
    private static <T> Map<Dynamic<T>, Dynamic<T>> method_28275(DynamicOps<T> dynamicOps, OptionalDynamic<T> optionalDynamic) {
            ...
            switch (string2) {
                ...
                case "separation": {
                    if ("oceanmonument".equals(string)) {
                        class_5300 lv = map.getOrDefault("minecraft:monument", field_24647.get("minecraft:monument"));
        ...
        ImmutableMap.Builder builder = ImmutableMap.builder();
        builder.put(optionalDynamic.createString("structures"), optionalDynamic.createMap(map.entrySet().stream().collect(Collectors.toMap(entry -> optionalDynamic.createString((String)entry.getKey()), entry -> ((class_5300)entry.getValue()).method_28288(dynamicOps)))));
    ...
    private static void method_28281(Map<String, class_5300> map, String string, String string2, int i) {
        class_5300 lv = map.getOrDefault(string, field_24647.get(string));
    ...
    static final class class_5300 {
        public static final Codec<class_5300> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.INT.fieldOf("spacing")).forGetter(arg -> arg.field_24649), ((MapCodec)Codec.INT.fieldOf("separation")).forGetter(arg -> arg.field_24650), ((MapCodec)Codec.INT.fieldOf("salt")).forGetter(arg -> arg.field_24651)).apply((Applicative<class_5300, ?>)instance, class_5300::new));
