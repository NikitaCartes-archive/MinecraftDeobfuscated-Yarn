...
extends RealmsScreen {
    ...
    public void init() {
        ...
        if (!this.field_19840) {
            ...
            this.field_19838 = this.newEditBox(3, this.width() / 2 - 100, 65, 200, 20, class_4391.getLocalizedString("mco.configure.world.name"));
            this.focusOn(this.field_19838);
            this.field_19839 = this.newEditBox(4, this.width() / 2 - 100, 115, 200, 20, class_4391.getLocalizedString("mco.configure.world.description"));
        }
        this.field_19841 = new RealmsButton(0, this.width() / 2 - 100, this.height() / 4 + 120 + 17, 97, 20, class_4391.getLocalizedString("mco.create.world")){
        ...
        this.buttonsAdd(this.field_19841);
        this.buttonsAdd(new RealmsButton(1, this.width() / 2 + 5, this.height() / 4 + 120 + 17, 95, 20, class_4391.getLocalizedString("gui.cancel")){
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(class_4391.getLocalizedString("mco.trial.title"), this.width() / 2, 11, 0xFFFFFF);
        this.drawString(class_4391.getLocalizedString("mco.configure.world.name"), this.width() / 2 - 100, 52, 0xA0A0A0);
        this.drawString(class_4391.getLocalizedString("mco.configure.world.description"), this.width() / 2 - 100, 102, 0xA0A0A0);
        if (this.field_19838 != null) {
