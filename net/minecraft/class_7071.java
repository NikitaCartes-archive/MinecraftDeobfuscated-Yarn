...
extends AbstractTagProvider<ConfiguredStructureFeature<?, ?>> {
    ...
    protected void configure() {
        this.getOrCreateTagBuilder(class_7045.VILLAGE).add(class_7058.VILLAGE_PLAINS).add(class_7058.VILLAGE_DESERT).add(class_7058.VILLAGE_SAVANNA).add(class_7058.VILLAGE_SNOWY).add(class_7058.VILLAGE_TAIGA);
        ...
        this.getOrCreateTagBuilder(class_7045.RUINED_PORTAL).add(class_7058.RUINED_PORTAL_DESERT).add(class_7058.RUINED_PORTAL_JUNGLE).add(class_7058.RUINED_PORTAL_MOUNTAIN).add(class_7058.RUINED_PORTAL_NETHER).add(class_7058.RUINED_PORTAL_OCEAN).add(class_7058.RUINED_PORTAL).add(class_7058.RUINED_PORTAL_SWAMP);
