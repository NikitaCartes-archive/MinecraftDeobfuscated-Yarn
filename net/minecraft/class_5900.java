...
implements Packet<ClientPlayPacketListener> {
    ...
    private class_5900(String string, int i, Optional<class_5902> optional, Collection<String> collection) {
        this.field_29152 = string;
        this.field_29151 = i;
        this.field_29154 = optional;
        this.field_29153 = ImmutableList.copyOf(collection);
    }

    public static class_5900 method_34172(Team team, boolean bl) {
        return new class_5900(team.getName(), bl ? 0 : 2, Optional.of(new class_5902(team)), bl ? team.getPlayerList() : ImmutableList.of());
    }

    public static class_5900 method_34170(Team team) {
        return new class_5900(team.getName(), 1, Optional.empty(), ImmutableList.of());
    }

    public static class_5900 method_34171(Team team, String string, class_5901 arg) {
        return new class_5900(team.getName(), arg == class_5901.field_29155 ? 3 : 1, Optional.empty(), ImmutableList.of(string));
    }
    ...
    public class_5900(PacketByteBuf packetByteBuf) {
        ...
        this.field_29154 = class_5900.method_34175(this.field_29151) ? Optional.of(new class_5902(packetByteBuf)) : Optional.empty();
        this.field_29153 = class_5900.method_34169(this.field_29151) ? packetByteBuf.method_34066(PacketByteBuf::readString) : ImmutableList.of();
    }
    ...
    public void write(PacketByteBuf buf) {
        ...
        if (class_5900.method_34175(this.field_29151)) {
            this.field_29154.orElseThrow(() -> new IllegalStateException("Parameters not present, but method is" + this.field_29151)).method_34182(buf);
        }
        if (class_5900.method_34169(this.field_29151)) {
    ...
    public class_5901 method_34174() {
        switch (this.field_29151) {
            case 0: 
            case 3: {
                return class_5901.field_29155;
            }
            case 4: {
                return class_5901.field_29156;
            }
        }
        return null;
    }
