...
public class class_5579<T extends class_5568>
implements AutoCloseable {
    ...
    private boolean addEntity(T entity, boolean bl) {
        ...
        entity.method_31744(new class_5580(this, (class_5568)entity, l, lv));
        if (!bl) {
            this.entityLoader.method_31802(entity);
        }
        if ((lv2 = class_5579.method_31832(entity, lv.method_31768())).shouldTrack()) {
    ...
    public void method_31816(ChunkPos chunkPos, class_5584 arg) {
        ...
        this.field_27265.method_31782(l).forEach(arg22 -> {
            class_5584 lv = arg22.method_31763(arg);
            boolean bl = lv.shouldTrack();
            boolean bl2 = arg.shouldTrack();
            boolean bl3 = lv.shouldTick();
            boolean bl4 = arg.shouldTick();
            if (bl3 && !bl4) {
                arg22.method_31766().filter(arg -> !arg.isPlayer()).forEach(this::method_31843);
            }
            if (bl && !bl2) {
                arg22.method_31766().filter(arg -> !arg.isPlayer()).forEach(this::method_31850);
            } else if (!bl && bl2) {
                arg22.method_31766().filter(arg -> !arg.isPlayer()).forEach(this::method_31847);
            }
            if (!bl3 && bl4) {
                arg22.method_31766().filter(arg -> !arg.isPlayer()).forEach(this::method_31838);
            }
        });
    }
    ...
    private boolean method_31812(long l, Consumer<T> consumer) {
        ...
        List<T> list = this.field_27265.method_31782(l).flatMap(arg -> arg.method_31766().filter(class_5568::method_31746)).collect(Collectors.toList());
        if (list.isEmpty()) {
    ...
    private void method_31853() {
        ...
        while ((lv = this.loadingQueue.poll()) != null) {
            lv.method_31742().forEach(arg -> this.addEntity(arg, true));
    ...
    implements class_5569 {
        ...
        final /* synthetic */ class_5579 field_27271;
        ...
        private void method_31865(class_5584 arg, class_5584 arg2) {
            ...
            if (lv == (lv2 = class_5579.method_31832(this.entity, arg2))) {
                return;
            }
            boolean bl = lv.shouldTrack();
            ...
            if (bl3 && !bl4) {
                this.field_27271.method_31843(this.entity);
            } else if (!bl3 && bl4) {
        ...
        public void remove(Entity.RemovalReason reason) {
            ...
            if ((lv = class_5579.method_31832(this.entity, this.field_27274.method_31768())).shouldTick()) {
                this.field_27271.method_31843(this.entity);
            }
            if (lv.shouldTrack()) {
                this.field_27271.method_31850(this.entity);
