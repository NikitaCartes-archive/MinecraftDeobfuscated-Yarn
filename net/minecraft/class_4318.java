...
extends Task<VillagerEntity> {
    private List<ItemEntity> field_19425 = new ArrayList<ItemEntity>();
    ...
    protected void method_20819(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
        ItemEntity itemEntity = this.field_19425.get(serverWorld.random.nextInt(this.field_19425.size()));
