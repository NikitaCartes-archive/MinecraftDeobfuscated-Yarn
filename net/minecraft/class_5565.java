...
implements class_5571<Entity> {
    ...
    public CompletableFuture<class_5566<Entity>> method_31759(ChunkPos chunkPos) {
        if (this.field_27235.contains(chunkPos.toLong())) {
            return CompletableFuture.completedFuture(class_5565.method_31735(chunkPos));
        }
        return this.field_27234.method_31738(chunkPos).thenApplyAsync(compoundTag -> {
            if (compoundTag == null) {
            ...
            try {
                ...
                field_27232.warn("Failed to parse chunk {} position info", (Object)chunkPos, (Object)exception);
            }
            CompoundTag compoundTag2 = this.method_31737((CompoundTag)compoundTag);
            ListTag listTag = compoundTag2.getList("Entities", 10);
            List list = EntityType.method_31489(listTag, this.field_27233).collect(ImmutableList.toImmutableList());
    ...
    private static class_5566<Entity> method_31735(ChunkPos chunkPos) {
        return new class_5566<Entity>(chunkPos, ImmutableList.of());
    }
