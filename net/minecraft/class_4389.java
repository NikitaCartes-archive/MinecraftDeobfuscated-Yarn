...
extends RealmsScreen {
    ...
    public class_4389(RealmsScreen realmsScreen, String string, String string2, int i) {
        ...
        this.field_19824 = i;
        this.field_19822 = class_4389.getLocalizedString("gui.yes");
        this.field_19823 = class_4389.getLocalizedString("gui.no");
    }
    ...
    public void render(int i, int j, float f) {
        ...
        this.drawCenteredString(this.field_19821, this.width() / 2, class_4359.method_21072(3), 0xFFFFFF);
        this.drawCenteredString(this.field_19825, this.width() / 2, class_4359.method_21072(5), 0xFFFFFF);
        super.render(i, j, f);
    }
