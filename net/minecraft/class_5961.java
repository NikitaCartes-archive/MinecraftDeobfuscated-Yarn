...
import net.minecraft.class_5970;
...
public class class_5961
implements class_5962 {
    @Nullable
    private static Consumer<Path> field_29579 = null;
    private final List<class_5969> field_29580 = new ObjectArrayList<class_5969>();
    ...
    private final List<class_5964> field_29587 = new ObjectArrayList<class_5964>();
    ...
    private void method_34761() {
        this.field_29580.add(new class_5969("JVM", class_5965.method_34778("heap (Mb)", () -> (double)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0)));
        this.field_29580.add(new class_5969("Frame times (ms)", this.method_34759(this.field_29586)));
        this.field_29580.add(new class_5969("Task total durations (ms)", this.method_34758("gameRendering").method_34799("root", "gameRenderer"), this.method_34758("updateDisplay").method_34799("root", "updateDisplay"), this.method_34758("skyRendering").method_34799("root", "gameRenderer", "level", "sky")));
        WorldRenderer worldRenderer = MinecraftClient.getInstance().worldRenderer;
        this.field_29580.add(new class_5969("Rendering chunk dispatching", class_5965.method_34777("totalChunks", worldRenderer, WorldRenderer::method_34811), class_5965.method_34777("renderedChunks", worldRenderer, WorldRenderer::getCompletedChunkCount), class_5965.method_34777("lastViewDistance", worldRenderer, WorldRenderer::method_34812)));
        ChunkBuilder chunkBuilder = worldRenderer.method_34810();
        this.field_29580.add(new class_5969("Rendering chunk stats", class_5965.method_34777("toUpload", chunkBuilder, ChunkBuilder::method_34846), class_5965.method_34777("freeBufferCount", chunkBuilder, ChunkBuilder::method_34847), class_5965.method_34777("toBatchCount", chunkBuilder, ChunkBuilder::method_34845)));
        class_5950.field_29555.method_34701().forEach((arg2, list) -> {
            List<class_5965> list2 = list.stream().map(arg -> class_5965.method_34776(arg.method_34697(), arg.method_34698())).collect(Collectors.toList());
            this.field_29580.add(new class_5969(arg2.method_34700(), list2));
        });
    }
    ...
    private class_5965 method_34759(final LongSupplier longSupplier) {
        ...
        class_5965.class_5968 lv = new class_5965.class_5968(0.5f, d -> this.field_29587.add(new class_5964(new Date(), this.field_29589, this.field_29590.getResult())));
        return class_5965.method_34779("frametime", toDoubleFunction, stopwatch2).method_34789(Stopwatch::start).method_34788(lv).method_34787();
    }
