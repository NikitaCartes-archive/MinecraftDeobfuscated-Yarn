...
extends Task<VillagerEntity> {
    ...
    protected void run(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
        ...
        serverWorld.getPointOfInterestStorage().getType(globalPos.getPos()).ifPresent(pointOfInterestType -> LookTargetUtil.method_29248(villagerEntity, villagerEntity -> this.method_29257(globalPos, (PointOfInterestType)pointOfInterestType, (VillagerEntity)villagerEntity)).reduce(villagerEntity, class_5326::method_29255));
    }
    ...
    private boolean method_29257(GlobalPos globalPos, PointOfInterestType pointOfInterestType, VillagerEntity villagerEntity) {
        return this.method_29254(villagerEntity) && globalPos.equals(villagerEntity.getBrain().getOptionalMemory(MemoryModuleType.JOB_SITE).get()) && this.method_29253(pointOfInterestType, villagerEntity.getVillagerData().getProfession());
    }
