...
public class class_5285 {
    private static final Dynamic<?> field_24522 = new Dynamic<CompoundTag>(NbtOps.INSTANCE, new CompoundTag());
    ...
    public static final class_5285 field_24520 = new class_5285(field_24524, true, true, class_5287.field_24542, field_24522, new OverworldChunkGenerator(new VanillaLayeredBiomeSource(field_24524, false, 4), field_24524, new OverworldChunkGeneratorConfig()));
    public static final class_5285 field_24521 = new class_5285(0L, false, false, class_5287.field_24543, field_24522, field_24523);
    ...
    public class_5285(long l, boolean bl, boolean bl2, class_5287 arg, Dynamic<?> dynamic, ChunkGenerator chunkGenerator) {
        this(l, bl, bl2, arg, dynamic, chunkGenerator, null, false);
    }

    private class_5285(long l, boolean bl, boolean bl2, class_5287 arg, Dynamic<?> dynamic, ChunkGenerator chunkGenerator, @Nullable String string, boolean bl3) {
        this.field_24526 = l;
        this.field_24527 = bl;
    ...
    public static class_5285 method_28023(CompoundTag compoundTag, DataFixer dataFixer, int i) {
        ...
        if (compoundTag.contains("generatorName", 8)) {
            ...
            lv = class_5287.method_28048(string2);
            if (lv == null) {
                lv = class_5287.field_24542;
            } else if (lv == class_5287.field_24548) {
                string = compoundTag.getString("generatorOptions");
            } else if (lv == class_5287.field_24542) {
                int j = 0;
                if (compoundTag.contains("generatorVersion", 99)) {
                    j = compoundTag.getInt("generatorVersion");
                }
                if (j == 0) {
                    lv = class_5287.field_24549;
                }
            }
            ...
            Dynamic<CompoundTag> dynamic2 = dynamic.merge(dynamic.createString("levelType"), dynamic.createString(lv.field_24551));
            ...
            chunkGenerator = class_5285.method_28013(lv, dynamic3, l);
        } else {
        ...
        boolean bl3 = lv == class_5287.field_24548 && i < 1466;
    ...
    public static class_5285 method_28009() {
        ...
        return new class_5285(l, true, false, class_5287.field_24542, field_24522, new OverworldChunkGenerator(new VanillaLayeredBiomeSource(l, false, 4), l, new OverworldChunkGeneratorConfig()));
    }

    public CompoundTag method_28025() {
        CompoundTag compoundTag = new CompoundTag();
        compoundTag.putLong("RandomSeed", this.method_28028());
        class_5287 lv = this.field_24529 == class_5287.field_24548 ? class_5287.field_24542 : this.field_24529;
        compoundTag.putString("generatorName", lv.field_24551);
        compoundTag.putInt("generatorVersion", this.field_24529 == class_5287.field_24542 ? 1 : 0);
    ...
    public Map<DimensionType, ChunkGenerator> method_28031() {
        return ImmutableMap.of(DimensionType.OVERWORLD, this.field_24531, DimensionType.THE_NETHER, class_5285.method_28026(this.field_24526), DimensionType.THE_END, class_5285.method_28011(this.field_24526));
    }
    ...
    public boolean method_28033() {
        return this.field_24529 == class_5287.field_24547;
    }

    public boolean method_28034() {
        return this.field_24529 == class_5287.field_24543;
    }
    ...
    public static class_5285 method_28021(Properties properties) {
        ...
        class_5287 lv = string4 != null ? MoreObjects.firstNonNull(class_5287.method_28048(string4), class_5287.field_24542) : class_5287.field_24542;
        ...
        return new class_5285(l, bl, false, lv, dynamic, class_5285.method_28013(lv, dynamic, l));
    }
    ...
    @Environment(value=EnvType.CLIENT)
    private class_5285 method_28014(class_5287 arg, Dynamic<?> dynamic, ChunkGenerator chunkGenerator) {
    ...
    public class_5285 method_28019(FlatChunkGeneratorConfig flatChunkGeneratorConfig) {
        return this.method_28014(class_5287.field_24543, flatChunkGeneratorConfig.toDynamic(NbtOps.INSTANCE), new FlatChunkGenerator(flatChunkGeneratorConfig));
    }

    @Environment(value=EnvType.CLIENT)
    public class_5285 method_28012(class_5286 arg, Set<Biome> set) {
        Dynamic<?> dynamic = class_5285.method_28027(arg, set);
        return this.method_28014(class_5287.field_24546, dynamic, class_5285.method_28013(class_5287.field_24546, dynamic, this.field_24526));
    }

    @Environment(value=EnvType.CLIENT)
    public class_5288 method_28039() {
        if (this.field_24529 == class_5287.field_24548) {
    ...
    public class_5285 method_28024(boolean bl, OptionalLong optionalLong) {
        ...
        ChunkGenerator chunkGenerator2 = chunkGenerator = optionalLong.isPresent() ? this.field_24531.method_27997(optionalLong.getAsLong()) : this.field_24531;
        class_5285 lv = this.method_28033() ? new class_5285(l, false, false, this.field_24529, this.field_24530, chunkGenerator) : new class_5285(l, this.method_28029(), this.method_28030() && !bl, this.field_24529, this.field_24530, chunkGenerator);
        return lv;
    }

    private static ChunkGenerator method_28013(class_5287 arg, Dynamic<?> dynamic, long l) {
        if (arg == class_5287.field_24546) {
            BiomeSource biomeSource = class_5285.method_28017(dynamic.get("biome_source"), l);
            OptionalDynamic<?> dynamicLike = dynamic.get("chunk_generator");
            class_5286 lv = DataFixUtils.orElse(((DynamicLike)dynamicLike).get("type").asString().flatMap(string -> Optional.ofNullable(class_5286.method_28045(string))), class_5286.field_24536);
            OptionalDynamic dynamicLike2 = ((DynamicLike)dynamicLike).get("options");
            BlockState blockState = class_5285.method_28018(((DynamicLike)dynamicLike2).get("default_block"), Registry.BLOCK, Blocks.STONE).getDefaultState();
            BlockState blockState2 = class_5285.method_28018(((DynamicLike)dynamicLike2).get("default_fluid"), Registry.BLOCK, Blocks.WATER).getDefaultState();
            switch (lv) {
                case field_24537: {
                    CavesChunkGeneratorConfig cavesChunkGeneratorConfig = new CavesChunkGeneratorConfig(new ChunkGeneratorConfig());
        ...
        if (arg == class_5287.field_24547) {
            return DebugChunkGenerator.field_24509;
        }
        boolean bl = arg == class_5287.field_24549;
        int i = arg == class_5287.field_24544 ? 6 : 4;
        boolean bl2 = arg == class_5287.field_24545;
    ...
    private static BiomeSource method_28017(DynamicLike<?> dynamicLike, long l) {
        BiomeSourceType biomeSourceType = class_5285.method_28018(dynamicLike.get("type"), Registry.BIOME_SOURCE_TYPE, BiomeSourceType.FIXED);
        OptionalDynamic<?> dynamicLike2 = dynamicLike.get("options");
        Stream stream2 = ((DynamicLike)dynamicLike2).get("biomes").asStreamOpt().map(stream -> stream.map(dynamic -> class_5285.method_28018(dynamic, Registry.BIOME, Biomes.OCEAN))).orElseGet(Stream::empty);
    ...
    public FlatChunkGeneratorConfig method_28040() {
        return this.field_24529 == class_5287.field_24543 ? FlatChunkGeneratorConfig.fromDynamic(this.field_24530) : FlatChunkGeneratorConfig.getDefaultConfig();
    }

    @Environment(value=EnvType.CLIENT)
    public Pair<class_5286, Set<Biome>> method_28041() {
        if (this.field_24529 != class_5287.field_24546) {
            return Pair.of(class_5286.field_24536, ImmutableSet.of());
        }
        class_5286 lv = class_5286.field_24536;
    ...
    public static final class class_5288 {
        public static final class_5288 field_24552 = new class_5288(class_5287.field_24542);
        public static final class_5288 field_24553 = new class_5288(class_5287.field_24543);
        public static final class_5288 field_24554 = new class_5288(class_5287.field_24545);
        public static final class_5288 field_24555 = new class_5288(class_5287.field_24546);
        public static final List<class_5288> field_24556 = Lists.newArrayList(field_24552, field_24553, new class_5288(class_5287.field_24544), field_24554, field_24555, new class_5288(class_5287.field_24547));
    ...
    static class class_5287 {
        ...
        public static final class_5287 field_24542 = new class_5287("default");
        public static final class_5287 field_24543 = new class_5287("flat");
        public static final class_5287 field_24544 = new class_5287("largeBiomes");
        public static final class_5287 field_24545 = new class_5287("amplified");
        public static final class_5287 field_24546 = new class_5287("buffet");
        public static final class_5287 field_24547 = new class_5287("debug_all_block_states");
        public static final class_5287 field_24548 = new class_5287("customized");
        public static final class_5287 field_24549 = new class_5287("default_1_1");
