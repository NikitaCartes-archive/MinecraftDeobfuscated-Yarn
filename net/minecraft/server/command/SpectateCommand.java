...
public class SpectateCommand {
    ...
    private static final DynamicCommandExceptionType NOT_SPECTATOR_EXCEPTION = new DynamicCommandExceptionType(playerName -> Text.method_43469("commands.spectate.not_spectator", playerName));
