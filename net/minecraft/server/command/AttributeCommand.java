...
public class AttributeCommand {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("attribute").requires(serverCommandSource -> serverCommandSource.hasPermissionLevel(2))).then(CommandManager.argument("target", EntityArgumentType.entity()).then((ArgumentBuilder<ServerCommandSource, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument("attribute", IdentifierArgumentType.identifier()).suggests(SUGGESTION_PROVIDER).then((ArgumentBuilder<ServerCommandSource, ?>)((LiteralArgumentBuilder)CommandManager.literal("get").executes(commandContext -> AttributeCommand.executeValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), 1.0))).then(CommandManager.argument("scale", DoubleArgumentType.doubleArg()).executes(commandContext -> AttributeCommand.executeValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), DoubleArgumentType.getDouble(commandContext, "scale")))))).then(((LiteralArgumentBuilder)CommandManager.literal("base").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("set").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument("value", DoubleArgumentType.doubleArg()).executes(commandContext -> AttributeCommand.executeBaseValueSet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), DoubleArgumentType.getDouble(commandContext, "value")))))).then(((LiteralArgumentBuilder)CommandManager.literal("get").executes(commandContext -> AttributeCommand.executeBaseValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), 1.0))).then(CommandManager.argument("scale", DoubleArgumentType.doubleArg()).executes(commandContext -> AttributeCommand.executeBaseValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), DoubleArgumentType.getDouble(commandContext, "scale"))))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("modifier").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("add").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument("uuid", UuidArgumentType.uuid()).then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument("name", StringArgumentType.string()).then((ArgumentBuilder<ServerCommandSource, ?>)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument("value", DoubleArgumentType.doubleArg()).then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("add").executes(commandContext -> AttributeCommand.executeModifierAdd((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid"), StringArgumentType.getString(commandContext, "name"), DoubleArgumentType.getDouble(commandContext, "value"), EntityAttributeModifier.Operation.ADDITION)))).then(CommandManager.literal("multiply").executes(commandContext -> AttributeCommand.executeModifierAdd((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid"), StringArgumentType.getString(commandContext, "name"), DoubleArgumentType.getDouble(commandContext, "value"), EntityAttributeModifier.Operation.MULTIPLY_TOTAL)))).then(CommandManager.literal("multiply_base").executes(commandContext -> AttributeCommand.executeModifierAdd((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid"), StringArgumentType.getString(commandContext, "name"), DoubleArgumentType.getDouble(commandContext, "value"), EntityAttributeModifier.Operation.MULTIPLY_BASE)))))))).then(CommandManager.literal("remove").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument("uuid", UuidArgumentType.uuid()).executes(commandContext -> AttributeCommand.executeModifierRemove((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid")))))).then(CommandManager.literal("value").then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("get").then((ArgumentBuilder<ServerCommandSource, ?>)((RequiredArgumentBuilder)CommandManager.argument("uuid", UuidArgumentType.uuid()).executes(commandContext -> AttributeCommand.executeModifierValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid"), 1.0))).then(CommandManager.argument("scale", DoubleArgumentType.doubleArg()).executes(commandContext -> AttributeCommand.executeModifierValueGet((ServerCommandSource)commandContext.getSource(), EntityArgumentType.getEntity(commandContext, "target"), IdentifierArgumentType.getAttributeArgument(commandContext, "attribute"), UuidArgumentType.getUuid(commandContext, "uuid"), DoubleArgumentType.getDouble(commandContext, "scale")))))))))));
    }
