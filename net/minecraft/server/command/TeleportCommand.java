...
public class TeleportCommand {
    private static final SimpleCommandExceptionType field_22255 = new SimpleCommandExceptionType(new TranslatableText("commands.teleport.invalidPosition", new Object[0]));
