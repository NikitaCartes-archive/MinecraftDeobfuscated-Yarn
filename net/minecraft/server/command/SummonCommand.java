...
public class SummonCommand {
    ...
    private static final SimpleCommandExceptionType INVALID_POSITION_EXCEPTION = new SimpleCommandExceptionType(Text.method_43471("commands.summon.invalidPosition"));
    ...
    private static int execute(ServerCommandSource source, Identifier entity2, Vec3d pos, NbtCompound nbt, boolean initialize) throws CommandSyntaxException {
        ...
        source.sendFeedback(Text.method_43469("commands.summon.success", entity22.getDisplayName()), true);
        return 1;
    }
}
