...
public class SummonCommand {
    ...
    private static final SimpleCommandExceptionType field_22254 = new SimpleCommandExceptionType(new TranslatableText("commands.summon.invalidPosition", new Object[0]));
