...
public class TestCommand {
    ...
    private static int executeRunAll(ServerCommandSource source, int rotationSteps, int i) {
        ...
        TestCommand.run(source, collection, rotationSteps, i);
        return 1;
    }
