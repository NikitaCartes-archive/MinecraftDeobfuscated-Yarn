...
public class LocateBiomeCommand {
    private static final DynamicCommandExceptionType NOT_FOUND_EXCEPTION = new DynamicCommandExceptionType(id -> Text.method_43469("commands.locatebiome.notFound", id));
