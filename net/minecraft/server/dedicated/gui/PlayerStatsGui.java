...
extends JComponent {
    private static final DecimalFormat AVG_TICK_FORMAT = Util.create(new DecimalFormat("########0.000"), decimalFormat -> decimalFormat.setDecimalFormatSymbols(DecimalFormatSymbols.getInstance(Locale.ROOT)));
