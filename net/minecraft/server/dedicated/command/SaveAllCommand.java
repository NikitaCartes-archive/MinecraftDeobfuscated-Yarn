...
public class SaveAllCommand {
    private static final SimpleCommandExceptionType SAVE_FAILED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableComponent("commands.save.failed", new Object[0]));
    ...
    private static int saveAll(ServerCommandSource serverCommandSource, boolean bl) throws CommandSyntaxException {
        serverCommandSource.sendFeedback(new TranslatableComponent("commands.save.saving", new Object[0]), false);
        ...
        serverCommandSource.sendFeedback(new TranslatableComponent("commands.save.success", new Object[0]), true);
        return 1;
    }
}
