...
public class DeOpCommand {
    private static final SimpleCommandExceptionType ALREADY_DEOPPED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableComponent("commands.deop.failed", new Object[0]));
    ...
    private static int deop(ServerCommandSource serverCommandSource, Collection<GameProfile> collection) throws CommandSyntaxException {
        ...
        for (GameProfile gameProfile : collection) {
            ...
            ++i;
            serverCommandSource.sendFeedback(new TranslatableComponent("commands.deop.success", collection.iterator().next().getName()), true);
        }
        if (i == 0) {
