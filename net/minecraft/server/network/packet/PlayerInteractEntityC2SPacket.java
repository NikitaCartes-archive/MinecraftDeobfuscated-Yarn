...
implements Packet<ServerPlayPacketListener> {
    ...
    public void read(PacketByteBuf packetByteBuf) throws IOException {
        ...
        this.type = packetByteBuf.readEnumConstant(InteractionType.class);
        if (this.type == InteractionType.INTERACT_AT) {
            this.hitPos = new Vec3d(packetByteBuf.readFloat(), packetByteBuf.readFloat(), packetByteBuf.readFloat());
        }
