...
implements Packet<ServerPlayPacketListener> {
    ...
    public UpdateStructureBlockC2SPacket(BlockPos blockPos, StructureBlockBlockEntity.Action action, StructureBlockMode structureBlockMode, String string, BlockPos blockPos2, BlockPos blockPos3, BlockMirror blockMirror, BlockRotation blockRotation, String string2, boolean bl, boolean bl2, boolean bl3, float f, long l) {
        this.pos = blockPos;
        this.action = action;
    ...
    public void read(PacketByteBuf packetByteBuf) throws IOException {
        ...
        this.structureName = packetByteBuf.readString(Short.MAX_VALUE);
        this.offset = new BlockPos(MathHelper.clamp(packetByteBuf.readByte(), -32, 32), MathHelper.clamp(packetByteBuf.readByte(), -32, 32), MathHelper.clamp(packetByteBuf.readByte(), -32, 32));
        this.size = new BlockPos(MathHelper.clamp(packetByteBuf.readByte(), 0, 32), MathHelper.clamp(packetByteBuf.readByte(), 0, 32), MathHelper.clamp(packetByteBuf.readByte(), 0, 32));
