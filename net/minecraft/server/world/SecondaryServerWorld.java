...
extends ServerWorld {
    public SecondaryServerWorld(ServerWorld serverWorld, MinecraftServer minecraftServer, Executor executor, WorldSaveHandler worldSaveHandler, DimensionType dimensionType, Profiler profiler, WorldGenerationProgressListener worldGenerationProgressListener) {
