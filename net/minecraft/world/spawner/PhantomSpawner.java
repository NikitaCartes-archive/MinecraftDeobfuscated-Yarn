...
implements Spawner {
    ...
    public int spawn(ServerWorld world, boolean spawnMonsters, boolean spawnAnimals) {
        ...
        this.cooldown += (60 + abstractRandom.nextInt(60)) * 20;
        ...
        for (PlayerEntity playerEntity : world.getPlayers()) {
            ...
            if (world.getDimension().hasSkyLight() && (blockPos.getY() < world.getSeaLevel() || !world.isSkyVisible(blockPos)) || !(localDifficulty = world.getLocalDifficulty(blockPos)).isHarderThan(abstractRandom.nextFloat() * 3.0f)) continue;
            ...
            int k = 24000;
            if (abstractRandom.nextInt(j) < 72000 || !SpawnHelper.isClearForSpawn(world, blockPos2 = blockPos.up(20 + abstractRandom.nextInt(15)).east(-10 + abstractRandom.nextInt(21)).south(-10 + abstractRandom.nextInt(21)), blockState = world.getBlockState(blockPos2), fluidState = world.getFluidState(blockPos2), EntityType.PHANTOM)) continue;
