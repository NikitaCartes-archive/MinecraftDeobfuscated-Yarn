...
extends OffsetPredicate {
    ...
    public static final Codec<MatchingBlockTagPredicate> CODEC = RecordCodecBuilder.create(instance -> MatchingBlockTagPredicate.registerOffsetField(instance).and(((MapCodec)TagKey.unprefixedCodec(Registry.BLOCK_KEY).fieldOf("tag")).forGetter(predicate -> predicate.tag)).apply((Applicative<MatchingBlockTagPredicate, ?>)instance, MatchingBlockTagPredicate::new));
