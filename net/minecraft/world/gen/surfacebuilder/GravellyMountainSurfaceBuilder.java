...
extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void method_15245(Random random, Chunk chunk, Biome biome, int i, int j, int k, double d, BlockState blockState, BlockState blockState2, int l, long m, TernarySurfaceConfig ternarySurfaceConfig) {
        if (d < -1.0 || d > 2.0) {
