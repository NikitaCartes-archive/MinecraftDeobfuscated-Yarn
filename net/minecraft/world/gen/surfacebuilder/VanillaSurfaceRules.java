...
public class VanillaSurfaceRules {
    ...
    public static MaterialRules.MaterialRule createOverworldSurfaceRule() {
        ...
        MaterialRules.MaterialRule materialRule5 = MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.POWDER_SNOW_UNDER, 0.45, 0.58), POWDER_SNOW);
        MaterialRules.MaterialRule materialRule6 = MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.POWDER_SNOW_SURFACE, 0.35, 0.6), POWDER_SNOW);
