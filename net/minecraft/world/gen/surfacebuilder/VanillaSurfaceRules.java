...
public class VanillaSurfaceRules {
    ...
    private static final MaterialRules.MaterialRule field_35639 = VanillaSurfaceRules.block(Blocks.BEDROCK);
    ...
    private static final MaterialRules.MaterialRule field_35561 = VanillaSurfaceRules.block(Blocks.RED_SANDSTONE);
    private static final MaterialRules.MaterialRule STONE = VanillaSurfaceRules.block(Blocks.STONE);
    private static final MaterialRules.MaterialRule field_35640 = VanillaSurfaceRules.block(Blocks.DEEPSLATE);
    ...
    private static final MaterialRules.MaterialRule field_35562 = VanillaSurfaceRules.block(Blocks.SANDSTONE);
    ...
    public static MaterialRules.MaterialRule createOverworldSurfaceRule() {
        ...
        MaterialRules.MaterialRule materialRule7 = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(BiomeKeys.FROZEN_PEAKS), MaterialRules.sequence(MaterialRules.condition(materialCondition12, PACKED_ICE), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.PACKED_ICE, -0.5, 0.2), PACKED_ICE), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.ICE, -0.0625, 0.025), ICE), SNOW_BLOCK)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.SNOWY_SLOPES), MaterialRules.sequence(MaterialRules.condition(materialCondition12, STONE), materialRule5, SNOW_BLOCK)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.JAGGED_PEAKS), STONE), MaterialRules.condition(MaterialRules.biome(BiomeKeys.GROVE), MaterialRules.sequence(materialRule5, DIRT)), materialRule4, MaterialRules.condition(MaterialRules.biome(BiomeKeys.WINDSWEPT_SAVANNA), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(1.75), STONE)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.WINDSWEPT_GRAVELLY_HILLS), MaterialRules.sequence(MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(2.0), materialRule3), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(1.0), STONE), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(-1.0), DIRT), materialRule3)), DIRT);
        MaterialRules.MaterialRule materialRule8 = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(BiomeKeys.FROZEN_PEAKS), MaterialRules.sequence(MaterialRules.condition(materialCondition12, PACKED_ICE), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.PACKED_ICE, 0.0, 0.2), PACKED_ICE), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.ICE, 0.0, 0.025), ICE), SNOW_BLOCK)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.SNOWY_SLOPES), MaterialRules.sequence(MaterialRules.condition(materialCondition12, STONE), materialRule6, SNOW_BLOCK)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.JAGGED_PEAKS), MaterialRules.sequence(MaterialRules.condition(materialCondition12, STONE), SNOW_BLOCK)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.GROVE), MaterialRules.sequence(materialRule6, SNOW_BLOCK)), materialRule4, MaterialRules.condition(MaterialRules.biome(BiomeKeys.WINDSWEPT_SAVANNA), MaterialRules.sequence(MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(1.75), STONE), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(-0.5), COARSE_DIRT))), MaterialRules.condition(MaterialRules.biome(BiomeKeys.WINDSWEPT_GRAVELLY_HILLS), MaterialRules.sequence(MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(2.0), materialRule3), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(1.0), STONE), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(-1.0), materialRule), materialRule3)), MaterialRules.condition(MaterialRules.biome(BiomeKeys.OLD_GROWTH_PINE_TAIGA, BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA), MaterialRules.sequence(MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(1.75), COARSE_DIRT), MaterialRules.condition(VanillaSurfaceRules.surfaceNoiseThreshold(-0.95), PODZOL))), MaterialRules.condition(MaterialRules.biome(BiomeKeys.ICE_SPIKES), SNOW_BLOCK), MaterialRules.condition(MaterialRules.biome(BiomeKeys.MUSHROOM_FIELDS), MYCELIUM), materialRule);
        ...
        MaterialRules.MaterialRule materialRule9 = MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(BiomeKeys.WOODED_BADLANDS), MaterialRules.condition(materialCondition, MaterialRules.sequence(MaterialRules.condition(materialCondition13, COARSE_DIRT), MaterialRules.condition(materialCondition14, COARSE_DIRT), MaterialRules.condition(materialCondition15, COARSE_DIRT), materialRule))), MaterialRules.condition(MaterialRules.biome(BiomeKeys.SWAMP), MaterialRules.condition(materialCondition5, MaterialRules.condition(MaterialRules.not(materialCondition6), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE_SWAMP, 0.0), WATER)))))), MaterialRules.condition(MaterialRules.biome(BiomeKeys.BADLANDS, BiomeKeys.ERODED_BADLANDS, BiomeKeys.WOODED_BADLANDS), MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(materialCondition2, ORANGE_TERRACOTTA), MaterialRules.condition(materialCondition4, MaterialRules.sequence(MaterialRules.condition(materialCondition13, TERRACOTTA), MaterialRules.condition(materialCondition14, TERRACOTTA), MaterialRules.condition(materialCondition15, TERRACOTTA), MaterialRules.terracottaBands())), MaterialRules.condition(materialCondition7, MaterialRules.sequence(MaterialRules.condition(MaterialRules.field_35494, field_35561), RED_SAND)), MaterialRules.condition(MaterialRules.not(materialCondition10), ORANGE_TERRACOTTA), MaterialRules.condition(materialCondition9, WHITE_TERRACOTTA), materialRule3)), MaterialRules.condition(materialCondition3, MaterialRules.sequence(MaterialRules.condition(materialCondition6, MaterialRules.condition(MaterialRules.not(materialCondition4), ORANGE_TERRACOTTA)), MaterialRules.terracottaBands())), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_RUN_DEPTH, MaterialRules.condition(materialCondition9, WHITE_TERRACOTTA)))), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.condition(materialCondition7, MaterialRules.sequence(MaterialRules.condition(materialCondition11, MaterialRules.condition(materialCondition10, MaterialRules.sequence(MaterialRules.condition(materialCondition8, AIR), MaterialRules.condition(MaterialRules.temperature(), ICE), WATER))), materialRule8))), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.condition(materialCondition9, MaterialRules.condition(materialCondition11, MaterialRules.condition(materialCondition10, WATER)))), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_RUN_DEPTH, MaterialRules.condition(materialCondition9, materialRule7)), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(BiomeKeys.FROZEN_PEAKS, BiomeKeys.JAGGED_PEAKS), STONE), MaterialRules.condition(MaterialRules.biome(BiomeKeys.WARM_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), materialRule2), materialRule3)));
        return MaterialRules.sequence(MaterialRules.condition(MaterialRules.method_39472("bedrock_floor", YOffset.getBottom(), YOffset.aboveBottom(5)), field_35639), MaterialRules.condition(MaterialRules.method_39473(), materialRule9), MaterialRules.condition(MaterialRules.method_39472("deepslate", YOffset.fixed(0), YOffset.fixed(8)), field_35640));
    }
