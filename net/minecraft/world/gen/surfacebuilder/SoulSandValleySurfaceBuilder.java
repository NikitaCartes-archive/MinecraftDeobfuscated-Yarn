...
extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void generate(Random random, Chunk chunk, Biome biome, int i, int j, int k, double d, BlockState blockState, BlockState blockState2, int l, long m, TernarySurfaceConfig ternarySurfaceConfig) {
        ...
        double f = this.field_22205.sample(i, l, j);
        double g = this.field_22212.sample(i, l, j);
        double h = this.field_22207.sample(i, l, j);
        double s = this.field_22206.sample(i, l, j);
        ...
        for (int t = 127; t >= 0; --t) {
            ...
            if ((blockState5.isAir() || blockState5 == blockState2) && blockState6.getBlock() == blockState.getBlock()) {
                for (u = 0; u < r && chunk.getBlockState(mutable).getBlock() == blockState.getBlock(); ++u) {
                    if (bl && t >= n - 4 && t <= n + 1) {
    ...
    public void initSeed(long seed) {
        if (this.seed != seed || this.field_22212 == null || this.field_22205 == null || this.field_22206 == null || this.field_22207 == null || this.field_22208 == null) {
            this.field_22212 = new OctavePerlinNoiseSampler(new ChunkRandom(seed), ImmutableList.of(Integer.valueOf(-4)));
            this.field_22205 = new OctavePerlinNoiseSampler(new ChunkRandom(seed + 1L), ImmutableList.of(Integer.valueOf(-4)));
            this.field_22206 = new OctavePerlinNoiseSampler(new ChunkRandom(seed + 2L), ImmutableList.of(Integer.valueOf(-4)));
            this.field_22207 = new OctavePerlinNoiseSampler(new ChunkRandom(seed + 3L), ImmutableList.of(Integer.valueOf(-4)));
            this.field_22208 = new OctavePerlinNoiseSampler(new ChunkRandom(seed + 4L), ImmutableList.of(Integer.valueOf(0)));
        }
        this.seed = seed;
    }
}
