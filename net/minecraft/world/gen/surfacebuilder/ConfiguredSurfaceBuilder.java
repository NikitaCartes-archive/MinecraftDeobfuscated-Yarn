...
public class ConfiguredSurfaceBuilder<SC extends SurfaceConfig> {
    public static final Codec<ConfiguredSurfaceBuilder<?>> field_25015 = Registry.SURFACE_BUILDER.dispatch("name", configuredSurfaceBuilder -> configuredSurfaceBuilder.surfaceBuilder, SurfaceBuilder::method_29003);
