...
public class NoiseCaveSampler {
    ...
    public NoiseCaveSampler(WorldGenRandom random, int minY) {
        this.minY = minY;
        this.verticalAdditionNoise = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -7, 1.0, 1.0);
        this.falloffNoise = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -8, 1.0);
        this.pow3AdditionNoise = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -8, 1.0);
        ...
        this.caveExtentNoise = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -11, 1.0);
        ...
        this.verticalOffsetNoise = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -8, 1.0);
    }
    ...
    private double getAdditionNoise(int x, int y, int z) {
        double d = 0.0;
        double e = 2.0;
        double f = NoiseHelper.lerpFromProgress(this.falloffNoise, x, y, z, 0.0, 2.0);
        boolean i = false;
        boolean j = true;
        double g = NoiseHelper.lerpFromProgress(this.pow3AdditionNoise, x, y, z, 0.0, 1.0);
        g = Math.pow(g, 3.0);
        double h = 25.0;
        double k = 0.3;
    ...
    private double getVerticalNoise(int x, int y, int z) {
        double d = this.verticalOffsetNoise.sample(x, y * 8, z);
