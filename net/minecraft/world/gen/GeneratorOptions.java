...
public class GeneratorOptions {
    ...
    public GeneratorOptions(long seed, boolean generateStructures, boolean bonusChest, LinkedHashMap<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> linkedHashMap) {
        this(seed, generateStructures, bonusChest, linkedHashMap, Optional.empty());
    }

    private GeneratorOptions(long seed, boolean generateStructures, boolean bonusChest, LinkedHashMap<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> linkedHashMap, Optional<String> legacyCustomOptions) {
        this.seed = seed;
    ...
    public static LinkedHashMap<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> method_28608(LinkedHashMap<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> linkedHashMap, ChunkGenerator chunkGenerator) {
        ...
        for (Map.Entry<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> entry : linkedHashMap.entrySet()) {
            if (Objects.equals(entry.getKey(), DimensionType.OVERWORLD_REGISTRY_KEY)) continue;
    ...
    public GeneratorOptions withHardcore(boolean hardcore, OptionalLong seed) {
        ...
        if (seed.isPresent()) {
            ...
            for (Map.Entry<RegistryKey<DimensionType>, Pair<DimensionType, ChunkGenerator>> entry : this.field_24827.entrySet()) {
