...
public class Structures {
    ...
    public static void bootstrap(Registerable<Structure> structureRegisterable) {
        ...
        structureRegisterable.register(StructureKeys.MANSION, new WoodlandMansionStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.WOODLAND_MANSION_HAS_STRUCTURE), StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.JUNGLE_PYRAMID, new JungleTempleStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.JUNGLE_TEMPLE_HAS_STRUCTURE), StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.DESERT_PYRAMID, new DesertPyramidStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.DESERT_PYRAMID_HAS_STRUCTURE), StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.IGLOO, new IglooStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.IGLOO_HAS_STRUCTURE), StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.SHIPWRECK, new ShipwreckStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.SHIPWRECK_HAS_STRUCTURE), StructureTerrainAdaptation.NONE), false));
        structureRegisterable.register(StructureKeys.SHIPWRECK_BEACHED, new ShipwreckStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.SHIPWRECK_BEACHED_HAS_STRUCTURE), StructureTerrainAdaptation.NONE), true));
        ...
        structureRegisterable.register(StructureKeys.STRONGHOLD, new StrongholdStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.STRONGHOLD_HAS_STRUCTURE), StructureTerrainAdaptation.BURY)));
        ...
        structureRegisterable.register(StructureKeys.OCEAN_RUIN_COLD, new OceanRuinStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.OCEAN_RUIN_COLD_HAS_STRUCTURE), StructureTerrainAdaptation.NONE), OceanRuinStructure.BiomeTemperature.COLD, 0.3f, 0.9f));
        structureRegisterable.register(StructureKeys.OCEAN_RUIN_WARM, new OceanRuinStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.OCEAN_RUIN_WARM_HAS_STRUCTURE), StructureTerrainAdaptation.NONE), OceanRuinStructure.BiomeTemperature.WARM, 0.3f, 0.9f));
        ...
        structureRegisterable.register(StructureKeys.END_CITY, new EndCityStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.END_CITY_HAS_STRUCTURE), StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.BURIED_TREASURE, new BuriedTreasureStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.BURIED_TREASURE_HAS_STRUCTURE), GenerationStep.Feature.UNDERGROUND_STRUCTURES, StructureTerrainAdaptation.NONE)));
        structureRegisterable.register(StructureKeys.BASTION_REMNANT, new JigsawStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.BASTION_REMNANT_HAS_STRUCTURE), StructureTerrainAdaptation.NONE), registryEntryLookup2.getOrThrow(BastionRemnantGenerator.STRUCTURE_POOLS), 6, ConstantHeightProvider.create(YOffset.fixed(33)), false));
        ...
        structureRegisterable.register(StructureKeys.VILLAGE_DESERT, new JigsawStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.VILLAGE_DESERT_HAS_STRUCTURE), StructureTerrainAdaptation.BEARD_THIN), registryEntryLookup2.getOrThrow(DesertVillageData.TOWN_CENTERS_KEY), 6, ConstantHeightProvider.create(YOffset.fixed(0)), true, Heightmap.Type.WORLD_SURFACE_WG));
        structureRegisterable.register(StructureKeys.VILLAGE_SAVANNA, new JigsawStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.VILLAGE_SAVANNA_HAS_STRUCTURE), StructureTerrainAdaptation.BEARD_THIN), registryEntryLookup2.getOrThrow(SavannaVillageData.TOWN_CENTERS_KEY), 6, ConstantHeightProvider.create(YOffset.fixed(0)), true, Heightmap.Type.WORLD_SURFACE_WG));
        structureRegisterable.register(StructureKeys.VILLAGE_SNOWY, new JigsawStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.VILLAGE_SNOWY_HAS_STRUCTURE), StructureTerrainAdaptation.BEARD_THIN), registryEntryLookup2.getOrThrow(SnowyVillageData.TOWN_CENTERS_KEY), 6, ConstantHeightProvider.create(YOffset.fixed(0)), true, Heightmap.Type.WORLD_SURFACE_WG));
        structureRegisterable.register(StructureKeys.VILLAGE_TAIGA, new JigsawStructure(Structures.createConfig(registryEntryLookup.getOrThrow(BiomeTags.VILLAGE_TAIGA_HAS_STRUCTURE), StructureTerrainAdaptation.BEARD_THIN), registryEntryLookup2.getOrThrow(TaigaVillageData.TOWN_CENTERS_KEY), 6, ConstantHeightProvider.create(YOffset.fixed(0)), true, Heightmap.Type.WORLD_SURFACE_WG));
