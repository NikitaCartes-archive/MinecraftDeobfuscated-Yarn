...
public class DensityFunctions {
    ...
    protected static class_7056 method_41103(GenerationShapeConfig generationShapeConfig) {
        return DensityFunctions.method_41104(generationShapeConfig, true, true);
    }

    protected static class_7056 method_41114(GenerationShapeConfig generationShapeConfig) {
        return DensityFunctions.method_41104(generationShapeConfig, false, false);
    }
    ...
    public static RegistryEntry<? extends DensityFunction> init() {
        ...
        DensityFunction densityFunction7 = DensityFunctions.method_40541(densityFunction3, densityFunction4, densityFunction5, DensityFunctionTypes.TerrainShaperSpline.class_7054.OFFSET, -0.81, 2.5, DensityFunctionTypes.blendOffset());
        DensityFunction densityFunction8 = DensityFunctions.method_41112(FACTOR_OVERWORLD, DensityFunctions.method_40541(densityFunction3, densityFunction4, densityFunction5, DensityFunctionTypes.TerrainShaperSpline.class_7054.FACTOR, 0.0, 8.0, field_36618));
        ...
        DensityFunction densityFunction12 = DensityFunctions.method_40541(densityFunction10, densityFunction11, densityFunction5, DensityFunctionTypes.TerrainShaperSpline.class_7054.OFFSET, -0.81, 2.5, DensityFunctionTypes.blendOffset());
        DensityFunction densityFunction13 = DensityFunctions.method_41112(FACTOR_OVERWORLD_LARGE_BIOME, DensityFunctions.method_40541(densityFunction10, densityFunction11, densityFunction5, DensityFunctionTypes.TerrainShaperSpline.class_7054.FACTOR, 0.0, 8.0, field_36618));
    ...
    private static DensityFunction method_41102(DensityFunction densityFunction, DensityFunction densityFunction2, DensityFunction densityFunction3, DensityFunction densityFunction4, DensityFunction densityFunction5, DensityFunction densityFunction6) {
        DensityFunction densityFunction7 = DensityFunctions.method_40541(densityFunction, densityFunction2, densityFunction3, DensityFunctionTypes.TerrainShaperSpline.class_7054.JAGGEDNESS, 0.0, 1.28, field_36619);
        DensityFunction densityFunction8 = DensityFunctionTypes.method_40500(densityFunction7, densityFunction6.halfNegative());
        DensityFunction densityFunction9 = DensityFunctions.method_40540(densityFunction5, densityFunction4, densityFunction8);
    ...
    private static DensityFunction method_41105(GenerationShapeConfig generationShapeConfig, boolean bl, boolean bl2, boolean bl3) {
        DensityFunction densityFunction3;
        DensityFunction densityFunction2;
        boolean bl4;
        boolean bl5 = !bl ? true : (bl4 = false);
        DensityFunction densityFunction = generationShapeConfig.islandNoiseOverride() ? DensityFunctions.method_41116(SLOPED_CHEESE_END) : DensityFunctions.method_41116(bl3 ? SLOPED_CHEESE_OVERWORLD_LARGE_BIOME : SLOPED_CHEESE_OVERWORLD);
        if (bl4) {
            densityFunction2 = densityFunction;
        } else {
            densityFunction3 = DensityFunctionTypes.method_40505(densityFunction, DensityFunctionTypes.method_40500(DensityFunctionTypes.constant(5.0), DensityFunctions.method_41116(CAVES_ENTRANCES_OVERWORLD)));
            densityFunction2 = DensityFunctionTypes.rangeChoice(densityFunction, -1000000.0, 1.5625, densityFunction3, DensityFunctions.method_41101(densityFunction));
        }
        densityFunction3 = DensityFunctionTypes.slide(generationShapeConfig, densityFunction2);
        DensityFunction densityFunction4 = DensityFunctionTypes.interpolated(DensityFunctionTypes.blendDensity(densityFunction3));
        DensityFunction densityFunction5 = DensityFunctionTypes.method_40500(densityFunction4, DensityFunctionTypes.constant(0.64));
        DensityFunction densityFunction6 = bl2 ? DensityFunctions.method_41116(CAVES_NOODLE_OVERWORLD) : DensityFunctionTypes.constant(64.0);
        return DensityFunctionTypes.method_40505(densityFunction5.squeeze(), densityFunction6);
    }
    ...
    protected static class_7056 method_41104(GenerationShapeConfig generationShapeConfig, boolean bl, boolean bl2) {
        ...
        DensityFunction densityFunction7 = DensityFunctionTypes.shiftedNoise(densityFunction5, densityFunction6, 0.25, DensityFunctions.method_41111(bl3 ? NoiseParametersKeys.TEMPERATURE_LARGE : NoiseParametersKeys.TEMPERATURE));
        DensityFunction densityFunction8 = DensityFunctionTypes.shiftedNoise(densityFunction5, densityFunction6, 0.25, DensityFunctions.method_41111(bl3 ? NoiseParametersKeys.VEGETATION_LARGE : NoiseParametersKeys.VEGETATION));
        if (generationShapeConfig.islandNoiseOverride()) {
            densityFunction9 = DensityFunctionTypes.cache2d(DensityFunctionTypes.endIslands(0L));
        } else {
            densityFunction10 = DensityFunctions.method_41116(bl3 ? FACTOR_OVERWORLD_LARGE_BIOME : FACTOR_OVERWORLD);
            densityFunction11 = DensityFunctions.method_41116(bl3 ? DEPTH_OVERWORLD_LARGE_BIOME : DEPTH_OVERWORLD);
            densityFunction9 = DensityFunctions.method_40540(densityFunction11, DensityFunctionTypes.cache2d(densityFunction10), DensityFunctionTypes.zero());
        }
        densityFunction10 = DensityFunctions.method_41105(generationShapeConfig, bl, bl2, bl3);
        densityFunction11 = DensityFunctions.method_41116(Y);
        ...
        DensityFunction densityFunction12 = DensityFunctions.method_40539(densityFunction11, DensityFunctionTypes.method_40502(DensityFunctions.method_41111(NoiseParametersKeys.ORE_VEININESS), 1.5, 1.5), j, k, 0);
        float f = 4.0f;
        DensityFunction densityFunction13 = DensityFunctions.method_40539(densityFunction11, DensityFunctionTypes.method_40502(DensityFunctions.method_41111(NoiseParametersKeys.ORE_VEIN_A), 4.0, 4.0), j, k, 0).abs();
        DensityFunction densityFunction14 = DensityFunctions.method_40539(densityFunction11, DensityFunctionTypes.method_40502(DensityFunctions.method_41111(NoiseParametersKeys.ORE_VEIN_B), 4.0, 4.0), j, k, 0).abs();
        DensityFunction densityFunction15 = DensityFunctionTypes.method_40486(DensityFunctionTypes.constant(-0.08f), DensityFunctionTypes.method_40508(densityFunction13, densityFunction14));
        DensityFunction densityFunction16 = DensityFunctionTypes.noise(DensityFunctions.method_41111(NoiseParametersKeys.ORE_GAP));
        return new class_7056(densityFunction, densityFunction2, densityFunction3, densityFunction4, densityFunction7, densityFunction8, DensityFunctions.method_41116(bl3 ? CONTINENTS_OVERWORLD_LARGE_BIOME : CONTINENTS_OVERWORLD), DensityFunctions.method_41116(bl3 ? EROSION_OVERWORLD_LARGE_BIOME : EROSION_OVERWORLD), DensityFunctions.method_41116(bl3 ? DEPTH_OVERWORLD_LARGE_BIOME : DEPTH_OVERWORLD), DensityFunctions.method_41116(RIDGES_OVERWORLD), densityFunction9, densityFunction10, densityFunction12, densityFunction15, densityFunction16);
    }
    ...
    public static NoiseRouter method_40544(GenerationShapeConfig generationShapeConfig, long l, Registry<DoublePerlinNoiseSampler.NoiseParameters> registry, ChunkRandom.RandomProvider randomProvider, class_7056 arg) {
        ...
        class_7056 lv = arg.method_41124(densityFunctionVisitor2);
        ...
        return new NoiseRouter(lv.barrierNoise(), lv.fluidLevelFloodednessNoise(), lv.fluidLevelSpreadNoise(), lv.lavaNoise(), randomDeriver2, randomDeriver3, lv.temperature(), lv.vegetation(), lv.continents(), lv.erosion(), lv.depth(), lv.ridges(), lv.initialDensityWithoutJaggedness(), lv.finalDensity(), lv.veinToggle(), lv.veinRidged(), lv.veinGap(), new VanillaBiomeParameters().getSpawnSuitabilityNoises());
    }

    private static DensityFunction method_40541(DensityFunction densityFunction, DensityFunction densityFunction2, DensityFunction densityFunction3, DensityFunctionTypes.TerrainShaperSpline.class_7054 arg, double d, double e, DensityFunction densityFunction4) {
        DensityFunction densityFunction5 = DensityFunctionTypes.method_40489(densityFunction, densityFunction2, densityFunction3, arg, d, e);
    ...
    private static DensityFunction method_40540(DensityFunction densityFunction, DensityFunction densityFunction2, DensityFunction densityFunction3) {
        DensityFunction densityFunction4 = DensityFunctionTypes.method_40500(DensityFunctionTypes.method_40486(densityFunction, densityFunction3), densityFunction2);
        return DensityFunctionTypes.method_40500(DensityFunctionTypes.constant(4.0), densityFunction4.quarterNegative());
    }
