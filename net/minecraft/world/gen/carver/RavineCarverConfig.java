...
extends CarverConfig {
    public static final Codec<RavineCarverConfig> RAVINE_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.floatRange(0.0f, 1.0f).fieldOf("probability")).forGetter(ravineCarverConfig -> Float.valueOf(ravineCarverConfig.probability)), CarverDebugConfig.CODEC.optionalFieldOf("debug_settings", CarverDebugConfig.DEFAULT).forGetter(CarverConfig::getDebugConfig), ((MapCodec)YOffset.OFFSET_CODEC.fieldOf("bottom_inclusive")).forGetter(RavineCarverConfig::getBottom), ((MapCodec)YOffset.OFFSET_CODEC.fieldOf("top_inclusive")).forGetter(RavineCarverConfig::getTop), ((MapCodec)UniformIntDistribution.CODEC.fieldOf("y_scale")).forGetter(RavineCarverConfig::getYScale), ((MapCodec)FloatProvider.createValidatedCodec(0.0f, 1.0f).fieldOf("distanceFactor")).forGetter(RavineCarverConfig::getDistanceFactor), ((MapCodec)FloatProvider.VALUE_CODEC.fieldOf("vertical_rotation")).forGetter(RavineCarverConfig::getVerticalRotation), ((MapCodec)FloatProvider.VALUE_CODEC.fieldOf("thickness")).forGetter(RavineCarverConfig::getThickness), ((MapCodec)Codec.intRange(0, Integer.MAX_VALUE).fieldOf("width_smoothness")).forGetter(RavineCarverConfig::getWidthSmoothness), ((MapCodec)FloatProvider.VALUE_CODEC.fieldOf("horizontal_radius_factor")).forGetter(RavineCarverConfig::getHorizontalRadiusFactor), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_default_factor")).forGetter(RavineCarverConfig::getVerticalRadiusDefaultFactor), ((MapCodec)Codec.FLOAT.fieldOf("vertical_radius_center_factor")).forGetter(RavineCarverConfig::getVerticalRadiusCenterFactor)).apply((Applicative<RavineCarverConfig, ?>)instance, RavineCarverConfig::new));
