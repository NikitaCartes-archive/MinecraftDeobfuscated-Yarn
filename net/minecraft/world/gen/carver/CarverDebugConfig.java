...
public class CarverDebugConfig {
    ...
    public static final Codec<CarverDebugConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.BOOL.optionalFieldOf("debug_mode", false).forGetter(CarverDebugConfig::isDebugMode), BlockState.CODEC.optionalFieldOf("air_state", DEFAULT.getDebugState()).forGetter(CarverDebugConfig::getDebugState), BlockState.CODEC.optionalFieldOf("water_state", DEFAULT.getDebugState()).forGetter(CarverDebugConfig::method_36414), BlockState.CODEC.optionalFieldOf("lava_state", DEFAULT.getDebugState()).forGetter(CarverDebugConfig::method_36415), BlockState.CODEC.optionalFieldOf("barrier_state", DEFAULT.getDebugState()).forGetter(CarverDebugConfig::method_36416)).apply((Applicative<CarverDebugConfig, ?>)instance, CarverDebugConfig::new));
