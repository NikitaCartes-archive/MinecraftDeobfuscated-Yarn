...
public class ConfiguredCarvers {
    ...
    public static final ConfiguredCarver<CaveCarverConfig> PROTOTYPE_CAVE = ConfiguredCarvers.register("prototype_cave", Carver.CAVE.configure(new CaveCarverConfig(0.33333334f, UniformHeightProvider.create(YOffset.aboveBottom(8), YOffset.fixed(126)), UniformFloatProvider.create(0.1f, 0.9f), YOffset.aboveBottom(8), false, CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), UniformFloatProvider.create(0.7f, 1.4f), UniformFloatProvider.create(0.8f, 1.3f), UniformFloatProvider.create(-1.0f, -0.4f))));
