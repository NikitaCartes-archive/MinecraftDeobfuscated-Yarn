...
public class ConfiguredCarvers {
    public static final ConfiguredCarver<CarverConfig> CAVE = ConfiguredCarvers.register("cave", Carver.CAVE.configure(new CarverConfig(0.25f, CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()))));
    ...
    public static final ConfiguredCarver<CarverConfig> OCEAN_CAVE = ConfiguredCarvers.register("ocean_cave", Carver.CAVE.configure(new CarverConfig(0.125f, CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()))));
