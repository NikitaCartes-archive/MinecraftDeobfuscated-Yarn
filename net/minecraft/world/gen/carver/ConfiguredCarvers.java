...
public class ConfiguredCarvers {
    ...
    public static final ConfiguredCarver<CaveCarverConfig> OLD_OCEAN_CAVE = ConfiguredCarvers.register("old_ocean_cave", Carver.CAVE.configure(new CaveCarverConfig(0.06666667f, BiasedToBottomHeightProvider.create(YOffset.fixed(0), YOffset.fixed(127), 8), ConstantFloatProvider.create(0.5f), YOffset.aboveBottom(11), CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(-0.7f))));
    public static final ConfiguredCarver<CaveCarverConfig> OCEAN_CAVE = ConfiguredCarvers.register("ocean_cave", Carver.CAVE.configure(new CaveCarverConfig(0.14285715f, BiasedToBottomHeightProvider.create(YOffset.fixed(0), YOffset.fixed(127), 8), UniformFloatProvider.create(0.1f, 0.9f), YOffset.aboveBottom(9), CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(1.0f), UniformFloatProvider.create(-1.0f, 0.0f))));
    public static final ConfiguredCarver<RavineCarverConfig> OLD_UNDERWATER_CANYON = ConfiguredCarvers.register("old_underwater_canyon", Carver.UNDERWATER_CANYON.configure(new RavineCarverConfig(0.02f, BiasedToBottomHeightProvider.create(YOffset.fixed(20), YOffset.fixed(67), 8), ConstantFloatProvider.create(3.0f), YOffset.aboveBottom(11), CarverDebugConfig.create(false, Blocks.WARPED_BUTTON.getDefaultState()), UniformFloatProvider.create(-0.125f, 0.125f), new RavineCarverConfig.Shape(UniformFloatProvider.create(0.75f, 1.0f), TrapezoidFloatProvider.create(0.0f, 6.0f, 2.0f), 3, UniformFloatProvider.create(0.75f, 1.0f), 1.0f, 0.0f))));
    public static final ConfiguredCarver<CaveCarverConfig> OLD_UNDERWATER_CAVE = ConfiguredCarvers.register("old_underwater_cave", Carver.UNDERWATER_CAVE.configure(new CaveCarverConfig(0.06666667f, BiasedToBottomHeightProvider.create(YOffset.fixed(0), YOffset.fixed(127), 8), ConstantFloatProvider.create(0.5f), YOffset.aboveBottom(11), CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(-0.7f))));
