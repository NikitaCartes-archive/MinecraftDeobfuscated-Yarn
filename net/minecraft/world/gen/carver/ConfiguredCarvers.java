...
public class ConfiguredCarvers {
    ...
    public static final ConfiguredCarver<CaveCarverConfig> PROTOTYPE_CAVE = ConfiguredCarvers.register("prototype_cave", Carver.CAVE.configure(new CaveCarverConfig(0.33333334f, UniformHeightProvider.create(YOffset.aboveBottom(8), YOffset.fixed(126)), UniformFloatProvider.create(0.1f, 0.9f), YOffset.aboveBottom(8), false, CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), UniformFloatProvider.create(0.3f, 1.8f), UniformFloatProvider.create(0.5f, 1.8f), UniformFloatProvider.create(-1.0f, 0.0f))));
    ...
    public static final ConfiguredCarver<CaveCarverConfig> PROTOTYPE_OCEAN_CAVE = ConfiguredCarvers.register("prototype_ocean_cave", Carver.CAVE.configure(new CaveCarverConfig(0.14285715f, BiasedToBottomHeightProvider.create(YOffset.fixed(0), YOffset.fixed(127), 8), UniformFloatProvider.create(0.1f, 0.9f), YOffset.aboveBottom(8), false, CarverDebugConfig.create(false, Blocks.CRIMSON_BUTTON.getDefaultState()), ConstantFloatProvider.create(1.0f), ConstantFloatProvider.create(1.0f), UniformFloatProvider.create(-1.0f, 0.0f))));
    ...
    public static final ConfiguredCarver<RavineCarverConfig> PROTOTYPE_CREVICE = ConfiguredCarvers.register("prototype_crevice", Carver.RAVINE.configure(new RavineCarverConfig(0.00125f, UniformHeightProvider.create(YOffset.fixed(40), YOffset.fixed(80)), UniformFloatProvider.create(6.0f, 8.0f), YOffset.aboveBottom(8), false, CarverDebugConfig.create(false, Blocks.OAK_BUTTON.getDefaultState()), UniformFloatProvider.create(-0.125f, 0.125f), new RavineCarverConfig.Shape(UniformFloatProvider.create(0.5f, 1.0f), UniformFloatProvider.create(0.0f, 1.0f), 6, UniformFloatProvider.create(0.25f, 1.0f), 0.0f, 5.0f))));
