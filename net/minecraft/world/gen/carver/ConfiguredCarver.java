...
public record ConfiguredCarver<WC extends CarverConfig>(Carver<WC> carver, WC config) {
    ...
    public boolean carve(CarverContext context, Chunk chunk, Function<BlockPos, RegistryEntry<Biome>> posToBiome, AbstractRandom random, AquiferSampler aquiferSampler, ChunkPos pos, CarvingMask mask) {
