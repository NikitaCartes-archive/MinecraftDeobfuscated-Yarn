...
extends Carver<ProbabilityConfig> {
    ...
    public boolean method_12673(Chunk chunk, Function<BlockPos, Biome> function, Random random, int i, int j, int k, int l, int m, BitSet bitSet, ProbabilityConfig probabilityConfig) {
    ...
    protected void carveTunnels(Chunk chunk, Function<BlockPos, Biome> function, long l, int i, int j, int k, double d, double e, double f, float g, float h, float m, int n, int o, double p, BitSet bitSet) {
        ...
        for (int t = n; t < o; ++t) {
            ...
            if (t == q && g > 1.0f) {
                this.carveTunnels(chunk, function, random.nextLong(), i, j, k, d, e, f, random.nextFloat() * 0.5f + 0.5f, h - 1.5707964f, m / 3.0f, t, o, 1.0, bitSet);
                this.carveTunnels(chunk, function, random.nextLong(), i, j, k, d, e, f, random.nextFloat() * 0.5f + 0.5f, h + 1.5707964f, m / 3.0f, t, o, 1.0, bitSet);
                return;
            }
