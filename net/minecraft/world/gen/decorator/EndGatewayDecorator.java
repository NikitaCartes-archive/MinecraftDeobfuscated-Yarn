...
extends Decorator<NopeDecoratorConfig> {
    ...
    public Stream<BlockPos> getPositions(DecoratorContext decoratorContext, Random random, NopeDecoratorConfig nopeDecoratorConfig, BlockPos blockPos) {
        ...
        int i;
        int k;
        if (random.nextInt(700) == 0 && (k = decoratorContext.getTopY(Heightmap.Type.MOTION_BLOCKING, i = random.nextInt(16) + blockPos.getX(), j = random.nextInt(16) + blockPos.getZ())) > decoratorContext.getSectionCount()) {
