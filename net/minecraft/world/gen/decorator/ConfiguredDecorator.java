...
public class ConfiguredDecorator<DC extends DecoratorConfig> {
    public static final Codec<ConfiguredDecorator<?>> field_24981 = Registry.DECORATOR.dispatch("name", configuredDecorator -> configuredDecorator.decorator, Decorator::method_28928);
