...
import net.minecraft.world.gen.decorator.BiasedRangeDecorator;
...
public abstract class Decorator<DC extends DecoratorConfig> {
    ...
    public static final Decorator<BiasedRangedDecoratorConfig> RANGE_VERY_BIASED_TO_BOTTOM = Decorator.register("range_very_biased_to_bottom", new VeryBiasedRangeDecoratorConfig(BiasedRangedDecoratorConfig.CODEC));
