...
implements DecoratorConfig {
    public static final Codec<RangeDecoratorConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)YOffset.OFFSET_CODEC.fieldOf("bottom_inclusive")).forGetter(RangeDecoratorConfig::getBottom), ((MapCodec)YOffset.OFFSET_CODEC.fieldOf("top_inclusive")).forGetter(RangeDecoratorConfig::getTop)).apply((Applicative<RangeDecoratorConfig, ?>)instance, RangeDecoratorConfig::new));
