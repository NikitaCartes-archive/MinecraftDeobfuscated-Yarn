...
extends SimpleDecorator<CountExtraChanceDecoratorConfig> {
    ...
    public Stream<BlockPos> getPositions(Random random, CountExtraChanceDecoratorConfig countExtraChanceDecoratorConfig, BlockPos blockPos) {
        int i2 = countExtraChanceDecoratorConfig.count + (random.nextFloat() < countExtraChanceDecoratorConfig.extraChance ? countExtraChanceDecoratorConfig.extraCount : 0);
