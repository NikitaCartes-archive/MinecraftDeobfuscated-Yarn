...
extends Feature<RandomRandomFeatureConfig> {
    ...
    @Override
    public boolean generate(ServerWorldAccess serverWorldAccess, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, RandomRandomFeatureConfig randomRandomFeatureConfig) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            configuredFeature.generate(serverWorldAccess, chunkGenerator, random, blockPos);
        }
        return true;
    }
}
