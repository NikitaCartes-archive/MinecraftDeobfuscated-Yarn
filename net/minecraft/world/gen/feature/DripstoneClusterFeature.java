...
extends Feature<DripstoneClusterFeatureConfig> {
    ...
    private void generate(StructureWorldAccess world, AbstractRandom random, BlockPos pos, int localX, int localZ, float wetness, double dripstoneChance, int height, float density, DripstoneClusterFeatureConfig config) {
        boolean bl4;
        int t;
        int m;
        boolean bl3;
