...
public class NormalTreeFeatureConfig
extends AbstractTreeFeatureConfig {
    ...
    protected NormalTreeFeatureConfig(StateProvider stateProvider, StateProvider stateProvider2, FoliagePlacer foliagePlacer, List<TreeDecorator> list, int i, int j, int k, int l, int m, int n, int o, int p, int q, int r, boolean bl) {
    ...
    public <T> Dynamic<T> serialize(DynamicOps<T> dynamicOps) {
        ...
        builder.put(dynamicOps.createString("foliage_placer"), this.foliagePlacer.serialize(dynamicOps)).put(dynamicOps.createString("height_rand_a"), dynamicOps.createInt(this.heightRandA)).put(dynamicOps.createString("height_rand_b"), dynamicOps.createInt(this.heightRandB)).put(dynamicOps.createString("trunk_height"), dynamicOps.createInt(this.trunkHeight)).put(dynamicOps.createString("trunk_height_random"), dynamicOps.createInt(this.trunkHeightRandom)).put(dynamicOps.createString("trunk_top_offset"), dynamicOps.createInt(this.trunkTopOffsetRandom)).put(dynamicOps.createString("trunk_top_offset_random"), dynamicOps.createInt(this.field_21265)).put(dynamicOps.createString("foliage_height"), dynamicOps.createInt(this.field_21266)).put(dynamicOps.createString("foliage_height_random"), dynamicOps.createInt(this.field_21267)).put(dynamicOps.createString("max_water_depth"), dynamicOps.createInt(this.field_21268)).put(dynamicOps.createString("ignore_vines"), dynamicOps.createBoolean(this.field_21269));
    ...
    extends AbstractTreeFeatureConfig.Builder {
        ...
        public Builder method_23429(List<TreeDecorator> list) {
            this.treeDecorators = list;
            return this;
        }

        public Builder method_23428(int i) {
            this.field_21272 = i;
            return this;
        }

        public Builder method_23430(int i) {
            this.field_21273 = i;
            return this;
        }

        public Builder method_23432(int i) {
            this.field_21274 = i;
            return this;
        }

        public Builder method_23433(int i) {
            this.field_21275 = i;
            return this;
        }

        public Builder method_23434(int i) {
            this.field_21276 = i;
            return this;
        }

        public Builder method_23435(int i) {
            this.field_21277 = i;
            return this;
        }

        public Builder method_23436(int i) {
            this.field_21278 = i;
            return this;
        }

        public Builder method_23437(int i) {
            this.field_21279 = i;
            return this;
        }

        public Builder method_23438(int i) {
            this.field_21280 = i;
            return this;
        }

        public Builder method_23439(int i) {
            this.field_21281 = i;
            return this;
        }

        public Builder method_23427() {
            this.field_21282 = true;
            return this;
        }

        public NormalTreeFeatureConfig method_23431() {
            return new NormalTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.field_21270, this.treeDecorators, this.field_21272, this.field_21273, this.field_21274, this.field_21275, this.field_21276, this.field_21277, this.field_21278, this.field_21279, this.field_21280, this.field_21281, this.field_21282);
        }
