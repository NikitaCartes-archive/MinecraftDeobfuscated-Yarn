...
public class UndergroundConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<SculkPatchFeatureConfig, ?>> SCULK_PATCH = ConfiguredFeatures.register("sculk_patch", Feature.SCULK_PATCH, new SculkPatchFeatureConfig(10, 32, 64, 0, 1, 0.5f));
