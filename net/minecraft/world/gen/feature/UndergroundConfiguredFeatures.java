...
public class UndergroundConfiguredFeatures {
    public static final ConfiguredFeature<DefaultFeatureConfig, ?> MONSTER_ROOM = ConfiguredFeatures.register("monster_room", Feature.MONSTER_ROOM.configure(FeatureConfig.DEFAULT));
    ...
    public static final ConfiguredFeature<FossilFeatureConfig, ?> FOSSIL_COAL = ConfiguredFeatures.register("fossil_coal", Feature.FOSSIL.configure(new FossilFeatureConfig(FOSSIL_IDS, COAL_FOSSIL_IDS, StructureProcessorLists.FOSSIL_ROT, StructureProcessorLists.FOSSIL_COAL, 4)));
    public static final ConfiguredFeature<FossilFeatureConfig, ?> FOSSIL_DIAMONDS = ConfiguredFeatures.register("fossil_diamonds", Feature.FOSSIL.configure(new FossilFeatureConfig(FOSSIL_IDS, COAL_FOSSIL_IDS, StructureProcessorLists.FOSSIL_ROT, StructureProcessorLists.FOSSIL_DIAMONDS, 4)));
    public static final ConfiguredFeature<DripstoneClusterFeatureConfig, ?> DRIPSTONE_CLUSTER = ConfiguredFeatures.register("dripstone_cluster", Feature.DRIPSTONE_CLUSTER.configure(new DripstoneClusterFeatureConfig(12, UniformIntProvider.create(3, 6), UniformIntProvider.create(2, 8), 1, 3, UniformIntProvider.create(2, 4), UniformFloatProvider.create(0.3f, 0.7f), ClampedNormalFloatProvider.create(0.1f, 0.3f, 0.1f, 0.9f), 0.1f, 3, 8)));
    public static final ConfiguredFeature<LargeDripstoneFeatureConfig, ?> LARGE_DRIPSTONE = ConfiguredFeatures.register("large_dripstone", Feature.LARGE_DRIPSTONE.configure(new LargeDripstoneFeatureConfig(30, UniformIntProvider.create(3, 19), UniformFloatProvider.create(0.4f, 2.0f), 0.33f, UniformFloatProvider.create(0.3f, 0.9f), UniformFloatProvider.create(0.4f, 1.0f), UniformFloatProvider.create(0.0f, 0.3f), 4, 0.6f)));
    public static final ConfiguredFeature<SimpleRandomFeatureConfig, ?> POINTED_DRIPSTONE = ConfiguredFeatures.register("pointed_dripstone", Feature.SIMPLE_RANDOM_SELECTOR.configure(new SimpleRandomFeatureConfig(ImmutableList.of(() -> Feature.POINTED_DRIPSTONE.configure(new SmallDripstoneFeatureConfig(0.2f, 0.7f, 0.5f, 0.5f)).withPlacement(EnvironmentScanPlacementModifier.of(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.IS_AIR_OR_WATER, 12)), () -> Feature.POINTED_DRIPSTONE.configure(new SmallDripstoneFeatureConfig(0.2f, 0.7f, 0.5f, 0.5f)).withPlacement(EnvironmentScanPlacementModifier.of(Direction.UP, BlockPredicate.solid(), BlockPredicate.IS_AIR_OR_WATER, 12))))));
    public static final ConfiguredFeature<UnderwaterMagmaFeatureConfig, ?> UNDERWATER_MAGMA = ConfiguredFeatures.register("underwater_magma", Feature.UNDERWATER_MAGMA.configure(new UnderwaterMagmaFeatureConfig(5, 1, 0.5f)));
    public static final ConfiguredFeature<GlowLichenFeatureConfig, ?> GLOW_LICHEN = ConfiguredFeatures.register("glow_lichen", Feature.GLOW_LICHEN.configure(new GlowLichenFeatureConfig(20, false, true, true, 0.5f, List.of(Blocks.STONE.getDefaultState(), Blocks.ANDESITE.getDefaultState(), Blocks.DIORITE.getDefaultState(), Blocks.GRANITE.getDefaultState(), Blocks.DRIPSTONE_BLOCK.getDefaultState(), Blocks.CALCITE.getDefaultState(), Blocks.TUFF.getDefaultState(), Blocks.DEEPSLATE.getDefaultState()))));
    public static final ConfiguredFeature<RootSystemFeatureConfig, ?> ROOTED_AZALEA_TREE = ConfiguredFeatures.register("rooted_azalea_tree", Feature.ROOT_SYSTEM.configure(new RootSystemFeatureConfig(() -> TreeConfiguredFeatures.AZALEA_TREE.withPlacement(new PlacementModifier[0]), 3, 3, BlockTags.LUSH_GROUND_REPLACEABLE.getId(), BlockStateProvider.of(Blocks.ROOTED_DIRT), 20, 100, 3, 2, BlockStateProvider.of(Blocks.HANGING_ROOTS), 20, 2)));
    private static final WeightedBlockStateProvider field_35793 = new WeightedBlockStateProvider(DataPool.builder().add(Blocks.CAVE_VINES_PLANT.getDefaultState(), 4).add((BlockState)Blocks.CAVE_VINES_PLANT.getDefaultState().with(CaveVines.BERRIES, true), 1));
    private static final RandomizedIntBlockStateProvider field_35794 = new RandomizedIntBlockStateProvider((BlockStateProvider)new WeightedBlockStateProvider(DataPool.builder().add(Blocks.CAVE_VINES.getDefaultState(), 4).add((BlockState)Blocks.CAVE_VINES.getDefaultState().with(CaveVines.BERRIES, true), 1)), CaveVinesHeadBlock.AGE, (IntProvider)UniformIntProvider.create(23, 25));
    public static final ConfiguredFeature<BlockColumnFeatureConfig, ?> CAVE_VINE = ConfiguredFeatures.register("cave_vine", Feature.BLOCK_COLUMN.configure(new BlockColumnFeatureConfig(List.of(BlockColumnFeatureConfig.createLayer(new WeightedListIntProvider(DataPool.builder().add(UniformIntProvider.create(0, 19), 2).add(UniformIntProvider.create(0, 2), 3).add(UniformIntProvider.create(0, 6), 10).build()), field_35793), BlockColumnFeatureConfig.createLayer(ConstantIntProvider.create(1), field_35794)), Direction.DOWN, BlockPredicate.IS_AIR, true)));
    public static final ConfiguredFeature<BlockColumnFeatureConfig, ?> CAVE_VINE_IN_MOSS = ConfiguredFeatures.register("cave_vine_in_moss", Feature.BLOCK_COLUMN.configure(new BlockColumnFeatureConfig(List.of(BlockColumnFeatureConfig.createLayer(new WeightedListIntProvider(DataPool.builder().add(UniformIntProvider.create(0, 3), 5).add(UniformIntProvider.create(1, 7), 1).build()), field_35793), BlockColumnFeatureConfig.createLayer(ConstantIntProvider.create(1), field_35794)), Direction.DOWN, BlockPredicate.IS_AIR, true)));
    ...
    public static final ConfiguredFeature<SimpleRandomFeatureConfig, ?> DRIPLEAF = ConfiguredFeatures.register("dripleaf", Feature.SIMPLE_RANDOM_SELECTOR.configure(new SimpleRandomFeatureConfig(List.of(UndergroundConfiguredFeatures::method_39686, () -> UndergroundConfiguredFeatures.method_39687(Direction.EAST), () -> UndergroundConfiguredFeatures.method_39687(Direction.WEST), () -> UndergroundConfiguredFeatures.method_39687(Direction.SOUTH), () -> UndergroundConfiguredFeatures.method_39687(Direction.NORTH)))));
    public static final ConfiguredFeature<?, ?> CLAY_WITH_DRIPLEAVES = ConfiguredFeatures.register("clay_with_dripleaves", Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(BlockTags.LUSH_GROUND_REPLACEABLE.getId(), BlockStateProvider.of(Blocks.CLAY), () -> DRIPLEAF, VerticalSurfaceType.FLOOR, ConstantIntProvider.create(3), 0.8f, 2, 0.05f, UniformIntProvider.create(4, 7), 0.7f)));
