...
public class UndergroundConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> CLAY_WITH_DRIPLEAVES = ConfiguredFeatures.register("clay_with_dripleaves", Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(BlockTags.LUSH_GROUND_REPLACEABLE.getId(), BlockStateProvider.of(Blocks.CLAY), () -> DRIPLEAF.withPlacement(new PlacementModifier[0]), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(3), 0.8f, 2, 0.05f, UniformIntProvider.create(4, 7), 0.7f)));
    public static final ConfiguredFeature<?, ?> CLAY_POOL_WITH_DRIPLEAVES = ConfiguredFeatures.register("clay_pool_with_dripleaves", Feature.WATERLOGGED_VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(BlockTags.LUSH_GROUND_REPLACEABLE.getId(), BlockStateProvider.of(Blocks.CLAY), () -> DRIPLEAF.withPlacement(new PlacementModifier[0]), VerticalSurfaceType.FLOOR, ConstantIntProvider.create(3), 0.8f, 5, 0.1f, UniformIntProvider.create(4, 7), 0.7f)));
    public static final ConfiguredFeature<RandomBooleanFeatureConfig, ?> LUSH_CAVES_CLAY = ConfiguredFeatures.register("lush_caves_clay", Feature.RANDOM_BOOLEAN_SELECTOR.configure(new RandomBooleanFeatureConfig(() -> CLAY_WITH_DRIPLEAVES.withPlacement(new PlacementModifier[0]), () -> CLAY_POOL_WITH_DRIPLEAVES.withPlacement(new PlacementModifier[0]))));
    public static final ConfiguredFeature<VegetationPatchFeatureConfig, ?> MOSS_PATCH_CEILING = ConfiguredFeatures.register("moss_patch_ceiling", Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(BlockTags.MOSS_REPLACEABLE.getId(), BlockStateProvider.of(Blocks.MOSS_BLOCK), () -> CAVE_VINE_IN_MOSS.withPlacement(new PlacementModifier[0]), VerticalSurfaceType.CEILING, UniformIntProvider.create(1, 2), 0.0f, 5, 0.08f, UniformIntProvider.create(4, 7), 0.3f)));
