...
public class ConfiguredStructureFeature<FC extends FeatureConfig, F extends StructureFeature<FC>> {
     ...
     */
    public StructureStart<?> tryPlaceStart(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, BiomeSource biomeSource, StructureManager structureManager, long worldSeed, ChunkPos chunkPos, int structureReferences, StructureConfig structureConfig, HeightLimitView world, Predicate<Biome> biomeLimit) {
        return ((StructureFeature)this.feature).tryPlaceStart(registryManager, chunkGenerator, biomeSource, structureManager, worldSeed, chunkPos, structureReferences, structureConfig, this.config, world, biomeLimit);
    }
}
