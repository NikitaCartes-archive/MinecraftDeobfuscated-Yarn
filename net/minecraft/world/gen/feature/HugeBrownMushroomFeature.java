    ...
    protected void method_23375(IWorld iWorld, Random random, BlockPos blockPos, int i, BlockPos.Mutable mutable, class_4635 arg) {
        ...
        for (int k = -j; k <= j; ++k) {
            for (int l = -j; l <= j; ++l) {
                ...
                this.setBlockState(iWorld, mutable, (BlockState)((BlockState)((BlockState)((BlockState)arg.field_21230.method_23455(random, blockPos).with(MushroomBlock.WEST, bl72)).with(MushroomBlock.EAST, bl8)).with(MushroomBlock.NORTH, bl9)).with(MushroomBlock.SOUTH, bl10));
            }
        }
    }
