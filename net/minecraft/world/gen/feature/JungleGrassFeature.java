...
extends Feature<DefaultFeatureConfig> {
    ...
    public boolean method_13459(IWorld iWorld, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator, Random random, BlockPos blockPos, DefaultFeatureConfig defaultFeatureConfig) {
        ...
        for (int j = 0; j < 128; ++j) {
            ...
            if (!iWorld.method_22347(blockPos2) || iWorld.getBlockState(blockPos2.down()).getBlock() == Blocks.PODZOL || !blockState.canPlaceAt(iWorld, blockPos2)) continue;
