...
implements FeatureConfig {
    public static final Codec<RandomPatchFeatureConfig> field_24902 = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockStateProvider.field_24937.fieldOf("state_provider")).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.stateProvider), ((MapCodec)BlockPlacer.field_24865.fieldOf("block_placer")).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.blockPlacer), ((MapCodec)BlockState.field_24734.listOf().fieldOf("whitelist")).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.whitelist.stream().map(Block::getDefaultState).collect(Collectors.toList())), ((MapCodec)BlockState.field_24734.listOf().fieldOf("blacklist")).forGetter(randomPatchFeatureConfig -> ImmutableList.copyOf(randomPatchFeatureConfig.blacklist)), ((MapCodec)Codec.INT.fieldOf("tries")).withDefault(128).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.tries), ((MapCodec)Codec.INT.fieldOf("xspread")).withDefault(7).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.spreadX), ((MapCodec)Codec.INT.fieldOf("yspread")).withDefault(3).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.spreadY), ((MapCodec)Codec.INT.fieldOf("zspread")).withDefault(7).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.spreadZ), ((MapCodec)Codec.BOOL.fieldOf("can_replace")).withDefault(false).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.canReplace), ((MapCodec)Codec.BOOL.fieldOf("project")).withDefault(true).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.project), ((MapCodec)Codec.BOOL.fieldOf("need_water")).withDefault(false).forGetter(randomPatchFeatureConfig -> randomPatchFeatureConfig.needsWater)).apply((Applicative<RandomPatchFeatureConfig, ?>)instance, RandomPatchFeatureConfig::new));
    ...
    private RandomPatchFeatureConfig(BlockStateProvider blockStateProvider, BlockPlacer blockPlacer, List<BlockState> list, List<BlockState> list2, int i, int j, int k, int l, boolean bl, boolean bl2, boolean bl3) {
        this(blockStateProvider, blockPlacer, list.stream().map(AbstractBlock.AbstractBlockState::getBlock).collect(Collectors.toSet()), ImmutableSet.copyOf(list2), i, j, k, l, bl, bl2, bl3);
    }
