...
extends StructureFeature<ShipwreckFeatureConfig> {
    ...
    extends StructureStart<ShipwreckFeatureConfig> {
        ...
        @Override
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int j, Biome biome, ShipwreckFeatureConfig shipwreckFeatureConfig, HeightLimitView heightLimitView) {
