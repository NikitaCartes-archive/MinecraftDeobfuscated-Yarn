...
extends StructureFeature<ShipwreckFeatureConfig> {
    ...
    extends StructureStart<ShipwreckFeatureConfig> {
        ...
        @Override
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, ShipwreckFeatureConfig shipwreckFeatureConfig, HeightLimitView heightLimitView, Predicate<Biome> predicate) {
            if (!StructureFeature.checkBiome(chunkGenerator, heightLimitView, predicate, shipwreckFeatureConfig.isBeached ? Heightmap.Type.WORLD_SURFACE_WG : Heightmap.Type.OCEAN_FLOOR_WG, chunkPos.getCenterX(), chunkPos.getCenterZ())) {
                return;
            }
