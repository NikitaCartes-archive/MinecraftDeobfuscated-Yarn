...
extends StructureFeature {
    public static final Codec<ShipwreckFeature> CODEC = RecordCodecBuilder.create(instance -> ShipwreckFeature.method_41608(instance).and(((MapCodec)Codec.BOOL.fieldOf("is_beached")).forGetter(shipwreckFeature -> shipwreckFeature.field_37816)).apply((Applicative<ShipwreckFeature, ?>)instance, ShipwreckFeature::new));
    public final boolean field_37816;

    public ShipwreckFeature(RegistryEntryList<Biome> registryEntryList, Map<SpawnGroup, StructureSpawns> map, GenerationStep.Feature feature, boolean bl, boolean bl2) {
    ...
    public Optional<StructureFeature.class_7150> method_38676(StructureFeature.class_7149 arg) {
        ...
        return ShipwreckFeature.method_41612(arg, type, structurePiecesCollector -> this.addPieces((StructurePiecesCollector)structurePiecesCollector, arg));
    }
