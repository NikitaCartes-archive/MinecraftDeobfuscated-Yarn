...
extends StructureFeature {
    public static final Codec<StrongholdFeature> CODEC = RecordCodecBuilder.create(instance -> StrongholdFeature.method_41608(instance).apply(instance, StrongholdFeature::new));
    ...
    public Optional<StructureFeature.class_7150> method_38676(StructureFeature.class_7149 arg) {
        return Optional.of(new StructureFeature.class_7150(arg.chunkPos().getStartPos(), structurePiecesCollector -> StrongholdFeature.method_41691(structurePiecesCollector, arg)));
    }
