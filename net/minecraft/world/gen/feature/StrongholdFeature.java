...
extends StructureFeature {
    public static final Codec<StrongholdFeature> CODEC = StrongholdFeature.createCodec(StrongholdFeature::new);
    ...
    public Optional<StructureFeature.StructurePosition> getStructurePosition(StructureFeature.Context context) {
        return Optional.of(new StructureFeature.StructurePosition(context.chunkPos().getStartPos(), structurePiecesCollector -> StrongholdFeature.addPieces(structurePiecesCollector, context)));
    }
