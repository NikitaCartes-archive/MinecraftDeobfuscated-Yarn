...
public class EndPlacedFeatures {
    ...
    public static final PlacedFeature END_ISLAND_DECORATED = PlacedFeatures.register("end_island_decorated", EndConfiguredFeatures.END_ISLAND.withPlacement(RarityFilterPlacementModifier.of(14), PlacedFeatures.createCountExtraModifier(1, 0.25f, 1), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.fixed(55), YOffset.fixed(70)), BiomePlacementModifier.of()));
}
