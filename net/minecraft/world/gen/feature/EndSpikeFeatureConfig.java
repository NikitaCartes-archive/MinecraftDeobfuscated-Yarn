...
implements FeatureConfig {
    public static final Codec<EndSpikeFeatureConfig> field_24911 = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.BOOL.fieldOf("crystal_invulnerable")).withDefault(false).forGetter(endSpikeFeatureConfig -> endSpikeFeatureConfig.crystalInvulnerable), ((MapCodec)EndSpikeFeature.Spike.CODEC.listOf().fieldOf("spikes")).forGetter(endSpikeFeatureConfig -> endSpikeFeatureConfig.spikes), BlockPos.field_25064.optionalFieldOf("crystal_beam_target").forGetter(endSpikeFeatureConfig -> Optional.ofNullable(endSpikeFeatureConfig.crystalBeamTarget))).apply((Applicative<EndSpikeFeatureConfig, ?>)instance, EndSpikeFeatureConfig::new));
