...
extends BasicTempleStructureFeature {
    public static final Codec<DesertPyramidFeature> CODEC = RecordCodecBuilder.create(instance -> DesertPyramidFeature.method_41608(instance).apply(instance, DesertPyramidFeature::new));
