...
extends class_4626<NormalTreeFeatureConfig> {
    ...
    public boolean method_23402(ModifiableTestableWorld modifiableTestableWorld, Random random, BlockPos blockPos, Set<BlockPos> set, Set<BlockPos> set2, BlockBox blockBox, NormalTreeFeatureConfig normalTreeFeatureConfig) {
        int k;
        int j;
        ...
        this.method_23379(modifiableTestableWorld, random, i, blockPos2, normalTreeFeatureConfig.trunkTopOffsetRandom + random.nextInt(normalTreeFeatureConfig.field_21265 + 1), set, blockBox, normalTreeFeatureConfig);
        return true;
    }
}
