...
extends StructureFeature {
    public static final Codec<IglooFeature> CODEC = RecordCodecBuilder.create(instance -> IglooFeature.method_41608(instance).apply(instance, IglooFeature::new));
    ...
    public Optional<StructureFeature.class_7150> method_38676(StructureFeature.class_7149 arg) {
        return IglooFeature.method_41612(arg, Heightmap.Type.WORLD_SURFACE_WG, structurePiecesCollector -> this.addPieces((StructurePiecesCollector)structurePiecesCollector, arg));
    }
