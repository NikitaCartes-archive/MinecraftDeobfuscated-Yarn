...
extends StructureFeature {
    public static final Codec<IglooFeature> CODEC = IglooFeature.createCodec(IglooFeature::new);
    ...
    public Optional<StructureFeature.StructurePosition> getStructurePosition(StructureFeature.Context context) {
        return IglooFeature.getStructurePosition(context, Heightmap.Type.WORLD_SURFACE_WG, structurePiecesCollector -> this.addPieces((StructurePiecesCollector)structurePiecesCollector, context));
    }
