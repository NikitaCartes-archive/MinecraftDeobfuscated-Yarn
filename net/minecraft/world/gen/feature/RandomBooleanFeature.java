...
extends Feature<RandomBooleanFeatureConfig> {
    ...
    public boolean generate(FeatureContext<RandomBooleanFeatureConfig> context) {
        ...
        return (bl ? randomBooleanFeatureConfig.featureTrue : randomBooleanFeatureConfig.featureFalse).value().generateUnregistered(structureWorldAccess, chunkGenerator, abstractRandom, blockPos);
    }
}
