...
extends AbstractTempleFeature<DefaultFeatureConfig> {
    ...
    extends StructureStart {
        ...
        public void initialize(ChunkGenerator<?> chunkGenerator, StructureManager structureManager, int x, int z, Biome biome) {
            int i = x * 16;
            int j = z * 16;
            NetherFossilGenerator.addPieces(structureManager, this.children, this.random, new BlockPos(i + this.random.nextInt(16), chunkGenerator.getSeaLevel(), j + this.random.nextInt(16)));
