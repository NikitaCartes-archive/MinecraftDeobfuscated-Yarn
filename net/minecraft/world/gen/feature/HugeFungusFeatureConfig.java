...
implements FeatureConfig {
    public static final Codec<HugeFungusFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockState.field_24734.fieldOf("valid_base_block")).forGetter(hugeFungusFeatureConfig -> hugeFungusFeatureConfig.validBaseBlock), ((MapCodec)BlockState.field_24734.fieldOf("stem_state")).forGetter(hugeFungusFeatureConfig -> hugeFungusFeatureConfig.stemState), ((MapCodec)BlockState.field_24734.fieldOf("hat_state")).forGetter(hugeFungusFeatureConfig -> hugeFungusFeatureConfig.hatState), ((MapCodec)BlockState.field_24734.fieldOf("decor_state")).forGetter(hugeFungusFeatureConfig -> hugeFungusFeatureConfig.decorationState), ((MapCodec)Codec.BOOL.fieldOf("planted")).withDefault(false).forGetter(hugeFungusFeatureConfig -> hugeFungusFeatureConfig.planted)).apply((Applicative<HugeFungusFeatureConfig, ?>)instance, HugeFungusFeatureConfig::new));
