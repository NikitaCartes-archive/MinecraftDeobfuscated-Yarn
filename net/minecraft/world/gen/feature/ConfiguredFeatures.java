...
public class ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ICE_PATCH = ConfiguredFeatures.register("ice_patch", (ConfiguredFeature)Feature.ICE_PATCH.configure(new DiskFeatureConfig(States.PACKED_ICE, UniformIntDistribution.of(2, 1), 1, ImmutableList.of(States.DIRT, States.GRASS_BLOCK, States.PODZOL, States.COARSE_DIRT, States.MYCELIUM, States.SNOW_BLOCK, States.ICE))).decorate((ConfiguredDecorator)Decorators.field_26165).repeat(2));
    ...
    public static final ConfiguredFeature<?, ?> SEAGRASS_SIMPLE = ConfiguredFeatures.register("seagrass_simple", Feature.SIMPLE_BLOCK.configure(new SimpleBlockFeatureConfig(States.SEAGRASS, ImmutableList.of(States.STONE), ImmutableList.of(States.WATER_BLOCK), ImmutableList.of(States.WATER_BLOCK))).decorate((ConfiguredDecorator)Decorator.CARVING_MASK.configure(new CarvingMaskDecoratorConfig(GenerationStep.Carver.LIQUID, 0.1f))));
    ...
    public static final ConfiguredFeature<?, ?> DISK_CLAY = ConfiguredFeatures.register("disk_clay", Feature.DISK.configure(new DiskFeatureConfig(States.CLAY, UniformIntDistribution.of(2, 1), 1, ImmutableList.of(States.DIRT, States.CLAY))).decorate((ConfiguredDecorator)Decorators.field_26167));
    public static final ConfiguredFeature<?, ?> DISK_GRAVEL = ConfiguredFeatures.register("disk_gravel", Feature.DISK.configure(new DiskFeatureConfig(States.GRAVEL, UniformIntDistribution.of(2, 3), 2, ImmutableList.of(States.DIRT, States.GRASS_BLOCK))).decorate((ConfiguredDecorator)Decorators.field_26167));
    public static final ConfiguredFeature<?, ?> DISK_SAND = ConfiguredFeatures.register("disk_sand", (ConfiguredFeature)Feature.DISK.configure(new DiskFeatureConfig(States.SAND, UniformIntDistribution.of(2, 4), 2, ImmutableList.of(States.DIRT, States.GRASS_BLOCK))).decorate((ConfiguredDecorator)Decorators.field_26167).repeat(3));
    ...
    public static final ConfiguredFeature<?, ?> SPRING_OPEN = ConfiguredFeatures.register("spring_open", (ConfiguredFeature)((ConfiguredFeature)Feature.SPRING_FEATURE.configure(new SpringFeatureConfig(States.LAVA_FLUID, false, 4, 1, ImmutableSet.of(Blocks.NETHERRACK))).decorate((ConfiguredDecorator)Decorators.NETHER_SPRING).spreadHorizontally()).repeat(8));
    public static final ConfiguredFeature<?, ?> SPRING_WATER = ConfiguredFeatures.register("spring_water", (ConfiguredFeature)((ConfiguredFeature)Feature.SPRING_FEATURE.configure(new SpringFeatureConfig(States.WATER_FLUID, true, 4, 1, ImmutableSet.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE))).decorate((ConfiguredDecorator)Decorator.RANGE_BIASED.configure(new RangeDecoratorConfig(8, 8, 256))).spreadHorizontally()).repeat(50));
    ...
    public static final ConfiguredFeature<?, ?> PATCH_PUMPKIN = ConfiguredFeatures.register("patch_pumpkin", (ConfiguredFeature)Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.PUMPKIN), SimpleBlockPlacer.INSTANCE).tries(64).whitelist(ImmutableSet.of(States.GRASS_BLOCK.getBlock())).cannotProject().build()).decorate((ConfiguredDecorator)Decorators.field_26166).applyChance(32));
    ...
    public static final ConfiguredFeature<?, ?> PATCH_MELON = ConfiguredFeatures.register("patch_melon", Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.MELON), SimpleBlockPlacer.INSTANCE).tries(64).whitelist(ImmutableSet.of(States.GRASS_BLOCK.getBlock())).canReplace().cannotProject().build()).decorate((ConfiguredDecorator)Decorators.field_26166));
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> JUNGLE_TREE = ConfiguredFeatures.register("jungle_tree", Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.JUNGLE_LOG), new SimpleBlockStateProvider(States.JUNGLE_LEAVES), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(4, 8, 0), new TwoLayersFeatureSize(1, 0, 1)).decorators(ImmutableList.of(new CocoaBeansTreeDecorator(0.2f), TrunkVineTreeDecorator.INSTANCE, LeaveVineTreeDecorator.INSTANCE)).ignoreVines().build()));
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> SUPER_BIRCH_BEES_0002 = ConfiguredFeatures.register("super_birch_bees_0002", Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.BIRCH_LOG), new SimpleBlockStateProvider(States.BIRCH_LEAVES), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(5, 2, 6), new TwoLayersFeatureSize(1, 0, 1)).ignoreVines().decorators(ImmutableList.of(Decorators.VERY_RARE_BEEHIVES_TREES)).build()));
    public static final ConfiguredFeature<?, ?> SWAMP_TREE = ConfiguredFeatures.register("swamp_tree", ((ConfiguredFeature)Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.OAK_LOG), new SimpleBlockStateProvider(States.OAK_LEAVES), new BlobFoliagePlacer(UniformIntDistribution.of(3), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(5, 3, 0), new TwoLayersFeatureSize(1, 0, 1)).maxWaterDepth(1).decorators(ImmutableList.of(LeaveVineTreeDecorator.INSTANCE)).build()).decorate((ConfiguredDecorator)Decorators.field_26165)).decorate((ConfiguredDecorator)Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(2, 0.1f, 1))));
    ...
    public static final ConfiguredFeature<?, ?> FOREST_FLOWER_TREES = ConfiguredFeatures.register("forest_flower_trees", ((ConfiguredFeature)Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(BIRCH_BEES_002.withChance(0.2f), FANCY_OAK_BEES_002.withChance(0.1f)), OAK_BEES_002)).decorate((ConfiguredDecorator)Decorators.field_26165)).decorate((ConfiguredDecorator)Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(6, 0.1f, 1))));
    ...
    public static final ConfiguredFeature<?, ?> TREES_JUNGLE_EDGE = ConfiguredFeatures.register("trees_jungle_edge", ((ConfiguredFeature)Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(FANCY_OAK.withChance(0.1f), JUNGLE_BUSH.withChance(0.5f)), JUNGLE_TREE)).decorate((ConfiguredDecorator)Decorators.field_26165)).decorate((ConfiguredDecorator)Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(2, 0.1f, 1))));
    ...
    public static final class Configs {
        ...
        public static final RandomPatchFeatureConfig LUSH_GRASS_CONFIG = new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider().addState(States.GRASS, 3).addState(States.FERN, 1), SimpleBlockPlacer.INSTANCE).blacklist(ImmutableSet.of(States.PODZOL)).tries(32).build();
        ...
        public static final SpringFeatureConfig LAVA_SPRING_CONFIG = new SpringFeatureConfig(States.LAVA_FLUID, true, 4, 1, ImmutableSet.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE));
