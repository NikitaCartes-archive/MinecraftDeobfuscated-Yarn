...
public class TreeConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, CRIMSON_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.CRIMSON_NYLIUM.getDefaultState(), Blocks.CRIMSON_STEM.getDefaultState(), Blocks.NETHER_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), false));
        ConfiguredFeatures.register(featureRegisterable, CRIMSON_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.CRIMSON_NYLIUM.getDefaultState(), Blocks.CRIMSON_STEM.getDefaultState(), Blocks.NETHER_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), true));
        ConfiguredFeatures.register(featureRegisterable, WARPED_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.WARPED_NYLIUM.getDefaultState(), Blocks.WARPED_STEM.getDefaultState(), Blocks.WARPED_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), false));
        ConfiguredFeatures.register(featureRegisterable, WARPED_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusFeatureConfig(Blocks.WARPED_NYLIUM.getDefaultState(), Blocks.WARPED_STEM.getDefaultState(), Blocks.WARPED_WART_BLOCK.getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), true));
        ...
        ConfiguredFeatures.register(featureRegisterable, OAK, Feature.TREE, TreeConfiguredFeatures.oak().build());
        ConfiguredFeatures.register(featureRegisterable, DARK_OAK, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.DARK_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.of(Blocks.DARK_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty())).ignoreVines().build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH, Feature.TREE, TreeConfiguredFeatures.birch().build());
        ...
        ConfiguredFeatures.register(featureRegisterable, CHERRY, Feature.TREE, TreeConfiguredFeatures.cherry().build());
        ConfiguredFeatures.register(featureRegisterable, CHERRY_BEES_005, Feature.TREE, TreeConfiguredFeatures.cherry().decorators(List.of(beehiveTreeDecorator4)).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, JUNGLE_TREE, Feature.TREE, TreeConfiguredFeatures.jungle().decorators(ImmutableList.of(new CocoaBeansTreeDecorator(0.2f), TrunkVineTreeDecorator.INSTANCE, new LeavesVineTreeDecorator(0.25f))).ignoreVines().build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK, Feature.TREE, TreeConfiguredFeatures.fancyOak().build());
        ConfiguredFeatures.register(featureRegisterable, JUNGLE_TREE_NO_VINE, Feature.TREE, TreeConfiguredFeatures.jungle().ignoreVines().build());
        ...
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(beehiveTreeDecorator)).build());
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(beehiveTreeDecorator5)).build());
        ConfiguredFeatures.register(featureRegisterable, SWAMP_OAK, Feature.TREE, TreeConfiguredFeatures.builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new LeavesVineTreeDecorator(0.25f))).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(beehiveTreeDecorator)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(beehiveTreeDecorator3)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(beehiveTreeDecorator4)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(beehiveTreeDecorator)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(beehiveTreeDecorator3)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_005, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(beehiveTreeDecorator4)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(beehiveTreeDecorator)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(beehiveTreeDecorator3)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(beehiveTreeDecorator4)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(beehiveTreeDecorator5)).build());
    }
}
