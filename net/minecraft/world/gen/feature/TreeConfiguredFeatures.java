...
public class TreeConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> JUNGLE_TREE = ConfiguredFeatures.register("jungle_tree", Feature.TREE, TreeConfiguredFeatures.jungle().decorators(ImmutableList.of(new CocoaBeansTreeDecorator(0.2f), TrunkVineTreeDecorator.INSTANCE, new LeavesVineTreeDecorator(0.25f))).ignoreVines().build());
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> SUPER_BIRCH_BEES_0002 = ConfiguredFeatures.register("super_birch_bees_0002", Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(BEES_0002)).build());
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> SUPER_BIRCH_BEES = ConfiguredFeatures.register("super_birch_bees", Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(BEES)).build());
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> SWAMP_OAK = ConfiguredFeatures.register("swamp_oak", Feature.TREE, TreeConfiguredFeatures.builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new LeavesVineTreeDecorator(0.25f))).build());
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> MANGROVE = ConfiguredFeatures.register("mangrove", Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformIntProvider.create(1, 4), 0.5f, UniformIntProvider.create(0, 1), Registry.BLOCK.getOrCreateEntryList(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.of(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 70), Optional.of(new MangroveRootPlacer(BlockStateProvider.of(Blocks.MANGROVE_ROOTS), Registry.BLOCK.getOrCreateEntryList(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), RegistryEntryList.of(Block::getRegistryEntry, Blocks.MUD), BlockStateProvider.of(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, UniformIntProvider.create(1, 3), 0.2f)), new TwoLayersFeatureSize(1, 0, 2)).decorators(List.of(new LeavesVineTreeDecorator(0.125f), new AttachedToLeavesTreeDecorator(0.14f, 1, 0, new RandomizedIntBlockStateProvider((BlockStateProvider)BlockStateProvider.of((BlockState)Blocks.MANGROVE_PROPAGULE.getDefaultState().with(PropaguleBlock.HANGING, true)), PropaguleBlock.AGE, (IntProvider)UniformIntProvider.create(0, 4)), 2, List.of(Direction.DOWN)), BEES_005)).ignoreVines().build());
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> TALL_MANGROVE = ConfiguredFeatures.register("tall_mangrove", Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformIntProvider.create(1, 6), 0.5f, UniformIntProvider.create(0, 1), Registry.BLOCK.getOrCreateEntryList(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.of(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), ConstantIntProvider.create(2), 70), Optional.of(new MangroveRootPlacer(BlockStateProvider.of(Blocks.MANGROVE_ROOTS), Registry.BLOCK.getOrCreateEntryList(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), RegistryEntryList.of(Block::getRegistryEntry, Blocks.MUD), BlockStateProvider.of(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, UniformIntProvider.create(3, 7), 0.2f)), new TwoLayersFeatureSize(1, 0, 3)).decorators(List.of(new LeavesVineTreeDecorator(0.125f), new AttachedToLeavesTreeDecorator(0.14f, 1, 0, new RandomizedIntBlockStateProvider((BlockStateProvider)BlockStateProvider.of((BlockState)Blocks.MANGROVE_PROPAGULE.getDefaultState().with(PropaguleBlock.HANGING, true)), PropaguleBlock.AGE, (IntProvider)UniformIntProvider.create(0, 4)), 2, List.of(Direction.DOWN)), BEES_005)).ignoreVines().build());
