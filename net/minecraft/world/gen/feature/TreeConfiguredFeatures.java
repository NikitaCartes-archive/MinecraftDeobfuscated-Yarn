...
public class TreeConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> SWAMP_OAK = ConfiguredFeatures.register("swamp_oak", Feature.TREE, TreeConfiguredFeatures.builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(LeavesVineTreeDecorator.INSTANCE)).build());
