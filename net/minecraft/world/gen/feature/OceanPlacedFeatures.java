...
public class OceanPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        PlacedFeatures.register(featureRegisterable, SEAGRASS_WARM, reference, OceanPlacedFeatures.seagrassModifiers(80));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_NORMAL, reference, OceanPlacedFeatures.seagrassModifiers(48));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_COLD, reference, OceanPlacedFeatures.seagrassModifiers(32));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_RIVER, reference2, OceanPlacedFeatures.seagrassModifiers(48));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_SWAMP, reference3, OceanPlacedFeatures.seagrassModifiers(64));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_DEEP_WARM, reference4, OceanPlacedFeatures.seagrassModifiers(80));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_DEEP, reference4, OceanPlacedFeatures.seagrassModifiers(48));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_DEEP_COLD, reference4, OceanPlacedFeatures.seagrassModifiers(40));
        PlacedFeatures.register(featureRegisterable, SEAGRASS_SIMPLE, reference5, CarvingMaskPlacementModifier.of(GenerationStep.Carver.LIQUID), RarityFilterPlacementModifier.of(10), BlockFilterPlacementModifier.of(BlockPredicate.allOf(BlockPredicate.matchingBlocks(Direction.DOWN.getVector(), Blocks.STONE), BlockPredicate.matchingBlocks((Vec3i)BlockPos.ORIGIN, Blocks.WATER), BlockPredicate.matchingBlocks(Direction.UP.getVector(), Blocks.WATER))), BiomePlacementModifier.of());
        ...
        PlacedFeatures.register(featureRegisterable, KELP_COLD, reference7, NoiseBasedCountPlacementModifier.of(120, 80.0, 0.0), SquarePlacementModifier.of(), PlacedFeatures.OCEAN_FLOOR_WG_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, KELP_WARM, reference7, NoiseBasedCountPlacementModifier.of(80, 80.0, 0.0), SquarePlacementModifier.of(), PlacedFeatures.OCEAN_FLOOR_WG_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, WARM_OCEAN_VEGETATION, reference8, NoiseBasedCountPlacementModifier.of(20, 400.0, 0.0), SquarePlacementModifier.of(), PlacedFeatures.OCEAN_FLOOR_WG_HEIGHTMAP, BiomePlacementModifier.of());
    }
}
