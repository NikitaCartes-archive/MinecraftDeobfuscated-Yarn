...
public class ConfiguredFeature<FC extends FeatureConfig, F extends Feature<FC>> {
    public static final ConfiguredFeature<?, ?> NO_OP = new ConfiguredFeature<DefaultFeatureConfig, Feature<DefaultFeatureConfig>>(Feature.NO_OP, DefaultFeatureConfig.DEFAULT);
    public static final Codec<ConfiguredFeature<?, ?>> CODEC = Registry.FEATURE.dispatch("name", configuredFeature -> configuredFeature.feature, Feature::getCodec).withDefault(NO_OP);
