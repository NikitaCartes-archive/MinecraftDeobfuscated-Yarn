...
implements FeatureConfig {
    ...
    public VegetationPatchFeatureConfig(TagKey<Block> tagKey, BlockStateProvider groundState, RegistryEntry<PlacedFeature> registryEntry, VerticalSurfaceType surface, IntProvider depth, float extraBottomBlockChance, int verticalRange, float vegetationChance, IntProvider horizontalRadius, float extraEdgeColumnChance) {
