...
public class UndergroundPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> SCULK_PATCH = PlacedFeatures.register("sculk_patch", UndergroundConfiguredFeatures.SCULK_PATCH, CountPlacementModifier.of(ConstantIntProvider.create(256)), SquarePlacementModifier.of(), PlacedFeatures.BOTTOM_TO_120_RANGE, BiomePlacementModifier.of());
