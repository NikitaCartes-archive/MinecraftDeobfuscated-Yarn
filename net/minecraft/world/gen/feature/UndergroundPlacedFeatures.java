...
public class UndergroundPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> SCULK_PATCH_DEEP_DARK = PlacedFeatures.register("sculk_patch_deep_dark", UndergroundConfiguredFeatures.SCULK_PATCH_DEEP_DARK, CountPlacementModifier.of(ConstantIntProvider.create(256)), SquarePlacementModifier.of(), PlacedFeatures.BOTTOM_TO_120_RANGE, BiomePlacementModifier.of());
    public static final RegistryEntry<PlacedFeature> SCULK_PATCH_ANCIENT_CITY = PlacedFeatures.register("sculk_patch_ancient_city", UndergroundConfiguredFeatures.SCULK_PATCH_ANCIENT_CITY, new PlacementModifier[0]);
    public static final RegistryEntry<PlacedFeature> SCULK_VEIN = PlacedFeatures.register("sculk_vein", UndergroundConfiguredFeatures.SCULK_VEIN, CountPlacementModifier.of(UniformIntProvider.create(204, 250)), SquarePlacementModifier.of(), PlacedFeatures.BOTTOM_TO_120_RANGE, BiomePlacementModifier.of());
}
