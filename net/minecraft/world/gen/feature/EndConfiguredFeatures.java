...
public class EndConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<DefaultFeatureConfig, ?>> CHORUS_PLANT = ConfiguredFeatures.register("chorus_plant", Feature.CHORUS_PLANT);
    public static final RegistryEntry<ConfiguredFeature<DefaultFeatureConfig, ?>> END_ISLAND = ConfiguredFeatures.register("end_island", Feature.END_ISLAND);
}
