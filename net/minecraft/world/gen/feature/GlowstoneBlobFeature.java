...
extends Feature<DefaultFeatureConfig> {
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        for (int i = 0; i < 1500; ++i) {
            BlockPos blockPos2 = blockPos.add(abstractRandom.nextInt(8) - abstractRandom.nextInt(8), -abstractRandom.nextInt(12), abstractRandom.nextInt(8) - abstractRandom.nextInt(8));
