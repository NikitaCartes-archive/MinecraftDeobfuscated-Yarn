...
extends Feature<GlowLichenFeatureConfig> {
    ...
    @Override
    public boolean generate(StructureWorldAccess structureWorldAccess, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, GlowLichenFeatureConfig glowLichenFeatureConfig) {
