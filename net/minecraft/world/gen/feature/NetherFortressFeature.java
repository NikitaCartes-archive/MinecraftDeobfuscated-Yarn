...
extends StructureFeature {
    ...
    public static final Codec<NetherFortressFeature> CODEC = RecordCodecBuilder.create(instance -> NetherFortressFeature.method_41608(instance).apply(instance, NetherFortressFeature::new));
    ...
    public Optional<StructureFeature.class_7150> method_38676(StructureFeature.class_7149 arg) {
        ...
        return Optional.of(new StructureFeature.class_7150(blockPos, structurePiecesCollector -> NetherFortressFeature.addPieces(structurePiecesCollector, arg)));
    }
