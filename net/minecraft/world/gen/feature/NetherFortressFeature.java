...
extends StructureFeature {
    ...
    public static final Codec<NetherFortressFeature> CODEC = NetherFortressFeature.createCodec(NetherFortressFeature::new);

    public NetherFortressFeature(StructureFeature.Config config) {
        super(config);
    }
    ...
    public Optional<StructureFeature.StructurePosition> getStructurePosition(StructureFeature.Context context) {
        ...
        return Optional.of(new StructureFeature.StructurePosition(blockPos, structurePiecesCollector -> NetherFortressFeature.addPieces(structurePiecesCollector, context)));
    }
