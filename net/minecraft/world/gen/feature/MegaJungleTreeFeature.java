...
extends MegaTreeFeature<class_4636> {
    public MegaJungleTreeFeature(Function<Dynamic<?>, ? extends class_4636> function) {
        super(function);
    }

    public boolean method_23398(ModifiableTestableWorld modifiableTestableWorld, Random random, BlockPos blockPos, Set<BlockPos> set, Set<BlockPos> set2, BlockBox blockBox, class_4636 arg) {
    ...
    private void makeLeaves(ModifiableTestableWorld modifiableTestableWorld, Random random, BlockPos blockPos, int i, Set<BlockPos> set, BlockBox blockBox, class_4643 arg) {
        int j = 2;
        for (int k = -2; k <= 0; ++k) {
