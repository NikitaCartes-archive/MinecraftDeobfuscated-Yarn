...
extends StructureFeature<ProbabilityConfig> {
    ...
    @Override
    protected boolean shouldStartAt(ChunkGenerator chunkGenerator, BiomeSource biomeSource, long l, ChunkPos chunkPos, ProbabilityConfig probabilityConfig, HeightLimitView heightLimitView) {
