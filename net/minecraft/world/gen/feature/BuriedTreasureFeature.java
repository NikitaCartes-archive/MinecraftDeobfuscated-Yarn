...
extends StructureFeature {
    public static final Codec<BuriedTreasureFeature> CODEC = RecordCodecBuilder.create(instance -> BuriedTreasureFeature.method_41608(instance).apply(instance, BuriedTreasureFeature::new));
    ...
    public Optional<StructureFeature.class_7150> method_38676(StructureFeature.class_7149 arg) {
        return BuriedTreasureFeature.method_41612(arg, Heightmap.Type.OCEAN_FLOOR_WG, structurePiecesCollector -> BuriedTreasureFeature.addPieces(structurePiecesCollector, arg));
    }
