...
extends StructureFeature {
    public static final Codec<BuriedTreasureFeature> CODEC = BuriedTreasureFeature.createCodec(BuriedTreasureFeature::new);
    ...
    public Optional<StructureFeature.StructurePosition> getStructurePosition(StructureFeature.Context context) {
        return BuriedTreasureFeature.getStructurePosition(context, Heightmap.Type.OCEAN_FLOOR_WG, structurePiecesCollector -> BuriedTreasureFeature.addPieces(structurePiecesCollector, context));
    }
