...
public abstract class Feature<FC extends FeatureConfig> {
    ...
    public static final Feature<class_4640> NORMAL_TREE = Feature.register("normal_tree", new OakTreeFeature((Function<Dynamic<?>, ? extends class_4640>)((Function<Dynamic<?>, class_4640>)class_4640::method_23426)));
    public static final Feature<class_4640> ACACIA_TREE = Feature.register("acacia_tree", new class_4627((Function<Dynamic<?>, ? extends class_4640>)((Function<Dynamic<?>, class_4640>)class_4640::method_23426)));
    public static final Feature<class_4640> FANCY_TREE = Feature.register("fancy_tree", new LargeOakTreeFeature((Function<Dynamic<?>, ? extends class_4640>)((Function<Dynamic<?>, class_4640>)class_4640::method_23426)));
    public static final Feature<class_4643> JUNGLE_GROUND_BUSH = Feature.register("jungle_ground_bush", new JungleGroundBushFeature((Function<Dynamic<?>, ? extends class_4643>)((Function<Dynamic<?>, class_4643>)class_4643::method_23444)));
    public static final Feature<class_4636> DARK_OAK_TREE = Feature.register("dark_oak_tree", new DarkOakTreeFeature((Function<Dynamic<?>, ? extends class_4636>)((Function<Dynamic<?>, class_4636>)class_4636::method_23408)));
    public static final Feature<class_4636> MEGA_JUNGLE_TREE = Feature.register("mega_jungle_tree", new MegaJungleTreeFeature((Function<Dynamic<?>, ? extends class_4636>)((Function<Dynamic<?>, class_4636>)class_4636::method_23408)));
    public static final Feature<class_4636> MEGA_SPRUCE_TREE = Feature.register("mega_spruce_tree", new MegaPineTreeFeature((Function<Dynamic<?>, ? extends class_4636>)((Function<Dynamic<?>, class_4636>)class_4636::method_23408)));
    public static final class_4624<class_4638> field_21219 = Feature.register("flower", new DefaultFlowerFeature((Function<Dynamic<?>, ? extends class_4638>)((Function<Dynamic<?>, class_4638>)class_4638::method_23413)));
    public static final Feature<class_4638> RANDOM_PATCH = Feature.register("random_patch", new class_4628((Function<Dynamic<?>, ? extends class_4638>)((Function<Dynamic<?>, class_4638>)class_4638::method_23413)));
    public static final Feature<class_4634> BLOCK_PILE = Feature.register("block_pile", new AbstractPileFeature((Function<Dynamic<?>, ? extends class_4634>)((Function<Dynamic<?>, class_4634>)class_4634::method_23406)));
    public static final Feature<class_4642> SPRING_FEATURE = Feature.register("spring_feature", new SpringFeature((Function<Dynamic<?>, ? extends class_4642>)((Function<Dynamic<?>, class_4642>)class_4642::method_23440)));
    ...
    public static final Feature<class_4635> HUGE_RED_MUSHROOM = Feature.register("huge_red_mushroom", new HugeRedMushroomFeature((Function<Dynamic<?>, ? extends class_4635>)((Function<Dynamic<?>, class_4635>)class_4635::method_23407)));
    public static final Feature<class_4635> HUGE_BROWN_MUSHROOM = Feature.register("huge_brown_mushroom", new HugeBrownMushroomFeature((Function<Dynamic<?>, ? extends class_4635>)((Function<Dynamic<?>, class_4635>)class_4635::method_23407)));
