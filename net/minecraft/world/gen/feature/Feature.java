...
public abstract class Feature<FC extends FeatureConfig> {
    ...
    public static final Feature<NormalTreeFeatureConfig> NORMAL_TREE = Feature.register("normal_tree", new OakTreeFeature((Function<Dynamic<?>, ? extends NormalTreeFeatureConfig>)((Function<Dynamic<?>, NormalTreeFeatureConfig>)NormalTreeFeatureConfig::method_23426)));
    public static final Feature<NormalTreeFeatureConfig> ACACIA_TREE = Feature.register("acacia_tree", new class_4627((Function<Dynamic<?>, ? extends NormalTreeFeatureConfig>)((Function<Dynamic<?>, NormalTreeFeatureConfig>)NormalTreeFeatureConfig::method_23426)));
    public static final Feature<NormalTreeFeatureConfig> FANCY_TREE = Feature.register("fancy_tree", new LargeOakTreeFeature((Function<Dynamic<?>, ? extends NormalTreeFeatureConfig>)((Function<Dynamic<?>, NormalTreeFeatureConfig>)NormalTreeFeatureConfig::method_23426)));
    public static final Feature<AbstractTreeFeatureConfig> JUNGLE_GROUND_BUSH = Feature.register("jungle_ground_bush", new JungleGroundBushFeature((Function<Dynamic<?>, ? extends AbstractTreeFeatureConfig>)((Function<Dynamic<?>, AbstractTreeFeatureConfig>)AbstractTreeFeatureConfig::deserialize)));
    ...
    public static final Feature<FlowerFeatureConfig> RANDOM_PATCH = Feature.register("random_patch", new class_4628((Function<Dynamic<?>, ? extends FlowerFeatureConfig>)((Function<Dynamic<?>, FlowerFeatureConfig>)FlowerFeatureConfig::method_23413)));
