...
extends class_4624<class_4638> {
    ...
    public BlockPos method_23392(Random random, BlockPos blockPos, class_4638 arg) {
        return blockPos.add(random.nextInt(arg.field_21242) - random.nextInt(arg.field_21242), random.nextInt(arg.field_21243) - random.nextInt(arg.field_21243), random.nextInt(arg.field_21244) - random.nextInt(arg.field_21244));
    }
