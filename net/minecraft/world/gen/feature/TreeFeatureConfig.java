...
implements FeatureConfig {
    public static final Codec<TreeFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("trunk_provider")).forGetter(treeFeatureConfig -> treeFeatureConfig.trunkProvider), ((MapCodec)BlockStateProvider.TYPE_CODEC.fieldOf("leaves_provider")).forGetter(treeFeatureConfig -> treeFeatureConfig.leavesProvider), ((MapCodec)FoliagePlacer.TYPE_CODEC.fieldOf("foliage_placer")).forGetter(treeFeatureConfig -> treeFeatureConfig.foliagePlacer), ((MapCodec)TrunkPlacer.TYPE_CODEC.fieldOf("trunk_placer")).forGetter(treeFeatureConfig -> treeFeatureConfig.trunkPlacer), ((MapCodec)FeatureSize.TYPE_CODEC.fieldOf("minimum_size")).forGetter(treeFeatureConfig -> treeFeatureConfig.minimumSize), ((MapCodec)TreeDecorator.TYPE_CODEC.listOf().fieldOf("decorators")).forGetter(treeFeatureConfig -> treeFeatureConfig.decorators), ((MapCodec)Codec.INT.fieldOf("max_water_depth")).orElse(0).forGetter(treeFeatureConfig -> treeFeatureConfig.maxWaterDepth), ((MapCodec)Codec.BOOL.fieldOf("ignore_vines")).orElse(false).forGetter(treeFeatureConfig -> treeFeatureConfig.ignoreVines), ((MapCodec)Heightmap.Type.CODEC.fieldOf("heightmap")).forGetter(treeFeatureConfig -> treeFeatureConfig.heightmap)).apply((Applicative<TreeFeatureConfig, ?>)instance, TreeFeatureConfig::new));
