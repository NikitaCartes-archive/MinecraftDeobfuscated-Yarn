...
public class AquiferSampler {
    ...
    public AquiferSampler(int x, int z, DoublePerlinNoiseSampler doublePerlinNoiseSampler, DoublePerlinNoiseSampler waterLevelNoise, ChunkGeneratorSettings settings, NoiseColumnSampler columnSampler, int height) {
