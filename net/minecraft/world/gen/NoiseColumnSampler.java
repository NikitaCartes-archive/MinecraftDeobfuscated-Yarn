...
implements MultiNoiseUtil.MultiNoiseSampler {
    ...
    public NoiseColumnSampler(GenerationShapeConfig generationShapeConfig, boolean bl, long l, Registry<DoublePerlinNoiseSampler.NoiseParameters> registry, ChunkRandom.RandomProvider randomProvider) {
        ...
        if (randomProvider != ChunkRandom.RandomProvider.LEGACY) {
            this.terrainNoise = new InterpolatedNoiseSampler(randomDeriver.createRandom(new Identifier("terrain")), generationShapeConfig.sampling(), generationShapeConfig.method_39546(), generationShapeConfig.method_39545());
            this.temperatureNoise = NoiseParametersKeys.method_39173(registry, randomDeriver, bl2 ? NoiseParametersKeys.TEMPERATURE_LARGE : NoiseParametersKeys.TEMPERATURE);
            ...
            this.terrainNoise = new InterpolatedNoiseSampler(randomProvider.create(l), generationShapeConfig.sampling(), generationShapeConfig.method_39546(), generationShapeConfig.method_39545());
        ...
        this.continentalnessNoise = NoiseParametersKeys.method_39173(registry, randomDeriver, bl2 ? NoiseParametersKeys.CONTINENTALNESS_LARGE : NoiseParametersKeys.CONTINENTALNESS);
        ...
        this.oreFrequencyNoiseSamplerFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.ORE_VEININESS), j, k, 0, 1.5);
        this.firstOrePlacementNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.ORE_VEIN_A), j, k, 0, 4.0);
        this.secondOrePlacementNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.ORE_VEIN_B), j, k, 0, 4.0);
        this.oreGapNoise = NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.ORE_GAP);
        this.noodleNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.NOODLE), m, n, -1, 1.0);
        this.noodleThicknessNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.NOODLE_THICKNESS), m, n, 0, 1.0);
        this.noodleRidgeFirstNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.NOODLE_RIDGE_A), m, n, 0, 2.6666666666666665);
        this.noodleRidgeSecondNoiseFactory = NoiseColumnSampler.createNoiseSamplerFactory(NoiseParametersKeys.method_39173(registry, randomDeriver, NoiseParametersKeys.NOODLE_RIDGE_B), m, n, 0, 2.6666666666666665);
    ...
    protected AquiferSampler createAquiferSampler(ChunkNoiseSampler chunkNoiseSampler, int x, int z, int minimumY, int height, AquiferSampler.FluidLevelSampler fluidLevelSampler, boolean hasAquifers) {
        ...
        return AquiferSampler.aquifer(chunkNoiseSampler, new ChunkPos(i, j), this.aquiferBarrierNoise, this.aquiferFluidLevelFloodednessNoise, this.aquiferFluidLevelSpreadNoise, this.aquiferLavaNoise, this.aquiferRandomDeriver, this, minimumY * this.config.method_39545(), height * this.config.method_39545(), fluidLevelSampler);
    }
