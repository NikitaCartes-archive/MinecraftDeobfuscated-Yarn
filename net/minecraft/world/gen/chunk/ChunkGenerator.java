...
public abstract class ChunkGenerator {
    ...
    public BlockPos locateStructure(ServerWorld serverWorld, StructureFeature<?> structureFeature, BlockPos center, int radius, boolean skipExistingChunks) {
        ...
        return structureFeature.locateStructure(serverWorld, serverWorld.getStructureAccessor(), center, radius, skipExistingChunks, serverWorld.getSeed(), this.config.method_28600(structureFeature));
    }
