...
public class NoodleCavesGenerator {
    ...
    public NoodleCavesGenerator(long seed) {
        ...
        this.frequencyNoiseSampler = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -8, 1.0);
        this.weightReducingNoiseSampler = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -8, 1.0);
        this.firstWeightNoiseSampelr = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -7, 1.0);
        this.secondWeightNoiseSampler = DoublePerlinNoiseSampler.create((WorldGenRandom)new SimpleRandom(random.nextLong()), -7, 1.0);
    }
