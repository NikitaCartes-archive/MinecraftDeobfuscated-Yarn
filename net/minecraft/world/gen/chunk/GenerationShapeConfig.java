...
public record GenerationShapeConfig(int minimumY, int height, NoiseSamplingConfig sampling, SlideConfig topSlide, SlideConfig bottomSlide, int horizontalSize, int verticalSize, boolean islandNoiseOverride, boolean amplified, boolean largeBiomes, VanillaTerrainParameters terrainParameters) {
    ...
    static final GenerationShapeConfig field_37138 = GenerationShapeConfig.create(0, 128, new NoiseSamplingConfig(1.0, 3.0, 80.0, 60.0), new SlideConfig(0.9375, 3, 0), new SlideConfig(2.5, 4, -1), 1, 2, false, false, false, VanillaTerrainParametersCreator.createNetherParameters());
    static final GenerationShapeConfig field_37139 = GenerationShapeConfig.create(0, 128, new NoiseSamplingConfig(2.0, 1.0, 80.0, 160.0), new SlideConfig(-23.4375, 64, -46), new SlideConfig(-0.234375, 7, 1), 2, 1, true, false, false, VanillaTerrainParametersCreator.createEndParameters());
    static final GenerationShapeConfig field_37140 = GenerationShapeConfig.create(-64, 192, new NoiseSamplingConfig(1.0, 3.0, 80.0, 60.0), new SlideConfig(0.9375, 3, 0), new SlideConfig(2.5, 4, -1), 1, 2, false, false, false, VanillaTerrainParametersCreator.createCavesParameters());
    static final GenerationShapeConfig field_37141 = GenerationShapeConfig.create(0, 256, new NoiseSamplingConfig(2.0, 1.0, 80.0, 160.0), new SlideConfig(-23.4375, 64, -46), new SlideConfig(-0.234375, 7, 1), 2, 1, false, false, false, VanillaTerrainParametersCreator.createFloatingIslandsParameters());
    ...
    static GenerationShapeConfig method_41126(boolean bl, boolean bl2) {
        return GenerationShapeConfig.create(-64, 384, new NoiseSamplingConfig(1.0, 1.0, 80.0, 160.0), new SlideConfig(-0.078125, 2, bl ? 0 : 8), new SlideConfig(bl ? 0.4 : 0.1171875, 3, 0), 1, 2, false, bl, bl2, VanillaTerrainParametersCreator.createSurfaceParameters(bl));
    }
