...
public class ChunkNoiseSampler {
    ...
    public ChunkNoiseSampler(int horizontalNoiseResolution, int verticalNoiseResolution, int horizontalSize, int height, int minimumY, NoiseColumnSampler noiseColumnSampler, int x, int z, ColumnSampler columnSampler, Supplier<ChunkGeneratorSettings> settings, AquiferSampler.FluidLevelSampler fluidLevelSampler, class_6748 arg) {
