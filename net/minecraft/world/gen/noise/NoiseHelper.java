...
public class NoiseHelper {
    ...
    public static void appendDebugInfo(StringBuilder builder, double originX, double originY, double originZ, byte[] permutation) {
        builder.append(String.format("xo=%.3f, yo=%.3f, zo=%.3f, p0=%d, p255=%d", Float.valueOf((float)originX), Float.valueOf((float)originY), Float.valueOf((float)originZ), permutation[0], permutation[255]));
    }
