...
extends BlockStateProvider {
    public static final Codec<PillarBlockStateProvider> field_24944 = ((MapCodec)BlockState.field_24734.fieldOf("state")).xmap(AbstractBlock.AbstractBlockState::getBlock, Block::getDefaultState).xmap(PillarBlockStateProvider::new, pillarBlockStateProvider -> pillarBlockStateProvider.block).codec();
