...
public class StateProviderType<P extends StateProvider> {
    ...
    public static final StateProviderType<PlainFlowerStateProvider> PLAIN_FLOWER_PROVIDER = StateProviderType.register("plain_flower_provider", PlainFlowerStateProvider::new);
    ...
    private static <P extends StateProvider> StateProviderType<P> register(String string, Function<Dynamic<?>, P> function) {
        return Registry.register(Registry.BLOCK_STATE_PROVIDER_TYPE, string, new StateProviderType<P>(function));
    }
