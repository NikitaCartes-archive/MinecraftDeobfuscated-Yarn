...
public class TrunkPlacerType<P extends TrunkPlacer> {
    ...
    public static final TrunkPlacerType<class_5214> GIANT_TRUNK_PLACER = TrunkPlacerType.register("giant_trunk_placer", class_5214::new);
    public static final TrunkPlacerType<class_5215> MEGA_JUNGLE_TRUNK_PLACER = TrunkPlacerType.register("mega_jungle_trunk_placer", class_5215::new);
    public static final TrunkPlacerType<class_5211> DARK_OAK_TRUNK_PLACER = TrunkPlacerType.register("dark_oak_trunk_placer", class_5211::new);
    public static final TrunkPlacerType<class_5212> FANCY_TRUNK_PLACER = TrunkPlacerType.register("fancy_trunk_placer", class_5212::new);
