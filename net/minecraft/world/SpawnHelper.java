    ...
    public static void spawnEntitiesInChunk(EntityCategory entityCategory, World world, WorldChunk worldChunk, BlockPos blockPos) {
        ...
        block2: for (int m = 0; m < 3; ++m) {
            ...
            for (int s = 0; s < q; ++s) {
                ...
                if (playerEntity == null || playerEntity.squaredDistanceTo(f, k, g) <= 576.0 || blockPos.isWithinDistance(new Vec3d(f, k, g), 24.0) || !Objects.equals(chunkPos = new ChunkPos(mutable), worldChunk.getPos())) continue;
                if (spawnEntry == null) {
