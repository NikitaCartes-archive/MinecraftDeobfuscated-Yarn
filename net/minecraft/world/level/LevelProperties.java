...
class_5219 {
    ...
    public class_5217 method_27437(DimensionType dimensionType) {
        return dimensionType == DimensionType.OVERWORLD ? this : new UnmodifiableLevelProperties(dimensionType, this, this);
    }

    @Override
    public LevelInfo method_27433() {
        LevelInfo levelInfo = new LevelInfo(this.levelName, this.randomSeed, this.gameMode, this.structures, this.hardcore, this.difficulty, this.generatorOptions, this.gameRules.copy());
        if (this.field_24192) {
