...
SaveProperties {
    ...
    private void updateProperties(DynamicRegistryManager registryManager, NbtCompound levelNbt, @Nullable NbtCompound playerNbt) {
        ...
        GeneratorOptions.CODEC.encodeStart(registryReadingOps, this.generatorOptions).resultOrPartial(Util.addPrefix("WorldGenSettings: ", LOGGER::error)).ifPresent(nbtElement -> levelNbt.put(WORLD_GEN_SETTINGS_KEY, (NbtElement)nbtElement));
