...
public class LevelGeneratorType {
    ...
    private static final Dynamic<?> EMPTY_COMPOUND_NBT_DYNAMIC = new Dynamic<CompoundTag>(NbtOps.INSTANCE, new CompoundTag());
    ...
    private LevelGeneratorType(int index, String name, String storedName, int version, BiFunction<LevelGeneratorType, Dynamic<?>, LevelGeneratorOptions> optionsFactory) {
        this.name = name;
        this.storedName = storedName;
        this.version = version;
        this.optionsLoader = dynamic -> (LevelGeneratorOptions)optionsFactory.apply(this, (Dynamic<?>)dynamic);
        this.defaultOptions = new Lazy<LevelGeneratorOptions>(() -> (LevelGeneratorOptions)optionsFactory.apply(this, EMPTY_COMPOUND_NBT_DYNAMIC));
        this.visible = true;
        this.id = index;
        LevelGeneratorType.TYPES[index] = this;
    }
