...
public class AnvilLevelStorage {
    ...
    static boolean convertLevel(LevelStorage.Session session, ProgressListener progressListener) {
        ...
        BiomeSource biomeSource = saveProperties != null && saveProperties.getGeneratorOptions().isFlatWorld() ? new FixedBiomeSource(registry.method_31140(Biomes.PLAINS)) : new VanillaLayeredBiomeSource(l, false, false, registry);
        AnvilLevelStorage.convertRegions(impl, new File(file, "region"), list, biomeSource, 0, i, progressListener);
        AnvilLevelStorage.convertRegions(impl, new File(file2, "region"), list2, new FixedBiomeSource(registry.method_31140(Biomes.NETHER_WASTES)), list.size(), i, progressListener);
        AnvilLevelStorage.convertRegions(impl, new File(file3, "region"), list3, new FixedBiomeSource(registry.method_31140(Biomes.THE_END)), list.size() + list2.size(), i, progressListener);
