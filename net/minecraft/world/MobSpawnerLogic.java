...
public abstract class MobSpawnerLogic {
    ...
    private Identifier getEntityId() {
        ...
        try {
            ...
            LOGGER.warn("Invalid entity id '{}' at spawner {}:[{},{},{}]", (Object)string, (Object)this.getWorld().method_27983(), (Object)blockPos.getX(), (Object)blockPos.getY(), (Object)blockPos.getZ());
            return null;
        }
    }
    ...
    public void update() {
        ...
        if (world.isClient) {
            ...
            for (int i = 0; i < this.spawnCount; ++i) {
                ...
                if (!world.doesNotCollide(optional.get().createSimpleBoundingBox(g, h, k)) || !SpawnRestriction.canSpawn(optional.get(), world.getWorld(), SpawnReason.SPAWNER, new BlockPos(g, h, k), world.getRandom())) continue;
