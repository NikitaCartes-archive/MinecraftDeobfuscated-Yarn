...
public class ChunkSerializer {
    ...
    private static Map<StructureFeature, LongSet> readStructureReferences(DynamicRegistryManager dynamicRegistryManager, ChunkPos chunkPos, NbtCompound nbtCompound) {
