...
public class DefaultBiomeCreator {
    ...
    private static Biome method_39152(Biome.Precipitation precipitation, Biome.Category category, float f, float g, SpawnSettings.Builder builder, GenerationSettings.Builder builder2) {
        return DefaultBiomeCreator.method_39151(precipitation, category, f, g, 4159204, 329011, builder, builder2);
    }

    private static Biome method_39151(Biome.Precipitation precipitation, Biome.Category category, float f, float g, int i, int j, SpawnSettings.Builder builder, GenerationSettings.Builder builder2) {
    ...
    public static Biome createOldGrowthPineTaiga(boolean bl) {
        ...
        DefaultBiomeCreator.method_39153(builder2);
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.TAIGA, bl ? 0.25f : 0.3f, 0.8f, builder, builder2);
    }
    ...
    private static Biome createJungleFeatures(float depth, boolean bamboo, boolean sparse, boolean unmodified, SpawnSettings.Builder builder) {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.JUNGLE, 0.95f, depth, builder, builder2);
    }
    ...
    public static Biome createWindsweptHills(boolean bl) {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.EXTREME_HILLS, 0.2f, 0.3f, builder, builder2);
    }
    ...
    public static Biome createDesert() {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.NONE, Biome.Category.DESERT, 2.0f, 0.0f, builder, builder2);
    }
    ...
    public static Biome createPlains(boolean bl, boolean bl2, boolean bl3) {
        ...
        return DefaultBiomeCreator.method_39152(bl2 ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, bl2 ? Biome.Category.ICY : Biome.Category.PLAINS, f, bl2 ? 0.5f : 0.4f, builder, builder2);
    }
    ...
    public static Biome createMushroomFields() {
        ...
        DefaultBiomeFeatures.addDefaultMushrooms(builder2);
        DefaultBiomeFeatures.addDefaultVegetation(builder2);
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.MUSHROOM, 0.9f, 1.0f, builder, builder2);
    }

    public static Biome createSavanna(boolean bl, boolean windswept) {
        GenerationSettings.Builder builder = new GenerationSettings.Builder();
        DefaultBiomeCreator.method_39153(builder);
        if (!bl) {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.NONE, Biome.Category.SAVANNA, f, 0.0f, builder2, builder);
    }
    ...
    private static Biome createOcean(SpawnSettings.Builder spawnSettings, int waterColor, int waterFogColor, GenerationSettings.Builder builder) {
        return DefaultBiomeCreator.method_39151(Biome.Precipitation.RAIN, Biome.Category.OCEAN, 0.5f, 0.5f, waterColor, waterFogColor, spawnSettings, builder);
    }
    ...
    public static Biome createColdOcean(boolean deep) {
        ...
        GenerationSettings.Builder builder2 = DefaultBiomeCreator.createOceanGenerationSettings();
    ...
    public static Biome createWarmOcean() {
        ...
        GenerationSettings.Builder builder2 = DefaultBiomeCreator.createOceanGenerationSettings().feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.WARM_OCEAN_VEGETATION).feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEAGRASS_WARM).feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEA_PICKLE);
    ...
    public static Biome createDeepWarmOcean() {
        ...
        GenerationSettings.Builder builder2 = DefaultBiomeCreator.createOceanGenerationSettings().feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEAGRASS_DEEP_WARM);
        DefaultBiomeFeatures.addSeagrassOnStone(builder2);
        return DefaultBiomeCreator.createOcean(builder, 4445678, 270131, builder2);
    }
    ...
    public static Biome createNormalForest(boolean bl, boolean bl2, boolean bl3) {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.FOREST, f, bl ? 0.6f : 0.8f, builder2, builder);
    }
    ...
    public static Biome createTaiga(boolean cold) {
        ...
        return DefaultBiomeCreator.method_39151(cold ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.Category.TAIGA, f, cold ? 0.4f : 0.8f, cold ? 4020182 : 4159204, 329011, builder, builder2);
    }
    ...
    public static Biome createRiver(boolean bl) {
        ...
        return DefaultBiomeCreator.method_39151(bl ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.Category.RIVER, f, 0.5f, bl ? 3750089 : 4159204, 329011, builder, builder2);
    }
    ...
    public static Biome createBeach(boolean bl, boolean bl2) {
        ...
        return DefaultBiomeCreator.method_39151(bl ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, Biome.Category.BEACH, f, bl3 ? 0.4f : 0.3f, bl ? 4020182 : 4159204, 329011, builder, builder2);
    }
    ...
    public static Biome createTheVoid() {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.NONE, Biome.Category.NONE, 0.5f, 0.5f, new SpawnSettings.Builder(), builder);
    }
    ...
    public static Biome createMeadow() {
        ...
        return DefaultBiomeCreator.method_39151(Biome.Precipitation.RAIN, Biome.Category.MOUNTAIN, 0.5f, 0.8f, 937679, 329011, builder2, builder);
    }
    ...
    public static Biome createFrozenPeaks() {
        ...
        DefaultBiomeFeatures.addEmeraldOre(builder);
        DefaultBiomeFeatures.addInfestedStone(builder);
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.SNOW, Biome.Category.MOUNTAIN, -0.7f, 0.9f, builder2, builder);
    }
    ...
    public static Biome createStonyPeaks() {
        ...
        DefaultBiomeFeatures.addEmeraldOre(builder);
        DefaultBiomeFeatures.addInfestedStone(builder);
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.MOUNTAIN, 1.0f, 0.3f, builder2, builder);
    }
    ...
    public static Biome createSnowySlopes() {
        ...
        DefaultBiomeFeatures.addEmeraldOre(builder);
        DefaultBiomeFeatures.addInfestedStone(builder);
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.SNOW, Biome.Category.MOUNTAIN, -0.3f, 0.9f, builder2, builder);
    }
    ...
    public static Biome createGrove() {
        ...
        DefaultBiomeFeatures.addEmeraldOre(builder);
        DefaultBiomeFeatures.addInfestedStone(builder);
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.SNOW, Biome.Category.FOREST, -0.2f, 0.8f, builder2, builder);
    }
    ...
    public static Biome createLushCaves() {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.UNDERGROUND, 0.5f, 0.5f, builder, builder2);
    }
    ...
    public static Biome createDripstoneCaves() {
        ...
        return DefaultBiomeCreator.method_39152(Biome.Precipitation.RAIN, Biome.Category.UNDERGROUND, 0.8f, 0.4f, builder, builder2);
    }
}
