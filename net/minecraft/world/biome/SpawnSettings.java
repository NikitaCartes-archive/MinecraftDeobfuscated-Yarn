...
public class SpawnSettings {
    ...
    public static final SpawnSettings INSTANCE = new SpawnSettings(0.1f, (Map<SpawnGroup, List<SpawnEntry>>)Stream.of(SpawnGroup.values()).collect(ImmutableMap.toImmutableMap(spawnGroup -> spawnGroup, spawnGroup -> ImmutableList.of())), ImmutableMap.of());
    ...
    public static class Builder {
        ...
        public SpawnSettings build() {
            return new SpawnSettings(this.creatureSpawnProbability, this.spawners.entrySet().stream().collect(ImmutableMap.toImmutableMap(Map.Entry::getKey, entry -> ImmutableList.copyOf((Collection)entry.getValue()))), ImmutableMap.copyOf(this.spawnCosts));
        }
    }
