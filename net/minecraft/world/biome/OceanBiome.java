...
extends Biome {
    public OceanBiome() {
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, OceanBiome.configureFeature(Feature.SEAGRASS, new SeagrassFeatureConfig(48, 0.3), Decorator.TOP_SOLID_HEIGHTMAP, DecoratorConfig.DEFAULT));
