...
extends Biome {
    public EndMidlandsBiome() {
        ...
        this.addFeature(GenerationStep.Feature.SURFACE_STRUCTURES, EndMidlandsBiome.configureFeature(Feature.END_CITY, FeatureConfig.DEFAULT, Decorator.NOPE, DecoratorConfig.DEFAULT));
