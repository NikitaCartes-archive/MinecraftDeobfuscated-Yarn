...
extends Biome {
    public VoidBiome() {
        ...
        this.addFeature(GenerationStep.Feature.TOP_LAYER_MODIFICATION, VoidBiome.configureFeature(Feature.VOID_START_PLATFORM, FeatureConfig.DEFAULT, Decorator.NOPE, DecoratorConfig.DEFAULT));
    }
}
