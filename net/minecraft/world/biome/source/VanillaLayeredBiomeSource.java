...
extends BiomeSource {
    public static final Codec<VanillaLayeredBiomeSource> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.LONG.fieldOf("seed")).stable().forGetter(vanillaLayeredBiomeSource -> vanillaLayeredBiomeSource.field_24728), Codec.BOOL.optionalFieldOf("legacy_biome_init_layer", false, Lifecycle.stable()).forGetter(vanillaLayeredBiomeSource -> vanillaLayeredBiomeSource.field_24498), ((MapCodec)Codec.BOOL.fieldOf("large_biomes")).orElse(false).stable().forGetter(vanillaLayeredBiomeSource -> vanillaLayeredBiomeSource.field_24729), class_5505.method_31148(Registry.BIOME_KEY).forGetter(vanillaLayeredBiomeSource -> vanillaLayeredBiomeSource.field_26698)).apply((Applicative<VanillaLayeredBiomeSource, ?>)instance, instance.stable(VanillaLayeredBiomeSource::new)));
    ...
    public VanillaLayeredBiomeSource(long l, boolean bl, boolean bl2, Registry<Biome> registry) {
        super(BIOMES.stream().map(registryKey -> () -> (Biome)registry.method_31140((RegistryKey<Biome>)registryKey)));
        this.field_24728 = l;
        this.field_24498 = bl;
