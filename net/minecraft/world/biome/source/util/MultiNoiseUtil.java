...
public class MultiNoiseUtil {
    ...
    public static MultiNoiseSampler method_40443() {
        ...
        return new MultiNoiseSampler(noiseType, noiseType, noiseType, noiseType, noiseType, noiseType, List.of());
    }
    ...
    public record MultiNoiseSampler(NoiseType temperature, NoiseType humidity, NoiseType continentalness, NoiseType erosion, NoiseType depth, NoiseType weirdness, List<NoiseHypercube> spawnTarget) {
