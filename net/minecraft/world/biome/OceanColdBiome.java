...
extends Biome {
    public OceanColdBiome() {
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, OceanColdBiome.configureFeature(Feature.SEAGRASS, new SeagrassFeatureConfig(32, 0.3), Decorator.TOP_SOLID_HEIGHTMAP, DecoratorConfig.DEFAULT));
