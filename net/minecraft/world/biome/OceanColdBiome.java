...
extends Biome {
    public OceanColdBiome() {
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.SEAGRASS.method_23397(new SeagrassFeatureConfig(32, 0.3)).method_23388(Decorator.TOP_SOLID_HEIGHTMAP.method_23475(DecoratorConfig.DEFAULT)));
