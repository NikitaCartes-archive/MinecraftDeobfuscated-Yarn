...
public class BiomeEffects {
    ...
    BiomeEffects(int i, int j, int k, int l, Optional<Integer> optional, Optional<Integer> optional2, GrassColorModifier grassColorModifier, Optional<BiomeParticleConfig> optional3, Optional<SoundEvent> optional4, Optional<BiomeMoodSound> optional5, Optional<BiomeAdditionsSound> optional6, Optional<MusicSound> optional7) {
        this.fogColor = i;
        this.waterColor = j;
