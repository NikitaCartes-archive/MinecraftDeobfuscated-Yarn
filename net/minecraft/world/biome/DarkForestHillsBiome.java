...
extends Biome {
    public DarkForestHillsBiome() {
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(Feature.HUGE_RED_MUSHROOM.configure(DefaultBiomeFeatures.field_21142).method_23387(0.025f), Feature.HUGE_BROWN_MUSHROOM.configure(DefaultBiomeFeatures.field_21143).method_23387(0.05f), Feature.DARK_OAK_TREE.configure(DefaultBiomeFeatures.field_21197).method_23387(0.6666667f), Feature.NORMAL_TREE.configure(DefaultBiomeFeatures.field_21187).method_23387(0.2f), Feature.FANCY_TREE.configure(DefaultBiomeFeatures.field_21190).method_23387(0.1f)), Feature.NORMAL_TREE.configure(DefaultBiomeFeatures.field_21126))).createDecoratedFeature(Decorator.DARK_OAK_TREE.configure(DecoratorConfig.DEFAULT)));
