...
public enum IncreaseEdgeCurvatureLayer implements DiagonalCrossSamplingLayer
{
    ...
    public int sample(LayerRandomnessSource layerRandomnessSource, int i, int j, int k, int l, int m) {
        ...
        if (!BiomeLayers.isShallowOcean(m) && (BiomeLayers.isShallowOcean(l) || BiomeLayers.isShallowOcean(i) || BiomeLayers.isShallowOcean(k) || BiomeLayers.isShallowOcean(j)) && layerRandomnessSource.nextInt(5) == 0) {
