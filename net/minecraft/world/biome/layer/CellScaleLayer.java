...
public enum CellScaleLayer implements ParentedLayer
{
    ...
    public int sample(LayerSampleContext<?> layerSampleContext, LayerSampler layerSampler, int i, int j) {
        ...
        int o = m << 2;
        int p = n << 2;
        layerSampleContext.initSeed(o, p);
        ...
        layerSampleContext.initSeed(o + 4, p);
        ...
        layerSampleContext.initSeed(o, p + 4);
        ...
        layerSampleContext.initSeed(o + 4, p + 4);
        ...
        if (x < v && x < w && x < y) {
            return layerSampler.sample(this.transformX(o), this.transformZ(p + 4));
        }
        return layerSampler.sample(this.transformX(o + 4), this.transformZ(p + 4)) & 0xFF;
    }
