...
public class OverworldBiomeCreator {
    ...
    public static Biome createWarmOcean() {
        ...
        GenerationSettings.Builder builder2 = OverworldBiomeCreator.createOceanGenerationSettings().feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.WARM_OCEAN_VEGETATION).feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEAGRASS_WARM).feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEA_PICKLE);
    ...
    public static Biome createDeepWarmOcean() {
        ...
        GenerationSettings.Builder builder2 = OverworldBiomeCreator.createOceanGenerationSettings().feature(GenerationStep.Feature.VEGETAL_DECORATION, ConfiguredFeatures.SEAGRASS_DEEP_WARM);
        DefaultBiomeFeatures.addSeagrassOnStone(builder2);
        return OverworldBiomeCreator.createOcean(builder, 4445678, 270131, builder2);
    }
