...
import net.minecraft.world.biome.OceanColdBiome;
import net.minecraft.world.biome.OceanDeepColdBiome;
import net.minecraft.world.biome.OceanDeepFrozenBiome;
import net.minecraft.world.biome.OceanDeepLukewarmBiome;
import net.minecraft.world.biome.OceanDeepWarmBiome;
import net.minecraft.world.biome.OceanLukewarmBiome;
...
public abstract class Biomes {
    ...
    static {
        ...
        WARM_OCEAN = Biomes.register(44, "warm_ocean", new OceanWarmBiome());
        LUKEWARM_OCEAN = Biomes.register(45, "lukewarm_ocean", new OceanLukewarmBiome());
        COLD_OCEAN = Biomes.register(46, "cold_ocean", new OceanColdBiome());
        DEEP_WARM_OCEAN = Biomes.register(47, "deep_warm_ocean", new OceanDeepWarmBiome());
        DEEP_LUKEWARM_OCEAN = Biomes.register(48, "deep_lukewarm_ocean", new OceanDeepLukewarmBiome());
        DEEP_COLD_OCEAN = Biomes.register(49, "deep_cold_ocean", new OceanDeepColdBiome());
        DEEP_FROZEN_OCEAN = Biomes.register(50, "deep_frozen_ocean", new OceanDeepFrozenBiome());
