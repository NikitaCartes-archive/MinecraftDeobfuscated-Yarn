...
public class LootPool {
    ...
    private final class_4570[] conditions;
    ...
    private LootPool(LootEntry[] lootEntrys, class_4570[] args, LootFunction[] lootFunctions, LootTableRange lootTableRange, UniformLootTableRange uniformLootTableRange) {
    ...
    JsonSerializer<LootPool> {
        public LootPool method_358(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
            ...
            return new LootPool(lootEntrys, lvs, lootFunctions, lootTableRange, uniformLootTableRange);
        }
    ...
    ConditionConsumerBuilder<Builder> {
        private final List<LootEntry> entries = Lists.newArrayList();
        private final List<class_4570> conditions = Lists.newArrayList();
        ...
        public Builder method_356(class_4570.Builder builder) {
        ...
        public LootPool build() {
            ...
            return new LootPool(this.entries.toArray(new LootEntry[0]), this.conditions.toArray(new class_4570[0]), this.functions.toArray(new LootFunction[0]), this.rollsRange, this.bonusRollsRange);
        }
