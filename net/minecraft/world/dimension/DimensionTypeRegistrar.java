...
public class DimensionTypeRegistrar {
    public static RegistryEntry<DimensionType> initAndGetDefault(Registry<DimensionType> registry) {
        ...
        return BuiltinRegistries.add(registry, DimensionTypes.OVERWORLD_CAVES, new DimensionType(OptionalLong.empty(), true, true, false, true, 1.0, true, false, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, DimensionTypes.OVERWORLD_ID, 0.0f, new DimensionType.MonsterSettings(false, true, UniformIntProvider.create(0, 7), 0)));
    }
}
