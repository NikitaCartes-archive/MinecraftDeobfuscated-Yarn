...
extends DataFix {
    ...
    private static <T> Dynamic<T> method_28271(Dynamic<T> dynamic2) {
        ...
        if (optional.equals(Optional.of("customized"))) {
            dynamic22 = StructureSeparationDataFix.method_28268(l, dynamic2, dynamic2.createString("minecraft:overworld"), StructureSeparationDataFix.method_28272(dynamic2, l, false, false));
            ...
            switch (optional.get()) {
                ...
                default: {
                    ...
                    dynamic22 = StructureSeparationDataFix.method_28268(l, dynamic2, dynamic2.createString(bl3 ? "minecraft:amplified" : "minecraft:overworld"), StructureSeparationDataFix.method_28272(dynamic2, l, bl2, bl4));
                }
            }
        }
