...
public abstract class DirtPathRenameFix
extends BlockNameFix {
    ...
    public static DataFix createDirtPathRenameFix(Schema schema, String string, final Function<String, String> function) {
