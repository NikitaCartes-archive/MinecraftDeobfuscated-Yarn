...
extends DataFix {
    ...
    static class ChunkNibbleArray {
        ...
        public int get(int i, int j, int k) {
            ...
            if (this.method_15641(j << 8 | k << 4 | i)) {
    ...
    static final class Level {
        ...
        public static int adjacentTo(int i, Facing facing) {
            switch (facing.getAxis()) {
                case X: {
                    int j = (i & 0xF) + facing.getDirection().getOffset();
                ...
                case Z: {
                    int l = (i >> 4 & 0xF) + facing.getDirection().getOffset();
