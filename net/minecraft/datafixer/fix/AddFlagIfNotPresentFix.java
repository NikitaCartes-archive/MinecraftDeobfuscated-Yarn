...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(this.field_35009, type, typed -> typed.update(DSL.remainderFinder(), dynamic -> dynamic.set(this.field_35011, DataFixUtils.orElseGet(dynamic.get(this.field_35011).result(), () -> dynamic.createBoolean(this.field_35010)))));
    }
}
