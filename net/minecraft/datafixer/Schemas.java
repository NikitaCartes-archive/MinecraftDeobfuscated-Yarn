...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(new RecipeRenameFix(schema97, false, "Rename sugar recipe", Schemas.replacing("minecraft:sugar", "sugar_from_sugar_cane")));
        builder.addFixer(new AdvancementRenameFix(schema97, false, "Rename sugar recipe advancement", Schemas.replacing("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        builder.addFixer(ItemNameFix.create(schema99, "Rename bee_hive item to beehive", Schemas.replacing("minecraft:bee_hive", "minecraft:beehive")));
        builder.addFixer(new BeehiveRenameFix(schema99));
        builder.addFixer(BlockNameFix.create(schema99, "Rename bee_hive block to beehive", Schemas.replacing("minecraft:bee_hive", "minecraft:beehive")));
        ...
        builder.addFixer(new AdvancementRenameFix(schema104, false, "Composter category change", Schemas.replacing("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        builder.addFixer(ItemNameFix.create(schema106, "Renamed fungi items to fungus", Schemas.replacing(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        builder.addFixer(BlockNameFix.create(schema106, "Renamed fungi blocks to fungus", Schemas.replacing(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        ...
        builder.addFixer(ItemNameFix.create(schema116, "Rename soul fire torch and soul fire lantern", Schemas.replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        builder.addFixer(BlockNameFix.create(schema116, "Rename soul fire torch and soul fire lantern", Schemas.replacing(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        ...
        builder.addFixer(ItemNameFix.create(schema133, "Renamed copper block items to new oxidized terms", Schemas.replacing(immutableMap)));
        builder.addFixer(JigsawBlockNameFix.create(schema133, "Renamed copper blocks to new oxidized terms", Schemas.replacing(immutableMap)));
        ...
        builder.addFixer(JigsawBlockNameFix.create(schema136, "Renamed grimstone blocks to deepslate", Schemas.replacing(immutableMap3)));
        Schema schema137 = builder.addSchema(2700, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(JigsawBlockNameFix.create(schema137, "Renamed cave vines blocks", Schemas.replacing(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
