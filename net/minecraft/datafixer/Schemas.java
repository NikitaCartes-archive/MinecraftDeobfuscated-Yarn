...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(BlockNameFix.create(schema69, "Block renamening fix", Schemas.replacing(EntityTheRenameningBlockFix.BLOCKS)));
        builder.addFixer(ItemNameFix.create(schema69, "Item renamening fix", Schemas.replacing(EntityTheRenameningBlockFix.ITEMS)));
