...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(ItemNameFix.create(schema32, "totem item renamer", string -> Objects.equals(string, "minecraft:totem") ? "minecraft:totem_of_undying" : string));
        ...
        builder.addFixer(BlockNameFix.create(schema53, "Flowing fixer", string -> ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava").getOrDefault(string, (String)string)));
        Schema schema54 = builder.addSchema(1480, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema54, "Rename coral blocks", string -> LegacyCoralBlockMapping.MAP.getOrDefault(string, (String)string)));
        builder.addFixer(ItemNameFix.create(schema54, "Rename coral items", string -> LegacyCoralBlockMapping.MAP.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema56, "Rename pufferfish egg item", string -> EntityPufferfishRenameFix.RENAMED_FISHES.getOrDefault(string, (String)string)));
        Schema schema57 = builder.addSchema(1484, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema57, "Rename seagrass items", string -> ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, (String)string)));
        builder.addFixer(BlockNameFix.create(schema57, "Rename seagrass blocks", string -> ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema58, "Rename cod/salmon egg items", string -> EntityCodSalmonFix.SPAWN_EGGS.getOrDefault(string, (String)string)));
        Schema schema59 = builder.addSchema(1487, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", string -> ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, (String)string)));
        builder.addFixer(BlockNameFix.create(schema59, "Rename prismarine_brick(s)_* items", string -> ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, (String)string)));
        Schema schema60 = builder.addSchema(1488, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema60, "Rename kelp/kelptop", string -> ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema61, "Rename melon_block/melon/speckled_melon", string -> ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(BlockNameFix.create(schema69, "Block renamening fix", string -> EntityTheRenameningBlock.BLOCKS.getOrDefault(string, (String)string)));
        builder.addFixer(ItemNameFix.create(schema69, "Item renamening fix", string -> EntityTheRenameningBlock.ITEMS.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(BlockNameFix.create(schema71, "Rename coral fan blocks", string -> LegacyCoralFanBlockMapping.MAP.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema73, "Rename dye items", string -> LegacyDyeItemMapping.MAP.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(BlockNameFix.create(schema75, "Rename sign blocks & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign").getOrDefault(string, (String)string)));
        builder.addFixer(ItemNameFix.create(schema75, "Rename sign item & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema86, "Rename ravager egg item", string -> EntityRavagerRenameFix.ITEMS.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(new RecipeRenameFix(schema95, false, "Rename sugar recipe", string -> "minecraft:sugar".equals(string) ? "sugar_from_sugar_cane" : string));
        builder.addFixer(new AdvancementRenameFix(schema95, false, "Rename sugar recipe advancement", string -> "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string));
        ...
        builder.addFixer(ItemNameFix.create(schema97, "Rename bee_hive item to beehive", string -> Objects.equals(string, "minecraft:bee_hive") ? "minecraft:beehive" : string));
        builder.addFixer(new BeehiveRenameFix(schema97));
        builder.addFixer(BlockNameFix.create(schema97, "Rename bee_hive block to beehive", string -> ImmutableMap.of("minecraft:bee_hive", "minecraft:beehive").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema104, "Renamed fungi items to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        builder.addFixer(BlockNameFix.create(schema104, "Renamed fungi blocks to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        Schema schema105 = builder.addSchema(2509, Schema2509::new);
        builder.addFixer(new EntityZombifiedPiglinRenameFix(schema105));
        builder.addFixer(ItemNameFix.create(schema105, "Rename zombie pigman egg item", string -> EntityZombifiedPiglinRenameFix.RENAMES.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", string -> ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern").getOrDefault(string, (String)string)));
        builder.addFixer(BlockNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", string -> ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(new class_5299(schema119));
        Schema schema120 = builder.addSchema(2551, class_5301::new);
