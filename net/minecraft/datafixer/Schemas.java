...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(new RecipeRenameFix(schema95, false, "Rename sugar recipe", Schemas.method_30068("minecraft:sugar", "sugar_from_sugar_cane")));
        builder.addFixer(new AdvancementRenameFix(schema95, false, "Rename sugar recipe advancement", Schemas.method_30068("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        builder.addFixer(ItemNameFix.create(schema97, "Rename bee_hive item to beehive", Schemas.method_30068("minecraft:bee_hive", "minecraft:beehive")));
        builder.addFixer(new BeehiveRenameFix(schema97));
        builder.addFixer(BlockNameFix.create(schema97, "Rename bee_hive block to beehive", Schemas.method_30068("minecraft:bee_hive", "minecraft:beehive")));
        ...
        builder.addFixer(new AdvancementRenameFix(schema102, false, "Composter category change", Schemas.method_30068("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        builder.addFixer(ItemNameFix.create(schema104, "Renamed fungi items to fungus", Schemas.method_30070(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        builder.addFixer(BlockNameFix.create(schema104, "Renamed fungi blocks to fungus", Schemas.method_30070(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
        Schema schema105 = builder.addSchema(2509, Schema2509::new);
        builder.addFixer(new EntityZombifiedPiglinRenameFix(schema105));
        builder.addFixer(ItemNameFix.create(schema105, "Rename zombie pigman egg item", Schemas.method_30070(EntityZombifiedPiglinRenameFix.RENAMES)));
        ...
        builder.addFixer(ItemNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", Schemas.method_30070(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
        builder.addFixer(BlockNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", Schemas.method_30070(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
