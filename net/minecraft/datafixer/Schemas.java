...
import net.minecraft.datafixer.StructureReferenceFixer;
...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(ItemNameFix.create(schema18, "cooked_fished item renamer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : string));
        ...
        builder.addFixer(BlockNameFix.create(schema52, "Colorless shulker block fixer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        builder.addFixer(ItemNameFix.create(schema52, "Colorless shulker item fixer", string -> Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string));
        ...
        builder.addFixer(BlockNameFix.create(schema70, "Block renamening fix", string -> EntityTheRenameningBlock.BLOCKS.getOrDefault(string, (String)string)));
        builder.addFixer(ItemNameFix.create(schema70, "Item renamening fix", string -> EntityTheRenameningBlock.ITEMS.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(BlockNameFix.create(schema72, "Rename coral fan blocks", string -> LegacyCoralFanBlockMapping.MAP.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema74, "Rename dye items", string -> LegacyDyeItemMapping.MAP.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(BlockNameFix.create(schema76, "Rename sign blocks & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign").getOrDefault(string, (String)string)));
        builder.addFixer(ItemNameFix.create(schema76, "Rename sign item & stone slabs", string -> ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign").getOrDefault(string, (String)string)));
        ...
        builder.addFixer(ItemNameFix.create(schema87, "Rename ravager egg item", string -> EntityRavagerRenameFix.ITEMS.getOrDefault(string, (String)string)));
        ...
        builder.addFixer(new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", string -> "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string));
        ...
        builder.addFixer(ItemNameFix.create(schema98, "Rename bee_hive item to beehive", string -> Objects.equals(string, "minecraft:bee_hive") ? "minecraft:beehive" : string));
        builder.addFixer(new BeehiveRenameFix(schema98));
        builder.addFixer(BlockNameFix.create(schema98, "Rename bee_hive block to beehive", string -> ImmutableMap.of("minecraft:bee_hive", "minecraft:beehive").getOrDefault(string, (String)string)));
