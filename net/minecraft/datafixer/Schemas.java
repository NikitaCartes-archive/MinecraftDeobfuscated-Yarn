...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(ItemNameFix.create(schema105, "Renamed fungi items to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        builder.addFixer(BlockNameFix.create(schema105, "Renamed fungi blocks to fungus", string -> ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus").getOrDefault(string, (String)string)));
        Schema schema106 = builder.addSchema(2509, Schema2509::new);
        builder.addFixer(new EntityZombifiedPiglinRenameFix(schema106));
        builder.addFixer(ItemNameFix.create(schema106, "Rename zombie pigman egg item", string -> EntityZombifiedPiglinRenameFix.RENAMES.getOrDefault(string, (String)string)));
