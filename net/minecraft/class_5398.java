...
extends Goal {
    ...
    public void start() {
        ...
        if (this.field_25605) {
            this.method_29933().stream().filter(mobEntity -> mobEntity != this.field_25604).map(mobEntity -> (Angerable)((Object)mobEntity)).forEach(Angerable::method_29921);
        }
        super.start();
    }
    ...
    private List<MobEntity> method_29933() {
        ...
        Box box = Box.method_29968(((Entity)this.field_25604).getPos()).expand(d, 10.0, d);
        return ((MobEntity)this.field_25604).world.getEntitiesIncludingUngeneratedChunks(this.field_25604.getClass(), box);
    }
}
