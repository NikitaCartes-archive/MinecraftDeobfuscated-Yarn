...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.field_20188 = new RealmsButton(1, this.width() / 2 - 100, this.height() - 42, 200, 20, class_4427.getLocalizedString("gui.back")){
        ...
        this.field_20189 = new RealmsButton(0, this.width() / 2 - 100, this.height() - 42, 200, 20, class_4427.getLocalizedString("gui.cancel")){
        ...
        this.buttonsAdd(this.field_20189);
        if (!this.field_20187) {
    ...
    public void render(int i, int j, float f) {
        ...
        if (!this.field_20185 && this.field_20179.field_19601 != 0L && this.field_20179.field_19601.longValue() == this.field_20179.field_19602.longValue()) {
            this.field_20182 = class_4427.getLocalizedString("mco.upload.verifying");
            this.field_20189.active(false);
        }
        this.drawCenteredString(this.field_20182, this.width() / 2, 50, 0xFFFFFF);
        if (this.field_20186) {
            this.method_21530();
        }
    ...
    private void method_21530() {
        ...
        this.drawString(field_20191[this.field_20192 % field_20191.length], this.width() / 2 + i / 2 + 5, 50, 0xFFFFFF);
    }
    ...
    private void method_21532() {
        ...
        this.drawCenteredString(this.field_20183 + " %", this.width() / 2, 84, 0xFFFFFF);
    }
    ...
    private void method_21526(long l) {
        if (l > 0L) {
            ...
            String string = "(" + class_4427.method_21509(l) + ")";
    ...
    public static class_4428 method_21518(long l) {
        if (l < 1024L) {
            return class_4428.B;
        }
        ...
        try {
            return class_4428.valueOf(string + "B");
        } catch (Exception exception) {
            return class_4428.GB;
        }
    }

    public static double method_21510(long l, class_4428 arg) {
        if (arg.equals((Object)class_4428.B)) {
            return l;
        }
        return (double)l / Math.pow(1024.0, arg.ordinal());
    }

    public static String method_21519(long l, class_4428 arg) {
        return String.format("%." + (arg.equals((Object)class_4428.GB) ? "1" : "0") + "f %s", class_4427.method_21510(l, arg), arg.name());
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    for (int i = 0; i < 20; ++i) {
                        block35: {
                            try {
                                if (!class_4427.this.field_20184) break block35;
                                class_4427.this.method_21538();
                                return;
                            } catch (class_4356 lv2) {
                                Thread.sleep(lv2.field_19608 * 1000);
                                continue;
                            }
                        }
                    ...
                    if (!class_4427.this.method_21515(file)) {
                        long m = file.length();
                        class_4428 lv3 = class_4427.method_21518(m);
                        class_4428 lv4 = class_4427.method_21518(0x140000000L);
                        if (class_4427.method_21519(m, lv3).equals(class_4427.method_21519(0x140000000L, lv4)) && lv3 != class_4428.B) {
                            class_4428 lv5 = class_4428.values()[lv3.ordinal() - 1];
                            class_4427.this.field_20181 = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", class_4427.this.field_20176.getLevelName()) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", class_4427.method_21519(m, lv5), class_4427.method_21519(0x140000000L, lv5));
                            return;
                        }
                        class_4427.this.field_20181 = RealmsScreen.getLocalizedString("mco.upload.size.failure.line1", class_4427.this.field_20176.getLevelName()) + "\\n" + RealmsScreen.getLocalizedString("mco.upload.size.failure.line2", class_4427.method_21519(m, lv3), class_4427.method_21519(0x140000000L, lv4));
                        return;
                    }
                    ...
                    class_4337 lv6 = new class_4337(file, class_4427.this.field_20177, class_4427.this.field_20178, uploadInfo, Realms.getSessionId(), Realms.getName(), Realms.getMinecraftVersionString(), class_4427.this.field_20179);
                    ...
                    class_4427.this.field_20181 = RealmsScreen.getLocalizedString("mco.upload.failed", iOException.getMessage());
                } catch (class_4355 lv7) {
                    class_4427.this.field_20181 = RealmsScreen.getLocalizedString("mco.upload.failed", lv7.toString());
    ...
    private void method_21538() {
        this.field_20182 = class_4427.getLocalizedString("mco.upload.cancelled");
