...
extends class_4651 {
    ...
    public BlockState method_23455(Random random, BlockPos blockPos) {
        ...
        return (BlockState)this.field_21313.getDefaultState().with(PillarBlock.AXIS, axis);
    }

    @Override
    public <T> T serialize(DynamicOps<T> dynamicOps) {
        ImmutableMap.Builder<T, T> builder = ImmutableMap.builder();
        builder.put(dynamicOps.createString("type"), dynamicOps.createString(Registry.BLOCK_STATE_PROVIDER_TYPE.getId(this.field_21304).toString())).put(dynamicOps.createString("state"), BlockState.serialize(dynamicOps, this.field_21313.getDefaultState()).getValue());
