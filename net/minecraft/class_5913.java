...
public abstract class class_5913 {
    private static final Pattern field_29200 = Pattern.compile("(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*(#(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*moj_import(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*(?:\"(.*)\"|<(.*)>))");
    private static final Pattern field_29201 = Pattern.compile("(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*(#(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*version(?:/\\*(?:[^*]|\\*+[^/])*\\*+/|\\h)*(\\d+))\\b");

    public List<String> method_34229(String string) {
        class_5914 lv = new class_5914();
        List<String> list = this.method_34232(string, lv, "");
        list.set(0, this.method_34230(list.get(0), lv.field_29202));
        return list;
    }

    private List<String> method_34232(String string, class_5914 arg, String string2) {
        String string4;
        ...
        while (matcher.find()) {
            ...
            if (!Strings.isEmpty(string7)) {
                ...
                list2.set(0, String.format("#line %d %d\n%s", 0, k, this.method_34231(list2.get(0), arg)));
            ...
            k = ChatUtil.method_34238(string.substring(0, matcher.end(1)));
    ...
    private String method_34231(String string, class_5914 arg) {
    ...
    @Nullable
    public abstract String method_34233(boolean var1, String var2);
