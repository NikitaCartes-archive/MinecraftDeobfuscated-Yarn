...
extends AbstractSet<T> {
    ...
    private class_4706(int i, Comparator<T> comparator) {
        ...
        this.field_21563 = class_4706.method_23864(new Object[i]);
    }
    ...
    public boolean add(T object) {
        ...
        int j = class_4706.method_23866(i);
    ...
    private void method_23868(int i) {
        ...
        if (this.field_21563 != ObjectArrays.DEFAULT_EMPTY_ARRAY) {
            i = (int)Math.max(Math.min((long)this.field_21563.length + (long)(this.field_21563.length >> 1), 0x7FFFFFF7L), (long)i);
        } else if (i < 10) {
            i = 10;
        }
        Object[] objects = new Object[i];
        System.arraycopy(this.field_21563, 0, objects, 0, this.field_21564);
        this.field_21563 = class_4706.method_23864(objects);
    }
    ...
    public T method_23862(T object) {
        ...
        this.method_23863(object, class_4706.method_23866(i));
        return object;
    }
    ...
    public <U> U[] toArray(U[] objects) {
        if (objects.length < this.field_21564) {
            return Arrays.copyOf(this.field_21563, this.field_21564, objects.getClass());
        }
        System.arraycopy(this.field_21563, 0, objects, 0, this.field_21564);
        if (objects.length > this.field_21564) {
