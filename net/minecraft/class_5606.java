...
public class class_5606 {
    ...
    public class_5606 method_32105(String string, float f, float g, float h, int i, int j, int k, class_5605 arg, int l, int m) {
        ...
        this.field_27719.add(new class_5604(string, this.field_27720, this.field_27721, f, g, h, i, j, k, arg, this.field_27722, 1.0f, 1.0f));
        return this;
    }

    public class_5606 method_32104(String string, float f, float g, float h, int i, int j, int k, int l, int m) {
        this.method_32101(l, m);
        this.field_27719.add(new class_5604(string, this.field_27720, this.field_27721, f, g, h, i, j, k, class_5605.field_27715, this.field_27722, 1.0f, 1.0f));
        return this;
    }

    public class_5606 method_32097(float f, float g, float h, float i, float j, float k) {
        this.field_27719.add(new class_5604(null, this.field_27720, this.field_27721, f, g, h, i, j, k, class_5605.field_27715, this.field_27722, 1.0f, 1.0f));
        return this;
    }
    ...
    public class_5606 method_32100(float f, float g, float h, float i, float j, float k, boolean bl) {
        this.field_27719.add(new class_5604(null, this.field_27720, this.field_27721, f, g, h, i, j, k, class_5605.field_27715, bl, 1.0f, 1.0f));
        return this;
    }

    public class_5606 method_32099(float f, float g, float h, float i, float j, float k, class_5605 arg, float l, float m) {
        this.field_27719.add(new class_5604(null, this.field_27720, this.field_27721, f, g, h, i, j, k, arg, this.field_27722, l, m));
        return this;
    }

    public class_5606 method_32098(float f, float g, float h, float i, float j, float k, class_5605 arg) {
        this.field_27719.add(new class_5604(null, this.field_27720, this.field_27721, f, g, h, i, j, k, arg, this.field_27722, 1.0f, 1.0f));
        return this;
    }
