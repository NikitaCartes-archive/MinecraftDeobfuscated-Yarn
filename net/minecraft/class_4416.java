...
extends RealmsScreen {
    ...
    private List<RealmsLevelSummary> field_20055 = new ArrayList<RealmsLevelSummary>();
    private int field_20056 = -1;
    private class_4418 field_20057;
    ...
    public void init() {
        ...
        try {
            ...
            field_20049.error("Couldn't load level list", (Throwable)exception);
            Realms.setScreen(new class_4394("Unable to load worlds", exception.getMessage(), this.field_20050));
            return;
        }
        this.field_20058 = class_4416.getLocalizedString("selectWorld.world");
        this.field_20059 = class_4416.getLocalizedString("selectWorld.conversion");
        this.field_20060[Realms.survivalId()] = class_4416.getLocalizedString("gameMode.survival");
        this.field_20060[Realms.creativeId()] = class_4416.getLocalizedString("gameMode.creative");
        this.field_20060[Realms.adventureId()] = class_4416.getLocalizedString("gameMode.adventure");
        this.field_20060[Realms.spectatorId()] = class_4416.getLocalizedString("gameMode.spectator");
        this.addWidget(this.field_20057);
        this.buttonsAdd(new RealmsButton(1, this.width() / 2 + 6, this.height() - 32, 153, 20, class_4416.getLocalizedString("gui.back")){
        ...
        this.field_20053 = new RealmsButton(2, this.width() / 2 - 154, this.height() - 32, 153, 20, class_4416.getLocalizedString("mco.upload.button.name")){
        ...
        this.buttonsAdd(this.field_20053);
        this.field_20053.active(this.field_20056 >= 0 && this.field_20056 < this.field_20055.size());
        this.field_20061 = new RealmsLabel(class_4416.getLocalizedString("mco.upload.select.world.title"), this.width() / 2, 13, 0xFFFFFF);
        this.addWidget(this.field_20061);
        this.field_20062 = new RealmsLabel(class_4416.getLocalizedString("mco.upload.select.world.subtitle"), this.width() / 2, class_4359.method_21072(-1), 0xA0A0A0);
        this.addWidget(this.field_20062);
        if (this.field_20055.isEmpty()) {
            this.field_20063 = new RealmsLabel(class_4416.getLocalizedString("mco.upload.select.world.none"), this.width() / 2, this.height() / 2 - 20, 0xFFFFFF);
    ...
    private void method_21401() {
        if (this.field_20056 != -1 && !this.field_20055.get(this.field_20056).isHardcore()) {
            RealmsLevelSummary realmsLevelSummary = this.field_20055.get(this.field_20056);
        ...
        protected void method_21411(RealmsLevelSummary realmsLevelSummary, int i, int j, int k, int l, Tezzelator tezzelator, int m, int n) {
            ...
            if (realmsLevelSummary.isRequiresConversion()) {
                ...
                if (realmsLevelSummary.isHardcore()) {
                    string3 = (Object)((Object)class_4357.DARK_RED) + RealmsScreen.getLocalizedString("mco.upload.hardcore") + (Object)((Object)class_4357.RESET);
                }
                if (realmsLevelSummary.hasCheats()) {
                    string3 = string3 + ", " + RealmsScreen.getLocalizedString("selectWorld.cheats");
                }
            }
            class_4416.this.drawString(string, j + 2, k + 1, 0xFFFFFF);
            class_4416.this.drawString(string2, j + 2, k + 12, 0x808080);
            class_4416.this.drawString(string3, j + 2, k + 12 + 10, 0x808080);
        }
    }
    ...
    extends RealmsObjectSelectionList {
        ...
        public void method_21412(RealmsLevelSummary realmsLevelSummary) {
            this.addEntry(new class_4417(realmsLevelSummary));
        }
        ...
        public void selectItem(int i) {
            ...
            if (i != -1) {
                ...
                String string2 = Realms.joinNarrations(Arrays.asList(realmsLevelSummary.getLevelName(), class_4416.this.method_21404(realmsLevelSummary), class_4416.this.method_21400(realmsLevelSummary), string));
                Realms.narrateNow(RealmsScreen.getLocalizedString("narrator.select", string2));
            }
            class_4416.this.field_20056 = i;
            class_4416.this.field_20053.active(class_4416.this.field_20056 >= 0 && class_4416.this.field_20056 < this.getItemCount() && !((RealmsLevelSummary)class_4416.this.field_20055.get(class_4416.this.field_20056)).isHardcore());
        }
    }
}
