...
public class TradeOffers {
    ...
    public static final Int2ObjectMap<Factory[]> ONE_TWENTY_WANDERING_TRADER_TRADES = TradeOffers.copyToFastUtilMap(ImmutableMap.of(1, new Factory[]{new SellItemFactory(Items.CHERRY_SAPLING, 5, 1, 8, 1)}));
