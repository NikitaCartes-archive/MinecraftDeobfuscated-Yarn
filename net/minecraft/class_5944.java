...
AutoCloseable {
    ...
    public class_5944(ResourceFactory resourceFactory, String string, VertexFormat vertexFormat) throws IOException {
        ...
        try {
            ...
            this.field_29464 = class_5944.method_34581(JsonHelper.getObject(jsonObject, "blend", null));
            this.field_29467 = class_5944.method_34579(resourceFactory, GlShader.Type.VERTEX, string2);
            this.field_29468 = class_5944.method_34579(resourceFactory, GlShader.Type.FRAGMENT, string3);
    ...
    private void method_34588() {
        ...
        for (GlUniform glUniform : this.field_29490) {
            ...
            if (l == -1) {
                field_29483.warn("Could not find uniform named {} in the specified shader program.", (Object)string2);
                continue;
            }
