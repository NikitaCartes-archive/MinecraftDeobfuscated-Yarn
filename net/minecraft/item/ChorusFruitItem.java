    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity entity) {
        ...
        if (!world.isClient) {
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                double h = MathHelper.clamp(entity.getY() + (double)(entity.getRandom().nextInt(16) - 8), (double)world.getSectionCount(), (double)(world.getSectionCount() + ((ServerWorld)world).getHeightLimit() - 1));
