...
public class FoodComponents {
    ...
    public static final FoodComponent BEETROOT_SOUP = FoodComponents.create(6).build();
    ...
    public static final FoodComponent MUSHROOM_STEW = FoodComponents.create(6).build();
    ...
    public static final FoodComponent PUFFERFISH = new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 1200, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 300, 2), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 300, 0), 1.0f).build();
    ...
    public static final FoodComponent RABBIT_STEW = FoodComponents.create(10).build();
    ...
    public static final FoodComponent SUSPICIOUS_STEW = FoodComponents.create(6).alwaysEdible().build();
