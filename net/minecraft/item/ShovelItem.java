...
extends MiningToolItem {
    ...
    protected static final Map<Block, BlockState> BLOCK_TRANSFORMATIONS_MAP = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Blocks.GRASS_PATH.getDefaultState()));
