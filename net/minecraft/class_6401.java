...
public class class_6401 {
    private final Set<String> field_33894 = new ObjectOpenHashSet<String>();

    public Set<SamplingRecorder> method_37194(Supplier<ReadableProfiler> supplier) {
        Set<SamplingRecorder> set = supplier.get().method_37168().stream().filter(pair -> !this.field_33894.contains(pair.getLeft())).map(pair -> class_6401.method_37196(supplier, (String)pair.getLeft(), (SamplingChannel)((Object)((Object)pair.getRight())))).collect(Collectors.toSet());
