...
public class class_5875
extends Feature<OreFeatureConfig> {
    class_5875(Codec<OreFeatureConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<OreFeatureConfig> context) {
        ...
        block0: for (int j = 0; j < i; ++j) {
            ...
            for (OreFeatureConfig.class_5876 lv : oreFeatureConfig.field_29063) {
                if (!OreFeature.method_33983(blockState, structureWorldAccess::getBlockState, random, oreFeatureConfig, lv, mutable)) continue;
