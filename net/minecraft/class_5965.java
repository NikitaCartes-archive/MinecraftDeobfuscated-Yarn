...
public class class_5965 {
    ...
    @Nullable
    private final class_5967 field_29603;

    private <T> class_5965(class_5951 arg, DoubleSupplier doubleSupplier, @Nullable Runnable runnable, @Nullable class_5967 arg2) {
    ...
    public static class_5965 method_34778(String string, DoubleSupplier doubleSupplier) {
        return class_5965.method_34776(new class_5951(string), doubleSupplier);
    }

    public static <T> class_5965 method_34777(String string, T object, ToDoubleFunction<T> toDoubleFunction) {
        return class_5965.method_34779(string, toDoubleFunction, object).method_34787();
    }

    public static <T> class_5966<T> method_34779(String string, ToDoubleFunction<T> toDoubleFunction, T object) {
        return new class_5966<T>(new class_5951(string), toDoubleFunction, object);
    }
    ...
    public static class class_5966<T> {
        ...
        public class_5966<T> method_34788(class_5967 arg) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class class_5968
    implements class_5967 {
        ...
        public void method_34792(double d) {
            boolean bl;
            boolean bl2 = bl = this.field_29611 != Double.MIN_VALUE && d > this.field_29611 && (d - this.field_29611) / this.field_29611 >= (double)this.field_29609;
            if (bl) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static interface class_5967 {
        public void method_34792(double var1);
    }
}
